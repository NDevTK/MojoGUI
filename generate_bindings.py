...
'''
    ...
    for interface in parsed.get('interfaces', []):
        ...
        js_code += "    if (this.router_.onConnectionError) {\n"
        js_code += "      this.router_.onConnectionError.addListener(() => {\n"
        js_code += "         console.error(`[GeneratedReceiver] Connection for ${iface_name} CLOSED.`);\n"
        js_code += "      });\n"
        js_code += "    }\n"
