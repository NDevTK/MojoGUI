...
(function(global) {
    ...
    const MojoUtils = {
         ...
         */
        sanitizeKeys(obj, seen = new WeakSet()) {
            ...
            for (const key in obj) {
                ...
                clean[cleanKey] = this.sanitizeKeys(obj[key], seen);
            }
            return clean;
        },
        ...
        reconcileKeys(edited, original, useHeuristics = true) {
            ...
            if (Array.isArray(edited)) {
                return edited.map((v, i) => this.reconcileKeys(v, Array.isArray(original) ? original[i] : null, useHeuristics));
            }
            ...
            for (const key in edited) {
                ...
                restored[originalKey] = this.reconcileKeys(edited[key], original && original[originalKey], useHeuristics);
            }
            return restored;
        }
    };
