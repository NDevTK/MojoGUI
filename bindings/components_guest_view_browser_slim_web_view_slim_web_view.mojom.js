// Auto-generated MojoJS binding
 // Source: chromium_src/components/guest_view/browser/slim_web_view/slim_web_view.mojom
...
mojo.internal.bindings.guest_view.mojom.PermissionResponseActionSpec = mojo.internal.bindings.guest_view.mojom.PermissionResponseActionSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.guest_view.mojom.SetSizeParamsSpec = mojo.internal.bindings.guest_view.mojom.SetSizeParamsSpec || { $: {} };
if (mojo.internal.bindings.guest_view.mojom.SetSizeParamsSpec.$.structSpec && mojo.internal.bindings.guest_view.mojom.SetSizeParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.guest_view.mojom.SetSizeParamsSpec.$ = {};
mojo.internal.bindings.guest_view.mojom.PageHandlerFactory = mojo.internal.bindings.guest_view.mojom.PageHandlerFactory || {};
mojo.internal.bindings.guest_view.mojom.PageHandlerFactorySpec = mojo.internal.bindings.guest_view.mojom.PageHandlerFactorySpec || { $ : {} };
if (mojo.internal.bindings.guest_view.mojom.PageHandlerFactorySpec.$.structSpec && mojo.internal.bindings.guest_view.mojom.PageHandlerFactorySpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.guest_view.mojom.PageHandlerFactorySpec.$ = {};
mojo.internal.bindings.guest_view.mojom.PageHandlerFactory.$interfaceName = 'guest_view.mojom.PageHandlerFactory';
mojo.internal.bindings.guest_view.mojom.PageHandlerFactory_CreatePageHandler_ParamsSpec = mojo.internal.bindings.guest_view.mojom.PageHandlerFactory_CreatePageHandler_ParamsSpec || { $: {} };
if (mojo.internal.bindings.guest_view.mojom.PageHandlerFactory_CreatePageHandler_ParamsSpec.$.structSpec && mojo.internal.bindings.guest_view.mojom.PageHandlerFactory_CreatePageHandler_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.guest_view.mojom.PageHandlerFactory_CreatePageHandler_ParamsSpec.$ = {};
mojo.internal.bindings.guest_view.mojom.PageHandler = mojo.internal.bindings.guest_view.mojom.PageHandler || {};
mojo.internal.bindings.guest_view.mojom.PageHandlerSpec = mojo.internal.bindings.guest_view.mojom.PageHandlerSpec || { $ : {} };
if (mojo.internal.bindings.guest_view.mojom.PageHandlerSpec.$.structSpec && mojo.internal.bindings.guest_view.mojom.PageHandlerSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.guest_view.mojom.PageHandlerSpec.$ = {};
mojo.internal.bindings.guest_view.mojom.PageHandler.$interfaceName = 'guest_view.mojom.PageHandler';
mojo.internal.bindings.guest_view.mojom.PageHandler_CreateGuest_ParamsSpec = mojo.internal.bindings.guest_view.mojom.PageHandler_CreateGuest_ParamsSpec || { $: {} };
if (mojo.internal.bindings.guest_view.mojom.PageHandler_CreateGuest_ParamsSpec.$.structSpec && mojo.internal.bindings.guest_view.mojom.PageHandler_CreateGuest_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.guest_view.mojom.PageHandler_CreateGuest_ParamsSpec.$ = {};
mojo.internal.bindings.guest_view.mojom.PageHandler_CreateGuest_ResponseParamsSpec = mojo.internal.bindings.guest_view.mojom.PageHandler_CreateGuest_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.guest_view.mojom.PageHandler_CreateGuest_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.guest_view.mojom.PageHandler_CreateGuest_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.guest_view.mojom.PageHandler_CreateGuest_ResponseParamsSpec.$ = {};
mojo.internal.bindings.guest_view.mojom.PageHandler_SetSize_ParamsSpec = mojo.internal.bindings.guest_view.mojom.PageHandler_SetSize_ParamsSpec || { $: {} };
if (mojo.internal.bindings.guest_view.mojom.PageHandler_SetSize_ParamsSpec.$.structSpec && mojo.internal.bindings.guest_view.mojom.PageHandler_SetSize_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.guest_view.mojom.PageHandler_SetSize_ParamsSpec.$ = {};
mojo.internal.bindings.guest_view.mojom.PageHandler_Navigate_ParamsSpec = mojo.internal.bindings.guest_view.mojom.PageHandler_Navigate_ParamsSpec || { $: {} };
if (mojo.internal.bindings.guest_view.mojom.PageHandler_Navigate_ParamsSpec.$.structSpec && mojo.internal.bindings.guest_view.mojom.PageHandler_Navigate_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.guest_view.mojom.PageHandler_Navigate_ParamsSpec.$ = {};
mojo.internal.bindings.guest_view.mojom.PageHandler_SetPermission_ParamsSpec = mojo.internal.bindings.guest_view.mojom.PageHandler_SetPermission_ParamsSpec || { $: {} };
if (mojo.internal.bindings.guest_view.mojom.PageHandler_SetPermission_ParamsSpec.$.structSpec && mojo.internal.bindings.guest_view.mojom.PageHandler_SetPermission_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.guest_view.mojom.PageHandler_SetPermission_ParamsSpec.$ = {};
mojo.internal.bindings.guest_view.mojom.PageHandler_SetPermission_ResponseParamsSpec = mojo.internal.bindings.guest_view.mojom.PageHandler_SetPermission_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.guest_view.mojom.PageHandler_SetPermission_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.guest_view.mojom.PageHandler_SetPermission_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.guest_view.mojom.PageHandler_SetPermission_ResponseParamsSpec.$ = {};
mojo.internal.bindings.guest_view.mojom.PageHandler_SetUserAgentOverride_ParamsSpec = mojo.internal.bindings.guest_view.mojom.PageHandler_SetUserAgentOverride_ParamsSpec || { $: {} };
if (mojo.internal.bindings.guest_view.mojom.PageHandler_SetUserAgentOverride_ParamsSpec.$.structSpec && mojo.internal.bindings.guest_view.mojom.PageHandler_SetUserAgentOverride_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.guest_view.mojom.PageHandler_SetUserAgentOverride_ParamsSpec.$ = {};
mojo.internal.bindings.guest_view.mojom.PageHandler_SetZoom_ParamsSpec = mojo.internal.bindings.guest_view.mojom.PageHandler_SetZoom_ParamsSpec || { $: {} };
if (mojo.internal.bindings.guest_view.mojom.PageHandler_SetZoom_ParamsSpec.$.structSpec && mojo.internal.bindings.guest_view.mojom.PageHandler_SetZoom_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.guest_view.mojom.PageHandler_SetZoom_ParamsSpec.$ = {};
mojo.internal.bindings.guest_view.mojom.PageHandler_SetZoom_ResponseParamsSpec = mojo.internal.bindings.guest_view.mojom.PageHandler_SetZoom_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.guest_view.mojom.PageHandler_SetZoom_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.guest_view.mojom.PageHandler_SetZoom_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.guest_view.mojom.PageHandler_SetZoom_ResponseParamsSpec.$ = {};
mojo.internal.bindings.guest_view.mojom.PageHandler_GetZoom_ParamsSpec = mojo.internal.bindings.guest_view.mojom.PageHandler_GetZoom_ParamsSpec || { $: {} };
if (mojo.internal.bindings.guest_view.mojom.PageHandler_GetZoom_ParamsSpec.$.structSpec && mojo.internal.bindings.guest_view.mojom.PageHandler_GetZoom_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.guest_view.mojom.PageHandler_GetZoom_ParamsSpec.$ = {};
mojo.internal.bindings.guest_view.mojom.PageHandler_GetZoom_ResponseParamsSpec = mojo.internal.bindings.guest_view.mojom.PageHandler_GetZoom_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.guest_view.mojom.PageHandler_GetZoom_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.guest_view.mojom.PageHandler_GetZoom_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.guest_view.mojom.PageHandler_GetZoom_ResponseParamsSpec.$ = {};
mojo.internal.bindings.guest_view.mojom.Page = mojo.internal.bindings.guest_view.mojom.Page || {};
mojo.internal.bindings.guest_view.mojom.PageSpec = mojo.internal.bindings.guest_view.mojom.PageSpec || { $ : {} };
if (mojo.internal.bindings.guest_view.mojom.PageSpec.$.structSpec && mojo.internal.bindings.guest_view.mojom.PageSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.guest_view.mojom.PageSpec.$ = {};
mojo.internal.bindings.guest_view.mojom.Page.$interfaceName = 'guest_view.mojom.Page';
mojo.internal.bindings.guest_view.mojom.Page_DispatchEvent_ParamsSpec = mojo.internal.bindings.guest_view.mojom.Page_DispatchEvent_ParamsSpec || { $: {} };
if (mojo.internal.bindings.guest_view.mojom.Page_DispatchEvent_ParamsSpec.$.structSpec && mojo.internal.bindings.guest_view.mojom.Page_DispatchEvent_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.guest_view.mojom.Page_DispatchEvent_ParamsSpec.$ = {};
...
mojo.internal.bindings.guest_view.mojom.PermissionResponseAction = {
  kDeny: 0,
  kAllow: 1,
  kDefault: 2,
};
...
mojo.internal.bindings.guest_view.mojom.PageHandlerFactoryPendingReceiver = class {
  constructor(handle) {
    this.handle = handle;
    if (handle) {
...
mojo.internal.bindings.guest_view.mojom.PageHandlerFactoryRemote = class {
  static get $interfaceName() {
    return 'guest_view.mojom.PageHandlerFactory';
  }

  constructor(handle = undefined) {
    this.__mojoHandle = handle;
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.guest_view.mojom.PageHandlerFactoryPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.guest_view.mojom.PageHandlerFactoryRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.guest_view.mojom.PageHandlerFactoryRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('guest_view.mojom.PageHandlerFactory', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.guest_view.mojom.PageHandlerFactory.getRemote = function() {
  let remote = new mojo.internal.bindings.guest_view.mojom.PageHandlerFactoryRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
    'guest_view.mojom.PageHandlerFactory',
    'context');
  return remote.$;
};

mojo.internal.bindings.guest_view.mojom.PageHandlerFactoryReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('guest_view.mojom.PageHandlerFactory', [
      { explicit: null },
    ]);
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        case 0: {
          ...
          const params = decoder.decodeStructInline(mojo.internal.bindings.guest_view.mojom.PageHandlerFactory_CreatePageHandler_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.guest_view.mojom.PageHandlerFactoryReceiver = mojo.internal.bindings.guest_view.mojom.PageHandlerFactoryReceiver;

mojo.internal.bindings.guest_view.mojom.PageHandlerFactoryPtr = mojo.internal.bindings.guest_view.mojom.PageHandlerFactoryRemote;
mojo.internal.bindings.guest_view.mojom.PageHandlerFactoryRequest = mojo.internal.bindings.guest_view.mojom.PageHandlerFactoryPendingReceiver;


// Interface: PageHandler
mojo.internal.bindings.guest_view.mojom.PageHandlerPendingReceiver = class {
  constructor(handle) {
    this.handle = handle;
    if (handle) {
      this.__mojoHandle = handle.router_ ? handle.router_.pipe_ : (handle.pipe_ || handle);
...
mojo.internal.bindings.guest_view.mojom.PageHandlerRemote = class {
  static get $interfaceName() {
    return 'guest_view.mojom.PageHandler';
  }

  constructor(handle = undefined) {
    this.__mojoHandle = handle;
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.guest_view.mojom.PageHandlerPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.guest_view.mojom.PageHandlerRemoteCallHandler(this.proxy);
  }
  ...
  createGuest(arg_create_params) {
    return this.$.createGuest(arg_create_params);
  }
  setSize(arg_guest_instance_id, arg_size_params) {
    return this.$.setSize(arg_guest_instance_id, arg_size_params);
  }
  navigate(arg_guest_instance_id, arg_url) {
    return this.$.navigate(arg_guest_instance_id, arg_url);
  }
  setPermission(arg_guest_instance_id, arg_request_id, arg_action) {
    return this.$.setPermission(arg_guest_instance_id, arg_request_id, arg_action);
  }
  setUserAgentOverride(arg_guest_instance_id, arg_user_agent_override) {
    return this.$.setUserAgentOverride(arg_guest_instance_id, arg_user_agent_override);
  }
  setZoom(arg_guest_instance_id, arg_zoom_factor) {
    return this.$.setZoom(arg_guest_instance_id, arg_zoom_factor);
  }
  getZoom(arg_guest_instance_id) {
    return this.$.getZoom(arg_guest_instance_id);
  }
};

mojo.internal.bindings.guest_view.mojom.PageHandlerRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('guest_view.mojom.PageHandler', [
      { explicit: null },
      { explicit: null },
      { explicit: null },
      { explicit: null },
  ...
  createGuest(arg_create_params) {
    return this.proxy.sendMessage(
      this.ordinals[0],  // ordinal
      mojo.internal.bindings.guest_view.mojom.PageHandler_CreateGuest_ParamsSpec,
      mojo.internal.bindings.guest_view.mojom.PageHandler_CreateGuest_ResponseParamsSpec,
      [arg_create_params],
      false);
  }
  ...
  setSize(arg_guest_instance_id, arg_size_params) {
    return this.proxy.sendMessage(
      ...
      mojo.internal.bindings.guest_view.mojom.PageHandler_SetSize_ParamsSpec,
      null,
      [arg_guest_instance_id, arg_size_params],
      false);
  }
  ...
  navigate(arg_guest_instance_id, arg_url) {
    return this.proxy.sendMessage(
      ...
      mojo.internal.bindings.guest_view.mojom.PageHandler_Navigate_ParamsSpec,
      null,
      [arg_guest_instance_id, arg_url],
      false);
  }
  ...
  setPermission(arg_guest_instance_id, arg_request_id, arg_action) {
    return this.proxy.sendMessage(
      ...
      mojo.internal.bindings.guest_view.mojom.PageHandler_SetPermission_ParamsSpec,
      mojo.internal.bindings.guest_view.mojom.PageHandler_SetPermission_ResponseParamsSpec,
      [arg_guest_instance_id, arg_request_id, arg_action],
      false);
  }
  ...
  setUserAgentOverride(arg_guest_instance_id, arg_user_agent_override) {
    return this.proxy.sendMessage(
      ...
      mojo.internal.bindings.guest_view.mojom.PageHandler_SetUserAgentOverride_ParamsSpec,
      null,
      [arg_guest_instance_id, arg_user_agent_override],
      false);
  }
  ...
  setZoom(arg_guest_instance_id, arg_zoom_factor) {
    return this.proxy.sendMessage(
      ...
      mojo.internal.bindings.guest_view.mojom.PageHandler_SetZoom_ParamsSpec,
      mojo.internal.bindings.guest_view.mojom.PageHandler_SetZoom_ResponseParamsSpec,
      [arg_guest_instance_id, arg_zoom_factor],
      false);
  }
  ...
  getZoom(arg_guest_instance_id) {
    return this.proxy.sendMessage(
      ...
      mojo.internal.bindings.guest_view.mojom.PageHandler_GetZoom_ParamsSpec,
      mojo.internal.bindings.guest_view.mojom.PageHandler_GetZoom_ResponseParamsSpec,
...
mojo.internal.bindings.guest_view.mojom.PageHandler.getRemote = function() {
  let remote = new mojo.internal.bindings.guest_view.mojom.PageHandlerRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
    'guest_view.mojom.PageHandler',
    'context');
  return remote.$;
};

mojo.internal.bindings.guest_view.mojom.PageHandlerReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('guest_view.mojom.PageHandler', [
      { explicit: null },
      { explicit: null },
      { explicit: null },
      { explicit: null },
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.guest_view.mojom.PageHandler_CreateGuest_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.createGuest');
          const result = this.impl.createGuest(params.arg_create_params);
          const expectsResponse = header.expectsResponse || (header.flags & 1);
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              const val = (response && typeof response === 'object' && 'arg_guest_instance_id' in response) ? response['arg_guest_instance_id'] : response;
              const resp_obj = { 'arg_guest_instance_id': val };
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.guest_view.mojom.PageHandler_CreateGuest_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
            }).catch(e => console.error('[GeneratedReceiver] createGuest FAILED:', e));
          }
          break;
        }
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.guest_view.mojom.PageHandler_SetSize_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.setSize');
          const result = this.impl.setSize(params.arg_guest_instance_id, params.arg_size_params);
          break;
        }
        case 2: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.guest_view.mojom.PageHandler_Navigate_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.navigate');
          const result = this.impl.navigate(params.arg_guest_instance_id, params.arg_url);
          break;
        }
        case 3: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.guest_view.mojom.PageHandler_SetPermission_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.setPermission');
          const result = this.impl.setPermission(params.arg_guest_instance_id, params.arg_request_id, params.arg_action);
          const expectsResponse = header.expectsResponse || (header.flags & 1);
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.guest_view.mojom.PageHandler_SetPermission_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
            }).catch(e => console.error('[GeneratedReceiver] setPermission FAILED:', e));
          }
          break;
        }
        case 4: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.guest_view.mojom.PageHandler_SetUserAgentOverride_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.setUserAgentOverride');
          const result = this.impl.setUserAgentOverride(params.arg_guest_instance_id, params.arg_user_agent_override);
          break;
        }
        case 5: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.guest_view.mojom.PageHandler_SetZoom_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.setZoom');
          const result = this.impl.setZoom(params.arg_guest_instance_id, params.arg_zoom_factor);
          const expectsResponse = header.expectsResponse || (header.flags & 1);
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.guest_view.mojom.PageHandler_SetZoom_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
            }).catch(e => console.error('[GeneratedReceiver] setZoom FAILED:', e));
          }
          break;
        }
        case 6: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.guest_view.mojom.PageHandler_GetZoom_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.getZoom');
          const result = this.impl.getZoom(params.arg_guest_instance_id);
          const expectsResponse = header.expectsResponse || (header.flags & 1);
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              const val = (response && typeof response === 'object' && 'arg_zoom_factor' in response) ? response['arg_zoom_factor'] : response;
              const resp_obj = { 'arg_zoom_factor': val };
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.guest_view.mojom.PageHandler_GetZoom_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
            }).catch(e => console.error('[GeneratedReceiver] getZoom FAILED:', e));
          }
          break;
        }
      }
...
mojo.internal.bindings.guest_view.mojom.PageHandlerReceiver = mojo.internal.bindings.guest_view.mojom.PageHandlerReceiver;

mojo.internal.bindings.guest_view.mojom.PageHandlerPtr = mojo.internal.bindings.guest_view.mojom.PageHandlerRemote;
mojo.internal.bindings.guest_view.mojom.PageHandlerRequest = mojo.internal.bindings.guest_view.mojom.PageHandlerPendingReceiver;


// Interface: Page
mojo.internal.bindings.guest_view.mojom.PagePendingReceiver = class {
  constructor(handle) {
    this.handle = handle;
    if (handle) {
      this.__mojoHandle = handle.router_ ? handle.router_.pipe_ : (handle.pipe_ || handle);
...
mojo.internal.bindings.guest_view.mojom.PageRemote = class {
  static get $interfaceName() {
    return 'guest_view.mojom.Page';
  }

  constructor(handle = undefined) {
    this.__mojoHandle = handle;
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.guest_view.mojom.PagePendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.guest_view.mojom.PageRemoteCallHandler(this.proxy);
  }
  ...
  dispatchEvent(arg_event_name, arg_args, arg_instance_id) {
    return this.$.dispatchEvent(arg_event_name, arg_args, arg_instance_id);
  }
};

mojo.internal.bindings.guest_view.mojom.PageRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('guest_view.mojom.Page', [
      { explicit: null },
    ]);
  }
  ...
  dispatchEvent(arg_event_name, arg_args, arg_instance_id) {
    return this.proxy.sendMessage(
      this.ordinals[0],  // ordinal
      mojo.internal.bindings.guest_view.mojom.Page_DispatchEvent_ParamsSpec,
      null,
      [arg_event_name, arg_args, arg_instance_id],
      false);
  }

};

mojo.internal.bindings.guest_view.mojom.Page.getRemote = function() {
  let remote = new mojo.internal.bindings.guest_view.mojom.PageRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
    'guest_view.mojom.Page',
    'context');
  return remote.$;
};

mojo.internal.bindings.guest_view.mojom.PageReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('guest_view.mojom.Page', [
      { explicit: null },
    ]);
    ordinals.forEach((ord, idx) => {
      this.ordinalMap.set(ord, idx); // Scrambled/Explicit
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.guest_view.mojom.Page_DispatchEvent_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.dispatchEvent');
          const result = this.impl.dispatchEvent(params.arg_event_name, params.arg_args, params.arg_instance_id);
          break;
        }
      }
      } catch (err) {
...
mojo.internal.bindings.guest_view.mojom.PageReceiver = mojo.internal.bindings.guest_view.mojom.PageReceiver;

mojo.internal.bindings.guest_view.mojom.PagePtr = mojo.internal.bindings.guest_view.mojom.PageRemote;
mojo.internal.bindings.guest_view.mojom.PageRequest = mojo.internal.bindings.guest_view.mojom.PagePendingReceiver;
...
mojo.internal.Struct(
    mojo.internal.bindings.guest_view.mojom.SetSizeParamsSpec, 'guest_view.mojom.SetSizeParams', [
      mojo.internal.StructField('arg_enable_auto_size', 0, 0, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_min', 8, 0, mojo.internal.bindings.gfx.mojom.SizeSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_max', 16, 0, mojo.internal.bindings.gfx.mojom.SizeSpec, null, false, 0, undefined),
    ],
    [[0, 32]]);
mojo.internal.Struct(
    mojo.internal.bindings.guest_view.mojom.PageHandlerFactory_CreatePageHandler_ParamsSpec, 'guest_view.mojom.PageHandlerFactory_CreatePageHandler_Params', [
      mojo.internal.StructField('arg_handler', 0, 0, mojo.internal.InterfaceRequest(mojo.internal.bindings.guest_view.mojom.PageHandlerPendingReceiver), null, false, 0, undefined),
      mojo.internal.StructField('arg_page', 4, 0, mojo.internal.InterfaceProxy(mojo.internal.bindings.guest_view.mojom.PageRemote), null, false, 0, undefined),
    ],
    [[0, 24]]);

mojo.internal.Struct(
    mojo.internal.bindings.guest_view.mojom.PageHandler_CreateGuest_ParamsSpec, 'guest_view.mojom.PageHandler_CreateGuest_Params', [
      mojo.internal.StructField('arg_create_params', 0, 0, mojo.internal.bindings.mojo_base.mojom.DictionaryValueSpec, null, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.guest_view.mojom.PageHandler_CreateGuest_ResponseParamsSpec, 'guest_view.mojom.PageHandler_CreateGuest_ResponseParams', [
      mojo.internal.StructField('arg_guest_instance_id', 0, 0, mojo.internal.Int32, 0, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.guest_view.mojom.PageHandler_SetSize_ParamsSpec, 'guest_view.mojom.PageHandler_SetSize_Params', [
      mojo.internal.StructField('arg_guest_instance_id', 0, 0, mojo.internal.Int32, 0, false, 0, undefined),
      mojo.internal.StructField('arg_size_params', 8, 0, mojo.internal.bindings.guest_view.mojom.SetSizeParamsSpec, null, false, 0, undefined),
    ],
    [[0, 24]]);

mojo.internal.Struct(
    mojo.internal.bindings.guest_view.mojom.PageHandler_Navigate_ParamsSpec, 'guest_view.mojom.PageHandler_Navigate_Params', [
      mojo.internal.StructField('arg_guest_instance_id', 0, 0, mojo.internal.Int32, 0, false, 0, undefined),
...
mojo.internal.Struct(
    mojo.internal.bindings.guest_view.mojom.PageHandler_SetPermission_ParamsSpec, 'guest_view.mojom.PageHandler_SetPermission_Params', [
      mojo.internal.StructField('arg_guest_instance_id', 0, 0, mojo.internal.Int32, 0, false, 0, undefined),
      mojo.internal.StructField('arg_request_id', 4, 0, mojo.internal.Int32, 0, false, 0, undefined),
      mojo.internal.StructField('arg_action', 8, 0, mojo.internal.bindings.guest_view.mojom.PermissionResponseActionSpec, null, false, 0, undefined),
    ],
    [[0, 24]]);

mojo.internal.Struct(
    mojo.internal.bindings.guest_view.mojom.PageHandler_SetPermission_ResponseParamsSpec, 'guest_view.mojom.PageHandler_SetPermission_ResponseParams', [
      mojo.internal.StructField('arg_allowed', 0, 0, mojo.internal.Bool, false, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.guest_view.mojom.PageHandler_SetUserAgentOverride_ParamsSpec, 'guest_view.mojom.PageHandler_SetUserAgentOverride_Params', [
      mojo.internal.StructField('arg_guest_instance_id', 0, 0, mojo.internal.Int32, 0, false, 0, undefined),
      mojo.internal.StructField('arg_user_agent_override', 8, 0, mojo.internal.String, null, false, 0, undefined),
    ],
    [[0, 24]]);

mojo.internal.Struct(
    mojo.internal.bindings.guest_view.mojom.PageHandler_SetZoom_ParamsSpec, 'guest_view.mojom.PageHandler_SetZoom_Params', [
      mojo.internal.StructField('arg_guest_instance_id', 0, 0, mojo.internal.Int32, 0, false, 0, undefined),
      mojo.internal.StructField('arg_zoom_factor', 8, 0, mojo.internal.Double, 0, false, 0, undefined),
    ],
    [[0, 24]]);

mojo.internal.Struct(
    mojo.internal.bindings.guest_view.mojom.PageHandler_SetZoom_ResponseParamsSpec, 'guest_view.mojom.PageHandler_SetZoom_ResponseParams', [
    ],
    [[0, 8]]);

mojo.internal.Struct(
    mojo.internal.bindings.guest_view.mojom.PageHandler_GetZoom_ParamsSpec, 'guest_view.mojom.PageHandler_GetZoom_Params', [
      mojo.internal.StructField('arg_guest_instance_id', 0, 0, mojo.internal.Int32, 0, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.guest_view.mojom.PageHandler_GetZoom_ResponseParamsSpec, 'guest_view.mojom.PageHandler_GetZoom_ResponseParams', [
      mojo.internal.StructField('arg_zoom_factor', 0, 0, mojo.internal.Double, 0, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.guest_view.mojom.Page_DispatchEvent_ParamsSpec, 'guest_view.mojom.Page_DispatchEvent_Params', [
      mojo.internal.StructField('arg_event_name', 0, 0, mojo.internal.String, null, false, 0, undefined),
      mojo.internal.StructField('arg_args', 8, 0, mojo.internal.bindings.mojo_base.mojom.DictionaryValueSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_instance_id', 16, 0, mojo.internal.Int32, 0, false, 0, undefined),
    ],
    [[0, 32]]);
