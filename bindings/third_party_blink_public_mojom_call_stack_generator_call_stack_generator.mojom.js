...
mojo.internal.bindings.blink.mojom.CallStackGenerator = {};
mojo.internal.bindings.blink.mojom.CallStackGeneratorSpec = { $ : {} };
mojo.internal.bindings.blink.mojom.CallStackGenerator.$interfaceName = 'blink.mojom.CallStackGenerator';
...
mojo.internal.bindings.blink.mojom.CallStackGeneratorRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.blink.mojom.CallStackGeneratorPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.blink.mojom.CallStackGeneratorRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.blink.mojom.CallStackGeneratorRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('blink.mojom.CallStackGenerator', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.blink.mojom.CallStackGenerator.getRemote = function() {
  let remote = new mojo.internal.bindings.blink.mojom.CallStackGeneratorRemote();
...
mojo.internal.bindings.blink.mojom.CallStackGeneratorReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('blink.mojom.CallStackGenerator', [
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.blink.mojom.CallStackGenerator_CollectJavaScriptCallStack_ParamsSpec.$.structSpec);
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.blink.mojom.CallStackGenerator_CollectJavaScriptCallStack_ParamsSpec.$.structSpec);
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.blink.mojom.CallStackGenerator_CollectJavaScriptCallStack_ResponseParamsSpec, header, rawHeader);
               responder(response);
...
mojo.internal.bindings.blink.mojom.CallStackGeneratorReceiver = mojo.internal.bindings.blink.mojom.CallStackGeneratorReceiver;
