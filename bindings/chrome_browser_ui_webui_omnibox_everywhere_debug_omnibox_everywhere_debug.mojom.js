// Auto-generated MojoJS binding
 // Source: chromium_src/chrome/browser/ui/webui/omnibox_everywhere/debug/omnibox_everywhere_debug.mojom
 ...
 mojo.internal.bindings.omnibox_everywhere_debug = mojo.internal.bindings.omnibox_everywhere_debug || {};
mojo.internal.bindings.omnibox_everywhere_debug.mojom = mojo.internal.bindings.omnibox_everywhere_debug.mojom || {};
mojo.internal.bindings.mojo_base = mojo.internal.bindings.mojo_base || {};
mojo.internal.bindings.mojo_base.mojom = mojo.internal.bindings.mojo_base.mojom || {};

mojo.internal.bindings.omnibox_everywhere_debug.mojom.InvocationSourceSpec = mojo.internal.bindings.omnibox_everywhere_debug.mojom.InvocationSourceSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.omnibox_everywhere_debug.mojom.Page = mojo.internal.bindings.omnibox_everywhere_debug.mojom.Page || {};
mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageSpec = mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageSpec || { $ : {} };
if (mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageSpec.$.structSpec && mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageSpec.$ = {};
mojo.internal.bindings.omnibox_everywhere_debug.mojom.Page.$interfaceName = 'omnibox_everywhere_debug.mojom.Page';
mojo.internal.bindings.omnibox_everywhere_debug.mojom.Page_OnBackgroundModeChanged_ParamsSpec = mojo.internal.bindings.omnibox_everywhere_debug.mojom.Page_OnBackgroundModeChanged_ParamsSpec || { $: {} };
if (mojo.internal.bindings.omnibox_everywhere_debug.mojom.Page_OnBackgroundModeChanged_ParamsSpec.$.structSpec && mojo.internal.bindings.omnibox_everywhere_debug.mojom.Page_OnBackgroundModeChanged_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.omnibox_everywhere_debug.mojom.Page_OnBackgroundModeChanged_ParamsSpec.$ = {};
mojo.internal.bindings.omnibox_everywhere_debug.mojom.Page_OnHotkeyChanged_ParamsSpec = mojo.internal.bindings.omnibox_everywhere_debug.mojom.Page_OnHotkeyChanged_ParamsSpec || { $: {} };
if (mojo.internal.bindings.omnibox_everywhere_debug.mojom.Page_OnHotkeyChanged_ParamsSpec.$.structSpec && mojo.internal.bindings.omnibox_everywhere_debug.mojom.Page_OnHotkeyChanged_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.omnibox_everywhere_debug.mojom.Page_OnHotkeyChanged_ParamsSpec.$ = {};
mojo.internal.bindings.omnibox_everywhere_debug.mojom.Page_OnEphemeralModelChanged_ParamsSpec = mojo.internal.bindings.omnibox_everywhere_debug.mojom.Page_OnEphemeralModelChanged_ParamsSpec || { $: {} };
if (mojo.internal.bindings.omnibox_everywhere_debug.mojom.Page_OnEphemeralModelChanged_ParamsSpec.$.structSpec && mojo.internal.bindings.omnibox_everywhere_debug.mojom.Page_OnEphemeralModelChanged_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.omnibox_everywhere_debug.mojom.Page_OnEphemeralModelChanged_ParamsSpec.$ = {};
mojo.internal.bindings.omnibox_everywhere_debug.mojom.Page_OnLaunchOnStartupChanged_ParamsSpec = mojo.internal.bindings.omnibox_everywhere_debug.mojom.Page_OnLaunchOnStartupChanged_ParamsSpec || { $: {} };
if (mojo.internal.bindings.omnibox_everywhere_debug.mojom.Page_OnLaunchOnStartupChanged_ParamsSpec.$.structSpec && mojo.internal.bindings.omnibox_everywhere_debug.mojom.Page_OnLaunchOnStartupChanged_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.omnibox_everywhere_debug.mojom.Page_OnLaunchOnStartupChanged_ParamsSpec.$ = {};
mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler = mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler || {};
mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandlerSpec = mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandlerSpec || { $ : {} };
if (mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandlerSpec.$.structSpec && mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandlerSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandlerSpec.$ = {};
mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler.$interfaceName = 'omnibox_everywhere_debug.mojom.PageHandler';
mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_SetBackgroundModeEnabled_ParamsSpec = mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_SetBackgroundModeEnabled_ParamsSpec || { $: {} };
if (mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_SetBackgroundModeEnabled_ParamsSpec.$.structSpec && mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_SetBackgroundModeEnabled_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_SetBackgroundModeEnabled_ParamsSpec.$ = {};
mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_GetBackgroundModeEnabled_ParamsSpec = mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_GetBackgroundModeEnabled_ParamsSpec || { $: {} };
if (mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_GetBackgroundModeEnabled_ParamsSpec.$.structSpec && mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_GetBackgroundModeEnabled_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_GetBackgroundModeEnabled_ParamsSpec.$ = {};
mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_GetBackgroundModeEnabled_ResponseParamsSpec = mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_GetBackgroundModeEnabled_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_GetBackgroundModeEnabled_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_GetBackgroundModeEnabled_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_GetBackgroundModeEnabled_ResponseParamsSpec.$ = {};
mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_SetLaunchOnStartupEnabled_ParamsSpec = mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_SetLaunchOnStartupEnabled_ParamsSpec || { $: {} };
if (mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_SetLaunchOnStartupEnabled_ParamsSpec.$.structSpec && mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_SetLaunchOnStartupEnabled_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_SetLaunchOnStartupEnabled_ParamsSpec.$ = {};
mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_GetLaunchOnStartupEnabled_ParamsSpec = mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_GetLaunchOnStartupEnabled_ParamsSpec || { $: {} };
if (mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_GetLaunchOnStartupEnabled_ParamsSpec.$.structSpec && mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_GetLaunchOnStartupEnabled_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_GetLaunchOnStartupEnabled_ParamsSpec.$ = {};
mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_GetLaunchOnStartupEnabled_ResponseParamsSpec = mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_GetLaunchOnStartupEnabled_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_GetLaunchOnStartupEnabled_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_GetLaunchOnStartupEnabled_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_GetLaunchOnStartupEnabled_ResponseParamsSpec.$ = {};
mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_SetHotkeyEnabled_ParamsSpec = mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_SetHotkeyEnabled_ParamsSpec || { $: {} };
if (mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_SetHotkeyEnabled_ParamsSpec.$.structSpec && mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_SetHotkeyEnabled_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_SetHotkeyEnabled_ParamsSpec.$ = {};
mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_GetHotkeyEnabled_ParamsSpec = mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_GetHotkeyEnabled_ParamsSpec || { $: {} };
if (mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_GetHotkeyEnabled_ParamsSpec.$.structSpec && mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_GetHotkeyEnabled_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_GetHotkeyEnabled_ParamsSpec.$ = {};
mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_GetHotkeyEnabled_ResponseParamsSpec = mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_GetHotkeyEnabled_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_GetHotkeyEnabled_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_GetHotkeyEnabled_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_GetHotkeyEnabled_ResponseParamsSpec.$ = {};
mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_SetEphemeralModelEnabled_ParamsSpec = mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_SetEphemeralModelEnabled_ParamsSpec || { $: {} };
if (mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_SetEphemeralModelEnabled_ParamsSpec.$.structSpec && mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_SetEphemeralModelEnabled_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_SetEphemeralModelEnabled_ParamsSpec.$ = {};
mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_GetEphemeralModelEnabled_ParamsSpec = mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_GetEphemeralModelEnabled_ParamsSpec || { $: {} };
if (mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_GetEphemeralModelEnabled_ParamsSpec.$.structSpec && mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_GetEphemeralModelEnabled_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_GetEphemeralModelEnabled_ParamsSpec.$ = {};
mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_GetEphemeralModelEnabled_ResponseParamsSpec = mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_GetEphemeralModelEnabled_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_GetEphemeralModelEnabled_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_GetEphemeralModelEnabled_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_GetEphemeralModelEnabled_ResponseParamsSpec.$ = {};
mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_InvokeOmniboxEverywhere_ParamsSpec = mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_InvokeOmniboxEverywhere_ParamsSpec || { $: {} };
if (mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_InvokeOmniboxEverywhere_ParamsSpec.$.structSpec && mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_InvokeOmniboxEverywhere_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_InvokeOmniboxEverywhere_ParamsSpec.$ = {};
mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_ShowLensIph_ParamsSpec = mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_ShowLensIph_ParamsSpec || { $: {} };
if (mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_ShowLensIph_ParamsSpec.$.structSpec && mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_ShowLensIph_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_ShowLensIph_ParamsSpec.$ = {};
mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_CreateStartMenuShortcut_ParamsSpec = mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_CreateStartMenuShortcut_ParamsSpec || { $: {} };
if (mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_CreateStartMenuShortcut_ParamsSpec.$.structSpec && mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_CreateStartMenuShortcut_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_CreateStartMenuShortcut_ParamsSpec.$ = {};
mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_CreateStartMenuShortcut_ResponseParamsSpec = mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_CreateStartMenuShortcut_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_CreateStartMenuShortcut_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_CreateStartMenuShortcut_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_CreateStartMenuShortcut_ResponseParamsSpec.$ = {};
mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_PinToTaskbar_ParamsSpec = mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_PinToTaskbar_ParamsSpec || { $: {} };
if (mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_PinToTaskbar_ParamsSpec.$.structSpec && mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_PinToTaskbar_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_PinToTaskbar_ParamsSpec.$ = {};
mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_PinToTaskbar_ResponseParamsSpec = mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_PinToTaskbar_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_PinToTaskbar_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_PinToTaskbar_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_PinToTaskbar_ResponseParamsSpec.$ = {};
mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_ResetProfilePrefs_ParamsSpec = mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_ResetProfilePrefs_ParamsSpec || { $: {} };
if (mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_ResetProfilePrefs_ParamsSpec.$.structSpec && mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_ResetProfilePrefs_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_ResetProfilePrefs_ParamsSpec.$ = {};
mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_ResetProfilePrefs_ResponseParamsSpec = mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_ResetProfilePrefs_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_ResetProfilePrefs_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_ResetProfilePrefs_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_ResetProfilePrefs_ResponseParamsSpec.$ = {};
mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_ResetAllPrefs_ParamsSpec = mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_ResetAllPrefs_ParamsSpec || { $: {} };
if (mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_ResetAllPrefs_ParamsSpec.$.structSpec && mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_ResetAllPrefs_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_ResetAllPrefs_ParamsSpec.$ = {};
mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_ResetAllPrefs_ResponseParamsSpec = mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_ResetAllPrefs_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_ResetAllPrefs_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_ResetAllPrefs_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_ResetAllPrefs_ResponseParamsSpec.$ = {};
mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandlerFactory = mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandlerFactory || {};
mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandlerFactorySpec = mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandlerFactorySpec || { $ : {} };
if (mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandlerFactorySpec.$.structSpec && mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandlerFactorySpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandlerFactorySpec.$ = {};
mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandlerFactory.$interfaceName = 'omnibox_everywhere_debug.mojom.PageHandlerFactory';
mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandlerFactory_CreatePageHandler_ParamsSpec = mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandlerFactory_CreatePageHandler_ParamsSpec || { $: {} };
if (mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandlerFactory_CreatePageHandler_ParamsSpec.$.structSpec && mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandlerFactory_CreatePageHandler_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandlerFactory_CreatePageHandler_ParamsSpec.$ = {};

// Enum: InvocationSource
mojo.internal.bindings.omnibox_everywhere_debug.mojom.InvocationSource = {
  kGlobalHotkey: 0,
  kProfilePicker: 1,
};

// Interface: Page
mojo.internal.bindings.omnibox_everywhere_debug.mojom.PagePendingReceiver = class {
  constructor(handle) {
    this.handle = handle;
    if (handle) {
...
mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageRemote = class {
  static get $interfaceName() {
    return 'omnibox_everywhere_debug.mojom.Page';
  }

  constructor(handle = undefined) {
    this.__mojoHandle = handle;
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.omnibox_everywhere_debug.mojom.PagePendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageRemoteCallHandler(this.proxy);
  }
  ...
  onBackgroundModeChanged(arg_enabled) {
    return this.$.onBackgroundModeChanged(arg_enabled);
  }
  onHotkeyChanged(arg_enabled) {
    return this.$.onHotkeyChanged(arg_enabled);
  }
  onEphemeralModelChanged(arg_enabled) {
    return this.$.onEphemeralModelChanged(arg_enabled);
  }
  onLaunchOnStartupChanged(arg_enabled) {
    return this.$.onLaunchOnStartupChanged(arg_enabled);
  }
};

mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('omnibox_everywhere_debug.mojom.Page', [
      { explicit: null },
      { explicit: null },
      { explicit: null },
      { explicit: null },
  ...
  onHotkeyChanged(arg_enabled) {
    return this.proxy.sendMessage(
      ...
      mojo.internal.bindings.omnibox_everywhere_debug.mojom.Page_OnHotkeyChanged_ParamsSpec,
      null,
      [arg_enabled],
      false);
  }
...
mojo.internal.bindings.omnibox_everywhere_debug.mojom.Page.getRemote = function() {
  let remote = new mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
    'omnibox_everywhere_debug.mojom.Page',
    'context');
  return remote.$;
};

mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('omnibox_everywhere_debug.mojom.Page', [
      { explicit: null },
      { explicit: null },
      { explicit: null },
      { explicit: null },
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        case 0: {
          ...
          const params = decoder.decodeStructInline(mojo.internal.bindings.omnibox_everywhere_debug.mojom.Page_OnBackgroundModeChanged_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.onBackgroundModeChanged');
          const result = this.impl.onBackgroundModeChanged(params.arg_enabled);
          break;
        }
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.omnibox_everywhere_debug.mojom.Page_OnHotkeyChanged_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.onHotkeyChanged');
          const result = this.impl.onHotkeyChanged(params.arg_enabled);
          break;
        }
        case 2: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.omnibox_everywhere_debug.mojom.Page_OnEphemeralModelChanged_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.onEphemeralModelChanged');
          const result = this.impl.onEphemeralModelChanged(params.arg_enabled);
          break;
        }
        case 3: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.omnibox_everywhere_debug.mojom.Page_OnLaunchOnStartupChanged_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.onLaunchOnStartupChanged');
          const result = this.impl.onLaunchOnStartupChanged(params.arg_enabled);
          break;
        }
      }
      } catch (err) {
...
mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageReceiver = mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageReceiver;

mojo.internal.bindings.omnibox_everywhere_debug.mojom.PagePtr = mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageRemote;
mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageRequest = mojo.internal.bindings.omnibox_everywhere_debug.mojom.PagePendingReceiver;


// Interface: PageHandler
mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandlerPendingReceiver = class {
  constructor(handle) {
    this.handle = handle;
    if (handle) {
      this.__mojoHandle = handle.router_ ? handle.router_.pipe_ : (handle.pipe_ || handle);
...
mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandlerRemote = class {
  static get $interfaceName() {
    return 'omnibox_everywhere_debug.mojom.PageHandler';
  }

  constructor(handle = undefined) {
    this.__mojoHandle = handle;
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandlerPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandlerRemoteCallHandler(this.proxy);
  }
  ...
  setBackgroundModeEnabled(arg_enabled) {
    return this.$.setBackgroundModeEnabled(arg_enabled);
  }
  getBackgroundModeEnabled() {
    return this.$.getBackgroundModeEnabled();
  }
  setLaunchOnStartupEnabled(arg_enabled) {
    return this.$.setLaunchOnStartupEnabled(arg_enabled);
  }
  getLaunchOnStartupEnabled() {
    return this.$.getLaunchOnStartupEnabled();
  }
  setHotkeyEnabled(arg_enabled) {
    return this.$.setHotkeyEnabled(arg_enabled);
  }
  getHotkeyEnabled() {
    return this.$.getHotkeyEnabled();
  }
  setEphemeralModelEnabled(arg_enabled) {
    return this.$.setEphemeralModelEnabled(arg_enabled);
  }
  getEphemeralModelEnabled() {
    return this.$.getEphemeralModelEnabled();
  }
  invokeOmniboxEverywhere(arg_source) {
    return this.$.invokeOmniboxEverywhere(arg_source);
  }
  showLensIph() {
    return this.$.showLensIph();
  }
  createStartMenuShortcut() {
    return this.$.createStartMenuShortcut();
  }
  pinToTaskbar() {
    return this.$.pinToTaskbar();
  }
  resetProfilePrefs() {
    return this.$.resetProfilePrefs();
  }
  resetAllPrefs() {
    return this.$.resetAllPrefs();
  }
};

mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandlerRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('omnibox_everywhere_debug.mojom.PageHandler', [
      { explicit: null },
      { explicit: null },
      { explicit: null },
      { explicit: null },
...
mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler.getRemote = function() {
  let remote = new mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandlerRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
    'omnibox_everywhere_debug.mojom.PageHandler',
    'context');
  return remote.$;
};

mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandlerReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('omnibox_everywhere_debug.mojom.PageHandler', [
      { explicit: null },
      { explicit: null },
      { explicit: null },
      { explicit: null },
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_SetBackgroundModeEnabled_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.setBackgroundModeEnabled');
          const result = this.impl.setBackgroundModeEnabled(params.arg_enabled);
          break;
        }
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_GetBackgroundModeEnabled_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.getBackgroundModeEnabled');
          const result = this.impl.getBackgroundModeEnabled();
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const message = new mojo.internal.Message(
                ...
                header.ordinal, header.requestId, mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_GetBackgroundModeEnabled_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
            }).catch(e => console.error('[GeneratedReceiver] getBackgroundModeEnabled FAILED:', e));
          }
          break;
        }
        case 2: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_SetLaunchOnStartupEnabled_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.setLaunchOnStartupEnabled');
          const result = this.impl.setLaunchOnStartupEnabled(params.arg_enabled);
          break;
        }
        case 3: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_GetLaunchOnStartupEnabled_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.getLaunchOnStartupEnabled');
          const result = this.impl.getLaunchOnStartupEnabled();
          const expectsResponse = header.expectsResponse || (header.flags & 1);
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              const val = (response && typeof response === 'object' && 'arg_enabled' in response) ? response['arg_enabled'] : response;
              ...
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_GetLaunchOnStartupEnabled_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
            }).catch(e => console.error('[GeneratedReceiver] getLaunchOnStartupEnabled FAILED:', e));
          }
          break;
        }
        case 4: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_SetHotkeyEnabled_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.setHotkeyEnabled');
          const result = this.impl.setHotkeyEnabled(params.arg_enabled);
          break;
        }
        case 5: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_GetHotkeyEnabled_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.getHotkeyEnabled');
          const result = this.impl.getHotkeyEnabled();
          const expectsResponse = header.expectsResponse || (header.flags & 1);
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              const val = (response && typeof response === 'object' && 'arg_enabled' in response) ? response['arg_enabled'] : response;
              ...
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_GetHotkeyEnabled_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
            }).catch(e => console.error('[GeneratedReceiver] getHotkeyEnabled FAILED:', e));
          }
          break;
        }
        case 6: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_SetEphemeralModelEnabled_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.setEphemeralModelEnabled');
          const result = this.impl.setEphemeralModelEnabled(params.arg_enabled);
          break;
        }
        case 7: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_GetEphemeralModelEnabled_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.getEphemeralModelEnabled');
          const result = this.impl.getEphemeralModelEnabled();
          const expectsResponse = header.expectsResponse || (header.flags & 1);
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              const val = (response && typeof response === 'object' && 'arg_enabled' in response) ? response['arg_enabled'] : response;
              ...
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_GetEphemeralModelEnabled_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
            }).catch(e => console.error('[GeneratedReceiver] getEphemeralModelEnabled FAILED:', e));
          }
          break;
        }
        case 8: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_InvokeOmniboxEverywhere_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.invokeOmniboxEverywhere');
          const result = this.impl.invokeOmniboxEverywhere(params.arg_source);
          break;
        }
        case 9: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_ShowLensIph_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.showLensIph');
          const result = this.impl.showLensIph();
          break;
        }
        case 10: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_CreateStartMenuShortcut_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.createStartMenuShortcut');
          const result = this.impl.createStartMenuShortcut();
          const expectsResponse = header.expectsResponse || (header.flags & 1);
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_CreateStartMenuShortcut_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
            }).catch(e => console.error('[GeneratedReceiver] createStartMenuShortcut FAILED:', e));
          }
          break;
        }
        case 11: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_PinToTaskbar_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.pinToTaskbar');
          const result = this.impl.pinToTaskbar();
          const expectsResponse = header.expectsResponse || (header.flags & 1);
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              const val = (response && typeof response === 'object' && 'arg_success' in response) ? response['arg_success'] : response;
              ...
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_PinToTaskbar_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
            }).catch(e => console.error('[GeneratedReceiver] pinToTaskbar FAILED:', e));
          }
          break;
        }
        case 12: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_ResetProfilePrefs_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.resetProfilePrefs');
          const result = this.impl.resetProfilePrefs();
          const expectsResponse = header.expectsResponse || (header.flags & 1);
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              const val = (response && typeof response === 'object' && 'arg_success' in response) ? response['arg_success'] : response;
              ...
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_ResetProfilePrefs_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
            }).catch(e => console.error('[GeneratedReceiver] resetProfilePrefs FAILED:', e));
          }
          break;
        }
        case 13: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_ResetAllPrefs_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.resetAllPrefs');
          const result = this.impl.resetAllPrefs();
          const expectsResponse = header.expectsResponse || (header.flags & 1);
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              const val = (response && typeof response === 'object' && 'arg_success' in response) ? response['arg_success'] : response;
              ...
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_ResetAllPrefs_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
            }).catch(e => console.error('[GeneratedReceiver] resetAllPrefs FAILED:', e));
          }
          break;
        }
      }
...
mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandlerReceiver = mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandlerReceiver;

mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandlerPtr = mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandlerRemote;
mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandlerRequest = mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandlerPendingReceiver;


// Interface: PageHandlerFactory
mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandlerFactoryPendingReceiver = class {
  constructor(handle) {
    this.handle = handle;
    if (handle) {
      this.__mojoHandle = handle.router_ ? handle.router_.pipe_ : (handle.pipe_ || handle);
...
mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandlerFactoryRemote = class {
  static get $interfaceName() {
    return 'omnibox_everywhere_debug.mojom.PageHandlerFactory';
  }

  constructor(handle = undefined) {
    this.__mojoHandle = handle;
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandlerFactoryPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandlerFactoryRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandlerFactoryRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('omnibox_everywhere_debug.mojom.PageHandlerFactory', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandlerFactory.getRemote = function() {
  let remote = new mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandlerFactoryRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
...
mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandlerFactoryReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('omnibox_everywhere_debug.mojom.PageHandlerFactory', [
      { explicit: null },
    ]);
    ordinals.forEach((ord, idx) => {
      this.ordinalMap.set(ord, idx); // Scrambled/Explicit
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandlerFactory_CreatePageHandler_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandlerFactoryReceiver = mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandlerFactoryReceiver;

mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandlerFactoryPtr = mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandlerFactoryRemote;
mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandlerFactoryRequest = mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandlerFactoryPendingReceiver;


// Specs (at the end to ensure classes are defined for InterfaceProxy)
mojo.internal.Struct(
    mojo.internal.bindings.omnibox_everywhere_debug.mojom.Page_OnBackgroundModeChanged_ParamsSpec, 'omnibox_everywhere_debug.mojom.Page_OnBackgroundModeChanged_Params', [
      mojo.internal.StructField('arg_enabled', 0, 0, mojo.internal.Bool, false, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.omnibox_everywhere_debug.mojom.Page_OnHotkeyChanged_ParamsSpec, 'omnibox_everywhere_debug.mojom.Page_OnHotkeyChanged_Params', [
      mojo.internal.StructField('arg_enabled', 0, 0, mojo.internal.Bool, false, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.omnibox_everywhere_debug.mojom.Page_OnEphemeralModelChanged_ParamsSpec, 'omnibox_everywhere_debug.mojom.Page_OnEphemeralModelChanged_Params', [
      mojo.internal.StructField('arg_enabled', 0, 0, mojo.internal.Bool, false, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.omnibox_everywhere_debug.mojom.Page_OnLaunchOnStartupChanged_ParamsSpec, 'omnibox_everywhere_debug.mojom.Page_OnLaunchOnStartupChanged_Params', [
      mojo.internal.StructField('arg_enabled', 0, 0, mojo.internal.Bool, false, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_SetBackgroundModeEnabled_ParamsSpec, 'omnibox_everywhere_debug.mojom.PageHandler_SetBackgroundModeEnabled_Params', [
      mojo.internal.StructField('arg_enabled', 0, 0, mojo.internal.Bool, false, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_GetBackgroundModeEnabled_ParamsSpec, 'omnibox_everywhere_debug.mojom.PageHandler_GetBackgroundModeEnabled_Params', [
    ],
    [[0, 8]]);

mojo.internal.Struct(
    mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_GetBackgroundModeEnabled_ResponseParamsSpec, 'omnibox_everywhere_debug.mojom.PageHandler_GetBackgroundModeEnabled_ResponseParams', [
      mojo.internal.StructField('arg_enabled', 0, 0, mojo.internal.Bool, false, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_SetLaunchOnStartupEnabled_ParamsSpec, 'omnibox_everywhere_debug.mojom.PageHandler_SetLaunchOnStartupEnabled_Params', [
      mojo.internal.StructField('arg_enabled', 0, 0, mojo.internal.Bool, false, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_GetLaunchOnStartupEnabled_ParamsSpec, 'omnibox_everywhere_debug.mojom.PageHandler_GetLaunchOnStartupEnabled_Params', [
    ],
    [[0, 8]]);

mojo.internal.Struct(
    mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_GetLaunchOnStartupEnabled_ResponseParamsSpec, 'omnibox_everywhere_debug.mojom.PageHandler_GetLaunchOnStartupEnabled_ResponseParams', [
      mojo.internal.StructField('arg_enabled', 0, 0, mojo.internal.Bool, false, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_SetHotkeyEnabled_ParamsSpec, 'omnibox_everywhere_debug.mojom.PageHandler_SetHotkeyEnabled_Params', [
      mojo.internal.StructField('arg_enabled', 0, 0, mojo.internal.Bool, false, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_GetHotkeyEnabled_ParamsSpec, 'omnibox_everywhere_debug.mojom.PageHandler_GetHotkeyEnabled_Params', [
    ],
    [[0, 8]]);

mojo.internal.Struct(
    mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_GetHotkeyEnabled_ResponseParamsSpec, 'omnibox_everywhere_debug.mojom.PageHandler_GetHotkeyEnabled_ResponseParams', [
      mojo.internal.StructField('arg_enabled', 0, 0, mojo.internal.Bool, false, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_SetEphemeralModelEnabled_ParamsSpec, 'omnibox_everywhere_debug.mojom.PageHandler_SetEphemeralModelEnabled_Params', [
      mojo.internal.StructField('arg_enabled', 0, 0, mojo.internal.Bool, false, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_GetEphemeralModelEnabled_ParamsSpec, 'omnibox_everywhere_debug.mojom.PageHandler_GetEphemeralModelEnabled_Params', [
    ],
    [[0, 8]]);

mojo.internal.Struct(
    mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_GetEphemeralModelEnabled_ResponseParamsSpec, 'omnibox_everywhere_debug.mojom.PageHandler_GetEphemeralModelEnabled_ResponseParams', [
      mojo.internal.StructField('arg_enabled', 0, 0, mojo.internal.Bool, false, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_InvokeOmniboxEverywhere_ParamsSpec, 'omnibox_everywhere_debug.mojom.PageHandler_InvokeOmniboxEverywhere_Params', [
      mojo.internal.StructField('arg_source', 0, 0, mojo.internal.bindings.omnibox_everywhere_debug.mojom.InvocationSourceSpec, null, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_ShowLensIph_ParamsSpec, 'omnibox_everywhere_debug.mojom.PageHandler_ShowLensIph_Params', [
    ],
    [[0, 8]]);

mojo.internal.Struct(
    mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_CreateStartMenuShortcut_ParamsSpec, 'omnibox_everywhere_debug.mojom.PageHandler_CreateStartMenuShortcut_Params', [
    ],
    [[0, 8]]);

mojo.internal.Struct(
    mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_CreateStartMenuShortcut_ResponseParamsSpec, 'omnibox_everywhere_debug.mojom.PageHandler_CreateStartMenuShortcut_ResponseParams', [
      mojo.internal.StructField('arg_success', 0, 0, mojo.internal.Bool, false, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_PinToTaskbar_ParamsSpec, 'omnibox_everywhere_debug.mojom.PageHandler_PinToTaskbar_Params', [
    ],
    [[0, 8]]);

mojo.internal.Struct(
    mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_PinToTaskbar_ResponseParamsSpec, 'omnibox_everywhere_debug.mojom.PageHandler_PinToTaskbar_ResponseParams', [
      mojo.internal.StructField('arg_success', 0, 0, mojo.internal.Bool, false, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_ResetProfilePrefs_ParamsSpec, 'omnibox_everywhere_debug.mojom.PageHandler_ResetProfilePrefs_Params', [
    ],
    [[0, 8]]);

mojo.internal.Struct(
    mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_ResetProfilePrefs_ResponseParamsSpec, 'omnibox_everywhere_debug.mojom.PageHandler_ResetProfilePrefs_ResponseParams', [
      mojo.internal.StructField('arg_success', 0, 0, mojo.internal.Bool, false, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_ResetAllPrefs_ParamsSpec, 'omnibox_everywhere_debug.mojom.PageHandler_ResetAllPrefs_Params', [
    ],
    [[0, 8]]);

mojo.internal.Struct(
    mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandler_ResetAllPrefs_ResponseParamsSpec, 'omnibox_everywhere_debug.mojom.PageHandler_ResetAllPrefs_ResponseParams', [
      mojo.internal.StructField('arg_success', 0, 0, mojo.internal.Bool, false, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandlerFactory_CreatePageHandler_ParamsSpec, 'omnibox_everywhere_debug.mojom.PageHandlerFactory_CreatePageHandler_Params', [
      mojo.internal.StructField('arg_page', 0, 0, mojo.internal.InterfaceProxy(mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageRemote), null, false, 0, undefined),
      mojo.internal.StructField('arg_handler', 8, 0, mojo.internal.InterfaceRequest(mojo.internal.bindings.omnibox_everywhere_debug.mojom.PageHandlerPendingReceiver), null, false, 0, undefined),
    ],
    [[0, 24]]);
