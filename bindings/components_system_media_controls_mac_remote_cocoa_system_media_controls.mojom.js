...
system_media_controls.mojom.SystemMediaControls_SetPlaybackStatus_ParamsSpec = {
  $: {
    structSpec: {
      ...
      packedSize: 16,
      fields: [
        { name: 'status', packedOffset: 0, packedBitOffset: 0, type: system_media_controls.mojom.PlaybackStatusSpec, nullable: false },
      ],
      versions: [{version: 0}]
    }
  }
...
system_media_controls.mojom.SystemMediaControls_SetArtist_ParamsSpec = {
  $: {
    structSpec: {
      ...
      packedSize: 16,
      fields: [
        { name: 'artist', packedOffset: 0, packedBitOffset: 0, type: mojo_base.mojom.String16Spec, nullable: false },
      ],
      versions: [{version: 0}]
    }
  }
...
system_media_controls.mojom.SystemMediaControls_SetAlbum_ParamsSpec = {
  $: {
    structSpec: {
      ...
      packedSize: 16,
      fields: [
        { name: 'album', packedOffset: 0, packedBitOffset: 0, type: mojo_base.mojom.String16Spec, nullable: false },
      ],
      versions: [{version: 0}]
    }
  }
...
system_media_controls.mojom.SystemMediaControls_SetThumbnail_ParamsSpec = {
  $: {
    structSpec: {
      ...
      packedSize: 16,
      fields: [
        { name: 'thumbnail', packedOffset: 0, packedBitOffset: 0, type: media_session.mojom.MediaImageBitmapSpec, nullable: false },
      ],
      versions: [{version: 0}]
    }
  }
...
system_media_controls.mojom.SystemMediaControls_SetPosition_ParamsSpec = {
  $: {
    structSpec: {
      ...
      packedSize: 16,
      fields: [
        { name: 'position', packedOffset: 0, packedBitOffset: 0, type: media_session.mojom.MediaPositionSpec, nullable: false },
      ],
      versions: [{version: 0}]
    }
  }
