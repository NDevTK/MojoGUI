...
mojo.internal.bindings.dom_distiller.mojom.DistillerJavaScriptServiceRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.dom_distiller.mojom.DistillerJavaScriptServicePendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.dom_distiller.mojom.DistillerJavaScriptServiceRemoteCallHandler(this.proxy);
  }
  ...
  handleStoreThemePref(arg_theme) {
    return this.$.handleStoreThemePref(arg_theme);
  }
  handleStoreFontFamilyPref(arg_font_family) {
    return this.$.handleStoreFontFamilyPref(arg_font_family);
  }
  handleStoreFontScalingPref(arg_font_scale) {
    return this.$.handleStoreFontScalingPref(arg_font_scale);
  }
};
...
mojo.internal.bindings.dom_distiller.mojom.DistillerJavaScriptService.getRemote = function() {
  let remote = new mojo.internal.bindings.dom_distiller.mojom.DistillerJavaScriptServiceRemote();
...
mojo.internal.bindings.dom_distiller.mojom.DistillerJavaScriptServiceReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.dom_distiller.mojom.DistillerJavaScriptService_HandleDistillerOpenSettingsCall_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for HandleDistillerOpenSettingsCall failed with TypeError');
           }
        }
        // Try Method 1: HandleStoreThemePref
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.dom_distiller.mojom.DistillerJavaScriptService_HandleStoreThemePref_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for HandleStoreThemePref failed with TypeError');
           }
        }
        // Try Method 2: HandleStoreFontFamilyPref
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.dom_distiller.mojom.DistillerJavaScriptService_HandleStoreFontFamilyPref_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for HandleStoreFontFamilyPref failed with TypeError');
           }
        }
        // Try Method 3: HandleStoreFontScalingPref
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.dom_distiller.mojom.DistillerJavaScriptService_HandleStoreFontScalingPref_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for HandleStoreFontScalingPref failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.dom_distiller.mojom.DistillerJavaScriptService_HandleDistillerOpenSettingsCall_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.dom_distiller.mojom.DistillerJavaScriptServiceReceiver = mojo.internal.bindings.dom_distiller.mojom.DistillerJavaScriptServiceReceiver;
