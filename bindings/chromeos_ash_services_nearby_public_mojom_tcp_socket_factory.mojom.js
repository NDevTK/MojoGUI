...
mojo.internal.bindings.sharing.mojom.TcpSocketFactory = {};
mojo.internal.bindings.sharing.mojom.TcpSocketFactorySpec = { $ : {} };
mojo.internal.bindings.sharing.mojom.TcpSocketFactory.$interfaceName = 'sharing.mojom.TcpSocketFactory';
...
mojo.internal.Struct(
    mojo.internal.bindings.sharing.mojom.TcpSocketFactory_CreateTCPServerSocket_ParamsSpec, 'sharing.mojom.TcpSocketFactory_CreateTCPServerSocket_Params', [
      ...
      mojo.internal.StructField('arg_backlog', 32, 0, mojo.internal.Uint32, 0, false, 0, undefined),
    ],
    [[0, 48]]);

mojo.internal.Struct(
    mojo.internal.bindings.sharing.mojom.TcpSocketFactory_CreateTCPServerSocket_ResponseParamsSpec, 'sharing.mojom.TcpSocketFactory_CreateTCPServerSocket_ResponseParams', [
...
mojo.internal.Struct(
    mojo.internal.bindings.sharing.mojom.TcpSocketFactory_CreateTCPConnectedSocket_ParamsSpec, 'sharing.mojom.TcpSocketFactory_CreateTCPConnectedSocket_Params', [
...
mojo.internal.bindings.sharing.mojom.TcpSocketFactoryPendingReceiver = class {
  constructor(handle) {
    this.handle = handle;
  }
};
...
mojo.internal.bindings.sharing.mojom.TcpSocketFactoryRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.sharing.mojom.TcpSocketFactoryRemoteCallHandler(this.proxy);
  }
  ...
  createTCPServerSocket(arg_local_addr, arg_port, arg_backlog, arg_traffic_annotation, arg_socket) {
    return this.$.createTCPServerSocket(arg_local_addr, arg_port, arg_backlog, arg_traffic_annotation, arg_socket);
  }
  createTCPConnectedSocket(arg_timeout, arg_local_addr, arg_remote_addr_list, arg_tcp_connected_socket_options, arg_traffic_annotation, arg_socket, arg_observer) {
    return this.$.createTCPConnectedSocket(arg_timeout, arg_local_addr, arg_remote_addr_list, arg_tcp_connected_socket_options, arg_traffic_annotation, arg_socket, arg_observer);
  }
};

mojo.internal.bindings.sharing.mojom.TcpSocketFactoryRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('sharing.mojom.TcpSocketFactory', [
      { explicit: null },
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.sharing.mojom.TcpSocketFactory.getRemote = function() {
  let remote = new mojo.internal.bindings.sharing.mojom.TcpSocketFactoryRemote();
...
mojo.internal.bindings.sharing.mojom.TcpSocketFactoryReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('sharing.mojom.TcpSocketFactory', [
      { explicit: null },
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.sharing.mojom.TcpSocketFactory_CreateTCPServerSocket_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for CreateTCPServerSocket failed with TypeError');
           }
        }
        // Try Method 1: CreateTCPConnectedSocket
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.sharing.mojom.TcpSocketFactory_CreateTCPConnectedSocket_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for CreateTCPConnectedSocket failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.sharing.mojom.TcpSocketFactoryReceiver = mojo.internal.bindings.sharing.mojom.TcpSocketFactoryReceiver;

mojo.internal.bindings.sharing.mojom.TcpSocketFactoryPtr = mojo.internal.bindings.sharing.mojom.TcpSocketFactoryRemote;
mojo.internal.bindings.sharing.mojom.TcpSocketFactoryRequest = mojo.internal.bindings.sharing.mojom.TcpSocketFactoryPendingReceiver;
