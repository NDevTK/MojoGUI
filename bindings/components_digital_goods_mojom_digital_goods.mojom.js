  ...
  $: {
    structSpec: {
      ...
      fields: [
        ...
        { name: 'price', packedOffset: 24, packedBitOffset: 0, type: mojo.internal.Pointer, nullable: false },
        ...
        { name: 'introductory_price', packedOffset: 48, packedBitOffset: 0, type: mojo.internal.Pointer, nullable: true },
