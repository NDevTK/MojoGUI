          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const message = new mojo.internal.Message(
                ...
                header.ordinal, header.requestId, mojo.internal.bindings.extensions.mojom.Renderer_SuspendExtension_ResponseParamsSpec.$.structSpec, resp_obj);
        ...
        case 15: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.extensions.mojom.Renderer_ShouldSuspend_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
        ...
        case 16: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.extensions.mojom.Renderer_TransferBlobs_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
...
mojo.internal.Struct(
    mojo.internal.bindings.extensions.mojom.ExtensionLoadedParamsSpec, 'extensions.mojom.ExtensionLoadedParams', [
      ...
      mojo.internal.StructField('arg_uses_default_policy_blocked_allowed_hosts', 12, 0, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_user_scripts_allowed', 12, 1, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_is_mojo_js_enabled_for_service_worker', 12, 2, mojo.internal.Bool, false, false, 0, undefined),
      ...
      mojo.internal.StructField('arg_creation_flags', 80, 0, mojo.internal.Int32, 0, false, 0, undefined),
      mojo.internal.StructField('arg_guid', 88, 0, mojo.internal.String, null, false, 0, undefined),
    ],
    [[0, 104]]);
