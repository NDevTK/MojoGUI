...
cros.mojom.mojom.GRALLOC_USAGE_SW_READ_NEVER = 0x00000000;

cros.mojom.mojom.GRALLOC_USAGE_SW_READ_OFTEN = 0x00000003;

cros.mojom.mojom.GRALLOC_USAGE_SW_WRITE_NEVER = 0x00000000;

cros.mojom.mojom.GRALLOC_USAGE_SW_WRITE_OFTEN = 0x00000030;

cros.mojom.mojom.GRALLOC_USAGE_HW_COMPOSER = 0x00000800;

cros.mojom.mojom.GRALLOC_USAGE_HW_VIDEO_ENCODER = 0x00010000;

cros.mojom.mojom.GRALLOC_USAGE_HW_CAMERA_WRITE = 0x00020000;

cros.mojom.mojom.GRALLOC_USAGE_HW_CAMERA_READ = 0x00040000;

cros.mojom.mojom.GRALLOC_USAGE_FORCE_I420 = 0x10000000;

cros.mojom.mojom.GRALLOC_USAGE_STILL_CAPTURE = 0x20000000;

cros.mojom.mojom.NO_BUFFER_BUFFER_ID = 0xFFFFFFFFFFFFFFFF;

// Enum: HalPixelFormat
cros.mojom.mojom.HalPixelFormat = {
...
cros.mojom.mojom.HalPixelFormatSpec = { $: mojo.internal.Enum() };

// Enum: Camera3StreamType
cros.mojom.mojom.Camera3StreamType = {
  CAMERA3_STREAM_OUTPUT: 0,
  CAMERA3_STREAM_INPUT: 1,
  CAMERA3_STREAM_BIDIRECTIONAL: 2,
};
cros.mojom.mojom.Camera3StreamTypeSpec = { $: mojo.internal.Enum() };

// Enum: Camera3StreamRotation
cros.mojom.mojom.Camera3StreamRotation = {
  CAMERA3_STREAM_ROTATION_0: 0,
  CAMERA3_STREAM_ROTATION_90: 1,
  CAMERA3_STREAM_ROTATION_180: 2,
  CAMERA3_STREAM_ROTATION_270: 3,
};
cros.mojom.mojom.Camera3StreamRotationSpec = { $: mojo.internal.Enum() };

// Enum: Camera3StreamConfigurationMode
cros.mojom.mojom.Camera3StreamConfigurationMode = {
  CAMERA3_STREAM_CONFIGURATION_NORMAL_MODE: 0,
  CAMERA3_STREAM_CONFIGURATION_CONSTRAINED_HIGH_SPEED_MODE: 1,
};
cros.mojom.mojom.Camera3StreamConfigurationModeSpec = { $: mojo.internal.Enum() };

// Enum: Camera3BufferStatus
cros.mojom.mojom.Camera3BufferStatus = {
  CAMERA3_BUFFER_STATUS_OK: 0,
  CAMERA3_BUFFER_STATUS_ERROR: 1,
};
cros.mojom.mojom.Camera3BufferStatusSpec = { $: mojo.internal.Enum() };

// Enum: Camera3MsgType
cros.mojom.mojom.Camera3MsgType = {
  CAMERA3_MSG_ERROR: 0,
  CAMERA3_MSG_SHUTTER: 1,
};
cros.mojom.mojom.Camera3MsgTypeSpec = { $: mojo.internal.Enum() };

// Enum: Camera3ErrorMsgCode
cros.mojom.mojom.Camera3ErrorMsgCode = {
  CAMERA3_MSG_ERROR_DEVICE: 0,
  CAMERA3_MSG_ERROR_REQUEST: 1,
  CAMERA3_MSG_ERROR_RESULT: 2,
  CAMERA3_MSG_ERROR_BUFFER: 3,
};
cros.mojom.mojom.Camera3ErrorMsgCodeSpec = { $: mojo.internal.Enum() };

// Enum: Camera3BufferRequestStatus
cros.mojom.mojom.Camera3BufferRequestStatus = {
...
cros.mojom.mojom.Camera3BufferRequestStatusSpec = { $: mojo.internal.Enum() };

// Enum: Camera3StreamBufferReqStatus
cros.mojom.mojom.Camera3StreamBufferReqStatus = {
...
cros.mojom.mojom.Camera3StreamBufferReqStatusSpec = { $: mojo.internal.Enum() };

// Enum: Camera3RequestTemplate
cros.mojom.mojom.Camera3RequestTemplate = {
...
cros.mojom.mojom.Camera3RequestTemplateSpec = { $: mojo.internal.Enum() };

// Enum: BufferType
cros.mojom.mojom.BufferType = {
  DMABUF: 0,
  SHM: 1,
};
cros.mojom.mojom.BufferTypeSpec = { $: mojo.internal.Enum() };

// Union: Camera3NotifyMsgMessage
cros.mojom.mojom.Camera3NotifyMsgMessageSpec = { $: mojo.internal.Union(
...
cros.mojom.mojom.CropRotateScaleInfoSpec = {
  $: {
    structSpec: {
...
cros.mojom.mojom.Camera3StreamSpec = {
  $: {
    structSpec: {
      ...
      fields: [
        ...
        { name: 'stream_type', packedOffset: 32, packedBitOffset: 0, type: cros.mojom.Camera3StreamTypeSpec, nullable: false, minVersion: 0 },
        { name: 'width', packedOffset: 36, packedBitOffset: 0, type: mojo.internal.Uint32, nullable: false, minVersion: 0 },
        { name: 'height', packedOffset: 40, packedBitOffset: 0, type: mojo.internal.Uint32, nullable: false, minVersion: 0 },
        { name: 'format', packedOffset: 44, packedBitOffset: 0, type: cros.mojom.HalPixelFormatSpec, nullable: false, minVersion: 0 },
        { name: 'usage', packedOffset: 48, packedBitOffset: 0, type: mojo.internal.Uint32, nullable: false, minVersion: 0 },
        { name: 'max_buffers', packedOffset: 52, packedBitOffset: 0, type: mojo.internal.Uint32, nullable: false, minVersion: 0 },
        { name: 'data_space', packedOffset: 56, packedBitOffset: 0, type: mojo.internal.Uint32, nullable: false, minVersion: 0 },
        { name: 'rotation', packedOffset: 60, packedBitOffset: 0, type: cros.mojom.Camera3StreamRotationSpec, nullable: false, minVersion: 0 },
        { name: 'crop_rotate_scale_info', packedOffset: 8, packedBitOffset: 0, type: cros.mojom.CropRotateScaleInfoSpec, nullable: true, minVersion: 1 },
        { name: 'physical_camera_id', packedOffset: 16, packedBitOffset: 0, type: mojo.internal.String, nullable: true, minVersion: 4 },
        { name: 'effects', packedOffset: 24, packedBitOffset: 0, type: mojo.internal.Array(cros.mojom.Camera3StreamEffectSpec, false), nullable: true, minVersion: 6 },
      ],
      versions: [{version: 0, packedSize: 72}, {version: 1, packedSize: 72}, {version: 4, packedSize: 72}, {version: 6, packedSize: 72}]
    }
  }
};

// Struct: Camera3StreamConfiguration
cros.mojom.mojom.Camera3StreamConfigurationSpec = {
  $: {
    structSpec: {
      ...
      fields: [
        ...
        { name: 'operation_mode', packedOffset: 16, packedBitOffset: 0, type: cros.mojom.Camera3StreamConfigurationModeSpec, nullable: false, minVersion: 0 },
        { name: 'session_parameters', packedOffset: 8, packedBitOffset: 0, type: cros.mojom.CameraMetadataSpec, nullable: true, minVersion: 4 },
      ],
...
cros.mojom.mojom.CameraBufferHandleSpec = {
  $: {
    structSpec: {
      ...
      fields: [
        ...
        { name: 'drm_format', packedOffset: 48, packedBitOffset: 0, type: mojo.internal.Uint32, nullable: false, minVersion: 0 },
        { name: 'hal_pixel_format', packedOffset: 52, packedBitOffset: 0, type: cros.mojom.HalPixelFormatSpec, nullable: false, minVersion: 0 },
        { name: 'width', packedOffset: 56, packedBitOffset: 0, type: mojo.internal.Uint32, nullable: false, minVersion: 0 },
        { name: 'height', packedOffset: 60, packedBitOffset: 0, type: mojo.internal.Uint32, nullable: false, minVersion: 0 },
        ...
        { name: 'sizes', packedOffset: 32, packedBitOffset: 0, type: mojo.internal.Array(mojo.internal.Uint32, false), nullable: true, minVersion: 3 },
        { name: 'has_modifier', packedOffset: 64, packedBitOffset: 0, type: mojo.internal.Bool, nullable: false, minVersion: 7 },
        { name: 'modifier', packedOffset: 40, packedBitOffset: 0, type: mojo.internal.Uint64, nullable: false, minVersion: 7 },
      ],
      versions: [{version: 0, packedSize: 72}, {version: 3, packedSize: 72}, {version: 7, packedSize: 80}]
    }
  }
};

// Struct: Camera3StreamBuffer
cros.mojom.mojom.Camera3StreamBufferSpec = {
  $: {
    structSpec: {
      ...
      fields: [
        ...
        { name: 'status', packedOffset: 24, packedBitOffset: 0, type: cros.mojom.Camera3BufferStatusSpec, nullable: false, minVersion: 0 },
        { name: 'acquire_fence', packedOffset: 28, packedBitOffset: 0, type: mojo.internal.Handle, nullable: true, minVersion: 0 },
        { name: 'release_fence', packedOffset: 32, packedBitOffset: 0, type: mojo.internal.Handle, nullable: true, minVersion: 0 },
        { name: 'buffer_handle', packedOffset: 16, packedBitOffset: 0, type: cros.mojom.CameraBufferHandleSpec, nullable: true, minVersion: 2 },
      ],
      versions: [{version: 0, packedSize: 48}, {version: 2, packedSize: 48}]
    }
  }
};

// Struct: Camera3ErrorMsg
cros.mojom.mojom.Camera3ErrorMsgSpec = {
  $: {
    structSpec: {
...
cros.mojom.mojom.Camera3ShutterMsgSpec = {
  $: {
    structSpec: {
...
cros.mojom.mojom.Camera3NotifyMsgSpec = {
  $: {
    structSpec: {
...
cros.mojom.mojom.Camera3BufferRequestSpec = {
  $: {
    structSpec: {
...
cros.mojom.mojom.Camera3StreamBufferRetSpec = {
  $: {
    structSpec: {
...
cros.mojom.mojom.Camera3PhyscamMetadataSpec = {
  $: {
    structSpec: {
...
cros.mojom.mojom.Camera3CaptureRequestSpec = {
  $: {
    structSpec: {
      name: 'cros.mojom.Camera3CaptureRequest',
      packedSize: 48,
      fields: [
        { name: 'frame_number', packedOffset: 32, packedBitOffset: 0, type: mojo.internal.Uint32, nullable: false, minVersion: 0 },
        ...
        { name: 'physcam_settings', packedOffset: 24, packedBitOffset: 0, type: mojo.internal.Array(cros.mojom.Camera3PhyscamMetadataSpec, false), nullable: true, minVersion: 4 },
      ],
      versions: [{version: 0, packedSize: 48}, {version: 4, packedSize: 48}]
    }
  }
};

// Struct: Camera3CaptureResult
cros.mojom.mojom.Camera3CaptureResultSpec = {
  $: {
    structSpec: {
      ...
      fields: [
        ...
        { name: 'partial_result', packedOffset: 36, packedBitOffset: 0, type: mojo.internal.Uint32, nullable: false, minVersion: 0 },
        { name: 'physcam_metadata', packedOffset: 24, packedBitOffset: 0, type: mojo.internal.Array(cros.mojom.Camera3PhyscamMetadataSpec, false), nullable: true, minVersion: 4 },
      ],
      versions: [{version: 0, packedSize: 48}, {version: 4, packedSize: 48}]
    }
  }
...
cros.mojom.mojom.Camera3CallbackOps = {};

cros.mojom.mojom.Camera3CallbackOpsPendingReceiver = class {
  constructor(handle) {
    this.handle = handle;
  }
};

cros.mojom.mojom.Camera3CallbackOpsRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      cros.mojom.mojom.Camera3CallbackOpsPendingReceiver,
      handle);
    this.$ = new cros.mojom.mojom.Camera3CallbackOpsRemoteCallHandler(this.proxy);
  }
...
cros.mojom.mojom.Camera3CallbackOpsRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
  }
  ...
  processCaptureResult(result) {
    ...
    return this.proxy.sendMessage(
      0,  // ordinal
      cros.mojom.mojom.Camera3CallbackOps_ProcessCaptureResult_ParamsSpec,
      null,
      [result]);
  }
  ...
  notify(msg) {
    ...
    return this.proxy.sendMessage(
      1,  // ordinal
      cros.mojom.mojom.Camera3CallbackOps_Notify_ParamsSpec,
      null,
      [msg]);
  }
  ...
  requestStreamBuffers(buffer_reqs) {
    ...
    return this.proxy.sendMessage(
      2,  // ordinal
      cros.mojom.mojom.Camera3CallbackOps_RequestStreamBuffers_ParamsSpec,
      cros.mojom.mojom.Camera3CallbackOps_RequestStreamBuffers_ResponseParamsSpec,
      [buffer_reqs]);
  }
  ...
  returnStreamBuffers(buffers) {
    ...
    return this.proxy.sendMessage(
      3,  // ordinal
      cros.mojom.mojom.Camera3CallbackOps_ReturnStreamBuffers_ParamsSpec,
      null,
      [buffers]);
  }
...
cros.mojom.mojom.Camera3CallbackOps.getRemote = function() {
  let remote = new cros.mojom.mojom.Camera3CallbackOpsRemote();
...
cros.mojom.mojom.Camera3CallbackOpsPtr = cros.mojom.mojom.Camera3CallbackOpsRemote;
cros.mojom.mojom.Camera3CallbackOpsRequest = cros.mojom.mojom.Camera3CallbackOpsPendingReceiver;


// Interface: Camera3DeviceOps
cros.mojom.mojom.Camera3DeviceOps = {};

cros.mojom.mojom.Camera3DeviceOpsPendingReceiver = class {
  constructor(handle) {
    this.handle = handle;
  }
};

cros.mojom.mojom.Camera3DeviceOpsRemote = class {
  static get $interfaceName() {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      cros.mojom.mojom.Camera3DeviceOpsPendingReceiver,
      handle);
    this.$ = new cros.mojom.mojom.Camera3DeviceOpsRemoteCallHandler(this.proxy);
  }
...
cros.mojom.mojom.Camera3DeviceOpsRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
  }
  ...
  initialize(callback_ops) {
    ...
    return this.proxy.sendMessage(
      0,  // ordinal
      cros.mojom.mojom.Camera3DeviceOps_Initialize_ParamsSpec,
      cros.mojom.mojom.Camera3DeviceOps_Initialize_ResponseParamsSpec,
      [callback_ops]);
  }
  ...
  configureStreams(config) {
    ...
    return this.proxy.sendMessage(
      1,  // ordinal
      cros.mojom.mojom.Camera3DeviceOps_ConfigureStreams_ParamsSpec,
      cros.mojom.mojom.Camera3DeviceOps_ConfigureStreams_ResponseParamsSpec,
      [config]);
  }
  ...
  constructDefaultRequestSettings(type) {
    ...
    return this.proxy.sendMessage(
      2,  // ordinal
      cros.mojom.mojom.Camera3DeviceOps_ConstructDefaultRequestSettings_ParamsSpec,
      cros.mojom.mojom.Camera3DeviceOps_ConstructDefaultRequestSettings_ResponseParamsSpec,
      [type]);
  }
  ...
  processCaptureRequest(request) {
    ...
    return this.proxy.sendMessage(
      3,  // ordinal
      cros.mojom.mojom.Camera3DeviceOps_ProcessCaptureRequest_ParamsSpec,
      cros.mojom.mojom.Camera3DeviceOps_ProcessCaptureRequest_ResponseParamsSpec,
      [request]);
  }
  ...
  dump(fd) {
    ...
    return this.proxy.sendMessage(
      4,  // ordinal
      cros.mojom.mojom.Camera3DeviceOps_Dump_ParamsSpec,
      null,
      [fd]);
  }
  ...
  flush() {
    ...
    return this.proxy.sendMessage(
      5,  // ordinal
      cros.mojom.mojom.Camera3DeviceOps_Flush_ParamsSpec,
      cros.mojom.mojom.Camera3DeviceOps_Flush_ResponseParamsSpec,
      []);
  }
  ...
  registerBuffer(buffer_id, type, fds, drm_format, hal_pixel_format, width, height, strides, offsets) {
    ...
    return this.proxy.sendMessage(
      6,  // ordinal
      cros.mojom.mojom.Camera3DeviceOps_RegisterBuffer_ParamsSpec,
      cros.mojom.mojom.Camera3DeviceOps_RegisterBuffer_ResponseParamsSpec,
  ...
  close() {
    ...
    return this.proxy.sendMessage(
      7,  // ordinal
      cros.mojom.mojom.Camera3DeviceOps_Close_ParamsSpec,
      cros.mojom.mojom.Camera3DeviceOps_Close_ResponseParamsSpec,
      []);
  }
  ...
  configureStreamsAndGetAllocatedBuffers(config) {
    ...
    return this.proxy.sendMessage(
      8,  // ordinal
      cros.mojom.mojom.Camera3DeviceOps_ConfigureStreamsAndGetAllocatedBuffers_ParamsSpec,
      cros.mojom.mojom.Camera3DeviceOps_ConfigureStreamsAndGetAllocatedBuffers_ResponseParamsSpec,
      [config]);
  }
  ...
  signalStreamFlush(stream_ids) {
    ...
    return this.proxy.sendMessage(
      9,  // ordinal
      cros.mojom.mojom.Camera3DeviceOps_SignalStreamFlush_ParamsSpec,
      null,
      [stream_ids]);
  }
  ...
  onNewBuffer(buffer) {
    ...
    return this.proxy.sendMessage(
      10,  // ordinal
      cros.mojom.mojom.Camera3DeviceOps_OnNewBuffer_ParamsSpec,
      cros.mojom.mojom.Camera3DeviceOps_OnNewBuffer_ResponseParamsSpec,
      [buffer]);
  }
  ...
  onBufferRetired(buffer_id) {
    ...
    return this.proxy.sendMessage(
      11,  // ordinal
      cros.mojom.mojom.Camera3DeviceOps_OnBufferRetired_ParamsSpec,
      null,
      [buffer_id]);
  }
...
cros.mojom.mojom.Camera3DeviceOps.getRemote = function() {
  let remote = new cros.mojom.mojom.Camera3DeviceOpsRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
...
// Legacy compatibility
cros.mojom.mojom.Camera3DeviceOpsPtr = cros.mojom.mojom.Camera3DeviceOpsRemote;
cros.mojom.mojom.Camera3DeviceOpsRequest = cros.mojom.mojom.Camera3DeviceOpsPendingReceiver;
