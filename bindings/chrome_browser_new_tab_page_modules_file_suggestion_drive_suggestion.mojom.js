  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        try {
             decoder.decodeStruct(file_suggestion.mojom.DriveSuggestionHandler_GetFiles_ParamsSpec.$, message.header.headerSize);
        ...
        try {
             decoder.decodeStruct(file_suggestion.mojom.DriveSuggestionHandler_DismissModule_ParamsSpec.$, message.header.headerSize);
        ...
        try {
             decoder.decodeStruct(file_suggestion.mojom.DriveSuggestionHandler_RestoreModule_ParamsSpec.$, message.header.headerSize);
      ...
      switch (dispatchId) {
        case 2: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStruct(file_suggestion.mojom.DriveSuggestionHandler_GetFiles_ParamsSpec.$, message.header.headerSize);
        ...
        case 2: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStruct(file_suggestion.mojom.DriveSuggestionHandler_DismissModule_ParamsSpec.$, message.header.headerSize);
        ...
        case 2: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStruct(file_suggestion.mojom.DriveSuggestionHandler_RestoreModule_ParamsSpec.$, message.header.headerSize);
