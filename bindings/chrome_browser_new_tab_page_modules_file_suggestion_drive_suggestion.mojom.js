...
mojo.internal.bindings.file_suggestion.mojom.DriveSuggestionHandler = {};
mojo.internal.bindings.file_suggestion.mojom.DriveSuggestionHandlerSpec = { $ : {} };
mojo.internal.bindings.file_suggestion.mojom.DriveSuggestionHandler.$interfaceName = 'file_suggestion.mojom.DriveSuggestionHandler';
...
mojo.internal.bindings.file_suggestion.mojom.DriveSuggestionHandlerRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.file_suggestion.mojom.DriveSuggestionHandlerPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.file_suggestion.mojom.DriveSuggestionHandlerRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.file_suggestion.mojom.DriveSuggestionHandlerRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('file_suggestion.mojom.DriveSuggestionHandler', [
      { explicit: null },
      { explicit: null },
      { explicit: null },
    ]);
...
mojo.internal.bindings.file_suggestion.mojom.DriveSuggestionHandler.getRemote = function() {
  let remote = new mojo.internal.bindings.file_suggestion.mojom.DriveSuggestionHandlerRemote();
...
mojo.internal.bindings.file_suggestion.mojom.DriveSuggestionHandlerReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('file_suggestion.mojom.DriveSuggestionHandler', [
      { explicit: null },
      { explicit: null },
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.file_suggestion.mojom.DriveSuggestionHandler_GetFiles_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for GetFiles failed with TypeError');
           }
        }
        // Try Method 1: DismissModule
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.file_suggestion.mojom.DriveSuggestionHandler_DismissModule_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.file_suggestion.mojom.DriveSuggestionHandler_RestoreModule_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.file_suggestion.mojom.DriveSuggestionHandler_GetFiles_ParamsSpec.$.structSpec);
        ...
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.file_suggestion.mojom.DriveSuggestionHandler_DismissModule_ParamsSpec.$.structSpec);
        ...
        case 2: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.file_suggestion.mojom.DriveSuggestionHandler_RestoreModule_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.file_suggestion.mojom.DriveSuggestionHandlerReceiver = mojo.internal.bindings.file_suggestion.mojom.DriveSuggestionHandlerReceiver;
