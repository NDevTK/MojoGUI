...
mojo.internal.bindings.blink.mojom.RendererPreferenceWatcherRemote = mojo.internal.bindings.blink.mojom.RendererPreferenceWatcherRemote || class {};
mojo.internal.bindings.blink.mojom.RendererPreferenceWatcherPendingReceiver = mojo.internal.bindings.blink.mojom.RendererPreferenceWatcherPendingReceiver || class { constructor(handle) { this.handle = handle; } };
mojo.internal.bindings.blink = mojo.internal.bindings.blink || {};
mojo.internal.bindings.blink.mojom = mojo.internal.bindings.blink.mojom || {};
...
mojo.internal.bindings.blink.mojom.ServiceWorkerRemote = mojo.internal.bindings.blink.mojom.ServiceWorkerRemote || class {};
mojo.internal.bindings.blink.mojom.ServiceWorkerPendingReceiver = mojo.internal.bindings.blink.mojom.ServiceWorkerPendingReceiver || class { constructor(handle) { this.handle = handle; } };
mojo.internal.bindings.blink = mojo.internal.bindings.blink || {};
mojo.internal.bindings.blink.mojom = mojo.internal.bindings.blink.mojom || {};
...
mojo.internal.bindings.blink.mojom.SubresourceLoaderUpdaterRemote = mojo.internal.bindings.blink.mojom.SubresourceLoaderUpdaterRemote || class {};
mojo.internal.bindings.blink.mojom.SubresourceLoaderUpdaterPendingReceiver = mojo.internal.bindings.blink.mojom.SubresourceLoaderUpdaterPendingReceiver || class { constructor(handle) { this.handle = handle; } };
mojo.internal.bindings.blink = mojo.internal.bindings.blink || {};
mojo.internal.bindings.blink.mojom = mojo.internal.bindings.blink.mojom || {};
...
mojo.internal.bindings.blink.mojom.WorkerContentSettingsProxyRemote = mojo.internal.bindings.blink.mojom.WorkerContentSettingsProxyRemote || class {};
mojo.internal.bindings.blink.mojom.WorkerContentSettingsProxyPendingReceiver = mojo.internal.bindings.blink.mojom.WorkerContentSettingsProxyPendingReceiver || class { constructor(handle) { this.handle = handle; } };
mojo.internal.bindings.blink = mojo.internal.bindings.blink || {};
mojo.internal.bindings.blink.mojom = mojo.internal.bindings.blink.mojom || {};
        ...
        case 0: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const resp_obj = { 'arg_will_be_terminated': val };
...
mojo.internal.Struct(
    mojo.internal.bindings.blink.mojom.EmbeddedWorkerStartParamsSpec, 'blink.mojom.EmbeddedWorkerStartParams', [
      ...
      mojo.internal.StructField('arg_service_worker_route_id', 28, 0, mojo.internal.Int32, 0, false, 0, undefined),
      ...
      mojo.internal.StructField('arg_cross_origin_isolated', 72, 2, mojo.internal.Bool, false, false, 0, undefined),
      ...
      mojo.internal.StructField('arg_interface_provider', 88, 0, mojo.internal.InterfaceRequest(mojo.internal.bindings.service_manager.mojom.InterfaceProviderPendingReceiver), null, false, 0, undefined),
      mojo.internal.StructField('arg_controller_receiver', 92, 0, mojo.internal.InterfaceRequest(mojo.internal.bindings.blink.mojom.ControllerServiceWorkerPendingReceiver), null, false, 0, undefined),
      mojo.internal.StructField('arg_installed_scripts_info', 96, 0, mojo.internal.bindings.blink.mojom.ServiceWorkerInstalledScriptsInfoSpec, null, true, 0, undefined),
      mojo.internal.StructField('arg_instance_host', 104, 0, mojo.internal.AssociatedInterfaceProxy(mojo.internal.bindings.blink.mojom.EmbeddedWorkerInstanceHostRemote), null, false, 0, undefined),
      mojo.internal.StructField('arg_provider_info', 112, 0, mojo.internal.bindings.blink.mojom.ServiceWorkerProviderInfoForStartWorkerSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_content_settings_proxy', 120, 0, mojo.internal.InterfaceProxy(mojo.internal.bindings.blink.mojom.WorkerContentSettingsProxyRemote), null, false, 0, undefined),
      mojo.internal.StructField('arg_preference_watcher_receiver', 128, 0, mojo.internal.InterfaceRequest(mojo.internal.bindings.blink.mojom.RendererPreferenceWatcherPendingReceiver), null, false, 0, undefined),
      mojo.internal.StructField('arg_subresource_loader_updater', 132, 0, mojo.internal.InterfaceRequest(mojo.internal.bindings.blink.mojom.SubresourceLoaderUpdaterPendingReceiver), null, false, 0, undefined),
      mojo.internal.StructField('arg_subresource_loader_factories', 136, 0, mojo.internal.bindings.blink.mojom.URLLoaderFactoryBundleSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_service_worker_token', 144, 0, mojo.internal.bindings.blink.mojom.ServiceWorkerTokenSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_ukm_source_id', 152, 0, mojo.internal.Int64, 0, false, 0, undefined),
      mojo.internal.StructField('arg_main_script_load_params', 160, 0, mojo.internal.bindings.blink.mojom.WorkerMainScriptLoadParamsSpec, null, true, 0, undefined),
      mojo.internal.StructField('arg_policy_container', 168, 0, mojo.internal.bindings.blink.mojom.PolicyContainerSpec, null, true, 0, undefined),
      mojo.internal.StructField('arg_storage_key', 176, 0, mojo.internal.bindings.blink.mojom.StorageKeySpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_cors_exempt_header_list', 184, 0, mojo.internal.Array(mojo.internal.String, false), null, false, 0, undefined),
      mojo.internal.StructField('arg_coep_reporting_observer', 192, 0, mojo.internal.InterfaceRequest(mojo.internal.bindings.blink.mojom.ReportingObserverPendingReceiver), null, true, 0, undefined),
      mojo.internal.StructField('arg_dip_reporting_observer', 196, 0, mojo.internal.InterfaceRequest(mojo.internal.bindings.blink.mojom.ReportingObserverPendingReceiver), null, true, 0, undefined),
    ],
    [[0, 208]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.blink.mojom.EmbeddedWorkerInstanceHost_OnStarted_ParamsSpec, 'blink.mojom.EmbeddedWorkerInstanceHost_OnStarted_Params', [
      ...
      mojo.internal.StructField('arg_fetch_handler_type', 4, 0, mojo.internal.bindings.blink.mojom.ServiceWorkerFetchHandlerTypeSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_has_hid_event_handlers', 8, 0, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_has_usb_event_handlers', 8, 1, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_thread_id', 12, 0, mojo.internal.Int32, 0, false, 0, undefined),
...
mojo.internal.Struct(
    mojo.internal.bindings.blink.mojom.EmbeddedWorkerInstanceHost_OnReportException_ParamsSpec, 'blink.mojom.EmbeddedWorkerInstanceHost_OnReportException_Params', [
      ...
      mojo.internal.StructField('arg_column_number', 12, 0, mojo.internal.Int32, 0, false, 0, undefined),
...
mojo.internal.Struct(
    mojo.internal.bindings.blink.mojom.EmbeddedWorkerInstanceHost_OnReportConsoleMessage_ParamsSpec, 'blink.mojom.EmbeddedWorkerInstanceHost_OnReportConsoleMessage_Params', [
      ...
      mojo.internal.StructField('arg_message_level', 4, 0, mojo.internal.bindings.blink.mojom.ConsoleMessageLevelSpec, null, false, 0, undefined),
