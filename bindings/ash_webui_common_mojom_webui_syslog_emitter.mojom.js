...
mojo.internal.bindings.ash.common.mojom.WebUiSyslogEmitter = {};
mojo.internal.bindings.ash.common.mojom.WebUiSyslogEmitterSpec = { $ : {} };
mojo.internal.bindings.ash.common.mojom.WebUiSyslogEmitter.$interfaceName = 'ash.common.mojom.WebUiSyslogEmitter';
...
mojo.internal.bindings.ash.common.mojom.WebUiSyslogEmitterRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.ash.common.mojom.WebUiSyslogEmitterPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.ash.common.mojom.WebUiSyslogEmitterRemoteCallHandler(this.proxy);
  }
  ...
  emitSyslog(arg_prefix, arg_message) {
    return this.$.emitSyslog(arg_prefix, arg_message);
  }
};

mojo.internal.bindings.ash.common.mojom.WebUiSyslogEmitterRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('ash.common.mojom.WebUiSyslogEmitter', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.ash.common.mojom.WebUiSyslogEmitter.getRemote = function() {
  let remote = new mojo.internal.bindings.ash.common.mojom.WebUiSyslogEmitterRemote();
...
mojo.internal.bindings.ash.common.mojom.WebUiSyslogEmitterReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('ash.common.mojom.WebUiSyslogEmitter', [
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ash.common.mojom.WebUiSyslogEmitter_EmitSyslog_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for EmitSyslog failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.ash.common.mojom.WebUiSyslogEmitterReceiver = mojo.internal.bindings.ash.common.mojom.WebUiSyslogEmitterReceiver;
