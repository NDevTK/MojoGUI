// Auto-generated MojoJS binding
 ...
 mojo.internal.bindings.on_load_script_injector = mojo.internal.bindings.on_load_script_injector || {};
mojo.internal.bindings.on_load_script_injector.mojom = mojo.internal.bindings.on_load_script_injector.mojom || {};
mojo.internal.bindings.mojo_base = mojo.internal.bindings.mojo_base || {};

mojo.internal.bindings.on_load_script_injector.mojom.OnLoadScriptInjector = {};
mojo.internal.bindings.on_load_script_injector.mojom.OnLoadScriptInjectorSpec = { $ : {} };
mojo.internal.bindings.on_load_script_injector.mojom.OnLoadScriptInjector.$interfaceName = 'on_load_script_injector.mojom.OnLoadScriptInjector';
...
mojo.internal.bindings.on_load_script_injector.mojom.OnLoadScriptInjectorRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.on_load_script_injector.mojom.OnLoadScriptInjectorPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.on_load_script_injector.mojom.OnLoadScriptInjectorRemoteCallHandler(this.proxy);
  }
  ...
  addOnLoadScript(arg_script) {
    return this.$.addOnLoadScript(arg_script);
  }
  clearOnLoadScripts() {
...
mojo.internal.bindings.on_load_script_injector.mojom.OnLoadScriptInjectorRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('on_load_script_injector.mojom.OnLoadScriptInjector', [
      { explicit: null },
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.on_load_script_injector.mojom.OnLoadScriptInjector.getRemote = function() {
  let remote = new mojo.internal.bindings.on_load_script_injector.mojom.OnLoadScriptInjectorRemote();
...
mojo.internal.bindings.on_load_script_injector.mojom.OnLoadScriptInjectorReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('on_load_script_injector.mojom.OnLoadScriptInjector', [
      { explicit: null },
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.on_load_script_injector.mojom.OnLoadScriptInjector_AddOnLoadScript_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for AddOnLoadScript failed with TypeError');
           }
        }
        // Try Method 1: ClearOnLoadScripts
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.on_load_script_injector.mojom.OnLoadScriptInjector_ClearOnLoadScripts_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for ClearOnLoadScripts failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
      ...
      switch (dispatchId) {
        ...
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.on_load_script_injector.mojom.OnLoadScriptInjector_ClearOnLoadScripts_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.on_load_script_injector.mojom.OnLoadScriptInjectorReceiver = mojo.internal.bindings.on_load_script_injector.mojom.OnLoadScriptInjectorReceiver;
