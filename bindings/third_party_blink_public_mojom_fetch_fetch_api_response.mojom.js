  ...
  $: {
    structSpec: {
      ...
      fields: [
        ...
        { name: 'response_time', packedOffset: 56, packedBitOffset: 0, type: mojo.internal.Pointer, nullable: false },
        ...
        { name: 'parsed_headers', packedOffset: 96, packedBitOffset: 0, type: mojo.internal.Pointer, nullable: true },
        { name: 'connection_info', packedOffset: 104, packedBitOffset: 0, type: mojo.internal.Pointer, nullable: false },
        { name: 'alpn_negotiated_protocol', packedOffset: 112, packedBitOffset: 0, type: mojo.internal.String, nullable: false },
        { name: 'auth_challenge_info', packedOffset: 120, packedBitOffset: 0, type: mojo.internal.Pointer, nullable: true },
