  ...
  $: {
    structSpec: {
      ...
      fields: [
        ...
        { name: 'blob', packedOffset: 48, packedBitOffset: 0, type: blink.mojom.SerializedBlobSpec, nullable: true },
        ...
        { name: 'side_data_blob', packedOffset: 80, packedBitOffset: 0, type: blink.mojom.SerializedBlobSpec, nullable: true },
        { name: 'side_data_blob_for_cache_put', packedOffset: 88, packedBitOffset: 0, type: blink.mojom.SerializedBlobSpec, nullable: true },
