...
mojo.internal.bindings.gfx.mojom.DelegatedInkPointRendererRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.gfx.mojom.DelegatedInkPointRendererPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.gfx.mojom.DelegatedInkPointRendererRemoteCallHandler(this.proxy);
  }
  ...
  storeDelegatedInkPoint(arg_point) {
    return this.$.storeDelegatedInkPoint(arg_point);
  }
  resetPrediction() {
...
mojo.internal.bindings.gfx.mojom.DelegatedInkPointRenderer.getRemote = function() {
  let remote = new mojo.internal.bindings.gfx.mojom.DelegatedInkPointRendererRemote();
...
mojo.internal.bindings.gfx.mojom.DelegatedInkPointRendererReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.gfx.mojom.DelegatedInkPointRenderer_StoreDelegatedInkPoint_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for StoreDelegatedInkPoint failed with TypeError');
           }
        }
        // Try Method 1: ResetPrediction
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.gfx.mojom.DelegatedInkPointRenderer_ResetPrediction_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for ResetPrediction failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
      ...
      switch (dispatchId) {
        ...
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.gfx.mojom.DelegatedInkPointRenderer_ResetPrediction_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.gfx.mojom.DelegatedInkPointRendererReceiver = mojo.internal.bindings.gfx.mojom.DelegatedInkPointRendererReceiver;
