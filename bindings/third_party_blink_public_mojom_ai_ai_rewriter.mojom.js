        ...
        case 1: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, blink.mojom.AIRewriter_MeasureUsage_ResponseParamsSpec, header, rawHeader);
               responder(response);
