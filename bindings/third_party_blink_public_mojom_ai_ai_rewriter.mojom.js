...
mojo.internal.bindings.blink.mojom.AIRewriterFormat = {
  kAsIs: 0,
  kPlainText: 1,
  kMarkdown: 2,
};
...
mojo.internal.bindings.blink.mojom.AIRewriterLength = {
  kAsIs: 0,
  kShorter: 1,
  kLonger: 2,
};
...
mojo.internal.Struct(
    mojo.internal.bindings.blink.mojom.AIRewriterCreateOptionsSpec, 'blink.mojom.AIRewriterCreateOptions', [
      ...
      mojo.internal.StructField('arg_tone', 32, 0, mojo.internal.bindings.blink.mojom.AIRewriterToneSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_format', 36, 0, mojo.internal.bindings.blink.mojom.AIRewriterFormatSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_length', 40, 0, mojo.internal.bindings.blink.mojom.AIRewriterLengthSpec, null, false, 0, undefined),
    ],
    [[0, 56]]);

// Interface: AIRewriter
mojo.internal.Struct(
    mojo.internal.bindings.blink.mojom.AIRewriter_Rewrite_ParamsSpec, 'blink.mojom.AIRewriter_Rewrite_Params', [
      mojo.internal.StructField('arg_input', 0, 0, mojo.internal.String, null, false, 0, undefined),
      mojo.internal.StructField('arg_context', 8, 0, mojo.internal.String, null, true, 0, undefined),
...
mojo.internal.Struct(
    mojo.internal.bindings.blink.mojom.AIRewriter_MeasureUsage_ParamsSpec, 'blink.mojom.AIRewriter_MeasureUsage_Params', [
      mojo.internal.StructField('arg_input', 0, 0, mojo.internal.String, null, false, 0, undefined),
...
mojo.internal.Struct(
    mojo.internal.bindings.blink.mojom.AIRewriter_MeasureUsage_ResponseParamsSpec, 'blink.mojom.AIRewriter_MeasureUsage_ResponseParams', [
...
mojo.internal.bindings.blink.mojom.AIRewriterPendingReceiver = class {
  constructor(handle) {
    this.handle = handle;
  }
};

mojo.internal.bindings.blink.mojom.AIRewriterRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.blink.mojom.AIRewriterPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.blink.mojom.AIRewriterRemoteCallHandler(this.proxy);
  }
  ...
  rewrite(arg_input, arg_context, arg_pending_responder) {
    return this.$.rewrite(arg_input, arg_context, arg_pending_responder);
  }
...
mojo.internal.bindings.blink.mojom.AIRewriter.getRemote = function() {
  let remote = new mojo.internal.bindings.blink.mojom.AIRewriterRemote();
...
mojo.internal.bindings.blink.mojom.AIRewriterReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.blink.mojom.AIRewriter_Rewrite_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for Rewrite failed with TypeError');
           }
        }
        // Try Method 1: MeasureUsage
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.blink.mojom.AIRewriter_MeasureUsage_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.blink.mojom.AIRewriter_Rewrite_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.rewrite');
          const result = this.impl.rewrite(params.arg_input, params.arg_context, params.arg_pending_responder);
          break;
        }
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.blink.mojom.AIRewriter_MeasureUsage_ParamsSpec.$.structSpec);
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              this.endpoint.send(header.ordinal, header.requestId, mojo.internal.kMessageFlagIsResponse, mojo.internal.bindings.blink.mojom.AIRewriter_MeasureUsage_ResponseParamsSpec, response);
...
mojo.internal.bindings.blink.mojom.AIRewriterReceiver = mojo.internal.bindings.blink.mojom.AIRewriterReceiver;

mojo.internal.bindings.blink.mojom.AIRewriterPtr = mojo.internal.bindings.blink.mojom.AIRewriterRemote;
mojo.internal.bindings.blink.mojom.AIRewriterRequest = mojo.internal.bindings.blink.mojom.AIRewriterPendingReceiver;
