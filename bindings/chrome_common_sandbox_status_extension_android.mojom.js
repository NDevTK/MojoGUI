...
mojo.internal.bindings.chrome.mojom.SandboxStatusExtension = {};
mojo.internal.bindings.chrome.mojom.SandboxStatusExtensionSpec = { $ : {} };
mojo.internal.bindings.chrome.mojom.SandboxStatusExtension.$interfaceName = 'chrome.mojom.SandboxStatusExtension';
...
mojo.internal.bindings.chrome.mojom.SandboxStatusExtensionRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.chrome.mojom.SandboxStatusExtensionPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.chrome.mojom.SandboxStatusExtensionRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.chrome.mojom.SandboxStatusExtensionRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('chrome.mojom.SandboxStatusExtension', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.chrome.mojom.SandboxStatusExtension.getRemote = function() {
  let remote = new mojo.internal.bindings.chrome.mojom.SandboxStatusExtensionRemote();
...
mojo.internal.bindings.chrome.mojom.SandboxStatusExtensionReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('chrome.mojom.SandboxStatusExtension', [
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.chrome.mojom.SandboxStatusExtension_AddSandboxStatusExtension_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for AddSandboxStatusExtension failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.chrome.mojom.SandboxStatusExtension_AddSandboxStatusExtension_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.chrome.mojom.SandboxStatusExtensionReceiver = mojo.internal.bindings.chrome.mojom.SandboxStatusExtensionReceiver;
