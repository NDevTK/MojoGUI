...
mojo.internal.bindings.chromecast.shell.mojom.ApplicationMediaCapabilitiesObserverRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.chromecast.shell.mojom.ApplicationMediaCapabilitiesObserverPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.chromecast.shell.mojom.ApplicationMediaCapabilitiesObserverRemoteCallHandler(this.proxy);
  }
  ...
  onSupportedBitstreamAudioCodecsChanged(arg_info) {
    return this.$.onSupportedBitstreamAudioCodecsChanged(arg_info);
  }
};
...
mojo.internal.bindings.chromecast.shell.mojom.ApplicationMediaCapabilitiesObserver.getRemote = function() {
  let remote = new mojo.internal.bindings.chromecast.shell.mojom.ApplicationMediaCapabilitiesObserverRemote();
...
mojo.internal.bindings.chromecast.shell.mojom.ApplicationMediaCapabilitiesObserverReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.chromecast.shell.mojom.ApplicationMediaCapabilitiesObserver_OnSupportedBitstreamAudioCodecsChanged_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OnSupportedBitstreamAudioCodecsChanged failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.chromecast.shell.mojom.ApplicationMediaCapabilitiesObserverReceiver = mojo.internal.bindings.chromecast.shell.mojom.ApplicationMediaCapabilitiesObserverReceiver;

mojo.internal.bindings.chromecast.shell.mojom.ApplicationMediaCapabilitiesObserverPtr = mojo.internal.bindings.chromecast.shell.mojom.ApplicationMediaCapabilitiesObserverRemote;
mojo.internal.bindings.chromecast.shell.mojom.ApplicationMediaCapabilitiesObserverRequest = mojo.internal.bindings.chromecast.shell.mojom.ApplicationMediaCapabilitiesObserverPendingReceiver;
...
mojo.internal.bindings.chromecast.shell.mojom.ApplicationMediaCapabilitiesRemote = class {
  static get $interfaceName() {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.chromecast.shell.mojom.ApplicationMediaCapabilitiesPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.chromecast.shell.mojom.ApplicationMediaCapabilitiesRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.chromecast.shell.mojom.ApplicationMediaCapabilities.getRemote = function() {
  let remote = new mojo.internal.bindings.chromecast.shell.mojom.ApplicationMediaCapabilitiesRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
...
mojo.internal.bindings.chromecast.shell.mojom.ApplicationMediaCapabilitiesReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.chromecast.shell.mojom.ApplicationMediaCapabilities_AddObserver_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
...
mojo.internal.bindings.chromecast.shell.mojom.ApplicationMediaCapabilitiesReceiver = mojo.internal.bindings.chromecast.shell.mojom.ApplicationMediaCapabilitiesReceiver;
