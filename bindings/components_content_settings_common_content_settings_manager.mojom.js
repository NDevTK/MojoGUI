...
mojo.internal.Struct(
    mojo.internal.bindings.content_settings.mojom.ContentSettingsManager_AllowStorageAccess_ParamsSpec, 'content_settings.mojom.ContentSettingsManager_AllowStorageAccess_Params', [
      ...
      mojo.internal.StructField('arg_storage_type', 32, 0, mojo.internal.bindings.content_settings.mojom.StorageTypeSpec, null, false, 0, undefined),
    ],
    [[0, 48]]);
...
mojo.internal.bindings.content_settings.mojom.ContentSettingsManagerRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.content_settings.mojom.ContentSettingsManagerRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.content_settings.mojom.ContentSettingsManager.getRemote = function() {
  let remote = new mojo.internal.bindings.content_settings.mojom.ContentSettingsManagerRemote();
...
mojo.internal.bindings.content_settings.mojom.ContentSettingsManagerReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.content_settings.mojom.ContentSettingsManager_Clone_ParamsSpec.$.structSpec;
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.content_settings.mojom.ContentSettingsManager_AllowStorageAccess_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for AllowStorageAccess failed with TypeError');
           }
        }
        // Try Method 2: OnContentBlocked
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.content_settings.mojom.ContentSettingsManager_OnContentBlocked_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OnContentBlocked failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.content_settings.mojom.ContentSettingsManagerReceiver = mojo.internal.bindings.content_settings.mojom.ContentSettingsManagerReceiver;
