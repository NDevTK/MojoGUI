...
mojo.internal.bindings.ash.mojom.sample_swa.UntrustedPageInterfacesFactory = {};
mojo.internal.bindings.ash.mojom.sample_swa.UntrustedPageInterfacesFactorySpec = { $ : {} };
...
mojo.internal.bindings.ash.mojom.sample_swa.UntrustedPageInterfacesFactoryRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.ash.mojom.sample_swa.UntrustedPageInterfacesFactoryPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.ash.mojom.sample_swa.UntrustedPageInterfacesFactoryRemoteCallHandler(this.proxy);
  }
  ...
  createParentPage(arg_child_page, arg_parent_page) {
    return this.$.createParentPage(arg_child_page, arg_parent_page);
  }
};

mojo.internal.bindings.ash.mojom.sample_swa.UntrustedPageInterfacesFactoryRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('ash.mojom.sample_swa.UntrustedPageInterfacesFactory', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.ash.mojom.sample_swa.UntrustedPageInterfacesFactory.getRemote = function() {
  let remote = new mojo.internal.bindings.ash.mojom.sample_swa.UntrustedPageInterfacesFactoryRemote();
...
mojo.internal.bindings.ash.mojom.sample_swa.UntrustedPageInterfacesFactoryReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('ash.mojom.sample_swa.UntrustedPageInterfacesFactory', [
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        // Try Method 0: CreateParentPage
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ash.mojom.sample_swa.UntrustedPageInterfacesFactory_CreateParentPage_ParamsSpec.$.structSpec;
             ...
             if (sizeMatch && (!!(header.flags & 1) === methodExpectsResp)) {
               if (size > 8 || message.payload.byteLength === 8) {
                 ...
                 console.log('[GeneratedReceiver] Discovery SUCCESS: ' + header.ordinal + ' -> CreateParentPage (0)');
                 this.mapOrdinal(header.ordinal, 0);
                 dispatchId = 0;
               }
             }
           } catch (e) {
             if (e instanceof TypeError) console.warn('[Discovery] trial for CreateParentPage failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.ash.mojom.sample_swa.UntrustedPageInterfacesFactoryReceiver = mojo.internal.bindings.ash.mojom.sample_swa.UntrustedPageInterfacesFactoryReceiver;
