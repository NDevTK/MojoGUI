...
mojo.internal.bindings.arc.mojom.OnDeviceSafetyHostRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.arc.mojom.OnDeviceSafetyHostRemoteCallHandler(this.proxy);
  }
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.arc.mojom.OnDeviceSafetyHost_IsCrosSafetyServiceEnabled_ParamsSpec.$.structSpec);
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.arc.mojom.OnDeviceSafetyHost_IsCrosSafetyServiceEnabled_ResponseParamsSpec, header, rawHeader);
               responder(response);
...
mojo.internal.bindings.arc.mojom.OnDeviceSafetyHostReceiver = mojo.internal.bindings.arc.mojom.OnDeviceSafetyHostReceiver;

mojo.internal.bindings.arc.mojom.OnDeviceSafetyHostPtr = mojo.internal.bindings.arc.mojom.OnDeviceSafetyHostRemote;
mojo.internal.bindings.arc.mojom.OnDeviceSafetyHostRequest = mojo.internal.bindings.arc.mojom.OnDeviceSafetyHostPendingReceiver;
...
mojo.internal.Struct(
    mojo.internal.bindings.arc.mojom.OnDeviceSafetyInstance_GetArcSafetySession_ResponseParamsSpec, 'arc.mojom.OnDeviceSafetyInstance_GetArcSafetySession_ResponseParams', [
      mojo.internal.StructField('arg_status', 0, 0, mojo.internal.bindings.mojo.internal.bindings.arc.mojom.GetArcSafetySessionResultSpec.$, null, false, 0, undefined),
    ],
    [[0, 16]]);
...
mojo.internal.bindings.arc.mojom.OnDeviceSafetyInstanceRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.arc.mojom.OnDeviceSafetyInstanceRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.arc.mojom.OnDeviceSafetyInstance.getRemote = function() {
  let remote = new mojo.internal.bindings.arc.mojom.OnDeviceSafetyInstanceRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
      ...
      switch (dispatchId) {
        case 0: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              const rawHeader = (args[2] && args[2].slice) ? args[2].slice(0, header.headerSize) : null;
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.arc.mojom.OnDeviceSafetyInstance_GetArcSafetySession_ResponseParamsSpec, header, rawHeader);
               responder(response);
        ...
        case 1: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              const rawHeader = (args[2] && args[2].slice) ? args[2].slice(0, header.headerSize) : null;
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.arc.mojom.OnDeviceSafetyInstance_Init_ResponseParamsSpec, header, rawHeader);
               responder(response);
...
mojo.internal.bindings.arc.mojom.OnDeviceSafetyInstanceReceiver = mojo.internal.bindings.arc.mojom.OnDeviceSafetyInstanceReceiver;
