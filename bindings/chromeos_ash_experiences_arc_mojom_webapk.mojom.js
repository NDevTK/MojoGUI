...
mojo.internal.Struct(
    mojo.internal.bindings.arc.mojom.WebApkInfoSpec, 'arc.mojom.WebApkInfo', [
      ...
      mojo.internal.StructField('arg_share_info', 64, 0, mojo.internal.bindings.mojo.internal.bindings.arc.mojom.WebShareTargetInfoSpec.$, null, true, 0, undefined),
    ],
    [[0, 80]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.arc.mojom.WebApkInstance_InstallWebApk_ResponseParamsSpec, 'arc.mojom.WebApkInstance_InstallWebApk_ResponseParams', [
      mojo.internal.StructField('arg_result', 0, 0, mojo.internal.bindings.mojo.internal.bindings.arc.mojom.WebApkInstallResultSpec.$, null, false, 0, undefined),
    ],
    [[0, 16]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.arc.mojom.WebApkInstance_GetWebApkInfo_ResponseParamsSpec, 'arc.mojom.WebApkInstance_GetWebApkInfo_ResponseParams', [
      mojo.internal.StructField('arg_result', 0, 0, mojo.internal.bindings.mojo.internal.bindings.arc.mojom.WebApkInfoSpec.$, null, true, 0, undefined),
    ],
    [[0, 16]]);
...
mojo.internal.bindings.arc.mojom.WebApkInstanceRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.arc.mojom.WebApkInstanceRemoteCallHandler(this.proxy);
  }
  ...
  installWebApk(arg_package_name, arg_version, arg_app_name, arg_token) {
    return this.$.installWebApk(arg_package_name, arg_version, arg_app_name, arg_token);
  }
  getWebApkInfo(arg_package_name) {
    return this.$.getWebApkInfo(arg_package_name);
  }
};

mojo.internal.bindings.arc.mojom.WebApkInstanceRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
...
mojo.internal.bindings.arc.mojom.WebApkInstance.getRemote = function() {
  let remote = new mojo.internal.bindings.arc.mojom.WebApkInstanceRemote();
...
mojo.internal.bindings.arc.mojom.WebApkInstanceReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.arc.mojom.WebApkInstance_InstallWebApk_ParamsSpec);
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.arc.mojom.WebApkInstance_GetWebApkInfo_ParamsSpec);
      ...
      switch (dispatchId) {
        case 0: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.arc.mojom.WebApkInstance_InstallWebApk_ResponseParamsSpec, header, rawHeader);
               responder(response);
        ...
        case 1: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              const rawHeader = (args[2] && args[2].slice) ? args[2].slice(0, header.headerSize) : null;
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.arc.mojom.WebApkInstance_GetWebApkInfo_ResponseParamsSpec, header, rawHeader);
               responder(response);
...
mojo.internal.bindings.arc.mojom.WebApkInstanceReceiver = mojo.internal.bindings.arc.mojom.WebApkInstanceReceiver;
