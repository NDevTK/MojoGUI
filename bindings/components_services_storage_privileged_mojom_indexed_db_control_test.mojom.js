...
mojo.internal.bindings.storage.mojom.IndexedDBControlTest_PerformAndVerifySqliteMigrationForTesting_ParamsSpec = mojo.internal.bindings.storage.mojom.IndexedDBControlTest_PerformAndVerifySqliteMigrationForTesting_ParamsSpec || { $: {} };
if (mojo.internal.bindings.storage.mojom.IndexedDBControlTest_PerformAndVerifySqliteMigrationForTesting_ParamsSpec.$.structSpec && mojo.internal.bindings.storage.mojom.IndexedDBControlTest_PerformAndVerifySqliteMigrationForTesting_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.storage.mojom.IndexedDBControlTest_PerformAndVerifySqliteMigrationForTesting_ParamsSpec.$ = {};
mojo.internal.bindings.storage.mojom.IndexedDBControlTest_PerformAndVerifySqliteMigrationForTesting_ResponseParamsSpec = mojo.internal.bindings.storage.mojom.IndexedDBControlTest_PerformAndVerifySqliteMigrationForTesting_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.storage.mojom.IndexedDBControlTest_PerformAndVerifySqliteMigrationForTesting_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.storage.mojom.IndexedDBControlTest_PerformAndVerifySqliteMigrationForTesting_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.storage.mojom.IndexedDBControlTest_PerformAndVerifySqliteMigrationForTesting_ResponseParamsSpec.$ = {};
...
mojo.internal.bindings.storage.mojom.IndexedDBControlTestRemote = class {
  ...
  performAndVerifySqliteMigrationForTesting(arg_bucket_locator) {
    return this.$.performAndVerifySqliteMigrationForTesting(arg_bucket_locator);
  }
  getUsageForTesting() {
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        ...
        case 6: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.storage.mojom.IndexedDBControlTest_PerformAndVerifySqliteMigrationForTesting_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.performAndVerifySqliteMigrationForTesting');
          const result = this.impl.performAndVerifySqliteMigrationForTesting(params.arg_bucket_locator);
          const expectsResponse = header.expectsResponse || (header.flags & 1);
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              const resp_obj = response;
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.storage.mojom.IndexedDBControlTest_PerformAndVerifySqliteMigrationForTesting_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
            }).catch(e => console.error('[GeneratedReceiver] performAndVerifySqliteMigrationForTesting FAILED:', e));
          }
          break;
        }
        case 7: {
...
mojo.internal.Struct(
    mojo.internal.bindings.storage.mojom.MockFailureInjector_FailOperation_ParamsSpec, 'storage.mojom.MockFailureInjector_FailOperation_Params', [
      ...
      mojo.internal.StructField('arg_failure_method', 4, 0, mojo.internal.bindings.storage.mojom.FailMethodSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_instance_num', 8, 0, mojo.internal.Int32, 0, false, 0, undefined),
      mojo.internal.StructField('arg_call_num', 12, 0, mojo.internal.Int32, 0, false, 0, undefined),
    ],
    [[0, 24]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.storage.mojom.IndexedDBControlTest_PerformAndVerifySqliteMigrationForTesting_ParamsSpec, 'storage.mojom.IndexedDBControlTest_PerformAndVerifySqliteMigrationForTesting_Params', [
      mojo.internal.StructField('arg_bucket_locator', 0, 0, mojo.internal.bindings.storage.mojom.BucketLocatorSpec, null, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.storage.mojom.IndexedDBControlTest_PerformAndVerifySqliteMigrationForTesting_ResponseParamsSpec, 'storage.mojom.IndexedDBControlTest_PerformAndVerifySqliteMigrationForTesting_ResponseParams', [
    ],
    [[0, 8]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.storage.mojom.IndexedDBControlTest_BindMockFailureSingletonForTesting_ParamsSpec, 'storage.mojom.IndexedDBControlTest_BindMockFailureSingletonForTesting_Params', [
      mojo.internal.StructField('arg_receiver', 0, 0, mojo.internal.InterfaceRequest(mojo.internal.bindings.storage.mojom.MockFailureInjectorPendingReceiver), null, false, 0, undefined),
    ],
    [[0, 16]]);
