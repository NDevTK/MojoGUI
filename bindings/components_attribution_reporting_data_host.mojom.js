...
attribution_reporting.mojom.DataHost_SourceDataAvailable_ParamsSpec = {
  $: {
    structSpec: {
      ...
      packedSize: 32,
      fields: [
        { name: 'reporting_origin', packedOffset: 0, packedBitOffset: 0, type: attribution_reporting.mojom.SuitableOriginSpec, nullable: false },
        { name: 'data', packedOffset: 8, packedBitOffset: 0, type: attribution_reporting.mojom.SourceRegistrationSpec, nullable: false },
...
attribution_reporting.mojom.DataHost_TriggerDataAvailable_ParamsSpec = {
  $: {
    structSpec: {
      ...
      fields: [
        { name: 'reporting_origin', packedOffset: 0, packedBitOffset: 0, type: attribution_reporting.mojom.SuitableOriginSpec, nullable: false },
        { name: 'data', packedOffset: 8, packedBitOffset: 0, type: attribution_reporting.mojom.TriggerRegistrationSpec, nullable: false },
        { name: 'was_fetched_via_service_worker', packedOffset: 16, packedBitOffset: 0, type: mojo.internal.Bool, nullable: false },
      ],
      versions: [{version: 0}]
    }
...
attribution_reporting.mojom.DataHost_OsSourceDataAvailable_ParamsSpec = {
  $: {
    structSpec: {
      ...
      packedSize: 24,
      fields: [
        { name: 'registration', packedOffset: 0, packedBitOffset: 0, type: attribution_reporting.mojom.OsRegistrationSpec, nullable: false },
...
attribution_reporting.mojom.DataHost_ReportRegistrationHeaderError_ParamsSpec = {
  $: {
    structSpec: {
      ...
      fields: [
        { name: 'reporting_origin', packedOffset: 0, packedBitOffset: 0, type: attribution_reporting.mojom.SuitableOriginSpec, nullable: false },
        { name: 'error', packedOffset: 8, packedBitOffset: 0, type: attribution_reporting.mojom.RegistrationHeaderErrorSpec, nullable: false },
      ],
      versions: [{version: 0}]
    }
  }
