...
mojo.internal.bindings.attribution_reporting.mojom.DataHostRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.attribution_reporting.mojom.DataHostPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.attribution_reporting.mojom.DataHostRemoteCallHandler(this.proxy);
  }
  ...
  sourceDataAvailable(arg_reporting_origin, arg_data, arg_was_fetched_via_service_worker) {
    return this.$.sourceDataAvailable(arg_reporting_origin, arg_data, arg_was_fetched_via_service_worker);
  }
  triggerDataAvailable(arg_reporting_origin, arg_data, arg_was_fetched_via_service_worker) {
    return this.$.triggerDataAvailable(arg_reporting_origin, arg_data, arg_was_fetched_via_service_worker);
  }
  osSourceDataAvailable(arg_registration, arg_was_fetched_via_service_worker) {
    return this.$.osSourceDataAvailable(arg_registration, arg_was_fetched_via_service_worker);
  }
  osTriggerDataAvailable(arg_registration, arg_was_fetched_via_service_worker) {
    return this.$.osTriggerDataAvailable(arg_registration, arg_was_fetched_via_service_worker);
  }
  reportRegistrationHeaderError(arg_reporting_origin, arg_error) {
    return this.$.reportRegistrationHeaderError(arg_reporting_origin, arg_error);
  }
};
...
mojo.internal.bindings.attribution_reporting.mojom.DataHost.getRemote = function() {
  let remote = new mojo.internal.bindings.attribution_reporting.mojom.DataHostRemote();
...
mojo.internal.bindings.attribution_reporting.mojom.DataHostReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.attribution_reporting.mojom.DataHost_SourceDataAvailable_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for SourceDataAvailable failed with TypeError');
           }
        }
        // Try Method 1: TriggerDataAvailable
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.attribution_reporting.mojom.DataHost_TriggerDataAvailable_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for TriggerDataAvailable failed with TypeError');
           }
        }
        // Try Method 2: OsSourceDataAvailable
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.attribution_reporting.mojom.DataHost_OsSourceDataAvailable_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OsSourceDataAvailable failed with TypeError');
           }
        }
        // Try Method 3: OsTriggerDataAvailable
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.attribution_reporting.mojom.DataHost_OsTriggerDataAvailable_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OsTriggerDataAvailable failed with TypeError');
           }
        }
        // Try Method 4: ReportRegistrationHeaderError
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.attribution_reporting.mojom.DataHost_ReportRegistrationHeaderError_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for ReportRegistrationHeaderError failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.attribution_reporting.mojom.DataHostReceiver = mojo.internal.bindings.attribution_reporting.mojom.DataHostReceiver;
