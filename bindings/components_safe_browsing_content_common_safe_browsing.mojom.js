...
mojo.internal.bindings.safe_browsing.mojom.PhishingDetectorResultSpec = mojo.internal.bindings.safe_browsing.mojom.PhishingDetectorResultSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.safe_browsing.mojom.ClientSideDetectionTypeSpec = mojo.internal.bindings.safe_browsing.mojom.ClientSideDetectionTypeSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.safe_browsing.mojom.PhishingImageEmbeddingResultSpec = mojo.internal.bindings.safe_browsing.mojom.PhishingImageEmbeddingResultSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.safe_browsing.mojom.WebRequestProtocolTypeSpec = mojo.internal.bindings.safe_browsing.mojom.WebRequestProtocolTypeSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.safe_browsing.mojom.WebRequestContactInitiatorTypeSpec = mojo.internal.bindings.safe_browsing.mojom.WebRequestContactInitiatorTypeSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.safe_browsing.mojom.AttributeNameValueSpec = mojo.internal.bindings.safe_browsing.mojom.AttributeNameValueSpec || { $: {} };
if (mojo.internal.bindings.safe_browsing.mojom.AttributeNameValueSpec.$.structSpec && mojo.internal.bindings.safe_browsing.mojom.AttributeNameValueSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.safe_browsing.mojom.AttributeNameValueSpec.$ = {};
mojo.internal.bindings.safe_browsing.mojom.ThreatDOMDetailsNodeSpec = mojo.internal.bindings.safe_browsing.mojom.ThreatDOMDetailsNodeSpec || { $: {} };
if (mojo.internal.bindings.safe_browsing.mojom.ThreatDOMDetailsNodeSpec.$.structSpec && mojo.internal.bindings.safe_browsing.mojom.ThreatDOMDetailsNodeSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.safe_browsing.mojom.ThreatDOMDetailsNodeSpec.$ = {};
mojo.internal.bindings.safe_browsing.mojom.SafeBrowsing = mojo.internal.bindings.safe_browsing.mojom.SafeBrowsing || {};
mojo.internal.bindings.safe_browsing.mojom.SafeBrowsingSpec = mojo.internal.bindings.safe_browsing.mojom.SafeBrowsingSpec || { $ : {} };
if (mojo.internal.bindings.safe_browsing.mojom.SafeBrowsingSpec.$.structSpec && mojo.internal.bindings.safe_browsing.mojom.SafeBrowsingSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.safe_browsing.mojom.SafeBrowsingSpec.$ = {};
mojo.internal.bindings.safe_browsing.mojom.SafeBrowsing.$interfaceName = 'safe_browsing.mojom.SafeBrowsing';
mojo.internal.bindings.safe_browsing.mojom.SafeBrowsing_CreateCheckerAndCheck_ParamsSpec = mojo.internal.bindings.safe_browsing.mojom.SafeBrowsing_CreateCheckerAndCheck_ParamsSpec || { $: {} };
if (mojo.internal.bindings.safe_browsing.mojom.SafeBrowsing_CreateCheckerAndCheck_ParamsSpec.$.structSpec && mojo.internal.bindings.safe_browsing.mojom.SafeBrowsing_CreateCheckerAndCheck_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.safe_browsing.mojom.SafeBrowsing_CreateCheckerAndCheck_ParamsSpec.$ = {};
mojo.internal.bindings.safe_browsing.mojom.SafeBrowsing_CreateCheckerAndCheck_ResponseParamsSpec = mojo.internal.bindings.safe_browsing.mojom.SafeBrowsing_CreateCheckerAndCheck_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.safe_browsing.mojom.SafeBrowsing_CreateCheckerAndCheck_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.safe_browsing.mojom.SafeBrowsing_CreateCheckerAndCheck_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.safe_browsing.mojom.SafeBrowsing_CreateCheckerAndCheck_ResponseParamsSpec.$ = {};
mojo.internal.bindings.safe_browsing.mojom.SafeBrowsing_Clone_ParamsSpec = mojo.internal.bindings.safe_browsing.mojom.SafeBrowsing_Clone_ParamsSpec || { $: {} };
if (mojo.internal.bindings.safe_browsing.mojom.SafeBrowsing_Clone_ParamsSpec.$.structSpec && mojo.internal.bindings.safe_browsing.mojom.SafeBrowsing_Clone_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.safe_browsing.mojom.SafeBrowsing_Clone_ParamsSpec.$ = {};
mojo.internal.bindings.safe_browsing.mojom.ThreatReporter = mojo.internal.bindings.safe_browsing.mojom.ThreatReporter || {};
mojo.internal.bindings.safe_browsing.mojom.ThreatReporterSpec = mojo.internal.bindings.safe_browsing.mojom.ThreatReporterSpec || { $ : {} };
if (mojo.internal.bindings.safe_browsing.mojom.ThreatReporterSpec.$.structSpec && mojo.internal.bindings.safe_browsing.mojom.ThreatReporterSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.safe_browsing.mojom.ThreatReporterSpec.$ = {};
mojo.internal.bindings.safe_browsing.mojom.ThreatReporter.$interfaceName = 'safe_browsing.mojom.ThreatReporter';
mojo.internal.bindings.safe_browsing.mojom.ThreatReporter_GetThreatDOMDetails_ParamsSpec = mojo.internal.bindings.safe_browsing.mojom.ThreatReporter_GetThreatDOMDetails_ParamsSpec || { $: {} };
if (mojo.internal.bindings.safe_browsing.mojom.ThreatReporter_GetThreatDOMDetails_ParamsSpec.$.structSpec && mojo.internal.bindings.safe_browsing.mojom.ThreatReporter_GetThreatDOMDetails_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.safe_browsing.mojom.ThreatReporter_GetThreatDOMDetails_ParamsSpec.$ = {};
mojo.internal.bindings.safe_browsing.mojom.ThreatReporter_GetThreatDOMDetails_ResponseParamsSpec = mojo.internal.bindings.safe_browsing.mojom.ThreatReporter_GetThreatDOMDetails_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.safe_browsing.mojom.ThreatReporter_GetThreatDOMDetails_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.safe_browsing.mojom.ThreatReporter_GetThreatDOMDetails_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.safe_browsing.mojom.ThreatReporter_GetThreatDOMDetails_ResponseParamsSpec.$ = {};
mojo.internal.bindings.safe_browsing.mojom.PhishingDetector = mojo.internal.bindings.safe_browsing.mojom.PhishingDetector || {};
mojo.internal.bindings.safe_browsing.mojom.PhishingDetectorSpec = mojo.internal.bindings.safe_browsing.mojom.PhishingDetectorSpec || { $ : {} };
if (mojo.internal.bindings.safe_browsing.mojom.PhishingDetectorSpec.$.structSpec && mojo.internal.bindings.safe_browsing.mojom.PhishingDetectorSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.safe_browsing.mojom.PhishingDetectorSpec.$ = {};
mojo.internal.bindings.safe_browsing.mojom.PhishingDetector.$interfaceName = 'safe_browsing.mojom.PhishingDetector';
mojo.internal.bindings.safe_browsing.mojom.PhishingDetector_StartPhishingDetection_ParamsSpec = mojo.internal.bindings.safe_browsing.mojom.PhishingDetector_StartPhishingDetection_ParamsSpec || { $: {} };
if (mojo.internal.bindings.safe_browsing.mojom.PhishingDetector_StartPhishingDetection_ParamsSpec.$.structSpec && mojo.internal.bindings.safe_browsing.mojom.PhishingDetector_StartPhishingDetection_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.safe_browsing.mojom.PhishingDetector_StartPhishingDetection_ParamsSpec.$ = {};
mojo.internal.bindings.safe_browsing.mojom.PhishingDetector_StartPhishingDetection_ResponseParamsSpec = mojo.internal.bindings.safe_browsing.mojom.PhishingDetector_StartPhishingDetection_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.safe_browsing.mojom.PhishingDetector_StartPhishingDetection_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.safe_browsing.mojom.PhishingDetector_StartPhishingDetection_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.safe_browsing.mojom.PhishingDetector_StartPhishingDetection_ResponseParamsSpec.$ = {};
mojo.internal.bindings.safe_browsing.mojom.PhishingModelSetter = mojo.internal.bindings.safe_browsing.mojom.PhishingModelSetter || {};
...
if (mojo.internal.bindings.safe_browsing.mojom.PhishingModelSetter_ClearScorer_ParamsSpec.$.structSpec && mojo.internal.bindings.safe_browsing.mojom.PhishingModelSetter_ClearScorer_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.safe_browsing.mojom.PhishingModelSetter_ClearScorer_ParamsSpec.$ = {};
mojo.internal.bindings.safe_browsing.mojom.PhishingModelSetter_SetTestObserver_ParamsSpec = mojo.internal.bindings.safe_browsing.mojom.PhishingModelSetter_SetTestObserver_ParamsSpec || { $: {} };
if (mojo.internal.bindings.safe_browsing.mojom.PhishingModelSetter_SetTestObserver_ParamsSpec.$.structSpec && mojo.internal.bindings.safe_browsing.mojom.PhishingModelSetter_SetTestObserver_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.safe_browsing.mojom.PhishingModelSetter_SetTestObserver_ParamsSpec.$ = {};
mojo.internal.bindings.safe_browsing.mojom.PhishingModelSetter_SetTestObserver_ResponseParamsSpec = mojo.internal.bindings.safe_browsing.mojom.PhishingModelSetter_SetTestObserver_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.safe_browsing.mojom.PhishingModelSetter_SetTestObserver_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.safe_browsing.mojom.PhishingModelSetter_SetTestObserver_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.safe_browsing.mojom.PhishingModelSetter_SetTestObserver_ResponseParamsSpec.$ = {};
mojo.internal.bindings.safe_browsing.mojom.PhishingModelSetterTestObserver = mojo.internal.bindings.safe_browsing.mojom.PhishingModelSetterTestObserver || {};
mojo.internal.bindings.safe_browsing.mojom.PhishingModelSetterTestObserverSpec = mojo.internal.bindings.safe_browsing.mojom.PhishingModelSetterTestObserverSpec || { $ : {} };
if (mojo.internal.bindings.safe_browsing.mojom.PhishingModelSetterTestObserverSpec.$.structSpec && mojo.internal.bindings.safe_browsing.mojom.PhishingModelSetterTestObserverSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.safe_browsing.mojom.PhishingModelSetterTestObserverSpec.$ = {};
...
mojo.internal.bindings.safe_browsing.mojom.PhishingModelSetterTestObserver_PhishingModelUpdated_ParamsSpec = mojo.internal.bindings.safe_browsing.mojom.PhishingModelSetterTestObserver_PhishingModelUpdated_ParamsSpec || { $: {} };
if (mojo.internal.bindings.safe_browsing.mojom.PhishingModelSetterTestObserver_PhishingModelUpdated_ParamsSpec.$.structSpec && mojo.internal.bindings.safe_browsing.mojom.PhishingModelSetterTestObserver_PhishingModelUpdated_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.safe_browsing.mojom.PhishingModelSetterTestObserver_PhishingModelUpdated_ParamsSpec.$ = {};
mojo.internal.bindings.safe_browsing.mojom.PhishingImageEmbedderDetector = mojo.internal.bindings.safe_browsing.mojom.PhishingImageEmbedderDetector || {};
mojo.internal.bindings.safe_browsing.mojom.PhishingImageEmbedderDetectorSpec = mojo.internal.bindings.safe_browsing.mojom.PhishingImageEmbedderDetectorSpec || { $ : {} };
if (mojo.internal.bindings.safe_browsing.mojom.PhishingImageEmbedderDetectorSpec.$.structSpec && mojo.internal.bindings.safe_browsing.mojom.PhishingImageEmbedderDetectorSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.safe_browsing.mojom.PhishingImageEmbedderDetectorSpec.$ = {};
...
mojo.internal.bindings.safe_browsing.mojom.PhishingImageEmbedderDetector_StartImageEmbedding_ParamsSpec = mojo.internal.bindings.safe_browsing.mojom.PhishingImageEmbedderDetector_StartImageEmbedding_ParamsSpec || { $: {} };
if (mojo.internal.bindings.safe_browsing.mojom.PhishingImageEmbedderDetector_StartImageEmbedding_ParamsSpec.$.structSpec && mojo.internal.bindings.safe_browsing.mojom.PhishingImageEmbedderDetector_StartImageEmbedding_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.safe_browsing.mojom.PhishingImageEmbedderDetector_StartImageEmbedding_ParamsSpec.$ = {};
mojo.internal.bindings.safe_browsing.mojom.PhishingImageEmbedderDetector_StartImageEmbedding_ResponseParamsSpec = mojo.internal.bindings.safe_browsing.mojom.PhishingImageEmbedderDetector_StartImageEmbedding_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.safe_browsing.mojom.PhishingImageEmbedderDetector_StartImageEmbedding_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.safe_browsing.mojom.PhishingImageEmbedderDetector_StartImageEmbedding_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.safe_browsing.mojom.PhishingImageEmbedderDetector_StartImageEmbedding_ResponseParamsSpec.$ = {};
mojo.internal.bindings.safe_browsing.mojom.ExtensionWebRequestReporter = mojo.internal.bindings.safe_browsing.mojom.ExtensionWebRequestReporter || {};
mojo.internal.bindings.safe_browsing.mojom.ExtensionWebRequestReporterSpec = mojo.internal.bindings.safe_browsing.mojom.ExtensionWebRequestReporterSpec || { $ : {} };
if (mojo.internal.bindings.safe_browsing.mojom.ExtensionWebRequestReporterSpec.$.structSpec && mojo.internal.bindings.safe_browsing.mojom.ExtensionWebRequestReporterSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.safe_browsing.mojom.ExtensionWebRequestReporterSpec.$ = {};
...
mojo.internal.bindings.safe_browsing.mojom.ExtensionWebRequestReporter_SendWebRequestData_ParamsSpec = mojo.internal.bindings.safe_browsing.mojom.ExtensionWebRequestReporter_SendWebRequestData_ParamsSpec || { $: {} };
if (mojo.internal.bindings.safe_browsing.mojom.ExtensionWebRequestReporter_SendWebRequestData_ParamsSpec.$.structSpec && mojo.internal.bindings.safe_browsing.mojom.ExtensionWebRequestReporter_SendWebRequestData_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.safe_browsing.mojom.ExtensionWebRequestReporter_SendWebRequestData_ParamsSpec.$ = {};
mojo.internal.bindings.safe_browsing.mojom.ExtensionWebRequestReporter_Clone_ParamsSpec = mojo.internal.bindings.safe_browsing.mojom.ExtensionWebRequestReporter_Clone_ParamsSpec || { $: {} };
if (mojo.internal.bindings.safe_browsing.mojom.ExtensionWebRequestReporter_Clone_ParamsSpec.$.structSpec && mojo.internal.bindings.safe_browsing.mojom.ExtensionWebRequestReporter_Clone_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.safe_browsing.mojom.ExtensionWebRequestReporter_Clone_ParamsSpec.$ = {};
...
mojo.internal.bindings.safe_browsing.mojom.PhishingDetectorResult = {
  SUCCESS: 0,
  ...
  CLASSIFICATION_SKIPPED: 11,
};

// Enum: ClientSideDetectionType
mojo.internal.bindings.safe_browsing.mojom.ClientSideDetectionType = {
  kForceRequest: 0,
  kTriggerModels: 1,
  ...
  kUserReport: 11,
  kUnfamiliarLoginPage: 12,
};

// Enum: PhishingImageEmbeddingResult
mojo.internal.bindings.safe_browsing.mojom.PhishingImageEmbeddingResult = {
  kSuccess: 0,
...
mojo.internal.bindings.safe_browsing.mojom.WebRequestProtocolType = {
  kHttpHttps: 0,
  kWebSocket: 1,
};

// Enum: WebRequestContactInitiatorType
mojo.internal.bindings.safe_browsing.mojom.WebRequestContactInitiatorType = {
  kExtension: 0,
  kContentScript: 1,
};
...
mojo.internal.bindings.safe_browsing.mojom.SafeBrowsingRemote = class {
  ...
  constructor(handle = undefined) {
    ...
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.safe_browsing.mojom.SafeBrowsingPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.safe_browsing.mojom.SafeBrowsingRemoteCallHandler(this.proxy);
  }
  ...
  createCheckerAndCheck(arg_frame_token, arg_receiver, arg_url, arg_method, arg_headers, arg_load_flags, arg_has_user_gesture, arg_originated_from_service_worker) {
    return this.$.createCheckerAndCheck(arg_frame_token, arg_receiver, arg_url, arg_method, arg_headers, arg_load_flags, arg_has_user_gesture, arg_originated_from_service_worker);
  }
  clone(arg_receiver) {
...
mojo.internal.bindings.safe_browsing.mojom.SafeBrowsing.getRemote = function() {
  let remote = new mojo.internal.bindings.safe_browsing.mojom.SafeBrowsingRemote();
...
mojo.internal.bindings.safe_browsing.mojom.SafeBrowsingReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
...
mojo.internal.bindings.safe_browsing.mojom.SafeBrowsingReceiver = mojo.internal.bindings.safe_browsing.mojom.SafeBrowsingReceiver;

mojo.internal.bindings.safe_browsing.mojom.SafeBrowsingPtr = mojo.internal.bindings.safe_browsing.mojom.SafeBrowsingRemote;
mojo.internal.bindings.safe_browsing.mojom.SafeBrowsingRequest = mojo.internal.bindings.safe_browsing.mojom.SafeBrowsingPendingReceiver;
...
mojo.internal.bindings.safe_browsing.mojom.ThreatReporterRemote = class {
  static get $interfaceName() {
  ...
  constructor(handle = undefined) {
    this.__mojoHandle = handle;
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.safe_browsing.mojom.ThreatReporterPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.safe_browsing.mojom.ThreatReporterRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.safe_browsing.mojom.ThreatReporter.getRemote = function() {
  let remote = new mojo.internal.bindings.safe_browsing.mojom.ThreatReporterRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
...
mojo.internal.bindings.safe_browsing.mojom.ThreatReporterReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.safe_browsing.mojom.ThreatReporter_GetThreatDOMDetails_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.safe_browsing.mojom.ThreatReporterReceiver = mojo.internal.bindings.safe_browsing.mojom.ThreatReporterReceiver;

mojo.internal.bindings.safe_browsing.mojom.ThreatReporterPtr = mojo.internal.bindings.safe_browsing.mojom.ThreatReporterRemote;
mojo.internal.bindings.safe_browsing.mojom.ThreatReporterRequest = mojo.internal.bindings.safe_browsing.mojom.ThreatReporterPendingReceiver;
...
mojo.internal.bindings.safe_browsing.mojom.PhishingDetectorRemote = class {
  static get $interfaceName() {
  ...
  constructor(handle = undefined) {
    this.__mojoHandle = handle;
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.safe_browsing.mojom.PhishingDetectorPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.safe_browsing.mojom.PhishingDetectorRemoteCallHandler(this.proxy);
  }
  ...
  startPhishingDetection(arg_url, arg_request_type) {
    return this.$.startPhishingDetection(arg_url, arg_request_type);
  }
};
...
mojo.internal.bindings.safe_browsing.mojom.PhishingDetector.getRemote = function() {
  let remote = new mojo.internal.bindings.safe_browsing.mojom.PhishingDetectorRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
...
mojo.internal.bindings.safe_browsing.mojom.PhishingDetectorReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
...
mojo.internal.bindings.safe_browsing.mojom.PhishingDetectorReceiver = mojo.internal.bindings.safe_browsing.mojom.PhishingDetectorReceiver;

mojo.internal.bindings.safe_browsing.mojom.PhishingDetectorPtr = mojo.internal.bindings.safe_browsing.mojom.PhishingDetectorRemote;
mojo.internal.bindings.safe_browsing.mojom.PhishingDetectorRequest = mojo.internal.bindings.safe_browsing.mojom.PhishingDetectorPendingReceiver;
...
mojo.internal.bindings.safe_browsing.mojom.PhishingModelSetterRemote = class {
  static get $interfaceName() {
  ...
  constructor(handle = undefined) {
    this.__mojoHandle = handle;
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.safe_browsing.mojom.PhishingModelSetterPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.safe_browsing.mojom.PhishingModelSetterRemoteCallHandler(this.proxy);
  }
  ...
  setTestObserver(arg_observer) {
    return this.$.setTestObserver(arg_observer);
  }
};
...
mojo.internal.bindings.safe_browsing.mojom.PhishingModelSetter.getRemote = function() {
  let remote = new mojo.internal.bindings.safe_browsing.mojom.PhishingModelSetterRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
...
mojo.internal.bindings.safe_browsing.mojom.PhishingModelSetterReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
...
mojo.internal.bindings.safe_browsing.mojom.PhishingModelSetterReceiver = mojo.internal.bindings.safe_browsing.mojom.PhishingModelSetterReceiver;

mojo.internal.bindings.safe_browsing.mojom.PhishingModelSetterPtr = mojo.internal.bindings.safe_browsing.mojom.PhishingModelSetterRemote;
mojo.internal.bindings.safe_browsing.mojom.PhishingModelSetterRequest = mojo.internal.bindings.safe_browsing.mojom.PhishingModelSetterPendingReceiver;
...
mojo.internal.bindings.safe_browsing.mojom.PhishingModelSetterTestObserverRemote = class {
  static get $interfaceName() {
  ...
  constructor(handle = undefined) {
    this.__mojoHandle = handle;
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.safe_browsing.mojom.PhishingModelSetterTestObserverPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.safe_browsing.mojom.PhishingModelSetterTestObserverRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.safe_browsing.mojom.PhishingModelSetterTestObserver.getRemote = function() {
  let remote = new mojo.internal.bindings.safe_browsing.mojom.PhishingModelSetterTestObserverRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
...
mojo.internal.bindings.safe_browsing.mojom.PhishingModelSetterTestObserverReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.safe_browsing.mojom.PhishingModelSetterTestObserver_PhishingModelUpdated_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.safe_browsing.mojom.PhishingModelSetterTestObserverReceiver = mojo.internal.bindings.safe_browsing.mojom.PhishingModelSetterTestObserverReceiver;

mojo.internal.bindings.safe_browsing.mojom.PhishingModelSetterTestObserverPtr = mojo.internal.bindings.safe_browsing.mojom.PhishingModelSetterTestObserverRemote;
mojo.internal.bindings.safe_browsing.mojom.PhishingModelSetterTestObserverRequest = mojo.internal.bindings.safe_browsing.mojom.PhishingModelSetterTestObserverPendingReceiver;
...
mojo.internal.bindings.safe_browsing.mojom.PhishingImageEmbedderDetectorRemote = class {
  static get $interfaceName() {
  ...
  constructor(handle = undefined) {
    this.__mojoHandle = handle;
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.safe_browsing.mojom.PhishingImageEmbedderDetectorPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.safe_browsing.mojom.PhishingImageEmbedderDetectorRemoteCallHandler(this.proxy);
  }
  ...
  startImageEmbedding(arg_url, arg_extract_visual_features) {
    return this.$.startImageEmbedding(arg_url, arg_extract_visual_features);
  }
};
...
mojo.internal.bindings.safe_browsing.mojom.PhishingImageEmbedderDetectorRemoteCallHandler = class {
  ...
  startImageEmbedding(arg_url, arg_extract_visual_features) {
    return this.proxy.sendMessage(
      ...
      mojo.internal.bindings.safe_browsing.mojom.PhishingImageEmbedderDetector_StartImageEmbedding_ParamsSpec,
      mojo.internal.bindings.safe_browsing.mojom.PhishingImageEmbedderDetector_StartImageEmbedding_ResponseParamsSpec,
      [arg_url, arg_extract_visual_features],
      false);
  }

};

mojo.internal.bindings.safe_browsing.mojom.PhishingImageEmbedderDetector.getRemote = function() {
  let remote = new mojo.internal.bindings.safe_browsing.mojom.PhishingImageEmbedderDetectorRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
...
mojo.internal.bindings.safe_browsing.mojom.PhishingImageEmbedderDetectorReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        case 0: {
          ...
          const result = this.impl.startImageEmbedding(params.arg_url, params.arg_extract_visual_features);
          const expectsResponse = header.expectsResponse || (header.flags & 1);
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              const resp_obj = response;
...
mojo.internal.bindings.safe_browsing.mojom.PhishingImageEmbedderDetectorReceiver = mojo.internal.bindings.safe_browsing.mojom.PhishingImageEmbedderDetectorReceiver;

mojo.internal.bindings.safe_browsing.mojom.PhishingImageEmbedderDetectorPtr = mojo.internal.bindings.safe_browsing.mojom.PhishingImageEmbedderDetectorRemote;
mojo.internal.bindings.safe_browsing.mojom.PhishingImageEmbedderDetectorRequest = mojo.internal.bindings.safe_browsing.mojom.PhishingImageEmbedderDetectorPendingReceiver;
...
mojo.internal.bindings.safe_browsing.mojom.ExtensionWebRequestReporterRemote = class {
  static get $interfaceName() {
  ...
  constructor(handle = undefined) {
    this.__mojoHandle = handle;
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.safe_browsing.mojom.ExtensionWebRequestReporterPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.safe_browsing.mojom.ExtensionWebRequestReporterRemoteCallHandler(this.proxy);
  }
  ...
  sendWebRequestData(arg_origin_extension_id, arg_telemetry_url, arg_protocol_type, arg_contact_initiator_type) {
    return this.$.sendWebRequestData(arg_origin_extension_id, arg_telemetry_url, arg_protocol_type, arg_contact_initiator_type);
  }
  clone(arg_receiver) {
    return this.$.clone(arg_receiver);
  }
...
mojo.internal.bindings.safe_browsing.mojom.ExtensionWebRequestReporter.getRemote = function() {
  let remote = new mojo.internal.bindings.safe_browsing.mojom.ExtensionWebRequestReporterRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
...
mojo.internal.bindings.safe_browsing.mojom.ExtensionWebRequestReporterReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
...
mojo.internal.bindings.safe_browsing.mojom.ExtensionWebRequestReporterReceiver = mojo.internal.bindings.safe_browsing.mojom.ExtensionWebRequestReporterReceiver;
...
mojo.internal.Struct(
    mojo.internal.bindings.safe_browsing.mojom.PhishingImageEmbedderDetector_StartImageEmbedding_ParamsSpec, 'safe_browsing.mojom.PhishingImageEmbedderDetector_StartImageEmbedding_Params', [
      mojo.internal.StructField('arg_url', 0, 0, mojo.internal.bindings.url.mojom.UrlSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_extract_visual_features', 8, 0, mojo.internal.Bool, false, false, 0, undefined),
    ],
    [[0, 24]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.safe_browsing.mojom.PhishingImageEmbedderDetector_StartImageEmbedding_ResponseParamsSpec, 'safe_browsing.mojom.PhishingImageEmbedderDetector_StartImageEmbedding_ResponseParams', [
      ...
      mojo.internal.StructField('arg_visual_features', 16, 0, mojo.internal.bindings.mojo_base.mojom.ProtoWrapperSpec, null, true, 0, undefined),
    ],
    [[0, 32]]);
