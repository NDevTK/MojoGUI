...
mojo.internal.bindings.extensions.mojom.AppWindow = {};
mojo.internal.bindings.extensions.mojom.AppWindowSpec = { $ : {} };
mojo.internal.bindings.extensions.mojom.AppWindow.$interfaceName = 'extensions.mojom.AppWindow';
...
mojo.internal.bindings.extensions.mojom.AppWindowRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.extensions.mojom.AppWindowPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.extensions.mojom.AppWindowRemoteCallHandler(this.proxy);
  }
  ...
  setVisuallyDeemphasized(arg_deemphasized) {
    return this.$.setVisuallyDeemphasized(arg_deemphasized);
  }
};

mojo.internal.bindings.extensions.mojom.AppWindowRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('extensions.mojom.AppWindow', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.extensions.mojom.AppWindow.getRemote = function() {
  let remote = new mojo.internal.bindings.extensions.mojom.AppWindowRemote();
...
mojo.internal.bindings.extensions.mojom.AppWindowReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('extensions.mojom.AppWindow', [
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.extensions.mojom.AppWindow_SetVisuallyDeemphasized_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for SetVisuallyDeemphasized failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.extensions.mojom.AppWindowReceiver = mojo.internal.bindings.extensions.mojom.AppWindowReceiver;
