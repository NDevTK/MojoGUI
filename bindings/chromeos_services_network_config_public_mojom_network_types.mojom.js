...
mojo.internal.bindings.chromeos.network_config.mojom.DeviceStateType = {
  kUninitialized: 0,
  kDisabled: 1,
  kDisabling: 2,
  kEnabling: 3,
...
// Enum: IPConfigType
mojo.internal.bindings.chromeos.network_config.mojom.IPConfigType = {
  kIPv4: 0,
  kIPv6: 1,
};

// Enum: NetworkType
mojo.internal.bindings.chromeos.network_config.mojom.NetworkType = {
  kAll: 0,
  kCellular: 1,
  kEthernet: 2,
  kMobile: 3,
...
// Enum: OncSource
mojo.internal.bindings.chromeos.network_config.mojom.OncSource = {
  kNone: 0,
  kUser: 1,
  kDevice: 2,
  kUserPolicy: 3,
...
// Enum: PolicySource
mojo.internal.bindings.chromeos.network_config.mojom.PolicySource = {
  kNone: 0,
...
// Enum: PortalState
mojo.internal.bindings.chromeos.network_config.mojom.PortalState = {
  kUnknown: 0,
  kOnline: 1,
  kPortalSuspected: 2,
  kPortal: 3,
