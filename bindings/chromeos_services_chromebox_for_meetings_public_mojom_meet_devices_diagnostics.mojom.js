...
mojo.internal.bindings.ash.cros_healthd.mojom.ProcessResultSpec = mojo.internal.bindings.ash.cros_healthd.mojom.ProcessResultSpec || { $: mojo.internal.OpaqueStruct.$ };
mojo.internal.bindings.ash = mojo.internal.bindings.ash || {};
mojo.internal.bindings.ash.cros_healthd = mojo.internal.bindings.ash.cros_healthd || {};
mojo.internal.bindings.ash.cros_healthd.mojom = mojo.internal.bindings.ash.cros_healthd.mojom || {};
...
mojo.internal.bindings.chromeos.cfm.mojom.MeetDevicesDiagnosticsRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.chromeos.cfm.mojom.MeetDevicesDiagnosticsPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.chromeos.cfm.mojom.MeetDevicesDiagnosticsRemoteCallHandler(this.proxy);
  }
  ...
  getCrosHealthdProcessInfo(arg_pid) {
    return this.$.getCrosHealthdProcessInfo(arg_pid);
  }
};
...
mojo.internal.bindings.chromeos.cfm.mojom.MeetDevicesDiagnostics.getRemote = function() {
  let remote = new mojo.internal.bindings.chromeos.cfm.mojom.MeetDevicesDiagnosticsRemote();
...
mojo.internal.bindings.chromeos.cfm.mojom.MeetDevicesDiagnosticsReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.chromeos.cfm.mojom.MeetDevicesDiagnostics_GetCrosHealthdTelemetry_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for GetCrosHealthdTelemetry failed with TypeError');
           }
        }
        // Try Method 1: GetCrosHealthdProcessInfo
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.chromeos.cfm.mojom.MeetDevicesDiagnostics_GetCrosHealthdProcessInfo_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for GetCrosHealthdProcessInfo failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.chromeos.cfm.mojom.MeetDevicesDiagnostics_GetCrosHealthdTelemetry_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.chromeos.cfm.mojom.MeetDevicesDiagnosticsReceiver = mojo.internal.bindings.chromeos.cfm.mojom.MeetDevicesDiagnosticsReceiver;
