  ...
  $: {
    structSpec: {
      ...
      fields: [
        ...
        { name: 'plugin', packedOffset: 8, packedBitOffset: 0, type: mojo.internal.Pointer, nullable: false },
        ...
        { name: 'group_name', packedOffset: 32, packedBitOffset: 0, type: mojo.internal.Pointer, nullable: false },
      ],
      versions: [{version: 0}]
    }
  }
