...
// Enum: LandmarkType
mojo.internal.bindings.shape_detection.mojom.LandmarkType = {
  MOUTH: 0,
  EYE: 1,
  NOSE: 2,
};
...
mojo.internal.Struct(
    mojo.internal.bindings.shape_detection.mojom.FaceDetectorOptionsSpec, 'shape_detection.mojom.FaceDetectorOptions', [
      mojo.internal.StructField('arg_max_detected_faces', 0, 0, mojo.internal.Uint32, 0, false, 0, undefined),
      mojo.internal.StructField('arg_fast_mode', 4, 0, mojo.internal.Bool, false, false, 0, undefined),
    ],
    [[0, 16]]);
...
mojo.internal.bindings.shape_detection.mojom.FaceDetectionPendingReceiver = class {
  constructor(handle) {
    this.handle = handle;
  }
};
...
mojo.internal.bindings.shape_detection.mojom.FaceDetectionRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.shape_detection.mojom.FaceDetectionRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.shape_detection.mojom.FaceDetectionRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('shape_detection.mojom.FaceDetection', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.shape_detection.mojom.FaceDetection.getRemote = function() {
  let remote = new mojo.internal.bindings.shape_detection.mojom.FaceDetectionRemote();
...
mojo.internal.bindings.shape_detection.mojom.FaceDetectionReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('shape_detection.mojom.FaceDetection', [
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.shape_detection.mojom.FaceDetection_Detect_ParamsSpec.$.structSpec);
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.shape_detection.mojom.FaceDetection_Detect_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.shape_detection.mojom.FaceDetectionReceiver = mojo.internal.bindings.shape_detection.mojom.FaceDetectionReceiver;

mojo.internal.bindings.shape_detection.mojom.FaceDetectionPtr = mojo.internal.bindings.shape_detection.mojom.FaceDetectionRemote;
mojo.internal.bindings.shape_detection.mojom.FaceDetectionRequest = mojo.internal.bindings.shape_detection.mojom.FaceDetectionPendingReceiver;
