...
mojo.internal.bindings.ui.ozone.mojom.SetGesturePropErrorCode = {
  SUCCESS: 0,
  UNKNOWN_ERROR: 1,
  NOT_FOUND: 2,
  READ_ONLY: 3,
...
mojo.internal.Struct(
    mojo.internal.bindings.ui.ozone.mojom.GesturePropertiesService_GetProperty_ResponseParamsSpec, 'ui.ozone.mojom.GesturePropertiesService_GetProperty_ResponseParams', [
      ...
      mojo.internal.StructField('arg_is_read_only', 8, 0, mojo.internal.Bool, false, false, 0, undefined),
    ],
    [[0, 24]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.ui.ozone.mojom.GesturePropertiesService_SetProperty_ParamsSpec, 'ui.ozone.mojom.GesturePropertiesService_SetProperty_Params', [
      mojo.internal.StructField('arg_name', 0, 0, mojo.internal.String, null, false, 0, undefined),
      mojo.internal.StructField('arg_value', 8, 0, mojo.internal.bindings.ui.ozone.mojom.GesturePropValueSpec.$, null, false, 0, undefined),
      mojo.internal.StructField('arg_device_id', 16, 0, mojo.internal.Int32, 0, false, 0, undefined),
    ],
    [[0, 32]]);
...
mojo.internal.bindings.ui.ozone.mojom.GesturePropertiesServiceRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.ui.ozone.mojom.GesturePropertiesServicePendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.ui.ozone.mojom.GesturePropertiesServiceRemoteCallHandler(this.proxy);
  }
  ...
  listProperties(arg_device_id) {
    return this.$.listProperties(arg_device_id);
  }
  getProperty(arg_device_id, arg_name) {
    return this.$.getProperty(arg_device_id, arg_name);
  }
  setProperty(arg_device_id, arg_name, arg_value) {
    return this.$.setProperty(arg_device_id, arg_name, arg_value);
  }
};
...
mojo.internal.bindings.ui.ozone.mojom.GesturePropertiesService.getRemote = function() {
  let remote = new mojo.internal.bindings.ui.ozone.mojom.GesturePropertiesServiceRemote();
...
mojo.internal.bindings.ui.ozone.mojom.GesturePropertiesServiceReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ui.ozone.mojom.GesturePropertiesService_ListDevices_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for ListDevices failed with TypeError');
           }
        }
        // Try Method 1: ListProperties
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ui.ozone.mojom.GesturePropertiesService_ListProperties_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for ListProperties failed with TypeError');
           }
        }
        // Try Method 2: GetProperty
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ui.ozone.mojom.GesturePropertiesService_GetProperty_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for GetProperty failed with TypeError');
           }
        }
        // Try Method 3: SetProperty
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ui.ozone.mojom.GesturePropertiesService_SetProperty_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for SetProperty failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.ui.ozone.mojom.GesturePropertiesService_ListDevices_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.ui.ozone.mojom.GesturePropertiesServiceReceiver = mojo.internal.bindings.ui.ozone.mojom.GesturePropertiesServiceReceiver;
