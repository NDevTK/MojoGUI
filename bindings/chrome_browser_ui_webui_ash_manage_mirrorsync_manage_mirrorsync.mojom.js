...
mojo.internal.bindings.ash.manage_mirrorsync.mojom.GetSyncPathError = {
...
mojo.internal.bindings.ash.manage_mirrorsync.mojom.PageHandlerFactoryRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.ash.manage_mirrorsync.mojom.PageHandlerFactoryPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.ash.manage_mirrorsync.mojom.PageHandlerFactoryRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.ash.manage_mirrorsync.mojom.PageHandlerFactoryRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('ash.manage_mirrorsync.mojom.PageHandlerFactory', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.ash.manage_mirrorsync.mojom.PageHandlerFactory.getRemote = function() {
  let remote = new mojo.internal.bindings.ash.manage_mirrorsync.mojom.PageHandlerFactoryRemote();
...
mojo.internal.bindings.ash.manage_mirrorsync.mojom.PageHandlerFactoryReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('ash.manage_mirrorsync.mojom.PageHandlerFactory', [
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ash.manage_mirrorsync.mojom.PageHandlerFactory_CreatePageHandler_ParamsSpec.$.structSpec;
...
mojo.internal.bindings.ash.manage_mirrorsync.mojom.PageHandlerFactoryReceiver = mojo.internal.bindings.ash.manage_mirrorsync.mojom.PageHandlerFactoryReceiver;

mojo.internal.bindings.ash.manage_mirrorsync.mojom.PageHandlerFactoryPtr = mojo.internal.bindings.ash.manage_mirrorsync.mojom.PageHandlerFactoryRemote;
mojo.internal.bindings.ash.manage_mirrorsync.mojom.PageHandlerFactoryRequest = mojo.internal.bindings.ash.manage_mirrorsync.mojom.PageHandlerFactoryPendingReceiver;
...
mojo.internal.Struct(
    mojo.internal.bindings.ash.manage_mirrorsync.mojom.PageHandler_GetSyncingPaths_ResponseParamsSpec, 'ash.manage_mirrorsync.mojom.PageHandler_GetSyncingPaths_ResponseParams', [
      mojo.internal.StructField('arg_syncing_paths', 0, 0, mojo.internal.Array(mojo.internal.bindings.mojo_base.mojom.FilePathSpec, false), null, false, 0, undefined),
      mojo.internal.StructField('arg_error', 8, 0, mojo.internal.bindings.ash.manage_mirrorsync.mojom.GetSyncPathErrorSpec, null, false, 0, undefined),
    ],
    [[0, 24]]);
...
mojo.internal.bindings.ash.manage_mirrorsync.mojom.PageHandlerRemote = class {
  static get $interfaceName() {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.ash.manage_mirrorsync.mojom.PageHandlerPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.ash.manage_mirrorsync.mojom.PageHandlerRemoteCallHandler(this.proxy);
  }
  ...
  getChildFolders(arg_path) {
    return this.$.getChildFolders(arg_path);
  }
  getSyncingPaths() {
...
mojo.internal.bindings.ash.manage_mirrorsync.mojom.PageHandlerRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('ash.manage_mirrorsync.mojom.PageHandler', [
      { explicit: null },
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.ash.manage_mirrorsync.mojom.PageHandler.getRemote = function() {
  let remote = new mojo.internal.bindings.ash.manage_mirrorsync.mojom.PageHandlerRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
...
mojo.internal.bindings.ash.manage_mirrorsync.mojom.PageHandlerReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('ash.manage_mirrorsync.mojom.PageHandler', [
      { explicit: null },
      { explicit: null },
    ]);
    ordinals.forEach((ord, idx) => {
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ash.manage_mirrorsync.mojom.PageHandler_GetChildFolders_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for GetChildFolders failed with TypeError');
           }
        }
        // Try Method 1: GetSyncingPaths
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ash.manage_mirrorsync.mojom.PageHandler_GetSyncingPaths_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for GetSyncingPaths failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
             console.warn('[GeneratedReceiver] Failed to discover ordinal ' + header.ordinal);
      ...
      switch (dispatchId) {
        ...
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.ash.manage_mirrorsync.mojom.PageHandler_GetSyncingPaths_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.ash.manage_mirrorsync.mojom.PageHandlerReceiver = mojo.internal.bindings.ash.manage_mirrorsync.mojom.PageHandlerReceiver;
