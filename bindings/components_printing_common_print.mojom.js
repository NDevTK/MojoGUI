  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.printing.mojom.PrintRenderer_CreatePreviewDocument_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for CreatePreviewDocument failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.printing.mojom.PrintPreviewUI_SetOptionsFromDocument_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for SetOptionsFromDocument failed with TypeError');
           }
        }
        // Try Method 1: DidPrepareDocumentForPreview
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.printing.mojom.PrintPreviewUI_DidPrepareDocumentForPreview_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for DidPrepareDocumentForPreview failed with TypeError');
           }
        }
        // Try Method 2: DidPreviewPage
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.printing.mojom.PrintPreviewUI_DidPreviewPage_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for DidPreviewPage failed with TypeError');
           }
        }
        // Try Method 3: MetafileReadyForPrinting
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.printing.mojom.PrintPreviewUI_MetafileReadyForPrinting_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for MetafileReadyForPrinting failed with TypeError');
           }
        }
        // Try Method 4: PrintPreviewFailed
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.printing.mojom.PrintPreviewUI_PrintPreviewFailed_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for PrintPreviewFailed failed with TypeError');
           }
        }
        // Try Method 5: PrintPreviewCancelled
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.printing.mojom.PrintPreviewUI_PrintPreviewCancelled_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for PrintPreviewCancelled failed with TypeError');
           }
        }
        // Try Method 6: PrinterSettingsInvalid
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.printing.mojom.PrintPreviewUI_PrinterSettingsInvalid_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for PrinterSettingsInvalid failed with TypeError');
           }
        }
        // Try Method 7: DidGetDefaultPageLayout
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.printing.mojom.PrintPreviewUI_DidGetDefaultPageLayout_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for DidGetDefaultPageLayout failed with TypeError');
           }
        }
        // Try Method 8: DidStartPreview
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.printing.mojom.PrintPreviewUI_DidStartPreview_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for DidStartPreview failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
             console.warn('[GeneratedReceiver] Failed to discover ordinal ' + header.ordinal);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.printing.mojom.PrintRenderFrame_PrintRequestedPages_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for PrintRequestedPages failed with TypeError');
           }
        }
        // Try Method 1: PrintWithParams
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.printing.mojom.PrintRenderFrame_PrintWithParams_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for PrintWithParams failed with TypeError');
           }
        }
        // Try Method 2: PrintForSystemDialog
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.printing.mojom.PrintRenderFrame_PrintForSystemDialog_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for PrintForSystemDialog failed with TypeError');
           }
        }
        // Try Method 3: InitiatePrintPreview
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.printing.mojom.PrintRenderFrame_InitiatePrintPreview_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for InitiatePrintPreview failed with TypeError');
           }
        }
        // Try Method 4: SetPrintPreviewUI
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.printing.mojom.PrintRenderFrame_SetPrintPreviewUI_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for SetPrintPreviewUI failed with TypeError');
           }
        }
        // Try Method 5: PrintPreview
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.printing.mojom.PrintRenderFrame_PrintPreview_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for PrintPreview failed with TypeError');
           }
        }
        // Try Method 6: OnPrintPreviewDialogClosed
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.printing.mojom.PrintRenderFrame_OnPrintPreviewDialogClosed_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OnPrintPreviewDialogClosed failed with TypeError');
           }
        }
        // Try Method 7: PrintFrameContent
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.printing.mojom.PrintRenderFrame_PrintFrameContent_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for PrintFrameContent failed with TypeError');
           }
        }
        // Try Method 8: ConnectToPdfRenderer
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.printing.mojom.PrintRenderFrame_ConnectToPdfRenderer_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for ConnectToPdfRenderer failed with TypeError');
           }
        }
        // Try Method 9: PrintingDone
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.printing.mojom.PrintRenderFrame_PrintingDone_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for PrintingDone failed with TypeError');
           }
        }
        // Try Method 10: PrintNodeUnderContextMenu
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.printing.mojom.PrintRenderFrame_PrintNodeUnderContextMenu_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for PrintNodeUnderContextMenu failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
             console.warn('[GeneratedReceiver] Failed to discover ordinal ' + header.ordinal);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.printing.mojom.PrintManagerHost_DidGetPrintedPagesCount_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for DidGetPrintedPagesCount failed with TypeError');
           }
        }
        // Try Method 1: GetDefaultPrintSettings
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.printing.mojom.PrintManagerHost_GetDefaultPrintSettings_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for GetDefaultPrintSettings failed with TypeError');
           }
        }
        // Try Method 2: DidShowPrintDialog
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.printing.mojom.PrintManagerHost_DidShowPrintDialog_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for DidShowPrintDialog failed with TypeError');
           }
        }
        // Try Method 3: DidPrintDocument
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.printing.mojom.PrintManagerHost_DidPrintDocument_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for DidPrintDocument failed with TypeError');
           }
        }
        // Try Method 4: IsPrintingEnabled
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.printing.mojom.PrintManagerHost_IsPrintingEnabled_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for IsPrintingEnabled failed with TypeError');
           }
        }
        // Try Method 5: ScriptedPrint
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.printing.mojom.PrintManagerHost_ScriptedPrint_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for ScriptedPrint failed with TypeError');
           }
        }
        // Try Method 6: PrintingFailed
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.printing.mojom.PrintManagerHost_PrintingFailed_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for PrintingFailed failed with TypeError');
           }
        }
        // Try Method 7: UpdatePrintSettings
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.printing.mojom.PrintManagerHost_UpdatePrintSettings_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for UpdatePrintSettings failed with TypeError');
           }
        }
        // Try Method 8: SetupScriptedPrintPreview
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.printing.mojom.PrintManagerHost_SetupScriptedPrintPreview_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for SetupScriptedPrintPreview failed with TypeError');
           }
        }
        // Try Method 9: ShowScriptedPrintPreview
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.printing.mojom.PrintManagerHost_ShowScriptedPrintPreview_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for ShowScriptedPrintPreview failed with TypeError');
           }
        }
        // Try Method 10: RequestPrintPreview
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.printing.mojom.PrintManagerHost_RequestPrintPreview_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for RequestPrintPreview failed with TypeError');
           }
        }
        // Try Method 11: CheckForCancel
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.printing.mojom.PrintManagerHost_CheckForCancel_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for CheckForCancel failed with TypeError');
           }
        }
        // Try Method 12: SetAccessibilityTree
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.printing.mojom.PrintManagerHost_SetAccessibilityTree_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for SetAccessibilityTree failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
             console.warn('[GeneratedReceiver] Failed to discover ordinal ' + header.ordinal);
