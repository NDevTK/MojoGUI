...
mojo.internal.Struct(
    printing.mojom.OptionsFromDocumentParamsSpec, 'printing.mojom.OptionsFromDocumentParams', [
      mojo.internal.StructField('is_scaling_disabled', 8, 0, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('copies', 0, 0, mojo.internal.Int32, 0, false, 0, undefined),
      mojo.internal.StructField('duplex', 4, 0, printing.mojom.DuplexModeSpec, null, false, 0, undefined),
    ],
    [[0, 24]]);
...
mojo.internal.Struct(
    printing.mojom.PrintParamsSpec, 'printing.mojom.PrintParams', [
      ...
      mojo.internal.StructField('margin_top', 72, 0, mojo.internal.Float, 0, false, 0, undefined),
      mojo.internal.StructField('margin_left', 76, 0, mojo.internal.Float, 0, false, 0, undefined),
      mojo.internal.StructField('page_orientation', 80, 0, printing.mojom.PageOrientationSpec, null, false, 0, undefined),
      mojo.internal.StructField('dpi', 24, 0, gfx.mojom.SizeSpec, null, false, 0, undefined),
      mojo.internal.StructField('scale_factor', 32, 0, mojo.internal.Double, 0, false, 0, undefined),
      mojo.internal.StructField('document_cookie', 84, 0, mojo.internal.Int32, 0, false, 0, undefined),
      mojo.internal.StructField('selection_only', 116, 0, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('preview_ui_id', 88, 0, mojo.internal.Int32, 0, false, 0, undefined),
      mojo.internal.StructField('preview_request_id', 92, 0, mojo.internal.Int32, 0, false, 0, undefined),
      mojo.internal.StructField('is_first_request', 116, 1, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('print_scaling_option', 96, 0, printing.mojom.PrintScalingOptionSpec, null, false, 0, undefined),
      mojo.internal.StructField('print_to_pdf', 116, 2, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('display_header_footer', 116, 3, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('title', 40, 0, mojo_base.mojom.String16Spec, null, false, 0, undefined),
      mojo.internal.StructField('url', 48, 0, mojo_base.mojom.String16Spec, null, false, 0, undefined),
      mojo.internal.StructField('header_template', 56, 0, mojo_base.mojom.String16Spec, null, false, 0, undefined),
      mojo.internal.StructField('footer_template', 64, 0, mojo_base.mojom.String16Spec, null, false, 0, undefined),
      mojo.internal.StructField('rasterize_pdf', 116, 4, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('rasterize_pdf_dpi', 100, 0, mojo.internal.Int32, 0, false, 0, undefined),
      mojo.internal.StructField('should_print_backgrounds', 116, 5, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('printed_doc_type', 104, 0, printing.mojom.SkiaDocumentTypeSpec, null, false, 0, undefined),
      mojo.internal.StructField('prefer_css_page_size', 116, 6, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('pages_per_sheet', 108, 0, mojo.internal.Uint32, 0, false, 0, undefined),
      mojo.internal.StructField('generate_tagged_pdf_$flag', 116, 7, mojo.internal.Bool, false, false, 0, { isPrimary: true, linkedValueFieldName: 'generate_tagged_pdf_$value', originalFieldName: 'generate_tagged_pdf' }),
      mojo.internal.StructField('generate_tagged_pdf_$value', 117, 0, mojo.internal.Bool, false, false, 0, { isPrimary: false, linkedValueFieldName: 'generate_tagged_pdf_$flag', originalFieldName: 'generate_tagged_pdf' }),
      mojo.internal.StructField('generate_document_outline', 112, 0, printing.mojom.GenerateDocumentOutlineSpec, null, false, 0, undefined),
    ],
    [[0, 128]]);
...
mojo.internal.Struct(
    printing.mojom.ScriptedPrintParamsSpec, 'printing.mojom.ScriptedPrintParams', [
      ...
      mojo.internal.StructField('has_selection', 12, 0, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('is_scripted', 12, 1, mojo.internal.Bool, false, false, 0, undefined),
