  ...
  $: {
    structSpec: {
      ...
      fields: [
        ...
        { name: 'is_host_wildcard', packedOffset: 32, packedBitOffset: 0, type: mojo.internal.Bool, nullable: false },
        { name: 'is_port_wildcard', packedOffset: 32, packedBitOffset: 1, type: mojo.internal.Bool, nullable: false },
      ],
      versions: [{version: 0}]
    }
  }
  ...
  $: {
    structSpec: {
      ...
      fields: [
        ...
        { name: 'allow_self', packedOffset: 40, packedBitOffset: 0, type: mojo.internal.Bool, nullable: false },
        { name: 'allow_star', packedOffset: 40, packedBitOffset: 1, type: mojo.internal.Bool, nullable: false },
        { name: 'allow_inline', packedOffset: 40, packedBitOffset: 2, type: mojo.internal.Bool, nullable: false },
        { name: 'allow_inline_speculation_rules', packedOffset: 40, packedBitOffset: 3, type: mojo.internal.Bool, nullable: false },
        { name: 'allow_eval', packedOffset: 40, packedBitOffset: 4, type: mojo.internal.Bool, nullable: false },
        { name: 'allow_wasm_eval', packedOffset: 40, packedBitOffset: 5, type: mojo.internal.Bool, nullable: false },
        { name: 'allow_wasm_unsafe_eval', packedOffset: 40, packedBitOffset: 6, type: mojo.internal.Bool, nullable: false },
        { name: 'allow_dynamic', packedOffset: 40, packedBitOffset: 7, type: mojo.internal.Bool, nullable: false },
        { name: 'allow_dynamic_url', packedOffset: 40, packedBitOffset: 8, type: mojo.internal.Bool, nullable: false },
        { name: 'allow_unsafe_hashes', packedOffset: 40, packedBitOffset: 9, type: mojo.internal.Bool, nullable: false },
        { name: 'report_sample', packedOffset: 40, packedBitOffset: 10, type: mojo.internal.Bool, nullable: false },
        { name: 'allow_trusted_types_eval', packedOffset: 40, packedBitOffset: 11, type: mojo.internal.Bool, nullable: false },
        { name: 'report_hash_algorithm', packedOffset: 48, packedBitOffset: 0, type: network.mojom.IntegrityAlgorithmSpec, nullable: true },
      ],
      versions: [{version: 0}]
    }
  }
  ...
  $: {
    structSpec: {
      ...
      fields: [
        ...
        { name: 'upgrade_insecure_requests', packedOffset: 24, packedBitOffset: 0, type: mojo.internal.Bool, nullable: false },
        { name: 'treat_as_public_address', packedOffset: 24, packedBitOffset: 1, type: mojo.internal.Bool, nullable: false },
        { name: 'block_all_mixed_content', packedOffset: 24, packedBitOffset: 2, type: mojo.internal.Bool, nullable: false },
        { name: 'sandbox', packedOffset: 32, packedBitOffset: 0, type: network.mojom.WebSandboxFlagsSpec, nullable: false },
        { name: 'header', packedOffset: 40, packedBitOffset: 0, type: network.mojom.ContentSecurityPolicyHeaderSpec, nullable: false },
        { name: 'use_reporting_api', packedOffset: 48, packedBitOffset: 0, type: mojo.internal.Bool, nullable: false },
        { name: 'report_endpoints', packedOffset: 56, packedBitOffset: 0, type: mojo.internal.Array, nullable: false },
        { name: 'trusted_types', packedOffset: 64, packedBitOffset: 0, type: network.mojom.CSPTrustedTypesSpec, nullable: true },
        { name: 'parsing_errors', packedOffset: 72, packedBitOffset: 0, type: mojo.internal.Array, nullable: false },
      ],
      versions: [{version: 0}]
    }
  }
  ...
  $: {
    structSpec: {
      ...
      fields: [
        ...
        { name: 'use_reporting_api', packedOffset: 40, packedBitOffset: 0, type: mojo.internal.Bool, nullable: false },
        { name: 'header', packedOffset: 48, packedBitOffset: 0, type: mojo.internal.String, nullable: false },
        { name: 'type', packedOffset: 56, packedBitOffset: 0, type: network.mojom.ContentSecurityPolicyTypeSpec, nullable: false },
        { name: 'source_location', packedOffset: 64, packedBitOffset: 0, type: network.mojom.SourceLocationSpec, nullable: false },
      ],
      versions: [{version: 0}]
    }
  }
