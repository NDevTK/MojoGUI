...
mojo.internal.bindings.commerce_web_extractor.mojom.CommerceWebExtractorRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.commerce_web_extractor.mojom.CommerceWebExtractorPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.commerce_web_extractor.mojom.CommerceWebExtractorRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.commerce_web_extractor.mojom.CommerceWebExtractor.getRemote = function() {
  let remote = new mojo.internal.bindings.commerce_web_extractor.mojom.CommerceWebExtractorRemote();
...
mojo.internal.bindings.commerce_web_extractor.mojom.CommerceWebExtractorReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.commerce_web_extractor.mojom.CommerceWebExtractor_ExtractMetaInfo_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for ExtractMetaInfo failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.commerce_web_extractor.mojom.CommerceWebExtractor_ExtractMetaInfo_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.commerce_web_extractor.mojom.CommerceWebExtractorReceiver = mojo.internal.bindings.commerce_web_extractor.mojom.CommerceWebExtractorReceiver;
