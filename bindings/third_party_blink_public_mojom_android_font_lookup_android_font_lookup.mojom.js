...
mojo.internal.bindings.blink.mojom.AndroidFontLookupRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.blink.mojom.AndroidFontLookupPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.blink.mojom.AndroidFontLookupRemoteCallHandler(this.proxy);
  }
  ...
  matchLocalFontByUniqueName(arg_font_unique_name) {
    return this.$.matchLocalFontByUniqueName(arg_font_unique_name);
  }
  fetchAllFontFiles() {
...
mojo.internal.bindings.blink.mojom.AndroidFontLookup.getRemote = function() {
  let remote = new mojo.internal.bindings.blink.mojom.AndroidFontLookupRemote();
...
mojo.internal.bindings.blink.mojom.AndroidFontLookupReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.blink.mojom.AndroidFontLookup_GetUniqueNameLookupTable_ParamsSpec.$.structSpec);
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.blink.mojom.AndroidFontLookup_GetUniqueNameLookupTable_ResponseParamsSpec, header, rawHeader);
               responder(response);
        ...
        case 1: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              const rawHeader = (args[2] && args[2].slice) ? args[2].slice(0, header.headerSize) : null;
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.blink.mojom.AndroidFontLookup_MatchLocalFontByUniqueName_ResponseParamsSpec, header, rawHeader);
               responder(response);
        ...
        case 2: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.blink.mojom.AndroidFontLookup_FetchAllFontFiles_ParamsSpec.$.structSpec);
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              const rawHeader = (args[2] && args[2].slice) ? args[2].slice(0, header.headerSize) : null;
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.blink.mojom.AndroidFontLookup_FetchAllFontFiles_ResponseParamsSpec, header, rawHeader);
               responder(response);
...
mojo.internal.bindings.blink.mojom.AndroidFontLookupReceiver = mojo.internal.bindings.blink.mojom.AndroidFontLookupReceiver;
