...
mojo.internal.bindings.network.mojom.TLSClientSocketRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.network.mojom.TLSClientSocketRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.network.mojom.TLSClientSocketRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('network.mojom.TLSClientSocket', [
    ]);
  }

};

mojo.internal.bindings.network.mojom.TLSClientSocket.getRemote = function() {
  let remote = new mojo.internal.bindings.network.mojom.TLSClientSocketRemote();
...
mojo.internal.bindings.network.mojom.TLSClientSocketReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('network.mojom.TLSClientSocket', [
    ]);
...
mojo.internal.bindings.network.mojom.TLSClientSocketReceiver = mojo.internal.bindings.network.mojom.TLSClientSocketReceiver;
