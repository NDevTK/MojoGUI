...
mojo.internal.bindings.emoji_search.mojom.EmojiSearchRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.emoji_search.mojom.EmojiSearchPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.emoji_search.mojom.EmojiSearchRemoteCallHandler(this.proxy);
  }
  ...
  searchEmoji(arg_query, arg_language_codes) {
    return this.$.searchEmoji(arg_query, arg_language_codes);
  }
  loadEmojiLanguages(arg_language_codes) {
    return this.$.loadEmojiLanguages(arg_language_codes);
  }
};

mojo.internal.bindings.emoji_search.mojom.EmojiSearchRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('emoji_search.mojom.EmojiSearch', [
      { explicit: null },
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.emoji_search.mojom.EmojiSearch.getRemote = function() {
  let remote = new mojo.internal.bindings.emoji_search.mojom.EmojiSearchRemote();
...
mojo.internal.bindings.emoji_search.mojom.EmojiSearchReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('emoji_search.mojom.EmojiSearch', [
      { explicit: null },
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.emoji_search.mojom.EmojiSearch_SearchEmoji_ParamsSpec.$.structSpec);
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.emoji_search.mojom.EmojiSearch_LoadEmojiLanguages_ParamsSpec.$.structSpec);
        ...
        case 0: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.emoji_search.mojom.EmojiSearch_SearchEmoji_ResponseParamsSpec, header, rawHeader);
               responder(response);
...
mojo.internal.bindings.emoji_search.mojom.EmojiSearchReceiver = mojo.internal.bindings.emoji_search.mojom.EmojiSearchReceiver;
