...
mojo.internal.bindings.device.mojom.FingerprintError = {
  UNKNOWN: 0,
  HW_UNAVAILABLE: 1,
  UNABLE_TO_PROCESS: 2,
  TIMEOUT: 3,
...
// Enum: BiometricType
mojo.internal.bindings.device.mojom.BiometricType = {
  UNKNOWN: 0,
  FINGERPRINT: 1,
};

// Enum: BiometricsManagerStatus
mojo.internal.bindings.device.mojom.BiometricsManagerStatus = {
  UNKNOWN: 0,
  INITIALIZED: 1,
};
...
mojo.internal.Struct(
    mojo.internal.bindings.device.mojom.FingerprintObserver_OnEnrollScanDone_ParamsSpec, 'device.mojom.FingerprintObserver_OnEnrollScanDone_Params', [
      ...
      mojo.internal.StructField('arg_percent_complete', 4, 0, mojo.internal.Int32, 0, false, 0, undefined),
      mojo.internal.StructField('arg_is_complete', 8, 0, mojo.internal.Bool, false, false, 0, undefined),
    ],
    [[0, 24]]);
...
mojo.internal.bindings.device.mojom.FingerprintObserverRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.device.mojom.FingerprintObserverPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.device.mojom.FingerprintObserverRemoteCallHandler(this.proxy);
  }
  ...
  onStatusChanged(arg_status) {
    return this.$.onStatusChanged(arg_status);
  }
  onEnrollScanDone(arg_scan_result, arg_is_complete, arg_percent_complete) {
    return this.$.onEnrollScanDone(arg_scan_result, arg_is_complete, arg_percent_complete);
  }
  onAuthScanDone(arg_msg, arg_matches) {
    return this.$.onAuthScanDone(arg_msg, arg_matches);
  }
  onSessionFailed() {
...
mojo.internal.bindings.device.mojom.FingerprintObserverRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('device.mojom.FingerprintObserver', [
      { explicit: null },
      { explicit: null },
      { explicit: null },
      { explicit: null },
...
mojo.internal.bindings.device.mojom.FingerprintObserver.getRemote = function() {
  let remote = new mojo.internal.bindings.device.mojom.FingerprintObserverRemote();
...
mojo.internal.bindings.device.mojom.FingerprintObserverReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('device.mojom.FingerprintObserver', [
      { explicit: null },
      { explicit: null },
      { explicit: null },
      { explicit: null },
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.device.mojom.FingerprintObserver_OnRestarted_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OnRestarted failed with TypeError');
           }
        }
        // Try Method 1: OnStatusChanged
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.device.mojom.FingerprintObserver_OnStatusChanged_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OnStatusChanged failed with TypeError');
           }
        }
        // Try Method 2: OnEnrollScanDone
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.device.mojom.FingerprintObserver_OnEnrollScanDone_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OnEnrollScanDone failed with TypeError');
           }
        }
        // Try Method 3: OnAuthScanDone
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.device.mojom.FingerprintObserver_OnAuthScanDone_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OnAuthScanDone failed with TypeError');
           }
        }
        // Try Method 4: OnSessionFailed
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.device.mojom.FingerprintObserver_OnSessionFailed_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OnSessionFailed failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.device.mojom.FingerprintObserver_OnRestarted_ParamsSpec.$.structSpec);
        ...
        case 4: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.device.mojom.FingerprintObserver_OnSessionFailed_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.device.mojom.FingerprintObserverReceiver = mojo.internal.bindings.device.mojom.FingerprintObserverReceiver;

mojo.internal.bindings.device.mojom.FingerprintObserverPtr = mojo.internal.bindings.device.mojom.FingerprintObserverRemote;
mojo.internal.bindings.device.mojom.FingerprintObserverRequest = mojo.internal.bindings.device.mojom.FingerprintObserverPendingReceiver;
...
mojo.internal.bindings.device.mojom.FingerprintRemote = class {
  static get $interfaceName() {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.device.mojom.FingerprintPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.device.mojom.FingerprintRemoteCallHandler(this.proxy);
  }
  ...
  getRecordsForUser(arg_user_id) {
    return this.$.getRecordsForUser(arg_user_id);
  }
  startEnrollSession(arg_user_id, arg_label) {
    return this.$.startEnrollSession(arg_user_id, arg_label);
  }
  cancelCurrentEnrollSession() {
    return this.$.cancelCurrentEnrollSession();
  }
  requestRecordLabel(arg_record_path) {
    return this.$.requestRecordLabel(arg_record_path);
  }
  setRecordLabel(arg_record_path, arg_new_label) {
    return this.$.setRecordLabel(arg_record_path, arg_new_label);
  }
  removeRecord(arg_record_path) {
    return this.$.removeRecord(arg_record_path);
  }
  startAuthSession() {
  ...
  addFingerprintObserver(arg_observer) {
    return this.$.addFingerprintObserver(arg_observer);
  }
  requestType() {
...
mojo.internal.bindings.device.mojom.FingerprintRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('device.mojom.Fingerprint', [
      { explicit: null },
      { explicit: null },
      { explicit: null },
      { explicit: null },
...
mojo.internal.bindings.device.mojom.Fingerprint.getRemote = function() {
  let remote = new mojo.internal.bindings.device.mojom.FingerprintRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
...
mojo.internal.bindings.device.mojom.FingerprintReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('device.mojom.Fingerprint', [
      { explicit: null },
      { explicit: null },
      { explicit: null },
      { explicit: null },
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.device.mojom.Fingerprint_GetRecordsForUser_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for GetRecordsForUser failed with TypeError');
           }
        }
        // Try Method 1: StartEnrollSession
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.device.mojom.Fingerprint_StartEnrollSession_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for StartEnrollSession failed with TypeError');
           }
        }
        // Try Method 2: CancelCurrentEnrollSession
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.device.mojom.Fingerprint_CancelCurrentEnrollSession_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for CancelCurrentEnrollSession failed with TypeError');
           }
        }
        // Try Method 3: RequestRecordLabel
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.device.mojom.Fingerprint_RequestRecordLabel_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for RequestRecordLabel failed with TypeError');
           }
        }
        // Try Method 4: SetRecordLabel
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.device.mojom.Fingerprint_SetRecordLabel_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for SetRecordLabel failed with TypeError');
           }
        }
        // Try Method 5: RemoveRecord
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.device.mojom.Fingerprint_RemoveRecord_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for RemoveRecord failed with TypeError');
           }
        }
        // Try Method 6: StartAuthSession
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.device.mojom.Fingerprint_StartAuthSession_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for StartAuthSession failed with TypeError');
           }
        }
        // Try Method 7: EndCurrentAuthSession
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.device.mojom.Fingerprint_EndCurrentAuthSession_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for EndCurrentAuthSession failed with TypeError');
           }
        }
        // Try Method 8: DestroyAllRecords
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.device.mojom.Fingerprint_DestroyAllRecords_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for DestroyAllRecords failed with TypeError');
           }
        }
        // Try Method 9: AddFingerprintObserver
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.device.mojom.Fingerprint_AddFingerprintObserver_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for AddFingerprintObserver failed with TypeError');
           }
        }
        // Try Method 10: RequestType
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.device.mojom.Fingerprint_RequestType_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for RequestType failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
             console.warn('[GeneratedReceiver] Failed to discover ordinal ' + header.ordinal);
      ...
      switch (dispatchId) {
        ...
        case 2: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.device.mojom.Fingerprint_CancelCurrentEnrollSession_ParamsSpec.$.structSpec);
        ...
        case 6: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.device.mojom.Fingerprint_StartAuthSession_ParamsSpec.$.structSpec);
        ...
        case 7: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.device.mojom.Fingerprint_EndCurrentAuthSession_ParamsSpec.$.structSpec);
        ...
        case 8: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.device.mojom.Fingerprint_DestroyAllRecords_ParamsSpec.$.structSpec);
        ...
        case 10: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.device.mojom.Fingerprint_RequestType_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.device.mojom.FingerprintReceiver = mojo.internal.bindings.device.mojom.FingerprintReceiver;
