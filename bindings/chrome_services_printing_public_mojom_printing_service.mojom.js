...
mojo.internal.bindings.printing.mojom.PrintingServiceRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.printing.mojom.PrintingServicePendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.printing.mojom.PrintingServiceRemoteCallHandler(this.proxy);
  }
  ...
  bindPdfNupConverter(arg_receiver) {
    return this.$.bindPdfNupConverter(arg_receiver);
  }
...
mojo.internal.bindings.printing.mojom.PrintingServiceRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
...
mojo.internal.bindings.printing.mojom.PrintingService.getRemote = function() {
  let remote = new mojo.internal.bindings.printing.mojom.PrintingServiceRemote();
...
mojo.internal.bindings.printing.mojom.PrintingServiceReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.printing.mojom.PrintingService_BindPdfNupConverter_ParamsSpec.$.structSpec);
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.printing.mojom.PrintingService_BindPdfToPwgRasterConverter_ParamsSpec.$.structSpec);
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.printing.mojom.PrintingService_BindPdfFlattener_ParamsSpec.$.structSpec);
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.printing.mojom.PrintingService_BindPdfToEmfConverterFactory_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.printing.mojom.PrintingServiceReceiver = mojo.internal.bindings.printing.mojom.PrintingServiceReceiver;
