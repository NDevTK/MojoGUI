...
mojo.internal.bindings.blink.mojom.SubresourceLoaderUpdater = {};
mojo.internal.bindings.blink.mojom.SubresourceLoaderUpdaterSpec = { $ : {} };
...
mojo.internal.bindings.blink.mojom.SubresourceLoaderUpdaterRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.blink.mojom.SubresourceLoaderUpdaterPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.blink.mojom.SubresourceLoaderUpdaterRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.blink.mojom.SubresourceLoaderUpdaterRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('blink.mojom.SubresourceLoaderUpdater', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.blink.mojom.SubresourceLoaderUpdater.getRemote = function() {
  let remote = new mojo.internal.bindings.blink.mojom.SubresourceLoaderUpdaterRemote();
...
mojo.internal.bindings.blink.mojom.SubresourceLoaderUpdaterReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('blink.mojom.SubresourceLoaderUpdater', [
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        // Try Method 0: UpdateSubresourceLoaderFactories
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.blink.mojom.SubresourceLoaderUpdater_UpdateSubresourceLoaderFactories_ParamsSpec.$.structSpec;
             ...
             if (sizeMatch && (!!(header.flags & 1) === methodExpectsResp)) {
               if (size > 8 || message.payload.byteLength === 8) {
                 ...
                 console.log('[GeneratedReceiver] Discovery SUCCESS: ' + header.ordinal + ' -> UpdateSubresourceLoaderFactories (0)');
                 this.mapOrdinal(header.ordinal, 0);
                 dispatchId = 0;
               }
             }
           } catch (e) {
             if (e instanceof TypeError) console.warn('[Discovery] trial for UpdateSubresourceLoaderFactories failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.blink.mojom.SubresourceLoaderUpdaterReceiver = mojo.internal.bindings.blink.mojom.SubresourceLoaderUpdaterReceiver;
