...
blink.mojom.CloneableMessageSpec = {
  $: {
    structSpec: {
      ...
      packedSize: 80,
      fields: [
        { name: 'encoded_message', packedOffset: 0, packedBitOffset: 0, type: mojo.internal.Pointer, nullable: false },
        { name: 'blobs', packedOffset: 8, packedBitOffset: 0, type: mojo.internal.Array, nullable: false },
        { name: 'sender_origin', packedOffset: 16, packedBitOffset: 0, type: mojo.internal.Pointer, nullable: true },
        ...
        { name: 'sender_agent_cluster_id', packedOffset: 48, packedBitOffset: 0, type: mojo.internal.Pointer, nullable: false },
