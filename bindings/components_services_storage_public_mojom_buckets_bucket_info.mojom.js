  ...
  $: {
    structSpec: {
      ...
      fields: [
        ...
        { name: 'quota', packedOffset: 40, packedBitOffset: 0, type: mojo.internal.Uint64, nullable: false },
        { name: 'persistent', packedOffset: 48, packedBitOffset: 0, type: mojo.internal.Bool, nullable: false },
        { name: 'durability', packedOffset: 56, packedBitOffset: 0, type: blink.mojom.BucketDurabilitySpec, nullable: false },
      ],
      versions: [{version: 0}]
    }
  }
