...
mojo.internal.Struct(
    mojo.internal.bindings.media.mojom.PlaybackPropertiesSpec, 'media.mojom.PlaybackProperties', [
      ...
      mojo.internal.StructField('arg_demuxer_type', 16, 0, mojo.internal.bindings.media.mojom.DemuxerTypeSpec.$, null, false, 0, undefined),
      mojo.internal.StructField('arg_has_audio', 24, 0, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_has_video', 24, 1, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_is_background', 24, 2, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_is_muted', 24, 3, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_is_eme', 24, 4, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_is_embedded_media_experience', 24, 5, mojo.internal.Bool, false, false, 0, undefined),
    ],
    [[0, 40]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.media.mojom.SecondaryPlaybackPropertiesSpec, 'media.mojom.SecondaryPlaybackProperties', [
      ...
      mojo.internal.StructField('arg_video_codec', 8, 0, mojo.internal.bindings.media.mojom.VideoCodecSpec.$, null, false, 0, undefined),
      ...
      mojo.internal.StructField('arg_video_codec_profile', 24, 0, mojo.internal.bindings.media.mojom.VideoCodecProfileSpec.$, null, false, 0, undefined),
      mojo.internal.StructField('arg_audio_decoder', 32, 0, mojo.internal.bindings.media.mojom.AudioDecoderTypeSpec.$, null, false, 0, undefined),
      mojo.internal.StructField('arg_video_decoder', 40, 0, mojo.internal.bindings.media.mojom.VideoDecoderTypeSpec.$, null, false, 0, undefined),
      mojo.internal.StructField('arg_audio_encryption_scheme', 48, 0, mojo.internal.bindings.media.mojom.EncryptionSchemeSpec.$, null, false, 0, undefined),
      mojo.internal.StructField('arg_video_encryption_scheme', 56, 0, mojo.internal.bindings.media.mojom.EncryptionSchemeSpec.$, null, false, 0, undefined),
      mojo.internal.StructField('arg_natural_size', 64, 0, mojo.internal.bindings.gfx.mojom.SizeSpec.$, null, false, 0, undefined),
    ],
    [[0, 80]]);
...
mojo.internal.bindings.media.mojom.WatchTimeRecorderRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.media.mojom.WatchTimeRecorderRemoteCallHandler(this.proxy);
  }
  ...
  updateVideoDecodeStats(arg_frames_decoded, arg_frames_dropped) {
    return this.$.updateVideoDecodeStats(arg_frames_decoded, arg_frames_dropped);
  }
  ...
  updateUnderflowDuration(arg_total_completed_count, arg_total_duration) {
    return this.$.updateUnderflowDuration(arg_total_completed_count, arg_total_duration);
  }
};
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.media.mojom.WatchTimeRecorder_RecordWatchTime_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for RecordWatchTime failed with TypeError');
           }
        }
        // Try Method 1: FinalizeWatchTime
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.media.mojom.WatchTimeRecorder_FinalizeWatchTime_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for FinalizeWatchTime failed with TypeError');
           }
        }
        // Try Method 2: OnError
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.media.mojom.WatchTimeRecorder_OnError_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.media.mojom.WatchTimeRecorder_UpdateSecondaryProperties_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for UpdateSecondaryProperties failed with TypeError');
           }
        }
        // Try Method 4: SetAutoplayInitiated
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.media.mojom.WatchTimeRecorder_SetAutoplayInitiated_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for SetAutoplayInitiated failed with TypeError');
           }
        }
        // Try Method 5: OnDurationChanged
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.media.mojom.WatchTimeRecorder_OnDurationChanged_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OnDurationChanged failed with TypeError');
           }
        }
        // Try Method 6: UpdateVideoDecodeStats
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.media.mojom.WatchTimeRecorder_UpdateVideoDecodeStats_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for UpdateVideoDecodeStats failed with TypeError');
           }
        }
        // Try Method 7: UpdateUnderflowCount
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.media.mojom.WatchTimeRecorder_UpdateUnderflowCount_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for UpdateUnderflowCount failed with TypeError');
           }
        }
        // Try Method 8: UpdateUnderflowDuration
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.media.mojom.WatchTimeRecorder_UpdateUnderflowDuration_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for UpdateUnderflowDuration failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.media.mojom.WatchTimeRecorderReceiver = mojo.internal.bindings.media.mojom.WatchTimeRecorderReceiver;
