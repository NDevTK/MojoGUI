...
mojo.internal.bindings.device.mojom.Geolocation = {};
mojo.internal.bindings.device.mojom.GeolocationSpec = { $ : {} };
mojo.internal.bindings.device.mojom.Geolocation.$interfaceName = 'device.mojom.Geolocation';
...
mojo.internal.bindings.device.mojom.GeolocationRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.device.mojom.GeolocationPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.device.mojom.GeolocationRemoteCallHandler(this.proxy);
  }
  ...
  setHighAccuracyHint(arg_high_accuracy) {
    return this.$.setHighAccuracyHint(arg_high_accuracy);
  }
  queryNextPosition() {
...
mojo.internal.bindings.device.mojom.GeolocationRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('device.mojom.Geolocation', [
      { explicit: null },
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.device.mojom.Geolocation.getRemote = function() {
  let remote = new mojo.internal.bindings.device.mojom.GeolocationRemote();
...
mojo.internal.bindings.device.mojom.GeolocationReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('device.mojom.Geolocation', [
      { explicit: null },
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.device.mojom.Geolocation_SetHighAccuracyHint_ParamsSpec.$.structSpec);
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.device.mojom.Geolocation_QueryNextPosition_ParamsSpec.$.structSpec);
      ...
      switch (dispatchId) {
        ...
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.device.mojom.Geolocation_QueryNextPosition_ParamsSpec.$.structSpec);
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.device.mojom.Geolocation_QueryNextPosition_ResponseParamsSpec, header, rawHeader);
               responder(response);
...
mojo.internal.bindings.device.mojom.GeolocationReceiver = mojo.internal.bindings.device.mojom.GeolocationReceiver;
