...
blink.mojom.StorageAccessHandle_Estimate_ResponseParamsSpec = {
  $: {
    structSpec: {
      ...
      packedSize: 32,
      fields: [
        { name: 'current_usage', packedOffset: 8, packedBitOffset: 0, type: mojo_base.mojom.ByteCountSpec, nullable: false },
        { name: 'current_quota', packedOffset: 16, packedBitOffset: 0, type: mojo_base.mojom.ByteCountSpec, nullable: false },
