...
mojo.internal.Struct(
    mojo.internal.bindings.blink.mojom.FileChooserParamsSpec, 'blink.mojom.FileChooserParams', [
      ...
      mojo.internal.StructField('arg_need_local_path', 48, 0, mojo.internal.Bool, true, false, 0, undefined),
      mojo.internal.StructField('arg_use_media_capture', 48, 1, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_open_writable', 48, 2, mojo.internal.Bool, false, false, 0, undefined),
    ],
    [[0, 64]]);
...
mojo.internal.bindings.blink.mojom.FileChooserRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.blink.mojom.FileChooserPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.blink.mojom.FileChooserRemoteCallHandler(this.proxy);
  }
  ...
  openFileChooser(arg_params) {
    return this.$.openFileChooser(arg_params);
  }
  enumerateChosenDirectory(arg_directory_path) {
    return this.$.enumerateChosenDirectory(arg_directory_path);
  }
};

mojo.internal.bindings.blink.mojom.FileChooserRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('blink.mojom.FileChooser', [
      { explicit: null },
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.blink.mojom.FileChooser.getRemote = function() {
  let remote = new mojo.internal.bindings.blink.mojom.FileChooserRemote();
...
mojo.internal.bindings.blink.mojom.FileChooserReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('blink.mojom.FileChooser', [
      { explicit: null },
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.blink.mojom.FileChooser_OpenFileChooser_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OpenFileChooser failed with TypeError');
           }
        }
        // Try Method 1: EnumerateChosenDirectory
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.blink.mojom.FileChooser_EnumerateChosenDirectory_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for EnumerateChosenDirectory failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.blink.mojom.FileChooserReceiver = mojo.internal.bindings.blink.mojom.FileChooserReceiver;
