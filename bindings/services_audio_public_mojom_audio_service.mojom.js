...
mojo.internal.bindings.audio.mojom.AudioServiceRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.audio.mojom.AudioServicePendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.audio.mojom.AudioServiceRemoteCallHandler(this.proxy);
  }
  ...
  bindSystemInfo(arg_receiver) {
    return this.$.bindSystemInfo(arg_receiver);
  }
  bindDebugRecording(arg_receiver) {
    return this.$.bindDebugRecording(arg_receiver);
  }
  bindStreamFactory(arg_receiver) {
    return this.$.bindStreamFactory(arg_receiver);
  }
  bindDeviceNotifier(arg_receiver) {
    return this.$.bindDeviceNotifier(arg_receiver);
  }
  bindLogFactoryManager(arg_receiver) {
    return this.$.bindLogFactoryManager(arg_receiver);
  }
  bindTestingApi(arg_receiver) {
    return this.$.bindTestingApi(arg_receiver);
  }
  bindMlModelManager(arg_receiver) {
    return this.$.bindMlModelManager(arg_receiver);
  }
};
...
mojo.internal.bindings.audio.mojom.AudioService.getRemote = function() {
  let remote = new mojo.internal.bindings.audio.mojom.AudioServiceRemote();
...
mojo.internal.bindings.audio.mojom.AudioServiceReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.audio.mojom.AudioService_BindSystemInfo_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for BindSystemInfo failed with TypeError');
           }
        }
        // Try Method 1: BindDebugRecording
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.audio.mojom.AudioService_BindDebugRecording_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for BindDebugRecording failed with TypeError');
           }
        }
        // Try Method 2: BindStreamFactory
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.audio.mojom.AudioService_BindStreamFactory_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for BindStreamFactory failed with TypeError');
           }
        }
        // Try Method 3: BindDeviceNotifier
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.audio.mojom.AudioService_BindDeviceNotifier_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for BindDeviceNotifier failed with TypeError');
           }
        }
        // Try Method 4: BindLogFactoryManager
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.audio.mojom.AudioService_BindLogFactoryManager_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for BindLogFactoryManager failed with TypeError');
           }
        }
        // Try Method 5: BindTestingApi
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.audio.mojom.AudioService_BindTestingApi_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for BindTestingApi failed with TypeError');
           }
        }
        // Try Method 6: BindMlModelManager
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.audio.mojom.AudioService_BindMlModelManager_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for BindMlModelManager failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.audio.mojom.AudioServiceReceiver = mojo.internal.bindings.audio.mojom.AudioServiceReceiver;
