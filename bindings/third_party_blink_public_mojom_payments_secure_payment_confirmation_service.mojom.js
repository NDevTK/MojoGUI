...
mojo.internal.bindings.blink.mojom.AuthenticatorStatusSpec = mojo.internal.bindings.blink.mojom.AuthenticatorStatusSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.blink = mojo.internal.bindings.blink || {};
mojo.internal.bindings.blink.mojom = mojo.internal.bindings.blink.mojom || {};
mojo.internal.bindings.blink.mojom.MakeCredentialAuthenticatorResponseSpec = mojo.internal.bindings.blink.mojom.MakeCredentialAuthenticatorResponseSpec || { $: mojo.internal.OpaqueStruct.$ };
mojo.internal.bindings.blink = mojo.internal.bindings.blink || {};
mojo.internal.bindings.blink.mojom = mojo.internal.bindings.blink.mojom || {};
mojo.internal.bindings.blink.mojom.PublicKeyCredentialCreationOptionsSpec = mojo.internal.bindings.blink.mojom.PublicKeyCredentialCreationOptionsSpec || { $: mojo.internal.OpaqueStruct.$ };
mojo.internal.bindings.blink = mojo.internal.bindings.blink || {};
mojo.internal.bindings.blink.mojom = mojo.internal.bindings.blink.mojom || {};
mojo.internal.bindings.blink.mojom.WebAuthnDOMExceptionDetailsSpec = mojo.internal.bindings.blink.mojom.WebAuthnDOMExceptionDetailsSpec || { $: mojo.internal.OpaqueStruct.$ };

// Enum: PaymentCredentialStorageStatus
mojo.internal.bindings.payments.mojom.PaymentCredentialStorageStatus = {
  SUCCESS: 0,
  FAILED_TO_STORE_CREDENTIAL: 1,
};

// Enum: SecurePaymentConfirmationAvailabilityEnum
mojo.internal.bindings.payments.mojom.SecurePaymentConfirmationAvailabilityEnum = {
  kAvailable: 0,
...
mojo.internal.bindings.payments.mojom.SecurePaymentConfirmationServiceRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.payments.mojom.SecurePaymentConfirmationServicePendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.payments.mojom.SecurePaymentConfirmationServiceRemoteCallHandler(this.proxy);
  }
  ...
  storePaymentCredential(arg_credential_id, arg_rp_id, arg_user_id) {
    return this.$.storePaymentCredential(arg_credential_id, arg_rp_id, arg_user_id);
  }
  makePaymentCredential(arg_options) {
    return this.$.makePaymentCredential(arg_options);
  }
};

mojo.internal.bindings.payments.mojom.SecurePaymentConfirmationServiceRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('payments.mojom.SecurePaymentConfirmationService', [
      { explicit: null },
      { explicit: null },
      { explicit: null },
    ]);
...
mojo.internal.bindings.payments.mojom.SecurePaymentConfirmationService.getRemote = function() {
  let remote = new mojo.internal.bindings.payments.mojom.SecurePaymentConfirmationServiceRemote();
...
mojo.internal.bindings.payments.mojom.SecurePaymentConfirmationServiceReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('payments.mojom.SecurePaymentConfirmationService', [
      { explicit: null },
      { explicit: null },
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.payments.mojom.SecurePaymentConfirmationService_SecurePaymentConfirmationAvailability_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for SecurePaymentConfirmationAvailability failed with TypeError');
           }
        }
        // Try Method 1: StorePaymentCredential
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.payments.mojom.SecurePaymentConfirmationService_StorePaymentCredential_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for StorePaymentCredential failed with TypeError');
           }
        }
        // Try Method 2: MakePaymentCredential
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.payments.mojom.SecurePaymentConfirmationService_MakePaymentCredential_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for MakePaymentCredential failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.payments.mojom.SecurePaymentConfirmationService_SecurePaymentConfirmationAvailability_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.payments.mojom.SecurePaymentConfirmationServiceReceiver = mojo.internal.bindings.payments.mojom.SecurePaymentConfirmationServiceReceiver;
