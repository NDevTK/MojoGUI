...
mojo.internal.bindings.content.mojom.TestService_GetPseudonymizationSalt_ParamsSpec = mojo.internal.bindings.content.mojom.TestService_GetPseudonymizationSalt_ParamsSpec || { $: {} };
...
if (mojo.internal.bindings.content.mojom.TestService_IsPseudonymizationSaltInitialized_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.content.mojom.TestService_IsPseudonymizationSaltInitialized_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.content.mojom.TestService_IsPseudonymizationSaltInitialized_ResponseParamsSpec.$ = {};
...
mojo.internal.bindings.content.mojom.TestService_VerifyCheckIsTest_ParamsSpec = mojo.internal.bindings.content.mojom.TestService_VerifyCheckIsTest_ParamsSpec || { $: {} };
if (mojo.internal.bindings.content.mojom.TestService_VerifyCheckIsTest_ParamsSpec.$.structSpec && mojo.internal.bindings.content.mojom.TestService_VerifyCheckIsTest_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.content.mojom.TestService_VerifyCheckIsTest_ParamsSpec.$ = {};
mojo.internal.bindings.content.mojom.TestService_VerifyCheckIsTest_ResponseParamsSpec = mojo.internal.bindings.content.mojom.TestService_VerifyCheckIsTest_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.content.mojom.TestService_VerifyCheckIsTest_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.content.mojom.TestService_VerifyCheckIsTest_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.content.mojom.TestService_VerifyCheckIsTest_ResponseParamsSpec.$ = {};
...
mojo.internal.bindings.mojo_base = mojo.internal.bindings.mojo_base || {};
mojo.internal.bindings.mojo_base.mojom = mojo.internal.bindings.mojo_base.mojom || {};
mojo.internal.bindings.mojo_base.mojom.WritableSharedMemoryRegionSpec = mojo.internal.bindings.mojo_base.mojom.WritableSharedMemoryRegionSpec || { $: mojo.internal.OpaqueStruct.$ };
...
mojo.internal.bindings.content.mojom.TestServiceRemoteCallHandler = class {
  ...
  getPseudonymizationSalt() {
    return this.proxy.sendMessage(
      ...
      mojo.internal.bindings.content.mojom.TestService_GetPseudonymizationSalt_ParamsSpec,
      mojo.internal.bindings.content.mojom.TestService_GetPseudonymizationSalt_ResponseParamsSpec,
      [],
      false);
  }
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const message = new mojo.internal.Message(
                ...
                header.ordinal, header.requestId, mojo.internal.bindings.content.mojom.TestService_DoSomething_ResponseParamsSpec.$.structSpec, resp_obj);
        ...
        case 1: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.content.mojom.TestService_DoTerminateProcess_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
        ...
        case 2: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.content.mojom.TestService_DoCrashImmediately_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
        ...
        case 3: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.content.mojom.TestService_CreateFolder_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
        ...
        case 4: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.content.mojom.TestService_GetRequestorName_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
        ...
        case 5: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.content.mojom.TestService_CreateReadOnlySharedMemoryRegion_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
        ...
        case 6: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.content.mojom.TestService_CreateWritableSharedMemoryRegion_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
        ...
        case 7: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.content.mojom.TestService_CreateUnsafeSharedMemoryRegion_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
        ...
        case 8: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const resp_obj = { 'arg_new_region': val };
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.content.mojom.TestService_CloneSharedMemoryContents_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
        ...
        case 9: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const resp_obj = { 'arg_is_sandboxed': val };
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.content.mojom.TestService_IsProcessSandboxed_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
        ...
        case 10: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.content.mojom.TestService_PseudonymizeString_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
        ...
        case 11: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.content.mojom.TestService_GetPseudonymizationSalt_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.getPseudonymizationSalt');
          const result = this.impl.getPseudonymizationSalt();
          const expectsResponse = header.expectsResponse || (header.flags & 1);
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              const val = (response && typeof response === 'object' && 'arg_salt' in response) ? response['arg_salt'] : response;
              const resp_obj = { 'arg_salt': val };
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.content.mojom.TestService_GetPseudonymizationSalt_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
            }).catch(e => console.error('[GeneratedReceiver] getPseudonymizationSalt FAILED:', e));
          }
          break;
        }
        case 12: {
        ...
        case 13: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.content.mojom.TestService_IsPseudonymizationSaltInitialized_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
            }).catch(e => console.error('[GeneratedReceiver] isPseudonymizationSaltInitialized FAILED:', e));
          }
          break;
        }
        case 14: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.content.mojom.TestService_PassWriteableFile_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
        ...
        case 15: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.content.mojom.TestService_VerifyCheckIsTest_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
...
mojo.internal.Struct(
    mojo.internal.bindings.content.mojom.TestService_GetPseudonymizationSalt_ParamsSpec, 'content.mojom.TestService_GetPseudonymizationSalt_Params', [
    ],
    [[0, 8]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.content.mojom.TestService_IsPseudonymizationSaltInitialized_ParamsSpec, 'content.mojom.TestService_IsPseudonymizationSaltInitialized_Params', [
    ],
    [[0, 8]]);

mojo.internal.Struct(
    mojo.internal.bindings.content.mojom.TestService_IsPseudonymizationSaltInitialized_ResponseParamsSpec, 'content.mojom.TestService_IsPseudonymizationSaltInitialized_ResponseParams', [
      mojo.internal.StructField('arg_is_initialized', 0, 0, mojo.internal.Bool, false, false, 0, undefined),
    ],
    [[0, 16]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.content.mojom.TestService_VerifyCheckIsTest_ParamsSpec, 'content.mojom.TestService_VerifyCheckIsTest_Params', [
    ],
    [[0, 8]]);

mojo.internal.Struct(
    mojo.internal.bindings.content.mojom.TestService_VerifyCheckIsTest_ResponseParamsSpec, 'content.mojom.TestService_VerifyCheckIsTest_ResponseParams', [
      mojo.internal.StructField('arg_succeeded', 0, 0, mojo.internal.Bool, false, false, 0, undefined),
    ],
    [[0, 16]]);
