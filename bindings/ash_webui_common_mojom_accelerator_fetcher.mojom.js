...
mojo.internal.bindings.ash = mojo.internal.bindings.ash || {};
mojo.internal.bindings.ash.mojom = mojo.internal.bindings.ash.mojom || {};
mojo.internal.bindings.ash.mojom.StandardAcceleratorPropertiesSpec = mojo.internal.bindings.ash.mojom.StandardAcceleratorPropertiesSpec || { $: mojo.internal.OpaqueStruct.$ };
mojo.internal.bindings.ui = mojo.internal.bindings.ui || {};
...
mojo.internal.bindings.ash.common.mojom.AcceleratorFetcherObserverRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.ash.common.mojom.AcceleratorFetcherObserverPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.ash.common.mojom.AcceleratorFetcherObserverRemoteCallHandler(this.proxy);
  }
  ...
  onAcceleratorsUpdated(arg_actionId, arg_accelerators) {
    return this.$.onAcceleratorsUpdated(arg_actionId, arg_accelerators);
  }
};
...
mojo.internal.bindings.ash.common.mojom.AcceleratorFetcherObserver.getRemote = function() {
  let remote = new mojo.internal.bindings.ash.common.mojom.AcceleratorFetcherObserverRemote();
...
mojo.internal.bindings.ash.common.mojom.AcceleratorFetcherObserverReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ash.common.mojom.AcceleratorFetcherObserver_OnAcceleratorsUpdated_ParamsSpec.$.structSpec;
...
mojo.internal.bindings.ash.common.mojom.AcceleratorFetcherObserverReceiver = mojo.internal.bindings.ash.common.mojom.AcceleratorFetcherObserverReceiver;

mojo.internal.bindings.ash.common.mojom.AcceleratorFetcherObserverPtr = mojo.internal.bindings.ash.common.mojom.AcceleratorFetcherObserverRemote;
mojo.internal.bindings.ash.common.mojom.AcceleratorFetcherObserverRequest = mojo.internal.bindings.ash.common.mojom.AcceleratorFetcherObserverPendingReceiver;
...
mojo.internal.bindings.ash.common.mojom.AcceleratorFetcherRemote = class {
  static get $interfaceName() {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.ash.common.mojom.AcceleratorFetcherPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.ash.common.mojom.AcceleratorFetcherRemoteCallHandler(this.proxy);
  }
  ...
  observeAcceleratorChanges(arg_actionIds, arg_observer) {
    return this.$.observeAcceleratorChanges(arg_actionIds, arg_observer);
  }
  getMetaKeyToDisplay() {
...
mojo.internal.bindings.ash.common.mojom.AcceleratorFetcher.getRemote = function() {
  let remote = new mojo.internal.bindings.ash.common.mojom.AcceleratorFetcherRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
...
mojo.internal.bindings.ash.common.mojom.AcceleratorFetcherReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ash.common.mojom.AcceleratorFetcher_ObserveAcceleratorChanges_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for ObserveAcceleratorChanges failed with TypeError');
           }
        }
        // Try Method 1: GetMetaKeyToDisplay
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ash.common.mojom.AcceleratorFetcher_GetMetaKeyToDisplay_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
      ...
      switch (dispatchId) {
        ...
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.ash.common.mojom.AcceleratorFetcher_GetMetaKeyToDisplay_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.ash.common.mojom.AcceleratorFetcherReceiver = mojo.internal.bindings.ash.common.mojom.AcceleratorFetcherReceiver;
