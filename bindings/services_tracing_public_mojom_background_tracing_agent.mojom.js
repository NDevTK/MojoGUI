...
mojo.internal.bindings.tracing.mojom.BackgroundTracingAgentClientRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.tracing.mojom.BackgroundTracingAgentClientPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.tracing.mojom.BackgroundTracingAgentClientRemoteCallHandler(this.proxy);
  }
  ...
  onTriggerBackgroundTrace(arg_rule, arg_histogram_value, arg_flow_id) {
    return this.$.onTriggerBackgroundTrace(arg_rule, arg_histogram_value, arg_flow_id);
  }
};
...
mojo.internal.bindings.tracing.mojom.BackgroundTracingAgentClient.getRemote = function() {
  let remote = new mojo.internal.bindings.tracing.mojom.BackgroundTracingAgentClientRemote();
...
mojo.internal.bindings.tracing.mojom.BackgroundTracingAgentClientReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.tracing.mojom.BackgroundTracingAgentClient_OnInitialized_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OnInitialized failed with TypeError');
           }
        }
        // Try Method 1: OnTriggerBackgroundTrace
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.tracing.mojom.BackgroundTracingAgentClient_OnTriggerBackgroundTrace_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OnTriggerBackgroundTrace failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.tracing.mojom.BackgroundTracingAgentClient_OnInitialized_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.tracing.mojom.BackgroundTracingAgentClientReceiver = mojo.internal.bindings.tracing.mojom.BackgroundTracingAgentClientReceiver;

mojo.internal.bindings.tracing.mojom.BackgroundTracingAgentClientPtr = mojo.internal.bindings.tracing.mojom.BackgroundTracingAgentClientRemote;
mojo.internal.bindings.tracing.mojom.BackgroundTracingAgentClientRequest = mojo.internal.bindings.tracing.mojom.BackgroundTracingAgentClientPendingReceiver;
...
mojo.internal.bindings.tracing.mojom.BackgroundTracingAgentRemote = class {
  static get $interfaceName() {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.tracing.mojom.BackgroundTracingAgentPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.tracing.mojom.BackgroundTracingAgentRemoteCallHandler(this.proxy);
  }
  ...
  setUMACallback(arg_rule, arg_histogram_name, arg_histogram_lower_value, arg_histogram_upper_value) {
    return this.$.setUMACallback(arg_rule, arg_histogram_name, arg_histogram_lower_value, arg_histogram_upper_value);
  }
  clearUMACallback(arg_rule) {
    return this.$.clearUMACallback(arg_rule);
  }
};
...
mojo.internal.bindings.tracing.mojom.BackgroundTracingAgent.getRemote = function() {
  let remote = new mojo.internal.bindings.tracing.mojom.BackgroundTracingAgentRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
...
mojo.internal.bindings.tracing.mojom.BackgroundTracingAgentReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.tracing.mojom.BackgroundTracingAgent_SetUMACallback_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for SetUMACallback failed with TypeError');
           }
        }
        // Try Method 1: ClearUMACallback
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.tracing.mojom.BackgroundTracingAgent_ClearUMACallback_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for ClearUMACallback failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
             console.warn('[GeneratedReceiver] Failed to discover ordinal ' + header.ordinal);
...
mojo.internal.bindings.tracing.mojom.BackgroundTracingAgentReceiver = mojo.internal.bindings.tracing.mojom.BackgroundTracingAgentReceiver;

mojo.internal.bindings.tracing.mojom.BackgroundTracingAgentPtr = mojo.internal.bindings.tracing.mojom.BackgroundTracingAgentRemote;
mojo.internal.bindings.tracing.mojom.BackgroundTracingAgentRequest = mojo.internal.bindings.tracing.mojom.BackgroundTracingAgentPendingReceiver;
...
mojo.internal.bindings.tracing.mojom.BackgroundTracingAgentProviderRemote = class {
  static get $interfaceName() {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.tracing.mojom.BackgroundTracingAgentProviderPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.tracing.mojom.BackgroundTracingAgentProviderRemoteCallHandler(this.proxy);
  }
  ...
  create(arg_tracing_process_id, arg_client, arg_agent) {
    return this.$.create(arg_tracing_process_id, arg_client, arg_agent);
  }
};
...
mojo.internal.bindings.tracing.mojom.BackgroundTracingAgentProvider.getRemote = function() {
  let remote = new mojo.internal.bindings.tracing.mojom.BackgroundTracingAgentProviderRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
...
mojo.internal.bindings.tracing.mojom.BackgroundTracingAgentProviderReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.tracing.mojom.BackgroundTracingAgentProvider_Create_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
...
mojo.internal.bindings.tracing.mojom.BackgroundTracingAgentProviderReceiver = mojo.internal.bindings.tracing.mojom.BackgroundTracingAgentProviderReceiver;
