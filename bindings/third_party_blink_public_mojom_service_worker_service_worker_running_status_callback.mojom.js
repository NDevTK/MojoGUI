...
mojo.internal.bindings.blink.mojom.ServiceWorkerRunningStatusCallback = {};
mojo.internal.bindings.blink.mojom.ServiceWorkerRunningStatusCallbackSpec = { $ : {} };
...
mojo.internal.bindings.blink.mojom.ServiceWorkerRunningStatusCallbackRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.blink.mojom.ServiceWorkerRunningStatusCallbackPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.blink.mojom.ServiceWorkerRunningStatusCallbackRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.blink.mojom.ServiceWorkerRunningStatusCallbackRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('blink.mojom.ServiceWorkerRunningStatusCallback', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.blink.mojom.ServiceWorkerRunningStatusCallback.getRemote = function() {
  let remote = new mojo.internal.bindings.blink.mojom.ServiceWorkerRunningStatusCallbackRemote();
...
mojo.internal.bindings.blink.mojom.ServiceWorkerRunningStatusCallbackReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('blink.mojom.ServiceWorkerRunningStatusCallback', [
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.blink.mojom.ServiceWorkerRunningStatusCallback_OnStatusChanged_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.blink.mojom.ServiceWorkerRunningStatusCallbackReceiver = mojo.internal.bindings.blink.mojom.ServiceWorkerRunningStatusCallbackReceiver;
