...
mojo.internal.bindings.mojom.ModuleEventSink = {};
mojo.internal.bindings.mojom.ModuleEventSinkSpec = { $ : {} };
mojo.internal.bindings.mojom.ModuleEventSink.$interfaceName = 'mojom.ModuleEventSink';
...
mojo.internal.bindings.mojom.ModuleEventSinkRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.mojom.ModuleEventSinkPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.mojom.ModuleEventSinkRemoteCallHandler(this.proxy);
  }
  ...
  onModuleEvents(arg_module_load_addresses) {
    return this.$.onModuleEvents(arg_module_load_addresses);
  }
};

mojo.internal.bindings.mojom.ModuleEventSinkRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('mojom.ModuleEventSink', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.mojom.ModuleEventSink.getRemote = function() {
  let remote = new mojo.internal.bindings.mojom.ModuleEventSinkRemote();
...
mojo.internal.bindings.mojom.ModuleEventSinkReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('mojom.ModuleEventSink', [
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.mojom.ModuleEventSink_OnModuleEvents_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OnModuleEvents failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.mojom.ModuleEventSinkReceiver = mojo.internal.bindings.mojom.ModuleEventSinkReceiver;
