...
mojo.internal.bindings.mojom.WebEngineMediaResourceProviderRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.mojom.WebEngineMediaResourceProviderPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.mojom.WebEngineMediaResourceProviderRemoteCallHandler(this.proxy);
  }
  ...
  createAudioConsumer(arg_request) {
    return this.$.createAudioConsumer(arg_request);
  }
};
...
mojo.internal.bindings.mojom.WebEngineMediaResourceProvider.getRemote = function() {
  let remote = new mojo.internal.bindings.mojom.WebEngineMediaResourceProviderRemote();
...
mojo.internal.bindings.mojom.WebEngineMediaResourceProviderReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.mojom.WebEngineMediaResourceProvider_ShouldUseAudioConsumer_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for ShouldUseAudioConsumer failed with TypeError');
           }
        }
        // Try Method 1: CreateAudioConsumer
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.mojom.WebEngineMediaResourceProvider_CreateAudioConsumer_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for CreateAudioConsumer failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.mojom.WebEngineMediaResourceProvider_ShouldUseAudioConsumer_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.mojom.WebEngineMediaResourceProviderReceiver = mojo.internal.bindings.mojom.WebEngineMediaResourceProviderReceiver;
