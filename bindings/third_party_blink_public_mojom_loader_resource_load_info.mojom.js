...
blink.mojom.CommonNetworkInfoSpec = {
  $: {
    structSpec: {
      ...
      packedSize: 24,
      fields: [
        { name: 'network_accessed', packedOffset: 0, packedBitOffset: 0, type: mojo.internal.Bool, nullable: false },
        { name: 'always_access_network', packedOffset: 0, packedBitOffset: 1, type: mojo.internal.Bool, nullable: false },
        { name: 'remote_endpoint', packedOffset: 8, packedBitOffset: 0, type: network.mojom.IPEndPointSpec, nullable: true },
      ],
      versions: [{version: 0}]
    }
  }
  ...
  $: {
    structSpec: {
      ...
      fields: [
        ...
        { name: 'was_cached', packedOffset: 64, packedBitOffset: 0, type: mojo.internal.Bool, nullable: false },
        { name: 'network_info', packedOffset: 72, packedBitOffset: 0, type: blink.mojom.CommonNetworkInfoSpec, nullable: false },
        { name: 'net_error', packedOffset: 80, packedBitOffset: 0, type: mojo.internal.Int32, nullable: false },
        { name: 'proxy_chain', packedOffset: 88, packedBitOffset: 0, type: network.mojom.ProxyChainSpec, nullable: false },
        { name: 'load_timing_info', packedOffset: 96, packedBitOffset: 0, type: network.mojom.LoadTimingInfoSpec, nullable: false },
        { name: 'raw_body_bytes', packedOffset: 104, packedBitOffset: 0, type: mojo_base.mojom.ByteCountSpec, nullable: false },
        { name: 'total_received_bytes', packedOffset: 112, packedBitOffset: 0, type: mojo_base.mojom.ByteCountSpec, nullable: false },
        { name: 'redirect_info_chain', packedOffset: 120, packedBitOffset: 0, type: mojo.internal.Array, nullable: false },
        { name: 'http_status_code', packedOffset: 128, packedBitOffset: 0, type: mojo.internal.Int32, nullable: false },
        { name: 'did_use_server_http_auth', packedOffset: 132, packedBitOffset: 0, type: mojo.internal.Bool, nullable: false },
      ],
      versions: [{version: 0}]
    }
  }
