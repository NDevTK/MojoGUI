...
mojo.internal.bindings.viz.mojom.BeginFrameObserver = {};
mojo.internal.bindings.viz.mojom.BeginFrameObserverSpec = { $ : {} };
...
mojo.internal.bindings.viz.mojom.BeginFrameObserverRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.viz.mojom.BeginFrameObserverPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.viz.mojom.BeginFrameObserverRemoteCallHandler(this.proxy);
  }
  ...
  onStandaloneBeginFrame(arg_args) {
    return this.$.onStandaloneBeginFrame(arg_args);
  }
};

mojo.internal.bindings.viz.mojom.BeginFrameObserverRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('viz.mojom.BeginFrameObserver', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.viz.mojom.BeginFrameObserver.getRemote = function() {
  let remote = new mojo.internal.bindings.viz.mojom.BeginFrameObserverRemote();
...
mojo.internal.bindings.viz.mojom.BeginFrameObserverReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('viz.mojom.BeginFrameObserver', [
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        // Try Method 0: OnStandaloneBeginFrame
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.viz.mojom.BeginFrameObserver_OnStandaloneBeginFrame_ParamsSpec.$.structSpec;
             ...
             if (sizeMatch && (!!(header.flags & 1) === methodExpectsResp)) {
               if (size > 8 || message.payload.byteLength === 8) {
                 ...
                 console.log('[GeneratedReceiver] Discovery SUCCESS: ' + header.ordinal + ' -> OnStandaloneBeginFrame (0)');
                 this.mapOrdinal(header.ordinal, 0);
                 dispatchId = 0;
               }
             }
           } catch (e) {
             if (e instanceof TypeError) console.warn('[Discovery] trial for OnStandaloneBeginFrame failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.viz.mojom.BeginFrameObserverReceiver = mojo.internal.bindings.viz.mojom.BeginFrameObserverReceiver;
