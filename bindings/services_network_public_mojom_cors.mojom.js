...
network.mojom.CorsErrorStatusSpec = {
  $: {
    structSpec: {
      ...
      packedSize: 56,
      fields: [
        { name: 'cors_error', packedOffset: 0, packedBitOffset: 0, type: mojo.internal.Pointer, nullable: false },
        ...
        { name: 'issue_id', packedOffset: 32, packedBitOffset: 0, type: mojo.internal.Pointer, nullable: false },
