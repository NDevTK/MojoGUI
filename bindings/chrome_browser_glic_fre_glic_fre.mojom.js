...
mojo.internal.bindings.glic.mojom.FrePageHandlerFactoryRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('glic.mojom.FrePageHandlerFactory', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.glic.mojom.FrePageHandlerFactoryReceiver = class {
  constructor(impl) {
    ...
    const ordinals = window.mojoScrambler.getOrdinals('glic.mojom.FrePageHandlerFactory', [
      { explicit: null },
    ]);
...
mojo.internal.bindings.glic.mojom.FrePageHandlerRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('glic.mojom.FrePageHandler', [
      { explicit: null },
      { explicit: null },
      { explicit: null },
      { explicit: null },
...
mojo.internal.bindings.glic.mojom.FrePageHandlerReceiver = class {
  constructor(impl) {
    ...
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('glic.mojom.FrePageHandler', [
      { explicit: null },
      { explicit: null },
      { explicit: null },
      { explicit: null },
...
mojo.internal.Struct(
    mojo.internal.bindings.glic.mojom.FrePageHandlerFactory_CreatePageHandler_ParamsSpec, 'glic.mojom.FrePageHandlerFactory_CreatePageHandler_Params', [
      mojo.internal.StructField('arg_receiver', 0, 0, mojo.internal.InterfaceRequest(mojo.internal.bindings.glic.mojom.FrePageHandlerPendingReceiver), null, false, 0, undefined),
    ],
    [[0, 16]]);
