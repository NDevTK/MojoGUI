...
mojo.internal.Struct(
    mojo.internal.bindings.glic.mojom.FrePageHandlerFactory_CreatePageHandler_ParamsSpec, 'glic.mojom.FrePageHandlerFactory_CreatePageHandler_Params', [
      mojo.internal.StructField('arg_receiver', 0, 0, mojo.internal.InterfaceRequest(mojo.internal.bindings.glic.mojom.FrePageHandlerRemote), null, false, 0, undefined),
    ],
    [[0, 16]]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.glic.mojom.FrePageHandlerFactory_CreatePageHandler_ParamsSpec.$.structSpec;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.glic.mojom.FrePageHandler_AcceptFre_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for AcceptFre failed with TypeError');
           }
        }
        // Try Method 1: RejectFre
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.glic.mojom.FrePageHandler_RejectFre_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for RejectFre failed with TypeError');
           }
        }
        // Try Method 2: DismissFre
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.glic.mojom.FrePageHandler_DismissFre_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for DismissFre failed with TypeError');
           }
        }
        // Try Method 3: FreReloaded
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.glic.mojom.FrePageHandler_FreReloaded_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for FreReloaded failed with TypeError');
           }
        }
        // Try Method 4: PrepareForClient
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.glic.mojom.FrePageHandler_PrepareForClient_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for PrepareForClient failed with TypeError');
           }
        }
        // Try Method 5: ValidateAndOpenLinkInNewTab
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.glic.mojom.FrePageHandler_ValidateAndOpenLinkInNewTab_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for ValidateAndOpenLinkInNewTab failed with TypeError');
           }
        }
        // Try Method 6: WebUiStateChanged
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.glic.mojom.FrePageHandler_WebUiStateChanged_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for WebUiStateChanged failed with TypeError');
           }
        }
        // Try Method 7: ExceededTimeoutError
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.glic.mojom.FrePageHandler_ExceededTimeoutError_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for ExceededTimeoutError failed with TypeError');
           }
        }
        // Try Method 8: LogWebUiLoadComplete
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.glic.mojom.FrePageHandler_LogWebUiLoadComplete_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for LogWebUiLoadComplete failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
             console.warn('[GeneratedReceiver] Failed to discover ordinal ' + header.ordinal);
        ...
        case 4: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              this.endpoint.send(header.ordinal, header.requestId, mojo.internal.kMessageFlagIsResponse, mojo.internal.bindings.glic.mojom.FrePageHandler_PrepareForClient_ResponseParamsSpec, response);
