...
mojo.internal.bindings.blink = mojo.internal.bindings.blink || {};
mojo.internal.bindings.blink.mojom = mojo.internal.bindings.blink.mojom || {};
mojo.internal.bindings.blink.mojom.ServiceWorkerStreamHandleSpec = mojo.internal.bindings.blink.mojom.ServiceWorkerStreamHandleSpec || { $: mojo.internal.OpaqueStruct.$ };
mojo.internal.bindings.mojo_base = mojo.internal.bindings.mojo_base || {};
...
mojo.internal.bindings.blink.mojom.ServiceWorkerFetchResponseCallbackRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.blink.mojom.ServiceWorkerFetchResponseCallbackRemoteCallHandler(this.proxy);
  }
  ...
  onResponse(arg_response, arg_timing) {
    return this.$.onResponse(arg_response, arg_timing);
  }
  onResponseStream(arg_response, arg_body_as_stream, arg_timing) {
    return this.$.onResponseStream(arg_response, arg_body_as_stream, arg_timing);
  }
  onFallback(arg_request_body, arg_timing) {
    return this.$.onFallback(arg_request_body, arg_timing);
  }
};

mojo.internal.bindings.blink.mojom.ServiceWorkerFetchResponseCallbackRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('blink.mojom.ServiceWorkerFetchResponseCallback', [
      { explicit: null },
      { explicit: null },
      { explicit: null },
    ]);
...
mojo.internal.bindings.blink.mojom.ServiceWorkerFetchResponseCallback.getRemote = function() {
  let remote = new mojo.internal.bindings.blink.mojom.ServiceWorkerFetchResponseCallbackRemote();
...
mojo.internal.bindings.blink.mojom.ServiceWorkerFetchResponseCallbackReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('blink.mojom.ServiceWorkerFetchResponseCallback', [
      { explicit: null },
      { explicit: null },
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.blink.mojom.ServiceWorkerFetchResponseCallback_OnResponse_ParamsSpec.$.structSpec;
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.blink.mojom.ServiceWorkerFetchResponseCallback_OnResponseStream_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OnResponseStream failed with TypeError');
           }
        }
        // Try Method 2: OnFallback
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.blink.mojom.ServiceWorkerFetchResponseCallback_OnFallback_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
...
mojo.internal.bindings.blink.mojom.ServiceWorkerFetchResponseCallbackReceiver = mojo.internal.bindings.blink.mojom.ServiceWorkerFetchResponseCallbackReceiver;
