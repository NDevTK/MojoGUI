...
arc.mojom.MetricsHostPtr = class {
  ...
  0(events, boot_type) {
    // Method: 0
    // Call: 0(events, boot_type)
  }

  1(native_bridge_type) {
    // Method: 1
    // Call: 1(native_bridge_type)
  }
  ...
  11(duration, packages_deleted) {
    // Method: 11
    // Call: 11(duration, packages_deleted)
  }
  ...
  13(prediction_target) {
    // Method: 13
    // Call: 13(prediction_target)
  }

  16(query, success) {
    // Method: 16
    // Call: 16(query, success)
  }
  ...
  22(status, duration_ms) {
    // Method: 22
    // Call: 22(status, duration_ms)
  }

  23(psi_file_contents) {
    // Method: 23
    // Call: 23(psi_file_contents)
  }
