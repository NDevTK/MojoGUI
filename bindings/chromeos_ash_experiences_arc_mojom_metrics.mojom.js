...
mojo.internal.bindings.arc.mojom.BootTypeSpec = mojo.internal.bindings.arc.mojom.BootTypeSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.arc.mojom.NativeBridgeTypeSpec = mojo.internal.bindings.arc.mojom.NativeBridgeTypeSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.arc.mojom.CompanionLibApiIdSpec = mojo.internal.bindings.arc.mojom.CompanionLibApiIdSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.arc.mojom.ArcDnsQuerySpec = mojo.internal.bindings.arc.mojom.ArcDnsQuerySpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.arc.mojom.ArcNetworkEventSpec = mojo.internal.bindings.arc.mojom.ArcNetworkEventSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.arc.mojom.ArcNetworkErrorSpec = mojo.internal.bindings.arc.mojom.ArcNetworkErrorSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.arc.mojom.AppKillTypeSpec = mojo.internal.bindings.arc.mojom.AppKillTypeSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.arc.mojom.AppPrimaryAbiSpec = mojo.internal.bindings.arc.mojom.AppPrimaryAbiSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.arc.mojom.ArcCorePriAbiMigEventSpec = mojo.internal.bindings.arc.mojom.ArcCorePriAbiMigEventSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.arc.mojom.DataRestoreStatusSpec = mojo.internal.bindings.arc.mojom.DataRestoreStatusSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.arc.mojom.LowLatencyStylusLibraryTypeSpec = mojo.internal.bindings.arc.mojom.LowLatencyStylusLibraryTypeSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.arc.mojom.LowLatencyStylusLibApiIdSpec = mojo.internal.bindings.arc.mojom.LowLatencyStylusLibApiIdSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.arc.mojom.VpnServiceBuilderCompatApiIdSpec = mojo.internal.bindings.arc.mojom.VpnServiceBuilderCompatApiIdSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.arc.mojom.MainAccountHashMigrationStatusSpec = mojo.internal.bindings.arc.mojom.MainAccountHashMigrationStatusSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.arc.mojom.WaylandTimingEventSpec = mojo.internal.bindings.arc.mojom.WaylandTimingEventSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.arc.mojom.ArcKeyMintErrorSpec = mojo.internal.bindings.arc.mojom.ArcKeyMintErrorSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.arc.mojom.ArcKeyMintLoggedOperationSpec = mojo.internal.bindings.arc.mojom.ArcKeyMintLoggedOperationSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.arc.mojom.CertificateSigningResultSpec = mojo.internal.bindings.arc.mojom.CertificateSigningResultSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.arc.mojom.AppErrorDialogTypeSpec = mojo.internal.bindings.arc.mojom.AppErrorDialogTypeSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.arc.mojom.AndroidAppCategorySpec = mojo.internal.bindings.arc.mojom.AndroidAppCategorySpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.arc.mojom.AndroidDataDirectorySpec = mojo.internal.bindings.arc.mojom.AndroidDataDirectorySpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.arc.mojom.BootProgressEventSpec = mojo.internal.bindings.arc.mojom.BootProgressEventSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.BootProgressEventSpec.$.structSpec && mojo.internal.bindings.arc.mojom.BootProgressEventSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.BootProgressEventSpec.$ = {};
mojo.internal.bindings.arc.mojom.GfxMetricsSpec = mojo.internal.bindings.arc.mojom.GfxMetricsSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.GfxMetricsSpec.$.structSpec && mojo.internal.bindings.arc.mojom.GfxMetricsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.GfxMetricsSpec.$ = {};
mojo.internal.bindings.arc.mojom.AppKillSpec = mojo.internal.bindings.arc.mojom.AppKillSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.AppKillSpec.$.structSpec && mojo.internal.bindings.arc.mojom.AppKillSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.AppKillSpec.$ = {};
mojo.internal.bindings.arc.mojom.LowLatencyStylusLibPredictionTargetSpec = mojo.internal.bindings.arc.mojom.LowLatencyStylusLibPredictionTargetSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.LowLatencyStylusLibPredictionTargetSpec.$.structSpec && mojo.internal.bindings.arc.mojom.LowLatencyStylusLibPredictionTargetSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.LowLatencyStylusLibPredictionTargetSpec.$ = {};
mojo.internal.bindings.arc.mojom.AppCategoryDataSizeSpec = mojo.internal.bindings.arc.mojom.AppCategoryDataSizeSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.AppCategoryDataSizeSpec.$.structSpec && mojo.internal.bindings.arc.mojom.AppCategoryDataSizeSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.AppCategoryDataSizeSpec.$ = {};
mojo.internal.bindings.arc.mojom.DataDirectorySizeSpec = mojo.internal.bindings.arc.mojom.DataDirectorySizeSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.DataDirectorySizeSpec.$.structSpec && mojo.internal.bindings.arc.mojom.DataDirectorySizeSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.DataDirectorySizeSpec.$ = {};
mojo.internal.bindings.arc.mojom.MetricsHost = mojo.internal.bindings.arc.mojom.MetricsHost || {};
mojo.internal.bindings.arc.mojom.MetricsHostSpec = mojo.internal.bindings.arc.mojom.MetricsHostSpec || { $ : {} };
if (mojo.internal.bindings.arc.mojom.MetricsHostSpec.$.structSpec && mojo.internal.bindings.arc.mojom.MetricsHostSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.MetricsHostSpec.$ = {};
mojo.internal.bindings.arc.mojom.MetricsHost.$interfaceName = 'arc.mojom.MetricsHost';
mojo.internal.bindings.arc.mojom.MetricsHost_ReportBootProgress_ParamsSpec = mojo.internal.bindings.arc.mojom.MetricsHost_ReportBootProgress_ParamsSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.MetricsHost_ReportBootProgress_ParamsSpec.$.structSpec && mojo.internal.bindings.arc.mojom.MetricsHost_ReportBootProgress_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.MetricsHost_ReportBootProgress_ParamsSpec.$ = {};
mojo.internal.bindings.arc.mojom.MetricsHost_ReportNativeBridge_ParamsSpec = mojo.internal.bindings.arc.mojom.MetricsHost_ReportNativeBridge_ParamsSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.MetricsHost_ReportNativeBridge_ParamsSpec.$.structSpec && mojo.internal.bindings.arc.mojom.MetricsHost_ReportNativeBridge_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.MetricsHost_ReportNativeBridge_ParamsSpec.$ = {};
mojo.internal.bindings.arc.mojom.MetricsHost_ReportCompanionLibApiUsage_ParamsSpec = mojo.internal.bindings.arc.mojom.MetricsHost_ReportCompanionLibApiUsage_ParamsSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.MetricsHost_ReportCompanionLibApiUsage_ParamsSpec.$.structSpec && mojo.internal.bindings.arc.mojom.MetricsHost_ReportCompanionLibApiUsage_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.MetricsHost_ReportCompanionLibApiUsage_ParamsSpec.$ = {};
mojo.internal.bindings.arc.mojom.MetricsHost_ReportAppKill_ParamsSpec = mojo.internal.bindings.arc.mojom.MetricsHost_ReportAppKill_ParamsSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.MetricsHost_ReportAppKill_ParamsSpec.$.structSpec && mojo.internal.bindings.arc.mojom.MetricsHost_ReportAppKill_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.MetricsHost_ReportAppKill_ParamsSpec.$ = {};
mojo.internal.bindings.arc.mojom.MetricsHost_ReportArcCorePriAbiMigEvent_ParamsSpec = mojo.internal.bindings.arc.mojom.MetricsHost_ReportArcCorePriAbiMigEvent_ParamsSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.MetricsHost_ReportArcCorePriAbiMigEvent_ParamsSpec.$.structSpec && mojo.internal.bindings.arc.mojom.MetricsHost_ReportArcCorePriAbiMigEvent_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.MetricsHost_ReportArcCorePriAbiMigEvent_ParamsSpec.$ = {};
mojo.internal.bindings.arc.mojom.MetricsHost_ReportArcCorePriAbiMigFailedTries_ParamsSpec = mojo.internal.bindings.arc.mojom.MetricsHost_ReportArcCorePriAbiMigFailedTries_ParamsSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.MetricsHost_ReportArcCorePriAbiMigFailedTries_ParamsSpec.$.structSpec && mojo.internal.bindings.arc.mojom.MetricsHost_ReportArcCorePriAbiMigFailedTries_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.MetricsHost_ReportArcCorePriAbiMigFailedTries_ParamsSpec.$ = {};
mojo.internal.bindings.arc.mojom.MetricsHost_ReportArcCorePriAbiMigDowngradeDelay_ParamsSpec = mojo.internal.bindings.arc.mojom.MetricsHost_ReportArcCorePriAbiMigDowngradeDelay_ParamsSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.MetricsHost_ReportArcCorePriAbiMigDowngradeDelay_ParamsSpec.$.structSpec && mojo.internal.bindings.arc.mojom.MetricsHost_ReportArcCorePriAbiMigDowngradeDelay_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.MetricsHost_ReportArcCorePriAbiMigDowngradeDelay_ParamsSpec.$ = {};
mojo.internal.bindings.arc.mojom.MetricsHost_ReportArcCorePriAbiMigBootTime_ParamsSpec = mojo.internal.bindings.arc.mojom.MetricsHost_ReportArcCorePriAbiMigBootTime_ParamsSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.MetricsHost_ReportArcCorePriAbiMigBootTime_ParamsSpec.$.structSpec && mojo.internal.bindings.arc.mojom.MetricsHost_ReportArcCorePriAbiMigBootTime_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.MetricsHost_ReportArcCorePriAbiMigBootTime_ParamsSpec.$ = {};
mojo.internal.bindings.arc.mojom.MetricsHost_ReportAnr_ParamsSpec = mojo.internal.bindings.arc.mojom.MetricsHost_ReportAnr_ParamsSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.MetricsHost_ReportAnr_ParamsSpec.$.structSpec && mojo.internal.bindings.arc.mojom.MetricsHost_ReportAnr_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.MetricsHost_ReportAnr_ParamsSpec.$ = {};
mojo.internal.bindings.arc.mojom.MetricsHost_ReportArcSystemHealthUpgrade_ParamsSpec = mojo.internal.bindings.arc.mojom.MetricsHost_ReportArcSystemHealthUpgrade_ParamsSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.MetricsHost_ReportArcSystemHealthUpgrade_ParamsSpec.$.structSpec && mojo.internal.bindings.arc.mojom.MetricsHost_ReportArcSystemHealthUpgrade_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.MetricsHost_ReportArcSystemHealthUpgrade_ParamsSpec.$ = {};
mojo.internal.bindings.arc.mojom.MetricsHost_ReportLowLatencyStylusLibApiUsage_ParamsSpec = mojo.internal.bindings.arc.mojom.MetricsHost_ReportLowLatencyStylusLibApiUsage_ParamsSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.MetricsHost_ReportLowLatencyStylusLibApiUsage_ParamsSpec.$.structSpec && mojo.internal.bindings.arc.mojom.MetricsHost_ReportLowLatencyStylusLibApiUsage_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.MetricsHost_ReportLowLatencyStylusLibApiUsage_ParamsSpec.$ = {};
mojo.internal.bindings.arc.mojom.MetricsHost_ReportLowLatencyStylusLibPredictionTarget_ParamsSpec = mojo.internal.bindings.arc.mojom.MetricsHost_ReportLowLatencyStylusLibPredictionTarget_ParamsSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.MetricsHost_ReportLowLatencyStylusLibPredictionTarget_ParamsSpec.$.structSpec && mojo.internal.bindings.arc.mojom.MetricsHost_ReportLowLatencyStylusLibPredictionTarget_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.MetricsHost_ReportLowLatencyStylusLibPredictionTarget_ParamsSpec.$ = {};
mojo.internal.bindings.arc.mojom.MetricsHost_ReportDnsQueryResult_ParamsSpec = mojo.internal.bindings.arc.mojom.MetricsHost_ReportDnsQueryResult_ParamsSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.MetricsHost_ReportDnsQueryResult_ParamsSpec.$.structSpec && mojo.internal.bindings.arc.mojom.MetricsHost_ReportDnsQueryResult_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.MetricsHost_ReportDnsQueryResult_ParamsSpec.$ = {};
mojo.internal.bindings.arc.mojom.MetricsHost_ReportMainAccountHashMigrationMetrics_ParamsSpec = mojo.internal.bindings.arc.mojom.MetricsHost_ReportMainAccountHashMigrationMetrics_ParamsSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.MetricsHost_ReportMainAccountHashMigrationMetrics_ParamsSpec.$.structSpec && mojo.internal.bindings.arc.mojom.MetricsHost_ReportMainAccountHashMigrationMetrics_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.MetricsHost_ReportMainAccountHashMigrationMetrics_ParamsSpec.$ = {};
mojo.internal.bindings.arc.mojom.MetricsHost_ReportArcNetworkEvent_ParamsSpec = mojo.internal.bindings.arc.mojom.MetricsHost_ReportArcNetworkEvent_ParamsSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.MetricsHost_ReportArcNetworkEvent_ParamsSpec.$.structSpec && mojo.internal.bindings.arc.mojom.MetricsHost_ReportArcNetworkEvent_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.MetricsHost_ReportArcNetworkEvent_ParamsSpec.$ = {};
mojo.internal.bindings.arc.mojom.MetricsHost_ReportArcNetworkError_ParamsSpec = mojo.internal.bindings.arc.mojom.MetricsHost_ReportArcNetworkError_ParamsSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.MetricsHost_ReportArcNetworkError_ParamsSpec.$.structSpec && mojo.internal.bindings.arc.mojom.MetricsHost_ReportArcNetworkError_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.MetricsHost_ReportArcNetworkError_ParamsSpec.$ = {};
mojo.internal.bindings.arc.mojom.MetricsHost_ReportAppPrimaryAbi_ParamsSpec = mojo.internal.bindings.arc.mojom.MetricsHost_ReportAppPrimaryAbi_ParamsSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.MetricsHost_ReportAppPrimaryAbi_ParamsSpec.$.structSpec && mojo.internal.bindings.arc.mojom.MetricsHost_ReportAppPrimaryAbi_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.MetricsHost_ReportAppPrimaryAbi_ParamsSpec.$ = {};
mojo.internal.bindings.arc.mojom.MetricsHost_ReportDataRestore_ParamsSpec = mojo.internal.bindings.arc.mojom.MetricsHost_ReportDataRestore_ParamsSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.MetricsHost_ReportDataRestore_ParamsSpec.$.structSpec && mojo.internal.bindings.arc.mojom.MetricsHost_ReportDataRestore_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.MetricsHost_ReportDataRestore_ParamsSpec.$ = {};
mojo.internal.bindings.arc.mojom.MetricsHost_ReportMemoryPressure_ParamsSpec = mojo.internal.bindings.arc.mojom.MetricsHost_ReportMemoryPressure_ParamsSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.MetricsHost_ReportMemoryPressure_ParamsSpec.$.structSpec && mojo.internal.bindings.arc.mojom.MetricsHost_ReportMemoryPressure_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.MetricsHost_ReportMemoryPressure_ParamsSpec.$ = {};
mojo.internal.bindings.arc.mojom.MetricsHost_ReportProvisioningPreSignIn_ParamsSpec = mojo.internal.bindings.arc.mojom.MetricsHost_ReportProvisioningPreSignIn_ParamsSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.MetricsHost_ReportProvisioningPreSignIn_ParamsSpec.$.structSpec && mojo.internal.bindings.arc.mojom.MetricsHost_ReportProvisioningPreSignIn_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.MetricsHost_ReportProvisioningPreSignIn_ParamsSpec.$ = {};
mojo.internal.bindings.arc.mojom.MetricsHost_ReportWaylandLateTimingEvent_ParamsSpec = mojo.internal.bindings.arc.mojom.MetricsHost_ReportWaylandLateTimingEvent_ParamsSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.MetricsHost_ReportWaylandLateTimingEvent_ParamsSpec.$.structSpec && mojo.internal.bindings.arc.mojom.MetricsHost_ReportWaylandLateTimingEvent_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.MetricsHost_ReportWaylandLateTimingEvent_ParamsSpec.$ = {};
mojo.internal.bindings.arc.mojom.MetricsHost_ReportWebViewProcessStarted_ParamsSpec = mojo.internal.bindings.arc.mojom.MetricsHost_ReportWebViewProcessStarted_ParamsSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.MetricsHost_ReportWebViewProcessStarted_ParamsSpec.$.structSpec && mojo.internal.bindings.arc.mojom.MetricsHost_ReportWebViewProcessStarted_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.MetricsHost_ReportWebViewProcessStarted_ParamsSpec.$ = {};
mojo.internal.bindings.arc.mojom.MetricsHost_ReportVpnServiceBuilderCompatApiUsage_ParamsSpec = mojo.internal.bindings.arc.mojom.MetricsHost_ReportVpnServiceBuilderCompatApiUsage_ParamsSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.MetricsHost_ReportVpnServiceBuilderCompatApiUsage_ParamsSpec.$.structSpec && mojo.internal.bindings.arc.mojom.MetricsHost_ReportVpnServiceBuilderCompatApiUsage_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.MetricsHost_ReportVpnServiceBuilderCompatApiUsage_ParamsSpec.$ = {};
mojo.internal.bindings.arc.mojom.MetricsHost_ReportNewQosSocketCount_ParamsSpec = mojo.internal.bindings.arc.mojom.MetricsHost_ReportNewQosSocketCount_ParamsSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.MetricsHost_ReportNewQosSocketCount_ParamsSpec.$.structSpec && mojo.internal.bindings.arc.mojom.MetricsHost_ReportNewQosSocketCount_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.MetricsHost_ReportNewQosSocketCount_ParamsSpec.$ = {};
mojo.internal.bindings.arc.mojom.MetricsHost_ReportQosSocketPercentage_ParamsSpec = mojo.internal.bindings.arc.mojom.MetricsHost_ReportQosSocketPercentage_ParamsSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.MetricsHost_ReportQosSocketPercentage_ParamsSpec.$.structSpec && mojo.internal.bindings.arc.mojom.MetricsHost_ReportQosSocketPercentage_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.MetricsHost_ReportQosSocketPercentage_ParamsSpec.$ = {};
mojo.internal.bindings.arc.mojom.MetricsHost_ReportArcKeyMintError_ParamsSpec = mojo.internal.bindings.arc.mojom.MetricsHost_ReportArcKeyMintError_ParamsSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.MetricsHost_ReportArcKeyMintError_ParamsSpec.$.structSpec && mojo.internal.bindings.arc.mojom.MetricsHost_ReportArcKeyMintError_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.MetricsHost_ReportArcKeyMintError_ParamsSpec.$ = {};
mojo.internal.bindings.arc.mojom.MetricsHost_ReportDragResizeLatency_ParamsSpec = mojo.internal.bindings.arc.mojom.MetricsHost_ReportDragResizeLatency_ParamsSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.MetricsHost_ReportDragResizeLatency_ParamsSpec.$.structSpec && mojo.internal.bindings.arc.mojom.MetricsHost_ReportDragResizeLatency_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.MetricsHost_ReportDragResizeLatency_ParamsSpec.$ = {};
mojo.internal.bindings.arc.mojom.MetricsHost_ReportAppErrorDialogType_ParamsSpec = mojo.internal.bindings.arc.mojom.MetricsHost_ReportAppErrorDialogType_ParamsSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.MetricsHost_ReportAppErrorDialogType_ParamsSpec.$.structSpec && mojo.internal.bindings.arc.mojom.MetricsHost_ReportAppErrorDialogType_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.MetricsHost_ReportAppErrorDialogType_ParamsSpec.$ = {};
mojo.internal.bindings.arc.mojom.MetricsHost_ReportApkCacheHit_ParamsSpec = mojo.internal.bindings.arc.mojom.MetricsHost_ReportApkCacheHit_ParamsSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.MetricsHost_ReportApkCacheHit_ParamsSpec.$.structSpec && mojo.internal.bindings.arc.mojom.MetricsHost_ReportApkCacheHit_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.MetricsHost_ReportApkCacheHit_ParamsSpec.$ = {};
mojo.internal.bindings.arc.mojom.MetricsHost_ReportAppCategoryDataSizeList_ParamsSpec = mojo.internal.bindings.arc.mojom.MetricsHost_ReportAppCategoryDataSizeList_ParamsSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.MetricsHost_ReportAppCategoryDataSizeList_ParamsSpec.$.structSpec && mojo.internal.bindings.arc.mojom.MetricsHost_ReportAppCategoryDataSizeList_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.MetricsHost_ReportAppCategoryDataSizeList_ParamsSpec.$ = {};
mojo.internal.bindings.arc.mojom.MetricsHost_ReportDataDirectorySizeList_ParamsSpec = mojo.internal.bindings.arc.mojom.MetricsHost_ReportDataDirectorySizeList_ParamsSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.MetricsHost_ReportDataDirectorySizeList_ParamsSpec.$.structSpec && mojo.internal.bindings.arc.mojom.MetricsHost_ReportDataDirectorySizeList_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.MetricsHost_ReportDataDirectorySizeList_ParamsSpec.$ = {};
mojo.internal.bindings.arc.mojom.MetricsHost_ReportArcKeyMintErrorForOperation_ParamsSpec = mojo.internal.bindings.arc.mojom.MetricsHost_ReportArcKeyMintErrorForOperation_ParamsSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.MetricsHost_ReportArcKeyMintErrorForOperation_ParamsSpec.$.structSpec && mojo.internal.bindings.arc.mojom.MetricsHost_ReportArcKeyMintErrorForOperation_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.MetricsHost_ReportArcKeyMintErrorForOperation_ParamsSpec.$ = {};
mojo.internal.bindings.arc.mojom.MetricsHost_ReportCertificateSigningResult_ParamsSpec = mojo.internal.bindings.arc.mojom.MetricsHost_ReportCertificateSigningResult_ParamsSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.MetricsHost_ReportCertificateSigningResult_ParamsSpec.$.structSpec && mojo.internal.bindings.arc.mojom.MetricsHost_ReportCertificateSigningResult_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.MetricsHost_ReportCertificateSigningResult_ParamsSpec.$ = {};
mojo.internal.bindings.arc.mojom.MetricsInstance = mojo.internal.bindings.arc.mojom.MetricsInstance || {};
mojo.internal.bindings.arc.mojom.MetricsInstanceSpec = mojo.internal.bindings.arc.mojom.MetricsInstanceSpec || { $ : {} };
if (mojo.internal.bindings.arc.mojom.MetricsInstanceSpec.$.structSpec && mojo.internal.bindings.arc.mojom.MetricsInstanceSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.MetricsInstanceSpec.$ = {};
mojo.internal.bindings.arc.mojom.MetricsInstance.$interfaceName = 'arc.mojom.MetricsInstance';
mojo.internal.bindings.arc.mojom.MetricsInstance_Init_ParamsSpec = mojo.internal.bindings.arc.mojom.MetricsInstance_Init_ParamsSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.MetricsInstance_Init_ParamsSpec.$.structSpec && mojo.internal.bindings.arc.mojom.MetricsInstance_Init_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.MetricsInstance_Init_ParamsSpec.$ = {};
mojo.internal.bindings.arc.mojom.MetricsInstance_Init_ResponseParamsSpec = mojo.internal.bindings.arc.mojom.MetricsInstance_Init_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.MetricsInstance_Init_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.arc.mojom.MetricsInstance_Init_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.MetricsInstance_Init_ResponseParamsSpec.$ = {};
mojo.internal.bindings.arc.mojom.MetricsInstance_GetGfxMetrics_ParamsSpec = mojo.internal.bindings.arc.mojom.MetricsInstance_GetGfxMetrics_ParamsSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.MetricsInstance_GetGfxMetrics_ParamsSpec.$.structSpec && mojo.internal.bindings.arc.mojom.MetricsInstance_GetGfxMetrics_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.MetricsInstance_GetGfxMetrics_ParamsSpec.$ = {};
mojo.internal.bindings.arc.mojom.MetricsInstance_GetGfxMetrics_ResponseParamsSpec = mojo.internal.bindings.arc.mojom.MetricsInstance_GetGfxMetrics_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.MetricsInstance_GetGfxMetrics_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.arc.mojom.MetricsInstance_GetGfxMetrics_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.MetricsInstance_GetGfxMetrics_ResponseParamsSpec.$ = {};

// External type stubs (from imports)
mojo.internal.bindings.arc = mojo.internal.bindings.arc || {};
mojo.internal.bindings.arc.mojom = mojo.internal.bindings.arc.mojom || {};
mojo.internal.bindings.arc.mojom.AnrSpec = mojo.internal.bindings.arc.mojom.AnrSpec || { $: mojo.internal.OpaqueStruct.$ };
mojo.internal.bindings.mojo_base = mojo.internal.bindings.mojo_base || {};
mojo.internal.bindings.mojo_base.mojom = mojo.internal.bindings.mojo_base.mojom || {};
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const message = new mojo.internal.Message(
                ...
                header.ordinal, header.requestId, mojo.internal.bindings.arc.mojom.MetricsInstance_Init_ResponseParamsSpec.$.structSpec, resp_obj);
        ...
        case 1: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const resp_obj = { 'arg_metrics': val };
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.arc.mojom.MetricsInstance_GetGfxMetrics_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
