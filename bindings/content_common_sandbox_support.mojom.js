...
mojo.internal.Struct(
    mojo.internal.bindings.content.mojom.SandboxSupport_LocaleString_ParamsSpec, 'content.mojom.SandboxSupport_LocaleString_Params', [
      mojo.internal.StructField('arg_lcid', 0, 0, mojo.internal.Uint32, 0, false, 0, undefined),
      mojo.internal.StructField('arg_type', 4, 0, mojo.internal.bindings.content.mojom.LcTypeStringSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_defaults', 8, 0, mojo.internal.Bool, false, false, 0, undefined),
    ],
    [[0, 24]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.content.mojom.SandboxSupport_LocaleStrings_ParamsSpec, 'content.mojom.SandboxSupport_LocaleStrings_Params', [
      mojo.internal.StructField('arg_lcid', 0, 0, mojo.internal.Uint32, 0, false, 0, undefined),
      mojo.internal.StructField('arg_collection', 4, 0, mojo.internal.bindings.content.mojom.LcTypeStringsSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_defaults', 8, 0, mojo.internal.Bool, false, false, 0, undefined),
    ],
    [[0, 24]]);
...
mojo.internal.bindings.content.mojom.SandboxSupportRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('content.mojom.SandboxSupport', [
      { explicit: null },
      { explicit: null },
      { explicit: null },
      { explicit: null },
...
mojo.internal.bindings.content.mojom.SandboxSupportReceiver = class {
  constructor(impl) {
    ...
    const ordinals = window.mojoScrambler.getOrdinals('content.mojom.SandboxSupport', [
      { explicit: null },
      { explicit: null },
      { explicit: null },
      { explicit: null },
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.content.mojom.SandboxSupport_GetSystemColors_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for GetSystemColors failed with TypeError');
           }
        }
        // Try Method 1: LcidAndFirstDayOfWeek
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.content.mojom.SandboxSupport_LcidAndFirstDayOfWeek_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for LcidAndFirstDayOfWeek failed with TypeError');
           }
        }
        // Try Method 2: DigitsAndSigns
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.content.mojom.SandboxSupport_DigitsAndSigns_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for DigitsAndSigns failed with TypeError');
           }
        }
        // Try Method 3: LocaleString
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.content.mojom.SandboxSupport_LocaleString_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for LocaleString failed with TypeError');
           }
        }
        // Try Method 4: LocaleStrings
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.content.mojom.SandboxSupport_LocaleStrings_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for LocaleStrings failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
