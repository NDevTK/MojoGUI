...
mojo.internal.bindings.heap_profiling.mojom.TestConnectorRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.heap_profiling.mojom.TestConnectorPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.heap_profiling.mojom.TestConnectorRemoteCallHandler(this.proxy);
  }
  ...
  connectSnapshotController(arg_controller) {
    return this.$.connectSnapshotController(arg_controller);
  }
  connectProfileCollector(arg_collector) {
    return this.$.connectProfileCollector(arg_collector);
  }
  disconnect() {
...
mojo.internal.bindings.heap_profiling.mojom.TestConnector.getRemote = function() {
  let remote = new mojo.internal.bindings.heap_profiling.mojom.TestConnectorRemote();
...
mojo.internal.bindings.heap_profiling.mojom.TestConnectorReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.heap_profiling.mojom.TestConnector_ConnectSnapshotController_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for ConnectSnapshotController failed with TypeError');
           }
        }
        // Try Method 1: ConnectProfileCollector
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.heap_profiling.mojom.TestConnector_ConnectProfileCollector_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for ConnectProfileCollector failed with TypeError');
           }
        }
        // Try Method 2: Disconnect
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.heap_profiling.mojom.TestConnector_Disconnect_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
      ...
      switch (dispatchId) {
        ...
        case 2: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.heap_profiling.mojom.TestConnector_Disconnect_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.heap_profiling.mojom.TestConnectorReceiver = mojo.internal.bindings.heap_profiling.mojom.TestConnectorReceiver;
