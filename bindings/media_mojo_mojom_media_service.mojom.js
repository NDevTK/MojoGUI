...
mojo.internal.bindings.media.mojom.MediaService = {};
mojo.internal.bindings.media.mojom.MediaServiceSpec = { $ : {} };
...
mojo.internal.bindings.media.mojom.MediaServiceRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.media.mojom.MediaServicePendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.media.mojom.MediaServiceRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.media.mojom.MediaServiceRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('media.mojom.MediaService', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.media.mojom.MediaService.getRemote = function() {
  let remote = new mojo.internal.bindings.media.mojom.MediaServiceRemote();
...
mojo.internal.bindings.media.mojom.MediaServiceReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('media.mojom.MediaService', [
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.media.mojom.MediaService_CreateInterfaceFactory_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for CreateInterfaceFactory failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.media.mojom.MediaServiceReceiver = mojo.internal.bindings.media.mojom.MediaServiceReceiver;
