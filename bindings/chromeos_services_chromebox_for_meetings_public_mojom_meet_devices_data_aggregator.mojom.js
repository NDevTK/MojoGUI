...
mojo.internal.bindings.ash.cfm.mojom.DataWatchDogRemote = class {
  ...
  constructor(handle = undefined) {
    ...
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.ash.cfm.mojom.DataWatchDogRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.ash.cfm.mojom.DataWatchDogReceiver = mojo.internal.bindings.ash.cfm.mojom.DataWatchDogReceiver;

mojo.internal.bindings.ash.cfm.mojom.DataWatchDogPtr = mojo.internal.bindings.ash.cfm.mojom.DataWatchDogRemote;
mojo.internal.bindings.ash.cfm.mojom.DataWatchDogRequest = mojo.internal.bindings.ash.cfm.mojom.DataWatchDogPendingReceiver;
...
mojo.internal.bindings.ash.cfm.mojom.DataSourceRemote = class {
  ...
  constructor(handle = undefined) {
    ...
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.ash.cfm.mojom.DataSourceRemoteCallHandler(this.proxy);
  }
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.ash.cfm.mojom.DataSource_Fetch_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.fetch');
          const result = this.impl.fetch();
          const expectsResponse = header.expectsResponse || (header.flags & 1);
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              const val = (response && typeof response === 'object' && 'arg_serialized_payloads' in response) ? response['arg_serialized_payloads'] : response;
        ...
        case 2: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.ash.cfm.mojom.DataSource_Flush_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.ash.cfm.mojom.DataSourceReceiver = mojo.internal.bindings.ash.cfm.mojom.DataSourceReceiver;

mojo.internal.bindings.ash.cfm.mojom.DataSourcePtr = mojo.internal.bindings.ash.cfm.mojom.DataSourceRemote;
mojo.internal.bindings.ash.cfm.mojom.DataSourceRequest = mojo.internal.bindings.ash.cfm.mojom.DataSourcePendingReceiver;
...
mojo.internal.bindings.ash.cfm.mojom.DataAggregatorRemote = class {
  ...
  constructor(handle = undefined) {
    ...
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.ash.cfm.mojom.DataAggregatorRemoteCallHandler(this.proxy);
  }
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.ash.cfm.mojom.DataAggregator_GetDataSourceNames_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.getDataSourceNames');
          const result = this.impl.getDataSourceNames();
          const expectsResponse = header.expectsResponse || (header.flags & 1);
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              const val = (response && typeof response === 'object' && 'arg_data_source_names' in response) ? response['arg_data_source_names'] : response;
...
mojo.internal.bindings.ash.cfm.mojom.DataAggregatorReceiver = mojo.internal.bindings.ash.cfm.mojom.DataAggregatorReceiver;
