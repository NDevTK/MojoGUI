// Auto-generated MojoJS binding
 // Source: chromium_src/components/vrp_flags/vrp_flags.mojom
 // Module: vrp_flags.mojom
...
mojo.internal.bindings.vrp_flags.mojom.VrpFlags.$interfaceName = 'vrp_flags.mojom.VrpFlags';
mojo.internal.bindings.vrp_flags.mojom.VrpFlags_GetWriteLocations_ParamsSpec = mojo.internal.bindings.vrp_flags.mojom.VrpFlags_GetWriteLocations_ParamsSpec || { $: {} };
if (mojo.internal.bindings.vrp_flags.mojom.VrpFlags_GetWriteLocations_ParamsSpec.$.structSpec && mojo.internal.bindings.vrp_flags.mojom.VrpFlags_GetWriteLocations_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.vrp_flags.mojom.VrpFlags_GetWriteLocations_ParamsSpec.$ = {};
mojo.internal.bindings.vrp_flags.mojom.VrpFlags_GetWriteLocations_ResponseParamsSpec = mojo.internal.bindings.vrp_flags.mojom.VrpFlags_GetWriteLocations_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.vrp_flags.mojom.VrpFlags_GetWriteLocations_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.vrp_flags.mojom.VrpFlags_GetWriteLocations_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.vrp_flags.mojom.VrpFlags_GetWriteLocations_ResponseParamsSpec.$ = {};
mojo.internal.bindings.vrp_flags.mojom.VrpFlags_WriteAttempted_ParamsSpec = mojo.internal.bindings.vrp_flags.mojom.VrpFlags_WriteAttempted_ParamsSpec || { $: {} };
if (mojo.internal.bindings.vrp_flags.mojom.VrpFlags_WriteAttempted_ParamsSpec.$.structSpec && mojo.internal.bindings.vrp_flags.mojom.VrpFlags_WriteAttempted_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.vrp_flags.mojom.VrpFlags_WriteAttempted_ParamsSpec.$ = {};
mojo.internal.bindings.vrp_flags.mojom.VrpFlags_WriteAttempted_ResponseParamsSpec = mojo.internal.bindings.vrp_flags.mojom.VrpFlags_WriteAttempted_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.vrp_flags.mojom.VrpFlags_WriteAttempted_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.vrp_flags.mojom.VrpFlags_WriteAttempted_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.vrp_flags.mojom.VrpFlags_WriteAttempted_ResponseParamsSpec.$ = {};
mojo.internal.bindings.vrp_flags.mojom.VrpFlags_GetReadPrefix_ParamsSpec = mojo.internal.bindings.vrp_flags.mojom.VrpFlags_GetReadPrefix_ParamsSpec || { $: {} };
if (mojo.internal.bindings.vrp_flags.mojom.VrpFlags_GetReadPrefix_ParamsSpec.$.structSpec && mojo.internal.bindings.vrp_flags.mojom.VrpFlags_GetReadPrefix_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.vrp_flags.mojom.VrpFlags_GetReadPrefix_ParamsSpec.$ = {};
mojo.internal.bindings.vrp_flags.mojom.VrpFlags_GetReadPrefix_ResponseParamsSpec = mojo.internal.bindings.vrp_flags.mojom.VrpFlags_GetReadPrefix_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.vrp_flags.mojom.VrpFlags_GetReadPrefix_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.vrp_flags.mojom.VrpFlags_GetReadPrefix_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.vrp_flags.mojom.VrpFlags_GetReadPrefix_ResponseParamsSpec.$ = {};
mojo.internal.bindings.vrp_flags.mojom.VrpFlags_ReadAttempted_ParamsSpec = mojo.internal.bindings.vrp_flags.mojom.VrpFlags_ReadAttempted_ParamsSpec || { $: {} };
if (mojo.internal.bindings.vrp_flags.mojom.VrpFlags_ReadAttempted_ParamsSpec.$.structSpec && mojo.internal.bindings.vrp_flags.mojom.VrpFlags_ReadAttempted_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.vrp_flags.mojom.VrpFlags_ReadAttempted_ParamsSpec.$ = {};
mojo.internal.bindings.vrp_flags.mojom.VrpFlags_ReadAttempted_ResponseParamsSpec = mojo.internal.bindings.vrp_flags.mojom.VrpFlags_ReadAttempted_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.vrp_flags.mojom.VrpFlags_ReadAttempted_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.vrp_flags.mojom.VrpFlags_ReadAttempted_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.vrp_flags.mojom.VrpFlags_ReadAttempted_ResponseParamsSpec.$ = {};
mojo.internal.bindings.vrp_flags.mojom.VrpFlagsFactory = mojo.internal.bindings.vrp_flags.mojom.VrpFlagsFactory || {};
mojo.internal.bindings.vrp_flags.mojom.VrpFlagsFactorySpec = mojo.internal.bindings.vrp_flags.mojom.VrpFlagsFactorySpec || { $ : {} };
if (mojo.internal.bindings.vrp_flags.mojom.VrpFlagsFactorySpec.$.structSpec && mojo.internal.bindings.vrp_flags.mojom.VrpFlagsFactorySpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.vrp_flags.mojom.VrpFlagsFactorySpec.$ = {};
mojo.internal.bindings.vrp_flags.mojom.VrpFlagsFactory.$interfaceName = 'vrp_flags.mojom.VrpFlagsFactory';
mojo.internal.bindings.vrp_flags.mojom.VrpFlagsFactory_BindBrowserVrpFlags_ParamsSpec = mojo.internal.bindings.vrp_flags.mojom.VrpFlagsFactory_BindBrowserVrpFlags_ParamsSpec || { $: {} };
if (mojo.internal.bindings.vrp_flags.mojom.VrpFlagsFactory_BindBrowserVrpFlags_ParamsSpec.$.structSpec && mojo.internal.bindings.vrp_flags.mojom.VrpFlagsFactory_BindBrowserVrpFlags_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.vrp_flags.mojom.VrpFlagsFactory_BindBrowserVrpFlags_ParamsSpec.$ = {};
mojo.internal.bindings.vrp_flags.mojom.VrpFlagsFactory_BindNetworkVrpFlags_ParamsSpec = mojo.internal.bindings.vrp_flags.mojom.VrpFlagsFactory_BindNetworkVrpFlags_ParamsSpec || { $: {} };
...
mojo.internal.bindings.vrp_flags.mojom.VrpFlagsRemote = class {
  static get $interfaceName() {
    return 'vrp_flags.mojom.VrpFlags';
  }

  constructor(handle = undefined) {
    this.__mojoHandle = handle;
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.vrp_flags.mojom.VrpFlagsPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.vrp_flags.mojom.VrpFlagsRemoteCallHandler(this.proxy);
  }
  ...
  getWriteLocations() {
    return this.$.getWriteLocations();
  }
  writeAttempted(arg_location) {
    return this.$.writeAttempted(arg_location);
  }
  getReadPrefix() {
    return this.$.getReadPrefix();
  }
  readAttempted(arg_flag) {
    return this.$.readAttempted(arg_flag);
  }
};

mojo.internal.bindings.vrp_flags.mojom.VrpFlagsRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('vrp_flags.mojom.VrpFlags', [
      { explicit: null },
      { explicit: null },
      { explicit: null },
      { explicit: null },
  ...
  getWriteLocations() {
    return this.proxy.sendMessage(
      ...
      mojo.internal.bindings.vrp_flags.mojom.VrpFlags_GetWriteLocations_ParamsSpec,
      mojo.internal.bindings.vrp_flags.mojom.VrpFlags_GetWriteLocations_ResponseParamsSpec,
      [],
      false);
  }
  ...
  writeAttempted(arg_location) {
    return this.proxy.sendMessage(
      ...
      mojo.internal.bindings.vrp_flags.mojom.VrpFlags_WriteAttempted_ParamsSpec,
      mojo.internal.bindings.vrp_flags.mojom.VrpFlags_WriteAttempted_ResponseParamsSpec,
      [arg_location],
      false);
  }
  ...
  getReadPrefix() {
    return this.proxy.sendMessage(
      ...
      mojo.internal.bindings.vrp_flags.mojom.VrpFlags_GetReadPrefix_ParamsSpec,
      mojo.internal.bindings.vrp_flags.mojom.VrpFlags_GetReadPrefix_ResponseParamsSpec,
      [],
      false);
  }
  ...
  readAttempted(arg_flag) {
    return this.proxy.sendMessage(
      ...
      mojo.internal.bindings.vrp_flags.mojom.VrpFlags_ReadAttempted_ParamsSpec,
      mojo.internal.bindings.vrp_flags.mojom.VrpFlags_ReadAttempted_ResponseParamsSpec,
      [arg_flag],
      false);
  }
...
mojo.internal.bindings.vrp_flags.mojom.VrpFlags.getRemote = function() {
  let remote = new mojo.internal.bindings.vrp_flags.mojom.VrpFlagsRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
    'vrp_flags.mojom.VrpFlags',
    'context');
  return remote.$;
};

mojo.internal.bindings.vrp_flags.mojom.VrpFlagsReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('vrp_flags.mojom.VrpFlags', [
      { explicit: null },
      { explicit: null },
      { explicit: null },
      { explicit: null },
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        case 0: {
          ...
          const params = decoder.decodeStructInline(mojo.internal.bindings.vrp_flags.mojom.VrpFlags_GetWriteLocations_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.getWriteLocations');
          const result = this.impl.getWriteLocations();
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const message = new mojo.internal.Message(
                ...
                header.ordinal, header.requestId, mojo.internal.bindings.vrp_flags.mojom.VrpFlags_GetWriteLocations_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
            }).catch(e => console.error('[GeneratedReceiver] getWriteLocations FAILED:', e));
          }
          break;
        }
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.vrp_flags.mojom.VrpFlags_WriteAttempted_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.writeAttempted');
          const result = this.impl.writeAttempted(params.arg_location);
          const expectsResponse = header.expectsResponse || (header.flags & 1);
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.vrp_flags.mojom.VrpFlags_WriteAttempted_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
            }).catch(e => console.error('[GeneratedReceiver] writeAttempted FAILED:', e));
          }
          break;
        }
        case 2: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.vrp_flags.mojom.VrpFlags_GetReadPrefix_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.getReadPrefix');
          const result = this.impl.getReadPrefix();
          const expectsResponse = header.expectsResponse || (header.flags & 1);
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              const val = (response && typeof response === 'object' && 'arg_prefix' in response) ? response['arg_prefix'] : response;
              const resp_obj = { 'arg_prefix': val };
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.vrp_flags.mojom.VrpFlags_GetReadPrefix_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
            }).catch(e => console.error('[GeneratedReceiver] getReadPrefix FAILED:', e));
          }
          break;
        }
        case 3: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.vrp_flags.mojom.VrpFlags_ReadAttempted_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.readAttempted');
          const result = this.impl.readAttempted(params.arg_flag);
          const expectsResponse = header.expectsResponse || (header.flags & 1);
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              const val = (response && typeof response === 'object' && 'arg_success' in response) ? response['arg_success'] : response;
              ...
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.vrp_flags.mojom.VrpFlags_ReadAttempted_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
            }).catch(e => console.error('[GeneratedReceiver] readAttempted FAILED:', e));
          }
          break;
        }
      }
...
mojo.internal.bindings.vrp_flags.mojom.VrpFlagsReceiver = mojo.internal.bindings.vrp_flags.mojom.VrpFlagsReceiver;

mojo.internal.bindings.vrp_flags.mojom.VrpFlagsPtr = mojo.internal.bindings.vrp_flags.mojom.VrpFlagsRemote;
mojo.internal.bindings.vrp_flags.mojom.VrpFlagsRequest = mojo.internal.bindings.vrp_flags.mojom.VrpFlagsPendingReceiver;


// Interface: VrpFlagsFactory
mojo.internal.bindings.vrp_flags.mojom.VrpFlagsFactoryPendingReceiver = class {
  constructor(handle) {
    this.handle = handle;
    if (handle) {
      this.__mojoHandle = handle.router_ ? handle.router_.pipe_ : (handle.pipe_ || handle);
...
mojo.internal.bindings.vrp_flags.mojom.VrpFlagsFactoryRemote = class {
  static get $interfaceName() {
    return 'vrp_flags.mojom.VrpFlagsFactory';
  }

  constructor(handle = undefined) {
    this.__mojoHandle = handle;
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.vrp_flags.mojom.VrpFlagsFactoryPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.vrp_flags.mojom.VrpFlagsFactoryRemoteCallHandler(this.proxy);
  }
  ...
  bindBrowserVrpFlags(arg_receiver) {
    return this.$.bindBrowserVrpFlags(arg_receiver);
  }
  bindNetworkVrpFlags(arg_receiver) {
    return this.$.bindNetworkVrpFlags(arg_receiver);
  }
...
mojo.internal.bindings.vrp_flags.mojom.VrpFlagsFactoryRemoteCallHandler = class {
  ...
  bindBrowserVrpFlags(arg_receiver) {
    return this.proxy.sendMessage(
      this.ordinals[0],  // ordinal
      mojo.internal.bindings.vrp_flags.mojom.VrpFlagsFactory_BindBrowserVrpFlags_ParamsSpec,
      null,
      [arg_receiver],
      false);
  }
  ...
  bindNetworkVrpFlags(arg_receiver) {
    return this.proxy.sendMessage(
      this.ordinals[1],  // ordinal
      mojo.internal.bindings.vrp_flags.mojom.VrpFlagsFactory_BindNetworkVrpFlags_ParamsSpec,
      null,
      [arg_receiver],
      false);
  }
  ...
  bindGpuVrpFlags(arg_receiver) {
    return this.proxy.sendMessage(
      this.ordinals[2],  // ordinal
      mojo.internal.bindings.vrp_flags.mojom.VrpFlagsFactory_BindGpuVrpFlags_ParamsSpec,
      null,
      [arg_receiver],
      false);
  }
...
mojo.internal.bindings.vrp_flags.mojom.VrpFlagsFactory.getRemote = function() {
  let remote = new mojo.internal.bindings.vrp_flags.mojom.VrpFlagsFactoryRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
    'vrp_flags.mojom.VrpFlagsFactory',
    'context');
  return remote.$;
};

mojo.internal.bindings.vrp_flags.mojom.VrpFlagsFactoryReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.vrp_flags.mojom.VrpFlagsFactory_BindBrowserVrpFlags_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.bindBrowserVrpFlags');
          const result = this.impl.bindBrowserVrpFlags(params.arg_receiver);
          break;
        }
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.vrp_flags.mojom.VrpFlagsFactory_BindNetworkVrpFlags_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.bindNetworkVrpFlags');
          const result = this.impl.bindNetworkVrpFlags(params.arg_receiver);
          break;
        }
        case 2: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
...
mojo.internal.bindings.vrp_flags.mojom.VrpFlagsFactoryReceiver = mojo.internal.bindings.vrp_flags.mojom.VrpFlagsFactoryReceiver;

mojo.internal.bindings.vrp_flags.mojom.VrpFlagsFactoryPtr = mojo.internal.bindings.vrp_flags.mojom.VrpFlagsFactoryRemote;
mojo.internal.bindings.vrp_flags.mojom.VrpFlagsFactoryRequest = mojo.internal.bindings.vrp_flags.mojom.VrpFlagsFactoryPendingReceiver;


// Specs (at the end to ensure classes are defined for InterfaceProxy)
mojo.internal.Struct(
    mojo.internal.bindings.vrp_flags.mojom.VrpFlags_GetWriteLocations_ParamsSpec, 'vrp_flags.mojom.VrpFlags_GetWriteLocations_Params', [
    ],
    [[0, 8]]);

mojo.internal.Struct(
    mojo.internal.bindings.vrp_flags.mojom.VrpFlags_GetWriteLocations_ResponseParamsSpec, 'vrp_flags.mojom.VrpFlags_GetWriteLocations_ResponseParams', [
      mojo.internal.StructField('arg_locations', 0, 0, mojo.internal.Array(mojo.internal.Uint64, false), null, false, 0, undefined),
      mojo.internal.StructField('arg_value', 8, 0, mojo.internal.Uint64, 0, false, 0, undefined),
    ],
    [[0, 24]]);

mojo.internal.Struct(
    mojo.internal.bindings.vrp_flags.mojom.VrpFlags_WriteAttempted_ParamsSpec, 'vrp_flags.mojom.VrpFlags_WriteAttempted_Params', [
      mojo.internal.StructField('arg_location', 0, 0, mojo.internal.Uint64, 0, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.vrp_flags.mojom.VrpFlags_WriteAttempted_ResponseParamsSpec, 'vrp_flags.mojom.VrpFlags_WriteAttempted_ResponseParams', [
      mojo.internal.StructField('arg_success', 0, 0, mojo.internal.Bool, false, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.vrp_flags.mojom.VrpFlags_GetReadPrefix_ParamsSpec, 'vrp_flags.mojom.VrpFlags_GetReadPrefix_Params', [
    ],
    [[0, 8]]);

mojo.internal.Struct(
    mojo.internal.bindings.vrp_flags.mojom.VrpFlags_GetReadPrefix_ResponseParamsSpec, 'vrp_flags.mojom.VrpFlags_GetReadPrefix_ResponseParams', [
      mojo.internal.StructField('arg_prefix', 0, 0, mojo.internal.bindings.mojo_base.mojom.UnguessableTokenSpec, null, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.vrp_flags.mojom.VrpFlags_ReadAttempted_ParamsSpec, 'vrp_flags.mojom.VrpFlags_ReadAttempted_Params', [
      mojo.internal.StructField('arg_flag', 0, 0, mojo.internal.bindings.mojo_base.mojom.UnguessableTokenSpec, null, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.vrp_flags.mojom.VrpFlags_ReadAttempted_ResponseParamsSpec, 'vrp_flags.mojom.VrpFlags_ReadAttempted_ResponseParams', [
      mojo.internal.StructField('arg_success', 0, 0, mojo.internal.Bool, false, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.vrp_flags.mojom.VrpFlagsFactory_BindBrowserVrpFlags_ParamsSpec, 'vrp_flags.mojom.VrpFlagsFactory_BindBrowserVrpFlags_Params', [
...
mojo.internal.Struct(
    mojo.internal.bindings.vrp_flags.mojom.VrpFlagsFactory_BindNetworkVrpFlags_ParamsSpec, 'vrp_flags.mojom.VrpFlagsFactory_BindNetworkVrpFlags_Params', [
      mojo.internal.StructField('arg_receiver', 0, 0, mojo.internal.InterfaceRequest(mojo.internal.bindings.vrp_flags.mojom.VrpFlagsPendingReceiver), null, false, 0, undefined),
    ],
    [[0, 16]]);
