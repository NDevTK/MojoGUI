...
mojo.internal.bindings.metrics.mojom.CallStackProfileCollectorTest = {};
mojo.internal.bindings.metrics.mojom.CallStackProfileCollectorTestSpec = { $ : {} };
mojo.internal.bindings.metrics.mojom.CallStackProfileCollectorTest.$interfaceName = 'metrics.mojom.CallStackProfileCollectorTest';
...
mojo.internal.bindings.metrics.mojom.CallStackProfileCollectorTestRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.metrics.mojom.CallStackProfileCollectorTestPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.metrics.mojom.CallStackProfileCollectorTestRemoteCallHandler(this.proxy);
  }
  ...
  bounceSampledProfile(arg_in) {
    return this.$.bounceSampledProfile(arg_in);
  }
};

mojo.internal.bindings.metrics.mojom.CallStackProfileCollectorTestRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('metrics.mojom.CallStackProfileCollectorTest', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.metrics.mojom.CallStackProfileCollectorTest.getRemote = function() {
  let remote = new mojo.internal.bindings.metrics.mojom.CallStackProfileCollectorTestRemote();
...
mojo.internal.bindings.metrics.mojom.CallStackProfileCollectorTestReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('metrics.mojom.CallStackProfileCollectorTest', [
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.metrics.mojom.CallStackProfileCollectorTest_BounceSampledProfile_ParamsSpec.$.structSpec);
        ...
        case 0: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.metrics.mojom.CallStackProfileCollectorTest_BounceSampledProfile_ResponseParamsSpec, header, rawHeader);
               responder(response);
...
mojo.internal.bindings.metrics.mojom.CallStackProfileCollectorTestReceiver = mojo.internal.bindings.metrics.mojom.CallStackProfileCollectorTestReceiver;
