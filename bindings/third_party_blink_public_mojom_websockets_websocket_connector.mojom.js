...
mojo.internal.bindings.blink.mojom.WebSocketConnector = {};
mojo.internal.bindings.blink.mojom.WebSocketConnectorSpec = { $ : {} };
mojo.internal.bindings.blink.mojom.WebSocketConnector.$interfaceName = 'blink.mojom.WebSocketConnector';
...
mojo.internal.Struct(
    mojo.internal.bindings.blink.mojom.WebSocketConnector_Connect_ParamsSpec, 'blink.mojom.WebSocketConnector_Connect_Params', [
      ...
      mojo.internal.StructField('arg_handshake_client', 32, 0, mojo.internal.InterfaceProxy(mojo.internal.bindings.network.mojom.WebSocketHandshakeClientRemote), null, false, 0, undefined),
      mojo.internal.StructField('arg_throttling_profile_id', 40, 0, mojo.internal.bindings.mojo_base.mojom.UnguessableTokenSpec, null, true, 0, undefined),
...
mojo.internal.bindings.blink.mojom.WebSocketConnectorRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.blink.mojom.WebSocketConnectorPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.blink.mojom.WebSocketConnectorRemoteCallHandler(this.proxy);
  }
  ...
  connect(arg_url, arg_requested_protocols, arg_site_for_cookies, arg_user_agent, arg_storage_access_api_status, arg_handshake_client, arg_throttling_profile_id) {
    return this.$.connect(arg_url, arg_requested_protocols, arg_site_for_cookies, arg_user_agent, arg_storage_access_api_status, arg_handshake_client, arg_throttling_profile_id);
  }
};

mojo.internal.bindings.blink.mojom.WebSocketConnectorRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('blink.mojom.WebSocketConnector', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.blink.mojom.WebSocketConnector.getRemote = function() {
  let remote = new mojo.internal.bindings.blink.mojom.WebSocketConnectorRemote();
...
mojo.internal.bindings.blink.mojom.WebSocketConnectorReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('blink.mojom.WebSocketConnector', [
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.blink.mojom.WebSocketConnector_Connect_ParamsSpec.$.structSpec;
...
mojo.internal.bindings.blink.mojom.WebSocketConnectorReceiver = mojo.internal.bindings.blink.mojom.WebSocketConnectorReceiver;
