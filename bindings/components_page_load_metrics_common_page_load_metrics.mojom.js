...
mojo.internal.bindings.blink.mojom.JavaScriptFrameworkDetectionResultSpec = mojo.internal.bindings.blink.mojom.JavaScriptFrameworkDetectionResultSpec || { $: mojo.internal.OpaqueStruct.$ };
mojo.internal.bindings.blink = mojo.internal.bindings.blink || {};
mojo.internal.bindings.blink.mojom = mojo.internal.bindings.blink.mojom || {};
mojo.internal.bindings.blink.mojom.UseCounterFeatureSpec = mojo.internal.bindings.blink.mojom.UseCounterFeatureSpec || { $: mojo.internal.OpaqueStruct.$ };
mojo.internal.bindings.gfx = mojo.internal.bindings.gfx || {};
...
mojo.internal.Struct(
    mojo.internal.bindings.page_load_metrics.mojom.LargestContentfulPaintTimingSpec, 'page_load_metrics.mojom.LargestContentfulPaintTiming', [
      ...
      mojo.internal.StructField('arg_image_request_priority_valid', 60, 0, mojo.internal.Bool, false, false, 0, undefined),
    ],
    [[0, 72]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.page_load_metrics.mojom.ResourceDataUpdateSpec, 'page_load_metrics.mojom.ResourceDataUpdate', [
      ...
      mojo.internal.StructField('arg_cache_type', 44, 0, mojo.internal.bindings.page_load_metrics.mojom.CacheTypeSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_is_complete', 48, 0, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_reported_as_ad_resource', 48, 1, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_is_main_frame_resource', 48, 2, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_is_primary_frame_resource', 48, 3, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_is_secure_scheme', 48, 4, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_proxy_used', 48, 5, mojo.internal.Bool, false, false, 0, undefined),
    ],
    [[0, 64]]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.page_load_metrics.mojom.PageLoadMetrics_UpdateTiming_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for UpdateTiming failed with TypeError');
           }
        }
        // Try Method 1: SetUpSharedMemoryForDroppedFrames
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.page_load_metrics.mojom.PageLoadMetrics_SetUpSharedMemoryForDroppedFrames_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for SetUpSharedMemoryForDroppedFrames failed with TypeError');
           }
        }
        // Try Method 2: AddCustomUserTiming
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.page_load_metrics.mojom.PageLoadMetrics_AddCustomUserTiming_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for AddCustomUserTiming failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
