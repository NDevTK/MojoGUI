...
mojo.internal.bindings.device.mojom.SensorClientController = mojo.internal.bindings.device.mojom.SensorClientController || {};
mojo.internal.bindings.device.mojom.SensorClientControllerSpec = mojo.internal.bindings.device.mojom.SensorClientControllerSpec || { $ : {} };
if (mojo.internal.bindings.device.mojom.SensorClientControllerSpec.$.structSpec && mojo.internal.bindings.device.mojom.SensorClientControllerSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.device.mojom.SensorClientControllerSpec.$ = {};
mojo.internal.bindings.device.mojom.SensorClientController.$interfaceName = 'device.mojom.SensorClientController';
mojo.internal.bindings.device.mojom.SensorClientController_Suspend_ParamsSpec = mojo.internal.bindings.device.mojom.SensorClientController_Suspend_ParamsSpec || { $: {} };
if (mojo.internal.bindings.device.mojom.SensorClientController_Suspend_ParamsSpec.$.structSpec && mojo.internal.bindings.device.mojom.SensorClientController_Suspend_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.device.mojom.SensorClientController_Suspend_ParamsSpec.$ = {};
mojo.internal.bindings.device.mojom.SensorClientController_Resume_ParamsSpec = mojo.internal.bindings.device.mojom.SensorClientController_Resume_ParamsSpec || { $: {} };
if (mojo.internal.bindings.device.mojom.SensorClientController_Resume_ParamsSpec.$.structSpec && mojo.internal.bindings.device.mojom.SensorClientController_Resume_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.device.mojom.SensorClientController_Resume_ParamsSpec.$ = {};
...
mojo.internal.bindings.device = mojo.internal.bindings.device || {};
mojo.internal.bindings.device.mojom = mojo.internal.bindings.device.mojom || {};
mojo.internal.bindings.device.mojom.GetVirtualSensorInformationResultSpec = mojo.internal.bindings.device.mojom.GetVirtualSensorInformationResultSpec || { $: mojo.internal.OpaqueStruct.$ };
mojo.internal.bindings.device = mojo.internal.bindings.device || {};
mojo.internal.bindings.device.mojom = mojo.internal.bindings.device.mojom || {};
...
mojo.internal.bindings.device = mojo.internal.bindings.device || {};
mojo.internal.bindings.device.mojom = mojo.internal.bindings.device.mojom || {};
mojo.internal.bindings.device.mojom.SensorSpec = mojo.internal.bindings.device.mojom.SensorSpec || { $: mojo.internal.OpaqueStruct.$ };
mojo.internal.bindings.device.mojom.SensorRemote = mojo.internal.bindings.device.mojom.SensorRemote || class {};
mojo.internal.bindings.device.mojom.SensorPendingReceiver = mojo.internal.bindings.device.mojom.SensorPendingReceiver || class { constructor(handle) { this.handle = handle; } };
mojo.internal.bindings.device = mojo.internal.bindings.device || {};
mojo.internal.bindings.device.mojom = mojo.internal.bindings.device.mojom || {};
mojo.internal.bindings.device.mojom.SensorClientSpec = mojo.internal.bindings.device.mojom.SensorClientSpec || { $: mojo.internal.OpaqueStruct.$ };
mojo.internal.bindings.device.mojom.SensorClientRemote = mojo.internal.bindings.device.mojom.SensorClientRemote || class {};
mojo.internal.bindings.device.mojom.SensorClientPendingReceiver = mojo.internal.bindings.device.mojom.SensorClientPendingReceiver || class { constructor(handle) { this.handle = handle; } };
mojo.internal.bindings.device = mojo.internal.bindings.device || {};
mojo.internal.bindings.device.mojom = mojo.internal.bindings.device.mojom || {};
mojo.internal.bindings.device.mojom.SensorConfigurationSpec = mojo.internal.bindings.device.mojom.SensorConfigurationSpec || { $: mojo.internal.OpaqueStruct.$ };
mojo.internal.bindings.device = mojo.internal.bindings.device || {};
mojo.internal.bindings.device.mojom = mojo.internal.bindings.device.mojom || {};
mojo.internal.bindings.device.mojom.SensorReadingRawSpec = mojo.internal.bindings.device.mojom.SensorReadingRawSpec || { $: mojo.internal.OpaqueStruct.$ };
mojo.internal.bindings.device = mojo.internal.bindings.device || {};
mojo.internal.bindings.device.mojom = mojo.internal.bindings.device.mojom || {};
...
mojo.internal.bindings.device.mojom.kReadBufferSizeForTests = 48;

// Enum: SensorCreationResult
mojo.internal.bindings.device.mojom.SensorCreationResult = {
  SUCCESS: 0,
...
mojo.internal.bindings.device.mojom.CreateVirtualSensorResult = {
  kSuccess: 0,
  kSensorTypeAlreadyOverridden: 1,
};

// Enum: UpdateVirtualSensorResult
mojo.internal.bindings.device.mojom.UpdateVirtualSensorResult = {
  kSuccess: 0,
  kSensorTypeNotOverridden: 1,
};

// Enum: GetVirtualSensorInformationError
mojo.internal.bindings.device.mojom.GetVirtualSensorInformationError = {
  kSensorTypeNotOverridden: 0,
};

// Interface: SensorClientController
mojo.internal.bindings.device.mojom.SensorClientControllerPendingReceiver = class {
  constructor(handle) {
    this.handle = handle;
    if (handle) {
...
mojo.internal.bindings.device.mojom.SensorClientControllerRemote = class {
  static get $interfaceName() {
    return 'device.mojom.SensorClientController';
  }

  constructor(handle = undefined) {
    this.__mojoHandle = handle;
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.device.mojom.SensorClientControllerPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.device.mojom.SensorClientControllerRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.device.mojom.SensorClientControllerRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('device.mojom.SensorClientController', [
      { explicit: null },
      { explicit: null },
    ]);
  }
  ...
  suspend() {
    return this.proxy.sendMessage(
      ...
      mojo.internal.bindings.device.mojom.SensorClientController_Suspend_ParamsSpec,
      null,
      [],
      false);
  }
  ...
  resume() {
    return this.proxy.sendMessage(
      ...
      mojo.internal.bindings.device.mojom.SensorClientController_Resume_ParamsSpec,
      null,
      [],
      false);
  }
...
mojo.internal.bindings.device.mojom.SensorClientController.getRemote = function() {
  let remote = new mojo.internal.bindings.device.mojom.SensorClientControllerRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
    'device.mojom.SensorClientController',
    'context');
  return remote.$;
};

mojo.internal.bindings.device.mojom.SensorClientControllerReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('device.mojom.SensorClientController', [
      { explicit: null },
      { explicit: null },
    ]);
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        case 0: {
          ...
          const params = decoder.decodeStructInline(mojo.internal.bindings.device.mojom.SensorClientController_Suspend_ParamsSpec.$.structSpec);
        ...
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.device.mojom.SensorClientController_Resume_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.device.mojom.SensorClientControllerReceiver = mojo.internal.bindings.device.mojom.SensorClientControllerReceiver;

mojo.internal.bindings.device.mojom.SensorClientControllerPtr = mojo.internal.bindings.device.mojom.SensorClientControllerRemote;
mojo.internal.bindings.device.mojom.SensorClientControllerRequest = mojo.internal.bindings.device.mojom.SensorClientControllerPendingReceiver;
...
mojo.internal.bindings.device.mojom.SensorProviderRemote = class {
  static get $interfaceName() {
  ...
  constructor(handle = undefined) {
    this.__mojoHandle = handle;
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.device.mojom.SensorProviderPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.device.mojom.SensorProviderRemoteCallHandler(this.proxy);
  }
  ...
  getSensor(arg_type, arg_controller, arg_initially_suspended) {
    return this.$.getSensor(arg_type, arg_controller, arg_initially_suspended);
  }
  createVirtualSensor(arg_type, arg_metadata) {
    return this.$.createVirtualSensor(arg_type, arg_metadata);
  }
  updateVirtualSensor(arg_type, arg_reading) {
    return this.$.updateVirtualSensor(arg_type, arg_reading);
  }
  removeVirtualSensor(arg_type) {
    return this.$.removeVirtualSensor(arg_type);
  }
  getVirtualSensorInformation(arg_type) {
    return this.$.getVirtualSensorInformation(arg_type);
  }
};

mojo.internal.bindings.device.mojom.SensorProviderRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('device.mojom.SensorProvider', [
      { explicit: null },
      { explicit: null },
      { explicit: null },
      { explicit: null },
  ...
  getSensor(arg_type, arg_controller, arg_initially_suspended) {
    return this.proxy.sendMessage(
      ...
      [arg_type, arg_controller, arg_initially_suspended],
      false);
  }
...
mojo.internal.bindings.device.mojom.SensorProvider.getRemote = function() {
  let remote = new mojo.internal.bindings.device.mojom.SensorProviderRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
...
mojo.internal.bindings.device.mojom.SensorProviderReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('device.mojom.SensorProvider', [
      { explicit: null },
      { explicit: null },
      { explicit: null },
      { explicit: null },
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        case 0: {
          ...
          const result = this.impl.getSensor(params.arg_type, params.arg_controller, params.arg_initially_suspended);
...
mojo.internal.bindings.device.mojom.SensorProviderReceiver = mojo.internal.bindings.device.mojom.SensorProviderReceiver;

mojo.internal.bindings.device.mojom.SensorProviderPtr = mojo.internal.bindings.device.mojom.SensorProviderRemote;
mojo.internal.bindings.device.mojom.SensorProviderRequest = mojo.internal.bindings.device.mojom.SensorProviderPendingReceiver;
...
mojo.internal.Struct(
    mojo.internal.bindings.device.mojom.VirtualSensorMetadataSpec, 'device.mojom.VirtualSensorMetadata', [
      ...
      mojo.internal.StructField('arg_maximum_frequency_$flag', 0, 1, mojo.internal.Bool, false, false, 0, { isPrimary: true, linkedValueFieldName: 'arg_maximum_frequency_$value', originalFieldName: 'arg_maximum_frequency' }),
      mojo.internal.StructField('arg_minimum_frequency_$flag', 0, 2, mojo.internal.Bool, false, false, 0, { isPrimary: true, linkedValueFieldName: 'arg_minimum_frequency_$value', originalFieldName: 'arg_minimum_frequency' }),
      mojo.internal.StructField('arg_reporting_mode', 4, 0, mojo.internal.bindings.device.mojom.ReportingModeSpec, null, true, 0, undefined),
      mojo.internal.StructField('arg_maximum_frequency_$value', 8, 0, mojo.internal.Double, 0, false, 0, { isPrimary: false, linkedValueFieldName: 'arg_maximum_frequency_$flag', originalFieldName: 'arg_maximum_frequency' }),
      mojo.internal.StructField('arg_minimum_frequency_$value', 16, 0, mojo.internal.Double, 0, false, 0, { isPrimary: false, linkedValueFieldName: 'arg_minimum_frequency_$flag', originalFieldName: 'arg_minimum_frequency' }),
    ],
    [[0, 32]]);

// Struct: VirtualSensorInformation
mojo.internal.Struct(
    mojo.internal.bindings.device.mojom.VirtualSensorInformationSpec, 'device.mojom.VirtualSensorInformation', [
      mojo.internal.StructField('arg_sampling_frequency', 0, 0, mojo.internal.Double, 0, false, 0, undefined),
    ],
    [[0, 16]]);
mojo.internal.Struct(
    mojo.internal.bindings.device.mojom.SensorClientController_Suspend_ParamsSpec, 'device.mojom.SensorClientController_Suspend_Params', [
    ],
    [[0, 8]]);

mojo.internal.Struct(
    mojo.internal.bindings.device.mojom.SensorClientController_Resume_ParamsSpec, 'device.mojom.SensorClientController_Resume_Params', [
    ],
    [[0, 8]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.device.mojom.SensorProvider_GetSensor_ParamsSpec, 'device.mojom.SensorProvider_GetSensor_Params', [
      ...
      mojo.internal.StructField('arg_controller', 4, 0, mojo.internal.InterfaceRequest(mojo.internal.bindings.device.mojom.SensorClientControllerPendingReceiver), null, true, 0, undefined),
      mojo.internal.StructField('arg_initially_suspended', 8, 0, mojo.internal.Bool, false, false, 0, undefined),
    ],
    [[0, 24]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.device.mojom.SensorProvider_RemoveVirtualSensor_ResponseParamsSpec, 'device.mojom.SensorProvider_RemoveVirtualSensor_ResponseParams', [
    ],
    [[0, 8]]);
