...
mojo.internal.bindings.arc.mojom.InstallErrorReason = {
...
mojo.internal.bindings.arc.mojom.CommandResultType = {
  IGNORED: 0,
  FAILURE: 1,
  SUCCESS: 2,
};
...
mojo.internal.bindings.arc.mojom.PolicyHostRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.arc.mojom.PolicyHostPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.arc.mojom.PolicyHostRemoteCallHandler(this.proxy);
  }
  ...
  reportCompliance(arg_request) {
    return this.$.reportCompliance(arg_request);
  }
  reportDPCVersion(arg_version) {
    return this.$.reportDPCVersion(arg_version);
  }
  reportPlayStoreLocalPolicySet(arg_time, arg_package_names) {
    return this.$.reportPlayStoreLocalPolicySet(arg_time, arg_package_names);
  }
};

mojo.internal.bindings.arc.mojom.PolicyHostRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('arc.mojom.PolicyHost', [
      { explicit: 0 },
      { explicit: 1 },
      { explicit: 7 },
      { explicit: 8 },
...
mojo.internal.bindings.arc.mojom.PolicyHost.getRemote = function() {
  let remote = new mojo.internal.bindings.arc.mojom.PolicyHostRemote();
...
mojo.internal.bindings.arc.mojom.PolicyHostReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('arc.mojom.PolicyHost', [
      { explicit: 0 },
      { explicit: 1 },
      { explicit: 7 },
      { explicit: 8 },
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.arc.mojom.PolicyHost_GetPolicies_ParamsSpec.$.structSpec);
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.arc.mojom.PolicyHost_ReportCompliance_ParamsSpec.$.structSpec);
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.arc.mojom.PolicyHost_ReportDPCVersion_ParamsSpec.$.structSpec);
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.arc.mojom.PolicyHost_ReportPlayStoreLocalPolicySet_ParamsSpec.$.structSpec);
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.arc.mojom.PolicyHost_GetPolicies_ParamsSpec.$.structSpec);
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.arc.mojom.PolicyHost_GetPolicies_ResponseParamsSpec, header, rawHeader);
               responder(response);
        ...
        case 1: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              const rawHeader = (args[2] && args[2].slice) ? args[2].slice(0, header.headerSize) : null;
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.arc.mojom.PolicyHost_ReportCompliance_ResponseParamsSpec, header, rawHeader);
               responder(response);
...
mojo.internal.bindings.arc.mojom.PolicyHostReceiver = mojo.internal.bindings.arc.mojom.PolicyHostReceiver;

mojo.internal.bindings.arc.mojom.PolicyHostPtr = mojo.internal.bindings.arc.mojom.PolicyHostRemote;
mojo.internal.bindings.arc.mojom.PolicyHostRequest = mojo.internal.bindings.arc.mojom.PolicyHostPendingReceiver;
...
mojo.internal.bindings.arc.mojom.PolicyInstanceRemote = class {
  static get $interfaceName() {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.arc.mojom.PolicyInstancePendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.arc.mojom.PolicyInstanceRemoteCallHandler(this.proxy);
  }
  ...
  onCommandReceived(arg_command) {
    return this.$.onCommandReceived(arg_command);
  }
};

mojo.internal.bindings.arc.mojom.PolicyInstanceRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('arc.mojom.PolicyInstance', [
      { explicit: 2 },
      { explicit: 1 },
      { explicit: 3 },
    ]);
...
mojo.internal.bindings.arc.mojom.PolicyInstance.getRemote = function() {
  let remote = new mojo.internal.bindings.arc.mojom.PolicyInstanceRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
...
mojo.internal.bindings.arc.mojom.PolicyInstanceReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('arc.mojom.PolicyInstance', [
      { explicit: 2 },
      { explicit: 1 },
      { explicit: 3 },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.arc.mojom.PolicyInstance_Init_ParamsSpec.$.structSpec);
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.arc.mojom.PolicyInstance_OnPolicyUpdated_ParamsSpec.$.structSpec);
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.arc.mojom.PolicyInstance_OnCommandReceived_ParamsSpec.$.structSpec);
      ...
      switch (dispatchId) {
        case 0: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              const rawHeader = (args[2] && args[2].slice) ? args[2].slice(0, header.headerSize) : null;
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.arc.mojom.PolicyInstance_Init_ResponseParamsSpec, header, rawHeader);
               responder(response);
        ...
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.arc.mojom.PolicyInstance_OnPolicyUpdated_ParamsSpec.$.structSpec);
        ...
        case 2: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              const rawHeader = (args[2] && args[2].slice) ? args[2].slice(0, header.headerSize) : null;
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.arc.mojom.PolicyInstance_OnCommandReceived_ResponseParamsSpec, header, rawHeader);
               responder(response);
...
mojo.internal.bindings.arc.mojom.PolicyInstanceReceiver = mojo.internal.bindings.arc.mojom.PolicyInstanceReceiver;
