...
mojo.internal.bindings.remoting.mojom.ChromotingHostServicesRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.remoting.mojom.ChromotingHostServicesRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.remoting.mojom.ChromotingHostServices.getRemote = function() {
  let remote = new mojo.internal.bindings.remoting.mojom.ChromotingHostServicesRemote();
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.remoting.mojom.ChromotingHostServices_BindSessionServices_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for BindSessionServices failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.remoting.mojom.ChromotingHostServicesReceiver = mojo.internal.bindings.remoting.mojom.ChromotingHostServicesReceiver;

mojo.internal.bindings.remoting.mojom.ChromotingHostServicesPtr = mojo.internal.bindings.remoting.mojom.ChromotingHostServicesRemote;
mojo.internal.bindings.remoting.mojom.ChromotingHostServicesRequest = mojo.internal.bindings.remoting.mojom.ChromotingHostServicesPendingReceiver;
...
mojo.internal.bindings.remoting.mojom.ChromotingSessionServicesRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.remoting.mojom.ChromotingSessionServicesRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.remoting.mojom.ChromotingSessionServices.getRemote = function() {
  let remote = new mojo.internal.bindings.remoting.mojom.ChromotingSessionServicesRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.remoting.mojom.ChromotingSessionServices_BindWebAuthnProxy_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for BindWebAuthnProxy failed with TypeError');
           }
        }
        // Try Method 1: BindRemoteUrlOpener
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.remoting.mojom.ChromotingSessionServices_BindRemoteUrlOpener_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for BindRemoteUrlOpener failed with TypeError');
           }
        }
        // Try Method 2: BindSecurityKeyForwarder
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.remoting.mojom.ChromotingSessionServices_BindSecurityKeyForwarder_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for BindSecurityKeyForwarder failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
             console.warn('[GeneratedReceiver] Failed to discover ordinal ' + header.ordinal);
...
mojo.internal.bindings.remoting.mojom.ChromotingSessionServicesReceiver = mojo.internal.bindings.remoting.mojom.ChromotingSessionServicesReceiver;
