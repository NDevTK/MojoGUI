...
mojo.internal.bindings.network.mojom.AcceptCHFrameObserver = {};
mojo.internal.bindings.network.mojom.AcceptCHFrameObserverSpec = { $ : {} };
mojo.internal.bindings.network.mojom.AcceptCHFrameObserver.$interfaceName = 'network.mojom.AcceptCHFrameObserver';
...
mojo.internal.Struct(
    mojo.internal.bindings.network.mojom.AcceptCHFrameObserver_OnAcceptCHFrameReceived_ResponseParamsSpec, 'network.mojom.AcceptCHFrameObserver_OnAcceptCHFrameReceived_ResponseParams', [
...
mojo.internal.bindings.network.mojom.AcceptCHFrameObserverPendingReceiver = class {
  constructor(handle) {
    this.handle = handle;
  }
};

mojo.internal.bindings.network.mojom.AcceptCHFrameObserverRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.network.mojom.AcceptCHFrameObserverPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.network.mojom.AcceptCHFrameObserverRemoteCallHandler(this.proxy);
  }
  ...
  onAcceptCHFrameReceived(arg_origin, arg_accept_ch_frame) {
    return this.$.onAcceptCHFrameReceived(arg_origin, arg_accept_ch_frame);
  }
  clone(arg_listener) {
...
mojo.internal.bindings.network.mojom.AcceptCHFrameObserverRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('network.mojom.AcceptCHFrameObserver', [
      { explicit: null },
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.network.mojom.AcceptCHFrameObserver.getRemote = function() {
  let remote = new mojo.internal.bindings.network.mojom.AcceptCHFrameObserverRemote();
...
mojo.internal.bindings.network.mojom.AcceptCHFrameObserverReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('network.mojom.AcceptCHFrameObserver', [
      { explicit: null },
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.network.mojom.AcceptCHFrameObserver_OnAcceptCHFrameReceived_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OnAcceptCHFrameReceived failed with TypeError');
           }
        }
        // Try Method 1: Clone
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.network.mojom.AcceptCHFrameObserver_Clone_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
        ...
        case 0: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              this.endpoint.send(header.ordinal, header.requestId, mojo.internal.kMessageFlagIsResponse, mojo.internal.bindings.network.mojom.AcceptCHFrameObserver_OnAcceptCHFrameReceived_ResponseParamsSpec, response);
...
mojo.internal.bindings.network.mojom.AcceptCHFrameObserverReceiver = mojo.internal.bindings.network.mojom.AcceptCHFrameObserverReceiver;

mojo.internal.bindings.network.mojom.AcceptCHFrameObserverPtr = mojo.internal.bindings.network.mojom.AcceptCHFrameObserverRemote;
mojo.internal.bindings.network.mojom.AcceptCHFrameObserverRequest = mojo.internal.bindings.network.mojom.AcceptCHFrameObserverPendingReceiver;
