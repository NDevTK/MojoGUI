...
media.mojom.CdmContextEventCallback_EventCallback_ParamsSpec = {
  $: {
    structSpec: {
      ...
      packedSize: 16,
      fields: [
        { name: 'event', packedOffset: 0, packedBitOffset: 0, type: media.mojom.CdmContextEventSpec, nullable: false },
      ],
      versions: [{version: 0}]
    }
  }
...
media.mojom.CdmContextForOOPVD_GetHwConfigData_ResponseParamsSpec = {
  $: {
    structSpec: {
      ...
      packedSize: 24,
      fields: [
        { name: 'config_data', packedOffset: 0, packedBitOffset: 0, type: mojo.internal.Array, nullable: false },
...
media.mojom.CdmContextForOOPVD_ParseEncryptedSliceHeader_ParamsSpec = {
  $: {
    structSpec: {
      ...
      packedSize: 32,
      fields: [
        { name: 'secure_handle', packedOffset: 0, packedBitOffset: 0, type: mojo.internal.Uint64, nullable: false },
        { name: 'stream_data', packedOffset: 8, packedBitOffset: 0, type: mojo.internal.Array, nullable: false },
...
media.mojom.CdmContextForOOPVD_ParseEncryptedSliceHeader_ResponseParamsSpec = {
  $: {
    structSpec: {
      ...
      packedSize: 24,
      fields: [
        { name: 'slice_header', packedOffset: 0, packedBitOffset: 0, type: mojo.internal.Array, nullable: false },
        { name: 'success', packedOffset: 8, packedBitOffset: 0, type: mojo.internal.Bool, nullable: false },
      ],
      versions: [{version: 0}]
    }
