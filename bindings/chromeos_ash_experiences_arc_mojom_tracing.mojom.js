...
mojo.internal.bindings.arc.mojom.TracingInstance = {};
mojo.internal.bindings.arc.mojom.TracingInstanceSpec = { $ : {} };
mojo.internal.bindings.arc.mojom.TracingInstance.$interfaceName = 'arc.mojom.TracingInstance';
...
mojo.internal.bindings.arc.mojom.TracingInstanceRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.arc.mojom.TracingInstanceRemoteCallHandler(this.proxy);
  }
  ...
  startTracing(arg_categories, arg_socket) {
    return this.$.startTracing(arg_categories, arg_socket);
  }
  stopTracing() {
...
mojo.internal.bindings.arc.mojom.TracingInstanceRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('arc.mojom.TracingInstance', [
      { explicit: 0 },
      { explicit: 1 },
      { explicit: 2 },
    ]);
...
mojo.internal.bindings.arc.mojom.TracingInstance.getRemote = function() {
  let remote = new mojo.internal.bindings.arc.mojom.TracingInstanceRemote();
...
mojo.internal.bindings.arc.mojom.TracingInstanceReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('arc.mojom.TracingInstance', [
      { explicit: 0 },
      { explicit: 1 },
      { explicit: 2 },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.arc.mojom.TracingInstance_QueryAvailableCategories_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for QueryAvailableCategories failed with TypeError');
           }
        }
        // Try Method 1: StartTracing
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.arc.mojom.TracingInstance_StartTracing_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for StartTracing failed with TypeError');
           }
        }
        // Try Method 2: StopTracing
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.arc.mojom.TracingInstance_StopTracing_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for StopTracing failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.arc.mojom.TracingInstance_QueryAvailableCategories_ParamsSpec.$.structSpec);
        ...
        case 2: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.arc.mojom.TracingInstance_StopTracing_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.arc.mojom.TracingInstanceReceiver = mojo.internal.bindings.arc.mojom.TracingInstanceReceiver;
