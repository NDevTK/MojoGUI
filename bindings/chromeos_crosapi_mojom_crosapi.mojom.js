...
mojo.internal.bindings.chromeos.auth.mojom.InSessionAuthSpec = mojo.internal.bindings.chromeos.auth.mojom.InSessionAuthSpec || { $: mojo.internal.OpaqueStruct.$ };
mojo.internal.bindings.chromeos.auth.mojom.InSessionAuthRemote = mojo.internal.bindings.chromeos.auth.mojom.InSessionAuthRemote || class {};
mojo.internal.bindings.chromeos.auth.mojom.InSessionAuthPendingReceiver = mojo.internal.bindings.chromeos.auth.mojom.InSessionAuthPendingReceiver || class { constructor(handle) { this.handle = handle; } };
mojo.internal.bindings.chromeos = mojo.internal.bindings.chromeos || {};
...
mojo.internal.bindings.chromeos.cfm.mojom.CfmServiceContextSpec = mojo.internal.bindings.chromeos.cfm.mojom.CfmServiceContextSpec || { $: mojo.internal.OpaqueStruct.$ };
mojo.internal.bindings.chromeos.cfm.mojom.CfmServiceContextRemote = mojo.internal.bindings.chromeos.cfm.mojom.CfmServiceContextRemote || class {};
mojo.internal.bindings.chromeos.cfm.mojom.CfmServiceContextPendingReceiver = mojo.internal.bindings.chromeos.cfm.mojom.CfmServiceContextPendingReceiver || class { constructor(handle) { this.handle = handle; } };
mojo.internal.bindings.chromeos = mojo.internal.bindings.chromeos || {};
...
mojo.internal.bindings.crosapi = mojo.internal.bindings.crosapi || {};
mojo.internal.bindings.crosapi.mojom = mojo.internal.bindings.crosapi.mojom || {};
mojo.internal.bindings.crosapi.mojom.AccountManagerSpec = mojo.internal.bindings.crosapi.mojom.AccountManagerSpec || { $: mojo.internal.OpaqueStruct.$ };
mojo.internal.bindings.crosapi.mojom.AccountManagerRemote = mojo.internal.bindings.crosapi.mojom.AccountManagerRemote || class {};
mojo.internal.bindings.crosapi.mojom.AccountManagerPendingReceiver = mojo.internal.bindings.crosapi.mojom.AccountManagerPendingReceiver || class { constructor(handle) { this.handle = handle; } };
mojo.internal.bindings.crosapi = mojo.internal.bindings.crosapi || {};
mojo.internal.bindings.crosapi.mojom = mojo.internal.bindings.crosapi.mojom || {};
mojo.internal.bindings.crosapi.mojom.CrosDisplayConfigControllerSpec = mojo.internal.bindings.crosapi.mojom.CrosDisplayConfigControllerSpec || { $: mojo.internal.OpaqueStruct.$ };
mojo.internal.bindings.crosapi.mojom.CrosDisplayConfigControllerRemote = mojo.internal.bindings.crosapi.mojom.CrosDisplayConfigControllerRemote || class {};
mojo.internal.bindings.crosapi.mojom.CrosDisplayConfigControllerPendingReceiver = mojo.internal.bindings.crosapi.mojom.CrosDisplayConfigControllerPendingReceiver || class { constructor(handle) { this.handle = handle; } };
mojo.internal.bindings.crosapi = mojo.internal.bindings.crosapi || {};
mojo.internal.bindings.crosapi.mojom = mojo.internal.bindings.crosapi.mojom || {};
mojo.internal.bindings.crosapi.mojom.DiagnosticsServiceSpec = mojo.internal.bindings.crosapi.mojom.DiagnosticsServiceSpec || { $: mojo.internal.OpaqueStruct.$ };
mojo.internal.bindings.crosapi.mojom.DiagnosticsServiceRemote = mojo.internal.bindings.crosapi.mojom.DiagnosticsServiceRemote || class {};
mojo.internal.bindings.crosapi.mojom.DiagnosticsServicePendingReceiver = mojo.internal.bindings.crosapi.mojom.DiagnosticsServicePendingReceiver || class { constructor(handle) { this.handle = handle; } };
mojo.internal.bindings.crosapi = mojo.internal.bindings.crosapi || {};
mojo.internal.bindings.crosapi.mojom = mojo.internal.bindings.crosapi.mojom || {};
mojo.internal.bindings.crosapi.mojom.DocumentScanSpec = mojo.internal.bindings.crosapi.mojom.DocumentScanSpec || { $: mojo.internal.OpaqueStruct.$ };
mojo.internal.bindings.crosapi.mojom.DocumentScanRemote = mojo.internal.bindings.crosapi.mojom.DocumentScanRemote || class {};
mojo.internal.bindings.crosapi.mojom.DocumentScanPendingReceiver = mojo.internal.bindings.crosapi.mojom.DocumentScanPendingReceiver || class { constructor(handle) { this.handle = handle; } };
mojo.internal.bindings.crosapi = mojo.internal.bindings.crosapi || {};
mojo.internal.bindings.crosapi.mojom = mojo.internal.bindings.crosapi.mojom || {};
mojo.internal.bindings.crosapi.mojom.GuestOsSkForwarderFactorySpec = mojo.internal.bindings.crosapi.mojom.GuestOsSkForwarderFactorySpec || { $: mojo.internal.OpaqueStruct.$ };
mojo.internal.bindings.crosapi.mojom.GuestOsSkForwarderFactoryRemote = mojo.internal.bindings.crosapi.mojom.GuestOsSkForwarderFactoryRemote || class {};
mojo.internal.bindings.crosapi.mojom.GuestOsSkForwarderFactoryPendingReceiver = mojo.internal.bindings.crosapi.mojom.GuestOsSkForwarderFactoryPendingReceiver || class { constructor(handle) { this.handle = handle; } };
mojo.internal.bindings.crosapi = mojo.internal.bindings.crosapi || {};
mojo.internal.bindings.crosapi.mojom = mojo.internal.bindings.crosapi.mojom || {};
mojo.internal.bindings.crosapi.mojom.KeystoreServiceSpec = mojo.internal.bindings.crosapi.mojom.KeystoreServiceSpec || { $: mojo.internal.OpaqueStruct.$ };
mojo.internal.bindings.crosapi.mojom.KeystoreServiceRemote = mojo.internal.bindings.crosapi.mojom.KeystoreServiceRemote || class {};
mojo.internal.bindings.crosapi.mojom.KeystoreServicePendingReceiver = mojo.internal.bindings.crosapi.mojom.KeystoreServicePendingReceiver || class { constructor(handle) { this.handle = handle; } };
mojo.internal.bindings.crosapi = mojo.internal.bindings.crosapi || {};
mojo.internal.bindings.crosapi.mojom = mojo.internal.bindings.crosapi.mojom || {};
mojo.internal.bindings.crosapi.mojom.LocalPrinterSpec = mojo.internal.bindings.crosapi.mojom.LocalPrinterSpec || { $: mojo.internal.OpaqueStruct.$ };
mojo.internal.bindings.crosapi.mojom.LocalPrinterRemote = mojo.internal.bindings.crosapi.mojom.LocalPrinterRemote || class {};
mojo.internal.bindings.crosapi.mojom.LocalPrinterPendingReceiver = mojo.internal.bindings.crosapi.mojom.LocalPrinterPendingReceiver || class { constructor(handle) { this.handle = handle; } };
mojo.internal.bindings.crosapi = mojo.internal.bindings.crosapi || {};
mojo.internal.bindings.crosapi.mojom = mojo.internal.bindings.crosapi.mojom || {};
mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticRoutinesServiceSpec = mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticRoutinesServiceSpec || { $: mojo.internal.OpaqueStruct.$ };
mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticRoutinesServiceRemote = mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticRoutinesServiceRemote || class {};
mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticRoutinesServicePendingReceiver = mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticRoutinesServicePendingReceiver || class { constructor(handle) { this.handle = handle; } };
mojo.internal.bindings.crosapi = mojo.internal.bindings.crosapi || {};
mojo.internal.bindings.crosapi.mojom = mojo.internal.bindings.crosapi.mojom || {};
mojo.internal.bindings.crosapi.mojom.TelemetryManagementServiceSpec = mojo.internal.bindings.crosapi.mojom.TelemetryManagementServiceSpec || { $: mojo.internal.OpaqueStruct.$ };
mojo.internal.bindings.crosapi.mojom.TelemetryManagementServiceRemote = mojo.internal.bindings.crosapi.mojom.TelemetryManagementServiceRemote || class {};
mojo.internal.bindings.crosapi.mojom.TelemetryManagementServicePendingReceiver = mojo.internal.bindings.crosapi.mojom.TelemetryManagementServicePendingReceiver || class { constructor(handle) { this.handle = handle; } };
mojo.internal.bindings.crosapi = mojo.internal.bindings.crosapi || {};
mojo.internal.bindings.crosapi.mojom = mojo.internal.bindings.crosapi.mojom || {};
mojo.internal.bindings.crosapi.mojom.TelemetryProbeServiceSpec = mojo.internal.bindings.crosapi.mojom.TelemetryProbeServiceSpec || { $: mojo.internal.OpaqueStruct.$ };
mojo.internal.bindings.crosapi.mojom.TelemetryProbeServiceRemote = mojo.internal.bindings.crosapi.mojom.TelemetryProbeServiceRemote || class {};
mojo.internal.bindings.crosapi.mojom.TelemetryProbeServicePendingReceiver = mojo.internal.bindings.crosapi.mojom.TelemetryProbeServicePendingReceiver || class { constructor(handle) { this.handle = handle; } };
mojo.internal.bindings.crosapi = mojo.internal.bindings.crosapi || {};
mojo.internal.bindings.crosapi.mojom = mojo.internal.bindings.crosapi.mojom || {};
...
mojo.internal.bindings.crosapi.mojom.VideoCaptureDeviceFactoryRemote = mojo.internal.bindings.crosapi.mojom.VideoCaptureDeviceFactoryRemote || class {};
mojo.internal.bindings.crosapi.mojom.VideoCaptureDeviceFactoryPendingReceiver = mojo.internal.bindings.crosapi.mojom.VideoCaptureDeviceFactoryPendingReceiver || class { constructor(handle) { this.handle = handle; } };
mojo.internal.bindings.device = mojo.internal.bindings.device || {};
...
mojo.internal.bindings.media_session.mojom.AudioFocusManagerDebugPendingReceiver = mojo.internal.bindings.media_session.mojom.AudioFocusManagerDebugPendingReceiver || class { constructor(handle) { this.handle = handle; } };
mojo.internal.bindings.media_session = mojo.internal.bindings.media_session || {};
mojo.internal.bindings.media_session.mojom = mojo.internal.bindings.media_session.mojom || {};
...
mojo.internal.bindings.media_session.mojom.MediaControllerManagerPendingReceiver = mojo.internal.bindings.media_session.mojom.MediaControllerManagerPendingReceiver || class { constructor(handle) { this.handle = handle; } };
mojo.internal.bindings.mojo_base = mojo.internal.bindings.mojo_base || {};
...
mojo.internal.bindings.crosapi.mojom.CrosapiRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('crosapi.mojom.Crosapi', [
      { explicit: 7 },
      { explicit: 47 },
      { explicit: 142 },
      { explicit: 93 },
...
mojo.internal.bindings.crosapi.mojom.CrosapiReceiver = class {
  constructor(impl) {
    ...
    const ordinals = window.mojoScrambler.getOrdinals('crosapi.mojom.Crosapi', [
      { explicit: 7 },
      { explicit: 47 },
      { explicit: 142 },
      { explicit: 93 },
...
mojo.internal.Struct(
    mojo.internal.bindings.crosapi.mojom.Crosapi_BindAccountManager_ParamsSpec, 'crosapi.mojom.Crosapi_BindAccountManager_Params', [
      mojo.internal.StructField('arg_receiver', 0, 0, mojo.internal.InterfaceRequest(mojo.internal.bindings.crosapi.mojom.AccountManagerPendingReceiver), null, false, 0, undefined),
    ],
    [[0, 16]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.crosapi.mojom.Crosapi_BindCfmServiceContext_ParamsSpec, 'crosapi.mojom.Crosapi_BindCfmServiceContext_Params', [
      mojo.internal.StructField('arg_receiver', 0, 0, mojo.internal.InterfaceRequest(mojo.internal.bindings.chromeos.cfm.mojom.CfmServiceContextPendingReceiver), null, false, 0, undefined),
    ],
    [[0, 16]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.crosapi.mojom.Crosapi_BindCrosDisplayConfigController_ParamsSpec, 'crosapi.mojom.Crosapi_BindCrosDisplayConfigController_Params', [
      mojo.internal.StructField('arg_receiver', 0, 0, mojo.internal.InterfaceRequest(mojo.internal.bindings.crosapi.mojom.CrosDisplayConfigControllerPendingReceiver), null, false, 0, undefined),
    ],
    [[0, 16]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.crosapi.mojom.Crosapi_BindDiagnosticsService_ParamsSpec, 'crosapi.mojom.Crosapi_BindDiagnosticsService_Params', [
      mojo.internal.StructField('arg_receiver', 0, 0, mojo.internal.InterfaceRequest(mojo.internal.bindings.crosapi.mojom.DiagnosticsServicePendingReceiver), null, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.crosapi.mojom.Crosapi_BindDocumentScan_ParamsSpec, 'crosapi.mojom.Crosapi_BindDocumentScan_Params', [
      mojo.internal.StructField('arg_receiver', 0, 0, mojo.internal.InterfaceRequest(mojo.internal.bindings.crosapi.mojom.DocumentScanPendingReceiver), null, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.crosapi.mojom.Crosapi_BindInSessionAuth_ParamsSpec, 'crosapi.mojom.Crosapi_BindInSessionAuth_Params', [
      mojo.internal.StructField('arg_receiver', 0, 0, mojo.internal.InterfaceRequest(mojo.internal.bindings.chromeos.auth.mojom.InSessionAuthPendingReceiver), null, false, 0, undefined),
    ],
    [[0, 16]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.crosapi.mojom.Crosapi_BindKeystoreService_ParamsSpec, 'crosapi.mojom.Crosapi_BindKeystoreService_Params', [
      mojo.internal.StructField('arg_receiver', 0, 0, mojo.internal.InterfaceRequest(mojo.internal.bindings.crosapi.mojom.KeystoreServicePendingReceiver), null, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.crosapi.mojom.Crosapi_BindLocalPrinter_ParamsSpec, 'crosapi.mojom.Crosapi_BindLocalPrinter_Params', [
      mojo.internal.StructField('arg_receiver', 0, 0, mojo.internal.InterfaceRequest(mojo.internal.bindings.crosapi.mojom.LocalPrinterPendingReceiver), null, false, 0, undefined),
    ],
    [[0, 16]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.crosapi.mojom.Crosapi_BindTelemetryDiagnosticRoutinesService_ParamsSpec, 'crosapi.mojom.Crosapi_BindTelemetryDiagnosticRoutinesService_Params', [
      mojo.internal.StructField('arg_receiver', 0, 0, mojo.internal.InterfaceRequest(mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticRoutinesServicePendingReceiver), null, false, 0, undefined),
    ],
    [[0, 16]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.crosapi.mojom.Crosapi_BindTelemetryManagementService_ParamsSpec, 'crosapi.mojom.Crosapi_BindTelemetryManagementService_Params', [
      mojo.internal.StructField('arg_receiver', 0, 0, mojo.internal.InterfaceRequest(mojo.internal.bindings.crosapi.mojom.TelemetryManagementServicePendingReceiver), null, false, 0, undefined),
    ],
    [[0, 16]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.crosapi.mojom.Crosapi_BindTelemetryProbeService_ParamsSpec, 'crosapi.mojom.Crosapi_BindTelemetryProbeService_Params', [
      mojo.internal.StructField('arg_receiver', 0, 0, mojo.internal.InterfaceRequest(mojo.internal.bindings.crosapi.mojom.TelemetryProbeServicePendingReceiver), null, false, 0, undefined),
    ],
    [[0, 16]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.crosapi.mojom.Crosapi_BindVideoCaptureDeviceFactory_ParamsSpec, 'crosapi.mojom.Crosapi_BindVideoCaptureDeviceFactory_Params', [
      mojo.internal.StructField('arg_receiver', 0, 0, mojo.internal.InterfaceRequest(mojo.internal.bindings.crosapi.mojom.VideoCaptureDeviceFactoryPendingReceiver), null, false, 0, undefined),
    ],
    [[0, 16]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.crosapi.mojom.Crosapi_BindGuestOsSkForwarderFactory_ParamsSpec, 'crosapi.mojom.Crosapi_BindGuestOsSkForwarderFactory_Params', [
      mojo.internal.StructField('arg_receiver', 0, 0, mojo.internal.InterfaceRequest(mojo.internal.bindings.crosapi.mojom.GuestOsSkForwarderFactoryPendingReceiver), null, false, 0, undefined),
    ],
    [[0, 16]]);
