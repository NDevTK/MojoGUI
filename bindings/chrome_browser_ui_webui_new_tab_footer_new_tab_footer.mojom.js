...
// Enum: NewTabPageType
mojo.internal.bindings.new_tab_footer.mojom.NewTabPageType = {
  kFirstPartyWebUI: 0,
  kExtension: 1,
  kOther: 2,
};
...
mojo.internal.bindings.new_tab_footer.mojom.NewTabFooterHandlerFactoryRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.new_tab_footer.mojom.NewTabFooterHandlerFactoryPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.new_tab_footer.mojom.NewTabFooterHandlerFactoryRemoteCallHandler(this.proxy);
  }
  ...
  createNewTabFooterHandler(arg_document, arg_handler) {
    return this.$.createNewTabFooterHandler(arg_document, arg_handler);
  }
};
...
mojo.internal.bindings.new_tab_footer.mojom.NewTabFooterHandlerFactory.getRemote = function() {
  let remote = new mojo.internal.bindings.new_tab_footer.mojom.NewTabFooterHandlerFactoryRemote();
...
mojo.internal.bindings.new_tab_footer.mojom.NewTabFooterHandlerFactoryReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.new_tab_footer.mojom.NewTabFooterHandlerFactory_CreateNewTabFooterHandler_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for CreateNewTabFooterHandler failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.new_tab_footer.mojom.NewTabFooterHandlerFactoryReceiver = mojo.internal.bindings.new_tab_footer.mojom.NewTabFooterHandlerFactoryReceiver;

mojo.internal.bindings.new_tab_footer.mojom.NewTabFooterHandlerFactoryPtr = mojo.internal.bindings.new_tab_footer.mojom.NewTabFooterHandlerFactoryRemote;
mojo.internal.bindings.new_tab_footer.mojom.NewTabFooterHandlerFactoryRequest = mojo.internal.bindings.new_tab_footer.mojom.NewTabFooterHandlerFactoryPendingReceiver;
...
mojo.internal.bindings.new_tab_footer.mojom.NewTabFooterHandlerRemote = class {
  static get $interfaceName() {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.new_tab_footer.mojom.NewTabFooterHandlerPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.new_tab_footer.mojom.NewTabFooterHandlerRemoteCallHandler(this.proxy);
  }
  ...
  openUrlInCurrentTab(arg_url) {
    return this.$.openUrlInCurrentTab(arg_url);
  }
...
mojo.internal.bindings.new_tab_footer.mojom.NewTabFooterHandler.getRemote = function() {
  let remote = new mojo.internal.bindings.new_tab_footer.mojom.NewTabFooterHandlerRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
...
mojo.internal.bindings.new_tab_footer.mojom.NewTabFooterHandlerReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.new_tab_footer.mojom.NewTabFooterHandler_UpdateNtpExtensionName_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for UpdateNtpExtensionName failed with TypeError');
           }
        }
        // Try Method 1: UpdateManagementNotice
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.new_tab_footer.mojom.NewTabFooterHandler_UpdateManagementNotice_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for UpdateManagementNotice failed with TypeError');
           }
        }
        // Try Method 2: UpdateAttachedTabState
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.new_tab_footer.mojom.NewTabFooterHandler_UpdateAttachedTabState_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for UpdateAttachedTabState failed with TypeError');
           }
        }
        // Try Method 3: UpdateBackgroundAttribution
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.new_tab_footer.mojom.NewTabFooterHandler_UpdateBackgroundAttribution_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for UpdateBackgroundAttribution failed with TypeError');
           }
        }
        // Try Method 4: OpenExtensionOptionsPageWithFallback
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.new_tab_footer.mojom.NewTabFooterHandler_OpenExtensionOptionsPageWithFallback_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OpenExtensionOptionsPageWithFallback failed with TypeError');
           }
        }
        // Try Method 5: OpenManagementPage
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.new_tab_footer.mojom.NewTabFooterHandler_OpenManagementPage_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OpenManagementPage failed with TypeError');
           }
        }
        // Try Method 6: OpenUrlInCurrentTab
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.new_tab_footer.mojom.NewTabFooterHandler_OpenUrlInCurrentTab_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OpenUrlInCurrentTab failed with TypeError');
           }
        }
        // Try Method 7: ShowContextMenu
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.new_tab_footer.mojom.NewTabFooterHandler_ShowContextMenu_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.new_tab_footer.mojom.NewTabFooterHandler_NotifyCustomizationButtonVisible_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for NotifyCustomizationButtonVisible failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
             console.warn('[GeneratedReceiver] Failed to discover ordinal ' + header.ordinal);
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.new_tab_footer.mojom.NewTabFooterHandler_UpdateNtpExtensionName_ParamsSpec.$.structSpec);
        ...
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.new_tab_footer.mojom.NewTabFooterHandler_UpdateManagementNotice_ParamsSpec.$.structSpec);
        ...
        case 2: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.new_tab_footer.mojom.NewTabFooterHandler_UpdateAttachedTabState_ParamsSpec.$.structSpec);
        ...
        case 3: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.new_tab_footer.mojom.NewTabFooterHandler_UpdateBackgroundAttribution_ParamsSpec.$.structSpec);
        ...
        case 4: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.new_tab_footer.mojom.NewTabFooterHandler_OpenExtensionOptionsPageWithFallback_ParamsSpec.$.structSpec);
        ...
        case 5: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.new_tab_footer.mojom.NewTabFooterHandler_OpenManagementPage_ParamsSpec.$.structSpec);
        ...
        case 8: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.new_tab_footer.mojom.NewTabFooterHandler_NotifyCustomizationButtonVisible_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.new_tab_footer.mojom.NewTabFooterHandlerReceiver = mojo.internal.bindings.new_tab_footer.mojom.NewTabFooterHandlerReceiver;

mojo.internal.bindings.new_tab_footer.mojom.NewTabFooterHandlerPtr = mojo.internal.bindings.new_tab_footer.mojom.NewTabFooterHandlerRemote;
mojo.internal.bindings.new_tab_footer.mojom.NewTabFooterHandlerRequest = mojo.internal.bindings.new_tab_footer.mojom.NewTabFooterHandlerPendingReceiver;
...
mojo.internal.bindings.new_tab_footer.mojom.NewTabFooterDocumentRemote = class {
  static get $interfaceName() {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.new_tab_footer.mojom.NewTabFooterDocumentPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.new_tab_footer.mojom.NewTabFooterDocumentRemoteCallHandler(this.proxy);
  }
  ...
  setNtpExtensionName(arg_name) {
    return this.$.setNtpExtensionName(arg_name);
  }
  setManagementNotice(arg_notice) {
    return this.$.setManagementNotice(arg_notice);
  }
  attachedTabStateUpdated(arg_ntp_type, arg_can_customize_chrome) {
    return this.$.attachedTabStateUpdated(arg_ntp_type, arg_can_customize_chrome);
  }
  setBackgroundAttribution(arg_background_image_attribution) {
    return this.$.setBackgroundAttribution(arg_background_image_attribution);
  }
};
...
mojo.internal.bindings.new_tab_footer.mojom.NewTabFooterDocument.getRemote = function() {
  let remote = new mojo.internal.bindings.new_tab_footer.mojom.NewTabFooterDocumentRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
...
mojo.internal.bindings.new_tab_footer.mojom.NewTabFooterDocumentReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.new_tab_footer.mojom.NewTabFooterDocument_SetNtpExtensionName_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for SetNtpExtensionName failed with TypeError');
           }
        }
        // Try Method 1: SetManagementNotice
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.new_tab_footer.mojom.NewTabFooterDocument_SetManagementNotice_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for SetManagementNotice failed with TypeError');
           }
        }
        // Try Method 2: AttachedTabStateUpdated
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.new_tab_footer.mojom.NewTabFooterDocument_AttachedTabStateUpdated_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for AttachedTabStateUpdated failed with TypeError');
           }
        }
        // Try Method 3: SetBackgroundAttribution
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.new_tab_footer.mojom.NewTabFooterDocument_SetBackgroundAttribution_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for SetBackgroundAttribution failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
             console.warn('[GeneratedReceiver] Failed to discover ordinal ' + header.ordinal);
...
mojo.internal.bindings.new_tab_footer.mojom.NewTabFooterDocumentReceiver = mojo.internal.bindings.new_tab_footer.mojom.NewTabFooterDocumentReceiver;
