...
mojo.internal.bindings.blink.mojom.ServiceWorkerWorkerClient = {};
mojo.internal.bindings.blink.mojom.ServiceWorkerWorkerClientSpec = { $ : {} };
...
mojo.internal.bindings.blink.mojom.ServiceWorkerWorkerClientRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.blink.mojom.ServiceWorkerWorkerClientRemoteCallHandler(this.proxy);
  }
  ...
  onControllerChanged(arg_mode) {
    return this.$.onControllerChanged(arg_mode);
  }
};

mojo.internal.bindings.blink.mojom.ServiceWorkerWorkerClientRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('blink.mojom.ServiceWorkerWorkerClient', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.blink.mojom.ServiceWorkerWorkerClient.getRemote = function() {
  let remote = new mojo.internal.bindings.blink.mojom.ServiceWorkerWorkerClientRemote();
...
mojo.internal.bindings.blink.mojom.ServiceWorkerWorkerClientReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('blink.mojom.ServiceWorkerWorkerClient', [
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.blink.mojom.ServiceWorkerWorkerClient_OnControllerChanged_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OnControllerChanged failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.blink.mojom.ServiceWorkerWorkerClientReceiver = mojo.internal.bindings.blink.mojom.ServiceWorkerWorkerClientReceiver;
