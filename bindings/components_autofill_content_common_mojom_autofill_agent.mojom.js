...
mojo.internal.bindings.autofill.mojom.AutofillAgentRemote = class {
  ...
  sendEmailVerificationToken(arg_email_field_id, arg_email, arg_token_field_id, arg_token) {
    return this.$.sendEmailVerificationToken(arg_email_field_id, arg_email, arg_token_field_id, arg_token);
  }
...
mojo.internal.bindings.autofill.mojom.AutofillAgentRemoteCallHandler = class {
  ...
  sendEmailVerificationToken(arg_email_field_id, arg_email, arg_token_field_id, arg_token) {
    return this.proxy.sendMessage(
      ...
      null,
      [arg_email_field_id, arg_email, arg_token_field_id, arg_token],
      false);
  }
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        ...
        case 17: {
          ...
          const result = this.impl.sendEmailVerificationToken(params.arg_email_field_id, params.arg_email, params.arg_token_field_id, params.arg_token);
          break;
        }
        case 18: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
...
mojo.internal.Struct(
    mojo.internal.bindings.autofill.mojom.AutofillAgent_SendEmailVerificationToken_ParamsSpec, 'autofill.mojom.AutofillAgent_SendEmailVerificationToken_Params', [
      ...
      mojo.internal.StructField('arg_token_field_id', 16, 0, mojo.internal.bindings.autofill.mojom.FieldRendererIdSpec, null, false, 0, undefined),
