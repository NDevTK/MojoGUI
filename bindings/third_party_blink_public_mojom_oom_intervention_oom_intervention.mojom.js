...
mojo.internal.bindings.blink.mojom.OomInterventionHostRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.blink.mojom.OomInterventionHostPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.blink.mojom.OomInterventionHostRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.blink.mojom.OomInterventionHost.getRemote = function() {
  let remote = new mojo.internal.bindings.blink.mojom.OomInterventionHostRemote();
...
mojo.internal.bindings.blink.mojom.OomInterventionHostReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.blink.mojom.OomInterventionHost_OnHighMemoryUsage_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OnHighMemoryUsage failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.blink.mojom.OomInterventionHost_OnHighMemoryUsage_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.blink.mojom.OomInterventionHostReceiver = mojo.internal.bindings.blink.mojom.OomInterventionHostReceiver;

mojo.internal.bindings.blink.mojom.OomInterventionHostPtr = mojo.internal.bindings.blink.mojom.OomInterventionHostRemote;
mojo.internal.bindings.blink.mojom.OomInterventionHostRequest = mojo.internal.bindings.blink.mojom.OomInterventionHostPendingReceiver;
...
mojo.internal.bindings.blink.mojom.OomInterventionRemote = class {
  static get $interfaceName() {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.blink.mojom.OomInterventionPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.blink.mojom.OomInterventionRemoteCallHandler(this.proxy);
  }
  ...
  startDetection(arg_host, arg_detection_args, arg_renderer_pause_enabled, arg_navigate_ads_enabled, arg_purge_v8_memory_enabled) {
    return this.$.startDetection(arg_host, arg_detection_args, arg_renderer_pause_enabled, arg_navigate_ads_enabled, arg_purge_v8_memory_enabled);
  }
};
...
mojo.internal.bindings.blink.mojom.OomIntervention.getRemote = function() {
  let remote = new mojo.internal.bindings.blink.mojom.OomInterventionRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
...
mojo.internal.bindings.blink.mojom.OomInterventionReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.blink.mojom.OomIntervention_StartDetection_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for StartDetection failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
             console.warn('[GeneratedReceiver] Failed to discover ordinal ' + header.ordinal);
...
mojo.internal.bindings.blink.mojom.OomInterventionReceiver = mojo.internal.bindings.blink.mojom.OomInterventionReceiver;
