...
mojo.internal.bindings.shape_detection.mojom.BarcodeDetectionProviderRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.shape_detection.mojom.BarcodeDetectionProviderRemoteCallHandler(this.proxy);
  }
  ...
  createBarcodeDetection(arg_receiver, arg_options) {
    return this.$.createBarcodeDetection(arg_receiver, arg_options);
  }
...
mojo.internal.bindings.shape_detection.mojom.BarcodeDetectionProvider.getRemote = function() {
  let remote = new mojo.internal.bindings.shape_detection.mojom.BarcodeDetectionProviderRemote();
...
mojo.internal.bindings.shape_detection.mojom.BarcodeDetectionProviderReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.shape_detection.mojom.BarcodeDetectionProvider_CreateBarcodeDetection_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for CreateBarcodeDetection failed with TypeError');
           }
        }
        // Try Method 1: EnumerateSupportedFormats
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.shape_detection.mojom.BarcodeDetectionProvider_EnumerateSupportedFormats_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for EnumerateSupportedFormats failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
      ...
      switch (dispatchId) {
        ...
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.shape_detection.mojom.BarcodeDetectionProvider_EnumerateSupportedFormats_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.shape_detection.mojom.BarcodeDetectionProviderReceiver = mojo.internal.bindings.shape_detection.mojom.BarcodeDetectionProviderReceiver;
