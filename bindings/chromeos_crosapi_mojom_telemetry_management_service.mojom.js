...
mojo.internal.bindings.crosapi.mojom.TelemetryManagementServiceRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.crosapi.mojom.TelemetryManagementServicePendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.crosapi.mojom.TelemetryManagementServiceRemoteCallHandler(this.proxy);
  }
  ...
  setAudioGain(arg_node_id, arg_gain) {
    return this.$.setAudioGain(arg_node_id, arg_gain);
  }
  setAudioVolume(arg_node_id, arg_volume, arg_is_muted) {
    return this.$.setAudioVolume(arg_node_id, arg_volume, arg_is_muted);
  }
};
...
mojo.internal.bindings.crosapi.mojom.TelemetryManagementService.getRemote = function() {
  let remote = new mojo.internal.bindings.crosapi.mojom.TelemetryManagementServiceRemote();
...
mojo.internal.bindings.crosapi.mojom.TelemetryManagementServiceReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.crosapi.mojom.TelemetryManagementService_SetAudioGain_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for SetAudioGain failed with TypeError');
           }
        }
        // Try Method 1: SetAudioVolume
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.crosapi.mojom.TelemetryManagementService_SetAudioVolume_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for SetAudioVolume failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.crosapi.mojom.TelemetryManagementServiceReceiver = mojo.internal.bindings.crosapi.mojom.TelemetryManagementServiceReceiver;
