...
mojo.internal.bindings.arc.mojom.SystemUiInstanceRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.arc.mojom.SystemUiInstancePendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.arc.mojom.SystemUiInstanceRemoteCallHandler(this.proxy);
  }
  ...
  setDarkThemeStatus(arg_active) {
    return this.$.setDarkThemeStatus(arg_active);
  }
  setOverlayColor(arg_source_color, arg_theme_style) {
    return this.$.setOverlayColor(arg_source_color, arg_theme_style);
  }
};

mojo.internal.bindings.arc.mojom.SystemUiInstanceRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('arc.mojom.SystemUiInstance', [
      { explicit: 0 },
      { explicit: 1 },
    ]);
  }
...
mojo.internal.bindings.arc.mojom.SystemUiInstance.getRemote = function() {
  let remote = new mojo.internal.bindings.arc.mojom.SystemUiInstanceRemote();
...
mojo.internal.bindings.arc.mojom.SystemUiInstanceReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('arc.mojom.SystemUiInstance', [
      { explicit: 0 },
      { explicit: 1 },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.arc.mojom.SystemUiInstance_SetDarkThemeStatus_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for SetDarkThemeStatus failed with TypeError');
           }
        }
        // Try Method 1: SetOverlayColor
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.arc.mojom.SystemUiInstance_SetOverlayColor_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for SetOverlayColor failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.arc.mojom.SystemUiInstanceReceiver = mojo.internal.bindings.arc.mojom.SystemUiInstanceReceiver;
