...
mojo.internal.Struct(
    mojo.internal.bindings.mojom.app_service_internals.AppInfoSpec, 'mojom.app_service_internals.AppInfo', [
      mojo.internal.StructField('arg_id', 0, 0, mojo.internal.String, null, false, 0, undefined),
      mojo.internal.StructField('arg_name', 8, 0, mojo.internal.String, null, false, 0, undefined),
      mojo.internal.StructField('arg_debug_info', 16, 0, mojo.internal.String, null, false, 0, undefined),
    ],
    [[0, 32]]);

// Struct: PreferredAppInfo
mojo.internal.Struct(
    mojo.internal.bindings.mojom.app_service_internals.PreferredAppInfoSpec, 'mojom.app_service_internals.PreferredAppInfo', [
      mojo.internal.StructField('arg_id', 0, 0, mojo.internal.String, null, false, 0, undefined),
      mojo.internal.StructField('arg_name', 8, 0, mojo.internal.String, null, false, 0, undefined),
      mojo.internal.StructField('arg_preferred_filters', 16, 0, mojo.internal.String, null, false, 0, undefined),
    ],
    [[0, 32]]);

// Struct: PromiseAppInfo
mojo.internal.Struct(
    mojo.internal.bindings.mojom.app_service_internals.PromiseAppInfoSpec, 'mojom.app_service_internals.PromiseAppInfo', [
      mojo.internal.StructField('arg_package_id', 0, 0, mojo.internal.String, null, false, 0, undefined),
      mojo.internal.StructField('arg_debug_info', 8, 0, mojo.internal.String, null, false, 0, undefined),
    ],
    [[0, 24]]);

// Struct: AppCapabilityInfo
mojo.internal.Struct(
    mojo.internal.bindings.mojom.app_service_internals.AppCapabilityInfoSpec, 'mojom.app_service_internals.AppCapabilityInfo', [
...
mojo.internal.Struct(
    mojo.internal.bindings.mojom.app_service_internals.AppServiceInternalsPageHandler_GetDebugInfo_ParamsSpec, 'mojom.app_service_internals.AppServiceInternalsPageHandler_GetDebugInfo_Params', [
    ],
    [[0, 8]]);
...
mojo.internal.bindings.mojom.app_service_internals.AppServiceInternalsPageHandlerRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.mojom.app_service_internals.AppServiceInternalsPageHandlerPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.mojom.app_service_internals.AppServiceInternalsPageHandlerRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.mojom.app_service_internals.AppServiceInternalsPageHandler.getRemote = function() {
  let remote = new mojo.internal.bindings.mojom.app_service_internals.AppServiceInternalsPageHandlerRemote();
...
mojo.internal.bindings.mojom.app_service_internals.AppServiceInternalsPageHandlerReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.mojom.app_service_internals.AppServiceInternalsPageHandler_GetDebugInfo_ParamsSpec.$.structSpec;
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.mojom.app_service_internals.AppServiceInternalsPageHandler_GetDebugInfo_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.getDebugInfo');
          const result = this.impl.getDebugInfo();
          const expectsResponse = header.expectsResponse || (header.flags & 1);
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              this.endpoint.send(header.ordinal, header.requestId, mojo.internal.kMessageFlagIsResponse, mojo.internal.bindings.mojom.app_service_internals.AppServiceInternalsPageHandler_GetDebugInfo_ResponseParamsSpec, response);
...
mojo.internal.bindings.mojom.app_service_internals.AppServiceInternalsPageHandlerReceiver = mojo.internal.bindings.mojom.app_service_internals.AppServiceInternalsPageHandlerReceiver;

mojo.internal.bindings.mojom.app_service_internals.AppServiceInternalsPageHandlerPtr = mojo.internal.bindings.mojom.app_service_internals.AppServiceInternalsPageHandlerRemote;
mojo.internal.bindings.mojom.app_service_internals.AppServiceInternalsPageHandlerRequest = mojo.internal.bindings.mojom.app_service_internals.AppServiceInternalsPageHandlerPendingReceiver;
