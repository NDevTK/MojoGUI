...
mojo.internal.Struct(
    mojo.internal.bindings.ax.mojom.Automation_DispatchAccessibilityEvents_ParamsSpec, 'ax.mojom.Automation_DispatchAccessibilityEvents_Params', [
      ...
      mojo.internal.StructField('arg_mouse_location', 16, 0, mojo.internal.bindings.gfx.mojom.PointSpec.$, null, false, 0, undefined),
...
mojo.internal.Struct(
    mojo.internal.bindings.ax.mojom.Automation_DispatchAccessibilityLocationChange_ParamsSpec, 'ax.mojom.Automation_DispatchAccessibilityLocationChange_Params', [
      mojo.internal.StructField('arg_tree_id', 0, 0, mojo.internal.bindings.ax.mojom.AXTreeIDSpec.$, null, false, 0, undefined),
      mojo.internal.StructField('arg_bounds', 8, 0, mojo.internal.bindings.ax.mojom.AXRelativeBoundsSpec.$, null, false, 0, undefined),
...
mojo.internal.Struct(
    mojo.internal.bindings.ax.mojom.Automation_DispatchAccessibilityScrollChange_ParamsSpec, 'ax.mojom.Automation_DispatchAccessibilityScrollChange_Params', [
      ...
      mojo.internal.StructField('arg_scroll_x', 12, 0, mojo.internal.Int32, 0, false, 0, undefined),
      mojo.internal.StructField('arg_scroll_y', 16, 0, mojo.internal.Int32, 0, false, 0, undefined),
    ],
    [[0, 32]]);
...
mojo.internal.bindings.ax.mojom.AutomationRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.ax.mojom.AutomationRemoteCallHandler(this.proxy);
  }
  ...
  dispatchTreeDestroyedEvent(arg_tree_id) {
    return this.$.dispatchTreeDestroyedEvent(arg_tree_id);
  }
  dispatchActionResult(arg_data, arg_result) {
    return this.$.dispatchActionResult(arg_data, arg_result);
  }
  dispatchAccessibilityEvents(arg_tree_id, arg_updates, arg_mouse_location, arg_events) {
    return this.$.dispatchAccessibilityEvents(arg_tree_id, arg_updates, arg_mouse_location, arg_events);
  }
  dispatchAccessibilityLocationChange(arg_tree_id, arg_node_id, arg_bounds) {
    return this.$.dispatchAccessibilityLocationChange(arg_tree_id, arg_node_id, arg_bounds);
  }
...
mojo.internal.bindings.ax.mojom.Automation.getRemote = function() {
  let remote = new mojo.internal.bindings.ax.mojom.AutomationRemote();
...
mojo.internal.bindings.ax.mojom.AutomationReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ax.mojom.Automation_DispatchTreeDestroyedEvent_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for DispatchTreeDestroyedEvent failed with TypeError');
           }
        }
        // Try Method 1: DispatchActionResult
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ax.mojom.Automation_DispatchActionResult_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for DispatchActionResult failed with TypeError');
           }
        }
        // Try Method 2: DispatchAccessibilityEvents
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ax.mojom.Automation_DispatchAccessibilityEvents_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for DispatchAccessibilityEvents failed with TypeError');
           }
        }
        // Try Method 3: DispatchAccessibilityLocationChange
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ax.mojom.Automation_DispatchAccessibilityLocationChange_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for DispatchAccessibilityLocationChange failed with TypeError');
           }
        }
        // Try Method 4: DispatchAccessibilityScrollChange
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ax.mojom.Automation_DispatchAccessibilityScrollChange_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
...
mojo.internal.bindings.ax.mojom.AutomationReceiver = mojo.internal.bindings.ax.mojom.AutomationReceiver;
