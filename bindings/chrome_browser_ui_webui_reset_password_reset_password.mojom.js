...
mojo.internal.bindings.mojom.ResetPasswordHandlerRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.mojom.ResetPasswordHandlerPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.mojom.ResetPasswordHandlerRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.mojom.ResetPasswordHandler.getRemote = function() {
  let remote = new mojo.internal.bindings.mojom.ResetPasswordHandlerRemote();
...
mojo.internal.bindings.mojom.ResetPasswordHandlerReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.mojom.ResetPasswordHandler_HandlePasswordReset_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for HandlePasswordReset failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.mojom.ResetPasswordHandler_HandlePasswordReset_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.mojom.ResetPasswordHandlerReceiver = mojo.internal.bindings.mojom.ResetPasswordHandlerReceiver;
