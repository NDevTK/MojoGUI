...
mojo.internal.bindings.chrome.mojom.SingleFileExtractorRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.chrome.mojom.SingleFileExtractorPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.chrome.mojom.SingleFileExtractorRemoteCallHandler(this.proxy);
  }
  ...
  extract(arg_src_file, arg_dst_file, arg_listener) {
    return this.$.extract(arg_src_file, arg_dst_file, arg_listener);
  }
};
...
mojo.internal.bindings.chrome.mojom.SingleFileExtractor.getRemote = function() {
  let remote = new mojo.internal.bindings.chrome.mojom.SingleFileExtractorRemote();
...
mojo.internal.bindings.chrome.mojom.SingleFileExtractorReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.chrome.mojom.SingleFileExtractor_Extract_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for Extract failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.chrome.mojom.SingleFileExtractorReceiver = mojo.internal.bindings.chrome.mojom.SingleFileExtractorReceiver;

mojo.internal.bindings.chrome.mojom.SingleFileExtractorPtr = mojo.internal.bindings.chrome.mojom.SingleFileExtractorRemote;
mojo.internal.bindings.chrome.mojom.SingleFileExtractorRequest = mojo.internal.bindings.chrome.mojom.SingleFileExtractorPendingReceiver;
...
mojo.internal.bindings.chrome.mojom.SingleFileExtractorListenerRemote = class {
  static get $interfaceName() {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.chrome.mojom.SingleFileExtractorListenerPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.chrome.mojom.SingleFileExtractorListenerRemoteCallHandler(this.proxy);
  }
  ...
  onProgress(arg_total_bytes, arg_progress_bytes) {
    return this.$.onProgress(arg_total_bytes, arg_progress_bytes);
  }
};
...
mojo.internal.bindings.chrome.mojom.SingleFileExtractorListener.getRemote = function() {
  let remote = new mojo.internal.bindings.chrome.mojom.SingleFileExtractorListenerRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
...
mojo.internal.bindings.chrome.mojom.SingleFileExtractorListenerReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.chrome.mojom.SingleFileExtractorListener_OnProgress_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
...
mojo.internal.bindings.chrome.mojom.SingleFileExtractorListenerReceiver = mojo.internal.bindings.chrome.mojom.SingleFileExtractorListenerReceiver;
