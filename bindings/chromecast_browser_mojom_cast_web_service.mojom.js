...
mojo.internal.bindings.chromecast.mojom.BackgroundColor = {
  NONE: 0,
  WHITE: 1,
  BLACK: 2,
  TRANSPARENT: 3,
...
// Enum: RendererType
mojo.internal.bindings.chromecast.mojom.RendererType = {
  DEFAULT_RENDERER: 0,
  MOJO_RENDERER: 1,
  REMOTING_RENDERER: 2,
};
...
// Enum: RendererPool
mojo.internal.bindings.chromecast.mojom.RendererPool = {
  NONE: 0,
  OVERLAY: 1,
};

// Enum: GesturePriority
mojo.internal.bindings.chromecast.mojom.GesturePriority = {
  NONE: 0,
  ROOT_UI: 1,
  MAIN_ACTIVITY: 2,
  SETTINGS_UI: 3,
...
mojo.internal.Struct(
    mojo.internal.bindings.chromecast.mojom.CastWebViewParamsSpec, 'chromecast.mojom.CastWebViewParams', [
      ...
      mojo.internal.StructField('arg_prelaunch_url', 40, 0, mojo.internal.bindings.url.mojom.UrlSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_url_filters', 48, 0, mojo.internal.Array(mojo.internal.String, false), null, true, 0, undefined),
      mojo.internal.StructField('arg_renderer_pool', 56, 0, mojo.internal.bindings.chromecast.mojom.RendererPoolSpec, 0, false, 0, undefined),
      mojo.internal.StructField('arg_renderer_type', 60, 0, mojo.internal.bindings.chromecast.mojom.RendererTypeSpec, 0, false, 0, undefined),
      ...
      mojo.internal.StructField('arg_gesture_priority', 68, 0, mojo.internal.bindings.chromecast.mojom.GesturePrioritySpec, 0, false, 0, undefined),
      mojo.internal.StructField('arg_allow_media_access', 72, 0, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_force_720p_resolution', 72, 1, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_managed', 72, 2, mojo.internal.Bool, true, false, 0, undefined),
      mojo.internal.StructField('arg_log_js_console_messages', 72, 3, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_enabled_for_dev', 72, 4, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_is_root_window', 72, 5, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_handle_inner_contents', 72, 6, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_use_media_blocker', 72, 7, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_enable_websql', 73, 0, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_enable_mixer_audio', 73, 1, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_webrtc_allow_legacy_tls_protocols', 73, 2, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_enable_touch_input', 73, 3, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_is_remote_control_mode', 73, 4, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_turn_on_screen', 73, 5, mojo.internal.Bool, true, false, 0, undefined),
      mojo.internal.StructField('arg_keep_screen_on', 73, 6, mojo.internal.Bool, true, false, 0, undefined),
      mojo.internal.StructField('arg_enable_webui_bindings_permission', 73, 7, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_enable_url_rewrite_rules', 74, 0, mojo.internal.Bool, true, false, 0, undefined),
    ],
    [[0, 88]]);
...
mojo.internal.bindings.chromecast.mojom.CastWebServiceRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.chromecast.mojom.CastWebServicePendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.chromecast.mojom.CastWebServiceRemoteCallHandler(this.proxy);
  }
  ...
  createWebView(arg_params, arg_web_contents, arg_window) {
    return this.$.createWebView(arg_params, arg_web_contents, arg_window);
  }
  registerWebUiClient(arg_client, arg_hosts) {
    return this.$.registerWebUiClient(arg_client, arg_hosts);
  }
...
mojo.internal.bindings.chromecast.mojom.CastWebService.getRemote = function() {
  let remote = new mojo.internal.bindings.chromecast.mojom.CastWebServiceRemote();
...
mojo.internal.bindings.chromecast.mojom.CastWebServiceReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.chromecast.mojom.CastWebService_CreateWebView_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for CreateWebView failed with TypeError');
           }
        }
        // Try Method 1: RegisterWebUiClient
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.chromecast.mojom.CastWebService_RegisterWebUiClient_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for RegisterWebUiClient failed with TypeError');
           }
        }
        // Try Method 2: FlushDomLocalStorage
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.chromecast.mojom.CastWebService_FlushDomLocalStorage_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for FlushDomLocalStorage failed with TypeError');
           }
        }
        // Try Method 3: ClearLocalStorage
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.chromecast.mojom.CastWebService_ClearLocalStorage_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for ClearLocalStorage failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
      ...
      switch (dispatchId) {
        ...
        case 2: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.chromecast.mojom.CastWebService_FlushDomLocalStorage_ParamsSpec.$.structSpec);
        ...
        case 3: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.chromecast.mojom.CastWebService_ClearLocalStorage_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.chromecast.mojom.CastWebServiceReceiver = mojo.internal.bindings.chromecast.mojom.CastWebServiceReceiver;
