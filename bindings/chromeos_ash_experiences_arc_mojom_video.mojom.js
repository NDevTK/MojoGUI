...
mojo.internal.Struct(
    mojo.internal.bindings.arc.mojom.VideoHost_OnBootstrapVideoAcceleratorFactory_ResponseParamsSpec, 'arc.mojom.VideoHost_OnBootstrapVideoAcceleratorFactory_ResponseParams', [
      ...
      mojo.internal.StructField('arg_channel_handle', 8, 0, mojo.internal.Handle, null, false, 0, undefined),
    ],
    [[0, 24]]);
...
mojo.internal.bindings.arc.mojom.VideoHostRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.arc.mojom.VideoHostRemoteCallHandler(this.proxy);
  }
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.arc.mojom.VideoHost_OnBootstrapVideoAcceleratorFactory_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OnBootstrapVideoAcceleratorFactory failed with TypeError');
           }
        }
        // Try Method 1: CreateVideoAcceleratorFactory
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.arc.mojom.VideoHost_CreateVideoAcceleratorFactory_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for CreateVideoAcceleratorFactory failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.arc.mojom.VideoHost_OnBootstrapVideoAcceleratorFactory_ParamsSpec.$.structSpec);
        ...
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.arc.mojom.VideoHost_CreateVideoAcceleratorFactory_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.arc.mojom.VideoHostReceiver = mojo.internal.bindings.arc.mojom.VideoHostReceiver;

mojo.internal.bindings.arc.mojom.VideoHostPtr = mojo.internal.bindings.arc.mojom.VideoHostRemote;
mojo.internal.bindings.arc.mojom.VideoHostRequest = mojo.internal.bindings.arc.mojom.VideoHostPendingReceiver;
...
mojo.internal.bindings.arc.mojom.VideoInstanceRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.arc.mojom.VideoInstanceRemoteCallHandler(this.proxy);
  }
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.arc.mojom.VideoInstance_Init_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
...
mojo.internal.bindings.arc.mojom.VideoInstanceReceiver = mojo.internal.bindings.arc.mojom.VideoInstanceReceiver;

mojo.internal.bindings.arc.mojom.VideoInstancePtr = mojo.internal.bindings.arc.mojom.VideoInstanceRemote;
mojo.internal.bindings.arc.mojom.VideoInstanceRequest = mojo.internal.bindings.arc.mojom.VideoInstancePendingReceiver;
...
mojo.internal.Struct(
    mojo.internal.bindings.arc.mojom.VideoAcceleratorFactory_CreateDecodeAccelerator_ParamsSpec, 'arc.mojom.VideoAcceleratorFactory_CreateDecodeAccelerator_Params', [
      ...
      mojo.internal.StructField('arg_protected_buffer_manager', 8, 0, mojo.internal.InterfaceProxy(mojo.internal.bindings.arc.mojom.ProtectedBufferManagerRemote), null, true, 8, undefined),
      mojo.internal.StructField('arg_browser_cdm_factory', 16, 0, mojo.internal.InterfaceProxy(mojo.internal.bindings.chromeos.cdm.mojom.BrowserCdmFactoryRemote), null, true, 10, undefined),
    ],
    [[0, 16], [8, 24], [10, 32]]);
...
mojo.internal.bindings.arc.mojom.VideoAcceleratorFactoryRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.arc.mojom.VideoAcceleratorFactoryRemoteCallHandler(this.proxy);
  }
  ...
  createDecodeAccelerator(arg_video_decoder, arg_protected_buffer_manager, arg_browser_cdm_factory) {
    return this.$.createDecodeAccelerator(arg_video_decoder, arg_protected_buffer_manager, arg_browser_cdm_factory);
  }
  ...
  createProtectedBufferAllocator(arg_video_protected_buffer_allocator) {
    return this.$.createProtectedBufferAllocator(arg_video_protected_buffer_allocator);
  }
};
...
mojo.internal.bindings.arc.mojom.VideoAcceleratorFactory.getRemote = function() {
  let remote = new mojo.internal.bindings.arc.mojom.VideoAcceleratorFactoryRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.arc.mojom.VideoAcceleratorFactory_CreateEncodeAccelerator_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for CreateEncodeAccelerator failed with TypeError');
           }
        }
        // Try Method 1: CreateDecodeAccelerator
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.arc.mojom.VideoAcceleratorFactory_CreateDecodeAccelerator_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for CreateDecodeAccelerator failed with TypeError');
           }
        }
        // Try Method 2: CreateVideoDecoder
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.arc.mojom.VideoAcceleratorFactory_CreateVideoDecoder_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for CreateVideoDecoder failed with TypeError');
           }
        }
        // Try Method 3: CreateProtectedBufferAllocator
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.arc.mojom.VideoAcceleratorFactory_CreateProtectedBufferAllocator_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for CreateProtectedBufferAllocator failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
             console.warn('[GeneratedReceiver] Failed to discover ordinal ' + header.ordinal);
...
mojo.internal.bindings.arc.mojom.VideoAcceleratorFactoryReceiver = mojo.internal.bindings.arc.mojom.VideoAcceleratorFactoryReceiver;
