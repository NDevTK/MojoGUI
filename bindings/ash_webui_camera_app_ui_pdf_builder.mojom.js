...
mojo.internal.bindings.ash.camera_app.mojom.PdfBuilderRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.ash.camera_app.mojom.PdfBuilderRemoteCallHandler(this.proxy);
  }
  ...
  addPage(arg_jpeg, arg_page_index) {
    return this.$.addPage(arg_jpeg, arg_page_index);
  }
  addPageInline(arg_jpeg, arg_page_index) {
    return this.$.addPageInline(arg_jpeg, arg_page_index);
  }
...
mojo.internal.bindings.ash.camera_app.mojom.PdfBuilderRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('ash.camera_app.mojom.PdfBuilder', [
      { explicit: null },
      { explicit: null },
      { explicit: null },
      { explicit: null },
...
mojo.internal.bindings.ash.camera_app.mojom.PdfBuilder.getRemote = function() {
  let remote = new mojo.internal.bindings.ash.camera_app.mojom.PdfBuilderRemote();
...
mojo.internal.bindings.ash.camera_app.mojom.PdfBuilderReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('ash.camera_app.mojom.PdfBuilder', [
      { explicit: null },
      { explicit: null },
      { explicit: null },
      { explicit: null },
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.ash.camera_app.mojom.PdfBuilder_AddPage_ParamsSpec.$.structSpec);
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.ash.camera_app.mojom.PdfBuilder_AddPageInline_ParamsSpec.$.structSpec);
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.ash.camera_app.mojom.PdfBuilder_DeletePage_ParamsSpec.$.structSpec);
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.ash.camera_app.mojom.PdfBuilder_Save_ParamsSpec.$.structSpec);
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.ash.camera_app.mojom.PdfBuilder_SaveInline_ParamsSpec.$.structSpec);
      ...
      switch (dispatchId) {
        ...
        case 3: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.ash.camera_app.mojom.PdfBuilder_Save_ParamsSpec.$.structSpec);
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.ash.camera_app.mojom.PdfBuilder_Save_ResponseParamsSpec, header, rawHeader);
               responder(response);
        ...
        case 4: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.ash.camera_app.mojom.PdfBuilder_SaveInline_ParamsSpec.$.structSpec);
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              const rawHeader = (args[2] && args[2].slice) ? args[2].slice(0, header.headerSize) : null;
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.ash.camera_app.mojom.PdfBuilder_SaveInline_ResponseParamsSpec, header, rawHeader);
               responder(response);
...
mojo.internal.bindings.ash.camera_app.mojom.PdfBuilderReceiver = mojo.internal.bindings.ash.camera_app.mojom.PdfBuilderReceiver;
