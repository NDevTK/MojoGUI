...
ash.camera_app.mojom.PdfBuilder_AddPage_ParamsSpec = {
  $: {
    structSpec: {
      ...
      packedSize: 24,
      fields: [
        { name: 'jpeg', packedOffset: 0, packedBitOffset: 0, type: mojo.internal.String, nullable: true },
...
ash.camera_app.mojom.PdfBuilder_Save_ResponseParamsSpec = {
  $: {
    structSpec: {
      ...
      packedSize: 16,
      fields: [
        { name: 'pdf', packedOffset: 0, packedBitOffset: 0, type: mojo.internal.String, nullable: true },
      ],
      versions: [{version: 0}]
    }
  }
