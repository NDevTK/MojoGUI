...
mojo.internal.bindings.blink.mojom.BadgeValueSpec = { $: {} };
mojo.internal.bindings.blink.mojom.BadgeService = {};
mojo.internal.bindings.blink.mojom.BadgeServiceSpec = { $ : {} };
...
mojo.internal.bindings.blink.mojom.BadgeServiceRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.blink.mojom.BadgeServicePendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.blink.mojom.BadgeServiceRemoteCallHandler(this.proxy);
  }
  ...
  setBadge(arg_value) {
    return this.$.setBadge(arg_value);
  }
  clearBadge() {
...
mojo.internal.bindings.blink.mojom.BadgeServiceRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('blink.mojom.BadgeService', [
      { explicit: null },
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.blink.mojom.BadgeService.getRemote = function() {
  let remote = new mojo.internal.bindings.blink.mojom.BadgeServiceRemote();
...
mojo.internal.bindings.blink.mojom.BadgeServiceReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('blink.mojom.BadgeService', [
      { explicit: null },
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.blink.mojom.BadgeService_SetBadge_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for SetBadge failed with TypeError');
           }
        }
        // Try Method 1: ClearBadge
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.blink.mojom.BadgeService_ClearBadge_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for ClearBadge failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
      ...
      switch (dispatchId) {
        ...
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.blink.mojom.BadgeService_ClearBadge_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.blink.mojom.BadgeServiceReceiver = mojo.internal.bindings.blink.mojom.BadgeServiceReceiver;
