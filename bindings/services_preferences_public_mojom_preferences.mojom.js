...
prefs.mojom.TrackedPersistentPrefStoreConfigurationSpec = {
  $: {
    structSpec: {
      ...
      packedSize: 72,
      fields: [
        { name: 'unprotected_pref_filename', packedOffset: 0, packedBitOffset: 0, type: mojo.internal.Pointer, nullable: false },
        { name: 'protected_pref_filename', packedOffset: 8, packedBitOffset: 0, type: mojo.internal.Pointer, nullable: false },
        ...
        { name: 'registry_path', packedOffset: 48, packedBitOffset: 0, type: mojo.internal.Pointer, nullable: false },
