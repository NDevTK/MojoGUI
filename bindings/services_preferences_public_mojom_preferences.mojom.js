...
mojo.internal.bindings.prefs.mojom.PrefTrackingStrategy = {
  ATOMIC: 0,
  SPLIT: 1,
};

// Enum: ValueType
mojo.internal.bindings.prefs.mojom.ValueType = {
  IMPERSONAL: 0,
  PERSONAL: 1,
};
...
mojo.internal.Struct(
    mojo.internal.bindings.prefs.mojom.ResetOnLoadObserver_OnResetOnLoad_ParamsSpec, 'prefs.mojom.ResetOnLoadObserver_OnResetOnLoad_Params', [
    ],
    [[0, 8]]);

mojo.internal.bindings.prefs.mojom.ResetOnLoadObserverPendingReceiver = class {
  constructor(handle) {
    this.handle = handle;
  }
};

mojo.internal.bindings.prefs.mojom.ResetOnLoadObserverRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.prefs.mojom.ResetOnLoadObserverPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.prefs.mojom.ResetOnLoadObserverRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.prefs.mojom.ResetOnLoadObserver.getRemote = function() {
  let remote = new mojo.internal.bindings.prefs.mojom.ResetOnLoadObserverRemote();
...
mojo.internal.bindings.prefs.mojom.ResetOnLoadObserverReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.prefs.mojom.ResetOnLoadObserver_OnResetOnLoad_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OnResetOnLoad failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.prefs.mojom.ResetOnLoadObserver_OnResetOnLoad_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.prefs.mojom.ResetOnLoadObserverReceiver = mojo.internal.bindings.prefs.mojom.ResetOnLoadObserverReceiver;

mojo.internal.bindings.prefs.mojom.ResetOnLoadObserverPtr = mojo.internal.bindings.prefs.mojom.ResetOnLoadObserverRemote;
mojo.internal.bindings.prefs.mojom.ResetOnLoadObserverRequest = mojo.internal.bindings.prefs.mojom.ResetOnLoadObserverPendingReceiver;
