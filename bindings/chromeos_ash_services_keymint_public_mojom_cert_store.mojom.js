...
mojo.internal.bindings.arc.keymint.mojom.CertStoreInstanceRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.arc.keymint.mojom.CertStoreInstancePendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.arc.keymint.mojom.CertStoreInstanceRemoteCallHandler(this.proxy);
  }
  ...
  setSerialNumber(arg_serial_number) {
    return this.$.setSerialNumber(arg_serial_number);
  }
};
...
mojo.internal.bindings.arc.keymint.mojom.CertStoreInstance.getRemote = function() {
  let remote = new mojo.internal.bindings.arc.keymint.mojom.CertStoreInstanceRemote();
...
mojo.internal.bindings.arc.keymint.mojom.CertStoreInstanceReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.arc.keymint.mojom.CertStoreInstance_UpdatePlaceholderKeys_ParamsSpec.$.structSpec;
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.arc.keymint.mojom.CertStoreInstance_SetSerialNumber_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for SetSerialNumber failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.arc.keymint.mojom.CertStoreInstanceReceiver = mojo.internal.bindings.arc.keymint.mojom.CertStoreInstanceReceiver;
