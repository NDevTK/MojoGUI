...
mojo.internal.bindings.device.mojom.SensorConnectionWatcher = mojo.internal.bindings.device.mojom.SensorConnectionWatcher || {};
mojo.internal.bindings.device.mojom.SensorConnectionWatcherSpec = mojo.internal.bindings.device.mojom.SensorConnectionWatcherSpec || { $ : {} };
if (mojo.internal.bindings.device.mojom.SensorConnectionWatcherSpec.$.structSpec && mojo.internal.bindings.device.mojom.SensorConnectionWatcherSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.device.mojom.SensorConnectionWatcherSpec.$ = {};
mojo.internal.bindings.device.mojom.SensorConnectionWatcher.$interfaceName = 'device.mojom.SensorConnectionWatcher';
...
mojo.internal.bindings.device.mojom.SensorRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('device.mojom.Sensor', [
      { explicit: null },
      { explicit: null },
      { explicit: null },
      { explicit: null },
...
mojo.internal.bindings.device.mojom.SensorReceiver = class {
  constructor(impl) {
    ...
    const ordinals = window.mojoScrambler.getOrdinals('device.mojom.Sensor', [
      { explicit: null },
      { explicit: null },
      { explicit: null },
      { explicit: null },
        ...
        case 0: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              const val = (response && typeof response === 'object' && 'arg_configuration' in response) ? response['arg_configuration'] : response;
              const resp_obj = { 'arg_configuration': val };
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.device.mojom.Sensor_GetDefaultConfiguration_ResponseParamsSpec.$.structSpec, resp_obj);
        ...
        case 1: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.device.mojom.Sensor_AddConfiguration_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
...
mojo.internal.bindings.device.mojom.SensorClientRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('device.mojom.SensorClient', [
      { explicit: null },
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.device.mojom.SensorClientReceiver = class {
  constructor(impl) {
    ...
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('device.mojom.SensorClient', [
      { explicit: null },
      { explicit: null },
    ]);
    ordinals.forEach((ord, idx) => {
...
// Interface: SensorConnectionWatcher
mojo.internal.bindings.device.mojom.SensorConnectionWatcherPendingReceiver = class {
  constructor(handle) {
    this.handle = handle;
    if (handle) {
      this.__mojoHandle = handle.router_ ? handle.router_.pipe_ : (handle.pipe_ || handle);
...
mojo.internal.bindings.device.mojom.SensorConnectionWatcherRemote = class {
  static get $interfaceName() {
    return 'device.mojom.SensorConnectionWatcher';
  }

  constructor(handle = undefined) {
    this.__mojoHandle = handle;
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.device.mojom.SensorConnectionWatcherPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.device.mojom.SensorConnectionWatcherRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.device.mojom.SensorConnectionWatcherRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('device.mojom.SensorConnectionWatcher', [
    ]);
  }

};

mojo.internal.bindings.device.mojom.SensorConnectionWatcher.getRemote = function() {
  let remote = new mojo.internal.bindings.device.mojom.SensorConnectionWatcherRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
    'device.mojom.SensorConnectionWatcher',
    'context');
  return remote.$;
};

mojo.internal.bindings.device.mojom.SensorConnectionWatcherReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('device.mojom.SensorConnectionWatcher', [
    ]);
    ordinals.forEach((ord, idx) => {
      this.ordinalMap.set(ord, idx); // Scrambled/Explicit
    });
...
mojo.internal.bindings.device.mojom.SensorConnectionWatcherReceiver = mojo.internal.bindings.device.mojom.SensorConnectionWatcherReceiver;

mojo.internal.bindings.device.mojom.SensorConnectionWatcherPtr = mojo.internal.bindings.device.mojom.SensorConnectionWatcherRemote;
mojo.internal.bindings.device.mojom.SensorConnectionWatcherRequest = mojo.internal.bindings.device.mojom.SensorConnectionWatcherPendingReceiver;
