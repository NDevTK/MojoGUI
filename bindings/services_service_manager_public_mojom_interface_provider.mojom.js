...
mojo.internal.bindings.service_manager.mojom.InterfaceProvider = {};
mojo.internal.bindings.service_manager.mojom.InterfaceProviderSpec = { $ : {} };
mojo.internal.bindings.service_manager.mojom.InterfaceProvider.$interfaceName = 'service_manager.mojom.InterfaceProvider';
...
mojo.internal.bindings.service_manager.mojom.InterfaceProviderRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.service_manager.mojom.InterfaceProviderPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.service_manager.mojom.InterfaceProviderRemoteCallHandler(this.proxy);
  }
  ...
  getInterface(arg_interface_name, arg_pipe) {
    return this.$.getInterface(arg_interface_name, arg_pipe);
  }
};

mojo.internal.bindings.service_manager.mojom.InterfaceProviderRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('service_manager.mojom.InterfaceProvider', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.service_manager.mojom.InterfaceProvider.getRemote = function() {
  let remote = new mojo.internal.bindings.service_manager.mojom.InterfaceProviderRemote();
...
mojo.internal.bindings.service_manager.mojom.InterfaceProviderReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('service_manager.mojom.InterfaceProvider', [
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.service_manager.mojom.InterfaceProvider_GetInterface_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for GetInterface failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.service_manager.mojom.InterfaceProviderReceiver = mojo.internal.bindings.service_manager.mojom.InterfaceProviderReceiver;
