...
mojo.internal.bindings.services = mojo.internal.bindings.services || {};

mojo.internal.bindings.chrome.mojom.DocumentAnalysisService = {};
mojo.internal.bindings.chrome.mojom.DocumentAnalysisServiceSpec = { $ : {} };
mojo.internal.bindings.chrome.mojom.DocumentAnalysisService.$interfaceName = 'chrome.mojom.DocumentAnalysisService';
...
mojo.internal.bindings.chrome.mojom.DocumentAnalysisServiceRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.chrome.mojom.DocumentAnalysisServicePendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.chrome.mojom.DocumentAnalysisServiceRemoteCallHandler(this.proxy);
  }
  ...
  bindSafeDocumentAnalyzer(arg_receiver) {
    return this.$.bindSafeDocumentAnalyzer(arg_receiver);
  }
};

mojo.internal.bindings.chrome.mojom.DocumentAnalysisServiceRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('chrome.mojom.DocumentAnalysisService', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.chrome.mojom.DocumentAnalysisService.getRemote = function() {
  let remote = new mojo.internal.bindings.chrome.mojom.DocumentAnalysisServiceRemote();
...
mojo.internal.bindings.chrome.mojom.DocumentAnalysisServiceReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('chrome.mojom.DocumentAnalysisService', [
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.chrome.mojom.DocumentAnalysisService_BindSafeDocumentAnalyzer_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for BindSafeDocumentAnalyzer failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.chrome.mojom.DocumentAnalysisServiceReceiver = mojo.internal.bindings.chrome.mojom.DocumentAnalysisServiceReceiver;
