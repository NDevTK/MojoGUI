  ...
  $: {
    structSpec: {
      ...
      fields: [
        ...
        { name: 'primary_pointer_type', packedOffset: 64, packedBitOffset: 0, type: mojo.internal.Pointer, nullable: false },
        { name: 'output_device_update_ability_type', packedOffset: 72, packedBitOffset: 0, type: mojo.internal.Pointer, nullable: false },
        { name: 'primary_hover_type', packedOffset: 80, packedBitOffset: 0, type: mojo.internal.Pointer, nullable: false },
        { name: 'editing_behavior', packedOffset: 88, packedBitOffset: 0, type: mojo.internal.Pointer, nullable: false },
        { name: 'viewport_style', packedOffset: 96, packedBitOffset: 0, type: mojo.internal.Pointer, nullable: false },
        { name: 'v8_cache_options', packedOffset: 104, packedBitOffset: 0, type: mojo.internal.Pointer, nullable: false },
        { name: 'animation_policy', packedOffset: 112, packedBitOffset: 0, type: mojo.internal.Pointer, nullable: false },
        ...
        { name: 'web_app_scope', packedOffset: 192, packedBitOffset: 0, type: mojo.internal.Pointer, nullable: false },
        ...
        { name: 'default_video_poster_url', packedOffset: 240, packedBitOffset: 0, type: mojo.internal.Pointer, nullable: false },
        ...
        { name: 'autoplay_policy', packedOffset: 424, packedBitOffset: 0, type: mojo.internal.Pointer, nullable: false },
        { name: 'root_scrollbar_theme_color', packedOffset: 432, packedBitOffset: 0, type: mojo.internal.Pointer, nullable: true },
        { name: 'preferred_root_scrollbar_color_scheme', packedOffset: 440, packedBitOffset: 0, type: mojo.internal.Pointer, nullable: false },
        { name: 'preferred_color_scheme', packedOffset: 448, packedBitOffset: 0, type: mojo.internal.Pointer, nullable: false },
        { name: 'preferred_contrast', packedOffset: 456, packedBitOffset: 0, type: mojo.internal.Pointer, nullable: false },
        { name: 'low_priority_iframes_threshold', packedOffset: 464, packedBitOffset: 0, type: mojo.internal.Pointer, nullable: false },
        { name: 'network_quality_estimator_web_holdback', packedOffset: 472, packedBitOffset: 0, type: mojo.internal.Pointer, nullable: false },
