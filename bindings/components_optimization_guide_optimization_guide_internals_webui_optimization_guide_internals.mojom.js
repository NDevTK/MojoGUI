...
mojo.internal.bindings.optimization_guide_internals.mojom.PageHandlerFactoryRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.optimization_guide_internals.mojom.PageHandlerFactoryPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.optimization_guide_internals.mojom.PageHandlerFactoryRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.optimization_guide_internals.mojom.PageHandlerFactoryRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('optimization_guide_internals.mojom.PageHandlerFactory', [
      { explicit: null },
      { explicit: null },
      { explicit: null },
      { explicit: null },
...
mojo.internal.bindings.optimization_guide_internals.mojom.PageHandlerFactory.getRemote = function() {
  let remote = new mojo.internal.bindings.optimization_guide_internals.mojom.PageHandlerFactoryRemote();
...
mojo.internal.bindings.optimization_guide_internals.mojom.PageHandlerFactoryReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('optimization_guide_internals.mojom.PageHandlerFactory', [
      { explicit: null },
      { explicit: null },
      { explicit: null },
      { explicit: null },
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.optimization_guide_internals.mojom.PageHandlerFactory_CreatePageHandler_ParamsSpec.$.structSpec);
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.optimization_guide_internals.mojom.PageHandlerFactory_RequestDownloadedModelsInfo_ParamsSpec.$.structSpec);
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.optimization_guide_internals.mojom.PageHandlerFactory_RequestLoggedModelQualityClientIds_ParamsSpec.$.structSpec);
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.optimization_guide_internals.mojom.PageHandlerFactory_RequestMqlsLogs_ParamsSpec.$.structSpec);
      ...
      switch (dispatchId) {
        ...
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.optimization_guide_internals.mojom.PageHandlerFactory_RequestDownloadedModelsInfo_ParamsSpec.$.structSpec);
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.optimization_guide_internals.mojom.PageHandlerFactory_RequestDownloadedModelsInfo_ResponseParamsSpec, header, rawHeader);
               responder(response);
        ...
        case 2: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.optimization_guide_internals.mojom.PageHandlerFactory_RequestLoggedModelQualityClientIds_ParamsSpec.$.structSpec);
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              const rawHeader = (args[2] && args[2].slice) ? args[2].slice(0, header.headerSize) : null;
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.optimization_guide_internals.mojom.PageHandlerFactory_RequestLoggedModelQualityClientIds_ResponseParamsSpec, header, rawHeader);
               responder(response);
        ...
        case 3: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.optimization_guide_internals.mojom.PageHandlerFactory_RequestMqlsLogs_ParamsSpec.$.structSpec);
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              const rawHeader = (args[2] && args[2].slice) ? args[2].slice(0, header.headerSize) : null;
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.optimization_guide_internals.mojom.PageHandlerFactory_RequestMqlsLogs_ResponseParamsSpec, header, rawHeader);
               responder(response);
...
mojo.internal.bindings.optimization_guide_internals.mojom.PageHandlerFactoryReceiver = mojo.internal.bindings.optimization_guide_internals.mojom.PageHandlerFactoryReceiver;

mojo.internal.bindings.optimization_guide_internals.mojom.PageHandlerFactoryPtr = mojo.internal.bindings.optimization_guide_internals.mojom.PageHandlerFactoryRemote;
mojo.internal.bindings.optimization_guide_internals.mojom.PageHandlerFactoryRequest = mojo.internal.bindings.optimization_guide_internals.mojom.PageHandlerFactoryPendingReceiver;
...
mojo.internal.bindings.optimization_guide_internals.mojom.PageRemote = class {
  static get $interfaceName() {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.optimization_guide_internals.mojom.PagePendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.optimization_guide_internals.mojom.PageRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.optimization_guide_internals.mojom.PageRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('optimization_guide_internals.mojom.Page', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.optimization_guide_internals.mojom.Page.getRemote = function() {
  let remote = new mojo.internal.bindings.optimization_guide_internals.mojom.PageRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
...
mojo.internal.bindings.optimization_guide_internals.mojom.PageReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('optimization_guide_internals.mojom.Page', [
      { explicit: null },
    ]);
    ordinals.forEach((ord, idx) => {
      this.ordinalMap.set(ord, idx); // Scrambled/Explicit
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.optimization_guide_internals.mojom.Page_OnLogMessageAdded_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.optimization_guide_internals.mojom.PageReceiver = mojo.internal.bindings.optimization_guide_internals.mojom.PageReceiver;
