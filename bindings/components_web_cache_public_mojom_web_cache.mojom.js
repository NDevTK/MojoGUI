...
mojo.internal.bindings.web_cache.mojom.WebCacheRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.web_cache.mojom.WebCachePendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.web_cache.mojom.WebCacheRemoteCallHandler(this.proxy);
  }
  ...
  clearCache(arg_on_navigation) {
    return this.$.clearCache(arg_on_navigation);
  }
};
...
mojo.internal.bindings.web_cache.mojom.WebCache.getRemote = function() {
  let remote = new mojo.internal.bindings.web_cache.mojom.WebCacheRemote();
...
mojo.internal.bindings.web_cache.mojom.WebCacheReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.web_cache.mojom.WebCache_ClearCache_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for ClearCache failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.web_cache.mojom.WebCacheReceiver = mojo.internal.bindings.web_cache.mojom.WebCacheReceiver;
