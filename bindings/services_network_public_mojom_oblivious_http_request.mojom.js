...
mojo.internal.bindings.network.mojom.ObliviousHttpCompletionResultSpec = { $: {} };
mojo.internal.bindings.network.mojom.ObliviousHttpRequestBodySpec = { $: {} };
mojo.internal.bindings.network.mojom.ObliviousHttpResponseSpec = { $: {} };
...
mojo.internal.bindings.network = mojo.internal.bindings.network || {};
mojo.internal.bindings.network.mojom = mojo.internal.bindings.network.mojom || {};
mojo.internal.bindings.network.mojom.ObliviousHttpCompletionResultSpec = mojo.internal.bindings.network.mojom.ObliviousHttpCompletionResultSpec || { $: mojo.internal.OpaqueStruct.$ };
mojo.internal.bindings.network = mojo.internal.bindings.network || {};
mojo.internal.bindings.network.mojom = mojo.internal.bindings.network.mojom || {};
mojo.internal.bindings.network.mojom.TrustTokenParamsSpec = mojo.internal.bindings.network.mojom.TrustTokenParamsSpec || { $: mojo.internal.OpaqueStruct.$ };
mojo.internal.bindings.url = mojo.internal.bindings.url || {};
...
mojo.internal.Union(
    mojo.internal.bindings.network.mojom.ObliviousHttpCompletionResultSpec, 'network.mojom.ObliviousHttpCompletionResult', {
      'arg_net_error': {
        'ordinal': 0,
        'type': mojo.internal.Int32,
        'nullable': false,
      },
      'arg_outer_response_error_code': {
        'ordinal': 1,
        'type': mojo.internal.Int32,
        'nullable': false,
      },
...
mojo.internal.Struct(
    mojo.internal.bindings.network.mojom.ObliviousHttpPaddingParametersSpec, 'network.mojom.ObliviousHttpPaddingParameters', [
      mojo.internal.StructField('arg_exponential_mean', 0, 0, mojo.internal.Uint16, 0, false, 0, undefined),
      mojo.internal.StructField('arg_add_exponential_pad', 2, 0, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_pad_to_next_power_of_two', 2, 1, mojo.internal.Bool, false, false, 0, undefined),
    ],
    [[0, 16]]);
...
mojo.internal.bindings.network.mojom.ObliviousHttpClientRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.network.mojom.ObliviousHttpClientPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.network.mojom.ObliviousHttpClientRemoteCallHandler(this.proxy);
  }
  ...
  onCompleted(arg_response) {
    return this.$.onCompleted(arg_response);
  }
};
...
mojo.internal.bindings.network.mojom.ObliviousHttpClient.getRemote = function() {
  let remote = new mojo.internal.bindings.network.mojom.ObliviousHttpClientRemote();
...
mojo.internal.bindings.network.mojom.ObliviousHttpClientReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.network.mojom.ObliviousHttpClient_OnCompleted_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OnCompleted failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.network.mojom.ObliviousHttpClientReceiver = mojo.internal.bindings.network.mojom.ObliviousHttpClientReceiver;

mojo.internal.bindings.network.mojom.ObliviousHttpClientPtr = mojo.internal.bindings.network.mojom.ObliviousHttpClientRemote;
mojo.internal.bindings.network.mojom.ObliviousHttpClientRequest = mojo.internal.bindings.network.mojom.ObliviousHttpClientPendingReceiver;
