...
mojo.internal.bindings.chromecast.mojom.RemoteInterfaces = {};
mojo.internal.bindings.chromecast.mojom.RemoteInterfacesSpec = { $ : {} };
mojo.internal.bindings.chromecast.mojom.RemoteInterfaces.$interfaceName = 'chromecast.mojom.RemoteInterfaces';
...
mojo.internal.bindings.chromecast.mojom.RemoteInterfacesRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.chromecast.mojom.RemoteInterfacesPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.chromecast.mojom.RemoteInterfacesRemoteCallHandler(this.proxy);
  }
  ...
  bindInterface(arg_interface_name, arg_pipe) {
    return this.$.bindInterface(arg_interface_name, arg_pipe);
  }
  addClient(arg_receiver) {
    return this.$.addClient(arg_receiver);
  }
};

mojo.internal.bindings.chromecast.mojom.RemoteInterfacesRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('chromecast.mojom.RemoteInterfaces', [
      { explicit: null },
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.chromecast.mojom.RemoteInterfaces.getRemote = function() {
  let remote = new mojo.internal.bindings.chromecast.mojom.RemoteInterfacesRemote();
...
mojo.internal.bindings.chromecast.mojom.RemoteInterfacesReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('chromecast.mojom.RemoteInterfaces', [
      { explicit: null },
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.chromecast.mojom.RemoteInterfaces_BindInterface_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for BindInterface failed with TypeError');
           }
        }
        // Try Method 1: AddClient
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.chromecast.mojom.RemoteInterfaces_AddClient_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
...
mojo.internal.bindings.chromecast.mojom.RemoteInterfacesReceiver = mojo.internal.bindings.chromecast.mojom.RemoteInterfacesReceiver;
