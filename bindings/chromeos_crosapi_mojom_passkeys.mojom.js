...
mojo.internal.bindings.crosapi.mojom.PasskeyCreationError = {
  kInternalError: 0,
...
mojo.internal.bindings.crosapi.mojom.PasskeyAssertionError = {
  kInternalError: 0,
  kNonPrimaryAccount: 1,
  kPendingRequest: 2,
...
mojo.internal.bindings.crosapi.mojom.PasskeyAuthenticatorRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.crosapi.mojom.PasskeyAuthenticatorPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.crosapi.mojom.PasskeyAuthenticatorRemoteCallHandler(this.proxy);
  }
  ...
  create(arg_account, arg_request) {
    return this.$.create(arg_account, arg_request);
  }
  assert(arg_account, arg_request) {
    return this.$.assert(arg_account, arg_request);
  }
};
...
mojo.internal.bindings.crosapi.mojom.PasskeyAuthenticator.getRemote = function() {
  let remote = new mojo.internal.bindings.crosapi.mojom.PasskeyAuthenticatorRemote();
...
mojo.internal.bindings.crosapi.mojom.PasskeyAuthenticatorReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.crosapi.mojom.PasskeyAuthenticator_Create_ParamsSpec.$.structSpec;
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.crosapi.mojom.PasskeyAuthenticator_Assert_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for Assert failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.crosapi.mojom.PasskeyAuthenticatorReceiver = mojo.internal.bindings.crosapi.mojom.PasskeyAuthenticatorReceiver;
