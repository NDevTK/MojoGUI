...
mojo.internal.bindings.sharing.mojom.NearbySharingDecoderRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.sharing.mojom.NearbySharingDecoderRemoteCallHandler(this.proxy);
  }
  ...
  decodeAdvertisement(arg_data) {
    return this.$.decodeAdvertisement(arg_data);
  }
  decodeFrame(arg_data) {
    return this.$.decodeFrame(arg_data);
  }
};
...
mojo.internal.bindings.sharing.mojom.NearbySharingDecoder.getRemote = function() {
  let remote = new mojo.internal.bindings.sharing.mojom.NearbySharingDecoderRemote();
...
mojo.internal.bindings.sharing.mojom.NearbySharingDecoderReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.sharing.mojom.NearbySharingDecoder_DecodeAdvertisement_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for DecodeAdvertisement failed with TypeError');
           }
        }
        // Try Method 1: DecodeFrame
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.sharing.mojom.NearbySharingDecoder_DecodeFrame_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for DecodeFrame failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.sharing.mojom.NearbySharingDecoderReceiver = mojo.internal.bindings.sharing.mojom.NearbySharingDecoderReceiver;
