...
// Enum: OpenUrlResult
mojo.internal.bindings.remoting.mojom.OpenUrlResult = {
...
mojo.internal.Struct(
    mojo.internal.bindings.remoting.mojom.RemoteUrlOpener_OpenUrl_ResponseParamsSpec, 'remoting.mojom.RemoteUrlOpener_OpenUrl_ResponseParams', [
      mojo.internal.StructField('arg_result', 0, 0, mojo.internal.bindings.mojo.internal.bindings.remoting.mojom.OpenUrlResultSpec.$, null, false, 0, undefined),
    ],
    [[0, 16]]);
...
mojo.internal.bindings.remoting.mojom.RemoteUrlOpenerRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.remoting.mojom.RemoteUrlOpenerRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.remoting.mojom.RemoteUrlOpener.getRemote = function() {
  let remote = new mojo.internal.bindings.remoting.mojom.RemoteUrlOpenerRemote();
...
mojo.internal.bindings.remoting.mojom.RemoteUrlOpenerReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
        ...
        case 0: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.remoting.mojom.RemoteUrlOpener_OpenUrl_ResponseParamsSpec, header, rawHeader);
               responder(response);
...
mojo.internal.bindings.remoting.mojom.RemoteUrlOpenerReceiver = mojo.internal.bindings.remoting.mojom.RemoteUrlOpenerReceiver;
