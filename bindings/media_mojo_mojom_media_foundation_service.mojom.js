...
mojo.internal.bindings.media.mojom.FrameInterfaceFactoryPendingReceiver = mojo.internal.bindings.media.mojom.FrameInterfaceFactoryPendingReceiver || class { constructor(handle) { this.handle = handle; } };
mojo.internal.bindings.media = mojo.internal.bindings.media || {};
mojo.internal.bindings.media.mojom = mojo.internal.bindings.media.mojom || {};
...
mojo.internal.bindings.media.mojom.InterfaceFactoryPendingReceiver = mojo.internal.bindings.media.mojom.InterfaceFactoryPendingReceiver || class { constructor(handle) { this.handle = handle; } };
mojo.internal.bindings.media = mojo.internal.bindings.media || {};
mojo.internal.bindings.media.mojom = mojo.internal.bindings.media.mojom || {};
mojo.internal.bindings.media.mojom.KeySystemCapabilitySpec = mojo.internal.bindings.media.mojom.KeySystemCapabilitySpec || { $: mojo.internal.OpaqueStruct.$ };
mojo.internal.bindings.mojo_base = mojo.internal.bindings.mojo_base || {};
mojo.internal.bindings.mojo_base.mojom = mojo.internal.bindings.mojo_base.mojom || {};
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        case 0: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              const val = (response && typeof response === 'object' && 'arg_gpu_info_observer' in response) ? response['arg_gpu_info_observer'] : response;
...
mojo.internal.Struct(
    mojo.internal.bindings.media.mojom.MediaFoundationService_CreateInterfaceFactory_ParamsSpec, 'media.mojom.MediaFoundationService_CreateInterfaceFactory_Params', [
      mojo.internal.StructField('arg_factory', 0, 0, mojo.internal.InterfaceRequest(mojo.internal.bindings.media.mojom.InterfaceFactoryPendingReceiver), null, false, 0, undefined),
...
mojo.internal.Struct(
    mojo.internal.bindings.media.mojom.MediaFoundationServiceBroker_GetService_ParamsSpec, 'media.mojom.MediaFoundationServiceBroker_GetService_Params', [
      ...
      mojo.internal.StructField('arg_receiver', 8, 0, mojo.internal.InterfaceRequest(mojo.internal.bindings.media.mojom.MediaFoundationServicePendingReceiver), null, false, 0, undefined),
    ],
    [[0, 24]]);
