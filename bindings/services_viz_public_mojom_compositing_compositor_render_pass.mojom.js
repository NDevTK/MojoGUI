  ...
  $: {
    structSpec: {
      ...
      fields: [
        ...
        { name: 'has_transparent_background', packedOffset: 80, packedBitOffset: 0, type: mojo.internal.Bool, nullable: false, minVersion: 0 },
        { name: 'cache_render_pass', packedOffset: 80, packedBitOffset: 1, type: mojo.internal.Bool, nullable: false, minVersion: 0 },
        { name: 'has_damage_from_contributing_content', packedOffset: 80, packedBitOffset: 2, type: mojo.internal.Bool, nullable: false, minVersion: 0 },
        { name: 'generate_mipmap', packedOffset: 80, packedBitOffset: 3, type: mojo.internal.Bool, nullable: false, minVersion: 0 },
        { name: 'copy_requests', packedOffset: 88, packedBitOffset: 0, type: mojo.internal.Array(viz.mojom.CopyOutputRequestSpec, false), nullable: false, minVersion: 0 },
        { name: 'quad_list', packedOffset: 96, packedBitOffset: 0, type: mojo.internal.Array(viz.mojom.DrawQuadSpec, false), nullable: false, minVersion: 0 },
        { name: 'has_per_quad_damage', packedOffset: 80, packedBitOffset: 4, type: mojo.internal.Bool, nullable: false, minVersion: 0 },
      ],
