  ...
  $: {
    structSpec: {
      ...
      fields: [
        ...
        { name: 'damage_rect', packedOffset: 16, packedBitOffset: 0, type: gfx.mojom.RectSpec, nullable: false },
        { name: 'transform_to_root_target', packedOffset: 24, packedBitOffset: 0, type: gfx.mojom.TransformSpec, nullable: false },
        { name: 'filters', packedOffset: 32, packedBitOffset: 0, type: viz.mojom.FilterOperationsSpec, nullable: false },
        { name: 'backdrop_filters', packedOffset: 40, packedBitOffset: 0, type: viz.mojom.FilterOperationsSpec, nullable: false },
        { name: 'backdrop_filter_bounds', packedOffset: 48, packedBitOffset: 0, type: skia.mojom.SkPathSpec, nullable: true },
