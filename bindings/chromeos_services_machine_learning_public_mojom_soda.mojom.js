...
chromeos.machine_learning.mojom.SodaMultilangConfigSpec = {
  $: {
    structSpec: {
      ...
      packedSize: 24,
      fields: [
        { name: 'rewind_when_switching_language', packedOffset: 0, packedBitOffset: 0, type: mojo.internal.Bool, nullable: false, minVersion: 0 },
        { name: 'locale_to_language_pack_map', packedOffset: 8, packedBitOffset: 0, type: mojo.internal.Map(mojo.internal.String, mojo.internal.String, false), nullable: false, minVersion: 0 },
      ],
...
chromeos.machine_learning.mojom.SodaConfigSpec = {
  $: {
    structSpec: {
      ...
      packedSize: 72,
      fields: [
        { name: 'channel_count', packedOffset: 0, packedBitOffset: 0, type: mojo.internal.Uint32, nullable: false, minVersion: 0 },
        { name: 'sample_rate', packedOffset: 4, packedBitOffset: 0, type: mojo.internal.Uint32, nullable: false, minVersion: 0 },
        { name: 'api_key', packedOffset: 8, packedBitOffset: 0, type: mojo.internal.String, nullable: false, minVersion: 0 },
        { name: 'library_dlc_path', packedOffset: 16, packedBitOffset: 0, type: mojo.internal.String, nullable: false, minVersion: 0 },
        { name: 'language_dlc_path', packedOffset: 24, packedBitOffset: 0, type: mojo.internal.String, nullable: false, minVersion: 0 },
  ...
  $: {
    structSpec: {
      ...
      fields: [
        ...
        { name: 'normalized_latency', packedOffset: 40, packedBitOffset: 0, type: mojo.internal.Float, nullable: false, minVersion: 0 },
        { name: 'word_alignments', packedOffset: 48, packedBitOffset: 0, type: mojo.internal.Array(mojo_base.mojom.TimeDeltaSpec, false), nullable: false, minVersion: 0 },
      ],
...
chromeos.machine_learning.mojom.EndpointerEventSpec = {
  $: {
    structSpec: {
      ...
      packedSize: 24,
      fields: [
        { name: 'endpointer_type', packedOffset: 0, packedBitOffset: 0, type: chromeos.machine_learning.mojom.EndpointerTypeSpec, nullable: false, minVersion: 0 },
  ...
  $: {
    structSpec: {
      ...
      fields: [
        ...
        { name: 'endpoint_reason', packedOffset: 8, packedBitOffset: 0, type: chromeos.machine_learning.mojom.EndpointReasonSpec, nullable: false, minVersion: 0 },
        { name: 'timing_event', packedOffset: 16, packedBitOffset: 0, type: chromeos.machine_learning.mojom.TimingInfoSpec, nullable: true, minVersion: 0 },
