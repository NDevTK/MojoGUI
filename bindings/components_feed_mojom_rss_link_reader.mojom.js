...
mojo.internal.bindings.feed.mojom.RssLinkReaderRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.feed.mojom.RssLinkReaderPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.feed.mojom.RssLinkReaderRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.feed.mojom.RssLinkReaderRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('feed.mojom.RssLinkReader', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.feed.mojom.RssLinkReader.getRemote = function() {
  let remote = new mojo.internal.bindings.feed.mojom.RssLinkReaderRemote();
...
mojo.internal.bindings.feed.mojom.RssLinkReaderReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('feed.mojom.RssLinkReader', [
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.feed.mojom.RssLinkReader_GetRssLinks_ParamsSpec.$.structSpec);
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.feed.mojom.RssLinkReader_GetRssLinks_ParamsSpec.$.structSpec);
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.feed.mojom.RssLinkReader_GetRssLinks_ResponseParamsSpec, header, rawHeader);
               responder(response);
...
mojo.internal.bindings.feed.mojom.RssLinkReaderReceiver = mojo.internal.bindings.feed.mojom.RssLinkReaderReceiver;
