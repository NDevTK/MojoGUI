...
mojo.internal.bindings.blink.mojom.AutoplayConfigurationClient = {};
mojo.internal.bindings.blink.mojom.AutoplayConfigurationClientSpec = { $ : {} };
mojo.internal.bindings.blink.mojom.AutoplayConfigurationClient.$interfaceName = 'blink.mojom.AutoplayConfigurationClient';
...
mojo.internal.bindings.blink.mojom.kAutoplayFlagNone = 0x00000;

mojo.internal.bindings.blink.mojom.kAutoplayFlagHighMediaEngagement = 0x00001;

mojo.internal.bindings.blink.mojom.kAutoplayFlagForceAllow = 0x00002;
...
mojo.internal.bindings.blink.mojom.AutoplayConfigurationClientRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.blink.mojom.AutoplayConfigurationClientPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.blink.mojom.AutoplayConfigurationClientRemoteCallHandler(this.proxy);
  }
  ...
  addAutoplayFlags(arg_origin, arg_flags) {
    return this.$.addAutoplayFlags(arg_origin, arg_flags);
  }
};

mojo.internal.bindings.blink.mojom.AutoplayConfigurationClientRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('blink.mojom.AutoplayConfigurationClient', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.blink.mojom.AutoplayConfigurationClient.getRemote = function() {
  let remote = new mojo.internal.bindings.blink.mojom.AutoplayConfigurationClientRemote();
...
mojo.internal.bindings.blink.mojom.AutoplayConfigurationClientReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('blink.mojom.AutoplayConfigurationClient', [
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.blink.mojom.AutoplayConfigurationClient_AddAutoplayFlags_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for AddAutoplayFlags failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.blink.mojom.AutoplayConfigurationClientReceiver = mojo.internal.bindings.blink.mojom.AutoplayConfigurationClientReceiver;
