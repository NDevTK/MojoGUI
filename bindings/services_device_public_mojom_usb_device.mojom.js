...
mojo.internal.bindings.device.mojom.UsbOpenDeviceSuccessSpec = mojo.internal.bindings.device.mojom.UsbOpenDeviceSuccessSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.device.mojom.UsbOpenDeviceErrorSpec = mojo.internal.bindings.device.mojom.UsbOpenDeviceErrorSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.device.mojom.UsbClaimInterfaceResultSpec = mojo.internal.bindings.device.mojom.UsbClaimInterfaceResultSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.device.mojom.UsbTransferDirectionSpec = mojo.internal.bindings.device.mojom.UsbTransferDirectionSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.device.mojom.UsbControlTransferTypeSpec = mojo.internal.bindings.device.mojom.UsbControlTransferTypeSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.device.mojom.UsbControlTransferRecipientSpec = mojo.internal.bindings.device.mojom.UsbControlTransferRecipientSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.device.mojom.UsbTransferTypeSpec = mojo.internal.bindings.device.mojom.UsbTransferTypeSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.device.mojom.UsbSynchronizationTypeSpec = mojo.internal.bindings.device.mojom.UsbSynchronizationTypeSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.device.mojom.UsbUsageTypeSpec = mojo.internal.bindings.device.mojom.UsbUsageTypeSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.device.mojom.UsbTransferStatusSpec = mojo.internal.bindings.device.mojom.UsbTransferStatusSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.device.mojom.UsbOpenDeviceResultSpec = mojo.internal.bindings.device.mojom.UsbOpenDeviceResultSpec || { $: {} };
if (mojo.internal.bindings.device.mojom.UsbOpenDeviceResultSpec.$.structSpec && mojo.internal.bindings.device.mojom.UsbOpenDeviceResultSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.device.mojom.UsbOpenDeviceResultSpec.$ = {};
mojo.internal.bindings.device.mojom.UsbEndpointInfoSpec = mojo.internal.bindings.device.mojom.UsbEndpointInfoSpec || { $: {} };
if (mojo.internal.bindings.device.mojom.UsbEndpointInfoSpec.$.structSpec && mojo.internal.bindings.device.mojom.UsbEndpointInfoSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.device.mojom.UsbEndpointInfoSpec.$ = {};
mojo.internal.bindings.device.mojom.UsbAlternateInterfaceInfoSpec = mojo.internal.bindings.device.mojom.UsbAlternateInterfaceInfoSpec || { $: {} };
if (mojo.internal.bindings.device.mojom.UsbAlternateInterfaceInfoSpec.$.structSpec && mojo.internal.bindings.device.mojom.UsbAlternateInterfaceInfoSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.device.mojom.UsbAlternateInterfaceInfoSpec.$ = {};
mojo.internal.bindings.device.mojom.UsbInterfaceInfoSpec = mojo.internal.bindings.device.mojom.UsbInterfaceInfoSpec || { $: {} };
if (mojo.internal.bindings.device.mojom.UsbInterfaceInfoSpec.$.structSpec && mojo.internal.bindings.device.mojom.UsbInterfaceInfoSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.device.mojom.UsbInterfaceInfoSpec.$ = {};
mojo.internal.bindings.device.mojom.UsbConfigurationInfoSpec = mojo.internal.bindings.device.mojom.UsbConfigurationInfoSpec || { $: {} };
if (mojo.internal.bindings.device.mojom.UsbConfigurationInfoSpec.$.structSpec && mojo.internal.bindings.device.mojom.UsbConfigurationInfoSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.device.mojom.UsbConfigurationInfoSpec.$ = {};
mojo.internal.bindings.device.mojom.UsbDeviceInfoSpec = mojo.internal.bindings.device.mojom.UsbDeviceInfoSpec || { $: {} };
if (mojo.internal.bindings.device.mojom.UsbDeviceInfoSpec.$.structSpec && mojo.internal.bindings.device.mojom.UsbDeviceInfoSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.device.mojom.UsbDeviceInfoSpec.$ = {};
mojo.internal.bindings.device.mojom.UsbControlTransferParamsSpec = mojo.internal.bindings.device.mojom.UsbControlTransferParamsSpec || { $: {} };
if (mojo.internal.bindings.device.mojom.UsbControlTransferParamsSpec.$.structSpec && mojo.internal.bindings.device.mojom.UsbControlTransferParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.device.mojom.UsbControlTransferParamsSpec.$ = {};
mojo.internal.bindings.device.mojom.UsbIsochronousPacketSpec = mojo.internal.bindings.device.mojom.UsbIsochronousPacketSpec || { $: {} };
if (mojo.internal.bindings.device.mojom.UsbIsochronousPacketSpec.$.structSpec && mojo.internal.bindings.device.mojom.UsbIsochronousPacketSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.device.mojom.UsbIsochronousPacketSpec.$ = {};
mojo.internal.bindings.device.mojom.UsbDevice = mojo.internal.bindings.device.mojom.UsbDevice || {};
mojo.internal.bindings.device.mojom.UsbDeviceSpec = mojo.internal.bindings.device.mojom.UsbDeviceSpec || { $ : {} };
if (mojo.internal.bindings.device.mojom.UsbDeviceSpec.$.structSpec && mojo.internal.bindings.device.mojom.UsbDeviceSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.device.mojom.UsbDeviceSpec.$ = {};
mojo.internal.bindings.device.mojom.UsbDevice.$interfaceName = 'device.mojom.UsbDevice';
mojo.internal.bindings.device.mojom.UsbDevice_Open_ParamsSpec = mojo.internal.bindings.device.mojom.UsbDevice_Open_ParamsSpec || { $: {} };
if (mojo.internal.bindings.device.mojom.UsbDevice_Open_ParamsSpec.$.structSpec && mojo.internal.bindings.device.mojom.UsbDevice_Open_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.device.mojom.UsbDevice_Open_ParamsSpec.$ = {};
mojo.internal.bindings.device.mojom.UsbDevice_Open_ResponseParamsSpec = mojo.internal.bindings.device.mojom.UsbDevice_Open_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.device.mojom.UsbDevice_Open_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.device.mojom.UsbDevice_Open_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.device.mojom.UsbDevice_Open_ResponseParamsSpec.$ = {};
mojo.internal.bindings.device.mojom.UsbDevice_Close_ParamsSpec = mojo.internal.bindings.device.mojom.UsbDevice_Close_ParamsSpec || { $: {} };
if (mojo.internal.bindings.device.mojom.UsbDevice_Close_ParamsSpec.$.structSpec && mojo.internal.bindings.device.mojom.UsbDevice_Close_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.device.mojom.UsbDevice_Close_ParamsSpec.$ = {};
mojo.internal.bindings.device.mojom.UsbDevice_Close_ResponseParamsSpec = mojo.internal.bindings.device.mojom.UsbDevice_Close_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.device.mojom.UsbDevice_Close_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.device.mojom.UsbDevice_Close_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.device.mojom.UsbDevice_Close_ResponseParamsSpec.$ = {};
mojo.internal.bindings.device.mojom.UsbDevice_SetConfiguration_ParamsSpec = mojo.internal.bindings.device.mojom.UsbDevice_SetConfiguration_ParamsSpec || { $: {} };
if (mojo.internal.bindings.device.mojom.UsbDevice_SetConfiguration_ParamsSpec.$.structSpec && mojo.internal.bindings.device.mojom.UsbDevice_SetConfiguration_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.device.mojom.UsbDevice_SetConfiguration_ParamsSpec.$ = {};
mojo.internal.bindings.device.mojom.UsbDevice_SetConfiguration_ResponseParamsSpec = mojo.internal.bindings.device.mojom.UsbDevice_SetConfiguration_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.device.mojom.UsbDevice_SetConfiguration_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.device.mojom.UsbDevice_SetConfiguration_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.device.mojom.UsbDevice_SetConfiguration_ResponseParamsSpec.$ = {};
mojo.internal.bindings.device.mojom.UsbDevice_ClaimInterface_ParamsSpec = mojo.internal.bindings.device.mojom.UsbDevice_ClaimInterface_ParamsSpec || { $: {} };
if (mojo.internal.bindings.device.mojom.UsbDevice_ClaimInterface_ParamsSpec.$.structSpec && mojo.internal.bindings.device.mojom.UsbDevice_ClaimInterface_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.device.mojom.UsbDevice_ClaimInterface_ParamsSpec.$ = {};
mojo.internal.bindings.device.mojom.UsbDevice_ClaimInterface_ResponseParamsSpec = mojo.internal.bindings.device.mojom.UsbDevice_ClaimInterface_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.device.mojom.UsbDevice_ClaimInterface_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.device.mojom.UsbDevice_ClaimInterface_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.device.mojom.UsbDevice_ClaimInterface_ResponseParamsSpec.$ = {};
mojo.internal.bindings.device.mojom.UsbDevice_ReleaseInterface_ParamsSpec = mojo.internal.bindings.device.mojom.UsbDevice_ReleaseInterface_ParamsSpec || { $: {} };
if (mojo.internal.bindings.device.mojom.UsbDevice_ReleaseInterface_ParamsSpec.$.structSpec && mojo.internal.bindings.device.mojom.UsbDevice_ReleaseInterface_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.device.mojom.UsbDevice_ReleaseInterface_ParamsSpec.$ = {};
mojo.internal.bindings.device.mojom.UsbDevice_ReleaseInterface_ResponseParamsSpec = mojo.internal.bindings.device.mojom.UsbDevice_ReleaseInterface_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.device.mojom.UsbDevice_ReleaseInterface_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.device.mojom.UsbDevice_ReleaseInterface_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.device.mojom.UsbDevice_ReleaseInterface_ResponseParamsSpec.$ = {};
mojo.internal.bindings.device.mojom.UsbDevice_SetInterfaceAlternateSetting_ParamsSpec = mojo.internal.bindings.device.mojom.UsbDevice_SetInterfaceAlternateSetting_ParamsSpec || { $: {} };
if (mojo.internal.bindings.device.mojom.UsbDevice_SetInterfaceAlternateSetting_ParamsSpec.$.structSpec && mojo.internal.bindings.device.mojom.UsbDevice_SetInterfaceAlternateSetting_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.device.mojom.UsbDevice_SetInterfaceAlternateSetting_ParamsSpec.$ = {};
mojo.internal.bindings.device.mojom.UsbDevice_SetInterfaceAlternateSetting_ResponseParamsSpec = mojo.internal.bindings.device.mojom.UsbDevice_SetInterfaceAlternateSetting_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.device.mojom.UsbDevice_SetInterfaceAlternateSetting_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.device.mojom.UsbDevice_SetInterfaceAlternateSetting_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.device.mojom.UsbDevice_SetInterfaceAlternateSetting_ResponseParamsSpec.$ = {};
mojo.internal.bindings.device.mojom.UsbDevice_Reset_ParamsSpec = mojo.internal.bindings.device.mojom.UsbDevice_Reset_ParamsSpec || { $: {} };
if (mojo.internal.bindings.device.mojom.UsbDevice_Reset_ParamsSpec.$.structSpec && mojo.internal.bindings.device.mojom.UsbDevice_Reset_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.device.mojom.UsbDevice_Reset_ParamsSpec.$ = {};
mojo.internal.bindings.device.mojom.UsbDevice_Reset_ResponseParamsSpec = mojo.internal.bindings.device.mojom.UsbDevice_Reset_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.device.mojom.UsbDevice_Reset_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.device.mojom.UsbDevice_Reset_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.device.mojom.UsbDevice_Reset_ResponseParamsSpec.$ = {};
mojo.internal.bindings.device.mojom.UsbDevice_ClearHalt_ParamsSpec = mojo.internal.bindings.device.mojom.UsbDevice_ClearHalt_ParamsSpec || { $: {} };
if (mojo.internal.bindings.device.mojom.UsbDevice_ClearHalt_ParamsSpec.$.structSpec && mojo.internal.bindings.device.mojom.UsbDevice_ClearHalt_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.device.mojom.UsbDevice_ClearHalt_ParamsSpec.$ = {};
mojo.internal.bindings.device.mojom.UsbDevice_ClearHalt_ResponseParamsSpec = mojo.internal.bindings.device.mojom.UsbDevice_ClearHalt_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.device.mojom.UsbDevice_ClearHalt_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.device.mojom.UsbDevice_ClearHalt_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.device.mojom.UsbDevice_ClearHalt_ResponseParamsSpec.$ = {};
mojo.internal.bindings.device.mojom.UsbDevice_ControlTransferIn_ParamsSpec = mojo.internal.bindings.device.mojom.UsbDevice_ControlTransferIn_ParamsSpec || { $: {} };
if (mojo.internal.bindings.device.mojom.UsbDevice_ControlTransferIn_ParamsSpec.$.structSpec && mojo.internal.bindings.device.mojom.UsbDevice_ControlTransferIn_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.device.mojom.UsbDevice_ControlTransferIn_ParamsSpec.$ = {};
mojo.internal.bindings.device.mojom.UsbDevice_ControlTransferIn_ResponseParamsSpec = mojo.internal.bindings.device.mojom.UsbDevice_ControlTransferIn_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.device.mojom.UsbDevice_ControlTransferIn_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.device.mojom.UsbDevice_ControlTransferIn_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.device.mojom.UsbDevice_ControlTransferIn_ResponseParamsSpec.$ = {};
mojo.internal.bindings.device.mojom.UsbDevice_ControlTransferOut_ParamsSpec = mojo.internal.bindings.device.mojom.UsbDevice_ControlTransferOut_ParamsSpec || { $: {} };
if (mojo.internal.bindings.device.mojom.UsbDevice_ControlTransferOut_ParamsSpec.$.structSpec && mojo.internal.bindings.device.mojom.UsbDevice_ControlTransferOut_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.device.mojom.UsbDevice_ControlTransferOut_ParamsSpec.$ = {};
mojo.internal.bindings.device.mojom.UsbDevice_ControlTransferOut_ResponseParamsSpec = mojo.internal.bindings.device.mojom.UsbDevice_ControlTransferOut_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.device.mojom.UsbDevice_ControlTransferOut_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.device.mojom.UsbDevice_ControlTransferOut_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.device.mojom.UsbDevice_ControlTransferOut_ResponseParamsSpec.$ = {};
mojo.internal.bindings.device.mojom.UsbDevice_GenericTransferIn_ParamsSpec = mojo.internal.bindings.device.mojom.UsbDevice_GenericTransferIn_ParamsSpec || { $: {} };
if (mojo.internal.bindings.device.mojom.UsbDevice_GenericTransferIn_ParamsSpec.$.structSpec && mojo.internal.bindings.device.mojom.UsbDevice_GenericTransferIn_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.device.mojom.UsbDevice_GenericTransferIn_ParamsSpec.$ = {};
mojo.internal.bindings.device.mojom.UsbDevice_GenericTransferIn_ResponseParamsSpec = mojo.internal.bindings.device.mojom.UsbDevice_GenericTransferIn_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.device.mojom.UsbDevice_GenericTransferIn_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.device.mojom.UsbDevice_GenericTransferIn_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.device.mojom.UsbDevice_GenericTransferIn_ResponseParamsSpec.$ = {};
mojo.internal.bindings.device.mojom.UsbDevice_GenericTransferOut_ParamsSpec = mojo.internal.bindings.device.mojom.UsbDevice_GenericTransferOut_ParamsSpec || { $: {} };
if (mojo.internal.bindings.device.mojom.UsbDevice_GenericTransferOut_ParamsSpec.$.structSpec && mojo.internal.bindings.device.mojom.UsbDevice_GenericTransferOut_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.device.mojom.UsbDevice_GenericTransferOut_ParamsSpec.$ = {};
mojo.internal.bindings.device.mojom.UsbDevice_GenericTransferOut_ResponseParamsSpec = mojo.internal.bindings.device.mojom.UsbDevice_GenericTransferOut_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.device.mojom.UsbDevice_GenericTransferOut_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.device.mojom.UsbDevice_GenericTransferOut_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.device.mojom.UsbDevice_GenericTransferOut_ResponseParamsSpec.$ = {};
mojo.internal.bindings.device.mojom.UsbDevice_IsochronousTransferIn_ParamsSpec = mojo.internal.bindings.device.mojom.UsbDevice_IsochronousTransferIn_ParamsSpec || { $: {} };
if (mojo.internal.bindings.device.mojom.UsbDevice_IsochronousTransferIn_ParamsSpec.$.structSpec && mojo.internal.bindings.device.mojom.UsbDevice_IsochronousTransferIn_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.device.mojom.UsbDevice_IsochronousTransferIn_ParamsSpec.$ = {};
mojo.internal.bindings.device.mojom.UsbDevice_IsochronousTransferIn_ResponseParamsSpec = mojo.internal.bindings.device.mojom.UsbDevice_IsochronousTransferIn_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.device.mojom.UsbDevice_IsochronousTransferIn_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.device.mojom.UsbDevice_IsochronousTransferIn_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.device.mojom.UsbDevice_IsochronousTransferIn_ResponseParamsSpec.$ = {};
mojo.internal.bindings.device.mojom.UsbDevice_IsochronousTransferOut_ParamsSpec = mojo.internal.bindings.device.mojom.UsbDevice_IsochronousTransferOut_ParamsSpec || { $: {} };
if (mojo.internal.bindings.device.mojom.UsbDevice_IsochronousTransferOut_ParamsSpec.$.structSpec && mojo.internal.bindings.device.mojom.UsbDevice_IsochronousTransferOut_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.device.mojom.UsbDevice_IsochronousTransferOut_ParamsSpec.$ = {};
mojo.internal.bindings.device.mojom.UsbDevice_IsochronousTransferOut_ResponseParamsSpec = mojo.internal.bindings.device.mojom.UsbDevice_IsochronousTransferOut_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.device.mojom.UsbDevice_IsochronousTransferOut_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.device.mojom.UsbDevice_IsochronousTransferOut_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.device.mojom.UsbDevice_IsochronousTransferOut_ResponseParamsSpec.$ = {};
mojo.internal.bindings.device.mojom.UsbDeviceClient = mojo.internal.bindings.device.mojom.UsbDeviceClient || {};
mojo.internal.bindings.device.mojom.UsbDeviceClientSpec = mojo.internal.bindings.device.mojom.UsbDeviceClientSpec || { $ : {} };
if (mojo.internal.bindings.device.mojom.UsbDeviceClientSpec.$.structSpec && mojo.internal.bindings.device.mojom.UsbDeviceClientSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.device.mojom.UsbDeviceClientSpec.$ = {};
mojo.internal.bindings.device.mojom.UsbDeviceClient.$interfaceName = 'device.mojom.UsbDeviceClient';
mojo.internal.bindings.device.mojom.UsbDeviceClient_OnDeviceOpened_ParamsSpec = mojo.internal.bindings.device.mojom.UsbDeviceClient_OnDeviceOpened_ParamsSpec || { $: {} };
if (mojo.internal.bindings.device.mojom.UsbDeviceClient_OnDeviceOpened_ParamsSpec.$.structSpec && mojo.internal.bindings.device.mojom.UsbDeviceClient_OnDeviceOpened_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.device.mojom.UsbDeviceClient_OnDeviceOpened_ParamsSpec.$ = {};
mojo.internal.bindings.device.mojom.UsbDeviceClient_OnDeviceClosed_ParamsSpec = mojo.internal.bindings.device.mojom.UsbDeviceClient_OnDeviceClosed_ParamsSpec || { $: {} };
if (mojo.internal.bindings.device.mojom.UsbDeviceClient_OnDeviceClosed_ParamsSpec.$.structSpec && mojo.internal.bindings.device.mojom.UsbDeviceClient_OnDeviceClosed_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.device.mojom.UsbDeviceClient_OnDeviceClosed_ParamsSpec.$ = {};
...
mojo.internal.bindings.device.mojom.kUsbCommClass = 0x02;

mojo.internal.bindings.device.mojom.kUsbHidClass = 0x03;

mojo.internal.bindings.device.mojom.kUsbMassStorageClass = 0x08;

mojo.internal.bindings.device.mojom.kUsbSmartCardClass = 0x0B;

mojo.internal.bindings.device.mojom.kUsbVideoClass = 0x0E;

mojo.internal.bindings.device.mojom.kUsbAudioVideoClass = 0x10;

mojo.internal.bindings.device.mojom.kUsbWirelessClass = 0xE0;

mojo.internal.bindings.device.mojom.kSecurityKeyAOAModel = "12eba9f901039b36";

// Enum: UsbOpenDeviceSuccess
mojo.internal.bindings.device.mojom.UsbOpenDeviceSuccess = {
  OK: 0,
};

// Enum: UsbOpenDeviceError
mojo.internal.bindings.device.mojom.UsbOpenDeviceError = {
  ACCESS_DENIED: 0,
  ALREADY_OPEN: 1,
};

// Enum: UsbClaimInterfaceResult
mojo.internal.bindings.device.mojom.UsbClaimInterfaceResult = {
  kSuccess: 0,
  kProtectedClass: 1,
  kFailure: 2,
};
...
mojo.internal.bindings.device.mojom.UsbTransferDirection = {
  INBOUND: 0,
  OUTBOUND: 1,
};

// Enum: UsbControlTransferType
mojo.internal.bindings.device.mojom.UsbControlTransferType = {
  STANDARD: 0,
  CLASS: 1,
  VENDOR: 2,
  RESERVED: 3,
...
mojo.internal.bindings.device.mojom.UsbControlTransferRecipient = {
  DEVICE: 0,
  INTERFACE: 1,
  ENDPOINT: 2,
  OTHER: 3,
...
mojo.internal.bindings.device.mojom.UsbTransferType = {
  CONTROL: 0,
  ISOCHRONOUS: 1,
  BULK: 2,
  INTERRUPT: 3,
...
mojo.internal.bindings.device.mojom.UsbSynchronizationType = {
  NONE: 0,
  ASYNCHRONOUS: 1,
  ADAPTIVE: 2,
  SYNCHRONOUS: 3,
...
// Enum: UsbUsageType
mojo.internal.bindings.device.mojom.UsbUsageType = {
  DATA: 0,
  FEEDBACK: 1,
  EXPLICIT_FEEDBACK: 2,
  PERIODIC: 3,
...
mojo.internal.bindings.device.mojom.UsbTransferStatus = {
  COMPLETED: 0,
  TRANSFER_ERROR: 1,
  TIMEOUT: 2,
  CANCELLED: 3,
...
// Interface: UsbDevice
mojo.internal.bindings.device.mojom.UsbDevicePendingReceiver = class {
  constructor(handle) {
    this.handle = handle;
    if (handle) {
...
mojo.internal.bindings.device.mojom.UsbDeviceRemote = class {
  ...
  constructor(handle = undefined) {
    ...
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.device.mojom.UsbDevicePendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.device.mojom.UsbDeviceRemoteCallHandler(this.proxy);
  }
  ...
  setConfiguration(arg_value) {
    return this.$.setConfiguration(arg_value);
  }
  claimInterface(arg_interface_number) {
    return this.$.claimInterface(arg_interface_number);
  }
  releaseInterface(arg_interface_number) {
    return this.$.releaseInterface(arg_interface_number);
  }
  setInterfaceAlternateSetting(arg_interface_number, arg_alternate_setting) {
    return this.$.setInterfaceAlternateSetting(arg_interface_number, arg_alternate_setting);
  }
  reset() {
    return this.$.reset();
  }
  clearHalt(arg_direction, arg_endpoint_number) {
    return this.$.clearHalt(arg_direction, arg_endpoint_number);
  }
  controlTransferIn(arg_params, arg_length, arg_timeout) {
    return this.$.controlTransferIn(arg_params, arg_length, arg_timeout);
  }
  controlTransferOut(arg_params, arg_data, arg_timeout) {
    return this.$.controlTransferOut(arg_params, arg_data, arg_timeout);
  }
  genericTransferIn(arg_endpoint_number, arg_length, arg_timeout) {
    return this.$.genericTransferIn(arg_endpoint_number, arg_length, arg_timeout);
  }
  genericTransferOut(arg_endpoint_number, arg_data, arg_timeout) {
    return this.$.genericTransferOut(arg_endpoint_number, arg_data, arg_timeout);
  }
  isochronousTransferIn(arg_endpoint_number, arg_packet_lengths, arg_timeout) {
    return this.$.isochronousTransferIn(arg_endpoint_number, arg_packet_lengths, arg_timeout);
  }
  isochronousTransferOut(arg_endpoint_number, arg_data, arg_packet_lengths, arg_timeout) {
    return this.$.isochronousTransferOut(arg_endpoint_number, arg_data, arg_packet_lengths, arg_timeout);
  }
};
...
mojo.internal.bindings.device.mojom.UsbDevice.getRemote = function() {
  let remote = new mojo.internal.bindings.device.mojom.UsbDeviceRemote();
...
mojo.internal.bindings.device.mojom.UsbDeviceReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        case 0: {
          ...
          const params = decoder.decodeStructInline(mojo.internal.bindings.device.mojom.UsbDevice_Open_ParamsSpec.$.structSpec);
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const message = new mojo.internal.Message(
                ...
                header.ordinal, header.requestId, mojo.internal.bindings.device.mojom.UsbDevice_Open_ResponseParamsSpec.$.structSpec, resp_obj);
        ...
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.device.mojom.UsbDevice_Close_ParamsSpec.$.structSpec);
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.device.mojom.UsbDevice_Close_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
        ...
        case 2: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.device.mojom.UsbDevice_SetConfiguration_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
        ...
        case 3: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.device.mojom.UsbDevice_ClaimInterface_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
        ...
        case 4: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.device.mojom.UsbDevice_ReleaseInterface_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
        ...
        case 5: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.device.mojom.UsbDevice_SetInterfaceAlternateSetting_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
        ...
        case 6: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.device.mojom.UsbDevice_Reset_ParamsSpec.$.structSpec);
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.device.mojom.UsbDevice_Reset_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
        ...
        case 7: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.device.mojom.UsbDevice_ClearHalt_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
        ...
        case 8: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.device.mojom.UsbDevice_ControlTransferIn_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
        ...
        case 9: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.device.mojom.UsbDevice_ControlTransferOut_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
        ...
        case 10: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.device.mojom.UsbDevice_GenericTransferIn_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
        ...
        case 11: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.device.mojom.UsbDevice_GenericTransferOut_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
        ...
        case 12: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.device.mojom.UsbDevice_IsochronousTransferIn_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
        ...
        case 13: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const resp_obj = { 'arg_packets': val };
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.device.mojom.UsbDevice_IsochronousTransferOut_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
...
mojo.internal.bindings.device.mojom.UsbDeviceReceiver = mojo.internal.bindings.device.mojom.UsbDeviceReceiver;

mojo.internal.bindings.device.mojom.UsbDevicePtr = mojo.internal.bindings.device.mojom.UsbDeviceRemote;
mojo.internal.bindings.device.mojom.UsbDeviceRequest = mojo.internal.bindings.device.mojom.UsbDevicePendingReceiver;


// Interface: UsbDeviceClient
mojo.internal.bindings.device.mojom.UsbDeviceClientPendingReceiver = class {
  constructor(handle) {
    this.handle = handle;
    if (handle) {
      this.__mojoHandle = handle.router_ ? handle.router_.pipe_ : (handle.pipe_ || handle);
...
mojo.internal.bindings.device.mojom.UsbDeviceClientRemote = class {
  static get $interfaceName() {
  ...
  constructor(handle = undefined) {
    this.__mojoHandle = handle;
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.device.mojom.UsbDeviceClientPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.device.mojom.UsbDeviceClientRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.device.mojom.UsbDeviceClient.getRemote = function() {
  let remote = new mojo.internal.bindings.device.mojom.UsbDeviceClientRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
...
mojo.internal.bindings.device.mojom.UsbDeviceClientReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.device.mojom.UsbDeviceClient_OnDeviceOpened_ParamsSpec.$.structSpec);
        ...
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.device.mojom.UsbDeviceClient_OnDeviceClosed_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.device.mojom.UsbDeviceClientReceiver = mojo.internal.bindings.device.mojom.UsbDeviceClientReceiver;

mojo.internal.bindings.device.mojom.UsbDeviceClientPtr = mojo.internal.bindings.device.mojom.UsbDeviceClientRemote;
mojo.internal.bindings.device.mojom.UsbDeviceClientRequest = mojo.internal.bindings.device.mojom.UsbDeviceClientPendingReceiver;
...
mojo.internal.Union(
    mojo.internal.bindings.device.mojom.UsbOpenDeviceResultSpec, 'device.mojom.UsbOpenDeviceResult', {
      'arg_success': {
        'ordinal': 0,
        'type': mojo.internal.bindings.device.mojom.UsbOpenDeviceSuccessSpec,
        'nullable': false,
      },
      'arg_error': {
        'ordinal': 1,
        'type': mojo.internal.bindings.device.mojom.UsbOpenDeviceErrorSpec,
        'nullable': false,
      },
    });
...
mojo.internal.Struct(
    mojo.internal.bindings.device.mojom.UsbIsochronousPacketSpec, 'device.mojom.UsbIsochronousPacket', [
      mojo.internal.StructField('arg_length', 0, 0, mojo.internal.Uint32, 0, false, 0, undefined),
      mojo.internal.StructField('arg_transferred_length', 4, 0, mojo.internal.Uint32, 0, false, 0, undefined),
    ...
    [[0, 24]]);
mojo.internal.Struct(
    mojo.internal.bindings.device.mojom.UsbDevice_Open_ParamsSpec, 'device.mojom.UsbDevice_Open_Params', [
    ],
    [[0, 8]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.device.mojom.UsbDevice_Close_ResponseParamsSpec, 'device.mojom.UsbDevice_Close_ResponseParams', [
    ],
    [[0, 8]]);

mojo.internal.Struct(
    mojo.internal.bindings.device.mojom.UsbDevice_SetConfiguration_ParamsSpec, 'device.mojom.UsbDevice_SetConfiguration_Params', [
      mojo.internal.StructField('arg_value', 0, 0, mojo.internal.Uint8, 0, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.device.mojom.UsbDevice_SetConfiguration_ResponseParamsSpec, 'device.mojom.UsbDevice_SetConfiguration_ResponseParams', [
      mojo.internal.StructField('arg_success', 0, 0, mojo.internal.Bool, false, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.device.mojom.UsbDevice_ClaimInterface_ParamsSpec, 'device.mojom.UsbDevice_ClaimInterface_Params', [
      mojo.internal.StructField('arg_interface_number', 0, 0, mojo.internal.Uint8, 0, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.device.mojom.UsbDevice_ClaimInterface_ResponseParamsSpec, 'device.mojom.UsbDevice_ClaimInterface_ResponseParams', [
      mojo.internal.StructField('arg_result', 0, 0, mojo.internal.bindings.device.mojom.UsbClaimInterfaceResultSpec, null, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.device.mojom.UsbDevice_ReleaseInterface_ParamsSpec, 'device.mojom.UsbDevice_ReleaseInterface_Params', [
      mojo.internal.StructField('arg_interface_number', 0, 0, mojo.internal.Uint8, 0, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.device.mojom.UsbDevice_ReleaseInterface_ResponseParamsSpec, 'device.mojom.UsbDevice_ReleaseInterface_ResponseParams', [
      mojo.internal.StructField('arg_success', 0, 0, mojo.internal.Bool, false, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.device.mojom.UsbDevice_SetInterfaceAlternateSetting_ParamsSpec, 'device.mojom.UsbDevice_SetInterfaceAlternateSetting_Params', [
      mojo.internal.StructField('arg_interface_number', 0, 0, mojo.internal.Uint8, 0, false, 0, undefined),
      mojo.internal.StructField('arg_alternate_setting', 1, 0, mojo.internal.Uint8, 0, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.device.mojom.UsbDevice_SetInterfaceAlternateSetting_ResponseParamsSpec, 'device.mojom.UsbDevice_SetInterfaceAlternateSetting_ResponseParams', [
      mojo.internal.StructField('arg_success', 0, 0, mojo.internal.Bool, false, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.device.mojom.UsbDevice_Reset_ParamsSpec, 'device.mojom.UsbDevice_Reset_Params', [
    ],
    [[0, 8]]);

mojo.internal.Struct(
    mojo.internal.bindings.device.mojom.UsbDevice_Reset_ResponseParamsSpec, 'device.mojom.UsbDevice_Reset_ResponseParams', [
      mojo.internal.StructField('arg_success', 0, 0, mojo.internal.Bool, false, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.device.mojom.UsbDevice_ClearHalt_ParamsSpec, 'device.mojom.UsbDevice_ClearHalt_Params', [
      mojo.internal.StructField('arg_direction', 0, 0, mojo.internal.bindings.device.mojom.UsbTransferDirectionSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_endpoint_number', 4, 0, mojo.internal.Uint8, 0, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.device.mojom.UsbDevice_ClearHalt_ResponseParamsSpec, 'device.mojom.UsbDevice_ClearHalt_ResponseParams', [
      mojo.internal.StructField('arg_success', 0, 0, mojo.internal.Bool, false, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.device.mojom.UsbDevice_ControlTransferIn_ParamsSpec, 'device.mojom.UsbDevice_ControlTransferIn_Params', [
      mojo.internal.StructField('arg_params', 0, 0, mojo.internal.bindings.device.mojom.UsbControlTransferParamsSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_length', 8, 0, mojo.internal.Uint32, 0, false, 0, undefined),
      mojo.internal.StructField('arg_timeout', 12, 0, mojo.internal.Uint32, 0, false, 0, undefined),
    ],
    [[0, 24]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.device.mojom.UsbDevice_ControlTransferOut_ParamsSpec, 'device.mojom.UsbDevice_ControlTransferOut_Params', [
      mojo.internal.StructField('arg_params', 0, 0, mojo.internal.bindings.device.mojom.UsbControlTransferParamsSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_data', 8, 0, mojo.internal.bindings.mojo_base.mojom.ReadOnlyBufferSpec, null, false, 0, undefined),
...
mojo.internal.Struct(
    mojo.internal.bindings.device.mojom.UsbDevice_ControlTransferOut_ResponseParamsSpec, 'device.mojom.UsbDevice_ControlTransferOut_ResponseParams', [
      mojo.internal.StructField('arg_status', 0, 0, mojo.internal.bindings.device.mojom.UsbTransferStatusSpec, null, false, 0, undefined),
    ],
    [[0, 16]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.device.mojom.UsbDevice_GenericTransferOut_ResponseParamsSpec, 'device.mojom.UsbDevice_GenericTransferOut_ResponseParams', [
      mojo.internal.StructField('arg_status', 0, 0, mojo.internal.bindings.device.mojom.UsbTransferStatusSpec, null, false, 0, undefined),
    ],
    [[0, 16]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.device.mojom.UsbDevice_IsochronousTransferIn_ResponseParamsSpec, 'device.mojom.UsbDevice_IsochronousTransferIn_ResponseParams', [
      mojo.internal.StructField('arg_data', 0, 0, mojo.internal.bindings.mojo_base.mojom.ReadOnlyBufferSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_packets', 8, 0, mojo.internal.Array(mojo.internal.bindings.device.mojom.UsbIsochronousPacketSpec, false), null, false, 0, undefined),
    ],
    [[0, 24]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.device.mojom.UsbDevice_IsochronousTransferOut_ResponseParamsSpec, 'device.mojom.UsbDevice_IsochronousTransferOut_ResponseParams', [
      mojo.internal.StructField('arg_packets', 0, 0, mojo.internal.Array(mojo.internal.bindings.device.mojom.UsbIsochronousPacketSpec, false), null, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.device.mojom.UsbDeviceClient_OnDeviceOpened_ParamsSpec, 'device.mojom.UsbDeviceClient_OnDeviceOpened_Params', [
    ],
    [[0, 8]]);

mojo.internal.Struct(
    mojo.internal.bindings.device.mojom.UsbDeviceClient_OnDeviceClosed_ParamsSpec, 'device.mojom.UsbDeviceClient_OnDeviceClosed_Params', [
    ],
    [[0, 8]]);
