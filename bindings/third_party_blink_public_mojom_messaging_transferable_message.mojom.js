  ...
  $: {
    structSpec: {
      ...
      fields: [
        ...
        { name: 'user_activation', packedOffset: 40, packedBitOffset: 0, type: blink.mojom.UserActivationSnapshotSpec, nullable: true },
        { name: 'delegated_capability', packedOffset: 48, packedBitOffset: 0, type: blink.mojom.DelegatedCapabilitySpec, nullable: false },
        { name: 'task_state_id', packedOffset: 56, packedBitOffset: 0, type: blink.mojom.TaskAttributionIdSpec, nullable: true },
      ],
      versions: [{version: 0}]
    }
  }
