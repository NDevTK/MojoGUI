...
mojo.internal.Struct(
    mojo.internal.bindings.payments.mojom.SecurePaymentConfirmationRequestSpec, 'payments.mojom.SecurePaymentConfirmationRequest', [
      ...
      mojo.internal.StructField('arg_payment_entities_logos', 72, 0, mojo.internal.Array(mojo.internal.bindings.payments.mojom.PaymentEntityLogoSpec, false), null, false, 0, undefined),
...
mojo.internal.Struct(
    mojo.internal.bindings.payments.mojom.PaymentMethodDataSpec, 'payments.mojom.PaymentMethodData', [
      ...
      mojo.internal.StructField('arg_supported_networks', 16, 0, mojo.internal.Array(mojo.internal.bindings.payments.mojom.BasicCardNetworkSpec, false), null, false, 0, undefined),
      mojo.internal.StructField('arg_secure_payment_confirmation', 24, 0, mojo.internal.bindings.payments.mojom.SecurePaymentConfirmationRequestSpec, null, true, 0, undefined),
      mojo.internal.StructField('arg_environment', 32, 0, mojo.internal.bindings.payments.mojom.AndroidPayEnvironmentSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_min_google_play_services_version', 36, 0, mojo.internal.Int32, 0, false, 0, undefined),
      mojo.internal.StructField('arg_api_version', 40, 0, mojo.internal.Int32, 0, false, 0, undefined),
    ],
    [[0, 56]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.payments.mojom.PaymentOptionsSpec, 'payments.mojom.PaymentOptions', [
      mojo.internal.StructField('arg_shipping_type', 0, 0, mojo.internal.bindings.payments.mojom.PaymentShippingTypeSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_request_payer_name', 4, 0, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_request_payer_email', 4, 1, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_request_payer_phone', 4, 2, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_request_shipping', 4, 3, mojo.internal.Bool, false, false, 0, undefined),
    ],
    [[0, 16]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.payments.mojom.PaymentRequestClient_OnError_ParamsSpec, 'payments.mojom.PaymentRequestClient_OnError_Params', [
      ...
      mojo.internal.StructField('arg_error', 8, 0, mojo.internal.bindings.payments.mojom.PaymentErrorReasonSpec, null, false, 0, undefined),
    ],
    [[0, 24]]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.payments.mojom.PaymentRequestClient_OnPaymentMethodChange_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OnPaymentMethodChange failed with TypeError');
           }
        }
        // Try Method 1: OnShippingAddressChange
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.payments.mojom.PaymentRequestClient_OnShippingAddressChange_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OnShippingAddressChange failed with TypeError');
           }
        }
        // Try Method 2: OnShippingOptionChange
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.payments.mojom.PaymentRequestClient_OnShippingOptionChange_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OnShippingOptionChange failed with TypeError');
           }
        }
        // Try Method 3: OnPayerDetailChange
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.payments.mojom.PaymentRequestClient_OnPayerDetailChange_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OnPayerDetailChange failed with TypeError');
           }
        }
        // Try Method 4: OnPaymentResponse
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.payments.mojom.PaymentRequestClient_OnPaymentResponse_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OnPaymentResponse failed with TypeError');
           }
        }
        // Try Method 5: OnError
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.payments.mojom.PaymentRequestClient_OnError_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.payments.mojom.PaymentRequestClient_OnComplete_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.payments.mojom.PaymentRequestClient_OnAbort_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OnAbort failed with TypeError');
           }
        }
        // Try Method 8: OnCanMakePayment
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.payments.mojom.PaymentRequestClient_OnCanMakePayment_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OnCanMakePayment failed with TypeError');
           }
        }
        // Try Method 9: OnHasEnrolledInstrument
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.payments.mojom.PaymentRequestClient_OnHasEnrolledInstrument_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OnHasEnrolledInstrument failed with TypeError');
           }
        }
        // Try Method 10: WarnNoFavicon
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.payments.mojom.PaymentRequestClient_WarnNoFavicon_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for WarnNoFavicon failed with TypeError');
           }
        }
        // Try Method 11: AllowConnectToSource
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.payments.mojom.PaymentRequestClient_AllowConnectToSource_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for AllowConnectToSource failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
        ...
        case 11: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              this.endpoint.send(header.ordinal, header.requestId, mojo.internal.kMessageFlagIsResponse, mojo.internal.bindings.payments.mojom.PaymentRequestClient_AllowConnectToSource_ResponseParamsSpec, response);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.payments.mojom.PaymentRequest_Init_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.payments.mojom.PaymentRequest_Show_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.payments.mojom.PaymentRequest_UpdateWith_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for UpdateWith failed with TypeError');
           }
        }
        // Try Method 3: OnPaymentDetailsNotUpdated
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.payments.mojom.PaymentRequest_OnPaymentDetailsNotUpdated_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OnPaymentDetailsNotUpdated failed with TypeError');
           }
        }
        // Try Method 4: Abort
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.payments.mojom.PaymentRequest_Abort_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.payments.mojom.PaymentRequest_Complete_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.payments.mojom.PaymentRequest_Retry_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for Retry failed with TypeError');
           }
        }
        // Try Method 7: CanMakePayment
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.payments.mojom.PaymentRequest_CanMakePayment_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for CanMakePayment failed with TypeError');
           }
        }
        // Try Method 8: HasEnrolledInstrument
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.payments.mojom.PaymentRequest_HasEnrolledInstrument_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for HasEnrolledInstrument failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
             console.warn('[GeneratedReceiver] Failed to discover ordinal ' + header.ordinal);
