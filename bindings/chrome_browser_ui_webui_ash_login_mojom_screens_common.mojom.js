...
mojo.internal.bindings.ash.screens_common.mojom.FjordImageTypeSpec = mojo.internal.bindings.ash.screens_common.mojom.FjordImageTypeSpec || { $: mojo.internal.Enum().$ };
...
mojo.internal.bindings.ash.screens_common.mojom.FjordTouchControllerPageHandler = mojo.internal.bindings.ash.screens_common.mojom.FjordTouchControllerPageHandler || {};
mojo.internal.bindings.ash.screens_common.mojom.FjordTouchControllerPageHandlerSpec = mojo.internal.bindings.ash.screens_common.mojom.FjordTouchControllerPageHandlerSpec || { $ : {} };
if (mojo.internal.bindings.ash.screens_common.mojom.FjordTouchControllerPageHandlerSpec.$.structSpec && mojo.internal.bindings.ash.screens_common.mojom.FjordTouchControllerPageHandlerSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.screens_common.mojom.FjordTouchControllerPageHandlerSpec.$ = {};
mojo.internal.bindings.ash.screens_common.mojom.FjordTouchControllerPageHandler.$interfaceName = 'ash.screens_common.mojom.FjordTouchControllerPageHandler';
mojo.internal.bindings.ash.screens_common.mojom.FjordTouchControllerPageHandler_OnSetupComplete_ParamsSpec = mojo.internal.bindings.ash.screens_common.mojom.FjordTouchControllerPageHandler_OnSetupComplete_ParamsSpec || { $: {} };
if (mojo.internal.bindings.ash.screens_common.mojom.FjordTouchControllerPageHandler_OnSetupComplete_ParamsSpec.$.structSpec && mojo.internal.bindings.ash.screens_common.mojom.FjordTouchControllerPageHandler_OnSetupComplete_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.screens_common.mojom.FjordTouchControllerPageHandler_OnSetupComplete_ParamsSpec.$ = {};
mojo.internal.bindings.ash.screens_common.mojom.FjordImageSelectionPageHandler = mojo.internal.bindings.ash.screens_common.mojom.FjordImageSelectionPageHandler || {};
mojo.internal.bindings.ash.screens_common.mojom.FjordImageSelectionPageHandlerSpec = mojo.internal.bindings.ash.screens_common.mojom.FjordImageSelectionPageHandlerSpec || { $ : {} };
if (mojo.internal.bindings.ash.screens_common.mojom.FjordImageSelectionPageHandlerSpec.$.structSpec && mojo.internal.bindings.ash.screens_common.mojom.FjordImageSelectionPageHandlerSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.screens_common.mojom.FjordImageSelectionPageHandlerSpec.$ = {};
mojo.internal.bindings.ash.screens_common.mojom.FjordImageSelectionPageHandler.$interfaceName = 'ash.screens_common.mojom.FjordImageSelectionPageHandler';
mojo.internal.bindings.ash.screens_common.mojom.FjordImageSelectionPageHandler_OnImageSelected_ParamsSpec = mojo.internal.bindings.ash.screens_common.mojom.FjordImageSelectionPageHandler_OnImageSelected_ParamsSpec || { $: {} };
if (mojo.internal.bindings.ash.screens_common.mojom.FjordImageSelectionPageHandler_OnImageSelected_ParamsSpec.$.structSpec && mojo.internal.bindings.ash.screens_common.mojom.FjordImageSelectionPageHandler_OnImageSelected_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.screens_common.mojom.FjordImageSelectionPageHandler_OnImageSelected_ParamsSpec.$ = {};
...
// Enum: FjordImageType
mojo.internal.bindings.ash.screens_common.mojom.FjordImageType = {
  kCuttlefish: 0,
  kSquid: 1,
};
...
// Interface: FjordTouchControllerPageHandler
mojo.internal.bindings.ash.screens_common.mojom.FjordTouchControllerPageHandlerPendingReceiver = class {
  constructor(handle) {
    this.handle = handle;
    if (handle) {
      this.__mojoHandle = handle.router_ ? handle.router_.pipe_ : (handle.pipe_ || handle);
...
mojo.internal.bindings.ash.screens_common.mojom.FjordTouchControllerPageHandlerRemote = class {
  static get $interfaceName() {
    return 'ash.screens_common.mojom.FjordTouchControllerPageHandler';
  }

  constructor(handle = undefined) {
    this.__mojoHandle = handle;
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.ash.screens_common.mojom.FjordTouchControllerPageHandlerPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.ash.screens_common.mojom.FjordTouchControllerPageHandlerRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.ash.screens_common.mojom.FjordTouchControllerPageHandlerRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('ash.screens_common.mojom.FjordTouchControllerPageHandler', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.ash.screens_common.mojom.FjordTouchControllerPageHandler.getRemote = function() {
  let remote = new mojo.internal.bindings.ash.screens_common.mojom.FjordTouchControllerPageHandlerRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
    'ash.screens_common.mojom.FjordTouchControllerPageHandler',
    'context');
  return remote.$;
};

mojo.internal.bindings.ash.screens_common.mojom.FjordTouchControllerPageHandlerReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('ash.screens_common.mojom.FjordTouchControllerPageHandler', [
      { explicit: null },
    ]);
    ordinals.forEach((ord, idx) => {
      this.ordinalMap.set(ord, idx); // Scrambled/Explicit
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.ash.screens_common.mojom.FjordTouchControllerPageHandler_OnSetupComplete_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.onSetupComplete');
          const result = this.impl.onSetupComplete();
          break;
        }
...
mojo.internal.bindings.ash.screens_common.mojom.FjordTouchControllerPageHandlerReceiver = mojo.internal.bindings.ash.screens_common.mojom.FjordTouchControllerPageHandlerReceiver;

mojo.internal.bindings.ash.screens_common.mojom.FjordTouchControllerPageHandlerPtr = mojo.internal.bindings.ash.screens_common.mojom.FjordTouchControllerPageHandlerRemote;
mojo.internal.bindings.ash.screens_common.mojom.FjordTouchControllerPageHandlerRequest = mojo.internal.bindings.ash.screens_common.mojom.FjordTouchControllerPageHandlerPendingReceiver;


// Interface: FjordImageSelectionPageHandler
mojo.internal.bindings.ash.screens_common.mojom.FjordImageSelectionPageHandlerPendingReceiver = class {
  constructor(handle) {
    this.handle = handle;
    if (handle) {
      this.__mojoHandle = handle.router_ ? handle.router_.pipe_ : (handle.pipe_ || handle);
...
mojo.internal.bindings.ash.screens_common.mojom.FjordImageSelectionPageHandlerRemote = class {
  static get $interfaceName() {
    return 'ash.screens_common.mojom.FjordImageSelectionPageHandler';
  }

  constructor(handle = undefined) {
    this.__mojoHandle = handle;
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.ash.screens_common.mojom.FjordImageSelectionPageHandlerPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.ash.screens_common.mojom.FjordImageSelectionPageHandlerRemoteCallHandler(this.proxy);
  }
  ...
  onImageSelected(arg_image_type) {
    return this.$.onImageSelected(arg_image_type);
  }
};

mojo.internal.bindings.ash.screens_common.mojom.FjordImageSelectionPageHandlerRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('ash.screens_common.mojom.FjordImageSelectionPageHandler', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.ash.screens_common.mojom.FjordImageSelectionPageHandler.getRemote = function() {
  let remote = new mojo.internal.bindings.ash.screens_common.mojom.FjordImageSelectionPageHandlerRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
    'ash.screens_common.mojom.FjordImageSelectionPageHandler',
    'context');
  return remote.$;
};

mojo.internal.bindings.ash.screens_common.mojom.FjordImageSelectionPageHandlerReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('ash.screens_common.mojom.FjordImageSelectionPageHandler', [
      { explicit: null },
    ]);
    ordinals.forEach((ord, idx) => {
      this.ordinalMap.set(ord, idx); // Scrambled/Explicit
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.ash.screens_common.mojom.FjordImageSelectionPageHandler_OnImageSelected_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.onImageSelected');
          const result = this.impl.onImageSelected(params.arg_image_type);
          break;
        }
      }
      } catch (err) {
...
mojo.internal.bindings.ash.screens_common.mojom.FjordImageSelectionPageHandlerReceiver = mojo.internal.bindings.ash.screens_common.mojom.FjordImageSelectionPageHandlerReceiver;

mojo.internal.bindings.ash.screens_common.mojom.FjordImageSelectionPageHandlerPtr = mojo.internal.bindings.ash.screens_common.mojom.FjordImageSelectionPageHandlerRemote;
mojo.internal.bindings.ash.screens_common.mojom.FjordImageSelectionPageHandlerRequest = mojo.internal.bindings.ash.screens_common.mojom.FjordImageSelectionPageHandlerPendingReceiver;
...
mojo.internal.Struct(
    mojo.internal.bindings.ash.screens_common.mojom.FjordTouchControllerPageHandler_OnSetupComplete_ParamsSpec, 'ash.screens_common.mojom.FjordTouchControllerPageHandler_OnSetupComplete_Params', [
    ],
    [[0, 8]]);

mojo.internal.Struct(
    mojo.internal.bindings.ash.screens_common.mojom.FjordImageSelectionPageHandler_OnImageSelected_ParamsSpec, 'ash.screens_common.mojom.FjordImageSelectionPageHandler_OnImageSelected_Params', [
      mojo.internal.StructField('arg_image_type', 0, 0, mojo.internal.bindings.ash.screens_common.mojom.FjordImageTypeSpec, null, false, 0, undefined),
    ],
    [[0, 16]]);
