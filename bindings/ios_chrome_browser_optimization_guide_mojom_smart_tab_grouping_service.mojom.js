...
mojo.internal.bindings.ai = mojo.internal.bindings.ai || {};
mojo.internal.bindings.ai.mojom = mojo.internal.bindings.ai.mojom || {};
mojo.internal.bindings.ai.mojom.SmartTabGroupingResponseResultSpec = mojo.internal.bindings.ai.mojom.SmartTabGroupingResponseResultSpec || { $: mojo.internal.OpaqueStruct.$ };
mojo.internal.bindings.mojo_base = mojo.internal.bindings.mojo_base || {};
...
mojo.internal.bindings.ai.mojom.SmartTabGroupingServiceRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.ai.mojom.SmartTabGroupingServicePendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.ai.mojom.SmartTabGroupingServiceRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.ai.mojom.SmartTabGroupingServiceRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('ai.mojom.SmartTabGroupingService', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.ai.mojom.SmartTabGroupingService.getRemote = function() {
  let remote = new mojo.internal.bindings.ai.mojom.SmartTabGroupingServiceRemote();
...
mojo.internal.bindings.ai.mojom.SmartTabGroupingServiceReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('ai.mojom.SmartTabGroupingService', [
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ai.mojom.SmartTabGroupingService_ExecuteSmartTabGroupingRequest_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for ExecuteSmartTabGroupingRequest failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.ai.mojom.SmartTabGroupingService_ExecuteSmartTabGroupingRequest_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.ai.mojom.SmartTabGroupingServiceReceiver = mojo.internal.bindings.ai.mojom.SmartTabGroupingServiceReceiver;
