...
mojo.internal.bindings.blink.mojom.TextInputHost = {};
mojo.internal.bindings.blink.mojom.TextInputHostSpec = { $ : {} };
mojo.internal.bindings.blink.mojom.TextInputHost.$interfaceName = 'blink.mojom.TextInputHost';
...
mojo.internal.bindings.blink.mojom.TextInputHostRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.blink.mojom.TextInputHostPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.blink.mojom.TextInputHostRemoteCallHandler(this.proxy);
  }
  ...
  gotCharacterIndexAtPoint(arg_index) {
    return this.$.gotCharacterIndexAtPoint(arg_index);
  }
  gotFirstRectForRange(arg_rect) {
    return this.$.gotFirstRectForRange(arg_rect);
  }
};

mojo.internal.bindings.blink.mojom.TextInputHostRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('blink.mojom.TextInputHost', [
      { explicit: null },
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.blink.mojom.TextInputHost.getRemote = function() {
  let remote = new mojo.internal.bindings.blink.mojom.TextInputHostRemote();
...
mojo.internal.bindings.blink.mojom.TextInputHostReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('blink.mojom.TextInputHost', [
      { explicit: null },
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        // Try Method 0: GotCharacterIndexAtPoint
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.blink.mojom.TextInputHost_GotCharacterIndexAtPoint_ParamsSpec.$.structSpec;
             ...
             if (sizeMatch && (!!(header.flags & 1) === methodExpectsResp)) {
               if (size > 8 || message.payload.byteLength === 8) {
                 ...
                 console.log('[GeneratedReceiver] Discovery SUCCESS: ' + header.ordinal + ' -> GotCharacterIndexAtPoint (0)');
                 this.mapOrdinal(header.ordinal, 0);
                 dispatchId = 0;
               }
             }
           } catch (e) {
             if (e instanceof TypeError) console.warn('[Discovery] trial for GotCharacterIndexAtPoint failed with TypeError');
           }
        }
        // Try Method 1: GotFirstRectForRange
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.blink.mojom.TextInputHost_GotFirstRectForRange_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (sizeMatch && (!!(header.flags & 1) === methodExpectsResp)) {
               if (size > 8 || message.payload.byteLength === 8) {
                 decoder.decodeStructInline(structSpec);
                 console.log('[GeneratedReceiver] Discovery SUCCESS: ' + header.ordinal + ' -> GotFirstRectForRange (1)');
                 this.mapOrdinal(header.ordinal, 1);
                 dispatchId = 1;
               }
             }
           } catch (e) {
             if (e instanceof TypeError) console.warn('[Discovery] trial for GotFirstRectForRange failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.blink.mojom.TextInputHostReceiver = mojo.internal.bindings.blink.mojom.TextInputHostReceiver;
