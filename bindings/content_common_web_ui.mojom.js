...
mojo.internal.bindings.content.mojom.WebUIHostRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.content.mojom.WebUIHostRemoteCallHandler(this.proxy);
  }
  ...
  send(arg_message, arg_args) {
    return this.$.send(arg_message, arg_args);
  }
};
...
mojo.internal.bindings.content.mojom.WebUIHost.getRemote = function() {
  let remote = new mojo.internal.bindings.content.mojom.WebUIHostRemote();
...
mojo.internal.bindings.content.mojom.WebUIHostReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.content.mojom.WebUIHost_Send_ParamsSpec.$.structSpec;
...
mojo.internal.bindings.content.mojom.WebUIHostReceiver = mojo.internal.bindings.content.mojom.WebUIHostReceiver;

mojo.internal.bindings.content.mojom.WebUIHostPtr = mojo.internal.bindings.content.mojom.WebUIHostRemote;
mojo.internal.bindings.content.mojom.WebUIHostRequest = mojo.internal.bindings.content.mojom.WebUIHostPendingReceiver;
...
mojo.internal.bindings.content.mojom.WebUIRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.content.mojom.WebUIRemoteCallHandler(this.proxy);
  }
  ...
  setProperty(arg_property_name, arg_property_value_json) {
    return this.$.setProperty(arg_property_name, arg_property_value_json);
  }
};
...
mojo.internal.bindings.content.mojom.WebUI.getRemote = function() {
  let remote = new mojo.internal.bindings.content.mojom.WebUIRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
    'content.mojom.WebUI',
...
mojo.internal.bindings.content.mojom.WebUIReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.content.mojom.WebUI_SetProperty_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
...
mojo.internal.bindings.content.mojom.WebUIReceiver = mojo.internal.bindings.content.mojom.WebUIReceiver;
