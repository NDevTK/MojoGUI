...
mojo.internal.bindings.content.mojom.DomAutomationControllerHostRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.content.mojom.DomAutomationControllerHostPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.content.mojom.DomAutomationControllerHostRemoteCallHandler(this.proxy);
  }
  ...
  domOperationResponse(arg_json_string) {
    return this.$.domOperationResponse(arg_json_string);
  }
};
...
mojo.internal.bindings.content.mojom.DomAutomationControllerHost.getRemote = function() {
  let remote = new mojo.internal.bindings.content.mojom.DomAutomationControllerHostRemote();
...
mojo.internal.bindings.content.mojom.DomAutomationControllerHostReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.content.mojom.DomAutomationControllerHost_DomOperationResponse_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for DomOperationResponse failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.content.mojom.DomAutomationControllerHostReceiver = mojo.internal.bindings.content.mojom.DomAutomationControllerHostReceiver;
