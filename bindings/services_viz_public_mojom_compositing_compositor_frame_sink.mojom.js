...
viz.mojom.LayerContextSettingsSpec = {
  $: {
    structSpec: {
      ...
      packedSize: 88,
      fields: [
        { name: 'draw_mode_is_gpu', packedOffset: 0, packedBitOffset: 0, type: mojo.internal.Bool, nullable: false },
        { name: 'enable_early_damage_check', packedOffset: 0, packedBitOffset: 1, type: mojo.internal.Bool, nullable: false },
        { name: 'damaged_frame_limit', packedOffset: 8, packedBitOffset: 0, type: mojo.internal.Int32, nullable: false },
        { name: 'scrollbar_animator', packedOffset: 16, packedBitOffset: 0, type: cc.mojom.ScrollbarAnimatorSpec, nullable: false },
        { name: 'scrollbar_fade_delay', packedOffset: 24, packedBitOffset: 0, type: mojo_base.mojom.TimeDeltaSpec, nullable: false },
        { name: 'scrollbar_fade_duration', packedOffset: 32, packedBitOffset: 0, type: mojo_base.mojom.TimeDeltaSpec, nullable: false },
        { name: 'scrollbar_thinning_duration', packedOffset: 40, packedBitOffset: 0, type: mojo_base.mojom.TimeDeltaSpec, nullable: false },
        { name: 'idle_thickness_scale', packedOffset: 48, packedBitOffset: 0, type: mojo.internal.Float, nullable: false },
        { name: 'top_controls_show_threshold', packedOffset: 52, packedBitOffset: 0, type: mojo.internal.Float, nullable: false },
        { name: 'top_controls_hide_threshold', packedOffset: 56, packedBitOffset: 0, type: mojo.internal.Float, nullable: false },
        { name: 'minimum_occlusion_tracking_size', packedOffset: 64, packedBitOffset: 0, type: gfx.mojom.SizeSpec, nullable: false },
        { name: 'enable_edge_anti_aliasing', packedOffset: 72, packedBitOffset: 0, type: mojo.internal.Bool, nullable: false },
        { name: 'enable_backface_visibility_interop', packedOffset: 72, packedBitOffset: 1, type: mojo.internal.Bool, nullable: false },
        { name: 'enable_fluent_scrollbar', packedOffset: 72, packedBitOffset: 2, type: mojo.internal.Bool, nullable: false },
        { name: 'enable_fluent_overlay_scrollbar', packedOffset: 72, packedBitOffset: 3, type: mojo.internal.Bool, nullable: false },
      ],
      versions: [{version: 0}]
    }
  }
