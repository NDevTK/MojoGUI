  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.tracked_element.mojom.TrackedElementHandler_TrackedElementVisibilityChanged_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for TrackedElementVisibilityChanged failed with TypeError');
           }
        }
        // Try Method 1: TrackedElementActivated
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.tracked_element.mojom.TrackedElementHandler_TrackedElementActivated_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for TrackedElementActivated failed with TypeError');
           }
        }
        // Try Method 2: TrackedElementCustomEvent
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.tracked_element.mojom.TrackedElementHandler_TrackedElementCustomEvent_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for TrackedElementCustomEvent failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
