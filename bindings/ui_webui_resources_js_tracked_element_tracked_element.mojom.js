...
mojo.internal.bindings.tracked_element.mojom.TrackedElementHandlerRemote = class {
  ...
  trackedElementCanHighlightChanged(arg_native_identifier, arg_can_higlight) {
    return this.$.trackedElementCanHighlightChanged(arg_native_identifier, arg_can_higlight);
  }
  trackedElementVisibilityChanged(arg_native_identifier, arg_visible, arg_rect) {
    return this.$.trackedElementVisibilityChanged(arg_native_identifier, arg_visible, arg_rect);
  }
  trackedElementActivated(arg_native_identifier) {
    return this.$.trackedElementActivated(arg_native_identifier);
  }
  trackedElementCustomEvent(arg_native_identifier, arg_custom_event_name) {
    return this.$.trackedElementCustomEvent(arg_native_identifier, arg_custom_event_name);
  }
};
...
mojo.internal.bindings.tracked_element.mojom.TrackedElementHandlerRemoteCallHandler = class {
  ...
  trackedElementCanHighlightChanged(arg_native_identifier, arg_can_higlight) {
    return this.proxy.sendMessage(
      ...
      null,
      [arg_native_identifier, arg_can_higlight],
      false);
  }
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        ...
        case 1: {
          ...
          const result = this.impl.trackedElementCanHighlightChanged(params.arg_native_identifier, params.arg_can_higlight);
          break;
        }
        case 2: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
...
mojo.internal.bindings.tracked_element.mojom.TrackedElementManagerRemote = class {
  ...
  onElementHighlightChanged(arg_native_identifier, arg_highlighted) {
    return this.$.onElementHighlightChanged(arg_native_identifier, arg_highlighted);
  }
  clickElement(arg_native_identifier) {
    return this.$.clickElement(arg_native_identifier);
  }
  focusElement(arg_native_identifier) {
    return this.$.focusElement(arg_native_identifier);
  }
  selectTab(arg_native_identifier, arg_index) {
    return this.$.selectTab(arg_native_identifier, arg_index);
  }
  selectDropdownItem(arg_native_identifier, arg_index) {
    return this.$.selectDropdownItem(arg_native_identifier, arg_index);
  }
  enterText(arg_native_identifier, arg_text, arg_mode) {
    return this.$.enterText(arg_native_identifier, arg_text, arg_mode);
  }
  confirm(arg_native_identifier) {
    return this.$.confirm(arg_native_identifier);
  }
};
...
mojo.internal.bindings.tracked_element.mojom.TrackedElementManagerRemoteCallHandler = class {
  ...
  onElementHighlightChanged(arg_native_identifier, arg_highlighted) {
    return this.proxy.sendMessage(
      ...
      null,
      [arg_native_identifier, arg_highlighted],
      false);
  }
  ...
  selectTab(arg_native_identifier, arg_index) {
    return this.proxy.sendMessage(
      ...
      [arg_native_identifier, arg_index],
      false);
  }
  ...
  enterText(arg_native_identifier, arg_text, arg_mode) {
    return this.proxy.sendMessage(
      ...
      [arg_native_identifier, arg_text, arg_mode],
      false);
  }
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        case 0: {
          ...
          const result = this.impl.onElementHighlightChanged(params.arg_native_identifier, params.arg_highlighted);
          break;
        }
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          ...
          const result = this.impl.clickElement(params.arg_native_identifier);
        ...
        case 2: {
          ...
          const result = this.impl.focusElement(params.arg_native_identifier);
          const expectsResponse = header.expectsResponse || (header.flags & 1);
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              const val = (response && typeof response === 'object' && 'arg_success' in response) ? response['arg_success'] : response;
        ...
        case 3: {
          ...
          const result = this.impl.selectTab(params.arg_native_identifier, params.arg_index);
          const expectsResponse = header.expectsResponse || (header.flags & 1);
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              const val = (response && typeof response === 'object' && 'arg_success' in response) ? response['arg_success'] : response;
        ...
        case 4: {
          ...
          const result = this.impl.selectDropdownItem(params.arg_native_identifier, params.arg_index);
          const expectsResponse = header.expectsResponse || (header.flags & 1);
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              const val = (response && typeof response === 'object' && 'arg_success' in response) ? response['arg_success'] : response;
        ...
        case 5: {
          ...
          const result = this.impl.enterText(params.arg_native_identifier, params.arg_text, params.arg_mode);
          const expectsResponse = header.expectsResponse || (header.flags & 1);
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              const val = (response && typeof response === 'object' && 'arg_success' in response) ? response['arg_success'] : response;
        ...
        case 6: {
          ...
          const result = this.impl.confirm(params.arg_native_identifier);
          const expectsResponse = header.expectsResponse || (header.flags & 1);
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              const val = (response && typeof response === 'object' && 'arg_success' in response) ? response['arg_success'] : response;
