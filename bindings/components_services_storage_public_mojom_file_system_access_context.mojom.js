...
mojo.internal.bindings.storage.mojom.FileSystemAccessContextRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.storage.mojom.FileSystemAccessContextPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.storage.mojom.FileSystemAccessContextRemoteCallHandler(this.proxy);
  }
  ...
  serializeHandle(arg_token) {
    return this.$.serializeHandle(arg_token);
  }
  deserializeHandle(arg_storage_key, arg_bits, arg_token) {
    return this.$.deserializeHandle(arg_storage_key, arg_bits, arg_token);
  }
  clone(arg_receiever) {
    return this.$.clone(arg_receiever);
  }
};
...
mojo.internal.bindings.storage.mojom.FileSystemAccessContext.getRemote = function() {
  let remote = new mojo.internal.bindings.storage.mojom.FileSystemAccessContextRemote();
...
mojo.internal.bindings.storage.mojom.FileSystemAccessContextReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.storage.mojom.FileSystemAccessContext_SerializeHandle_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for SerializeHandle failed with TypeError');
           }
        }
        // Try Method 1: DeserializeHandle
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.storage.mojom.FileSystemAccessContext_DeserializeHandle_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for DeserializeHandle failed with TypeError');
           }
        }
        // Try Method 2: Clone
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.storage.mojom.FileSystemAccessContext_Clone_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
...
mojo.internal.bindings.storage.mojom.FileSystemAccessContextReceiver = mojo.internal.bindings.storage.mojom.FileSystemAccessContextReceiver;
