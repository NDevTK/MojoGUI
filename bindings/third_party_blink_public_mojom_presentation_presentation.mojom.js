...
mojo.internal.bindings.blink.mojom.PresentationReceiverService = mojo.internal.bindings.blink.mojom.PresentationReceiverService || {};
mojo.internal.bindings.blink.mojom.PresentationReceiverServiceSpec = mojo.internal.bindings.blink.mojom.PresentationReceiverServiceSpec || { $ : {} };
if (mojo.internal.bindings.blink.mojom.PresentationReceiverServiceSpec.$.structSpec && mojo.internal.bindings.blink.mojom.PresentationReceiverServiceSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.blink.mojom.PresentationReceiverServiceSpec.$ = {};
mojo.internal.bindings.blink.mojom.PresentationReceiverService.$interfaceName = 'blink.mojom.PresentationReceiverService';
mojo.internal.bindings.blink.mojom.PresentationReceiverService_SetReceiver_ParamsSpec = mojo.internal.bindings.blink.mojom.PresentationReceiverService_SetReceiver_ParamsSpec || { $: {} };
if (mojo.internal.bindings.blink.mojom.PresentationReceiverService_SetReceiver_ParamsSpec.$.structSpec && mojo.internal.bindings.blink.mojom.PresentationReceiverService_SetReceiver_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.blink.mojom.PresentationReceiverService_SetReceiver_ParamsSpec.$ = {};
...
// Interface: PresentationReceiverService
mojo.internal.bindings.blink.mojom.PresentationReceiverServicePendingReceiver = class {
  constructor(handle) {
    this.handle = handle;
    if (handle) {
      this.__mojoHandle = handle.router_ ? handle.router_.pipe_ : (handle.pipe_ || handle);
...
mojo.internal.bindings.blink.mojom.PresentationReceiverServiceRemote = class {
  static get $interfaceName() {
    return 'blink.mojom.PresentationReceiverService';
  }

  constructor(handle = undefined) {
    this.__mojoHandle = handle;
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.blink.mojom.PresentationReceiverServicePendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.blink.mojom.PresentationReceiverServiceRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.blink.mojom.PresentationReceiverServiceRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('blink.mojom.PresentationReceiverService', [
      { explicit: null },
    ]);
  }
  ...
  setReceiver(arg_receiver) {
    return this.proxy.sendMessage(
      this.ordinals[0],  // ordinal
      mojo.internal.bindings.blink.mojom.PresentationReceiverService_SetReceiver_ParamsSpec,
      null,
      [arg_receiver],
      false);
  }
...
mojo.internal.bindings.blink.mojom.PresentationReceiverService.getRemote = function() {
  let remote = new mojo.internal.bindings.blink.mojom.PresentationReceiverServiceRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
    'blink.mojom.PresentationReceiverService',
    'context');
  return remote.$;
};

mojo.internal.bindings.blink.mojom.PresentationReceiverServiceReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('blink.mojom.PresentationReceiverService', [
      { explicit: null },
    ]);
    ordinals.forEach((ord, idx) => {
      this.ordinalMap.set(ord, idx); // Scrambled/Explicit
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.blink.mojom.PresentationReceiverService_SetReceiver_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.blink.mojom.PresentationReceiverServiceReceiver = mojo.internal.bindings.blink.mojom.PresentationReceiverServiceReceiver;

mojo.internal.bindings.blink.mojom.PresentationReceiverServicePtr = mojo.internal.bindings.blink.mojom.PresentationReceiverServiceRemote;
mojo.internal.bindings.blink.mojom.PresentationReceiverServiceRequest = mojo.internal.bindings.blink.mojom.PresentationReceiverServicePendingReceiver;
...
mojo.internal.Struct(
    mojo.internal.bindings.blink.mojom.PresentationReceiverService_SetReceiver_ParamsSpec, 'blink.mojom.PresentationReceiverService_SetReceiver_Params', [
