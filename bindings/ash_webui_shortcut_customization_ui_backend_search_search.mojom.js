...
mojo.internal.bindings.ash.shortcut_customization.mojom.SearchResultsAvailabilityObserverRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.ash.shortcut_customization.mojom.SearchResultsAvailabilityObserverPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.ash.shortcut_customization.mojom.SearchResultsAvailabilityObserverRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.ash.shortcut_customization.mojom.SearchResultsAvailabilityObserver.getRemote = function() {
  let remote = new mojo.internal.bindings.ash.shortcut_customization.mojom.SearchResultsAvailabilityObserverRemote();
...
mojo.internal.bindings.ash.shortcut_customization.mojom.SearchResultsAvailabilityObserverReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ash.shortcut_customization.mojom.SearchResultsAvailabilityObserver_OnSearchResultsAvailabilityChanged_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OnSearchResultsAvailabilityChanged failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.ash.shortcut_customization.mojom.SearchResultsAvailabilityObserver_OnSearchResultsAvailabilityChanged_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.ash.shortcut_customization.mojom.SearchResultsAvailabilityObserverReceiver = mojo.internal.bindings.ash.shortcut_customization.mojom.SearchResultsAvailabilityObserverReceiver;

mojo.internal.bindings.ash.shortcut_customization.mojom.SearchResultsAvailabilityObserverPtr = mojo.internal.bindings.ash.shortcut_customization.mojom.SearchResultsAvailabilityObserverRemote;
mojo.internal.bindings.ash.shortcut_customization.mojom.SearchResultsAvailabilityObserverRequest = mojo.internal.bindings.ash.shortcut_customization.mojom.SearchResultsAvailabilityObserverPendingReceiver;
...
mojo.internal.bindings.ash.shortcut_customization.mojom.SearchHandlerRemote = class {
  static get $interfaceName() {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.ash.shortcut_customization.mojom.SearchHandlerPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.ash.shortcut_customization.mojom.SearchHandlerRemoteCallHandler(this.proxy);
  }
  ...
  addSearchResultsAvailabilityObserver(arg_observer) {
    return this.$.addSearchResultsAvailabilityObserver(arg_observer);
  }
};
...
mojo.internal.bindings.ash.shortcut_customization.mojom.SearchHandler.getRemote = function() {
  let remote = new mojo.internal.bindings.ash.shortcut_customization.mojom.SearchHandlerRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
...
mojo.internal.bindings.ash.shortcut_customization.mojom.SearchHandlerReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ash.shortcut_customization.mojom.SearchHandler_Search_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ash.shortcut_customization.mojom.SearchHandler_AddSearchResultsAvailabilityObserver_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for AddSearchResultsAvailabilityObserver failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
             console.warn('[GeneratedReceiver] Failed to discover ordinal ' + header.ordinal);
...
mojo.internal.bindings.ash.shortcut_customization.mojom.SearchHandlerReceiver = mojo.internal.bindings.ash.shortcut_customization.mojom.SearchHandlerReceiver;
