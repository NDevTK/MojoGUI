...
mojo.internal.bindings.device.mojom.RendererInformationSpec = mojo.internal.bindings.device.mojom.RendererInformationSpec || { $: {} };
if (mojo.internal.bindings.device.mojom.RendererInformationSpec.$.structSpec && mojo.internal.bindings.device.mojom.RendererInformationSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.device.mojom.RendererInformationSpec.$ = {};
mojo.internal.bindings.device.mojom.XRRuntimeSessionOptionsSpec = mojo.internal.bindings.device.mojom.XRRuntimeSessionOptionsSpec || { $: {} };
if (mojo.internal.bindings.device.mojom.XRRuntimeSessionOptionsSpec.$.structSpec && mojo.internal.bindings.device.mojom.XRRuntimeSessionOptionsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.device.mojom.XRRuntimeSessionOptionsSpec.$ = {};
mojo.internal.bindings.device.mojom.XRRuntimeSessionResultSpec = mojo.internal.bindings.device.mojom.XRRuntimeSessionResultSpec || { $: {} };
if (mojo.internal.bindings.device.mojom.XRRuntimeSessionResultSpec.$.structSpec && mojo.internal.bindings.device.mojom.XRRuntimeSessionResultSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.device.mojom.XRRuntimeSessionResultSpec.$ = {};
mojo.internal.bindings.device.mojom.XRDeviceDataSpec = mojo.internal.bindings.device.mojom.XRDeviceDataSpec || { $: {} };
if (mojo.internal.bindings.device.mojom.XRDeviceDataSpec.$.structSpec && mojo.internal.bindings.device.mojom.XRDeviceDataSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.device.mojom.XRDeviceDataSpec.$ = {};
mojo.internal.bindings.device.mojom.XRSessionController = mojo.internal.bindings.device.mojom.XRSessionController || {};
mojo.internal.bindings.device.mojom.XRSessionControllerSpec = mojo.internal.bindings.device.mojom.XRSessionControllerSpec || { $ : {} };
if (mojo.internal.bindings.device.mojom.XRSessionControllerSpec.$.structSpec && mojo.internal.bindings.device.mojom.XRSessionControllerSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.device.mojom.XRSessionControllerSpec.$ = {};
mojo.internal.bindings.device.mojom.XRSessionController.$interfaceName = 'device.mojom.XRSessionController';
mojo.internal.bindings.device.mojom.XRSessionController_SetFrameDataRestricted_ParamsSpec = mojo.internal.bindings.device.mojom.XRSessionController_SetFrameDataRestricted_ParamsSpec || { $: {} };
if (mojo.internal.bindings.device.mojom.XRSessionController_SetFrameDataRestricted_ParamsSpec.$.structSpec && mojo.internal.bindings.device.mojom.XRSessionController_SetFrameDataRestricted_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.device.mojom.XRSessionController_SetFrameDataRestricted_ParamsSpec.$ = {};
mojo.internal.bindings.device.mojom.XRRuntimeEventListener = mojo.internal.bindings.device.mojom.XRRuntimeEventListener || {};
mojo.internal.bindings.device.mojom.XRRuntimeEventListenerSpec = mojo.internal.bindings.device.mojom.XRRuntimeEventListenerSpec || { $ : {} };
if (mojo.internal.bindings.device.mojom.XRRuntimeEventListenerSpec.$.structSpec && mojo.internal.bindings.device.mojom.XRRuntimeEventListenerSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.device.mojom.XRRuntimeEventListenerSpec.$ = {};
mojo.internal.bindings.device.mojom.XRRuntimeEventListener.$interfaceName = 'device.mojom.XRRuntimeEventListener';
mojo.internal.bindings.device.mojom.XRRuntimeEventListener_OnVisibilityStateChanged_ParamsSpec = mojo.internal.bindings.device.mojom.XRRuntimeEventListener_OnVisibilityStateChanged_ParamsSpec || { $: {} };
if (mojo.internal.bindings.device.mojom.XRRuntimeEventListener_OnVisibilityStateChanged_ParamsSpec.$.structSpec && mojo.internal.bindings.device.mojom.XRRuntimeEventListener_OnVisibilityStateChanged_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.device.mojom.XRRuntimeEventListener_OnVisibilityStateChanged_ParamsSpec.$ = {};
mojo.internal.bindings.device.mojom.XRRuntimeEventListener_OnExitPresent_ParamsSpec = mojo.internal.bindings.device.mojom.XRRuntimeEventListener_OnExitPresent_ParamsSpec || { $: {} };
if (mojo.internal.bindings.device.mojom.XRRuntimeEventListener_OnExitPresent_ParamsSpec.$.structSpec && mojo.internal.bindings.device.mojom.XRRuntimeEventListener_OnExitPresent_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.device.mojom.XRRuntimeEventListener_OnExitPresent_ParamsSpec.$ = {};
mojo.internal.bindings.device.mojom.XRRuntime = mojo.internal.bindings.device.mojom.XRRuntime || {};
mojo.internal.bindings.device.mojom.XRRuntimeSpec = mojo.internal.bindings.device.mojom.XRRuntimeSpec || { $ : {} };
if (mojo.internal.bindings.device.mojom.XRRuntimeSpec.$.structSpec && mojo.internal.bindings.device.mojom.XRRuntimeSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.device.mojom.XRRuntimeSpec.$ = {};
mojo.internal.bindings.device.mojom.XRRuntime.$interfaceName = 'device.mojom.XRRuntime';
mojo.internal.bindings.device.mojom.XRRuntime_RequestSession_ParamsSpec = mojo.internal.bindings.device.mojom.XRRuntime_RequestSession_ParamsSpec || { $: {} };
if (mojo.internal.bindings.device.mojom.XRRuntime_RequestSession_ParamsSpec.$.structSpec && mojo.internal.bindings.device.mojom.XRRuntime_RequestSession_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.device.mojom.XRRuntime_RequestSession_ParamsSpec.$ = {};
mojo.internal.bindings.device.mojom.XRRuntime_RequestSession_ResponseParamsSpec = mojo.internal.bindings.device.mojom.XRRuntime_RequestSession_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.device.mojom.XRRuntime_RequestSession_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.device.mojom.XRRuntime_RequestSession_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.device.mojom.XRRuntime_RequestSession_ResponseParamsSpec.$ = {};
mojo.internal.bindings.device.mojom.XRRuntime_ShutdownSession_ParamsSpec = mojo.internal.bindings.device.mojom.XRRuntime_ShutdownSession_ParamsSpec || { $: {} };
if (mojo.internal.bindings.device.mojom.XRRuntime_ShutdownSession_ParamsSpec.$.structSpec && mojo.internal.bindings.device.mojom.XRRuntime_ShutdownSession_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.device.mojom.XRRuntime_ShutdownSession_ParamsSpec.$ = {};
mojo.internal.bindings.device.mojom.XRRuntime_ShutdownSession_ResponseParamsSpec = mojo.internal.bindings.device.mojom.XRRuntime_ShutdownSession_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.device.mojom.XRRuntime_ShutdownSession_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.device.mojom.XRRuntime_ShutdownSession_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.device.mojom.XRRuntime_ShutdownSession_ResponseParamsSpec.$ = {};
mojo.internal.bindings.device.mojom.XRRuntime_ListenToDeviceChanges_ParamsSpec = mojo.internal.bindings.device.mojom.XRRuntime_ListenToDeviceChanges_ParamsSpec || { $: {} };
if (mojo.internal.bindings.device.mojom.XRRuntime_ListenToDeviceChanges_ParamsSpec.$.structSpec && mojo.internal.bindings.device.mojom.XRRuntime_ListenToDeviceChanges_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.device.mojom.XRRuntime_ListenToDeviceChanges_ParamsSpec.$ = {};
mojo.internal.bindings.device.mojom.ImmersiveOverlay = mojo.internal.bindings.device.mojom.ImmersiveOverlay || {};
mojo.internal.bindings.device.mojom.ImmersiveOverlaySpec = mojo.internal.bindings.device.mojom.ImmersiveOverlaySpec || { $ : {} };
if (mojo.internal.bindings.device.mojom.ImmersiveOverlaySpec.$.structSpec && mojo.internal.bindings.device.mojom.ImmersiveOverlaySpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.device.mojom.ImmersiveOverlaySpec.$ = {};
mojo.internal.bindings.device.mojom.ImmersiveOverlay.$interfaceName = 'device.mojom.ImmersiveOverlay';
mojo.internal.bindings.device.mojom.ImmersiveOverlay_RequestNextOverlayPose_ParamsSpec = mojo.internal.bindings.device.mojom.ImmersiveOverlay_RequestNextOverlayPose_ParamsSpec || { $: {} };
if (mojo.internal.bindings.device.mojom.ImmersiveOverlay_RequestNextOverlayPose_ParamsSpec.$.structSpec && mojo.internal.bindings.device.mojom.ImmersiveOverlay_RequestNextOverlayPose_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.device.mojom.ImmersiveOverlay_RequestNextOverlayPose_ParamsSpec.$ = {};
mojo.internal.bindings.device.mojom.ImmersiveOverlay_RequestNextOverlayPose_ResponseParamsSpec = mojo.internal.bindings.device.mojom.ImmersiveOverlay_RequestNextOverlayPose_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.device.mojom.ImmersiveOverlay_RequestNextOverlayPose_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.device.mojom.ImmersiveOverlay_RequestNextOverlayPose_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.device.mojom.ImmersiveOverlay_RequestNextOverlayPose_ResponseParamsSpec.$ = {};
mojo.internal.bindings.device.mojom.ImmersiveOverlay_SubmitOverlayTexture_ParamsSpec = mojo.internal.bindings.device.mojom.ImmersiveOverlay_SubmitOverlayTexture_ParamsSpec || { $: {} };
if (mojo.internal.bindings.device.mojom.ImmersiveOverlay_SubmitOverlayTexture_ParamsSpec.$.structSpec && mojo.internal.bindings.device.mojom.ImmersiveOverlay_SubmitOverlayTexture_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.device.mojom.ImmersiveOverlay_SubmitOverlayTexture_ParamsSpec.$ = {};
mojo.internal.bindings.device.mojom.ImmersiveOverlay_SubmitOverlayTexture_ResponseParamsSpec = mojo.internal.bindings.device.mojom.ImmersiveOverlay_SubmitOverlayTexture_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.device.mojom.ImmersiveOverlay_SubmitOverlayTexture_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.device.mojom.ImmersiveOverlay_SubmitOverlayTexture_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.device.mojom.ImmersiveOverlay_SubmitOverlayTexture_ResponseParamsSpec.$ = {};
mojo.internal.bindings.device.mojom.ImmersiveOverlay_SetOverlayAndWebXRVisibility_ParamsSpec = mojo.internal.bindings.device.mojom.ImmersiveOverlay_SetOverlayAndWebXRVisibility_ParamsSpec || { $: {} };
if (mojo.internal.bindings.device.mojom.ImmersiveOverlay_SetOverlayAndWebXRVisibility_ParamsSpec.$.structSpec && mojo.internal.bindings.device.mojom.ImmersiveOverlay_SetOverlayAndWebXRVisibility_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.device.mojom.ImmersiveOverlay_SetOverlayAndWebXRVisibility_ParamsSpec.$ = {};
mojo.internal.bindings.device.mojom.ImmersiveOverlay_RequestNotificationOnWebXrSubmitted_ParamsSpec = mojo.internal.bindings.device.mojom.ImmersiveOverlay_RequestNotificationOnWebXrSubmitted_ParamsSpec || { $: {} };
if (mojo.internal.bindings.device.mojom.ImmersiveOverlay_RequestNotificationOnWebXrSubmitted_ParamsSpec.$.structSpec && mojo.internal.bindings.device.mojom.ImmersiveOverlay_RequestNotificationOnWebXrSubmitted_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.device.mojom.ImmersiveOverlay_RequestNotificationOnWebXrSubmitted_ParamsSpec.$ = {};
mojo.internal.bindings.device.mojom.ImmersiveOverlay_RequestNotificationOnWebXrSubmitted_ResponseParamsSpec = mojo.internal.bindings.device.mojom.ImmersiveOverlay_RequestNotificationOnWebXrSubmitted_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.device.mojom.ImmersiveOverlay_RequestNotificationOnWebXrSubmitted_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.device.mojom.ImmersiveOverlay_RequestNotificationOnWebXrSubmitted_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.device.mojom.ImmersiveOverlay_RequestNotificationOnWebXrSubmitted_ResponseParamsSpec.$ = {};
mojo.internal.bindings.device.mojom.IsolatedXRRuntimeProviderClient = mojo.internal.bindings.device.mojom.IsolatedXRRuntimeProviderClient || {};
mojo.internal.bindings.device.mojom.IsolatedXRRuntimeProviderClientSpec = mojo.internal.bindings.device.mojom.IsolatedXRRuntimeProviderClientSpec || { $ : {} };
if (mojo.internal.bindings.device.mojom.IsolatedXRRuntimeProviderClientSpec.$.structSpec && mojo.internal.bindings.device.mojom.IsolatedXRRuntimeProviderClientSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.device.mojom.IsolatedXRRuntimeProviderClientSpec.$ = {};
...
mojo.internal.bindings.device.mojom.IsolatedXRRuntimeProviderClient_OnDeviceAdded_ParamsSpec = mojo.internal.bindings.device.mojom.IsolatedXRRuntimeProviderClient_OnDeviceAdded_ParamsSpec || { $: {} };
if (mojo.internal.bindings.device.mojom.IsolatedXRRuntimeProviderClient_OnDeviceAdded_ParamsSpec.$.structSpec && mojo.internal.bindings.device.mojom.IsolatedXRRuntimeProviderClient_OnDeviceAdded_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.device.mojom.IsolatedXRRuntimeProviderClient_OnDeviceAdded_ParamsSpec.$ = {};
mojo.internal.bindings.device.mojom.IsolatedXRRuntimeProviderClient_OnDeviceRemoved_ParamsSpec = mojo.internal.bindings.device.mojom.IsolatedXRRuntimeProviderClient_OnDeviceRemoved_ParamsSpec || { $: {} };
if (mojo.internal.bindings.device.mojom.IsolatedXRRuntimeProviderClient_OnDeviceRemoved_ParamsSpec.$.structSpec && mojo.internal.bindings.device.mojom.IsolatedXRRuntimeProviderClient_OnDeviceRemoved_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.device.mojom.IsolatedXRRuntimeProviderClient_OnDeviceRemoved_ParamsSpec.$ = {};
mojo.internal.bindings.device.mojom.IsolatedXRRuntimeProviderClient_OnDevicesEnumerated_ParamsSpec = mojo.internal.bindings.device.mojom.IsolatedXRRuntimeProviderClient_OnDevicesEnumerated_ParamsSpec || { $: {} };
if (mojo.internal.bindings.device.mojom.IsolatedXRRuntimeProviderClient_OnDevicesEnumerated_ParamsSpec.$.structSpec && mojo.internal.bindings.device.mojom.IsolatedXRRuntimeProviderClient_OnDevicesEnumerated_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.device.mojom.IsolatedXRRuntimeProviderClient_OnDevicesEnumerated_ParamsSpec.$ = {};
mojo.internal.bindings.device.mojom.IsolatedXRRuntimeProvider = mojo.internal.bindings.device.mojom.IsolatedXRRuntimeProvider || {};
mojo.internal.bindings.device.mojom.IsolatedXRRuntimeProviderSpec = mojo.internal.bindings.device.mojom.IsolatedXRRuntimeProviderSpec || { $ : {} };
if (mojo.internal.bindings.device.mojom.IsolatedXRRuntimeProviderSpec.$.structSpec && mojo.internal.bindings.device.mojom.IsolatedXRRuntimeProviderSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.device.mojom.IsolatedXRRuntimeProviderSpec.$ = {};
mojo.internal.bindings.device.mojom.IsolatedXRRuntimeProvider.$interfaceName = 'device.mojom.IsolatedXRRuntimeProvider';
mojo.internal.bindings.device.mojom.IsolatedXRRuntimeProvider_RequestDevices_ParamsSpec = mojo.internal.bindings.device.mojom.IsolatedXRRuntimeProvider_RequestDevices_ParamsSpec || { $: {} };
if (mojo.internal.bindings.device.mojom.IsolatedXRRuntimeProvider_RequestDevices_ParamsSpec.$.structSpec && mojo.internal.bindings.device.mojom.IsolatedXRRuntimeProvider_RequestDevices_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.device.mojom.IsolatedXRRuntimeProvider_RequestDevices_ParamsSpec.$ = {};
mojo.internal.bindings.device.mojom.XRDeviceService = mojo.internal.bindings.device.mojom.XRDeviceService || {};
mojo.internal.bindings.device.mojom.XRDeviceServiceSpec = mojo.internal.bindings.device.mojom.XRDeviceServiceSpec || { $ : {} };
if (mojo.internal.bindings.device.mojom.XRDeviceServiceSpec.$.structSpec && mojo.internal.bindings.device.mojom.XRDeviceServiceSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.device.mojom.XRDeviceServiceSpec.$ = {};
mojo.internal.bindings.device.mojom.XRDeviceService.$interfaceName = 'device.mojom.XRDeviceService';
mojo.internal.bindings.device.mojom.XRDeviceService_BindRuntimeProvider_ParamsSpec = mojo.internal.bindings.device.mojom.XRDeviceService_BindRuntimeProvider_ParamsSpec || { $: {} };
if (mojo.internal.bindings.device.mojom.XRDeviceService_BindRuntimeProvider_ParamsSpec.$.structSpec && mojo.internal.bindings.device.mojom.XRDeviceService_BindRuntimeProvider_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.device.mojom.XRDeviceService_BindRuntimeProvider_ParamsSpec.$ = {};
mojo.internal.bindings.device.mojom.XRDeviceService_BindHookForTesting_ParamsSpec = mojo.internal.bindings.device.mojom.XRDeviceService_BindHookForTesting_ParamsSpec || { $: {} };
if (mojo.internal.bindings.device.mojom.XRDeviceService_BindHookForTesting_ParamsSpec.$.structSpec && mojo.internal.bindings.device.mojom.XRDeviceService_BindHookForTesting_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.device.mojom.XRDeviceService_BindHookForTesting_ParamsSpec.$ = {};
mojo.internal.bindings.device.mojom.XRDeviceServiceHost = mojo.internal.bindings.device.mojom.XRDeviceServiceHost || {};
mojo.internal.bindings.device.mojom.XRDeviceServiceHostSpec = mojo.internal.bindings.device.mojom.XRDeviceServiceHostSpec || { $ : {} };
if (mojo.internal.bindings.device.mojom.XRDeviceServiceHostSpec.$.structSpec && mojo.internal.bindings.device.mojom.XRDeviceServiceHostSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.device.mojom.XRDeviceServiceHostSpec.$ = {};
mojo.internal.bindings.device.mojom.XRDeviceServiceHost.$interfaceName = 'device.mojom.XRDeviceServiceHost';
mojo.internal.bindings.device.mojom.XRDeviceServiceHost_BindGpu_ParamsSpec = mojo.internal.bindings.device.mojom.XRDeviceServiceHost_BindGpu_ParamsSpec || { $: {} };
if (mojo.internal.bindings.device.mojom.XRDeviceServiceHost_BindGpu_ParamsSpec.$.structSpec && mojo.internal.bindings.device.mojom.XRDeviceServiceHost_BindGpu_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.device.mojom.XRDeviceServiceHost_BindGpu_ParamsSpec.$ = {};
...
mojo.internal.bindings.viz.mojom.GpuPendingReceiver = mojo.internal.bindings.viz.mojom.GpuPendingReceiver || class { constructor(handle) { this.handle = handle; } };
...
mojo.internal.bindings.device.mojom.XRSessionControllerRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('device.mojom.XRSessionController', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.device.mojom.XRSessionControllerReceiver = class {
  constructor(impl) {
    ...
    const ordinals = window.mojoScrambler.getOrdinals('device.mojom.XRSessionController', [
      { explicit: null },
    ]);
...
mojo.internal.bindings.device.mojom.XRRuntimeEventListenerRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('device.mojom.XRRuntimeEventListener', [
      { explicit: null },
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.device.mojom.XRRuntimeEventListenerReceiver = class {
  constructor(impl) {
    ...
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('device.mojom.XRRuntimeEventListener', [
      { explicit: null },
      { explicit: null },
    ]);
    ordinals.forEach((ord, idx) => {
...
mojo.internal.bindings.device.mojom.XRRuntimeRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('device.mojom.XRRuntime', [
      { explicit: null },
      { explicit: null },
      { explicit: null },
    ]);
...
mojo.internal.bindings.device.mojom.XRRuntimeReceiver = class {
  constructor(impl) {
    ...
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('device.mojom.XRRuntime', [
      { explicit: null },
      { explicit: null },
      { explicit: null },
    ]);
...
mojo.internal.bindings.device.mojom.ImmersiveOverlayRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('device.mojom.ImmersiveOverlay', [
      { explicit: null },
      { explicit: null },
      { explicit: null },
      { explicit: null },
...
mojo.internal.bindings.device.mojom.ImmersiveOverlayReceiver = class {
  constructor(impl) {
    ...
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('device.mojom.ImmersiveOverlay', [
      { explicit: null },
      { explicit: null },
      { explicit: null },
      { explicit: null },
...
mojo.internal.bindings.device.mojom.IsolatedXRRuntimeProviderClientRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('device.mojom.IsolatedXRRuntimeProviderClient', [
      { explicit: null },
      { explicit: null },
      { explicit: null },
    ]);
...
mojo.internal.bindings.device.mojom.IsolatedXRRuntimeProviderClientReceiver = class {
  constructor(impl) {
    ...
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('device.mojom.IsolatedXRRuntimeProviderClient', [
      { explicit: null },
      { explicit: null },
      { explicit: null },
    ]);
...
mojo.internal.bindings.device.mojom.IsolatedXRRuntimeProviderRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('device.mojom.IsolatedXRRuntimeProvider', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.device.mojom.IsolatedXRRuntimeProviderReceiver = class {
  constructor(impl) {
    ...
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('device.mojom.IsolatedXRRuntimeProvider', [
      { explicit: null },
    ]);
    ordinals.forEach((ord, idx) => {
      this.ordinalMap.set(ord, idx); // Scrambled/Explicit
...
mojo.internal.bindings.device.mojom.XRDeviceServiceRemote = class {
  ...
  bindHookForTesting(arg_receiver) {
    return this.$.bindHookForTesting(arg_receiver);
  }
};
...
mojo.internal.bindings.device.mojom.XRDeviceServiceRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('device.mojom.XRDeviceService', [
      { explicit: null },
      { explicit: null },
    ]);
  }
  ...
  bindHookForTesting(arg_receiver) {
    return this.proxy.sendMessage(
      this.ordinals[1],  // ordinal
      mojo.internal.bindings.device.mojom.XRDeviceService_BindHookForTesting_ParamsSpec,
      null,
      [arg_receiver],
      false);
  }
...
mojo.internal.bindings.device.mojom.XRDeviceServiceReceiver = class {
  constructor(impl) {
    ...
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('device.mojom.XRDeviceService', [
      { explicit: null },
      { explicit: null },
    ]);
    ordinals.forEach((ord, idx) => {
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        ...
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.device.mojom.XRDeviceService_BindHookForTesting_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.bindHookForTesting');
          const result = this.impl.bindHookForTesting(params.arg_receiver);
          break;
        }
      }
      } catch (err) {
...
mojo.internal.bindings.device.mojom.XRDeviceServiceHostRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('device.mojom.XRDeviceServiceHost', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.device.mojom.XRDeviceServiceHostReceiver = class {
  constructor(impl) {
    ...
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('device.mojom.XRDeviceServiceHost', [
      { explicit: null },
    ]);
    ordinals.forEach((ord, idx) => {
      this.ordinalMap.set(ord, idx); // Scrambled/Explicit
...
mojo.internal.Struct(
    mojo.internal.bindings.device.mojom.RendererInformationSpec, 'device.mojom.RendererInformation', [
      mojo.internal.StructField('arg_render_process_id', 0, 0, mojo.internal.bindings.network.mojom.RendererProcessIdSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_render_frame_id', 8, 0, mojo.internal.Int32, 0, false, 0, undefined),
    ],
    [[0, 24]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.device.mojom.XRRuntime_ListenToDeviceChanges_ParamsSpec, 'device.mojom.XRRuntime_ListenToDeviceChanges_Params', [
      mojo.internal.StructField('arg_listener', 0, 0, mojo.internal.AssociatedInterfaceProxy(mojo.internal.bindings.device.mojom.XRRuntimeEventListenerRemote), null, false, 0, undefined),
    ],
    [[0, 16]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.device.mojom.IsolatedXRRuntimeProvider_RequestDevices_ParamsSpec, 'device.mojom.IsolatedXRRuntimeProvider_RequestDevices_Params', [
      mojo.internal.StructField('arg_client', 0, 0, mojo.internal.InterfaceProxy(mojo.internal.bindings.device.mojom.IsolatedXRRuntimeProviderClientRemote), null, false, 0, undefined),
    ],
    [[0, 16]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.device.mojom.XRDeviceService_BindHookForTesting_ParamsSpec, 'device.mojom.XRDeviceService_BindHookForTesting_Params', [
      mojo.internal.StructField('arg_receiver', 0, 0, mojo.internal.Handle, null, false, 0, undefined),
    ],
    [[0, 16]]);
