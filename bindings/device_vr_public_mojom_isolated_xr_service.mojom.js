...
mojo.internal.bindings.device.mojom.XRDeviceService_BindTestHook_ParamsSpec = mojo.internal.bindings.device.mojom.XRDeviceService_BindTestHook_ParamsSpec || { $: {} };
if (mojo.internal.bindings.device.mojom.XRDeviceService_BindTestHook_ParamsSpec.$.structSpec && mojo.internal.bindings.device.mojom.XRDeviceService_BindTestHook_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.device.mojom.XRDeviceService_BindTestHook_ParamsSpec.$ = {};
...
mojo.internal.bindings.device_test.mojom.XRServiceTestHookPendingReceiver = mojo.internal.bindings.device_test.mojom.XRServiceTestHookPendingReceiver || class { constructor(handle) { this.handle = handle; } };
mojo.internal.bindings.gfx = mojo.internal.bindings.gfx || {};
...
mojo.internal.Struct(
    mojo.internal.bindings.device.mojom.XRRuntimeSessionOptionsSpec, 'device.mojom.XRRuntimeSessionOptions', [
      ...
      mojo.internal.StructField('arg_renderer_information', 24, 0, mojo.internal.bindings.device.mojom.RendererInformationSpec, null, true, 0, undefined),
