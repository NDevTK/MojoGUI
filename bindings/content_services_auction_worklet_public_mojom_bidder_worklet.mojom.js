...
auction_worklet.mojom.GenerateBidClient_OnBiddingSignalsReceived_ParamsSpec = {
  $: {
    structSpec: {
      name: 'auction_worklet.mojom.GenerateBidClient_OnBiddingSignalsReceived_Params',
      packedSize: 32,
      fields: [
...
auction_worklet.mojom.GenerateBidClient_OnGenerateBidComplete_ParamsSpec = {
  $: {
    structSpec: {
      name: 'auction_worklet.mojom.GenerateBidClient_OnGenerateBidComplete_Params',
      packedSize: 112,
      fields: [
...
auction_worklet.mojom.GenerateBidFinalizer_FinishGenerateBid_ParamsSpec = {
  $: {
    structSpec: {
      name: 'auction_worklet.mojom.GenerateBidFinalizer_FinishGenerateBid_Params',
      packedSize: 72,
      fields: [
...
auction_worklet.mojom.BidderWorklet_BeginGenerateBid_ParamsSpec = {
  $: {
    structSpec: {
      name: 'auction_worklet.mojom.BidderWorklet_BeginGenerateBid_Params',
      packedSize: 136,
      fields: [
...
auction_worklet.mojom.BidderWorklet_SendPendingSignalsRequests_ParamsSpec = {
  $: {
    structSpec: {
      name: 'auction_worklet.mojom.BidderWorklet_SendPendingSignalsRequests_Params',
      packedSize: 8,
      fields: [
      ],
...
auction_worklet.mojom.BidderWorklet_ReportWin_ParamsSpec = {
  $: {
    structSpec: {
      name: 'auction_worklet.mojom.BidderWorklet_ReportWin_Params',
      packedSize: 200,
      fields: [
...
auction_worklet.mojom.BidderWorklet_ConnectDevToolsAgent_ParamsSpec = {
  $: {
    structSpec: {
      name: 'auction_worklet.mojom.BidderWorklet_ConnectDevToolsAgent_Params',
      packedSize: 24,
      fields: [
