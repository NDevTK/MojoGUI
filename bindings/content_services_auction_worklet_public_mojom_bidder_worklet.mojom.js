...
auction_worklet.mojom.GenerateBidClientPtr = class {
  ...
  onGenerateBidComplete() {
    ...
    // Call: OnGenerateBidComplete()
  }

  onBiddingSignalsReceived() {
    // Method: OnBiddingSignalsReceived
    // Call: OnBiddingSignalsReceived()
  }
  ...
  kUnenforcedKAnon(done) {
    // Method: kUnenforcedKAnon
    // Call: kUnenforcedKAnon(done)
  }
...
auction_worklet.mojom.BidderWorkletPtr = class {
  ...
  reportAdditionalBidWin() {
    // Method: reportAdditionalBidWin
    // Call: reportAdditionalBidWin()
  }
  ...
  reportAggregateWin() {
    // Method: reportAggregateWin
    // Call: reportAggregateWin()
  }
