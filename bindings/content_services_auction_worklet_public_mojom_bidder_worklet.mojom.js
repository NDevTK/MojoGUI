...
mojo.internal.Struct(
    auction_worklet.mojom.BidderWorkletBidSpec, 'auction_worklet.mojom.BidderWorkletBid', [
      mojo.internal.StructField('bid_role', 72, 0, auction_worklet.mojom.BidRoleSpec, null, false, 0, undefined),
      ...
      mojo.internal.StructField('ad_cost_$flag', 78, 0, mojo.internal.Bool, false, false, 0, { isPrimary: true, linkedValueFieldName: 'ad_cost_$value', originalFieldName: 'ad_cost' }),
      mojo.internal.StructField('ad_cost_$value', 24, 0, mojo.internal.Double, 0, false, 0, { isPrimary: false, linkedValueFieldName: 'ad_cost_$flag', originalFieldName: 'ad_cost' }),
      mojo.internal.StructField('ad_descriptor', 32, 0, blink.mojom.AdDescriptorSpec, null, false, 0, undefined),
      mojo.internal.StructField('selected_buyer_and_seller_reporting_id', 40, 0, mojo.internal.String, null, true, 0, undefined),
      mojo.internal.StructField('ad_component_descriptors', 48, 0, mojo.internal.Array(blink.mojom.AdDescriptorSpec, false), null, true, 0, undefined),
      mojo.internal.StructField('modeling_signals_$flag', 78, 1, mojo.internal.Bool, false, false, 0, { isPrimary: true, linkedValueFieldName: 'modeling_signals_$value', originalFieldName: 'modeling_signals' }),
      mojo.internal.StructField('modeling_signals_$value', 76, 0, mojo.internal.Uint16, 0, false, 0, { isPrimary: false, linkedValueFieldName: 'modeling_signals_$flag', originalFieldName: 'modeling_signals' }),
      mojo.internal.StructField('aggregate_win_signals', 56, 0, mojo.internal.String, null, true, 0, undefined),
      mojo.internal.StructField('bid_duration', 64, 0, mojo_base.mojom.TimeDeltaSpec, null, false, 0, undefined),
    ],
    [[0, 88]]);
...
mojo.internal.Struct(
    auction_worklet.mojom.PrivateModelTrainingRequestDataSpec, 'auction_worklet.mojom.PrivateModelTrainingRequestData', [
      ...
      mojo.internal.StructField('payload_length', 32, 0, mojo.internal.Uint32, 0, false, 0, undefined),
      mojo.internal.StructField('aggregation_coordinator_origin', 16, 0, url.mojom.UrlSpec, null, false, 0, undefined),
      mojo.internal.StructField('destination', 24, 0, url.mojom.UrlSpec, null, false, 0, undefined),
    ],
    [[0, 48]]);
...
mojo.internal.Struct(
    auction_worklet.mojom.GenerateBidClient_OnGenerateBidComplete_ParamsSpec, 'auction_worklet.mojom.GenerateBidClient_OnGenerateBidComplete_Params', [
      ...
      mojo.internal.StructField('bidding_signals_data_version_$flag', 96, 0, mojo.internal.Bool, false, false, 0, { isPrimary: true, linkedValueFieldName: 'bidding_signals_data_version_$value', originalFieldName: 'bidding_signals_data_version' }),
      mojo.internal.StructField('bidding_signals_data_version_$value', 88, 0, mojo.internal.Uint32, 0, false, 0, { isPrimary: false, linkedValueFieldName: 'bidding_signals_data_version_$flag', originalFieldName: 'bidding_signals_data_version' }),
      ...
      mojo.internal.StructField('set_priority_$flag', 96, 1, mojo.internal.Bool, false, false, 0, { isPrimary: true, linkedValueFieldName: 'set_priority_$value', originalFieldName: 'set_priority' }),
      ...
      mojo.internal.StructField('reject_reason', 92, 0, auction_worklet.mojom.RejectReasonSpec, null, false, 0, undefined),
...
mojo.internal.Struct(
    auction_worklet.mojom.BidderWorklet_BeginGenerateBid_ParamsSpec, 'auction_worklet.mojom.BidderWorklet_BeginGenerateBid_Params', [
      ...
      mojo.internal.StructField('kanon_mode', 120, 0, auction_worklet.mojom.KAnonymityBidModeSpec, null, false, 0, undefined),
      mojo.internal.StructField('interest_group_join_origin', 16, 0, url.mojom.OriginSpec, null, false, 0, undefined),
      mojo.internal.StructField('direct_from_seller_per_buyer_signals', 24, 0, url.mojom.UrlSpec, null, true, 0, undefined),
      mojo.internal.StructField('direct_from_seller_auction_signals', 32, 0, url.mojom.UrlSpec, null, true, 0, undefined),
      mojo.internal.StructField('browser_signal_seller_origin', 40, 0, url.mojom.OriginSpec, null, false, 0, undefined),
      mojo.internal.StructField('browser_signal_top_level_seller_origin', 48, 0, url.mojom.OriginSpec, null, true, 0, undefined),
      mojo.internal.StructField('browser_signal_recency', 56, 0, mojo_base.mojom.TimeDeltaSpec, null, false, 0, undefined),
      mojo.internal.StructField('browser_signal_for_debugging_only_sampling', 126, 0, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('bidding_browser_signals', 64, 0, blink.mojom.BiddingBrowserSignalsSpec, null, false, 0, undefined),
      mojo.internal.StructField('auction_start_time', 72, 0, mojo_base.mojom.TimeSpec, null, false, 0, undefined),
      mojo.internal.StructField('requested_ad_size', 80, 0, blink.mojom.AdSizeSpec, null, true, 0, undefined),
      mojo.internal.StructField('multi_bid_limit', 124, 0, mojo.internal.Uint16, 0, false, 0, undefined),
      mojo.internal.StructField('group_by_origin_id', 88, 0, mojo.internal.Uint64, 0, false, 0, undefined),
      mojo.internal.StructField('trace_id', 96, 0, mojo.internal.Uint64, 0, false, 0, undefined),
      mojo.internal.StructField('generate_bid_client', 104, 0, mojo.internal.AssociatedInterfaceProxy(auction_worklet.mojom.GenerateBidClientRemote), null, false, 0, undefined),
      mojo.internal.StructField('bid_finalizer', 112, 0, mojo.internal.AssociatedInterfaceRequest(auction_worklet.mojom.GenerateBidFinalizerRemote), null, false, 0, undefined),
    ],
    [[0, 136]]);
...
mojo.internal.Struct(
    auction_worklet.mojom.BidderWorklet_ReportWin_ParamsSpec, 'auction_worklet.mojom.BidderWorklet_ReportWin_Params', [
      mojo.internal.StructField('is_for_additional_bid', 186, 0, mojo.internal.Bool, false, false, 0, undefined),
      ...
      mojo.internal.StructField('kanon_status', 176, 0, auction_worklet.mojom.KAnonymityStatusSpec, null, false, 0, undefined),
      mojo.internal.StructField('browser_signal_render_url', 88, 0, url.mojom.UrlSpec, null, false, 0, undefined),
      mojo.internal.StructField('browser_signal_bid', 96, 0, mojo.internal.Double, 0, false, 0, undefined),
      mojo.internal.StructField('browser_signal_bid_currency', 104, 0, blink.mojom.AdCurrencySpec, null, true, 0, undefined),
      ...
      mojo.internal.StructField('browser_signal_made_highest_scoring_other_bid', 186, 1, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('browser_signal_ad_cost_$flag', 186, 2, mojo.internal.Bool, false, false, 0, { isPrimary: true, linkedValueFieldName: 'browser_signal_ad_cost_$value', originalFieldName: 'browser_signal_ad_cost' }),
      mojo.internal.StructField('browser_signal_ad_cost_$value', 128, 0, mojo.internal.Double, 0, false, 0, { isPrimary: false, linkedValueFieldName: 'browser_signal_ad_cost_$flag', originalFieldName: 'browser_signal_ad_cost' }),
      mojo.internal.StructField('browser_signal_modeling_signals_$flag', 186, 3, mojo.internal.Bool, false, false, 0, { isPrimary: true, linkedValueFieldName: 'browser_signal_modeling_signals_$value', originalFieldName: 'browser_signal_modeling_signals' }),
      mojo.internal.StructField('browser_signal_modeling_signals_$value', 184, 0, mojo.internal.Uint16, 0, false, 0, { isPrimary: false, linkedValueFieldName: 'browser_signal_modeling_signals_$flag', originalFieldName: 'browser_signal_modeling_signals' }),
      mojo.internal.StructField('browser_signal_join_count', 187, 0, mojo.internal.Uint8, 0, false, 0, undefined),
      mojo.internal.StructField('browser_signal_recency', 188, 0, mojo.internal.Uint8, 0, false, 0, undefined),
      mojo.internal.StructField('browser_signal_seller_origin', 136, 0, url.mojom.OriginSpec, null, false, 0, undefined),
      mojo.internal.StructField('browser_signal_top_level_seller_origin', 144, 0, url.mojom.OriginSpec, null, true, 0, undefined),
      mojo.internal.StructField('browser_signal_reporting_timeout', 152, 0, mojo_base.mojom.TimeDeltaSpec, null, true, 0, undefined),
      mojo.internal.StructField('bidding_signals_data_version_$flag', 186, 4, mojo.internal.Bool, false, false, 0, { isPrimary: true, linkedValueFieldName: 'bidding_signals_data_version_$value', originalFieldName: 'bidding_signals_data_version' }),
      mojo.internal.StructField('bidding_signals_data_version_$value', 180, 0, mojo.internal.Uint32, 0, false, 0, { isPrimary: false, linkedValueFieldName: 'bidding_signals_data_version_$flag', originalFieldName: 'bidding_signals_data_version' }),
      mojo.internal.StructField('aggregate_win_signals', 160, 0, mojo.internal.String, null, true, 0, undefined),
