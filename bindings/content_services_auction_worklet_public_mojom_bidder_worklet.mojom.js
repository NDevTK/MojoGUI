  ...
  $: {
    structSpec: {
      ...
      fields: [
        ...
        { name: 'execution_mode', packedOffset: 24, packedBitOffset: 0, type: blink.mojom.InterestGroup.ExecutionModeSpec, nullable: false },
        { name: 'update_url', packedOffset: 32, packedBitOffset: 0, type: url.mojom.UrlSpec, nullable: true },
  ...
  $: {
    structSpec: {
      ...
      fields: [
        ...
        { name: 'bid_duration', packedOffset: 72, packedBitOffset: 0, type: mojo_base.mojom.TimeDeltaSpec, nullable: false },
  ...
  $: {
    structSpec: {
      ...
      fields: [
        ...
        { name: 'aggregation_coordinator_origin', packedOffset: 8, packedBitOffset: 0, type: url.mojom.UrlSpec, nullable: false },
        { name: 'destination', packedOffset: 16, packedBitOffset: 0, type: url.mojom.UrlSpec, nullable: false },
  ...
  $: {
    structSpec: {
      ...
      fields: [
        ...
        { name: 'debug_loss_report_url', packedOffset: 8, packedBitOffset: 0, type: url.mojom.UrlSpec, nullable: true },
        { name: 'debug_win_report_url', packedOffset: 16, packedBitOffset: 0, type: url.mojom.UrlSpec, nullable: true },
        { name: 'set_priority', packedOffset: 24, packedBitOffset: 0, type: mojo.internal.Double, nullable: true },
        { name: 'update_priority_signals_overrides', packedOffset: 32, packedBitOffset: 0, type: mojo.internal.Map, nullable: true },
        { name: 'pa_requests', packedOffset: 40, packedBitOffset: 0, type: mojo.internal.Array, nullable: false },
        { name: 'non_kanon_pa_requests', packedOffset: 48, packedBitOffset: 0, type: mojo.internal.Array, nullable: false },
  ...
  $: {
    structSpec: {
      ...
      fields: [
        ...
        { name: 'bidding_browser_signals', packedOffset: 72, packedBitOffset: 0, type: blink.mojom.BiddingBrowserSignalsSpec, nullable: false },
        { name: 'auction_start_time', packedOffset: 80, packedBitOffset: 0, type: mojo_base.mojom.TimeSpec, nullable: false },
        { name: 'requested_ad_size', packedOffset: 88, packedBitOffset: 0, type: blink.mojom.AdSizeSpec, nullable: true },
        { name: 'group_by_origin_id', packedOffset: 96, packedBitOffset: 0, type: mojo.internal.Uint64, nullable: false },
        { name: 'trace_id', packedOffset: 104, packedBitOffset: 0, type: mojo.internal.Uint64, nullable: false },
        { name: 'generate_bid_client', packedOffset: 112, packedBitOffset: 0, type: mojo.internal.AssociatedInterfaceProxy, nullable: false },
        { name: 'bid_finalizer', packedOffset: 116, packedBitOffset: 0, type: mojo.internal.AssociatedInterfaceRequest, nullable: false },
        { name: 'multi_bid_limit', packedOffset: 120, packedBitOffset: 0, type: mojo.internal.Uint16, nullable: false },
        { name: 'browser_signal_for_debugging_only_sampling', packedOffset: 122, packedBitOffset: 0, type: mojo.internal.Bool, nullable: false },
      ],
      versions: [{version: 0}]
    }
  }
...
auction_worklet.mojom.BidderWorklet_ReportWin_ParamsSpec = {
  $: {
    structSpec: {
      ...
      packedSize: 208,
      fields: [
        { name: 'interest_group_name_reporting_id', packedOffset: 0, packedBitOffset: 0, type: mojo.internal.String, nullable: true },
        { name: 'buyer_reporting_id', packedOffset: 8, packedBitOffset: 0, type: mojo.internal.String, nullable: true },
        { name: 'buyer_and_seller_reporting_id', packedOffset: 16, packedBitOffset: 0, type: mojo.internal.String, nullable: true },
        { name: 'selected_buyer_and_seller_reporting_id', packedOffset: 24, packedBitOffset: 0, type: mojo.internal.String, nullable: true },
        { name: 'auction_signals_json', packedOffset: 32, packedBitOffset: 0, type: mojo.internal.String, nullable: true },
        { name: 'per_buyer_signals_json', packedOffset: 40, packedBitOffset: 0, type: mojo.internal.String, nullable: true },
        { name: 'direct_from_seller_per_buyer_signals', packedOffset: 48, packedBitOffset: 0, type: url.mojom.UrlSpec, nullable: true },
        { name: 'direct_from_seller_per_buyer_signals_header_ad_slot', packedOffset: 56, packedBitOffset: 0, type: mojo.internal.String, nullable: true },
        { name: 'direct_from_seller_auction_signals', packedOffset: 64, packedBitOffset: 0, type: url.mojom.UrlSpec, nullable: true },
        { name: 'direct_from_seller_auction_signals_header_ad_slot', packedOffset: 72, packedBitOffset: 0, type: mojo.internal.String, nullable: true },
        { name: 'seller_signals_json', packedOffset: 80, packedBitOffset: 0, type: mojo.internal.String, nullable: false },
        { name: 'kanon_status', packedOffset: 88, packedBitOffset: 0, type: auction_worklet.mojom.KAnonymityStatusSpec, nullable: false },
        { name: 'browser_signal_render_url', packedOffset: 96, packedBitOffset: 0, type: url.mojom.UrlSpec, nullable: false },
        { name: 'browser_signal_bid', packedOffset: 104, packedBitOffset: 0, type: mojo.internal.Double, nullable: false },
        { name: 'browser_signal_bid_currency', packedOffset: 112, packedBitOffset: 0, type: blink.mojom.AdCurrencySpec, nullable: true },
        { name: 'browser_signal_highest_scoring_other_bid', packedOffset: 120, packedBitOffset: 0, type: mojo.internal.Double, nullable: false },
        { name: 'browser_signal_highest_scoring_other_bid_currency', packedOffset: 128, packedBitOffset: 0, type: blink.mojom.AdCurrencySpec, nullable: true },
        { name: 'browser_signal_ad_cost', packedOffset: 136, packedBitOffset: 0, type: mojo.internal.Double, nullable: true },
        { name: 'browser_signal_seller_origin', packedOffset: 144, packedBitOffset: 0, type: url.mojom.OriginSpec, nullable: false },
        { name: 'browser_signal_top_level_seller_origin', packedOffset: 152, packedBitOffset: 0, type: url.mojom.OriginSpec, nullable: true },
        { name: 'browser_signal_reporting_timeout', packedOffset: 160, packedBitOffset: 0, type: mojo_base.mojom.TimeDeltaSpec, nullable: true },
        { name: 'aggregate_win_signals', packedOffset: 168, packedBitOffset: 0, type: mojo.internal.String, nullable: true },
        { name: 'trace_id', packedOffset: 176, packedBitOffset: 0, type: mojo.internal.Uint64, nullable: false },
        { name: 'bidding_signals_data_version', packedOffset: 184, packedBitOffset: 0, type: mojo.internal.Uint32, nullable: true },
        { name: 'browser_signal_modeling_signals', packedOffset: 188, packedBitOffset: 0, type: mojo.internal.Uint16, nullable: true },
        { name: 'browser_signal_join_count', packedOffset: 190, packedBitOffset: 0, type: mojo.internal.Uint8, nullable: false },
        { name: 'browser_signal_recency', packedOffset: 191, packedBitOffset: 0, type: mojo.internal.Uint8, nullable: false },
        { name: 'is_for_additional_bid', packedOffset: 192, packedBitOffset: 0, type: mojo.internal.Bool, nullable: false },
        { name: 'browser_signal_made_highest_scoring_other_bid', packedOffset: 192, packedBitOffset: 1, type: mojo.internal.Bool, nullable: false },
      ],
      versions: [{version: 0}]
    }
  }
