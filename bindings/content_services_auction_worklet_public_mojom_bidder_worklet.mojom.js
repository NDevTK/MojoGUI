  ...
  $: {
    structSpec: {
      ...
      fields: [
        ...
        { name: 'trusted_bidding_signals_slot_size_mode', packedOffset: 8, packedBitOffset: 0, type: blink.mojom.InterestGroup.TrustedBiddingSignalsSlotSizeModeSpec, nullable: false },
        { name: 'enable_bidding_signals_prioritization', packedOffset: 16, packedBitOffset: 0, type: mojo.internal.Bool, nullable: false },
        { name: 'priority_vector', packedOffset: 24, packedBitOffset: 0, type: mojo.internal.Map, nullable: true },
        { name: 'execution_mode', packedOffset: 32, packedBitOffset: 0, type: blink.mojom.InterestGroup.ExecutionModeSpec, nullable: false },
        { name: 'update_url', packedOffset: 40, packedBitOffset: 0, type: url.mojom.UrlSpec, nullable: true },
        { name: 'trusted_bidding_signals_keys', packedOffset: 48, packedBitOffset: 0, type: mojo.internal.Array, nullable: true },
        { name: 'max_trusted_bidding_signals_url_length', packedOffset: 56, packedBitOffset: 0, type: mojo.internal.Int32, nullable: false },
        { name: 'user_bidding_signals', packedOffset: 64, packedBitOffset: 0, type: mojo.internal.String, nullable: true },
        { name: 'ads', packedOffset: 72, packedBitOffset: 0, type: mojo.internal.Array, nullable: true },
        { name: 'ad_components', packedOffset: 80, packedBitOffset: 0, type: mojo.internal.Array, nullable: true },
        { name: 'kanon_keys', packedOffset: 88, packedBitOffset: 0, type: mojo.internal.Array, nullable: false },
      ],
      versions: [{version: 0}]
    }
  }
...
auction_worklet.mojom.BidderWorkletBidSpec = {
  $: {
    structSpec: {
      ...
      packedSize: 96,
      fields: [
        { name: 'bid_role', packedOffset: 0, packedBitOffset: 0, type: auction_worklet.mojom.BidRoleSpec, nullable: false },
        ...
        { name: 'ad_descriptor', packedOffset: 40, packedBitOffset: 0, type: blink.mojom.AdDescriptorSpec, nullable: false },
        ...
        { name: 'modeling_signals', packedOffset: 64, packedBitOffset: 0, type: mojo.internal.Uint16, nullable: true },
        { name: 'aggregate_win_signals', packedOffset: 72, packedBitOffset: 0, type: mojo.internal.String, nullable: true },
        { name: 'bid_duration', packedOffset: 80, packedBitOffset: 0, type: mojo_base.mojom.TimeDeltaSpec, nullable: false },
      ],
      versions: [{version: 0}]
    }
  }
  ...
  $: {
    structSpec: {
      ...
      fields: [
        ...
        { name: 'config_promises_latency', packedOffset: 8, packedBitOffset: 0, type: mojo_base.mojom.TimeDeltaSpec, nullable: true },
        ...
        { name: 'trusted_bidding_signals_latency', packedOffset: 24, packedBitOffset: 0, type: mojo_base.mojom.TimeDeltaSpec, nullable: true },
        { name: 'deps_wait_start_time', packedOffset: 32, packedBitOffset: 0, type: mojo_base.mojom.TimeTicksSpec, nullable: false },
        { name: 'generate_bid_start_time', packedOffset: 40, packedBitOffset: 0, type: mojo_base.mojom.TimeTicksSpec, nullable: false },
        { name: 'generate_bid_finish_time', packedOffset: 48, packedBitOffset: 0, type: mojo_base.mojom.TimeTicksSpec, nullable: false },
      ],
      versions: [{version: 0}]
    }
  }
  ...
  $: {
    structSpec: {
      ...
      fields: [
        ...
        { name: 'wasm_fetch_latency', packedOffset: 8, packedBitOffset: 0, type: mojo_base.mojom.TimeDeltaSpec, nullable: true },
...
auction_worklet.mojom.PrivateModelTrainingRequestDataSpec = {
  $: {
    structSpec: {
      ...
      packedSize: 40,
      fields: [
        { name: 'payload', packedOffset: 0, packedBitOffset: 0, type: mojo_base.mojom.BigBufferSpec, nullable: false },
        { name: 'payload_length', packedOffset: 8, packedBitOffset: 0, type: mojo.internal.Uint32, nullable: false },
        { name: 'aggregation_coordinator_origin', packedOffset: 16, packedBitOffset: 0, type: url.mojom.UrlSpec, nullable: false },
        { name: 'destination', packedOffset: 24, packedBitOffset: 0, type: url.mojom.UrlSpec, nullable: false },
      ],
      versions: [{version: 0}]
    }
  }
...
auction_worklet.mojom.GenerateBidClient_OnBiddingSignalsReceived_ParamsSpec = {
  $: {
    structSpec: {
      ...
      packedSize: 32,
      fields: [
        { name: 'priority_vector', packedOffset: 0, packedBitOffset: 0, type: mojo.internal.Map, nullable: false },
        { name: 'trusted_signals_fetch_latency', packedOffset: 8, packedBitOffset: 0, type: mojo_base.mojom.TimeDeltaSpec, nullable: false },
        { name: 'update_if_older_than', packedOffset: 16, packedBitOffset: 0, type: mojo_base.mojom.TimeDeltaSpec, nullable: true },
      ],
      versions: [{version: 0}]
    }
  }
...
auction_worklet.mojom.GenerateBidClient_OnGenerateBidComplete_ParamsSpec = {
  $: {
    structSpec: {
      ...
      packedSize: 112,
      fields: [
        { name: 'bids', packedOffset: 0, packedBitOffset: 0, type: mojo.internal.Array, nullable: false },
        { name: 'bidding_signals_data_version', packedOffset: 8, packedBitOffset: 0, type: mojo.internal.Uint32, nullable: true },
        { name: 'debug_loss_report_url', packedOffset: 16, packedBitOffset: 0, type: url.mojom.UrlSpec, nullable: true },
        { name: 'debug_win_report_url', packedOffset: 24, packedBitOffset: 0, type: url.mojom.UrlSpec, nullable: true },
        { name: 'set_priority', packedOffset: 32, packedBitOffset: 0, type: mojo.internal.Double, nullable: true },
        { name: 'update_priority_signals_overrides', packedOffset: 40, packedBitOffset: 0, type: mojo.internal.Map, nullable: true },
        { name: 'pa_requests', packedOffset: 48, packedBitOffset: 0, type: mojo.internal.Array, nullable: false },
        { name: 'non_kanon_pa_requests', packedOffset: 56, packedBitOffset: 0, type: mojo.internal.Array, nullable: false },
        { name: 'real_time_contributions', packedOffset: 64, packedBitOffset: 0, type: mojo.internal.Array, nullable: false },
        { name: 'generate_bid_timing_metrics', packedOffset: 72, packedBitOffset: 0, type: auction_worklet.mojom.BidderTimingMetricsSpec, nullable: false },
        { name: 'generate_bid_dependency_latencies', packedOffset: 80, packedBitOffset: 0, type: auction_worklet.mojom.GenerateBidDependencyLatenciesSpec, nullable: false },
        { name: 'reject_reason', packedOffset: 88, packedBitOffset: 0, type: auction_worklet.mojom.RejectReasonSpec, nullable: false },
  ...
  $: {
    structSpec: {
      ...
      fields: [
        ...
        { name: 'per_buyer_timeout', packedOffset: 16, packedBitOffset: 0, type: mojo_base.mojom.TimeDeltaSpec, nullable: true },
        { name: 'expected_buyer_currency', packedOffset: 24, packedBitOffset: 0, type: blink.mojom.AdCurrencySpec, nullable: true },
  ...
  $: {
    structSpec: {
      ...
      fields: [
        ...
        { name: 'direct_from_seller_per_buyer_signals', packedOffset: 32, packedBitOffset: 0, type: url.mojom.UrlSpec, nullable: true },
        { name: 'direct_from_seller_auction_signals', packedOffset: 40, packedBitOffset: 0, type: url.mojom.UrlSpec, nullable: true },
        { name: 'browser_signal_seller_origin', packedOffset: 48, packedBitOffset: 0, type: url.mojom.OriginSpec, nullable: false },
        { name: 'browser_signal_top_level_seller_origin', packedOffset: 56, packedBitOffset: 0, type: url.mojom.OriginSpec, nullable: true },
        { name: 'browser_signal_recency', packedOffset: 64, packedBitOffset: 0, type: mojo_base.mojom.TimeDeltaSpec, nullable: false },
        { name: 'browser_signal_for_debugging_only_sampling', packedOffset: 72, packedBitOffset: 0, type: mojo.internal.Bool, nullable: false },
        { name: 'bidding_browser_signals', packedOffset: 80, packedBitOffset: 0, type: blink.mojom.BiddingBrowserSignalsSpec, nullable: false },
        { name: 'auction_start_time', packedOffset: 88, packedBitOffset: 0, type: mojo_base.mojom.TimeSpec, nullable: false },
        { name: 'requested_ad_size', packedOffset: 96, packedBitOffset: 0, type: blink.mojom.AdSizeSpec, nullable: true },
        { name: 'multi_bid_limit', packedOffset: 104, packedBitOffset: 0, type: mojo.internal.Uint16, nullable: false },
        { name: 'group_by_origin_id', packedOffset: 112, packedBitOffset: 0, type: mojo.internal.Uint64, nullable: false },
        { name: 'trace_id', packedOffset: 120, packedBitOffset: 0, type: mojo.internal.Uint64, nullable: false },
        { name: 'generate_bid_client', packedOffset: 128, packedBitOffset: 0, type: mojo.internal.AssociatedInterfaceProxy, nullable: false },
        { name: 'bid_finalizer', packedOffset: 132, packedBitOffset: 0, type: mojo.internal.AssociatedInterfaceRequest, nullable: false },
      ],
      versions: [{version: 0}]
    }
  }
...
auction_worklet.mojom.BidderWorklet_ReportWin_ParamsSpec = {
  $: {
    structSpec: {
      ...
      packedSize: 224,
      fields: [
        { name: 'is_for_additional_bid', packedOffset: 0, packedBitOffset: 0, type: mojo.internal.Bool, nullable: false },
        ...
        { name: 'direct_from_seller_per_buyer_signals', packedOffset: 56, packedBitOffset: 0, type: url.mojom.UrlSpec, nullable: true },
        ...
        { name: 'seller_signals_json', packedOffset: 88, packedBitOffset: 0, type: mojo.internal.String, nullable: false },
        { name: 'kanon_status', packedOffset: 96, packedBitOffset: 0, type: auction_worklet.mojom.KAnonymityStatusSpec, nullable: false },
        { name: 'browser_signal_render_url', packedOffset: 104, packedBitOffset: 0, type: url.mojom.UrlSpec, nullable: false },
        { name: 'browser_signal_bid', packedOffset: 112, packedBitOffset: 0, type: mojo.internal.Double, nullable: false },
        { name: 'browser_signal_bid_currency', packedOffset: 120, packedBitOffset: 0, type: blink.mojom.AdCurrencySpec, nullable: true },
        { name: 'browser_signal_highest_scoring_other_bid', packedOffset: 128, packedBitOffset: 0, type: mojo.internal.Double, nullable: false },
        { name: 'browser_signal_highest_scoring_other_bid_currency', packedOffset: 136, packedBitOffset: 0, type: blink.mojom.AdCurrencySpec, nullable: true },
        { name: 'browser_signal_made_highest_scoring_other_bid', packedOffset: 144, packedBitOffset: 0, type: mojo.internal.Bool, nullable: false },
        { name: 'browser_signal_ad_cost', packedOffset: 152, packedBitOffset: 0, type: mojo.internal.Double, nullable: true },
        { name: 'browser_signal_modeling_signals', packedOffset: 160, packedBitOffset: 0, type: mojo.internal.Uint16, nullable: true },
        { name: 'browser_signal_join_count', packedOffset: 162, packedBitOffset: 0, type: mojo.internal.Uint8, nullable: false },
        { name: 'browser_signal_recency', packedOffset: 163, packedBitOffset: 0, type: mojo.internal.Uint8, nullable: false },
        { name: 'browser_signal_seller_origin', packedOffset: 168, packedBitOffset: 0, type: url.mojom.OriginSpec, nullable: false },
        { name: 'browser_signal_top_level_seller_origin', packedOffset: 176, packedBitOffset: 0, type: url.mojom.OriginSpec, nullable: true },
        { name: 'browser_signal_reporting_timeout', packedOffset: 184, packedBitOffset: 0, type: mojo_base.mojom.TimeDeltaSpec, nullable: true },
        { name: 'bidding_signals_data_version', packedOffset: 192, packedBitOffset: 0, type: mojo.internal.Uint32, nullable: true },
        { name: 'aggregate_win_signals', packedOffset: 200, packedBitOffset: 0, type: mojo.internal.String, nullable: true },
        { name: 'trace_id', packedOffset: 208, packedBitOffset: 0, type: mojo.internal.Uint64, nullable: false },
      ],
      versions: [{version: 0}]
    }
  }
...
auction_worklet.mojom.BidderWorklet_ReportWin_ResponseParamsSpec = {
  $: {
    structSpec: {
      ...
      packedSize: 64,
      fields: [
        { name: 'report_url', packedOffset: 0, packedBitOffset: 0, type: url.mojom.UrlSpec, nullable: true },
        { name: 'ad_beacon_map', packedOffset: 8, packedBitOffset: 0, type: mojo.internal.Map, nullable: false },
        { name: 'ad_macro_map', packedOffset: 16, packedBitOffset: 0, type: mojo.internal.Map, nullable: false },
        { name: 'pa_requests', packedOffset: 24, packedBitOffset: 0, type: mojo.internal.Array, nullable: false },
        { name: 'pmt_request_data', packedOffset: 32, packedBitOffset: 0, type: auction_worklet.mojom.PrivateModelTrainingRequestDataSpec, nullable: true },
        { name: 'timing_metrics', packedOffset: 40, packedBitOffset: 0, type: auction_worklet.mojom.BidderTimingMetricsSpec, nullable: false },
