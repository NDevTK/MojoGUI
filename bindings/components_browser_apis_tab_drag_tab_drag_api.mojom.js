...
mojo.internal.bindings.tabs_api.mojom.TabDragServiceRemote = class {
  ...
  startDrag(arg_node_ids, arg_start_point) {
    return this.$.startDrag(arg_node_ids, arg_start_point);
  }
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        case 0: {
          ...
          const result = this.impl.startDrag(params.arg_node_ids, params.arg_start_point);
          break;
        }
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
...
mojo.internal.bindings.tabs_api.mojom.DropTargetRemote = class {
  ...
  onDragEntered(arg_source_tab_ids, arg_local_point) {
    return this.$.onDragEntered(arg_source_tab_ids, arg_local_point);
  }
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        case 0: {
          ...
          const result = this.impl.onDragEntered(params.arg_source_tab_ids, params.arg_local_point);
          break;
        }
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
