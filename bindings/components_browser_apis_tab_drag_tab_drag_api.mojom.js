...
mojo.internal.bindings.tabs_api.mojom.DropTarget_GetBounds_ParamsSpec = mojo.internal.bindings.tabs_api.mojom.DropTarget_GetBounds_ParamsSpec || { $: {} };
if (mojo.internal.bindings.tabs_api.mojom.DropTarget_GetBounds_ParamsSpec.$.structSpec && mojo.internal.bindings.tabs_api.mojom.DropTarget_GetBounds_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.tabs_api.mojom.DropTarget_GetBounds_ParamsSpec.$ = {};
...
mojo.internal.bindings.tabs_api.mojom.DropTargetRemoteCallHandler = class {
  ...
  getBounds() {
    return this.proxy.sendMessage(
      this.ordinals[0],  // ordinal
      mojo.internal.bindings.tabs_api.mojom.DropTarget_GetBounds_ParamsSpec,
      null,
      [],
      false);
  }
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.tabs_api.mojom.DropTarget_GetBounds_ParamsSpec.$.structSpec);
...
mojo.internal.Struct(
    mojo.internal.bindings.tabs_api.mojom.DropTarget_GetBounds_ParamsSpec, 'tabs_api.mojom.DropTarget_GetBounds_Params', [
    ],
    [[0, 8]]);
