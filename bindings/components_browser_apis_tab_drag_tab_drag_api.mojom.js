// Auto-generated MojoJS binding
 // Source: chromium_src/components/browser_apis/tab_drag/tab_drag_api.mojom
...
mojo.internal.bindings.tabs_api.mojom.TabDragService = mojo.internal.bindings.tabs_api.mojom.TabDragService || {};
mojo.internal.bindings.tabs_api.mojom.TabDragServiceSpec = mojo.internal.bindings.tabs_api.mojom.TabDragServiceSpec || { $ : {} };
if (mojo.internal.bindings.tabs_api.mojom.TabDragServiceSpec.$.structSpec && mojo.internal.bindings.tabs_api.mojom.TabDragServiceSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.tabs_api.mojom.TabDragServiceSpec.$ = {};
mojo.internal.bindings.tabs_api.mojom.TabDragService.$interfaceName = 'tabs_api.mojom.TabDragService';
mojo.internal.bindings.tabs_api.mojom.TabDragService_StartDrag_ParamsSpec = mojo.internal.bindings.tabs_api.mojom.TabDragService_StartDrag_ParamsSpec || { $: {} };
if (mojo.internal.bindings.tabs_api.mojom.TabDragService_StartDrag_ParamsSpec.$.structSpec && mojo.internal.bindings.tabs_api.mojom.TabDragService_StartDrag_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.tabs_api.mojom.TabDragService_StartDrag_ParamsSpec.$ = {};
mojo.internal.bindings.tabs_api.mojom.TabDragService_RegisterDropTarget_ParamsSpec = mojo.internal.bindings.tabs_api.mojom.TabDragService_RegisterDropTarget_ParamsSpec || { $: {} };
if (mojo.internal.bindings.tabs_api.mojom.TabDragService_RegisterDropTarget_ParamsSpec.$.structSpec && mojo.internal.bindings.tabs_api.mojom.TabDragService_RegisterDropTarget_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.tabs_api.mojom.TabDragService_RegisterDropTarget_ParamsSpec.$ = {};
mojo.internal.bindings.tabs_api.mojom.DropTargetRegistration = mojo.internal.bindings.tabs_api.mojom.DropTargetRegistration || {};
mojo.internal.bindings.tabs_api.mojom.DropTargetRegistrationSpec = mojo.internal.bindings.tabs_api.mojom.DropTargetRegistrationSpec || { $ : {} };
if (mojo.internal.bindings.tabs_api.mojom.DropTargetRegistrationSpec.$.structSpec && mojo.internal.bindings.tabs_api.mojom.DropTargetRegistrationSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.tabs_api.mojom.DropTargetRegistrationSpec.$ = {};
mojo.internal.bindings.tabs_api.mojom.DropTargetRegistration.$interfaceName = 'tabs_api.mojom.DropTargetRegistration';
mojo.internal.bindings.tabs_api.mojom.DropTargetRegistration_OnBoundsChanged_ParamsSpec = mojo.internal.bindings.tabs_api.mojom.DropTargetRegistration_OnBoundsChanged_ParamsSpec || { $: {} };
if (mojo.internal.bindings.tabs_api.mojom.DropTargetRegistration_OnBoundsChanged_ParamsSpec.$.structSpec && mojo.internal.bindings.tabs_api.mojom.DropTargetRegistration_OnBoundsChanged_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.tabs_api.mojom.DropTargetRegistration_OnBoundsChanged_ParamsSpec.$ = {};
mojo.internal.bindings.tabs_api.mojom.DropTarget = mojo.internal.bindings.tabs_api.mojom.DropTarget || {};
mojo.internal.bindings.tabs_api.mojom.DropTargetSpec = mojo.internal.bindings.tabs_api.mojom.DropTargetSpec || { $ : {} };
if (mojo.internal.bindings.tabs_api.mojom.DropTargetSpec.$.structSpec && mojo.internal.bindings.tabs_api.mojom.DropTargetSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.tabs_api.mojom.DropTargetSpec.$ = {};
mojo.internal.bindings.tabs_api.mojom.DropTarget.$interfaceName = 'tabs_api.mojom.DropTarget';
mojo.internal.bindings.tabs_api.mojom.DropTarget_OnDragEntered_ParamsSpec = mojo.internal.bindings.tabs_api.mojom.DropTarget_OnDragEntered_ParamsSpec || { $: {} };
if (mojo.internal.bindings.tabs_api.mojom.DropTarget_OnDragEntered_ParamsSpec.$.structSpec && mojo.internal.bindings.tabs_api.mojom.DropTarget_OnDragEntered_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.tabs_api.mojom.DropTarget_OnDragEntered_ParamsSpec.$ = {};
mojo.internal.bindings.tabs_api.mojom.DropTarget_OnDrag_ParamsSpec = mojo.internal.bindings.tabs_api.mojom.DropTarget_OnDrag_ParamsSpec || { $: {} };
if (mojo.internal.bindings.tabs_api.mojom.DropTarget_OnDrag_ParamsSpec.$.structSpec && mojo.internal.bindings.tabs_api.mojom.DropTarget_OnDrag_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.tabs_api.mojom.DropTarget_OnDrag_ParamsSpec.$ = {};
mojo.internal.bindings.tabs_api.mojom.DropTarget_OnDragLeave_ParamsSpec = mojo.internal.bindings.tabs_api.mojom.DropTarget_OnDragLeave_ParamsSpec || { $: {} };
if (mojo.internal.bindings.tabs_api.mojom.DropTarget_OnDragLeave_ParamsSpec.$.structSpec && mojo.internal.bindings.tabs_api.mojom.DropTarget_OnDragLeave_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.tabs_api.mojom.DropTarget_OnDragLeave_ParamsSpec.$ = {};
mojo.internal.bindings.tabs_api.mojom.DropTarget_OnDrop_ParamsSpec = mojo.internal.bindings.tabs_api.mojom.DropTarget_OnDrop_ParamsSpec || { $: {} };
if (mojo.internal.bindings.tabs_api.mojom.DropTarget_OnDrop_ParamsSpec.$.structSpec && mojo.internal.bindings.tabs_api.mojom.DropTarget_OnDrop_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.tabs_api.mojom.DropTarget_OnDrop_ParamsSpec.$ = {};
mojo.internal.bindings.tabs_api.mojom.DropTarget_OnDragCancelled_ParamsSpec = mojo.internal.bindings.tabs_api.mojom.DropTarget_OnDragCancelled_ParamsSpec || { $: {} };
if (mojo.internal.bindings.tabs_api.mojom.DropTarget_OnDragCancelled_ParamsSpec.$.structSpec && mojo.internal.bindings.tabs_api.mojom.DropTarget_OnDragCancelled_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.tabs_api.mojom.DropTarget_OnDragCancelled_ParamsSpec.$ = {};
...
mojo.internal.bindings.tabs_api.mojom.TabDragServicePendingReceiver = class {
  constructor(handle) {
    this.handle = handle;
    if (handle) {
...
mojo.internal.bindings.tabs_api.mojom.TabDragServiceRemote = class {
  static get $interfaceName() {
    return 'tabs_api.mojom.TabDragService';
  }

  constructor(handle = undefined) {
    this.__mojoHandle = handle;
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.tabs_api.mojom.TabDragServicePendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.tabs_api.mojom.TabDragServiceRemoteCallHandler(this.proxy);
  }
  ...
  startDrag(arg_node_ids, arg_start_point, arg_tab_original_offset_x, arg_mouse_to_tab_x_ratio) {
    return this.$.startDrag(arg_node_ids, arg_start_point, arg_tab_original_offset_x, arg_mouse_to_tab_x_ratio);
  }
  registerDropTarget(arg_target, arg_registration) {
    return this.$.registerDropTarget(arg_target, arg_registration);
  }
};

mojo.internal.bindings.tabs_api.mojom.TabDragServiceRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('tabs_api.mojom.TabDragService', [
      { explicit: null },
      { explicit: null },
    ]);
  }
  ...
  startDrag(arg_node_ids, arg_start_point, arg_tab_original_offset_x, arg_mouse_to_tab_x_ratio) {
    return this.proxy.sendMessage(
      ...
      mojo.internal.bindings.tabs_api.mojom.TabDragService_StartDrag_ParamsSpec,
      null,
      [arg_node_ids, arg_start_point, arg_tab_original_offset_x, arg_mouse_to_tab_x_ratio],
      false);
  }
  ...
  registerDropTarget(arg_target, arg_registration) {
    return this.proxy.sendMessage(
      ...
      mojo.internal.bindings.tabs_api.mojom.TabDragService_RegisterDropTarget_ParamsSpec,
      null,
      [arg_target, arg_registration],
      false);
  }

};

mojo.internal.bindings.tabs_api.mojom.TabDragService.getRemote = function() {
  let remote = new mojo.internal.bindings.tabs_api.mojom.TabDragServiceRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
    'tabs_api.mojom.TabDragService',
    'context');
  return remote.$;
};

mojo.internal.bindings.tabs_api.mojom.TabDragServiceReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('tabs_api.mojom.TabDragService', [
      { explicit: null },
      { explicit: null },
    ]);
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        case 0: {
          ...
          const params = decoder.decodeStructInline(mojo.internal.bindings.tabs_api.mojom.TabDragService_StartDrag_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.startDrag');
          const result = this.impl.startDrag(params.arg_node_ids, params.arg_start_point, params.arg_tab_original_offset_x, params.arg_mouse_to_tab_x_ratio);
          break;
        }
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.tabs_api.mojom.TabDragService_RegisterDropTarget_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.registerDropTarget');
          const result = this.impl.registerDropTarget(params.arg_target, params.arg_registration);
          break;
        }
      }
      } catch (err) {
...
mojo.internal.bindings.tabs_api.mojom.TabDragServiceReceiver = mojo.internal.bindings.tabs_api.mojom.TabDragServiceReceiver;

mojo.internal.bindings.tabs_api.mojom.TabDragServicePtr = mojo.internal.bindings.tabs_api.mojom.TabDragServiceRemote;
mojo.internal.bindings.tabs_api.mojom.TabDragServiceRequest = mojo.internal.bindings.tabs_api.mojom.TabDragServicePendingReceiver;


// Interface: DropTargetRegistration
mojo.internal.bindings.tabs_api.mojom.DropTargetRegistrationPendingReceiver = class {
  constructor(handle) {
    this.handle = handle;
    if (handle) {
      this.__mojoHandle = handle.router_ ? handle.router_.pipe_ : (handle.pipe_ || handle);
...
mojo.internal.bindings.tabs_api.mojom.DropTargetRegistrationRemote = class {
  static get $interfaceName() {
    return 'tabs_api.mojom.DropTargetRegistration';
  }

  constructor(handle = undefined) {
    this.__mojoHandle = handle;
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.tabs_api.mojom.DropTargetRegistrationPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.tabs_api.mojom.DropTargetRegistrationRemoteCallHandler(this.proxy);
  }
  ...
  onBoundsChanged(arg_bounds) {
    return this.$.onBoundsChanged(arg_bounds);
  }
};

mojo.internal.bindings.tabs_api.mojom.DropTargetRegistrationRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('tabs_api.mojom.DropTargetRegistration', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.tabs_api.mojom.DropTargetRegistration.getRemote = function() {
  let remote = new mojo.internal.bindings.tabs_api.mojom.DropTargetRegistrationRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
    'tabs_api.mojom.DropTargetRegistration',
    'context');
  return remote.$;
};

mojo.internal.bindings.tabs_api.mojom.DropTargetRegistrationReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('tabs_api.mojom.DropTargetRegistration', [
      { explicit: null },
    ]);
    ordinals.forEach((ord, idx) => {
      this.ordinalMap.set(ord, idx); // Scrambled/Explicit
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.tabs_api.mojom.DropTargetRegistration_OnBoundsChanged_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.onBoundsChanged');
          const result = this.impl.onBoundsChanged(params.arg_bounds);
          break;
        }
      }
      } catch (err) {
...
mojo.internal.bindings.tabs_api.mojom.DropTargetRegistrationReceiver = mojo.internal.bindings.tabs_api.mojom.DropTargetRegistrationReceiver;

mojo.internal.bindings.tabs_api.mojom.DropTargetRegistrationPtr = mojo.internal.bindings.tabs_api.mojom.DropTargetRegistrationRemote;
mojo.internal.bindings.tabs_api.mojom.DropTargetRegistrationRequest = mojo.internal.bindings.tabs_api.mojom.DropTargetRegistrationPendingReceiver;


// Interface: DropTarget
mojo.internal.bindings.tabs_api.mojom.DropTargetPendingReceiver = class {
  constructor(handle) {
    this.handle = handle;
    if (handle) {
      this.__mojoHandle = handle.router_ ? handle.router_.pipe_ : (handle.pipe_ || handle);
...
mojo.internal.bindings.tabs_api.mojom.DropTargetRemote = class {
  static get $interfaceName() {
    return 'tabs_api.mojom.DropTarget';
  }

  constructor(handle = undefined) {
    this.__mojoHandle = handle;
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.tabs_api.mojom.DropTargetPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.tabs_api.mojom.DropTargetRemoteCallHandler(this.proxy);
  }
  ...
  onDragEntered(arg_source_tab_ids, arg_local_point, arg_mouse_to_tab_x_ratio) {
    return this.$.onDragEntered(arg_source_tab_ids, arg_local_point, arg_mouse_to_tab_x_ratio);
  }
  onDrag(arg_local_point) {
    return this.$.onDrag(arg_local_point);
  }
  onDragLeave() {
    return this.$.onDragLeave();
  }
  onDrop(arg_source_tab_ids, arg_local_point) {
    return this.$.onDrop(arg_source_tab_ids, arg_local_point);
  }
  onDragCancelled() {
    return this.$.onDragCancelled();
  }
};

mojo.internal.bindings.tabs_api.mojom.DropTargetRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('tabs_api.mojom.DropTarget', [
      { explicit: null },
      { explicit: null },
      { explicit: null },
      { explicit: null },
  ...
  onDragEntered(arg_source_tab_ids, arg_local_point, arg_mouse_to_tab_x_ratio) {
    return this.proxy.sendMessage(
      this.ordinals[0],  // ordinal
      mojo.internal.bindings.tabs_api.mojom.DropTarget_OnDragEntered_ParamsSpec,
      null,
      [arg_source_tab_ids, arg_local_point, arg_mouse_to_tab_x_ratio],
      false);
  }
  ...
  onDrag(arg_local_point) {
    return this.proxy.sendMessage(
      this.ordinals[1],  // ordinal
      mojo.internal.bindings.tabs_api.mojom.DropTarget_OnDrag_ParamsSpec,
      null,
      [arg_local_point],
      false);
  }
  ...
  onDragLeave() {
    return this.proxy.sendMessage(
      ...
      mojo.internal.bindings.tabs_api.mojom.DropTarget_OnDragLeave_ParamsSpec,
      null,
      [],
      false);
  }
  ...
  onDrop(arg_source_tab_ids, arg_local_point) {
    return this.proxy.sendMessage(
      ...
      mojo.internal.bindings.tabs_api.mojom.DropTarget_OnDrop_ParamsSpec,
      null,
      [arg_source_tab_ids, arg_local_point],
      false);
  }
  ...
  onDragCancelled() {
    return this.proxy.sendMessage(
      ...
      mojo.internal.bindings.tabs_api.mojom.DropTarget_OnDragCancelled_ParamsSpec,
      null,
      [],
      false);
  }
...
mojo.internal.bindings.tabs_api.mojom.DropTarget.getRemote = function() {
  let remote = new mojo.internal.bindings.tabs_api.mojom.DropTargetRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
    'tabs_api.mojom.DropTarget',
    'context');
  return remote.$;
};

mojo.internal.bindings.tabs_api.mojom.DropTargetReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('tabs_api.mojom.DropTarget', [
      { explicit: null },
      { explicit: null },
      { explicit: null },
      { explicit: null },
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.tabs_api.mojom.DropTarget_OnDragEntered_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.onDragEntered');
          const result = this.impl.onDragEntered(params.arg_source_tab_ids, params.arg_local_point, params.arg_mouse_to_tab_x_ratio);
          break;
        }
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.tabs_api.mojom.DropTarget_OnDrag_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.onDrag');
          const result = this.impl.onDrag(params.arg_local_point);
          break;
        }
        case 2: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.tabs_api.mojom.DropTarget_OnDragLeave_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.onDragLeave');
          const result = this.impl.onDragLeave();
          break;
        }
        case 3: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.tabs_api.mojom.DropTarget_OnDrop_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.onDrop');
          const result = this.impl.onDrop(params.arg_source_tab_ids, params.arg_local_point);
          break;
        }
        case 4: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.tabs_api.mojom.DropTarget_OnDragCancelled_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.onDragCancelled');
          const result = this.impl.onDragCancelled();
          break;
        }
      }
      } catch (err) {
...
mojo.internal.bindings.tabs_api.mojom.DropTargetReceiver = mojo.internal.bindings.tabs_api.mojom.DropTargetReceiver;

mojo.internal.bindings.tabs_api.mojom.DropTargetPtr = mojo.internal.bindings.tabs_api.mojom.DropTargetRemote;
mojo.internal.bindings.tabs_api.mojom.DropTargetRequest = mojo.internal.bindings.tabs_api.mojom.DropTargetPendingReceiver;


// Specs (at the end to ensure classes are defined for InterfaceProxy)
mojo.internal.Struct(
    mojo.internal.bindings.tabs_api.mojom.TabDragService_StartDrag_ParamsSpec, 'tabs_api.mojom.TabDragService_StartDrag_Params', [
      mojo.internal.StructField('arg_node_ids', 0, 0, mojo.internal.Array(mojo.internal.bindings.tabs_api.mojom.NodeIdSpec, false), null, false, 0, undefined),
      mojo.internal.StructField('arg_start_point', 8, 0, mojo.internal.bindings.gfx.mojom.PointSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_tab_original_offset_x', 16, 0, mojo.internal.Int32, 0, false, 0, undefined),
      mojo.internal.StructField('arg_mouse_to_tab_x_ratio', 20, 0, mojo.internal.Float, 0, false, 0, undefined),
    ],
    [[0, 32]]);

mojo.internal.Struct(
    mojo.internal.bindings.tabs_api.mojom.TabDragService_RegisterDropTarget_ParamsSpec, 'tabs_api.mojom.TabDragService_RegisterDropTarget_Params', [
      mojo.internal.StructField('arg_target', 0, 0, mojo.internal.AssociatedInterfaceProxy(mojo.internal.bindings.tabs_api.mojom.DropTargetRemote), null, false, 0, undefined),
      mojo.internal.StructField('arg_registration', 8, 0, mojo.internal.AssociatedInterfaceRequest(mojo.internal.bindings.tabs_api.mojom.DropTargetRegistrationPendingReceiver), null, false, 0, undefined),
    ],
    [[0, 24]]);

mojo.internal.Struct(
    mojo.internal.bindings.tabs_api.mojom.DropTargetRegistration_OnBoundsChanged_ParamsSpec, 'tabs_api.mojom.DropTargetRegistration_OnBoundsChanged_Params', [
      mojo.internal.StructField('arg_bounds', 0, 0, mojo.internal.bindings.gfx.mojom.RectSpec, null, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.tabs_api.mojom.DropTarget_OnDragEntered_ParamsSpec, 'tabs_api.mojom.DropTarget_OnDragEntered_Params', [
      mojo.internal.StructField('arg_source_tab_ids', 0, 0, mojo.internal.Array(mojo.internal.bindings.tabs_api.mojom.NodeIdSpec, false), null, false, 0, undefined),
      mojo.internal.StructField('arg_local_point', 8, 0, mojo.internal.bindings.gfx.mojom.PointSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_mouse_to_tab_x_ratio', 16, 0, mojo.internal.Float, 0, false, 0, undefined),
    ],
    [[0, 32]]);

mojo.internal.Struct(
    mojo.internal.bindings.tabs_api.mojom.DropTarget_OnDrag_ParamsSpec, 'tabs_api.mojom.DropTarget_OnDrag_Params', [
      mojo.internal.StructField('arg_local_point', 0, 0, mojo.internal.bindings.gfx.mojom.PointSpec, null, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.tabs_api.mojom.DropTarget_OnDragLeave_ParamsSpec, 'tabs_api.mojom.DropTarget_OnDragLeave_Params', [
    ],
    [[0, 8]]);

mojo.internal.Struct(
    mojo.internal.bindings.tabs_api.mojom.DropTarget_OnDrop_ParamsSpec, 'tabs_api.mojom.DropTarget_OnDrop_Params', [
      mojo.internal.StructField('arg_source_tab_ids', 0, 0, mojo.internal.Array(mojo.internal.bindings.tabs_api.mojom.NodeIdSpec, false), null, false, 0, undefined),
      mojo.internal.StructField('arg_local_point', 8, 0, mojo.internal.bindings.gfx.mojom.PointSpec, null, false, 0, undefined),
    ],
    [[0, 24]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.tabs_api.mojom.DropTarget_OnDragCancelled_ParamsSpec, 'tabs_api.mojom.DropTarget_OnDragCancelled_Params', [
    ],
    [[0, 8]]);
