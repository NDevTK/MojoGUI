...
mojo.internal.bindings.viz.mojom.VSyncParameterObserver = {};
mojo.internal.bindings.viz.mojom.VSyncParameterObserverSpec = { $ : {} };
mojo.internal.bindings.viz.mojom.VSyncParameterObserver.$interfaceName = 'viz.mojom.VSyncParameterObserver';
...
mojo.internal.bindings.viz.mojom.VSyncParameterObserverRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.viz.mojom.VSyncParameterObserverPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.viz.mojom.VSyncParameterObserverRemoteCallHandler(this.proxy);
  }
  ...
  onUpdateVSyncParameters(arg_timebase, arg_interval) {
    return this.$.onUpdateVSyncParameters(arg_timebase, arg_interval);
  }
};

mojo.internal.bindings.viz.mojom.VSyncParameterObserverRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('viz.mojom.VSyncParameterObserver', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.viz.mojom.VSyncParameterObserver.getRemote = function() {
  let remote = new mojo.internal.bindings.viz.mojom.VSyncParameterObserverRemote();
...
mojo.internal.bindings.viz.mojom.VSyncParameterObserverReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('viz.mojom.VSyncParameterObserver', [
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.viz.mojom.VSyncParameterObserver_OnUpdateVSyncParameters_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OnUpdateVSyncParameters failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.viz.mojom.VSyncParameterObserverReceiver = mojo.internal.bindings.viz.mojom.VSyncParameterObserverReceiver;
