...
metrics.mojom.SampledProfileSpec = {
  $: {
    structSpec: {
      ...
      packedSize: 16,
      fields: [
        { name: 'contents', packedOffset: 8, packedBitOffset: 0, type: mojo_base.mojom.ProtoWrapperSpec, nullable: false },
      ],
      versions: [{version: 0}]
    }
  }
...
metrics.mojom.CallStackProfileCollector_Collect_ParamsSpec = {
  $: {
    structSpec: {
      ...
      packedSize: 32,
      fields: [
        { name: 'start_timestamp', packedOffset: 8, packedBitOffset: 0, type: mojo_base.mojom.TimeTicksSpec, nullable: false },
        { name: 'profile_type', packedOffset: 16, packedBitOffset: 0, type: metrics.mojom.ProfileTypeSpec, nullable: false },
        { name: 'profile', packedOffset: 24, packedBitOffset: 0, type: metrics.mojom.SampledProfileSpec, nullable: false },
      ],
      versions: [{version: 0}]
    }
  }
