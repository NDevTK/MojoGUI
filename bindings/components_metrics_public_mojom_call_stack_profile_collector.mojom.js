...
mojo.internal.bindings.metrics.mojom.CallStackProfileCollector.$interfaceName = 'metrics.mojom.CallStackProfileCollector';
...
// Enum: ProfileType
mojo.internal.bindings.metrics.mojom.ProfileType = {
  kCPU: 0,
  kHeap: 1,
};
...
mojo.internal.Struct(
    mojo.internal.bindings.metrics.mojom.CallStackProfileCollector_Collect_ParamsSpec, 'metrics.mojom.CallStackProfileCollector_Collect_Params', [
      ...
      mojo.internal.StructField('arg_profile', 8, 0, mojo.internal.bindings.metrics.mojom.SampledProfileSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_profile_type', 16, 0, mojo.internal.bindings.metrics.mojom.ProfileTypeSpec, null, false, 0, undefined),
    ],
    [[0, 32]]);
...
mojo.internal.bindings.metrics.mojom.CallStackProfileCollectorRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.metrics.mojom.CallStackProfileCollectorRemoteCallHandler(this.proxy);
  }
  ...
  collect(arg_start_timestamp, arg_profile_type, arg_profile) {
    return this.$.collect(arg_start_timestamp, arg_profile_type, arg_profile);
  }
};

mojo.internal.bindings.metrics.mojom.CallStackProfileCollectorRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('metrics.mojom.CallStackProfileCollector', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.metrics.mojom.CallStackProfileCollector.getRemote = function() {
  let remote = new mojo.internal.bindings.metrics.mojom.CallStackProfileCollectorRemote();
...
mojo.internal.bindings.metrics.mojom.CallStackProfileCollectorReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('metrics.mojom.CallStackProfileCollector', [
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.metrics.mojom.CallStackProfileCollector_Collect_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for Collect failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.metrics.mojom.CallStackProfileCollectorReceiver = mojo.internal.bindings.metrics.mojom.CallStackProfileCollectorReceiver;
