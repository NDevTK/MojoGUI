...
mojo.internal.bindings.user_data_importer.mojom.BookmarkHtmlParserSpec = mojo.internal.bindings.user_data_importer.mojom.BookmarkHtmlParserSpec || { $: mojo.internal.OpaqueStruct.$ };
mojo.internal.bindings.user_data_importer.mojom.BookmarkHtmlParserRemote = mojo.internal.bindings.user_data_importer.mojom.BookmarkHtmlParserRemote || class {};
mojo.internal.bindings.user_data_importer.mojom.BookmarkHtmlParserPendingReceiver = mojo.internal.bindings.user_data_importer.mojom.BookmarkHtmlParserPendingReceiver || class { constructor(handle) { this.handle = handle; } };
...
mojo.internal.bindings.chrome.mojom.ProfileImportRemote = class {
  ...
  startImport(arg_source_profile, arg_items, arg_localized_strings, arg_observer, arg_bookmark_html_parser) {
    return this.$.startImport(arg_source_profile, arg_items, arg_localized_strings, arg_observer, arg_bookmark_html_parser);
  }
  cancelImport() {
...
mojo.internal.bindings.chrome.mojom.ProfileImportRemoteCallHandler = class {
  ...
  startImport(arg_source_profile, arg_items, arg_localized_strings, arg_observer, arg_bookmark_html_parser) {
    return this.proxy.sendMessage(
      ...
      null,
      [arg_source_profile, arg_items, arg_localized_strings, arg_observer, arg_bookmark_html_parser],
      false);
  }
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        case 0: {
          ...
          const result = this.impl.startImport(params.arg_source_profile, params.arg_items, params.arg_localized_strings, params.arg_observer, params.arg_bookmark_html_parser);
          break;
        }
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
...
mojo.internal.Struct(
    mojo.internal.bindings.chrome.mojom.ProfileImport_StartImport_ParamsSpec, 'chrome.mojom.ProfileImport_StartImport_Params', [
      ...
      mojo.internal.StructField('arg_bookmark_html_parser', 32, 0, mojo.internal.InterfaceProxy(mojo.internal.bindings.user_data_importer.mojom.BookmarkHtmlParserRemote), null, true, 0, undefined),
    ],
    [[0, 48]]);
