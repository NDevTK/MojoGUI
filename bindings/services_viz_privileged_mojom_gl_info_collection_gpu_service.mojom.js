...
mojo.internal.bindings.viz.mojom.InfoCollectionGpuServiceRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.viz.mojom.InfoCollectionGpuServiceRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.viz.mojom.InfoCollectionGpuService.getRemote = function() {
  let remote = new mojo.internal.bindings.viz.mojom.InfoCollectionGpuServiceRemote();
...
mojo.internal.bindings.viz.mojom.InfoCollectionGpuServiceReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.viz.mojom.InfoCollectionGpuService_GetGpuSupportedDirectXVersionAndDevicePerfInfo_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for GetGpuSupportedDirectXVersionAndDevicePerfInfo failed with TypeError');
           }
        }
        // Try Method 1: GetGpuSupportedVulkanVersionInfo
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.viz.mojom.InfoCollectionGpuService_GetGpuSupportedVulkanVersionInfo_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for GetGpuSupportedVulkanVersionInfo failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.viz.mojom.InfoCollectionGpuService_GetGpuSupportedDirectXVersionAndDevicePerfInfo_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.getGpuSupportedDirectXVersionAndDevicePerfInfo');
        ...
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.viz.mojom.InfoCollectionGpuService_GetGpuSupportedVulkanVersionInfo_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.getGpuSupportedVulkanVersionInfo');
...
mojo.internal.bindings.viz.mojom.InfoCollectionGpuServiceReceiver = mojo.internal.bindings.viz.mojom.InfoCollectionGpuServiceReceiver;
