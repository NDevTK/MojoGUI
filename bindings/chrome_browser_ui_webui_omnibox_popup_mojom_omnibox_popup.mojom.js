...
mojo.internal.bindings.omnibox_popup.mojom.PageHandlerRemote = class {
  ...
  onSelectionChanged(arg_state) {
    return this.$.onSelectionChanged(arg_state);
  }
};
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        ...
        case 2: {
          ...
          const result = this.impl.onSelectionChanged(params.arg_state);
          break;
        }
      }
      } catch (err) {
...
mojo.internal.Struct(
    mojo.internal.bindings.omnibox_popup.mojom.OmniboxInputStateSpec, 'omnibox_popup.mojom.OmniboxInputState', [
      ...
      mojo.internal.StructField('arg_is_double_click', 20, 0, mojo.internal.Bool, false, false, 0, undefined),
    ],
    [[0, 32]]);
mojo.internal.Struct(
