...
mojo.internal.bindings.omnibox_popup.mojom.PageHandler_OnManualBlur_ParamsSpec = mojo.internal.bindings.omnibox_popup.mojom.PageHandler_OnManualBlur_ParamsSpec || { $: {} };
if (mojo.internal.bindings.omnibox_popup.mojom.PageHandler_OnManualBlur_ParamsSpec.$.structSpec && mojo.internal.bindings.omnibox_popup.mojom.PageHandler_OnManualBlur_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.omnibox_popup.mojom.PageHandler_OnManualBlur_ParamsSpec.$ = {};
...
mojo.internal.bindings.omnibox_popup.mojom.PageHandlerRemote = class {
  ...
  onManualBlur(arg_sequence_number) {
    return this.$.onManualBlur(arg_sequence_number);
  }
  onSelectionChanged(arg_selection, arg_sequence_number) {
    return this.$.onSelectionChanged(arg_selection, arg_sequence_number);
  }
...
mojo.internal.bindings.omnibox_popup.mojom.PageHandlerRemoteCallHandler = class {
  ...
  onManualBlur(arg_sequence_number) {
    return this.proxy.sendMessage(
      ...
      mojo.internal.bindings.omnibox_popup.mojom.PageHandler_OnManualBlur_ParamsSpec,
      null,
      [arg_sequence_number],
      false);
  }
  ...
  onSelectionChanged(arg_selection, arg_sequence_number) {
    return this.proxy.sendMessage(
      ...
      null,
      [arg_selection, arg_sequence_number],
      false);
  }
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        ...
        case 2: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.omnibox_popup.mojom.PageHandler_OnManualBlur_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.onManualBlur');
          const result = this.impl.onManualBlur(params.arg_sequence_number);
          break;
        }
        case 3: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          ...
          const result = this.impl.onSelectionChanged(params.arg_selection, params.arg_sequence_number);
          break;
        }
        case 4: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
...
mojo.internal.Struct(
    mojo.internal.bindings.omnibox_popup.mojom.PageHandler_OnManualBlur_ParamsSpec, 'omnibox_popup.mojom.PageHandler_OnManualBlur_Params', [
      mojo.internal.StructField('arg_sequence_number', 0, 0, mojo.internal.Uint32, 0, false, 0, undefined),
    ],
    [[0, 16]]);
