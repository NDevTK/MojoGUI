...
mojo.internal.bindings.sharing.mojom.IceConfigFetcherRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.sharing.mojom.IceConfigFetcherPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.sharing.mojom.IceConfigFetcherRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.sharing.mojom.IceConfigFetcher.getRemote = function() {
  let remote = new mojo.internal.bindings.sharing.mojom.IceConfigFetcherRemote();
...
mojo.internal.bindings.sharing.mojom.IceConfigFetcherReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.sharing.mojom.IceConfigFetcher_GetIceServers_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for GetIceServers failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.sharing.mojom.IceConfigFetcher_GetIceServers_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.sharing.mojom.IceConfigFetcherReceiver = mojo.internal.bindings.sharing.mojom.IceConfigFetcherReceiver;

mojo.internal.bindings.sharing.mojom.IceConfigFetcherPtr = mojo.internal.bindings.sharing.mojom.IceConfigFetcherRemote;
mojo.internal.bindings.sharing.mojom.IceConfigFetcherRequest = mojo.internal.bindings.sharing.mojom.IceConfigFetcherPendingReceiver;
...
mojo.internal.bindings.sharing.mojom.MdnsResponderFactoryRemote = class {
  static get $interfaceName() {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.sharing.mojom.MdnsResponderFactoryPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.sharing.mojom.MdnsResponderFactoryRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.sharing.mojom.MdnsResponderFactory.getRemote = function() {
  let remote = new mojo.internal.bindings.sharing.mojom.MdnsResponderFactoryRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
...
mojo.internal.bindings.sharing.mojom.MdnsResponderFactoryReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.sharing.mojom.MdnsResponderFactory_CreateMdnsResponder_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
...
mojo.internal.bindings.sharing.mojom.MdnsResponderFactoryReceiver = mojo.internal.bindings.sharing.mojom.MdnsResponderFactoryReceiver;
