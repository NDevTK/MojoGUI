...
mojo.internal.bindings.tabs_api.mojom.TabStripExperimentServiceRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.tabs_api.mojom.TabStripExperimentServicePendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.tabs_api.mojom.TabStripExperimentServiceRemoteCallHandler(this.proxy);
  }
  ...
  updateTabGroupVisual(arg_id, arg_visual_data) {
    return this.$.updateTabGroupVisual(arg_id, arg_visual_data);
  }
  showTabContextMenu(arg_tab_id, arg_location) {
    return this.$.showTabContextMenu(arg_tab_id, arg_location);
  }
};
...
mojo.internal.bindings.tabs_api.mojom.TabStripExperimentService.getRemote = function() {
  let remote = new mojo.internal.bindings.tabs_api.mojom.TabStripExperimentServiceRemote();
...
mojo.internal.bindings.tabs_api.mojom.TabStripExperimentServiceReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.tabs_api.mojom.TabStripExperimentService_UpdateTabGroupVisual_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for UpdateTabGroupVisual failed with TypeError');
           }
        }
        // Try Method 1: ShowTabContextMenu
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.tabs_api.mojom.TabStripExperimentService_ShowTabContextMenu_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for ShowTabContextMenu failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.tabs_api.mojom.TabStripExperimentServiceReceiver = mojo.internal.bindings.tabs_api.mojom.TabStripExperimentServiceReceiver;
