...
mojo.internal.Struct(
    mojo.internal.bindings.blink.mojom.ContactInfoSpec, 'blink.mojom.ContactInfo', [
      ...
      mojo.internal.StructField('arg_icon', 32, 0, mojo.internal.Array(mojo.internal.bindings.mojo.internal.bindings.blink.mojom.ContactIconBlobSpec.$, false), null, true, 0, undefined),
    ],
    [[0, 48]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.blink.mojom.ContactsManager_Select_ResponseParamsSpec, 'blink.mojom.ContactsManager_Select_ResponseParams', [
      mojo.internal.StructField('arg_contacts', 0, 0, mojo.internal.Array(mojo.internal.bindings.mojo.internal.bindings.blink.mojom.ContactInfoSpec.$, false), null, true, 0, undefined),
    ],
    [[0, 16]]);
...
mojo.internal.bindings.blink.mojom.ContactsManagerRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.blink.mojom.ContactsManagerPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.blink.mojom.ContactsManagerRemoteCallHandler(this.proxy);
  }
  ...
  select(arg_multiple, arg_include_names, arg_include_emails, arg_include_tel, arg_include_addresses, arg_include_icons) {
    return this.$.select(arg_multiple, arg_include_names, arg_include_emails, arg_include_tel, arg_include_addresses, arg_include_icons);
  }
};
...
mojo.internal.bindings.blink.mojom.ContactsManager.getRemote = function() {
  let remote = new mojo.internal.bindings.blink.mojom.ContactsManagerRemote();
...
mojo.internal.bindings.blink.mojom.ContactsManagerReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
        ...
        case 0: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.blink.mojom.ContactsManager_Select_ResponseParamsSpec, header, rawHeader);
               responder(response);
...
mojo.internal.bindings.blink.mojom.ContactsManagerReceiver = mojo.internal.bindings.blink.mojom.ContactsManagerReceiver;
