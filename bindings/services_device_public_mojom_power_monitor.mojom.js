...
mojo.internal.bindings.device.mojom.PowerMonitorRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.device.mojom.PowerMonitorPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.device.mojom.PowerMonitorRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.device.mojom.PowerMonitorRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('device.mojom.PowerMonitor', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.device.mojom.PowerMonitor.getRemote = function() {
  let remote = new mojo.internal.bindings.device.mojom.PowerMonitorRemote();
...
mojo.internal.bindings.device.mojom.PowerMonitorReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('device.mojom.PowerMonitor', [
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.device.mojom.PowerMonitor_AddClient_ParamsSpec.$.structSpec;
...
mojo.internal.bindings.device.mojom.PowerMonitorReceiver = mojo.internal.bindings.device.mojom.PowerMonitorReceiver;

mojo.internal.bindings.device.mojom.PowerMonitorPtr = mojo.internal.bindings.device.mojom.PowerMonitorRemote;
mojo.internal.bindings.device.mojom.PowerMonitorRequest = mojo.internal.bindings.device.mojom.PowerMonitorPendingReceiver;
...
mojo.internal.bindings.device.mojom.PowerMonitorClientRemote = class {
  static get $interfaceName() {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.device.mojom.PowerMonitorClientPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.device.mojom.PowerMonitorClientRemoteCallHandler(this.proxy);
  }
  ...
  powerStateChange(arg_battery_power_status) {
    return this.$.powerStateChange(arg_battery_power_status);
  }
  suspend() {
    return this.$.suspend();
  }
...
mojo.internal.bindings.device.mojom.PowerMonitorClientRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('device.mojom.PowerMonitorClient', [
      { explicit: null },
      { explicit: null },
      { explicit: null },
    ]);
...
mojo.internal.bindings.device.mojom.PowerMonitorClient.getRemote = function() {
  let remote = new mojo.internal.bindings.device.mojom.PowerMonitorClientRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
...
mojo.internal.bindings.device.mojom.PowerMonitorClientReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('device.mojom.PowerMonitorClient', [
      { explicit: null },
      { explicit: null },
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.device.mojom.PowerMonitorClient_PowerStateChange_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for PowerStateChange failed with TypeError');
           }
        }
        // Try Method 1: Suspend
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.device.mojom.PowerMonitorClient_Suspend_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.device.mojom.PowerMonitorClient_Resume_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
      ...
      switch (dispatchId) {
        ...
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.device.mojom.PowerMonitorClient_Suspend_ParamsSpec.$.structSpec);
        ...
        case 2: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.device.mojom.PowerMonitorClient_Resume_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.device.mojom.PowerMonitorClientReceiver = mojo.internal.bindings.device.mojom.PowerMonitorClientReceiver;
