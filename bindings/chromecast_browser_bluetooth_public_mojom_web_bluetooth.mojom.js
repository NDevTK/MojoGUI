...
mojo.internal.bindings.chromecast.mojom.BluetoothDeviceAccessProviderRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.chromecast.mojom.BluetoothDeviceAccessProviderPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.chromecast.mojom.BluetoothDeviceAccessProviderRemoteCallHandler(this.proxy);
  }
  ...
  requestDeviceAccess(arg_client) {
    return this.$.requestDeviceAccess(arg_client);
  }
};
...
mojo.internal.bindings.chromecast.mojom.BluetoothDeviceAccessProvider.getRemote = function() {
  let remote = new mojo.internal.bindings.chromecast.mojom.BluetoothDeviceAccessProviderRemote();
...
mojo.internal.bindings.chromecast.mojom.BluetoothDeviceAccessProviderReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.chromecast.mojom.BluetoothDeviceAccessProvider_RequestDeviceAccess_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for RequestDeviceAccess failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.chromecast.mojom.BluetoothDeviceAccessProviderReceiver = mojo.internal.bindings.chromecast.mojom.BluetoothDeviceAccessProviderReceiver;

mojo.internal.bindings.chromecast.mojom.BluetoothDeviceAccessProviderPtr = mojo.internal.bindings.chromecast.mojom.BluetoothDeviceAccessProviderRemote;
mojo.internal.bindings.chromecast.mojom.BluetoothDeviceAccessProviderRequest = mojo.internal.bindings.chromecast.mojom.BluetoothDeviceAccessProviderPendingReceiver;
...
mojo.internal.bindings.chromecast.mojom.BluetoothDeviceAccessProviderClientRemote = class {
  static get $interfaceName() {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.chromecast.mojom.BluetoothDeviceAccessProviderClientPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.chromecast.mojom.BluetoothDeviceAccessProviderClientRemoteCallHandler(this.proxy);
  }
  ...
  grantAccess(arg_address) {
    return this.$.grantAccess(arg_address);
  }
...
mojo.internal.bindings.chromecast.mojom.BluetoothDeviceAccessProviderClient.getRemote = function() {
  let remote = new mojo.internal.bindings.chromecast.mojom.BluetoothDeviceAccessProviderClientRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
...
mojo.internal.bindings.chromecast.mojom.BluetoothDeviceAccessProviderClientReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.chromecast.mojom.BluetoothDeviceAccessProviderClient_GrantAccess_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for GrantAccess failed with TypeError');
           }
        }
        // Try Method 1: GrantAccessToAllDevices
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.chromecast.mojom.BluetoothDeviceAccessProviderClient_GrantAccessToAllDevices_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for GrantAccessToAllDevices failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
             console.warn('[GeneratedReceiver] Failed to discover ordinal ' + header.ordinal);
      ...
      switch (dispatchId) {
        ...
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.chromecast.mojom.BluetoothDeviceAccessProviderClient_GrantAccessToAllDevices_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.chromecast.mojom.BluetoothDeviceAccessProviderClientReceiver = mojo.internal.bindings.chromecast.mojom.BluetoothDeviceAccessProviderClientReceiver;
