...
mojo.internal.bindings.blink.mojom.FederatedAuthRequestRemote = class {
  ...
  resolveTokenRequest(arg_account_id, arg_redirect_to, arg_token) {
    return this.$.resolveTokenRequest(arg_account_id, arg_redirect_to, arg_token);
  }
...
mojo.internal.bindings.blink.mojom.FederatedAuthRequestRemoteCallHandler = class {
  ...
  resolveTokenRequest(arg_account_id, arg_redirect_to, arg_token) {
    return this.proxy.sendMessage(
      ...
      mojo.internal.bindings.blink.mojom.FederatedAuthRequest_ResolveTokenRequest_ParamsSpec,
      mojo.internal.bindings.blink.mojom.FederatedAuthRequest_ResolveTokenRequest_ResponseParamsSpec,
      [arg_account_id, arg_redirect_to, arg_token],
      false);
  }
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        ...
        case 3: {
          ...
          const result = this.impl.resolveTokenRequest(params.arg_account_id, params.arg_redirect_to, params.arg_token);
          const expectsResponse = header.expectsResponse || (header.flags & 1);
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
...
mojo.internal.Struct(
    mojo.internal.bindings.blink.mojom.FederatedAuthRequest_ResolveTokenRequest_ParamsSpec, 'blink.mojom.FederatedAuthRequest_ResolveTokenRequest_Params', [
      ...
      mojo.internal.StructField('arg_redirect_to', 8, 0, mojo.internal.bindings.url.mojom.UrlSpec, null, true, 0, undefined),
      mojo.internal.StructField('arg_token', 16, 0, mojo.internal.bindings.mojo_base.mojom.ValueSpec, null, false, 0, undefined),
    ],
    [[0, 40]]);
