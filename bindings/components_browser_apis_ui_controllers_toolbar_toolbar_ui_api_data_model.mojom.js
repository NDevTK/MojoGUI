...
mojo.internal.bindings.toolbar_ui_api.mojom.ContextMenuType = {
  ...
  kHome: 6,
  kBatterySaver: 7,
  kPinnedActionNewIncognitoWindow: 8,
  kPinnedActionShowPasswordsBubbleOrPage: 9,
  kPinnedActionShowPaymentsBubbleOrPage: 10,
  kPinnedActionShowAddressesBubbleOrPage: 11,
  kPinnedActionSidePanelShowBookmarks: 12,
  kPinnedActionSidePanelShowReadingList: 13,
  kPinnedActionSidePanelShowHistoryCluster: 14,
  kPinnedActionShowDownloads: 15,
  kPinnedActionClearBrowsingData: 16,
  kPinnedActionPrint: 17,
  kPinnedActionSidePanelShowLensOverlayResults: 18,
  kPinnedActionShowTranslate: 19,
  kPinnedActionQrCodeGenerator: 20,
  kPinnedActionRouteMedia: 21,
  kPinnedActionSidePanelShowReadAnything: 22,
  kPinnedActionCopyUrl: 23,
  kPinnedActionSendTabToSelf: 24,
  kPinnedActionTaskManager: 25,
  kPinnedActionDevTools: 26,
  kPinnedActionTabSearch: 27,
  kPinnedActionSidePanelShowContextualTasks: 28,
  kPinnedActionSidePanelShowLens: 29,
  kPinnedActionSidePanelShowAboutThisSite: 30,
  kPinnedActionSidePanelShowCustomizeChrome: 31,
  kPinnedActionSidePanelShowShoppingInsights: 32,
  kPinnedActionSidePanelShowMerchantTrust: 33,
  kPinnedActionSendSharedTabGroupFeedback: 34,
  kPinnedActionSidePanelShowComments: 35,
  kAppMenu: 36,
};
