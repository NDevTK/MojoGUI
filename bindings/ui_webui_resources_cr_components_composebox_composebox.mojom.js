...
mojo.internal.bindings.composebox.mojom.PageHandlerFactoryRemote = class {
  ...
  createPageHandler(arg_page, arg_handler, arg_searchbox_page, arg_searchbox_handler) {
    return this.$.createPageHandler(arg_page, arg_handler, arg_searchbox_page, arg_searchbox_handler);
  }
};
...
mojo.internal.bindings.composebox.mojom.PageHandlerRemote = class {
  ...
  recordNextboxAnimationImpression() {
    return this.$.recordNextboxAnimationImpression();
  }
};
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        ...
        case 11: {
          ...
          const result = this.impl.recordNextboxAnimationImpression();
          break;
        }
      }
      } catch (err) {
...
// Interface: Page
mojo.internal.bindings.composebox.mojom.PagePendingReceiver = class {
  constructor(handle) {
    this.handle = handle;
    if (handle) {
      this.__mojoHandle = handle.router_ ? handle.router_.pipe_ : (handle.pipe_ || handle);
...
mojo.internal.bindings.composebox.mojom.PageRemote = class {
  static get $interfaceName() {
  ...
  constructor(handle = undefined) {
    this.__mojoHandle = handle;
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.composebox.mojom.PagePendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.composebox.mojom.PageRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.composebox.mojom.Page.getRemote = function() {
  let remote = new mojo.internal.bindings.composebox.mojom.PageRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
...
mojo.internal.bindings.composebox.mojom.PageReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
...
mojo.internal.bindings.composebox.mojom.PageReceiver = mojo.internal.bindings.composebox.mojom.PageReceiver;

mojo.internal.bindings.composebox.mojom.PagePtr = mojo.internal.bindings.composebox.mojom.PageRemote;
mojo.internal.bindings.composebox.mojom.PageRequest = mojo.internal.bindings.composebox.mojom.PagePendingReceiver;
