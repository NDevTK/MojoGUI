...
proxy_resolver.mojom.ProxyResolverRequestClient_ReportResult_ParamsSpec = {
  $: {
    structSpec: {
      ...
      fields: [
        { name: 'error', packedOffset: 0, packedBitOffset: 0, type: mojo.internal.String, nullable: true },
        { name: 'proxy_info', packedOffset: 8, packedBitOffset: 0, type: mojo.internal.String, nullable: true },
      ],
      versions: [{version: 0}]
    }
  }
  ...
  $: {
    structSpec: {
      ...
      fields: [
        ...
        { name: 'operation', packedOffset: 8, packedBitOffset: 0, type: mojo.internal.String, nullable: true },
...
proxy_resolver.mojom.ProxyResolverFactory_CreateResolver_ParamsSpec = {
  $: {
    structSpec: {
      ...
      packedSize: 32,
      fields: [
        { name: 'pac_script', packedOffset: 0, packedBitOffset: 0, type: mojo.internal.String, nullable: true },
...
proxy_resolver.mojom.SystemProxyResolver_GetProxyForUrl_ResponseParamsSpec = {
  $: {
    structSpec: {
      ...
      packedSize: 24,
      fields: [
        { name: 'proxy_list', packedOffset: 0, packedBitOffset: 0, type: mojo.internal.String, nullable: true },
