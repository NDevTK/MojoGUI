...
mojo.internal.bindings.ash.rollback_network_config.mojom.RollbackNetworkConfigRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.ash.rollback_network_config.mojom.RollbackNetworkConfigPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.ash.rollback_network_config.mojom.RollbackNetworkConfigRemoteCallHandler(this.proxy);
  }
  ...
  rollbackConfigImport(arg_config) {
    return this.$.rollbackConfigImport(arg_config);
  }
...
mojo.internal.bindings.ash.rollback_network_config.mojom.RollbackNetworkConfigRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('ash.rollback_network_config.mojom.RollbackNetworkConfig', [
      { explicit: null },
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.ash.rollback_network_config.mojom.RollbackNetworkConfig.getRemote = function() {
  let remote = new mojo.internal.bindings.ash.rollback_network_config.mojom.RollbackNetworkConfigRemote();
...
mojo.internal.bindings.ash.rollback_network_config.mojom.RollbackNetworkConfigReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('ash.rollback_network_config.mojom.RollbackNetworkConfig', [
      { explicit: null },
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.ash.rollback_network_config.mojom.RollbackNetworkConfig_RollbackConfigImport_ParamsSpec.$.structSpec);
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.ash.rollback_network_config.mojom.RollbackNetworkConfig_RollbackConfigExport_ParamsSpec.$.structSpec);
      ...
      switch (dispatchId) {
        case 0: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.ash.rollback_network_config.mojom.RollbackNetworkConfig_RollbackConfigImport_ResponseParamsSpec, header, rawHeader);
               responder(response);
        ...
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.ash.rollback_network_config.mojom.RollbackNetworkConfig_RollbackConfigExport_ParamsSpec.$.structSpec);
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              const rawHeader = (args[2] && args[2].slice) ? args[2].slice(0, header.headerSize) : null;
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.ash.rollback_network_config.mojom.RollbackNetworkConfig_RollbackConfigExport_ResponseParamsSpec, header, rawHeader);
               responder(response);
...
mojo.internal.bindings.ash.rollback_network_config.mojom.RollbackNetworkConfigReceiver = mojo.internal.bindings.ash.rollback_network_config.mojom.RollbackNetworkConfigReceiver;
