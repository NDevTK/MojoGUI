...
mojo.internal.bindings.blink.mojom.GeolocationService = {};
mojo.internal.bindings.blink.mojom.GeolocationServiceSpec = { $ : {} };
mojo.internal.bindings.blink.mojom.GeolocationService.$interfaceName = 'blink.mojom.GeolocationService';
...
mojo.internal.bindings.blink.mojom.GeolocationServiceRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.blink.mojom.GeolocationServicePendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.blink.mojom.GeolocationServiceRemoteCallHandler(this.proxy);
  }
  ...
  createGeolocation(arg_receiver, arg_user_gesture) {
    return this.$.createGeolocation(arg_receiver, arg_user_gesture);
  }
};

mojo.internal.bindings.blink.mojom.GeolocationServiceRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('blink.mojom.GeolocationService', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.blink.mojom.GeolocationService.getRemote = function() {
  let remote = new mojo.internal.bindings.blink.mojom.GeolocationServiceRemote();
...
mojo.internal.bindings.blink.mojom.GeolocationServiceReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('blink.mojom.GeolocationService', [
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.blink.mojom.GeolocationService_CreateGeolocation_ParamsSpec.$.structSpec);
        ...
        case 0: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.blink.mojom.GeolocationService_CreateGeolocation_ResponseParamsSpec, header, rawHeader);
               responder(response);
...
mojo.internal.bindings.blink.mojom.GeolocationServiceReceiver = mojo.internal.bindings.blink.mojom.GeolocationServiceReceiver;
