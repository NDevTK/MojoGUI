...
mojo.internal.bindings.ash.screens_osauth.mojom.LocalDataLossWarningPageHandlerRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.ash.screens_osauth.mojom.LocalDataLossWarningPageHandlerRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.ash.screens_osauth.mojom.LocalDataLossWarningPageHandler.getRemote = function() {
  let remote = new mojo.internal.bindings.ash.screens_osauth.mojom.LocalDataLossWarningPageHandlerRemote();
...
mojo.internal.bindings.ash.screens_osauth.mojom.LocalDataLossWarningPageHandlerReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ash.screens_osauth.mojom.LocalDataLossWarningPageHandler_OnPowerwash_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OnPowerwash failed with TypeError');
           }
        }
        // Try Method 1: OnRecreateUser
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ash.screens_osauth.mojom.LocalDataLossWarningPageHandler_OnRecreateUser_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OnRecreateUser failed with TypeError');
           }
        }
        // Try Method 2: OnCancel
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ash.screens_osauth.mojom.LocalDataLossWarningPageHandler_OnCancel_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OnCancel failed with TypeError');
           }
        }
        // Try Method 3: OnBack
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ash.screens_osauth.mojom.LocalDataLossWarningPageHandler_OnBack_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OnBack failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.ash.screens_osauth.mojom.LocalDataLossWarningPageHandler_OnPowerwash_ParamsSpec.$.structSpec);
        ...
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.ash.screens_osauth.mojom.LocalDataLossWarningPageHandler_OnRecreateUser_ParamsSpec.$.structSpec);
        ...
        case 2: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.ash.screens_osauth.mojom.LocalDataLossWarningPageHandler_OnCancel_ParamsSpec.$.structSpec);
        ...
        case 3: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.ash.screens_osauth.mojom.LocalDataLossWarningPageHandler_OnBack_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.ash.screens_osauth.mojom.LocalDataLossWarningPageHandlerReceiver = mojo.internal.bindings.ash.screens_osauth.mojom.LocalDataLossWarningPageHandlerReceiver;
