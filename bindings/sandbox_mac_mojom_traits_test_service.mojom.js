...
mojo.internal.bindings.sandbox.mac.mojom.TraitsTestService = {};
mojo.internal.bindings.sandbox.mac.mojom.TraitsTestServiceSpec = { $ : {} };
mojo.internal.bindings.sandbox.mac.mojom.TraitsTestService.$interfaceName = 'sandbox.mac.mojom.TraitsTestService';
...
mojo.internal.bindings.sandbox.mac.mojom.TraitsTestServiceRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.sandbox.mac.mojom.TraitsTestServicePendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.sandbox.mac.mojom.TraitsTestServiceRemoteCallHandler(this.proxy);
  }
  ...
  echoSeatbeltExtensionToken(arg_in) {
    return this.$.echoSeatbeltExtensionToken(arg_in);
  }
};

mojo.internal.bindings.sandbox.mac.mojom.TraitsTestServiceRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('sandbox.mac.mojom.TraitsTestService', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.sandbox.mac.mojom.TraitsTestService.getRemote = function() {
  let remote = new mojo.internal.bindings.sandbox.mac.mojom.TraitsTestServiceRemote();
...
mojo.internal.bindings.sandbox.mac.mojom.TraitsTestServiceReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('sandbox.mac.mojom.TraitsTestService', [
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        // Try Method 0: EchoSeatbeltExtensionToken
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.sandbox.mac.mojom.TraitsTestService_EchoSeatbeltExtensionToken_ParamsSpec.$.structSpec);
             console.log('[GeneratedReceiver] Discovery SUCCESS: ' + header.ordinal + ' -> EchoSeatbeltExtensionToken (0)');
        ...
        case 0: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.sandbox.mac.mojom.TraitsTestService_EchoSeatbeltExtensionToken_ResponseParamsSpec, header, rawHeader);
               responder(response);
...
mojo.internal.bindings.sandbox.mac.mojom.TraitsTestServiceReceiver = mojo.internal.bindings.sandbox.mac.mojom.TraitsTestServiceReceiver;
