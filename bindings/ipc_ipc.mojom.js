    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      switch (dispatchId) {
        case 0: {
          ...
          const params = decoder.decodeStruct(IPC.mojom.Channel_SetPeerPid_ParamsSpec.$, 0);
        ...
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStruct(IPC.mojom.Channel_GetAssociatedInterface_ParamsSpec.$, 0);
