...
mojo.internal.Struct(
    mojo.internal.bindings.IPC.mojom.MessageSpec, 'IPC.mojom.Message', [
      ...
      mojo.internal.StructField('arg_handles', 8, 0, mojo.internal.Array(mojo.internal.Pointer, false), null, true, 0, undefined),
    ],
    [[0, 24]]);
...
mojo.internal.bindings.IPC.mojom.ChannelRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.IPC.mojom.ChannelPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.IPC.mojom.ChannelRemoteCallHandler(this.proxy);
  }
  ...
  setPeerPid(arg_pid) {
    return this.$.setPeerPid(arg_pid);
  }
  getAssociatedInterface(arg_receiver) {
    return this.$.getAssociatedInterface(arg_receiver);
  }
};
...
mojo.internal.bindings.IPC.mojom.Channel.getRemote = function() {
  let remote = new mojo.internal.bindings.IPC.mojom.ChannelRemote();
...
mojo.internal.bindings.IPC.mojom.ChannelReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.IPC.mojom.Channel_SetPeerPid_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for SetPeerPid failed with TypeError');
           }
        }
        // Try Method 1: GetAssociatedInterface
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.IPC.mojom.Channel_GetAssociatedInterface_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
...
mojo.internal.bindings.IPC.mojom.ChannelReceiver = mojo.internal.bindings.IPC.mojom.ChannelReceiver;

mojo.internal.bindings.IPC.mojom.ChannelPtr = mojo.internal.bindings.IPC.mojom.ChannelRemote;
mojo.internal.bindings.IPC.mojom.ChannelRequest = mojo.internal.bindings.IPC.mojom.ChannelPendingReceiver;


// Interface: ChannelBootstrap
mojo.internal.bindings.IPC.mojom.ChannelBootstrapPendingReceiver = class {
  constructor(handle) {
    this.handle = handle;
  }
};
...
mojo.internal.bindings.IPC.mojom.ChannelBootstrapRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.IPC.mojom.ChannelBootstrapRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.IPC.mojom.ChannelBootstrap.getRemote = function() {
  let remote = new mojo.internal.bindings.IPC.mojom.ChannelBootstrapRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
...
mojo.internal.bindings.IPC.mojom.ChannelBootstrapReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
...
mojo.internal.bindings.IPC.mojom.ChannelBootstrapReceiver = mojo.internal.bindings.IPC.mojom.ChannelBootstrapReceiver;
