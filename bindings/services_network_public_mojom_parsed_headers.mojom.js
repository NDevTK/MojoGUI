  ...
  $: {
    structSpec: {
      ...
      fields: [
        ...
        { name: 'xfo', packedOffset: 88, packedBitOffset: 0, type: network.mojom.XFrameOptionsValueSpec, nullable: false },
        { name: 'link_headers', packedOffset: 96, packedBitOffset: 0, type: mojo.internal.Array, nullable: false },
        { name: 'timing_allow_origin', packedOffset: 104, packedBitOffset: 0, type: network.mojom.TimingAllowOriginSpec, nullable: true },
        ...
        { name: 'no_vary_search_with_parse_error', packedOffset: 152, packedBitOffset: 0, type: network.mojom.NoVarySearchWithParseErrorSpec, nullable: true },
