...
chrome.mojom.ChromeRenderFrame_SetWindowFeatures_ParamsSpec = {
  $: {
    structSpec: {
      ...
      packedSize: 16,
      fields: [
        { name: 'window_features', packedOffset: 0, packedBitOffset: 0, type: blink.mojom.WindowFeaturesSpec, nullable: false },
      ],
      versions: [{version: 0}]
    }
  }
  ...
  $: {
    structSpec: {
      ...
      fields: [
        ...
        { name: 'image_max_size_pixels', packedOffset: 8, packedBitOffset: 0, type: gfx.mojom.SizeSpec, nullable: false },
        { name: 'image_format', packedOffset: 16, packedBitOffset: 0, type: chrome.mojom.ImageFormatSpec, nullable: false },
...
chrome.mojom.ChromeRenderFrame_ExecuteWebUIJavaScript_ParamsSpec = {
  $: {
    structSpec: {
      ...
      packedSize: 16,
      fields: [
        { name: 'javascript', packedOffset: 0, packedBitOffset: 0, type: mojo_base.mojom.String16Spec, nullable: false },
      ],
      versions: [{version: 0}]
    }
  }
...
chrome.mojom.ChromeRenderFrame_InvokeTool_ParamsSpec = {
  $: {
    structSpec: {
      ...
      packedSize: 16,
      fields: [
        { name: 'request', packedOffset: 0, packedBitOffset: 0, type: actor.mojom.ToolInvocationSpec, nullable: false },
      ],
      versions: [{version: 0}]
    }
  }
...
chrome.mojom.ChromeRenderFrame_InvokeTool_ResponseParamsSpec = {
  $: {
    structSpec: {
      ...
      packedSize: 16,
      fields: [
        { name: 'result', packedOffset: 0, packedBitOffset: 0, type: actor.mojom.ActionResultSpec, nullable: false },
      ],
      versions: [{version: 0}]
    }
  }
