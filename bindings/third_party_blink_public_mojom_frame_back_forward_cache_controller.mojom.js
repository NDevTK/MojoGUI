...
mojo.internal.bindings.blink.mojom.BackForwardCacheControllerHostRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.blink.mojom.BackForwardCacheControllerHostRemoteCallHandler(this.proxy);
  }
  ...
  evictFromBackForwardCache(arg_reason, arg_source) {
    return this.$.evictFromBackForwardCache(arg_reason, arg_source);
  }
  didChangeBackForwardCacheDisablingFeatures(arg_details) {
    return this.$.didChangeBackForwardCacheDisablingFeatures(arg_details);
  }
};
...
mojo.internal.bindings.blink.mojom.BackForwardCacheControllerHost.getRemote = function() {
  let remote = new mojo.internal.bindings.blink.mojom.BackForwardCacheControllerHostRemote();
...
mojo.internal.bindings.blink.mojom.BackForwardCacheControllerHostReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.blink.mojom.BackForwardCacheControllerHost_EvictFromBackForwardCache_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for EvictFromBackForwardCache failed with TypeError');
           }
        }
        // Try Method 1: DidChangeBackForwardCacheDisablingFeatures
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.blink.mojom.BackForwardCacheControllerHost_DidChangeBackForwardCacheDisablingFeatures_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for DidChangeBackForwardCacheDisablingFeatures failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.blink.mojom.BackForwardCacheControllerHostReceiver = mojo.internal.bindings.blink.mojom.BackForwardCacheControllerHostReceiver;
