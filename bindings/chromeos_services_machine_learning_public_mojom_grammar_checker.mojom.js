...
mojo.internal.bindings.chromeos.machine_learning.mojom.GrammarCheckerRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.chromeos.machine_learning.mojom.GrammarCheckerRemoteCallHandler(this.proxy);
  }
  ...
  check(arg_query) {
    return this.$.check(arg_query);
  }
};

mojo.internal.bindings.chromeos.machine_learning.mojom.GrammarCheckerRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('chromeos.machine_learning.mojom.GrammarChecker', [
      { explicit: 0 },
    ]);
  }
...
mojo.internal.bindings.chromeos.machine_learning.mojom.GrammarChecker.getRemote = function() {
  let remote = new mojo.internal.bindings.chromeos.machine_learning.mojom.GrammarCheckerRemote();
...
mojo.internal.bindings.chromeos.machine_learning.mojom.GrammarCheckerReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('chromeos.machine_learning.mojom.GrammarChecker', [
      { explicit: 0 },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.chromeos.machine_learning.mojom.GrammarChecker_Check_ParamsSpec.$.structSpec);
        ...
        case 0: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.chromeos.machine_learning.mojom.GrammarChecker_Check_ResponseParamsSpec, header, rawHeader);
               responder(response);
...
mojo.internal.bindings.chromeos.machine_learning.mojom.GrammarCheckerReceiver = mojo.internal.bindings.chromeos.machine_learning.mojom.GrammarCheckerReceiver;
