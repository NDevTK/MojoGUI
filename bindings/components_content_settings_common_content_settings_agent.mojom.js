...
mojo.internal.bindings.content_settings.mojom.ContentSettingsAgent = {};
mojo.internal.bindings.content_settings.mojom.ContentSettingsAgentSpec = { $ : {} };
mojo.internal.bindings.content_settings.mojom.ContentSettingsAgent.$interfaceName = 'content_settings.mojom.ContentSettingsAgent';
...
mojo.internal.bindings.content_settings.mojom.ContentSettingsAgentRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.content_settings.mojom.ContentSettingsAgentPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.content_settings.mojom.ContentSettingsAgentRemoteCallHandler(this.proxy);
  }
  ...
  sendRendererContentSettingRules(arg_renderer_settings) {
    return this.$.sendRendererContentSettingRules(arg_renderer_settings);
  }
};

mojo.internal.bindings.content_settings.mojom.ContentSettingsAgentRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('content_settings.mojom.ContentSettingsAgent', [
      { explicit: null },
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.content_settings.mojom.ContentSettingsAgent.getRemote = function() {
  let remote = new mojo.internal.bindings.content_settings.mojom.ContentSettingsAgentRemote();
...
mojo.internal.bindings.content_settings.mojom.ContentSettingsAgentReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('content_settings.mojom.ContentSettingsAgent', [
      { explicit: null },
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.content_settings.mojom.ContentSettingsAgent_SetAllowRunningInsecureContent_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for SetAllowRunningInsecureContent failed with TypeError');
           }
        }
        // Try Method 1: SendRendererContentSettingRules
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.content_settings.mojom.ContentSettingsAgent_SendRendererContentSettingRules_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for SendRendererContentSettingRules failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.content_settings.mojom.ContentSettingsAgent_SetAllowRunningInsecureContent_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.content_settings.mojom.ContentSettingsAgentReceiver = mojo.internal.bindings.content_settings.mojom.ContentSettingsAgentReceiver;
