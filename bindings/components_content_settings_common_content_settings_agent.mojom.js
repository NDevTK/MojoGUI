  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(content_settings.mojom.ContentSettingsAgent_SetAllowRunningInsecureContent_ParamsSpec);
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(content_settings.mojom.ContentSettingsAgent_SendRendererContentSettingRules_ParamsSpec);
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(content_settings.mojom.ContentSettingsAgent_SetAllowRunningInsecureContent_ParamsSpec.$.structSpec);
        ...
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(content_settings.mojom.ContentSettingsAgent_SendRendererContentSettingRules_ParamsSpec.$.structSpec);
