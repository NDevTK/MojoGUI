...
mojo.internal.bindings.blink.mojom.ReportingObserverRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.blink.mojom.ReportingObserverPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.blink.mojom.ReportingObserverRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.blink.mojom.ReportingObserver.getRemote = function() {
  let remote = new mojo.internal.bindings.blink.mojom.ReportingObserverRemote();
...
mojo.internal.bindings.blink.mojom.ReportingObserverReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.blink.mojom.ReportingObserver_Notify_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for Notify failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.blink.mojom.ReportingObserverReceiver = mojo.internal.bindings.blink.mojom.ReportingObserverReceiver;
