  ...
  $: {
    structSpec: {
      ...
      fields: [
        ...
        { name: 'content_color_usage', packedOffset: 8, packedBitOffset: 0, type: gfx.mojom.ContentColorUsageSpec, nullable: false },
        { name: 'recorded_bounds', packedOffset: 16, packedBitOffset: 0, type: gfx.mojom.RectSpec, nullable: false },
  ...
  $: {
    structSpec: {
      ...
      fields: [
        ...
        { name: 'image_bounds', packedOffset: 8, packedBitOffset: 0, type: gfx.mojom.SizeSpec, nullable: false },
        { name: 'aperture', packedOffset: 16, packedBitOffset: 0, type: gfx.mojom.RectSpec, nullable: false },
        { name: 'thumb_ui_resource_id', packedOffset: 24, packedBitOffset: 0, type: cc.mojom.UIResourceIdSpec, nullable: false },
        { name: 'track_and_buttons_ui_resource_id', packedOffset: 32, packedBitOffset: 0, type: cc.mojom.UIResourceIdSpec, nullable: false },
...
viz.mojom.PaintedScrollbarLayerExtraSpec = {
  $: {
    structSpec: {
      ...
      fields: [
        { name: 'scrollbar_base_extra', packedOffset: 0, packedBitOffset: 0, type: viz.mojom.ScrollbarLayerBaseExtraSpec, nullable: false },
        { name: 'internal_content_bounds', packedOffset: 8, packedBitOffset: 0, type: gfx.mojom.SizeSpec, nullable: false },
        { name: 'back_button_rect', packedOffset: 16, packedBitOffset: 0, type: gfx.mojom.RectSpec, nullable: false },
        { name: 'forward_button_rect', packedOffset: 24, packedBitOffset: 0, type: gfx.mojom.RectSpec, nullable: false },
        { name: 'track_rect', packedOffset: 32, packedBitOffset: 0, type: gfx.mojom.RectSpec, nullable: false },
        { name: 'thumb_color', packedOffset: 40, packedBitOffset: 0, type: skia.mojom.SkColor4fSpec, nullable: true },
        { name: 'track_and_buttons_image_bounds', packedOffset: 48, packedBitOffset: 0, type: gfx.mojom.SizeSpec, nullable: false },
        { name: 'track_and_buttons_aperture', packedOffset: 56, packedBitOffset: 0, type: gfx.mojom.RectSpec, nullable: false },
        { name: 'track_and_buttons_ui_resource_id', packedOffset: 64, packedBitOffset: 0, type: cc.mojom.UIResourceIdSpec, nullable: false },
        { name: 'thumb_ui_resource_id', packedOffset: 72, packedBitOffset: 0, type: cc.mojom.UIResourceIdSpec, nullable: false },
...
viz.mojom.SolidColorScrollbarLayerExtraSpec = {
  $: {
    structSpec: {
      ...
      fields: [
        { name: 'scrollbar_base_extra', packedOffset: 0, packedBitOffset: 0, type: viz.mojom.ScrollbarLayerBaseExtraSpec, nullable: false },
        { name: 'color', packedOffset: 8, packedBitOffset: 0, type: skia.mojom.SkColor4fSpec, nullable: false },
  ...
  $: {
    structSpec: {
      ...
      fields: [
        ...
        { name: 'ui_resource_id', packedOffset: 24, packedBitOffset: 0, type: cc.mojom.UIResourceIdSpec, nullable: false },
        { name: 'image_bounds', packedOffset: 32, packedBitOffset: 0, type: gfx.mojom.SizeSpec, nullable: false },
        { name: 'uv_top_left', packedOffset: 40, packedBitOffset: 0, type: gfx.mojom.PointFSpec, nullable: false },
        { name: 'uv_bottom_right', packedOffset: 48, packedBitOffset: 0, type: gfx.mojom.PointFSpec, nullable: false },
  ...
  $: {
    structSpec: {
      ...
      fields: [
        ...
        { name: 'hit_test_opaqueness', packedOffset: 24, packedBitOffset: 0, type: cc.mojom.HitTestOpaquenessSpec, nullable: false },
        { name: 'background_color', packedOffset: 32, packedBitOffset: 0, type: skia.mojom.SkColor4fSpec, nullable: false },
        { name: 'safe_opaque_background_color', packedOffset: 40, packedBitOffset: 0, type: skia.mojom.SkColor4fSpec, nullable: false },
        { name: 'element_id', packedOffset: 48, packedBitOffset: 0, type: cc.mojom.ElementIdSpec, nullable: false },
...
viz.mojom.StickyPositionNodeDataSpec = {
  $: {
    structSpec: {
      ...
      packedSize: 96,
      fields: [
        { name: 'constraint_box_rect', packedOffset: 0, packedBitOffset: 0, type: gfx.mojom.RectFSpec, nullable: false },
        { name: 'scroll_container_relative_sticky_box_rect', packedOffset: 8, packedBitOffset: 0, type: gfx.mojom.RectFSpec, nullable: false },
        { name: 'scroll_container_relative_containing_block_rect', packedOffset: 16, packedBitOffset: 0, type: gfx.mojom.RectFSpec, nullable: false },
        { name: 'pixel_snap_offset', packedOffset: 24, packedBitOffset: 0, type: gfx.mojom.Vector2dFSpec, nullable: false },
        { name: 'total_sticky_box_sticky_offset', packedOffset: 32, packedBitOffset: 0, type: gfx.mojom.Vector2dFSpec, nullable: false },
        { name: 'total_containing_block_sticky_offset', packedOffset: 40, packedBitOffset: 0, type: gfx.mojom.Vector2dFSpec, nullable: false },
  ...
  $: {
    structSpec: {
      ...
      fields: [
        ...
        { name: 'local', packedOffset: 8, packedBitOffset: 0, type: gfx.mojom.TransformSpec, nullable: false },
        { name: 'origin', packedOffset: 16, packedBitOffset: 0, type: gfx.mojom.Point3FSpec, nullable: false },
        { name: 'post_translation', packedOffset: 24, packedBitOffset: 0, type: gfx.mojom.Vector2dFSpec, nullable: false },
        { name: 'to_parent', packedOffset: 32, packedBitOffset: 0, type: gfx.mojom.TransformSpec, nullable: false },
        { name: 'scroll_offset', packedOffset: 40, packedBitOffset: 0, type: gfx.mojom.PointFSpec, nullable: false },
        { name: 'snap_amount', packedOffset: 48, packedBitOffset: 0, type: gfx.mojom.Vector2dFSpec, nullable: false },
        { name: 'visible_frame_element_id', packedOffset: 56, packedBitOffset: 0, type: cc.mojom.ElementIdSpec, nullable: false },
...
viz.mojom.ClipNodeSpec = {
  $: {
    structSpec: {
      ...
      packedSize: 32,
      fields: [
        { name: 'clip', packedOffset: 0, packedBitOffset: 0, type: gfx.mojom.RectFSpec, nullable: false },
...
viz.mojom.ScrollNodeSpec = {
  $: {
    structSpec: {
      ...
      packedSize: 56,
      fields: [
        { name: 'container_bounds', packedOffset: 0, packedBitOffset: 0, type: gfx.mojom.SizeSpec, nullable: false },
        { name: 'bounds', packedOffset: 8, packedBitOffset: 0, type: gfx.mojom.SizeSpec, nullable: false },
