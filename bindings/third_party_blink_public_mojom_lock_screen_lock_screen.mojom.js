...
mojo.internal.bindings.blink.mojom.LockScreenServiceStatus = {
  kSuccess: 0,
...
mojo.internal.bindings.blink.mojom.LockScreenServiceRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.blink.mojom.LockScreenServicePendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.blink.mojom.LockScreenServiceRemoteCallHandler(this.proxy);
  }
  ...
  setData(arg_key, arg_data) {
    return this.$.setData(arg_key, arg_data);
  }
};

mojo.internal.bindings.blink.mojom.LockScreenServiceRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('blink.mojom.LockScreenService', [
      { explicit: null },
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.blink.mojom.LockScreenService.getRemote = function() {
  let remote = new mojo.internal.bindings.blink.mojom.LockScreenServiceRemote();
...
mojo.internal.bindings.blink.mojom.LockScreenServiceReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('blink.mojom.LockScreenService', [
      { explicit: null },
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.blink.mojom.LockScreenService_GetKeys_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for GetKeys failed with TypeError');
           }
        }
        // Try Method 1: SetData
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.blink.mojom.LockScreenService_SetData_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for SetData failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.blink.mojom.LockScreenService_GetKeys_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.blink.mojom.LockScreenServiceReceiver = mojo.internal.bindings.blink.mojom.LockScreenServiceReceiver;
