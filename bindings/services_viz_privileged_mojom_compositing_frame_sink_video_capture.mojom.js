...
mojo.internal.bindings.viz.mojom.FrameSinkVideoCapturer_SetIsSecure_ParamsSpec = mojo.internal.bindings.viz.mojom.FrameSinkVideoCapturer_SetIsSecure_ParamsSpec || { $: {} };
if (mojo.internal.bindings.viz.mojom.FrameSinkVideoCapturer_SetIsSecure_ParamsSpec.$.structSpec && mojo.internal.bindings.viz.mojom.FrameSinkVideoCapturer_SetIsSecure_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.viz.mojom.FrameSinkVideoCapturer_SetIsSecure_ParamsSpec.$ = {};
...
mojo.internal.bindings.viz.mojom.FrameSinkVideoCapturer_InvalidateBuffers_ParamsSpec = mojo.internal.bindings.viz.mojom.FrameSinkVideoCapturer_InvalidateBuffers_ParamsSpec || { $: {} };
if (mojo.internal.bindings.viz.mojom.FrameSinkVideoCapturer_InvalidateBuffers_ParamsSpec.$.structSpec && mojo.internal.bindings.viz.mojom.FrameSinkVideoCapturer_InvalidateBuffers_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.viz.mojom.FrameSinkVideoCapturer_InvalidateBuffers_ParamsSpec.$ = {};
...
mojo.internal.bindings.viz.mojom.FrameSinkVideoCapturerRemote = class {
  ...
  setIsSecure(arg_secure) {
    return this.$.setIsSecure(arg_secure);
  }
...
mojo.internal.bindings.viz.mojom.FrameSinkVideoCapturerRemoteCallHandler = class {
  ...
  setIsSecure(arg_secure) {
    return this.proxy.sendMessage(
      ...
      mojo.internal.bindings.viz.mojom.FrameSinkVideoCapturer_SetIsSecure_ParamsSpec,
      null,
      [arg_secure],
      false);
  }
  ...
  invalidateBuffers() {
    return this.proxy.sendMessage(
      ...
      mojo.internal.bindings.viz.mojom.FrameSinkVideoCapturer_InvalidateBuffers_ParamsSpec,
      null,
      [],
      false);
  }
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        ...
        case 6: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.viz.mojom.FrameSinkVideoCapturer_SetIsSecure_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.setIsSecure');
          const result = this.impl.setIsSecure(params.arg_secure);
          break;
        }
        case 7: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
        ...
        case 11: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.viz.mojom.FrameSinkVideoCapturer_InvalidateBuffers_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.invalidateBuffers');
          const result = this.impl.invalidateBuffers();
          break;
        }
        case 12: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
...
mojo.internal.Struct(
    mojo.internal.bindings.viz.mojom.FrameSinkVideoCapturer_SetIsSecure_ParamsSpec, 'viz.mojom.FrameSinkVideoCapturer_SetIsSecure_Params', [
...
mojo.internal.Struct(
    mojo.internal.bindings.viz.mojom.FrameSinkVideoCapturer_InvalidateBuffers_ParamsSpec, 'viz.mojom.FrameSinkVideoCapturer_InvalidateBuffers_Params', [
    ],
    [[0, 8]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.viz.mojom.FrameSinkVideoCapturer_CreateOverlay_ParamsSpec, 'viz.mojom.FrameSinkVideoCapturer_CreateOverlay_Params', [
      ...
      mojo.internal.StructField('arg_receiver', 4, 0, mojo.internal.InterfaceRequest(mojo.internal.bindings.viz.mojom.FrameSinkVideoCaptureOverlayPendingReceiver), null, false, 0, undefined),
    ],
    [[0, 16]]);
