...
mojo.internal.bindings.blink.mojom.WebLaunchServicePendingReceiver = class {
  constructor(handle) {
    this.handle = handle;
  }
};

mojo.internal.bindings.blink.mojom.WebLaunchServiceRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.blink.mojom.WebLaunchServicePendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.blink.mojom.WebLaunchServiceRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.blink.mojom.WebLaunchService.getRemote = function() {
  let remote = new mojo.internal.bindings.blink.mojom.WebLaunchServiceRemote();
...
mojo.internal.bindings.blink.mojom.WebLaunchServiceReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.blink.mojom.WebLaunchService_SetLaunchFiles_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for SetLaunchFiles failed with TypeError');
           }
        }
        // Try Method 1: EnqueueLaunchParams
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.blink.mojom.WebLaunchService_EnqueueLaunchParams_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for EnqueueLaunchParams failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.blink.mojom.WebLaunchServiceReceiver = mojo.internal.bindings.blink.mojom.WebLaunchServiceReceiver;

mojo.internal.bindings.blink.mojom.WebLaunchServicePtr = mojo.internal.bindings.blink.mojom.WebLaunchServiceRemote;
mojo.internal.bindings.blink.mojom.WebLaunchServiceRequest = mojo.internal.bindings.blink.mojom.WebLaunchServicePendingReceiver;
