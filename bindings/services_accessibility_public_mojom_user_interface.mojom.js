        ...
        case 2: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.ax.mojom.UserInterface_ShowConfirmationDialog_ResponseParamsSpec, header, rawHeader);
               responder(response);
