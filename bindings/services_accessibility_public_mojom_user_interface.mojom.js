...
// Enum: FocusType
mojo.internal.bindings.ax.mojom.FocusType = {
  kGlow: 0,
  kSolid: 1,
  kDashed: 2,
};
...
mojo.internal.bindings.ax.mojom.FocusRingStackingOrder = {
...
mojo.internal.Struct(
    mojo.internal.bindings.ax.mojom.FocusRingInfoSpec, 'ax.mojom.FocusRingInfo', [
      ...
      mojo.internal.StructField('arg_color', 8, 0, mojo.internal.bindings.skia.mojom.SkColorSpec, null, true, 0, undefined),
      mojo.internal.StructField('arg_secondary_color', 16, 0, mojo.internal.bindings.skia.mojom.SkColorSpec, null, true, 0, undefined),
      mojo.internal.StructField('arg_background_color', 24, 0, mojo.internal.bindings.skia.mojom.SkColorSpec, null, true, 0, undefined),
      mojo.internal.StructField('arg_id', 32, 0, mojo.internal.String, null, true, 0, undefined),
      mojo.internal.StructField('arg_type', 40, 0, mojo.internal.bindings.ax.mojom.FocusTypeSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_stacking_order', 44, 0, mojo.internal.bindings.ax.mojom.FocusRingStackingOrderSpec, null, true, 0, undefined),
    ],
    [[0, 56]]);
...
mojo.internal.bindings.ax.mojom.UserInterfaceRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.ax.mojom.UserInterfaceRemoteCallHandler(this.proxy);
  }
  ...
  darkenScreen(arg_darken) {
    return this.$.darkenScreen(arg_darken);
  }
  openSettingsSubpage(arg_subpage) {
    return this.$.openSettingsSubpage(arg_subpage);
  }
  showConfirmationDialog(arg_title, arg_description, arg_cancelName) {
    return this.$.showConfirmationDialog(arg_title, arg_description, arg_cancelName);
  }
  setFocusRings(arg_focus_rings, arg_at_type) {
    return this.$.setFocusRings(arg_focus_rings, arg_at_type);
  }
  setHighlights(arg_rects, arg_color) {
    return this.$.setHighlights(arg_rects, arg_color);
  }
  setVirtualKeyboardVisible(arg_is_visible) {
    return this.$.setVirtualKeyboardVisible(arg_is_visible);
  }
};
...
mojo.internal.bindings.ax.mojom.UserInterface.getRemote = function() {
  let remote = new mojo.internal.bindings.ax.mojom.UserInterfaceRemote();
...
mojo.internal.bindings.ax.mojom.UserInterfaceReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ax.mojom.UserInterface_DarkenScreen_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for DarkenScreen failed with TypeError');
           }
        }
        // Try Method 1: OpenSettingsSubpage
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ax.mojom.UserInterface_OpenSettingsSubpage_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OpenSettingsSubpage failed with TypeError');
           }
        }
        // Try Method 2: ShowConfirmationDialog
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ax.mojom.UserInterface_ShowConfirmationDialog_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for ShowConfirmationDialog failed with TypeError');
           }
        }
        // Try Method 3: SetFocusRings
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ax.mojom.UserInterface_SetFocusRings_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for SetFocusRings failed with TypeError');
           }
        }
        // Try Method 4: SetHighlights
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ax.mojom.UserInterface_SetHighlights_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for SetHighlights failed with TypeError');
           }
        }
        // Try Method 5: SetVirtualKeyboardVisible
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ax.mojom.UserInterface_SetVirtualKeyboardVisible_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for SetVirtualKeyboardVisible failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.ax.mojom.UserInterfaceReceiver = mojo.internal.bindings.ax.mojom.UserInterfaceReceiver;
