...
mojo.internal.bindings.theme_color_picker.mojom.ThemeColorPickerHandlerFactoryRemote = class {
  ...
  createThemeColorPickerHandler(arg_client, arg_handler) {
    return this.$.createThemeColorPickerHandler(arg_client, arg_handler);
  }
};
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        case 0: {
          ...
          const result = this.impl.createThemeColorPickerHandler(params.arg_client, params.arg_handler);
          break;
        }
      }
      } catch (err) {
        ...
        case 0: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              const val = (response && typeof response === 'object' && 'arg_colors' in response) ? response['arg_colors'] : response;
              const resp_obj = { 'arg_colors': val };
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.theme_color_picker.mojom.ThemeColorPickerHandler_GetChromeColors_ResponseParamsSpec.$.structSpec, resp_obj);
...
mojo.internal.Struct(
    mojo.internal.bindings.theme_color_picker.mojom.ThemeColorPickerHandlerFactory_CreateThemeColorPickerHandler_ParamsSpec, 'theme_color_picker.mojom.ThemeColorPickerHandlerFactory_CreateThemeColorPickerHandler_Params', [
      mojo.internal.StructField('arg_client', 0, 0, mojo.internal.InterfaceProxy(mojo.internal.bindings.theme_color_picker.mojom.ThemeColorPickerClientRemote), null, false, 0, undefined),
      mojo.internal.StructField('arg_handler', 8, 0, mojo.internal.InterfaceRequest(mojo.internal.bindings.theme_color_picker.mojom.ThemeColorPickerHandlerPendingReceiver), null, false, 0, undefined),
    ],
    [[0, 24]]);
