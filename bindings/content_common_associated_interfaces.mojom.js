...
mojo.internal.bindings.content.mojom.RouteProvider = {};
mojo.internal.bindings.content.mojom.RouteProviderSpec = { $ : {} };
mojo.internal.bindings.content.mojom.RouteProvider.$interfaceName = 'content.mojom.RouteProvider';
...
mojo.internal.bindings.content.mojom.RouteProviderRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.content.mojom.RouteProviderRemoteCallHandler(this.proxy);
  }
  ...
  getRoute(arg_frame_token, arg_receiver) {
    return this.$.getRoute(arg_frame_token, arg_receiver);
  }
};

mojo.internal.bindings.content.mojom.RouteProviderRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('content.mojom.RouteProvider', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.content.mojom.RouteProvider.getRemote = function() {
  let remote = new mojo.internal.bindings.content.mojom.RouteProviderRemote();
...
mojo.internal.bindings.content.mojom.RouteProviderReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('content.mojom.RouteProvider', [
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.content.mojom.RouteProvider_GetRoute_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for GetRoute failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.content.mojom.RouteProviderReceiver = mojo.internal.bindings.content.mojom.RouteProviderReceiver;
