...
mojo.internal.bindings.cros.mojom.CameraHalClient = {};
mojo.internal.bindings.cros.mojom.CameraHalClientSpec = { $ : {} };
...
mojo.internal.bindings.cros.mojom.CameraHalClientRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.cros.mojom.CameraHalClientRemoteCallHandler(this.proxy);
  }
  ...
  setUpChannel(arg_camera_module) {
    return this.$.setUpChannel(arg_camera_module);
  }
};

mojo.internal.bindings.cros.mojom.CameraHalClientRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('cros.mojom.CameraHalClient', [
      { explicit: 0 },
    ]);
  }
...
mojo.internal.bindings.cros.mojom.CameraHalClient.getRemote = function() {
  let remote = new mojo.internal.bindings.cros.mojom.CameraHalClientRemote();
...
mojo.internal.bindings.cros.mojom.CameraHalClientReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('cros.mojom.CameraHalClient', [
      { explicit: 0 },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.cros.mojom.CameraHalClient_SetUpChannel_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.cros.mojom.CameraHalClientReceiver = mojo.internal.bindings.cros.mojom.CameraHalClientReceiver;
