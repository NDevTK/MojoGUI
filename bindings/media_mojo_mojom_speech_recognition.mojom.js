...
mojo.internal.bindings.media.mojom.ConfidenceLevelSpec = mojo.internal.bindings.media.mojom.ConfidenceLevelSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.media.mojom.AsrSwitchResultSpec = mojo.internal.bindings.media.mojom.AsrSwitchResultSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.media.mojom.SpeechRecognitionModeSpec = mojo.internal.bindings.media.mojom.SpeechRecognitionModeSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.media.mojom.RecognizerClientTypeSpec = mojo.internal.bindings.media.mojom.RecognizerClientTypeSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.media.mojom.HypothesisPartsSpec = mojo.internal.bindings.media.mojom.HypothesisPartsSpec || { $: {} };
if (mojo.internal.bindings.media.mojom.HypothesisPartsSpec.$.structSpec && mojo.internal.bindings.media.mojom.HypothesisPartsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.media.mojom.HypothesisPartsSpec.$ = {};
mojo.internal.bindings.media.mojom.MediaTimestampRangeSpec = mojo.internal.bindings.media.mojom.MediaTimestampRangeSpec || { $: {} };
if (mojo.internal.bindings.media.mojom.MediaTimestampRangeSpec.$.structSpec && mojo.internal.bindings.media.mojom.MediaTimestampRangeSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.media.mojom.MediaTimestampRangeSpec.$ = {};
mojo.internal.bindings.media.mojom.TimingInformationSpec = mojo.internal.bindings.media.mojom.TimingInformationSpec || { $: {} };
if (mojo.internal.bindings.media.mojom.TimingInformationSpec.$.structSpec && mojo.internal.bindings.media.mojom.TimingInformationSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.media.mojom.TimingInformationSpec.$ = {};
mojo.internal.bindings.media.mojom.SpeechRecognitionResultSpec = mojo.internal.bindings.media.mojom.SpeechRecognitionResultSpec || { $: {} };
if (mojo.internal.bindings.media.mojom.SpeechRecognitionResultSpec.$.structSpec && mojo.internal.bindings.media.mojom.SpeechRecognitionResultSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.media.mojom.SpeechRecognitionResultSpec.$ = {};
mojo.internal.bindings.media.mojom.LanguageIdentificationEventSpec = mojo.internal.bindings.media.mojom.LanguageIdentificationEventSpec || { $: {} };
if (mojo.internal.bindings.media.mojom.LanguageIdentificationEventSpec.$.structSpec && mojo.internal.bindings.media.mojom.LanguageIdentificationEventSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.media.mojom.LanguageIdentificationEventSpec.$ = {};
mojo.internal.bindings.media.mojom.SpeechRecognitionOptionsSpec = mojo.internal.bindings.media.mojom.SpeechRecognitionOptionsSpec || { $: {} };
if (mojo.internal.bindings.media.mojom.SpeechRecognitionOptionsSpec.$.structSpec && mojo.internal.bindings.media.mojom.SpeechRecognitionOptionsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.media.mojom.SpeechRecognitionOptionsSpec.$ = {};
mojo.internal.bindings.media.mojom.SpeechRecognitionContext = mojo.internal.bindings.media.mojom.SpeechRecognitionContext || {};
mojo.internal.bindings.media.mojom.SpeechRecognitionContextSpec = mojo.internal.bindings.media.mojom.SpeechRecognitionContextSpec || { $ : {} };
if (mojo.internal.bindings.media.mojom.SpeechRecognitionContextSpec.$.structSpec && mojo.internal.bindings.media.mojom.SpeechRecognitionContextSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.media.mojom.SpeechRecognitionContextSpec.$ = {};
mojo.internal.bindings.media.mojom.SpeechRecognitionContext.$interfaceName = 'media.mojom.SpeechRecognitionContext';
mojo.internal.bindings.media.mojom.SpeechRecognitionContext_BindRecognizer_ParamsSpec = mojo.internal.bindings.media.mojom.SpeechRecognitionContext_BindRecognizer_ParamsSpec || { $: {} };
if (mojo.internal.bindings.media.mojom.SpeechRecognitionContext_BindRecognizer_ParamsSpec.$.structSpec && mojo.internal.bindings.media.mojom.SpeechRecognitionContext_BindRecognizer_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.media.mojom.SpeechRecognitionContext_BindRecognizer_ParamsSpec.$ = {};
mojo.internal.bindings.media.mojom.SpeechRecognitionContext_BindRecognizer_ResponseParamsSpec = mojo.internal.bindings.media.mojom.SpeechRecognitionContext_BindRecognizer_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.media.mojom.SpeechRecognitionContext_BindRecognizer_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.media.mojom.SpeechRecognitionContext_BindRecognizer_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.media.mojom.SpeechRecognitionContext_BindRecognizer_ResponseParamsSpec.$ = {};
mojo.internal.bindings.media.mojom.SpeechRecognitionContext_BindWebSpeechRecognizer_ParamsSpec = mojo.internal.bindings.media.mojom.SpeechRecognitionContext_BindWebSpeechRecognizer_ParamsSpec || { $: {} };
if (mojo.internal.bindings.media.mojom.SpeechRecognitionContext_BindWebSpeechRecognizer_ParamsSpec.$.structSpec && mojo.internal.bindings.media.mojom.SpeechRecognitionContext_BindWebSpeechRecognizer_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.media.mojom.SpeechRecognitionContext_BindWebSpeechRecognizer_ParamsSpec.$ = {};
mojo.internal.bindings.media.mojom.SpeechRecognitionRecognizer = mojo.internal.bindings.media.mojom.SpeechRecognitionRecognizer || {};
mojo.internal.bindings.media.mojom.SpeechRecognitionRecognizerSpec = mojo.internal.bindings.media.mojom.SpeechRecognitionRecognizerSpec || { $ : {} };
if (mojo.internal.bindings.media.mojom.SpeechRecognitionRecognizerSpec.$.structSpec && mojo.internal.bindings.media.mojom.SpeechRecognitionRecognizerSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.media.mojom.SpeechRecognitionRecognizerSpec.$ = {};
mojo.internal.bindings.media.mojom.SpeechRecognitionRecognizer.$interfaceName = 'media.mojom.SpeechRecognitionRecognizer';
mojo.internal.bindings.media.mojom.SpeechRecognitionRecognizer_SendAudioToSpeechRecognitionService_ParamsSpec = mojo.internal.bindings.media.mojom.SpeechRecognitionRecognizer_SendAudioToSpeechRecognitionService_ParamsSpec || { $: {} };
if (mojo.internal.bindings.media.mojom.SpeechRecognitionRecognizer_SendAudioToSpeechRecognitionService_ParamsSpec.$.structSpec && mojo.internal.bindings.media.mojom.SpeechRecognitionRecognizer_SendAudioToSpeechRecognitionService_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.media.mojom.SpeechRecognitionRecognizer_SendAudioToSpeechRecognitionService_ParamsSpec.$ = {};
mojo.internal.bindings.media.mojom.SpeechRecognitionRecognizer_MarkDone_ParamsSpec = mojo.internal.bindings.media.mojom.SpeechRecognitionRecognizer_MarkDone_ParamsSpec || { $: {} };
if (mojo.internal.bindings.media.mojom.SpeechRecognitionRecognizer_MarkDone_ParamsSpec.$.structSpec && mojo.internal.bindings.media.mojom.SpeechRecognitionRecognizer_MarkDone_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.media.mojom.SpeechRecognitionRecognizer_MarkDone_ParamsSpec.$ = {};
mojo.internal.bindings.media.mojom.SpeechRecognitionRecognizer_OnLanguageChanged_ParamsSpec = mojo.internal.bindings.media.mojom.SpeechRecognitionRecognizer_OnLanguageChanged_ParamsSpec || { $: {} };
if (mojo.internal.bindings.media.mojom.SpeechRecognitionRecognizer_OnLanguageChanged_ParamsSpec.$.structSpec && mojo.internal.bindings.media.mojom.SpeechRecognitionRecognizer_OnLanguageChanged_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.media.mojom.SpeechRecognitionRecognizer_OnLanguageChanged_ParamsSpec.$ = {};
mojo.internal.bindings.media.mojom.SpeechRecognitionRecognizer_OnMaskOffensiveWordsChanged_ParamsSpec = mojo.internal.bindings.media.mojom.SpeechRecognitionRecognizer_OnMaskOffensiveWordsChanged_ParamsSpec || { $: {} };
if (mojo.internal.bindings.media.mojom.SpeechRecognitionRecognizer_OnMaskOffensiveWordsChanged_ParamsSpec.$.structSpec && mojo.internal.bindings.media.mojom.SpeechRecognitionRecognizer_OnMaskOffensiveWordsChanged_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.media.mojom.SpeechRecognitionRecognizer_OnMaskOffensiveWordsChanged_ParamsSpec.$ = {};
mojo.internal.bindings.media.mojom.SpeechRecognitionRecognizer_UpdateRecognitionContext_ParamsSpec = mojo.internal.bindings.media.mojom.SpeechRecognitionRecognizer_UpdateRecognitionContext_ParamsSpec || { $: {} };
if (mojo.internal.bindings.media.mojom.SpeechRecognitionRecognizer_UpdateRecognitionContext_ParamsSpec.$.structSpec && mojo.internal.bindings.media.mojom.SpeechRecognitionRecognizer_UpdateRecognitionContext_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.media.mojom.SpeechRecognitionRecognizer_UpdateRecognitionContext_ParamsSpec.$ = {};
mojo.internal.bindings.media.mojom.SpeechRecognitionRecognizerClient = mojo.internal.bindings.media.mojom.SpeechRecognitionRecognizerClient || {};
mojo.internal.bindings.media.mojom.SpeechRecognitionRecognizerClientSpec = mojo.internal.bindings.media.mojom.SpeechRecognitionRecognizerClientSpec || { $ : {} };
if (mojo.internal.bindings.media.mojom.SpeechRecognitionRecognizerClientSpec.$.structSpec && mojo.internal.bindings.media.mojom.SpeechRecognitionRecognizerClientSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.media.mojom.SpeechRecognitionRecognizerClientSpec.$ = {};
...
mojo.internal.bindings.media.mojom.SpeechRecognitionRecognizerClient_OnSpeechRecognitionRecognitionEvent_ParamsSpec = mojo.internal.bindings.media.mojom.SpeechRecognitionRecognizerClient_OnSpeechRecognitionRecognitionEvent_ParamsSpec || { $: {} };
if (mojo.internal.bindings.media.mojom.SpeechRecognitionRecognizerClient_OnSpeechRecognitionRecognitionEvent_ParamsSpec.$.structSpec && mojo.internal.bindings.media.mojom.SpeechRecognitionRecognizerClient_OnSpeechRecognitionRecognitionEvent_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.media.mojom.SpeechRecognitionRecognizerClient_OnSpeechRecognitionRecognitionEvent_ParamsSpec.$ = {};
mojo.internal.bindings.media.mojom.SpeechRecognitionRecognizerClient_OnSpeechRecognitionRecognitionEvent_ResponseParamsSpec = mojo.internal.bindings.media.mojom.SpeechRecognitionRecognizerClient_OnSpeechRecognitionRecognitionEvent_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.media.mojom.SpeechRecognitionRecognizerClient_OnSpeechRecognitionRecognitionEvent_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.media.mojom.SpeechRecognitionRecognizerClient_OnSpeechRecognitionRecognitionEvent_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.media.mojom.SpeechRecognitionRecognizerClient_OnSpeechRecognitionRecognitionEvent_ResponseParamsSpec.$ = {};
mojo.internal.bindings.media.mojom.SpeechRecognitionRecognizerClient_OnSpeechRecognitionStopped_ParamsSpec = mojo.internal.bindings.media.mojom.SpeechRecognitionRecognizerClient_OnSpeechRecognitionStopped_ParamsSpec || { $: {} };
if (mojo.internal.bindings.media.mojom.SpeechRecognitionRecognizerClient_OnSpeechRecognitionStopped_ParamsSpec.$.structSpec && mojo.internal.bindings.media.mojom.SpeechRecognitionRecognizerClient_OnSpeechRecognitionStopped_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.media.mojom.SpeechRecognitionRecognizerClient_OnSpeechRecognitionStopped_ParamsSpec.$ = {};
mojo.internal.bindings.media.mojom.SpeechRecognitionRecognizerClient_OnSpeechRecognitionError_ParamsSpec = mojo.internal.bindings.media.mojom.SpeechRecognitionRecognizerClient_OnSpeechRecognitionError_ParamsSpec || { $: {} };
if (mojo.internal.bindings.media.mojom.SpeechRecognitionRecognizerClient_OnSpeechRecognitionError_ParamsSpec.$.structSpec && mojo.internal.bindings.media.mojom.SpeechRecognitionRecognizerClient_OnSpeechRecognitionError_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.media.mojom.SpeechRecognitionRecognizerClient_OnSpeechRecognitionError_ParamsSpec.$ = {};
mojo.internal.bindings.media.mojom.SpeechRecognitionRecognizerClient_OnLanguageIdentificationEvent_ParamsSpec = mojo.internal.bindings.media.mojom.SpeechRecognitionRecognizerClient_OnLanguageIdentificationEvent_ParamsSpec || { $: {} };
if (mojo.internal.bindings.media.mojom.SpeechRecognitionRecognizerClient_OnLanguageIdentificationEvent_ParamsSpec.$.structSpec && mojo.internal.bindings.media.mojom.SpeechRecognitionRecognizerClient_OnLanguageIdentificationEvent_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.media.mojom.SpeechRecognitionRecognizerClient_OnLanguageIdentificationEvent_ParamsSpec.$ = {};
mojo.internal.bindings.media.mojom.SpeechRecognitionBrowserObserver = mojo.internal.bindings.media.mojom.SpeechRecognitionBrowserObserver || {};
mojo.internal.bindings.media.mojom.SpeechRecognitionBrowserObserverSpec = mojo.internal.bindings.media.mojom.SpeechRecognitionBrowserObserverSpec || { $ : {} };
if (mojo.internal.bindings.media.mojom.SpeechRecognitionBrowserObserverSpec.$.structSpec && mojo.internal.bindings.media.mojom.SpeechRecognitionBrowserObserverSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.media.mojom.SpeechRecognitionBrowserObserverSpec.$ = {};
...
mojo.internal.bindings.media.mojom.SpeechRecognitionBrowserObserver_SpeechRecognitionAvailabilityChanged_ParamsSpec = mojo.internal.bindings.media.mojom.SpeechRecognitionBrowserObserver_SpeechRecognitionAvailabilityChanged_ParamsSpec || { $: {} };
if (mojo.internal.bindings.media.mojom.SpeechRecognitionBrowserObserver_SpeechRecognitionAvailabilityChanged_ParamsSpec.$.structSpec && mojo.internal.bindings.media.mojom.SpeechRecognitionBrowserObserver_SpeechRecognitionAvailabilityChanged_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.media.mojom.SpeechRecognitionBrowserObserver_SpeechRecognitionAvailabilityChanged_ParamsSpec.$ = {};
mojo.internal.bindings.media.mojom.SpeechRecognitionBrowserObserver_SpeechRecognitionLanguageChanged_ParamsSpec = mojo.internal.bindings.media.mojom.SpeechRecognitionBrowserObserver_SpeechRecognitionLanguageChanged_ParamsSpec || { $: {} };
if (mojo.internal.bindings.media.mojom.SpeechRecognitionBrowserObserver_SpeechRecognitionLanguageChanged_ParamsSpec.$.structSpec && mojo.internal.bindings.media.mojom.SpeechRecognitionBrowserObserver_SpeechRecognitionLanguageChanged_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.media.mojom.SpeechRecognitionBrowserObserver_SpeechRecognitionLanguageChanged_ParamsSpec.$ = {};
mojo.internal.bindings.media.mojom.SpeechRecognitionBrowserObserver_SpeechRecognitionMaskOffensiveWordsChanged_ParamsSpec = mojo.internal.bindings.media.mojom.SpeechRecognitionBrowserObserver_SpeechRecognitionMaskOffensiveWordsChanged_ParamsSpec || { $: {} };
if (mojo.internal.bindings.media.mojom.SpeechRecognitionBrowserObserver_SpeechRecognitionMaskOffensiveWordsChanged_ParamsSpec.$.structSpec && mojo.internal.bindings.media.mojom.SpeechRecognitionBrowserObserver_SpeechRecognitionMaskOffensiveWordsChanged_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.media.mojom.SpeechRecognitionBrowserObserver_SpeechRecognitionMaskOffensiveWordsChanged_ParamsSpec.$ = {};
mojo.internal.bindings.media.mojom.SpeechRecognitionSurface = mojo.internal.bindings.media.mojom.SpeechRecognitionSurface || {};
mojo.internal.bindings.media.mojom.SpeechRecognitionSurfaceSpec = mojo.internal.bindings.media.mojom.SpeechRecognitionSurfaceSpec || { $ : {} };
if (mojo.internal.bindings.media.mojom.SpeechRecognitionSurfaceSpec.$.structSpec && mojo.internal.bindings.media.mojom.SpeechRecognitionSurfaceSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.media.mojom.SpeechRecognitionSurfaceSpec.$ = {};
mojo.internal.bindings.media.mojom.SpeechRecognitionSurface.$interfaceName = 'media.mojom.SpeechRecognitionSurface';
mojo.internal.bindings.media.mojom.SpeechRecognitionSurface_Activate_ParamsSpec = mojo.internal.bindings.media.mojom.SpeechRecognitionSurface_Activate_ParamsSpec || { $: {} };
if (mojo.internal.bindings.media.mojom.SpeechRecognitionSurface_Activate_ParamsSpec.$.structSpec && mojo.internal.bindings.media.mojom.SpeechRecognitionSurface_Activate_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.media.mojom.SpeechRecognitionSurface_Activate_ParamsSpec.$ = {};
mojo.internal.bindings.media.mojom.SpeechRecognitionSurface_GetBounds_ParamsSpec = mojo.internal.bindings.media.mojom.SpeechRecognitionSurface_GetBounds_ParamsSpec || { $: {} };
if (mojo.internal.bindings.media.mojom.SpeechRecognitionSurface_GetBounds_ParamsSpec.$.structSpec && mojo.internal.bindings.media.mojom.SpeechRecognitionSurface_GetBounds_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.media.mojom.SpeechRecognitionSurface_GetBounds_ParamsSpec.$ = {};
mojo.internal.bindings.media.mojom.SpeechRecognitionSurface_GetBounds_ResponseParamsSpec = mojo.internal.bindings.media.mojom.SpeechRecognitionSurface_GetBounds_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.media.mojom.SpeechRecognitionSurface_GetBounds_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.media.mojom.SpeechRecognitionSurface_GetBounds_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.media.mojom.SpeechRecognitionSurface_GetBounds_ResponseParamsSpec.$ = {};
mojo.internal.bindings.media.mojom.SpeechRecognitionSurfaceClient = mojo.internal.bindings.media.mojom.SpeechRecognitionSurfaceClient || {};
mojo.internal.bindings.media.mojom.SpeechRecognitionSurfaceClientSpec = mojo.internal.bindings.media.mojom.SpeechRecognitionSurfaceClientSpec || { $ : {} };
if (mojo.internal.bindings.media.mojom.SpeechRecognitionSurfaceClientSpec.$.structSpec && mojo.internal.bindings.media.mojom.SpeechRecognitionSurfaceClientSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.media.mojom.SpeechRecognitionSurfaceClientSpec.$ = {};
...
mojo.internal.bindings.media.mojom.SpeechRecognitionSurfaceClient_OnSessionEnded_ParamsSpec = mojo.internal.bindings.media.mojom.SpeechRecognitionSurfaceClient_OnSessionEnded_ParamsSpec || { $: {} };
if (mojo.internal.bindings.media.mojom.SpeechRecognitionSurfaceClient_OnSessionEnded_ParamsSpec.$.structSpec && mojo.internal.bindings.media.mojom.SpeechRecognitionSurfaceClient_OnSessionEnded_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.media.mojom.SpeechRecognitionSurfaceClient_OnSessionEnded_ParamsSpec.$ = {};
mojo.internal.bindings.media.mojom.SpeechRecognitionSurfaceClient_OnFullscreenToggled_ParamsSpec = mojo.internal.bindings.media.mojom.SpeechRecognitionSurfaceClient_OnFullscreenToggled_ParamsSpec || { $: {} };
if (mojo.internal.bindings.media.mojom.SpeechRecognitionSurfaceClient_OnFullscreenToggled_ParamsSpec.$.structSpec && mojo.internal.bindings.media.mojom.SpeechRecognitionSurfaceClient_OnFullscreenToggled_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.media.mojom.SpeechRecognitionSurfaceClient_OnFullscreenToggled_ParamsSpec.$ = {};
mojo.internal.bindings.media.mojom.SpeechRecognitionClientBrowserInterface = mojo.internal.bindings.media.mojom.SpeechRecognitionClientBrowserInterface || {};
mojo.internal.bindings.media.mojom.SpeechRecognitionClientBrowserInterfaceSpec = mojo.internal.bindings.media.mojom.SpeechRecognitionClientBrowserInterfaceSpec || { $ : {} };
if (mojo.internal.bindings.media.mojom.SpeechRecognitionClientBrowserInterfaceSpec.$.structSpec && mojo.internal.bindings.media.mojom.SpeechRecognitionClientBrowserInterfaceSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.media.mojom.SpeechRecognitionClientBrowserInterfaceSpec.$ = {};
...
mojo.internal.bindings.media.mojom.SpeechRecognitionClientBrowserInterface_BindSpeechRecognitionBrowserObserver_ParamsSpec = mojo.internal.bindings.media.mojom.SpeechRecognitionClientBrowserInterface_BindSpeechRecognitionBrowserObserver_ParamsSpec || { $: {} };
if (mojo.internal.bindings.media.mojom.SpeechRecognitionClientBrowserInterface_BindSpeechRecognitionBrowserObserver_ParamsSpec.$.structSpec && mojo.internal.bindings.media.mojom.SpeechRecognitionClientBrowserInterface_BindSpeechRecognitionBrowserObserver_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.media.mojom.SpeechRecognitionClientBrowserInterface_BindSpeechRecognitionBrowserObserver_ParamsSpec.$ = {};
mojo.internal.bindings.media.mojom.SpeechRecognitionClientBrowserInterface_REMOVED_1_ParamsSpec = mojo.internal.bindings.media.mojom.SpeechRecognitionClientBrowserInterface_REMOVED_1_ParamsSpec || { $: {} };
if (mojo.internal.bindings.media.mojom.SpeechRecognitionClientBrowserInterface_REMOVED_1_ParamsSpec.$.structSpec && mojo.internal.bindings.media.mojom.SpeechRecognitionClientBrowserInterface_REMOVED_1_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.media.mojom.SpeechRecognitionClientBrowserInterface_REMOVED_1_ParamsSpec.$ = {};
...
mojo.internal.bindings.media = mojo.internal.bindings.media || {};
mojo.internal.bindings.media.mojom = mojo.internal.bindings.media.mojom || {};
mojo.internal.bindings.media.mojom.SpeechRecognitionSessionSpec = mojo.internal.bindings.media.mojom.SpeechRecognitionSessionSpec || { $: mojo.internal.OpaqueStruct.$ };
mojo.internal.bindings.media.mojom.SpeechRecognitionSessionRemote = mojo.internal.bindings.media.mojom.SpeechRecognitionSessionRemote || class {};
mojo.internal.bindings.media.mojom.SpeechRecognitionSessionPendingReceiver = mojo.internal.bindings.media.mojom.SpeechRecognitionSessionPendingReceiver || class { constructor(handle) { this.handle = handle; } };
mojo.internal.bindings.media = mojo.internal.bindings.media || {};
mojo.internal.bindings.media.mojom = mojo.internal.bindings.media.mojom || {};
mojo.internal.bindings.media.mojom.SpeechRecognitionSessionClientSpec = mojo.internal.bindings.media.mojom.SpeechRecognitionSessionClientSpec || { $: mojo.internal.OpaqueStruct.$ };
mojo.internal.bindings.media.mojom.SpeechRecognitionSessionClientRemote = mojo.internal.bindings.media.mojom.SpeechRecognitionSessionClientRemote || class {};
mojo.internal.bindings.media.mojom.SpeechRecognitionSessionClientPendingReceiver = mojo.internal.bindings.media.mojom.SpeechRecognitionSessionClientPendingReceiver || class { constructor(handle) { this.handle = handle; } };
mojo.internal.bindings.mojo_base = mojo.internal.bindings.mojo_base || {};
mojo.internal.bindings.mojo_base.mojom = mojo.internal.bindings.mojo_base.mojom || {};
...
mojo.internal.Struct(
    mojo.internal.bindings.media.mojom.SpeechRecognitionResultSpec, 'media.mojom.SpeechRecognitionResult', [
      ...
      mojo.internal.StructField('arg_timing_information', 16, 0, mojo.internal.bindings.media.mojom.TimingInformationSpec, null, true, 0, undefined),
    ],
    [[0, 32]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.media.mojom.SpeechRecognitionOptionsSpec, 'media.mojom.SpeechRecognitionOptions', [
      ...
      mojo.internal.StructField('arg_allow_multi_language', 4, 3, mojo.internal.Bool, true, false, 0, undefined),
...
mojo.internal.Struct(
    mojo.internal.bindings.media.mojom.SpeechRecognitionContext_BindWebSpeechRecognizer_ParamsSpec, 'media.mojom.SpeechRecognitionContext_BindWebSpeechRecognizer_Params', [
      ...
      mojo.internal.StructField('arg_continuous', 32, 0, mojo.internal.Bool, false, false, 0, undefined),
    ],
    [[0, 48]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.media.mojom.SpeechRecognitionRecognizerClient_OnSpeechRecognitionRecognitionEvent_ParamsSpec, 'media.mojom.SpeechRecognitionRecognizerClient_OnSpeechRecognitionRecognitionEvent_Params', [
      mojo.internal.StructField('arg_result', 0, 0, mojo.internal.bindings.media.mojom.SpeechRecognitionResultSpec, null, false, 0, undefined),
    ],
    [[0, 16]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.media.mojom.SpeechRecognitionRecognizerClient_OnLanguageIdentificationEvent_ParamsSpec, 'media.mojom.SpeechRecognitionRecognizerClient_OnLanguageIdentificationEvent_Params', [
      mojo.internal.StructField('arg_event', 0, 0, mojo.internal.bindings.media.mojom.LanguageIdentificationEventSpec, null, false, 0, undefined),
    ],
    [[0, 16]]);
