...
mojo.internal.bindings.cros.mojom.JpegAcceleratorProviderRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.cros.mojom.JpegAcceleratorProviderPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.cros.mojom.JpegAcceleratorProviderRemoteCallHandler(this.proxy);
  }
  ...
  getJpegEncodeAccelerator(arg_jea) {
    return this.$.getJpegEncodeAccelerator(arg_jea);
  }
  getMjpegDecodeAccelerator(arg_jda) {
    return this.$.getMjpegDecodeAccelerator(arg_jda);
  }
};
...
mojo.internal.bindings.cros.mojom.JpegAcceleratorProvider.getRemote = function() {
  let remote = new mojo.internal.bindings.cros.mojom.JpegAcceleratorProviderRemote();
...
mojo.internal.bindings.cros.mojom.JpegAcceleratorProviderReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.cros.mojom.JpegAcceleratorProvider_GetJpegEncodeAccelerator_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for GetJpegEncodeAccelerator failed with TypeError');
           }
        }
        // Try Method 1: GetMjpegDecodeAccelerator
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.cros.mojom.JpegAcceleratorProvider_GetMjpegDecodeAccelerator_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for GetMjpegDecodeAccelerator failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.cros.mojom.JpegAcceleratorProviderReceiver = mojo.internal.bindings.cros.mojom.JpegAcceleratorProviderReceiver;
