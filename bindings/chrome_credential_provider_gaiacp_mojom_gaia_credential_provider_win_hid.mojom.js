...
mojo.internal.Struct(
    mojo.internal.bindings.gcpw_hid.mojom.GaiaCredentialProviderHidBroker_OpenDevice_ResponseParamsSpec, 'gcpw_hid.mojom.GaiaCredentialProviderHidBroker_OpenDevice_ResponseParams', [
      mojo.internal.StructField('arg_out_handle', 0, 0, mojo.internal.Pointer, null, true, 0, undefined),
    ],
    [[0, 16]]);
...
mojo.internal.bindings.gcpw_hid.mojom.GaiaCredentialProviderHidBrokerRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.gcpw_hid.mojom.GaiaCredentialProviderHidBrokerPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.gcpw_hid.mojom.GaiaCredentialProviderHidBrokerRemoteCallHandler(this.proxy);
  }
  ...
  openDevice(arg_device_path) {
    return this.$.openDevice(arg_device_path);
  }
};
...
mojo.internal.bindings.gcpw_hid.mojom.GaiaCredentialProviderHidBroker.getRemote = function() {
  let remote = new mojo.internal.bindings.gcpw_hid.mojom.GaiaCredentialProviderHidBrokerRemote();
...
mojo.internal.bindings.gcpw_hid.mojom.GaiaCredentialProviderHidBrokerReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
        ...
        case 0: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.gcpw_hid.mojom.GaiaCredentialProviderHidBroker_OpenDevice_ResponseParamsSpec, header, rawHeader);
               responder(response);
...
mojo.internal.bindings.gcpw_hid.mojom.GaiaCredentialProviderHidBrokerReceiver = mojo.internal.bindings.gcpw_hid.mojom.GaiaCredentialProviderHidBrokerReceiver;
