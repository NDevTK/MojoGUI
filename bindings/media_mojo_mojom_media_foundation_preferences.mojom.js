...
mojo.internal.bindings.media.mojom.MediaFoundationPreferences = {};
mojo.internal.bindings.media.mojom.MediaFoundationPreferencesSpec = { $ : {} };
mojo.internal.bindings.media.mojom.MediaFoundationPreferences.$interfaceName = 'media.mojom.MediaFoundationPreferences';
...
mojo.internal.bindings.media.mojom.MediaFoundationPreferencesRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.media.mojom.MediaFoundationPreferencesPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.media.mojom.MediaFoundationPreferencesRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.media.mojom.MediaFoundationPreferencesRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('media.mojom.MediaFoundationPreferences', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.media.mojom.MediaFoundationPreferences.getRemote = function() {
  let remote = new mojo.internal.bindings.media.mojom.MediaFoundationPreferencesRemote();
...
mojo.internal.bindings.media.mojom.MediaFoundationPreferencesReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('media.mojom.MediaFoundationPreferences', [
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.media.mojom.MediaFoundationPreferences_IsHardwareSecureDecryptionAllowed_ParamsSpec.$.structSpec);
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.media.mojom.MediaFoundationPreferences_IsHardwareSecureDecryptionAllowed_ParamsSpec.$.structSpec);
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.media.mojom.MediaFoundationPreferences_IsHardwareSecureDecryptionAllowed_ResponseParamsSpec, header, rawHeader);
               responder(response);
...
mojo.internal.bindings.media.mojom.MediaFoundationPreferencesReceiver = mojo.internal.bindings.media.mojom.MediaFoundationPreferencesReceiver;
