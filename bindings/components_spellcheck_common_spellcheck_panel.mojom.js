...
mojo.internal.bindings.spellcheck.mojom.SpellCheckPanelRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.spellcheck.mojom.SpellCheckPanelPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.spellcheck.mojom.SpellCheckPanelRemoteCallHandler(this.proxy);
  }
  ...
  toggleSpellPanel(arg_visible) {
    return this.$.toggleSpellPanel(arg_visible);
  }
...
mojo.internal.bindings.spellcheck.mojom.SpellCheckPanel.getRemote = function() {
  let remote = new mojo.internal.bindings.spellcheck.mojom.SpellCheckPanelRemote();
...
mojo.internal.bindings.spellcheck.mojom.SpellCheckPanelReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.spellcheck.mojom.SpellCheckPanel_ToggleSpellPanel_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for ToggleSpellPanel failed with TypeError');
           }
        }
        // Try Method 1: AdvanceToNextMisspelling
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.spellcheck.mojom.SpellCheckPanel_AdvanceToNextMisspelling_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for AdvanceToNextMisspelling failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
      ...
      switch (dispatchId) {
        ...
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.spellcheck.mojom.SpellCheckPanel_AdvanceToNextMisspelling_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.spellcheck.mojom.SpellCheckPanelReceiver = mojo.internal.bindings.spellcheck.mojom.SpellCheckPanelReceiver;

mojo.internal.bindings.spellcheck.mojom.SpellCheckPanelPtr = mojo.internal.bindings.spellcheck.mojom.SpellCheckPanelRemote;
mojo.internal.bindings.spellcheck.mojom.SpellCheckPanelRequest = mojo.internal.bindings.spellcheck.mojom.SpellCheckPanelPendingReceiver;
...
mojo.internal.bindings.spellcheck.mojom.SpellCheckPanelHostRemote = class {
  static get $interfaceName() {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.spellcheck.mojom.SpellCheckPanelHostPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.spellcheck.mojom.SpellCheckPanelHostRemoteCallHandler(this.proxy);
  }
  ...
  showSpellingPanel(arg_show) {
    return this.$.showSpellingPanel(arg_show);
  }
  updateSpellingPanelWithMisspelledWord(arg_word) {
    return this.$.updateSpellingPanelWithMisspelledWord(arg_word);
  }
};
...
mojo.internal.bindings.spellcheck.mojom.SpellCheckPanelHost.getRemote = function() {
  let remote = new mojo.internal.bindings.spellcheck.mojom.SpellCheckPanelHostRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
...
mojo.internal.bindings.spellcheck.mojom.SpellCheckPanelHostReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.spellcheck.mojom.SpellCheckPanelHost_ShowSpellingPanel_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for ShowSpellingPanel failed with TypeError');
           }
        }
        // Try Method 1: UpdateSpellingPanelWithMisspelledWord
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.spellcheck.mojom.SpellCheckPanelHost_UpdateSpellingPanelWithMisspelledWord_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for UpdateSpellingPanelWithMisspelledWord failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
             console.warn('[GeneratedReceiver] Failed to discover ordinal ' + header.ordinal);
...
mojo.internal.bindings.spellcheck.mojom.SpellCheckPanelHostReceiver = mojo.internal.bindings.spellcheck.mojom.SpellCheckPanelHostReceiver;
