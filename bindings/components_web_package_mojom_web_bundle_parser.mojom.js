...
mojo.internal.bindings.web_package.mojom.BundleResponseParseErrorSpec = { $: {} };
mojo.internal.bindings.web_package.mojom.BundleIntegrityBlockAttributesSpec = { $: {} };
mojo.internal.bindings.web_package.mojom.BundleIntegrityBlockSpec = { $: {} };
mojo.internal.bindings.web_package.mojom.Ed25519PublicKeySpec = { $: {} };
mojo.internal.bindings.web_package.mojom.Ed25519SignatureSpec = { $: {} };
mojo.internal.bindings.web_package.mojom.SignatureInfoEd25519Spec = { $: {} };
mojo.internal.bindings.web_package.mojom.EcdsaP256PublicKeySpec = { $: {} };
mojo.internal.bindings.web_package.mojom.EcdsaP256SHA256SignatureSpec = { $: {} };
mojo.internal.bindings.web_package.mojom.SignatureInfoEcdsaP256SHA256Spec = { $: {} };
mojo.internal.bindings.web_package.mojom.SignatureInfoUnknownSpec = { $: {} };
mojo.internal.bindings.web_package.mojom.BundleIntegrityBlockSignatureStackEntrySpec = { $: {} };
mojo.internal.bindings.web_package.mojom.BundleMetadataSpec = { $: {} };
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.web_package.mojom.WebBundleParserFactory_GetParserForDataSource_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for GetParserForDataSource failed with TypeError');
           }
        }
        // Try Method 1: BindFileDataSource
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.web_package.mojom.WebBundleParserFactory_BindFileDataSource_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for BindFileDataSource failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.web_package.mojom.WebBundleParser_ParseIntegrityBlock_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for ParseIntegrityBlock failed with TypeError');
           }
        }
        // Try Method 1: ParseMetadata
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.web_package.mojom.WebBundleParser_ParseMetadata_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for ParseMetadata failed with TypeError');
           }
        }
        // Try Method 2: ParseResponse
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.web_package.mojom.WebBundleParser_ParseResponse_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for ParseResponse failed with TypeError');
           }
        }
        // Try Method 3: Close
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.web_package.mojom.WebBundleParser_Close_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.web_package.mojom.BundleDataSource_Read_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.web_package.mojom.BundleDataSource_Length_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for Length failed with TypeError');
           }
        }
        // Try Method 2: IsRandomAccessContext
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.web_package.mojom.BundleDataSource_IsRandomAccessContext_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for IsRandomAccessContext failed with TypeError');
           }
        }
        // Try Method 3: Close
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.web_package.mojom.BundleDataSource_Close_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
