...
mojo.internal.bindings.on_device_translation.mojom.TranslatorRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.on_device_translation.mojom.TranslatorPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.on_device_translation.mojom.TranslatorRemoteCallHandler(this.proxy);
  }
  ...
  translate(arg_input) {
    return this.$.translate(arg_input);
  }
  splitSentences(arg_input) {
    return this.$.splitSentences(arg_input);
  }
};

mojo.internal.bindings.on_device_translation.mojom.TranslatorRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('on_device_translation.mojom.Translator', [
      { explicit: null },
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.on_device_translation.mojom.Translator.getRemote = function() {
  let remote = new mojo.internal.bindings.on_device_translation.mojom.TranslatorRemote();
...
mojo.internal.bindings.on_device_translation.mojom.TranslatorReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('on_device_translation.mojom.Translator', [
      { explicit: null },
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.on_device_translation.mojom.Translator_Translate_ParamsSpec.$.structSpec);
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.on_device_translation.mojom.Translator_SplitSentences_ParamsSpec.$.structSpec);
      ...
      switch (dispatchId) {
        case 0: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.on_device_translation.mojom.Translator_Translate_ResponseParamsSpec, header, rawHeader);
               responder(response);
        ...
        case 1: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              const rawHeader = (args[2] && args[2].slice) ? args[2].slice(0, header.headerSize) : null;
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.on_device_translation.mojom.Translator_SplitSentences_ResponseParamsSpec, header, rawHeader);
               responder(response);
...
mojo.internal.bindings.on_device_translation.mojom.TranslatorReceiver = mojo.internal.bindings.on_device_translation.mojom.TranslatorReceiver;
