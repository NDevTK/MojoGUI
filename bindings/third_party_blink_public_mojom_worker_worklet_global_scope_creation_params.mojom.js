...
mojo.internal.bindings.blink.mojom.WorkletDevToolsHostRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.blink.mojom.WorkletDevToolsHostPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.blink.mojom.WorkletDevToolsHostRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.blink.mojom.WorkletDevToolsHost.getRemote = function() {
  let remote = new mojo.internal.bindings.blink.mojom.WorkletDevToolsHostRemote();
...
mojo.internal.bindings.blink.mojom.WorkletDevToolsHostReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.blink.mojom.WorkletDevToolsHost_OnReadyForInspection_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OnReadyForInspection failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.blink.mojom.WorkletDevToolsHostReceiver = mojo.internal.bindings.blink.mojom.WorkletDevToolsHostReceiver;
