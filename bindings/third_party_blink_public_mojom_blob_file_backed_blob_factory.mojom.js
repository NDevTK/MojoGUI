...
mojo.internal.bindings.blink.mojom.FileBackedBlobFactory = {};
mojo.internal.bindings.blink.mojom.FileBackedBlobFactorySpec = { $ : {} };
mojo.internal.bindings.blink.mojom.FileBackedBlobFactory.$interfaceName = 'blink.mojom.FileBackedBlobFactory';
...
mojo.internal.bindings.blink.mojom.FileBackedBlobFactoryRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.blink.mojom.FileBackedBlobFactoryPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.blink.mojom.FileBackedBlobFactoryRemoteCallHandler(this.proxy);
  }
  ...
  registerBlob(arg_blob, arg_uuid, arg_content_type, arg_file) {
    return this.$.registerBlob(arg_blob, arg_uuid, arg_content_type, arg_file);
  }
  registerBlobSync(arg_blob, arg_uuid, arg_content_type, arg_file) {
    return this.$.registerBlobSync(arg_blob, arg_uuid, arg_content_type, arg_file);
  }
};

mojo.internal.bindings.blink.mojom.FileBackedBlobFactoryRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('blink.mojom.FileBackedBlobFactory', [
      { explicit: null },
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.blink.mojom.FileBackedBlobFactory.getRemote = function() {
  let remote = new mojo.internal.bindings.blink.mojom.FileBackedBlobFactoryRemote();
...
mojo.internal.bindings.blink.mojom.FileBackedBlobFactoryReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('blink.mojom.FileBackedBlobFactory', [
      { explicit: null },
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.blink.mojom.FileBackedBlobFactory_RegisterBlob_ParamsSpec.$.structSpec);
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.blink.mojom.FileBackedBlobFactory_RegisterBlobSync_ParamsSpec.$.structSpec);
        ...
        case 1: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.blink.mojom.FileBackedBlobFactory_RegisterBlobSync_ResponseParamsSpec, header, rawHeader);
               responder(response);
...
mojo.internal.bindings.blink.mojom.FileBackedBlobFactoryReceiver = mojo.internal.bindings.blink.mojom.FileBackedBlobFactoryReceiver;
