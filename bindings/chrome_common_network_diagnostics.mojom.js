...
mojo.internal.bindings.chrome.mojom.NetworkDiagnosticsRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.chrome.mojom.NetworkDiagnosticsPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.chrome.mojom.NetworkDiagnosticsRemoteCallHandler(this.proxy);
  }
  ...
  runNetworkDiagnostics(arg_failed_url) {
    return this.$.runNetworkDiagnostics(arg_failed_url);
  }
};
...
mojo.internal.bindings.chrome.mojom.NetworkDiagnostics.getRemote = function() {
  let remote = new mojo.internal.bindings.chrome.mojom.NetworkDiagnosticsRemote();
...
mojo.internal.bindings.chrome.mojom.NetworkDiagnosticsReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.chrome.mojom.NetworkDiagnostics_RunNetworkDiagnostics_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for RunNetworkDiagnostics failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.chrome.mojom.NetworkDiagnosticsReceiver = mojo.internal.bindings.chrome.mojom.NetworkDiagnosticsReceiver;

mojo.internal.bindings.chrome.mojom.NetworkDiagnosticsPtr = mojo.internal.bindings.chrome.mojom.NetworkDiagnosticsRemote;
mojo.internal.bindings.chrome.mojom.NetworkDiagnosticsRequest = mojo.internal.bindings.chrome.mojom.NetworkDiagnosticsPendingReceiver;
...
mojo.internal.bindings.chrome.mojom.NetworkDiagnosticsClientRemote = class {
  static get $interfaceName() {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.chrome.mojom.NetworkDiagnosticsClientPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.chrome.mojom.NetworkDiagnosticsClientRemoteCallHandler(this.proxy);
  }
  ...
  setCanShowNetworkDiagnosticsDialog(arg_can_show) {
    return this.$.setCanShowNetworkDiagnosticsDialog(arg_can_show);
  }
  dNSProbeStatus(arg_status) {
    return this.$.dNSProbeStatus(arg_status);
  }
};
...
mojo.internal.bindings.chrome.mojom.NetworkDiagnosticsClient.getRemote = function() {
  let remote = new mojo.internal.bindings.chrome.mojom.NetworkDiagnosticsClientRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
...
mojo.internal.bindings.chrome.mojom.NetworkDiagnosticsClientReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.chrome.mojom.NetworkDiagnosticsClient_SetCanShowNetworkDiagnosticsDialog_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for SetCanShowNetworkDiagnosticsDialog failed with TypeError');
           }
        }
        // Try Method 1: DNSProbeStatus
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.chrome.mojom.NetworkDiagnosticsClient_DNSProbeStatus_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for DNSProbeStatus failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
             console.warn('[GeneratedReceiver] Failed to discover ordinal ' + header.ordinal);
...
mojo.internal.bindings.chrome.mojom.NetworkDiagnosticsClientReceiver = mojo.internal.bindings.chrome.mojom.NetworkDiagnosticsClientReceiver;
