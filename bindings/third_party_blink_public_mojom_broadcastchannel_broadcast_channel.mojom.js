...
mojo.internal.bindings.blink.mojom.BroadcastChannelClientRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.blink.mojom.BroadcastChannelClientPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.blink.mojom.BroadcastChannelClientRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.blink.mojom.BroadcastChannelClient.getRemote = function() {
  let remote = new mojo.internal.bindings.blink.mojom.BroadcastChannelClientRemote();
...
mojo.internal.bindings.blink.mojom.BroadcastChannelClientReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.blink.mojom.BroadcastChannelClient_OnMessage_ParamsSpec.$.structSpec;
...
mojo.internal.bindings.blink.mojom.BroadcastChannelClientReceiver = mojo.internal.bindings.blink.mojom.BroadcastChannelClientReceiver;

mojo.internal.bindings.blink.mojom.BroadcastChannelClientPtr = mojo.internal.bindings.blink.mojom.BroadcastChannelClientRemote;
mojo.internal.bindings.blink.mojom.BroadcastChannelClientRequest = mojo.internal.bindings.blink.mojom.BroadcastChannelClientPendingReceiver;
...
mojo.internal.bindings.blink.mojom.BroadcastChannelProviderRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.blink.mojom.BroadcastChannelProviderRemoteCallHandler(this.proxy);
  }
  ...
  connectToChannel(arg_name, arg_client, arg_connection) {
    return this.$.connectToChannel(arg_name, arg_client, arg_connection);
  }
};
...
mojo.internal.bindings.blink.mojom.BroadcastChannelProvider.getRemote = function() {
  let remote = new mojo.internal.bindings.blink.mojom.BroadcastChannelProviderRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
...
mojo.internal.bindings.blink.mojom.BroadcastChannelProviderReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.blink.mojom.BroadcastChannelProvider_ConnectToChannel_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for ConnectToChannel failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
             console.warn('[GeneratedReceiver] Failed to discover ordinal ' + header.ordinal);
...
mojo.internal.bindings.blink.mojom.BroadcastChannelProviderReceiver = mojo.internal.bindings.blink.mojom.BroadcastChannelProviderReceiver;
