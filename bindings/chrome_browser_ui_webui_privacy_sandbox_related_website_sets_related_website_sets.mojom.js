...
mojo.internal.Union(
    mojo.internal.bindings.related_website_sets.mojom.GetRelatedWebsiteSetsResponseSpec, 'related_website_sets.mojom.GetRelatedWebsiteSetsResponse', {
      'arg_related_website_sets': {
        'ordinal': 0,
        'type': mojo.internal.Array(mojo.internal.bindings.mojo.internal.bindings.related_website_sets.mojom.RelatedWebsiteSetSpec.$, false),
        'nullable': false,
      },
      'arg_error_message': {
        'ordinal': 1,
...
mojo.internal.Struct(
    mojo.internal.bindings.related_website_sets.mojom.MemberSpec, 'related_website_sets.mojom.Member', [
      ...
      mojo.internal.StructField('arg_type', 8, 0, mojo.internal.bindings.mojo.internal.bindings.related_website_sets.mojom.SiteTypeSpec.$, null, false, 0, undefined),
    ],
    [[0, 24]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.related_website_sets.mojom.RelatedWebsiteSetSpec, 'related_website_sets.mojom.RelatedWebsiteSet', [
      ...
      mojo.internal.StructField('arg_member_sites', 8, 0, mojo.internal.Array(mojo.internal.bindings.mojo.internal.bindings.related_website_sets.mojom.MemberSpec.$, false), null, false, 0, undefined),
...
mojo.internal.Struct(
    mojo.internal.bindings.related_website_sets.mojom.RelatedWebsiteSetsPageHandler_GetRelatedWebsiteSets_ParamsSpec, 'related_website_sets.mojom.RelatedWebsiteSetsPageHandler_GetRelatedWebsiteSets_Params', [
    ],
    [[0, 8]]);
...
mojo.internal.bindings.related_website_sets.mojom.RelatedWebsiteSetsPageHandlerRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.related_website_sets.mojom.RelatedWebsiteSetsPageHandlerPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.related_website_sets.mojom.RelatedWebsiteSetsPageHandlerRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.related_website_sets.mojom.RelatedWebsiteSetsPageHandler.getRemote = function() {
  let remote = new mojo.internal.bindings.related_website_sets.mojom.RelatedWebsiteSetsPageHandlerRemote();
...
mojo.internal.bindings.related_website_sets.mojom.RelatedWebsiteSetsPageHandlerReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.related_website_sets.mojom.RelatedWebsiteSetsPageHandler_GetRelatedWebsiteSets_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.getRelatedWebsiteSets');
          const result = this.impl.getRelatedWebsiteSets();
          const expectsResponse = header.expectsResponse || (header.flags & 1);
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              const rawHeader = (args[2] && args[2].slice) ? args[2].slice(0, header.headerSize) : null;
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.related_website_sets.mojom.RelatedWebsiteSetsPageHandler_GetRelatedWebsiteSets_ResponseParamsSpec, header, rawHeader);
               responder(response);
...
mojo.internal.bindings.related_website_sets.mojom.RelatedWebsiteSetsPageHandlerReceiver = mojo.internal.bindings.related_website_sets.mojom.RelatedWebsiteSetsPageHandlerReceiver;

mojo.internal.bindings.related_website_sets.mojom.RelatedWebsiteSetsPageHandlerPtr = mojo.internal.bindings.related_website_sets.mojom.RelatedWebsiteSetsPageHandlerRemote;
mojo.internal.bindings.related_website_sets.mojom.RelatedWebsiteSetsPageHandlerRequest = mojo.internal.bindings.related_website_sets.mojom.RelatedWebsiteSetsPageHandlerPendingReceiver;
