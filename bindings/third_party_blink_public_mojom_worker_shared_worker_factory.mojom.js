  ...
  $: {
    structSpec: {
      ...
      fields: [
        ...
        { name: 'ua_metadata', packedOffset: 40, packedBitOffset: 0, type: blink.mojom.UserAgentMetadataSpec, nullable: false },
        { name: 'devtools_worker_token', packedOffset: 48, packedBitOffset: 0, type: mojo_base.mojom.UnguessableTokenSpec, nullable: false },
        { name: 'renderer_preferences', packedOffset: 56, packedBitOffset: 0, type: blink.mojom.RendererPreferencesSpec, nullable: false },
        { name: 'service_worker_container_info', packedOffset: 64, packedBitOffset: 0, type: blink.mojom.ServiceWorkerContainerInfoForClientSpec, nullable: true },
        { name: 'main_script_load_params', packedOffset: 72, packedBitOffset: 0, type: blink.mojom.WorkerMainScriptLoadParamsSpec, nullable: false },
        { name: 'subresource_loader_factories', packedOffset: 80, packedBitOffset: 0, type: blink.mojom.URLLoaderFactoryBundleSpec, nullable: false },
        { name: 'controller_info', packedOffset: 88, packedBitOffset: 0, type: blink.mojom.ControllerServiceWorkerInfoSpec, nullable: true },
        { name: 'policy_container', packedOffset: 96, packedBitOffset: 0, type: blink.mojom.PolicyContainerSpec, nullable: false },
