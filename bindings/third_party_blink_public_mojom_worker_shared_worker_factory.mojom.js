  ...
  $: {
    structSpec: {
      ...
      fields: [
        ...
        { name: 'constructor_key', packedOffset: 16, packedBitOffset: 0, type: mojo.internal.Pointer, nullable: false },
        { name: 'origin', packedOffset: 24, packedBitOffset: 0, type: mojo.internal.Pointer, nullable: false },
        { name: 'is_constructor_secure_context', packedOffset: 32, packedBitOffset: 0, type: mojo.internal.Bool, nullable: false },
        ...
        { name: 'pause_on_start', packedOffset: 56, packedBitOffset: 0, type: mojo.internal.Bool, nullable: false },
        { name: 'devtools_worker_token', packedOffset: 64, packedBitOffset: 0, type: mojo.internal.Pointer, nullable: false },
        { name: 'renderer_preferences', packedOffset: 72, packedBitOffset: 0, type: mojo.internal.Pointer, nullable: false },
        { name: 'preference_watcher_receiver', packedOffset: 80, packedBitOffset: 0, type: mojo.internal.InterfaceRequest, nullable: false },
        { name: 'content_settings', packedOffset: 88, packedBitOffset: 0, type: mojo.internal.InterfaceProxy, nullable: false },
        { name: 'service_worker_container_info', packedOffset: 96, packedBitOffset: 0, type: mojo.internal.Pointer, nullable: true },
        { name: 'main_script_load_params', packedOffset: 104, packedBitOffset: 0, type: mojo.internal.Pointer, nullable: false },
        { name: 'subresource_loader_factories', packedOffset: 112, packedBitOffset: 0, type: mojo.internal.Pointer, nullable: false },
        { name: 'controller_info', packedOffset: 120, packedBitOffset: 0, type: mojo.internal.Pointer, nullable: true },
        ...
        { name: 'shared_worker', packedOffset: 144, packedBitOffset: 0, type: mojo.internal.InterfaceRequest, nullable: false },
        { name: 'browser_interface_broker', packedOffset: 152, packedBitOffset: 0, type: mojo.internal.InterfaceProxy, nullable: false },
        { name: 'ukm_source_id', packedOffset: 160, packedBitOffset: 0, type: mojo.internal.Int64, nullable: false },
        { name: 'require_cross_site_request_for_cookies', packedOffset: 168, packedBitOffset: 0, type: mojo.internal.Bool, nullable: false },
