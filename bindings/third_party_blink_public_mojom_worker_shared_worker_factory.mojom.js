  ...
  $: {
    structSpec: {
      ...
      fields: [
        ...
        { name: 'token', packedOffset: 8, packedBitOffset: 0, type: blink.mojom.SharedWorkerTokenSpec, nullable: false },
        ...
        { name: 'content_settings', packedOffset: 84, packedBitOffset: 0, type: mojo.internal.InterfaceProxy, nullable: false },
        { name: 'service_worker_container_info', packedOffset: 88, packedBitOffset: 0, type: blink.mojom.ServiceWorkerContainerInfoForClientSpec, nullable: true },
        { name: 'main_script_load_params', packedOffset: 96, packedBitOffset: 0, type: blink.mojom.WorkerMainScriptLoadParamsSpec, nullable: false },
        ...
        { name: 'controller_info', packedOffset: 112, packedBitOffset: 0, type: blink.mojom.ControllerServiceWorkerInfoSpec, nullable: true },
        { name: 'policy_container', packedOffset: 120, packedBitOffset: 0, type: blink.mojom.PolicyContainerSpec, nullable: false },
        { name: 'host', packedOffset: 128, packedBitOffset: 0, type: mojo.internal.InterfaceProxy, nullable: false },
        { name: 'shared_worker', packedOffset: 132, packedBitOffset: 0, type: mojo.internal.InterfaceRequest, nullable: false },
        { name: 'browser_interface_broker', packedOffset: 136, packedBitOffset: 0, type: mojo.internal.InterfaceProxy, nullable: false },
        { name: 'ukm_source_id', packedOffset: 144, packedBitOffset: 0, type: mojo.internal.Int64, nullable: false },
        { name: 'require_cross_site_request_for_cookies', packedOffset: 152, packedBitOffset: 0, type: mojo.internal.Bool, nullable: false },
        { name: 'coep_reporting_observer_receiver', packedOffset: 160, packedBitOffset: 0, type: mojo.internal.InterfaceRequest, nullable: true },
        { name: 'dip_reporting_observer_receiver', packedOffset: 164, packedBitOffset: 0, type: mojo.internal.InterfaceRequest, nullable: true },
      ],
      versions: [{version: 0}]
    }
  }
