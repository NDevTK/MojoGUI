  ...
  $: {
    structSpec: {
      ...
      fields: [
        ...
        { name: 'is_constructor_secure_context', packedOffset: 140, packedBitOffset: 0, type: mojo.internal.Bool, nullable: false, minVersion: 0 },
        ...
        { name: 'pause_on_start', packedOffset: 140, packedBitOffset: 1, type: mojo.internal.Bool, nullable: false, minVersion: 0 },
        ...
        { name: 'preference_watcher_receiver', packedOffset: 112, packedBitOffset: 0, type: mojo.internal.InterfaceRequest, nullable: false, minVersion: 0 },
        { name: 'content_settings', packedOffset: 116, packedBitOffset: 0, type: mojo.internal.InterfaceProxy, nullable: false, minVersion: 0 },
        { name: 'service_worker_container_info', packedOffset: 64, packedBitOffset: 0, type: blink.mojom.ServiceWorkerContainerInfoForClientSpec, nullable: true, minVersion: 0 },
        { name: 'main_script_load_params', packedOffset: 72, packedBitOffset: 0, type: blink.mojom.WorkerMainScriptLoadParamsSpec, nullable: false, minVersion: 0 },
        { name: 'subresource_loader_factories', packedOffset: 80, packedBitOffset: 0, type: blink.mojom.URLLoaderFactoryBundleSpec, nullable: false, minVersion: 0 },
        { name: 'controller_info', packedOffset: 88, packedBitOffset: 0, type: blink.mojom.ControllerServiceWorkerInfoSpec, nullable: true, minVersion: 0 },
        { name: 'policy_container', packedOffset: 96, packedBitOffset: 0, type: blink.mojom.PolicyContainerSpec, nullable: false, minVersion: 0 },
        { name: 'host', packedOffset: 120, packedBitOffset: 0, type: mojo.internal.InterfaceProxy, nullable: false, minVersion: 0 },
        { name: 'shared_worker', packedOffset: 124, packedBitOffset: 0, type: mojo.internal.InterfaceRequest, nullable: false, minVersion: 0 },
        { name: 'browser_interface_broker', packedOffset: 128, packedBitOffset: 0, type: mojo.internal.InterfaceProxy, nullable: false, minVersion: 0 },
        { name: 'ukm_source_id', packedOffset: 104, packedBitOffset: 0, type: mojo.internal.Int64, nullable: false, minVersion: 0 },
        { name: 'require_cross_site_request_for_cookies', packedOffset: 140, packedBitOffset: 2, type: mojo.internal.Bool, nullable: false, minVersion: 0 },
        { name: 'coep_reporting_observer_receiver', packedOffset: 132, packedBitOffset: 0, type: mojo.internal.InterfaceRequest, nullable: true, minVersion: 0 },
        { name: 'dip_reporting_observer_receiver', packedOffset: 136, packedBitOffset: 0, type: mojo.internal.InterfaceRequest, nullable: true, minVersion: 0 },
      ],
