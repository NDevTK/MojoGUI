...
mojo.internal.bindings.storage.mojom.QuotaManagerObserver = {};
mojo.internal.bindings.storage.mojom.QuotaManagerObserverSpec = { $ : {} };
mojo.internal.bindings.storage.mojom.QuotaManagerObserver.$interfaceName = 'storage.mojom.QuotaManagerObserver';
...
mojo.internal.bindings.storage.mojom.QuotaManagerObserverRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.storage.mojom.QuotaManagerObserverPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.storage.mojom.QuotaManagerObserverRemoteCallHandler(this.proxy);
  }
  ...
  onCreateOrUpdateBucket(arg_bucket_info) {
    return this.$.onCreateOrUpdateBucket(arg_bucket_info);
  }
  onDeleteBucket(arg_bucket_locator) {
    return this.$.onDeleteBucket(arg_bucket_locator);
  }
};

mojo.internal.bindings.storage.mojom.QuotaManagerObserverRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('storage.mojom.QuotaManagerObserver', [
      { explicit: null },
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.storage.mojom.QuotaManagerObserver.getRemote = function() {
  let remote = new mojo.internal.bindings.storage.mojom.QuotaManagerObserverRemote();
...
mojo.internal.bindings.storage.mojom.QuotaManagerObserverReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('storage.mojom.QuotaManagerObserver', [
      { explicit: null },
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.storage.mojom.QuotaManagerObserver_OnCreateOrUpdateBucket_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OnCreateOrUpdateBucket failed with TypeError');
           }
        }
        // Try Method 1: OnDeleteBucket
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.storage.mojom.QuotaManagerObserver_OnDeleteBucket_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OnDeleteBucket failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.storage.mojom.QuotaManagerObserverReceiver = mojo.internal.bindings.storage.mojom.QuotaManagerObserverReceiver;
