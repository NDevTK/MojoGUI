...
mojo.internal.bindings.skills.mojom.ToastTypeSpec = mojo.internal.bindings.skills.mojom.ToastTypeSpec || { $: mojo.internal.Enum().$ };
...
mojo.internal.bindings.skills.mojom.SkillsPageHandler_ShowToast_ParamsSpec = mojo.internal.bindings.skills.mojom.SkillsPageHandler_ShowToast_ParamsSpec || { $: {} };
...
// Enum: ToastType
mojo.internal.bindings.skills.mojom.ToastType = {
  kSave: 0,
  kDelete: 1,
};
...
mojo.internal.bindings.skills.mojom.SkillsPageHandlerRemote = class {
  ...
  showToast(arg_toast_type) {
    return this.$.showToast(arg_toast_type);
  }
...
mojo.internal.bindings.skills.mojom.SkillsPageHandlerRemoteCallHandler = class {
  ...
  showToast(arg_toast_type) {
    return this.proxy.sendMessage(
      this.ordinals[1],  // ordinal
      mojo.internal.bindings.skills.mojom.SkillsPageHandler_ShowToast_ParamsSpec,
      null,
      [arg_toast_type],
      false);
  }
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        ...
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.skills.mojom.SkillsPageHandler_ShowToast_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.showToast');
          const result = this.impl.showToast(params.arg_toast_type);
          break;
        }
        case 2: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
...
mojo.internal.Struct(
    mojo.internal.bindings.skills.mojom.SkillsPageHandler_ShowToast_ParamsSpec, 'skills.mojom.SkillsPageHandler_ShowToast_Params', [
      mojo.internal.StructField('arg_toast_type', 0, 0, mojo.internal.bindings.skills.mojom.ToastTypeSpec, null, false, 0, undefined),
    ],
    [[0, 16]]);
