...
mojo.internal.bindings.skills.mojom.SkillsPageHandlerRemote = class {
  ...
  showToast(arg_skill_id, arg_toast_type) {
    return this.$.showToast(arg_skill_id, arg_toast_type);
  }
};
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        ...
        case 1: {
          ...
          const result = this.impl.showToast(params.arg_skill_id, params.arg_toast_type);
          break;
        }
      }
      } catch (err) {
...
mojo.internal.Struct(
    mojo.internal.bindings.skills.mojom.SkillsPageHandler_ShowToast_ParamsSpec, 'skills.mojom.SkillsPageHandler_ShowToast_Params', [
      mojo.internal.StructField('arg_skill_id', 0, 0, mojo.internal.String, null, false, 0, undefined),
      mojo.internal.StructField('arg_toast_type', 8, 0, mojo.internal.bindings.skills.mojom.ToastTypeSpec, null, false, 0, undefined),
    ],
    [[0, 24]]);
