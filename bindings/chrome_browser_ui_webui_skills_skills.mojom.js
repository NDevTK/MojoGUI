...
if (mojo.internal.bindings.skills.mojom.SkillsPage_Update1PMap_ParamsSpec.$.structSpec && mojo.internal.bindings.skills.mojom.SkillsPage_Update1PMap_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.skills.mojom.SkillsPage_Update1PMap_ParamsSpec.$ = {};
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        ...
        case 2: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              const val = (response && typeof response === 'object' && 'arg_skill_map' in response) ? response['arg_skill_map'] : response;
              const resp_obj = { 'arg_skill_map': val };
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
...
mojo.internal.bindings.skills.mojom.SkillsPageRemote = class {
  ...
  update1PMap(arg_skill_map) {
    return this.$.update1PMap(arg_skill_map);
  }
};
...
mojo.internal.bindings.skills.mojom.SkillsPageRemoteCallHandler = class {
  ...
  update1PMap(arg_skill_map) {
    return this.proxy.sendMessage(
      this.ordinals[2],  // ordinal
      mojo.internal.bindings.skills.mojom.SkillsPage_Update1PMap_ParamsSpec,
      null,
      [arg_skill_map],
      false);
  }
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        ...
        case 2: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.skills.mojom.SkillsPage_Update1PMap_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.update1PMap');
          const result = this.impl.update1PMap(params.arg_skill_map);
          break;
        }
      }
      } catch (err) {
...
mojo.internal.Struct(
    mojo.internal.bindings.skills.mojom.SkillsPage_Update1PMap_ParamsSpec, 'skills.mojom.SkillsPage_Update1PMap_Params', [
      mojo.internal.StructField('arg_skill_map', 0, 0, mojo.internal.Map(mojo.internal.String, mojo.internal.Array(mojo.internal.bindings.skills.mojom.SkillSpec, false), false), null, false, 0, undefined),
    ],
    [[0, 16]]);
