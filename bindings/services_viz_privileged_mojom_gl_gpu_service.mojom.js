  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.viz.mojom.GpuService_EstablishGpuChannel_ParamsSpec.$.structSpec;
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.viz.mojom.GpuService_SetChannelClientPid_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for SetChannelClientPid failed with TypeError');
           }
        }
        // Try Method 2: SetChannelDiskCacheHandle
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.viz.mojom.GpuService_SetChannelDiskCacheHandle_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for SetChannelDiskCacheHandle failed with TypeError');
           }
        }
        // Try Method 3: SetChannelPersistentCachePendingBackend
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.viz.mojom.GpuService_SetChannelPersistentCachePendingBackend_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for SetChannelPersistentCachePendingBackend failed with TypeError');
           }
        }
        // Try Method 4: OnDiskCacheHandleDestoyed
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.viz.mojom.GpuService_OnDiskCacheHandleDestoyed_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OnDiskCacheHandleDestoyed failed with TypeError');
           }
        }
        // Try Method 5: CloseChannel
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.viz.mojom.GpuService_CloseChannel_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
        ...
        if (dispatchId === undefined) {
           try {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for ThrowJavaException failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
