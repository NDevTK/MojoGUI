...
mojo.internal.bindings.data_decoder.mojom.kTypeKey = "type";

mojo.internal.bindings.data_decoder.mojom.kTagKey = "tag";

mojo.internal.bindings.data_decoder.mojom.kTextKey = "text";

mojo.internal.bindings.data_decoder.mojom.kAttributesKey = "attributes";

mojo.internal.bindings.data_decoder.mojom.kChildrenKey = "children";

mojo.internal.bindings.data_decoder.mojom.kNamespacesKey = "namespaces";

mojo.internal.bindings.data_decoder.mojom.kElementType = "element";

mojo.internal.bindings.data_decoder.mojom.kTextNodeType = "text";

mojo.internal.bindings.data_decoder.mojom.kCDataNodeType = "cdata";

// Enum: WhitespaceBehavior
mojo.internal.bindings.data_decoder.mojom.WhitespaceBehavior = {
  kIgnore: 0,
...
mojo.internal.bindings.data_decoder.mojom.XmlParserRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.data_decoder.mojom.XmlParserRemoteCallHandler(this.proxy);
  }
  ...
  parse(arg_xml, arg_whitespace_behavior) {
    return this.$.parse(arg_xml, arg_whitespace_behavior);
  }
};
...
mojo.internal.bindings.data_decoder.mojom.XmlParser.getRemote = function() {
  let remote = new mojo.internal.bindings.data_decoder.mojom.XmlParserRemote();
...
mojo.internal.bindings.data_decoder.mojom.XmlParserReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
        ...
        case 0: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.data_decoder.mojom.XmlParser_Parse_ResponseParamsSpec, header, rawHeader);
               responder(response);
...
mojo.internal.bindings.data_decoder.mojom.XmlParserReceiver = mojo.internal.bindings.data_decoder.mojom.XmlParserReceiver;
