...
mojo.internal.bindings.ntp.most_relevant_tab_resumption.mojom.PageHandlerRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.ntp.most_relevant_tab_resumption.mojom.PageHandlerPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.ntp.most_relevant_tab_resumption.mojom.PageHandlerRemoteCallHandler(this.proxy);
  }
  ...
  dismissModule(arg_url_visits) {
    return this.$.dismissModule(arg_url_visits);
  }
  dismissURLVisit(arg_url_visit) {
    return this.$.dismissURLVisit(arg_url_visit);
  }
  restoreModule(arg_url_visits) {
    return this.$.restoreModule(arg_url_visits);
  }
  restoreURLVisit(arg_url_visit) {
    return this.$.restoreURLVisit(arg_url_visit);
  }
  recordAction(arg_action, arg_url_key, arg_visit_request_id) {
    return this.$.recordAction(arg_action, arg_url_key, arg_visit_request_id);
  }
};

mojo.internal.bindings.ntp.most_relevant_tab_resumption.mojom.PageHandlerRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('ntp.most_relevant_tab_resumption.mojom.PageHandler', [
      { explicit: null },
      { explicit: null },
      { explicit: null },
      { explicit: null },
...
mojo.internal.bindings.ntp.most_relevant_tab_resumption.mojom.PageHandler.getRemote = function() {
  let remote = new mojo.internal.bindings.ntp.most_relevant_tab_resumption.mojom.PageHandlerRemote();
...
mojo.internal.bindings.ntp.most_relevant_tab_resumption.mojom.PageHandlerReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('ntp.most_relevant_tab_resumption.mojom.PageHandler', [
      { explicit: null },
      { explicit: null },
      { explicit: null },
      { explicit: null },
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ntp.most_relevant_tab_resumption.mojom.PageHandler_GetURLVisits_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for GetURLVisits failed with TypeError');
           }
        }
        // Try Method 1: DismissModule
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ntp.most_relevant_tab_resumption.mojom.PageHandler_DismissModule_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ntp.most_relevant_tab_resumption.mojom.PageHandler_DismissURLVisit_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for DismissURLVisit failed with TypeError');
           }
        }
        // Try Method 3: RestoreModule
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ntp.most_relevant_tab_resumption.mojom.PageHandler_RestoreModule_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ntp.most_relevant_tab_resumption.mojom.PageHandler_RestoreURLVisit_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for RestoreURLVisit failed with TypeError');
           }
        }
        // Try Method 5: RecordAction
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ntp.most_relevant_tab_resumption.mojom.PageHandler_RecordAction_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for RecordAction failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.ntp.most_relevant_tab_resumption.mojom.PageHandler_GetURLVisits_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.ntp.most_relevant_tab_resumption.mojom.PageHandlerReceiver = mojo.internal.bindings.ntp.most_relevant_tab_resumption.mojom.PageHandlerReceiver;
