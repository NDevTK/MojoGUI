...
mojo.internal.bindings.chromecast.media.mojom.MediaCapsRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.chromecast.media.mojom.MediaCapsPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.chromecast.media.mojom.MediaCapsRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.chromecast.media.mojom.MediaCaps.getRemote = function() {
  let remote = new mojo.internal.bindings.chromecast.media.mojom.MediaCapsRemote();
...
mojo.internal.bindings.chromecast.media.mojom.MediaCapsReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.chromecast.media.mojom.MediaCaps_AddObserver_ParamsSpec.$.structSpec;
...
mojo.internal.bindings.chromecast.media.mojom.MediaCapsReceiver = mojo.internal.bindings.chromecast.media.mojom.MediaCapsReceiver;

mojo.internal.bindings.chromecast.media.mojom.MediaCapsPtr = mojo.internal.bindings.chromecast.media.mojom.MediaCapsRemote;
mojo.internal.bindings.chromecast.media.mojom.MediaCapsRequest = mojo.internal.bindings.chromecast.media.mojom.MediaCapsPendingReceiver;
...
mojo.internal.bindings.chromecast.media.mojom.MediaCapsObserverRemote = class {
  static get $interfaceName() {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.chromecast.media.mojom.MediaCapsObserverPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.chromecast.media.mojom.MediaCapsObserverRemoteCallHandler(this.proxy);
  }
  ...
  addSupportedCodecProfileLevel(arg_codec_profile_level) {
    return this.$.addSupportedCodecProfileLevel(arg_codec_profile_level);
  }
};
...
mojo.internal.bindings.chromecast.media.mojom.MediaCapsObserver.getRemote = function() {
  let remote = new mojo.internal.bindings.chromecast.media.mojom.MediaCapsObserverRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
...
mojo.internal.bindings.chromecast.media.mojom.MediaCapsObserverReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.chromecast.media.mojom.MediaCapsObserver_AddSupportedCodecProfileLevel_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for AddSupportedCodecProfileLevel failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
             console.warn('[GeneratedReceiver] Failed to discover ordinal ' + header.ordinal);
...
mojo.internal.bindings.chromecast.media.mojom.MediaCapsObserverReceiver = mojo.internal.bindings.chromecast.media.mojom.MediaCapsObserverReceiver;
