...
mojo.internal.bindings.blink.mojom.ProgressClientRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.blink.mojom.ProgressClientPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.blink.mojom.ProgressClientRemoteCallHandler(this.proxy);
  }
  ...
  onProgress(arg_delta) {
    return this.$.onProgress(arg_delta);
  }
};
...
mojo.internal.bindings.blink.mojom.ProgressClient.getRemote = function() {
  let remote = new mojo.internal.bindings.blink.mojom.ProgressClientRemote();
...
mojo.internal.bindings.blink.mojom.ProgressClientReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.blink.mojom.ProgressClient_OnProgress_ParamsSpec.$.structSpec;
...
mojo.internal.bindings.blink.mojom.ProgressClientReceiver = mojo.internal.bindings.blink.mojom.ProgressClientReceiver;

mojo.internal.bindings.blink.mojom.ProgressClientPtr = mojo.internal.bindings.blink.mojom.ProgressClientRemote;
mojo.internal.bindings.blink.mojom.ProgressClientRequest = mojo.internal.bindings.blink.mojom.ProgressClientPendingReceiver;
...
mojo.internal.bindings.blink.mojom.BlobRegistryRemote = class {
  static get $interfaceName() {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.blink.mojom.BlobRegistryPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.blink.mojom.BlobRegistryRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.blink.mojom.BlobRegistry.getRemote = function() {
  let remote = new mojo.internal.bindings.blink.mojom.BlobRegistryRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
...
mojo.internal.bindings.blink.mojom.BlobRegistryReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.blink.mojom.BlobRegistry_Register_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.blink.mojom.BlobRegistry_RegisterFromStream_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for RegisterFromStream failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
             console.warn('[GeneratedReceiver] Failed to discover ordinal ' + header.ordinal);
...
mojo.internal.bindings.blink.mojom.BlobRegistryReceiver = mojo.internal.bindings.blink.mojom.BlobRegistryReceiver;
