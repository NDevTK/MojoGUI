// Auto-generated MojoJS binding
 // Source: chromium_src/chrome/browser/glic/host/glic_internals.mojom
 // Module: glic.mojom
...
mojo.internal.bindings.glic.mojom.InternalsPageHandler_GetOpenTabs_ParamsSpec = mojo.internal.bindings.glic.mojom.InternalsPageHandler_GetOpenTabs_ParamsSpec || { $: {} };
if (mojo.internal.bindings.glic.mojom.InternalsPageHandler_GetOpenTabs_ParamsSpec.$.structSpec && mojo.internal.bindings.glic.mojom.InternalsPageHandler_GetOpenTabs_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.glic.mojom.InternalsPageHandler_GetOpenTabs_ParamsSpec.$ = {};
mojo.internal.bindings.glic.mojom.InternalsPageHandler_GetOpenTabs_ResponseParamsSpec = mojo.internal.bindings.glic.mojom.InternalsPageHandler_GetOpenTabs_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.glic.mojom.InternalsPageHandler_GetOpenTabs_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.glic.mojom.InternalsPageHandler_GetOpenTabs_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.glic.mojom.InternalsPageHandler_GetOpenTabs_ResponseParamsSpec.$ = {};
...
mojo.internal.bindings.glic.mojom.InternalsPageHandler_ShowExperimentalOptIn_ParamsSpec = mojo.internal.bindings.glic.mojom.InternalsPageHandler_ShowExperimentalOptIn_ParamsSpec || { $: {} };
if (mojo.internal.bindings.glic.mojom.InternalsPageHandler_ShowExperimentalOptIn_ParamsSpec.$.structSpec && mojo.internal.bindings.glic.mojom.InternalsPageHandler_ShowExperimentalOptIn_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.glic.mojom.InternalsPageHandler_ShowExperimentalOptIn_ParamsSpec.$ = {};
mojo.internal.bindings.glic.mojom.InternalsPageHandler_RevokeExperimentalTriggeringConsent_ParamsSpec = mojo.internal.bindings.glic.mojom.InternalsPageHandler_RevokeExperimentalTriggeringConsent_ParamsSpec || { $: {} };
if (mojo.internal.bindings.glic.mojom.InternalsPageHandler_RevokeExperimentalTriggeringConsent_ParamsSpec.$.structSpec && mojo.internal.bindings.glic.mojom.InternalsPageHandler_RevokeExperimentalTriggeringConsent_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.glic.mojom.InternalsPageHandler_RevokeExperimentalTriggeringConsent_ParamsSpec.$ = {};
mojo.internal.bindings.glic.mojom.InternalsPageHandler_RevokeGlicConsent_ParamsSpec = mojo.internal.bindings.glic.mojom.InternalsPageHandler_RevokeGlicConsent_ParamsSpec || { $: {} };
...
mojo.internal.bindings.glic.mojom.InternalsPageHandlerRemote = class {
  ...
  showExperimentalOptIn() {
    return this.$.showExperimentalOptIn();
  }
  revokeExperimentalTriggeringConsent() {
    return this.$.revokeExperimentalTriggeringConsent();
  }
  revokeGlicConsent() {
    return this.$.revokeGlicConsent();
  }
...
mojo.internal.bindings.glic.mojom.InternalsPageHandlerRemoteCallHandler = class {
  ...
  getOpenTabs() {
    return this.proxy.sendMessage(
      ...
      mojo.internal.bindings.glic.mojom.InternalsPageHandler_GetOpenTabs_ParamsSpec,
      mojo.internal.bindings.glic.mojom.InternalsPageHandler_GetOpenTabs_ResponseParamsSpec,
      [],
      false);
  }
  ...
  revokeGlicConsent() {
    return this.proxy.sendMessage(
      ...
      mojo.internal.bindings.glic.mojom.InternalsPageHandler_RevokeGlicConsent_ParamsSpec,
      null,
      [],
      false);
  }
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        ...
        case 3: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.glic.mojom.InternalsPageHandler_GetOpenTabs_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.getOpenTabs');
          const result = this.impl.getOpenTabs();
          const expectsResponse = header.expectsResponse || (header.flags & 1);
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              const val = (response && typeof response === 'object' && 'arg_tab_titles' in response) ? response['arg_tab_titles'] : response;
              const resp_obj = { 'arg_tab_titles': val };
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.glic.mojom.InternalsPageHandler_GetOpenTabs_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
            }).catch(e => console.error('[GeneratedReceiver] getOpenTabs FAILED:', e));
          }
          break;
        }
        case 4: {
        ...
        case 6: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.glic.mojom.InternalsPageHandler_ShowExperimentalOptIn_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.showExperimentalOptIn');
          const result = this.impl.showExperimentalOptIn();
          break;
        }
        case 7: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.glic.mojom.InternalsPageHandler_RevokeExperimentalTriggeringConsent_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.revokeExperimentalTriggeringConsent');
          const result = this.impl.revokeExperimentalTriggeringConsent();
          break;
        }
        case 8: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.glic.mojom.InternalsPageHandler_RevokeGlicConsent_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.revokeGlicConsent');
          const result = this.impl.revokeGlicConsent();
          break;
        }
        case 9: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
...
mojo.internal.Struct(
    mojo.internal.bindings.glic.mojom.TieredRolloutInfoSpec, 'glic.mojom.TieredRolloutInfo', [
      mojo.internal.StructField('arg_ai_subscription_tier_$flag', 0, 0, mojo.internal.Bool, false, false, 0, { isPrimary: true, linkedValueFieldName: 'arg_ai_subscription_tier_$value', originalFieldName: 'arg_ai_subscription_tier' }),
      mojo.internal.StructField('arg_is_eligible_for_tiered_rollout_v1', 0, 1, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_is_eligible_for_tiered_rollout_v2', 0, 2, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_is_eligible_for_benefit_based_rollout', 0, 3, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_is_eligible_overall', 0, 4, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_glic_rollout_eligibility_pref', 0, 5, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_ai_subscription_tier_$value', 4, 0, mojo.internal.Int32, 0, false, 0, { isPrimary: false, linkedValueFieldName: 'arg_ai_subscription_tier_$flag', originalFieldName: 'arg_ai_subscription_tier' }),
      mojo.internal.StructField('arg_tiered_rollout_v2_eligible_tiers', 8, 0, mojo.internal.String, null, false, 0, undefined),
      mojo.internal.StructField('arg_subscription_benefits', 16, 0, mojo.internal.Array(mojo.internal.String, false), null, false, 0, undefined),
      mojo.internal.StructField('arg_eligible_benefits', 24, 0, mojo.internal.String, null, false, 0, undefined),
      mojo.internal.StructField('arg_actor_eligible_benefits', 32, 0, mojo.internal.String, null, false, 0, undefined),
      mojo.internal.StructField('arg_preference_sync_status', 40, 0, mojo.internal.String, null, false, 0, undefined),
    ],
    [[0, 56]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.glic.mojom.InternalsDebugInfoSpec, 'glic.mojom.InternalsDebugInfo', [
      mojo.internal.StructField('arg_glic_actor_feature_enabled', 0, 0, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_glic_rollout_feature_enabled', 0, 1, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_glic_tiered_rollout_feature_enabled', 0, 2, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_glic_tiered_rollout_v2_feature_enabled', 0, 3, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_glic_subscription_benefits_eligibility_feature_enabled', 0, 4, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_system_requirement_met', 0, 5, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_os_version_supported', 0, 6, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_anchor_entrypoint_override_active', 0, 7, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_primary_account_needs_signed_in', 1, 0, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_platform', 4, 0, mojo.internal.bindings.glic.mojom.PlatformSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_form_factor', 8, 0, mojo.internal.bindings.glic.mojom.FormFactorSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_boolean_settings', 16, 0, mojo.internal.Map(mojo.internal.String, mojo.internal.Bool, false), null, false, 0, undefined),
      ...
      mojo.internal.StructField('arg_permanent_country_code', 40, 0, mojo.internal.String, null, false, 0, undefined),
      mojo.internal.StructField('arg_session_country_code', 48, 0, mojo.internal.String, null, false, 0, undefined),
      mojo.internal.StructField('arg_dogfood_status', 56, 0, mojo.internal.String, null, false, 0, undefined),
    ],
    [[0, 72]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.glic.mojom.InternalsPageHandler_GetOpenTabs_ParamsSpec, 'glic.mojom.InternalsPageHandler_GetOpenTabs_Params', [
    ],
    [[0, 8]]);

mojo.internal.Struct(
    mojo.internal.bindings.glic.mojom.InternalsPageHandler_GetOpenTabs_ResponseParamsSpec, 'glic.mojom.InternalsPageHandler_GetOpenTabs_ResponseParams', [
      mojo.internal.StructField('arg_tab_titles', 0, 0, mojo.internal.Array(mojo.internal.String, false), null, false, 0, undefined),
    ],
    [[0, 16]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.glic.mojom.InternalsPageHandler_ShowExperimentalOptIn_ParamsSpec, 'glic.mojom.InternalsPageHandler_ShowExperimentalOptIn_Params', [
    ],
    [[0, 8]]);

mojo.internal.Struct(
    mojo.internal.bindings.glic.mojom.InternalsPageHandler_RevokeExperimentalTriggeringConsent_ParamsSpec, 'glic.mojom.InternalsPageHandler_RevokeExperimentalTriggeringConsent_Params', [
    ],
    [[0, 8]]);

mojo.internal.Struct(
    mojo.internal.bindings.glic.mojom.InternalsPageHandler_RevokeGlicConsent_ParamsSpec, 'glic.mojom.InternalsPageHandler_RevokeGlicConsent_Params', [
    ],
    [[0, 8]]);
