...
mojo.internal.bindings.supervised_user.mojom.SupervisedUserCommandsRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.supervised_user.mojom.SupervisedUserCommandsPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.supervised_user.mojom.SupervisedUserCommandsRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.supervised_user.mojom.SupervisedUserCommands.getRemote = function() {
  let remote = new mojo.internal.bindings.supervised_user.mojom.SupervisedUserCommandsRemote();
...
mojo.internal.bindings.supervised_user.mojom.SupervisedUserCommandsReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.supervised_user.mojom.SupervisedUserCommands_GoBack_ParamsSpec.$.structSpec;
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.supervised_user.mojom.SupervisedUserCommands_RequestUrlAccessRemote_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for RequestUrlAccessRemote failed with TypeError');
           }
        }
        // Try Method 2: RequestUrlAccessLocal
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.supervised_user.mojom.SupervisedUserCommands_RequestUrlAccessLocal_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.supervised_user.mojom.SupervisedUserCommands_GoBack_ParamsSpec.$.structSpec);
        ...
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.supervised_user.mojom.SupervisedUserCommands_RequestUrlAccessRemote_ParamsSpec.$.structSpec);
        ...
        case 2: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.supervised_user.mojom.SupervisedUserCommands_RequestUrlAccessLocal_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.supervised_user.mojom.SupervisedUserCommandsReceiver = mojo.internal.bindings.supervised_user.mojom.SupervisedUserCommandsReceiver;
