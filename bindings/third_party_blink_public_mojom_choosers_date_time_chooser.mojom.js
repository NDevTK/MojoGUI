...
mojo.internal.Struct(
    mojo.internal.bindings.blink.mojom.DateTimeChooser_CloseDateTimeDialog_ParamsSpec, 'blink.mojom.DateTimeChooser_CloseDateTimeDialog_Params', [
    ],
    [[0, 8]]);

mojo.internal.bindings.blink.mojom.DateTimeChooserPendingReceiver = class {
  constructor(handle) {
    this.handle = handle;
  }
};

mojo.internal.bindings.blink.mojom.DateTimeChooserRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.blink.mojom.DateTimeChooserPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.blink.mojom.DateTimeChooserRemoteCallHandler(this.proxy);
  }
  ...
  openDateTimeDialog(arg_value) {
    return this.$.openDateTimeDialog(arg_value);
  }
  closeDateTimeDialog() {
...
mojo.internal.bindings.blink.mojom.DateTimeChooser.getRemote = function() {
  let remote = new mojo.internal.bindings.blink.mojom.DateTimeChooserRemote();
...
mojo.internal.bindings.blink.mojom.DateTimeChooserReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.blink.mojom.DateTimeChooser_OpenDateTimeDialog_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OpenDateTimeDialog failed with TypeError');
           }
        }
        // Try Method 1: CloseDateTimeDialog
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.blink.mojom.DateTimeChooser_CloseDateTimeDialog_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for CloseDateTimeDialog failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
      ...
      switch (dispatchId) {
        ...
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.blink.mojom.DateTimeChooser_CloseDateTimeDialog_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.blink.mojom.DateTimeChooserReceiver = mojo.internal.bindings.blink.mojom.DateTimeChooserReceiver;

mojo.internal.bindings.blink.mojom.DateTimeChooserPtr = mojo.internal.bindings.blink.mojom.DateTimeChooserRemote;
mojo.internal.bindings.blink.mojom.DateTimeChooserRequest = mojo.internal.bindings.blink.mojom.DateTimeChooserPendingReceiver;
