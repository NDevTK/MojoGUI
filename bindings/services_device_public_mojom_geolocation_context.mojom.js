...
mojo.internal.Struct(
    mojo.internal.bindings.device.mojom.GeolocationContext_BindGeolocation_ParamsSpec, 'device.mojom.GeolocationContext_BindGeolocation_Params', [
      ...
      mojo.internal.StructField('arg_has_precise_permission', 24, 0, mojo.internal.Bool, false, false, 0, undefined),
    ],
    [[0, 40]]);
...
mojo.internal.bindings.device.mojom.GeolocationContextRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.device.mojom.GeolocationContextRemoteCallHandler(this.proxy);
  }
  ...
  setOverride(arg_result) {
    return this.$.setOverride(arg_result);
  }
  clearOverride() {
...
mojo.internal.bindings.device.mojom.GeolocationContext.getRemote = function() {
  let remote = new mojo.internal.bindings.device.mojom.GeolocationContextRemote();
...
mojo.internal.bindings.device.mojom.GeolocationContextReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.device.mojom.GeolocationContext_BindGeolocation_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for BindGeolocation failed with TypeError');
           }
        }
        // Try Method 1: OnPermissionUpdated
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.device.mojom.GeolocationContext_OnPermissionUpdated_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OnPermissionUpdated failed with TypeError');
           }
        }
        // Try Method 2: SetOverride
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.device.mojom.GeolocationContext_SetOverride_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for SetOverride failed with TypeError');
           }
        }
        // Try Method 3: ClearOverride
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.device.mojom.GeolocationContext_ClearOverride_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for ClearOverride failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
      ...
      switch (dispatchId) {
        ...
        case 3: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.device.mojom.GeolocationContext_ClearOverride_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.device.mojom.GeolocationContextReceiver = mojo.internal.bindings.device.mojom.GeolocationContextReceiver;
