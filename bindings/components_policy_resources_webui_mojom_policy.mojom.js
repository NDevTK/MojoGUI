...
mojo.internal.bindings.policy.mojom.PolicyPageHandler_CheckCommandLineSwitches_ParamsSpec = mojo.internal.bindings.policy.mojom.PolicyPageHandler_CheckCommandLineSwitches_ParamsSpec || { $: {} };
if (mojo.internal.bindings.policy.mojom.PolicyPageHandler_CheckCommandLineSwitches_ParamsSpec.$.structSpec && mojo.internal.bindings.policy.mojom.PolicyPageHandler_CheckCommandLineSwitches_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.policy.mojom.PolicyPageHandler_CheckCommandLineSwitches_ParamsSpec.$ = {};
mojo.internal.bindings.policy.mojom.PolicyPageHandler_CheckCommandLineSwitches_ResponseParamsSpec = mojo.internal.bindings.policy.mojom.PolicyPageHandler_CheckCommandLineSwitches_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.policy.mojom.PolicyPageHandler_CheckCommandLineSwitches_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.policy.mojom.PolicyPageHandler_CheckCommandLineSwitches_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.policy.mojom.PolicyPageHandler_CheckCommandLineSwitches_ResponseParamsSpec.$ = {};
...
mojo.internal.bindings.policy.mojom.PolicyPageHandlerRemote = class {
  ...
  checkCommandLineSwitches() {
    return this.$.checkCommandLineSwitches();
  }
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        ...
        case 10: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.policy.mojom.PolicyPageHandler_CheckCommandLineSwitches_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.checkCommandLineSwitches');
          const result = this.impl.checkCommandLineSwitches();
          const expectsResponse = header.expectsResponse || (header.flags & 1);
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              const val = (response && typeof response === 'object' && 'arg_has_custom_flags' in response) ? response['arg_has_custom_flags'] : response;
              const resp_obj = { 'arg_has_custom_flags': val };
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.policy.mojom.PolicyPageHandler_CheckCommandLineSwitches_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
            }).catch(e => console.error('[GeneratedReceiver] checkCommandLineSwitches FAILED:', e));
          }
          break;
        }
        case 11: {
...
mojo.internal.Struct(
    mojo.internal.bindings.policy.mojom.PolicyPageHandler_CheckCommandLineSwitches_ParamsSpec, 'policy.mojom.PolicyPageHandler_CheckCommandLineSwitches_Params', [
    ],
    [[0, 8]]);

mojo.internal.Struct(
    mojo.internal.bindings.policy.mojom.PolicyPageHandler_CheckCommandLineSwitches_ResponseParamsSpec, 'policy.mojom.PolicyPageHandler_CheckCommandLineSwitches_ResponseParams', [
      mojo.internal.StructField('arg_has_custom_flags', 0, 0, mojo.internal.Bool, false, false, 0, undefined),
    ],
    [[0, 16]]);
