// Auto-generated MojoJS binding
 // Source: chromium_src/components/policy/resources/webui/mojom/policy.mojom
 // Module: policy.mojom
...
mojo.internal.bindings.policy.mojom = mojo.internal.bindings.policy.mojom || {};
mojo.internal.bindings.mojo_base = mojo.internal.bindings.mojo_base || {};
mojo.internal.bindings.mojo_base.mojom = mojo.internal.bindings.mojo_base.mojom || {};

mojo.internal.bindings.policy.mojom.GetPoliciesReasonSpec = mojo.internal.bindings.policy.mojom.GetPoliciesReasonSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.policy.mojom.LogSpec = mojo.internal.bindings.policy.mojom.LogSpec || { $: {} };
if (mojo.internal.bindings.policy.mojom.LogSpec.$.structSpec && mojo.internal.bindings.policy.mojom.LogSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.policy.mojom.LogSpec.$ = {};
mojo.internal.bindings.policy.mojom.StatusSpec = mojo.internal.bindings.policy.mojom.StatusSpec || { $: {} };
if (mojo.internal.bindings.policy.mojom.StatusSpec.$.structSpec && mojo.internal.bindings.policy.mojom.StatusSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.policy.mojom.StatusSpec.$ = {};
mojo.internal.bindings.policy.mojom.ConflictSpec = mojo.internal.bindings.policy.mojom.ConflictSpec || { $: {} };
if (mojo.internal.bindings.policy.mojom.ConflictSpec.$.structSpec && mojo.internal.bindings.policy.mojom.ConflictSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.policy.mojom.ConflictSpec.$ = {};
mojo.internal.bindings.policy.mojom.PolicySpec = mojo.internal.bindings.policy.mojom.PolicySpec || { $: {} };
if (mojo.internal.bindings.policy.mojom.PolicySpec.$.structSpec && mojo.internal.bindings.policy.mojom.PolicySpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.policy.mojom.PolicySpec.$ = {};
mojo.internal.bindings.policy.mojom.PolicyGroupSpec = mojo.internal.bindings.policy.mojom.PolicyGroupSpec || { $: {} };
if (mojo.internal.bindings.policy.mojom.PolicyGroupSpec.$.structSpec && mojo.internal.bindings.policy.mojom.PolicyGroupSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.policy.mojom.PolicyGroupSpec.$ = {};
mojo.internal.bindings.policy.mojom.PolicyGroupsResponseSpec = mojo.internal.bindings.policy.mojom.PolicyGroupsResponseSpec || { $: {} };
if (mojo.internal.bindings.policy.mojom.PolicyGroupsResponseSpec.$.structSpec && mojo.internal.bindings.policy.mojom.PolicyGroupsResponseSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.policy.mojom.PolicyGroupsResponseSpec.$ = {};
mojo.internal.bindings.policy.mojom.PolicyGroupNamesSpec = mojo.internal.bindings.policy.mojom.PolicyGroupNamesSpec || { $: {} };
if (mojo.internal.bindings.policy.mojom.PolicyGroupNamesSpec.$.structSpec && mojo.internal.bindings.policy.mojom.PolicyGroupNamesSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.policy.mojom.PolicyGroupNamesSpec.$ = {};
mojo.internal.bindings.policy.mojom.PolicyPageHandler = mojo.internal.bindings.policy.mojom.PolicyPageHandler || {};
mojo.internal.bindings.policy.mojom.PolicyPageHandlerSpec = mojo.internal.bindings.policy.mojom.PolicyPageHandlerSpec || { $ : {} };
if (mojo.internal.bindings.policy.mojom.PolicyPageHandlerSpec.$.structSpec && mojo.internal.bindings.policy.mojom.PolicyPageHandlerSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.policy.mojom.PolicyPageHandlerSpec.$ = {};
mojo.internal.bindings.policy.mojom.PolicyPageHandler.$interfaceName = 'policy.mojom.PolicyPageHandler';
mojo.internal.bindings.policy.mojom.PolicyPageHandler_GetDebugString_ParamsSpec = mojo.internal.bindings.policy.mojom.PolicyPageHandler_GetDebugString_ParamsSpec || { $: {} };
...
mojo.internal.bindings.policy.mojom.PolicyPageHandler_GetPolicyLogs_ParamsSpec = mojo.internal.bindings.policy.mojom.PolicyPageHandler_GetPolicyLogs_ParamsSpec || { $: {} };
if (mojo.internal.bindings.policy.mojom.PolicyPageHandler_GetPolicyLogs_ParamsSpec.$.structSpec && mojo.internal.bindings.policy.mojom.PolicyPageHandler_GetPolicyLogs_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.policy.mojom.PolicyPageHandler_GetPolicyLogs_ParamsSpec.$ = {};
mojo.internal.bindings.policy.mojom.PolicyPageHandler_GetPolicyLogs_ResponseParamsSpec = mojo.internal.bindings.policy.mojom.PolicyPageHandler_GetPolicyLogs_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.policy.mojom.PolicyPageHandler_GetPolicyLogs_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.policy.mojom.PolicyPageHandler_GetPolicyLogs_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.policy.mojom.PolicyPageHandler_GetPolicyLogs_ResponseParamsSpec.$ = {};
mojo.internal.bindings.policy.mojom.PolicyPageHandler_CheckPromotionEligibility_ParamsSpec = mojo.internal.bindings.policy.mojom.PolicyPageHandler_CheckPromotionEligibility_ParamsSpec || { $: {} };
if (mojo.internal.bindings.policy.mojom.PolicyPageHandler_CheckPromotionEligibility_ParamsSpec.$.structSpec && mojo.internal.bindings.policy.mojom.PolicyPageHandler_CheckPromotionEligibility_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.policy.mojom.PolicyPageHandler_CheckPromotionEligibility_ParamsSpec.$ = {};
mojo.internal.bindings.policy.mojom.PolicyPageHandler_CheckPromotionEligibility_ResponseParamsSpec = mojo.internal.bindings.policy.mojom.PolicyPageHandler_CheckPromotionEligibility_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.policy.mojom.PolicyPageHandler_CheckPromotionEligibility_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.policy.mojom.PolicyPageHandler_CheckPromotionEligibility_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.policy.mojom.PolicyPageHandler_CheckPromotionEligibility_ResponseParamsSpec.$ = {};
mojo.internal.bindings.policy.mojom.PolicyPageHandler_SetBannerDismissed_ParamsSpec = mojo.internal.bindings.policy.mojom.PolicyPageHandler_SetBannerDismissed_ParamsSpec || { $: {} };
if (mojo.internal.bindings.policy.mojom.PolicyPageHandler_SetBannerDismissed_ParamsSpec.$.structSpec && mojo.internal.bindings.policy.mojom.PolicyPageHandler_SetBannerDismissed_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.policy.mojom.PolicyPageHandler_SetBannerDismissed_ParamsSpec.$ = {};
mojo.internal.bindings.policy.mojom.PolicyPageHandler_RecordBannerRedirected_ParamsSpec = mojo.internal.bindings.policy.mojom.PolicyPageHandler_RecordBannerRedirected_ParamsSpec || { $: {} };
if (mojo.internal.bindings.policy.mojom.PolicyPageHandler_RecordBannerRedirected_ParamsSpec.$.structSpec && mojo.internal.bindings.policy.mojom.PolicyPageHandler_RecordBannerRedirected_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.policy.mojom.PolicyPageHandler_RecordBannerRedirected_ParamsSpec.$ = {};
mojo.internal.bindings.policy.mojom.PolicyPageHandler_GetPoliciesJson_ParamsSpec = mojo.internal.bindings.policy.mojom.PolicyPageHandler_GetPoliciesJson_ParamsSpec || { $: {} };
if (mojo.internal.bindings.policy.mojom.PolicyPageHandler_GetPoliciesJson_ParamsSpec.$.structSpec && mojo.internal.bindings.policy.mojom.PolicyPageHandler_GetPoliciesJson_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.policy.mojom.PolicyPageHandler_GetPoliciesJson_ParamsSpec.$ = {};
mojo.internal.bindings.policy.mojom.PolicyPageHandler_GetPoliciesJson_ResponseParamsSpec = mojo.internal.bindings.policy.mojom.PolicyPageHandler_GetPoliciesJson_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.policy.mojom.PolicyPageHandler_GetPoliciesJson_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.policy.mojom.PolicyPageHandler_GetPoliciesJson_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.policy.mojom.PolicyPageHandler_GetPoliciesJson_ResponseParamsSpec.$ = {};
...
mojo.internal.bindings.policy.mojom.PolicyPageClient.$interfaceName = 'policy.mojom.PolicyPageClient';
mojo.internal.bindings.policy.mojom.PolicyPageClient_StatusUpdated_ParamsSpec = mojo.internal.bindings.policy.mojom.PolicyPageClient_StatusUpdated_ParamsSpec || { $: {} };
if (mojo.internal.bindings.policy.mojom.PolicyPageClient_StatusUpdated_ParamsSpec.$.structSpec && mojo.internal.bindings.policy.mojom.PolicyPageClient_StatusUpdated_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.policy.mojom.PolicyPageClient_StatusUpdated_ParamsSpec.$ = {};
mojo.internal.bindings.policy.mojom.PolicyPageClient_PoliciesUpdated_ParamsSpec = mojo.internal.bindings.policy.mojom.PolicyPageClient_PoliciesUpdated_ParamsSpec || { $: {} };
if (mojo.internal.bindings.policy.mojom.PolicyPageClient_PoliciesUpdated_ParamsSpec.$.structSpec && mojo.internal.bindings.policy.mojom.PolicyPageClient_PoliciesUpdated_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.policy.mojom.PolicyPageClient_PoliciesUpdated_ParamsSpec.$ = {};
mojo.internal.bindings.policy.mojom.PolicyPageHandlerFactory = mojo.internal.bindings.policy.mojom.PolicyPageHandlerFactory || {};
mojo.internal.bindings.policy.mojom.PolicyPageHandlerFactorySpec = mojo.internal.bindings.policy.mojom.PolicyPageHandlerFactorySpec || { $ : {} };
if (mojo.internal.bindings.policy.mojom.PolicyPageHandlerFactorySpec.$.structSpec && mojo.internal.bindings.policy.mojom.PolicyPageHandlerFactorySpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.policy.mojom.PolicyPageHandlerFactorySpec.$ = {};
mojo.internal.bindings.policy.mojom.PolicyPageHandlerFactory.$interfaceName = 'policy.mojom.PolicyPageHandlerFactory';
mojo.internal.bindings.policy.mojom.PolicyPageHandlerFactory_CreateHandler_ParamsSpec = mojo.internal.bindings.policy.mojom.PolicyPageHandlerFactory_CreateHandler_ParamsSpec || { $: {} };
if (mojo.internal.bindings.policy.mojom.PolicyPageHandlerFactory_CreateHandler_ParamsSpec.$.structSpec && mojo.internal.bindings.policy.mojom.PolicyPageHandlerFactory_CreateHandler_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.policy.mojom.PolicyPageHandlerFactory_CreateHandler_ParamsSpec.$ = {};
...
mojo.internal.bindings.policy.mojom.GetPoliciesReason = {
  kCopy: 0,
  kExport: 1,
};

// Interface: PolicyPageHandler
mojo.internal.bindings.policy.mojom.PolicyPageHandlerPendingReceiver = class {
  constructor(handle) {
    this.handle = handle;
    if (handle) {
...
mojo.internal.bindings.policy.mojom.PolicyPageHandlerRemote = class {
  static get $interfaceName() {
    return 'policy.mojom.PolicyPageHandler';
  }

  constructor(handle = undefined) {
    this.__mojoHandle = handle;
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.policy.mojom.PolicyPageHandlerPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.policy.mojom.PolicyPageHandlerRemoteCallHandler(this.proxy);
  }
  ...
  getPolicyLogs() {
    return this.$.getPolicyLogs();
  }
  checkPromotionEligibility() {
    return this.$.checkPromotionEligibility();
  }
  setBannerDismissed() {
    return this.$.setBannerDismissed();
  }
  recordBannerRedirected() {
    return this.$.recordBannerRedirected();
  }
  getPoliciesJson(arg_reason) {
    return this.$.getPoliciesJson(arg_reason);
  }
};
...
mojo.internal.bindings.policy.mojom.PolicyPageHandlerRemoteCallHandler = class {
  ...
  getPolicyLogs() {
    return this.proxy.sendMessage(
      ...
      mojo.internal.bindings.policy.mojom.PolicyPageHandler_GetPolicyLogs_ParamsSpec,
      mojo.internal.bindings.policy.mojom.PolicyPageHandler_GetPolicyLogs_ResponseParamsSpec,
      [],
      false);
  }
  ...
  setBannerDismissed() {
    return this.proxy.sendMessage(
      ...
      mojo.internal.bindings.policy.mojom.PolicyPageHandler_SetBannerDismissed_ParamsSpec,
      null,
      [],
      false);
  }
  ...
  getPoliciesJson(arg_reason) {
    return this.proxy.sendMessage(
      ...
      mojo.internal.bindings.policy.mojom.PolicyPageHandler_GetPoliciesJson_ParamsSpec,
      mojo.internal.bindings.policy.mojom.PolicyPageHandler_GetPoliciesJson_ResponseParamsSpec,
      [arg_reason],
      false);
  }
...
mojo.internal.bindings.policy.mojom.PolicyPageHandler.getRemote = function() {
  let remote = new mojo.internal.bindings.policy.mojom.PolicyPageHandlerRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
    'policy.mojom.PolicyPageHandler',
    'context');
  return remote.$;
};

mojo.internal.bindings.policy.mojom.PolicyPageHandlerReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        case 0: {
          ...
          const params = decoder.decodeStructInline(mojo.internal.bindings.policy.mojom.PolicyPageHandler_GetDebugString_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.getDebugString');
          const result = this.impl.getDebugString();
        ...
        case 6: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.policy.mojom.PolicyPageHandler_GetPolicyLogs_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.getPolicyLogs');
          const result = this.impl.getPolicyLogs();
          const expectsResponse = header.expectsResponse || (header.flags & 1);
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              const val = (response && typeof response === 'object' && 'arg_policy_logs' in response) ? response['arg_policy_logs'] : response;
              const resp_obj = { 'arg_policy_logs': val };
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.policy.mojom.PolicyPageHandler_GetPolicyLogs_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
            }).catch(e => console.error('[GeneratedReceiver] getPolicyLogs FAILED:', e));
          }
          break;
        }
        case 7: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.policy.mojom.PolicyPageHandler_CheckPromotionEligibility_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.checkPromotionEligibility');
          const result = this.impl.checkPromotionEligibility();
          const expectsResponse = header.expectsResponse || (header.flags & 1);
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              const val = (response && typeof response === 'object' && 'arg_should_show_promotion' in response) ? response['arg_should_show_promotion'] : response;
              const resp_obj = { 'arg_should_show_promotion': val };
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.policy.mojom.PolicyPageHandler_CheckPromotionEligibility_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
            }).catch(e => console.error('[GeneratedReceiver] checkPromotionEligibility FAILED:', e));
          }
          break;
        }
        case 8: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.policy.mojom.PolicyPageHandler_SetBannerDismissed_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.setBannerDismissed');
          const result = this.impl.setBannerDismissed();
          break;
        }
        case 9: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.policy.mojom.PolicyPageHandler_RecordBannerRedirected_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.recordBannerRedirected');
          const result = this.impl.recordBannerRedirected();
          break;
        }
        case 10: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.policy.mojom.PolicyPageHandler_GetPoliciesJson_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.getPoliciesJson');
          const result = this.impl.getPoliciesJson(params.arg_reason);
          const expectsResponse = header.expectsResponse || (header.flags & 1);
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.policy.mojom.PolicyPageHandler_GetPoliciesJson_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
...
mojo.internal.bindings.policy.mojom.PolicyPageHandlerReceiver = mojo.internal.bindings.policy.mojom.PolicyPageHandlerReceiver;

mojo.internal.bindings.policy.mojom.PolicyPageHandlerPtr = mojo.internal.bindings.policy.mojom.PolicyPageHandlerRemote;
mojo.internal.bindings.policy.mojom.PolicyPageHandlerRequest = mojo.internal.bindings.policy.mojom.PolicyPageHandlerPendingReceiver;


// Interface: PolicyPageClient
mojo.internal.bindings.policy.mojom.PolicyPageClientPendingReceiver = class {
  constructor(handle) {
    this.handle = handle;
    if (handle) {
      this.__mojoHandle = handle.router_ ? handle.router_.pipe_ : (handle.pipe_ || handle);
...
mojo.internal.bindings.policy.mojom.PolicyPageClientRemote = class {
  static get $interfaceName() {
    return 'policy.mojom.PolicyPageClient';
  }

  constructor(handle = undefined) {
    this.__mojoHandle = handle;
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.policy.mojom.PolicyPageClientPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.policy.mojom.PolicyPageClientRemoteCallHandler(this.proxy);
  }
  ...
  statusUpdated(arg_status) {
    return this.$.statusUpdated(arg_status);
  }
  policiesUpdated(arg_policy_names, arg_policy_values) {
    return this.$.policiesUpdated(arg_policy_names, arg_policy_values);
  }
};

mojo.internal.bindings.policy.mojom.PolicyPageClientRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('policy.mojom.PolicyPageClient', [
      { explicit: null },
      { explicit: null },
    ]);
  }
  ...
  statusUpdated(arg_status) {
    return this.proxy.sendMessage(
      this.ordinals[0],  // ordinal
      mojo.internal.bindings.policy.mojom.PolicyPageClient_StatusUpdated_ParamsSpec,
      null,
      [arg_status],
      false);
  }
  ...
  policiesUpdated(arg_policy_names, arg_policy_values) {
    return this.proxy.sendMessage(
      this.ordinals[1],  // ordinal
      mojo.internal.bindings.policy.mojom.PolicyPageClient_PoliciesUpdated_ParamsSpec,
      null,
      [arg_policy_names, arg_policy_values],
      false);
  }

};

mojo.internal.bindings.policy.mojom.PolicyPageClient.getRemote = function() {
  let remote = new mojo.internal.bindings.policy.mojom.PolicyPageClientRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
    'policy.mojom.PolicyPageClient',
    'context');
  return remote.$;
};

mojo.internal.bindings.policy.mojom.PolicyPageClientReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('policy.mojom.PolicyPageClient', [
      { explicit: null },
      { explicit: null },
    ]);
    ordinals.forEach((ord, idx) => {
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.policy.mojom.PolicyPageClient_StatusUpdated_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.statusUpdated');
          const result = this.impl.statusUpdated(params.arg_status);
          break;
        }
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.policy.mojom.PolicyPageClient_PoliciesUpdated_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.policiesUpdated');
          const result = this.impl.policiesUpdated(params.arg_policy_names, params.arg_policy_values);
          break;
        }
      }
      } catch (err) {
...
mojo.internal.bindings.policy.mojom.PolicyPageClientReceiver = mojo.internal.bindings.policy.mojom.PolicyPageClientReceiver;

mojo.internal.bindings.policy.mojom.PolicyPageClientPtr = mojo.internal.bindings.policy.mojom.PolicyPageClientRemote;
mojo.internal.bindings.policy.mojom.PolicyPageClientRequest = mojo.internal.bindings.policy.mojom.PolicyPageClientPendingReceiver;


// Interface: PolicyPageHandlerFactory
mojo.internal.bindings.policy.mojom.PolicyPageHandlerFactoryPendingReceiver = class {
  constructor(handle) {
    this.handle = handle;
    if (handle) {
      this.__mojoHandle = handle.router_ ? handle.router_.pipe_ : (handle.pipe_ || handle);
...
mojo.internal.bindings.policy.mojom.PolicyPageHandlerFactoryRemote = class {
  static get $interfaceName() {
    return 'policy.mojom.PolicyPageHandlerFactory';
  }

  constructor(handle = undefined) {
    this.__mojoHandle = handle;
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.policy.mojom.PolicyPageHandlerFactoryPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.policy.mojom.PolicyPageHandlerFactoryRemoteCallHandler(this.proxy);
  }
  ...
  createHandler(arg_handler, arg_client) {
    return this.$.createHandler(arg_handler, arg_client);
  }
};

mojo.internal.bindings.policy.mojom.PolicyPageHandlerFactoryRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('policy.mojom.PolicyPageHandlerFactory', [
      { explicit: null },
    ]);
  }
  ...
  createHandler(arg_handler, arg_client) {
    return this.proxy.sendMessage(
      this.ordinals[0],  // ordinal
      mojo.internal.bindings.policy.mojom.PolicyPageHandlerFactory_CreateHandler_ParamsSpec,
      null,
...
mojo.internal.bindings.policy.mojom.PolicyPageHandlerFactory.getRemote = function() {
  let remote = new mojo.internal.bindings.policy.mojom.PolicyPageHandlerFactoryRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
...
mojo.internal.bindings.policy.mojom.PolicyPageHandlerFactoryReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('policy.mojom.PolicyPageHandlerFactory', [
      { explicit: null },
    ]);
    ordinals.forEach((ord, idx) => {
      this.ordinalMap.set(ord, idx); // Scrambled/Explicit
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.policy.mojom.PolicyPageHandlerFactory_CreateHandler_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.createHandler');
          const result = this.impl.createHandler(params.arg_handler, params.arg_client);
          break;
        }
      }
      } catch (err) {
...
mojo.internal.bindings.policy.mojom.PolicyPageHandlerFactoryReceiver = mojo.internal.bindings.policy.mojom.PolicyPageHandlerFactoryReceiver;

mojo.internal.bindings.policy.mojom.PolicyPageHandlerFactoryPtr = mojo.internal.bindings.policy.mojom.PolicyPageHandlerFactoryRemote;
mojo.internal.bindings.policy.mojom.PolicyPageHandlerFactoryRequest = mojo.internal.bindings.policy.mojom.PolicyPageHandlerFactoryPendingReceiver;
...
mojo.internal.Struct(
    mojo.internal.bindings.policy.mojom.LogSpec, 'policy.mojom.Log', [
      mojo.internal.StructField('arg_message', 0, 0, mojo.internal.String, null, false, 0, undefined),
      mojo.internal.StructField('arg_log_severity', 8, 0, mojo.internal.String, null, false, 0, undefined),
      mojo.internal.StructField('arg_log_source', 16, 0, mojo.internal.String, null, false, 0, undefined),
      mojo.internal.StructField('arg_file_and_line', 24, 0, mojo.internal.String, null, false, 0, undefined),
      mojo.internal.StructField('arg_location', 32, 0, mojo.internal.String, null, false, 0, undefined),
      mojo.internal.StructField('arg_timestamp', 40, 0, mojo.internal.String, null, false, 0, undefined),
    ],
    [[0, 56]]);

// Struct: Status
mojo.internal.Struct(
    mojo.internal.bindings.policy.mojom.StatusSpec, 'policy.mojom.Status', [
      mojo.internal.StructField('arg_policy_description_key', 0, 0, mojo.internal.String, null, false, 0, undefined),
      mojo.internal.StructField('arg_flex_org_warning', 8, 0, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_is_off_hours_active_$flag', 8, 1, mojo.internal.Bool, false, false, 0, { isPrimary: true, linkedValueFieldName: 'arg_is_off_hours_active_$value', originalFieldName: 'arg_is_off_hours_active' }),
      mojo.internal.StructField('arg_is_off_hours_active_$value', 8, 2, mojo.internal.Bool, false, false, 0, { isPrimary: false, linkedValueFieldName: 'arg_is_off_hours_active_$flag', originalFieldName: 'arg_is_off_hours_active' }),
      mojo.internal.StructField('arg_is_affiliated_$flag', 8, 3, mojo.internal.Bool, false, false, 0, { isPrimary: true, linkedValueFieldName: 'arg_is_affiliated_$value', originalFieldName: 'arg_is_affiliated' }),
      mojo.internal.StructField('arg_is_affiliated_$value', 8, 4, mojo.internal.Bool, false, false, 0, { isPrimary: false, linkedValueFieldName: 'arg_is_affiliated_$flag', originalFieldName: 'arg_is_affiliated' }),
      mojo.internal.StructField('arg_policies_push_available', 8, 5, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_error', 8, 6, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_extension_install_error', 8, 7, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_asset_id', 16, 0, mojo.internal.String, null, true, 0, undefined),
      mojo.internal.StructField('arg_location', 24, 0, mojo.internal.String, null, true, 0, undefined),
      mojo.internal.StructField('arg_directory_api_id', 32, 0, mojo.internal.String, null, true, 0, undefined),
      mojo.internal.StructField('arg_client_id', 40, 0, mojo.internal.String, null, false, 0, undefined),
      mojo.internal.StructField('arg_device_id', 48, 0, mojo.internal.String, null, false, 0, undefined),
      mojo.internal.StructField('arg_enrollment_token', 56, 0, mojo.internal.String, null, false, 0, undefined),
      mojo.internal.StructField('arg_domain', 64, 0, mojo.internal.String, null, false, 0, undefined),
      mojo.internal.StructField('arg_machine', 72, 0, mojo.internal.String, null, true, 0, undefined),
      mojo.internal.StructField('arg_version', 80, 0, mojo.internal.String, null, true, 0, undefined),
      mojo.internal.StructField('arg_username', 88, 0, mojo.internal.String, null, true, 0, undefined),
      mojo.internal.StructField('arg_gaia_id', 96, 0, mojo.internal.String, null, true, 0, undefined),
      mojo.internal.StructField('arg_profile_id', 104, 0, mojo.internal.String, null, true, 0, undefined),
      mojo.internal.StructField('arg_status', 112, 0, mojo.internal.String, null, false, 0, undefined),
      mojo.internal.StructField('arg_extension_install_status', 120, 0, mojo.internal.String, null, false, 0, undefined),
      mojo.internal.StructField('arg_refresh_interval', 128, 0, mojo.internal.String, null, true, 0, undefined),
      mojo.internal.StructField('arg_time_since_last_refresh', 136, 0, mojo.internal.String, null, true, 0, undefined),
      mojo.internal.StructField('arg_time_since_last_fetch_attempt', 144, 0, mojo.internal.String, null, true, 0, undefined),
      mojo.internal.StructField('arg_extension_install_time_since_last_refresh', 152, 0, mojo.internal.String, null, true, 0, undefined),
      mojo.internal.StructField('arg_extension_install_time_since_last_fetch_attempt', 160, 0, mojo.internal.String, null, true, 0, undefined),
      mojo.internal.StructField('arg_last_cloud_report_sent_timestamp', 168, 0, mojo.internal.String, null, true, 0, undefined),
      mojo.internal.StructField('arg_time_since_last_cloud_report_sent', 176, 0, mojo.internal.String, null, true, 0, undefined),
      mojo.internal.StructField('arg_enterprise_domain_manager', 184, 0, mojo.internal.String, null, true, 0, undefined),
    ],
    [[0, 200]]);

// Struct: Conflict
mojo.internal.Struct(
    mojo.internal.bindings.policy.mojom.ConflictSpec, 'policy.mojom.Conflict', [
      mojo.internal.StructField('arg_level', 0, 0, mojo.internal.String, null, false, 0, undefined),
...
// Struct: Policy
mojo.internal.Struct(
    mojo.internal.bindings.policy.mojom.PolicySpec, 'policy.mojom.Policy', [
      mojo.internal.StructField('arg_ignored', 0, 0, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_restart_required', 0, 1, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_deprecated', 0, 2, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_future', 0, 3, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_all_sources_merged_$flag', 0, 4, mojo.internal.Bool, false, false, 0, { isPrimary: true, linkedValueFieldName: 'arg_all_sources_merged_$value', originalFieldName: 'arg_all_sources_merged' }),
      mojo.internal.StructField('arg_all_sources_merged_$value', 0, 5, mojo.internal.Bool, false, false, 0, { isPrimary: false, linkedValueFieldName: 'arg_all_sources_merged_$flag', originalFieldName: 'arg_all_sources_merged' }),
      mojo.internal.StructField('arg_name', 8, 0, mojo.internal.String, null, false, 0, undefined),
      mojo.internal.StructField('arg_level', 16, 0, mojo.internal.String, null, false, 0, undefined),
      mojo.internal.StructField('arg_scope', 24, 0, mojo.internal.String, null, false, 0, undefined),
      mojo.internal.StructField('arg_source', 32, 0, mojo.internal.String, null, false, 0, undefined),
      mojo.internal.StructField('arg_value', 40, 0, mojo.internal.bindings.mojo_base.mojom.ValueSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_conflicts', 56, 0, mojo.internal.Array(mojo.internal.bindings.policy.mojom.ConflictSpec, false), null, false, 0, undefined),
      mojo.internal.StructField('arg_superseded', 64, 0, mojo.internal.Array(mojo.internal.bindings.policy.mojom.ConflictSpec, false), null, false, 0, undefined),
      mojo.internal.StructField('arg_error', 72, 0, mojo.internal.String, null, false, 0, undefined),
      mojo.internal.StructField('arg_warning', 80, 0, mojo.internal.String, null, false, 0, undefined),
      mojo.internal.StructField('arg_info', 88, 0, mojo.internal.String, null, false, 0, undefined),
    ],
    [[0, 104]]);

// Struct: PolicyGroup
mojo.internal.Struct(
    mojo.internal.bindings.policy.mojom.PolicyGroupSpec, 'policy.mojom.PolicyGroup', [
      mojo.internal.StructField('arg_name', 0, 0, mojo.internal.String, null, false, 0, undefined),
      mojo.internal.StructField('arg_policies', 8, 0, mojo.internal.Map(mojo.internal.String, mojo.internal.bindings.policy.mojom.PolicySpec, false), null, false, 0, undefined),
      mojo.internal.StructField('arg_precedence_order', 16, 0, mojo.internal.Array(mojo.internal.String, false), null, true, 0, undefined),
      mojo.internal.StructField('arg_is_extension', 24, 0, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_for_signin_screen', 24, 1, mojo.internal.Bool, false, false, 0, undefined),
    ],
    [[0, 40]]);

// Struct: PolicyGroupsResponse
mojo.internal.Struct(
    mojo.internal.bindings.policy.mojom.PolicyGroupsResponseSpec, 'policy.mojom.PolicyGroupsResponse', [
      mojo.internal.StructField('arg_policy_ids_presentation_order', 0, 0, mojo.internal.Array(mojo.internal.String, false), null, false, 0, undefined),
      mojo.internal.StructField('arg_policy_groups', 8, 0, mojo.internal.Map(mojo.internal.String, mojo.internal.bindings.policy.mojom.PolicyGroupSpec, false), null, false, 0, undefined),
    ],
    [[0, 24]]);

// Struct: PolicyGroupNames
mojo.internal.Struct(
    mojo.internal.bindings.policy.mojom.PolicyGroupNamesSpec, 'policy.mojom.PolicyGroupNames', [
      mojo.internal.StructField('arg_name', 0, 0, mojo.internal.String, null, false, 0, undefined),
      mojo.internal.StructField('arg_policy_names', 8, 0, mojo.internal.Array(mojo.internal.String, false), null, false, 0, undefined),
    ],
    [[0, 24]]);
mojo.internal.Struct(
    mojo.internal.bindings.policy.mojom.PolicyPageHandler_GetDebugString_ParamsSpec, 'policy.mojom.PolicyPageHandler_GetDebugString_Params', [
    ],
    [[0, 8]]);

mojo.internal.Struct(
    mojo.internal.bindings.policy.mojom.PolicyPageHandler_GetDebugString_ResponseParamsSpec, 'policy.mojom.PolicyPageHandler_GetDebugString_ResponseParams', [
      mojo.internal.StructField('arg_message', 0, 0, mojo.internal.String, null, false, 0, undefined),
    ],
    [[0, 16]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.policy.mojom.PolicyPageHandler_GetPolicyLogs_ParamsSpec, 'policy.mojom.PolicyPageHandler_GetPolicyLogs_Params', [
    ],
    [[0, 8]]);

mojo.internal.Struct(
    mojo.internal.bindings.policy.mojom.PolicyPageHandler_GetPolicyLogs_ResponseParamsSpec, 'policy.mojom.PolicyPageHandler_GetPolicyLogs_ResponseParams', [
      mojo.internal.StructField('arg_policy_logs', 0, 0, mojo.internal.Array(mojo.internal.bindings.policy.mojom.LogSpec, false), null, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.policy.mojom.PolicyPageHandler_CheckPromotionEligibility_ParamsSpec, 'policy.mojom.PolicyPageHandler_CheckPromotionEligibility_Params', [
    ],
    [[0, 8]]);

mojo.internal.Struct(
    mojo.internal.bindings.policy.mojom.PolicyPageHandler_CheckPromotionEligibility_ResponseParamsSpec, 'policy.mojom.PolicyPageHandler_CheckPromotionEligibility_ResponseParams', [
      mojo.internal.StructField('arg_should_show_promotion', 0, 0, mojo.internal.Bool, false, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.policy.mojom.PolicyPageHandler_SetBannerDismissed_ParamsSpec, 'policy.mojom.PolicyPageHandler_SetBannerDismissed_Params', [
    ],
    [[0, 8]]);

mojo.internal.Struct(
    mojo.internal.bindings.policy.mojom.PolicyPageHandler_RecordBannerRedirected_ParamsSpec, 'policy.mojom.PolicyPageHandler_RecordBannerRedirected_Params', [
    ],
    [[0, 8]]);

mojo.internal.Struct(
    mojo.internal.bindings.policy.mojom.PolicyPageHandler_GetPoliciesJson_ParamsSpec, 'policy.mojom.PolicyPageHandler_GetPoliciesJson_Params', [
      mojo.internal.StructField('arg_reason', 0, 0, mojo.internal.bindings.policy.mojom.GetPoliciesReasonSpec, null, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.policy.mojom.PolicyPageHandler_GetPoliciesJson_ResponseParamsSpec, 'policy.mojom.PolicyPageHandler_GetPoliciesJson_ResponseParams', [
      mojo.internal.StructField('arg_policies_json', 0, 0, mojo.internal.String, null, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.policy.mojom.PolicyPageClient_StatusUpdated_ParamsSpec, 'policy.mojom.PolicyPageClient_StatusUpdated_Params', [
      mojo.internal.StructField('arg_status', 0, 0, mojo.internal.Map(mojo.internal.String, mojo.internal.bindings.policy.mojom.StatusSpec, false), null, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.policy.mojom.PolicyPageClient_PoliciesUpdated_ParamsSpec, 'policy.mojom.PolicyPageClient_PoliciesUpdated_Params', [
      mojo.internal.StructField('arg_policy_names', 0, 0, mojo.internal.Map(mojo.internal.String, mojo.internal.bindings.policy.mojom.PolicyGroupNamesSpec, false), null, false, 0, undefined),
      mojo.internal.StructField('arg_policy_values', 8, 0, mojo.internal.bindings.policy.mojom.PolicyGroupsResponseSpec, null, false, 0, undefined),
    ],
    [[0, 24]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.policy.mojom.PolicyPageHandlerFactory_CreateHandler_ParamsSpec, 'policy.mojom.PolicyPageHandlerFactory_CreateHandler_Params', [
      mojo.internal.StructField('arg_handler', 0, 0, mojo.internal.InterfaceRequest(mojo.internal.bindings.policy.mojom.PolicyPageHandlerPendingReceiver), null, false, 0, undefined),
      mojo.internal.StructField('arg_client', 4, 0, mojo.internal.InterfaceProxy(mojo.internal.bindings.policy.mojom.PolicyPageClientRemote), null, false, 0, undefined),
    ],
    [[0, 24]]);
