...
mojo.internal.bindings.blink.mojom.PictureInPictureServiceRemote = class {
  ...
  startSession(arg_player_id, arg_player_remote, arg_surface_id, arg_natural_size, arg_show_play_pause_button, arg_observer, arg_source_bounds) {
    return this.$.startSession(arg_player_id, arg_player_remote, arg_surface_id, arg_natural_size, arg_show_play_pause_button, arg_observer, arg_source_bounds);
  }
};
