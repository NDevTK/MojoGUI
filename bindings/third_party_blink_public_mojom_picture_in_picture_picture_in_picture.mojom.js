...
mojo.internal.bindings.media = mojo.internal.bindings.media || {};
mojo.internal.bindings.media.mojom = mojo.internal.bindings.media.mojom || {};
mojo.internal.bindings.media.mojom.VideoSpatialFormatSpec = mojo.internal.bindings.media.mojom.VideoSpatialFormatSpec || { $: mojo.internal.OpaqueStruct.$ };
mojo.internal.bindings.media_session = mojo.internal.bindings.media_session || {};
...
mojo.internal.bindings.blink.mojom.PictureInPictureServiceRemote = class {
  ...
  startSession(arg_player_id, arg_player_remote, arg_surface_id, arg_natural_size, arg_show_play_pause_button, arg_observer, arg_source_bounds, arg_request_immersive, arg_spatial_format) {
    return this.$.startSession(arg_player_id, arg_player_remote, arg_surface_id, arg_natural_size, arg_show_play_pause_button, arg_observer, arg_source_bounds, arg_request_immersive, arg_spatial_format);
  }
};
...
mojo.internal.bindings.blink.mojom.PictureInPictureServiceRemoteCallHandler = class {
  ...
  startSession(arg_player_id, arg_player_remote, arg_surface_id, arg_natural_size, arg_show_play_pause_button, arg_observer, arg_source_bounds, arg_request_immersive, arg_spatial_format) {
    return this.proxy.sendMessage(
      ...
      mojo.internal.bindings.blink.mojom.PictureInPictureService_StartSession_ResponseParamsSpec,
      [arg_player_id, arg_player_remote, arg_surface_id, arg_natural_size, arg_show_play_pause_button, arg_observer, arg_source_bounds, arg_request_immersive, arg_spatial_format],
      false);
  }
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        case 0: {
          ...
          const result = this.impl.startSession(params.arg_player_id, params.arg_player_remote, params.arg_surface_id, params.arg_natural_size, params.arg_show_play_pause_button, params.arg_observer, params.arg_source_bounds, params.arg_request_immersive, params.arg_spatial_format);
          const expectsResponse = header.expectsResponse || (header.flags & 1);
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              const resp_obj = response;
...
mojo.internal.Struct(
    mojo.internal.bindings.blink.mojom.PictureInPictureService_StartSession_ParamsSpec, 'blink.mojom.PictureInPictureService_StartSession_Params', [
      ...
      mojo.internal.StructField('arg_player_remote', 4, 0, mojo.internal.AssociatedInterfaceProxy(mojo.internal.bindings.media.mojom.MediaPlayerRemote), null, false, 0, undefined),
      mojo.internal.StructField('arg_show_play_pause_button', 12, 0, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_request_immersive', 12, 1, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_surface_id', 16, 0, mojo.internal.bindings.viz.mojom.SurfaceIdSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_natural_size', 24, 0, mojo.internal.bindings.gfx.mojom.SizeSpec, null, false, 0, undefined),
      ...
      mojo.internal.StructField('arg_spatial_format', 48, 0, mojo.internal.bindings.media.mojom.VideoSpatialFormatSpec, null, false, 0, undefined),
    ],
    [[0, 64]]);
