...
pdf.mojom.SaveDataBufferHandler_Read_ResponseParamsSpec = {
  $: {
    structSpec: {
      ...
      packedSize: 16,
      fields: [
        { name: 'block', packedOffset: 0, packedBitOffset: 0, type: mojo_base.mojom.BigBufferSpec, nullable: false },
      ],
      versions: [{version: 0}]
    }
  }
...
pdf.mojom.PdfListener_MoveRangeSelectionExtent_ParamsSpec = {
  $: {
    structSpec: {
      ...
      packedSize: 16,
      fields: [
        { name: 'extent', packedOffset: 0, packedBitOffset: 0, type: gfx.mojom.PointFSpec, nullable: false },
      ],
      versions: [{version: 0}]
    }
  }
...
pdf.mojom.PdfListener_SetSelectionBounds_ParamsSpec = {
  $: {
    structSpec: {
      ...
      packedSize: 24,
      fields: [
        { name: 'base', packedOffset: 0, packedBitOffset: 0, type: gfx.mojom.PointFSpec, nullable: false },
...
pdf.mojom.PdfListener_GetPdfBytes_ResponseParamsSpec = {
  $: {
    structSpec: {
      ...
      packedSize: 32,
      fields: [
        { name: 'status', packedOffset: 0, packedBitOffset: 0, type: pdf.mojom.GetPdfBytesStatusSpec, nullable: false },
...
pdf.mojom.PdfListener_GetSaveDataBufferHandlerForDrive_ParamsSpec = {
  $: {
    structSpec: {
      ...
      packedSize: 16,
      fields: [
        { name: 'request_type', packedOffset: 0, packedBitOffset: 0, type: pdf.mojom.SaveRequestTypeSpec, nullable: false },
      ],
      versions: [{version: 0}]
    }
  }
...
pdf.mojom.PdfListener_GetSaveDataBufferHandlerForDrive_ResponseParamsSpec = {
  $: {
    structSpec: {
      ...
      packedSize: 16,
      fields: [
        { name: 'result', packedOffset: 0, packedBitOffset: 0, type: pdf.mojom.SaveDataBufferHandlerGetResultSpec, nullable: true },
      ],
      versions: [{version: 0}]
    }
  }
...
pdf.mojom.PdfHost_SelectionChanged_ParamsSpec = {
  $: {
    structSpec: {
      ...
      packedSize: 40,
      fields: [
        { name: 'left', packedOffset: 0, packedBitOffset: 0, type: gfx.mojom.PointFSpec, nullable: false },
        { name: 'left_height', packedOffset: 8, packedBitOffset: 0, type: mojo.internal.Int32, nullable: false },
        { name: 'right', packedOffset: 16, packedBitOffset: 0, type: gfx.mojom.PointFSpec, nullable: false },
