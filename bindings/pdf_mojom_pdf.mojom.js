...
mojo.internal.bindings.pdf.mojom.InkGlyphInfoSpec = mojo.internal.bindings.pdf.mojom.InkGlyphInfoSpec || { $: {} };
if (mojo.internal.bindings.pdf.mojom.InkGlyphInfoSpec.$.structSpec && mojo.internal.bindings.pdf.mojom.InkGlyphInfoSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.pdf.mojom.InkGlyphInfoSpec.$ = {};
mojo.internal.bindings.pdf.mojom.InkTypefaceRunSpec = mojo.internal.bindings.pdf.mojom.InkTypefaceRunSpec || { $: {} };
if (mojo.internal.bindings.pdf.mojom.InkTypefaceRunSpec.$.structSpec && mojo.internal.bindings.pdf.mojom.InkTypefaceRunSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.pdf.mojom.InkTypefaceRunSpec.$ = {};
mojo.internal.bindings.pdf.mojom.InkTextRunSpec = mojo.internal.bindings.pdf.mojom.InkTextRunSpec || { $: {} };
if (mojo.internal.bindings.pdf.mojom.InkTextRunSpec.$.structSpec && mojo.internal.bindings.pdf.mojom.InkTextRunSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.pdf.mojom.InkTextRunSpec.$ = {};
mojo.internal.bindings.pdf.mojom.InkTextInfoSpec = mojo.internal.bindings.pdf.mojom.InkTextInfoSpec || { $: {} };
if (mojo.internal.bindings.pdf.mojom.InkTextInfoSpec.$.structSpec && mojo.internal.bindings.pdf.mojom.InkTextInfoSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.pdf.mojom.InkTextInfoSpec.$ = {};
...
mojo.internal.bindings.pdf.mojom.PdfListener_SetSelectionBase_ParamsSpec = mojo.internal.bindings.pdf.mojom.PdfListener_SetSelectionBase_ParamsSpec || { $: {} };
if (mojo.internal.bindings.pdf.mojom.PdfListener_SetSelectionBase_ParamsSpec.$.structSpec && mojo.internal.bindings.pdf.mojom.PdfListener_SetSelectionBase_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.pdf.mojom.PdfListener_SetSelectionBase_ParamsSpec.$ = {};
...
mojo.internal.bindings.pdf.mojom.PdfListener_HasMeaningfulText_ParamsSpec = mojo.internal.bindings.pdf.mojom.PdfListener_HasMeaningfulText_ParamsSpec || { $: {} };
if (mojo.internal.bindings.pdf.mojom.PdfListener_HasMeaningfulText_ParamsSpec.$.structSpec && mojo.internal.bindings.pdf.mojom.PdfListener_HasMeaningfulText_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.pdf.mojom.PdfListener_HasMeaningfulText_ParamsSpec.$ = {};
mojo.internal.bindings.pdf.mojom.PdfListener_HasMeaningfulText_ResponseParamsSpec = mojo.internal.bindings.pdf.mojom.PdfListener_HasMeaningfulText_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.pdf.mojom.PdfListener_HasMeaningfulText_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.pdf.mojom.PdfListener_HasMeaningfulText_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.pdf.mojom.PdfListener_HasMeaningfulText_ResponseParamsSpec.$ = {};
mojo.internal.bindings.pdf.mojom.PdfListener_HasJavaScript_ParamsSpec = mojo.internal.bindings.pdf.mojom.PdfListener_HasJavaScript_ParamsSpec || { $: {} };
if (mojo.internal.bindings.pdf.mojom.PdfListener_HasJavaScript_ParamsSpec.$.structSpec && mojo.internal.bindings.pdf.mojom.PdfListener_HasJavaScript_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.pdf.mojom.PdfListener_HasJavaScript_ParamsSpec.$ = {};
mojo.internal.bindings.pdf.mojom.PdfListener_HasJavaScript_ResponseParamsSpec = mojo.internal.bindings.pdf.mojom.PdfListener_HasJavaScript_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.pdf.mojom.PdfListener_HasJavaScript_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.pdf.mojom.PdfListener_HasJavaScript_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.pdf.mojom.PdfListener_HasJavaScript_ResponseParamsSpec.$ = {};
mojo.internal.bindings.pdf.mojom.PdfListener_IsPasswordProtected_ParamsSpec = mojo.internal.bindings.pdf.mojom.PdfListener_IsPasswordProtected_ParamsSpec || { $: {} };
if (mojo.internal.bindings.pdf.mojom.PdfListener_IsPasswordProtected_ParamsSpec.$.structSpec && mojo.internal.bindings.pdf.mojom.PdfListener_IsPasswordProtected_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.pdf.mojom.PdfListener_IsPasswordProtected_ParamsSpec.$ = {};
mojo.internal.bindings.pdf.mojom.PdfListener_IsPasswordProtected_ResponseParamsSpec = mojo.internal.bindings.pdf.mojom.PdfListener_IsPasswordProtected_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.pdf.mojom.PdfListener_IsPasswordProtected_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.pdf.mojom.PdfListener_IsPasswordProtected_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.pdf.mojom.PdfListener_IsPasswordProtected_ResponseParamsSpec.$ = {};
...
mojo.internal.bindings.pdf.mojom.PdfHost_OnPdfFirstContentPainted_ParamsSpec = mojo.internal.bindings.pdf.mojom.PdfHost_OnPdfFirstContentPainted_ParamsSpec || { $: {} };
if (mojo.internal.bindings.pdf.mojom.PdfHost_OnPdfFirstContentPainted_ParamsSpec.$.structSpec && mojo.internal.bindings.pdf.mojom.PdfHost_OnPdfFirstContentPainted_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.pdf.mojom.PdfHost_OnPdfFirstContentPainted_ParamsSpec.$ = {};
...
mojo.internal.bindings.pdf.mojom.GetPdfBytesStatus = {
  kSuccess: 0,
...
mojo.internal.bindings.pdf.mojom.SaveDataBufferHandlerPendingReceiver = class {
  constructor(handle) {
    this.handle = handle;
    if (handle) {
...
mojo.internal.bindings.pdf.mojom.SaveDataBufferHandlerRemote = class {
  ...
  constructor(handle = undefined) {
    ...
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.pdf.mojom.SaveDataBufferHandlerPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.pdf.mojom.SaveDataBufferHandlerRemoteCallHandler(this.proxy);
  }
  ...
  read(arg_offset, arg_block_size) {
    return this.$.read(arg_offset, arg_block_size);
  }
};

mojo.internal.bindings.pdf.mojom.SaveDataBufferHandlerRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('pdf.mojom.SaveDataBufferHandler', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.pdf.mojom.SaveDataBufferHandler.getRemote = function() {
  let remote = new mojo.internal.bindings.pdf.mojom.SaveDataBufferHandlerRemote();
...
mojo.internal.bindings.pdf.mojom.SaveDataBufferHandlerReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('pdf.mojom.SaveDataBufferHandler', [
      { explicit: null },
    ]);
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        case 0: {
          ...
          const params = decoder.decodeStructInline(mojo.internal.bindings.pdf.mojom.SaveDataBufferHandler_Read_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.read');
          const result = this.impl.read(params.arg_offset, params.arg_block_size);
          const expectsResponse = header.expectsResponse || (header.flags & 1);
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              const val = (response && typeof response === 'object' && 'arg_block' in response) ? response['arg_block'] : response;
              const resp_obj = { 'arg_block': val };
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.pdf.mojom.SaveDataBufferHandler_Read_ResponseParamsSpec.$.structSpec, resp_obj);
...
mojo.internal.bindings.pdf.mojom.SaveDataBufferHandlerReceiver = mojo.internal.bindings.pdf.mojom.SaveDataBufferHandlerReceiver;

mojo.internal.bindings.pdf.mojom.SaveDataBufferHandlerPtr = mojo.internal.bindings.pdf.mojom.SaveDataBufferHandlerRemote;
mojo.internal.bindings.pdf.mojom.SaveDataBufferHandlerRequest = mojo.internal.bindings.pdf.mojom.SaveDataBufferHandlerPendingReceiver;


// Interface: PdfListener
mojo.internal.bindings.pdf.mojom.PdfListenerPendingReceiver = class {
  constructor(handle) {
    this.handle = handle;
    if (handle) {
      this.__mojoHandle = handle.router_ ? handle.router_.pipe_ : (handle.pipe_ || handle);
...
mojo.internal.bindings.pdf.mojom.PdfListenerRemote = class {
  static get $interfaceName() {
  ...
  constructor(handle = undefined) {
    this.__mojoHandle = handle;
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.pdf.mojom.PdfListenerPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.pdf.mojom.PdfListenerRemoteCallHandler(this.proxy);
  }
  ...
  setCaretPosition(arg_position) {
    return this.$.setCaretPosition(arg_position);
  }
  moveRangeSelectionExtent(arg_extent) {
    return this.$.moveRangeSelectionExtent(arg_extent);
  }
  setSelectionBase(arg_base) {
    return this.$.setSelectionBase(arg_base);
  }
  getPdfBytes(arg_size_limit) {
    return this.$.getPdfBytes(arg_size_limit);
  }
  getPageText(arg_page_index) {
    return this.$.getPageText(arg_page_index);
  }
  getMostVisiblePageIndex() {
    return this.$.getMostVisiblePageIndex();
  }
  hasMeaningfulText() {
    return this.$.hasMeaningfulText();
  }
  hasJavaScript() {
  ...
  getSaveDataBufferHandlerForDrive(arg_request_type) {
    return this.$.getSaveDataBufferHandlerForDrive(arg_request_type);
  }
};

mojo.internal.bindings.pdf.mojom.PdfListenerRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('pdf.mojom.PdfListener', [
      { explicit: null },
      { explicit: null },
      { explicit: null },
      { explicit: null },
  ...
  setSelectionBase(arg_base) {
    return this.proxy.sendMessage(
      ...
      mojo.internal.bindings.pdf.mojom.PdfListener_SetSelectionBase_ParamsSpec,
      null,
      [arg_base],
      false);
  }
  ...
  hasMeaningfulText() {
    return this.proxy.sendMessage(
      ...
      mojo.internal.bindings.pdf.mojom.PdfListener_HasMeaningfulText_ParamsSpec,
      mojo.internal.bindings.pdf.mojom.PdfListener_HasMeaningfulText_ResponseParamsSpec,
      [],
      false);
  }
  ...
  hasJavaScript() {
    return this.proxy.sendMessage(
      ...
      mojo.internal.bindings.pdf.mojom.PdfListener_HasJavaScript_ParamsSpec,
      mojo.internal.bindings.pdf.mojom.PdfListener_HasJavaScript_ResponseParamsSpec,
      [],
      false);
  }
  ...
  isPasswordProtected() {
    return this.proxy.sendMessage(
      ...
      mojo.internal.bindings.pdf.mojom.PdfListener_IsPasswordProtected_ParamsSpec,
      mojo.internal.bindings.pdf.mojom.PdfListener_IsPasswordProtected_ResponseParamsSpec,
      [],
      false);
  }
...
mojo.internal.bindings.pdf.mojom.PdfListener.getRemote = function() {
  let remote = new mojo.internal.bindings.pdf.mojom.PdfListenerRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
...
mojo.internal.bindings.pdf.mojom.PdfListenerReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('pdf.mojom.PdfListener', [
      { explicit: null },
      { explicit: null },
      { explicit: null },
      { explicit: null },
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.pdf.mojom.PdfListener_SetCaretPosition_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.setCaretPosition');
          const result = this.impl.setCaretPosition(params.arg_position);
          break;
        }
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.pdf.mojom.PdfListener_MoveRangeSelectionExtent_ParamsSpec.$.structSpec);
        ...
        case 2: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.pdf.mojom.PdfListener_SetSelectionBase_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.setSelectionBase');
          const result = this.impl.setSelectionBase(params.arg_base);
          break;
        }
        case 3: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.pdf.mojom.PdfListener_GetPdfBytes_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.getPdfBytes');
          const result = this.impl.getPdfBytes(params.arg_size_limit);
          const expectsResponse = header.expectsResponse || (header.flags & 1);
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.pdf.mojom.PdfListener_GetPdfBytes_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
        ...
        case 4: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.pdf.mojom.PdfListener_GetPageText_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.getPageText');
          const result = this.impl.getPageText(params.arg_page_index);
          const expectsResponse = header.expectsResponse || (header.flags & 1);
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              const val = (response && typeof response === 'object' && 'arg_text' in response) ? response['arg_text'] : response;
              const resp_obj = { 'arg_text': val };
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.pdf.mojom.PdfListener_GetPageText_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
        ...
        case 5: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.pdf.mojom.PdfListener_GetMostVisiblePageIndex_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.getMostVisiblePageIndex');
          const result = this.impl.getMostVisiblePageIndex();
          const expectsResponse = header.expectsResponse || (header.flags & 1);
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              const val = (response && typeof response === 'object' && 'arg_page_index' in response) ? response['arg_page_index'] : response;
              const resp_obj = { 'arg_page_index': val };
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.pdf.mojom.PdfListener_GetMostVisiblePageIndex_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
        ...
        case 6: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.pdf.mojom.PdfListener_HasMeaningfulText_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.hasMeaningfulText');
          const result = this.impl.hasMeaningfulText();
          const expectsResponse = header.expectsResponse || (header.flags & 1);
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              const val = (response && typeof response === 'object' && 'arg_has_meaningful_text' in response) ? response['arg_has_meaningful_text'] : response;
              const resp_obj = { 'arg_has_meaningful_text': val };
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.pdf.mojom.PdfListener_HasMeaningfulText_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
            }).catch(e => console.error('[GeneratedReceiver] hasMeaningfulText FAILED:', e));
          }
          break;
        }
        case 7: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.pdf.mojom.PdfListener_HasJavaScript_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.hasJavaScript');
          const result = this.impl.hasJavaScript();
          const expectsResponse = header.expectsResponse || (header.flags & 1);
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              const val = (response && typeof response === 'object' && 'arg_has_javascript' in response) ? response['arg_has_javascript'] : response;
              const resp_obj = { 'arg_has_javascript': val };
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.pdf.mojom.PdfListener_HasJavaScript_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
            }).catch(e => console.error('[GeneratedReceiver] hasJavaScript FAILED:', e));
          }
          break;
        }
        case 8: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.pdf.mojom.PdfListener_IsPasswordProtected_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.isPasswordProtected');
          const result = this.impl.isPasswordProtected();
          const expectsResponse = header.expectsResponse || (header.flags & 1);
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              const val = (response && typeof response === 'object' && 'arg_is_password_protected' in response) ? response['arg_is_password_protected'] : response;
              const resp_obj = { 'arg_is_password_protected': val };
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.pdf.mojom.PdfListener_IsPasswordProtected_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
            }).catch(e => console.error('[GeneratedReceiver] isPasswordProtected FAILED:', e));
          }
          break;
        }
        case 9: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.pdf.mojom.PdfListener_GetSaveDataBufferHandlerForDrive_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.getSaveDataBufferHandlerForDrive');
          const result = this.impl.getSaveDataBufferHandlerForDrive(params.arg_request_type);
          const expectsResponse = header.expectsResponse || (header.flags & 1);
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.pdf.mojom.PdfListener_GetSaveDataBufferHandlerForDrive_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
...
mojo.internal.bindings.pdf.mojom.PdfListenerReceiver = mojo.internal.bindings.pdf.mojom.PdfListenerReceiver;

mojo.internal.bindings.pdf.mojom.PdfListenerPtr = mojo.internal.bindings.pdf.mojom.PdfListenerRemote;
mojo.internal.bindings.pdf.mojom.PdfListenerRequest = mojo.internal.bindings.pdf.mojom.PdfListenerPendingReceiver;


// Interface: PdfHost
mojo.internal.bindings.pdf.mojom.PdfHostPendingReceiver = class {
  constructor(handle) {
    this.handle = handle;
    if (handle) {
      this.__mojoHandle = handle.router_ ? handle.router_.pipe_ : (handle.pipe_ || handle);
...
mojo.internal.bindings.pdf.mojom.PdfHostRemote = class {
  static get $interfaceName() {
  ...
  constructor(handle = undefined) {
    this.__mojoHandle = handle;
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.pdf.mojom.PdfHostPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.pdf.mojom.PdfHostRemoteCallHandler(this.proxy);
  }
  ...
  setListener(arg_client) {
    return this.$.setListener(arg_client);
  }
  onDocumentLoadComplete() {
    return this.$.onDocumentLoadComplete();
  }
  onPdfFirstContentPainted(arg_paint_time) {
    return this.$.onPdfFirstContentPainted(arg_paint_time);
  }
  ...
  setPluginCanSave(arg_can_save) {
    return this.$.setPluginCanSave(arg_can_save);
  }
  onSearchifyStarted() {
...
mojo.internal.bindings.pdf.mojom.PdfHostRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('pdf.mojom.PdfHost', [
      { explicit: null },
      { explicit: null },
      { explicit: null },
      { explicit: null },
  ...
  onPdfFirstContentPainted(arg_paint_time) {
    return this.proxy.sendMessage(
      this.ordinals[2],  // ordinal
      mojo.internal.bindings.pdf.mojom.PdfHost_OnPdfFirstContentPainted_ParamsSpec,
      null,
      [arg_paint_time],
      false);
  }
...
mojo.internal.bindings.pdf.mojom.PdfHost.getRemote = function() {
  let remote = new mojo.internal.bindings.pdf.mojom.PdfHostRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
    'pdf.mojom.PdfHost',
...
mojo.internal.bindings.pdf.mojom.PdfHostReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('pdf.mojom.PdfHost', [
      { explicit: null },
      { explicit: null },
      { explicit: null },
      { explicit: null },
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.pdf.mojom.PdfHost_SetListener_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.setListener');
          const result = this.impl.setListener(params.arg_client);
          break;
        }
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.pdf.mojom.PdfHost_OnDocumentLoadComplete_ParamsSpec.$.structSpec);
        ...
        case 2: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.pdf.mojom.PdfHost_OnPdfFirstContentPainted_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.onPdfFirstContentPainted');
          const result = this.impl.onPdfFirstContentPainted(params.arg_paint_time);
          break;
        }
        case 3: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.pdf.mojom.PdfHost_UpdateContentRestrictions_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.updateContentRestrictions');
          const result = this.impl.updateContentRestrictions(params.arg_restrictions);
          break;
        }
        case 4: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
        ...
        case 5: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.pdf.mojom.PdfHost_SelectionChanged_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.selectionChanged');
          const result = this.impl.selectionChanged(params.arg_left, params.arg_left_height, params.arg_right, params.arg_right_height);
          break;
        }
        case 6: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.pdf.mojom.PdfHost_SetPluginCanSave_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.setPluginCanSave');
          const result = this.impl.setPluginCanSave(params.arg_can_save);
          break;
        }
        case 7: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.pdf.mojom.PdfHost_OnSearchifyStarted_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.pdf.mojom.PdfHostReceiver = mojo.internal.bindings.pdf.mojom.PdfHostReceiver;

mojo.internal.bindings.pdf.mojom.PdfHostPtr = mojo.internal.bindings.pdf.mojom.PdfHostRemote;
mojo.internal.bindings.pdf.mojom.PdfHostRequest = mojo.internal.bindings.pdf.mojom.PdfHostPendingReceiver;
...
mojo.internal.Struct(
    mojo.internal.bindings.pdf.mojom.SaveDataBufferHandlerGetResultSpec, 'pdf.mojom.SaveDataBufferHandlerGetResult', [
      mojo.internal.StructField('arg_handler', 0, 0, mojo.internal.InterfaceProxy(mojo.internal.bindings.pdf.mojom.SaveDataBufferHandlerRemote), null, false, 0, undefined),
      mojo.internal.StructField('arg_total_file_size', 8, 0, mojo.internal.Uint32, 0, false, 0, undefined),
    ],
    [[0, 24]]);

// Struct: InkGlyphInfo
mojo.internal.Struct(
    mojo.internal.bindings.pdf.mojom.InkGlyphInfoSpec, 'pdf.mojom.InkGlyphInfo', [
...
mojo.internal.Struct(
    mojo.internal.bindings.pdf.mojom.InkTypefaceRunSpec, 'pdf.mojom.InkTypefaceRun', [
      mojo.internal.StructField('arg_typeface_id', 0, 0, mojo.internal.Uint32, 0, false, 0, undefined),
      mojo.internal.StructField('arg_is_horizontal', 4, 0, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_is_synthetic_bold', 4, 1, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_is_synthetic_italic', 4, 2, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_glyphs', 8, 0, mojo.internal.Array(mojo.internal.bindings.pdf.mojom.InkGlyphInfoSpec, false), null, false, 0, undefined),
    ],
    [[0, 24]]);
...
// Struct: InkTextInfo
mojo.internal.Struct(
    mojo.internal.bindings.pdf.mojom.InkTextInfoSpec, 'pdf.mojom.InkTextInfo', [
      mojo.internal.StructField('arg_text_runs', 0, 0, mojo.internal.Array(mojo.internal.bindings.pdf.mojom.InkTextRunSpec, false), null, false, 0, undefined),
      mojo.internal.StructField('arg_effective_zoom', 8, 0, mojo.internal.Float, 0, false, 0, undefined),
      mojo.internal.StructField('arg_primary_ascent', 12, 0, mojo.internal.Float, 0, false, 0, undefined),
    ],
    [[0, 24]]);
mojo.internal.Struct(
    mojo.internal.bindings.pdf.mojom.SaveDataBufferHandler_Read_ParamsSpec, 'pdf.mojom.SaveDataBufferHandler_Read_Params', [
      mojo.internal.StructField('arg_offset', 0, 0, mojo.internal.Uint32, 0, false, 0, undefined),
      mojo.internal.StructField('arg_block_size', 4, 0, mojo.internal.Uint32, 0, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.pdf.mojom.SaveDataBufferHandler_Read_ResponseParamsSpec, 'pdf.mojom.SaveDataBufferHandler_Read_ResponseParams', [
      mojo.internal.StructField('arg_block', 0, 0, mojo.internal.bindings.mojo_base.mojom.BigBufferSpec, null, false, 0, undefined),
    ],
    [[0, 24]]);

mojo.internal.Struct(
    mojo.internal.bindings.pdf.mojom.PdfListener_SetCaretPosition_ParamsSpec, 'pdf.mojom.PdfListener_SetCaretPosition_Params', [
      mojo.internal.StructField('arg_position', 0, 0, mojo.internal.bindings.gfx.mojom.PointFSpec, null, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.pdf.mojom.PdfListener_MoveRangeSelectionExtent_ParamsSpec, 'pdf.mojom.PdfListener_MoveRangeSelectionExtent_Params', [
      mojo.internal.StructField('arg_extent', 0, 0, mojo.internal.bindings.gfx.mojom.PointFSpec, null, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.pdf.mojom.PdfListener_SetSelectionBase_ParamsSpec, 'pdf.mojom.PdfListener_SetSelectionBase_Params', [
      mojo.internal.StructField('arg_base', 0, 0, mojo.internal.bindings.gfx.mojom.PointFSpec, null, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.pdf.mojom.PdfListener_GetPdfBytes_ParamsSpec, 'pdf.mojom.PdfListener_GetPdfBytes_Params', [
      mojo.internal.StructField('arg_size_limit', 0, 0, mojo.internal.Uint32, 0, false, 0, undefined),
    ],
    [[0, 16]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.pdf.mojom.PdfListener_GetPageText_ParamsSpec, 'pdf.mojom.PdfListener_GetPageText_Params', [
      mojo.internal.StructField('arg_page_index', 0, 0, mojo.internal.Int32, 0, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.pdf.mojom.PdfListener_GetPageText_ResponseParamsSpec, 'pdf.mojom.PdfListener_GetPageText_ResponseParams', [
      mojo.internal.StructField('arg_text', 0, 0, mojo.internal.bindings.mojo_base.mojom.String16Spec, null, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.pdf.mojom.PdfListener_GetMostVisiblePageIndex_ParamsSpec, 'pdf.mojom.PdfListener_GetMostVisiblePageIndex_Params', [
    ],
    [[0, 8]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.pdf.mojom.PdfListener_HasMeaningfulText_ParamsSpec, 'pdf.mojom.PdfListener_HasMeaningfulText_Params', [
    ],
    [[0, 8]]);

mojo.internal.Struct(
    mojo.internal.bindings.pdf.mojom.PdfListener_HasMeaningfulText_ResponseParamsSpec, 'pdf.mojom.PdfListener_HasMeaningfulText_ResponseParams', [
      mojo.internal.StructField('arg_has_meaningful_text', 0, 0, mojo.internal.Bool, false, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.pdf.mojom.PdfListener_HasJavaScript_ParamsSpec, 'pdf.mojom.PdfListener_HasJavaScript_Params', [
    ],
    [[0, 8]]);

mojo.internal.Struct(
    mojo.internal.bindings.pdf.mojom.PdfListener_HasJavaScript_ResponseParamsSpec, 'pdf.mojom.PdfListener_HasJavaScript_ResponseParams', [
      mojo.internal.StructField('arg_has_javascript', 0, 0, mojo.internal.Bool, false, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.pdf.mojom.PdfListener_IsPasswordProtected_ParamsSpec, 'pdf.mojom.PdfListener_IsPasswordProtected_Params', [
    ],
    [[0, 8]]);

mojo.internal.Struct(
    mojo.internal.bindings.pdf.mojom.PdfListener_IsPasswordProtected_ResponseParamsSpec, 'pdf.mojom.PdfListener_IsPasswordProtected_ResponseParams', [
      mojo.internal.StructField('arg_is_password_protected', 0, 0, mojo.internal.Bool, false, false, 0, undefined),
    ],
    [[0, 16]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.pdf.mojom.PdfHost_SetListener_ParamsSpec, 'pdf.mojom.PdfHost_SetListener_Params', [
      mojo.internal.StructField('arg_client', 0, 0, mojo.internal.InterfaceProxy(mojo.internal.bindings.pdf.mojom.PdfListenerRemote), null, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.pdf.mojom.PdfHost_OnDocumentLoadComplete_ParamsSpec, 'pdf.mojom.PdfHost_OnDocumentLoadComplete_Params', [
    ],
    [[0, 8]]);

mojo.internal.Struct(
    mojo.internal.bindings.pdf.mojom.PdfHost_OnPdfFirstContentPainted_ParamsSpec, 'pdf.mojom.PdfHost_OnPdfFirstContentPainted_Params', [
      mojo.internal.StructField('arg_paint_time', 0, 0, mojo.internal.bindings.mojo_base.mojom.TimeTicksSpec, null, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.pdf.mojom.PdfHost_UpdateContentRestrictions_ParamsSpec, 'pdf.mojom.PdfHost_UpdateContentRestrictions_Params', [
      mojo.internal.StructField('arg_restrictions', 0, 0, mojo.internal.Int32, 0, false, 0, undefined),
    ],
    [[0, 16]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.pdf.mojom.PdfHost_SetPluginCanSave_ParamsSpec, 'pdf.mojom.PdfHost_SetPluginCanSave_Params', [
      mojo.internal.StructField('arg_can_save', 0, 0, mojo.internal.Bool, false, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.pdf.mojom.PdfHost_OnSearchifyStarted_ParamsSpec, 'pdf.mojom.PdfHost_OnSearchifyStarted_Params', [
    ],
    [[0, 8]]);
