...
mojo.internal.bindings.blink.mojom.PerProcessV8MemoryUsageSpec = { $: {} };
mojo.internal.bindings.blink.mojom.V8DetailedMemoryReporter = {};
mojo.internal.bindings.blink.mojom.V8DetailedMemoryReporterSpec = { $ : {} };
mojo.internal.bindings.blink.mojom.V8DetailedMemoryReporter.$interfaceName = 'blink.mojom.V8DetailedMemoryReporter';
...
// Enum: Mode
mojo.internal.bindings.blink.mojom.Mode = {
  DEFAULT: 0,
  EAGER: 1,
  LAZY: 2,
};
...
mojo.internal.Struct(
    mojo.internal.bindings.blink.mojom.PerContextV8MemoryUsageSpec, 'blink.mojom.PerContextV8MemoryUsage', [
      mojo.internal.StructField('arg_token', 0, 0, mojo.internal.bindings.blink.mojom.ExecutionContextTokenSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_memory_used', 16, 0, mojo.internal.bindings.mojo_base.mojom.ByteSizeSpec, null, false, 0, undefined),
...
mojo.internal.Struct(
    mojo.internal.bindings.blink.mojom.PerContextCanvasMemoryUsageSpec, 'blink.mojom.PerContextCanvasMemoryUsage', [
      mojo.internal.StructField('arg_token', 0, 0, mojo.internal.bindings.blink.mojom.ExecutionContextTokenSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_memory_used', 16, 0, mojo.internal.bindings.mojo_base.mojom.ByteSizeSpec, null, false, 0, undefined),
    ],
    [[0, 32]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.blink.mojom.PerIsolateV8MemoryUsageSpec, 'blink.mojom.PerIsolateV8MemoryUsage', [
      mojo.internal.StructField('arg_num_detached_contexts', 0, 0, mojo.internal.Uint64, 0, false, 0, undefined),
...
mojo.internal.bindings.blink.mojom.V8DetailedMemoryReporterPendingReceiver = class {
  constructor(handle) {
    this.handle = handle;
  }
};

mojo.internal.bindings.blink.mojom.V8DetailedMemoryReporterRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.blink.mojom.V8DetailedMemoryReporterPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.blink.mojom.V8DetailedMemoryReporterRemoteCallHandler(this.proxy);
  }
  ...
  getV8MemoryUsage(arg_mode) {
    return this.$.getV8MemoryUsage(arg_mode);
  }
};

mojo.internal.bindings.blink.mojom.V8DetailedMemoryReporterRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('blink.mojom.V8DetailedMemoryReporter', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.blink.mojom.V8DetailedMemoryReporter.getRemote = function() {
  let remote = new mojo.internal.bindings.blink.mojom.V8DetailedMemoryReporterRemote();
...
mojo.internal.bindings.blink.mojom.V8DetailedMemoryReporterReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('blink.mojom.V8DetailedMemoryReporter', [
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        // Try Method 0: GetV8MemoryUsage
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.blink.mojom.V8DetailedMemoryReporter_GetV8MemoryUsage_ParamsSpec.$.structSpec;
             ...
             if (sizeMatch && (!!(header.flags & 1) === methodExpectsResp)) {
               if (size > 8 || message.payload.byteLength === 8) {
                 ...
                 console.log('[GeneratedReceiver] Discovery SUCCESS: ' + header.ordinal + ' -> GetV8MemoryUsage (0)');
                 this.mapOrdinal(header.ordinal, 0);
                 dispatchId = 0;
               }
             }
           } catch (e) {
             if (e instanceof TypeError) console.warn('[Discovery] trial for GetV8MemoryUsage failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
        ...
        case 0: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              this.endpoint.send(header.ordinal, header.requestId, mojo.internal.kMessageFlagIsResponse, mojo.internal.bindings.blink.mojom.V8DetailedMemoryReporter_GetV8MemoryUsage_ResponseParamsSpec, response);
...
mojo.internal.bindings.blink.mojom.V8DetailedMemoryReporterReceiver = mojo.internal.bindings.blink.mojom.V8DetailedMemoryReporterReceiver;

mojo.internal.bindings.blink.mojom.V8DetailedMemoryReporterPtr = mojo.internal.bindings.blink.mojom.V8DetailedMemoryReporterRemote;
mojo.internal.bindings.blink.mojom.V8DetailedMemoryReporterRequest = mojo.internal.bindings.blink.mojom.V8DetailedMemoryReporterPendingReceiver;
