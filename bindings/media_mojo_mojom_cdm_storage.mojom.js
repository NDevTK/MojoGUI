...
mojo.internal.bindings.media.mojom.CdmStorageRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.media.mojom.CdmStorageRemoteCallHandler(this.proxy);
  }
  ...
  open(arg_file_name) {
    return this.$.open(arg_file_name);
  }
};
...
mojo.internal.bindings.media.mojom.CdmStorage.getRemote = function() {
  let remote = new mojo.internal.bindings.media.mojom.CdmStorageRemote();
...
mojo.internal.bindings.media.mojom.CdmStorageReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
        ...
        case 0: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.media.mojom.CdmStorage_Open_ResponseParamsSpec, header, rawHeader);
               responder(response);
...
mojo.internal.bindings.media.mojom.CdmStorageReceiver = mojo.internal.bindings.media.mojom.CdmStorageReceiver;

mojo.internal.bindings.media.mojom.CdmStoragePtr = mojo.internal.bindings.media.mojom.CdmStorageRemote;
mojo.internal.bindings.media.mojom.CdmStorageRequest = mojo.internal.bindings.media.mojom.CdmStoragePendingReceiver;
...
mojo.internal.bindings.media.mojom.CdmFileRemote = class {
  static get $interfaceName() {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.media.mojom.CdmFilePendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.media.mojom.CdmFileRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.media.mojom.CdmFile.getRemote = function() {
  let remote = new mojo.internal.bindings.media.mojom.CdmFileRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
    'media.mojom.CdmFile',
...
mojo.internal.bindings.media.mojom.CdmFileReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.media.mojom.CdmFile_Read_ParamsSpec.$.structSpec);
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              const rawHeader = (args[2] && args[2].slice) ? args[2].slice(0, header.headerSize) : null;
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.media.mojom.CdmFile_Read_ResponseParamsSpec, header, rawHeader);
               responder(response);
        ...
        case 1: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              const rawHeader = (args[2] && args[2].slice) ? args[2].slice(0, header.headerSize) : null;
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.media.mojom.CdmFile_Write_ResponseParamsSpec, header, rawHeader);
               responder(response);
...
mojo.internal.bindings.media.mojom.CdmFileReceiver = mojo.internal.bindings.media.mojom.CdmFileReceiver;
