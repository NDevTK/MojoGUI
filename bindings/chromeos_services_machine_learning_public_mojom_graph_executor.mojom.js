...
mojo.internal.bindings.chromeos.machine_learning.mojom.GraphExecutorRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.chromeos.machine_learning.mojom.GraphExecutorPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.chromeos.machine_learning.mojom.GraphExecutorRemoteCallHandler(this.proxy);
  }
  ...
  execute(arg_inputs, arg_output_names) {
    return this.$.execute(arg_inputs, arg_output_names);
  }
};

mojo.internal.bindings.chromeos.machine_learning.mojom.GraphExecutorRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('chromeos.machine_learning.mojom.GraphExecutor', [
      { explicit: 0 },
    ]);
  }
...
mojo.internal.bindings.chromeos.machine_learning.mojom.GraphExecutor.getRemote = function() {
  let remote = new mojo.internal.bindings.chromeos.machine_learning.mojom.GraphExecutorRemote();
...
mojo.internal.bindings.chromeos.machine_learning.mojom.GraphExecutorReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('chromeos.machine_learning.mojom.GraphExecutor', [
      { explicit: 0 },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.chromeos.machine_learning.mojom.GraphExecutor_Execute_ParamsSpec.$.structSpec);
        ...
        case 0: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.chromeos.machine_learning.mojom.GraphExecutor_Execute_ResponseParamsSpec, header, rawHeader);
               responder(response);
...
mojo.internal.bindings.chromeos.machine_learning.mojom.GraphExecutorReceiver = mojo.internal.bindings.chromeos.machine_learning.mojom.GraphExecutorReceiver;
