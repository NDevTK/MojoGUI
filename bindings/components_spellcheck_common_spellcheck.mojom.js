      ...
      onMessageReceived: (...args) => {
        try {
          ...
          if (dispatchId === undefined) {
            ...
            if (dispatchId === undefined) {
              try {
                const structSpec = mojo.internal.bindings.spellcheck.mojom.SpellChecker_Initialize_ParamsSpec.$.structSpec;
            ...
            if (dispatchId === undefined) {
              try {
                const structSpec = mojo.internal.bindings.spellcheck.mojom.SpellChecker_CustomDictionaryChanged_ParamsSpec.$.structSpec;
                const size = decoder.decodeUint32(0);
                const version = decoder.decodeUint32(4);
                let sizeMatch = false;
                for (const v of structSpec.versions) {
      ...
      onMessageReceived: (...args) => {
        try {
          ...
          if (dispatchId === undefined) {
            ...
            if (dispatchId === undefined) {
              try {
                const structSpec = mojo.internal.bindings.spellcheck.mojom.SpellCheckInitializationHost_RequestDictionary_ParamsSpec.$.structSpec;
                const size = decoder.decodeUint32(0);
                const version = decoder.decodeUint32(4);
                let sizeMatch = false;
                for (const v of structSpec.versions) {
      ...
      onMessageReceived: (...args) => {
        try {
          ...
          if (dispatchId === undefined) {
            ...
            if (dispatchId === undefined) {
              try {
                const structSpec = mojo.internal.bindings.spellcheck.mojom.SpellCheckHost_NotifyChecked_ParamsSpec.$.structSpec;
                const size = decoder.decodeUint32(0);
                const version = decoder.decodeUint32(4);
                let sizeMatch = false;
                for (const v of structSpec.versions) {
                ...
                if (sizeMatch && (!!(header.flags & 1) === false)) {
              ...
              } catch (e) { if (e instanceof TypeError) console.warn('[Discovery] trial for NotifyChecked failed with TypeError'); }
            }
            // Try Method 1: CallSpellingService
            if (dispatchId === undefined) {
              try {
                const structSpec = mojo.internal.bindings.spellcheck.mojom.SpellCheckHost_CallSpellingService_ParamsSpec.$.structSpec;
                const size = decoder.decodeUint32(0);
                const version = decoder.decodeUint32(4);
                let sizeMatch = false;
                for (const v of structSpec.versions) {
                ...
                if (sizeMatch && (!!(header.flags & 1) === true)) {
                  if (size > 8 || message.payload.byteLength === 8) {
                    decoder.decodeStructInline(structSpec);
              ...
              } catch (e) { if (e instanceof TypeError) console.warn('[Discovery] trial for CallSpellingService failed with TypeError'); }
            }
            // Try Method 2: RequestTextCheck
            if (dispatchId === undefined) {
              try {
                const structSpec = mojo.internal.bindings.spellcheck.mojom.SpellCheckHost_RequestTextCheck_ParamsSpec.$.structSpec;
                const size = decoder.decodeUint32(0);
                const version = decoder.decodeUint32(4);
                let sizeMatch = false;
                for (const v of structSpec.versions) {
              ...
              } catch (e) { if (e instanceof TypeError) console.warn('[Discovery] trial for RequestTextCheck failed with TypeError'); }
            }
            // Try Method 3: DisconnectSessionBridge
            if (dispatchId === undefined) {
              try {
                const structSpec = mojo.internal.bindings.spellcheck.mojom.SpellCheckHost_DisconnectSessionBridge_ParamsSpec.$.structSpec;
                const size = decoder.decodeUint32(0);
                const version = decoder.decodeUint32(4);
                let sizeMatch = false;
                for (const v of structSpec.versions) {
              ...
              } catch (e) { if (e instanceof TypeError) console.warn('[Discovery] trial for DisconnectSessionBridge failed with TypeError'); }
            }
            // Try Method 4: CheckSpelling
            if (dispatchId === undefined) {
              try {
                const structSpec = mojo.internal.bindings.spellcheck.mojom.SpellCheckHost_CheckSpelling_ParamsSpec.$.structSpec;
                const size = decoder.decodeUint32(0);
                const version = decoder.decodeUint32(4);
                let sizeMatch = false;
                for (const v of structSpec.versions) {
              ...
              } catch (e) { if (e instanceof TypeError) console.warn('[Discovery] trial for CheckSpelling failed with TypeError'); }
            }
            // Try Method 5: FillSuggestionList
            if (dispatchId === undefined) {
              try {
                const structSpec = mojo.internal.bindings.spellcheck.mojom.SpellCheckHost_FillSuggestionList_ParamsSpec.$.structSpec;
                const size = decoder.decodeUint32(0);
                const version = decoder.decodeUint32(4);
                let sizeMatch = false;
                for (const v of structSpec.versions) {
              ...
              } catch (e) { if (e instanceof TypeError) console.warn('[Discovery] trial for FillSuggestionList failed with TypeError'); }
            }
            // Try Method 6: InitializeDictionaries
            if (dispatchId === undefined) {
              try {
                const structSpec = mojo.internal.bindings.spellcheck.mojom.SpellCheckHost_InitializeDictionaries_ParamsSpec.$.structSpec;
                const size = decoder.decodeUint32(0);
                const version = decoder.decodeUint32(4);
                let sizeMatch = false;
                for (const v of structSpec.versions) {
              ...
              } catch (e) { if (e instanceof TypeError) console.warn('[Discovery] trial for InitializeDictionaries failed with TypeError'); }
            }
            if (dispatchId === undefined) {
              console.warn('[GeneratedReceiver] Failed to discover ordinal ' + header.ordinal);
              return;
          ...
          switch (dispatchId) {
            ...
            case 1: {
              ...
              if (expectsResponse) {
                Promise.resolve(result).then(response => {
                  this.endpoint.send(header.ordinal, header.requestId, mojo.internal.kMessageFlagIsResponse, mojo.internal.bindings.spellcheck.mojom.SpellCheckHost_CallSpellingService_ResponseParamsSpec, response);
            ...
            case 2: {
              ...
              if (expectsResponse) {
                Promise.resolve(result).then(response => {
                  this.endpoint.send(header.ordinal, header.requestId, mojo.internal.kMessageFlagIsResponse, mojo.internal.bindings.spellcheck.mojom.SpellCheckHost_RequestTextCheck_ResponseParamsSpec, response);
            ...
            case 4: {
              ...
              if (expectsResponse) {
                Promise.resolve(result).then(response => {
                  this.endpoint.send(header.ordinal, header.requestId, mojo.internal.kMessageFlagIsResponse, mojo.internal.bindings.spellcheck.mojom.SpellCheckHost_CheckSpelling_ResponseParamsSpec, response);
            ...
            case 5: {
              ...
              if (expectsResponse) {
                Promise.resolve(result).then(response => {
                  this.endpoint.send(header.ordinal, header.requestId, mojo.internal.kMessageFlagIsResponse, mojo.internal.bindings.spellcheck.mojom.SpellCheckHost_FillSuggestionList_ResponseParamsSpec, response);
            ...
            case 6: {
              ...
              if (expectsResponse) {
                Promise.resolve(result).then(response => {
                  this.endpoint.send(header.ordinal, header.requestId, mojo.internal.kMessageFlagIsResponse, mojo.internal.bindings.spellcheck.mojom.SpellCheckHost_InitializeDictionaries_ResponseParamsSpec, response);
