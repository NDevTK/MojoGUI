...
mojo.internal.bindings.chrome.mojom.WebRtcLoggingClientRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.chrome.mojom.WebRtcLoggingClientPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.chrome.mojom.WebRtcLoggingClientRemoteCallHandler(this.proxy);
  }
  ...
  onAddMessages(arg_messages) {
    return this.$.onAddMessages(arg_messages);
  }
  onStopped() {
...
mojo.internal.bindings.chrome.mojom.WebRtcLoggingClient.getRemote = function() {
  let remote = new mojo.internal.bindings.chrome.mojom.WebRtcLoggingClientRemote();
...
mojo.internal.bindings.chrome.mojom.WebRtcLoggingClientReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.chrome.mojom.WebRtcLoggingClient_OnAddMessages_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OnAddMessages failed with TypeError');
           }
        }
        // Try Method 1: OnStopped
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.chrome.mojom.WebRtcLoggingClient_OnStopped_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
      ...
      switch (dispatchId) {
        ...
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.chrome.mojom.WebRtcLoggingClient_OnStopped_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.chrome.mojom.WebRtcLoggingClientReceiver = mojo.internal.bindings.chrome.mojom.WebRtcLoggingClientReceiver;

mojo.internal.bindings.chrome.mojom.WebRtcLoggingClientPtr = mojo.internal.bindings.chrome.mojom.WebRtcLoggingClientRemote;
mojo.internal.bindings.chrome.mojom.WebRtcLoggingClientRequest = mojo.internal.bindings.chrome.mojom.WebRtcLoggingClientPendingReceiver;
...
mojo.internal.bindings.chrome.mojom.WebRtcLoggingAgentRemote = class {
  static get $interfaceName() {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.chrome.mojom.WebRtcLoggingAgentPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.chrome.mojom.WebRtcLoggingAgentRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.chrome.mojom.WebRtcLoggingAgent.getRemote = function() {
  let remote = new mojo.internal.bindings.chrome.mojom.WebRtcLoggingAgentRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
...
mojo.internal.bindings.chrome.mojom.WebRtcLoggingAgentReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.chrome.mojom.WebRtcLoggingAgent_Start_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.chrome.mojom.WebRtcLoggingAgent_Stop_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
      ...
      switch (dispatchId) {
        ...
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.chrome.mojom.WebRtcLoggingAgent_Stop_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.chrome.mojom.WebRtcLoggingAgentReceiver = mojo.internal.bindings.chrome.mojom.WebRtcLoggingAgentReceiver;
