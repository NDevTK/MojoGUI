...
mojo.internal.bindings.shape_detection.mojom.FaceDetectionProvider = {};
mojo.internal.bindings.shape_detection.mojom.FaceDetectionProviderSpec = { $ : {} };
...
mojo.internal.bindings.shape_detection.mojom.FaceDetectionProviderRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.shape_detection.mojom.FaceDetectionProviderRemoteCallHandler(this.proxy);
  }
  ...
  createFaceDetection(arg_receiver, arg_options) {
    return this.$.createFaceDetection(arg_receiver, arg_options);
  }
};

mojo.internal.bindings.shape_detection.mojom.FaceDetectionProviderRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('shape_detection.mojom.FaceDetectionProvider', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.shape_detection.mojom.FaceDetectionProvider.getRemote = function() {
  let remote = new mojo.internal.bindings.shape_detection.mojom.FaceDetectionProviderRemote();
...
mojo.internal.bindings.shape_detection.mojom.FaceDetectionProviderReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('shape_detection.mojom.FaceDetectionProvider', [
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.shape_detection.mojom.FaceDetectionProvider_CreateFaceDetection_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for CreateFaceDetection failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.shape_detection.mojom.FaceDetectionProviderReceiver = mojo.internal.bindings.shape_detection.mojom.FaceDetectionProviderReceiver;
