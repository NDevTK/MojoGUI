...
gpu.mojom.GpuPreferencesSpec = {
  $: {
    structSpec: {
      ...
      packedSize: 104,
      fields: [
        { name: 'gr_context_type', packedOffset: 0, packedBitOffset: 0, type: gpu.mojom.GrContextTypeSpec, nullable: false },
        { name: 'use_vulkan', packedOffset: 8, packedBitOffset: 0, type: gpu.mojom.VulkanImplementationNameSpec, nullable: false },
        { name: 'use_webgpu_adapter', packedOffset: 16, packedBitOffset: 0, type: gpu.mojom.WebGPUAdapterNameSpec, nullable: false },
        { name: 'use_webgpu_power_preference', packedOffset: 24, packedBitOffset: 0, type: gpu.mojom.WebGPUPowerPreferenceSpec, nullable: false },
        { name: 'enable_dawn_backend_validation', packedOffset: 32, packedBitOffset: 0, type: gpu.mojom.DawnBackendValidationLevelSpec, nullable: false },
        ...
        { name: 'message_pump_type', packedOffset: 56, packedBitOffset: 0, type: [EnableIf=use_ozone] mojo_base.mojom.MessagePumpTypeSpec, nullable: false },
