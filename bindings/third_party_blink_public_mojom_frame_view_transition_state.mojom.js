  ...
  $: {
    structSpec: {
      ...
      fields: [
        ...
        { name: 'paint_order', packedOffset: 48, packedBitOffset: 0, type: mojo.internal.Int32, nullable: false },
        { name: 'captured_css_properties', packedOffset: 56, packedBitOffset: 0, type: mojo.internal.Map, nullable: false },
        { name: 'group_children_css_properties', packedOffset: 64, packedBitOffset: 0, type: mojo.internal.Map, nullable: false },
        { name: 'border_offset', packedOffset: 72, packedBitOffset: 0, type: gfx.mojom.Vector2dSpec, nullable: false },
        { name: 'class_list', packedOffset: 80, packedBitOffset: 0, type: mojo.internal.Array, nullable: false },
        { name: 'containing_group_name', packedOffset: 88, packedBitOffset: 0, type: mojo.internal.String, nullable: false },
        { name: 'layered_box_properties', packedOffset: 96, packedBitOffset: 0, type: blink.mojom.ViewTransitionElementLayeredBoxPropertiesSpec, nullable: true },
      ],
      versions: [{version: 0}]
    }
  }
  ...
  $: {
    structSpec: {
      ...
      fields: [
        ...
        { name: 'device_pixel_ratio', packedOffset: 24, packedBitOffset: 0, type: mojo.internal.Float, nullable: false },
        { name: 'next_element_resource_id', packedOffset: 28, packedBitOffset: 0, type: mojo.internal.Uint32, nullable: false },
        { name: 'subframe_snapshot_id', packedOffset: 32, packedBitOffset: 0, type: viz.mojom.ViewTransitionElementResourceIdSpec, nullable: false },
        { name: 'id_to_auto_name_map', packedOffset: 40, packedBitOffset: 0, type: mojo.internal.Map, nullable: false },
