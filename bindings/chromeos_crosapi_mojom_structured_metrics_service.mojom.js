...
mojo.internal.bindings.crosapi.mojom.StructuredMetricsServiceRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.crosapi.mojom.StructuredMetricsServicePendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.crosapi.mojom.StructuredMetricsServiceRemoteCallHandler(this.proxy);
  }
  ...
  record(arg_events) {
    return this.$.record(arg_events);
  }
};

mojo.internal.bindings.crosapi.mojom.StructuredMetricsServiceRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('crosapi.mojom.StructuredMetricsService', [
      { explicit: 0 },
    ]);
  }
...
mojo.internal.bindings.crosapi.mojom.StructuredMetricsService.getRemote = function() {
  let remote = new mojo.internal.bindings.crosapi.mojom.StructuredMetricsServiceRemote();
...
mojo.internal.bindings.crosapi.mojom.StructuredMetricsServiceReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('crosapi.mojom.StructuredMetricsService', [
      { explicit: 0 },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.crosapi.mojom.StructuredMetricsService_Record_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for Record failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.crosapi.mojom.StructuredMetricsServiceReceiver = mojo.internal.bindings.crosapi.mojom.StructuredMetricsServiceReceiver;
