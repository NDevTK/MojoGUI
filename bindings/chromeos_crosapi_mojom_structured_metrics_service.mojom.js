...
mojo.internal.bindings.crosapi.mojom.StructuredMetricsServiceRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('StructuredMetricsService', [
      { explicit: 0 },
    ]);
  }
...
mojo.internal.bindings.crosapi.mojom.StructuredMetricsServiceReceiver = class {
  constructor(impl) {
    ...
    const ordinals = window.mojoScrambler.getOrdinals('StructuredMetricsService', [
      { explicit: 0 },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.crosapi.mojom.StructuredMetricsService_Record_ParamsSpec);
