...
mojo.internal.bindings.gfx.mojom.ImageTraitsTestServiceRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.gfx.mojom.ImageTraitsTestServicePendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.gfx.mojom.ImageTraitsTestServiceRemoteCallHandler(this.proxy);
  }
  ...
  echoImageSkiaRep(arg_in) {
    return this.$.echoImageSkiaRep(arg_in);
  }
  echoImageSkia(arg_in) {
    return this.$.echoImageSkia(arg_in);
  }
};

mojo.internal.bindings.gfx.mojom.ImageTraitsTestServiceRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('gfx.mojom.ImageTraitsTestService', [
      { explicit: null },
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.gfx.mojom.ImageTraitsTestService.getRemote = function() {
  let remote = new mojo.internal.bindings.gfx.mojom.ImageTraitsTestServiceRemote();
...
mojo.internal.bindings.gfx.mojom.ImageTraitsTestServiceReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('gfx.mojom.ImageTraitsTestService', [
      { explicit: null },
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.gfx.mojom.ImageTraitsTestService_EchoImageSkiaRep_ParamsSpec.$.structSpec);
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.gfx.mojom.ImageTraitsTestService_EchoImageSkia_ParamsSpec.$.structSpec);
      ...
      switch (dispatchId) {
        case 0: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.gfx.mojom.ImageTraitsTestService_EchoImageSkiaRep_ResponseParamsSpec, header, rawHeader);
               responder(response);
        ...
        case 1: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              const rawHeader = (args[2] && args[2].slice) ? args[2].slice(0, header.headerSize) : null;
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.gfx.mojom.ImageTraitsTestService_EchoImageSkia_ResponseParamsSpec, header, rawHeader);
               responder(response);
...
mojo.internal.bindings.gfx.mojom.ImageTraitsTestServiceReceiver = mojo.internal.bindings.gfx.mojom.ImageTraitsTestServiceReceiver;
