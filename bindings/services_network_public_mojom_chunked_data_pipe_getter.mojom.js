  ...
  bind(handle) {
    ...
    this.endpoint.start((message) => {
      ...
      switch (header.ordinal) {
        case 0: {
          const params = network.mojom.ChunkedDataPipeGetter_GetSize_ParamsSpec.$.decode(message.payload);
        ...
        case 1: {
          const params = network.mojom.ChunkedDataPipeGetter_StartReading_ParamsSpec.$.decode(message.payload);
