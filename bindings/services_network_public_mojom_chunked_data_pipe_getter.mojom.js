...
mojo.internal.bindings.network.mojom.ChunkedDataPipeGetterRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.network.mojom.ChunkedDataPipeGetterPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.network.mojom.ChunkedDataPipeGetterRemoteCallHandler(this.proxy);
  }
  ...
  startReading(arg_pipe) {
    return this.$.startReading(arg_pipe);
  }
};

mojo.internal.bindings.network.mojom.ChunkedDataPipeGetterRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('network.mojom.ChunkedDataPipeGetter', [
      { explicit: null },
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.network.mojom.ChunkedDataPipeGetter.getRemote = function() {
  let remote = new mojo.internal.bindings.network.mojom.ChunkedDataPipeGetterRemote();
...
mojo.internal.bindings.network.mojom.ChunkedDataPipeGetterReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('network.mojom.ChunkedDataPipeGetter', [
      { explicit: null },
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.network.mojom.ChunkedDataPipeGetter_GetSize_ParamsSpec.$.structSpec);
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.network.mojom.ChunkedDataPipeGetter_StartReading_ParamsSpec.$.structSpec);
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.network.mojom.ChunkedDataPipeGetter_GetSize_ParamsSpec.$.structSpec);
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.network.mojom.ChunkedDataPipeGetter_GetSize_ResponseParamsSpec, header, rawHeader);
               responder(response);
...
mojo.internal.bindings.network.mojom.ChunkedDataPipeGetterReceiver = mojo.internal.bindings.network.mojom.ChunkedDataPipeGetterReceiver;
