  ...
  $: {
    structSpec: {
      ...
      fields: [
        ...
        { name: 'type', packedOffset: 8, packedBitOffset: 0, type: arc.mojom.ArcNotificationTypeSpec, nullable: false, minVersion: 0 },
        ...
        { name: 'app_display_name', packedOffset: 32, packedBitOffset: 0, type: mojo.internal.String, nullable: true, minVersion: 0 },
        { name: 'deprecated_icon_data', packedOffset: 40, packedBitOffset: 0, type: mojo.internal.Array(mojo.internal.Uint8, false), nullable: true, minVersion: 0 },
        { name: 'priority', packedOffset: 12, packedBitOffset: 0, type: arc.mojom.ArcNotificationPrioritySpec, nullable: false, minVersion: 0 },
        { name: 'time', packedOffset: 48, packedBitOffset: 0, type: mojo.internal.Int64, nullable: false, minVersion: 0 },
        { name: 'progress_current', packedOffset: 56, packedBitOffset: 0, type: mojo.internal.Int32, nullable: false, minVersion: 0 },
        { name: 'progress_max', packedOffset: 60, packedBitOffset: 0, type: mojo.internal.Int32, nullable: false, minVersion: 0 },
        { name: 'buttons', packedOffset: 64, packedBitOffset: 0, type: mojo.internal.Array(arc.mojom.ArcNotificationButtonSpec, false), nullable: true, minVersion: 0 },
  ...
  $: {
    structSpec: {
      ...
      fields: [
        ...
        { name: 'top_level_notification_key_deprecated', packedOffset: 8, packedBitOffset: 0, type: mojo.internal.String, nullable: false, minVersion: 0 },
        { name: 'defer_until_unlock', packedOffset: 4, packedBitOffset: 0, type: mojo.internal.Bool, nullable: false, minVersion: 0 },
        { name: 'to_be_focused_after_unlock', packedOffset: 4, packedBitOffset: 1, type: mojo.internal.Bool, nullable: false, minVersion: 0 },
      ],
      versions: [{version: 0, packedSize: 24}]
    }
  }
...
arc.mojom.NotificationsInstance_SendNotificationButtonClickToAndroid_ParamsSpec = {
  $: {
    structSpec: {
      ...
      fields: [
        { name: 'key', packedOffset: 0, packedBitOffset: 0, type: mojo.internal.String, nullable: false, minVersion: 0 },
        { name: 'action_button_index', packedOffset: 8, packedBitOffset: 0, type: mojo.internal.Uint32, nullable: false, minVersion: 0 },
        { name: 'input', packedOffset: 16, packedBitOffset: 0, type: mojo.internal.String, nullable: false, minVersion: 0 },
      ],
      versions: [{version: 0, packedSize: 32}]
    }
  }
