...
mojo.internal.bindings.network.mojom.NetworkChangeEvent = {
  kSoonToDisconnect: 0,
  kDisconnected: 1,
  kConnected: 2,
...
mojo.internal.Struct(
    mojo.internal.bindings.network.mojom.ConnectionKeepAliveConfigSpec, 'network.mojom.ConnectionKeepAliveConfig', [
      mojo.internal.StructField('arg_quic_connection_options', 0, 0, mojo.internal.String, 0, false, 0, undefined),
      mojo.internal.StructField('arg_idle_timeout_in_seconds', 8, 0, mojo.internal.Int32, 0, false, 0, undefined),
      mojo.internal.StructField('arg_ping_interval_in_seconds', 12, 0, mojo.internal.Int32, 0, false, 0, undefined),
      mojo.internal.StructField('arg_enable_connection_keep_alive', 16, 0, mojo.internal.Bool, false, false, 0, undefined),
    ],
    [[0, 32]]);
...
mojo.internal.bindings.network.mojom.ConnectionChangeObserverClientRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.network.mojom.ConnectionChangeObserverClientPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.network.mojom.ConnectionChangeObserverClientRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.network.mojom.ConnectionChangeObserverClient.getRemote = function() {
  let remote = new mojo.internal.bindings.network.mojom.ConnectionChangeObserverClientRemote();
...
mojo.internal.bindings.network.mojom.ConnectionChangeObserverClientReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.network.mojom.ConnectionChangeObserverClient_OnSessionClosed_ParamsSpec.$.structSpec;
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.network.mojom.ConnectionChangeObserverClient_OnNetworkEvent_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OnNetworkEvent failed with TypeError');
           }
        }
        // Try Method 2: OnConnectionFailed
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.network.mojom.ConnectionChangeObserverClient_OnConnectionFailed_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OnConnectionFailed failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
      ...
      switch (dispatchId) {
        ...
        case 2: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.network.mojom.ConnectionChangeObserverClient_OnConnectionFailed_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.network.mojom.ConnectionChangeObserverClientReceiver = mojo.internal.bindings.network.mojom.ConnectionChangeObserverClientReceiver;
