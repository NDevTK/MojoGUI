...
blink.mojom.TextFragmentReceiver_RequestSelector_ResponseParamsSpec = {
  $: {
    structSpec: {
      ...
      packedSize: 32,
      fields: [
        { name: 'selector', packedOffset: 0, packedBitOffset: 0, type: mojo.internal.String, nullable: true },
...
blink.mojom.TextFragmentReceiver_GetExistingSelectors_ResponseParamsSpec = {
  $: {
    structSpec: {
      ...
      packedSize: 16,
      fields: [
        { name: 'selectors', packedOffset: 0, packedBitOffset: 0, type: mojo.internal.String, nullable: true },
      ],
      versions: [{version: 0}]
    }
  }
