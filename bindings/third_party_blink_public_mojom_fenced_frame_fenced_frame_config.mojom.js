...
blink.mojom.FencedFrameConfigSpec = {
  $: {
    structSpec: {
      ...
      packedSize: 96,
      fields: [
        { name: 'mapped_url', packedOffset: 0, packedBitOffset: 0, type: mojo.internal.Pointer, nullable: true },
        { name: 'container_size', packedOffset: 8, packedBitOffset: 0, type: mojo.internal.Pointer, nullable: true },
        { name: 'content_size', packedOffset: 16, packedBitOffset: 0, type: mojo.internal.Pointer, nullable: true },
        { name: 'deprecated_should_freeze_initial_size', packedOffset: 24, packedBitOffset: 0, type: mojo.internal.Pointer, nullable: true },
