...
mojo.internal.bindings.actor.mojom.InitializeToolResultSpec = mojo.internal.bindings.actor.mojom.InitializeToolResultSpec || { $: {} };
if (mojo.internal.bindings.actor.mojom.InitializeToolResultSpec.$.structSpec && mojo.internal.bindings.actor.mojom.InitializeToolResultSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.actor.mojom.InitializeToolResultSpec.$ = {};
...
mojo.internal.bindings.actor.mojom.ActionResultCode = {
  ...
  kActionsBlockedForSiteRisk: 44,
  kActionsBlockedSafeBrowsingDisabled: 45,
  ...
  kLoginFederatedContinuation: 910,
  kLoginFederatedAccountNotLoggedIn: 911,
  kLoginFederatedAccountIsSignUp: 912,
  kLoginFederatedAccountNotAvailable: 913,
  kLoginFederatedIdpReturnedError: 914,
  kLoginFederatedIdpNetworkError: 915,
  kLoginFederatedTokenRequestAborted: 916,
  kLoginFederatedFrameNotActive: 917,
  kLoginFederatedExpectedAccountNotPresent: 918,
  ...
  kScriptToolNavigationDidNotCommit: 1207,
  kScriptToolNavigationCommittedErrorPage: 1208,
  kScriptToolNavigationFailedLoad: 1209,
  kActorUiError: 1300,
};
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const message = new mojo.internal.Message(
                ...
                header.ordinal, header.requestId, mojo.internal.bindings.actor.mojom.PageStabilityMonitor_NotifyWhenStable_ResponseParamsSpec.$.structSpec, resp_obj);
...
mojo.internal.Union(
    mojo.internal.bindings.actor.mojom.InitializeToolResultSpec, 'actor.mojom.InitializeToolResult', {
      'arg_success_point': {
        'ordinal': 0,
        'type': mojo.internal.bindings.gfx.mojom.PointSpec,
        'nullable': true,
      ...
      'arg_error_result': {
        'ordinal': 1,
        'type': mojo.internal.bindings.actor.mojom.ActionResultSpec,
        'nullable': false,
      },
    });
...
mojo.internal.Struct(
    mojo.internal.bindings.actor.mojom.TypeActionSpec, 'actor.mojom.TypeAction', [
      ...
      mojo.internal.StructField('arg_follow_by_enter', 4, 0, mojo.internal.Bool, false, false, 0, undefined),
...
mojo.internal.Struct(
    mojo.internal.bindings.actor.mojom.ToolInvocationSpec, 'actor.mojom.ToolInvocation', [
      ...
      mojo.internal.StructField('arg_execution_id', 8, 0, mojo.internal.bindings.mojo_base.mojom.UnguessableTokenSpec, null, true, 0, undefined),
      mojo.internal.StructField('arg_action', 16, 0, mojo.internal.bindings.actor.mojom.ToolActionSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_target', 32, 0, mojo.internal.bindings.actor.mojom.ToolTargetSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_observed_target', 48, 0, mojo.internal.bindings.actor.mojom.ObservedToolTargetSpec, null, true, 0, undefined),
    ],
    [[0, 64]]);
