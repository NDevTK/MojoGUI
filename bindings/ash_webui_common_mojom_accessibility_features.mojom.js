...
mojo.internal.bindings.ash.common.mojom.ForceHiddenElementsVisibleObserverRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.ash.common.mojom.ForceHiddenElementsVisibleObserverPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.ash.common.mojom.ForceHiddenElementsVisibleObserverRemoteCallHandler(this.proxy);
  }
  ...
  onForceHiddenElementsVisibleChange(arg_forceVisible) {
    return this.$.onForceHiddenElementsVisibleChange(arg_forceVisible);
  }
};
...
mojo.internal.bindings.ash.common.mojom.ForceHiddenElementsVisibleObserver.getRemote = function() {
  let remote = new mojo.internal.bindings.ash.common.mojom.ForceHiddenElementsVisibleObserverRemote();
...
mojo.internal.bindings.ash.common.mojom.ForceHiddenElementsVisibleObserverReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ash.common.mojom.ForceHiddenElementsVisibleObserver_OnForceHiddenElementsVisibleChange_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OnForceHiddenElementsVisibleChange failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.ash.common.mojom.ForceHiddenElementsVisibleObserverReceiver = mojo.internal.bindings.ash.common.mojom.ForceHiddenElementsVisibleObserverReceiver;

mojo.internal.bindings.ash.common.mojom.ForceHiddenElementsVisibleObserverPtr = mojo.internal.bindings.ash.common.mojom.ForceHiddenElementsVisibleObserverRemote;
mojo.internal.bindings.ash.common.mojom.ForceHiddenElementsVisibleObserverRequest = mojo.internal.bindings.ash.common.mojom.ForceHiddenElementsVisibleObserverPendingReceiver;
...
mojo.internal.bindings.ash.common.mojom.AccessibilityFeaturesRemote = class {
  static get $interfaceName() {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.ash.common.mojom.AccessibilityFeaturesPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.ash.common.mojom.AccessibilityFeaturesRemoteCallHandler(this.proxy);
  }
  ...
  observeForceHiddenElementsVisible(arg_observer) {
    return this.$.observeForceHiddenElementsVisible(arg_observer);
  }
};
...
mojo.internal.bindings.ash.common.mojom.AccessibilityFeatures.getRemote = function() {
  let remote = new mojo.internal.bindings.ash.common.mojom.AccessibilityFeaturesRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
...
mojo.internal.bindings.ash.common.mojom.AccessibilityFeaturesReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ash.common.mojom.AccessibilityFeatures_ObserveForceHiddenElementsVisible_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for ObserveForceHiddenElementsVisible failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
             console.warn('[GeneratedReceiver] Failed to discover ordinal ' + header.ordinal);
...
mojo.internal.bindings.ash.common.mojom.AccessibilityFeaturesReceiver = mojo.internal.bindings.ash.common.mojom.AccessibilityFeaturesReceiver;
