...
mojo.internal.bindings.blink.mojom.ManifestUrlChangeObserver = {};
mojo.internal.bindings.blink.mojom.ManifestUrlChangeObserverSpec = { $ : {} };
mojo.internal.bindings.blink.mojom.ManifestUrlChangeObserver.$interfaceName = 'blink.mojom.ManifestUrlChangeObserver';
...
mojo.internal.bindings.blink.mojom.ManifestUrlChangeObserverRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.blink.mojom.ManifestUrlChangeObserverPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.blink.mojom.ManifestUrlChangeObserverRemoteCallHandler(this.proxy);
  }
  ...
  manifestUrlChanged(arg_manifest_url) {
    return this.$.manifestUrlChanged(arg_manifest_url);
  }
};

mojo.internal.bindings.blink.mojom.ManifestUrlChangeObserverRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('blink.mojom.ManifestUrlChangeObserver', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.blink.mojom.ManifestUrlChangeObserver.getRemote = function() {
  let remote = new mojo.internal.bindings.blink.mojom.ManifestUrlChangeObserverRemote();
...
mojo.internal.bindings.blink.mojom.ManifestUrlChangeObserverReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('blink.mojom.ManifestUrlChangeObserver', [
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.blink.mojom.ManifestUrlChangeObserver_ManifestUrlChanged_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for ManifestUrlChanged failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.blink.mojom.ManifestUrlChangeObserverReceiver = mojo.internal.bindings.blink.mojom.ManifestUrlChangeObserverReceiver;
