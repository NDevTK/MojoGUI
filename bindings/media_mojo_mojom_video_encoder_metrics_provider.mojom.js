...
mojo.internal.Struct(
    mojo.internal.bindings.media.mojom.VideoEncoderMetricsProvider_Initialize_ParamsSpec, 'media.mojom.VideoEncoderMetricsProvider_Initialize_Params', [
      ...
      mojo.internal.StructField('arg_encode_size', 8, 0, mojo.internal.bindings.gfx.mojom.SizeSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_encoder_use_case', 16, 0, mojo.internal.bindings.media.mojom.VideoEncoderUseCaseSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_profile', 20, 0, mojo.internal.bindings.media.mojom.VideoCodecProfileSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_svc_mode', 24, 0, mojo.internal.bindings.media.mojom.SVCScalabilityModeSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_is_hardware_encoder', 28, 0, mojo.internal.Bool, false, false, 0, undefined),
    ],
    [[0, 40]]);
...
mojo.internal.bindings.media.mojom.VideoEncoderMetricsProviderRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.media.mojom.VideoEncoderMetricsProviderRemoteCallHandler(this.proxy);
  }
  ...
  initialize(arg_encoder_id, arg_encoder_use_case, arg_profile, arg_encode_size, arg_is_hardware_encoder, arg_svc_mode) {
    return this.$.initialize(arg_encoder_id, arg_encoder_use_case, arg_profile, arg_encode_size, arg_is_hardware_encoder, arg_svc_mode);
  }
  setEncodedFrameCount(arg_encoder_id, arg_num_encoded_frames) {
    return this.$.setEncodedFrameCount(arg_encoder_id, arg_num_encoded_frames);
  }
  setError(arg_encoder_id, arg_status) {
    return this.$.setError(arg_encoder_id, arg_status);
  }
  complete(arg_encoder_id) {
    return this.$.complete(arg_encoder_id);
  }
};

mojo.internal.bindings.media.mojom.VideoEncoderMetricsProviderRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('media.mojom.VideoEncoderMetricsProvider', [
      { explicit: null },
      { explicit: null },
      { explicit: null },
      { explicit: null },
...
mojo.internal.bindings.media.mojom.VideoEncoderMetricsProvider.getRemote = function() {
  let remote = new mojo.internal.bindings.media.mojom.VideoEncoderMetricsProviderRemote();
...
mojo.internal.bindings.media.mojom.VideoEncoderMetricsProviderReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('media.mojom.VideoEncoderMetricsProvider', [
      { explicit: null },
      { explicit: null },
      { explicit: null },
      { explicit: null },
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.media.mojom.VideoEncoderMetricsProvider_Initialize_ParamsSpec.$.structSpec;
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.media.mojom.VideoEncoderMetricsProvider_SetEncodedFrameCount_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for SetEncodedFrameCount failed with TypeError');
           }
        }
        // Try Method 2: SetError
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.media.mojom.VideoEncoderMetricsProvider_SetError_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for SetError failed with TypeError');
           }
        }
        // Try Method 3: Complete
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.media.mojom.VideoEncoderMetricsProvider_Complete_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
...
mojo.internal.bindings.media.mojom.VideoEncoderMetricsProviderReceiver = mojo.internal.bindings.media.mojom.VideoEncoderMetricsProviderReceiver;
