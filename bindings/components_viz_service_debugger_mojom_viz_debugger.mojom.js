...
mojo.internal.bindings.viz.mojom.VizDebugOutput = {};
mojo.internal.bindings.viz.mojom.VizDebugOutputSpec = { $ : {} };
mojo.internal.bindings.viz.mojom.VizDebugOutput.$interfaceName = 'viz.mojom.VizDebugOutput';
...
mojo.internal.bindings.viz.mojom.VizDebugOutputRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.viz.mojom.VizDebugOutputPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.viz.mojom.VizDebugOutputRemoteCallHandler(this.proxy);
  }
  ...
  logFrame(arg_frameData) {
    return this.$.logFrame(arg_frameData);
  }
};

mojo.internal.bindings.viz.mojom.VizDebugOutputRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('viz.mojom.VizDebugOutput', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.viz.mojom.VizDebugOutput.getRemote = function() {
  let remote = new mojo.internal.bindings.viz.mojom.VizDebugOutputRemote();
...
mojo.internal.bindings.viz.mojom.VizDebugOutputReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('viz.mojom.VizDebugOutput', [
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        // Try Method 0: LogFrame
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.viz.mojom.VizDebugOutput_LogFrame_ParamsSpec.$.structSpec;
             ...
             if (sizeMatch && (!!(header.flags & 1) === methodExpectsResp)) {
               if (size > 8 || message.payload.byteLength === 8) {
                 ...
                 console.log('[GeneratedReceiver] Discovery SUCCESS: ' + header.ordinal + ' -> LogFrame (0)');
                 this.mapOrdinal(header.ordinal, 0);
                 dispatchId = 0;
               }
             }
           } catch (e) {
             if (e instanceof TypeError) console.warn('[Discovery] trial for LogFrame failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.viz.mojom.VizDebugOutputReceiver = mojo.internal.bindings.viz.mojom.VizDebugOutputReceiver;
