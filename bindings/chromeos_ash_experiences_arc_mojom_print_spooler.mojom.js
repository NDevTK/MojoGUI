...
mojo.internal.bindings.arc.mojom.PrintSessionHostRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.arc.mojom.PrintSessionHostRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.arc.mojom.PrintSessionHostReceiver = mojo.internal.bindings.arc.mojom.PrintSessionHostReceiver;

mojo.internal.bindings.arc.mojom.PrintSessionHostPtr = mojo.internal.bindings.arc.mojom.PrintSessionHostRemote;
mojo.internal.bindings.arc.mojom.PrintSessionHostRequest = mojo.internal.bindings.arc.mojom.PrintSessionHostPendingReceiver;
...
mojo.internal.Struct(
    mojo.internal.bindings.arc.mojom.PrintSessionInstance_CreatePreviewDocument_ResponseParamsSpec, 'arc.mojom.PrintSessionInstance_CreatePreviewDocument_ResponseParams', [
      mojo.internal.StructField('arg_data_size', 0, 0, mojo.internal.Int64, 0, false, 0, undefined),
      mojo.internal.StructField('arg_preview_document', 8, 0, mojo.internal.Handle, null, true, 0, undefined),
    ],
    [[0, 24]]);
...
mojo.internal.bindings.arc.mojom.PrintSessionInstanceRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.arc.mojom.PrintSessionInstanceRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.arc.mojom.PrintSessionInstance.getRemote = function() {
  let remote = new mojo.internal.bindings.arc.mojom.PrintSessionInstanceRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.arc.mojom.PrintSessionInstance_OnPrintPreviewClosed_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OnPrintPreviewClosed failed with TypeError');
           }
        }
        // Try Method 1: CreatePreviewDocument
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.arc.mojom.PrintSessionInstance_CreatePreviewDocument_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.arc.mojom.PrintSessionInstance_OnPrintPreviewClosed_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.arc.mojom.PrintSessionInstanceReceiver = mojo.internal.bindings.arc.mojom.PrintSessionInstanceReceiver;

mojo.internal.bindings.arc.mojom.PrintSessionInstancePtr = mojo.internal.bindings.arc.mojom.PrintSessionInstanceRemote;
mojo.internal.bindings.arc.mojom.PrintSessionInstanceRequest = mojo.internal.bindings.arc.mojom.PrintSessionInstancePendingReceiver;
...
mojo.internal.bindings.arc.mojom.PrintSpoolerHostRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.arc.mojom.PrintSpoolerHostRemoteCallHandler(this.proxy);
  }
  ...
  startPrintInCustomTab(arg_scoped_handle, arg_task_id, arg_instance) {
    return this.$.startPrintInCustomTab(arg_scoped_handle, arg_task_id, arg_instance);
  }
};
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.arc.mojom.PrintSpoolerHost_StartPrintInCustomTab_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for StartPrintInCustomTab failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
             console.warn('[GeneratedReceiver] Failed to discover ordinal ' + header.ordinal);
...
mojo.internal.bindings.arc.mojom.PrintSpoolerHostReceiver = mojo.internal.bindings.arc.mojom.PrintSpoolerHostReceiver;

mojo.internal.bindings.arc.mojom.PrintSpoolerHostPtr = mojo.internal.bindings.arc.mojom.PrintSpoolerHostRemote;
mojo.internal.bindings.arc.mojom.PrintSpoolerHostRequest = mojo.internal.bindings.arc.mojom.PrintSpoolerHostPendingReceiver;
...
mojo.internal.bindings.arc.mojom.PrintSpoolerInstanceRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.arc.mojom.PrintSpoolerInstanceRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.arc.mojom.PrintSpoolerInstance.getRemote = function() {
  let remote = new mojo.internal.bindings.arc.mojom.PrintSpoolerInstanceRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.arc.mojom.PrintSpoolerInstance_Init_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
...
mojo.internal.bindings.arc.mojom.PrintSpoolerInstanceReceiver = mojo.internal.bindings.arc.mojom.PrintSpoolerInstanceReceiver;
