...
mojo.internal.bindings.chromecast.external_mojo.mojom.TestExternalConnectorRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.chromecast.external_mojo.mojom.TestExternalConnectorPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.chromecast.external_mojo.mojom.TestExternalConnectorRemoteCallHandler(this.proxy);
  }
  ...
  bindInterfaceInternal(arg_service_name, arg_interface_name, arg_interface_pipe) {
    return this.$.bindInterfaceInternal(arg_service_name, arg_interface_name, arg_interface_pipe);
  }
};
...
mojo.internal.bindings.chromecast.external_mojo.mojom.TestExternalConnector.getRemote = function() {
  let remote = new mojo.internal.bindings.chromecast.external_mojo.mojom.TestExternalConnectorRemote();
...
mojo.internal.bindings.chromecast.external_mojo.mojom.TestExternalConnectorReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.chromecast.external_mojo.mojom.TestExternalConnector_BindInterfaceInternal_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for BindInterfaceInternal failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.chromecast.external_mojo.mojom.TestExternalConnectorReceiver = mojo.internal.bindings.chromecast.external_mojo.mojom.TestExternalConnectorReceiver;
