...
mojo.internal.bindings.printing.mojom.PdfToPwgRasterConverterRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.printing.mojom.PdfToPwgRasterConverterRemoteCallHandler(this.proxy);
  }
  ...
  convert(arg_pdf_region, arg_pdf_settings, arg_pwg_raster_settings) {
    return this.$.convert(arg_pdf_region, arg_pdf_settings, arg_pwg_raster_settings);
  }
...
mojo.internal.bindings.printing.mojom.PdfToPwgRasterConverterRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('printing.mojom.PdfToPwgRasterConverter', [
      { explicit: null },
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.printing.mojom.PdfToPwgRasterConverter.getRemote = function() {
  let remote = new mojo.internal.bindings.printing.mojom.PdfToPwgRasterConverterRemote();
...
mojo.internal.bindings.printing.mojom.PdfToPwgRasterConverterReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('printing.mojom.PdfToPwgRasterConverter', [
      { explicit: null },
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.printing.mojom.PdfToPwgRasterConverter_Convert_ParamsSpec.$.structSpec);
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.printing.mojom.PdfToPwgRasterConverter_SetUseSkiaRendererPolicy_ParamsSpec.$.structSpec);
        ...
        case 0: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.printing.mojom.PdfToPwgRasterConverter_Convert_ResponseParamsSpec, header, rawHeader);
               responder(response);
...
mojo.internal.bindings.printing.mojom.PdfToPwgRasterConverterReceiver = mojo.internal.bindings.printing.mojom.PdfToPwgRasterConverterReceiver;
