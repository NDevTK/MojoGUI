...
mojo.internal.bindings.network.mojom.SocketBroker = {};
mojo.internal.bindings.network.mojom.SocketBrokerSpec = { $ : {} };
mojo.internal.bindings.network.mojom.SocketBroker.$interfaceName = 'network.mojom.SocketBroker';
...
mojo.internal.bindings.network.mojom.SocketBrokerRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.network.mojom.SocketBrokerPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.network.mojom.SocketBrokerRemoteCallHandler(this.proxy);
  }
  ...
  createTcpSocket(arg_address_family) {
    return this.$.createTcpSocket(arg_address_family);
  }
  createUdpSocket(arg_address_family) {
    return this.$.createUdpSocket(arg_address_family);
  }
};

mojo.internal.bindings.network.mojom.SocketBrokerRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('network.mojom.SocketBroker', [
      { explicit: null },
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.network.mojom.SocketBroker.getRemote = function() {
  let remote = new mojo.internal.bindings.network.mojom.SocketBrokerRemote();
...
mojo.internal.bindings.network.mojom.SocketBrokerReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('network.mojom.SocketBroker', [
      { explicit: null },
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.network.mojom.SocketBroker_CreateTcpSocket_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for CreateTcpSocket failed with TypeError');
           }
        }
        // Try Method 1: CreateUdpSocket
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.network.mojom.SocketBroker_CreateUdpSocket_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for CreateUdpSocket failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.network.mojom.SocketBrokerReceiver = mojo.internal.bindings.network.mojom.SocketBrokerReceiver;
