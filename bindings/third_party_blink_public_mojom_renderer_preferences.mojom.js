...
blink.mojom.RendererPreferencesSpec = {
  $: {
    structSpec: {
      ...
      packedSize: 272,
      fields: [
        { name: 'hinting', packedOffset: 0, packedBitOffset: 0, type: mojo.internal.Pointer, nullable: false },
        ...
        { name: 'caret_blink_interval', packedOffset: 24, packedBitOffset: 0, type: mojo.internal.Pointer, nullable: true },
        { name: 'use_overlay_scrollbar', packedOffset: 32, packedBitOffset: 0, type: mojo.internal.Pointer, nullable: false },
        { name: 'webrtc_ip_handling_policy', packedOffset: 40, packedBitOffset: 0, type: mojo.internal.Pointer, nullable: false },
        ...
        { name: 'user_agent_override', packedOffset: 64, packedBitOffset: 0, type: mojo.internal.Pointer, nullable: false },
        ...
        { name: 'caption_font_family_name', packedOffset: 88, packedBitOffset: 0, type: mojo.internal.Pointer, nullable: false },
        { name: 'caption_font_height', packedOffset: 96, packedBitOffset: 0, type: mojo.internal.Pointer, nullable: false },
        { name: 'small_caption_font_family_name', packedOffset: 104, packedBitOffset: 0, type: mojo.internal.Pointer, nullable: false },
        { name: 'small_caption_font_height', packedOffset: 112, packedBitOffset: 0, type: mojo.internal.Pointer, nullable: false },
        { name: 'menu_font_family_name', packedOffset: 120, packedBitOffset: 0, type: mojo.internal.Pointer, nullable: false },
        { name: 'menu_font_height', packedOffset: 128, packedBitOffset: 0, type: mojo.internal.Pointer, nullable: false },
        { name: 'status_font_family_name', packedOffset: 136, packedBitOffset: 0, type: mojo.internal.Pointer, nullable: false },
        { name: 'status_font_height', packedOffset: 144, packedBitOffset: 0, type: mojo.internal.Pointer, nullable: false },
        { name: 'message_font_family_name', packedOffset: 152, packedBitOffset: 0, type: mojo.internal.Pointer, nullable: false },
