...
mojo.internal.bindings.download.mojom.DownloadStreamClientRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.download.mojom.DownloadStreamClientPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.download.mojom.DownloadStreamClientRemoteCallHandler(this.proxy);
  }
  ...
  onStreamCompleted(arg_status) {
    return this.$.onStreamCompleted(arg_status);
  }
};
...
mojo.internal.bindings.download.mojom.DownloadStreamClient.getRemote = function() {
  let remote = new mojo.internal.bindings.download.mojom.DownloadStreamClientRemote();
...
mojo.internal.bindings.download.mojom.DownloadStreamClientReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.download.mojom.DownloadStreamClient_OnStreamCompleted_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OnStreamCompleted failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.download.mojom.DownloadStreamClientReceiver = mojo.internal.bindings.download.mojom.DownloadStreamClientReceiver;
