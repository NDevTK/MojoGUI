...
mojo.internal.bindings.watermark.mojom.PageHandlerFactoryRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.watermark.mojom.PageHandlerFactoryPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.watermark.mojom.PageHandlerFactoryRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.watermark.mojom.PageHandlerFactoryRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('watermark.mojom.PageHandlerFactory', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.watermark.mojom.PageHandlerFactory.getRemote = function() {
  let remote = new mojo.internal.bindings.watermark.mojom.PageHandlerFactoryRemote();
...
mojo.internal.bindings.watermark.mojom.PageHandlerFactoryReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('watermark.mojom.PageHandlerFactory', [
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.watermark.mojom.PageHandlerFactory_CreatePageHandler_ParamsSpec.$.structSpec;
...
mojo.internal.bindings.watermark.mojom.PageHandlerFactoryReceiver = mojo.internal.bindings.watermark.mojom.PageHandlerFactoryReceiver;

mojo.internal.bindings.watermark.mojom.PageHandlerFactoryPtr = mojo.internal.bindings.watermark.mojom.PageHandlerFactoryRemote;
mojo.internal.bindings.watermark.mojom.PageHandlerFactoryRequest = mojo.internal.bindings.watermark.mojom.PageHandlerFactoryPendingReceiver;
...
mojo.internal.bindings.watermark.mojom.PageHandlerRemote = class {
  static get $interfaceName() {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.watermark.mojom.PageHandlerPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.watermark.mojom.PageHandlerRemoteCallHandler(this.proxy);
  }
  ...
  setWatermarkStyle(arg_style) {
    return this.$.setWatermarkStyle(arg_style);
  }
...
mojo.internal.bindings.watermark.mojom.PageHandlerRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('watermark.mojom.PageHandler', [
      { explicit: null },
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.watermark.mojom.PageHandler.getRemote = function() {
  let remote = new mojo.internal.bindings.watermark.mojom.PageHandlerRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
...
mojo.internal.bindings.watermark.mojom.PageHandlerReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('watermark.mojom.PageHandler', [
      { explicit: null },
      { explicit: null },
    ]);
    ordinals.forEach((ord, idx) => {
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.watermark.mojom.PageHandler_SetWatermarkStyle_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for SetWatermarkStyle failed with TypeError');
           }
        }
        // Try Method 1: ShowNotificationToast
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.watermark.mojom.PageHandler_ShowNotificationToast_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for ShowNotificationToast failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
             console.warn('[GeneratedReceiver] Failed to discover ordinal ' + header.ordinal);
      ...
      switch (dispatchId) {
        ...
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.watermark.mojom.PageHandler_ShowNotificationToast_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.watermark.mojom.PageHandlerReceiver = mojo.internal.bindings.watermark.mojom.PageHandlerReceiver;
