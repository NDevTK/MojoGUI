...
mojo.internal.bindings.chromecast.mojom.ServiceConnector = {};
mojo.internal.bindings.chromecast.mojom.ServiceConnectorSpec = { $ : {} };
mojo.internal.bindings.chromecast.mojom.ServiceConnector.$interfaceName = 'chromecast.mojom.ServiceConnector';
...
mojo.internal.bindings.chromecast.mojom.ServiceConnectorRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.chromecast.mojom.ServiceConnectorPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.chromecast.mojom.ServiceConnectorRemoteCallHandler(this.proxy);
  }
  ...
  connect(arg_service_name, arg_receiver) {
    return this.$.connect(arg_service_name, arg_receiver);
  }
};

mojo.internal.bindings.chromecast.mojom.ServiceConnectorRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('chromecast.mojom.ServiceConnector', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.chromecast.mojom.ServiceConnector.getRemote = function() {
  let remote = new mojo.internal.bindings.chromecast.mojom.ServiceConnectorRemote();
...
mojo.internal.bindings.chromecast.mojom.ServiceConnectorReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('chromecast.mojom.ServiceConnector', [
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.chromecast.mojom.ServiceConnector_Connect_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.chromecast.mojom.ServiceConnectorReceiver = mojo.internal.bindings.chromecast.mojom.ServiceConnectorReceiver;
