...
mojo.internal.Struct(
    viz.mojom.LayerTreeUpdateSpec, 'viz.mojom.LayerTreeUpdate', [
      ...
      mojo.internal.StructField('max_safe_area_inset_bottom', 176, 0, mojo.internal.Float, 0, false, 0, undefined),
      mojo.internal.StructField('browser_controls_params', 184, 0, cc.mojom.BrowserControlsParamsSpec.$, null, false, 0, undefined),
      mojo.internal.StructField('browser_controls_offset_tag_modifications', 192, 0, cc.mojom.BrowserControlsOffsetTagModificationsSpec.$, null, false, 0, undefined),
      mojo.internal.StructField('top_controls_shown_ratio', 200, 0, mojo.internal.Float, 0, false, 0, undefined),
      mojo.internal.StructField('bottom_controls_shown_ratio', 204, 0, mojo.internal.Float, 0, false, 0, undefined),
      mojo.internal.StructField('ui_resource_requests', 208, 0, mojo.internal.Array(viz.mojom.TransferableUIResourceRequestSpec.$, false), null, false, 0, undefined),
      mojo.internal.StructField('layers', 216, 0, mojo.internal.Array(viz.mojom.LayerSpec.$, false), null, false, 0, undefined),
      mojo.internal.StructField('layer_order', 224, 0, mojo.internal.Array(mojo.internal.Int32, false), null, true, 0, undefined),
      mojo.internal.StructField('transform_tree_update', 232, 0, viz.mojom.TransformTreeUpdateSpec.$, null, true, 0, undefined),
      mojo.internal.StructField('scroll_tree_update', 240, 0, viz.mojom.ScrollTreeUpdateSpec.$, null, true, 0, undefined),
      mojo.internal.StructField('transform_nodes', 248, 0, mojo.internal.Array(viz.mojom.TransformNodeSpec.$, false), null, false, 0, undefined),
      mojo.internal.StructField('clip_nodes', 256, 0, mojo.internal.Array(viz.mojom.ClipNodeSpec.$, false), null, false, 0, undefined),
      mojo.internal.StructField('effect_nodes', 264, 0, mojo.internal.Array(viz.mojom.EffectNodeSpec.$, false), null, false, 0, undefined),
      mojo.internal.StructField('scroll_nodes', 272, 0, mojo.internal.Array(viz.mojom.ScrollNodeSpec.$, false), null, false, 0, undefined),
      mojo.internal.StructField('num_transform_nodes', 280, 0, mojo.internal.Uint32, 0, false, 0, undefined),
      mojo.internal.StructField('num_clip_nodes', 284, 0, mojo.internal.Uint32, 0, false, 0, undefined),
      mojo.internal.StructField('num_effect_nodes', 288, 0, mojo.internal.Uint32, 0, false, 0, undefined),
      mojo.internal.StructField('num_scroll_nodes', 292, 0, mojo.internal.Uint32, 0, false, 0, undefined),
      mojo.internal.StructField('tilings', 296, 0, mojo.internal.Array(viz.mojom.TilingSpec.$, false), null, false, 0, undefined),
      mojo.internal.StructField('surface_ranges', 304, 0, mojo.internal.Array(viz.mojom.SurfaceRangeSpec.$, false), null, true, 0, undefined),
      mojo.internal.StructField('view_transition_requests', 312, 0, mojo.internal.Array(viz.mojom.ViewTransitionRequestSpec.$, false), null, true, 0, undefined),
      mojo.internal.StructField('animation_timelines', 320, 0, mojo.internal.Array(viz.mojom.AnimationTimelineSpec.$, false), null, true, 0, undefined),
      mojo.internal.StructField('removed_animation_timelines', 328, 0, mojo.internal.Array(mojo.internal.Int32, false), null, true, 0, undefined),
      mojo.internal.StructField('frame_has_damage', 336, 0, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('damage_reasons_bit_mask', 340, 0, mojo.internal.Uint32, 0, false, 0, undefined),
      mojo.internal.StructField('is_handling_interaction', 344, 0, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('delegated_ink_metadata', 352, 0, gfx.mojom.DelegatedInkMetadataSpec.$, null, true, 0, undefined),
      mojo.internal.StructField('may_throttle_if_undrawn_frames', 360, 0, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('is_viewport_mobile_optimized', 360, 1, mojo.internal.Bool, false, false, 0, undefined),
    ],
    [[0, 376]]);
