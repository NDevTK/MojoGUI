...
mojo.internal.Struct(
    mojo.internal.bindings.viz.mojom.TransferableUIResourceRequestSpec, 'viz.mojom.TransferableUIResourceRequest', [
      mojo.internal.StructField('arg_uid', 0, 0, mojo.internal.bindings.cc.mojom.UIResourceIdSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_transferable_resource', 8, 0, mojo.internal.bindings.viz.mojom.TransferableResourceSpec, null, true, 0, undefined),
      mojo.internal.StructField('arg_type', 16, 0, mojo.internal.bindings.viz.mojom.TypeSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_opaque', 20, 0, mojo.internal.Bool, false, false, 0, undefined),
    ],
    [[0, 32]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.viz.mojom.LayerTreeUpdateSpec, 'viz.mojom.LayerTreeUpdate', [
      ...
      mojo.internal.StructField('arg_browser_controls_params', 96, 0, mojo.internal.bindings.cc.mojom.BrowserControlsParamsSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_browser_controls_offset_tag_modifications', 104, 0, mojo.internal.bindings.cc.mojom.BrowserControlsOffsetTagModificationsSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_ui_resource_requests', 112, 0, mojo.internal.Array(mojo.internal.bindings.viz.mojom.TransferableUIResourceRequestSpec, false), null, false, 0, undefined),
      mojo.internal.StructField('arg_layers', 120, 0, mojo.internal.Array(mojo.internal.bindings.viz.mojom.LayerSpec, false), null, false, 0, undefined),
      mojo.internal.StructField('arg_layer_order', 128, 0, mojo.internal.Array(mojo.internal.Int32, false), null, true, 0, undefined),
      mojo.internal.StructField('arg_transform_tree_update', 136, 0, mojo.internal.bindings.viz.mojom.TransformTreeUpdateSpec, null, true, 0, undefined),
      mojo.internal.StructField('arg_scroll_tree_update', 144, 0, mojo.internal.bindings.viz.mojom.ScrollTreeUpdateSpec, null, true, 0, undefined),
      mojo.internal.StructField('arg_transform_nodes', 152, 0, mojo.internal.Array(mojo.internal.bindings.viz.mojom.TransformNodeSpec, false), null, false, 0, undefined),
      mojo.internal.StructField('arg_clip_nodes', 160, 0, mojo.internal.Array(mojo.internal.bindings.viz.mojom.ClipNodeSpec, false), null, false, 0, undefined),
      mojo.internal.StructField('arg_effect_nodes', 168, 0, mojo.internal.Array(mojo.internal.bindings.viz.mojom.EffectNodeSpec, false), null, false, 0, undefined),
      mojo.internal.StructField('arg_scroll_nodes', 176, 0, mojo.internal.Array(mojo.internal.bindings.viz.mojom.ScrollNodeSpec, false), null, false, 0, undefined),
      mojo.internal.StructField('arg_tilings', 184, 0, mojo.internal.Array(mojo.internal.bindings.viz.mojom.TilingSpec, false), null, false, 0, undefined),
      mojo.internal.StructField('arg_surface_ranges', 192, 0, mojo.internal.Array(mojo.internal.bindings.viz.mojom.SurfaceRangeSpec, false), null, true, 0, undefined),
      mojo.internal.StructField('arg_view_transition_requests', 200, 0, mojo.internal.Array(mojo.internal.bindings.viz.mojom.ViewTransitionRequestSpec, false), null, true, 0, undefined),
      mojo.internal.StructField('arg_animation_timelines', 208, 0, mojo.internal.Array(mojo.internal.bindings.viz.mojom.AnimationTimelineSpec, false), null, true, 0, undefined),
      mojo.internal.StructField('arg_removed_animation_timelines', 216, 0, mojo.internal.Array(mojo.internal.Int32, false), null, true, 0, undefined),
      mojo.internal.StructField('arg_delegated_ink_metadata', 224, 0, mojo.internal.bindings.gfx.mojom.DelegatedInkMetadataSpec, null, true, 0, undefined),
      mojo.internal.StructField('arg_source_frame_number', 232, 0, mojo.internal.Int32, 0, false, 0, undefined),
      mojo.internal.StructField('arg_page_scale_factor', 236, 0, mojo.internal.Float, 0, false, 0, undefined),
      mojo.internal.StructField('arg_min_page_scale_factor', 240, 0, mojo.internal.Float, 0, false, 0, undefined),
      mojo.internal.StructField('arg_max_page_scale_factor', 244, 0, mojo.internal.Float, 0, false, 0, undefined),
      mojo.internal.StructField('arg_external_page_scale_factor', 248, 0, mojo.internal.Float, 0, false, 0, undefined),
      mojo.internal.StructField('arg_device_scale_factor', 252, 0, mojo.internal.Float, 0, false, 0, undefined),
      mojo.internal.StructField('arg_painted_device_scale_factor', 256, 0, mojo.internal.Float, 0, false, 0, undefined),
      mojo.internal.StructField('arg_next_frame_token', 260, 0, mojo.internal.Uint32, 0, false, 0, undefined),
      mojo.internal.StructField('arg_overscroll_elasticity_transform', 264, 0, mojo.internal.Int32, 0, false, 0, undefined),
      mojo.internal.StructField('arg_page_scale_transform', 268, 0, mojo.internal.Int32, 0, false, 0, undefined),
      mojo.internal.StructField('arg_inner_scroll', 272, 0, mojo.internal.Int32, 0, false, 0, undefined),
      mojo.internal.StructField('arg_outer_clip', 276, 0, mojo.internal.Int32, 0, false, 0, undefined),
      mojo.internal.StructField('arg_outer_scroll', 280, 0, mojo.internal.Int32, 0, false, 0, undefined),
      mojo.internal.StructField('arg_display_transform_hint', 284, 0, mojo.internal.bindings.gfx.mojom.OverlayTransformSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_max_safe_area_inset_bottom', 288, 0, mojo.internal.Float, 0, false, 0, undefined),
      mojo.internal.StructField('arg_top_controls_shown_ratio', 292, 0, mojo.internal.Float, 0, false, 0, undefined),
      mojo.internal.StructField('arg_bottom_controls_shown_ratio', 296, 0, mojo.internal.Float, 0, false, 0, undefined),
      mojo.internal.StructField('arg_num_transform_nodes', 300, 0, mojo.internal.Uint32, 0, false, 0, undefined),
      mojo.internal.StructField('arg_num_clip_nodes', 304, 0, mojo.internal.Uint32, 0, false, 0, undefined),
      mojo.internal.StructField('arg_num_effect_nodes', 308, 0, mojo.internal.Uint32, 0, false, 0, undefined),
      mojo.internal.StructField('arg_num_scroll_nodes', 312, 0, mojo.internal.Uint32, 0, false, 0, undefined),
      mojo.internal.StructField('arg_damage_reasons_bit_mask', 316, 0, mojo.internal.Uint32, 0, false, 0, undefined),
      mojo.internal.StructField('arg_send_frame_token_to_embedder', 320, 0, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_full_tree_damaged', 320, 1, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_frame_has_damage', 320, 2, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_is_handling_interaction', 320, 3, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_may_throttle_if_undrawn_frames', 320, 4, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_is_viewport_mobile_optimized', 320, 5, mojo.internal.Bool, false, false, 0, undefined),
    ],
    [[0, 336]]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.viz.mojom.LayerContext_SetVisible_ParamsSpec.$.structSpec;
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.viz.mojom.LayerContext_UpdateDisplayTree_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for UpdateDisplayTree failed with TypeError');
           }
        }
        // Try Method 2: UpdateDisplayTiling
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.viz.mojom.LayerContext_UpdateDisplayTiling_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for UpdateDisplayTiling failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.viz.mojom.LayerContextClient_OnRequestCommitForFrame_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OnRequestCommitForFrame failed with TypeError');
           }
        }
        // Try Method 1: OnTilingsReadyForCleanup
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.viz.mojom.LayerContextClient_OnTilingsReadyForCleanup_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OnTilingsReadyForCleanup failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
             console.warn('[GeneratedReceiver] Failed to discover ordinal ' + header.ordinal);
