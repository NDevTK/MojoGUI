  ...
  $: {
    structSpec: {
      ...
      fields: [
        ...
        { name: 'selection', packedOffset: 24, packedBitOffset: 0, type: mojo.internal.Pointer, nullable: false },
        { name: 'device_viewport', packedOffset: 32, packedBitOffset: 0, type: mojo.internal.Pointer, nullable: false },
        { name: 'display_color_spaces', packedOffset: 40, packedBitOffset: 0, type: mojo.internal.Pointer, nullable: false },
        ...
        { name: 'background_color', packedOffset: 72, packedBitOffset: 0, type: mojo.internal.Pointer, nullable: false },
        { name: 'viewport_damage_rect', packedOffset: 80, packedBitOffset: 0, type: mojo.internal.Pointer, nullable: false },
        { name: 'debug_state', packedOffset: 88, packedBitOffset: 0, type: mojo.internal.Pointer, nullable: false },
        { name: 'display_transform_hint', packedOffset: 96, packedBitOffset: 0, type: mojo.internal.Pointer, nullable: false },
        { name: 'browser_controls_params', packedOffset: 104, packedBitOffset: 0, type: mojo.internal.Pointer, nullable: false },
        { name: 'browser_controls_offset_tag_modifications', packedOffset: 112, packedBitOffset: 0, type: mojo.internal.Pointer, nullable: false },
        ...
        { name: 'delegated_ink_metadata', packedOffset: 232, packedBitOffset: 0, type: mojo.internal.Pointer, nullable: true },
