// Auto-generated MojoJS binding
 ...
 mojo.internal.bindings.notifications_internals = mojo.internal.bindings.notifications_internals || {};
mojo.internal.bindings.notifications_internals.mojom = mojo.internal.bindings.notifications_internals.mojom || {};

mojo.internal.bindings.notifications_internals.mojom.PageHandler = {};
mojo.internal.bindings.notifications_internals.mojom.PageHandlerSpec = { $ : {} };
mojo.internal.bindings.notifications_internals.mojom.PageHandler.$interfaceName = 'notifications_internals.mojom.PageHandler';
...
mojo.internal.bindings.notifications_internals.mojom.PageHandlerRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.notifications_internals.mojom.PageHandlerPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.notifications_internals.mojom.PageHandlerRemoteCallHandler(this.proxy);
  }
  ...
  scheduleNotification(arg_feature) {
    return this.$.scheduleNotification(arg_feature);
  }
};

mojo.internal.bindings.notifications_internals.mojom.PageHandlerRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('notifications_internals.mojom.PageHandler', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.notifications_internals.mojom.PageHandler.getRemote = function() {
  let remote = new mojo.internal.bindings.notifications_internals.mojom.PageHandlerRemote();
...
mojo.internal.bindings.notifications_internals.mojom.PageHandlerReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('notifications_internals.mojom.PageHandler', [
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.notifications_internals.mojom.PageHandler_ScheduleNotification_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for ScheduleNotification failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.notifications_internals.mojom.PageHandlerReceiver = mojo.internal.bindings.notifications_internals.mojom.PageHandlerReceiver;
