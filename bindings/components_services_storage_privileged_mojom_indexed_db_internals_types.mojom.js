  ...
  $: {
    structSpec: {
      ...
      fields: [
        ...
        { name: 'connection_id', packedOffset: 24, packedBitOffset: 0, type: mojo.internal.Int32, nullable: false },
        { name: 'client_token', packedOffset: 32, packedBitOffset: 0, type: mojo.internal.String, nullable: false },
        { name: 'age', packedOffset: 40, packedBitOffset: 0, type: mojo.internal.Double, nullable: false },
        { name: 'runtime', packedOffset: 48, packedBitOffset: 0, type: mojo.internal.Double, nullable: false },
        { name: 'tasks_scheduled', packedOffset: 56, packedBitOffset: 0, type: mojo.internal.Double, nullable: false },
        { name: 'tasks_completed', packedOffset: 64, packedBitOffset: 0, type: mojo.internal.Double, nullable: false },
        { name: 'scope', packedOffset: 72, packedBitOffset: 0, type: mojo.internal.Array, nullable: false },
        { name: 'state_history', packedOffset: 80, packedBitOffset: 0, type: mojo.internal.Array, nullable: false },
      ],
      versions: [{version: 0}]
    }
  }
