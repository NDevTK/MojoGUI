...
mojo.internal.bindings.blink.mojom.FileSystemAccessDataTransferToken = {};
mojo.internal.bindings.blink.mojom.FileSystemAccessDataTransferTokenSpec = { $ : {} };
mojo.internal.bindings.blink.mojom.FileSystemAccessDataTransferToken.$interfaceName = 'blink.mojom.FileSystemAccessDataTransferToken';
...
mojo.internal.bindings.blink.mojom.FileSystemAccessDataTransferTokenRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.blink.mojom.FileSystemAccessDataTransferTokenRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.blink.mojom.FileSystemAccessDataTransferTokenRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('blink.mojom.FileSystemAccessDataTransferToken', [
      { explicit: null },
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.blink.mojom.FileSystemAccessDataTransferToken.getRemote = function() {
  let remote = new mojo.internal.bindings.blink.mojom.FileSystemAccessDataTransferTokenRemote();
...
mojo.internal.bindings.blink.mojom.FileSystemAccessDataTransferTokenReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('blink.mojom.FileSystemAccessDataTransferToken', [
      { explicit: null },
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.blink.mojom.FileSystemAccessDataTransferToken_GetInternalId_ParamsSpec.$.structSpec);
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.blink.mojom.FileSystemAccessDataTransferToken_Clone_ParamsSpec.$.structSpec);
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.blink.mojom.FileSystemAccessDataTransferToken_GetInternalId_ParamsSpec.$.structSpec);
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.blink.mojom.FileSystemAccessDataTransferToken_GetInternalId_ResponseParamsSpec, header, rawHeader);
               responder(response);
...
mojo.internal.bindings.blink.mojom.FileSystemAccessDataTransferTokenReceiver = mojo.internal.bindings.blink.mojom.FileSystemAccessDataTransferTokenReceiver;
