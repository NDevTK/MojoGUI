...
mojo.internal.bindings.ntp_promo.mojom.NtpPromoHandlerRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.ntp_promo.mojom.NtpPromoHandlerPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.ntp_promo.mojom.NtpPromoHandlerRemoteCallHandler(this.proxy);
  }
  ...
  onPromosShown(arg_eligible_shown, arg_completed_shown) {
    return this.$.onPromosShown(arg_eligible_shown, arg_completed_shown);
  }
...
mojo.internal.bindings.ntp_promo.mojom.NtpPromoHandler.getRemote = function() {
  let remote = new mojo.internal.bindings.ntp_promo.mojom.NtpPromoHandlerRemote();
...
mojo.internal.bindings.ntp_promo.mojom.NtpPromoHandlerReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ntp_promo.mojom.NtpPromoHandler_RequestPromos_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for RequestPromos failed with TypeError');
           }
        }
        // Try Method 1: OnPromosShown
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ntp_promo.mojom.NtpPromoHandler_OnPromosShown_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OnPromosShown failed with TypeError');
           }
        }
        // Try Method 2: OnPromoClicked
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ntp_promo.mojom.NtpPromoHandler_OnPromoClicked_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OnPromoClicked failed with TypeError');
           }
        }
        // Try Method 3: SnoozeSetupList
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ntp_promo.mojom.NtpPromoHandler_SnoozeSetupList_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for SnoozeSetupList failed with TypeError');
           }
        }
        // Try Method 4: UnsnoozeSetupList
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ntp_promo.mojom.NtpPromoHandler_UnsnoozeSetupList_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for UnsnoozeSetupList failed with TypeError');
           }
        }
        // Try Method 5: DisableSetupList
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ntp_promo.mojom.NtpPromoHandler_DisableSetupList_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for DisableSetupList failed with TypeError');
           }
        }
        // Try Method 6: UndisableSetupList
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ntp_promo.mojom.NtpPromoHandler_UndisableSetupList_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for UndisableSetupList failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.ntp_promo.mojom.NtpPromoHandler_RequestPromos_ParamsSpec.$.structSpec);
        ...
        case 3: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.ntp_promo.mojom.NtpPromoHandler_SnoozeSetupList_ParamsSpec.$.structSpec);
        ...
        case 4: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.ntp_promo.mojom.NtpPromoHandler_UnsnoozeSetupList_ParamsSpec.$.structSpec);
        ...
        case 5: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.ntp_promo.mojom.NtpPromoHandler_DisableSetupList_ParamsSpec.$.structSpec);
        ...
        case 6: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.ntp_promo.mojom.NtpPromoHandler_UndisableSetupList_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.ntp_promo.mojom.NtpPromoHandlerReceiver = mojo.internal.bindings.ntp_promo.mojom.NtpPromoHandlerReceiver;

mojo.internal.bindings.ntp_promo.mojom.NtpPromoHandlerPtr = mojo.internal.bindings.ntp_promo.mojom.NtpPromoHandlerRemote;
mojo.internal.bindings.ntp_promo.mojom.NtpPromoHandlerRequest = mojo.internal.bindings.ntp_promo.mojom.NtpPromoHandlerPendingReceiver;
...
mojo.internal.bindings.ntp_promo.mojom.NtpPromoClientRemote = class {
  static get $interfaceName() {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.ntp_promo.mojom.NtpPromoClientPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.ntp_promo.mojom.NtpPromoClientRemoteCallHandler(this.proxy);
  }
  ...
  setPromos(arg_eligible, arg_completed) {
    return this.$.setPromos(arg_eligible, arg_completed);
  }
};
...
mojo.internal.bindings.ntp_promo.mojom.NtpPromoClient.getRemote = function() {
  let remote = new mojo.internal.bindings.ntp_promo.mojom.NtpPromoClientRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
...
mojo.internal.bindings.ntp_promo.mojom.NtpPromoClientReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ntp_promo.mojom.NtpPromoClient_SetPromos_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for SetPromos failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
             console.warn('[GeneratedReceiver] Failed to discover ordinal ' + header.ordinal);
...
mojo.internal.bindings.ntp_promo.mojom.NtpPromoClientReceiver = mojo.internal.bindings.ntp_promo.mojom.NtpPromoClientReceiver;

mojo.internal.bindings.ntp_promo.mojom.NtpPromoClientPtr = mojo.internal.bindings.ntp_promo.mojom.NtpPromoClientRemote;
mojo.internal.bindings.ntp_promo.mojom.NtpPromoClientRequest = mojo.internal.bindings.ntp_promo.mojom.NtpPromoClientPendingReceiver;
...
mojo.internal.bindings.ntp_promo.mojom.NtpPromoHandlerFactoryRemote = class {
  static get $interfaceName() {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.ntp_promo.mojom.NtpPromoHandlerFactoryPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.ntp_promo.mojom.NtpPromoHandlerFactoryRemoteCallHandler(this.proxy);
  }
  ...
  createNtpPromoHandler(arg_client, arg_handler) {
    return this.$.createNtpPromoHandler(arg_client, arg_handler);
  }
};
...
mojo.internal.bindings.ntp_promo.mojom.NtpPromoHandlerFactory.getRemote = function() {
  let remote = new mojo.internal.bindings.ntp_promo.mojom.NtpPromoHandlerFactoryRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
...
mojo.internal.bindings.ntp_promo.mojom.NtpPromoHandlerFactoryReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ntp_promo.mojom.NtpPromoHandlerFactory_CreateNtpPromoHandler_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for CreateNtpPromoHandler failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
             console.warn('[GeneratedReceiver] Failed to discover ordinal ' + header.ordinal);
...
mojo.internal.bindings.ntp_promo.mojom.NtpPromoHandlerFactoryReceiver = mojo.internal.bindings.ntp_promo.mojom.NtpPromoHandlerFactoryReceiver;
