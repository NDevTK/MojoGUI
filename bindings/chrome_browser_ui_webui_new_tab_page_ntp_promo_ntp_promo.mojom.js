...
mojo.internal.bindings.ntp_promo.mojom.NtpPromoHandler_OnPromoShown_ParamsSpec = mojo.internal.bindings.ntp_promo.mojom.NtpPromoHandler_OnPromoShown_ParamsSpec || { $: {} };
...
mojo.internal.bindings.ntp_promo.mojom.NtpPromoClient_SetPromo_ParamsSpec = mojo.internal.bindings.ntp_promo.mojom.NtpPromoClient_SetPromo_ParamsSpec || { $: {} };
if (mojo.internal.bindings.ntp_promo.mojom.NtpPromoClient_SetPromo_ParamsSpec.$.structSpec && mojo.internal.bindings.ntp_promo.mojom.NtpPromoClient_SetPromo_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ntp_promo.mojom.NtpPromoClient_SetPromo_ParamsSpec.$ = {};
...
mojo.internal.bindings.ntp_promo.mojom.NtpPromoHandlerRemote = class {
  ...
  onPromoShown(arg_promo_id) {
    return this.$.onPromoShown(arg_promo_id);
  }
...
mojo.internal.bindings.ntp_promo.mojom.NtpPromoHandlerRemoteCallHandler = class {
  ...
  onPromoShown(arg_promo_id) {
    return this.proxy.sendMessage(
      ...
      mojo.internal.bindings.ntp_promo.mojom.NtpPromoHandler_OnPromoShown_ParamsSpec,
      null,
      [arg_promo_id],
      false);
  }
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        ...
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.ntp_promo.mojom.NtpPromoHandler_OnPromoShown_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.onPromoShown');
          const result = this.impl.onPromoShown(params.arg_promo_id);
          break;
        }
        case 2: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
...
mojo.internal.bindings.ntp_promo.mojom.NtpPromoClientRemoteCallHandler = class {
  ...
  setPromo(arg_promo) {
    return this.proxy.sendMessage(
      this.ordinals[0],  // ordinal
      mojo.internal.bindings.ntp_promo.mojom.NtpPromoClient_SetPromo_ParamsSpec,
      null,
      [arg_promo],
      false);
  }
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.ntp_promo.mojom.NtpPromoClient_SetPromo_ParamsSpec.$.structSpec);
...
mojo.internal.Struct(
    mojo.internal.bindings.ntp_promo.mojom.NtpPromoHandler_OnPromoShown_ParamsSpec, 'ntp_promo.mojom.NtpPromoHandler_OnPromoShown_Params', [
...
mojo.internal.Struct(
    mojo.internal.bindings.ntp_promo.mojom.NtpPromoClient_SetPromo_ParamsSpec, 'ntp_promo.mojom.NtpPromoClient_SetPromo_Params', [
      mojo.internal.StructField('arg_promo', 0, 0, mojo.internal.bindings.ntp_promo.mojom.PromoSpec, null, true, 0, undefined),
    ],
    [[0, 16]]);
