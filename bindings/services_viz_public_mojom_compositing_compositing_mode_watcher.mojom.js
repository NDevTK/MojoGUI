...
mojo.internal.bindings.viz.mojom.CompositingModeWatcherRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.viz.mojom.CompositingModeWatcherPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.viz.mojom.CompositingModeWatcherRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.viz.mojom.CompositingModeWatcher.getRemote = function() {
  let remote = new mojo.internal.bindings.viz.mojom.CompositingModeWatcherRemote();
...
mojo.internal.bindings.viz.mojom.CompositingModeWatcherReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.viz.mojom.CompositingModeWatcher_CompositingModeFallbackToSoftware_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for CompositingModeFallbackToSoftware failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.viz.mojom.CompositingModeWatcher_CompositingModeFallbackToSoftware_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.viz.mojom.CompositingModeWatcherReceiver = mojo.internal.bindings.viz.mojom.CompositingModeWatcherReceiver;

mojo.internal.bindings.viz.mojom.CompositingModeWatcherPtr = mojo.internal.bindings.viz.mojom.CompositingModeWatcherRemote;
mojo.internal.bindings.viz.mojom.CompositingModeWatcherRequest = mojo.internal.bindings.viz.mojom.CompositingModeWatcherPendingReceiver;
...
mojo.internal.bindings.viz.mojom.CompositingModeReporterRemote = class {
  static get $interfaceName() {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.viz.mojom.CompositingModeReporterPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.viz.mojom.CompositingModeReporterRemoteCallHandler(this.proxy);
  }
  ...
  addCompositingModeWatcher(arg_watcher) {
    return this.$.addCompositingModeWatcher(arg_watcher);
  }
};
...
mojo.internal.bindings.viz.mojom.CompositingModeReporter.getRemote = function() {
  let remote = new mojo.internal.bindings.viz.mojom.CompositingModeReporterRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
...
mojo.internal.bindings.viz.mojom.CompositingModeReporterReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.viz.mojom.CompositingModeReporter_AddCompositingModeWatcher_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for AddCompositingModeWatcher failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
             console.warn('[GeneratedReceiver] Failed to discover ordinal ' + header.ordinal);
...
mojo.internal.bindings.viz.mojom.CompositingModeReporterReceiver = mojo.internal.bindings.viz.mojom.CompositingModeReporterReceiver;
