...
mojo.internal.bindings.ui.mojom.IMEStructTraitsTest = {};
mojo.internal.bindings.ui.mojom.IMEStructTraitsTestSpec = { $ : {} };
mojo.internal.bindings.ui.mojom.IMEStructTraitsTest.$interfaceName = 'ui.mojom.IMEStructTraitsTest';
...
mojo.internal.bindings.ui.mojom.IMEStructTraitsTestRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.ui.mojom.IMEStructTraitsTestPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.ui.mojom.IMEStructTraitsTestRemoteCallHandler(this.proxy);
  }
  ...
  echoTextInputType(arg_in) {
    return this.$.echoTextInputType(arg_in);
  }
};

mojo.internal.bindings.ui.mojom.IMEStructTraitsTestRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('ui.mojom.IMEStructTraitsTest', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.ui.mojom.IMEStructTraitsTest.getRemote = function() {
  let remote = new mojo.internal.bindings.ui.mojom.IMEStructTraitsTestRemote();
...
mojo.internal.bindings.ui.mojom.IMEStructTraitsTestReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('ui.mojom.IMEStructTraitsTest', [
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.ui.mojom.IMEStructTraitsTest_EchoTextInputType_ParamsSpec.$.structSpec);
        ...
        case 0: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.ui.mojom.IMEStructTraitsTest_EchoTextInputType_ResponseParamsSpec, header, rawHeader);
               responder(response);
...
mojo.internal.bindings.ui.mojom.IMEStructTraitsTestReceiver = mojo.internal.bindings.ui.mojom.IMEStructTraitsTestReceiver;
