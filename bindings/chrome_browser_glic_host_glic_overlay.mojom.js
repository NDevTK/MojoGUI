// Auto-generated MojoJS binding
 // Source: chromium_src/chrome/browser/glic/host/glic_overlay.mojom
 // Module: glic.mojom
...
mojo.internal.bindings.glic.mojom.ErrorPanelTypeSpec = mojo.internal.bindings.glic.mojom.ErrorPanelTypeSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.glic.mojom.LoadingStyleSpec = mojo.internal.bindings.glic.mojom.LoadingStyleSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.glic.mojom.OverlayStateSpec = mojo.internal.bindings.glic.mojom.OverlayStateSpec || { $: {} };
if (mojo.internal.bindings.glic.mojom.OverlayStateSpec.$.structSpec && mojo.internal.bindings.glic.mojom.OverlayStateSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.glic.mojom.OverlayStateSpec.$ = {};
mojo.internal.bindings.glic.mojom.GlicOverlayPage = mojo.internal.bindings.glic.mojom.GlicOverlayPage || {};
mojo.internal.bindings.glic.mojom.GlicOverlayPageSpec = mojo.internal.bindings.glic.mojom.GlicOverlayPageSpec || { $ : {} };
if (mojo.internal.bindings.glic.mojom.GlicOverlayPageSpec.$.structSpec && mojo.internal.bindings.glic.mojom.GlicOverlayPageSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.glic.mojom.GlicOverlayPageSpec.$ = {};
mojo.internal.bindings.glic.mojom.GlicOverlayPage.$interfaceName = 'glic.mojom.GlicOverlayPage';
mojo.internal.bindings.glic.mojom.GlicOverlayPage_SetOverlayState_ParamsSpec = mojo.internal.bindings.glic.mojom.GlicOverlayPage_SetOverlayState_ParamsSpec || { $: {} };
if (mojo.internal.bindings.glic.mojom.GlicOverlayPage_SetOverlayState_ParamsSpec.$.structSpec && mojo.internal.bindings.glic.mojom.GlicOverlayPage_SetOverlayState_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.glic.mojom.GlicOverlayPage_SetOverlayState_ParamsSpec.$ = {};
mojo.internal.bindings.glic.mojom.GlicOverlayPageHandler = mojo.internal.bindings.glic.mojom.GlicOverlayPageHandler || {};
mojo.internal.bindings.glic.mojom.GlicOverlayPageHandlerSpec = mojo.internal.bindings.glic.mojom.GlicOverlayPageHandlerSpec || { $ : {} };
if (mojo.internal.bindings.glic.mojom.GlicOverlayPageHandlerSpec.$.structSpec && mojo.internal.bindings.glic.mojom.GlicOverlayPageHandlerSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.glic.mojom.GlicOverlayPageHandlerSpec.$ = {};
mojo.internal.bindings.glic.mojom.GlicOverlayPageHandler.$interfaceName = 'glic.mojom.GlicOverlayPageHandler';
mojo.internal.bindings.glic.mojom.GlicOverlayPageHandler_OnRetryClicked_ParamsSpec = mojo.internal.bindings.glic.mojom.GlicOverlayPageHandler_OnRetryClicked_ParamsSpec || { $: {} };
if (mojo.internal.bindings.glic.mojom.GlicOverlayPageHandler_OnRetryClicked_ParamsSpec.$.structSpec && mojo.internal.bindings.glic.mojom.GlicOverlayPageHandler_OnRetryClicked_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.glic.mojom.GlicOverlayPageHandler_OnRetryClicked_ParamsSpec.$ = {};
mojo.internal.bindings.glic.mojom.GlicOverlayPageHandler_OnSignInClicked_ParamsSpec = mojo.internal.bindings.glic.mojom.GlicOverlayPageHandler_OnSignInClicked_ParamsSpec || { $: {} };
if (mojo.internal.bindings.glic.mojom.GlicOverlayPageHandler_OnSignInClicked_ParamsSpec.$.structSpec && mojo.internal.bindings.glic.mojom.GlicOverlayPageHandler_OnSignInClicked_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.glic.mojom.GlicOverlayPageHandler_OnSignInClicked_ParamsSpec.$ = {};
mojo.internal.bindings.glic.mojom.GlicOverlayPageHandler_OnProfilePickerClicked_ParamsSpec = mojo.internal.bindings.glic.mojom.GlicOverlayPageHandler_OnProfilePickerClicked_ParamsSpec || { $: {} };
if (mojo.internal.bindings.glic.mojom.GlicOverlayPageHandler_OnProfilePickerClicked_ParamsSpec.$.structSpec && mojo.internal.bindings.glic.mojom.GlicOverlayPageHandler_OnProfilePickerClicked_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.glic.mojom.GlicOverlayPageHandler_OnProfilePickerClicked_ParamsSpec.$ = {};
mojo.internal.bindings.glic.mojom.GlicOverlayPageHandler_OnIneligibleAccountHelpClicked_ParamsSpec = mojo.internal.bindings.glic.mojom.GlicOverlayPageHandler_OnIneligibleAccountHelpClicked_ParamsSpec || { $: {} };
if (mojo.internal.bindings.glic.mojom.GlicOverlayPageHandler_OnIneligibleAccountHelpClicked_ParamsSpec.$.structSpec && mojo.internal.bindings.glic.mojom.GlicOverlayPageHandler_OnIneligibleAccountHelpClicked_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.glic.mojom.GlicOverlayPageHandler_OnIneligibleAccountHelpClicked_ParamsSpec.$ = {};
mojo.internal.bindings.glic.mojom.GlicOverlayPageHandler_OnLocationMismatchHelpClicked_ParamsSpec = mojo.internal.bindings.glic.mojom.GlicOverlayPageHandler_OnLocationMismatchHelpClicked_ParamsSpec || { $: {} };
if (mojo.internal.bindings.glic.mojom.GlicOverlayPageHandler_OnLocationMismatchHelpClicked_ParamsSpec.$.structSpec && mojo.internal.bindings.glic.mojom.GlicOverlayPageHandler_OnLocationMismatchHelpClicked_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.glic.mojom.GlicOverlayPageHandler_OnLocationMismatchHelpClicked_ParamsSpec.$ = {};
mojo.internal.bindings.glic.mojom.GlicOverlayPageHandler_OnDisabledByAdminCloseClicked_ParamsSpec = mojo.internal.bindings.glic.mojom.GlicOverlayPageHandler_OnDisabledByAdminCloseClicked_ParamsSpec || { $: {} };
if (mojo.internal.bindings.glic.mojom.GlicOverlayPageHandler_OnDisabledByAdminCloseClicked_ParamsSpec.$.structSpec && mojo.internal.bindings.glic.mojom.GlicOverlayPageHandler_OnDisabledByAdminCloseClicked_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.glic.mojom.GlicOverlayPageHandler_OnDisabledByAdminCloseClicked_ParamsSpec.$ = {};
mojo.internal.bindings.glic.mojom.GlicOverlayPageHandler_OnDisabledByAdminLinkClicked_ParamsSpec = mojo.internal.bindings.glic.mojom.GlicOverlayPageHandler_OnDisabledByAdminLinkClicked_ParamsSpec || { $: {} };
...
mojo.internal.bindings.glic.mojom.GlicOverlayPageHandlerFactory.$interfaceName = 'glic.mojom.GlicOverlayPageHandlerFactory';
mojo.internal.bindings.glic.mojom.GlicOverlayPageHandlerFactory_CreatePageHandler_ParamsSpec = mojo.internal.bindings.glic.mojom.GlicOverlayPageHandlerFactory_CreatePageHandler_ParamsSpec || { $: {} };
if (mojo.internal.bindings.glic.mojom.GlicOverlayPageHandlerFactory_CreatePageHandler_ParamsSpec.$.structSpec && mojo.internal.bindings.glic.mojom.GlicOverlayPageHandlerFactory_CreatePageHandler_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.glic.mojom.GlicOverlayPageHandlerFactory_CreatePageHandler_ParamsSpec.$ = {};

// External type stubs (from imports)
mojo.internal.bindings.glic = mojo.internal.bindings.glic || {};
mojo.internal.bindings.glic.mojom = mojo.internal.bindings.glic.mojom || {};
mojo.internal.bindings.glic.mojom.OverlayStateSpec = mojo.internal.bindings.glic.mojom.OverlayStateSpec || { $: mojo.internal.OpaqueStruct.$ };

// Enum: ErrorPanelType
mojo.internal.bindings.glic.mojom.ErrorPanelType = {
  kOffline: 0,
  kError: 1,
  kUnavailable: 2,
...
// Enum: LoadingStyle
mojo.internal.bindings.glic.mojom.LoadingStyle = {
  kFloating: 0,
  kSidePanel: 1,
};

// Interface: GlicOverlayPage
mojo.internal.bindings.glic.mojom.GlicOverlayPagePendingReceiver = class {
  constructor(handle) {
    this.handle = handle;
    if (handle) {
...
mojo.internal.bindings.glic.mojom.GlicOverlayPageRemote = class {
  static get $interfaceName() {
    return 'glic.mojom.GlicOverlayPage';
  }

  constructor(handle = undefined) {
    this.__mojoHandle = handle;
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.glic.mojom.GlicOverlayPagePendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.glic.mojom.GlicOverlayPageRemoteCallHandler(this.proxy);
  }
  ...
  setOverlayState(arg_state) {
    return this.$.setOverlayState(arg_state);
  }
};

mojo.internal.bindings.glic.mojom.GlicOverlayPageRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('glic.mojom.GlicOverlayPage', [
      { explicit: null },
    ]);
  }
  ...
  setOverlayState(arg_state) {
    return this.proxy.sendMessage(
      ...
      mojo.internal.bindings.glic.mojom.GlicOverlayPage_SetOverlayState_ParamsSpec,
      null,
      [arg_state],
      false);
  }
...
mojo.internal.bindings.glic.mojom.GlicOverlayPage.getRemote = function() {
  let remote = new mojo.internal.bindings.glic.mojom.GlicOverlayPageRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
    'glic.mojom.GlicOverlayPage',
    'context');
  return remote.$;
};

mojo.internal.bindings.glic.mojom.GlicOverlayPageReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('glic.mojom.GlicOverlayPage', [
      { explicit: null },
    ]);
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        case 0: {
          ...
          const params = decoder.decodeStructInline(mojo.internal.bindings.glic.mojom.GlicOverlayPage_SetOverlayState_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.setOverlayState');
          const result = this.impl.setOverlayState(params.arg_state);
          break;
        }
      }
      } catch (err) {
...
mojo.internal.bindings.glic.mojom.GlicOverlayPageReceiver = mojo.internal.bindings.glic.mojom.GlicOverlayPageReceiver;

mojo.internal.bindings.glic.mojom.GlicOverlayPagePtr = mojo.internal.bindings.glic.mojom.GlicOverlayPageRemote;
mojo.internal.bindings.glic.mojom.GlicOverlayPageRequest = mojo.internal.bindings.glic.mojom.GlicOverlayPagePendingReceiver;


// Interface: GlicOverlayPageHandler
mojo.internal.bindings.glic.mojom.GlicOverlayPageHandlerPendingReceiver = class {
  constructor(handle) {
    this.handle = handle;
    if (handle) {
      this.__mojoHandle = handle.router_ ? handle.router_.pipe_ : (handle.pipe_ || handle);
...
mojo.internal.bindings.glic.mojom.GlicOverlayPageHandlerRemote = class {
  static get $interfaceName() {
    return 'glic.mojom.GlicOverlayPageHandler';
  }

  constructor(handle = undefined) {
    this.__mojoHandle = handle;
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.glic.mojom.GlicOverlayPageHandlerPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.glic.mojom.GlicOverlayPageHandlerRemoteCallHandler(this.proxy);
  }
  ...
  onProfilePickerClicked() {
    return this.$.onProfilePickerClicked();
  }
  onIneligibleAccountHelpClicked() {
    return this.$.onIneligibleAccountHelpClicked();
  }
  onLocationMismatchHelpClicked() {
    return this.$.onLocationMismatchHelpClicked();
  }
  onDisabledByAdminCloseClicked() {
    return this.$.onDisabledByAdminCloseClicked();
  }
  onDisabledByAdminLinkClicked() {
    return this.$.onDisabledByAdminLinkClicked();
  }
  onClosePanelClicked() {
...
mojo.internal.bindings.glic.mojom.GlicOverlayPageHandlerRemoteCallHandler = class {
  ...
  onRetryClicked() {
    return this.proxy.sendMessage(
      this.ordinals[0],  // ordinal
      mojo.internal.bindings.glic.mojom.GlicOverlayPageHandler_OnRetryClicked_ParamsSpec,
      null,
      [],
      false);
  }
  ...
  onSignInClicked() {
    return this.proxy.sendMessage(
      ...
      mojo.internal.bindings.glic.mojom.GlicOverlayPageHandler_OnSignInClicked_ParamsSpec,
      null,
      [],
      false);
  }
...
mojo.internal.bindings.glic.mojom.GlicOverlayPageHandler.getRemote = function() {
  let remote = new mojo.internal.bindings.glic.mojom.GlicOverlayPageHandlerRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
    'glic.mojom.GlicOverlayPageHandler',
    'context');
  return remote.$;
};

mojo.internal.bindings.glic.mojom.GlicOverlayPageHandlerReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.glic.mojom.GlicOverlayPageHandler_OnRetryClicked_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.onRetryClicked');
          const result = this.impl.onRetryClicked();
          break;
        }
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.glic.mojom.GlicOverlayPageHandler_OnSignInClicked_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.onSignInClicked');
          const result = this.impl.onSignInClicked();
          break;
        }
        case 2: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.glic.mojom.GlicOverlayPageHandler_OnProfilePickerClicked_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.onProfilePickerClicked');
          const result = this.impl.onProfilePickerClicked();
          break;
        }
        case 3: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.glic.mojom.GlicOverlayPageHandler_OnIneligibleAccountHelpClicked_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.onIneligibleAccountHelpClicked');
          const result = this.impl.onIneligibleAccountHelpClicked();
          break;
        }
        case 4: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.glic.mojom.GlicOverlayPageHandler_OnLocationMismatchHelpClicked_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.onLocationMismatchHelpClicked');
          const result = this.impl.onLocationMismatchHelpClicked();
          break;
        }
        case 5: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.glic.mojom.GlicOverlayPageHandler_OnDisabledByAdminCloseClicked_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.onDisabledByAdminCloseClicked');
          const result = this.impl.onDisabledByAdminCloseClicked();
          break;
        }
        case 6: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.glic.mojom.GlicOverlayPageHandler_OnDisabledByAdminLinkClicked_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.onDisabledByAdminLinkClicked');
          const result = this.impl.onDisabledByAdminLinkClicked();
          break;
        }
        case 7: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
...
mojo.internal.bindings.glic.mojom.GlicOverlayPageHandlerReceiver = mojo.internal.bindings.glic.mojom.GlicOverlayPageHandlerReceiver;

mojo.internal.bindings.glic.mojom.GlicOverlayPageHandlerPtr = mojo.internal.bindings.glic.mojom.GlicOverlayPageHandlerRemote;
mojo.internal.bindings.glic.mojom.GlicOverlayPageHandlerRequest = mojo.internal.bindings.glic.mojom.GlicOverlayPageHandlerPendingReceiver;


// Interface: GlicOverlayPageHandlerFactory
mojo.internal.bindings.glic.mojom.GlicOverlayPageHandlerFactoryPendingReceiver = class {
  constructor(handle) {
    this.handle = handle;
    if (handle) {
      this.__mojoHandle = handle.router_ ? handle.router_.pipe_ : (handle.pipe_ || handle);
...
mojo.internal.bindings.glic.mojom.GlicOverlayPageHandlerFactoryRemote = class {
  static get $interfaceName() {
    return 'glic.mojom.GlicOverlayPageHandlerFactory';
  }

  constructor(handle = undefined) {
    this.__mojoHandle = handle;
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.glic.mojom.GlicOverlayPageHandlerFactoryPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.glic.mojom.GlicOverlayPageHandlerFactoryRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.glic.mojom.GlicOverlayPageHandlerFactoryRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('glic.mojom.GlicOverlayPageHandlerFactory', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.glic.mojom.GlicOverlayPageHandlerFactory.getRemote = function() {
  let remote = new mojo.internal.bindings.glic.mojom.GlicOverlayPageHandlerFactoryRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
    'glic.mojom.GlicOverlayPageHandlerFactory',
    'context');
  return remote.$;
};

mojo.internal.bindings.glic.mojom.GlicOverlayPageHandlerFactoryReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('glic.mojom.GlicOverlayPageHandlerFactory', [
      { explicit: null },
    ]);
    ordinals.forEach((ord, idx) => {
      this.ordinalMap.set(ord, idx); // Scrambled/Explicit
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.glic.mojom.GlicOverlayPageHandlerFactory_CreatePageHandler_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.glic.mojom.GlicOverlayPageHandlerFactoryReceiver = mojo.internal.bindings.glic.mojom.GlicOverlayPageHandlerFactoryReceiver;

mojo.internal.bindings.glic.mojom.GlicOverlayPageHandlerFactoryPtr = mojo.internal.bindings.glic.mojom.GlicOverlayPageHandlerFactoryRemote;
mojo.internal.bindings.glic.mojom.GlicOverlayPageHandlerFactoryRequest = mojo.internal.bindings.glic.mojom.GlicOverlayPageHandlerFactoryPendingReceiver;
...
// Union: OverlayState
mojo.internal.Union(
    mojo.internal.bindings.glic.mojom.OverlayStateSpec, 'glic.mojom.OverlayState', {
      'arg_loading': {
        'ordinal': 0,
        'type': mojo.internal.bindings.glic.mojom.LoadingStyleSpec,
        'nullable': false,
      },
      'arg_error': {
        'ordinal': 1,
        'type': mojo.internal.bindings.glic.mojom.ErrorPanelTypeSpec,
        'nullable': false,
      },
    });
mojo.internal.Struct(
    mojo.internal.bindings.glic.mojom.GlicOverlayPage_SetOverlayState_ParamsSpec, 'glic.mojom.GlicOverlayPage_SetOverlayState_Params', [
      mojo.internal.StructField('arg_state', 0, 0, mojo.internal.bindings.glic.mojom.OverlayStateSpec, null, false, 0, undefined),
    ],
    [[0, 24]]);

mojo.internal.Struct(
    mojo.internal.bindings.glic.mojom.GlicOverlayPageHandler_OnRetryClicked_ParamsSpec, 'glic.mojom.GlicOverlayPageHandler_OnRetryClicked_Params', [
    ],
    [[0, 8]]);

mojo.internal.Struct(
    mojo.internal.bindings.glic.mojom.GlicOverlayPageHandler_OnSignInClicked_ParamsSpec, 'glic.mojom.GlicOverlayPageHandler_OnSignInClicked_Params', [
    ],
    [[0, 8]]);

mojo.internal.Struct(
    mojo.internal.bindings.glic.mojom.GlicOverlayPageHandler_OnProfilePickerClicked_ParamsSpec, 'glic.mojom.GlicOverlayPageHandler_OnProfilePickerClicked_Params', [
    ],
    [[0, 8]]);

mojo.internal.Struct(
    mojo.internal.bindings.glic.mojom.GlicOverlayPageHandler_OnIneligibleAccountHelpClicked_ParamsSpec, 'glic.mojom.GlicOverlayPageHandler_OnIneligibleAccountHelpClicked_Params', [
    ],
    [[0, 8]]);

mojo.internal.Struct(
    mojo.internal.bindings.glic.mojom.GlicOverlayPageHandler_OnLocationMismatchHelpClicked_ParamsSpec, 'glic.mojom.GlicOverlayPageHandler_OnLocationMismatchHelpClicked_Params', [
    ],
    [[0, 8]]);

mojo.internal.Struct(
    mojo.internal.bindings.glic.mojom.GlicOverlayPageHandler_OnDisabledByAdminCloseClicked_ParamsSpec, 'glic.mojom.GlicOverlayPageHandler_OnDisabledByAdminCloseClicked_Params', [
    ],
    [[0, 8]]);

mojo.internal.Struct(
    mojo.internal.bindings.glic.mojom.GlicOverlayPageHandler_OnDisabledByAdminLinkClicked_ParamsSpec, 'glic.mojom.GlicOverlayPageHandler_OnDisabledByAdminLinkClicked_Params', [
    ],
    [[0, 8]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.glic.mojom.GlicOverlayPageHandlerFactory_CreatePageHandler_ParamsSpec, 'glic.mojom.GlicOverlayPageHandlerFactory_CreatePageHandler_Params', [
      mojo.internal.StructField('arg_page', 0, 0, mojo.internal.InterfaceProxy(mojo.internal.bindings.glic.mojom.GlicOverlayPageRemote), null, false, 0, undefined),
      mojo.internal.StructField('arg_handler', 8, 0, mojo.internal.InterfaceRequest(mojo.internal.bindings.glic.mojom.GlicOverlayPageHandlerPendingReceiver), null, false, 0, undefined),
    ],
    [[0, 24]]);
