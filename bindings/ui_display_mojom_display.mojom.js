  ...
  $: {
    structSpec: {
      ...
      fields: [
        ...
        { name: 'rotation', packedOffset: 40, packedBitOffset: 0, type: display.mojom.RotationSpec, nullable: false },
        { name: 'touch_support', packedOffset: 48, packedBitOffset: 0, type: display.mojom.TouchSupportSpec, nullable: false },
        { name: 'accelerometer_support', packedOffset: 56, packedBitOffset: 0, type: display.mojom.AccelerometerSupportSpec, nullable: false },
        { name: 'maximum_cursor_size', packedOffset: 64, packedBitOffset: 0, type: gfx.mojom.SizeSpec, nullable: false },
        { name: 'color_spaces', packedOffset: 72, packedBitOffset: 0, type: gfx.mojom.DisplayColorSpacesSpec, nullable: false },
