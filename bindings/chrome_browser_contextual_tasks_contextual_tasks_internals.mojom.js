...
mojo.internal.bindings.contextual_tasks_internals.mojom.EligibilityStateSpec = mojo.internal.bindings.contextual_tasks_internals.mojom.EligibilityStateSpec || { $: {} };
if (mojo.internal.bindings.contextual_tasks_internals.mojom.EligibilityStateSpec.$.structSpec && mojo.internal.bindings.contextual_tasks_internals.mojom.EligibilityStateSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.contextual_tasks_internals.mojom.EligibilityStateSpec.$ = {};
...
mojo.internal.bindings.contextual_tasks_internals.mojom.ContextualTasksInternalsPageHandler_GetEligibilityState_ParamsSpec = mojo.internal.bindings.contextual_tasks_internals.mojom.ContextualTasksInternalsPageHandler_GetEligibilityState_ParamsSpec || { $: {} };
if (mojo.internal.bindings.contextual_tasks_internals.mojom.ContextualTasksInternalsPageHandler_GetEligibilityState_ParamsSpec.$.structSpec && mojo.internal.bindings.contextual_tasks_internals.mojom.ContextualTasksInternalsPageHandler_GetEligibilityState_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.contextual_tasks_internals.mojom.ContextualTasksInternalsPageHandler_GetEligibilityState_ParamsSpec.$ = {};
mojo.internal.bindings.contextual_tasks_internals.mojom.ContextualTasksInternalsPageHandler_GetEligibilityState_ResponseParamsSpec = mojo.internal.bindings.contextual_tasks_internals.mojom.ContextualTasksInternalsPageHandler_GetEligibilityState_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.contextual_tasks_internals.mojom.ContextualTasksInternalsPageHandler_GetEligibilityState_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.contextual_tasks_internals.mojom.ContextualTasksInternalsPageHandler_GetEligibilityState_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.contextual_tasks_internals.mojom.ContextualTasksInternalsPageHandler_GetEligibilityState_ResponseParamsSpec.$ = {};
...
mojo.internal.bindings.contextual_tasks.mojom.TabSelectionModeSpec = mojo.internal.bindings.contextual_tasks.mojom.TabSelectionModeSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.mojo_base = mojo.internal.bindings.mojo_base || {};
mojo.internal.bindings.mojo_base.mojom = mojo.internal.bindings.mojo_base.mojom || {};
...
mojo.internal.bindings.contextual_tasks_internals.mojom.ContextualTasksInternalsPageHandlerFactoryRemote = class {
  ...
  constructor(handle = undefined) {
    ...
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.contextual_tasks_internals.mojom.ContextualTasksInternalsPageHandlerFactoryPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.contextual_tasks_internals.mojom.ContextualTasksInternalsPageHandlerFactoryRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.contextual_tasks_internals.mojom.ContextualTasksInternalsPageHandlerFactory.getRemote = function() {
  let remote = new mojo.internal.bindings.contextual_tasks_internals.mojom.ContextualTasksInternalsPageHandlerFactoryRemote();
...
mojo.internal.bindings.contextual_tasks_internals.mojom.ContextualTasksInternalsPageHandlerFactoryReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
...
mojo.internal.bindings.contextual_tasks_internals.mojom.ContextualTasksInternalsPageHandlerFactoryReceiver = mojo.internal.bindings.contextual_tasks_internals.mojom.ContextualTasksInternalsPageHandlerFactoryReceiver;

mojo.internal.bindings.contextual_tasks_internals.mojom.ContextualTasksInternalsPageHandlerFactoryPtr = mojo.internal.bindings.contextual_tasks_internals.mojom.ContextualTasksInternalsPageHandlerFactoryRemote;
mojo.internal.bindings.contextual_tasks_internals.mojom.ContextualTasksInternalsPageHandlerFactoryRequest = mojo.internal.bindings.contextual_tasks_internals.mojom.ContextualTasksInternalsPageHandlerFactoryPendingReceiver;
...
mojo.internal.bindings.contextual_tasks_internals.mojom.ContextualTasksInternalsPageHandlerRemote = class {
  static get $interfaceName() {
  ...
  constructor(handle = undefined) {
    this.__mojoHandle = handle;
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.contextual_tasks_internals.mojom.ContextualTasksInternalsPageHandlerPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.contextual_tasks_internals.mojom.ContextualTasksInternalsPageHandlerRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.contextual_tasks_internals.mojom.ContextualTasksInternalsPageHandlerRemoteCallHandler = class {
  ...
  getEligibilityState() {
    return this.proxy.sendMessage(
      ...
      mojo.internal.bindings.contextual_tasks_internals.mojom.ContextualTasksInternalsPageHandler_GetEligibilityState_ParamsSpec,
      mojo.internal.bindings.contextual_tasks_internals.mojom.ContextualTasksInternalsPageHandler_GetEligibilityState_ResponseParamsSpec,
      [],
      false);
  }
...
mojo.internal.bindings.contextual_tasks_internals.mojom.ContextualTasksInternalsPageHandler.getRemote = function() {
  let remote = new mojo.internal.bindings.contextual_tasks_internals.mojom.ContextualTasksInternalsPageHandlerRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
...
mojo.internal.bindings.contextual_tasks_internals.mojom.ContextualTasksInternalsPageHandlerReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        ...
        case 3: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.contextual_tasks_internals.mojom.ContextualTasksInternalsPageHandler_GetEligibilityState_ParamsSpec.$.structSpec);
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.contextual_tasks_internals.mojom.ContextualTasksInternalsPageHandler_GetEligibilityState_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
...
mojo.internal.bindings.contextual_tasks_internals.mojom.ContextualTasksInternalsPageHandlerReceiver = mojo.internal.bindings.contextual_tasks_internals.mojom.ContextualTasksInternalsPageHandlerReceiver;

mojo.internal.bindings.contextual_tasks_internals.mojom.ContextualTasksInternalsPageHandlerPtr = mojo.internal.bindings.contextual_tasks_internals.mojom.ContextualTasksInternalsPageHandlerRemote;
mojo.internal.bindings.contextual_tasks_internals.mojom.ContextualTasksInternalsPageHandlerRequest = mojo.internal.bindings.contextual_tasks_internals.mojom.ContextualTasksInternalsPageHandlerPendingReceiver;
...
mojo.internal.bindings.contextual_tasks_internals.mojom.ContextualTasksInternalsPageRemote = class {
  static get $interfaceName() {
  ...
  constructor(handle = undefined) {
    this.__mojoHandle = handle;
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.contextual_tasks_internals.mojom.ContextualTasksInternalsPagePendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.contextual_tasks_internals.mojom.ContextualTasksInternalsPageRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.contextual_tasks_internals.mojom.ContextualTasksInternalsPage.getRemote = function() {
  let remote = new mojo.internal.bindings.contextual_tasks_internals.mojom.ContextualTasksInternalsPageRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
...
mojo.internal.bindings.contextual_tasks_internals.mojom.ContextualTasksInternalsPageReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
...
mojo.internal.bindings.contextual_tasks_internals.mojom.ContextualTasksInternalsPageReceiver = mojo.internal.bindings.contextual_tasks_internals.mojom.ContextualTasksInternalsPageReceiver;
...
mojo.internal.Struct(
    mojo.internal.bindings.contextual_tasks_internals.mojom.EligibilityStateSpec, 'contextual_tasks_internals.mojom.EligibilityState', [
      mojo.internal.StructField('arg_is_eligible', 0, 0, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_is_contextual_tasks_enabled', 0, 1, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_is_signed_in', 0, 2, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_primary_account_in_cookie_jar', 0, 3, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_is_aim_allowed_by_policy', 0, 4, mojo.internal.Bool, false, false, 0, undefined),
...
mojo.internal.Struct(
    mojo.internal.bindings.contextual_tasks_internals.mojom.ContextualTasksInternalsPageHandlerFactory_CreatePageHandler_ParamsSpec, 'contextual_tasks_internals.mojom.ContextualTasksInternalsPageHandlerFactory_CreatePageHandler_Params', [
      ...
      mojo.internal.StructField('arg_handler', 8, 0, mojo.internal.InterfaceRequest(mojo.internal.bindings.contextual_tasks_internals.mojom.ContextualTasksInternalsPageHandlerPendingReceiver), null, false, 0, undefined),
    ],
    [[0, 24]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.contextual_tasks_internals.mojom.ContextualTasksInternalsPageHandler_GetEligibilityState_ParamsSpec, 'contextual_tasks_internals.mojom.ContextualTasksInternalsPageHandler_GetEligibilityState_Params', [
    ],
    [[0, 8]]);

mojo.internal.Struct(
    mojo.internal.bindings.contextual_tasks_internals.mojom.ContextualTasksInternalsPageHandler_GetEligibilityState_ResponseParamsSpec, 'contextual_tasks_internals.mojom.ContextualTasksInternalsPageHandler_GetEligibilityState_ResponseParams', [
      mojo.internal.StructField('arg_state', 0, 0, mojo.internal.bindings.contextual_tasks_internals.mojom.EligibilityStateSpec, null, false, 0, undefined),
    ],
    [[0, 16]]);
