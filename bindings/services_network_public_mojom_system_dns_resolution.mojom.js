...
mojo.internal.bindings.network.mojom.SystemDnsResolverRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.network.mojom.SystemDnsResolverRemoteCallHandler(this.proxy);
  }
  ...
  resolve(arg_hostname, arg_addr_family, arg_flags, arg_network) {
    return this.$.resolve(arg_hostname, arg_addr_family, arg_flags, arg_network);
  }
};

mojo.internal.bindings.network.mojom.SystemDnsResolverRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('network.mojom.SystemDnsResolver', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.network.mojom.SystemDnsResolver.getRemote = function() {
  let remote = new mojo.internal.bindings.network.mojom.SystemDnsResolverRemote();
...
mojo.internal.bindings.network.mojom.SystemDnsResolverReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('network.mojom.SystemDnsResolver', [
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.network.mojom.SystemDnsResolver_Resolve_ParamsSpec.$.structSpec);
        ...
        case 0: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.network.mojom.SystemDnsResolver_Resolve_ResponseParamsSpec, header, rawHeader);
               responder(response);
...
mojo.internal.bindings.network.mojom.SystemDnsResolverReceiver = mojo.internal.bindings.network.mojom.SystemDnsResolverReceiver;
