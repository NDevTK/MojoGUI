...
mojo.internal.bindings.blink.mojom.SharedFileSpec = { $: {} };
mojo.internal.bindings.blink.mojom.ShareService = {};
mojo.internal.bindings.blink.mojom.ShareServiceSpec = { $ : {} };
mojo.internal.bindings.blink.mojom.ShareService.$interfaceName = 'blink.mojom.ShareService';
...
mojo.internal.bindings.blink.mojom.ShareServiceRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.blink.mojom.ShareServicePendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.blink.mojom.ShareServiceRemoteCallHandler(this.proxy);
  }
  ...
  share(arg_title, arg_text, arg_url, arg_files) {
    return this.$.share(arg_title, arg_text, arg_url, arg_files);
  }
};

mojo.internal.bindings.blink.mojom.ShareServiceRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('blink.mojom.ShareService', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.blink.mojom.ShareService.getRemote = function() {
  let remote = new mojo.internal.bindings.blink.mojom.ShareServiceRemote();
...
mojo.internal.bindings.blink.mojom.ShareServiceReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('blink.mojom.ShareService', [
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.blink.mojom.ShareService_Share_ParamsSpec.$.structSpec);
        ...
        case 0: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.blink.mojom.ShareService_Share_ResponseParamsSpec, header, rawHeader);
               responder(response);
...
mojo.internal.bindings.blink.mojom.ShareServiceReceiver = mojo.internal.bindings.blink.mojom.ShareServiceReceiver;
