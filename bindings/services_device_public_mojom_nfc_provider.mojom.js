...
mojo.internal.Struct(
    mojo.internal.bindings.device.mojom.NFCProvider_GetNFCForHost_ParamsSpec, 'device.mojom.NFCProvider_GetNFCForHost_Params', [
      mojo.internal.StructField('arg_receiver', 0, 0, mojo.internal.InterfaceRequest(mojo.internal.bindings.device.mojom.NFCRemote), null, false, 0, undefined),
      mojo.internal.StructField('arg_host_id', 8, 0, mojo.internal.Int32, 0, false, 0, undefined),
    ],
    [[0, 24]]);
...
mojo.internal.bindings.device.mojom.NFCProviderRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.device.mojom.NFCProviderPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.device.mojom.NFCProviderRemoteCallHandler(this.proxy);
  }
  ...
  getNFCForHost(arg_host_id, arg_receiver) {
    return this.$.getNFCForHost(arg_host_id, arg_receiver);
  }
...
mojo.internal.bindings.device.mojom.NFCProviderRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('device.mojom.NFCProvider', [
      { explicit: null },
      { explicit: null },
      { explicit: null },
    ]);
...
mojo.internal.bindings.device.mojom.NFCProvider.getRemote = function() {
  let remote = new mojo.internal.bindings.device.mojom.NFCProviderRemote();
...
mojo.internal.bindings.device.mojom.NFCProviderReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('device.mojom.NFCProvider', [
      { explicit: null },
      { explicit: null },
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.device.mojom.NFCProvider_GetNFCForHost_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for GetNFCForHost failed with TypeError');
           }
        }
        // Try Method 1: SuspendNFCOperations
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.device.mojom.NFCProvider_SuspendNFCOperations_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for SuspendNFCOperations failed with TypeError');
           }
        }
        // Try Method 2: ResumeNFCOperations
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.device.mojom.NFCProvider_ResumeNFCOperations_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for ResumeNFCOperations failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
      ...
      switch (dispatchId) {
        ...
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.device.mojom.NFCProvider_SuspendNFCOperations_ParamsSpec.$.structSpec);
        ...
        case 2: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.device.mojom.NFCProvider_ResumeNFCOperations_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.device.mojom.NFCProviderReceiver = mojo.internal.bindings.device.mojom.NFCProviderReceiver;
