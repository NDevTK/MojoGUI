...
mojo.internal.bindings.device.mojom.ScreenOrientationRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.device.mojom.ScreenOrientationPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.device.mojom.ScreenOrientationRemoteCallHandler(this.proxy);
  }
  ...
  lockOrientation(arg_orientation) {
    return this.$.lockOrientation(arg_orientation);
  }
  unlockOrientation() {
...
mojo.internal.bindings.device.mojom.ScreenOrientation.getRemote = function() {
  let remote = new mojo.internal.bindings.device.mojom.ScreenOrientationRemote();
...
mojo.internal.bindings.device.mojom.ScreenOrientationReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.device.mojom.ScreenOrientation_LockOrientation_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for LockOrientation failed with TypeError');
           }
        }
        // Try Method 1: UnlockOrientation
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.device.mojom.ScreenOrientation_UnlockOrientation_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for UnlockOrientation failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
      ...
      switch (dispatchId) {
        ...
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.device.mojom.ScreenOrientation_UnlockOrientation_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.device.mojom.ScreenOrientationReceiver = mojo.internal.bindings.device.mojom.ScreenOrientationReceiver;

mojo.internal.bindings.device.mojom.ScreenOrientationPtr = mojo.internal.bindings.device.mojom.ScreenOrientationRemote;
mojo.internal.bindings.device.mojom.ScreenOrientationRequest = mojo.internal.bindings.device.mojom.ScreenOrientationPendingReceiver;
...
mojo.internal.bindings.device.mojom.ScreenOrientationListenerRemote = class {
  static get $interfaceName() {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.device.mojom.ScreenOrientationListenerRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.device.mojom.ScreenOrientationListener.getRemote = function() {
  let remote = new mojo.internal.bindings.device.mojom.ScreenOrientationListenerRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
...
mojo.internal.bindings.device.mojom.ScreenOrientationListenerReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.device.mojom.ScreenOrientationListener_IsAutoRotateEnabledByUser_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for IsAutoRotateEnabledByUser failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
             console.warn('[GeneratedReceiver] Failed to discover ordinal ' + header.ordinal);
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.device.mojom.ScreenOrientationListener_IsAutoRotateEnabledByUser_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.device.mojom.ScreenOrientationListenerReceiver = mojo.internal.bindings.device.mojom.ScreenOrientationListenerReceiver;
