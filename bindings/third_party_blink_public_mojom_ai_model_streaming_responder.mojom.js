...
mojo.internal.Struct(
    mojo.internal.bindings.blink.mojom.ModelStreamingResponder_OnError_ParamsSpec, 'blink.mojom.ModelStreamingResponder_OnError_Params', [
      ...
      mojo.internal.StructField('arg_status', 8, 0, mojo.internal.bindings.blink.mojom.ModelStreamingResponseStatusSpec, null, false, 0, undefined),
    ],
    [[0, 24]]);
...
mojo.internal.bindings.blink.mojom.ModelStreamingResponderRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.blink.mojom.ModelStreamingResponderPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.blink.mojom.ModelStreamingResponderRemoteCallHandler(this.proxy);
  }
  ...
  onCompletion(arg_context_info) {
    return this.$.onCompletion(arg_context_info);
  }
  onError(arg_status, arg_quota_error_info) {
    return this.$.onError(arg_status, arg_quota_error_info);
  }
  onStreaming(arg_text) {
    return this.$.onStreaming(arg_text);
  }
  onQuotaOverflow() {
...
mojo.internal.bindings.blink.mojom.ModelStreamingResponder.getRemote = function() {
  let remote = new mojo.internal.bindings.blink.mojom.ModelStreamingResponderRemote();
...
mojo.internal.bindings.blink.mojom.ModelStreamingResponderReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.blink.mojom.ModelStreamingResponder_OnCompletion_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OnCompletion failed with TypeError');
           }
        }
        // Try Method 1: OnError
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.blink.mojom.ModelStreamingResponder_OnError_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.blink.mojom.ModelStreamingResponder_OnStreaming_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OnStreaming failed with TypeError');
           }
        }
        // Try Method 3: OnQuotaOverflow
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.blink.mojom.ModelStreamingResponder_OnQuotaOverflow_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OnQuotaOverflow failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
      ...
      switch (dispatchId) {
        ...
        case 3: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.blink.mojom.ModelStreamingResponder_OnQuotaOverflow_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.blink.mojom.ModelStreamingResponderReceiver = mojo.internal.bindings.blink.mojom.ModelStreamingResponderReceiver;
