...
mojo.internal.bindings.blink.mojom.DocumentMetadataRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.blink.mojom.DocumentMetadataPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.blink.mojom.DocumentMetadataRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.blink.mojom.DocumentMetadataRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('blink.mojom.DocumentMetadata', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.blink.mojom.DocumentMetadata.getRemote = function() {
  let remote = new mojo.internal.bindings.blink.mojom.DocumentMetadataRemote();
...
mojo.internal.bindings.blink.mojom.DocumentMetadataReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('blink.mojom.DocumentMetadata', [
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.blink.mojom.DocumentMetadata_GetEntities_ParamsSpec.$.structSpec);
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.blink.mojom.DocumentMetadata_GetEntities_ParamsSpec.$.structSpec);
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.blink.mojom.DocumentMetadata_GetEntities_ResponseParamsSpec, header, rawHeader);
               responder(response);
...
mojo.internal.bindings.blink.mojom.DocumentMetadataReceiver = mojo.internal.bindings.blink.mojom.DocumentMetadataReceiver;
