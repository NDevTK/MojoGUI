...
mojo.internal.bindings.blink.mojom.AIProofreaderCreateOptionsSpec = { $: {} };
mojo.internal.bindings.blink.mojom.AIProofreader = {};
mojo.internal.bindings.blink.mojom.AIProofreaderSpec = { $ : {} };
mojo.internal.bindings.blink.mojom.AIProofreader.$interfaceName = 'blink.mojom.AIProofreader';
...
mojo.internal.bindings.blink.mojom.AIProofreaderRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.blink.mojom.AIProofreaderPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.blink.mojom.AIProofreaderRemoteCallHandler(this.proxy);
  }
  ...
  proofread(arg_input, arg_pending_responder) {
    return this.$.proofread(arg_input, arg_pending_responder);
  }
  getCorrectionType(arg_input, arg_corrected_input, arg_correction_instruction, arg_pending_responder) {
    return this.$.getCorrectionType(arg_input, arg_corrected_input, arg_correction_instruction, arg_pending_responder);
  }
};

mojo.internal.bindings.blink.mojom.AIProofreaderRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('blink.mojom.AIProofreader', [
      { explicit: null },
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.blink.mojom.AIProofreader.getRemote = function() {
  let remote = new mojo.internal.bindings.blink.mojom.AIProofreaderRemote();
...
mojo.internal.bindings.blink.mojom.AIProofreaderReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('blink.mojom.AIProofreader', [
      { explicit: null },
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.blink.mojom.AIProofreader_Proofread_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for Proofread failed with TypeError');
           }
        }
        // Try Method 1: GetCorrectionType
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.blink.mojom.AIProofreader_GetCorrectionType_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for GetCorrectionType failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.blink.mojom.AIProofreaderReceiver = mojo.internal.bindings.blink.mojom.AIProofreaderReceiver;
