...
mojo.internal.bindings.audio.mojom.LogFactoryManagerRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.audio.mojom.LogFactoryManagerPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.audio.mojom.LogFactoryManagerRemoteCallHandler(this.proxy);
  }
  ...
  setLogFactory(arg_factory) {
    return this.$.setLogFactory(arg_factory);
  }
};

mojo.internal.bindings.audio.mojom.LogFactoryManagerRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('audio.mojom.LogFactoryManager', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.audio.mojom.LogFactoryManager.getRemote = function() {
  let remote = new mojo.internal.bindings.audio.mojom.LogFactoryManagerRemote();
...
mojo.internal.bindings.audio.mojom.LogFactoryManagerReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('audio.mojom.LogFactoryManager', [
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.audio.mojom.LogFactoryManager_SetLogFactory_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for SetLogFactory failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.audio.mojom.LogFactoryManagerReceiver = mojo.internal.bindings.audio.mojom.LogFactoryManagerReceiver;
