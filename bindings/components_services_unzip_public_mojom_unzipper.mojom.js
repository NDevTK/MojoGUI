...
mojo.internal.Struct(
    mojo.internal.bindings.unzip.mojom.InfoSpec, 'unzip.mojom.Info', [
      ...
      mojo.internal.StructField('arg_size_is_valid', 8, 0, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_is_encrypted', 8, 1, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_uses_aes_encryption', 8, 2, mojo.internal.Bool, false, false, 0, undefined),
    ],
    [[0, 24]]);
...
mojo.internal.bindings.unzip.mojom.UnzipFilterRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.unzip.mojom.UnzipFilterRemoteCallHandler(this.proxy);
  }
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.unzip.mojom.UnzipFilter_ShouldUnzipFile_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for ShouldUnzipFile failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.unzip.mojom.UnzipFilterReceiver = mojo.internal.bindings.unzip.mojom.UnzipFilterReceiver;

mojo.internal.bindings.unzip.mojom.UnzipFilterPtr = mojo.internal.bindings.unzip.mojom.UnzipFilterRemote;
mojo.internal.bindings.unzip.mojom.UnzipFilterRequest = mojo.internal.bindings.unzip.mojom.UnzipFilterPendingReceiver;
...
mojo.internal.bindings.unzip.mojom.UnzipListenerRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.unzip.mojom.UnzipListenerRemoteCallHandler(this.proxy);
  }
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.unzip.mojom.UnzipListener_OnProgress_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
...
mojo.internal.bindings.unzip.mojom.UnzipListenerReceiver = mojo.internal.bindings.unzip.mojom.UnzipListenerReceiver;

mojo.internal.bindings.unzip.mojom.UnzipListenerPtr = mojo.internal.bindings.unzip.mojom.UnzipListenerRemote;
mojo.internal.bindings.unzip.mojom.UnzipListenerRequest = mojo.internal.bindings.unzip.mojom.UnzipListenerPendingReceiver;
...
mojo.internal.bindings.unzip.mojom.UnzipperRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.unzip.mojom.UnzipperRemoteCallHandler(this.proxy);
  }
  ...
  unzip(arg_zip_file, arg_output_dir, arg_options, arg_filter, arg_listener) {
    return this.$.unzip(arg_zip_file, arg_output_dir, arg_options, arg_filter, arg_listener);
  }
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.unzip.mojom.Unzipper_Unzip_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for Unzip failed with TypeError');
           }
        }
        // Try Method 1: DetectEncoding
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.unzip.mojom.Unzipper_DetectEncoding_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for DetectEncoding failed with TypeError');
           }
        }
        // Try Method 2: GetExtractedInfo
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.unzip.mojom.Unzipper_GetExtractedInfo_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for GetExtractedInfo failed with TypeError');
           }
        }
        // Try Method 3: DecodeXz
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.unzip.mojom.Unzipper_DecodeXz_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for DecodeXz failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
             console.warn('[GeneratedReceiver] Failed to discover ordinal ' + header.ordinal);
...
mojo.internal.bindings.unzip.mojom.UnzipperReceiver = mojo.internal.bindings.unzip.mojom.UnzipperReceiver;
