...
mojo.internal.bindings.blink.mojom.KeepAliveHandleFactory = {};
mojo.internal.bindings.blink.mojom.KeepAliveHandleFactorySpec = { $ : {} };
...
mojo.internal.bindings.blink.mojom.KeepAliveHandleFactoryRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.blink.mojom.KeepAliveHandleFactoryRemoteCallHandler(this.proxy);
  }
  ...
  issueKeepAliveHandle(arg_keep_alive_handle) {
    return this.$.issueKeepAliveHandle(arg_keep_alive_handle);
  }
};

mojo.internal.bindings.blink.mojom.KeepAliveHandleFactoryRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('blink.mojom.KeepAliveHandleFactory', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.blink.mojom.KeepAliveHandleFactory.getRemote = function() {
  let remote = new mojo.internal.bindings.blink.mojom.KeepAliveHandleFactoryRemote();
...
mojo.internal.bindings.blink.mojom.KeepAliveHandleFactoryReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('blink.mojom.KeepAliveHandleFactory', [
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        // Try Method 0: IssueKeepAliveHandle
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.blink.mojom.KeepAliveHandleFactory_IssueKeepAliveHandle_ParamsSpec.$.structSpec);
             console.log('[GeneratedReceiver] Discovery SUCCESS: ' + header.ordinal + ' -> IssueKeepAliveHandle (0)');
...
mojo.internal.bindings.blink.mojom.KeepAliveHandleFactoryReceiver = mojo.internal.bindings.blink.mojom.KeepAliveHandleFactoryReceiver;
