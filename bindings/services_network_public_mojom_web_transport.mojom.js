...
mojo.internal.bindings.network.mojom.WebTransportCongestionControlSpec = mojo.internal.bindings.network.mojom.WebTransportCongestionControlSpec || { $: mojo.internal.Enum().$ };
...
mojo.internal.bindings.network.mojom.WebTransportHttpRequestHeadersSpec = mojo.internal.bindings.network.mojom.WebTransportHttpRequestHeadersSpec || { $: {} };
if (mojo.internal.bindings.network.mojom.WebTransportHttpRequestHeadersSpec.$.structSpec && mojo.internal.bindings.network.mojom.WebTransportHttpRequestHeadersSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.network.mojom.WebTransportHttpRequestHeadersSpec.$ = {};
...
mojo.internal.bindings.network.mojom.WebTransportReceiveStreamStatsSpec = mojo.internal.bindings.network.mojom.WebTransportReceiveStreamStatsSpec || { $: {} };
if (mojo.internal.bindings.network.mojom.WebTransportReceiveStreamStatsSpec.$.structSpec && mojo.internal.bindings.network.mojom.WebTransportReceiveStreamStatsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.network.mojom.WebTransportReceiveStreamStatsSpec.$ = {};
mojo.internal.bindings.network.mojom.WebTransportSendStreamStatsSpec = mojo.internal.bindings.network.mojom.WebTransportSendStreamStatsSpec || { $: {} };
if (mojo.internal.bindings.network.mojom.WebTransportSendStreamStatsSpec.$.structSpec && mojo.internal.bindings.network.mojom.WebTransportSendStreamStatsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.network.mojom.WebTransportSendStreamStatsSpec.$ = {};
...
mojo.internal.bindings.network.mojom.WebTransportDatagramWritable = mojo.internal.bindings.network.mojom.WebTransportDatagramWritable || {};
mojo.internal.bindings.network.mojom.WebTransportDatagramWritableSpec = mojo.internal.bindings.network.mojom.WebTransportDatagramWritableSpec || { $ : {} };
if (mojo.internal.bindings.network.mojom.WebTransportDatagramWritableSpec.$.structSpec && mojo.internal.bindings.network.mojom.WebTransportDatagramWritableSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.network.mojom.WebTransportDatagramWritableSpec.$ = {};
mojo.internal.bindings.network.mojom.WebTransportDatagramWritable.$interfaceName = 'network.mojom.WebTransportDatagramWritable';
mojo.internal.bindings.network.mojom.WebTransportDatagramWritable_SendDatagram_ParamsSpec = mojo.internal.bindings.network.mojom.WebTransportDatagramWritable_SendDatagram_ParamsSpec || { $: {} };
if (mojo.internal.bindings.network.mojom.WebTransportDatagramWritable_SendDatagram_ParamsSpec.$.structSpec && mojo.internal.bindings.network.mojom.WebTransportDatagramWritable_SendDatagram_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.network.mojom.WebTransportDatagramWritable_SendDatagram_ParamsSpec.$ = {};
mojo.internal.bindings.network.mojom.WebTransportDatagramWritable_SendDatagram_ResponseParamsSpec = mojo.internal.bindings.network.mojom.WebTransportDatagramWritable_SendDatagram_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.network.mojom.WebTransportDatagramWritable_SendDatagram_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.network.mojom.WebTransportDatagramWritable_SendDatagram_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.network.mojom.WebTransportDatagramWritable_SendDatagram_ResponseParamsSpec.$ = {};
mojo.internal.bindings.network.mojom.WebTransportDatagramWritable_SetPriority_ParamsSpec = mojo.internal.bindings.network.mojom.WebTransportDatagramWritable_SetPriority_ParamsSpec || { $: {} };
if (mojo.internal.bindings.network.mojom.WebTransportDatagramWritable_SetPriority_ParamsSpec.$.structSpec && mojo.internal.bindings.network.mojom.WebTransportDatagramWritable_SetPriority_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.network.mojom.WebTransportDatagramWritable_SetPriority_ParamsSpec.$ = {};
...
mojo.internal.bindings.network.mojom.WebTransport_CreateDatagramWritable_ParamsSpec = mojo.internal.bindings.network.mojom.WebTransport_CreateDatagramWritable_ParamsSpec || { $: {} };
if (mojo.internal.bindings.network.mojom.WebTransport_CreateDatagramWritable_ParamsSpec.$.structSpec && mojo.internal.bindings.network.mojom.WebTransport_CreateDatagramWritable_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.network.mojom.WebTransport_CreateDatagramWritable_ParamsSpec.$ = {};
...
mojo.internal.bindings.network.mojom.WebTransport_GetReceiveStreamStats_ParamsSpec = mojo.internal.bindings.network.mojom.WebTransport_GetReceiveStreamStats_ParamsSpec || { $: {} };
if (mojo.internal.bindings.network.mojom.WebTransport_GetReceiveStreamStats_ParamsSpec.$.structSpec && mojo.internal.bindings.network.mojom.WebTransport_GetReceiveStreamStats_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.network.mojom.WebTransport_GetReceiveStreamStats_ParamsSpec.$ = {};
mojo.internal.bindings.network.mojom.WebTransport_GetReceiveStreamStats_ResponseParamsSpec = mojo.internal.bindings.network.mojom.WebTransport_GetReceiveStreamStats_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.network.mojom.WebTransport_GetReceiveStreamStats_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.network.mojom.WebTransport_GetReceiveStreamStats_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.network.mojom.WebTransport_GetReceiveStreamStats_ResponseParamsSpec.$ = {};
mojo.internal.bindings.network.mojom.WebTransport_GetSendStreamStats_ParamsSpec = mojo.internal.bindings.network.mojom.WebTransport_GetSendStreamStats_ParamsSpec || { $: {} };
if (mojo.internal.bindings.network.mojom.WebTransport_GetSendStreamStats_ParamsSpec.$.structSpec && mojo.internal.bindings.network.mojom.WebTransport_GetSendStreamStats_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.network.mojom.WebTransport_GetSendStreamStats_ParamsSpec.$ = {};
mojo.internal.bindings.network.mojom.WebTransport_GetSendStreamStats_ResponseParamsSpec = mojo.internal.bindings.network.mojom.WebTransport_GetSendStreamStats_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.network.mojom.WebTransport_GetSendStreamStats_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.network.mojom.WebTransport_GetSendStreamStats_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.network.mojom.WebTransport_GetSendStreamStats_ResponseParamsSpec.$ = {};
...
mojo.internal.bindings.network.mojom.WebTransport_SetStreamPriority_ParamsSpec = mojo.internal.bindings.network.mojom.WebTransport_SetStreamPriority_ParamsSpec || { $: {} };
if (mojo.internal.bindings.network.mojom.WebTransport_SetStreamPriority_ParamsSpec.$.structSpec && mojo.internal.bindings.network.mojom.WebTransport_SetStreamPriority_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.network.mojom.WebTransport_SetStreamPriority_ParamsSpec.$ = {};
...
mojo.internal.bindings.network.mojom.WebTransportClient_OnDraining_ParamsSpec = mojo.internal.bindings.network.mojom.WebTransportClient_OnDraining_ParamsSpec || { $: {} };
if (mojo.internal.bindings.network.mojom.WebTransportClient_OnDraining_ParamsSpec.$.structSpec && mojo.internal.bindings.network.mojom.WebTransportClient_OnDraining_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.network.mojom.WebTransportClient_OnDraining_ParamsSpec.$ = {};
...
mojo.internal.bindings.network = mojo.internal.bindings.network || {};
mojo.internal.bindings.network.mojom = mojo.internal.bindings.network.mojom || {};
mojo.internal.bindings.network.mojom.HttpRequestHeaderKeyValuePairSpec = mojo.internal.bindings.network.mojom.HttpRequestHeaderKeyValuePairSpec || { $: mojo.internal.OpaqueStruct.$ };
mojo.internal.bindings.network = mojo.internal.bindings.network || {};
mojo.internal.bindings.network.mojom = mojo.internal.bindings.network.mojom || {};
...
mojo.internal.bindings.network.mojom.kCreationRejectedDisconnectReason = 1;

mojo.internal.bindings.network.mojom.kSessionClosedDisconnectReason = 2;

// Enum: WebTransportCongestionControl
mojo.internal.bindings.network.mojom.WebTransportCongestionControl = {
  kDefault: 0,
  kThroughput: 1,
  kLowLatency: 2,
};

// Interface: WebTransportDatagramWritable
mojo.internal.bindings.network.mojom.WebTransportDatagramWritablePendingReceiver = class {
  constructor(handle) {
    this.handle = handle;
    if (handle) {
...
mojo.internal.bindings.network.mojom.WebTransportDatagramWritableRemote = class {
  static get $interfaceName() {
    return 'network.mojom.WebTransportDatagramWritable';
  }

  constructor(handle = undefined) {
    this.__mojoHandle = handle;
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.network.mojom.WebTransportDatagramWritablePendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.network.mojom.WebTransportDatagramWritableRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.network.mojom.WebTransportDatagramWritableRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('network.mojom.WebTransportDatagramWritable', [
      { explicit: null },
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.network.mojom.WebTransportDatagramWritable.getRemote = function() {
  let remote = new mojo.internal.bindings.network.mojom.WebTransportDatagramWritableRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
    'network.mojom.WebTransportDatagramWritable',
    'context');
  return remote.$;
};

mojo.internal.bindings.network.mojom.WebTransportDatagramWritableReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('network.mojom.WebTransportDatagramWritable', [
      { explicit: null },
      { explicit: null },
    ]);
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        case 0: {
          ...
          const params = decoder.decodeStructInline(mojo.internal.bindings.network.mojom.WebTransportDatagramWritable_SendDatagram_ParamsSpec.$.structSpec);
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const message = new mojo.internal.Message(
                ...
                header.ordinal, header.requestId, mojo.internal.bindings.network.mojom.WebTransportDatagramWritable_SendDatagram_ResponseParamsSpec.$.structSpec, resp_obj);
        ...
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.network.mojom.WebTransportDatagramWritable_SetPriority_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.network.mojom.WebTransportDatagramWritableReceiver = mojo.internal.bindings.network.mojom.WebTransportDatagramWritableReceiver;

mojo.internal.bindings.network.mojom.WebTransportDatagramWritablePtr = mojo.internal.bindings.network.mojom.WebTransportDatagramWritableRemote;
mojo.internal.bindings.network.mojom.WebTransportDatagramWritableRequest = mojo.internal.bindings.network.mojom.WebTransportDatagramWritablePendingReceiver;
...
mojo.internal.bindings.network.mojom.WebTransportRemote = class {
  ...
  createDatagramWritable(arg_writable, arg_priority) {
    return this.$.createDatagramWritable(arg_writable, arg_priority);
  }
  ...
  getReceiveStreamStats(arg_stream_id) {
    return this.$.getReceiveStreamStats(arg_stream_id);
  }
  getSendStreamStats(arg_stream_id) {
    return this.$.getSendStreamStats(arg_stream_id);
  }
  close(arg_close_info) {
    return this.$.close(arg_close_info);
  }
  setStreamPriority(arg_stream_id, arg_priority) {
    return this.$.setStreamPriority(arg_stream_id, arg_priority);
  }
};
...
mojo.internal.bindings.network.mojom.WebTransportRemoteCallHandler = class {
  ...
  createDatagramWritable(arg_writable, arg_priority) {
    return this.proxy.sendMessage(
      this.ordinals[1],  // ordinal
      mojo.internal.bindings.network.mojom.WebTransport_CreateDatagramWritable_ParamsSpec,
      null,
      [arg_writable, arg_priority],
      false);
  }
  ...
  getReceiveStreamStats(arg_stream_id) {
    return this.proxy.sendMessage(
      ...
      mojo.internal.bindings.network.mojom.WebTransport_GetReceiveStreamStats_ParamsSpec,
      mojo.internal.bindings.network.mojom.WebTransport_GetReceiveStreamStats_ResponseParamsSpec,
      [arg_stream_id],
      false);
  }
  ...
  getSendStreamStats(arg_stream_id) {
    return this.proxy.sendMessage(
      ...
      mojo.internal.bindings.network.mojom.WebTransport_GetSendStreamStats_ParamsSpec,
      mojo.internal.bindings.network.mojom.WebTransport_GetSendStreamStats_ResponseParamsSpec,
      [arg_stream_id],
      false);
  }
  ...
  setStreamPriority(arg_stream_id, arg_priority) {
    return this.proxy.sendMessage(
      ...
      mojo.internal.bindings.network.mojom.WebTransport_SetStreamPriority_ParamsSpec,
      null,
      [arg_stream_id, arg_priority],
      false);
  }
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        ...
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.network.mojom.WebTransport_CreateDatagramWritable_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.createDatagramWritable');
          const result = this.impl.createDatagramWritable(params.arg_writable, params.arg_priority);
          break;
        }
        case 2: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
        ...
        case 10: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.network.mojom.WebTransport_GetReceiveStreamStats_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.getReceiveStreamStats');
          const result = this.impl.getReceiveStreamStats(params.arg_stream_id);
          const expectsResponse = header.expectsResponse || (header.flags & 1);
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              const val = (response && typeof response === 'object' && 'arg_stats' in response) ? response['arg_stats'] : response;
              ...
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.network.mojom.WebTransport_GetReceiveStreamStats_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
            }).catch(e => console.error('[GeneratedReceiver] getReceiveStreamStats FAILED:', e));
          }
          break;
        }
        case 11: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.network.mojom.WebTransport_GetSendStreamStats_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.getSendStreamStats');
          const result = this.impl.getSendStreamStats(params.arg_stream_id);
          const expectsResponse = header.expectsResponse || (header.flags & 1);
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              const val = (response && typeof response === 'object' && 'arg_stats' in response) ? response['arg_stats'] : response;
              ...
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.network.mojom.WebTransport_GetSendStreamStats_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
            }).catch(e => console.error('[GeneratedReceiver] getSendStreamStats FAILED:', e));
          }
          break;
        }
        case 12: {
        ...
        case 13: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.network.mojom.WebTransport_SetStreamPriority_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.setStreamPriority');
          const result = this.impl.setStreamPriority(params.arg_stream_id, params.arg_priority);
          break;
        }
      }
      } catch (err) {
...
mojo.internal.bindings.network.mojom.WebTransportClientRemote = class {
  ...
  onIncomingStreamClosed(arg_stream_id, arg_fin_received, arg_bytes_received) {
    return this.$.onIncomingStreamClosed(arg_stream_id, arg_fin_received, arg_bytes_received);
  }
  ...
  onReceivedResetStream(arg_stream_id, arg_stream_error_code, arg_bytes_received) {
    return this.$.onReceivedResetStream(arg_stream_id, arg_stream_error_code, arg_bytes_received);
  }
  onClosed(arg_close_info, arg_final_stats) {
    return this.$.onClosed(arg_close_info, arg_final_stats);
  }
  onDraining() {
    return this.$.onDraining();
  }
};
...
mojo.internal.bindings.network.mojom.WebTransportClientRemoteCallHandler = class {
  ...
  onIncomingStreamClosed(arg_stream_id, arg_fin_received, arg_bytes_received) {
    return this.proxy.sendMessage(
      ...
      mojo.internal.bindings.network.mojom.WebTransportClient_OnIncomingStreamClosed_ParamsSpec,
      null,
      [arg_stream_id, arg_fin_received, arg_bytes_received],
      false);
  }
  ...
  onReceivedResetStream(arg_stream_id, arg_stream_error_code, arg_bytes_received) {
    return this.proxy.sendMessage(
      ...
      mojo.internal.bindings.network.mojom.WebTransportClient_OnReceivedResetStream_ParamsSpec,
      null,
      [arg_stream_id, arg_stream_error_code, arg_bytes_received],
      false);
  }
  ...
  onDraining() {
    return this.proxy.sendMessage(
      this.ordinals[6],  // ordinal
      mojo.internal.bindings.network.mojom.WebTransportClient_OnDraining_ParamsSpec,
      null,
      [],
      false);
  }
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        ...
        case 1: {
          ...
          const result = this.impl.onIncomingStreamClosed(params.arg_stream_id, params.arg_fin_received, params.arg_bytes_received);
          break;
        }
        case 2: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
        ...
        case 4: {
          ...
          const result = this.impl.onReceivedResetStream(params.arg_stream_id, params.arg_stream_error_code, params.arg_bytes_received);
          break;
        }
        case 5: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
        ...
        case 6: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.network.mojom.WebTransportClient_OnDraining_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.onDraining');
          const result = this.impl.onDraining();
          break;
        }
      }
      } catch (err) {
...
mojo.internal.bindings.network.mojom.WebTransportHandshakeClientRemote = class {
  ...
  onConnectionEstablished(arg_transport, arg_client, arg_response_headers, arg_selected_application_protocol, arg_initial_stats, arg_max_datagram_size) {
    return this.$.onConnectionEstablished(arg_transport, arg_client, arg_response_headers, arg_selected_application_protocol, arg_initial_stats, arg_max_datagram_size);
  }
...
mojo.internal.bindings.network.mojom.WebTransportHandshakeClientRemoteCallHandler = class {
  ...
  onConnectionEstablished(arg_transport, arg_client, arg_response_headers, arg_selected_application_protocol, arg_initial_stats, arg_max_datagram_size) {
    return this.proxy.sendMessage(
      ...
      mojo.internal.bindings.network.mojom.WebTransportHandshakeClient_OnConnectionEstablished_ParamsSpec,
      null,
      [arg_transport, arg_client, arg_response_headers, arg_selected_application_protocol, arg_initial_stats, arg_max_datagram_size],
      false);
  }
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        ...
        case 1: {
          ...
          const result = this.impl.onConnectionEstablished(params.arg_transport, params.arg_client, params.arg_response_headers, params.arg_selected_application_protocol, params.arg_initial_stats, params.arg_max_datagram_size);
          break;
        }
        case 2: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
...
// Struct: WebTransportHttpRequestHeaders
mojo.internal.Struct(
    mojo.internal.bindings.network.mojom.WebTransportHttpRequestHeadersSpec, 'network.mojom.WebTransportHttpRequestHeaders', [
...
mojo.internal.Struct(
    mojo.internal.bindings.network.mojom.WebTransportReceiveStreamStatsSpec, 'network.mojom.WebTransportReceiveStreamStats', [
      mojo.internal.StructField('arg_bytes_received', 0, 0, mojo.internal.Uint64, 0, false, 0, undefined),
    ],
    [[0, 16]]);

// Struct: WebTransportSendStreamStats
mojo.internal.Struct(
    mojo.internal.bindings.network.mojom.WebTransportSendStreamStatsSpec, 'network.mojom.WebTransportSendStreamStats', [
      mojo.internal.StructField('arg_bytes_sent', 0, 0, mojo.internal.Uint64, 0, false, 0, undefined),
      mojo.internal.StructField('arg_bytes_acknowledged', 8, 0, mojo.internal.Uint64, 0, false, 0, undefined),
    ],
    [[0, 24]]);
...
mojo.internal.Struct(
    ...
    [[0, 24]]);
mojo.internal.Struct(
    mojo.internal.bindings.network.mojom.WebTransportDatagramWritable_SendDatagram_ParamsSpec, 'network.mojom.WebTransportDatagramWritable_SendDatagram_Params', [
      mojo.internal.StructField('arg_data', 0, 0, mojo.internal.bindings.mojo_base.mojom.ReadOnlyBufferSpec, null, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.network.mojom.WebTransportDatagramWritable_SendDatagram_ResponseParamsSpec, 'network.mojom.WebTransportDatagramWritable_SendDatagram_ResponseParams', [
      mojo.internal.StructField('arg_result', 0, 0, mojo.internal.Bool, false, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.network.mojom.WebTransportDatagramWritable_SetPriority_ParamsSpec, 'network.mojom.WebTransportDatagramWritable_SetPriority_Params', [
      mojo.internal.StructField('arg_priority', 0, 0, mojo.internal.bindings.network.mojom.WebTransportStreamPrioritySpec, null, false, 0, undefined),
    ],
    [[0, 16]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.network.mojom.WebTransport_CreateDatagramWritable_ParamsSpec, 'network.mojom.WebTransport_CreateDatagramWritable_Params', [
      mojo.internal.StructField('arg_writable', 0, 0, mojo.internal.InterfaceRequest(mojo.internal.bindings.network.mojom.WebTransportDatagramWritablePendingReceiver), null, false, 0, undefined),
      mojo.internal.StructField('arg_priority', 8, 0, mojo.internal.bindings.network.mojom.WebTransportStreamPrioritySpec, null, false, 0, undefined),
    ],
    [[0, 24]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.network.mojom.WebTransport_AcceptBidirectionalStream_ResponseParamsSpec, 'network.mojom.WebTransport_AcceptBidirectionalStream_ResponseParams', [
      ...
      mojo.internal.StructField('arg_readable', 4, 0, mojo.internal.Handle, null, false, 0, undefined),
      mojo.internal.StructField('arg_writable', 8, 0, mojo.internal.Handle, null, false, 0, undefined),
    ],
    [[0, 24]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.network.mojom.WebTransport_GetReceiveStreamStats_ParamsSpec, 'network.mojom.WebTransport_GetReceiveStreamStats_Params', [
      mojo.internal.StructField('arg_stream_id', 0, 0, mojo.internal.Uint32, 0, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.network.mojom.WebTransport_GetReceiveStreamStats_ResponseParamsSpec, 'network.mojom.WebTransport_GetReceiveStreamStats_ResponseParams', [
      mojo.internal.StructField('arg_stats', 0, 0, mojo.internal.bindings.network.mojom.WebTransportReceiveStreamStatsSpec, null, true, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.network.mojom.WebTransport_GetSendStreamStats_ParamsSpec, 'network.mojom.WebTransport_GetSendStreamStats_Params', [
      mojo.internal.StructField('arg_stream_id', 0, 0, mojo.internal.Uint32, 0, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.network.mojom.WebTransport_GetSendStreamStats_ResponseParamsSpec, 'network.mojom.WebTransport_GetSendStreamStats_ResponseParams', [
      mojo.internal.StructField('arg_stats', 0, 0, mojo.internal.bindings.network.mojom.WebTransportSendStreamStatsSpec, null, true, 0, undefined),
    ],
    [[0, 16]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.network.mojom.WebTransport_SetStreamPriority_ParamsSpec, 'network.mojom.WebTransport_SetStreamPriority_Params', [
      mojo.internal.StructField('arg_stream_id', 0, 0, mojo.internal.Uint32, 0, false, 0, undefined),
      mojo.internal.StructField('arg_priority', 8, 0, mojo.internal.bindings.network.mojom.WebTransportStreamPrioritySpec, null, false, 0, undefined),
    ],
    [[0, 24]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.network.mojom.WebTransportClient_OnIncomingStreamClosed_ParamsSpec, 'network.mojom.WebTransportClient_OnIncomingStreamClosed_Params', [
      ...
      mojo.internal.StructField('arg_bytes_received', 8, 0, mojo.internal.Uint64, 0, false, 0, undefined),
    ],
    [[0, 24]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.network.mojom.WebTransportClient_OnDraining_ParamsSpec, 'network.mojom.WebTransportClient_OnDraining_Params', [
    ],
    [[0, 8]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.network.mojom.WebTransportHandshakeClient_OnConnectionEstablished_ParamsSpec, 'network.mojom.WebTransportHandshakeClient_OnConnectionEstablished_Params', [
      ...
      mojo.internal.StructField('arg_max_datagram_size_$flag', 12, 0, mojo.internal.Bool, false, false, 0, { isPrimary: true, linkedValueFieldName: 'arg_max_datagram_size_$value', originalFieldName: 'arg_max_datagram_size' }),
      ...
      mojo.internal.StructField('arg_max_datagram_size_$value', 40, 0, mojo.internal.Uint32, 0, false, 0, { isPrimary: false, linkedValueFieldName: 'arg_max_datagram_size_$flag', originalFieldName: 'arg_max_datagram_size' }),
    ],
    [[0, 56]]);
