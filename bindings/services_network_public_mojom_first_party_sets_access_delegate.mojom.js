    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      switch (dispatchId) {
        case 0: {
          ...
          const params = decoder.decodeStruct(network.mojom.FirstPartySetsAccessDelegate_NotifyReady_ParamsSpec.$, 0);
        ...
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStruct(network.mojom.FirstPartySetsAccessDelegate_SetEnabled_ParamsSpec.$, 0);
