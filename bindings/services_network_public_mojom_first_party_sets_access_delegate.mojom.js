...
mojo.internal.Struct(
    mojo.internal.bindings.network.mojom.FirstPartySetsAccessDelegate_SetEnabled_ParamsSpec, 'network.mojom.FirstPartySetsAccessDelegate_SetEnabled_Params', [
      mojo.internal.StructField('arg_enabled', 0, 0, mojo.internal.Bool, false, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.bindings.network.mojom.FirstPartySetsAccessDelegatePendingReceiver = class {
  constructor(handle) {
    this.handle = handle;
  }
};

mojo.internal.bindings.network.mojom.FirstPartySetsAccessDelegateRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.network.mojom.FirstPartySetsAccessDelegatePendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.network.mojom.FirstPartySetsAccessDelegateRemoteCallHandler(this.proxy);
  }
  ...
  notifyReady(arg_ready_event) {
    return this.$.notifyReady(arg_ready_event);
  }
...
mojo.internal.bindings.network.mojom.FirstPartySetsAccessDelegate.getRemote = function() {
  let remote = new mojo.internal.bindings.network.mojom.FirstPartySetsAccessDelegateRemote();
...
mojo.internal.bindings.network.mojom.FirstPartySetsAccessDelegateReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.network.mojom.FirstPartySetsAccessDelegate_NotifyReady_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for NotifyReady failed with TypeError');
           }
        }
        // Try Method 1: SetEnabled
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.network.mojom.FirstPartySetsAccessDelegate_SetEnabled_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
...
mojo.internal.bindings.network.mojom.FirstPartySetsAccessDelegateReceiver = mojo.internal.bindings.network.mojom.FirstPartySetsAccessDelegateReceiver;

mojo.internal.bindings.network.mojom.FirstPartySetsAccessDelegatePtr = mojo.internal.bindings.network.mojom.FirstPartySetsAccessDelegateRemote;
mojo.internal.bindings.network.mojom.FirstPartySetsAccessDelegateRequest = mojo.internal.bindings.network.mojom.FirstPartySetsAccessDelegatePendingReceiver;
