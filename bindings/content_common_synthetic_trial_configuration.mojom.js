...
mojo.internal.bindings.content.mojom.SyntheticTrialConfigurationRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.content.mojom.SyntheticTrialConfigurationPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.content.mojom.SyntheticTrialConfigurationRemoteCallHandler(this.proxy);
  }
  ...
  addOrUpdateSyntheticTrialGroups(arg_groups) {
    return this.$.addOrUpdateSyntheticTrialGroups(arg_groups);
  }
  removeSyntheticTrialGroups(arg_groups) {
    return this.$.removeSyntheticTrialGroups(arg_groups);
  }
};
...
mojo.internal.bindings.content.mojom.SyntheticTrialConfiguration.getRemote = function() {
  let remote = new mojo.internal.bindings.content.mojom.SyntheticTrialConfigurationRemote();
...
mojo.internal.bindings.content.mojom.SyntheticTrialConfigurationReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.content.mojom.SyntheticTrialConfiguration_AddOrUpdateSyntheticTrialGroups_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for AddOrUpdateSyntheticTrialGroups failed with TypeError');
           }
        }
        // Try Method 1: RemoveSyntheticTrialGroups
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.content.mojom.SyntheticTrialConfiguration_RemoveSyntheticTrialGroups_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for RemoveSyntheticTrialGroups failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.content.mojom.SyntheticTrialConfigurationReceiver = mojo.internal.bindings.content.mojom.SyntheticTrialConfigurationReceiver;
