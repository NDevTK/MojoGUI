  ...
  $: {
    structSpec: {
      ...
      fields: [
        ...
        { name: 'ancestor_chain_bit', packedOffset: 24, packedBitOffset: 0, type: blink.mojom.AncestorChainBitSpec, nullable: false },
        { name: 'top_level_site_if_third_party_enabled', packedOffset: 32, packedBitOffset: 0, type: network.mojom.SchemefulSiteSpec, nullable: false },
        { name: 'ancestor_chain_bit_if_third_party_enabled', packedOffset: 40, packedBitOffset: 0, type: blink.mojom.AncestorChainBitSpec, nullable: false },
      ],
      versions: [{version: 0}]
    }
  }
