...
mojo.internal.bindings.browser_command.mojom.CommandHandlerFactoryRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.browser_command.mojom.CommandHandlerFactoryPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.browser_command.mojom.CommandHandlerFactoryRemoteCallHandler(this.proxy);
  }
  ...
  createBrowserCommandHandler(arg_handler) {
    return this.$.createBrowserCommandHandler(arg_handler);
  }
};
...
mojo.internal.bindings.browser_command.mojom.CommandHandlerFactory.getRemote = function() {
  let remote = new mojo.internal.bindings.browser_command.mojom.CommandHandlerFactoryRemote();
...
mojo.internal.bindings.browser_command.mojom.CommandHandlerFactoryReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.browser_command.mojom.CommandHandlerFactory_CreateBrowserCommandHandler_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for CreateBrowserCommandHandler failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.browser_command.mojom.CommandHandlerFactoryReceiver = mojo.internal.bindings.browser_command.mojom.CommandHandlerFactoryReceiver;

mojo.internal.bindings.browser_command.mojom.CommandHandlerFactoryPtr = mojo.internal.bindings.browser_command.mojom.CommandHandlerFactoryRemote;
mojo.internal.bindings.browser_command.mojom.CommandHandlerFactoryRequest = mojo.internal.bindings.browser_command.mojom.CommandHandlerFactoryPendingReceiver;
...
mojo.internal.Struct(
    mojo.internal.bindings.browser_command.mojom.CommandHandler_ExecuteCommand_ParamsSpec, 'browser_command.mojom.CommandHandler_ExecuteCommand_Params', [
      mojo.internal.StructField('arg_click_info', 0, 0, mojo.internal.bindings.browser_command.mojom.ClickInfoSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_command_id', 8, 0, mojo.internal.bindings.browser_command.mojom.CommandSpec, null, false, 0, undefined),
    ],
    [[0, 24]]);
...
mojo.internal.bindings.browser_command.mojom.CommandHandlerRemote = class {
  static get $interfaceName() {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.browser_command.mojom.CommandHandlerPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.browser_command.mojom.CommandHandlerRemoteCallHandler(this.proxy);
  }
  ...
  canExecuteCommand(arg_command_id) {
    return this.$.canExecuteCommand(arg_command_id);
  }
  executeCommand(arg_command_id, arg_click_info) {
    return this.$.executeCommand(arg_command_id, arg_click_info);
  }
};
...
mojo.internal.bindings.browser_command.mojom.CommandHandler.getRemote = function() {
  let remote = new mojo.internal.bindings.browser_command.mojom.CommandHandlerRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
...
mojo.internal.bindings.browser_command.mojom.CommandHandlerReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.browser_command.mojom.CommandHandler_CanExecuteCommand_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for CanExecuteCommand failed with TypeError');
           }
        }
        // Try Method 1: ExecuteCommand
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.browser_command.mojom.CommandHandler_ExecuteCommand_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
...
mojo.internal.bindings.browser_command.mojom.CommandHandlerReceiver = mojo.internal.bindings.browser_command.mojom.CommandHandlerReceiver;
