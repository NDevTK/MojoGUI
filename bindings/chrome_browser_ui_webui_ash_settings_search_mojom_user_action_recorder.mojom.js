...
mojo.internal.bindings.ash.settings.mojom.UserActionRecorderRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.ash.settings.mojom.UserActionRecorderPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.ash.settings.mojom.UserActionRecorderRemoteCallHandler(this.proxy);
  }
  ...
  recordSettingChangeWithDetails(arg_setting, arg_value) {
    return this.$.recordSettingChangeWithDetails(arg_setting, arg_value);
  }
};
...
mojo.internal.bindings.ash.settings.mojom.UserActionRecorder.getRemote = function() {
  let remote = new mojo.internal.bindings.ash.settings.mojom.UserActionRecorderRemote();
...
mojo.internal.bindings.ash.settings.mojom.UserActionRecorderReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ash.settings.mojom.UserActionRecorder_RecordPageFocus_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for RecordPageFocus failed with TypeError');
           }
        }
        // Try Method 1: RecordPageBlur
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ash.settings.mojom.UserActionRecorder_RecordPageBlur_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for RecordPageBlur failed with TypeError');
           }
        }
        // Try Method 2: RecordClick
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ash.settings.mojom.UserActionRecorder_RecordClick_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for RecordClick failed with TypeError');
           }
        }
        // Try Method 3: RecordNavigation
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ash.settings.mojom.UserActionRecorder_RecordNavigation_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for RecordNavigation failed with TypeError');
           }
        }
        // Try Method 4: RecordSearch
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ash.settings.mojom.UserActionRecorder_RecordSearch_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for RecordSearch failed with TypeError');
           }
        }
        // Try Method 5: RecordSettingChange
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ash.settings.mojom.UserActionRecorder_RecordSettingChange_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for RecordSettingChange failed with TypeError');
           }
        }
        // Try Method 6: RecordSettingChangeWithDetails
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ash.settings.mojom.UserActionRecorder_RecordSettingChangeWithDetails_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for RecordSettingChangeWithDetails failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.ash.settings.mojom.UserActionRecorder_RecordPageFocus_ParamsSpec.$.structSpec);
        ...
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.ash.settings.mojom.UserActionRecorder_RecordPageBlur_ParamsSpec.$.structSpec);
        ...
        case 2: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.ash.settings.mojom.UserActionRecorder_RecordClick_ParamsSpec.$.structSpec);
        ...
        case 3: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.ash.settings.mojom.UserActionRecorder_RecordNavigation_ParamsSpec.$.structSpec);
        ...
        case 4: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.ash.settings.mojom.UserActionRecorder_RecordSearch_ParamsSpec.$.structSpec);
        ...
        case 5: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.ash.settings.mojom.UserActionRecorder_RecordSettingChange_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.ash.settings.mojom.UserActionRecorderReceiver = mojo.internal.bindings.ash.settings.mojom.UserActionRecorderReceiver;
