...
mojo.internal.bindings.shape_detection.mojom.ShapeDetectionService = {};
mojo.internal.bindings.shape_detection.mojom.ShapeDetectionServiceSpec = { $ : {} };
mojo.internal.bindings.shape_detection.mojom.ShapeDetectionService.$interfaceName = 'shape_detection.mojom.ShapeDetectionService';
...
mojo.internal.bindings.shape_detection.mojom.ShapeDetectionServiceRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.shape_detection.mojom.ShapeDetectionServicePendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.shape_detection.mojom.ShapeDetectionServiceRemoteCallHandler(this.proxy);
  }
  ...
  bindBarcodeDetectionProvider(arg_receiver) {
    return this.$.bindBarcodeDetectionProvider(arg_receiver);
  }
  bindFaceDetectionProvider(arg_receiver) {
    return this.$.bindFaceDetectionProvider(arg_receiver);
  }
  bindTextDetection(arg_receiver) {
    return this.$.bindTextDetection(arg_receiver);
  }
};

mojo.internal.bindings.shape_detection.mojom.ShapeDetectionServiceRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('shape_detection.mojom.ShapeDetectionService', [
      { explicit: null },
      { explicit: null },
      { explicit: null },
    ]);
...
mojo.internal.bindings.shape_detection.mojom.ShapeDetectionService.getRemote = function() {
  let remote = new mojo.internal.bindings.shape_detection.mojom.ShapeDetectionServiceRemote();
...
mojo.internal.bindings.shape_detection.mojom.ShapeDetectionServiceReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('shape_detection.mojom.ShapeDetectionService', [
      { explicit: null },
      { explicit: null },
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.shape_detection.mojom.ShapeDetectionService_BindBarcodeDetectionProvider_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for BindBarcodeDetectionProvider failed with TypeError');
           }
        }
        // Try Method 1: BindFaceDetectionProvider
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.shape_detection.mojom.ShapeDetectionService_BindFaceDetectionProvider_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for BindFaceDetectionProvider failed with TypeError');
           }
        }
        // Try Method 2: BindTextDetection
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.shape_detection.mojom.ShapeDetectionService_BindTextDetection_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for BindTextDetection failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.shape_detection.mojom.ShapeDetectionServiceReceiver = mojo.internal.bindings.shape_detection.mojom.ShapeDetectionServiceReceiver;
