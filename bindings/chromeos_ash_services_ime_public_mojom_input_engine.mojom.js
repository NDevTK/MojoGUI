...
mojo.internal.bindings.ash.ime.mojom.InputChannel = {};
mojo.internal.bindings.ash.ime.mojom.InputChannelSpec = { $ : {} };
mojo.internal.bindings.ash.ime.mojom.InputChannel.$interfaceName = 'ash.ime.mojom.InputChannel';
...
mojo.internal.bindings.ash.ime.mojom.InputChannelRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.ash.ime.mojom.InputChannelRemoteCallHandler(this.proxy);
  }
  ...
  processMessage(arg_message) {
    return this.$.processMessage(arg_message);
  }
};

mojo.internal.bindings.ash.ime.mojom.InputChannelRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('ash.ime.mojom.InputChannel', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.ash.ime.mojom.InputChannel.getRemote = function() {
  let remote = new mojo.internal.bindings.ash.ime.mojom.InputChannelRemote();
...
mojo.internal.bindings.ash.ime.mojom.InputChannelReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('ash.ime.mojom.InputChannel', [
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.ash.ime.mojom.InputChannel_ProcessMessage_ParamsSpec.$.structSpec);
        ...
        case 0: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.ash.ime.mojom.InputChannel_ProcessMessage_ResponseParamsSpec, header, rawHeader);
               responder(response);
...
mojo.internal.bindings.ash.ime.mojom.InputChannelReceiver = mojo.internal.bindings.ash.ime.mojom.InputChannelReceiver;
