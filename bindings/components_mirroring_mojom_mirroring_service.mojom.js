...
mojo.internal.bindings.mirroring = mojo.internal.bindings.mirroring || {};
mojo.internal.bindings.mirroring.mojom = mojo.internal.bindings.mirroring.mojom || {};
mojo.internal.bindings.mirroring.mojom.CastMessageChannelSpec = mojo.internal.bindings.mirroring.mojom.CastMessageChannelSpec || { $: mojo.internal.OpaqueStruct.$ };
mojo.internal.bindings.mirroring = mojo.internal.bindings.mirroring || {};
mojo.internal.bindings.mirroring.mojom = mojo.internal.bindings.mirroring.mojom || {};
mojo.internal.bindings.mirroring.mojom.ResourceProviderSpec = mojo.internal.bindings.mirroring.mojom.ResourceProviderSpec || { $: mojo.internal.OpaqueStruct.$ };
mojo.internal.bindings.mirroring = mojo.internal.bindings.mirroring || {};
mojo.internal.bindings.mirroring.mojom = mojo.internal.bindings.mirroring.mojom || {};
mojo.internal.bindings.mirroring.mojom.SessionObserverSpec = mojo.internal.bindings.mirroring.mojom.SessionObserverSpec || { $: mojo.internal.OpaqueStruct.$ };
mojo.internal.bindings.mirroring = mojo.internal.bindings.mirroring || {};
mojo.internal.bindings.mirroring.mojom = mojo.internal.bindings.mirroring.mojom || {};
mojo.internal.bindings.mirroring.mojom.SessionParametersSpec = mojo.internal.bindings.mirroring.mojom.SessionParametersSpec || { $: mojo.internal.OpaqueStruct.$ };
mojo.internal.bindings.mojo_base = mojo.internal.bindings.mojo_base || {};
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.mirroring.mojom.MirroringService_Start_ParamsSpec.$.structSpec;
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.mirroring.mojom.MirroringService_SwitchMirroringSourceTab_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for SwitchMirroringSourceTab failed with TypeError');
           }
        }
        // Try Method 2: GetMirroringStats
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.mirroring.mojom.MirroringService_GetMirroringStats_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for GetMirroringStats failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
