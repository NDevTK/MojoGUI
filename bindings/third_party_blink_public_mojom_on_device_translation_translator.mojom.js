...
mojo.internal.bindings.blink.mojom.Translator = {};
mojo.internal.bindings.blink.mojom.TranslatorSpec = { $ : {} };
mojo.internal.bindings.blink.mojom.Translator.$interfaceName = 'blink.mojom.Translator';
...
mojo.internal.bindings.blink.mojom.TranslatorRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.blink.mojom.TranslatorPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.blink.mojom.TranslatorRemoteCallHandler(this.proxy);
  }
  ...
  translate(arg_input, arg_pending_responder) {
    return this.$.translate(arg_input, arg_pending_responder);
  }
  translateStreaming(arg_input, arg_pending_responder) {
    return this.$.translateStreaming(arg_input, arg_pending_responder);
  }
};

mojo.internal.bindings.blink.mojom.TranslatorRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('blink.mojom.Translator', [
      { explicit: null },
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.blink.mojom.Translator.getRemote = function() {
  let remote = new mojo.internal.bindings.blink.mojom.TranslatorRemote();
...
mojo.internal.bindings.blink.mojom.TranslatorReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('blink.mojom.Translator', [
      { explicit: null },
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.blink.mojom.Translator_Translate_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for Translate failed with TypeError');
           }
        }
        // Try Method 1: TranslateStreaming
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.blink.mojom.Translator_TranslateStreaming_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for TranslateStreaming failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.blink.mojom.TranslatorReceiver = mojo.internal.bindings.blink.mojom.TranslatorReceiver;
