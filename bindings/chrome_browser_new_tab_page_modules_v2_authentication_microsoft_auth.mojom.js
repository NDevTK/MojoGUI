    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      switch (dispatchId) {
        case 0: {
          ...
          const params = decoder.decodeStruct(ntp.authentication.mojom.MicrosoftAuthPageHandler_DismissModule_ParamsSpec.$, 0);
        ...
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStruct(ntp.authentication.mojom.MicrosoftAuthPageHandler_RestoreModule_ParamsSpec.$, 0);
        ...
        case 2: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStruct(ntp.authentication.mojom.MicrosoftAuthPageHandler_ShouldShowModule_ParamsSpec.$, 0);
