...
mojo.internal.Struct(
    mojo.internal.bindings.network.mojom.NetworkContextClient_OnCanSendReportingReports_ParamsSpec, 'network.mojom.NetworkContextClient_OnCanSendReportingReports_Params', [
...
mojo.internal.Struct(
    mojo.internal.bindings.network.mojom.NetworkContextClient_OnCanSendReportingReports_ResponseParamsSpec, 'network.mojom.NetworkContextClient_OnCanSendReportingReports_ResponseParams', [
      mojo.internal.StructField('arg_origins', 0, 0, mojo.internal.Array(mojo.internal.bindings.url.mojom.OriginSpec, false), null, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.network.mojom.NetworkContextClient_OnCanSendDomainReliabilityUpload_ParamsSpec, 'network.mojom.NetworkContextClient_OnCanSendDomainReliabilityUpload_Params', [
      mojo.internal.StructField('arg_origin', 0, 0, mojo.internal.bindings.url.mojom.OriginSpec, null, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.network.mojom.NetworkContextClient_OnCanSendDomainReliabilityUpload_ResponseParamsSpec, 'network.mojom.NetworkContextClient_OnCanSendDomainReliabilityUpload_ResponseParams', [
...
mojo.internal.bindings.network.mojom.NetworkContextClientRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.network.mojom.NetworkContextClientRemoteCallHandler(this.proxy);
  }
  ...
  onFileUploadRequested(arg_process_id, arg_async, arg_file_paths, arg_destination_url) {
    return this.$.onFileUploadRequested(arg_process_id, arg_async, arg_file_paths, arg_destination_url);
  }
  onCanSendReportingReports(arg_origins) {
    return this.$.onCanSendReportingReports(arg_origins);
  }
...
mojo.internal.bindings.network.mojom.NetworkContextClient.getRemote = function() {
  let remote = new mojo.internal.bindings.network.mojom.NetworkContextClientRemote();
...
mojo.internal.bindings.network.mojom.NetworkContextClientReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.network.mojom.NetworkContextClient_OnFileUploadRequested_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OnFileUploadRequested failed with TypeError');
           }
        }
        // Try Method 1: OnCanSendReportingReports
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.network.mojom.NetworkContextClient_OnCanSendReportingReports_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OnCanSendReportingReports failed with TypeError');
           }
        }
        // Try Method 2: OnCanSendDomainReliabilityUpload
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.network.mojom.NetworkContextClient_OnCanSendDomainReliabilityUpload_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
...
mojo.internal.bindings.network.mojom.NetworkContextClientReceiver = mojo.internal.bindings.network.mojom.NetworkContextClientReceiver;

mojo.internal.bindings.network.mojom.NetworkContextClientPtr = mojo.internal.bindings.network.mojom.NetworkContextClientRemote;
mojo.internal.bindings.network.mojom.NetworkContextClientRequest = mojo.internal.bindings.network.mojom.NetworkContextClientPendingReceiver;
