...
mojo.internal.bindings.blink.mojom.ServiceWorkerStreamCallbackRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.blink.mojom.ServiceWorkerStreamCallbackPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.blink.mojom.ServiceWorkerStreamCallbackRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.blink.mojom.ServiceWorkerStreamCallback.getRemote = function() {
  let remote = new mojo.internal.bindings.blink.mojom.ServiceWorkerStreamCallbackRemote();
...
mojo.internal.bindings.blink.mojom.ServiceWorkerStreamCallbackReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.blink.mojom.ServiceWorkerStreamCallback_OnCompleted_ParamsSpec.$.structSpec;
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.blink.mojom.ServiceWorkerStreamCallback_OnAborted_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OnAborted failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.blink.mojom.ServiceWorkerStreamCallback_OnCompleted_ParamsSpec.$.structSpec);
        ...
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.blink.mojom.ServiceWorkerStreamCallback_OnAborted_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.blink.mojom.ServiceWorkerStreamCallbackReceiver = mojo.internal.bindings.blink.mojom.ServiceWorkerStreamCallbackReceiver;
