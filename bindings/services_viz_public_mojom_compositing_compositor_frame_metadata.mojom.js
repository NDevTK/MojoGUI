  ...
  $: {
    structSpec: {
      ...
      fields: [
        ...
        { name: 'scrollable_viewport_size', packedOffset: 8, packedBitOffset: 0, type: mojo.internal.Pointer, nullable: false },
        { name: 'visible_viewport_size', packedOffset: 16, packedBitOffset: 0, type: mojo.internal.Pointer, nullable: false },
        { name: 'content_color_usage', packedOffset: 24, packedBitOffset: 0, type: mojo.internal.Pointer, nullable: false },
        { name: 'root_background_color', packedOffset: 32, packedBitOffset: 0, type: mojo.internal.Pointer, nullable: false },
        ...
        { name: 'deadline', packedOffset: 56, packedBitOffset: 0, type: mojo.internal.Pointer, nullable: false },
        { name: 'activation_dependencies', packedOffset: 64, packedBitOffset: 0, type: mojo.internal.Array, nullable: false },
        { name: 'begin_frame_ack', packedOffset: 72, packedBitOffset: 0, type: mojo.internal.Pointer, nullable: false },
        { name: 'display_transform_hint', packedOffset: 80, packedBitOffset: 0, type: mojo.internal.Pointer, nullable: false },
        { name: 'delegated_ink_metadata', packedOffset: 88, packedBitOffset: 0, type: mojo.internal.Pointer, nullable: true },
        { name: 'transition_directives', packedOffset: 96, packedBitOffset: 0, type: mojo.internal.Array, nullable: false },
        { name: 'capture_bounds', packedOffset: 104, packedBitOffset: 0, type: mojo.internal.Pointer, nullable: false },
        { name: 'screenshot_destination', packedOffset: 112, packedBitOffset: 0, type: mojo.internal.Pointer, nullable: true },
        ...
        { name: 'frame_interval_inputs', packedOffset: 136, packedBitOffset: 0, type: mojo.internal.Pointer, nullable: false },
        { name: 'trees_in_viz_timing', packedOffset: 144, packedBitOffset: 0, type: mojo.internal.Pointer, nullable: false },
