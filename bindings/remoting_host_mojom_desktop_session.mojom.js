...
mojo.internal.bindings.remoting.mojom.DesktopSessionManagerRemote = class {
  ...
  createDesktopSession(arg_terminal_id, arg_screen_resolution, arg_is_curtained) {
    return this.$.createDesktopSession(arg_terminal_id, arg_screen_resolution, arg_is_curtained);
  }
...
mojo.internal.bindings.remoting.mojom.DesktopSessionManagerRemoteCallHandler = class {
  ...
  createDesktopSession(arg_terminal_id, arg_screen_resolution, arg_is_curtained) {
    return this.proxy.sendMessage(
      ...
      mojo.internal.bindings.remoting.mojom.DesktopSessionManager_CreateDesktopSession_ParamsSpec,
      null,
      [arg_terminal_id, arg_screen_resolution, arg_is_curtained],
      false);
  }
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        case 0: {
          ...
          const result = this.impl.createDesktopSession(params.arg_terminal_id, params.arg_screen_resolution, params.arg_is_curtained);
          break;
        }
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
...
mojo.internal.Struct(
    mojo.internal.bindings.remoting.mojom.DesktopSessionManager_CreateDesktopSession_ParamsSpec, 'remoting.mojom.DesktopSessionManager_CreateDesktopSession_Params', [
      ...
      mojo.internal.StructField('arg_is_curtained', 4, 0, mojo.internal.Bool, false, false, 0, undefined),
