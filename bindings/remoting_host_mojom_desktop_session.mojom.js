...
mojo.internal.bindings.remoting.mojom.SourceLocationSpec = mojo.internal.bindings.remoting.mojom.SourceLocationSpec || { $: {} };
if (mojo.internal.bindings.remoting.mojom.SourceLocationSpec.$.structSpec && mojo.internal.bindings.remoting.mojom.SourceLocationSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.remoting.mojom.SourceLocationSpec.$ = {};
...
mojo.internal.bindings.remoting.mojom.DesktopSessionManager_CreateDesktopSession_ParamsSpec = mojo.internal.bindings.remoting.mojom.DesktopSessionManager_CreateDesktopSession_ParamsSpec || { $: {} };
if (mojo.internal.bindings.remoting.mojom.DesktopSessionManager_CreateDesktopSession_ParamsSpec.$.structSpec && mojo.internal.bindings.remoting.mojom.DesktopSessionManager_CreateDesktopSession_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.remoting.mojom.DesktopSessionManager_CreateDesktopSession_ParamsSpec.$ = {};
mojo.internal.bindings.remoting.mojom.DesktopSessionManager_ReconnectDesktopSession_ParamsSpec = mojo.internal.bindings.remoting.mojom.DesktopSessionManager_ReconnectDesktopSession_ParamsSpec || { $: {} };
if (mojo.internal.bindings.remoting.mojom.DesktopSessionManager_ReconnectDesktopSession_ParamsSpec.$.structSpec && mojo.internal.bindings.remoting.mojom.DesktopSessionManager_ReconnectDesktopSession_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.remoting.mojom.DesktopSessionManager_ReconnectDesktopSession_ParamsSpec.$ = {};
mojo.internal.bindings.remoting.mojom.DesktopSessionManager_CloseDesktopSession_ParamsSpec = mojo.internal.bindings.remoting.mojom.DesktopSessionManager_CloseDesktopSession_ParamsSpec || { $: {} };
if (mojo.internal.bindings.remoting.mojom.DesktopSessionManager_CloseDesktopSession_ParamsSpec.$.structSpec && mojo.internal.bindings.remoting.mojom.DesktopSessionManager_CloseDesktopSession_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.remoting.mojom.DesktopSessionManager_CloseDesktopSession_ParamsSpec.$ = {};
mojo.internal.bindings.remoting.mojom.DesktopSessionManager_SetScreenResolution_ParamsSpec = mojo.internal.bindings.remoting.mojom.DesktopSessionManager_SetScreenResolution_ParamsSpec || { $: {} };
if (mojo.internal.bindings.remoting.mojom.DesktopSessionManager_SetScreenResolution_ParamsSpec.$.structSpec && mojo.internal.bindings.remoting.mojom.DesktopSessionManager_SetScreenResolution_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.remoting.mojom.DesktopSessionManager_SetScreenResolution_ParamsSpec.$ = {};
...
mojo.internal.bindings.remoting.mojom.DesktopSessionManagerRemote = class {
  ...
  createDesktopSession(arg_terminal_id, arg_options) {
    return this.$.createDesktopSession(arg_terminal_id, arg_options);
  }
  reconnectDesktopSession(arg_terminal_id, arg_options) {
    return this.$.reconnectDesktopSession(arg_terminal_id, arg_options);
  }
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        case 0: {
          ...
          const result = this.impl.createDesktopSession(params.arg_terminal_id, params.arg_options);
          break;
        }
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.remoting.mojom.DesktopSessionManager_ReconnectDesktopSession_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.reconnectDesktopSession');
          const result = this.impl.reconnectDesktopSession(params.arg_terminal_id, params.arg_options);
          break;
        }
        case 2: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
...
mojo.internal.Struct(
    mojo.internal.bindings.remoting.mojom.DesktopSessionManager_CreateDesktopSession_ParamsSpec, 'remoting.mojom.DesktopSessionManager_CreateDesktopSession_Params', [
      ...
      mojo.internal.StructField('arg_options', 8, 0, mojo.internal.bindings.remoting.mojom.DesktopSessionOptionsSpec, null, false, 0, undefined),
    ],
    [[0, 24]]);

mojo.internal.Struct(
    mojo.internal.bindings.remoting.mojom.DesktopSessionManager_ReconnectDesktopSession_ParamsSpec, 'remoting.mojom.DesktopSessionManager_ReconnectDesktopSession_Params', [
      mojo.internal.StructField('arg_terminal_id', 0, 0, mojo.internal.Int32, 0, false, 0, undefined),
      mojo.internal.StructField('arg_options', 8, 0, mojo.internal.bindings.remoting.mojom.DesktopSessionOptionsSpec, null, false, 0, undefined),
    ],
    [[0, 24]]);
