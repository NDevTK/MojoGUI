...
mojo.internal.bindings.storage.mojom.IndexedDBClientStateCheckerRemote = mojo.internal.bindings.storage.mojom.IndexedDBClientStateCheckerRemote || class {};
mojo.internal.bindings.storage.mojom.IndexedDBClientStateCheckerPendingReceiver = mojo.internal.bindings.storage.mojom.IndexedDBClientStateCheckerPendingReceiver || class { constructor(handle) { this.handle = handle; } };
mojo.internal.bindings.storage = mojo.internal.bindings.storage || {};
mojo.internal.bindings.storage.mojom = mojo.internal.bindings.storage.mojom || {};
...
mojo.internal.bindings.storage.mojom.IndexedDBControlTestRemote = mojo.internal.bindings.storage.mojom.IndexedDBControlTestRemote || class {};
mojo.internal.bindings.storage.mojom.IndexedDBControlTestPendingReceiver = mojo.internal.bindings.storage.mojom.IndexedDBControlTestPendingReceiver || class { constructor(handle) { this.handle = handle; } };
mojo.internal.bindings.storage = mojo.internal.bindings.storage || {};
mojo.internal.bindings.storage.mojom = mojo.internal.bindings.storage.mojom || {};
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const message = new mojo.internal.Message(
                ...
                header.ordinal, header.requestId, mojo.internal.bindings.storage.mojom.IndexedDBControl_ForceClose_ResponseParamsSpec.$.structSpec, resp_obj);
        ...
        case 2: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.storage.mojom.IndexedDBControl_DownloadBucketData_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
        ...
        case 3: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.storage.mojom.IndexedDBControl_GetAllBucketsDetails_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
        ...
        case 4: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.storage.mojom.IndexedDBControl_StartMetadataRecording_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
        ...
        case 5: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.storage.mojom.IndexedDBControl_StopMetadataRecording_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
