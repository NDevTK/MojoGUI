...
mojo.internal.bindings.storage.mojom.IndexedDBControlRemote = class {
  ...
  bindIndexedDB(arg_bucket_locator, arg_client_info, arg_receiver) {
    return this.$.bindIndexedDB(arg_bucket_locator, arg_client_info, arg_receiver);
  }
...
mojo.internal.bindings.storage.mojom.IndexedDBControlRemoteCallHandler = class {
  ...
  bindIndexedDB(arg_bucket_locator, arg_client_info, arg_receiver) {
    return this.proxy.sendMessage(
      ...
      null,
      [arg_bucket_locator, arg_client_info, arg_receiver],
      false);
  }
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        case 0: {
          ...
          const result = this.impl.bindIndexedDB(params.arg_bucket_locator, params.arg_client_info, params.arg_receiver);
          break;
        }
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
...
mojo.internal.Struct(
    mojo.internal.bindings.storage.mojom.IndexedDBControl_BindIndexedDB_ParamsSpec, 'storage.mojom.IndexedDBControl_BindIndexedDB_Params', [
      ...
      mojo.internal.StructField('arg_receiver', 16, 0, mojo.internal.InterfaceRequest(mojo.internal.bindings.blink.mojom.IDBFactoryPendingReceiver), null, false, 0, undefined),
    ],
    [[0, 32]]);
