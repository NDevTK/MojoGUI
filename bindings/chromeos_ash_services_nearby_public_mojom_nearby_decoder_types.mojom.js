...
// Enum: SecurityType
mojo.internal.bindings.sharing.mojom.SecurityType = {
...
// Enum: Status
mojo.internal.bindings.sharing.mojom.Status = {
  kUnknown: 0,
  kAccept: 1,
  kReject: 2,
  kNotEnoughSpace: 3,
...
mojo.internal.Struct(
    mojo.internal.bindings.sharing.mojom.PairedKeyEncryptionFrameSpec, 'sharing.mojom.PairedKeyEncryptionFrame', [
      mojo.internal.StructField('arg_signed_data', 0, 0, mojo.internal.Array(mojo.internal.Uint8, false), null, false, 0, undefined),
      mojo.internal.StructField('arg_secret_id_hash', 8, 0, mojo.internal.Array(mojo.internal.Uint8, false), null, false, 0, undefined),
      mojo.internal.StructField('arg_optional_signed_data', 16, 0, mojo.internal.Array(mojo.internal.Uint8, false), null, true, 0, undefined),
    ],
    [[0, 32]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.sharing.mojom.PublicCertificateSpec, 'sharing.mojom.PublicCertificate', [
...
// Struct: CancelFrame
mojo.internal.Struct(
    mojo.internal.bindings.sharing.mojom.CancelFrameSpec, 'sharing.mojom.CancelFrame', [
    ],
    [[0, 8]]);
