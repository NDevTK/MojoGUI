...
mojo.internal.Struct(
    mojo.internal.bindings.arc.mojom.PrintAttributesSpec, 'arc.mojom.PrintAttributes', [
      ...
      mojo.internal.StructField('arg_duplex_mode', 28, 0, mojo.internal.bindings.arc.mojom.PrintDuplexModeSpec, null, false, 0, undefined),
    ],
    [[0, 40]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.arc.mojom.PrintJobRequestSpec, 'arc.mojom.PrintJobRequest', [
      ...
      mojo.internal.StructField('arg_data_size', 56, 0, mojo.internal.Int64, 0, false, 0, undefined),
      mojo.internal.StructField('arg_copies', 64, 0, mojo.internal.Int32, 0, false, 0, undefined),
      mojo.internal.StructField('arg_document_page_count', 68, 0, mojo.internal.Int32, 0, false, 0, undefined),
      mojo.internal.StructField('arg_content_type', 72, 0, mojo.internal.bindings.arc.mojom.PrintContentTypeSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_data', 76, 0, mojo.internal.Handle, null, true, 0, undefined),
    ],
    [[0, 88]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.arc.mojom.PrinterCapabilitiesSpec, 'arc.mojom.PrinterCapabilities', [
      ...
      mojo.internal.StructField('arg_defaults', 24, 0, mojo.internal.bindings.arc.mojom.PrintAttributesSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_color_modes', 32, 0, mojo.internal.bindings.arc.mojom.PrintColorModeSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_duplex_modes', 36, 0, mojo.internal.bindings.arc.mojom.PrintDuplexModeSpec, null, false, 0, undefined),
    ],
    [[0, 48]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.arc.mojom.PrinterInfoSpec, 'arc.mojom.PrinterInfo', [
      ...
      mojo.internal.StructField('arg_info_intent', 24, 0, mojo.internal.String, null, true, 0, undefined),
      mojo.internal.StructField('arg_capabilities', 32, 0, mojo.internal.bindings.arc.mojom.PrinterCapabilitiesSpec, null, true, 0, undefined),
      mojo.internal.StructField('arg_status', 40, 0, mojo.internal.bindings.arc.mojom.PrinterStatusSpec, null, false, 0, undefined),
    ],
    [[0, 56]]);
