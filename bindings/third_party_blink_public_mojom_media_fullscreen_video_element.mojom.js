...
mojo.internal.bindings.blink.mojom.FullscreenVideoElementHandler = {};
mojo.internal.bindings.blink.mojom.FullscreenVideoElementHandlerSpec = { $ : {} };
mojo.internal.bindings.blink.mojom.FullscreenVideoElementHandler.$interfaceName = 'blink.mojom.FullscreenVideoElementHandler';
...
mojo.internal.bindings.blink.mojom.FullscreenVideoElementHandlerRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.blink.mojom.FullscreenVideoElementHandlerPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.blink.mojom.FullscreenVideoElementHandlerRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.blink.mojom.FullscreenVideoElementHandlerRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('blink.mojom.FullscreenVideoElementHandler', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.blink.mojom.FullscreenVideoElementHandler.getRemote = function() {
  let remote = new mojo.internal.bindings.blink.mojom.FullscreenVideoElementHandlerRemote();
...
mojo.internal.bindings.blink.mojom.FullscreenVideoElementHandlerReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('blink.mojom.FullscreenVideoElementHandler', [
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.blink.mojom.FullscreenVideoElementHandler_RequestFullscreenVideoElement_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for RequestFullscreenVideoElement failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.blink.mojom.FullscreenVideoElementHandler_RequestFullscreenVideoElement_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.blink.mojom.FullscreenVideoElementHandlerReceiver = mojo.internal.bindings.blink.mojom.FullscreenVideoElementHandlerReceiver;
