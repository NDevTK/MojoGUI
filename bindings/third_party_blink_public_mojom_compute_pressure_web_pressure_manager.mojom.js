...
mojo.internal.bindings.blink.mojom.WebPressureManagerRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.blink.mojom.WebPressureManagerPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.blink.mojom.WebPressureManagerRemoteCallHandler(this.proxy);
  }
  ...
  addClient(arg_source, arg_client) {
    return this.$.addClient(arg_source, arg_client);
  }
};
...
mojo.internal.bindings.blink.mojom.WebPressureManager.getRemote = function() {
  let remote = new mojo.internal.bindings.blink.mojom.WebPressureManagerRemote();
...
mojo.internal.bindings.blink.mojom.WebPressureManagerReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.blink.mojom.WebPressureManager_AddClient_ParamsSpec.$.structSpec;
...
mojo.internal.bindings.blink.mojom.WebPressureManagerReceiver = mojo.internal.bindings.blink.mojom.WebPressureManagerReceiver;

mojo.internal.bindings.blink.mojom.WebPressureManagerPtr = mojo.internal.bindings.blink.mojom.WebPressureManagerRemote;
mojo.internal.bindings.blink.mojom.WebPressureManagerRequest = mojo.internal.bindings.blink.mojom.WebPressureManagerPendingReceiver;
...
mojo.internal.bindings.blink.mojom.WebPressureClientRemote = class {
  static get $interfaceName() {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.blink.mojom.WebPressureClientPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.blink.mojom.WebPressureClientRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.blink.mojom.WebPressureClient.getRemote = function() {
  let remote = new mojo.internal.bindings.blink.mojom.WebPressureClientRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
...
mojo.internal.bindings.blink.mojom.WebPressureClientReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.blink.mojom.WebPressureClient_OnPressureUpdated_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
...
mojo.internal.bindings.blink.mojom.WebPressureClientReceiver = mojo.internal.bindings.blink.mojom.WebPressureClientReceiver;
