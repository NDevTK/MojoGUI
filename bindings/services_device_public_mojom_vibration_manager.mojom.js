...
mojo.internal.bindings.device.mojom.VibrationManagerRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.device.mojom.VibrationManagerPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.device.mojom.VibrationManagerRemoteCallHandler(this.proxy);
  }
  ...
  vibrate(arg_milliseconds) {
    return this.$.vibrate(arg_milliseconds);
  }
  cancel() {
    return this.$.cancel();
  }
...
mojo.internal.bindings.device.mojom.VibrationManager.getRemote = function() {
  let remote = new mojo.internal.bindings.device.mojom.VibrationManagerRemote();
...
mojo.internal.bindings.device.mojom.VibrationManagerReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.device.mojom.VibrationManager_Vibrate_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for Vibrate failed with TypeError');
           }
        }
        // Try Method 1: Cancel
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.device.mojom.VibrationManager_Cancel_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
      ...
      switch (dispatchId) {
        ...
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.device.mojom.VibrationManager_Cancel_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.device.mojom.VibrationManagerReceiver = mojo.internal.bindings.device.mojom.VibrationManagerReceiver;

mojo.internal.bindings.device.mojom.VibrationManagerPtr = mojo.internal.bindings.device.mojom.VibrationManagerRemote;
mojo.internal.bindings.device.mojom.VibrationManagerRequest = mojo.internal.bindings.device.mojom.VibrationManagerPendingReceiver;
...
mojo.internal.bindings.device.mojom.VibrationManagerListenerRemote = class {
  static get $interfaceName() {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.device.mojom.VibrationManagerListenerPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.device.mojom.VibrationManagerListenerRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.device.mojom.VibrationManagerListener.getRemote = function() {
  let remote = new mojo.internal.bindings.device.mojom.VibrationManagerListenerRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
...
mojo.internal.bindings.device.mojom.VibrationManagerListenerReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.device.mojom.VibrationManagerListener_OnVibrate_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OnVibrate failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
             console.warn('[GeneratedReceiver] Failed to discover ordinal ' + header.ordinal);
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.device.mojom.VibrationManagerListener_OnVibrate_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.device.mojom.VibrationManagerListenerReceiver = mojo.internal.bindings.device.mojom.VibrationManagerListenerReceiver;
