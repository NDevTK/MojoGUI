...
mojo.internal.bindings.blink.mojom.PrerenderTriggerType = {
  kLinkRelPrerender: 0,
  kLinkRelNext: 1,
};
...
mojo.internal.Struct(
    mojo.internal.bindings.blink.mojom.PrerenderAttributesSpec, 'blink.mojom.PrerenderAttributes', [
      ...
      mojo.internal.StructField('arg_trigger_type', 8, 0, mojo.internal.bindings.mojo.internal.bindings.blink.mojom.PrerenderTriggerTypeSpec.$, null, false, 0, undefined),
...
mojo.internal.Struct(
    mojo.internal.bindings.blink.mojom.NoStatePrefetchProcessor_Start_ParamsSpec, 'blink.mojom.NoStatePrefetchProcessor_Start_Params', [
      mojo.internal.StructField('arg_prerender_attribute', 0, 0, mojo.internal.bindings.mojo.internal.bindings.blink.mojom.PrerenderAttributesSpec.$, null, false, 0, undefined),
    ],
    [[0, 16]]);
...
mojo.internal.bindings.blink.mojom.NoStatePrefetchProcessorRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.blink.mojom.NoStatePrefetchProcessorPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.blink.mojom.NoStatePrefetchProcessorRemoteCallHandler(this.proxy);
  }
  ...
  start(arg_prerender_attribute) {
    return this.$.start(arg_prerender_attribute);
  }
  cancel() {
    return this.$.cancel();
  }
...
mojo.internal.bindings.blink.mojom.NoStatePrefetchProcessorRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
...
mojo.internal.bindings.blink.mojom.NoStatePrefetchProcessor.getRemote = function() {
  let remote = new mojo.internal.bindings.blink.mojom.NoStatePrefetchProcessorRemote();
...
mojo.internal.bindings.blink.mojom.NoStatePrefetchProcessorReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.blink.mojom.NoStatePrefetchProcessor_Start_ParamsSpec);
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.blink.mojom.NoStatePrefetchProcessor_Cancel_ParamsSpec);
      ...
      switch (dispatchId) {
        ...
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.blink.mojom.NoStatePrefetchProcessor_Cancel_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.blink.mojom.NoStatePrefetchProcessorReceiver = mojo.internal.bindings.blink.mojom.NoStatePrefetchProcessorReceiver;
