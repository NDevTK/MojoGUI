...
mojo.internal.Struct(
    mojo.internal.bindings.content.mojom.UpdateScrollbarThemeParamsSpec, 'content.mojom.UpdateScrollbarThemeParams', [
      mojo.internal.StructField('arg_preferred_scroller_style', 0, 0, mojo.internal.bindings.content.mojom.ScrollerStyleSpec.$, null, false, 0, undefined),
      mojo.internal.StructField('arg_initial_button_delay', 8, 0, mojo.internal.Float, 0, false, 0, undefined),
      mojo.internal.StructField('arg_autoscroll_button_delay', 12, 0, mojo.internal.Float, 0, false, 0, undefined),
      mojo.internal.StructField('arg_has_initial_button_delay', 16, 0, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_has_autoscroll_button_delay', 16, 1, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_jump_on_track_click', 16, 2, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_redraw', 16, 3, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_scroll_view_rubber_banding', 16, 4, mojo.internal.Bool, false, false, 0, undefined),
    ],
    [[0, 32]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.content.mojom.Renderer_SetIsCrossOriginIsolated_ParamsSpec, 'content.mojom.Renderer_SetIsCrossOriginIsolated_Params', [
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.content.mojom.Renderer_CreateAgentSchedulingGroup_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for CreateAgentSchedulingGroup failed with TypeError');
           }
        }
        // Try Method 1: CreateAssociatedAgentSchedulingGroup
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.content.mojom.Renderer_CreateAssociatedAgentSchedulingGroup_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for CreateAssociatedAgentSchedulingGroup failed with TypeError');
           }
        }
        // Try Method 2: TransferSharedLastForegroundTime
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.content.mojom.Renderer_TransferSharedLastForegroundTime_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for TransferSharedLastForegroundTime failed with TypeError');
           }
        }
        // Try Method 3: OnNetworkConnectionChanged
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.content.mojom.Renderer_OnNetworkConnectionChanged_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OnNetworkConnectionChanged failed with TypeError');
           }
        }
        // Try Method 4: OnNetworkQualityChanged
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.content.mojom.Renderer_OnNetworkQualityChanged_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OnNetworkQualityChanged failed with TypeError');
           }
        }
        // Try Method 5: SetWebKitSharedTimersSuspended
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.content.mojom.Renderer_SetWebKitSharedTimersSuspended_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for SetWebKitSharedTimersSuspended failed with TypeError');
           }
        }
        // Try Method 6: UpdateScrollbarTheme
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.content.mojom.Renderer_UpdateScrollbarTheme_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for UpdateScrollbarTheme failed with TypeError');
           }
        }
        // Try Method 7: OnSystemColorsChanged
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.content.mojom.Renderer_OnSystemColorsChanged_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OnSystemColorsChanged failed with TypeError');
           }
        }
        // Try Method 8: UpdateSystemColorInfo
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.content.mojom.Renderer_UpdateSystemColorInfo_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for UpdateSystemColorInfo failed with TypeError');
           }
        }
        // Try Method 9: PurgePluginListCache
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.content.mojom.Renderer_PurgePluginListCache_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for PurgePluginListCache failed with TypeError');
           }
        }
        // Try Method 10: PurgeResourceCache
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.content.mojom.Renderer_PurgeResourceCache_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for PurgeResourceCache failed with TypeError');
           }
        }
        // Try Method 11: SetProcessState
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.content.mojom.Renderer_SetProcessState_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for SetProcessState failed with TypeError');
           }
        }
        // Try Method 12: SetIsLockedToSite
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.content.mojom.Renderer_SetIsLockedToSite_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for SetIsLockedToSite failed with TypeError');
           }
        }
        // Try Method 13: WriteClangProfilingProfile
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.content.mojom.Renderer_WriteClangProfilingProfile_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.content.mojom.Renderer_SetIsCrossOriginIsolated_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for SetIsCrossOriginIsolated failed with TypeError');
           }
        }
        // Try Method 15: SetIsWebSecurityDisabled
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.content.mojom.Renderer_SetIsWebSecurityDisabled_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for SetIsWebSecurityDisabled failed with TypeError');
           }
        }
        // Try Method 16: SetIsIsolatedContext
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.content.mojom.Renderer_SetIsIsolatedContext_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for SetIsIsolatedContext failed with TypeError');
           }
        }
        // Try Method 17: SetWebUIResourceUrlToCodeCacheMap
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.content.mojom.Renderer_SetWebUIResourceUrlToCodeCacheMap_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for SetWebUIResourceUrlToCodeCacheMap failed with TypeError');
           }
        }
        // Try Method 18: InitializeRenderer
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.content.mojom.Renderer_InitializeRenderer_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for InitializeRenderer failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
      ...
      switch (dispatchId) {
        ...
        case 10: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              this.endpoint.send(header.ordinal, header.requestId, mojo.internal.kMessageFlagIsResponse, mojo.internal.bindings.content.mojom.Renderer_PurgeResourceCache_ResponseParamsSpec, response);
        ...
        case 13: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              this.endpoint.send(header.ordinal, header.requestId, mojo.internal.kMessageFlagIsResponse, mojo.internal.bindings.content.mojom.Renderer_WriteClangProfilingProfile_ResponseParamsSpec, response);
        ...
        case 14: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.content.mojom.Renderer_SetIsCrossOriginIsolated_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.setIsCrossOriginIsolated');
          const result = this.impl.setIsCrossOriginIsolated(params.arg_value);
          break;
        }
        case 15: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
