...
mojo.internal.bindings.media.mojom.MediaDrmSupportSpec = { $ : {} };
...
mojo.internal.bindings.media.mojom.MediaDrmSupportRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('media.mojom.MediaDrmSupport', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.media.mojom.MediaDrmSupportReceiver = class {
  constructor(impl) {
    ...
    const ordinals = window.mojoScrambler.getOrdinals('media.mojom.MediaDrmSupport', [
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.media.mojom.MediaDrmSupport_IsKeySystemSupported_ParamsSpec.$.structSpec);
