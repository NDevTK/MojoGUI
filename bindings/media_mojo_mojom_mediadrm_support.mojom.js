...
mojo.internal.bindings.media.mojom.MediaDrmSupportResultSpec = { $: {} };
mojo.internal.bindings.media.mojom.MediaDrmSupport = {};
mojo.internal.bindings.media.mojom.MediaDrmSupport.$interfaceName = 'media.mojom.MediaDrmSupport';
...
mojo.internal.Struct(
    mojo.internal.bindings.media.mojom.MediaDrmSupport_IsKeySystemSupported_ResponseParamsSpec, 'media.mojom.MediaDrmSupport_IsKeySystemSupported_ResponseParams', [
      mojo.internal.StructField('arg_key_system_supports', 0, 0, mojo.internal.bindings.mojo.internal.bindings.media.mojom.MediaDrmSupportResultSpec.$, null, true, 0, undefined),
    ],
    [[0, 16]]);
...
mojo.internal.bindings.media.mojom.MediaDrmSupportRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.media.mojom.MediaDrmSupportPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.media.mojom.MediaDrmSupportRemoteCallHandler(this.proxy);
  }
  ...
  isKeySystemSupported(arg_key_system, arg_is_secure) {
    return this.$.isKeySystemSupported(arg_key_system, arg_is_secure);
  }
};

mojo.internal.bindings.media.mojom.MediaDrmSupportRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('MediaDrmSupport', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.media.mojom.MediaDrmSupport.getRemote = function() {
  let remote = new mojo.internal.bindings.media.mojom.MediaDrmSupportRemote();
...
mojo.internal.bindings.media.mojom.MediaDrmSupportReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('MediaDrmSupport', [
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.media.mojom.MediaDrmSupport_IsKeySystemSupported_ParamsSpec);
        ...
        case 0: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.media.mojom.MediaDrmSupport_IsKeySystemSupported_ResponseParamsSpec, header, rawHeader);
               responder(response);
...
mojo.internal.bindings.media.mojom.MediaDrmSupportReceiver = mojo.internal.bindings.media.mojom.MediaDrmSupportReceiver;
