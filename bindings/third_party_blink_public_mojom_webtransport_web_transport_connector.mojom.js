  ...
  $: {
    structSpec: {
      ...
      fields: [
        ...
        { name: 'fingerprints', packedOffset: 8, packedBitOffset: 0, type: mojo.internal.String, nullable: true },
        { name: 'application_protocols', packedOffset: 16, packedBitOffset: 0, type: mojo.internal.String, nullable: true },
