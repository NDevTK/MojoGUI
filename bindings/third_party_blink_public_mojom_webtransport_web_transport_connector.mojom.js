...
mojo.internal.bindings.blink.mojom.WebTransportConnector = {};
mojo.internal.bindings.blink.mojom.WebTransportConnectorSpec = { $ : {} };
mojo.internal.bindings.blink.mojom.WebTransportConnector.$interfaceName = 'blink.mojom.WebTransportConnector';
...
mojo.internal.bindings.blink.mojom.WebTransportConnectorRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.blink.mojom.WebTransportConnectorPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.blink.mojom.WebTransportConnectorRemoteCallHandler(this.proxy);
  }
  ...
  connect(arg_url, arg_fingerprints, arg_application_protocols, arg_client) {
    return this.$.connect(arg_url, arg_fingerprints, arg_application_protocols, arg_client);
  }
};

mojo.internal.bindings.blink.mojom.WebTransportConnectorRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('blink.mojom.WebTransportConnector', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.blink.mojom.WebTransportConnector.getRemote = function() {
  let remote = new mojo.internal.bindings.blink.mojom.WebTransportConnectorRemote();
...
mojo.internal.bindings.blink.mojom.WebTransportConnectorReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('blink.mojom.WebTransportConnector', [
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.blink.mojom.WebTransportConnector_Connect_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.blink.mojom.WebTransportConnectorReceiver = mojo.internal.bindings.blink.mojom.WebTransportConnectorReceiver;
