...
mojo.internal.Struct(
    mojo.internal.bindings.ash.wifi_direct.mojom.WifiDirectConnectionPropertiesSpec, 'ash.wifi_direct.mojom.WifiDirectConnectionProperties', [
      ...
      mojo.internal.StructField('arg_ipv4_address', 8, 0, mojo.internal.String, null, false, 0, undefined),
      mojo.internal.StructField('arg_frequency', 16, 0, mojo.internal.Uint32, 0, false, 0, undefined),
    ],
    [[0, 32]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.ash.wifi_direct.mojom.WifiDirectManager_CreateWifiDirectGroup_ResponseParamsSpec, 'ash.wifi_direct.mojom.WifiDirectManager_CreateWifiDirectGroup_ResponseParams', [
      mojo.internal.StructField('arg_wifi_direct_connection', 0, 0, mojo.internal.InterfaceProxy(mojo.internal.bindings.ash.wifi_direct.mojom.WifiDirectConnectionRemote), null, true, 0, undefined),
      mojo.internal.StructField('arg_result', 8, 0, mojo.internal.bindings.ash.wifi_direct.mojom.WifiDirectOperationResultSpec, null, false, 0, undefined),
    ],
    [[0, 24]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.ash.wifi_direct.mojom.WifiDirectManager_ConnectToWifiDirectGroup_ParamsSpec, 'ash.wifi_direct.mojom.WifiDirectManager_ConnectToWifiDirectGroup_Params', [
      mojo.internal.StructField('arg_credentials', 0, 0, mojo.internal.bindings.ash.wifi_direct.mojom.WifiCredentialsSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_frequency_$value', 8, 0, mojo.internal.Uint32, 0, false, 0, { isPrimary: false, linkedValueFieldName: 'arg_frequency_$flag', originalFieldName: 'arg_frequency' }),
      mojo.internal.StructField('arg_frequency_$flag', 12, 0, mojo.internal.Bool, false, false, 0, { isPrimary: true, linkedValueFieldName: 'arg_frequency_$value', originalFieldName: 'arg_frequency' }),
    ],
    [[0, 24]]);
...
mojo.internal.bindings.ash.wifi_direct.mojom.WifiDirectManagerRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.ash.wifi_direct.mojom.WifiDirectManagerRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.ash.wifi_direct.mojom.WifiDirectManager.getRemote = function() {
  let remote = new mojo.internal.bindings.ash.wifi_direct.mojom.WifiDirectManagerRemote();
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ash.wifi_direct.mojom.WifiDirectManager_CreateWifiDirectGroup_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for CreateWifiDirectGroup failed with TypeError');
           }
        }
        // Try Method 1: ConnectToWifiDirectGroup
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ash.wifi_direct.mojom.WifiDirectManager_ConnectToWifiDirectGroup_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for ConnectToWifiDirectGroup failed with TypeError');
           }
        }
        // Try Method 2: GetWifiP2PCapabilities
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ash.wifi_direct.mojom.WifiDirectManager_GetWifiP2PCapabilities_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for GetWifiP2PCapabilities failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
      ...
      switch (dispatchId) {
        ...
        case 2: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.ash.wifi_direct.mojom.WifiDirectManager_GetWifiP2PCapabilities_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.ash.wifi_direct.mojom.WifiDirectManagerReceiver = mojo.internal.bindings.ash.wifi_direct.mojom.WifiDirectManagerReceiver;

mojo.internal.bindings.ash.wifi_direct.mojom.WifiDirectManagerPtr = mojo.internal.bindings.ash.wifi_direct.mojom.WifiDirectManagerRemote;
mojo.internal.bindings.ash.wifi_direct.mojom.WifiDirectManagerRequest = mojo.internal.bindings.ash.wifi_direct.mojom.WifiDirectManagerPendingReceiver;
...
mojo.internal.Struct(
    mojo.internal.bindings.ash.wifi_direct.mojom.WifiDirectConnection_AssociateSocket_ParamsSpec, 'ash.wifi_direct.mojom.WifiDirectConnection_AssociateSocket_Params', [
      mojo.internal.StructField('arg_socket', 0, 0, mojo.internal.Pointer, null, false, 0, undefined),
    ],
    [[0, 16]]);
...
mojo.internal.bindings.ash.wifi_direct.mojom.WifiDirectConnectionRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.ash.wifi_direct.mojom.WifiDirectConnectionRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.ash.wifi_direct.mojom.WifiDirectConnection.getRemote = function() {
  let remote = new mojo.internal.bindings.ash.wifi_direct.mojom.WifiDirectConnectionRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ash.wifi_direct.mojom.WifiDirectConnection_GetProperties_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ash.wifi_direct.mojom.WifiDirectConnection_AssociateSocket_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for AssociateSocket failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
             console.warn('[GeneratedReceiver] Failed to discover ordinal ' + header.ordinal);
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.ash.wifi_direct.mojom.WifiDirectConnection_GetProperties_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.ash.wifi_direct.mojom.WifiDirectConnectionReceiver = mojo.internal.bindings.ash.wifi_direct.mojom.WifiDirectConnectionReceiver;
