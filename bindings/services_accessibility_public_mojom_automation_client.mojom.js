...
mojo.internal.bindings.ax.mojom.AutomationClientRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.ax.mojom.AutomationClientPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.ax.mojom.AutomationClientRemoteCallHandler(this.proxy);
  }
  ...
  enableChildTree(arg_tree_id) {
    return this.$.enableChildTree(arg_tree_id);
  }
...
mojo.internal.bindings.ax.mojom.AutomationClient.getRemote = function() {
  let remote = new mojo.internal.bindings.ax.mojom.AutomationClientRemote();
...
mojo.internal.bindings.ax.mojom.AutomationClientReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ax.mojom.AutomationClient_Enable_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for Enable failed with TypeError');
           }
        }
        // Try Method 1: Disable
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ax.mojom.AutomationClient_Disable_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for Disable failed with TypeError');
           }
        }
        // Try Method 2: EnableChildTree
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ax.mojom.AutomationClient_EnableChildTree_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for EnableChildTree failed with TypeError');
           }
        }
        // Try Method 3: PerformAction
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ax.mojom.AutomationClient_PerformAction_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.ax.mojom.AutomationClient_Enable_ParamsSpec.$.structSpec);
        ...
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.ax.mojom.AutomationClient_Disable_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.ax.mojom.AutomationClientReceiver = mojo.internal.bindings.ax.mojom.AutomationClientReceiver;
