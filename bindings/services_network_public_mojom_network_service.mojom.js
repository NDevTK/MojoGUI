...
mojo.internal.bindings.network.mojom.NetworkServiceRemote = class {
  ...
  setMaxConnectionsPerProxyChain(arg_max_connections_normal, arg_max_connections_websocket) {
    return this.$.setMaxConnectionsPerProxyChain(arg_max_connections_normal, arg_max_connections_websocket);
  }
...
mojo.internal.bindings.network.mojom.NetworkServiceRemoteCallHandler = class {
  ...
  setMaxConnectionsPerProxyChain(arg_max_connections_normal, arg_max_connections_websocket) {
    return this.proxy.sendMessage(
      ...
      mojo.internal.bindings.network.mojom.NetworkService_SetMaxConnectionsPerProxyChain_ParamsSpec,
      null,
      [arg_max_connections_normal, arg_max_connections_websocket],
      false);
  }
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        ...
        case 10: {
          ...
          const result = this.impl.setMaxConnectionsPerProxyChain(params.arg_max_connections_normal, params.arg_max_connections_websocket);
          break;
        }
        case 11: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
