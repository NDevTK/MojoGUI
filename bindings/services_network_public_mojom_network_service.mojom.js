...
mojo.internal.bindings.network = mojo.internal.bindings.network || {};
mojo.internal.bindings.network.mojom = mojo.internal.bindings.network.mojom || {};
mojo.internal.bindings.network.mojom.RendererProcessSpec = mojo.internal.bindings.network.mojom.RendererProcessSpec || { $: mojo.internal.OpaqueStruct.$ };
mojo.internal.bindings.network = mojo.internal.bindings.network || {};
mojo.internal.bindings.network.mojom = mojo.internal.bindings.network.mojom || {};
...
mojo.internal.Struct(
    mojo.internal.bindings.network.mojom.NetworkService_SetRawHeadersAccess_ParamsSpec, 'network.mojom.NetworkService_SetRawHeadersAccess_Params', [
      mojo.internal.StructField('arg_process_id', 0, 0, mojo.internal.bindings.network.mojom.RendererProcessSpec, null, false, 0, undefined),
