...
mojo.internal.Struct(
    mojo.internal.bindings.network.mojom.NetworkServiceParamsSpec, 'network.mojom.NetworkServiceParams', [
      mojo.internal.StructField('arg_initial_address_map', 0, 0, mojo.internal.bindings.network.mojom.InitialAddressMapSpec, null, true, 0, undefined),
      mojo.internal.StructField('arg_environment', 8, 0, mojo.internal.Array(mojo.internal.bindings.network.mojom.EnvironmentVariableSpec, false), null, false, 0, undefined),
      mojo.internal.StructField('arg_default_observer', 16, 0, mojo.internal.InterfaceProxy(mojo.internal.bindings.network.mojom.URLLoaderNetworkServiceObserverRemote), null, false, 0, undefined),
      mojo.internal.StructField('arg_system_dns_resolver', 24, 0, mojo.internal.InterfaceProxy(mojo.internal.bindings.network.mojom.SystemDnsResolverRemote), null, true, 0, undefined),
      mojo.internal.StructField('arg_initial_connection_type', 32, 0, mojo.internal.bindings.network.mojom.ConnectionTypeSpec, 0, false, 0, undefined),
      mojo.internal.StructField('arg_initial_connection_subtype', 36, 0, mojo.internal.bindings.network.mojom.ConnectionSubtypeSpec, 0, false, 0, undefined),
      mojo.internal.StructField('arg_first_party_sets_enabled', 40, 0, mojo.internal.Bool, false, false, 0, undefined),
    ],
    [[0, 56]]);
...
mojo.internal.bindings.network.mojom.GssapiLibraryLoadObserverRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('network.mojom.GssapiLibraryLoadObserver', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.network.mojom.GssapiLibraryLoadObserverReceiver = class {
  constructor(impl) {
    ...
    const ordinals = window.mojoScrambler.getOrdinals('network.mojom.GssapiLibraryLoadObserver', [
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.network.mojom.GssapiLibraryLoadObserver_OnBeforeGssapiLibraryLoad_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OnBeforeGssapiLibraryLoad failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.Struct(
    mojo.internal.bindings.network.mojom.NetworkService_StartNetLog_ParamsSpec, 'network.mojom.NetworkService_StartNetLog_Params', [
      ...
      mojo.internal.StructField('arg_constants', 16, 0, mojo.internal.bindings.mojo_base.mojom.DictionaryValueSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_duration', 24, 0, mojo.internal.bindings.mojo_base.mojom.TimeDeltaSpec, null, true, 0, undefined),
      mojo.internal.StructField('arg_capture_mode', 32, 0, mojo.internal.bindings.network.mojom.NetLogCaptureModeSpec, null, false, 0, undefined),
    ],
    [[0, 48]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.network.mojom.NetworkService_ConfigureStubHostResolver_ParamsSpec, 'network.mojom.NetworkService_ConfigureStubHostResolver_Params', [
      mojo.internal.StructField('arg_dns_over_https_config', 0, 0, mojo.internal.bindings.network.mojom.DnsOverHttpsConfigSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_fallback_doh_nameservers', 8, 0, mojo.internal.Array(mojo.internal.bindings.network.mojom.IPEndPointSpec, false), null, false, 0, undefined),
      mojo.internal.StructField('arg_secure_dns_mode', 16, 0, mojo.internal.bindings.network.mojom.SecureDnsModeSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_insecure_dns_client_enabled', 20, 0, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_happy_eyeballs_v3_enabled', 20, 1, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_additional_dns_types_enabled', 20, 2, mojo.internal.Bool, false, false, 0, undefined),
    ],
    [[0, 32]]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.network.mojom.NetworkService_SetParams_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for SetParams failed with TypeError');
           }
        }
        // Try Method 1: StartNetLog
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.network.mojom.NetworkService_StartNetLog_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for StartNetLog failed with TypeError');
           }
        }
        // Try Method 2: AttachNetLogProxy
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.network.mojom.NetworkService_AttachNetLogProxy_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for AttachNetLogProxy failed with TypeError');
           }
        }
        // Try Method 3: SetSSLKeyLogFile
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.network.mojom.NetworkService_SetSSLKeyLogFile_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for SetSSLKeyLogFile failed with TypeError');
           }
        }
        // Try Method 4: CreateNetworkContext
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.network.mojom.NetworkService_CreateNetworkContext_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for CreateNetworkContext failed with TypeError');
           }
        }
        // Try Method 5: ConfigureStubHostResolver
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.network.mojom.NetworkService_ConfigureStubHostResolver_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for ConfigureStubHostResolver failed with TypeError');
           }
        }
        // Try Method 6: DisableQuic
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.network.mojom.NetworkService_DisableQuic_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for DisableQuic failed with TypeError');
           }
        }
        // Try Method 7: SetUpHttpAuth
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.network.mojom.NetworkService_SetUpHttpAuth_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for SetUpHttpAuth failed with TypeError');
           }
        }
        // Try Method 8: ConfigureHttpAuthPrefs
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.network.mojom.NetworkService_ConfigureHttpAuthPrefs_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for ConfigureHttpAuthPrefs failed with TypeError');
           }
        }
        // Try Method 9: SetRawHeadersAccess
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.network.mojom.NetworkService_SetRawHeadersAccess_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for SetRawHeadersAccess failed with TypeError');
           }
        }
        // Try Method 10: SetMaxConnectionsPerProxyChain
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.network.mojom.NetworkService_SetMaxConnectionsPerProxyChain_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for SetMaxConnectionsPerProxyChain failed with TypeError');
           }
        }
        // Try Method 11: GetNetworkChangeManager
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.network.mojom.NetworkService_GetNetworkChangeManager_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for GetNetworkChangeManager failed with TypeError');
           }
        }
        // Try Method 12: GetNetworkQualityEstimatorManager
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.network.mojom.NetworkService_GetNetworkQualityEstimatorManager_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for GetNetworkQualityEstimatorManager failed with TypeError');
           }
        }
        // Try Method 13: GetDnsConfigChangeManager
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.network.mojom.NetworkService_GetDnsConfigChangeManager_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for GetDnsConfigChangeManager failed with TypeError');
           }
        }
        // Try Method 14: GetNetworkList
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.network.mojom.NetworkService_GetNetworkList_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for GetNetworkList failed with TypeError');
           }
        }
        // Try Method 15: OnTrustStoreChanged
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.network.mojom.NetworkService_OnTrustStoreChanged_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OnTrustStoreChanged failed with TypeError');
           }
        }
        // Try Method 16: OnClientCertStoreChanged
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.network.mojom.NetworkService_OnClientCertStoreChanged_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OnClientCertStoreChanged failed with TypeError');
           }
        }
        // Try Method 17: SetEncryptionKey
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.network.mojom.NetworkService_SetEncryptionKey_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for SetEncryptionKey failed with TypeError');
           }
        }
        // Try Method 18: OnPeerToPeerConnectionsCountChange
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.network.mojom.NetworkService_OnPeerToPeerConnectionsCountChange_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
        ...
        if (dispatchId === undefined) {
           try {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for AddDurableMessageCollector failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
             console.warn('[GeneratedReceiver] Failed to discover ordinal ' + header.ordinal);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.network.mojom.DurableMessageCollector_Configure_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for Configure failed with TypeError');
           }
        }
        // Try Method 1: EnableForProfile
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.network.mojom.DurableMessageCollector_EnableForProfile_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for EnableForProfile failed with TypeError');
           }
        }
        // Try Method 2: DisableForProfile
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.network.mojom.DurableMessageCollector_DisableForProfile_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for DisableForProfile failed with TypeError');
           }
        }
        // Try Method 3: Retrieve
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.network.mojom.DurableMessageCollector_Retrieve_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for Retrieve failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
             console.warn('[GeneratedReceiver] Failed to discover ordinal ' + header.ordinal);
