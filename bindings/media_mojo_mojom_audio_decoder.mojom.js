...
mojo.internal.bindings.media.mojom.SupportedAudioDecoderConfigSpec = mojo.internal.bindings.media.mojom.SupportedAudioDecoderConfigSpec || { $: {} };
if (mojo.internal.bindings.media.mojom.SupportedAudioDecoderConfigSpec.$.structSpec && mojo.internal.bindings.media.mojom.SupportedAudioDecoderConfigSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.media.mojom.SupportedAudioDecoderConfigSpec.$ = {};
mojo.internal.bindings.media.mojom.AudioDecoder = mojo.internal.bindings.media.mojom.AudioDecoder || {};
mojo.internal.bindings.media.mojom.AudioDecoderSpec = mojo.internal.bindings.media.mojom.AudioDecoderSpec || { $ : {} };
if (mojo.internal.bindings.media.mojom.AudioDecoderSpec.$.structSpec && mojo.internal.bindings.media.mojom.AudioDecoderSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.media.mojom.AudioDecoderSpec.$ = {};
mojo.internal.bindings.media.mojom.AudioDecoder.$interfaceName = 'media.mojom.AudioDecoder';
mojo.internal.bindings.media.mojom.AudioDecoder_GetSupportedConfigs_ParamsSpec = mojo.internal.bindings.media.mojom.AudioDecoder_GetSupportedConfigs_ParamsSpec || { $: {} };
if (mojo.internal.bindings.media.mojom.AudioDecoder_GetSupportedConfigs_ParamsSpec.$.structSpec && mojo.internal.bindings.media.mojom.AudioDecoder_GetSupportedConfigs_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.media.mojom.AudioDecoder_GetSupportedConfigs_ParamsSpec.$ = {};
mojo.internal.bindings.media.mojom.AudioDecoder_GetSupportedConfigs_ResponseParamsSpec = mojo.internal.bindings.media.mojom.AudioDecoder_GetSupportedConfigs_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.media.mojom.AudioDecoder_GetSupportedConfigs_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.media.mojom.AudioDecoder_GetSupportedConfigs_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.media.mojom.AudioDecoder_GetSupportedConfigs_ResponseParamsSpec.$ = {};
mojo.internal.bindings.media.mojom.AudioDecoder_Construct_ParamsSpec = mojo.internal.bindings.media.mojom.AudioDecoder_Construct_ParamsSpec || { $: {} };
if (mojo.internal.bindings.media.mojom.AudioDecoder_Construct_ParamsSpec.$.structSpec && mojo.internal.bindings.media.mojom.AudioDecoder_Construct_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.media.mojom.AudioDecoder_Construct_ParamsSpec.$ = {};
mojo.internal.bindings.media.mojom.AudioDecoder_Initialize_ParamsSpec = mojo.internal.bindings.media.mojom.AudioDecoder_Initialize_ParamsSpec || { $: {} };
if (mojo.internal.bindings.media.mojom.AudioDecoder_Initialize_ParamsSpec.$.structSpec && mojo.internal.bindings.media.mojom.AudioDecoder_Initialize_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.media.mojom.AudioDecoder_Initialize_ParamsSpec.$ = {};
mojo.internal.bindings.media.mojom.AudioDecoder_Initialize_ResponseParamsSpec = mojo.internal.bindings.media.mojom.AudioDecoder_Initialize_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.media.mojom.AudioDecoder_Initialize_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.media.mojom.AudioDecoder_Initialize_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.media.mojom.AudioDecoder_Initialize_ResponseParamsSpec.$ = {};
mojo.internal.bindings.media.mojom.AudioDecoder_SetDataSource_ParamsSpec = mojo.internal.bindings.media.mojom.AudioDecoder_SetDataSource_ParamsSpec || { $: {} };
if (mojo.internal.bindings.media.mojom.AudioDecoder_SetDataSource_ParamsSpec.$.structSpec && mojo.internal.bindings.media.mojom.AudioDecoder_SetDataSource_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.media.mojom.AudioDecoder_SetDataSource_ParamsSpec.$ = {};
mojo.internal.bindings.media.mojom.AudioDecoder_Decode_ParamsSpec = mojo.internal.bindings.media.mojom.AudioDecoder_Decode_ParamsSpec || { $: {} };
if (mojo.internal.bindings.media.mojom.AudioDecoder_Decode_ParamsSpec.$.structSpec && mojo.internal.bindings.media.mojom.AudioDecoder_Decode_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.media.mojom.AudioDecoder_Decode_ParamsSpec.$ = {};
mojo.internal.bindings.media.mojom.AudioDecoder_Decode_ResponseParamsSpec = mojo.internal.bindings.media.mojom.AudioDecoder_Decode_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.media.mojom.AudioDecoder_Decode_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.media.mojom.AudioDecoder_Decode_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.media.mojom.AudioDecoder_Decode_ResponseParamsSpec.$ = {};
mojo.internal.bindings.media.mojom.AudioDecoder_Reset_ParamsSpec = mojo.internal.bindings.media.mojom.AudioDecoder_Reset_ParamsSpec || { $: {} };
if (mojo.internal.bindings.media.mojom.AudioDecoder_Reset_ParamsSpec.$.structSpec && mojo.internal.bindings.media.mojom.AudioDecoder_Reset_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.media.mojom.AudioDecoder_Reset_ParamsSpec.$ = {};
mojo.internal.bindings.media.mojom.AudioDecoder_Reset_ResponseParamsSpec = mojo.internal.bindings.media.mojom.AudioDecoder_Reset_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.media.mojom.AudioDecoder_Reset_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.media.mojom.AudioDecoder_Reset_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.media.mojom.AudioDecoder_Reset_ResponseParamsSpec.$ = {};
mojo.internal.bindings.media.mojom.AudioDecoderClient = mojo.internal.bindings.media.mojom.AudioDecoderClient || {};
mojo.internal.bindings.media.mojom.AudioDecoderClientSpec = mojo.internal.bindings.media.mojom.AudioDecoderClientSpec || { $ : {} };
if (mojo.internal.bindings.media.mojom.AudioDecoderClientSpec.$.structSpec && mojo.internal.bindings.media.mojom.AudioDecoderClientSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.media.mojom.AudioDecoderClientSpec.$ = {};
mojo.internal.bindings.media.mojom.AudioDecoderClient.$interfaceName = 'media.mojom.AudioDecoderClient';
mojo.internal.bindings.media.mojom.AudioDecoderClient_OnBufferDecoded_ParamsSpec = mojo.internal.bindings.media.mojom.AudioDecoderClient_OnBufferDecoded_ParamsSpec || { $: {} };
if (mojo.internal.bindings.media.mojom.AudioDecoderClient_OnBufferDecoded_ParamsSpec.$.structSpec && mojo.internal.bindings.media.mojom.AudioDecoderClient_OnBufferDecoded_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.media.mojom.AudioDecoderClient_OnBufferDecoded_ParamsSpec.$ = {};
mojo.internal.bindings.media.mojom.AudioDecoderClient_OnWaiting_ParamsSpec = mojo.internal.bindings.media.mojom.AudioDecoderClient_OnWaiting_ParamsSpec || { $: {} };
if (mojo.internal.bindings.media.mojom.AudioDecoderClient_OnWaiting_ParamsSpec.$.structSpec && mojo.internal.bindings.media.mojom.AudioDecoderClient_OnWaiting_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.media.mojom.AudioDecoderClient_OnWaiting_ParamsSpec.$ = {};
...
mojo.internal.bindings.media.mojom.AudioDecoderPendingReceiver = class {
  constructor(handle) {
    this.handle = handle;
    if (handle) {
...
mojo.internal.bindings.media.mojom.AudioDecoderRemote = class {
  ...
  constructor(handle = undefined) {
    ...
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.media.mojom.AudioDecoderPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.media.mojom.AudioDecoderRemoteCallHandler(this.proxy);
  }
  ...
  construct(arg_client, arg_media_log) {
    return this.$.construct(arg_client, arg_media_log);
  }
  initialize(arg_config, arg_cdm_id) {
    return this.$.initialize(arg_config, arg_cdm_id);
  }
  setDataSource(arg_receive_pipe) {
    return this.$.setDataSource(arg_receive_pipe);
  }
  decode(arg_buffer) {
...
mojo.internal.bindings.media.mojom.AudioDecoderRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('media.mojom.AudioDecoder', [
      { explicit: null },
      { explicit: null },
      { explicit: null },
      { explicit: null },
  ...
  getSupportedConfigs() {
    return this.proxy.sendMessage(
      ...
      mojo.internal.bindings.media.mojom.AudioDecoder_GetSupportedConfigs_ParamsSpec,
      mojo.internal.bindings.media.mojom.AudioDecoder_GetSupportedConfigs_ResponseParamsSpec,
      [],
      false);
  }
  ...
  construct(arg_client, arg_media_log) {
    return this.proxy.sendMessage(
      ...
      mojo.internal.bindings.media.mojom.AudioDecoder_Construct_ParamsSpec,
      null,
      [arg_client, arg_media_log],
      false);
  }
  ...
  initialize(arg_config, arg_cdm_id) {
    return this.proxy.sendMessage(
      ...
      mojo.internal.bindings.media.mojom.AudioDecoder_Initialize_ParamsSpec,
      mojo.internal.bindings.media.mojom.AudioDecoder_Initialize_ResponseParamsSpec,
      [arg_config, arg_cdm_id],
      false);
  }
  ...
  setDataSource(arg_receive_pipe) {
    return this.proxy.sendMessage(
      ...
      mojo.internal.bindings.media.mojom.AudioDecoder_SetDataSource_ParamsSpec,
      null,
      [arg_receive_pipe],
      false);
  }
  ...
  decode(arg_buffer) {
    return this.proxy.sendMessage(
      ...
      mojo.internal.bindings.media.mojom.AudioDecoder_Decode_ParamsSpec,
      mojo.internal.bindings.media.mojom.AudioDecoder_Decode_ResponseParamsSpec,
      [arg_buffer],
      false);
  }
  ...
  reset() {
    return this.proxy.sendMessage(
      ...
      mojo.internal.bindings.media.mojom.AudioDecoder_Reset_ParamsSpec,
      mojo.internal.bindings.media.mojom.AudioDecoder_Reset_ResponseParamsSpec,
      [],
      false);
  }
...
mojo.internal.bindings.media.mojom.AudioDecoder.getRemote = function() {
  let remote = new mojo.internal.bindings.media.mojom.AudioDecoderRemote();
...
mojo.internal.bindings.media.mojom.AudioDecoderReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('media.mojom.AudioDecoder', [
      { explicit: null },
      { explicit: null },
      { explicit: null },
      { explicit: null },
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        case 0: {
          ...
          const params = decoder.decodeStructInline(mojo.internal.bindings.media.mojom.AudioDecoder_GetSupportedConfigs_ParamsSpec.$.structSpec);
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const resp_obj = { 'arg_supported_configs': val };
        ...
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.media.mojom.AudioDecoder_Construct_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.construct');
          const result = this.impl.construct(params.arg_client, params.arg_media_log);
          break;
        }
        case 2: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.media.mojom.AudioDecoder_Initialize_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.initialize');
          const result = this.impl.initialize(params.arg_config, params.arg_cdm_id);
          const expectsResponse = header.expectsResponse || (header.flags & 1);
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
        ...
        case 3: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.media.mojom.AudioDecoder_SetDataSource_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.setDataSource');
          const result = this.impl.setDataSource(params.arg_receive_pipe);
          break;
        }
        case 4: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.media.mojom.AudioDecoder_Decode_ParamsSpec.$.structSpec);
        ...
        case 5: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.media.mojom.AudioDecoder_Reset_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.media.mojom.AudioDecoderReceiver = mojo.internal.bindings.media.mojom.AudioDecoderReceiver;

mojo.internal.bindings.media.mojom.AudioDecoderPtr = mojo.internal.bindings.media.mojom.AudioDecoderRemote;
mojo.internal.bindings.media.mojom.AudioDecoderRequest = mojo.internal.bindings.media.mojom.AudioDecoderPendingReceiver;


// Interface: AudioDecoderClient
mojo.internal.bindings.media.mojom.AudioDecoderClientPendingReceiver = class {
  constructor(handle) {
    this.handle = handle;
    if (handle) {
      this.__mojoHandle = handle.router_ ? handle.router_.pipe_ : (handle.pipe_ || handle);
...
mojo.internal.bindings.media.mojom.AudioDecoderClientRemote = class {
  static get $interfaceName() {
  ...
  constructor(handle = undefined) {
    this.__mojoHandle = handle;
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.media.mojom.AudioDecoderClientPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.media.mojom.AudioDecoderClientRemoteCallHandler(this.proxy);
  }
  ...
  onBufferDecoded(arg_buffer) {
    return this.$.onBufferDecoded(arg_buffer);
  }
...
mojo.internal.bindings.media.mojom.AudioDecoderClientRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('media.mojom.AudioDecoderClient', [
      { explicit: null },
      { explicit: null },
    ]);
  }
  ...
  onBufferDecoded(arg_buffer) {
    return this.proxy.sendMessage(
      this.ordinals[0],  // ordinal
      mojo.internal.bindings.media.mojom.AudioDecoderClient_OnBufferDecoded_ParamsSpec,
      null,
      [arg_buffer],
      false);
  }
  ...
  onWaiting(arg_reason) {
    return this.proxy.sendMessage(
      this.ordinals[1],  // ordinal
      mojo.internal.bindings.media.mojom.AudioDecoderClient_OnWaiting_ParamsSpec,
      null,
      [arg_reason],
      false);
  }
...
mojo.internal.bindings.media.mojom.AudioDecoderClient.getRemote = function() {
  let remote = new mojo.internal.bindings.media.mojom.AudioDecoderClientRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
...
mojo.internal.bindings.media.mojom.AudioDecoderClientReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('media.mojom.AudioDecoderClient', [
      { explicit: null },
      { explicit: null },
    ]);
    ordinals.forEach((ord, idx) => {
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.media.mojom.AudioDecoderClient_OnBufferDecoded_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.onBufferDecoded');
          const result = this.impl.onBufferDecoded(params.arg_buffer);
          break;
        }
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.media.mojom.AudioDecoderClient_OnWaiting_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.media.mojom.AudioDecoderClientReceiver = mojo.internal.bindings.media.mojom.AudioDecoderClientReceiver;

mojo.internal.bindings.media.mojom.AudioDecoderClientPtr = mojo.internal.bindings.media.mojom.AudioDecoderClientRemote;
mojo.internal.bindings.media.mojom.AudioDecoderClientRequest = mojo.internal.bindings.media.mojom.AudioDecoderClientPendingReceiver;
...
mojo.internal.Struct(
    mojo.internal.bindings.media.mojom.SupportedAudioDecoderConfigSpec, 'media.mojom.SupportedAudioDecoderConfig', [
      mojo.internal.StructField('arg_codec', 0, 0, mojo.internal.bindings.media.mojom.AudioCodecSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_profile', 4, 0, mojo.internal.bindings.media.mojom.AudioCodecProfileSpec, null, false, 0, undefined),
    ],
    [[0, 16]]);
mojo.internal.Struct(
    mojo.internal.bindings.media.mojom.AudioDecoder_GetSupportedConfigs_ParamsSpec, 'media.mojom.AudioDecoder_GetSupportedConfigs_Params', [
    ],
    [[0, 8]]);

mojo.internal.Struct(
    mojo.internal.bindings.media.mojom.AudioDecoder_GetSupportedConfigs_ResponseParamsSpec, 'media.mojom.AudioDecoder_GetSupportedConfigs_ResponseParams', [
      mojo.internal.StructField('arg_supported_configs', 0, 0, mojo.internal.Array(mojo.internal.bindings.media.mojom.SupportedAudioDecoderConfigSpec, false), null, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.media.mojom.AudioDecoder_Construct_ParamsSpec, 'media.mojom.AudioDecoder_Construct_Params', [
      mojo.internal.StructField('arg_client', 0, 0, mojo.internal.AssociatedInterfaceProxy(mojo.internal.bindings.media.mojom.AudioDecoderClientRemote), null, false, 0, undefined),
...
mojo.internal.Struct(
    mojo.internal.bindings.media.mojom.AudioDecoder_Initialize_ParamsSpec, 'media.mojom.AudioDecoder_Initialize_Params', [
      ...
      mojo.internal.StructField('arg_cdm_id', 8, 0, mojo.internal.bindings.mojo_base.mojom.UnguessableTokenSpec, null, true, 0, undefined),
    ],
    [[0, 24]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.media.mojom.AudioDecoder_Decode_ParamsSpec, 'media.mojom.AudioDecoder_Decode_Params', [
      mojo.internal.StructField('arg_buffer', 0, 0, mojo.internal.bindings.media.mojom.DecoderBufferSpec, null, false, 0, undefined),
    ],
    [[0, 24]]);

mojo.internal.Struct(
    mojo.internal.bindings.media.mojom.AudioDecoder_Decode_ResponseParamsSpec, 'media.mojom.AudioDecoder_Decode_ResponseParams', [
      mojo.internal.StructField('arg_status', 0, 0, mojo.internal.bindings.media.mojom.DecoderStatusSpec, null, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.media.mojom.AudioDecoder_Reset_ParamsSpec, 'media.mojom.AudioDecoder_Reset_Params', [
    ],
    [[0, 8]]);

mojo.internal.Struct(
    mojo.internal.bindings.media.mojom.AudioDecoder_Reset_ResponseParamsSpec, 'media.mojom.AudioDecoder_Reset_ResponseParams', [
    ],
    [[0, 8]]);

mojo.internal.Struct(
    mojo.internal.bindings.media.mojom.AudioDecoderClient_OnBufferDecoded_ParamsSpec, 'media.mojom.AudioDecoderClient_OnBufferDecoded_Params', [
      mojo.internal.StructField('arg_buffer', 0, 0, mojo.internal.bindings.media.mojom.AudioBufferSpec, null, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.media.mojom.AudioDecoderClient_OnWaiting_ParamsSpec, 'media.mojom.AudioDecoderClient_OnWaiting_Params', [
