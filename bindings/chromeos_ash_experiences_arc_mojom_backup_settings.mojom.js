...
mojo.internal.bindings.arc.mojom.BackupSettingsInstance = {};
mojo.internal.bindings.arc.mojom.BackupSettingsInstanceSpec = { $ : {} };
mojo.internal.bindings.arc.mojom.BackupSettingsInstance.$interfaceName = 'arc.mojom.BackupSettingsInstance';
...
mojo.internal.bindings.arc.mojom.BackupSettingsInstanceRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.arc.mojom.BackupSettingsInstancePendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.arc.mojom.BackupSettingsInstanceRemoteCallHandler(this.proxy);
  }
  ...
  setBackupEnabled(arg_enabled, arg_managed) {
    return this.$.setBackupEnabled(arg_enabled, arg_managed);
  }
};

mojo.internal.bindings.arc.mojom.BackupSettingsInstanceRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('arc.mojom.BackupSettingsInstance', [
      { explicit: 0 },
    ]);
  }
...
mojo.internal.bindings.arc.mojom.BackupSettingsInstance.getRemote = function() {
  let remote = new mojo.internal.bindings.arc.mojom.BackupSettingsInstanceRemote();
...
mojo.internal.bindings.arc.mojom.BackupSettingsInstanceReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('arc.mojom.BackupSettingsInstance', [
      { explicit: 0 },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.arc.mojom.BackupSettingsInstance_SetBackupEnabled_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for SetBackupEnabled failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.arc.mojom.BackupSettingsInstanceReceiver = mojo.internal.bindings.arc.mojom.BackupSettingsInstanceReceiver;
