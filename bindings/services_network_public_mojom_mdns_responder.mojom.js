...
mojo.internal.bindings.network.mojom.MdnsResponder = {};
mojo.internal.bindings.network.mojom.MdnsResponderSpec = { $ : {} };
mojo.internal.bindings.network.mojom.MdnsResponder.$interfaceName = 'network.mojom.MdnsResponder';
...
mojo.internal.bindings.network.mojom.MdnsResponderRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.network.mojom.MdnsResponderPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.network.mojom.MdnsResponderRemoteCallHandler(this.proxy);
  }
  ...
  createNameForAddress(arg_address) {
    return this.$.createNameForAddress(arg_address);
  }
  removeNameForAddress(arg_address) {
    return this.$.removeNameForAddress(arg_address);
  }
};

mojo.internal.bindings.network.mojom.MdnsResponderRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('network.mojom.MdnsResponder', [
      { explicit: null },
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.network.mojom.MdnsResponder.getRemote = function() {
  let remote = new mojo.internal.bindings.network.mojom.MdnsResponderRemote();
...
mojo.internal.bindings.network.mojom.MdnsResponderReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('network.mojom.MdnsResponder', [
      { explicit: null },
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.network.mojom.MdnsResponder_CreateNameForAddress_ParamsSpec.$.structSpec);
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.network.mojom.MdnsResponder_RemoveNameForAddress_ParamsSpec.$.structSpec);
      ...
      switch (dispatchId) {
        case 0: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.network.mojom.MdnsResponder_CreateNameForAddress_ResponseParamsSpec, header, rawHeader);
               responder(response);
        ...
        case 1: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              const rawHeader = (args[2] && args[2].slice) ? args[2].slice(0, header.headerSize) : null;
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.network.mojom.MdnsResponder_RemoveNameForAddress_ResponseParamsSpec, header, rawHeader);
               responder(response);
...
mojo.internal.bindings.network.mojom.MdnsResponderReceiver = mojo.internal.bindings.network.mojom.MdnsResponderReceiver;
