...
mojo.internal.bindings.viz.mojom.TextureReleaser = {};
mojo.internal.bindings.viz.mojom.TextureReleaserSpec = { $ : {} };
mojo.internal.bindings.viz.mojom.TextureReleaser.$interfaceName = 'viz.mojom.TextureReleaser';
...
mojo.internal.bindings.viz.mojom.TextureReleaserRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.viz.mojom.TextureReleaserRemoteCallHandler(this.proxy);
  }
  ...
  release(arg_sync_token, arg_is_lost) {
    return this.$.release(arg_sync_token, arg_is_lost);
  }
};

mojo.internal.bindings.viz.mojom.TextureReleaserRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('viz.mojom.TextureReleaser', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.viz.mojom.TextureReleaser.getRemote = function() {
  let remote = new mojo.internal.bindings.viz.mojom.TextureReleaserRemote();
...
mojo.internal.bindings.viz.mojom.TextureReleaserReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('viz.mojom.TextureReleaser', [
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.viz.mojom.TextureReleaser_Release_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.viz.mojom.TextureReleaserReceiver = mojo.internal.bindings.viz.mojom.TextureReleaserReceiver;
