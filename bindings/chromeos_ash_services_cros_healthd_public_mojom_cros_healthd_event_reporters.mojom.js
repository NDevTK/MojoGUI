...
mojo.internal.bindings.ash.cros_healthd.mojom.AshEventReporter = {};
mojo.internal.bindings.ash.cros_healthd.mojom.AshEventReporterSpec = { $ : {} };
mojo.internal.bindings.ash.cros_healthd.mojom.AshEventReporter.$interfaceName = 'ash.cros_healthd.mojom.AshEventReporter';
...
mojo.internal.bindings.ash.cros_healthd.mojom.AshEventReporterRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.ash.cros_healthd.mojom.AshEventReporterPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.ash.cros_healthd.mojom.AshEventReporterRemoteCallHandler(this.proxy);
  }
  ...
  sendKeyboardDiagnosticEvent(arg_info) {
    return this.$.sendKeyboardDiagnosticEvent(arg_info);
  }
};

mojo.internal.bindings.ash.cros_healthd.mojom.AshEventReporterRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('ash.cros_healthd.mojom.AshEventReporter', [
      { explicit: 0 },
    ]);
  }
...
mojo.internal.bindings.ash.cros_healthd.mojom.AshEventReporter.getRemote = function() {
  let remote = new mojo.internal.bindings.ash.cros_healthd.mojom.AshEventReporterRemote();
...
mojo.internal.bindings.ash.cros_healthd.mojom.AshEventReporterReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('ash.cros_healthd.mojom.AshEventReporter', [
      { explicit: 0 },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ash.cros_healthd.mojom.AshEventReporter_SendKeyboardDiagnosticEvent_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for SendKeyboardDiagnosticEvent failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.ash.cros_healthd.mojom.AshEventReporterReceiver = mojo.internal.bindings.ash.cros_healthd.mojom.AshEventReporterReceiver;
