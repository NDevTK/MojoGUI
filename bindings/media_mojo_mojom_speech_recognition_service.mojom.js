...
mojo.internal.bindings.media.mojom.SpeechRecognitionContextRemote = mojo.internal.bindings.media.mojom.SpeechRecognitionContextRemote || class {};
mojo.internal.bindings.media.mojom.SpeechRecognitionContextPendingReceiver = mojo.internal.bindings.media.mojom.SpeechRecognitionContextPendingReceiver || class { constructor(handle) { this.handle = handle; } };
mojo.internal.bindings.media = mojo.internal.bindings.media || {};
mojo.internal.bindings.media.mojom = mojo.internal.bindings.media.mojom || {};
...
mojo.internal.bindings.media.mojom.SpeechRecognitionRecognizerClientRemote = mojo.internal.bindings.media.mojom.SpeechRecognitionRecognizerClientRemote || class {};
mojo.internal.bindings.media.mojom.SpeechRecognitionRecognizerClientPendingReceiver = mojo.internal.bindings.media.mojom.SpeechRecognitionRecognizerClientPendingReceiver || class { constructor(handle) { this.handle = handle; } };
mojo.internal.bindings.mojo_base = mojo.internal.bindings.mojo_base || {};
mojo.internal.bindings.mojo_base.mojom = mojo.internal.bindings.mojo_base.mojom || {};
