...
mojo.internal.bindings.blink.mojom.CrashMemoryMetricsReporter = {};
mojo.internal.bindings.blink.mojom.CrashMemoryMetricsReporterSpec = { $ : {} };
mojo.internal.bindings.blink.mojom.CrashMemoryMetricsReporter.$interfaceName = 'blink.mojom.CrashMemoryMetricsReporter';
...
mojo.internal.bindings.blink.mojom.CrashMemoryMetricsReporterRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.blink.mojom.CrashMemoryMetricsReporterPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.blink.mojom.CrashMemoryMetricsReporterRemoteCallHandler(this.proxy);
  }
  ...
  setSharedMemory(arg_shared_metrics_buffer) {
    return this.$.setSharedMemory(arg_shared_metrics_buffer);
  }
};

mojo.internal.bindings.blink.mojom.CrashMemoryMetricsReporterRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('blink.mojom.CrashMemoryMetricsReporter', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.blink.mojom.CrashMemoryMetricsReporter.getRemote = function() {
  let remote = new mojo.internal.bindings.blink.mojom.CrashMemoryMetricsReporterRemote();
...
mojo.internal.bindings.blink.mojom.CrashMemoryMetricsReporterReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('blink.mojom.CrashMemoryMetricsReporter', [
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.blink.mojom.CrashMemoryMetricsReporter_SetSharedMemory_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for SetSharedMemory failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.blink.mojom.CrashMemoryMetricsReporterReceiver = mojo.internal.bindings.blink.mojom.CrashMemoryMetricsReporterReceiver;
