...
mojo.internal.bindings.ash.ime.mojom.ConnectionFactoryRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.ash.ime.mojom.ConnectionFactoryRemoteCallHandler(this.proxy);
  }
  ...
  connectToInputMethod(arg_ime_spec, arg_input_method, arg_input_method_host, arg_settings) {
    return this.$.connectToInputMethod(arg_ime_spec, arg_input_method, arg_input_method_host, arg_settings);
  }
  unused(arg_unused) {
    return this.$.unused(arg_unused);
  }
};
...
mojo.internal.bindings.ash.ime.mojom.ConnectionFactory.getRemote = function() {
  let remote = new mojo.internal.bindings.ash.ime.mojom.ConnectionFactoryRemote();
...
mojo.internal.bindings.ash.ime.mojom.ConnectionFactoryReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
      ...
      switch (dispatchId) {
        case 0: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.ash.ime.mojom.ConnectionFactory_ConnectToInputMethod_ResponseParamsSpec, header, rawHeader);
               responder(response);
        ...
        case 1: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              const rawHeader = (args[2] && args[2].slice) ? args[2].slice(0, header.headerSize) : null;
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.ash.ime.mojom.ConnectionFactory_Unused_ResponseParamsSpec, header, rawHeader);
               responder(response);
...
mojo.internal.bindings.ash.ime.mojom.ConnectionFactoryReceiver = mojo.internal.bindings.ash.ime.mojom.ConnectionFactoryReceiver;
