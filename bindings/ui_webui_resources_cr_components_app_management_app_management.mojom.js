  ...
  $: {
    structSpec: {
      ...
      fields: [
        ...
        { name: 'value', packedOffset: 8, packedBitOffset: 0, type: app_management.mojom.PermissionValueSpec, nullable: false, minVersion: 0 },
  ...
  $: {
    structSpec: {
      ...
      fields: [
        ...
        { name: 'type', packedOffset: 8, packedBitOffset: 0, type: app_management.mojom.AppTypeSpec, nullable: false, minVersion: 0 },
        ...
        { name: 'is_pinned_$flag', packedOffset: 12, packedBitOffset: 0, type: mojo.internal.Bool, nullable: false, minVersion: 0, nullableValueKindProperties: { isPrimary: true, linkedValueFieldName: 'is_pinned_$value', originalFieldName: 'is_pinned' } },
        { name: 'is_pinned_$value', packedOffset: 12, packedBitOffset: 1, type: mojo.internal.Bool, nullable: false, minVersion: 0, nullableValueKindProperties: { isPrimary: false, linkedValueFieldName: 'is_pinned_$flag', originalFieldName: 'is_pinned' } },
        { name: 'is_policy_pinned_$flag', packedOffset: 12, packedBitOffset: 2, type: mojo.internal.Bool, nullable: false, minVersion: 0, nullableValueKindProperties: { isPrimary: true, linkedValueFieldName: 'is_policy_pinned_$value', originalFieldName: 'is_policy_pinned' } },
        { name: 'is_policy_pinned_$value', packedOffset: 12, packedBitOffset: 3, type: mojo.internal.Bool, nullable: false, minVersion: 0, nullableValueKindProperties: { isPrimary: false, linkedValueFieldName: 'is_policy_pinned_$flag', originalFieldName: 'is_policy_pinned' } },
        { name: 'version', packedOffset: 32, packedBitOffset: 0, type: mojo.internal.String, nullable: true, minVersion: 0 },
        { name: 'size', packedOffset: 40, packedBitOffset: 0, type: mojo.internal.String, nullable: true, minVersion: 0 },
        { name: 'permissions', packedOffset: 48, packedBitOffset: 0, type: mojo.internal.Map(app_management.mojom.PermissionTypeSpec, app_management.mojom.PermissionSpec, false), nullable: false, minVersion: 0 },
        { name: 'install_reason', packedOffset: 56, packedBitOffset: 0, type: app_management.mojom.InstallReasonSpec, nullable: false, minVersion: 0 },
        { name: 'install_source', packedOffset: 60, packedBitOffset: 0, type: app_management.mojom.InstallSourceSpec, nullable: false, minVersion: 0 },
        { name: 'hide_more_settings', packedOffset: 12, packedBitOffset: 4, type: mojo.internal.Bool, nullable: false, minVersion: 0 },
        { name: 'hide_pin_to_shelf', packedOffset: 12, packedBitOffset: 5, type: mojo.internal.Bool, nullable: false, minVersion: 0 },
        { name: 'is_preferred_app', packedOffset: 12, packedBitOffset: 6, type: mojo.internal.Bool, nullable: false, minVersion: 0 },
        { name: 'window_mode', packedOffset: 64, packedBitOffset: 0, type: app_management.mojom.WindowModeSpec, nullable: false, minVersion: 0 },
        { name: 'hide_window_mode', packedOffset: 12, packedBitOffset: 7, type: mojo.internal.Bool, nullable: false, minVersion: 0 },
        { name: 'resize_locked', packedOffset: 13, packedBitOffset: 0, type: mojo.internal.Bool, nullable: false, minVersion: 0 },
        { name: 'hide_resize_locked', packedOffset: 13, packedBitOffset: 1, type: mojo.internal.Bool, nullable: false, minVersion: 0 },
        { name: 'supported_links', packedOffset: 72, packedBitOffset: 0, type: mojo.internal.Array(mojo.internal.String, false), nullable: false, minVersion: 0 },
        { name: 'run_on_os_login', packedOffset: 80, packedBitOffset: 0, type: app_management.mojom.RunOnOsLoginSpec, nullable: true, minVersion: 0 },
        { name: 'file_handling_state', packedOffset: 88, packedBitOffset: 0, type: app_management.mojom.FileHandlingStateSpec, nullable: true, minVersion: 0 },
        { name: 'app_size', packedOffset: 96, packedBitOffset: 0, type: mojo.internal.String, nullable: true, minVersion: 0 },
        { name: 'data_size', packedOffset: 104, packedBitOffset: 0, type: mojo.internal.String, nullable: true, minVersion: 0 },
        { name: 'publisher_id', packedOffset: 112, packedBitOffset: 0, type: mojo.internal.String, nullable: false, minVersion: 0 },
        { name: 'formatted_origin', packedOffset: 120, packedBitOffset: 0, type: mojo.internal.String, nullable: true, minVersion: 0 },
        { name: 'scope_extensions', packedOffset: 128, packedBitOffset: 0, type: mojo.internal.Array(mojo.internal.String, false), nullable: false, minVersion: 0 },
        { name: 'supported_locales', packedOffset: 136, packedBitOffset: 0, type: mojo.internal.Array(app_management.mojom.LocaleSpec, false), nullable: false, minVersion: 0 },
        { name: 'selected_locale', packedOffset: 144, packedBitOffset: 0, type: app_management.mojom.LocaleSpec, nullable: true, minVersion: 0 },
        { name: 'show_system_notifications_settings_link', packedOffset: 13, packedBitOffset: 2, type: mojo.internal.Bool, nullable: false, minVersion: 0 },
        { name: 'allow_uninstall', packedOffset: 13, packedBitOffset: 3, type: mojo.internal.Bool, nullable: false, minVersion: 0 },
        { name: 'disable_user_choice_navigation_capturing', packedOffset: 13, packedBitOffset: 4, type: mojo.internal.Bool, nullable: false, minVersion: 0 },
      ],
  ...
  $: {
    structSpec: {
      ...
      fields: [
        ...
        { name: 'is_managed', packedOffset: 0, packedBitOffset: 1, type: mojo.internal.Bool, nullable: false, minVersion: 0 },
        { name: 'user_visible_types', packedOffset: 8, packedBitOffset: 0, type: mojo.internal.String, nullable: false, minVersion: 0 },
        { name: 'user_visible_types_label', packedOffset: 16, packedBitOffset: 0, type: mojo.internal.String, nullable: false, minVersion: 0 },
        { name: 'learn_more_url', packedOffset: 24, packedBitOffset: 0, type: url.mojom.UrlSpec, nullable: true, minVersion: 0 },
      ],
      versions: [{version: 0, packedSize: 40}]
    }
  }
