...
mojo.internal.Struct(
    mojo.internal.bindings.device_signals.mojom.FileSystemItemSpec, 'device_signals.mojom.FileSystemItem', [
      ...
      mojo.internal.StructField('arg_sha256_hash', 8, 0, mojo.internal.bindings.mojo_base.mojom.ByteStringSpec, null, true, 0, undefined),
      mojo.internal.StructField('arg_executable_metadata', 16, 0, mojo.internal.bindings.device_signals.mojom.ExecutableMetadataSpec, null, true, 0, undefined),
      mojo.internal.StructField('arg_presence', 24, 0, mojo.internal.bindings.device_signals.mojom.PresenceValueSpec, null, false, 0, undefined),
    ],
    [[0, 40]]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.device_signals.mojom.SystemSignalsService_GetFileSystemSignals_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for GetFileSystemSignals failed with TypeError');
           }
        }
        // Try Method 1: GetAntiVirusSignals
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.device_signals.mojom.SystemSignalsService_GetAntiVirusSignals_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for GetAntiVirusSignals failed with TypeError');
           }
        }
        // Try Method 2: GetHotfixSignals
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.device_signals.mojom.SystemSignalsService_GetHotfixSignals_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for GetHotfixSignals failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
