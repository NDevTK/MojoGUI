...
mojo.internal.bindings.arc.mojom.ObbMounterHostRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.arc.mojom.ObbMounterHostPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.arc.mojom.ObbMounterHostRemoteCallHandler(this.proxy);
  }
  ...
  mountObb(arg_obb_file, arg_target_path, arg_owner_gid) {
    return this.$.mountObb(arg_obb_file, arg_target_path, arg_owner_gid);
  }
  unmountObb(arg_target_path) {
    return this.$.unmountObb(arg_target_path);
  }
};
...
mojo.internal.bindings.arc.mojom.ObbMounterHost.getRemote = function() {
  let remote = new mojo.internal.bindings.arc.mojom.ObbMounterHostRemote();
...
mojo.internal.bindings.arc.mojom.ObbMounterHostReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
      ...
      switch (dispatchId) {
        case 0: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.arc.mojom.ObbMounterHost_MountObb_ResponseParamsSpec, header, rawHeader);
               responder(response);
        ...
        case 1: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              const rawHeader = (args[2] && args[2].slice) ? args[2].slice(0, header.headerSize) : null;
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.arc.mojom.ObbMounterHost_UnmountObb_ResponseParamsSpec, header, rawHeader);
               responder(response);
...
mojo.internal.bindings.arc.mojom.ObbMounterHostReceiver = mojo.internal.bindings.arc.mojom.ObbMounterHostReceiver;

mojo.internal.bindings.arc.mojom.ObbMounterHostPtr = mojo.internal.bindings.arc.mojom.ObbMounterHostRemote;
mojo.internal.bindings.arc.mojom.ObbMounterHostRequest = mojo.internal.bindings.arc.mojom.ObbMounterHostPendingReceiver;
...
mojo.internal.bindings.arc.mojom.ObbMounterInstanceRemote = class {
  static get $interfaceName() {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.arc.mojom.ObbMounterInstancePendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.arc.mojom.ObbMounterInstanceRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.arc.mojom.ObbMounterInstance.getRemote = function() {
  let remote = new mojo.internal.bindings.arc.mojom.ObbMounterInstanceRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
...
mojo.internal.bindings.arc.mojom.ObbMounterInstanceReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
      ...
      switch (dispatchId) {
        case 0: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              const rawHeader = (args[2] && args[2].slice) ? args[2].slice(0, header.headerSize) : null;
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.arc.mojom.ObbMounterInstance_Init_ResponseParamsSpec, header, rawHeader);
               responder(response);
...
mojo.internal.bindings.arc.mojom.ObbMounterInstanceReceiver = mojo.internal.bindings.arc.mojom.ObbMounterInstanceReceiver;
