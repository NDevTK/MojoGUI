...
mojo.internal.bindings.content.mojom.RenderFrameTestHelper = {};
mojo.internal.bindings.content.mojom.RenderFrameTestHelperSpec = { $ : {} };
mojo.internal.bindings.content.mojom.RenderFrameTestHelper.$interfaceName = 'content.mojom.RenderFrameTestHelper';
...
mojo.internal.bindings.content.mojom.RenderFrameTestHelperRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.content.mojom.RenderFrameTestHelperPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.content.mojom.RenderFrameTestHelperRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.content.mojom.RenderFrameTestHelperRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('content.mojom.RenderFrameTestHelper', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.content.mojom.RenderFrameTestHelper.getRemote = function() {
  let remote = new mojo.internal.bindings.content.mojom.RenderFrameTestHelperRemote();
...
mojo.internal.bindings.content.mojom.RenderFrameTestHelperReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('content.mojom.RenderFrameTestHelper', [
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.content.mojom.RenderFrameTestHelper_GetDocumentToken_ParamsSpec.$.structSpec);
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.content.mojom.RenderFrameTestHelper_GetDocumentToken_ParamsSpec.$.structSpec);
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.content.mojom.RenderFrameTestHelper_GetDocumentToken_ResponseParamsSpec, header, rawHeader);
               responder(response);
...
mojo.internal.bindings.content.mojom.RenderFrameTestHelperReceiver = mojo.internal.bindings.content.mojom.RenderFrameTestHelperReceiver;
