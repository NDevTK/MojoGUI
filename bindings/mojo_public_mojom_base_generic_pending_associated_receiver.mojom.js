...
mojo.internal.bindings.mojo_base.mojom.GenericAssociatedInterfaceRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.mojo_base.mojom.GenericAssociatedInterfacePendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.mojo_base.mojom.GenericAssociatedInterfaceRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.mojo_base.mojom.GenericAssociatedInterface.getRemote = function() {
  let remote = new mojo.internal.bindings.mojo_base.mojom.GenericAssociatedInterfaceRemote();
...
mojo.internal.bindings.mojo_base.mojom.GenericAssociatedInterfaceReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
...
mojo.internal.bindings.mojo_base.mojom.GenericAssociatedInterfaceReceiver = mojo.internal.bindings.mojo_base.mojom.GenericAssociatedInterfaceReceiver;
