  ...
  bind(handle) {
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        ...
        case 2: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.indigo_internals.mojom.PageHandler_InvalidateRemoteEligibility_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.invalidateRemoteEligibility');
...
mojo.internal.Struct(
    mojo.internal.bindings.indigo_internals.mojom.PageHandler_InvalidateRemoteEligibility_ParamsSpec, 'indigo_internals.mojom.PageHandler_InvalidateRemoteEligibility_Params', [
    ],
    [[0, 8]]);
