// Auto-generated MojoJS binding
 // Source: chromium_src/chrome/browser/ui/webui/indigo_internals/indigo_internals.mojom
 ...
 mojo.internal.bindings.indigo_internals = mojo.internal.bindings.indigo_internals || {};
mojo.internal.bindings.indigo_internals.mojom = mojo.internal.bindings.indigo_internals.mojom || {};
...
mojo.internal.bindings.indigo_internals.mojom.IndigoPromptSpec = mojo.internal.bindings.indigo_internals.mojom.IndigoPromptSpec || { $: {} };
if (mojo.internal.bindings.indigo_internals.mojom.IndigoPromptSpec.$.structSpec && mojo.internal.bindings.indigo_internals.mojom.IndigoPromptSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.indigo_internals.mojom.IndigoPromptSpec.$ = {};
...
if (mojo.internal.bindings.indigo_internals.mojom.CombinedEligibilitySpec.$.structSpec && mojo.internal.bindings.indigo_internals.mojom.CombinedEligibilitySpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.indigo_internals.mojom.CombinedEligibilitySpec.$ = {};
mojo.internal.bindings.indigo_internals.mojom.GlicPromptInfoSpec = mojo.internal.bindings.indigo_internals.mojom.GlicPromptInfoSpec || { $: {} };
if (mojo.internal.bindings.indigo_internals.mojom.GlicPromptInfoSpec.$.structSpec && mojo.internal.bindings.indigo_internals.mojom.GlicPromptInfoSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.indigo_internals.mojom.GlicPromptInfoSpec.$ = {};
mojo.internal.bindings.indigo_internals.mojom.PageHandlerFactory = mojo.internal.bindings.indigo_internals.mojom.PageHandlerFactory || {};
mojo.internal.bindings.indigo_internals.mojom.PageHandlerFactorySpec = mojo.internal.bindings.indigo_internals.mojom.PageHandlerFactorySpec || { $ : {} };
if (mojo.internal.bindings.indigo_internals.mojom.PageHandlerFactorySpec.$.structSpec && mojo.internal.bindings.indigo_internals.mojom.PageHandlerFactorySpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.indigo_internals.mojom.PageHandlerFactorySpec.$ = {};
mojo.internal.bindings.indigo_internals.mojom.PageHandlerFactory.$interfaceName = 'indigo_internals.mojom.PageHandlerFactory';
mojo.internal.bindings.indigo_internals.mojom.PageHandlerFactory_CreatePageHandler_ParamsSpec = mojo.internal.bindings.indigo_internals.mojom.PageHandlerFactory_CreatePageHandler_ParamsSpec || { $: {} };
if (mojo.internal.bindings.indigo_internals.mojom.PageHandlerFactory_CreatePageHandler_ParamsSpec.$.structSpec && mojo.internal.bindings.indigo_internals.mojom.PageHandlerFactory_CreatePageHandler_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.indigo_internals.mojom.PageHandlerFactory_CreatePageHandler_ParamsSpec.$ = {};
mojo.internal.bindings.indigo_internals.mojom.PageHandler = mojo.internal.bindings.indigo_internals.mojom.PageHandler || {};
mojo.internal.bindings.indigo_internals.mojom.PageHandlerSpec = mojo.internal.bindings.indigo_internals.mojom.PageHandlerSpec || { $ : {} };
if (mojo.internal.bindings.indigo_internals.mojom.PageHandlerSpec.$.structSpec && mojo.internal.bindings.indigo_internals.mojom.PageHandlerSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.indigo_internals.mojom.PageHandlerSpec.$ = {};
mojo.internal.bindings.indigo_internals.mojom.PageHandler.$interfaceName = 'indigo_internals.mojom.PageHandler';
mojo.internal.bindings.indigo_internals.mojom.PageHandler_GetLocalEligibility_ParamsSpec = mojo.internal.bindings.indigo_internals.mojom.PageHandler_GetLocalEligibility_ParamsSpec || { $: {} };
if (mojo.internal.bindings.indigo_internals.mojom.PageHandler_GetLocalEligibility_ParamsSpec.$.structSpec && mojo.internal.bindings.indigo_internals.mojom.PageHandler_GetLocalEligibility_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.indigo_internals.mojom.PageHandler_GetLocalEligibility_ParamsSpec.$ = {};
mojo.internal.bindings.indigo_internals.mojom.PageHandler_GetLocalEligibility_ResponseParamsSpec = mojo.internal.bindings.indigo_internals.mojom.PageHandler_GetLocalEligibility_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.indigo_internals.mojom.PageHandler_GetLocalEligibility_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.indigo_internals.mojom.PageHandler_GetLocalEligibility_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.indigo_internals.mojom.PageHandler_GetLocalEligibility_ResponseParamsSpec.$ = {};
mojo.internal.bindings.indigo_internals.mojom.PageHandler_GetCombinedEligibility_ParamsSpec = mojo.internal.bindings.indigo_internals.mojom.PageHandler_GetCombinedEligibility_ParamsSpec || { $: {} };
if (mojo.internal.bindings.indigo_internals.mojom.PageHandler_GetCombinedEligibility_ParamsSpec.$.structSpec && mojo.internal.bindings.indigo_internals.mojom.PageHandler_GetCombinedEligibility_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.indigo_internals.mojom.PageHandler_GetCombinedEligibility_ParamsSpec.$ = {};
mojo.internal.bindings.indigo_internals.mojom.PageHandler_GetCombinedEligibility_ResponseParamsSpec = mojo.internal.bindings.indigo_internals.mojom.PageHandler_GetCombinedEligibility_ResponseParamsSpec || { $: {} };
...
mojo.internal.bindings.indigo_internals.mojom.PageHandler_GetGlicPromptInfo_ParamsSpec = mojo.internal.bindings.indigo_internals.mojom.PageHandler_GetGlicPromptInfo_ParamsSpec || { $: {} };
if (mojo.internal.bindings.indigo_internals.mojom.PageHandler_GetGlicPromptInfo_ParamsSpec.$.structSpec && mojo.internal.bindings.indigo_internals.mojom.PageHandler_GetGlicPromptInfo_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.indigo_internals.mojom.PageHandler_GetGlicPromptInfo_ParamsSpec.$ = {};
mojo.internal.bindings.indigo_internals.mojom.PageHandler_GetGlicPromptInfo_ResponseParamsSpec = mojo.internal.bindings.indigo_internals.mojom.PageHandler_GetGlicPromptInfo_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.indigo_internals.mojom.PageHandler_GetGlicPromptInfo_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.indigo_internals.mojom.PageHandler_GetGlicPromptInfo_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.indigo_internals.mojom.PageHandler_GetGlicPromptInfo_ResponseParamsSpec.$ = {};
...
mojo.internal.bindings.indigo_internals.mojom.LocalEligibility = {
  kEligible: 0,
  kNotSignedIn: 1,
  kRefreshTokenInPersistentErrorState: 2,
  kMissingCapabilities: 3,
  kDisabledByPolicy: 4,
  kMissingScript: 5,
  kManagedDomain: 6,
  kGlicDisabledForProfile: 7,
  kEnterpriseDisallowed: 8,
};
...
mojo.internal.bindings.indigo_internals.mojom.PageHandlerFactoryPendingReceiver = class {
  constructor(handle) {
    this.handle = handle;
    if (handle) {
...
mojo.internal.bindings.indigo_internals.mojom.PageHandlerFactoryRemote = class {
  static get $interfaceName() {
    return 'indigo_internals.mojom.PageHandlerFactory';
  }

  constructor(handle = undefined) {
    this.__mojoHandle = handle;
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.indigo_internals.mojom.PageHandlerFactoryPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.indigo_internals.mojom.PageHandlerFactoryRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.indigo_internals.mojom.PageHandlerFactoryRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('indigo_internals.mojom.PageHandlerFactory', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.indigo_internals.mojom.PageHandlerFactory.getRemote = function() {
  let remote = new mojo.internal.bindings.indigo_internals.mojom.PageHandlerFactoryRemote();
...
mojo.internal.bindings.indigo_internals.mojom.PageHandlerFactoryReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('indigo_internals.mojom.PageHandlerFactory', [
      { explicit: null },
    ]);
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        case 0: {
          ...
          const params = decoder.decodeStructInline(mojo.internal.bindings.indigo_internals.mojom.PageHandlerFactory_CreatePageHandler_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.indigo_internals.mojom.PageHandlerFactoryReceiver = mojo.internal.bindings.indigo_internals.mojom.PageHandlerFactoryReceiver;

mojo.internal.bindings.indigo_internals.mojom.PageHandlerFactoryPtr = mojo.internal.bindings.indigo_internals.mojom.PageHandlerFactoryRemote;
mojo.internal.bindings.indigo_internals.mojom.PageHandlerFactoryRequest = mojo.internal.bindings.indigo_internals.mojom.PageHandlerFactoryPendingReceiver;


// Interface: PageHandler
mojo.internal.bindings.indigo_internals.mojom.PageHandlerPendingReceiver = class {
  constructor(handle) {
    this.handle = handle;
    if (handle) {
      this.__mojoHandle = handle.router_ ? handle.router_.pipe_ : (handle.pipe_ || handle);
...
mojo.internal.bindings.indigo_internals.mojom.PageHandlerRemote = class {
  static get $interfaceName() {
    return 'indigo_internals.mojom.PageHandler';
  }

  constructor(handle = undefined) {
    this.__mojoHandle = handle;
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.indigo_internals.mojom.PageHandlerPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.indigo_internals.mojom.PageHandlerRemoteCallHandler(this.proxy);
  }
  ...
  getLocalEligibility() {
    return this.$.getLocalEligibility();
  }
  getCombinedEligibility() {
    return this.$.getCombinedEligibility();
  }
  getOptimizationGuideStatus() {
    return this.$.getOptimizationGuideStatus();
  }
  getGlicPromptInfo() {
    return this.$.getGlicPromptInfo();
  }
};
...
mojo.internal.bindings.indigo_internals.mojom.PageHandler.getRemote = function() {
  let remote = new mojo.internal.bindings.indigo_internals.mojom.PageHandlerRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
...
mojo.internal.bindings.indigo_internals.mojom.PageHandlerReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.indigo_internals.mojom.PageHandler_GetLocalEligibility_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.getLocalEligibility');
          const result = this.impl.getLocalEligibility();
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const message = new mojo.internal.Message(
                ...
                header.ordinal, header.requestId, mojo.internal.bindings.indigo_internals.mojom.PageHandler_GetLocalEligibility_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
            }).catch(e => console.error('[GeneratedReceiver] getLocalEligibility FAILED:', e));
          }
          break;
        }
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.indigo_internals.mojom.PageHandler_GetCombinedEligibility_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.getCombinedEligibility');
          const result = this.impl.getCombinedEligibility();
          const expectsResponse = header.expectsResponse || (header.flags & 1);
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              const val = (response && typeof response === 'object' && 'arg_status' in response) ? response['arg_status'] : response;
              ...
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.indigo_internals.mojom.PageHandler_GetCombinedEligibility_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
            }).catch(e => console.error('[GeneratedReceiver] getCombinedEligibility FAILED:', e));
          }
          break;
        }
        case 2: {
        ...
        case 3: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.indigo_internals.mojom.PageHandler_GetGlicPromptInfo_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.getGlicPromptInfo');
          const result = this.impl.getGlicPromptInfo();
          const expectsResponse = header.expectsResponse || (header.flags & 1);
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.indigo_internals.mojom.PageHandler_GetGlicPromptInfo_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
            }).catch(e => console.error('[GeneratedReceiver] getGlicPromptInfo FAILED:', e));
          }
          break;
        }
      }
...
mojo.internal.bindings.indigo_internals.mojom.PageHandlerReceiver = mojo.internal.bindings.indigo_internals.mojom.PageHandlerReceiver;

mojo.internal.bindings.indigo_internals.mojom.PageHandlerPtr = mojo.internal.bindings.indigo_internals.mojom.PageHandlerRemote;
mojo.internal.bindings.indigo_internals.mojom.PageHandlerRequest = mojo.internal.bindings.indigo_internals.mojom.PageHandlerPendingReceiver;


// Interface: Page
mojo.internal.bindings.indigo_internals.mojom.PagePendingReceiver = class {
  constructor(handle) {
    this.handle = handle;
    if (handle) {
      this.__mojoHandle = handle.router_ ? handle.router_.pipe_ : (handle.pipe_ || handle);
...
mojo.internal.bindings.indigo_internals.mojom.PageRemote = class {
  static get $interfaceName() {
    return 'indigo_internals.mojom.Page';
  }

  constructor(handle = undefined) {
    this.__mojoHandle = handle;
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.indigo_internals.mojom.PagePendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.indigo_internals.mojom.PageRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.indigo_internals.mojom.Page.getRemote = function() {
  let remote = new mojo.internal.bindings.indigo_internals.mojom.PageRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
    'indigo_internals.mojom.Page',
    'context');
  return remote.$;
};

mojo.internal.bindings.indigo_internals.mojom.PageReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
...
mojo.internal.bindings.indigo_internals.mojom.PageReceiver = mojo.internal.bindings.indigo_internals.mojom.PageReceiver;

mojo.internal.bindings.indigo_internals.mojom.PagePtr = mojo.internal.bindings.indigo_internals.mojom.PageRemote;
mojo.internal.bindings.indigo_internals.mojom.PageRequest = mojo.internal.bindings.indigo_internals.mojom.PagePendingReceiver;
...
mojo.internal.Struct(
    mojo.internal.bindings.indigo_internals.mojom.RemoteEligibilitySpec, 'indigo_internals.mojom.RemoteEligibility', [
      mojo.internal.StructField('arg_is_service_supported_for_account', 0, 0, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_has_user_image', 0, 1, mojo.internal.Bool, false, false, 0, undefined),
    ],
    [[0, 16]]);

// Struct: IndigoPrompt
mojo.internal.Struct(
    mojo.internal.bindings.indigo_internals.mojom.IndigoPromptSpec, 'indigo_internals.mojom.IndigoPrompt', [
...
mojo.internal.Struct(
    mojo.internal.bindings.indigo_internals.mojom.CombinedEligibilitySpec, 'indigo_internals.mojom.CombinedEligibility', [
      mojo.internal.StructField('arg_local_eligibility', 0, 0, mojo.internal.bindings.indigo_internals.mojom.LocalEligibilitySpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_can_generate_image', 4, 0, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_ready_to_onboard', 4, 1, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_has_onboarded_pref', 4, 2, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_remote_eligibility', 8, 0, mojo.internal.bindings.indigo_internals.mojom.RemoteEligibilitySpec, null, true, 0, undefined),
    ],
    [[0, 24]]);

// Struct: GlicPromptInfo
mojo.internal.Struct(
    mojo.internal.bindings.indigo_internals.mojom.GlicPromptInfoSpec, 'indigo_internals.mojom.GlicPromptInfo', [
      mojo.internal.StructField('arg_integration_enabled', 0, 0, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_current_key', 8, 0, mojo.internal.String, null, false, 0, undefined),
      mojo.internal.StructField('arg_override_prompt', 16, 0, mojo.internal.String, null, false, 0, undefined),
      mojo.internal.StructField('arg_skill_id', 24, 0, mojo.internal.String, null, false, 0, undefined),
      mojo.internal.StructField('arg_skill_name', 32, 0, mojo.internal.String, null, false, 0, undefined),
      mojo.internal.StructField('arg_loaded_prompts', 40, 0, mojo.internal.Array(mojo.internal.bindings.indigo_internals.mojom.IndigoPromptSpec, false), null, false, 0, undefined),
    ],
    [[0, 56]]);
mojo.internal.Struct(
    mojo.internal.bindings.indigo_internals.mojom.PageHandlerFactory_CreatePageHandler_ParamsSpec, 'indigo_internals.mojom.PageHandlerFactory_CreatePageHandler_Params', [
      mojo.internal.StructField('arg_page', 0, 0, mojo.internal.InterfaceProxy(mojo.internal.bindings.indigo_internals.mojom.PageRemote), null, false, 0, undefined),
      mojo.internal.StructField('arg_handler', 8, 0, mojo.internal.InterfaceRequest(mojo.internal.bindings.indigo_internals.mojom.PageHandlerPendingReceiver), null, false, 0, undefined),
    ],
    [[0, 24]]);

mojo.internal.Struct(
    mojo.internal.bindings.indigo_internals.mojom.PageHandler_GetLocalEligibility_ParamsSpec, 'indigo_internals.mojom.PageHandler_GetLocalEligibility_Params', [
    ],
    [[0, 8]]);

mojo.internal.Struct(
    mojo.internal.bindings.indigo_internals.mojom.PageHandler_GetLocalEligibility_ResponseParamsSpec, 'indigo_internals.mojom.PageHandler_GetLocalEligibility_ResponseParams', [
...
mojo.internal.Struct(
    mojo.internal.bindings.indigo_internals.mojom.PageHandler_GetCombinedEligibility_ParamsSpec, 'indigo_internals.mojom.PageHandler_GetCombinedEligibility_Params', [
    ],
    [[0, 8]]);

mojo.internal.Struct(
    mojo.internal.bindings.indigo_internals.mojom.PageHandler_GetCombinedEligibility_ResponseParamsSpec, 'indigo_internals.mojom.PageHandler_GetCombinedEligibility_ResponseParams', [
      mojo.internal.StructField('arg_status', 0, 0, mojo.internal.bindings.indigo_internals.mojom.CombinedEligibilitySpec, null, false, 0, undefined),
    ],
    [[0, 16]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.indigo_internals.mojom.PageHandler_GetGlicPromptInfo_ParamsSpec, 'indigo_internals.mojom.PageHandler_GetGlicPromptInfo_Params', [
    ],
    [[0, 8]]);

mojo.internal.Struct(
    mojo.internal.bindings.indigo_internals.mojom.PageHandler_GetGlicPromptInfo_ResponseParamsSpec, 'indigo_internals.mojom.PageHandler_GetGlicPromptInfo_ResponseParams', [
      mojo.internal.StructField('arg_info', 0, 0, mojo.internal.bindings.indigo_internals.mojom.GlicPromptInfoSpec, null, false, 0, undefined),
    ],
    [[0, 16]]);
