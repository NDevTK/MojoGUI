...
mojo.internal.bindings.blink = mojo.internal.bindings.blink || {};
mojo.internal.bindings.blink.mojom = mojo.internal.bindings.blink.mojom || {};
mojo.internal.bindings.blink.mojom.ServiceWorkerStateSpec = mojo.internal.bindings.blink.mojom.ServiceWorkerStateSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.blink = mojo.internal.bindings.blink || {};
mojo.internal.bindings.blink.mojom = mojo.internal.bindings.blink.mojom || {};
...
mojo.internal.bindings.blink.mojom.ServiceWorkerObjectHostRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.blink.mojom.ServiceWorkerObjectHostPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.blink.mojom.ServiceWorkerObjectHostRemoteCallHandler(this.proxy);
  }
  ...
  postMessageToServiceWorker(arg_message) {
    return this.$.postMessageToServiceWorker(arg_message);
  }
  terminateForTesting() {
...
mojo.internal.bindings.blink.mojom.ServiceWorkerObjectHostRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('blink.mojom.ServiceWorkerObjectHost', [
      { explicit: null },
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.blink.mojom.ServiceWorkerObjectHost.getRemote = function() {
  let remote = new mojo.internal.bindings.blink.mojom.ServiceWorkerObjectHostRemote();
...
mojo.internal.bindings.blink.mojom.ServiceWorkerObjectHostReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('blink.mojom.ServiceWorkerObjectHost', [
      { explicit: null },
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.blink.mojom.ServiceWorkerObjectHost_PostMessageToServiceWorker_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for PostMessageToServiceWorker failed with TypeError');
           }
        }
        // Try Method 1: TerminateForTesting
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.blink.mojom.ServiceWorkerObjectHost_TerminateForTesting_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
      ...
      switch (dispatchId) {
        ...
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.blink.mojom.ServiceWorkerObjectHost_TerminateForTesting_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.blink.mojom.ServiceWorkerObjectHostReceiver = mojo.internal.bindings.blink.mojom.ServiceWorkerObjectHostReceiver;

mojo.internal.bindings.blink.mojom.ServiceWorkerObjectHostPtr = mojo.internal.bindings.blink.mojom.ServiceWorkerObjectHostRemote;
mojo.internal.bindings.blink.mojom.ServiceWorkerObjectHostRequest = mojo.internal.bindings.blink.mojom.ServiceWorkerObjectHostPendingReceiver;
...
mojo.internal.bindings.blink.mojom.ServiceWorkerObjectRemote = class {
  static get $interfaceName() {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.blink.mojom.ServiceWorkerObjectPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.blink.mojom.ServiceWorkerObjectRemoteCallHandler(this.proxy);
  }
  ...
  stateChanged(arg_state) {
    return this.$.stateChanged(arg_state);
  }
};

mojo.internal.bindings.blink.mojom.ServiceWorkerObjectRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('blink.mojom.ServiceWorkerObject', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.blink.mojom.ServiceWorkerObject.getRemote = function() {
  let remote = new mojo.internal.bindings.blink.mojom.ServiceWorkerObjectRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
...
mojo.internal.bindings.blink.mojom.ServiceWorkerObjectReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('blink.mojom.ServiceWorkerObject', [
      { explicit: null },
    ]);
    ordinals.forEach((ord, idx) => {
      this.ordinalMap.set(ord, idx); // Scrambled/Explicit
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.blink.mojom.ServiceWorkerObject_StateChanged_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for StateChanged failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
             console.warn('[GeneratedReceiver] Failed to discover ordinal ' + header.ordinal);
...
mojo.internal.bindings.blink.mojom.ServiceWorkerObjectReceiver = mojo.internal.bindings.blink.mojom.ServiceWorkerObjectReceiver;
