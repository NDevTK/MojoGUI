...
mojo.internal.bindings.ash.annotator.mojom.UntrustedAnnotatorPageRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.ash.annotator.mojom.UntrustedAnnotatorPagePendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.ash.annotator.mojom.UntrustedAnnotatorPageRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.ash.annotator.mojom.UntrustedAnnotatorPage.getRemote = function() {
  let remote = new mojo.internal.bindings.ash.annotator.mojom.UntrustedAnnotatorPageRemote();
...
mojo.internal.bindings.ash.annotator.mojom.UntrustedAnnotatorPageReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ash.annotator.mojom.UntrustedAnnotatorPage_Clear_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for Clear failed with TypeError');
           }
        }
        // Try Method 1: Undo
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ash.annotator.mojom.UntrustedAnnotatorPage_Undo_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ash.annotator.mojom.UntrustedAnnotatorPage_Redo_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ash.annotator.mojom.UntrustedAnnotatorPage_SetTool_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for SetTool failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.ash.annotator.mojom.UntrustedAnnotatorPage_Clear_ParamsSpec.$.structSpec);
        ...
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.ash.annotator.mojom.UntrustedAnnotatorPage_Undo_ParamsSpec.$.structSpec);
        ...
        case 2: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.ash.annotator.mojom.UntrustedAnnotatorPage_Redo_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.ash.annotator.mojom.UntrustedAnnotatorPageReceiver = mojo.internal.bindings.ash.annotator.mojom.UntrustedAnnotatorPageReceiver;

mojo.internal.bindings.ash.annotator.mojom.UntrustedAnnotatorPagePtr = mojo.internal.bindings.ash.annotator.mojom.UntrustedAnnotatorPageRemote;
mojo.internal.bindings.ash.annotator.mojom.UntrustedAnnotatorPageRequest = mojo.internal.bindings.ash.annotator.mojom.UntrustedAnnotatorPagePendingReceiver;
...
mojo.internal.bindings.ash.annotator.mojom.UntrustedAnnotatorPageHandlerRemote = class {
  static get $interfaceName() {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.ash.annotator.mojom.UntrustedAnnotatorPageHandlerPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.ash.annotator.mojom.UntrustedAnnotatorPageHandlerRemoteCallHandler(this.proxy);
  }
  ...
  onUndoRedoAvailabilityChanged(arg_undo_available, arg_redo_available) {
    return this.$.onUndoRedoAvailabilityChanged(arg_undo_available, arg_redo_available);
  }
  onCanvasInitialized(arg_success) {
    return this.$.onCanvasInitialized(arg_success);
  }
};
...
mojo.internal.bindings.ash.annotator.mojom.UntrustedAnnotatorPageHandler.getRemote = function() {
  let remote = new mojo.internal.bindings.ash.annotator.mojom.UntrustedAnnotatorPageHandlerRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
...
mojo.internal.bindings.ash.annotator.mojom.UntrustedAnnotatorPageHandlerReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ash.annotator.mojom.UntrustedAnnotatorPageHandler_OnUndoRedoAvailabilityChanged_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OnUndoRedoAvailabilityChanged failed with TypeError');
           }
        }
        // Try Method 1: OnCanvasInitialized
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ash.annotator.mojom.UntrustedAnnotatorPageHandler_OnCanvasInitialized_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OnCanvasInitialized failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
             console.warn('[GeneratedReceiver] Failed to discover ordinal ' + header.ordinal);
...
mojo.internal.bindings.ash.annotator.mojom.UntrustedAnnotatorPageHandlerReceiver = mojo.internal.bindings.ash.annotator.mojom.UntrustedAnnotatorPageHandlerReceiver;

mojo.internal.bindings.ash.annotator.mojom.UntrustedAnnotatorPageHandlerPtr = mojo.internal.bindings.ash.annotator.mojom.UntrustedAnnotatorPageHandlerRemote;
mojo.internal.bindings.ash.annotator.mojom.UntrustedAnnotatorPageHandlerRequest = mojo.internal.bindings.ash.annotator.mojom.UntrustedAnnotatorPageHandlerPendingReceiver;
...
mojo.internal.bindings.ash.annotator.mojom.UntrustedAnnotatorPageHandlerFactoryRemote = class {
  static get $interfaceName() {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.ash.annotator.mojom.UntrustedAnnotatorPageHandlerFactoryPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.ash.annotator.mojom.UntrustedAnnotatorPageHandlerFactoryRemoteCallHandler(this.proxy);
  }
  ...
  create(arg_handler, arg_annotator) {
    return this.$.create(arg_handler, arg_annotator);
  }
};
...
mojo.internal.bindings.ash.annotator.mojom.UntrustedAnnotatorPageHandlerFactory.getRemote = function() {
  let remote = new mojo.internal.bindings.ash.annotator.mojom.UntrustedAnnotatorPageHandlerFactoryRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
...
mojo.internal.bindings.ash.annotator.mojom.UntrustedAnnotatorPageHandlerFactoryReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ash.annotator.mojom.UntrustedAnnotatorPageHandlerFactory_Create_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
...
mojo.internal.bindings.ash.annotator.mojom.UntrustedAnnotatorPageHandlerFactoryReceiver = mojo.internal.bindings.ash.annotator.mojom.UntrustedAnnotatorPageHandlerFactoryReceiver;
