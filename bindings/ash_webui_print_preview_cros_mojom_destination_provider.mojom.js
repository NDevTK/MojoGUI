...
mojo.internal.bindings.ash.printing.print_preview.mojom.DestinationProvider = {};
mojo.internal.bindings.ash.printing.print_preview.mojom.DestinationProviderSpec = { $ : {} };
mojo.internal.bindings.ash.printing.print_preview.mojom.DestinationProvider.$interfaceName = 'ash.printing.print_preview.mojom.DestinationProvider';
...
mojo.internal.bindings.ash.printing.print_preview.mojom.DestinationProviderRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.ash.printing.print_preview.mojom.DestinationProviderPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.ash.printing.print_preview.mojom.DestinationProviderRemoteCallHandler(this.proxy);
  }
  ...
  fetchCapabilities(arg_destination_id, arg_printer_type) {
    return this.$.fetchCapabilities(arg_destination_id, arg_printer_type);
  }
};

mojo.internal.bindings.ash.printing.print_preview.mojom.DestinationProviderRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('ash.printing.print_preview.mojom.DestinationProvider', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.ash.printing.print_preview.mojom.DestinationProvider.getRemote = function() {
  let remote = new mojo.internal.bindings.ash.printing.print_preview.mojom.DestinationProviderRemote();
...
mojo.internal.bindings.ash.printing.print_preview.mojom.DestinationProviderReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('ash.printing.print_preview.mojom.DestinationProvider', [
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.ash.printing.print_preview.mojom.DestinationProvider_FetchCapabilities_ParamsSpec.$.structSpec);
        ...
        case 0: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.ash.printing.print_preview.mojom.DestinationProvider_FetchCapabilities_ResponseParamsSpec, header, rawHeader);
               responder(response);
...
mojo.internal.bindings.ash.printing.print_preview.mojom.DestinationProviderReceiver = mojo.internal.bindings.ash.printing.print_preview.mojom.DestinationProviderReceiver;
