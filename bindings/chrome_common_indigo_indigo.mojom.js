// Auto-generated MojoJS binding
 // Source: chromium_src/chrome/common/indigo/indigo.mojom
 // Module: chrome.mojom
...
mojo.internal.bindings.chrome.mojom.IndigoInvokeErrorSpec = mojo.internal.bindings.chrome.mojom.IndigoInvokeErrorSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.chrome.mojom.IndigoAgentHost = mojo.internal.bindings.chrome.mojom.IndigoAgentHost || {};
mojo.internal.bindings.chrome.mojom.IndigoAgentHostSpec = mojo.internal.bindings.chrome.mojom.IndigoAgentHostSpec || { $ : {} };
if (mojo.internal.bindings.chrome.mojom.IndigoAgentHostSpec.$.structSpec && mojo.internal.bindings.chrome.mojom.IndigoAgentHostSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.chrome.mojom.IndigoAgentHostSpec.$ = {};
mojo.internal.bindings.chrome.mojom.IndigoAgentHost.$interfaceName = 'chrome.mojom.IndigoAgentHost';
mojo.internal.bindings.chrome.mojom.IndigoAgentHost_StartImageReplacement_ParamsSpec = mojo.internal.bindings.chrome.mojom.IndigoAgentHost_StartImageReplacement_ParamsSpec || { $: {} };
if (mojo.internal.bindings.chrome.mojom.IndigoAgentHost_StartImageReplacement_ParamsSpec.$.structSpec && mojo.internal.bindings.chrome.mojom.IndigoAgentHost_StartImageReplacement_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.chrome.mojom.IndigoAgentHost_StartImageReplacement_ParamsSpec.$ = {};
mojo.internal.bindings.chrome.mojom.IndigoAgentHost_StartImageReplacement_ResponseParamsSpec = mojo.internal.bindings.chrome.mojom.IndigoAgentHost_StartImageReplacement_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.chrome.mojom.IndigoAgentHost_StartImageReplacement_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.chrome.mojom.IndigoAgentHost_StartImageReplacement_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.chrome.mojom.IndigoAgentHost_StartImageReplacement_ResponseParamsSpec.$ = {};
mojo.internal.bindings.chrome.mojom.IndigoAgentHost_ReportInvokeError_ParamsSpec = mojo.internal.bindings.chrome.mojom.IndigoAgentHost_ReportInvokeError_ParamsSpec || { $: {} };
if (mojo.internal.bindings.chrome.mojom.IndigoAgentHost_ReportInvokeError_ParamsSpec.$.structSpec && mojo.internal.bindings.chrome.mojom.IndigoAgentHost_ReportInvokeError_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.chrome.mojom.IndigoAgentHost_ReportInvokeError_ParamsSpec.$ = {};
mojo.internal.bindings.chrome.mojom.IndigoAgent = mojo.internal.bindings.chrome.mojom.IndigoAgent || {};
mojo.internal.bindings.chrome.mojom.IndigoAgentSpec = mojo.internal.bindings.chrome.mojom.IndigoAgentSpec || { $ : {} };
if (mojo.internal.bindings.chrome.mojom.IndigoAgentSpec.$.structSpec && mojo.internal.bindings.chrome.mojom.IndigoAgentSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.chrome.mojom.IndigoAgentSpec.$ = {};
mojo.internal.bindings.chrome.mojom.IndigoAgent.$interfaceName = 'chrome.mojom.IndigoAgent';
mojo.internal.bindings.chrome.mojom.IndigoAgent_InjectScript_ParamsSpec = mojo.internal.bindings.chrome.mojom.IndigoAgent_InjectScript_ParamsSpec || { $: {} };
if (mojo.internal.bindings.chrome.mojom.IndigoAgent_InjectScript_ParamsSpec.$.structSpec && mojo.internal.bindings.chrome.mojom.IndigoAgent_InjectScript_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.chrome.mojom.IndigoAgent_InjectScript_ParamsSpec.$ = {};
mojo.internal.bindings.chrome.mojom.IndigoAgent_InjectScript_ResponseParamsSpec = mojo.internal.bindings.chrome.mojom.IndigoAgent_InjectScript_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.chrome.mojom.IndigoAgent_InjectScript_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.chrome.mojom.IndigoAgent_InjectScript_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.chrome.mojom.IndigoAgent_InjectScript_ResponseParamsSpec.$ = {};
mojo.internal.bindings.chrome.mojom.IndigoAgent_Invoke_ParamsSpec = mojo.internal.bindings.chrome.mojom.IndigoAgent_Invoke_ParamsSpec || { $: {} };
if (mojo.internal.bindings.chrome.mojom.IndigoAgent_Invoke_ParamsSpec.$.structSpec && mojo.internal.bindings.chrome.mojom.IndigoAgent_Invoke_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.chrome.mojom.IndigoAgent_Invoke_ParamsSpec.$ = {};
mojo.internal.bindings.chrome.mojom.IndigoAgent_Invoke_ResponseParamsSpec = mojo.internal.bindings.chrome.mojom.IndigoAgent_Invoke_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.chrome.mojom.IndigoAgent_Invoke_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.chrome.mojom.IndigoAgent_Invoke_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.chrome.mojom.IndigoAgent_Invoke_ResponseParamsSpec.$ = {};
mojo.internal.bindings.chrome.mojom.IndigoAgent_Reset_ParamsSpec = mojo.internal.bindings.chrome.mojom.IndigoAgent_Reset_ParamsSpec || { $: {} };
if (mojo.internal.bindings.chrome.mojom.IndigoAgent_Reset_ParamsSpec.$.structSpec && mojo.internal.bindings.chrome.mojom.IndigoAgent_Reset_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.chrome.mojom.IndigoAgent_Reset_ParamsSpec.$ = {};
mojo.internal.bindings.chrome.mojom.IndigoAgent_Reset_ResponseParamsSpec = mojo.internal.bindings.chrome.mojom.IndigoAgent_Reset_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.chrome.mojom.IndigoAgent_Reset_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.chrome.mojom.IndigoAgent_Reset_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.chrome.mojom.IndigoAgent_Reset_ResponseParamsSpec.$ = {};
mojo.internal.bindings.chrome.mojom.IndigoOnboardingDialogHost = mojo.internal.bindings.chrome.mojom.IndigoOnboardingDialogHost || {};
mojo.internal.bindings.chrome.mojom.IndigoOnboardingDialogHostSpec = mojo.internal.bindings.chrome.mojom.IndigoOnboardingDialogHostSpec || { $ : {} };
if (mojo.internal.bindings.chrome.mojom.IndigoOnboardingDialogHostSpec.$.structSpec && mojo.internal.bindings.chrome.mojom.IndigoOnboardingDialogHostSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.chrome.mojom.IndigoOnboardingDialogHostSpec.$ = {};
mojo.internal.bindings.chrome.mojom.IndigoOnboardingDialogHost.$interfaceName = 'chrome.mojom.IndigoOnboardingDialogHost';
mojo.internal.bindings.chrome.mojom.IndigoOnboardingDialogHost_AcknowledgeChromeDisclaimer_ParamsSpec = mojo.internal.bindings.chrome.mojom.IndigoOnboardingDialogHost_AcknowledgeChromeDisclaimer_ParamsSpec || { $: {} };
if (mojo.internal.bindings.chrome.mojom.IndigoOnboardingDialogHost_AcknowledgeChromeDisclaimer_ParamsSpec.$.structSpec && mojo.internal.bindings.chrome.mojom.IndigoOnboardingDialogHost_AcknowledgeChromeDisclaimer_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.chrome.mojom.IndigoOnboardingDialogHost_AcknowledgeChromeDisclaimer_ParamsSpec.$ = {};

// External type stubs (from imports)
mojo.internal.bindings.blink = mojo.internal.bindings.blink || {};
mojo.internal.bindings.blink.mojom = mojo.internal.bindings.blink.mojom || {};
mojo.internal.bindings.blink.mojom.ImageReplacementSpec = mojo.internal.bindings.blink.mojom.ImageReplacementSpec || { $: mojo.internal.OpaqueStruct.$ };
mojo.internal.bindings.blink.mojom.ImageReplacementRemote = mojo.internal.bindings.blink.mojom.ImageReplacementRemote || class {};
mojo.internal.bindings.blink.mojom.ImageReplacementPendingReceiver = mojo.internal.bindings.blink.mojom.ImageReplacementPendingReceiver || class { constructor(handle) { this.handle = handle; } };
mojo.internal.bindings.mojo_base = mojo.internal.bindings.mojo_base || {};
mojo.internal.bindings.mojo_base.mojom = mojo.internal.bindings.mojo_base.mojom || {};
...
// Enum: IndigoInvokeError
mojo.internal.bindings.chrome.mojom.IndigoInvokeError = {
  kNoPrimaryImageFound: 0,
  kPrimaryImageReplacementCreationFailed: 1,
};

// Interface: IndigoAgentHost
mojo.internal.bindings.chrome.mojom.IndigoAgentHostPendingReceiver = class {
  constructor(handle) {
    this.handle = handle;
    if (handle) {
...
mojo.internal.bindings.chrome.mojom.IndigoAgentHostRemote = class {
  static get $interfaceName() {
    return 'chrome.mojom.IndigoAgentHost';
  }

  constructor(handle = undefined) {
    this.__mojoHandle = handle;
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.chrome.mojom.IndigoAgentHostPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.chrome.mojom.IndigoAgentHostRemoteCallHandler(this.proxy);
  }
  ...
  reportInvokeError(arg_error) {
    return this.$.reportInvokeError(arg_error);
  }
};

mojo.internal.bindings.chrome.mojom.IndigoAgentHostRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('chrome.mojom.IndigoAgentHost', [
      { explicit: null },
      { explicit: null },
    ]);
  }
  ...
  reportInvokeError(arg_error) {
    return this.proxy.sendMessage(
      ...
      mojo.internal.bindings.chrome.mojom.IndigoAgentHost_ReportInvokeError_ParamsSpec,
      null,
      [arg_error],
      false);
  }
...
mojo.internal.bindings.chrome.mojom.IndigoAgentHost.getRemote = function() {
  let remote = new mojo.internal.bindings.chrome.mojom.IndigoAgentHostRemote();
...
mojo.internal.bindings.chrome.mojom.IndigoAgentHostReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('chrome.mojom.IndigoAgentHost', [
      { explicit: null },
      { explicit: null },
    ]);
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const message = new mojo.internal.Message(
                ...
                header.ordinal, header.requestId, mojo.internal.bindings.chrome.mojom.IndigoAgentHost_StartImageReplacement_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
            }).catch(e => console.error('[GeneratedReceiver] startImageReplacement FAILED:', e));
          }
          break;
        }
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.chrome.mojom.IndigoAgentHost_ReportInvokeError_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.reportInvokeError');
          const result = this.impl.reportInvokeError(params.arg_error);
          break;
        }
      }
      } catch (err) {
...
mojo.internal.bindings.chrome.mojom.IndigoAgentHostReceiver = mojo.internal.bindings.chrome.mojom.IndigoAgentHostReceiver;

mojo.internal.bindings.chrome.mojom.IndigoAgentHostPtr = mojo.internal.bindings.chrome.mojom.IndigoAgentHostRemote;
mojo.internal.bindings.chrome.mojom.IndigoAgentHostRequest = mojo.internal.bindings.chrome.mojom.IndigoAgentHostPendingReceiver;


// Interface: IndigoAgent
mojo.internal.bindings.chrome.mojom.IndigoAgentPendingReceiver = class {
  constructor(handle) {
    this.handle = handle;
    if (handle) {
      this.__mojoHandle = handle.router_ ? handle.router_.pipe_ : (handle.pipe_ || handle);
...
mojo.internal.bindings.chrome.mojom.IndigoAgentRemote = class {
  static get $interfaceName() {
    return 'chrome.mojom.IndigoAgent';
  }

  constructor(handle = undefined) {
    this.__mojoHandle = handle;
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.chrome.mojom.IndigoAgentPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.chrome.mojom.IndigoAgentRemoteCallHandler(this.proxy);
  }
  ...
  injectScript(arg_script_content, arg_script_url, arg_origin, arg_host) {
    return this.$.injectScript(arg_script_content, arg_script_url, arg_origin, arg_host);
  }
  invoke() {
    return this.$.invoke();
  }
...
mojo.internal.bindings.chrome.mojom.IndigoAgentRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('chrome.mojom.IndigoAgent', [
      { explicit: null },
      { explicit: null },
      { explicit: null },
    ]);
  ...
  injectScript(arg_script_content, arg_script_url, arg_origin, arg_host) {
    return this.proxy.sendMessage(
      this.ordinals[0],  // ordinal
      mojo.internal.bindings.chrome.mojom.IndigoAgent_InjectScript_ParamsSpec,
      mojo.internal.bindings.chrome.mojom.IndigoAgent_InjectScript_ResponseParamsSpec,
      [arg_script_content, arg_script_url, arg_origin, arg_host],
      false);
  }
  ...
  invoke() {
    return this.proxy.sendMessage(
      this.ordinals[1],  // ordinal
      mojo.internal.bindings.chrome.mojom.IndigoAgent_Invoke_ParamsSpec,
      mojo.internal.bindings.chrome.mojom.IndigoAgent_Invoke_ResponseParamsSpec,
      [],
      false);
  }
  ...
  reset() {
    return this.proxy.sendMessage(
      ...
      mojo.internal.bindings.chrome.mojom.IndigoAgent_Reset_ParamsSpec,
      mojo.internal.bindings.chrome.mojom.IndigoAgent_Reset_ResponseParamsSpec,
      [],
      false);
  }
...
mojo.internal.bindings.chrome.mojom.IndigoAgent.getRemote = function() {
  let remote = new mojo.internal.bindings.chrome.mojom.IndigoAgentRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
...
mojo.internal.bindings.chrome.mojom.IndigoAgentReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('chrome.mojom.IndigoAgent', [
      { explicit: null },
      { explicit: null },
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.chrome.mojom.IndigoAgent_InjectScript_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.injectScript');
          const result = this.impl.injectScript(params.arg_script_content, params.arg_script_url, params.arg_origin, params.arg_host);
          const expectsResponse = header.expectsResponse || (header.flags & 1);
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              const resp_obj = response;
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.chrome.mojom.IndigoAgent_InjectScript_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
            }).catch(e => console.error('[GeneratedReceiver] injectScript FAILED:', e));
          }
          break;
        }
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.chrome.mojom.IndigoAgent_Invoke_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.invoke');
          const result = this.impl.invoke();
          const expectsResponse = header.expectsResponse || (header.flags & 1);
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              const resp_obj = response;
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.chrome.mojom.IndigoAgent_Invoke_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
        ...
        case 2: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.chrome.mojom.IndigoAgent_Reset_ParamsSpec.$.structSpec);
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.chrome.mojom.IndigoAgent_Reset_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
...
mojo.internal.bindings.chrome.mojom.IndigoAgentReceiver = mojo.internal.bindings.chrome.mojom.IndigoAgentReceiver;

mojo.internal.bindings.chrome.mojom.IndigoAgentPtr = mojo.internal.bindings.chrome.mojom.IndigoAgentRemote;
mojo.internal.bindings.chrome.mojom.IndigoAgentRequest = mojo.internal.bindings.chrome.mojom.IndigoAgentPendingReceiver;


// Interface: IndigoOnboardingDialogHost
mojo.internal.bindings.chrome.mojom.IndigoOnboardingDialogHostPendingReceiver = class {
  constructor(handle) {
    this.handle = handle;
    if (handle) {
      this.__mojoHandle = handle.router_ ? handle.router_.pipe_ : (handle.pipe_ || handle);
...
mojo.internal.bindings.chrome.mojom.IndigoOnboardingDialogHostRemote = class {
  static get $interfaceName() {
    return 'chrome.mojom.IndigoOnboardingDialogHost';
  }

  constructor(handle = undefined) {
    this.__mojoHandle = handle;
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.chrome.mojom.IndigoOnboardingDialogHostPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.chrome.mojom.IndigoOnboardingDialogHostRemoteCallHandler(this.proxy);
  }
  ...
  acknowledgeChromeDisclaimer() {
    return this.$.acknowledgeChromeDisclaimer();
  }
};

mojo.internal.bindings.chrome.mojom.IndigoOnboardingDialogHostRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('chrome.mojom.IndigoOnboardingDialogHost', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.chrome.mojom.IndigoOnboardingDialogHost.getRemote = function() {
  let remote = new mojo.internal.bindings.chrome.mojom.IndigoOnboardingDialogHostRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
    'chrome.mojom.IndigoOnboardingDialogHost',
    'context');
  return remote.$;
};

mojo.internal.bindings.chrome.mojom.IndigoOnboardingDialogHostReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('chrome.mojom.IndigoOnboardingDialogHost', [
      { explicit: null },
    ]);
    ordinals.forEach((ord, idx) => {
      this.ordinalMap.set(ord, idx); // Scrambled/Explicit
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.chrome.mojom.IndigoOnboardingDialogHost_AcknowledgeChromeDisclaimer_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.acknowledgeChromeDisclaimer');
          const result = this.impl.acknowledgeChromeDisclaimer();
          break;
        }
      }
      } catch (err) {
...
mojo.internal.bindings.chrome.mojom.IndigoOnboardingDialogHostReceiver = mojo.internal.bindings.chrome.mojom.IndigoOnboardingDialogHostReceiver;

mojo.internal.bindings.chrome.mojom.IndigoOnboardingDialogHostPtr = mojo.internal.bindings.chrome.mojom.IndigoOnboardingDialogHostRemote;
mojo.internal.bindings.chrome.mojom.IndigoOnboardingDialogHostRequest = mojo.internal.bindings.chrome.mojom.IndigoOnboardingDialogHostPendingReceiver;
...
mojo.internal.Struct(
    mojo.internal.bindings.chrome.mojom.IndigoAgentHost_ReportInvokeError_ParamsSpec, 'chrome.mojom.IndigoAgentHost_ReportInvokeError_Params', [
      mojo.internal.StructField('arg_error', 0, 0, mojo.internal.bindings.chrome.mojom.IndigoInvokeErrorSpec, null, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.chrome.mojom.IndigoAgent_InjectScript_ParamsSpec, 'chrome.mojom.IndigoAgent_InjectScript_Params', [
      mojo.internal.StructField('arg_script_content', 0, 0, mojo.internal.bindings.mojo_base.mojom.BigStringSpec, null, false, 0, undefined),
      ...
      mojo.internal.StructField('arg_host', 24, 0, mojo.internal.AssociatedInterfaceProxy(mojo.internal.bindings.chrome.mojom.IndigoAgentHostRemote), null, false, 0, undefined),
    ],
    [[0, 40]]);

mojo.internal.Struct(
    mojo.internal.bindings.chrome.mojom.IndigoAgent_InjectScript_ResponseParamsSpec, 'chrome.mojom.IndigoAgent_InjectScript_ResponseParams', [
    ],
    [[0, 8]]);

mojo.internal.Struct(
    mojo.internal.bindings.chrome.mojom.IndigoAgent_Invoke_ParamsSpec, 'chrome.mojom.IndigoAgent_Invoke_Params', [
    ],
    [[0, 8]]);

mojo.internal.Struct(
    mojo.internal.bindings.chrome.mojom.IndigoAgent_Invoke_ResponseParamsSpec, 'chrome.mojom.IndigoAgent_Invoke_ResponseParams', [
    ],
    [[0, 8]]);

mojo.internal.Struct(
    mojo.internal.bindings.chrome.mojom.IndigoAgent_Reset_ParamsSpec, 'chrome.mojom.IndigoAgent_Reset_Params', [
    ],
    [[0, 8]]);

mojo.internal.Struct(
    mojo.internal.bindings.chrome.mojom.IndigoAgent_Reset_ResponseParamsSpec, 'chrome.mojom.IndigoAgent_Reset_ResponseParams', [
    ],
    [[0, 8]]);

mojo.internal.Struct(
    mojo.internal.bindings.chrome.mojom.IndigoOnboardingDialogHost_AcknowledgeChromeDisclaimer_ParamsSpec, 'chrome.mojom.IndigoOnboardingDialogHost_AcknowledgeChromeDisclaimer_Params', [
    ],
    [[0, 8]]);
