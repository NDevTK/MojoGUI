...
// Enum: BarcodeFormat
mojo.internal.bindings.shape_detection.mojom.BarcodeFormat = {
  AZTEC: 0,
  CODE_128: 1,
  CODE_39: 2,
  CODE_93: 3,
...
mojo.internal.Struct(
    mojo.internal.bindings.shape_detection.mojom.BarcodeDetectionResultSpec, 'shape_detection.mojom.BarcodeDetectionResult', [
      ...
      mojo.internal.StructField('arg_format', 16, 0, mojo.internal.bindings.mojo.internal.bindings.shape_detection.mojom.BarcodeFormatSpec.$, null, false, 0, undefined),
...
mojo.internal.Struct(
    mojo.internal.bindings.shape_detection.mojom.BarcodeDetection_Detect_ResponseParamsSpec, 'shape_detection.mojom.BarcodeDetection_Detect_ResponseParams', [
      mojo.internal.StructField('arg_results', 0, 0, mojo.internal.Array(mojo.internal.bindings.mojo.internal.bindings.shape_detection.mojom.BarcodeDetectionResultSpec.$, false), null, false, 0, undefined),
    ],
    [[0, 16]]);
...
mojo.internal.bindings.shape_detection.mojom.BarcodeDetectionRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.shape_detection.mojom.BarcodeDetectionPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.shape_detection.mojom.BarcodeDetectionRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.shape_detection.mojom.BarcodeDetection.getRemote = function() {
  let remote = new mojo.internal.bindings.shape_detection.mojom.BarcodeDetectionRemote();
...
mojo.internal.bindings.shape_detection.mojom.BarcodeDetectionReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
        ...
        case 0: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.shape_detection.mojom.BarcodeDetection_Detect_ResponseParamsSpec, header, rawHeader);
               responder(response);
...
mojo.internal.bindings.shape_detection.mojom.BarcodeDetectionReceiver = mojo.internal.bindings.shape_detection.mojom.BarcodeDetectionReceiver;
