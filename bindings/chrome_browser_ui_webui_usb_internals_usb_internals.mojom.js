...
mojo.internal.bindings.mojom.UsbInternalsPageHandlerRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.mojom.UsbInternalsPageHandlerPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.mojom.UsbInternalsPageHandlerRemoteCallHandler(this.proxy);
  }
  ...
  bindUsbDeviceManagerInterface(arg_receiver) {
    return this.$.bindUsbDeviceManagerInterface(arg_receiver);
  }
  bindTestInterface(arg_receiver) {
    return this.$.bindTestInterface(arg_receiver);
  }
};
...
mojo.internal.bindings.mojom.UsbInternalsPageHandler.getRemote = function() {
  let remote = new mojo.internal.bindings.mojom.UsbInternalsPageHandlerRemote();
...
mojo.internal.bindings.mojom.UsbInternalsPageHandlerReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.mojom.UsbInternalsPageHandler_BindUsbDeviceManagerInterface_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for BindUsbDeviceManagerInterface failed with TypeError');
           }
        }
        // Try Method 1: BindTestInterface
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.mojom.UsbInternalsPageHandler_BindTestInterface_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for BindTestInterface failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.mojom.UsbInternalsPageHandlerReceiver = mojo.internal.bindings.mojom.UsbInternalsPageHandlerReceiver;
