...
mojo.internal.bindings.media.mojom.VideoDecoderFactoryProcess = {};
mojo.internal.bindings.media.mojom.VideoDecoderFactoryProcessSpec = { $ : {} };
mojo.internal.bindings.media.mojom.VideoDecoderFactoryProcess.$interfaceName = 'media.mojom.VideoDecoderFactoryProcess';
...
mojo.internal.bindings.media.mojom.VideoDecoderFactoryProcessRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.media.mojom.VideoDecoderFactoryProcessPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.media.mojom.VideoDecoderFactoryProcessRemoteCallHandler(this.proxy);
  }
  ...
  initializeVideoDecoderFactory(arg_gpu_feature_info, arg_receiver, arg_gpu_remote) {
    return this.$.initializeVideoDecoderFactory(arg_gpu_feature_info, arg_receiver, arg_gpu_remote);
  }
};

mojo.internal.bindings.media.mojom.VideoDecoderFactoryProcessRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('media.mojom.VideoDecoderFactoryProcess', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.media.mojom.VideoDecoderFactoryProcess.getRemote = function() {
  let remote = new mojo.internal.bindings.media.mojom.VideoDecoderFactoryProcessRemote();
...
mojo.internal.bindings.media.mojom.VideoDecoderFactoryProcessReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('media.mojom.VideoDecoderFactoryProcess', [
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.media.mojom.VideoDecoderFactoryProcess_InitializeVideoDecoderFactory_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for InitializeVideoDecoderFactory failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.media.mojom.VideoDecoderFactoryProcessReceiver = mojo.internal.bindings.media.mojom.VideoDecoderFactoryProcessReceiver;
