...
mojo.internal.bindings.commerce.price_insights.mojom.PriceInsightsHandlerRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.commerce.price_insights.mojom.PriceInsightsHandlerPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.commerce.price_insights.mojom.PriceInsightsHandlerRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.commerce.price_insights.mojom.PriceInsightsHandler.getRemote = function() {
  let remote = new mojo.internal.bindings.commerce.price_insights.mojom.PriceInsightsHandlerRemote();
...
mojo.internal.bindings.commerce.price_insights.mojom.PriceInsightsHandlerReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.commerce.price_insights.mojom.PriceInsightsHandler_ShowSidePanelUI_ParamsSpec.$.structSpec;
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.commerce.price_insights.mojom.PriceInsightsHandler_ShowFeedback_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for ShowFeedback failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.commerce.price_insights.mojom.PriceInsightsHandler_ShowSidePanelUI_ParamsSpec.$.structSpec);
        ...
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.commerce.price_insights.mojom.PriceInsightsHandler_ShowFeedback_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.commerce.price_insights.mojom.PriceInsightsHandlerReceiver = mojo.internal.bindings.commerce.price_insights.mojom.PriceInsightsHandlerReceiver;

mojo.internal.bindings.commerce.price_insights.mojom.PriceInsightsHandlerPtr = mojo.internal.bindings.commerce.price_insights.mojom.PriceInsightsHandlerRemote;
mojo.internal.bindings.commerce.price_insights.mojom.PriceInsightsHandlerRequest = mojo.internal.bindings.commerce.price_insights.mojom.PriceInsightsHandlerPendingReceiver;
...
mojo.internal.bindings.commerce.price_insights.mojom.PriceInsightsHandlerFactoryRemote = class {
  static get $interfaceName() {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.commerce.price_insights.mojom.PriceInsightsHandlerFactoryPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.commerce.price_insights.mojom.PriceInsightsHandlerFactoryRemoteCallHandler(this.proxy);
  }
  ...
  createPriceInsightsHandler(arg_handler) {
    return this.$.createPriceInsightsHandler(arg_handler);
  }
};
...
mojo.internal.bindings.commerce.price_insights.mojom.PriceInsightsHandlerFactory.getRemote = function() {
  let remote = new mojo.internal.bindings.commerce.price_insights.mojom.PriceInsightsHandlerFactoryRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
...
mojo.internal.bindings.commerce.price_insights.mojom.PriceInsightsHandlerFactoryReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.commerce.price_insights.mojom.PriceInsightsHandlerFactory_CreatePriceInsightsHandler_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for CreatePriceInsightsHandler failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
             console.warn('[GeneratedReceiver] Failed to discover ordinal ' + header.ordinal);
...
mojo.internal.bindings.commerce.price_insights.mojom.PriceInsightsHandlerFactoryReceiver = mojo.internal.bindings.commerce.price_insights.mojom.PriceInsightsHandlerFactoryReceiver;
