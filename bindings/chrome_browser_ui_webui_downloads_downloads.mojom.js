...
downloads.mojom.DataSpec = {
  $: {
    structSpec: {
      ...
      packedSize: 176,
      fields: [
        { name: 'is_insecure', packedOffset: 0, packedBitOffset: 0, type: mojo.internal.Pointer, nullable: false },
        { name: 'total', packedOffset: 8, packedBitOffset: 0, type: mojo.internal.Int64, nullable: false },
        { name: 'by_ext_id', packedOffset: 16, packedBitOffset: 0, type: mojo.internal.String, nullable: false },
        { name: 'by_ext_name', packedOffset: 24, packedBitOffset: 0, type: mojo.internal.String, nullable: false },
        { name: 'danger_type', packedOffset: 32, packedBitOffset: 0, type: downloads.mojom.DangerTypeSpec, nullable: false },
        { name: 'tailored_warning_type', packedOffset: 40, packedBitOffset: 0, type: downloads.mojom.TailoredWarningTypeSpec, nullable: false },
        { name: 'date_string', packedOffset: 48, packedBitOffset: 0, type: mojo.internal.String, nullable: false },
        { name: 'file_name', packedOffset: 56, packedBitOffset: 0, type: mojo.internal.String, nullable: false },
        { name: 'file_path', packedOffset: 64, packedBitOffset: 0, type: mojo.internal.String, nullable: false },
        { name: 'file_url', packedOffset: 72, packedBitOffset: 0, type: mojo.internal.String, nullable: false },
        { name: 'id', packedOffset: 80, packedBitOffset: 0, type: mojo.internal.String, nullable: false },
        { name: 'last_reason_text', packedOffset: 88, packedBitOffset: 0, type: mojo.internal.String, nullable: false },
        { name: 'progress_status_text', packedOffset: 96, packedBitOffset: 0, type: mojo.internal.String, nullable: false },
        { name: 'show_in_folder_text', packedOffset: 104, packedBitOffset: 0, type: mojo.internal.String, nullable: false },
        { name: 'since_string', packedOffset: 112, packedBitOffset: 0, type: mojo.internal.String, nullable: false },
        { name: 'state', packedOffset: 120, packedBitOffset: 0, type: downloads.mojom.StateSpec, nullable: false },
        { name: 'display_initiator_origin', packedOffset: 128, packedBitOffset: 0, type: mojo_base.mojom.String16Spec, nullable: false },
        { name: 'url', packedOffset: 136, packedBitOffset: 0, type: url.mojom.UrlSpec, nullable: true },
        { name: 'safe_browsing_state', packedOffset: 144, packedBitOffset: 0, type: downloads.mojom.SafeBrowsingStateSpec, nullable: false },
        { name: 'percent', packedOffset: 152, packedBitOffset: 0, type: mojo.internal.Int32, nullable: false },
        { name: 'started', packedOffset: 156, packedBitOffset: 0, type: mojo.internal.Int32, nullable: false },
        { name: 'file_externally_removed', packedOffset: 160, packedBitOffset: 0, type: mojo.internal.Bool, nullable: false },
        { name: 'is_dangerous', packedOffset: 160, packedBitOffset: 1, type: mojo.internal.Bool, nullable: false },
        { name: 'is_reviewable', packedOffset: 160, packedBitOffset: 2, type: mojo.internal.Bool, nullable: false },
        { name: 'otr', packedOffset: 160, packedBitOffset: 3, type: mojo.internal.Bool, nullable: false },
        { name: 'resume', packedOffset: 160, packedBitOffset: 4, type: mojo.internal.Bool, nullable: false },
        { name: 'retry', packedOffset: 160, packedBitOffset: 5, type: mojo.internal.Bool, nullable: false },
        { name: 'has_safe_browsing_verdict', packedOffset: 160, packedBitOffset: 6, type: mojo.internal.Bool, nullable: false },
      ],
      versions: [{version: 0}]
    }
  }
...
downloads.mojom.Page_UpdateItem_ParamsSpec = {
  $: {
    structSpec: {
      ...
      packedSize: 24,
      fields: [
        { name: 'data', packedOffset: 0, packedBitOffset: 0, type: downloads.mojom.DataSpec, nullable: false },
