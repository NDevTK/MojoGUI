...
mojo.internal.bindings.history.mojom.HistoryEntrySpec = { $: {} };
mojo.internal.bindings.history.mojom.QueryResultSpec = { $: {} };
...
mojo.internal.Struct(
    mojo.internal.bindings.history.mojom.QueryStateSpec, 'history.mojom.QueryState', [
      mojo.internal.StructField('arg_search_term', 0, 0, mojo.internal.String, null, false, 0, undefined),
      mojo.internal.StructField('arg_after', 8, 0, mojo.internal.String, null, true, 0, undefined),
      mojo.internal.StructField('arg_incremental', 16, 0, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_querying', 16, 1, mojo.internal.Bool, false, false, 0, undefined),
    ],
    [[0, 32]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.history.mojom.DebugInfoSpec, 'history.mojom.DebugInfo', [
      mojo.internal.StructField('arg_visit_count', 0, 0, mojo.internal.Uint32, 0, false, 0, undefined),
      mojo.internal.StructField('arg_typed_count', 4, 0, mojo.internal.Uint32, 0, false, 0, undefined),
      mojo.internal.StructField('arg_is_url_in_local_database', 8, 0, mojo.internal.Bool, false, false, 0, undefined),
    ],
    [[0, 24]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.history.mojom.HistoryEntrySpec, 'history.mojom.HistoryEntry', [
      ...
      mojo.internal.StructField('arg_remote_icon_url_for_uma', 104, 0, mojo.internal.String, null, false, 0, undefined),
      mojo.internal.StructField('arg_debug', 112, 0, mojo.internal.bindings.history.mojom.DebugInfoSpec, null, true, 0, undefined),
      mojo.internal.StructField('arg_host_filtering_behavior', 120, 0, mojo.internal.bindings.history.mojom.FilteringBehaviorSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_selected', 124, 0, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_starred', 124, 1, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_blocked_visit', 124, 2, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_is_url_in_remote_user_data', 124, 3, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_is_actor_visit', 124, 4, mojo.internal.Bool, false, false, 0, undefined),
    ],
    [[0, 136]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.history.mojom.PageHandler_QueryHistory_ParamsSpec, 'history.mojom.PageHandler_QueryHistory_Params', [
      ...
      mojo.internal.StructField('arg_begin_time_$value', 8, 0, mojo.internal.Double, 0, false, 0, { isPrimary: false, linkedValueFieldName: 'arg_begin_time_$flag', originalFieldName: 'arg_begin_time' }),
      mojo.internal.StructField('arg_max_results', 16, 0, mojo.internal.Int32, 0, false, 0, undefined),
      mojo.internal.StructField('arg_begin_time_$flag', 20, 0, mojo.internal.Bool, false, false, 0, { isPrimary: true, linkedValueFieldName: 'arg_begin_time_$value', originalFieldName: 'arg_begin_time' }),
    ],
    [[0, 32]]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.history.mojom.PageHandler_SetPage_ParamsSpec.$.structSpec;
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.history.mojom.PageHandler_QueryHistory_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for QueryHistory failed with TypeError');
           }
        }
        // Try Method 2: QueryHistoryContinuation
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.history.mojom.PageHandler_QueryHistoryContinuation_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for QueryHistoryContinuation failed with TypeError');
           }
        }
        // Try Method 3: RemoveVisits
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.history.mojom.PageHandler_RemoveVisits_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.history.mojom.PageHandler_OpenClearBrowsingDataDialog_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OpenClearBrowsingDataDialog failed with TypeError');
           }
        }
        // Try Method 5: RemoveBookmark
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.history.mojom.PageHandler_RemoveBookmark_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for RemoveBookmark failed with TypeError');
           }
        }
        // Try Method 6: SetLastSelectedTab
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.history.mojom.PageHandler_SetLastSelectedTab_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for SetLastSelectedTab failed with TypeError');
           }
        }
        // Try Method 7: ShowSidePanelUI
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.history.mojom.PageHandler_ShowSidePanelUI_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.history.mojom.PageHandler_RequestAccountInfo_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.history.mojom.PageHandler_TurnOnHistorySync_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for TurnOnHistorySync failed with TypeError');
           }
        }
        // Try Method 10: ShouldShowHistoryPageHistorySyncPromo
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.history.mojom.PageHandler_ShouldShowHistoryPageHistorySyncPromo_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for ShouldShowHistoryPageHistorySyncPromo failed with TypeError');
           }
        }
        // Try Method 11: RecordHistoryPageHistorySyncPromoDismissed
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.history.mojom.PageHandler_RecordHistoryPageHistorySyncPromoDismissed_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for RecordHistoryPageHistorySyncPromoDismissed failed with TypeError');
           }
        }
        // Try Method 12: IncrementHistoryPageHistorySyncPromoShownCount
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.history.mojom.PageHandler_IncrementHistoryPageHistorySyncPromoShownCount_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for IncrementHistoryPageHistorySyncPromoShownCount failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.history.mojom.Page_OnHistoryDeleted_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.history.mojom.Page_OnHasOtherFormsChanged_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OnHasOtherFormsChanged failed with TypeError');
           }
        }
        // Try Method 2: SendAccountInfo
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.history.mojom.Page_SendAccountInfo_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
