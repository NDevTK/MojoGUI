...
mojo.internal.bindings.history.mojom.PageHandlerRemote = class {
  ...
  queryHistory(arg_query, arg_max_results, arg_begin_time) {
    return this.$.queryHistory(arg_query, arg_max_results, arg_begin_time);
  }
...
mojo.internal.bindings.history.mojom.PageHandlerRemoteCallHandler = class {
  ...
  queryHistory(arg_query, arg_max_results, arg_begin_time) {
    return this.proxy.sendMessage(
      ...
      [arg_query, arg_max_results, arg_begin_time],
      false);
  }
