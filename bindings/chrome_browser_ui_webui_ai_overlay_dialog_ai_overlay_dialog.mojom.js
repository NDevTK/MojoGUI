...
mojo.internal.bindings.ai_overlay_dialog.mojom.PageRemote = class {
  ...
  updateCurrentPageContext(arg_page_title, arg_page_content) {
    return this.$.updateCurrentPageContext(arg_page_title, arg_page_content);
  }
...
mojo.internal.bindings.ai_overlay_dialog.mojom.PageRemoteCallHandler = class {
  ...
  updateCurrentPageContext(arg_page_title, arg_page_content) {
    return this.proxy.sendMessage(
      ...
      mojo.internal.bindings.ai_overlay_dialog.mojom.Page_UpdateCurrentPageContext_ParamsSpec,
      null,
      [arg_page_title, arg_page_content],
      false);
  }
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        ...
        case 1: {
          ...
          const result = this.impl.updateCurrentPageContext(params.arg_page_title, params.arg_page_content);
          break;
        }
        case 2: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
...
mojo.internal.Struct(
    mojo.internal.bindings.ai_overlay_dialog.mojom.Page_UpdateCurrentPageContext_ParamsSpec, 'ai_overlay_dialog.mojom.Page_UpdateCurrentPageContext_Params', [
      ...
      mojo.internal.StructField('arg_page_content', 8, 0, mojo.internal.String, null, false, 0, undefined),
    ],
    [[0, 24]]);
