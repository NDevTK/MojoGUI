// Auto-generated MojoJS binding
 // Source: chromium_src/chrome/browser/ui/webui/ai_overlay_dialog/ai_overlay_dialog.mojom
...
mojo.internal.bindings.ai_overlay_dialog.mojom.NodeRoleSpec = mojo.internal.bindings.ai_overlay_dialog.mojom.NodeRoleSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.ai_overlay_dialog.mojom.DebugFileTypeSpec = mojo.internal.bindings.ai_overlay_dialog.mojom.DebugFileTypeSpec || { $: mojo.internal.Enum().$ };
...
mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandlerFactorySpec = mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandlerFactorySpec || { $ : {} };
if (mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandlerFactorySpec.$.structSpec && mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandlerFactorySpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandlerFactorySpec.$ = {};
mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandlerFactory.$interfaceName = 'ai_overlay_dialog.mojom.PageHandlerFactory';
mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandlerFactory_CreatePageHandler_ParamsSpec = mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandlerFactory_CreatePageHandler_ParamsSpec || { $: {} };
if (mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandlerFactory_CreatePageHandler_ParamsSpec.$.structSpec && mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandlerFactory_CreatePageHandler_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandlerFactory_CreatePageHandler_ParamsSpec.$ = {};
mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandler = mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandler || {};
mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandlerSpec = mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandlerSpec || { $ : {} };
if (mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandlerSpec.$.structSpec && mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandlerSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandlerSpec.$ = {};
mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandler.$interfaceName = 'ai_overlay_dialog.mojom.PageHandler';
mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandler_GetMockAudioData_ParamsSpec = mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandler_GetMockAudioData_ParamsSpec || { $: {} };
...
mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandler_CaptureRawViewportRegion_ParamsSpec = mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandler_CaptureRawViewportRegion_ParamsSpec || { $: {} };
if (mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandler_CaptureRawViewportRegion_ParamsSpec.$.structSpec && mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandler_CaptureRawViewportRegion_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandler_CaptureRawViewportRegion_ParamsSpec.$ = {};
mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandler_CaptureRawViewportRegion_ResponseParamsSpec = mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandler_CaptureRawViewportRegion_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandler_CaptureRawViewportRegion_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandler_CaptureRawViewportRegion_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandler_CaptureRawViewportRegion_ResponseParamsSpec.$ = {};
mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandler_SetRememberedNote_ParamsSpec = mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandler_SetRememberedNote_ParamsSpec || { $: {} };
if (mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandler_SetRememberedNote_ParamsSpec.$.structSpec && mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandler_SetRememberedNote_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandler_SetRememberedNote_ParamsSpec.$ = {};
mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandler_SetRememberedNote_ResponseParamsSpec = mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandler_SetRememberedNote_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandler_SetRememberedNote_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandler_SetRememberedNote_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandler_SetRememberedNote_ResponseParamsSpec.$ = {};
mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandler_GetRememberedNotes_ParamsSpec = mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandler_GetRememberedNotes_ParamsSpec || { $: {} };
if (mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandler_GetRememberedNotes_ParamsSpec.$.structSpec && mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandler_GetRememberedNotes_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandler_GetRememberedNotes_ParamsSpec.$ = {};
mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandler_GetRememberedNotes_ResponseParamsSpec = mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandler_GetRememberedNotes_ResponseParamsSpec || { $: {} };
...
mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandler_StartStreamingSession_ParamsSpec = mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandler_StartStreamingSession_ParamsSpec || { $: {} };
if (mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandler_StartStreamingSession_ParamsSpec.$.structSpec && mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandler_StartStreamingSession_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandler_StartStreamingSession_ParamsSpec.$ = {};
mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandler_SendAudioChunk_ParamsSpec = mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandler_SendAudioChunk_ParamsSpec || { $: {} };
if (mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandler_SendAudioChunk_ParamsSpec.$.structSpec && mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandler_SendAudioChunk_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandler_SendAudioChunk_ParamsSpec.$ = {};
mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandler_SendTextInput_ParamsSpec = mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandler_SendTextInput_ParamsSpec || { $: {} };
if (mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandler_SendTextInput_ParamsSpec.$.structSpec && mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandler_SendTextInput_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandler_SendTextInput_ParamsSpec.$ = {};
mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandler_ReportPlaybackStatus_ParamsSpec = mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandler_ReportPlaybackStatus_ParamsSpec || { $: {} };
if (mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandler_ReportPlaybackStatus_ParamsSpec.$.structSpec && mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandler_ReportPlaybackStatus_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandler_ReportPlaybackStatus_ParamsSpec.$ = {};
mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandler_StopStreamingSession_ParamsSpec = mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandler_StopStreamingSession_ParamsSpec || { $: {} };
if (mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandler_StopStreamingSession_ParamsSpec.$.structSpec && mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandler_StopStreamingSession_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandler_StopStreamingSession_ParamsSpec.$ = {};
...
mojo.internal.bindings.ai_overlay_dialog.mojom.Page.$interfaceName = 'ai_overlay_dialog.mojom.Page';
mojo.internal.bindings.ai_overlay_dialog.mojom.Page_DidChangePage_ParamsSpec = mojo.internal.bindings.ai_overlay_dialog.mojom.Page_DidChangePage_ParamsSpec || { $: {} };
if (mojo.internal.bindings.ai_overlay_dialog.mojom.Page_DidChangePage_ParamsSpec.$.structSpec && mojo.internal.bindings.ai_overlay_dialog.mojom.Page_DidChangePage_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ai_overlay_dialog.mojom.Page_DidChangePage_ParamsSpec.$ = {};
mojo.internal.bindings.ai_overlay_dialog.mojom.Page_UpdateCurrentPageContext_ParamsSpec = mojo.internal.bindings.ai_overlay_dialog.mojom.Page_UpdateCurrentPageContext_ParamsSpec || { $: {} };
if (mojo.internal.bindings.ai_overlay_dialog.mojom.Page_UpdateCurrentPageContext_ParamsSpec.$.structSpec && mojo.internal.bindings.ai_overlay_dialog.mojom.Page_UpdateCurrentPageContext_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ai_overlay_dialog.mojom.Page_UpdateCurrentPageContext_ParamsSpec.$ = {};
mojo.internal.bindings.ai_overlay_dialog.mojom.Page_SetInputCaptionsVisible_ParamsSpec = mojo.internal.bindings.ai_overlay_dialog.mojom.Page_SetInputCaptionsVisible_ParamsSpec || { $: {} };
if (mojo.internal.bindings.ai_overlay_dialog.mojom.Page_SetInputCaptionsVisible_ParamsSpec.$.structSpec && mojo.internal.bindings.ai_overlay_dialog.mojom.Page_SetInputCaptionsVisible_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ai_overlay_dialog.mojom.Page_SetInputCaptionsVisible_ParamsSpec.$ = {};
mojo.internal.bindings.ai_overlay_dialog.mojom.Page_SetOutputCaptionsVisible_ParamsSpec = mojo.internal.bindings.ai_overlay_dialog.mojom.Page_SetOutputCaptionsVisible_ParamsSpec || { $: {} };
if (mojo.internal.bindings.ai_overlay_dialog.mojom.Page_SetOutputCaptionsVisible_ParamsSpec.$.structSpec && mojo.internal.bindings.ai_overlay_dialog.mojom.Page_SetOutputCaptionsVisible_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ai_overlay_dialog.mojom.Page_SetOutputCaptionsVisible_ParamsSpec.$ = {};
mojo.internal.bindings.ai_overlay_dialog.mojom.Page_SetUsePersona_ParamsSpec = mojo.internal.bindings.ai_overlay_dialog.mojom.Page_SetUsePersona_ParamsSpec || { $: {} };
if (mojo.internal.bindings.ai_overlay_dialog.mojom.Page_SetUsePersona_ParamsSpec.$.structSpec && mojo.internal.bindings.ai_overlay_dialog.mojom.Page_SetUsePersona_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ai_overlay_dialog.mojom.Page_SetUsePersona_ParamsSpec.$ = {};
mojo.internal.bindings.ai_overlay_dialog.mojom.Page_OnStreamingSessionStateChanged_ParamsSpec = mojo.internal.bindings.ai_overlay_dialog.mojom.Page_OnStreamingSessionStateChanged_ParamsSpec || { $: {} };
if (mojo.internal.bindings.ai_overlay_dialog.mojom.Page_OnStreamingSessionStateChanged_ParamsSpec.$.structSpec && mojo.internal.bindings.ai_overlay_dialog.mojom.Page_OnStreamingSessionStateChanged_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ai_overlay_dialog.mojom.Page_OnStreamingSessionStateChanged_ParamsSpec.$ = {};
mojo.internal.bindings.ai_overlay_dialog.mojom.Page_OnTranscriptions_ParamsSpec = mojo.internal.bindings.ai_overlay_dialog.mojom.Page_OnTranscriptions_ParamsSpec || { $: {} };
if (mojo.internal.bindings.ai_overlay_dialog.mojom.Page_OnTranscriptions_ParamsSpec.$.structSpec && mojo.internal.bindings.ai_overlay_dialog.mojom.Page_OnTranscriptions_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ai_overlay_dialog.mojom.Page_OnTranscriptions_ParamsSpec.$ = {};
mojo.internal.bindings.ai_overlay_dialog.mojom.Page_OnAudioOutput_ParamsSpec = mojo.internal.bindings.ai_overlay_dialog.mojom.Page_OnAudioOutput_ParamsSpec || { $: {} };
if (mojo.internal.bindings.ai_overlay_dialog.mojom.Page_OnAudioOutput_ParamsSpec.$.structSpec && mojo.internal.bindings.ai_overlay_dialog.mojom.Page_OnAudioOutput_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ai_overlay_dialog.mojom.Page_OnAudioOutput_ParamsSpec.$ = {};
mojo.internal.bindings.ai_overlay_dialog.mojom.Page_OnGenerationStateChanged_ParamsSpec = mojo.internal.bindings.ai_overlay_dialog.mojom.Page_OnGenerationStateChanged_ParamsSpec || { $: {} };
if (mojo.internal.bindings.ai_overlay_dialog.mojom.Page_OnGenerationStateChanged_ParamsSpec.$.structSpec && mojo.internal.bindings.ai_overlay_dialog.mojom.Page_OnGenerationStateChanged_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ai_overlay_dialog.mojom.Page_OnGenerationStateChanged_ParamsSpec.$ = {};
...
// Enum: NodeRole
mojo.internal.bindings.ai_overlay_dialog.mojom.NodeRole = {
  kNone: 0,
  kButton: 1,
  kCheckbox: 2,
  kCombobox: 3,
...
// Enum: DebugFileType
mojo.internal.bindings.ai_overlay_dialog.mojom.DebugFileType = {
  kPrimingTurnMarkdown: 0,
  kImage: 1,
};

// Interface: PageHandlerFactory
mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandlerFactoryPendingReceiver = class {
  constructor(handle) {
    this.handle = handle;
    if (handle) {
...
mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandlerFactoryRemote = class {
  static get $interfaceName() {
    return 'ai_overlay_dialog.mojom.PageHandlerFactory';
  }

  constructor(handle = undefined) {
    this.__mojoHandle = handle;
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandlerFactoryPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandlerFactoryRemoteCallHandler(this.proxy);
  }
  ...
  createPageHandler(arg_handler, arg_page, arg_tools) {
    return this.$.createPageHandler(arg_handler, arg_page, arg_tools);
  }
};

mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandlerFactoryRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('ai_overlay_dialog.mojom.PageHandlerFactory', [
      { explicit: null },
    ]);
  }
  ...
  createPageHandler(arg_handler, arg_page, arg_tools) {
    return this.proxy.sendMessage(
      ...
      mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandlerFactory_CreatePageHandler_ParamsSpec,
      null,
      [arg_handler, arg_page, arg_tools],
      false);
  }

};

mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandlerFactory.getRemote = function() {
  let remote = new mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandlerFactoryRemote();
...
mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandlerFactoryReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('ai_overlay_dialog.mojom.PageHandlerFactory', [
      { explicit: null },
    ]);
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        case 0: {
          ...
          const params = decoder.decodeStructInline(mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandlerFactory_CreatePageHandler_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.createPageHandler');
          const result = this.impl.createPageHandler(params.arg_handler, params.arg_page, params.arg_tools);
          break;
        }
      }
      } catch (err) {
...
mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandlerFactoryReceiver = mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandlerFactoryReceiver;

mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandlerFactoryPtr = mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandlerFactoryRemote;
mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandlerFactoryRequest = mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandlerFactoryPendingReceiver;


// Interface: PageHandler
mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandlerPendingReceiver = class {
  constructor(handle) {
    this.handle = handle;
    if (handle) {
      this.__mojoHandle = handle.router_ ? handle.router_.pipe_ : (handle.pipe_ || handle);
...
mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandlerRemote = class {
  static get $interfaceName() {
    return 'ai_overlay_dialog.mojom.PageHandler';
  }

  constructor(handle = undefined) {
    this.__mojoHandle = handle;
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandlerPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandlerRemoteCallHandler(this.proxy);
  }
  ...
  captureRawViewportRegion(arg_x, arg_y, arg_width, arg_height) {
    return this.$.captureRawViewportRegion(arg_x, arg_y, arg_width, arg_height);
  }
  setRememberedNote(arg_note) {
    return this.$.setRememberedNote(arg_note);
  }
  getRememberedNotes() {
    return this.$.getRememberedNotes();
  }
  ...
  startStreamingSession() {
    return this.$.startStreamingSession();
  }
  sendAudioChunk(arg_pcm_data) {
    return this.$.sendAudioChunk(arg_pcm_data);
  }
  sendTextInput(arg_text) {
    return this.$.sendTextInput(arg_text);
  }
  reportPlaybackStatus(arg_last_played_sequence_number) {
    return this.$.reportPlaybackStatus(arg_last_played_sequence_number);
  }
...
mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandlerRemoteCallHandler = class {
  ...
  captureRawViewportRegion(arg_x, arg_y, arg_width, arg_height) {
    return this.proxy.sendMessage(
      ...
      mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandler_CaptureRawViewportRegion_ParamsSpec,
      mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandler_CaptureRawViewportRegion_ResponseParamsSpec,
      [arg_x, arg_y, arg_width, arg_height],
      false);
  }
  ...
  saveDebugFile(arg_type, arg_content) {
    return this.proxy.sendMessage(
      ...
      mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandler_SaveDebugFile_ParamsSpec,
      null,
      [arg_type, arg_content],
      false);
  }
  ...
  sendAudioChunk(arg_pcm_data) {
    return this.proxy.sendMessage(
      ...
      mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandler_SendAudioChunk_ParamsSpec,
      null,
      [arg_pcm_data],
      false);
  }
  ...
  sendTextInput(arg_text) {
    return this.proxy.sendMessage(
      ...
      mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandler_SendTextInput_ParamsSpec,
      null,
      [arg_text],
      false);
  }
  ...
  reportPlaybackStatus(arg_last_played_sequence_number) {
    return this.proxy.sendMessage(
      ...
      mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandler_ReportPlaybackStatus_ParamsSpec,
      null,
      [arg_last_played_sequence_number],
      false);
  }
...
mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandler.getRemote = function() {
  let remote = new mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandlerRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
    'ai_overlay_dialog.mojom.PageHandler',
    'context');
  return remote.$;
};

mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandlerReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandler_GetMockAudioData_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.getMockAudioData');
          const result = this.impl.getMockAudioData();
          const expectsResponse = header.expectsResponse || (header.flags & 1);
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              const val = (response && typeof response === 'object' && 'arg_json_data' in response) ? response['arg_json_data'] : response;
              const resp_obj = { 'arg_json_data': val };
        ...
        case 4: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandler_CaptureRawViewportRegion_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.captureRawViewportRegion');
          const result = this.impl.captureRawViewportRegion(params.arg_x, params.arg_y, params.arg_width, params.arg_height);
          const expectsResponse = header.expectsResponse || (header.flags & 1);
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandler_CaptureRawViewportRegion_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
            }).catch(e => console.error('[GeneratedReceiver] captureRawViewportRegion FAILED:', e));
          }
          break;
        }
        case 5: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandler_SetRememberedNote_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.setRememberedNote');
          const result = this.impl.setRememberedNote(params.arg_note);
          const expectsResponse = header.expectsResponse || (header.flags & 1);
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandler_SetRememberedNote_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
            }).catch(e => console.error('[GeneratedReceiver] setRememberedNote FAILED:', e));
          }
          break;
        }
        case 6: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandler_GetRememberedNotes_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.getRememberedNotes');
          const result = this.impl.getRememberedNotes();
          const expectsResponse = header.expectsResponse || (header.flags & 1);
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              const val = (response && typeof response === 'object' && 'arg_notes' in response) ? response['arg_notes'] : response;
              const resp_obj = { 'arg_notes': val };
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandler_GetRememberedNotes_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
            }).catch(e => console.error('[GeneratedReceiver] getRememberedNotes FAILED:', e));
          }
          break;
        }
        case 7: {
        ...
        case 9: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandler_StartStreamingSession_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.startStreamingSession');
          const result = this.impl.startStreamingSession();
          break;
        }
        case 10: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandler_SendAudioChunk_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.sendAudioChunk');
          const result = this.impl.sendAudioChunk(params.arg_pcm_data);
          break;
        }
        case 11: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandler_SendTextInput_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.sendTextInput');
          const result = this.impl.sendTextInput(params.arg_text);
          break;
        }
        case 12: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandler_ReportPlaybackStatus_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.reportPlaybackStatus');
          const result = this.impl.reportPlaybackStatus(params.arg_last_played_sequence_number);
          break;
        }
        case 13: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandler_StopStreamingSession_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.stopStreamingSession');
          const result = this.impl.stopStreamingSession();
          break;
        }
      }
      } catch (err) {
...
mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandlerReceiver = mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandlerReceiver;

mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandlerPtr = mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandlerRemote;
mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandlerRequest = mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandlerPendingReceiver;


// Interface: Page
mojo.internal.bindings.ai_overlay_dialog.mojom.PagePendingReceiver = class {
  constructor(handle) {
    this.handle = handle;
    if (handle) {
      this.__mojoHandle = handle.router_ ? handle.router_.pipe_ : (handle.pipe_ || handle);
...
mojo.internal.bindings.ai_overlay_dialog.mojom.PageRemote = class {
  static get $interfaceName() {
    return 'ai_overlay_dialog.mojom.Page';
  }

  constructor(handle = undefined) {
    this.__mojoHandle = handle;
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.ai_overlay_dialog.mojom.PagePendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.ai_overlay_dialog.mojom.PageRemoteCallHandler(this.proxy);
  }
  ...
  didChangePage(arg_url, arg_title, arg_content) {
    return this.$.didChangePage(arg_url, arg_title, arg_content);
  }
  updateCurrentPageContext(arg_page_title, arg_root_node) {
    return this.$.updateCurrentPageContext(arg_page_title, arg_root_node);
  }
  setInputCaptionsVisible(arg_visible) {
    return this.$.setInputCaptionsVisible(arg_visible);
  }
  setOutputCaptionsVisible(arg_visible) {
    return this.$.setOutputCaptionsVisible(arg_visible);
  }
  setUsePersona(arg_use_persona) {
    return this.$.setUsePersona(arg_use_persona);
  }
  onStreamingSessionStateChanged(arg_connected, arg_session_id, arg_error_message) {
    return this.$.onStreamingSessionStateChanged(arg_connected, arg_session_id, arg_error_message);
  }
  onTranscriptions(arg_input_transcription, arg_output_transcription) {
    return this.$.onTranscriptions(arg_input_transcription, arg_output_transcription);
  }
  onAudioOutput(arg_audio_data, arg_sequence_number) {
    return this.$.onAudioOutput(arg_audio_data, arg_sequence_number);
  }
  onGenerationStateChanged(arg_started, arg_completed, arg_interrupted) {
    return this.$.onGenerationStateChanged(arg_started, arg_completed, arg_interrupted);
  }
};

mojo.internal.bindings.ai_overlay_dialog.mojom.PageRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('ai_overlay_dialog.mojom.Page', [
      { explicit: null },
      { explicit: null },
      { explicit: null },
      { explicit: null },
  ...
  didChangePage(arg_url, arg_title, arg_content) {
    return this.proxy.sendMessage(
      this.ordinals[0],  // ordinal
      mojo.internal.bindings.ai_overlay_dialog.mojom.Page_DidChangePage_ParamsSpec,
      null,
      [arg_url, arg_title, arg_content],
      false);
  }
  ...
  setUsePersona(arg_use_persona) {
    return this.proxy.sendMessage(
      this.ordinals[4],  // ordinal
      mojo.internal.bindings.ai_overlay_dialog.mojom.Page_SetUsePersona_ParamsSpec,
      null,
      [arg_use_persona],
      false);
  }
  ...
  onStreamingSessionStateChanged(arg_connected, arg_session_id, arg_error_message) {
    return this.proxy.sendMessage(
      ...
      mojo.internal.bindings.ai_overlay_dialog.mojom.Page_OnStreamingSessionStateChanged_ParamsSpec,
      null,
      [arg_connected, arg_session_id, arg_error_message],
      false);
  }
  ...
  onTranscriptions(arg_input_transcription, arg_output_transcription) {
    return this.proxy.sendMessage(
      this.ordinals[6],  // ordinal
      mojo.internal.bindings.ai_overlay_dialog.mojom.Page_OnTranscriptions_ParamsSpec,
      null,
      [arg_input_transcription, arg_output_transcription],
      false);
  }
  ...
  onAudioOutput(arg_audio_data, arg_sequence_number) {
    return this.proxy.sendMessage(
      this.ordinals[7],  // ordinal
      mojo.internal.bindings.ai_overlay_dialog.mojom.Page_OnAudioOutput_ParamsSpec,
      null,
      [arg_audio_data, arg_sequence_number],
      false);
  }
  ...
  onGenerationStateChanged(arg_started, arg_completed, arg_interrupted) {
    return this.proxy.sendMessage(
      ...
      mojo.internal.bindings.ai_overlay_dialog.mojom.Page_OnGenerationStateChanged_ParamsSpec,
      null,
      [arg_started, arg_completed, arg_interrupted],
      false);
  }

};

mojo.internal.bindings.ai_overlay_dialog.mojom.Page.getRemote = function() {
  let remote = new mojo.internal.bindings.ai_overlay_dialog.mojom.PageRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
...
mojo.internal.bindings.ai_overlay_dialog.mojom.PageReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('ai_overlay_dialog.mojom.Page', [
      { explicit: null },
      { explicit: null },
      { explicit: null },
      { explicit: null },
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.ai_overlay_dialog.mojom.Page_DidChangePage_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.didChangePage');
          const result = this.impl.didChangePage(params.arg_url, params.arg_title, params.arg_content);
          break;
        }
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.ai_overlay_dialog.mojom.Page_UpdateCurrentPageContext_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.updateCurrentPageContext');
          const result = this.impl.updateCurrentPageContext(params.arg_page_title, params.arg_root_node);
          break;
        }
        case 2: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.ai_overlay_dialog.mojom.Page_SetInputCaptionsVisible_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.setInputCaptionsVisible');
          const result = this.impl.setInputCaptionsVisible(params.arg_visible);
          break;
        }
        case 3: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.ai_overlay_dialog.mojom.Page_SetOutputCaptionsVisible_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.setOutputCaptionsVisible');
          const result = this.impl.setOutputCaptionsVisible(params.arg_visible);
          break;
        }
        case 4: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.ai_overlay_dialog.mojom.Page_SetUsePersona_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.setUsePersona');
          const result = this.impl.setUsePersona(params.arg_use_persona);
          break;
        }
        case 5: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.ai_overlay_dialog.mojom.Page_OnStreamingSessionStateChanged_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.onStreamingSessionStateChanged');
          const result = this.impl.onStreamingSessionStateChanged(params.arg_connected, params.arg_session_id, params.arg_error_message);
          break;
        }
        case 6: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.ai_overlay_dialog.mojom.Page_OnTranscriptions_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.onTranscriptions');
          const result = this.impl.onTranscriptions(params.arg_input_transcription, params.arg_output_transcription);
          break;
        }
        case 7: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.ai_overlay_dialog.mojom.Page_OnAudioOutput_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.onAudioOutput');
          const result = this.impl.onAudioOutput(params.arg_audio_data, params.arg_sequence_number);
          break;
        }
        case 8: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.ai_overlay_dialog.mojom.Page_OnGenerationStateChanged_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.onGenerationStateChanged');
          const result = this.impl.onGenerationStateChanged(params.arg_started, params.arg_completed, params.arg_interrupted);
          break;
        }
      }
      } catch (err) {
...
mojo.internal.bindings.ai_overlay_dialog.mojom.PageReceiver = mojo.internal.bindings.ai_overlay_dialog.mojom.PageReceiver;

mojo.internal.bindings.ai_overlay_dialog.mojom.PagePtr = mojo.internal.bindings.ai_overlay_dialog.mojom.PageRemote;
mojo.internal.bindings.ai_overlay_dialog.mojom.PageRequest = mojo.internal.bindings.ai_overlay_dialog.mojom.PagePendingReceiver;


// Specs (at the end to ensure classes are defined for InterfaceProxy)

// Struct: PageContentNode
mojo.internal.Struct(
    mojo.internal.bindings.ai_overlay_dialog.mojom.PageContentNodeSpec, 'ai_overlay_dialog.mojom.PageContentNode', [
      mojo.internal.StructField('arg_dom_node_id', 0, 0, mojo.internal.Int32, 0, false, 0, undefined),
      mojo.internal.StructField('arg_role', 4, 0, mojo.internal.bindings.ai_overlay_dialog.mojom.NodeRoleSpec, 0, false, 0, undefined),
      mojo.internal.StructField('arg_tag_name', 8, 0, mojo.internal.String, null, false, 0, undefined),
      mojo.internal.StructField('arg_text', 16, 0, mojo.internal.String, null, false, 0, undefined),
      mojo.internal.StructField('arg_value', 24, 0, mojo.internal.String, null, false, 0, undefined),
      ...
      mojo.internal.StructField('arg_is_interactive', 40, 1, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_url', 48, 0, mojo.internal.bindings.url.mojom.UrlSpec, null, true, 0, undefined),
      mojo.internal.StructField('arg_children', 56, 0, mojo.internal.Array(mojo.internal.bindings.ai_overlay_dialog.mojom.PageContentNodeSpec, false), null, false, 0, undefined),
    ],
    [[0, 72]]);
...
mojo.internal.Struct(
    ...
    [[0, 24]]);
mojo.internal.Struct(
    mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandlerFactory_CreatePageHandler_ParamsSpec, 'ai_overlay_dialog.mojom.PageHandlerFactory_CreatePageHandler_Params', [
      mojo.internal.StructField('arg_handler', 0, 0, mojo.internal.InterfaceRequest(mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandlerPendingReceiver), null, false, 0, undefined),
      mojo.internal.StructField('arg_page', 4, 0, mojo.internal.InterfaceProxy(mojo.internal.bindings.ai_overlay_dialog.mojom.PageRemote), null, false, 0, undefined),
      mojo.internal.StructField('arg_tools', 12, 0, mojo.internal.InterfaceRequest(mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayToolsPendingReceiver), null, false, 0, undefined),
    ],
    [[0, 24]]);

mojo.internal.Struct(
    mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandler_GetMockAudioData_ParamsSpec, 'ai_overlay_dialog.mojom.PageHandler_GetMockAudioData_Params', [
    ],
    [[0, 8]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandler_UpdateAudioEnergy_ParamsSpec, 'ai_overlay_dialog.mojom.PageHandler_UpdateAudioEnergy_Params', [
...
mojo.internal.Struct(
    mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandler_CaptureRawViewportRegion_ParamsSpec, 'ai_overlay_dialog.mojom.PageHandler_CaptureRawViewportRegion_Params', [
...
mojo.internal.Struct(
    mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandler_CaptureRawViewportRegion_ResponseParamsSpec, 'ai_overlay_dialog.mojom.PageHandler_CaptureRawViewportRegion_ResponseParams', [
      mojo.internal.StructField('arg_result', 0, 0, mojo.internal.bindings.ai_overlay_dialog.mojom.RawViewportRegionResultSpec, null, true, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandler_SetRememberedNote_ParamsSpec, 'ai_overlay_dialog.mojom.PageHandler_SetRememberedNote_Params', [
      mojo.internal.StructField('arg_note', 0, 0, mojo.internal.bindings.ai_overlay_dialog.mojom.RememberedNoteSpec, null, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandler_SetRememberedNote_ResponseParamsSpec, 'ai_overlay_dialog.mojom.PageHandler_SetRememberedNote_ResponseParams', [
      mojo.internal.StructField('arg_success', 0, 0, mojo.internal.Bool, false, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandler_GetRememberedNotes_ParamsSpec, 'ai_overlay_dialog.mojom.PageHandler_GetRememberedNotes_Params', [
    ],
    [[0, 8]]);

mojo.internal.Struct(
    mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandler_GetRememberedNotes_ResponseParamsSpec, 'ai_overlay_dialog.mojom.PageHandler_GetRememberedNotes_ResponseParams', [
      mojo.internal.StructField('arg_notes', 0, 0, mojo.internal.Array(mojo.internal.bindings.ai_overlay_dialog.mojom.RememberedNoteSpec, false), null, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandler_SaveDebugFile_ParamsSpec, 'ai_overlay_dialog.mojom.PageHandler_SaveDebugFile_Params', [
      mojo.internal.StructField('arg_type', 0, 0, mojo.internal.bindings.ai_overlay_dialog.mojom.DebugFileTypeSpec, null, false, 0, undefined),
...
mojo.internal.Struct(
    mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandler_StartStreamingSession_ParamsSpec, 'ai_overlay_dialog.mojom.PageHandler_StartStreamingSession_Params', [
    ],
    [[0, 8]]);

mojo.internal.Struct(
    mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandler_SendAudioChunk_ParamsSpec, 'ai_overlay_dialog.mojom.PageHandler_SendAudioChunk_Params', [
      mojo.internal.StructField('arg_pcm_data', 0, 0, mojo.internal.bindings.mojo_base.mojom.BigBufferSpec, null, false, 0, undefined),
    ],
    [[0, 24]]);

mojo.internal.Struct(
    mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandler_SendTextInput_ParamsSpec, 'ai_overlay_dialog.mojom.PageHandler_SendTextInput_Params', [
      mojo.internal.StructField('arg_text', 0, 0, mojo.internal.String, null, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandler_ReportPlaybackStatus_ParamsSpec, 'ai_overlay_dialog.mojom.PageHandler_ReportPlaybackStatus_Params', [
      mojo.internal.StructField('arg_last_played_sequence_number', 0, 0, mojo.internal.Int64, 0, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandler_StopStreamingSession_ParamsSpec, 'ai_overlay_dialog.mojom.PageHandler_StopStreamingSession_Params', [
    ],
    [[0, 8]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.ai_overlay_dialog.mojom.Page_DidChangePage_ParamsSpec, 'ai_overlay_dialog.mojom.Page_DidChangePage_Params', [
      ...
      mojo.internal.StructField('arg_content', 16, 0, mojo.internal.String, null, true, 0, undefined),
    ],
    [[0, 32]]);

mojo.internal.Struct(
    mojo.internal.bindings.ai_overlay_dialog.mojom.Page_UpdateCurrentPageContext_ParamsSpec, 'ai_overlay_dialog.mojom.Page_UpdateCurrentPageContext_Params', [
      mojo.internal.StructField('arg_page_title', 0, 0, mojo.internal.String, null, false, 0, undefined),
      mojo.internal.StructField('arg_root_node', 8, 0, mojo.internal.bindings.ai_overlay_dialog.mojom.PageContentNodeSpec, null, true, 0, undefined),
    ],
    [[0, 24]]);

mojo.internal.Struct(
    mojo.internal.bindings.ai_overlay_dialog.mojom.Page_SetInputCaptionsVisible_ParamsSpec, 'ai_overlay_dialog.mojom.Page_SetInputCaptionsVisible_Params', [
      mojo.internal.StructField('arg_visible', 0, 0, mojo.internal.Bool, false, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.ai_overlay_dialog.mojom.Page_SetOutputCaptionsVisible_ParamsSpec, 'ai_overlay_dialog.mojom.Page_SetOutputCaptionsVisible_Params', [
      mojo.internal.StructField('arg_visible', 0, 0, mojo.internal.Bool, false, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.ai_overlay_dialog.mojom.Page_SetUsePersona_ParamsSpec, 'ai_overlay_dialog.mojom.Page_SetUsePersona_Params', [
      mojo.internal.StructField('arg_use_persona', 0, 0, mojo.internal.Bool, false, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.ai_overlay_dialog.mojom.Page_OnStreamingSessionStateChanged_ParamsSpec, 'ai_overlay_dialog.mojom.Page_OnStreamingSessionStateChanged_Params', [
...
mojo.internal.Struct(
    mojo.internal.bindings.ai_overlay_dialog.mojom.Page_OnTranscriptions_ParamsSpec, 'ai_overlay_dialog.mojom.Page_OnTranscriptions_Params', [
      mojo.internal.StructField('arg_input_transcription', 0, 0, mojo.internal.String, null, false, 0, undefined),
      mojo.internal.StructField('arg_output_transcription', 8, 0, mojo.internal.String, null, false, 0, undefined),
    ],
    [[0, 24]]);

mojo.internal.Struct(
    mojo.internal.bindings.ai_overlay_dialog.mojom.Page_OnAudioOutput_ParamsSpec, 'ai_overlay_dialog.mojom.Page_OnAudioOutput_Params', [
      mojo.internal.StructField('arg_audio_data', 0, 0, mojo.internal.bindings.mojo_base.mojom.BigBufferSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_sequence_number', 16, 0, mojo.internal.Int64, 0, false, 0, undefined),
    ],
    [[0, 32]]);

mojo.internal.Struct(
    mojo.internal.bindings.ai_overlay_dialog.mojom.Page_OnGenerationStateChanged_ParamsSpec, 'ai_overlay_dialog.mojom.Page_OnGenerationStateChanged_Params', [
      mojo.internal.StructField('arg_started', 0, 0, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_completed', 0, 1, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_interrupted', 0, 2, mojo.internal.Bool, false, false, 0, undefined),
    ],
    [[0, 16]]);
