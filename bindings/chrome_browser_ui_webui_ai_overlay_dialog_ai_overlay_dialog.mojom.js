...
mojo.internal.bindings.ai_overlay_dialog.mojom.Page_SetCaptionsVisible_ParamsSpec = mojo.internal.bindings.ai_overlay_dialog.mojom.Page_SetCaptionsVisible_ParamsSpec || { $: {} };
if (mojo.internal.bindings.ai_overlay_dialog.mojom.Page_SetCaptionsVisible_ParamsSpec.$.structSpec && mojo.internal.bindings.ai_overlay_dialog.mojom.Page_SetCaptionsVisible_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ai_overlay_dialog.mojom.Page_SetCaptionsVisible_ParamsSpec.$ = {};
...
mojo.internal.bindings.ai_overlay_dialog.mojom.PageRemote = class {
  ...
  setCaptionsVisible(arg_visible) {
    return this.$.setCaptionsVisible(arg_visible);
  }
...
mojo.internal.bindings.ai_overlay_dialog.mojom.PageRemoteCallHandler = class {
  ...
  setCaptionsVisible(arg_visible) {
    return this.proxy.sendMessage(
      ...
      mojo.internal.bindings.ai_overlay_dialog.mojom.Page_SetCaptionsVisible_ParamsSpec,
      null,
      [arg_visible],
      false);
  }
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        ...
        case 2: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.ai_overlay_dialog.mojom.Page_SetCaptionsVisible_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.setCaptionsVisible');
          const result = this.impl.setCaptionsVisible(params.arg_visible);
          break;
        }
        case 3: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
...
mojo.internal.Struct(
    mojo.internal.bindings.ai_overlay_dialog.mojom.Page_SetCaptionsVisible_ParamsSpec, 'ai_overlay_dialog.mojom.Page_SetCaptionsVisible_Params', [
