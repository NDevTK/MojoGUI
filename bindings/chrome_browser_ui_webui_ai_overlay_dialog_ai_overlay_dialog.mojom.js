...
mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandler_GetApiKey_ParamsSpec = mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandler_GetApiKey_ParamsSpec || { $: {} };
if (mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandler_GetApiKey_ParamsSpec.$.structSpec && mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandler_GetApiKey_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandler_GetApiKey_ParamsSpec.$ = {};
mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandler_GetApiKey_ResponseParamsSpec = mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandler_GetApiKey_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandler_GetApiKey_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandler_GetApiKey_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandler_GetApiKey_ResponseParamsSpec.$ = {};
...
mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandlerRemoteCallHandler = class {
  ...
  getApiKey() {
    return this.proxy.sendMessage(
      this.ordinals[0],  // ordinal
      mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandler_GetApiKey_ParamsSpec,
      mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandler_GetApiKey_ResponseParamsSpec,
      [],
      false);
  }
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandler_GetApiKey_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.getApiKey');
          const result = this.impl.getApiKey();
          const expectsResponse = header.expectsResponse || (header.flags & 1);
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              const val = (response && typeof response === 'object' && 'arg_api_key' in response) ? response['arg_api_key'] : response;
              const resp_obj = { 'arg_api_key': val };
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandler_GetApiKey_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
            }).catch(e => console.error('[GeneratedReceiver] getApiKey FAILED:', e));
          }
          break;
        }
        case 1: {
...
mojo.internal.Struct(
    mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandler_GetApiKey_ParamsSpec, 'ai_overlay_dialog.mojom.PageHandler_GetApiKey_Params', [
    ],
    [[0, 8]]);

mojo.internal.Struct(
    mojo.internal.bindings.ai_overlay_dialog.mojom.PageHandler_GetApiKey_ResponseParamsSpec, 'ai_overlay_dialog.mojom.PageHandler_GetApiKey_ResponseParams', [
