...
mojo.internal.bindings.blink.mojom.AppBannerControllerRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.blink.mojom.AppBannerControllerRemoteCallHandler(this.proxy);
  }
  ...
  bannerPromptRequest(arg_service, arg_event_receiver, arg_platform) {
    return this.$.bannerPromptRequest(arg_service, arg_event_receiver, arg_platform);
  }
};
...
mojo.internal.bindings.blink.mojom.AppBannerController.getRemote = function() {
  let remote = new mojo.internal.bindings.blink.mojom.AppBannerControllerRemote();
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.blink.mojom.AppBannerController_BannerPromptRequest_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for BannerPromptRequest failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
        ...
        case 0: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              this.endpoint.send(header.ordinal, header.requestId, mojo.internal.kMessageFlagIsResponse, mojo.internal.bindings.blink.mojom.AppBannerController_BannerPromptRequest_ResponseParamsSpec, response);
...
mojo.internal.bindings.blink.mojom.AppBannerControllerReceiver = mojo.internal.bindings.blink.mojom.AppBannerControllerReceiver;

mojo.internal.bindings.blink.mojom.AppBannerControllerPtr = mojo.internal.bindings.blink.mojom.AppBannerControllerRemote;
mojo.internal.bindings.blink.mojom.AppBannerControllerRequest = mojo.internal.bindings.blink.mojom.AppBannerControllerPendingReceiver;


// Interface: AppBannerEvent
mojo.internal.Struct(
    mojo.internal.bindings.blink.mojom.AppBannerEvent_BannerAccepted_ParamsSpec, 'blink.mojom.AppBannerEvent_BannerAccepted_Params', [
      mojo.internal.StructField('arg_platform', 0, 0, mojo.internal.String, null, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.blink.mojom.AppBannerEvent_BannerDismissed_ParamsSpec, 'blink.mojom.AppBannerEvent_BannerDismissed_Params', [
    ],
    [[0, 8]]);
...
mojo.internal.bindings.blink.mojom.AppBannerEventRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.blink.mojom.AppBannerEventRemoteCallHandler(this.proxy);
  }
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.blink.mojom.AppBannerEvent_BannerAccepted_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for BannerAccepted failed with TypeError');
           }
        }
        // Try Method 1: BannerDismissed
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.blink.mojom.AppBannerEvent_BannerDismissed_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for BannerDismissed failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
             console.warn('[GeneratedReceiver] Failed to discover ordinal ' + header.ordinal);
      ...
      switch (dispatchId) {
        ...
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.blink.mojom.AppBannerEvent_BannerDismissed_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.blink.mojom.AppBannerEventReceiver = mojo.internal.bindings.blink.mojom.AppBannerEventReceiver;

mojo.internal.bindings.blink.mojom.AppBannerEventPtr = mojo.internal.bindings.blink.mojom.AppBannerEventRemote;
mojo.internal.bindings.blink.mojom.AppBannerEventRequest = mojo.internal.bindings.blink.mojom.AppBannerEventPendingReceiver;


// Interface: AppBannerService
mojo.internal.Struct(
    mojo.internal.bindings.blink.mojom.AppBannerService_DisplayAppBanner_ParamsSpec, 'blink.mojom.AppBannerService_DisplayAppBanner_Params', [
    ],
    [[0, 8]]);
...
mojo.internal.bindings.blink.mojom.AppBannerServiceRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.blink.mojom.AppBannerServiceRemoteCallHandler(this.proxy);
  }
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.blink.mojom.AppBannerService_DisplayAppBanner_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for DisplayAppBanner failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
             console.warn('[GeneratedReceiver] Failed to discover ordinal ' + header.ordinal);
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.blink.mojom.AppBannerService_DisplayAppBanner_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.blink.mojom.AppBannerServiceReceiver = mojo.internal.bindings.blink.mojom.AppBannerServiceReceiver;

mojo.internal.bindings.blink.mojom.AppBannerServicePtr = mojo.internal.bindings.blink.mojom.AppBannerServiceRemote;
mojo.internal.bindings.blink.mojom.AppBannerServiceRequest = mojo.internal.bindings.blink.mojom.AppBannerServicePendingReceiver;
