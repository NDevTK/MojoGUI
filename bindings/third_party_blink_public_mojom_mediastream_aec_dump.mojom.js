...
mojo.internal.bindings.blink.mojom.AecDumpAgentRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.blink.mojom.AecDumpAgentPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.blink.mojom.AecDumpAgentRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.blink.mojom.AecDumpAgent.getRemote = function() {
  let remote = new mojo.internal.bindings.blink.mojom.AecDumpAgentRemote();
...
mojo.internal.bindings.blink.mojom.AecDumpAgentReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.blink.mojom.AecDumpAgent_Start_ParamsSpec.$.structSpec;
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.blink.mojom.AecDumpAgent_Stop_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
      ...
      switch (dispatchId) {
        ...
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.blink.mojom.AecDumpAgent_Stop_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.blink.mojom.AecDumpAgentReceiver = mojo.internal.bindings.blink.mojom.AecDumpAgentReceiver;

mojo.internal.bindings.blink.mojom.AecDumpAgentPtr = mojo.internal.bindings.blink.mojom.AecDumpAgentRemote;
mojo.internal.bindings.blink.mojom.AecDumpAgentRequest = mojo.internal.bindings.blink.mojom.AecDumpAgentPendingReceiver;
...
mojo.internal.bindings.blink.mojom.AecDumpManagerRemote = class {
  static get $interfaceName() {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.blink.mojom.AecDumpManagerPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.blink.mojom.AecDumpManagerRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.blink.mojom.AecDumpManager.getRemote = function() {
  let remote = new mojo.internal.bindings.blink.mojom.AecDumpManagerRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
...
mojo.internal.bindings.blink.mojom.AecDumpManagerReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.blink.mojom.AecDumpManager_Add_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for Add failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
             console.warn('[GeneratedReceiver] Failed to discover ordinal ' + header.ordinal);
...
mojo.internal.bindings.blink.mojom.AecDumpManagerReceiver = mojo.internal.bindings.blink.mojom.AecDumpManagerReceiver;
