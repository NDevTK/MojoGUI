...
mojo.internal.Struct(
    mojo.internal.bindings.ash.cros_safety.mojom.CloudSafetySession_ClassifyTextSafety_ParamsSpec, 'ash.cros_safety.mojom.CloudSafetySession_ClassifyTextSafety_Params', [
      ...
      mojo.internal.StructField('arg_rules', 8, 0, mojo.internal.bindings.ash.cros_safety.mojom.SafetyRulesetSpec, null, false, 0, undefined),
    ],
    [[0, 24]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.ash.cros_safety.mojom.CloudSafetySession_ClassifyImageSafety_ParamsSpec, 'ash.cros_safety.mojom.CloudSafetySession_ClassifyImageSafety_Params', [
      mojo.internal.StructField('arg_image', 0, 0, mojo.internal.bindings.mojo_base.mojom.BigBufferSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_prompt', 16, 0, mojo.internal.String, null, true, 0, undefined),
      mojo.internal.StructField('arg_rules', 24, 0, mojo.internal.bindings.ash.cros_safety.mojom.SafetyRulesetSpec, null, false, 0, undefined),
    ],
    [[0, 40]]);
...
mojo.internal.bindings.ash.cros_safety.mojom.CloudSafetySessionRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.ash.cros_safety.mojom.CloudSafetySessionRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.ash.cros_safety.mojom.CloudSafetySessionRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('ash.cros_safety.mojom.CloudSafetySession', [
      { explicit: 0 },
      { explicit: 1 },
    ]);
  }
...
mojo.internal.bindings.ash.cros_safety.mojom.CloudSafetySession.getRemote = function() {
  let remote = new mojo.internal.bindings.ash.cros_safety.mojom.CloudSafetySessionRemote();
...
mojo.internal.bindings.ash.cros_safety.mojom.CloudSafetySessionReceiver = class {
  constructor(impl) {
    ...
    const ordinals = window.mojoScrambler.getOrdinals('ash.cros_safety.mojom.CloudSafetySession', [
      { explicit: 0 },
      { explicit: 1 },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ash.cros_safety.mojom.CloudSafetySession_ClassifyTextSafety_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for ClassifyTextSafety failed with TypeError');
           }
        }
        // Try Method 1: ClassifyImageSafety
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ash.cros_safety.mojom.CloudSafetySession_ClassifyImageSafety_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
...
mojo.internal.bindings.ash.cros_safety.mojom.CloudSafetySessionReceiver = mojo.internal.bindings.ash.cros_safety.mojom.CloudSafetySessionReceiver;

mojo.internal.bindings.ash.cros_safety.mojom.CloudSafetySessionPtr = mojo.internal.bindings.ash.cros_safety.mojom.CloudSafetySessionRemote;
mojo.internal.bindings.ash.cros_safety.mojom.CloudSafetySessionRequest = mojo.internal.bindings.ash.cros_safety.mojom.CloudSafetySessionPendingReceiver;
...
mojo.internal.Struct(
    mojo.internal.bindings.ash.cros_safety.mojom.OnDeviceSafetySession_ClassifyImageSafety_ParamsSpec, 'ash.cros_safety.mojom.OnDeviceSafetySession_ClassifyImageSafety_Params', [
      mojo.internal.StructField('arg_image', 0, 0, mojo.internal.bindings.mojo_base.mojom.BigBufferSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_rules', 16, 0, mojo.internal.bindings.ash.cros_safety.mojom.SafetyRulesetSpec, null, false, 0, undefined),
    ],
    [[0, 32]]);
...
mojo.internal.bindings.ash.cros_safety.mojom.OnDeviceSafetySessionRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.ash.cros_safety.mojom.OnDeviceSafetySessionRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.ash.cros_safety.mojom.OnDeviceSafetySessionRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('ash.cros_safety.mojom.OnDeviceSafetySession', [
      { explicit: 0 },
      { explicit: 1 },
    ]);
  }
...
mojo.internal.bindings.ash.cros_safety.mojom.OnDeviceSafetySession.getRemote = function() {
  let remote = new mojo.internal.bindings.ash.cros_safety.mojom.OnDeviceSafetySessionRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
...
mojo.internal.bindings.ash.cros_safety.mojom.OnDeviceSafetySessionReceiver = class {
  constructor(impl) {
    ...
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('ash.cros_safety.mojom.OnDeviceSafetySession', [
      { explicit: 0 },
      { explicit: 1 },
    ]);
    ordinals.forEach((ord, idx) => {
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ash.cros_safety.mojom.OnDeviceSafetySession_ClassifyTextSafety_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ash.cros_safety.mojom.OnDeviceSafetySession_ClassifyImageSafety_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
...
mojo.internal.bindings.ash.cros_safety.mojom.OnDeviceSafetySessionReceiver = mojo.internal.bindings.ash.cros_safety.mojom.OnDeviceSafetySessionReceiver;
