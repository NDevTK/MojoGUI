...
quarantine.mojom.Quarantine_QuarantineFile_ParamsSpec = {
  $: {
    structSpec: {
      ...
      packedSize: 48,
      fields: [
        { name: 'full_path', packedOffset: 0, packedBitOffset: 0, type: mojo_base.mojom.FilePathSpec, nullable: false },
        { name: 'source_url', packedOffset: 8, packedBitOffset: 0, type: url.mojom.UrlSpec, nullable: false },
        { name: 'referrer_url', packedOffset: 16, packedBitOffset: 0, type: url.mojom.UrlSpec, nullable: false },
        { name: 'request_initiator', packedOffset: 24, packedBitOffset: 0, type: url.mojom.OriginSpec, nullable: true },
...
quarantine.mojom.Quarantine_QuarantineFile_ResponseParamsSpec = {
  $: {
    structSpec: {
      ...
      packedSize: 16,
      fields: [
        { name: 'result', packedOffset: 0, packedBitOffset: 0, type: quarantine.mojom.QuarantineFileResultSpec, nullable: false },
      ],
      versions: [{version: 0}]
    }
  }
