  ...
  $: {
    structSpec: {
      ...
      fields: [
        ...
        { name: 'origin', packedOffset: 8, packedBitOffset: 0, type: gfx.mojom.PointSpec, nullable: false },
        { name: 'mode', packedOffset: 16, packedBitOffset: 0, type: display.mojom.DisplayModeSpec, nullable: true },
