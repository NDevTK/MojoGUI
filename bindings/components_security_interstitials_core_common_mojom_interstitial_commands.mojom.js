...
mojo.internal.bindings.security_interstitials.mojom.InterstitialCommandsRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.security_interstitials.mojom.InterstitialCommandsPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.security_interstitials.mojom.InterstitialCommandsRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.security_interstitials.mojom.InterstitialCommands.getRemote = function() {
  let remote = new mojo.internal.bindings.security_interstitials.mojom.InterstitialCommandsRemote();
...
mojo.internal.bindings.security_interstitials.mojom.InterstitialCommandsReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.security_interstitials.mojom.InterstitialCommands_DontProceed_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for DontProceed failed with TypeError');
           }
        }
        // Try Method 1: Proceed
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.security_interstitials.mojom.InterstitialCommands_Proceed_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for Proceed failed with TypeError');
           }
        }
        // Try Method 2: ShowMoreSection
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.security_interstitials.mojom.InterstitialCommands_ShowMoreSection_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for ShowMoreSection failed with TypeError');
           }
        }
        // Try Method 3: OpenHelpCenter
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.security_interstitials.mojom.InterstitialCommands_OpenHelpCenter_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OpenHelpCenter failed with TypeError');
           }
        }
        // Try Method 4: OpenDiagnostic
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.security_interstitials.mojom.InterstitialCommands_OpenDiagnostic_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OpenDiagnostic failed with TypeError');
           }
        }
        // Try Method 5: Reload
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.security_interstitials.mojom.InterstitialCommands_Reload_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for Reload failed with TypeError');
           }
        }
        // Try Method 6: OpenDateSettings
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.security_interstitials.mojom.InterstitialCommands_OpenDateSettings_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OpenDateSettings failed with TypeError');
           }
        }
        // Try Method 7: OpenLogin
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.security_interstitials.mojom.InterstitialCommands_OpenLogin_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OpenLogin failed with TypeError');
           }
        }
        // Try Method 8: DoReport
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.security_interstitials.mojom.InterstitialCommands_DoReport_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for DoReport failed with TypeError');
           }
        }
        // Try Method 9: DontReport
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.security_interstitials.mojom.InterstitialCommands_DontReport_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for DontReport failed with TypeError');
           }
        }
        // Try Method 10: OpenReportingPrivacy
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.security_interstitials.mojom.InterstitialCommands_OpenReportingPrivacy_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OpenReportingPrivacy failed with TypeError');
           }
        }
        // Try Method 11: OpenWhitepaper
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.security_interstitials.mojom.InterstitialCommands_OpenWhitepaper_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OpenWhitepaper failed with TypeError');
           }
        }
        // Try Method 12: OpenHelpCenterInNewTab
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.security_interstitials.mojom.InterstitialCommands_OpenHelpCenterInNewTab_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OpenHelpCenterInNewTab failed with TypeError');
           }
        }
        // Try Method 13: OpenDiagnosticInNewTab
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.security_interstitials.mojom.InterstitialCommands_OpenDiagnosticInNewTab_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OpenDiagnosticInNewTab failed with TypeError');
           }
        }
        // Try Method 14: OpenReportingPrivacyInNewTab
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.security_interstitials.mojom.InterstitialCommands_OpenReportingPrivacyInNewTab_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OpenReportingPrivacyInNewTab failed with TypeError');
           }
        }
        // Try Method 15: OpenWhitepaperInNewTab
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.security_interstitials.mojom.InterstitialCommands_OpenWhitepaperInNewTab_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OpenWhitepaperInNewTab failed with TypeError');
           }
        }
        // Try Method 16: ReportPhishingErrorInNewTab
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.security_interstitials.mojom.InterstitialCommands_ReportPhishingErrorInNewTab_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for ReportPhishingErrorInNewTab failed with TypeError');
           }
        }
        // Try Method 17: ReportPhishingError
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.security_interstitials.mojom.InterstitialCommands_ReportPhishingError_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for ReportPhishingError failed with TypeError');
           }
        }
        // Try Method 18: OpenEnhancedProtectionSettings
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.security_interstitials.mojom.InterstitialCommands_OpenEnhancedProtectionSettings_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OpenEnhancedProtectionSettings failed with TypeError');
           }
        }
        // Try Method 19: ShowCertificateViewer
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.security_interstitials.mojom.InterstitialCommands_ShowCertificateViewer_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.security_interstitials.mojom.InterstitialCommands_DontProceed_ParamsSpec.$.structSpec);
        ...
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.security_interstitials.mojom.InterstitialCommands_Proceed_ParamsSpec.$.structSpec);
        ...
        case 2: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.security_interstitials.mojom.InterstitialCommands_ShowMoreSection_ParamsSpec.$.structSpec);
        ...
        case 3: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.security_interstitials.mojom.InterstitialCommands_OpenHelpCenter_ParamsSpec.$.structSpec);
        ...
        case 4: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.security_interstitials.mojom.InterstitialCommands_OpenDiagnostic_ParamsSpec.$.structSpec);
        ...
        case 5: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.security_interstitials.mojom.InterstitialCommands_Reload_ParamsSpec.$.structSpec);
        ...
        case 6: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.security_interstitials.mojom.InterstitialCommands_OpenDateSettings_ParamsSpec.$.structSpec);
        ...
        case 7: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.security_interstitials.mojom.InterstitialCommands_OpenLogin_ParamsSpec.$.structSpec);
        ...
        case 8: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.security_interstitials.mojom.InterstitialCommands_DoReport_ParamsSpec.$.structSpec);
        ...
        case 9: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.security_interstitials.mojom.InterstitialCommands_DontReport_ParamsSpec.$.structSpec);
        ...
        case 10: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.security_interstitials.mojom.InterstitialCommands_OpenReportingPrivacy_ParamsSpec.$.structSpec);
        ...
        case 11: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.security_interstitials.mojom.InterstitialCommands_OpenWhitepaper_ParamsSpec.$.structSpec);
        ...
        case 12: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.security_interstitials.mojom.InterstitialCommands_OpenHelpCenterInNewTab_ParamsSpec.$.structSpec);
        ...
        case 13: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.security_interstitials.mojom.InterstitialCommands_OpenDiagnosticInNewTab_ParamsSpec.$.structSpec);
        ...
        case 14: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.security_interstitials.mojom.InterstitialCommands_OpenReportingPrivacyInNewTab_ParamsSpec.$.structSpec);
        ...
        case 15: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.security_interstitials.mojom.InterstitialCommands_OpenWhitepaperInNewTab_ParamsSpec.$.structSpec);
        ...
        case 16: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.security_interstitials.mojom.InterstitialCommands_ReportPhishingErrorInNewTab_ParamsSpec.$.structSpec);
        ...
        case 17: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.security_interstitials.mojom.InterstitialCommands_ReportPhishingError_ParamsSpec.$.structSpec);
        ...
        case 18: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.security_interstitials.mojom.InterstitialCommands_OpenEnhancedProtectionSettings_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.security_interstitials.mojom.InterstitialCommandsReceiver = mojo.internal.bindings.security_interstitials.mojom.InterstitialCommandsReceiver;
