...
arc.mojom.keymint.KeyMintServerPtr = class {
  ...
  0(android_version, android_patchlevel) {
    // Method: 0
    // Call: 0(android_version, android_patchlevel)
  }
  ...
  10(password_only, timestamp_token) {
    // Method: 10
    return new Promise((resolve) => {
      // Call: 10(password_only, timestamp_token)
      resolve({});
    });
  }
  ...
  26(android_vendor_patchlevel) {
    // Method: 26
    // Call: 26(android_vendor_patchlevel)
  }
