...
mojo.internal.bindings.service_manager.mojom.ServiceControl = {};
mojo.internal.bindings.service_manager.mojom.ServiceControlSpec = { $ : {} };
mojo.internal.bindings.service_manager.mojom.ServiceControl.$interfaceName = 'service_manager.mojom.ServiceControl';
...
mojo.internal.bindings.service_manager.mojom.ServiceControlRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.service_manager.mojom.ServiceControlPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.service_manager.mojom.ServiceControlRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.service_manager.mojom.ServiceControlRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('service_manager.mojom.ServiceControl', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.service_manager.mojom.ServiceControl.getRemote = function() {
  let remote = new mojo.internal.bindings.service_manager.mojom.ServiceControlRemote();
...
mojo.internal.bindings.service_manager.mojom.ServiceControlReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('service_manager.mojom.ServiceControl', [
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.service_manager.mojom.ServiceControl_RequestQuit_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for RequestQuit failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.service_manager.mojom.ServiceControl_RequestQuit_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.service_manager.mojom.ServiceControlReceiver = mojo.internal.bindings.service_manager.mojom.ServiceControlReceiver;
