...
mojo.internal.bindings.gl.mojom.TraitsTestService = {};
mojo.internal.bindings.gl.mojom.TraitsTestServiceSpec = { $ : {} };
mojo.internal.bindings.gl.mojom.TraitsTestService.$interfaceName = 'gl.mojom.TraitsTestService';
...
mojo.internal.bindings.gl.mojom.TraitsTestServiceRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.gl.mojom.TraitsTestServicePendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.gl.mojom.TraitsTestServiceRemoteCallHandler(this.proxy);
  }
  ...
  echoGpuPreference(arg_g) {
    return this.$.echoGpuPreference(arg_g);
  }
  echoGLImplementationParts(arg_impl) {
    return this.$.echoGLImplementationParts(arg_impl);
  }
};

mojo.internal.bindings.gl.mojom.TraitsTestServiceRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('gl.mojom.TraitsTestService', [
      { explicit: null },
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.gl.mojom.TraitsTestService.getRemote = function() {
  let remote = new mojo.internal.bindings.gl.mojom.TraitsTestServiceRemote();
...
mojo.internal.bindings.gl.mojom.TraitsTestServiceReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('gl.mojom.TraitsTestService', [
      { explicit: null },
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.gl.mojom.TraitsTestService_EchoGpuPreference_ParamsSpec.$.structSpec);
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.gl.mojom.TraitsTestService_EchoGLImplementationParts_ParamsSpec.$.structSpec);
      ...
      switch (dispatchId) {
        case 0: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.gl.mojom.TraitsTestService_EchoGpuPreference_ResponseParamsSpec, header, rawHeader);
               responder(response);
        ...
        case 1: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              const rawHeader = (args[2] && args[2].slice) ? args[2].slice(0, header.headerSize) : null;
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.gl.mojom.TraitsTestService_EchoGLImplementationParts_ResponseParamsSpec, header, rawHeader);
               responder(response);
...
mojo.internal.bindings.gl.mojom.TraitsTestServiceReceiver = mojo.internal.bindings.gl.mojom.TraitsTestServiceReceiver;
