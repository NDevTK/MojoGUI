...
mojo.internal.bindings.blink.mojom.AIManagerRemote = class {
  ...
  createClassifier(arg_client, arg_options) {
    return this.$.createClassifier(arg_client, arg_options);
  }
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        ...
        case 12: {
          ...
          const result = this.impl.createClassifier(params.arg_client, params.arg_options);
          break;
        }
        case 13: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
...
mojo.internal.Struct(
    mojo.internal.bindings.blink.mojom.AIManager_AddModelDownloadProgressObserver_ParamsSpec, 'blink.mojom.AIManager_AddModelDownloadProgressObserver_Params', [
      mojo.internal.StructField('arg_observer_remote', 0, 0, mojo.internal.InterfaceProxy(mojo.internal.bindings.on_device_model.mojom.DownloadObserverRemote), null, false, 0, undefined),
    ],
    [[0, 16]]);
