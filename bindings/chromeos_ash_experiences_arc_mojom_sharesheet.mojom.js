...
mojo.internal.bindings.arc.mojom.SharesheetHostPendingReceiver = class {
  constructor(handle) {
    this.handle = handle;
  }
};

mojo.internal.bindings.arc.mojom.SharesheetHostRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.arc.mojom.SharesheetHostPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.arc.mojom.SharesheetHostRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.arc.mojom.SharesheetHost.getRemote = function() {
  let remote = new mojo.internal.bindings.arc.mojom.SharesheetHostRemote();
...
mojo.internal.bindings.arc.mojom.SharesheetHostReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
...
mojo.internal.bindings.arc.mojom.SharesheetHostReceiver = mojo.internal.bindings.arc.mojom.SharesheetHostReceiver;

mojo.internal.bindings.arc.mojom.SharesheetHostPtr = mojo.internal.bindings.arc.mojom.SharesheetHostRemote;
mojo.internal.bindings.arc.mojom.SharesheetHostRequest = mojo.internal.bindings.arc.mojom.SharesheetHostPendingReceiver;
...
mojo.internal.bindings.arc.mojom.SharesheetInstanceRemote = class {
  static get $interfaceName() {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.arc.mojom.SharesheetInstancePendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.arc.mojom.SharesheetInstanceRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.arc.mojom.SharesheetInstance.getRemote = function() {
  let remote = new mojo.internal.bindings.arc.mojom.SharesheetInstanceRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
...
mojo.internal.bindings.arc.mojom.SharesheetInstanceReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
        ...
        case 0: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.arc.mojom.SharesheetInstance_Init_ResponseParamsSpec, header, rawHeader);
               responder(response);
...
mojo.internal.bindings.arc.mojom.SharesheetInstanceReceiver = mojo.internal.bindings.arc.mojom.SharesheetInstanceReceiver;
