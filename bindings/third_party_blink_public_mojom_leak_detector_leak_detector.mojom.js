...
mojo.internal.Struct(
    mojo.internal.bindings.blink.mojom.LeakDetector_PerformLeakDetection_ResponseParamsSpec, 'blink.mojom.LeakDetector_PerformLeakDetection_ResponseParams', [
      mojo.internal.StructField('arg_result', 0, 0, mojo.internal.bindings.mojo.internal.bindings.blink.mojom.LeakDetectionResultSpec.$, null, true, 0, undefined),
    ],
    [[0, 16]]);
...
mojo.internal.bindings.blink.mojom.LeakDetectorRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.blink.mojom.LeakDetectorPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.blink.mojom.LeakDetectorRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.blink.mojom.LeakDetectorRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('LeakDetector', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.blink.mojom.LeakDetector.getRemote = function() {
  let remote = new mojo.internal.bindings.blink.mojom.LeakDetectorRemote();
...
mojo.internal.bindings.blink.mojom.LeakDetectorReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('LeakDetector', [
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.blink.mojom.LeakDetector_PerformLeakDetection_ParamsSpec);
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.blink.mojom.LeakDetector_PerformLeakDetection_ParamsSpec.$.structSpec);
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.blink.mojom.LeakDetector_PerformLeakDetection_ResponseParamsSpec, header, rawHeader);
               responder(response);
...
mojo.internal.bindings.blink.mojom.LeakDetectorReceiver = mojo.internal.bindings.blink.mojom.LeakDetectorReceiver;
