...
mojo.internal.bindings.extensions.mojom.ServiceWorker = {};
mojo.internal.bindings.extensions.mojom.ServiceWorkerSpec = { $ : {} };
mojo.internal.bindings.extensions.mojom.ServiceWorker.$interfaceName = 'extensions.mojom.ServiceWorker';
...
mojo.internal.bindings.extensions.mojom.ServiceWorkerRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.extensions.mojom.ServiceWorkerPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.extensions.mojom.ServiceWorkerRemoteCallHandler(this.proxy);
  }
  ...
  updatePermissions(arg_active_permissions, arg_withheld_permissions) {
    return this.$.updatePermissions(arg_active_permissions, arg_withheld_permissions);
  }
...
mojo.internal.bindings.extensions.mojom.ServiceWorkerRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('extensions.mojom.ServiceWorker', [
      { explicit: null },
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.extensions.mojom.ServiceWorker.getRemote = function() {
  let remote = new mojo.internal.bindings.extensions.mojom.ServiceWorkerRemote();
...
mojo.internal.bindings.extensions.mojom.ServiceWorkerReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('extensions.mojom.ServiceWorker', [
      { explicit: null },
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.extensions.mojom.ServiceWorker_UpdatePermissions_ParamsSpec.$.structSpec);
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.extensions.mojom.ServiceWorker_DispatchOnConnect_ParamsSpec.$.structSpec);
        ...
        case 1: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.extensions.mojom.ServiceWorker_DispatchOnConnect_ResponseParamsSpec, header, rawHeader);
               responder(response);
...
mojo.internal.bindings.extensions.mojom.ServiceWorkerReceiver = mojo.internal.bindings.extensions.mojom.ServiceWorkerReceiver;
