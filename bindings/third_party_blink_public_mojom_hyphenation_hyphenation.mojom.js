...
mojo.internal.bindings.blink.mojom.Hyphenation = {};
mojo.internal.bindings.blink.mojom.HyphenationSpec = { $ : {} };
mojo.internal.bindings.blink.mojom.Hyphenation.$interfaceName = 'blink.mojom.Hyphenation';
...
mojo.internal.bindings.blink.mojom.HyphenationRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.blink.mojom.HyphenationPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.blink.mojom.HyphenationRemoteCallHandler(this.proxy);
  }
  ...
  openDictionary(arg_locale) {
    return this.$.openDictionary(arg_locale);
  }
};

mojo.internal.bindings.blink.mojom.HyphenationRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('blink.mojom.Hyphenation', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.blink.mojom.Hyphenation.getRemote = function() {
  let remote = new mojo.internal.bindings.blink.mojom.HyphenationRemote();
...
mojo.internal.bindings.blink.mojom.HyphenationReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('blink.mojom.Hyphenation', [
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.blink.mojom.Hyphenation_OpenDictionary_ParamsSpec.$.structSpec);
        ...
        case 0: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.blink.mojom.Hyphenation_OpenDictionary_ResponseParamsSpec, header, rawHeader);
               responder(response);
...
mojo.internal.bindings.blink.mojom.HyphenationReceiver = mojo.internal.bindings.blink.mojom.HyphenationReceiver;
