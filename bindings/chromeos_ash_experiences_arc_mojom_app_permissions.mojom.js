...
// Enum: AppPermission
mojo.internal.bindings.arc.mojom.AppPermission = {
  CAMERA: 0,
  LOCATION: 1,
  MICROPHONE: 2,
  NOTIFICATIONS: 3,
...
mojo.internal.bindings.arc.mojom.AppPermissionGroup = {
  CAMERA: 0,
  MICROPHONE: 1,
  LOCATION: 2,
};
...
mojo.internal.Struct(
    mojo.internal.bindings.arc.mojom.PermissionStateSpec, 'arc.mojom.PermissionState', [
      ...
      mojo.internal.StructField('arg_one_time', 16, 0, mojo.internal.Bool, false, false, 2, undefined),
    ],
    [[0, 16], [1, 24], [2, 32]]);
...
mojo.internal.bindings.arc.mojom.AppPermissionsInstanceRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.arc.mojom.AppPermissionsInstancePendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.arc.mojom.AppPermissionsInstanceRemoteCallHandler(this.proxy);
  }
  ...
  grantPermission(arg_package_name, arg_permission) {
    return this.$.grantPermission(arg_package_name, arg_permission);
  }
  revokePermission(arg_package_name, arg_permission) {
    return this.$.revokePermission(arg_package_name, arg_permission);
  }
};
...
mojo.internal.bindings.arc.mojom.AppPermissionsInstance.getRemote = function() {
  let remote = new mojo.internal.bindings.arc.mojom.AppPermissionsInstanceRemote();
...
mojo.internal.bindings.arc.mojom.AppPermissionsInstanceReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.arc.mojom.AppPermissionsInstance_GrantPermission_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for GrantPermission failed with TypeError');
           }
        }
        // Try Method 1: RevokePermission
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.arc.mojom.AppPermissionsInstance_RevokePermission_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
...
mojo.internal.bindings.arc.mojom.AppPermissionsInstanceReceiver = mojo.internal.bindings.arc.mojom.AppPermissionsInstanceReceiver;
