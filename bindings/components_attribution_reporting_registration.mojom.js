...
attribution_reporting.mojom.FilterConfigSpec = {
  $: {
    structSpec: {
      ...
      packedSize: 24,
      fields: [
        { name: 'lookback_window', packedOffset: 0, packedBitOffset: 0, type: mojo_base.mojom.TimeDeltaSpec, nullable: true },
...
attribution_reporting.mojom.AggregatableTriggerDataSpec = {
  $: {
    structSpec: {
      ...
      packedSize: 32,
      fields: [
        { name: 'key_piece', packedOffset: 0, packedBitOffset: 0, type: mojo_base.mojom.Uint128Spec, nullable: false },
...
attribution_reporting.mojom.EventReportWindowsSpec = {
  $: {
    structSpec: {
      ...
      packedSize: 24,
      fields: [
        { name: 'start_time', packedOffset: 0, packedBitOffset: 0, type: mojo_base.mojom.TimeDeltaSpec, nullable: false },
  ...
  $: {
    structSpec: {
      ...
      fields: [
        ...
        { name: 'aggregation_coordinator_origin', packedOffset: 16, packedBitOffset: 0, type: attribution_reporting.mojom.SuitableOriginSpec, nullable: true },
      ],
      versions: [{version: 0}]
    }
  }
...
attribution_reporting.mojom.SourceAggregatableDebugReportingConfigSpec = {
  $: {
    structSpec: {
      ...
      packedSize: 24,
      fields: [
        { name: 'budget', packedOffset: 0, packedBitOffset: 0, type: mojo.internal.Int32, nullable: false },
        { name: 'config', packedOffset: 8, packedBitOffset: 0, type: attribution_reporting.mojom.AggregatableDebugReportingConfigSpec, nullable: false },
      ],
      versions: [{version: 0}]
    }
  }
...
attribution_reporting.mojom.AttributionScopesDataSpec = {
  $: {
    structSpec: {
      ...
      packedSize: 24,
      fields: [
        { name: 'attribution_scopes_set', packedOffset: 0, packedBitOffset: 0, type: attribution_reporting.mojom.AttributionScopesSetSpec, nullable: false },
...
attribution_reporting.mojom.SourceRegistrationSpec = {
  $: {
    structSpec: {
      ...
      packedSize: 152,
      fields: [
        { name: 'destinations', packedOffset: 0, packedBitOffset: 0, type: attribution_reporting.mojom.DestinationSetSpec, nullable: false },
        { name: 'source_event_id', packedOffset: 8, packedBitOffset: 0, type: mojo.internal.Uint64, nullable: false },
        { name: 'expiry', packedOffset: 16, packedBitOffset: 0, type: mojo_base.mojom.TimeDeltaSpec, nullable: false },
        { name: 'trigger_data', packedOffset: 24, packedBitOffset: 0, type: attribution_reporting.mojom.TriggerDataSetSpec, nullable: false },
        { name: 'event_report_windows', packedOffset: 32, packedBitOffset: 0, type: attribution_reporting.mojom.EventReportWindowsSpec, nullable: false },
        { name: 'max_event_level_reports', packedOffset: 40, packedBitOffset: 0, type: mojo.internal.Int32, nullable: false },
        { name: 'aggregatable_report_window', packedOffset: 48, packedBitOffset: 0, type: mojo_base.mojom.TimeDeltaSpec, nullable: false },
        { name: 'priority', packedOffset: 56, packedBitOffset: 0, type: mojo.internal.Int64, nullable: false },
        { name: 'debug_key', packedOffset: 64, packedBitOffset: 0, type: mojo.internal.Uint64, nullable: true },
        { name: 'filter_data', packedOffset: 72, packedBitOffset: 0, type: attribution_reporting.mojom.FilterDataSpec, nullable: false },
        { name: 'aggregation_keys', packedOffset: 80, packedBitOffset: 0, type: attribution_reporting.mojom.AggregationKeysSpec, nullable: false },
        { name: 'debug_reporting', packedOffset: 88, packedBitOffset: 0, type: mojo.internal.Bool, nullable: false },
        { name: 'trigger_data_matching', packedOffset: 96, packedBitOffset: 0, type: attribution_reporting.mojom.TriggerDataMatchingSpec, nullable: false },
        { name: 'event_level_epsilon', packedOffset: 104, packedBitOffset: 0, type: mojo.internal.Double, nullable: false },
        { name: 'aggregatable_debug_reporting_config', packedOffset: 112, packedBitOffset: 0, type: attribution_reporting.mojom.SourceAggregatableDebugReportingConfigSpec, nullable: false },
        { name: 'destination_limit_priority', packedOffset: 120, packedBitOffset: 0, type: mojo.internal.Int64, nullable: false },
        { name: 'attribution_scopes_data', packedOffset: 128, packedBitOffset: 0, type: attribution_reporting.mojom.AttributionScopesDataSpec, nullable: true },
        { name: 'aggregatable_named_budget_defs', packedOffset: 136, packedBitOffset: 0, type: attribution_reporting.mojom.AggregatableNamedBudgetDefsSpec, nullable: false },
      ],
      versions: [{version: 0}]
    }
  }
  ...
  $: {
    structSpec: {
      ...
      fields: [
        ...
        { name: 'filters', packedOffset: 8, packedBitOffset: 0, type: attribution_reporting.mojom.FilterPairSpec, nullable: false },
      ],
      versions: [{version: 0}]
    }
  }
  ...
  $: {
    structSpec: {
      ...
      fields: [
        ...
        { name: 'debug_reporting', packedOffset: 48, packedBitOffset: 0, type: mojo.internal.Bool, nullable: false },
        { name: 'aggregation_coordinator_origin', packedOffset: 56, packedBitOffset: 0, type: attribution_reporting.mojom.SuitableOriginSpec, nullable: true },
        { name: 'source_registration_time_config', packedOffset: 64, packedBitOffset: 0, type: attribution_reporting.mojom.SourceRegistrationTimeConfigSpec, nullable: false },
        { name: 'trigger_context_id', packedOffset: 72, packedBitOffset: 0, type: mojo.internal.String, nullable: true },
        { name: 'aggregatable_filtering_id_max_bytes', packedOffset: 80, packedBitOffset: 0, type: mojo.internal.Uint8, nullable: false },
        { name: 'aggregatable_debug_reporting_config', packedOffset: 88, packedBitOffset: 0, type: attribution_reporting.mojom.AggregatableDebugReportingConfigSpec, nullable: false },
        { name: 'attribution_scopes', packedOffset: 96, packedBitOffset: 0, type: attribution_reporting.mojom.AttributionScopesSetSpec, nullable: false },
        { name: 'aggregatable_named_budget_candidates', packedOffset: 104, packedBitOffset: 0, type: mojo.internal.Array, nullable: false },
      ],
      versions: [{version: 0}]
    }
  }
