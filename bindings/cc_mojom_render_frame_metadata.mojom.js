...
mojo.internal.bindings.viz = mojo.internal.bindings.viz || {};
mojo.internal.bindings.viz.mojom = mojo.internal.bindings.viz.mojom || {};
mojo.internal.bindings.viz.mojom.SelectionSpec = mojo.internal.bindings.viz.mojom.SelectionSpec || { $: mojo.internal.OpaqueStruct.$ };
mojo.internal.bindings.viz = mojo.internal.bindings.viz || {};
mojo.internal.bindings.viz.mojom = mojo.internal.bindings.viz.mojom || {};
mojo.internal.bindings.viz.mojom.VerticalScrollDirectionSpec = mojo.internal.bindings.viz.mojom.VerticalScrollDirectionSpec || { $: mojo.internal.Enum().$ };

// Enum: RootScrollOffsetUpdateFrequency
mojo.internal.bindings.cc.mojom.RootScrollOffsetUpdateFrequency = {
  kNone: 0,
  kOnScrollEnd: 1,
  kAllUpdates: 2,
};
...
mojo.internal.Struct(
    mojo.internal.bindings.cc.mojom.DelegatedInkBrowserMetadataSpec, 'cc.mojom.DelegatedInkBrowserMetadata', [
      mojo.internal.StructField('arg_delegated_ink_is_hovering', 0, 0, mojo.internal.Bool, false, false, 0, undefined),
    ],
    [[0, 16]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.cc.mojom.RenderFrameMetadataSpec, 'cc.mojom.RenderFrameMetadata', [
      ...
      mojo.internal.StructField('arg_is_scroll_offset_at_top', 16, 0, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_is_mobile_optimized', 16, 1, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_root_overflow_y_hidden', 16, 2, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_has_transparent_background', 16, 3, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_device_scale_factor', 20, 0, mojo.internal.Float, 0, false, 0, undefined),
      mojo.internal.StructField('arg_selection', 24, 0, mojo.internal.bindings.viz.mojom.SelectionSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_delegated_ink_metadata', 32, 0, mojo.internal.bindings.cc.mojom.DelegatedInkBrowserMetadataSpec, null, true, 0, undefined),
      mojo.internal.StructField('arg_viewport_size_in_pixels', 40, 0, mojo.internal.bindings.gfx.mojom.SizeSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_local_surface_id', 48, 0, mojo.internal.bindings.viz.mojom.LocalSurfaceIdSpec, null, true, 0, undefined),
      mojo.internal.StructField('arg_page_scale_factor', 56, 0, mojo.internal.Float, 0, false, 0, undefined),
      mojo.internal.StructField('arg_external_page_scale_factor', 60, 0, mojo.internal.Float, 0, false, 0, undefined),
      mojo.internal.StructField('arg_top_controls_height', 64, 0, mojo.internal.Float, 0, false, 0, undefined),
      mojo.internal.StructField('arg_top_controls_shown_ratio', 68, 0, mojo.internal.Float, 0, false, 0, undefined),
...
mojo.internal.bindings.cc.mojom.RenderFrameMetadataObserverPendingReceiver = class {
  constructor(handle) {
    this.handle = handle;
  }
};
...
mojo.internal.bindings.cc.mojom.RenderFrameMetadataObserverRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.cc.mojom.RenderFrameMetadataObserverRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.cc.mojom.RenderFrameMetadataObserverRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
...
mojo.internal.bindings.cc.mojom.RenderFrameMetadataObserver.getRemote = function() {
  let remote = new mojo.internal.bindings.cc.mojom.RenderFrameMetadataObserverRemote();
...
mojo.internal.bindings.cc.mojom.RenderFrameMetadataObserverReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for ReportAllFrameSubmissionsForTesting failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.cc.mojom.RenderFrameMetadataObserverReceiver = mojo.internal.bindings.cc.mojom.RenderFrameMetadataObserverReceiver;

mojo.internal.bindings.cc.mojom.RenderFrameMetadataObserverPtr = mojo.internal.bindings.cc.mojom.RenderFrameMetadataObserverRemote;
mojo.internal.bindings.cc.mojom.RenderFrameMetadataObserverRequest = mojo.internal.bindings.cc.mojom.RenderFrameMetadataObserverPendingReceiver;
...
mojo.internal.Struct(
    mojo.internal.bindings.cc.mojom.RenderFrameMetadataObserverClient_OnRenderFrameMetadataChanged_ParamsSpec, 'cc.mojom.RenderFrameMetadataObserverClient_OnRenderFrameMetadataChanged_Params', [
      mojo.internal.StructField('arg_frame_token', 0, 0, mojo.internal.Uint32, 0, false, 0, undefined),
      mojo.internal.StructField('arg_metadata', 8, 0, mojo.internal.bindings.cc.mojom.RenderFrameMetadataSpec, null, false, 0, undefined),
    ],
    [[0, 24]]);

mojo.internal.Struct(
    mojo.internal.bindings.cc.mojom.RenderFrameMetadataObserverClient_OnFrameSubmissionForTesting_ParamsSpec, 'cc.mojom.RenderFrameMetadataObserverClient_OnFrameSubmissionForTesting_Params', [
      mojo.internal.StructField('arg_frame_token', 0, 0, mojo.internal.Uint32, 0, false, 0, undefined),
    ],
    [[0, 16]]);
...
mojo.internal.bindings.cc.mojom.RenderFrameMetadataObserverClientRemote = class {
  static get $interfaceName() {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.cc.mojom.RenderFrameMetadataObserverClientRemoteCallHandler(this.proxy);
  }
  ...
  onRenderFrameMetadataChanged(arg_frame_token, arg_metadata) {
    return this.$.onRenderFrameMetadataChanged(arg_frame_token, arg_metadata);
  }
...
mojo.internal.bindings.cc.mojom.RenderFrameMetadataObserverClient.getRemote = function() {
  let remote = new mojo.internal.bindings.cc.mojom.RenderFrameMetadataObserverClientRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
...
mojo.internal.bindings.cc.mojom.RenderFrameMetadataObserverClientReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.cc.mojom.RenderFrameMetadataObserverClient_OnRenderFrameMetadataChanged_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OnRenderFrameMetadataChanged failed with TypeError');
           }
        }
        // Try Method 1: OnFrameSubmissionForTesting
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.cc.mojom.RenderFrameMetadataObserverClient_OnFrameSubmissionForTesting_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
...
mojo.internal.bindings.cc.mojom.RenderFrameMetadataObserverClientReceiver = mojo.internal.bindings.cc.mojom.RenderFrameMetadataObserverClientReceiver;

mojo.internal.bindings.cc.mojom.RenderFrameMetadataObserverClientPtr = mojo.internal.bindings.cc.mojom.RenderFrameMetadataObserverClientRemote;
mojo.internal.bindings.cc.mojom.RenderFrameMetadataObserverClientRequest = mojo.internal.bindings.cc.mojom.RenderFrameMetadataObserverClientPendingReceiver;
