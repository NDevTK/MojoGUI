  ...
  $: {
    structSpec: {
      ...
      fields: [
        ...
        { name: 'load_timing', packedOffset: 72, packedBitOffset: 0, type: network.mojom.LoadTimingInfoSpec, nullable: false },
        { name: 'load_timing_internal_info', packedOffset: 80, packedBitOffset: 0, type: network.mojom.LoadTimingInternalInfoSpec, nullable: true },
        { name: 'connection_info', packedOffset: 88, packedBitOffset: 0, type: network.mojom.ConnectionInfoSpec, nullable: false },
        { name: 'alpn_negotiated_protocol', packedOffset: 96, packedBitOffset: 0, type: mojo.internal.String, nullable: false },
        { name: 'alternate_protocol_usage', packedOffset: 104, packedBitOffset: 0, type: network.mojom.AlternateProtocolUsageSpec, nullable: false },
        { name: 'remote_endpoint', packedOffset: 112, packedBitOffset: 0, type: network.mojom.IPEndPointSpec, nullable: false },
        { name: 'client_address_space', packedOffset: 120, packedBitOffset: 0, type: network.mojom.IPAddressSpaceSpec, nullable: false },
        { name: 'response_address_space', packedOffset: 128, packedBitOffset: 0, type: network.mojom.IPAddressSpaceSpec, nullable: false },
        { name: 'navigation_delivery_type', packedOffset: 136, packedBitOffset: 0, type: network.mojom.NavigationDeliveryTypeSpec, nullable: false },
        { name: 'proxy_chain', packedOffset: 144, packedBitOffset: 0, type: network.mojom.ProxyChainSpec, nullable: false },
        { name: 'url_list_via_service_worker', packedOffset: 152, packedBitOffset: 0, type: mojo.internal.Array, nullable: false },
        { name: 'initial_service_worker_status', packedOffset: 160, packedBitOffset: 0, type: network.mojom.ServiceWorkerStatusSpec, nullable: true },
        { name: 'service_worker_router_info', packedOffset: 168, packedBitOffset: 0, type: network.mojom.ServiceWorkerRouterInfoSpec, nullable: true },
        { name: 'response_type', packedOffset: 176, packedBitOffset: 0, type: network.mojom.FetchResponseTypeSpec, nullable: false },
        ...
        { name: 'ssl_info', packedOffset: 200, packedBitOffset: 0, type: network.mojom.SSLInfoSpec, nullable: true },
        ...
        { name: 'auth_challenge_info', packedOffset: 224, packedBitOffset: 0, type: network.mojom.AuthChallengeInfoSpec, nullable: true },
        { name: 'request_start', packedOffset: 232, packedBitOffset: 0, type: mojo_base.mojom.TimeTicksSpec, nullable: false },
        { name: 'response_start', packedOffset: 240, packedBitOffset: 0, type: mojo_base.mojom.TimeTicksSpec, nullable: false },
        { name: 'parsed_headers', packedOffset: 248, packedBitOffset: 0, type: network.mojom.ParsedHeadersSpec, nullable: true },
        { name: 'recursive_prefetch_token', packedOffset: 256, packedBitOffset: 0, type: mojo_base.mojom.UnguessableTokenSpec, nullable: true },
        ...
        { name: 'unencoded_digests', packedOffset: 280, packedBitOffset: 0, type: network.mojom.UnencodedDigestsSpec, nullable: true },
