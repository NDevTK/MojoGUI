...
// Enum: AIWriterFormat
mojo.internal.bindings.blink.mojom.AIWriterFormat = {
  kPlainText: 0,
  kMarkdown: 1,
};

// Enum: AIWriterLength
mojo.internal.bindings.blink.mojom.AIWriterLength = {
  kShort: 0,
  kMedium: 1,
  kLong: 2,
};
...
mojo.internal.Struct(
    mojo.internal.bindings.blink.mojom.AIWriterCreateOptionsSpec, 'blink.mojom.AIWriterCreateOptions', [
      ...
      mojo.internal.StructField('arg_tone', 8, 0, mojo.internal.bindings.mojo.internal.bindings.blink.mojom.AIWriterToneSpec.$, null, false, 0, undefined),
      mojo.internal.StructField('arg_format', 16, 0, mojo.internal.bindings.mojo.internal.bindings.blink.mojom.AIWriterFormatSpec.$, null, false, 0, undefined),
      mojo.internal.StructField('arg_length', 24, 0, mojo.internal.bindings.mojo.internal.bindings.blink.mojom.AIWriterLengthSpec.$, null, false, 0, undefined),
...
// Interface: AIWriter
mojo.internal.Struct(
    mojo.internal.bindings.blink.mojom.AIWriter_Write_ParamsSpec, 'blink.mojom.AIWriter_Write_Params', [
...
mojo.internal.Struct(
    mojo.internal.bindings.blink.mojom.AIWriter_MeasureUsage_ParamsSpec, 'blink.mojom.AIWriter_MeasureUsage_Params', [
      mojo.internal.StructField('arg_input', 0, 0, mojo.internal.String, null, false, 0, undefined),
...
mojo.internal.bindings.blink.mojom.AIWriterPendingReceiver = class {
  constructor(handle) {
    this.handle = handle;
  }
};
...
mojo.internal.bindings.blink.mojom.AIWriterRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.blink.mojom.AIWriterRemoteCallHandler(this.proxy);
  }
  ...
  write(arg_input, arg_context, arg_pending_responder) {
    return this.$.write(arg_input, arg_context, arg_pending_responder);
  }
...
mojo.internal.bindings.blink.mojom.AIWriterRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
...
mojo.internal.bindings.blink.mojom.AIWriter.getRemote = function() {
  let remote = new mojo.internal.bindings.blink.mojom.AIWriterRemote();
...
mojo.internal.bindings.blink.mojom.AIWriterReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.blink.mojom.AIWriter_Write_ParamsSpec);
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.blink.mojom.AIWriter_MeasureUsage_ParamsSpec);
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.blink.mojom.AIWriter_Write_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.write');
          const result = this.impl.write(params.arg_input, params.arg_context, params.arg_pending_responder);
          break;
        }
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.blink.mojom.AIWriter_MeasureUsage_ParamsSpec.$.structSpec);
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.blink.mojom.AIWriter_MeasureUsage_ResponseParamsSpec, header, rawHeader);
               responder(response);
...
mojo.internal.bindings.blink.mojom.AIWriterReceiver = mojo.internal.bindings.blink.mojom.AIWriterReceiver;

mojo.internal.bindings.blink.mojom.AIWriterPtr = mojo.internal.bindings.blink.mojom.AIWriterRemote;
mojo.internal.bindings.blink.mojom.AIWriterRequest = mojo.internal.bindings.blink.mojom.AIWriterPendingReceiver;
