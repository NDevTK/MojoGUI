...
mojo.internal.Struct(
    mojo.internal.bindings.blink.mojom.AIWriterCreateOptionsSpec, 'blink.mojom.AIWriterCreateOptions', [
      ...
      mojo.internal.StructField('arg_format', 16, 0, mojo.internal.bindings.blink.mojom.AIWriterFormatSpec.$, null, false, 0, undefined),
      mojo.internal.StructField('arg_length', 24, 0, mojo.internal.bindings.blink.mojom.AIWriterLengthSpec.$, null, false, 0, undefined),
...
mojo.internal.bindings.blink.mojom.AIWriterRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('blink.mojom.AIWriter', [
      { explicit: null },
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.blink.mojom.AIWriterReceiver = class {
  constructor(impl) {
    ...
    const ordinals = window.mojoScrambler.getOrdinals('blink.mojom.AIWriter', [
      { explicit: null },
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.blink.mojom.AIWriter_Write_ParamsSpec.$.structSpec);
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.blink.mojom.AIWriter_MeasureUsage_ParamsSpec.$.structSpec);
