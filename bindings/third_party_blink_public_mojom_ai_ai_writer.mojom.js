  ...
  $: {
    structSpec: {
      ...
      fields: [
        ...
        { name: 'tone', packedOffset: 8, packedBitOffset: 0, type: blink.mojom.AIWriterToneSpec, nullable: false },
        { name: 'format', packedOffset: 16, packedBitOffset: 0, type: blink.mojom.AIWriterFormatSpec, nullable: false },
        { name: 'length', packedOffset: 24, packedBitOffset: 0, type: blink.mojom.AIWriterLengthSpec, nullable: false },
