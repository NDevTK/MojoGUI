...
network.mojom.mojom.kInvalidCookieVersion = 0;

network.mojom.mojom.kInitialCookieVersion = 1;

// Enum: CookieMatchType
network.mojom.mojom.CookieMatchType = {
  EQUALS: 0,
  STARTS_WITH: 1,
};
network.mojom.mojom.CookieMatchTypeSpec = { $: mojo.internal.Enum() };

// Enum: RestrictedCookieManagerRole
network.mojom.mojom.RestrictedCookieManagerRole = {
  SCRIPT: 0,
  NETWORK: 1,
};
network.mojom.mojom.RestrictedCookieManagerRoleSpec = { $: mojo.internal.Enum() };

// Struct: CookieManagerGetOptions
network.mojom.mojom.CookieManagerGetOptionsSpec = {
  $: {
    structSpec: {
...
network.mojom.mojom.CookiesResponseSpec = {
  $: {
    structSpec: {
...
network.mojom.mojom.RestrictedCookieManager = {};

network.mojom.mojom.RestrictedCookieManagerPendingReceiver = class {
  constructor(handle) {
    this.handle = handle;
  }
};

network.mojom.mojom.RestrictedCookieManagerRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      network.mojom.mojom.RestrictedCookieManagerPendingReceiver,
      handle);
    this.$ = new network.mojom.mojom.RestrictedCookieManagerRemoteCallHandler(this.proxy);
  }
...
network.mojom.mojom.RestrictedCookieManagerRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
  }
  ...
  getAllForUrl(url, site_for_cookies, top_frame_origin, storage_access_api_status, options, is_ad_tagged, apply_devtools_overrides, force_disable_third_party_cookies) {
    ...
    return this.proxy.sendMessage(
      0,  // ordinal
      network.mojom.mojom.RestrictedCookieManager_GetAllForUrl_ParamsSpec,
      network.mojom.mojom.RestrictedCookieManager_GetAllForUrl_ResponseParamsSpec,
  ...
  setCanonicalCookie(cookie, url, site_for_cookies, top_frame_origin, storage_access_api_status, status, is_ad_tagged, apply_devtools_overrides) {
    ...
    return this.proxy.sendMessage(
      1,  // ordinal
      network.mojom.mojom.RestrictedCookieManager_SetCanonicalCookie_ParamsSpec,
      network.mojom.mojom.RestrictedCookieManager_SetCanonicalCookie_ResponseParamsSpec,
  ...
  addChangeListener(url, site_for_cookies, top_frame_origin, storage_access_api_status, listener) {
    ...
    return this.proxy.sendMessage(
      2,  // ordinal
      network.mojom.mojom.RestrictedCookieManager_AddChangeListener_ParamsSpec,
      null,
  ...
  setCookieFromString(url, site_for_cookies, top_frame_origin, storage_access_api_status, get_version_shared_memory, is_ad_tagged, apply_devtools_overrides, cookie) {
    ...
    return this.proxy.sendMessage(
      3,  // ordinal
      network.mojom.mojom.RestrictedCookieManager_SetCookieFromString_ParamsSpec,
      network.mojom.mojom.RestrictedCookieManager_SetCookieFromString_ResponseParamsSpec,
  ...
  getCookiesString(url, site_for_cookies, top_frame_origin, storage_access_api_status, get_version_shared_memory, is_ad_tagged, apply_devtools_overrides, force_disable_third_party_cookies) {
    ...
    return this.proxy.sendMessage(
      4,  // ordinal
      network.mojom.mojom.RestrictedCookieManager_GetCookiesString_ParamsSpec,
      network.mojom.mojom.RestrictedCookieManager_GetCookiesString_ResponseParamsSpec,
  ...
  cookiesEnabledFor(url, site_for_cookies, top_frame_origin, storage_access_api_status, apply_devtools_overrides) {
    ...
    return this.proxy.sendMessage(
      5,  // ordinal
      network.mojom.mojom.RestrictedCookieManager_CookiesEnabledFor_ParamsSpec,
      network.mojom.mojom.RestrictedCookieManager_CookiesEnabledFor_ResponseParamsSpec,
      [url, site_for_cookies, top_frame_origin, storage_access_api_status, apply_devtools_overrides]);
  }

};

network.mojom.mojom.RestrictedCookieManager.getRemote = function() {
  let remote = new network.mojom.mojom.RestrictedCookieManagerRemote();
  ...
  $: {
    structSpec: {
      ...
      fields: [
        ...
        { name: 'options', packedOffset: 24, packedBitOffset: 0, type: network.mojom.CookieManagerGetOptionsSpec, nullable: false, minVersion: 0 },
        ...
        { name: 'force_disable_third_party_cookies', packedOffset: 36, packedBitOffset: 2, type: mojo.internal.Bool, nullable: false, minVersion: 0 },
      ],
  ...
  $: {
    structSpec: {
      ...
      fields: [
        ...
        { name: 'status', packedOffset: 32, packedBitOffset: 0, type: network.mojom.CookieInclusionStatusSpec, nullable: false, minVersion: 0 },
        { name: 'is_ad_tagged', packedOffset: 44, packedBitOffset: 0, type: mojo.internal.Bool, nullable: false, minVersion: 0 },
        { name: 'apply_devtools_overrides', packedOffset: 44, packedBitOffset: 1, type: mojo.internal.Bool, nullable: false, minVersion: 0 },
      ],
  ...
  $: {
    structSpec: {
      ...
      fields: [
        ...
        { name: 'top_frame_origin', packedOffset: 16, packedBitOffset: 0, type: url.mojom.OriginSpec, nullable: false, minVersion: 0 },
        { name: 'storage_access_api_status', packedOffset: 32, packedBitOffset: 0, type: network.mojom.StorageAccessApiStatusSpec, nullable: false, minVersion: 0 },
        { name: 'listener', packedOffset: 24, packedBitOffset: 0, type: mojo.internal.InterfaceProxy(network.mojom.CookieChangeListenerRemote), nullable: false, minVersion: 0 },
      ],
      versions: [{version: 0, packedSize: 48}]
    }
  }
  ...
  $: {
    structSpec: {
      ...
      fields: [
        ...
        { name: 'top_frame_origin', packedOffset: 16, packedBitOffset: 0, type: url.mojom.OriginSpec, nullable: false, minVersion: 0 },
        { name: 'storage_access_api_status', packedOffset: 32, packedBitOffset: 0, type: network.mojom.StorageAccessApiStatusSpec, nullable: false, minVersion: 0 },
        { name: 'get_version_shared_memory', packedOffset: 36, packedBitOffset: 0, type: mojo.internal.Bool, nullable: false, minVersion: 0 },
        { name: 'is_ad_tagged', packedOffset: 36, packedBitOffset: 1, type: mojo.internal.Bool, nullable: false, minVersion: 0 },
        { name: 'apply_devtools_overrides', packedOffset: 36, packedBitOffset: 2, type: mojo.internal.Bool, nullable: false, minVersion: 0 },
        { name: 'cookie', packedOffset: 24, packedBitOffset: 0, type: mojo.internal.String, nullable: false, minVersion: 0 },
      ],
      versions: [{version: 0, packedSize: 48}]
    }
  }
...
network.mojom.mojom.RestrictedCookieManagerPtr = network.mojom.mojom.RestrictedCookieManagerRemote;
network.mojom.mojom.RestrictedCookieManagerRequest = network.mojom.mojom.RestrictedCookieManagerPendingReceiver;
