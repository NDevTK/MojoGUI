...
mojo.internal.bindings.webnn.mojom.WeightsFileSession = mojo.internal.bindings.webnn.mojom.WeightsFileSession || {};
mojo.internal.bindings.webnn.mojom.WeightsFileSessionSpec = mojo.internal.bindings.webnn.mojom.WeightsFileSessionSpec || { $ : {} };
if (mojo.internal.bindings.webnn.mojom.WeightsFileSessionSpec.$.structSpec && mojo.internal.bindings.webnn.mojom.WeightsFileSessionSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.webnn.mojom.WeightsFileSessionSpec.$ = {};
mojo.internal.bindings.webnn.mojom.WeightsFileSession.$interfaceName = 'webnn.mojom.WeightsFileSession';
mojo.internal.bindings.webnn.mojom.WeightsFileSession_RequestCapacityChange_ParamsSpec = mojo.internal.bindings.webnn.mojom.WeightsFileSession_RequestCapacityChange_ParamsSpec || { $: {} };
if (mojo.internal.bindings.webnn.mojom.WeightsFileSession_RequestCapacityChange_ParamsSpec.$.structSpec && mojo.internal.bindings.webnn.mojom.WeightsFileSession_RequestCapacityChange_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.webnn.mojom.WeightsFileSession_RequestCapacityChange_ParamsSpec.$ = {};
mojo.internal.bindings.webnn.mojom.WeightsFileSession_RequestCapacityChange_ResponseParamsSpec = mojo.internal.bindings.webnn.mojom.WeightsFileSession_RequestCapacityChange_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.webnn.mojom.WeightsFileSession_RequestCapacityChange_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.webnn.mojom.WeightsFileSession_RequestCapacityChange_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.webnn.mojom.WeightsFileSession_RequestCapacityChange_ResponseParamsSpec.$ = {};
mojo.internal.bindings.webnn.mojom.WeightsFileSession_Finalize_ParamsSpec = mojo.internal.bindings.webnn.mojom.WeightsFileSession_Finalize_ParamsSpec || { $: {} };
if (mojo.internal.bindings.webnn.mojom.WeightsFileSession_Finalize_ParamsSpec.$.structSpec && mojo.internal.bindings.webnn.mojom.WeightsFileSession_Finalize_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.webnn.mojom.WeightsFileSession_Finalize_ParamsSpec.$ = {};
mojo.internal.bindings.webnn.mojom.WeightsFileSession_Finalize_ResponseParamsSpec = mojo.internal.bindings.webnn.mojom.WeightsFileSession_Finalize_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.webnn.mojom.WeightsFileSession_Finalize_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.webnn.mojom.WeightsFileSession_Finalize_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.webnn.mojom.WeightsFileSession_Finalize_ResponseParamsSpec.$ = {};
mojo.internal.bindings.webnn.mojom.WebNNWeightsFileCreator = mojo.internal.bindings.webnn.mojom.WebNNWeightsFileCreator || {};
mojo.internal.bindings.webnn.mojom.WebNNWeightsFileCreatorSpec = mojo.internal.bindings.webnn.mojom.WebNNWeightsFileCreatorSpec || { $ : {} };
if (mojo.internal.bindings.webnn.mojom.WebNNWeightsFileCreatorSpec.$.structSpec && mojo.internal.bindings.webnn.mojom.WebNNWeightsFileCreatorSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.webnn.mojom.WebNNWeightsFileCreatorSpec.$ = {};
mojo.internal.bindings.webnn.mojom.WebNNWeightsFileCreator.$interfaceName = 'webnn.mojom.WebNNWeightsFileCreator';
mojo.internal.bindings.webnn.mojom.WebNNWeightsFileCreator_OpenWeightsFile_ParamsSpec = mojo.internal.bindings.webnn.mojom.WebNNWeightsFileCreator_OpenWeightsFile_ParamsSpec || { $: {} };
if (mojo.internal.bindings.webnn.mojom.WebNNWeightsFileCreator_OpenWeightsFile_ParamsSpec.$.structSpec && mojo.internal.bindings.webnn.mojom.WebNNWeightsFileCreator_OpenWeightsFile_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.webnn.mojom.WebNNWeightsFileCreator_OpenWeightsFile_ParamsSpec.$ = {};
mojo.internal.bindings.webnn.mojom.WebNNWeightsFileCreator_OpenWeightsFile_ResponseParamsSpec = mojo.internal.bindings.webnn.mojom.WebNNWeightsFileCreator_OpenWeightsFile_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.webnn.mojom.WebNNWeightsFileCreator_OpenWeightsFile_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.webnn.mojom.WebNNWeightsFileCreator_OpenWeightsFile_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.webnn.mojom.WebNNWeightsFileCreator_OpenWeightsFile_ResponseParamsSpec.$ = {};
...
mojo.internal.bindings.mojo_base = mojo.internal.bindings.mojo_base || {};
mojo.internal.bindings.mojo_base.mojom = mojo.internal.bindings.mojo_base.mojom || {};
mojo.internal.bindings.mojo_base.mojom.ErrorSpec = mojo.internal.bindings.mojo_base.mojom.ErrorSpec || { $: mojo.internal.OpaqueStruct.$ };
mojo.internal.bindings.mojo_base = mojo.internal.bindings.mojo_base || {};
mojo.internal.bindings.mojo_base.mojom = mojo.internal.bindings.mojo_base.mojom || {};
...
mojo.internal.bindings.webnn.mojom.WebNNCompilerContextRemote = mojo.internal.bindings.webnn.mojom.WebNNCompilerContextRemote || class {};
mojo.internal.bindings.webnn.mojom.WebNNCompilerContextPendingReceiver = mojo.internal.bindings.webnn.mojom.WebNNCompilerContextPendingReceiver || class { constructor(handle) { this.handle = handle; } };
mojo.internal.bindings.webnn = mojo.internal.bindings.webnn || {};
mojo.internal.bindings.webnn.mojom = mojo.internal.bindings.webnn.mojom || {};
...
mojo.internal.bindings.webnn.mojom.WebNNContextProviderRemote = class {
  ...
  constructor(handle = undefined) {
    ...
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.webnn.mojom.WebNNContextProviderRemoteCallHandler(this.proxy);
  }
  ...
  createWebNNContext(arg_options) {
    return this.$.createWebNNContext(arg_options);
  }
};
...
mojo.internal.bindings.webnn.mojom.WebNNContextProvider.getRemote = function() {
  let remote = new mojo.internal.bindings.webnn.mojom.WebNNContextProviderRemote();
...
mojo.internal.bindings.webnn.mojom.WebNNContextProviderReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
...
mojo.internal.bindings.webnn.mojom.WebNNContextProviderReceiver = mojo.internal.bindings.webnn.mojom.WebNNContextProviderReceiver;
...
mojo.internal.bindings.webnn.mojom.WeightsFileSessionPendingReceiver = class {
  constructor(handle) {
    this.handle = handle;
    if (handle) {
      this.__mojoHandle = handle.router_ ? handle.router_.pipe_ : (handle.pipe_ || handle);
...
mojo.internal.bindings.webnn.mojom.WeightsFileSessionRemote = class {
  static get $interfaceName() {
    return 'webnn.mojom.WeightsFileSession';
  }

  constructor(handle = undefined) {
    this.__mojoHandle = handle;
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.webnn.mojom.WeightsFileSessionPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.webnn.mojom.WeightsFileSessionRemoteCallHandler(this.proxy);
  }
  ...
  requestCapacityChange(arg_new_size) {
    return this.$.requestCapacityChange(arg_new_size);
  }
  finalize() {
...
mojo.internal.bindings.webnn.mojom.WeightsFileSessionRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('webnn.mojom.WeightsFileSession', [
      { explicit: null },
      { explicit: null },
    ]);
  }
  ...
  finalize() {
    return this.proxy.sendMessage(
      ...
      mojo.internal.bindings.webnn.mojom.WeightsFileSession_Finalize_ParamsSpec,
      mojo.internal.bindings.webnn.mojom.WeightsFileSession_Finalize_ResponseParamsSpec,
      [],
      false);
  }
...
mojo.internal.bindings.webnn.mojom.WeightsFileSession.getRemote = function() {
  let remote = new mojo.internal.bindings.webnn.mojom.WeightsFileSessionRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
    'webnn.mojom.WeightsFileSession',
    'context');
  return remote.$;
};

mojo.internal.bindings.webnn.mojom.WeightsFileSessionReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('webnn.mojom.WeightsFileSession', [
      { explicit: null },
      { explicit: null },
    ]);
    ordinals.forEach((ord, idx) => {
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.webnn.mojom.WeightsFileSession_RequestCapacityChange_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.requestCapacityChange');
          const result = this.impl.requestCapacityChange(params.arg_new_size);
          const expectsResponse = header.expectsResponse || (header.flags & 1);
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.webnn.mojom.WeightsFileSession_RequestCapacityChange_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
        ...
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.webnn.mojom.WeightsFileSession_Finalize_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.finalize');
          const result = this.impl.finalize();
          const expectsResponse = header.expectsResponse || (header.flags & 1);
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              const val = (response && typeof response === 'object' && 'arg_sealed_file' in response) ? response['arg_sealed_file'] : response;
              const resp_obj = { 'arg_sealed_file': val };
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.webnn.mojom.WeightsFileSession_Finalize_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
            }).catch(e => console.error('[GeneratedReceiver] finalize FAILED:', e));
          }
          break;
        }
      }
...
mojo.internal.bindings.webnn.mojom.WeightsFileSessionReceiver = mojo.internal.bindings.webnn.mojom.WeightsFileSessionReceiver;

mojo.internal.bindings.webnn.mojom.WeightsFileSessionPtr = mojo.internal.bindings.webnn.mojom.WeightsFileSessionRemote;
mojo.internal.bindings.webnn.mojom.WeightsFileSessionRequest = mojo.internal.bindings.webnn.mojom.WeightsFileSessionPendingReceiver;


// Interface: WebNNWeightsFileCreator
mojo.internal.bindings.webnn.mojom.WebNNWeightsFileCreatorPendingReceiver = class {
  constructor(handle) {
    this.handle = handle;
    if (handle) {
      this.__mojoHandle = handle.router_ ? handle.router_.pipe_ : (handle.pipe_ || handle);
...
mojo.internal.bindings.webnn.mojom.WebNNWeightsFileCreatorRemote = class {
  static get $interfaceName() {
    return 'webnn.mojom.WebNNWeightsFileCreator';
  }

  constructor(handle = undefined) {
    this.__mojoHandle = handle;
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.webnn.mojom.WebNNWeightsFileCreatorPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.webnn.mojom.WebNNWeightsFileCreatorRemoteCallHandler(this.proxy);
  }
  ...
  openWeightsFile() {
    return this.$.openWeightsFile();
  }
};

mojo.internal.bindings.webnn.mojom.WebNNWeightsFileCreatorRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('webnn.mojom.WebNNWeightsFileCreator', [
      { explicit: null },
    ]);
  }
  ...
  openWeightsFile() {
    return this.proxy.sendMessage(
      this.ordinals[0],  // ordinal
      mojo.internal.bindings.webnn.mojom.WebNNWeightsFileCreator_OpenWeightsFile_ParamsSpec,
      mojo.internal.bindings.webnn.mojom.WebNNWeightsFileCreator_OpenWeightsFile_ResponseParamsSpec,
      [],
      false);
  }
...
mojo.internal.bindings.webnn.mojom.WebNNWeightsFileCreator.getRemote = function() {
  let remote = new mojo.internal.bindings.webnn.mojom.WebNNWeightsFileCreatorRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
    'webnn.mojom.WebNNWeightsFileCreator',
    'context');
  return remote.$;
};

mojo.internal.bindings.webnn.mojom.WebNNWeightsFileCreatorReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('webnn.mojom.WebNNWeightsFileCreator', [
      { explicit: null },
    ]);
    ordinals.forEach((ord, idx) => {
      this.ordinalMap.set(ord, idx); // Scrambled/Explicit
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.webnn.mojom.WebNNWeightsFileCreator_OpenWeightsFile_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.openWeightsFile');
          const result = this.impl.openWeightsFile();
          const expectsResponse = header.expectsResponse || (header.flags & 1);
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.webnn.mojom.WebNNWeightsFileCreator_OpenWeightsFile_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
            }).catch(e => console.error('[GeneratedReceiver] openWeightsFile FAILED:', e));
          }
          break;
        }
      }
...
mojo.internal.bindings.webnn.mojom.WebNNWeightsFileCreatorReceiver = mojo.internal.bindings.webnn.mojom.WebNNWeightsFileCreatorReceiver;

mojo.internal.bindings.webnn.mojom.WebNNWeightsFileCreatorPtr = mojo.internal.bindings.webnn.mojom.WebNNWeightsFileCreatorRemote;
mojo.internal.bindings.webnn.mojom.WebNNWeightsFileCreatorRequest = mojo.internal.bindings.webnn.mojom.WebNNWeightsFileCreatorPendingReceiver;
...
mojo.internal.Struct(
    mojo.internal.bindings.webnn.mojom.CreateContextSuccessSpec, 'webnn.mojom.CreateContextSuccess', [
      ...
      mojo.internal.StructField('arg_compiler_context_remote', 8, 0, mojo.internal.InterfaceProxy(mojo.internal.bindings.webnn.mojom.WebNNCompilerContextRemote), null, true, 0, undefined),
      mojo.internal.StructField('arg_context_properties', 16, 0, mojo.internal.bindings.webnn.mojom.ContextPropertiesSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_context_handle', 24, 0, mojo.internal.bindings.blink.mojom.WebNNContextTokenSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_write_tensor_producer', 32, 0, mojo.internal.Handle, null, true, 0, undefined),
      mojo.internal.StructField('arg_read_tensor_consumer', 36, 0, mojo.internal.Handle, null, true, 0, undefined),
      mojo.internal.StructField('arg_command_buffer_id', 40, 0, mojo.internal.Uint64, 0, false, 0, undefined),
    ],
    [[0, 56]]);
mojo.internal.Struct(
...
mojo.internal.Struct(
    mojo.internal.bindings.webnn.mojom.WeightsFileSession_RequestCapacityChange_ParamsSpec, 'webnn.mojom.WeightsFileSession_RequestCapacityChange_Params', [
      mojo.internal.StructField('arg_new_size', 0, 0, mojo.internal.Uint64, 0, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.webnn.mojom.WeightsFileSession_RequestCapacityChange_ResponseParamsSpec, 'webnn.mojom.WeightsFileSession_RequestCapacityChange_ResponseParams', [
      mojo.internal.StructField('arg_granted', 0, 0, mojo.internal.Bool, false, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.webnn.mojom.WeightsFileSession_Finalize_ParamsSpec, 'webnn.mojom.WeightsFileSession_Finalize_Params', [
    ],
    [[0, 8]]);

mojo.internal.Struct(
    mojo.internal.bindings.webnn.mojom.WeightsFileSession_Finalize_ResponseParamsSpec, 'webnn.mojom.WeightsFileSession_Finalize_ResponseParams', [
      mojo.internal.StructField('arg_sealed_file', 0, 0, mojo.internal.bindings.mojo_base.mojom.ReadOnlyFileSpec, null, true, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.webnn.mojom.WebNNWeightsFileCreator_OpenWeightsFile_ParamsSpec, 'webnn.mojom.WebNNWeightsFileCreator_OpenWeightsFile_Params', [
    ],
    [[0, 8]]);

mojo.internal.Struct(
    mojo.internal.bindings.webnn.mojom.WebNNWeightsFileCreator_OpenWeightsFile_ResponseParamsSpec, 'webnn.mojom.WebNNWeightsFileCreator_OpenWeightsFile_ResponseParams', [
      mojo.internal.StructField('arg_writable_fd', 0, 0, mojo.internal.bindings.mojo_base.mojom.FileSpec, null, true, 0, undefined),
      mojo.internal.StructField('arg_session', 8, 0, mojo.internal.InterfaceProxy(mojo.internal.bindings.webnn.mojom.WeightsFileSessionRemote), null, true, 0, undefined),
    ],
    [[0, 24]]);
