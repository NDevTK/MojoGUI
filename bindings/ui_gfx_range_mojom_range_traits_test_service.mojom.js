...
mojo.internal.bindings.gfx.mojom.RangeTraitsTestService = {};
mojo.internal.bindings.gfx.mojom.RangeTraitsTestServiceSpec = { $ : {} };
mojo.internal.bindings.gfx.mojom.RangeTraitsTestService.$interfaceName = 'gfx.mojom.RangeTraitsTestService';
...
mojo.internal.bindings.gfx.mojom.RangeTraitsTestServiceRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.gfx.mojom.RangeTraitsTestServicePendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.gfx.mojom.RangeTraitsTestServiceRemoteCallHandler(this.proxy);
  }
  ...
  echoRange(arg_p) {
    return this.$.echoRange(arg_p);
  }
  echoRangeF(arg_p) {
    return this.$.echoRangeF(arg_p);
  }
};

mojo.internal.bindings.gfx.mojom.RangeTraitsTestServiceRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('gfx.mojom.RangeTraitsTestService', [
      { explicit: null },
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.gfx.mojom.RangeTraitsTestService.getRemote = function() {
  let remote = new mojo.internal.bindings.gfx.mojom.RangeTraitsTestServiceRemote();
...
mojo.internal.bindings.gfx.mojom.RangeTraitsTestServiceReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('gfx.mojom.RangeTraitsTestService', [
      { explicit: null },
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        // Try Method 0: EchoRange
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.gfx.mojom.RangeTraitsTestService_EchoRange_ParamsSpec.$.structSpec);
             console.log('[GeneratedReceiver] Discovery SUCCESS: ' + header.ordinal + ' -> EchoRange (0)');
        ...
        // Try Method 1: EchoRangeF
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.gfx.mojom.RangeTraitsTestService_EchoRangeF_ParamsSpec.$.structSpec);
             console.log('[GeneratedReceiver] Discovery SUCCESS: ' + header.ordinal + ' -> EchoRangeF (1)');
      ...
      switch (dispatchId) {
        case 0: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.gfx.mojom.RangeTraitsTestService_EchoRange_ResponseParamsSpec, header, rawHeader);
               responder(response);
        ...
        case 1: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              const rawHeader = (args[2] && args[2].slice) ? args[2].slice(0, header.headerSize) : null;
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.gfx.mojom.RangeTraitsTestService_EchoRangeF_ResponseParamsSpec, header, rawHeader);
               responder(response);
...
mojo.internal.bindings.gfx.mojom.RangeTraitsTestServiceReceiver = mojo.internal.bindings.gfx.mojom.RangeTraitsTestServiceReceiver;
