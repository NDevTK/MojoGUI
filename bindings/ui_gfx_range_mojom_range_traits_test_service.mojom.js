...
gfx.mojom.RangeTraitsTestService_EchoRange_ParamsSpec = {
  $: {
    structSpec: {
      ...
      packedSize: 16,
      fields: [
        { name: 'p', packedOffset: 0, packedBitOffset: 0, type: gfx.mojom.RangeSpec, nullable: false },
      ],
      versions: [{version: 0}]
    }
  }
...
gfx.mojom.RangeTraitsTestService_EchoRange_ResponseParamsSpec = {
  $: {
    structSpec: {
      ...
      packedSize: 16,
      fields: [
        { name: 'pass', packedOffset: 0, packedBitOffset: 0, type: gfx.mojom.RangeSpec, nullable: false },
      ],
      versions: [{version: 0}]
    }
  }
...
gfx.mojom.RangeTraitsTestService_EchoRangeF_ParamsSpec = {
  $: {
    structSpec: {
      ...
      packedSize: 16,
      fields: [
        { name: 'p', packedOffset: 0, packedBitOffset: 0, type: gfx.mojom.RangeFSpec, nullable: false },
      ],
      versions: [{version: 0}]
    }
  }
...
gfx.mojom.RangeTraitsTestService_EchoRangeF_ResponseParamsSpec = {
  $: {
    structSpec: {
      ...
      packedSize: 16,
      fields: [
        { name: 'pass', packedOffset: 0, packedBitOffset: 0, type: gfx.mojom.RangeFSpec, nullable: false },
      ],
      versions: [{version: 0}]
    }
  }
