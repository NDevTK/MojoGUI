...
mojo.internal.Struct(
    mojo.internal.bindings.video_capture.mojom.VideoSourceProvider_GetSourceInfos_ResponseParamsSpec, 'video_capture.mojom.VideoSourceProvider_GetSourceInfos_ResponseParams', [
      mojo.internal.StructField('arg_source_infos', 0, 0, mojo.internal.Array(mojo.internal.bindings.media.mojom.VideoCaptureDeviceInfoSpec, false), null, false, 0, undefined),
      mojo.internal.StructField('arg_result', 8, 0, mojo.internal.bindings.video_capture.mojom.GetSourceInfosResultSpec, null, false, 0, undefined),
    ],
    [[0, 24]]);
...
mojo.internal.bindings.video_capture.mojom.VideoSourceProviderRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.video_capture.mojom.VideoSourceProviderRemoteCallHandler(this.proxy);
  }
  ...
  addSharedMemoryVirtualDevice(arg_device_info, arg_producer, arg_virtual_device_receiver) {
    return this.$.addSharedMemoryVirtualDevice(arg_device_info, arg_producer, arg_virtual_device_receiver);
  }
  addTextureVirtualDevice(arg_device_info, arg_virtual_device_receiver) {
    return this.$.addTextureVirtualDevice(arg_device_info, arg_virtual_device_receiver);
  }
  registerVirtualDevicesChangedObserver(arg_observer, arg_raise_event_if_virtual_devices_already_present) {
    return this.$.registerVirtualDevicesChangedObserver(arg_observer, arg_raise_event_if_virtual_devices_already_present);
  }
...
mojo.internal.bindings.video_capture.mojom.VideoSourceProviderRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('video_capture.mojom.VideoSourceProvider', [
      { explicit: null },
      { explicit: null },
      { explicit: null },
      { explicit: null },
...
mojo.internal.bindings.video_capture.mojom.VideoSourceProvider.getRemote = function() {
  let remote = new mojo.internal.bindings.video_capture.mojom.VideoSourceProviderRemote();
...
mojo.internal.bindings.video_capture.mojom.VideoSourceProviderReceiver = class {
  constructor(impl) {
    ...
    const ordinals = window.mojoScrambler.getOrdinals('video_capture.mojom.VideoSourceProvider', [
      { explicit: null },
      { explicit: null },
      { explicit: null },
      { explicit: null },
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.video_capture.mojom.VideoSourceProvider_GetSourceInfos_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for GetSourceInfos failed with TypeError');
           }
        }
        // Try Method 1: GetVideoSource
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.video_capture.mojom.VideoSourceProvider_GetVideoSource_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for GetVideoSource failed with TypeError');
           }
        }
        // Try Method 2: AddSharedMemoryVirtualDevice
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.video_capture.mojom.VideoSourceProvider_AddSharedMemoryVirtualDevice_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for AddSharedMemoryVirtualDevice failed with TypeError');
           }
        }
        // Try Method 3: AddTextureVirtualDevice
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.video_capture.mojom.VideoSourceProvider_AddTextureVirtualDevice_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for AddTextureVirtualDevice failed with TypeError');
           }
        }
        // Try Method 4: RegisterVirtualDevicesChangedObserver
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.video_capture.mojom.VideoSourceProvider_RegisterVirtualDevicesChangedObserver_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for RegisterVirtualDevicesChangedObserver failed with TypeError');
           }
        }
        // Try Method 5: RegisterDevicesChangedObserver
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.video_capture.mojom.VideoSourceProvider_RegisterDevicesChangedObserver_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for RegisterDevicesChangedObserver failed with TypeError');
           }
        }
        // Try Method 6: Close
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.video_capture.mojom.VideoSourceProvider_Close_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for Close failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.video_capture.mojom.VideoSourceProvider_GetSourceInfos_ParamsSpec.$.structSpec);
        ...
        case 6: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.video_capture.mojom.VideoSourceProvider_Close_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.video_capture.mojom.VideoSourceProviderReceiver = mojo.internal.bindings.video_capture.mojom.VideoSourceProviderReceiver;
