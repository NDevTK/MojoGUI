...
mojo.internal.bindings.chromecast.mojom.ActivityUrlFilterConfigurationRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.chromecast.mojom.ActivityUrlFilterConfigurationPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.chromecast.mojom.ActivityUrlFilterConfigurationRemoteCallHandler(this.proxy);
  }
  ...
  setFilter(arg_filter) {
    return this.$.setFilter(arg_filter);
  }
};

mojo.internal.bindings.chromecast.mojom.ActivityUrlFilterConfigurationRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('chromecast.mojom.ActivityUrlFilterConfiguration', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.chromecast.mojom.ActivityUrlFilterConfiguration.getRemote = function() {
  let remote = new mojo.internal.bindings.chromecast.mojom.ActivityUrlFilterConfigurationRemote();
...
mojo.internal.bindings.chromecast.mojom.ActivityUrlFilterConfigurationReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('chromecast.mojom.ActivityUrlFilterConfiguration', [
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.chromecast.mojom.ActivityUrlFilterConfiguration_SetFilter_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for SetFilter failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.chromecast.mojom.ActivityUrlFilterConfigurationReceiver = mojo.internal.bindings.chromecast.mojom.ActivityUrlFilterConfigurationReceiver;
