...
if (mojo.internal.bindings.new_tab_page.mojom.PageHandler_CanShowRealboxContextMenuAnimation_ParamsSpec.$.structSpec && mojo.internal.bindings.new_tab_page.mojom.PageHandler_CanShowRealboxContextMenuAnimation_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.new_tab_page.mojom.PageHandler_CanShowRealboxContextMenuAnimation_ParamsSpec.$ = {};
mojo.internal.bindings.new_tab_page.mojom.PageHandler_CanShowRealboxContextMenuAnimation_ResponseParamsSpec = mojo.internal.bindings.new_tab_page.mojom.PageHandler_CanShowRealboxContextMenuAnimation_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.new_tab_page.mojom.PageHandler_CanShowRealboxContextMenuAnimation_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.new_tab_page.mojom.PageHandler_CanShowRealboxContextMenuAnimation_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.new_tab_page.mojom.PageHandler_CanShowRealboxContextMenuAnimation_ResponseParamsSpec.$ = {};
mojo.internal.bindings.new_tab_page.mojom.PageHandler_RecordRealboxContextMenuAnimationImpression_ParamsSpec = mojo.internal.bindings.new_tab_page.mojom.PageHandler_RecordRealboxContextMenuAnimationImpression_ParamsSpec || { $: {} };
if (mojo.internal.bindings.new_tab_page.mojom.PageHandler_RecordRealboxContextMenuAnimationImpression_ParamsSpec.$.structSpec && mojo.internal.bindings.new_tab_page.mojom.PageHandler_RecordRealboxContextMenuAnimationImpression_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.new_tab_page.mojom.PageHandler_RecordRealboxContextMenuAnimationImpression_ParamsSpec.$ = {};
mojo.internal.bindings.new_tab_page.mojom.PageHandler_OnContextualSearchIPHEngaged_ParamsSpec = mojo.internal.bindings.new_tab_page.mojom.PageHandler_OnContextualSearchIPHEngaged_ParamsSpec || { $: {} };
if (mojo.internal.bindings.new_tab_page.mojom.PageHandler_OnContextualSearchIPHEngaged_ParamsSpec.$.structSpec && mojo.internal.bindings.new_tab_page.mojom.PageHandler_OnContextualSearchIPHEngaged_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.new_tab_page.mojom.PageHandler_OnContextualSearchIPHEngaged_ParamsSpec.$ = {};
...
mojo.internal.bindings.new_tab_page.mojom.PageHandlerRemote = class {
  ...
  canShowRealboxContextMenuAnimation() {
    return this.$.canShowRealboxContextMenuAnimation();
  }
  recordRealboxContextMenuAnimationImpression() {
    return this.$.recordRealboxContextMenuAnimationImpression();
  }
  onContextualSearchIPHEngaged() {
    return this.$.onContextualSearchIPHEngaged();
  }
};
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        ...
        case 30: {
          ...
          const result = this.impl.canShowRealboxContextMenuAnimation();
          const expectsResponse = header.expectsResponse || (header.flags & 1);
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.new_tab_page.mojom.PageHandler_CanShowRealboxContextMenuAnimation_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
            }).catch(e => console.error('[GeneratedReceiver] canShowRealboxContextMenuAnimation FAILED:', e));
          }
          break;
        }
        case 31: {
          ...
          const result = this.impl.recordRealboxContextMenuAnimationImpression();
          break;
        }
        case 32: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          ...
          const result = this.impl.onContextualSearchIPHEngaged();
          break;
        }
      }
      } catch (err) {
...
mojo.internal.Struct(
    mojo.internal.bindings.new_tab_page.mojom.PageHandler_CanShowRealboxContextMenuAnimation_ParamsSpec, 'new_tab_page.mojom.PageHandler_CanShowRealboxContextMenuAnimation_Params', [
    ],
    [[0, 8]]);

mojo.internal.Struct(
    mojo.internal.bindings.new_tab_page.mojom.PageHandler_CanShowRealboxContextMenuAnimation_ResponseParamsSpec, 'new_tab_page.mojom.PageHandler_CanShowRealboxContextMenuAnimation_ResponseParams', [
      mojo.internal.StructField('arg_can_show', 0, 0, mojo.internal.Bool, false, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.new_tab_page.mojom.PageHandler_RecordRealboxContextMenuAnimationImpression_ParamsSpec, 'new_tab_page.mojom.PageHandler_RecordRealboxContextMenuAnimationImpression_Params', [
    ],
    [[0, 8]]);

mojo.internal.Struct(
    mojo.internal.bindings.new_tab_page.mojom.PageHandler_OnContextualSearchIPHEngaged_ParamsSpec, 'new_tab_page.mojom.PageHandler_OnContextualSearchIPHEngaged_Params', [
    ],
    [[0, 8]]);
