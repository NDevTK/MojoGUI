...
mojo.internal.Struct(
    mojo.internal.bindings.blink.mojom.ControllerServiceWorkerInfoSpec, 'blink.mojom.ControllerServiceWorkerInfo', [
      ...
      mojo.internal.StructField('arg_remote_controller', 24, 0, mojo.internal.InterfaceProxy(mojo.internal.bindings.blink.mojom.ControllerServiceWorkerRemote), null, true, 0, undefined),
      ...
      mojo.internal.StructField('arg_object_info', 48, 0, mojo.internal.bindings.blink.mojom.ServiceWorkerObjectInfoSpec.$, null, true, 0, undefined),
      mojo.internal.StructField('arg_used_features', 56, 0, mojo.internal.Array(mojo.internal.bindings.blink.mojom.WebFeatureSpec.$, false), null, false, 0, undefined),
      mojo.internal.StructField('arg_need_router_evaluate', 64, 0, mojo.internal.Bool, false, false, 0, undefined),
    ],
    [[0, 80]]);
...
mojo.internal.bindings.blink.mojom.ControllerServiceWorkerPendingReceiver = class {
  constructor(handle) {
    this.handle = handle;
  }
};

mojo.internal.bindings.blink.mojom.ControllerServiceWorkerRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.blink.mojom.ControllerServiceWorkerPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.blink.mojom.ControllerServiceWorkerRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.blink.mojom.ControllerServiceWorkerRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('blink.mojom.ControllerServiceWorker', [
      { explicit: null },
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.blink.mojom.ControllerServiceWorker.getRemote = function() {
  let remote = new mojo.internal.bindings.blink.mojom.ControllerServiceWorkerRemote();
...
mojo.internal.bindings.blink.mojom.ControllerServiceWorkerReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('blink.mojom.ControllerServiceWorker', [
      { explicit: null },
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.blink.mojom.ControllerServiceWorker_DispatchFetchEventForSubresource_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for DispatchFetchEventForSubresource failed with TypeError');
           }
        }
        // Try Method 1: Clone
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.blink.mojom.ControllerServiceWorker_Clone_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
        ...
        case 0: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              this.endpoint.send(header.ordinal, header.requestId, mojo.internal.kMessageFlagIsResponse, mojo.internal.bindings.blink.mojom.ControllerServiceWorker_DispatchFetchEventForSubresource_ResponseParamsSpec, response);
...
mojo.internal.bindings.blink.mojom.ControllerServiceWorkerReceiver = mojo.internal.bindings.blink.mojom.ControllerServiceWorkerReceiver;

mojo.internal.bindings.blink.mojom.ControllerServiceWorkerPtr = mojo.internal.bindings.blink.mojom.ControllerServiceWorkerRemote;
mojo.internal.bindings.blink.mojom.ControllerServiceWorkerRequest = mojo.internal.bindings.blink.mojom.ControllerServiceWorkerPendingReceiver;
...
mojo.internal.Struct(
    mojo.internal.bindings.blink.mojom.ControllerServiceWorkerConnector_UpdateController_ParamsSpec, 'blink.mojom.ControllerServiceWorkerConnector_UpdateController_Params', [
      mojo.internal.StructField('arg_controller', 0, 0, mojo.internal.InterfaceProxy(mojo.internal.bindings.blink.mojom.ControllerServiceWorkerRemote), null, true, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.bindings.blink.mojom.ControllerServiceWorkerConnectorPendingReceiver = class {
  constructor(handle) {
    this.handle = handle;
  }
};

mojo.internal.bindings.blink.mojom.ControllerServiceWorkerConnectorRemote = class {
  static get $interfaceName() {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.blink.mojom.ControllerServiceWorkerConnectorPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.blink.mojom.ControllerServiceWorkerConnectorRemoteCallHandler(this.proxy);
  }
  ...
  updateController(arg_controller) {
    return this.$.updateController(arg_controller);
  }
};

mojo.internal.bindings.blink.mojom.ControllerServiceWorkerConnectorRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('blink.mojom.ControllerServiceWorkerConnector', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.blink.mojom.ControllerServiceWorkerConnector.getRemote = function() {
  let remote = new mojo.internal.bindings.blink.mojom.ControllerServiceWorkerConnectorRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
...
mojo.internal.bindings.blink.mojom.ControllerServiceWorkerConnectorReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('blink.mojom.ControllerServiceWorkerConnector', [
      { explicit: null },
    ]);
    ordinals.forEach((ord, idx) => {
      this.ordinalMap.set(ord, idx); // Scrambled/Explicit
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.blink.mojom.ControllerServiceWorkerConnector_UpdateController_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for UpdateController failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
             console.warn('[GeneratedReceiver] Failed to discover ordinal ' + header.ordinal);
...
mojo.internal.bindings.blink.mojom.ControllerServiceWorkerConnectorReceiver = mojo.internal.bindings.blink.mojom.ControllerServiceWorkerConnectorReceiver;

mojo.internal.bindings.blink.mojom.ControllerServiceWorkerConnectorPtr = mojo.internal.bindings.blink.mojom.ControllerServiceWorkerConnectorRemote;
mojo.internal.bindings.blink.mojom.ControllerServiceWorkerConnectorRequest = mojo.internal.bindings.blink.mojom.ControllerServiceWorkerConnectorPendingReceiver;
