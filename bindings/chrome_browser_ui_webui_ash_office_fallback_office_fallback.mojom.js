...
// Enum: DialogChoice
mojo.internal.bindings.ash.office_fallback.mojom.DialogChoice = {
  kCancel: 0,
  kOk: 1,
  kQuickOffice: 2,
  kTryAgain: 3,
...
mojo.internal.bindings.ash.office_fallback.mojom.PageHandlerFactoryRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.ash.office_fallback.mojom.PageHandlerFactoryPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.ash.office_fallback.mojom.PageHandlerFactoryRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.ash.office_fallback.mojom.PageHandlerFactory.getRemote = function() {
  let remote = new mojo.internal.bindings.ash.office_fallback.mojom.PageHandlerFactoryRemote();
...
mojo.internal.bindings.ash.office_fallback.mojom.PageHandlerFactoryReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ash.office_fallback.mojom.PageHandlerFactory_CreatePageHandler_ParamsSpec.$.structSpec;
...
mojo.internal.bindings.ash.office_fallback.mojom.PageHandlerFactoryReceiver = mojo.internal.bindings.ash.office_fallback.mojom.PageHandlerFactoryReceiver;

mojo.internal.bindings.ash.office_fallback.mojom.PageHandlerFactoryPtr = mojo.internal.bindings.ash.office_fallback.mojom.PageHandlerFactoryRemote;
mojo.internal.bindings.ash.office_fallback.mojom.PageHandlerFactoryRequest = mojo.internal.bindings.ash.office_fallback.mojom.PageHandlerFactoryPendingReceiver;
...
mojo.internal.bindings.ash.office_fallback.mojom.PageHandlerRemote = class {
  static get $interfaceName() {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.ash.office_fallback.mojom.PageHandlerPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.ash.office_fallback.mojom.PageHandlerRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.ash.office_fallback.mojom.PageHandler.getRemote = function() {
  let remote = new mojo.internal.bindings.ash.office_fallback.mojom.PageHandlerRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
...
mojo.internal.bindings.ash.office_fallback.mojom.PageHandlerReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ash.office_fallback.mojom.PageHandler_Close_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
...
mojo.internal.bindings.ash.office_fallback.mojom.PageHandlerReceiver = mojo.internal.bindings.ash.office_fallback.mojom.PageHandlerReceiver;
