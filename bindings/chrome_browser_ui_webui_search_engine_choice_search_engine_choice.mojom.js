...
search_engine_choice.mojom.PageHandler_HandleSearchEngineChoiceSelected_ParamsSpec = {
  $: {
    structSpec: {
      ...
      packedSize: 24,
      fields: [
        { name: 'prepopulate_id', packedOffset: 0, packedBitOffset: 0, type: mojo.internal.String, nullable: true },
        { name: 'save_guest_mode_selection', packedOffset: 8, packedBitOffset: 0, type: mojo.internal.String, nullable: true },
      ],
      versions: [{version: 0}]
    }
  }
...
search_engine_choice.mojom.PageHandler_RecordScrollState_ParamsSpec = {
  $: {
    structSpec: {
      ...
      packedSize: 16,
      fields: [
        { name: 'scroll_state', packedOffset: 0, packedBitOffset: 0, type: mojo.internal.String, nullable: true },
      ],
      versions: [{version: 0}]
    }
  }
