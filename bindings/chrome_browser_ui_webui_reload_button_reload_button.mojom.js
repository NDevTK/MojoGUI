...
reload_button.mojom.PageHandler_Reload_ParamsSpec = {
  $: {
    structSpec: {
      ...
      packedSize: 24,
      fields: [
        { name: 'ignore_cache', packedOffset: 0, packedBitOffset: 0, type: mojo.internal.String, nullable: true },
...
reload_button.mojom.PageHandler_ShowContextMenu_ParamsSpec = {
  $: {
    structSpec: {
      ...
      packedSize: 24,
      fields: [
        { name: 'offset_x', packedOffset: 0, packedBitOffset: 0, type: mojo.internal.String, nullable: true },
        { name: 'offset_y', packedOffset: 8, packedBitOffset: 0, type: mojo.internal.String, nullable: true },
      ],
      versions: [{version: 0}]
    }
  }
  ...
  $: {
    structSpec: {
      ...
      fields: [
        ...
        { name: 'is_menu_enabled', packedOffset: 8, packedBitOffset: 0, type: mojo.internal.String, nullable: true },
      ],
      versions: [{version: 0}]
    }
  }
