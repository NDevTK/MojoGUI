  ...
  $: {
    structSpec: {
      ...
      fields: [
        ...
        { name: 'source', packedOffset: 8, packedBitOffset: 0, type: ntp.most_relevant_tab_resumption.mojom.VisitSourceSpec, nullable: false },
        ...
        { name: 'decoration', packedOffset: 40, packedBitOffset: 0, type: ntp.most_relevant_tab_resumption.mojom.DecorationSpec, nullable: false },
        { name: 'relative_time', packedOffset: 48, packedBitOffset: 0, type: mojo_base.mojom.TimeDeltaSpec, nullable: false },
        { name: 'timestamp', packedOffset: 56, packedBitOffset: 0, type: mojo_base.mojom.TimeSpec, nullable: true },
