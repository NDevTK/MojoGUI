...
mojo.internal.bindings.browser.context_hub.mojom.PageHandler_GenerateAutoTodos_ParamsSpec = mojo.internal.bindings.browser.context_hub.mojom.PageHandler_GenerateAutoTodos_ParamsSpec || { $: {} };
if (mojo.internal.bindings.browser.context_hub.mojom.PageHandler_GenerateAutoTodos_ParamsSpec.$.structSpec && mojo.internal.bindings.browser.context_hub.mojom.PageHandler_GenerateAutoTodos_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.browser.context_hub.mojom.PageHandler_GenerateAutoTodos_ParamsSpec.$ = {};
mojo.internal.bindings.browser.context_hub.mojom.PageHandler_GenerateAutoTodos_ResponseParamsSpec = mojo.internal.bindings.browser.context_hub.mojom.PageHandler_GenerateAutoTodos_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.browser.context_hub.mojom.PageHandler_GenerateAutoTodos_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.browser.context_hub.mojom.PageHandler_GenerateAutoTodos_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.browser.context_hub.mojom.PageHandler_GenerateAutoTodos_ResponseParamsSpec.$ = {};
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.browser.context_hub.mojom.PageHandler_GenerateAutoTodos_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.generateAutoTodos');
          const result = this.impl.generateAutoTodos();
          const expectsResponse = header.expectsResponse || (header.flags & 1);
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              const val = (response && typeof response === 'object' && 'arg_todos' in response) ? response['arg_todos'] : response;
              const resp_obj = { 'arg_todos': val };
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.browser.context_hub.mojom.PageHandler_GenerateAutoTodos_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
            }).catch(e => console.error('[GeneratedReceiver] generateAutoTodos FAILED:', e));
          }
          break;
        }
        case 1: {
...
mojo.internal.Struct(
    mojo.internal.bindings.browser.context_hub.mojom.PageHandler_GenerateAutoTodos_ParamsSpec, 'browser.context_hub.mojom.PageHandler_GenerateAutoTodos_Params', [
    ],
    [[0, 8]]);

mojo.internal.Struct(
    mojo.internal.bindings.browser.context_hub.mojom.PageHandler_GenerateAutoTodos_ResponseParamsSpec, 'browser.context_hub.mojom.PageHandler_GenerateAutoTodos_ResponseParams', [
      mojo.internal.StructField('arg_todos', 0, 0, mojo.internal.Array(mojo.internal.bindings.browser.context_hub.mojom.AutoTodoItemSpec, false), null, true, 0, undefined),
    ],
    [[0, 16]]);
