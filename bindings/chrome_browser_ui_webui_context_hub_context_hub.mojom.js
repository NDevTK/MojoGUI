...
mojo.internal.bindings.browser.context_hub.mojom.TabClusterSpec = mojo.internal.bindings.browser.context_hub.mojom.TabClusterSpec || { $: {} };
if (mojo.internal.bindings.browser.context_hub.mojom.TabClusterSpec.$.structSpec && mojo.internal.bindings.browser.context_hub.mojom.TabClusterSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.browser.context_hub.mojom.TabClusterSpec.$ = {};
...
mojo.internal.bindings.browser.context_hub.mojom.PageHandler_ClusterTabs_ParamsSpec = mojo.internal.bindings.browser.context_hub.mojom.PageHandler_ClusterTabs_ParamsSpec || { $: {} };
if (mojo.internal.bindings.browser.context_hub.mojom.PageHandler_ClusterTabs_ParamsSpec.$.structSpec && mojo.internal.bindings.browser.context_hub.mojom.PageHandler_ClusterTabs_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.browser.context_hub.mojom.PageHandler_ClusterTabs_ParamsSpec.$ = {};
mojo.internal.bindings.browser.context_hub.mojom.PageHandler_ClusterTabs_ResponseParamsSpec = mojo.internal.bindings.browser.context_hub.mojom.PageHandler_ClusterTabs_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.browser.context_hub.mojom.PageHandler_ClusterTabs_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.browser.context_hub.mojom.PageHandler_ClusterTabs_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.browser.context_hub.mojom.PageHandler_ClusterTabs_ResponseParamsSpec.$ = {};
...
mojo.internal.bindings.browser.context_hub.mojom.PageHandlerRemoteCallHandler = class {
  ...
  clusterTabs() {
    return this.proxy.sendMessage(
      ...
      mojo.internal.bindings.browser.context_hub.mojom.PageHandler_ClusterTabs_ParamsSpec,
      mojo.internal.bindings.browser.context_hub.mojom.PageHandler_ClusterTabs_ResponseParamsSpec,
      [],
      false);
  }
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        ...
        case 4: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.browser.context_hub.mojom.PageHandler_ClusterTabs_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.clusterTabs');
          const result = this.impl.clusterTabs();
          const expectsResponse = header.expectsResponse || (header.flags & 1);
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              const resp_obj = response;
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.browser.context_hub.mojom.PageHandler_ClusterTabs_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
            }).catch(e => console.error('[GeneratedReceiver] clusterTabs FAILED:', e));
          }
          break;
        }
        case 5: {
...
mojo.internal.Struct(
    mojo.internal.bindings.browser.context_hub.mojom.AutoTodoItemSpec, 'browser.context_hub.mojom.AutoTodoItem', [
      ...
      mojo.internal.StructField('arg_source_references', 16, 0, mojo.internal.Array(mojo.internal.bindings.browser.context_hub.mojom.SourceReferenceSpec, false), null, false, 0, undefined),
    ],
    [[0, 32]]);
...
// Struct: TabCluster
mojo.internal.Struct(
    mojo.internal.bindings.browser.context_hub.mojom.TabClusterSpec, 'browser.context_hub.mojom.TabCluster', [
      mojo.internal.StructField('arg_label', 0, 0, mojo.internal.String, null, false, 0, undefined),
      mojo.internal.StructField('arg_tab_ids', 8, 0, mojo.internal.Array(mojo.internal.Int32, false), null, false, 0, undefined),
    ],
    [[0, 24]]);
mojo.internal.Struct(
...
mojo.internal.Struct(
    mojo.internal.bindings.browser.context_hub.mojom.PageHandler_ClusterTabs_ParamsSpec, 'browser.context_hub.mojom.PageHandler_ClusterTabs_Params', [
    ],
    [[0, 8]]);

mojo.internal.Struct(
    mojo.internal.bindings.browser.context_hub.mojom.PageHandler_ClusterTabs_ResponseParamsSpec, 'browser.context_hub.mojom.PageHandler_ClusterTabs_ResponseParams', [
      mojo.internal.StructField('arg_clusters', 0, 0, mojo.internal.Array(mojo.internal.bindings.browser.context_hub.mojom.TabClusterSpec, false), null, false, 0, undefined),
      mojo.internal.StructField('arg_ungrouped_tab_ids', 8, 0, mojo.internal.Array(mojo.internal.Int32, false), null, false, 0, undefined),
    ],
    [[0, 24]]);
