...
mojo.internal.bindings.browser.context_hub.mojom.PageHandlerRemote = class {
  ...
  askGeminiWithContext(arg_user_command, arg_memory_bank_entry_ids) {
    return this.$.askGeminiWithContext(arg_user_command, arg_memory_bank_entry_ids);
  }
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        ...
        case 24: {
          ...
          const result = this.impl.askGeminiWithContext(params.arg_user_command, params.arg_memory_bank_entry_ids);
          const expectsResponse = header.expectsResponse || (header.flags & 1);
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
