...
ash.quick_pair.mojom.FastPairDataParser_ParseDecryptedResponse_ResponseParamsSpec = {
  $: {
    structSpec: {
      ...
      packedSize: 16,
      fields: [
        { name: 'response', packedOffset: 0, packedBitOffset: 0, type: ash.quick_pair.mojom.DecryptedResponseSpec, nullable: true },
      ],
      versions: [{version: 0}]
    }
  }
...
ash.quick_pair.mojom.FastPairDataParser_ParseDecryptedPasskey_ResponseParamsSpec = {
  $: {
    structSpec: {
      ...
      packedSize: 16,
      fields: [
        { name: 'passkey', packedOffset: 0, packedBitOffset: 0, type: ash.quick_pair.mojom.DecryptedPasskeySpec, nullable: true },
      ],
      versions: [{version: 0}]
    }
  }
...
ash.quick_pair.mojom.FastPairDataParser_ParseNotDiscoverableAdvertisement_ResponseParamsSpec = {
  $: {
    structSpec: {
      ...
      packedSize: 16,
      fields: [
        { name: 'advertisement', packedOffset: 0, packedBitOffset: 0, type: ash.quick_pair.mojom.NotDiscoverableAdvertisementSpec, nullable: true },
      ],
      versions: [{version: 0}]
    }
  }
