...
mojo.internal.bindings.ash.quick_pair = mojo.internal.bindings.ash.quick_pair || {};
mojo.internal.bindings.ash.quick_pair.mojom = mojo.internal.bindings.ash.quick_pair.mojom || {};
mojo.internal.bindings.ash.quick_pair.mojom.MessageStreamMessageSpec = mojo.internal.bindings.ash.quick_pair.mojom.MessageStreamMessageSpec || { $: mojo.internal.OpaqueStruct.$ };
...
mojo.internal.Struct(
    mojo.internal.bindings.ash.quick_pair.mojom.DecryptedResponseSpec, 'ash.quick_pair.mojom.DecryptedResponse', [
      ...
      mojo.internal.StructField('arg_secondary_address_bytes', 16, 0, mojo.internal.Array(mojo.internal.Uint8, false), null, true, 0, undefined),
      mojo.internal.StructField('arg_message_type', 24, 0, mojo.internal.bindings.ash.quick_pair.mojom.MessageTypeSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_flags_$flag', 28, 0, mojo.internal.Bool, false, false, 0, { isPrimary: true, linkedValueFieldName: 'arg_flags_$value', originalFieldName: 'arg_flags' }),
      mojo.internal.StructField('arg_flags_$value', 29, 0, mojo.internal.Uint8, 0, false, 0, { isPrimary: false, linkedValueFieldName: 'arg_flags_$flag', originalFieldName: 'arg_flags' }),
      mojo.internal.StructField('arg_num_addresses_$flag', 30, 0, mojo.internal.Bool, false, false, 0, { isPrimary: true, linkedValueFieldName: 'arg_num_addresses_$value', originalFieldName: 'arg_num_addresses' }),
      mojo.internal.StructField('arg_num_addresses_$value', 31, 0, mojo.internal.Uint8, 0, false, 0, { isPrimary: false, linkedValueFieldName: 'arg_num_addresses_$flag', originalFieldName: 'arg_num_addresses' }),
    ],
    [[0, 40]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.ash.quick_pair.mojom.DecryptedPasskeySpec, 'ash.quick_pair.mojom.DecryptedPasskey', [
      ...
      mojo.internal.StructField('arg_message_type', 8, 0, mojo.internal.bindings.ash.quick_pair.mojom.MessageTypeSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_passkey', 12, 0, mojo.internal.Uint32, 0, false, 0, undefined),
    ],
    [[0, 24]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.ash.quick_pair.mojom.AcknowledgementMessageSpec, 'ash.quick_pair.mojom.AcknowledgementMessage', [
      ...
      mojo.internal.StructField('arg_action_message_group', 4, 0, mojo.internal.bindings.ash.quick_pair.mojom.MessageGroupSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_action_message_code', 8, 0, mojo.internal.Uint8, 0, false, 0, undefined),
    ],
    [[0, 24]]);
...
mojo.internal.bindings.ash.quick_pair.mojom.FastPairDataParserRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('ash.quick_pair.mojom.FastPairDataParser', [
      { explicit: null },
      { explicit: null },
      { explicit: null },
      { explicit: null },
...
mojo.internal.bindings.ash.quick_pair.mojom.FastPairDataParserReceiver = class {
  constructor(impl) {
    ...
    const ordinals = window.mojoScrambler.getOrdinals('ash.quick_pair.mojom.FastPairDataParser', [
      { explicit: null },
      { explicit: null },
      { explicit: null },
      { explicit: null },
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ash.quick_pair.mojom.FastPairDataParser_GetHexModelIdFromServiceData_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for GetHexModelIdFromServiceData failed with TypeError');
           }
        }
        // Try Method 1: ParseDecryptedResponse
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ash.quick_pair.mojom.FastPairDataParser_ParseDecryptedResponse_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for ParseDecryptedResponse failed with TypeError');
           }
        }
        // Try Method 2: ParseDecryptedPasskey
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ash.quick_pair.mojom.FastPairDataParser_ParseDecryptedPasskey_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for ParseDecryptedPasskey failed with TypeError');
           }
        }
        // Try Method 3: ParseNotDiscoverableAdvertisement
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ash.quick_pair.mojom.FastPairDataParser_ParseNotDiscoverableAdvertisement_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for ParseNotDiscoverableAdvertisement failed with TypeError');
           }
        }
        // Try Method 4: ParseMessageStreamMessages
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ash.quick_pair.mojom.FastPairDataParser_ParseMessageStreamMessages_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for ParseMessageStreamMessages failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
