...
cros.mojom.CameraAppDeviceProvider_GetCameraAppDevice_ResponseParamsSpec = {
  $: {
    structSpec: {
      ...
      packedSize: 24,
      fields: [
        { name: 'status', packedOffset: 0, packedBitOffset: 0, type: cros.mojom.GetCameraAppDeviceStatusSpec, nullable: false },
...
cros.mojom.CameraAppDevice_SetFpsRange_ParamsSpec = {
  $: {
    structSpec: {
      ...
      packedSize: 16,
      fields: [
        { name: 'fps_range', packedOffset: 0, packedBitOffset: 0, type: gfx.mojom.RangeSpec, nullable: false },
      ],
      versions: [{version: 0}]
    }
  }
...
cros.mojom.CameraAppDevice_SetStillCaptureResolution_ParamsSpec = {
  $: {
    structSpec: {
      ...
      packedSize: 16,
      fields: [
        { name: 'resolution', packedOffset: 0, packedBitOffset: 0, type: gfx.mojom.SizeSpec, nullable: false },
      ],
      versions: [{version: 0}]
    }
  }
...
cros.mojom.CameraAppDevice_SetCaptureIntent_ParamsSpec = {
  $: {
    structSpec: {
      ...
      packedSize: 16,
      fields: [
        { name: 'intent', packedOffset: 0, packedBitOffset: 0, type: cros.mojom.CaptureIntentSpec, nullable: false },
      ],
      versions: [{version: 0}]
    }
  }
...
cros.mojom.CameraAppDevice_SetCropRegion_ParamsSpec = {
  $: {
    structSpec: {
      ...
      packedSize: 16,
      fields: [
        { name: 'crop_region', packedOffset: 0, packedBitOffset: 0, type: gfx.mojom.RectSpec, nullable: false },
      ],
      versions: [{version: 0}]
    }
  }
