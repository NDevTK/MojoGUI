...
mojo.internal.bindings.tab_search.mojom.TabOrganizationStateSpec = mojo.internal.bindings.tab_search.mojom.TabOrganizationStateSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.tab_search.mojom.TabOrganizationFeatureSpec = mojo.internal.bindings.tab_search.mojom.TabOrganizationFeatureSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.tab_search.mojom.TabOrganizationErrorSpec = mojo.internal.bindings.tab_search.mojom.TabOrganizationErrorSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.tab_search.mojom.TabOrganizationModelStrategySpec = mojo.internal.bindings.tab_search.mojom.TabOrganizationModelStrategySpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.tab_search.mojom.TabSearchSectionSpec = mojo.internal.bindings.tab_search.mojom.TabSearchSectionSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.tab_search.mojom.UserFeedbackSpec = mojo.internal.bindings.tab_search.mojom.UserFeedbackSpec || { $: mojo.internal.Enum().$ };
...
mojo.internal.bindings.tab_search.mojom.TabOrganizationSpec = mojo.internal.bindings.tab_search.mojom.TabOrganizationSpec || { $: {} };
if (mojo.internal.bindings.tab_search.mojom.TabOrganizationSpec.$.structSpec && mojo.internal.bindings.tab_search.mojom.TabOrganizationSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.tab_search.mojom.TabOrganizationSpec.$ = {};
mojo.internal.bindings.tab_search.mojom.TabOrganizationSessionSpec = mojo.internal.bindings.tab_search.mojom.TabOrganizationSessionSpec || { $: {} };
if (mojo.internal.bindings.tab_search.mojom.TabOrganizationSessionSpec.$.structSpec && mojo.internal.bindings.tab_search.mojom.TabOrganizationSessionSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.tab_search.mojom.TabOrganizationSessionSpec.$ = {};
...
mojo.internal.bindings.tab_search.mojom.UnusedTabInfoSpec = mojo.internal.bindings.tab_search.mojom.UnusedTabInfoSpec || { $: {} };
if (mojo.internal.bindings.tab_search.mojom.UnusedTabInfoSpec.$.structSpec && mojo.internal.bindings.tab_search.mojom.UnusedTabInfoSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.tab_search.mojom.UnusedTabInfoSpec.$ = {};
...
mojo.internal.bindings.tab_search.mojom.PageHandler_DeclutterTabs_ParamsSpec = mojo.internal.bindings.tab_search.mojom.PageHandler_DeclutterTabs_ParamsSpec || { $: {} };
if (mojo.internal.bindings.tab_search.mojom.PageHandler_DeclutterTabs_ParamsSpec.$.structSpec && mojo.internal.bindings.tab_search.mojom.PageHandler_DeclutterTabs_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.tab_search.mojom.PageHandler_DeclutterTabs_ParamsSpec.$ = {};
mojo.internal.bindings.tab_search.mojom.PageHandler_AcceptTabOrganization_ParamsSpec = mojo.internal.bindings.tab_search.mojom.PageHandler_AcceptTabOrganization_ParamsSpec || { $: {} };
if (mojo.internal.bindings.tab_search.mojom.PageHandler_AcceptTabOrganization_ParamsSpec.$.structSpec && mojo.internal.bindings.tab_search.mojom.PageHandler_AcceptTabOrganization_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.tab_search.mojom.PageHandler_AcceptTabOrganization_ParamsSpec.$ = {};
mojo.internal.bindings.tab_search.mojom.PageHandler_RejectTabOrganization_ParamsSpec = mojo.internal.bindings.tab_search.mojom.PageHandler_RejectTabOrganization_ParamsSpec || { $: {} };
if (mojo.internal.bindings.tab_search.mojom.PageHandler_RejectTabOrganization_ParamsSpec.$.structSpec && mojo.internal.bindings.tab_search.mojom.PageHandler_RejectTabOrganization_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.tab_search.mojom.PageHandler_RejectTabOrganization_ParamsSpec.$ = {};
mojo.internal.bindings.tab_search.mojom.PageHandler_RenameTabOrganization_ParamsSpec = mojo.internal.bindings.tab_search.mojom.PageHandler_RenameTabOrganization_ParamsSpec || { $: {} };
if (mojo.internal.bindings.tab_search.mojom.PageHandler_RenameTabOrganization_ParamsSpec.$.structSpec && mojo.internal.bindings.tab_search.mojom.PageHandler_RenameTabOrganization_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.tab_search.mojom.PageHandler_RenameTabOrganization_ParamsSpec.$ = {};
mojo.internal.bindings.tab_search.mojom.PageHandler_ExcludeFromStaleTabs_ParamsSpec = mojo.internal.bindings.tab_search.mojom.PageHandler_ExcludeFromStaleTabs_ParamsSpec || { $: {} };
if (mojo.internal.bindings.tab_search.mojom.PageHandler_ExcludeFromStaleTabs_ParamsSpec.$.structSpec && mojo.internal.bindings.tab_search.mojom.PageHandler_ExcludeFromStaleTabs_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.tab_search.mojom.PageHandler_ExcludeFromStaleTabs_ParamsSpec.$ = {};
mojo.internal.bindings.tab_search.mojom.PageHandler_ExcludeFromDuplicateTabs_ParamsSpec = mojo.internal.bindings.tab_search.mojom.PageHandler_ExcludeFromDuplicateTabs_ParamsSpec || { $: {} };
if (mojo.internal.bindings.tab_search.mojom.PageHandler_ExcludeFromDuplicateTabs_ParamsSpec.$.structSpec && mojo.internal.bindings.tab_search.mojom.PageHandler_ExcludeFromDuplicateTabs_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.tab_search.mojom.PageHandler_ExcludeFromDuplicateTabs_ParamsSpec.$ = {};
...
mojo.internal.bindings.tab_search.mojom.PageHandler_GetUnusedTabs_ParamsSpec = mojo.internal.bindings.tab_search.mojom.PageHandler_GetUnusedTabs_ParamsSpec || { $: {} };
if (mojo.internal.bindings.tab_search.mojom.PageHandler_GetUnusedTabs_ParamsSpec.$.structSpec && mojo.internal.bindings.tab_search.mojom.PageHandler_GetUnusedTabs_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.tab_search.mojom.PageHandler_GetUnusedTabs_ParamsSpec.$ = {};
mojo.internal.bindings.tab_search.mojom.PageHandler_GetUnusedTabs_ResponseParamsSpec = mojo.internal.bindings.tab_search.mojom.PageHandler_GetUnusedTabs_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.tab_search.mojom.PageHandler_GetUnusedTabs_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.tab_search.mojom.PageHandler_GetUnusedTabs_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.tab_search.mojom.PageHandler_GetUnusedTabs_ResponseParamsSpec.$ = {};
mojo.internal.bindings.tab_search.mojom.PageHandler_GetTabSearchSection_ParamsSpec = mojo.internal.bindings.tab_search.mojom.PageHandler_GetTabSearchSection_ParamsSpec || { $: {} };
if (mojo.internal.bindings.tab_search.mojom.PageHandler_GetTabSearchSection_ParamsSpec.$.structSpec && mojo.internal.bindings.tab_search.mojom.PageHandler_GetTabSearchSection_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.tab_search.mojom.PageHandler_GetTabSearchSection_ParamsSpec.$ = {};
mojo.internal.bindings.tab_search.mojom.PageHandler_GetTabSearchSection_ResponseParamsSpec = mojo.internal.bindings.tab_search.mojom.PageHandler_GetTabSearchSection_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.tab_search.mojom.PageHandler_GetTabSearchSection_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.tab_search.mojom.PageHandler_GetTabSearchSection_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.tab_search.mojom.PageHandler_GetTabSearchSection_ResponseParamsSpec.$ = {};
mojo.internal.bindings.tab_search.mojom.PageHandler_GetTabOrganizationFeature_ParamsSpec = mojo.internal.bindings.tab_search.mojom.PageHandler_GetTabOrganizationFeature_ParamsSpec || { $: {} };
if (mojo.internal.bindings.tab_search.mojom.PageHandler_GetTabOrganizationFeature_ParamsSpec.$.structSpec && mojo.internal.bindings.tab_search.mojom.PageHandler_GetTabOrganizationFeature_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.tab_search.mojom.PageHandler_GetTabOrganizationFeature_ParamsSpec.$ = {};
mojo.internal.bindings.tab_search.mojom.PageHandler_GetTabOrganizationFeature_ResponseParamsSpec = mojo.internal.bindings.tab_search.mojom.PageHandler_GetTabOrganizationFeature_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.tab_search.mojom.PageHandler_GetTabOrganizationFeature_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.tab_search.mojom.PageHandler_GetTabOrganizationFeature_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.tab_search.mojom.PageHandler_GetTabOrganizationFeature_ResponseParamsSpec.$ = {};
mojo.internal.bindings.tab_search.mojom.PageHandler_GetTabOrganizationSession_ParamsSpec = mojo.internal.bindings.tab_search.mojom.PageHandler_GetTabOrganizationSession_ParamsSpec || { $: {} };
if (mojo.internal.bindings.tab_search.mojom.PageHandler_GetTabOrganizationSession_ParamsSpec.$.structSpec && mojo.internal.bindings.tab_search.mojom.PageHandler_GetTabOrganizationSession_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.tab_search.mojom.PageHandler_GetTabOrganizationSession_ParamsSpec.$ = {};
mojo.internal.bindings.tab_search.mojom.PageHandler_GetTabOrganizationSession_ResponseParamsSpec = mojo.internal.bindings.tab_search.mojom.PageHandler_GetTabOrganizationSession_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.tab_search.mojom.PageHandler_GetTabOrganizationSession_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.tab_search.mojom.PageHandler_GetTabOrganizationSession_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.tab_search.mojom.PageHandler_GetTabOrganizationSession_ResponseParamsSpec.$ = {};
mojo.internal.bindings.tab_search.mojom.PageHandler_GetTabOrganizationModelStrategy_ParamsSpec = mojo.internal.bindings.tab_search.mojom.PageHandler_GetTabOrganizationModelStrategy_ParamsSpec || { $: {} };
if (mojo.internal.bindings.tab_search.mojom.PageHandler_GetTabOrganizationModelStrategy_ParamsSpec.$.structSpec && mojo.internal.bindings.tab_search.mojom.PageHandler_GetTabOrganizationModelStrategy_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.tab_search.mojom.PageHandler_GetTabOrganizationModelStrategy_ParamsSpec.$ = {};
mojo.internal.bindings.tab_search.mojom.PageHandler_GetTabOrganizationModelStrategy_ResponseParamsSpec = mojo.internal.bindings.tab_search.mojom.PageHandler_GetTabOrganizationModelStrategy_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.tab_search.mojom.PageHandler_GetTabOrganizationModelStrategy_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.tab_search.mojom.PageHandler_GetTabOrganizationModelStrategy_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.tab_search.mojom.PageHandler_GetTabOrganizationModelStrategy_ResponseParamsSpec.$ = {};
...
mojo.internal.bindings.tab_search.mojom.PageHandler_RequestTabOrganization_ParamsSpec = mojo.internal.bindings.tab_search.mojom.PageHandler_RequestTabOrganization_ParamsSpec || { $: {} };
if (mojo.internal.bindings.tab_search.mojom.PageHandler_RequestTabOrganization_ParamsSpec.$.structSpec && mojo.internal.bindings.tab_search.mojom.PageHandler_RequestTabOrganization_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.tab_search.mojom.PageHandler_RequestTabOrganization_ParamsSpec.$ = {};
mojo.internal.bindings.tab_search.mojom.PageHandler_RemoveTabFromOrganization_ParamsSpec = mojo.internal.bindings.tab_search.mojom.PageHandler_RemoveTabFromOrganization_ParamsSpec || { $: {} };
if (mojo.internal.bindings.tab_search.mojom.PageHandler_RemoveTabFromOrganization_ParamsSpec.$.structSpec && mojo.internal.bindings.tab_search.mojom.PageHandler_RemoveTabFromOrganization_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.tab_search.mojom.PageHandler_RemoveTabFromOrganization_ParamsSpec.$ = {};
mojo.internal.bindings.tab_search.mojom.PageHandler_RejectSession_ParamsSpec = mojo.internal.bindings.tab_search.mojom.PageHandler_RejectSession_ParamsSpec || { $: {} };
if (mojo.internal.bindings.tab_search.mojom.PageHandler_RejectSession_ParamsSpec.$.structSpec && mojo.internal.bindings.tab_search.mojom.PageHandler_RejectSession_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.tab_search.mojom.PageHandler_RejectSession_ParamsSpec.$ = {};
...
mojo.internal.bindings.tab_search.mojom.PageHandler_RestartSession_ParamsSpec = mojo.internal.bindings.tab_search.mojom.PageHandler_RestartSession_ParamsSpec || { $: {} };
if (mojo.internal.bindings.tab_search.mojom.PageHandler_RestartSession_ParamsSpec.$.structSpec && mojo.internal.bindings.tab_search.mojom.PageHandler_RestartSession_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.tab_search.mojom.PageHandler_RestartSession_ParamsSpec.$ = {};
...
mojo.internal.bindings.tab_search.mojom.PageHandler_SetOrganizationFeature_ParamsSpec = mojo.internal.bindings.tab_search.mojom.PageHandler_SetOrganizationFeature_ParamsSpec || { $: {} };
if (mojo.internal.bindings.tab_search.mojom.PageHandler_SetOrganizationFeature_ParamsSpec.$.structSpec && mojo.internal.bindings.tab_search.mojom.PageHandler_SetOrganizationFeature_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.tab_search.mojom.PageHandler_SetOrganizationFeature_ParamsSpec.$ = {};
...
mojo.internal.bindings.tab_search.mojom.PageHandler_TriggerFeedback_ParamsSpec = mojo.internal.bindings.tab_search.mojom.PageHandler_TriggerFeedback_ParamsSpec || { $: {} };
if (mojo.internal.bindings.tab_search.mojom.PageHandler_TriggerFeedback_ParamsSpec.$.structSpec && mojo.internal.bindings.tab_search.mojom.PageHandler_TriggerFeedback_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.tab_search.mojom.PageHandler_TriggerFeedback_ParamsSpec.$ = {};
mojo.internal.bindings.tab_search.mojom.PageHandler_TriggerSignIn_ParamsSpec = mojo.internal.bindings.tab_search.mojom.PageHandler_TriggerSignIn_ParamsSpec || { $: {} };
if (mojo.internal.bindings.tab_search.mojom.PageHandler_TriggerSignIn_ParamsSpec.$.structSpec && mojo.internal.bindings.tab_search.mojom.PageHandler_TriggerSignIn_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.tab_search.mojom.PageHandler_TriggerSignIn_ParamsSpec.$ = {};
mojo.internal.bindings.tab_search.mojom.PageHandler_OpenHelpPage_ParamsSpec = mojo.internal.bindings.tab_search.mojom.PageHandler_OpenHelpPage_ParamsSpec || { $: {} };
if (mojo.internal.bindings.tab_search.mojom.PageHandler_OpenHelpPage_ParamsSpec.$.structSpec && mojo.internal.bindings.tab_search.mojom.PageHandler_OpenHelpPage_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.tab_search.mojom.PageHandler_OpenHelpPage_ParamsSpec.$ = {};
mojo.internal.bindings.tab_search.mojom.PageHandler_SetTabOrganizationModelStrategy_ParamsSpec = mojo.internal.bindings.tab_search.mojom.PageHandler_SetTabOrganizationModelStrategy_ParamsSpec || { $: {} };
if (mojo.internal.bindings.tab_search.mojom.PageHandler_SetTabOrganizationModelStrategy_ParamsSpec.$.structSpec && mojo.internal.bindings.tab_search.mojom.PageHandler_SetTabOrganizationModelStrategy_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.tab_search.mojom.PageHandler_SetTabOrganizationModelStrategy_ParamsSpec.$ = {};
mojo.internal.bindings.tab_search.mojom.PageHandler_SetTabOrganizationUserInstruction_ParamsSpec = mojo.internal.bindings.tab_search.mojom.PageHandler_SetTabOrganizationUserInstruction_ParamsSpec || { $: {} };
if (mojo.internal.bindings.tab_search.mojom.PageHandler_SetTabOrganizationUserInstruction_ParamsSpec.$.structSpec && mojo.internal.bindings.tab_search.mojom.PageHandler_SetTabOrganizationUserInstruction_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.tab_search.mojom.PageHandler_SetTabOrganizationUserInstruction_ParamsSpec.$ = {};
mojo.internal.bindings.tab_search.mojom.PageHandler_SetUserFeedback_ParamsSpec = mojo.internal.bindings.tab_search.mojom.PageHandler_SetUserFeedback_ParamsSpec || { $: {} };
if (mojo.internal.bindings.tab_search.mojom.PageHandler_SetUserFeedback_ParamsSpec.$.structSpec && mojo.internal.bindings.tab_search.mojom.PageHandler_SetUserFeedback_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.tab_search.mojom.PageHandler_SetUserFeedback_ParamsSpec.$ = {};
mojo.internal.bindings.tab_search.mojom.PageHandler_NotifyOrganizationUIReadyToShow_ParamsSpec = mojo.internal.bindings.tab_search.mojom.PageHandler_NotifyOrganizationUIReadyToShow_ParamsSpec || { $: {} };
if (mojo.internal.bindings.tab_search.mojom.PageHandler_NotifyOrganizationUIReadyToShow_ParamsSpec.$.structSpec && mojo.internal.bindings.tab_search.mojom.PageHandler_NotifyOrganizationUIReadyToShow_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.tab_search.mojom.PageHandler_NotifyOrganizationUIReadyToShow_ParamsSpec.$ = {};
mojo.internal.bindings.tab_search.mojom.PageHandler_NotifySearchUIReadyToShow_ParamsSpec = mojo.internal.bindings.tab_search.mojom.PageHandler_NotifySearchUIReadyToShow_ParamsSpec || { $: {} };
if (mojo.internal.bindings.tab_search.mojom.PageHandler_NotifySearchUIReadyToShow_ParamsSpec.$.structSpec && mojo.internal.bindings.tab_search.mojom.PageHandler_NotifySearchUIReadyToShow_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.tab_search.mojom.PageHandler_NotifySearchUIReadyToShow_ParamsSpec.$ = {};
...
mojo.internal.bindings.tab_search.mojom.Page_TabOrganizationSessionUpdated_ParamsSpec = mojo.internal.bindings.tab_search.mojom.Page_TabOrganizationSessionUpdated_ParamsSpec || { $: {} };
if (mojo.internal.bindings.tab_search.mojom.Page_TabOrganizationSessionUpdated_ParamsSpec.$.structSpec && mojo.internal.bindings.tab_search.mojom.Page_TabOrganizationSessionUpdated_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.tab_search.mojom.Page_TabOrganizationSessionUpdated_ParamsSpec.$ = {};
mojo.internal.bindings.tab_search.mojom.Page_TabOrganizationModelStrategyUpdated_ParamsSpec = mojo.internal.bindings.tab_search.mojom.Page_TabOrganizationModelStrategyUpdated_ParamsSpec || { $: {} };
if (mojo.internal.bindings.tab_search.mojom.Page_TabOrganizationModelStrategyUpdated_ParamsSpec.$.structSpec && mojo.internal.bindings.tab_search.mojom.Page_TabOrganizationModelStrategyUpdated_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.tab_search.mojom.Page_TabOrganizationModelStrategyUpdated_ParamsSpec.$ = {};
...
mojo.internal.bindings.tab_search.mojom.Page_TabSearchSectionChanged_ParamsSpec = mojo.internal.bindings.tab_search.mojom.Page_TabSearchSectionChanged_ParamsSpec || { $: {} };
if (mojo.internal.bindings.tab_search.mojom.Page_TabSearchSectionChanged_ParamsSpec.$.structSpec && mojo.internal.bindings.tab_search.mojom.Page_TabSearchSectionChanged_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.tab_search.mojom.Page_TabSearchSectionChanged_ParamsSpec.$ = {};
mojo.internal.bindings.tab_search.mojom.Page_TabOrganizationFeatureChanged_ParamsSpec = mojo.internal.bindings.tab_search.mojom.Page_TabOrganizationFeatureChanged_ParamsSpec || { $: {} };
if (mojo.internal.bindings.tab_search.mojom.Page_TabOrganizationFeatureChanged_ParamsSpec.$.structSpec && mojo.internal.bindings.tab_search.mojom.Page_TabOrganizationFeatureChanged_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.tab_search.mojom.Page_TabOrganizationFeatureChanged_ParamsSpec.$ = {};
mojo.internal.bindings.tab_search.mojom.Page_ShowFREChanged_ParamsSpec = mojo.internal.bindings.tab_search.mojom.Page_ShowFREChanged_ParamsSpec || { $: {} };
if (mojo.internal.bindings.tab_search.mojom.Page_ShowFREChanged_ParamsSpec.$.structSpec && mojo.internal.bindings.tab_search.mojom.Page_ShowFREChanged_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.tab_search.mojom.Page_ShowFREChanged_ParamsSpec.$ = {};
mojo.internal.bindings.tab_search.mojom.Page_TabOrganizationEnabledChanged_ParamsSpec = mojo.internal.bindings.tab_search.mojom.Page_TabOrganizationEnabledChanged_ParamsSpec || { $: {} };
if (mojo.internal.bindings.tab_search.mojom.Page_TabOrganizationEnabledChanged_ParamsSpec.$.structSpec && mojo.internal.bindings.tab_search.mojom.Page_TabOrganizationEnabledChanged_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.tab_search.mojom.Page_TabOrganizationEnabledChanged_ParamsSpec.$ = {};
mojo.internal.bindings.tab_search.mojom.Page_UnusedTabsChanged_ParamsSpec = mojo.internal.bindings.tab_search.mojom.Page_UnusedTabsChanged_ParamsSpec || { $: {} };
if (mojo.internal.bindings.tab_search.mojom.Page_UnusedTabsChanged_ParamsSpec.$.structSpec && mojo.internal.bindings.tab_search.mojom.Page_UnusedTabsChanged_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.tab_search.mojom.Page_UnusedTabsChanged_ParamsSpec.$ = {};
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        ...
        case 10: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              const val = (response && typeof response === 'object' && 'arg_section' in response) ? response['arg_section'] : response;
        ...
        case 11: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              const val = (response && typeof response === 'object' && 'arg_feature' in response) ? response['arg_feature'] : response;
        ...
        case 13: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              const val = (response && typeof response === 'object' && 'arg_strategy' in response) ? response['arg_strategy'] : response;
