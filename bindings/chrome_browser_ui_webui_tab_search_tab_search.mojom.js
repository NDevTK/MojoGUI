...
mojo.internal.bindings.tab_search.mojom.PageHandler_GetRangesIgnoringCaseAndAccents_ParamsSpec = mojo.internal.bindings.tab_search.mojom.PageHandler_GetRangesIgnoringCaseAndAccents_ParamsSpec || { $: {} };
if (mojo.internal.bindings.tab_search.mojom.PageHandler_GetRangesIgnoringCaseAndAccents_ParamsSpec.$.structSpec && mojo.internal.bindings.tab_search.mojom.PageHandler_GetRangesIgnoringCaseAndAccents_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.tab_search.mojom.PageHandler_GetRangesIgnoringCaseAndAccents_ParamsSpec.$ = {};
mojo.internal.bindings.tab_search.mojom.PageHandler_GetRangesIgnoringCaseAndAccents_ResponseParamsSpec = mojo.internal.bindings.tab_search.mojom.PageHandler_GetRangesIgnoringCaseAndAccents_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.tab_search.mojom.PageHandler_GetRangesIgnoringCaseAndAccents_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.tab_search.mojom.PageHandler_GetRangesIgnoringCaseAndAccents_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.tab_search.mojom.PageHandler_GetRangesIgnoringCaseAndAccents_ResponseParamsSpec.$ = {};
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        ...
        case 11: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.tab_search.mojom.PageHandler_GetRangesIgnoringCaseAndAccents_ParamsSpec.$.structSpec);
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.tab_search.mojom.PageHandler_GetRangesIgnoringCaseAndAccents_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
...
mojo.internal.Struct(
    mojo.internal.bindings.tab_search.mojom.PageHandler_GetRangesIgnoringCaseAndAccents_ParamsSpec, 'tab_search.mojom.PageHandler_GetRangesIgnoringCaseAndAccents_Params', [
...
mojo.internal.Struct(
    mojo.internal.bindings.tab_search.mojom.PageHandler_GetRangesIgnoringCaseAndAccents_ResponseParamsSpec, 'tab_search.mojom.PageHandler_GetRangesIgnoringCaseAndAccents_ResponseParams', [
