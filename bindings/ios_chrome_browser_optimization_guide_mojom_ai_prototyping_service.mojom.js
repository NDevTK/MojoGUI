...
mojo.internal.bindings.ai.mojom.AIPrototypingServiceRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.ai.mojom.AIPrototypingServicePendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.ai.mojom.AIPrototypingServiceRemoteCallHandler(this.proxy);
  }
  ...
  executeServerQuery(arg_request) {
    return this.$.executeServerQuery(arg_request);
  }
  executeOnDeviceQuery(arg_request) {
    return this.$.executeOnDeviceQuery(arg_request);
  }
};

mojo.internal.bindings.ai.mojom.AIPrototypingServiceRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('ai.mojom.AIPrototypingService', [
      { explicit: null },
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.ai.mojom.AIPrototypingService.getRemote = function() {
  let remote = new mojo.internal.bindings.ai.mojom.AIPrototypingServiceRemote();
...
mojo.internal.bindings.ai.mojom.AIPrototypingServiceReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('ai.mojom.AIPrototypingService', [
      { explicit: null },
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.ai.mojom.AIPrototypingService_ExecuteServerQuery_ParamsSpec.$.structSpec);
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.ai.mojom.AIPrototypingService_ExecuteOnDeviceQuery_ParamsSpec.$.structSpec);
      ...
      switch (dispatchId) {
        case 0: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.ai.mojom.AIPrototypingService_ExecuteServerQuery_ResponseParamsSpec, header, rawHeader);
               responder(response);
        ...
        case 1: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              const rawHeader = (args[2] && args[2].slice) ? args[2].slice(0, header.headerSize) : null;
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.ai.mojom.AIPrototypingService_ExecuteOnDeviceQuery_ResponseParamsSpec, header, rawHeader);
               responder(response);
...
mojo.internal.bindings.ai.mojom.AIPrototypingServiceReceiver = mojo.internal.bindings.ai.mojom.AIPrototypingServiceReceiver;
