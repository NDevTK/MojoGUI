...
mojo.internal.bindings.searchbox.mojom.PageHandlerRemote = class {
  ...
  queryAutocomplete(arg_query_id, arg_input, arg_prevent_inline_autocomplete, arg_cursor_position, arg_suggest_inventory, arg_is_on_focus) {
    return this.$.queryAutocomplete(arg_query_id, arg_input, arg_prevent_inline_autocomplete, arg_cursor_position, arg_suggest_inventory, arg_is_on_focus);
  }
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        ...
        case 1: {
          ...
          const result = this.impl.queryAutocomplete(params.arg_query_id, params.arg_input, params.arg_prevent_inline_autocomplete, params.arg_cursor_position, params.arg_suggest_inventory, params.arg_is_on_focus);
          break;
        }
        case 2: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
