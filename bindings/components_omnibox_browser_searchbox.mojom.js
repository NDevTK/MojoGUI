...
mojo.internal.bindings.searchbox.mojom.PageHandler_AddDriveContext_ParamsSpec = mojo.internal.bindings.searchbox.mojom.PageHandler_AddDriveContext_ParamsSpec || { $: {} };
if (mojo.internal.bindings.searchbox.mojom.PageHandler_AddDriveContext_ParamsSpec.$.structSpec && mojo.internal.bindings.searchbox.mojom.PageHandler_AddDriveContext_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.searchbox.mojom.PageHandler_AddDriveContext_ParamsSpec.$ = {};
...
mojo.internal.bindings.searchbox.mojom.PageHandler_ShouldShowDriveDisclaimer_ParamsSpec = mojo.internal.bindings.searchbox.mojom.PageHandler_ShouldShowDriveDisclaimer_ParamsSpec || { $: {} };
if (mojo.internal.bindings.searchbox.mojom.PageHandler_ShouldShowDriveDisclaimer_ParamsSpec.$.structSpec && mojo.internal.bindings.searchbox.mojom.PageHandler_ShouldShowDriveDisclaimer_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.searchbox.mojom.PageHandler_ShouldShowDriveDisclaimer_ParamsSpec.$ = {};
mojo.internal.bindings.searchbox.mojom.PageHandler_ShouldShowDriveDisclaimer_ResponseParamsSpec = mojo.internal.bindings.searchbox.mojom.PageHandler_ShouldShowDriveDisclaimer_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.searchbox.mojom.PageHandler_ShouldShowDriveDisclaimer_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.searchbox.mojom.PageHandler_ShouldShowDriveDisclaimer_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.searchbox.mojom.PageHandler_ShouldShowDriveDisclaimer_ResponseParamsSpec.$ = {};
...
mojo.internal.bindings.searchbox.mojom.PageHandlerRemote = class {
  ...
  addDriveContext(arg_drive_id, arg_resource_key, arg_mime_type) {
    return this.$.addDriveContext(arg_drive_id, arg_resource_key, arg_mime_type);
  }
  ...
  shouldShowDriveDisclaimer() {
    return this.$.shouldShowDriveDisclaimer();
  }
...
mojo.internal.bindings.searchbox.mojom.PageHandlerRemoteCallHandler = class {
  ...
  addDriveContext(arg_drive_id, arg_resource_key, arg_mime_type) {
    return this.proxy.sendMessage(
      ...
      mojo.internal.bindings.searchbox.mojom.PageHandler_AddDriveContext_ParamsSpec,
      null,
      [arg_drive_id, arg_resource_key, arg_mime_type],
      false);
  }
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        ...
        case 19: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.searchbox.mojom.PageHandler_AddDriveContext_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.addDriveContext');
          const result = this.impl.addDriveContext(params.arg_drive_id, params.arg_resource_key, params.arg_mime_type);
          break;
        }
        case 20: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
        ...
        case 29: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.searchbox.mojom.PageHandler_ShouldShowDriveDisclaimer_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.shouldShowDriveDisclaimer');
          const result = this.impl.shouldShowDriveDisclaimer();
          const expectsResponse = header.expectsResponse || (header.flags & 1);
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              const val = (response && typeof response === 'object' && 'arg_should_show' in response) ? response['arg_should_show'] : response;
              const resp_obj = { 'arg_should_show': val };
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.searchbox.mojom.PageHandler_ShouldShowDriveDisclaimer_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
            }).catch(e => console.error('[GeneratedReceiver] shouldShowDriveDisclaimer FAILED:', e));
          }
          break;
        }
        case 30: {
...
mojo.internal.Struct(
    mojo.internal.bindings.searchbox.mojom.PageHandler_AddDriveContext_ParamsSpec, 'searchbox.mojom.PageHandler_AddDriveContext_Params', [
      mojo.internal.StructField('arg_drive_id', 0, 0, mojo.internal.String, null, false, 0, undefined),
      mojo.internal.StructField('arg_resource_key', 8, 0, mojo.internal.String, null, false, 0, undefined),
      mojo.internal.StructField('arg_mime_type', 16, 0, mojo.internal.String, null, false, 0, undefined),
    ],
    [[0, 32]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.searchbox.mojom.PageHandler_ShouldShowDriveDisclaimer_ParamsSpec, 'searchbox.mojom.PageHandler_ShouldShowDriveDisclaimer_Params', [
    ],
    [[0, 8]]);

mojo.internal.Struct(
    mojo.internal.bindings.searchbox.mojom.PageHandler_ShouldShowDriveDisclaimer_ResponseParamsSpec, 'searchbox.mojom.PageHandler_ShouldShowDriveDisclaimer_ResponseParams', [
