...
mojo.internal.bindings.searchbox.mojom.Page_SetShowFre_ParamsSpec = mojo.internal.bindings.searchbox.mojom.Page_SetShowFre_ParamsSpec || { $: {} };
if (mojo.internal.bindings.searchbox.mojom.Page_SetShowFre_ParamsSpec.$.structSpec && mojo.internal.bindings.searchbox.mojom.Page_SetShowFre_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.searchbox.mojom.Page_SetShowFre_ParamsSpec.$ = {};
...
mojo.internal.bindings.searchbox.mojom.PageRemote = class {
  ...
  setShowFre(arg_show) {
    return this.$.setShowFre(arg_show);
  }
...
mojo.internal.bindings.searchbox.mojom.PageRemoteCallHandler = class {
  ...
  setShowFre(arg_show) {
    return this.proxy.sendMessage(
      this.ordinals[0],  // ordinal
      mojo.internal.bindings.searchbox.mojom.Page_SetShowFre_ParamsSpec,
      null,
      [arg_show],
      false);
  }
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.searchbox.mojom.Page_SetShowFre_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.setShowFre');
          const result = this.impl.setShowFre(params.arg_show);
          break;
        }
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
...
mojo.internal.Struct(
    mojo.internal.bindings.searchbox.mojom.Page_SetShowFre_ParamsSpec, 'searchbox.mojom.Page_SetShowFre_Params', [
