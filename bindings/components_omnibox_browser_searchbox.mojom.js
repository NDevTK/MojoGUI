...
mojo.internal.bindings.searchbox.mojom.PageHandlerRemote = class {
  ...
  openPopupSelection(arg_selection, arg_disposition) {
    return this.$.openPopupSelection(arg_selection, arg_disposition);
  }
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        ...
        case 6: {
          ...
          const result = this.impl.openPopupSelection(params.arg_selection, params.arg_disposition);
          break;
        }
        case 7: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
