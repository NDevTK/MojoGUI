...
mojo.internal.bindings.searchbox.mojom.Page_ResetPopupToInitialState_ParamsSpec = mojo.internal.bindings.searchbox.mojom.Page_ResetPopupToInitialState_ParamsSpec || { $: {} };
if (mojo.internal.bindings.searchbox.mojom.Page_ResetPopupToInitialState_ParamsSpec.$.structSpec && mojo.internal.bindings.searchbox.mojom.Page_ResetPopupToInitialState_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.searchbox.mojom.Page_ResetPopupToInitialState_ParamsSpec.$ = {};
...
mojo.internal.bindings.searchbox.mojom.PageHandlerRemote = class {
  ...
  setActiveToolMode(arg_tool, arg_is_set_by_server) {
    return this.$.setActiveToolMode(arg_tool, arg_is_set_by_server);
  }
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        ...
        case 26: {
          ...
          const result = this.impl.setActiveToolMode(params.arg_tool, params.arg_is_set_by_server);
          break;
        }
        case 27: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
...
mojo.internal.bindings.searchbox.mojom.PageRemote = class {
  ...
  resetPopupToInitialState() {
    return this.$.resetPopupToInitialState();
  }
...
mojo.internal.bindings.searchbox.mojom.PageRemoteCallHandler = class {
  ...
  resetPopupToInitialState() {
    return this.proxy.sendMessage(
      this.ordinals[4],  // ordinal
      mojo.internal.bindings.searchbox.mojom.Page_ResetPopupToInitialState_ParamsSpec,
      null,
      [],
      false);
  }
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        ...
        case 4: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.searchbox.mojom.Page_ResetPopupToInitialState_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.resetPopupToInitialState');
          const result = this.impl.resetPopupToInitialState();
          break;
        }
        case 5: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
...
mojo.internal.Struct(
    mojo.internal.bindings.searchbox.mojom.AutocompleteMatchSpec, 'searchbox.mojom.AutocompleteMatch', [
      ...
      mojo.internal.StructField('arg_show_contextual_description', 1, 2, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_supports_deletion', 1, 3, mojo.internal.Bool, false, false, 0, undefined),
...
mojo.internal.Struct(
    mojo.internal.bindings.searchbox.mojom.PageHandler_SetActiveToolMode_ParamsSpec, 'searchbox.mojom.PageHandler_SetActiveToolMode_Params', [
      ...
      mojo.internal.StructField('arg_is_set_by_server', 4, 0, mojo.internal.Bool, false, false, 0, undefined),
    ],
    [[0, 16]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.searchbox.mojom.Page_ResetPopupToInitialState_ParamsSpec, 'searchbox.mojom.Page_ResetPopupToInitialState_Params', [
    ],
    [[0, 8]]);
