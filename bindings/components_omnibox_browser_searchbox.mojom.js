...
mojo.internal.bindings.searchbox.mojom.KeywordTypeSpec = mojo.internal.bindings.searchbox.mojom.KeywordTypeSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.searchbox.mojom.SuggestStyleSpec = mojo.internal.bindings.searchbox.mojom.SuggestStyleSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.searchbox.mojom.TabAttachmentSourceSpec = mojo.internal.bindings.searchbox.mojom.TabAttachmentSourceSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.searchbox.mojom.FreStageSpec = mojo.internal.bindings.searchbox.mojom.FreStageSpec || { $: mojo.internal.Enum().$ };
...
mojo.internal.bindings.searchbox.mojom.InputKeywordModelSpec = mojo.internal.bindings.searchbox.mojom.InputKeywordModelSpec || { $: {} };
if (mojo.internal.bindings.searchbox.mojom.InputKeywordModelSpec.$.structSpec && mojo.internal.bindings.searchbox.mojom.InputKeywordModelSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.searchbox.mojom.InputKeywordModelSpec.$ = {};
mojo.internal.bindings.searchbox.mojom.MatchKeywordModelSpec = mojo.internal.bindings.searchbox.mojom.MatchKeywordModelSpec || { $: {} };
if (mojo.internal.bindings.searchbox.mojom.MatchKeywordModelSpec.$.structSpec && mojo.internal.bindings.searchbox.mojom.MatchKeywordModelSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.searchbox.mojom.MatchKeywordModelSpec.$ = {};
...
mojo.internal.bindings.searchbox.mojom.FreStateSpec = mojo.internal.bindings.searchbox.mojom.FreStateSpec || { $: {} };
if (mojo.internal.bindings.searchbox.mojom.FreStateSpec.$.structSpec && mojo.internal.bindings.searchbox.mojom.FreStateSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.searchbox.mojom.FreStateSpec.$ = {};
...
mojo.internal.bindings.searchbox.mojom.ActionModifiersSpec = mojo.internal.bindings.searchbox.mojom.ActionModifiersSpec || { $: {} };
if (mojo.internal.bindings.searchbox.mojom.ActionModifiersSpec.$.structSpec && mojo.internal.bindings.searchbox.mojom.ActionModifiersSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.searchbox.mojom.ActionModifiersSpec.$ = {};
...
mojo.internal.bindings.searchbox.mojom.PageHandler_GetCyclingPlaceholderConfig_ParamsSpec = mojo.internal.bindings.searchbox.mojom.PageHandler_GetCyclingPlaceholderConfig_ParamsSpec || { $: {} };
if (mojo.internal.bindings.searchbox.mojom.PageHandler_GetCyclingPlaceholderConfig_ParamsSpec.$.structSpec && mojo.internal.bindings.searchbox.mojom.PageHandler_GetCyclingPlaceholderConfig_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.searchbox.mojom.PageHandler_GetCyclingPlaceholderConfig_ParamsSpec.$ = {};
mojo.internal.bindings.searchbox.mojom.PageHandler_GetCyclingPlaceholderConfig_ResponseParamsSpec = mojo.internal.bindings.searchbox.mojom.PageHandler_GetCyclingPlaceholderConfig_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.searchbox.mojom.PageHandler_GetCyclingPlaceholderConfig_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.searchbox.mojom.PageHandler_GetCyclingPlaceholderConfig_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.searchbox.mojom.PageHandler_GetCyclingPlaceholderConfig_ResponseParamsSpec.$ = {};
...
mojo.internal.bindings.searchbox.mojom.PageHandler_DeleteTabContext_ParamsSpec = mojo.internal.bindings.searchbox.mojom.PageHandler_DeleteTabContext_ParamsSpec || { $: {} };
if (mojo.internal.bindings.searchbox.mojom.PageHandler_DeleteTabContext_ParamsSpec.$.structSpec && mojo.internal.bindings.searchbox.mojom.PageHandler_DeleteTabContext_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.searchbox.mojom.PageHandler_DeleteTabContext_ParamsSpec.$ = {};
...
mojo.internal.bindings.searchbox.mojom.PageHandler_DismissFre_ParamsSpec = mojo.internal.bindings.searchbox.mojom.PageHandler_DismissFre_ParamsSpec || { $: {} };
...
mojo.internal.bindings.searchbox.mojom.Page_SetFreState_ParamsSpec = mojo.internal.bindings.searchbox.mojom.Page_SetFreState_ParamsSpec || { $: {} };
if (mojo.internal.bindings.searchbox.mojom.Page_SetFreState_ParamsSpec.$.structSpec && mojo.internal.bindings.searchbox.mojom.Page_SetFreState_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.searchbox.mojom.Page_SetFreState_ParamsSpec.$ = {};
...
mojo.internal.bindings.searchbox.mojom.Page_SetKeywordSpaceTriggeringEnabled_ParamsSpec = mojo.internal.bindings.searchbox.mojom.Page_SetKeywordSpaceTriggeringEnabled_ParamsSpec || { $: {} };
if (mojo.internal.bindings.searchbox.mojom.Page_SetKeywordSpaceTriggeringEnabled_ParamsSpec.$.structSpec && mojo.internal.bindings.searchbox.mojom.Page_SetKeywordSpaceTriggeringEnabled_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.searchbox.mojom.Page_SetKeywordSpaceTriggeringEnabled_ParamsSpec.$ = {};
mojo.internal.bindings.searchbox.mojom.Page_SetAvailableKeywordModels_ParamsSpec = mojo.internal.bindings.searchbox.mojom.Page_SetAvailableKeywordModels_ParamsSpec || { $: {} };
if (mojo.internal.bindings.searchbox.mojom.Page_SetAvailableKeywordModels_ParamsSpec.$.structSpec && mojo.internal.bindings.searchbox.mojom.Page_SetAvailableKeywordModels_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.searchbox.mojom.Page_SetAvailableKeywordModels_ParamsSpec.$ = {};
...
// Enum: KeywordType
mojo.internal.bindings.searchbox.mojom.KeywordType = {
  kChip: 0,
  kInKeyword: 1,
  kInstant: 2,
};
...
// Enum: SuggestStyle
mojo.internal.bindings.searchbox.mojom.SuggestStyle = {
  kUnspecified: 0,
  kDefault: 1,
  kEnriched: 2,
  kAnnotated: 3,
...
mojo.internal.bindings.searchbox.mojom.TabAttachmentSource = {
  kOther: 0,
  kContextMenu: 1,
  kCurrentTabChip: 2,
  kActionChip: 3,
...
// Enum: FreStage
mojo.internal.bindings.searchbox.mojom.FreStage = {
  kNone: 0,
  kIntroModal: 1,
...
mojo.internal.bindings.searchbox.mojom.SelectionLineState = {
  ...
  kCtrlEnter: 7,
  kFocusedButtonVoiceSearch: 8,
  kFocusedButtonLensSearch: 9,
};
...
// Enum: InputMethod
mojo.internal.bindings.searchbox.mojom.InputMethod = {
  kKeyboard: 1,
  kPaste: 2,
  kSpeech: 6,
  kTab: 8,
...
mojo.internal.bindings.searchbox.mojom.PageHandlerRemote = class {
  ...
  queryAutocomplete(arg_query_id, arg_tab_id, arg_input, arg_prevent_inline_autocomplete, arg_cursor_position, arg_suggest_inventory, arg_is_on_focus, arg_keyword, arg_input_method) {
    return this.$.queryAutocomplete(arg_query_id, arg_tab_id, arg_input, arg_prevent_inline_autocomplete, arg_cursor_position, arg_suggest_inventory, arg_is_on_focus, arg_keyword, arg_input_method);
  }
  stopAutocomplete(arg_clear_result) {
    return this.$.stopAutocomplete(arg_clear_result);
  }
  openAutocompleteMatch(arg_result_sequence_id, arg_line, arg_url, arg_are_matches_showing, arg_mouse_button, arg_modifiers, arg_via_keyboard) {
    return this.$.openAutocompleteMatch(arg_result_sequence_id, arg_line, arg_url, arg_are_matches_showing, arg_mouse_button, arg_modifiers, arg_via_keyboard);
  }
  ...
  getCyclingPlaceholderConfig() {
    return this.$.getCyclingPlaceholderConfig();
  }
  getRecentTabs() {
  ...
  addTabContext(arg_tab_id, arg_delay_upload, arg_source) {
    return this.$.addTabContext(arg_tab_id, arg_delay_upload, arg_source);
  }
  deleteContext(arg_token, arg_from_automatic_chip) {
    return this.$.deleteContext(arg_token, arg_from_automatic_chip);
  }
  deleteTabContext(arg_tab_id) {
    return this.$.deleteTabContext(arg_tab_id);
  }
  ...
  setActiveToolMode(arg_tool, arg_is_set_by_aim) {
    return this.$.setActiveToolMode(arg_tool, arg_is_set_by_aim);
  }
  setActiveModelMode(arg_model, arg_is_set_by_aim) {
    return this.$.setActiveModelMode(arg_model, arg_is_set_by_aim);
  }
  ...
  dismissFre(arg_stage) {
    return this.$.dismissFre(arg_stage);
  }
  showHotkeyDropdown(arg_anchor_bounds) {
    return this.$.showHotkeyDropdown(arg_anchor_bounds);
  }
  openHotkeySettings() {
...
mojo.internal.bindings.searchbox.mojom.PageHandlerRemoteCallHandler = class {
  ...
  queryAutocomplete(arg_query_id, arg_tab_id, arg_input, arg_prevent_inline_autocomplete, arg_cursor_position, arg_suggest_inventory, arg_is_on_focus, arg_keyword, arg_input_method) {
    return this.proxy.sendMessage(
      ...
      null,
      [arg_query_id, arg_tab_id, arg_input, arg_prevent_inline_autocomplete, arg_cursor_position, arg_suggest_inventory, arg_is_on_focus, arg_keyword, arg_input_method],
      false);
  }
  ...
  openAutocompleteMatch(arg_result_sequence_id, arg_line, arg_url, arg_are_matches_showing, arg_mouse_button, arg_modifiers, arg_via_keyboard) {
    return this.proxy.sendMessage(
      ...
      null,
      [arg_result_sequence_id, arg_line, arg_url, arg_are_matches_showing, arg_mouse_button, arg_modifiers, arg_via_keyboard],
      false);
  }
  ...
  addTabContext(arg_tab_id, arg_delay_upload, arg_source) {
    return this.proxy.sendMessage(
      ...
      null,
      [arg_tab_id, arg_delay_upload, arg_source],
      false);
  }
  ...
  deleteTabContext(arg_tab_id) {
    return this.proxy.sendMessage(
      ...
      mojo.internal.bindings.searchbox.mojom.PageHandler_DeleteTabContext_ParamsSpec,
      null,
      [arg_tab_id],
      false);
  }
  ...
  dismissFre(arg_stage) {
    return this.proxy.sendMessage(
      ...
      mojo.internal.bindings.searchbox.mojom.PageHandler_DismissFre_ParamsSpec,
      null,
      [arg_stage],
      false);
  }
  ...
  openHotkeySettings() {
    return this.proxy.sendMessage(
      ...
      mojo.internal.bindings.searchbox.mojom.PageHandler_OpenHotkeySettings_ParamsSpec,
      null,
      [],
      false);
  }
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        ...
        case 1: {
          ...
          const result = this.impl.queryAutocomplete(params.arg_query_id, params.arg_tab_id, params.arg_input, params.arg_prevent_inline_autocomplete, params.arg_cursor_position, params.arg_suggest_inventory, params.arg_is_on_focus, params.arg_keyword, params.arg_input_method);
          break;
        }
        case 2: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
        ...
        case 3: {
          ...
          const result = this.impl.openAutocompleteMatch(params.arg_result_sequence_id, params.arg_line, params.arg_url, params.arg_are_matches_showing, params.arg_mouse_button, params.arg_modifiers, params.arg_via_keyboard);
          break;
        }
        case 4: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
        ...
        case 12: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.searchbox.mojom.PageHandler_GetCyclingPlaceholderConfig_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.getCyclingPlaceholderConfig');
          const result = this.impl.getCyclingPlaceholderConfig();
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const message = new mojo.internal.Message(
                ...
                header.ordinal, header.requestId, mojo.internal.bindings.searchbox.mojom.PageHandler_GetCyclingPlaceholderConfig_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
            }).catch(e => console.error('[GeneratedReceiver] getCyclingPlaceholderConfig FAILED:', e));
          }
          break;
        }
        case 13: {
        ...
        case 20: {
          ...
          const result = this.impl.addTabContext(params.arg_tab_id, params.arg_delay_upload, params.arg_source);
          break;
        }
        case 21: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
        ...
        case 22: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.searchbox.mojom.PageHandler_DeleteTabContext_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.deleteTabContext');
          const result = this.impl.deleteTabContext(params.arg_tab_id);
          break;
        }
        case 23: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
        ...
        case 26: {
          ...
          const result = this.impl.setActiveToolMode(params.arg_tool, params.arg_is_set_by_aim);
          break;
        }
        case 27: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          ...
          const result = this.impl.setActiveModelMode(params.arg_model, params.arg_is_set_by_aim);
          break;
        }
        case 28: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
        ...
        case 36: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.searchbox.mojom.PageHandler_StartScreenshare_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
            }).catch(e => console.error('[GeneratedReceiver] startScreenshare FAILED:', e));
          }
          break;
        }
        case 37: {
        ...
        case 41: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.searchbox.mojom.PageHandler_DismissFre_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.dismissFre');
          const result = this.impl.dismissFre(params.arg_stage);
          break;
        }
        case 42: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
...
mojo.internal.bindings.searchbox.mojom.PageRemote = class {
  ...
  setFreState(arg_state) {
    return this.$.setFreState(arg_state);
  }
  ...
  setKeywordSpaceTriggeringEnabled(arg_enabled) {
    return this.$.setKeywordSpaceTriggeringEnabled(arg_enabled);
  }
  setAvailableKeywordModels(arg_models, arg_default_search_provider_keyword) {
    return this.$.setAvailableKeywordModels(arg_models, arg_default_search_provider_keyword);
  }
  ...
  updateAutoSuggestedTabContext(arg_tab, arg_invocation_source) {
    return this.$.updateAutoSuggestedTabContext(arg_tab, arg_invocation_source);
  }
...
mojo.internal.bindings.searchbox.mojom.PageRemoteCallHandler = class {
  ...
  setFreState(arg_state) {
    return this.proxy.sendMessage(
      this.ordinals[0],  // ordinal
      mojo.internal.bindings.searchbox.mojom.Page_SetFreState_ParamsSpec,
      null,
      [arg_state],
      false);
  }
  ...
  setAvailableKeywordModels(arg_models, arg_default_search_provider_keyword) {
    return this.proxy.sendMessage(
      this.ordinals[9],  // ordinal
      mojo.internal.bindings.searchbox.mojom.Page_SetAvailableKeywordModels_ParamsSpec,
      null,
      [arg_models, arg_default_search_provider_keyword],
      false);
  }
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.searchbox.mojom.Page_SetFreState_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.setFreState');
          const result = this.impl.setFreState(params.arg_state);
          break;
        }
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
        ...
        case 8: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.searchbox.mojom.Page_SetKeywordSpaceTriggeringEnabled_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.setKeywordSpaceTriggeringEnabled');
          const result = this.impl.setKeywordSpaceTriggeringEnabled(params.arg_enabled);
          break;
        }
        case 9: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.searchbox.mojom.Page_SetAvailableKeywordModels_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.setAvailableKeywordModels');
          const result = this.impl.setAvailableKeywordModels(params.arg_models, params.arg_default_search_provider_keyword);
          break;
        }
        case 10: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
...
mojo.internal.Struct(
    mojo.internal.bindings.searchbox.mojom.InputKeywordModelSpec, 'searchbox.mojom.InputKeywordModel', [
      mojo.internal.StructField('arg_type', 0, 0, mojo.internal.bindings.searchbox.mojom.KeywordTypeSpec, null, false, 0, undefined),
...
mojo.internal.Struct(
    mojo.internal.bindings.searchbox.mojom.MatchKeywordModelSpec, 'searchbox.mojom.MatchKeywordModel', [
      mojo.internal.StructField('arg_type', 0, 0, mojo.internal.bindings.searchbox.mojom.KeywordTypeSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_chip_hint', 8, 0, mojo.internal.String, null, false, 0, undefined),
      mojo.internal.StructField('arg_chip_a11y', 16, 0, mojo.internal.String, null, false, 0, undefined),
      mojo.internal.StructField('arg_placeholder', 24, 0, mojo.internal.String, null, false, 0, undefined),
...
mojo.internal.Struct(
    mojo.internal.bindings.searchbox.mojom.AutocompleteMatchSpec, 'searchbox.mojom.AutocompleteMatch', [
      ...
      mojo.internal.StructField('arg_show_contextual_description', 1, 0, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_supports_deletion', 1, 1, mojo.internal.Bool, false, false, 0, undefined),
      ...
      mojo.internal.StructField('arg_keyword_model', 136, 0, mojo.internal.bindings.searchbox.mojom.MatchKeywordModelSpec, null, true, 0, undefined),
      mojo.internal.StructField('arg_fusebox_action', 144, 0, mojo.internal.bindings.fusebox_action.mojom.FuseboxActionSpec, null, true, 0, undefined),
      mojo.internal.StructField('arg_suggest_style', 152, 0, mojo.internal.bindings.searchbox.mojom.SuggestStyleSpec, 0, false, 0, undefined),
    ],
    [[0, 168]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.searchbox.mojom.TabAttachmentSpec, 'searchbox.mojom.TabAttachment', [
      mojo.internal.StructField('arg_tab_id', 0, 0, mojo.internal.Int32, 0, false, 0, undefined),
      mojo.internal.StructField('arg_source', 4, 0, mojo.internal.bindings.searchbox.mojom.TabAttachmentSourceSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_title', 8, 0, mojo.internal.String, null, false, 0, undefined),
      mojo.internal.StructField('arg_url', 16, 0, mojo.internal.bindings.url.mojom.UrlSpec, null, false, 0, undefined),
    ],
    [[0, 32]]);
...
// Struct: FreState
mojo.internal.Struct(
    mojo.internal.bindings.searchbox.mojom.FreStateSpec, 'searchbox.mojom.FreState', [
      mojo.internal.StructField('arg_stage', 0, 0, mojo.internal.bindings.searchbox.mojom.FreStageSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_current_hotkey_tokens', 8, 0, mojo.internal.Array(mojo.internal.String, false), null, false, 0, undefined),
    ],
    [[0, 24]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.searchbox.mojom.ActionModifiersSpec, 'searchbox.mojom.ActionModifiers', [
      mojo.internal.StructField('arg_alt_key', 0, 0, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_ctrl_key', 0, 1, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_meta_key', 0, 2, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_shift_key', 0, 3, mojo.internal.Bool, false, false, 0, undefined),
    ],
    [[0, 16]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.searchbox.mojom.PageHandler_QueryAutocomplete_ParamsSpec, 'searchbox.mojom.PageHandler_QueryAutocomplete_Params', [
      ...
      mojo.internal.StructField('arg_prevent_inline_autocomplete', 4, 1, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_is_on_focus', 4, 2, mojo.internal.Bool, false, false, 0, undefined),
...
mojo.internal.Struct(
    mojo.internal.bindings.searchbox.mojom.PageHandler_OpenAutocompleteMatch_ParamsSpec, 'searchbox.mojom.PageHandler_OpenAutocompleteMatch_Params', [
      ...
      mojo.internal.StructField('arg_are_matches_showing', 5, 0, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_via_keyboard', 5, 1, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_mouse_button', 6, 0, mojo.internal.Uint8, 0, false, 0, undefined),
...
mojo.internal.Struct(
    mojo.internal.bindings.searchbox.mojom.PageHandler_GetCyclingPlaceholderConfig_ParamsSpec, 'searchbox.mojom.PageHandler_GetCyclingPlaceholderConfig_Params', [
    ],
    [[0, 8]]);

mojo.internal.Struct(
    mojo.internal.bindings.searchbox.mojom.PageHandler_GetCyclingPlaceholderConfig_ResponseParamsSpec, 'searchbox.mojom.PageHandler_GetCyclingPlaceholderConfig_ResponseParams', [
...
mojo.internal.Struct(
    mojo.internal.bindings.searchbox.mojom.PageHandler_AddTabContext_ParamsSpec, 'searchbox.mojom.PageHandler_AddTabContext_Params', [
      ...
      mojo.internal.StructField('arg_source', 8, 0, mojo.internal.bindings.searchbox.mojom.TabAttachmentSourceSpec, null, false, 0, undefined),
    ],
    [[0, 24]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.searchbox.mojom.PageHandler_DeleteTabContext_ParamsSpec, 'searchbox.mojom.PageHandler_DeleteTabContext_Params', [
      mojo.internal.StructField('arg_tab_id', 0, 0, mojo.internal.Int32, 0, false, 0, undefined),
    ],
    [[0, 16]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.searchbox.mojom.PageHandler_SetActiveToolMode_ParamsSpec, 'searchbox.mojom.PageHandler_SetActiveToolMode_Params', [
      ...
      mojo.internal.StructField('arg_is_set_by_aim', 4, 0, mojo.internal.Bool, false, false, 0, undefined),
    ],
    [[0, 16]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.searchbox.mojom.PageHandler_DismissFre_ParamsSpec, 'searchbox.mojom.PageHandler_DismissFre_Params', [
      mojo.internal.StructField('arg_stage', 0, 0, mojo.internal.bindings.searchbox.mojom.FreStageSpec, null, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.searchbox.mojom.PageHandler_ShowHotkeyDropdown_ParamsSpec, 'searchbox.mojom.PageHandler_ShowHotkeyDropdown_Params', [
...
mojo.internal.Struct(
    mojo.internal.bindings.searchbox.mojom.Page_SetFreState_ParamsSpec, 'searchbox.mojom.Page_SetFreState_Params', [
      mojo.internal.StructField('arg_state', 0, 0, mojo.internal.bindings.searchbox.mojom.FreStateSpec, null, false, 0, undefined),
    ],
    [[0, 16]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.searchbox.mojom.Page_SetKeywordSpaceTriggeringEnabled_ParamsSpec, 'searchbox.mojom.Page_SetKeywordSpaceTriggeringEnabled_Params', [
      mojo.internal.StructField('arg_enabled', 0, 0, mojo.internal.Bool, false, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.searchbox.mojom.Page_SetAvailableKeywordModels_ParamsSpec, 'searchbox.mojom.Page_SetAvailableKeywordModels_Params', [
      mojo.internal.StructField('arg_models', 0, 0, mojo.internal.Array(mojo.internal.bindings.searchbox.mojom.InputKeywordModelSpec, false), null, false, 0, undefined),
      mojo.internal.StructField('arg_default_search_provider_keyword', 8, 0, mojo.internal.String, null, false, 0, undefined),
    ],
    [[0, 24]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.searchbox.mojom.Page_UpdateAutoSuggestedTabContext_ParamsSpec, 'searchbox.mojom.Page_UpdateAutoSuggestedTabContext_Params', [
      ...
      mojo.internal.StructField('arg_invocation_source', 8, 0, mojo.internal.String, null, true, 0, undefined),
    ],
    [[0, 24]]);
