...
mojo.internal.bindings.searchbox.mojom.ToolModeSpec = mojo.internal.bindings.searchbox.mojom.ToolModeSpec || { $: mojo.internal.Enum().$ };
...
mojo.internal.bindings.searchbox.mojom.PageHandler_SetPage_ParamsSpec = mojo.internal.bindings.searchbox.mojom.PageHandler_SetPage_ParamsSpec || { $: {} };
if (mojo.internal.bindings.searchbox.mojom.PageHandler_SetPage_ParamsSpec.$.structSpec && mojo.internal.bindings.searchbox.mojom.PageHandler_SetPage_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.searchbox.mojom.PageHandler_SetPage_ParamsSpec.$ = {};
...
mojo.internal.bindings.searchbox.mojom.PageHandler_ShowContextMenu_ParamsSpec = mojo.internal.bindings.searchbox.mojom.PageHandler_ShowContextMenu_ParamsSpec || { $: {} };
if (mojo.internal.bindings.searchbox.mojom.PageHandler_ShowContextMenu_ParamsSpec.$.structSpec && mojo.internal.bindings.searchbox.mojom.PageHandler_ShowContextMenu_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.searchbox.mojom.PageHandler_ShowContextMenu_ParamsSpec.$ = {};
...
mojo.internal.bindings.searchbox.mojom.PageHandler_AddFileContext_ResponseParamsSpec = mojo.internal.bindings.searchbox.mojom.PageHandler_AddFileContext_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.searchbox.mojom.PageHandler_AddFileContext_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.searchbox.mojom.PageHandler_AddFileContext_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.searchbox.mojom.PageHandler_AddFileContext_ResponseParamsSpec.$ = {};
...
mojo.internal.bindings.searchbox.mojom.PageHandler_AddTabContext_ResponseParamsSpec = mojo.internal.bindings.searchbox.mojom.PageHandler_AddTabContext_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.searchbox.mojom.PageHandler_AddTabContext_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.searchbox.mojom.PageHandler_AddTabContext_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.searchbox.mojom.PageHandler_AddTabContext_ResponseParamsSpec.$ = {};
...
mojo.internal.bindings.searchbox.mojom.Page_OnShow_ParamsSpec = mojo.internal.bindings.searchbox.mojom.Page_OnShow_ParamsSpec || { $: {} };
if (mojo.internal.bindings.searchbox.mojom.Page_OnShow_ParamsSpec.$.structSpec && mojo.internal.bindings.searchbox.mojom.Page_OnShow_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.searchbox.mojom.Page_OnShow_ParamsSpec.$ = {};
...
mojo.internal.bindings.searchbox.mojom.Page_UpdateAimEligibility_ParamsSpec = mojo.internal.bindings.searchbox.mojom.Page_UpdateAimEligibility_ParamsSpec || { $: {} };
if (mojo.internal.bindings.searchbox.mojom.Page_UpdateAimEligibility_ParamsSpec.$.structSpec && mojo.internal.bindings.searchbox.mojom.Page_UpdateAimEligibility_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.searchbox.mojom.Page_UpdateAimEligibility_ParamsSpec.$ = {};
mojo.internal.bindings.searchbox.mojom.Page_OnShowAiModePrefChanged_ParamsSpec = mojo.internal.bindings.searchbox.mojom.Page_OnShowAiModePrefChanged_ParamsSpec || { $: {} };
if (mojo.internal.bindings.searchbox.mojom.Page_OnShowAiModePrefChanged_ParamsSpec.$.structSpec && mojo.internal.bindings.searchbox.mojom.Page_OnShowAiModePrefChanged_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.searchbox.mojom.Page_OnShowAiModePrefChanged_ParamsSpec.$ = {};
...
mojo.internal.Struct(
    mojo.internal.bindings.searchbox.mojom.PageHandler_SetActiveToolMode_ParamsSpec, 'searchbox.mojom.PageHandler_SetActiveToolMode_Params', [
      mojo.internal.StructField('arg_tool', 0, 0, mojo.internal.bindings.searchbox.mojom.ToolModeSpec, null, false, 0, undefined),
    ],
    [[0, 16]]);
