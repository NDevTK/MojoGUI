...
mojo.internal.bindings.searchbox.mojom.PageHandlerRemote = class {
  ...
  openAutocompleteMatch(arg_line, arg_url, arg_are_matches_showing, arg_mouse_button, arg_modifiers, arg_via_keyboard) {
    return this.$.openAutocompleteMatch(arg_line, arg_url, arg_are_matches_showing, arg_mouse_button, arg_modifiers, arg_via_keyboard);
  }
...
mojo.internal.bindings.searchbox.mojom.PageHandlerRemoteCallHandler = class {
  ...
  openAutocompleteMatch(arg_line, arg_url, arg_are_matches_showing, arg_mouse_button, arg_modifiers, arg_via_keyboard) {
    return this.proxy.sendMessage(
      ...
      null,
      [arg_line, arg_url, arg_are_matches_showing, arg_mouse_button, arg_modifiers, arg_via_keyboard],
      false);
  }
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        ...
        case 3: {
          ...
          const result = this.impl.openAutocompleteMatch(params.arg_line, params.arg_url, params.arg_are_matches_showing, params.arg_mouse_button, params.arg_modifiers, params.arg_via_keyboard);
          break;
        }
        case 4: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
...
mojo.internal.Struct(
    mojo.internal.bindings.searchbox.mojom.PageHandler_OpenAutocompleteMatch_ParamsSpec, 'searchbox.mojom.PageHandler_OpenAutocompleteMatch_Params', [
      ...
      mojo.internal.StructField('arg_via_keyboard', 1, 1, mojo.internal.Bool, false, false, 0, undefined),
