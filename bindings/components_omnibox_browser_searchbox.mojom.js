...
mojo.internal.bindings.searchbox.mojom.Page_OnEmbeddedPermissionPromptChanged_ParamsSpec = mojo.internal.bindings.searchbox.mojom.Page_OnEmbeddedPermissionPromptChanged_ParamsSpec || { $: {} };
if (mojo.internal.bindings.searchbox.mojom.Page_OnEmbeddedPermissionPromptChanged_ParamsSpec.$.structSpec && mojo.internal.bindings.searchbox.mojom.Page_OnEmbeddedPermissionPromptChanged_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.searchbox.mojom.Page_OnEmbeddedPermissionPromptChanged_ParamsSpec.$ = {};
...
mojo.internal.bindings.searchbox.mojom.PageRemote = class {
  ...
  onEmbeddedPermissionPromptChanged(arg_is_showing, arg_prompt_size) {
    return this.$.onEmbeddedPermissionPromptChanged(arg_is_showing, arg_prompt_size);
  }
};
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        ...
        case 16: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.searchbox.mojom.Page_OnEmbeddedPermissionPromptChanged_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.onEmbeddedPermissionPromptChanged');
          const result = this.impl.onEmbeddedPermissionPromptChanged(params.arg_is_showing, params.arg_prompt_size);
          break;
        }
      }
      } catch (err) {
...
mojo.internal.Struct(
    mojo.internal.bindings.searchbox.mojom.Page_OnEmbeddedPermissionPromptChanged_ParamsSpec, 'searchbox.mojom.Page_OnEmbeddedPermissionPromptChanged_Params', [
