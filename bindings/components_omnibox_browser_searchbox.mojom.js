...
mojo.internal.bindings.searchbox.mojom.PageRemote = class {
  ...
  setAvailableKeywordModels(arg_models) {
    return this.$.setAvailableKeywordModels(arg_models);
  }
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        ...
        case 9: {
          ...
          const result = this.impl.setAvailableKeywordModels(params.arg_models);
          break;
        }
        case 10: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
