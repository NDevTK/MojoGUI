...
mojo.internal.bindings.searchbox.mojom.KeywordModelSpec = mojo.internal.bindings.searchbox.mojom.KeywordModelSpec || { $: {} };
if (mojo.internal.bindings.searchbox.mojom.KeywordModelSpec.$.structSpec && mojo.internal.bindings.searchbox.mojom.KeywordModelSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.searchbox.mojom.KeywordModelSpec.$ = {};
...
mojo.internal.bindings.searchbox.mojom.PageHandler_SetInputMethod_ParamsSpec = mojo.internal.bindings.searchbox.mojom.PageHandler_SetInputMethod_ParamsSpec || { $: {} };
if (mojo.internal.bindings.searchbox.mojom.PageHandler_SetInputMethod_ParamsSpec.$.structSpec && mojo.internal.bindings.searchbox.mojom.PageHandler_SetInputMethod_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.searchbox.mojom.PageHandler_SetInputMethod_ParamsSpec.$ = {};
...
mojo.internal.bindings.searchbox.mojom.PageHandlerRemote = class {
  ...
  queryAutocomplete(arg_query_id, arg_input, arg_prevent_inline_autocomplete, arg_cursor_position, arg_suggest_inventory, arg_is_on_focus, arg_keyword) {
    return this.$.queryAutocomplete(arg_query_id, arg_input, arg_prevent_inline_autocomplete, arg_cursor_position, arg_suggest_inventory, arg_is_on_focus, arg_keyword);
  }
  ...
  setInputMethod(arg_input_method) {
    return this.$.setInputMethod(arg_input_method);
  }
...
mojo.internal.bindings.searchbox.mojom.PageHandlerRemoteCallHandler = class {
  ...
  queryAutocomplete(arg_query_id, arg_input, arg_prevent_inline_autocomplete, arg_cursor_position, arg_suggest_inventory, arg_is_on_focus, arg_keyword) {
    return this.proxy.sendMessage(
      ...
      null,
      [arg_query_id, arg_input, arg_prevent_inline_autocomplete, arg_cursor_position, arg_suggest_inventory, arg_is_on_focus, arg_keyword],
      false);
  }
  ...
  setInputMethod(arg_input_method) {
    return this.proxy.sendMessage(
      ...
      mojo.internal.bindings.searchbox.mojom.PageHandler_SetInputMethod_ParamsSpec,
      null,
      [arg_input_method],
      false);
  }
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        ...
        case 1: {
          ...
          const result = this.impl.queryAutocomplete(params.arg_query_id, params.arg_input, params.arg_prevent_inline_autocomplete, params.arg_cursor_position, params.arg_suggest_inventory, params.arg_is_on_focus, params.arg_keyword);
          break;
        }
        case 2: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
        ...
        case 5: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.searchbox.mojom.PageHandler_SetInputMethod_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.setInputMethod');
          const result = this.impl.setInputMethod(params.arg_input_method);
          break;
        }
        case 6: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
...
// Struct: KeywordModel
mojo.internal.Struct(
    mojo.internal.bindings.searchbox.mojom.KeywordModelSpec, 'searchbox.mojom.KeywordModel', [
...
mojo.internal.Struct(
    mojo.internal.bindings.searchbox.mojom.AutocompleteMatchSpec, 'searchbox.mojom.AutocompleteMatch', [
      ...
      mojo.internal.StructField('arg_keyword_model', 144, 0, mojo.internal.bindings.searchbox.mojom.KeywordModelSpec, null, true, 0, undefined),
    ],
    [[0, 160]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.searchbox.mojom.PageHandler_SetInputMethod_ParamsSpec, 'searchbox.mojom.PageHandler_SetInputMethod_Params', [
      mojo.internal.StructField('arg_input_method', 0, 0, mojo.internal.bindings.searchbox.mojom.InputMethodSpec, null, false, 0, undefined),
    ],
    [[0, 16]]);
