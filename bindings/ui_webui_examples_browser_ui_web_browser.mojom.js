...
mojo.internal.bindings.webui_examples.mojom.PageHandlerFactoryRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.webui_examples.mojom.PageHandlerFactoryPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.webui_examples.mojom.PageHandlerFactoryRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.webui_examples.mojom.PageHandlerFactoryRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('webui_examples.mojom.PageHandlerFactory', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.webui_examples.mojom.PageHandlerFactory.getRemote = function() {
  let remote = new mojo.internal.bindings.webui_examples.mojom.PageHandlerFactoryRemote();
...
mojo.internal.bindings.webui_examples.mojom.PageHandlerFactoryReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('webui_examples.mojom.PageHandlerFactory', [
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.webui_examples.mojom.PageHandlerFactory_CreatePageHandler_ParamsSpec.$.structSpec;
...
mojo.internal.bindings.webui_examples.mojom.PageHandlerFactoryReceiver = mojo.internal.bindings.webui_examples.mojom.PageHandlerFactoryReceiver;

mojo.internal.bindings.webui_examples.mojom.PageHandlerFactoryPtr = mojo.internal.bindings.webui_examples.mojom.PageHandlerFactoryRemote;
mojo.internal.bindings.webui_examples.mojom.PageHandlerFactoryRequest = mojo.internal.bindings.webui_examples.mojom.PageHandlerFactoryPendingReceiver;
...
mojo.internal.bindings.webui_examples.mojom.PageHandlerRemote = class {
  static get $interfaceName() {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.webui_examples.mojom.PageHandlerPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.webui_examples.mojom.PageHandlerRemoteCallHandler(this.proxy);
  }
  ...
  navigate(arg_guest_contents_id, arg_src) {
    return this.$.navigate(arg_guest_contents_id, arg_src);
  }
  goBack(arg_guest_contents_id) {
    return this.$.goBack(arg_guest_contents_id);
  }
  goForward(arg_guest_contents_id) {
    return this.$.goForward(arg_guest_contents_id);
  }
};

mojo.internal.bindings.webui_examples.mojom.PageHandlerRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('webui_examples.mojom.PageHandler', [
      { explicit: null },
      { explicit: null },
      { explicit: null },
    ]);
...
mojo.internal.bindings.webui_examples.mojom.PageHandler.getRemote = function() {
  let remote = new mojo.internal.bindings.webui_examples.mojom.PageHandlerRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
...
mojo.internal.bindings.webui_examples.mojom.PageHandlerReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('webui_examples.mojom.PageHandler', [
      { explicit: null },
      { explicit: null },
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.webui_examples.mojom.PageHandler_Navigate_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for Navigate failed with TypeError');
           }
        }
        // Try Method 1: GoBack
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.webui_examples.mojom.PageHandler_GoBack_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for GoBack failed with TypeError');
           }
        }
        // Try Method 2: GoForward
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.webui_examples.mojom.PageHandler_GoForward_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for GoForward failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
             console.warn('[GeneratedReceiver] Failed to discover ordinal ' + header.ordinal);
...
mojo.internal.bindings.webui_examples.mojom.PageHandlerReceiver = mojo.internal.bindings.webui_examples.mojom.PageHandlerReceiver;
