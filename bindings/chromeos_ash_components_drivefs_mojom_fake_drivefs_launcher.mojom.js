...
mojo.internal.bindings.drivefs.mojom.FakeDriveFsLauncher = {};
mojo.internal.bindings.drivefs.mojom.FakeDriveFsLauncherSpec = { $ : {} };
mojo.internal.bindings.drivefs.mojom.FakeDriveFsLauncher.$interfaceName = 'drivefs.mojom.FakeDriveFsLauncher';
...
mojo.internal.bindings.drivefs.mojom.FakeDriveFsLauncherRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.drivefs.mojom.FakeDriveFsLauncherPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.drivefs.mojom.FakeDriveFsLauncherRemoteCallHandler(this.proxy);
  }
  ...
  launchDriveFs(arg_datadir_path, arg_mount_path, arg_mojo_socket_handle) {
    return this.$.launchDriveFs(arg_datadir_path, arg_mount_path, arg_mojo_socket_handle);
  }
};

mojo.internal.bindings.drivefs.mojom.FakeDriveFsLauncherRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('drivefs.mojom.FakeDriveFsLauncher', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.drivefs.mojom.FakeDriveFsLauncher.getRemote = function() {
  let remote = new mojo.internal.bindings.drivefs.mojom.FakeDriveFsLauncherRemote();
...
mojo.internal.bindings.drivefs.mojom.FakeDriveFsLauncherReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('drivefs.mojom.FakeDriveFsLauncher', [
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.drivefs.mojom.FakeDriveFsLauncher_LaunchDriveFs_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for LaunchDriveFs failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.drivefs.mojom.FakeDriveFsLauncherReceiver = mojo.internal.bindings.drivefs.mojom.FakeDriveFsLauncherReceiver;
