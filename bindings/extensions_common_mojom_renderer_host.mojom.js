...
mojo.internal.bindings.extensions.mojom.RendererHostRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.extensions.mojom.RendererHostPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.extensions.mojom.RendererHostRemoteCallHandler(this.proxy);
  }
  ...
  addAPIActionToActivityLog(arg_extension_id, arg_call_name, arg_args, arg_extra) {
    return this.$.addAPIActionToActivityLog(arg_extension_id, arg_call_name, arg_args, arg_extra);
  }
  addEventToActivityLog(arg_extension_id, arg_call_name, arg_args, arg_extra) {
    return this.$.addEventToActivityLog(arg_extension_id, arg_call_name, arg_args, arg_extra);
  }
  addDOMActionToActivityLog(arg_extension_id, arg_call_name, arg_args, arg_url, arg_url_title, arg_call_type) {
    return this.$.addDOMActionToActivityLog(arg_extension_id, arg_call_name, arg_args, arg_url, arg_url_title, arg_call_type);
  }
  getMessageBundle(arg_extension_id) {
    return this.$.getMessageBundle(arg_extension_id);
  }
};
...
mojo.internal.bindings.extensions.mojom.RendererHost.getRemote = function() {
  let remote = new mojo.internal.bindings.extensions.mojom.RendererHostRemote();
...
mojo.internal.bindings.extensions.mojom.RendererHostReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.extensions.mojom.RendererHost_AddAPIActionToActivityLog_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for AddAPIActionToActivityLog failed with TypeError');
           }
        }
        // Try Method 1: AddEventToActivityLog
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.extensions.mojom.RendererHost_AddEventToActivityLog_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for AddEventToActivityLog failed with TypeError');
           }
        }
        // Try Method 2: AddDOMActionToActivityLog
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.extensions.mojom.RendererHost_AddDOMActionToActivityLog_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for AddDOMActionToActivityLog failed with TypeError');
           }
        }
        // Try Method 3: GetMessageBundle
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.extensions.mojom.RendererHost_GetMessageBundle_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for GetMessageBundle failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.extensions.mojom.RendererHostReceiver = mojo.internal.bindings.extensions.mojom.RendererHostReceiver;
