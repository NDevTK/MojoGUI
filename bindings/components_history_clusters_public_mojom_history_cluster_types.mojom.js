  ...
  $: {
    structSpec: {
      ...
      fields: [
        ...
        { name: 'debug_info', packedOffset: 80, packedBitOffset: 0, type: mojo.internal.Map, nullable: false },
        { name: 'is_known_to_sync', packedOffset: 88, packedBitOffset: 0, type: mojo.internal.Bool, nullable: false },
        { name: 'has_url_keyed_image', packedOffset: 88, packedBitOffset: 1, type: mojo.internal.Bool, nullable: false },
      ],
      versions: [{version: 0}]
    }
  }
