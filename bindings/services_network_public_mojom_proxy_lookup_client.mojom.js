...
mojo.internal.bindings.network.mojom.ProxyLookupClient = {};
mojo.internal.bindings.network.mojom.ProxyLookupClientSpec = { $ : {} };
mojo.internal.bindings.network.mojom.ProxyLookupClient.$interfaceName = 'network.mojom.ProxyLookupClient';
...
mojo.internal.Struct(
    mojo.internal.bindings.network.mojom.ProxyLookupClient_OnProxyLookupComplete_ParamsSpec, 'network.mojom.ProxyLookupClient_OnProxyLookupComplete_Params', [
      mojo.internal.StructField('arg_proxy_info', 0, 0, mojo.internal.bindings.proxy_resolver.mojom.ProxyInfoSpec.$, null, true, 0, undefined),
...
mojo.internal.bindings.network.mojom.ProxyLookupClientRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.network.mojom.ProxyLookupClientPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.network.mojom.ProxyLookupClientRemoteCallHandler(this.proxy);
  }
  ...
  onProxyLookupComplete(arg_net_error, arg_proxy_info) {
    return this.$.onProxyLookupComplete(arg_net_error, arg_proxy_info);
  }
};

mojo.internal.bindings.network.mojom.ProxyLookupClientRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('network.mojom.ProxyLookupClient', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.network.mojom.ProxyLookupClient.getRemote = function() {
  let remote = new mojo.internal.bindings.network.mojom.ProxyLookupClientRemote();
...
mojo.internal.bindings.network.mojom.ProxyLookupClientReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('network.mojom.ProxyLookupClient', [
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.network.mojom.ProxyLookupClient_OnProxyLookupComplete_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OnProxyLookupComplete failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.network.mojom.ProxyLookupClientReceiver = mojo.internal.bindings.network.mojom.ProxyLookupClientReceiver;
