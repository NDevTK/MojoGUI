...
mojo.internal.bindings.lens.mojom.UserActionSpec = mojo.internal.bindings.lens.mojom.UserActionSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.lens.mojom.SemanticEventSpec = mojo.internal.bindings.lens.mojom.SemanticEventSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.lens.mojom.OverlayThemeSpec = mojo.internal.bindings.lens.mojom.OverlayThemeSpec || { $: {} };
if (mojo.internal.bindings.lens.mojom.OverlayThemeSpec.$.structSpec && mojo.internal.bindings.lens.mojom.OverlayThemeSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.lens.mojom.OverlayThemeSpec.$ = {};
mojo.internal.bindings.lens.mojom.LensPageHandlerFactory = mojo.internal.bindings.lens.mojom.LensPageHandlerFactory || {};
mojo.internal.bindings.lens.mojom.LensPageHandlerFactorySpec = mojo.internal.bindings.lens.mojom.LensPageHandlerFactorySpec || { $ : {} };
if (mojo.internal.bindings.lens.mojom.LensPageHandlerFactorySpec.$.structSpec && mojo.internal.bindings.lens.mojom.LensPageHandlerFactorySpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.lens.mojom.LensPageHandlerFactorySpec.$ = {};
mojo.internal.bindings.lens.mojom.LensPageHandlerFactory.$interfaceName = 'lens.mojom.LensPageHandlerFactory';
mojo.internal.bindings.lens.mojom.LensPageHandlerFactory_CreatePageHandler_ParamsSpec = mojo.internal.bindings.lens.mojom.LensPageHandlerFactory_CreatePageHandler_ParamsSpec || { $: {} };
if (mojo.internal.bindings.lens.mojom.LensPageHandlerFactory_CreatePageHandler_ParamsSpec.$.structSpec && mojo.internal.bindings.lens.mojom.LensPageHandlerFactory_CreatePageHandler_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.lens.mojom.LensPageHandlerFactory_CreatePageHandler_ParamsSpec.$ = {};
mojo.internal.bindings.lens.mojom.LensPageHandler = mojo.internal.bindings.lens.mojom.LensPageHandler || {};
mojo.internal.bindings.lens.mojom.LensPageHandlerSpec = mojo.internal.bindings.lens.mojom.LensPageHandlerSpec || { $ : {} };
if (mojo.internal.bindings.lens.mojom.LensPageHandlerSpec.$.structSpec && mojo.internal.bindings.lens.mojom.LensPageHandlerSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.lens.mojom.LensPageHandlerSpec.$ = {};
mojo.internal.bindings.lens.mojom.LensPageHandler.$interfaceName = 'lens.mojom.LensPageHandler';
mojo.internal.bindings.lens.mojom.LensPageHandler_ActivityRequestedByOverlay_ParamsSpec = mojo.internal.bindings.lens.mojom.LensPageHandler_ActivityRequestedByOverlay_ParamsSpec || { $: {} };
if (mojo.internal.bindings.lens.mojom.LensPageHandler_ActivityRequestedByOverlay_ParamsSpec.$.structSpec && mojo.internal.bindings.lens.mojom.LensPageHandler_ActivityRequestedByOverlay_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.lens.mojom.LensPageHandler_ActivityRequestedByOverlay_ParamsSpec.$ = {};
mojo.internal.bindings.lens.mojom.LensPageHandler_CloseRequestedByOverlayCloseButton_ParamsSpec = mojo.internal.bindings.lens.mojom.LensPageHandler_CloseRequestedByOverlayCloseButton_ParamsSpec || { $: {} };
if (mojo.internal.bindings.lens.mojom.LensPageHandler_CloseRequestedByOverlayCloseButton_ParamsSpec.$.structSpec && mojo.internal.bindings.lens.mojom.LensPageHandler_CloseRequestedByOverlayCloseButton_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.lens.mojom.LensPageHandler_CloseRequestedByOverlayCloseButton_ParamsSpec.$ = {};
mojo.internal.bindings.lens.mojom.LensPageHandler_CloseRequestedByOverlayBackgroundClick_ParamsSpec = mojo.internal.bindings.lens.mojom.LensPageHandler_CloseRequestedByOverlayBackgroundClick_ParamsSpec || { $: {} };
if (mojo.internal.bindings.lens.mojom.LensPageHandler_CloseRequestedByOverlayBackgroundClick_ParamsSpec.$.structSpec && mojo.internal.bindings.lens.mojom.LensPageHandler_CloseRequestedByOverlayBackgroundClick_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.lens.mojom.LensPageHandler_CloseRequestedByOverlayBackgroundClick_ParamsSpec.$ = {};
mojo.internal.bindings.lens.mojom.LensPageHandler_NotifyOverlayInitialized_ParamsSpec = mojo.internal.bindings.lens.mojom.LensPageHandler_NotifyOverlayInitialized_ParamsSpec || { $: {} };
if (mojo.internal.bindings.lens.mojom.LensPageHandler_NotifyOverlayInitialized_ParamsSpec.$.structSpec && mojo.internal.bindings.lens.mojom.LensPageHandler_NotifyOverlayInitialized_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.lens.mojom.LensPageHandler_NotifyOverlayInitialized_ParamsSpec.$ = {};
mojo.internal.bindings.lens.mojom.LensPageHandler_AddBackgroundBlur_ParamsSpec = mojo.internal.bindings.lens.mojom.LensPageHandler_AddBackgroundBlur_ParamsSpec || { $: {} };
if (mojo.internal.bindings.lens.mojom.LensPageHandler_AddBackgroundBlur_ParamsSpec.$.structSpec && mojo.internal.bindings.lens.mojom.LensPageHandler_AddBackgroundBlur_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.lens.mojom.LensPageHandler_AddBackgroundBlur_ParamsSpec.$ = {};
mojo.internal.bindings.lens.mojom.LensPageHandler_SetLiveBlur_ParamsSpec = mojo.internal.bindings.lens.mojom.LensPageHandler_SetLiveBlur_ParamsSpec || { $: {} };
if (mojo.internal.bindings.lens.mojom.LensPageHandler_SetLiveBlur_ParamsSpec.$.structSpec && mojo.internal.bindings.lens.mojom.LensPageHandler_SetLiveBlur_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.lens.mojom.LensPageHandler_SetLiveBlur_ParamsSpec.$ = {};
mojo.internal.bindings.lens.mojom.LensPageHandler_FeedbackRequestedByOverlay_ParamsSpec = mojo.internal.bindings.lens.mojom.LensPageHandler_FeedbackRequestedByOverlay_ParamsSpec || { $: {} };
if (mojo.internal.bindings.lens.mojom.LensPageHandler_FeedbackRequestedByOverlay_ParamsSpec.$.structSpec && mojo.internal.bindings.lens.mojom.LensPageHandler_FeedbackRequestedByOverlay_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.lens.mojom.LensPageHandler_FeedbackRequestedByOverlay_ParamsSpec.$ = {};
mojo.internal.bindings.lens.mojom.LensPageHandler_GetOverlayInvocationSource_ParamsSpec = mojo.internal.bindings.lens.mojom.LensPageHandler_GetOverlayInvocationSource_ParamsSpec || { $: {} };
if (mojo.internal.bindings.lens.mojom.LensPageHandler_GetOverlayInvocationSource_ParamsSpec.$.structSpec && mojo.internal.bindings.lens.mojom.LensPageHandler_GetOverlayInvocationSource_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.lens.mojom.LensPageHandler_GetOverlayInvocationSource_ParamsSpec.$ = {};
mojo.internal.bindings.lens.mojom.LensPageHandler_GetOverlayInvocationSource_ResponseParamsSpec = mojo.internal.bindings.lens.mojom.LensPageHandler_GetOverlayInvocationSource_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.lens.mojom.LensPageHandler_GetOverlayInvocationSource_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.lens.mojom.LensPageHandler_GetOverlayInvocationSource_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.lens.mojom.LensPageHandler_GetOverlayInvocationSource_ResponseParamsSpec.$ = {};
mojo.internal.bindings.lens.mojom.LensPageHandler_InfoRequestedByOverlay_ParamsSpec = mojo.internal.bindings.lens.mojom.LensPageHandler_InfoRequestedByOverlay_ParamsSpec || { $: {} };
if (mojo.internal.bindings.lens.mojom.LensPageHandler_InfoRequestedByOverlay_ParamsSpec.$.structSpec && mojo.internal.bindings.lens.mojom.LensPageHandler_InfoRequestedByOverlay_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.lens.mojom.LensPageHandler_InfoRequestedByOverlay_ParamsSpec.$ = {};
mojo.internal.bindings.lens.mojom.LensPageHandler_IssueLensRegionRequest_ParamsSpec = mojo.internal.bindings.lens.mojom.LensPageHandler_IssueLensRegionRequest_ParamsSpec || { $: {} };
if (mojo.internal.bindings.lens.mojom.LensPageHandler_IssueLensRegionRequest_ParamsSpec.$.structSpec && mojo.internal.bindings.lens.mojom.LensPageHandler_IssueLensRegionRequest_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.lens.mojom.LensPageHandler_IssueLensRegionRequest_ParamsSpec.$ = {};
mojo.internal.bindings.lens.mojom.LensPageHandler_IssueLensObjectRequest_ParamsSpec = mojo.internal.bindings.lens.mojom.LensPageHandler_IssueLensObjectRequest_ParamsSpec || { $: {} };
if (mojo.internal.bindings.lens.mojom.LensPageHandler_IssueLensObjectRequest_ParamsSpec.$.structSpec && mojo.internal.bindings.lens.mojom.LensPageHandler_IssueLensObjectRequest_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.lens.mojom.LensPageHandler_IssueLensObjectRequest_ParamsSpec.$ = {};
mojo.internal.bindings.lens.mojom.LensPageHandler_IssueTextSelectionRequest_ParamsSpec = mojo.internal.bindings.lens.mojom.LensPageHandler_IssueTextSelectionRequest_ParamsSpec || { $: {} };
if (mojo.internal.bindings.lens.mojom.LensPageHandler_IssueTextSelectionRequest_ParamsSpec.$.structSpec && mojo.internal.bindings.lens.mojom.LensPageHandler_IssueTextSelectionRequest_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.lens.mojom.LensPageHandler_IssueTextSelectionRequest_ParamsSpec.$ = {};
mojo.internal.bindings.lens.mojom.LensPageHandler_IssueTranslateSelectionRequest_ParamsSpec = mojo.internal.bindings.lens.mojom.LensPageHandler_IssueTranslateSelectionRequest_ParamsSpec || { $: {} };
if (mojo.internal.bindings.lens.mojom.LensPageHandler_IssueTranslateSelectionRequest_ParamsSpec.$.structSpec && mojo.internal.bindings.lens.mojom.LensPageHandler_IssueTranslateSelectionRequest_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.lens.mojom.LensPageHandler_IssueTranslateSelectionRequest_ParamsSpec.$ = {};
mojo.internal.bindings.lens.mojom.LensPageHandler_IssueMathSelectionRequest_ParamsSpec = mojo.internal.bindings.lens.mojom.LensPageHandler_IssueMathSelectionRequest_ParamsSpec || { $: {} };
if (mojo.internal.bindings.lens.mojom.LensPageHandler_IssueMathSelectionRequest_ParamsSpec.$.structSpec && mojo.internal.bindings.lens.mojom.LensPageHandler_IssueMathSelectionRequest_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.lens.mojom.LensPageHandler_IssueMathSelectionRequest_ParamsSpec.$ = {};
mojo.internal.bindings.lens.mojom.LensPageHandler_IssueTranslateFullPageRequest_ParamsSpec = mojo.internal.bindings.lens.mojom.LensPageHandler_IssueTranslateFullPageRequest_ParamsSpec || { $: {} };
if (mojo.internal.bindings.lens.mojom.LensPageHandler_IssueTranslateFullPageRequest_ParamsSpec.$.structSpec && mojo.internal.bindings.lens.mojom.LensPageHandler_IssueTranslateFullPageRequest_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.lens.mojom.LensPageHandler_IssueTranslateFullPageRequest_ParamsSpec.$ = {};
mojo.internal.bindings.lens.mojom.LensPageHandler_IssueEndTranslateModeRequest_ParamsSpec = mojo.internal.bindings.lens.mojom.LensPageHandler_IssueEndTranslateModeRequest_ParamsSpec || { $: {} };
if (mojo.internal.bindings.lens.mojom.LensPageHandler_IssueEndTranslateModeRequest_ParamsSpec.$.structSpec && mojo.internal.bindings.lens.mojom.LensPageHandler_IssueEndTranslateModeRequest_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.lens.mojom.LensPageHandler_IssueEndTranslateModeRequest_ParamsSpec.$ = {};
mojo.internal.bindings.lens.mojom.LensPageHandler_CopyText_ParamsSpec = mojo.internal.bindings.lens.mojom.LensPageHandler_CopyText_ParamsSpec || { $: {} };
if (mojo.internal.bindings.lens.mojom.LensPageHandler_CopyText_ParamsSpec.$.structSpec && mojo.internal.bindings.lens.mojom.LensPageHandler_CopyText_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.lens.mojom.LensPageHandler_CopyText_ParamsSpec.$ = {};
mojo.internal.bindings.lens.mojom.LensPageHandler_CopyImage_ParamsSpec = mojo.internal.bindings.lens.mojom.LensPageHandler_CopyImage_ParamsSpec || { $: {} };
if (mojo.internal.bindings.lens.mojom.LensPageHandler_CopyImage_ParamsSpec.$.structSpec && mojo.internal.bindings.lens.mojom.LensPageHandler_CopyImage_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.lens.mojom.LensPageHandler_CopyImage_ParamsSpec.$ = {};
mojo.internal.bindings.lens.mojom.LensPageHandler_SaveAsImage_ParamsSpec = mojo.internal.bindings.lens.mojom.LensPageHandler_SaveAsImage_ParamsSpec || { $: {} };
if (mojo.internal.bindings.lens.mojom.LensPageHandler_SaveAsImage_ParamsSpec.$.structSpec && mojo.internal.bindings.lens.mojom.LensPageHandler_SaveAsImage_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.lens.mojom.LensPageHandler_SaveAsImage_ParamsSpec.$ = {};
mojo.internal.bindings.lens.mojom.LensPageHandler_ClosePreselectionBubble_ParamsSpec = mojo.internal.bindings.lens.mojom.LensPageHandler_ClosePreselectionBubble_ParamsSpec || { $: {} };
if (mojo.internal.bindings.lens.mojom.LensPageHandler_ClosePreselectionBubble_ParamsSpec.$.structSpec && mojo.internal.bindings.lens.mojom.LensPageHandler_ClosePreselectionBubble_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.lens.mojom.LensPageHandler_ClosePreselectionBubble_ParamsSpec.$ = {};
mojo.internal.bindings.lens.mojom.LensPageHandler_RecordUkmAndTaskCompletionForLensOverlayInteraction_ParamsSpec = mojo.internal.bindings.lens.mojom.LensPageHandler_RecordUkmAndTaskCompletionForLensOverlayInteraction_ParamsSpec || { $: {} };
if (mojo.internal.bindings.lens.mojom.LensPageHandler_RecordUkmAndTaskCompletionForLensOverlayInteraction_ParamsSpec.$.structSpec && mojo.internal.bindings.lens.mojom.LensPageHandler_RecordUkmAndTaskCompletionForLensOverlayInteraction_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.lens.mojom.LensPageHandler_RecordUkmAndTaskCompletionForLensOverlayInteraction_ParamsSpec.$ = {};
mojo.internal.bindings.lens.mojom.LensPageHandler_RecordLensOverlaySemanticEvent_ParamsSpec = mojo.internal.bindings.lens.mojom.LensPageHandler_RecordLensOverlaySemanticEvent_ParamsSpec || { $: {} };
if (mojo.internal.bindings.lens.mojom.LensPageHandler_RecordLensOverlaySemanticEvent_ParamsSpec.$.structSpec && mojo.internal.bindings.lens.mojom.LensPageHandler_RecordLensOverlaySemanticEvent_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.lens.mojom.LensPageHandler_RecordLensOverlaySemanticEvent_ParamsSpec.$ = {};
mojo.internal.bindings.lens.mojom.LensPageHandler_MaybeShowTranslateFeaturePromo_ParamsSpec = mojo.internal.bindings.lens.mojom.LensPageHandler_MaybeShowTranslateFeaturePromo_ParamsSpec || { $: {} };
if (mojo.internal.bindings.lens.mojom.LensPageHandler_MaybeShowTranslateFeaturePromo_ParamsSpec.$.structSpec && mojo.internal.bindings.lens.mojom.LensPageHandler_MaybeShowTranslateFeaturePromo_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.lens.mojom.LensPageHandler_MaybeShowTranslateFeaturePromo_ParamsSpec.$ = {};
mojo.internal.bindings.lens.mojom.LensPageHandler_MaybeCloseTranslateFeaturePromo_ParamsSpec = mojo.internal.bindings.lens.mojom.LensPageHandler_MaybeCloseTranslateFeaturePromo_ParamsSpec || { $: {} };
if (mojo.internal.bindings.lens.mojom.LensPageHandler_MaybeCloseTranslateFeaturePromo_ParamsSpec.$.structSpec && mojo.internal.bindings.lens.mojom.LensPageHandler_MaybeCloseTranslateFeaturePromo_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.lens.mojom.LensPageHandler_MaybeCloseTranslateFeaturePromo_ParamsSpec.$ = {};
mojo.internal.bindings.lens.mojom.LensPageHandler_FetchSupportedLanguages_ParamsSpec = mojo.internal.bindings.lens.mojom.LensPageHandler_FetchSupportedLanguages_ParamsSpec || { $: {} };
if (mojo.internal.bindings.lens.mojom.LensPageHandler_FetchSupportedLanguages_ParamsSpec.$.structSpec && mojo.internal.bindings.lens.mojom.LensPageHandler_FetchSupportedLanguages_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.lens.mojom.LensPageHandler_FetchSupportedLanguages_ParamsSpec.$ = {};
mojo.internal.bindings.lens.mojom.LensPageHandler_FetchSupportedLanguages_ResponseParamsSpec = mojo.internal.bindings.lens.mojom.LensPageHandler_FetchSupportedLanguages_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.lens.mojom.LensPageHandler_FetchSupportedLanguages_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.lens.mojom.LensPageHandler_FetchSupportedLanguages_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.lens.mojom.LensPageHandler_FetchSupportedLanguages_ResponseParamsSpec.$ = {};
mojo.internal.bindings.lens.mojom.LensPageHandler_FinishReshowOverlay_ParamsSpec = mojo.internal.bindings.lens.mojom.LensPageHandler_FinishReshowOverlay_ParamsSpec || { $: {} };
if (mojo.internal.bindings.lens.mojom.LensPageHandler_FinishReshowOverlay_ParamsSpec.$.structSpec && mojo.internal.bindings.lens.mojom.LensPageHandler_FinishReshowOverlay_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.lens.mojom.LensPageHandler_FinishReshowOverlay_ParamsSpec.$ = {};
mojo.internal.bindings.lens.mojom.LensPageHandler_AcceptPrivacyNotice_ParamsSpec = mojo.internal.bindings.lens.mojom.LensPageHandler_AcceptPrivacyNotice_ParamsSpec || { $: {} };
if (mojo.internal.bindings.lens.mojom.LensPageHandler_AcceptPrivacyNotice_ParamsSpec.$.structSpec && mojo.internal.bindings.lens.mojom.LensPageHandler_AcceptPrivacyNotice_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.lens.mojom.LensPageHandler_AcceptPrivacyNotice_ParamsSpec.$ = {};
mojo.internal.bindings.lens.mojom.LensPageHandler_DismissPrivacyNotice_ParamsSpec = mojo.internal.bindings.lens.mojom.LensPageHandler_DismissPrivacyNotice_ParamsSpec || { $: {} };
if (mojo.internal.bindings.lens.mojom.LensPageHandler_DismissPrivacyNotice_ParamsSpec.$.structSpec && mojo.internal.bindings.lens.mojom.LensPageHandler_DismissPrivacyNotice_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.lens.mojom.LensPageHandler_DismissPrivacyNotice_ParamsSpec.$ = {};
mojo.internal.bindings.lens.mojom.LensPage = mojo.internal.bindings.lens.mojom.LensPage || {};
mojo.internal.bindings.lens.mojom.LensPageSpec = mojo.internal.bindings.lens.mojom.LensPageSpec || { $ : {} };
if (mojo.internal.bindings.lens.mojom.LensPageSpec.$.structSpec && mojo.internal.bindings.lens.mojom.LensPageSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.lens.mojom.LensPageSpec.$ = {};
mojo.internal.bindings.lens.mojom.LensPage.$interfaceName = 'lens.mojom.LensPage';
mojo.internal.bindings.lens.mojom.LensPage_ScreenshotDataReceived_ParamsSpec = mojo.internal.bindings.lens.mojom.LensPage_ScreenshotDataReceived_ParamsSpec || { $: {} };
if (mojo.internal.bindings.lens.mojom.LensPage_ScreenshotDataReceived_ParamsSpec.$.structSpec && mojo.internal.bindings.lens.mojom.LensPage_ScreenshotDataReceived_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.lens.mojom.LensPage_ScreenshotDataReceived_ParamsSpec.$ = {};
mojo.internal.bindings.lens.mojom.LensPage_NotifyHandshakeComplete_ParamsSpec = mojo.internal.bindings.lens.mojom.LensPage_NotifyHandshakeComplete_ParamsSpec || { $: {} };
if (mojo.internal.bindings.lens.mojom.LensPage_NotifyHandshakeComplete_ParamsSpec.$.structSpec && mojo.internal.bindings.lens.mojom.LensPage_NotifyHandshakeComplete_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.lens.mojom.LensPage_NotifyHandshakeComplete_ParamsSpec.$ = {};
mojo.internal.bindings.lens.mojom.LensPage_NotifyResultsPanelOpened_ParamsSpec = mojo.internal.bindings.lens.mojom.LensPage_NotifyResultsPanelOpened_ParamsSpec || { $: {} };
if (mojo.internal.bindings.lens.mojom.LensPage_NotifyResultsPanelOpened_ParamsSpec.$.structSpec && mojo.internal.bindings.lens.mojom.LensPage_NotifyResultsPanelOpened_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.lens.mojom.LensPage_NotifyResultsPanelOpened_ParamsSpec.$ = {};
mojo.internal.bindings.lens.mojom.LensPage_NotifyOverlayClosing_ParamsSpec = mojo.internal.bindings.lens.mojom.LensPage_NotifyOverlayClosing_ParamsSpec || { $: {} };
if (mojo.internal.bindings.lens.mojom.LensPage_NotifyOverlayClosing_ParamsSpec.$.structSpec && mojo.internal.bindings.lens.mojom.LensPage_NotifyOverlayClosing_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.lens.mojom.LensPage_NotifyOverlayClosing_ParamsSpec.$ = {};
mojo.internal.bindings.lens.mojom.LensPage_ObjectsReceived_ParamsSpec = mojo.internal.bindings.lens.mojom.LensPage_ObjectsReceived_ParamsSpec || { $: {} };
if (mojo.internal.bindings.lens.mojom.LensPage_ObjectsReceived_ParamsSpec.$.structSpec && mojo.internal.bindings.lens.mojom.LensPage_ObjectsReceived_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.lens.mojom.LensPage_ObjectsReceived_ParamsSpec.$ = {};
mojo.internal.bindings.lens.mojom.LensPage_TextReceived_ParamsSpec = mojo.internal.bindings.lens.mojom.LensPage_TextReceived_ParamsSpec || { $: {} };
if (mojo.internal.bindings.lens.mojom.LensPage_TextReceived_ParamsSpec.$.structSpec && mojo.internal.bindings.lens.mojom.LensPage_TextReceived_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.lens.mojom.LensPage_TextReceived_ParamsSpec.$ = {};
mojo.internal.bindings.lens.mojom.LensPage_RegionTextReceived_ParamsSpec = mojo.internal.bindings.lens.mojom.LensPage_RegionTextReceived_ParamsSpec || { $: {} };
if (mojo.internal.bindings.lens.mojom.LensPage_RegionTextReceived_ParamsSpec.$.structSpec && mojo.internal.bindings.lens.mojom.LensPage_RegionTextReceived_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.lens.mojom.LensPage_RegionTextReceived_ParamsSpec.$ = {};
mojo.internal.bindings.lens.mojom.LensPage_ThemeReceived_ParamsSpec = mojo.internal.bindings.lens.mojom.LensPage_ThemeReceived_ParamsSpec || { $: {} };
if (mojo.internal.bindings.lens.mojom.LensPage_ThemeReceived_ParamsSpec.$.structSpec && mojo.internal.bindings.lens.mojom.LensPage_ThemeReceived_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.lens.mojom.LensPage_ThemeReceived_ParamsSpec.$ = {};
mojo.internal.bindings.lens.mojom.LensPage_ShouldShowContextualSearchBox_ParamsSpec = mojo.internal.bindings.lens.mojom.LensPage_ShouldShowContextualSearchBox_ParamsSpec || { $: {} };
if (mojo.internal.bindings.lens.mojom.LensPage_ShouldShowContextualSearchBox_ParamsSpec.$.structSpec && mojo.internal.bindings.lens.mojom.LensPage_ShouldShowContextualSearchBox_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.lens.mojom.LensPage_ShouldShowContextualSearchBox_ParamsSpec.$ = {};
mojo.internal.bindings.lens.mojom.LensPage_PageContentTypeChanged_ParamsSpec = mojo.internal.bindings.lens.mojom.LensPage_PageContentTypeChanged_ParamsSpec || { $: {} };
if (mojo.internal.bindings.lens.mojom.LensPage_PageContentTypeChanged_ParamsSpec.$.structSpec && mojo.internal.bindings.lens.mojom.LensPage_PageContentTypeChanged_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.lens.mojom.LensPage_PageContentTypeChanged_ParamsSpec.$ = {};
mojo.internal.bindings.lens.mojom.LensPage_SetPostRegionSelection_ParamsSpec = mojo.internal.bindings.lens.mojom.LensPage_SetPostRegionSelection_ParamsSpec || { $: {} };
if (mojo.internal.bindings.lens.mojom.LensPage_SetPostRegionSelection_ParamsSpec.$.structSpec && mojo.internal.bindings.lens.mojom.LensPage_SetPostRegionSelection_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.lens.mojom.LensPage_SetPostRegionSelection_ParamsSpec.$ = {};
mojo.internal.bindings.lens.mojom.LensPage_SetTextSelection_ParamsSpec = mojo.internal.bindings.lens.mojom.LensPage_SetTextSelection_ParamsSpec || { $: {} };
if (mojo.internal.bindings.lens.mojom.LensPage_SetTextSelection_ParamsSpec.$.structSpec && mojo.internal.bindings.lens.mojom.LensPage_SetTextSelection_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.lens.mojom.LensPage_SetTextSelection_ParamsSpec.$ = {};
mojo.internal.bindings.lens.mojom.LensPage_SetTranslateMode_ParamsSpec = mojo.internal.bindings.lens.mojom.LensPage_SetTranslateMode_ParamsSpec || { $: {} };
if (mojo.internal.bindings.lens.mojom.LensPage_SetTranslateMode_ParamsSpec.$.structSpec && mojo.internal.bindings.lens.mojom.LensPage_SetTranslateMode_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.lens.mojom.LensPage_SetTranslateMode_ParamsSpec.$ = {};
mojo.internal.bindings.lens.mojom.LensPage_ClearRegionSelection_ParamsSpec = mojo.internal.bindings.lens.mojom.LensPage_ClearRegionSelection_ParamsSpec || { $: {} };
if (mojo.internal.bindings.lens.mojom.LensPage_ClearRegionSelection_ParamsSpec.$.structSpec && mojo.internal.bindings.lens.mojom.LensPage_ClearRegionSelection_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.lens.mojom.LensPage_ClearRegionSelection_ParamsSpec.$ = {};
mojo.internal.bindings.lens.mojom.LensPage_ClearTextSelection_ParamsSpec = mojo.internal.bindings.lens.mojom.LensPage_ClearTextSelection_ParamsSpec || { $: {} };
if (mojo.internal.bindings.lens.mojom.LensPage_ClearTextSelection_ParamsSpec.$.structSpec && mojo.internal.bindings.lens.mojom.LensPage_ClearTextSelection_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.lens.mojom.LensPage_ClearTextSelection_ParamsSpec.$ = {};
mojo.internal.bindings.lens.mojom.LensPage_ClearAllSelections_ParamsSpec = mojo.internal.bindings.lens.mojom.LensPage_ClearAllSelections_ParamsSpec || { $: {} };
if (mojo.internal.bindings.lens.mojom.LensPage_ClearAllSelections_ParamsSpec.$.structSpec && mojo.internal.bindings.lens.mojom.LensPage_ClearAllSelections_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.lens.mojom.LensPage_ClearAllSelections_ParamsSpec.$ = {};
mojo.internal.bindings.lens.mojom.LensPage_OnCopyCommand_ParamsSpec = mojo.internal.bindings.lens.mojom.LensPage_OnCopyCommand_ParamsSpec || { $: {} };
if (mojo.internal.bindings.lens.mojom.LensPage_OnCopyCommand_ParamsSpec.$.structSpec && mojo.internal.bindings.lens.mojom.LensPage_OnCopyCommand_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.lens.mojom.LensPage_OnCopyCommand_ParamsSpec.$ = {};
mojo.internal.bindings.lens.mojom.LensPage_SuppressGhostLoader_ParamsSpec = mojo.internal.bindings.lens.mojom.LensPage_SuppressGhostLoader_ParamsSpec || { $: {} };
if (mojo.internal.bindings.lens.mojom.LensPage_SuppressGhostLoader_ParamsSpec.$.structSpec && mojo.internal.bindings.lens.mojom.LensPage_SuppressGhostLoader_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.lens.mojom.LensPage_SuppressGhostLoader_ParamsSpec.$ = {};
mojo.internal.bindings.lens.mojom.LensPage_OnOverlayReshown_ParamsSpec = mojo.internal.bindings.lens.mojom.LensPage_OnOverlayReshown_ParamsSpec || { $: {} };
if (mojo.internal.bindings.lens.mojom.LensPage_OnOverlayReshown_ParamsSpec.$.structSpec && mojo.internal.bindings.lens.mojom.LensPage_OnOverlayReshown_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.lens.mojom.LensPage_OnOverlayReshown_ParamsSpec.$ = {};
        ...
        case 7: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const resp_obj = { 'arg_invocation_source': val };
...
mojo.internal.Struct(
    mojo.internal.bindings.lens.mojom.LensPageHandlerFactory_CreatePageHandler_ParamsSpec, 'lens.mojom.LensPageHandlerFactory_CreatePageHandler_Params', [
      mojo.internal.StructField('arg_handler', 0, 0, mojo.internal.InterfaceRequest(mojo.internal.bindings.lens.mojom.LensPageHandlerPendingReceiver), null, false, 0, undefined),
