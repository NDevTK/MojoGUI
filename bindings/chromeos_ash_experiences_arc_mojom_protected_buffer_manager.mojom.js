...
mojo.internal.bindings.media.stable.mojom.NativePixmapHandleSpec = mojo.internal.bindings.media.stable.mojom.NativePixmapHandleSpec || { $: mojo.internal.OpaqueStruct.$ };
mojo.internal.bindings.mojo_base = mojo.internal.bindings.mojo_base || {};
...
mojo.internal.bindings.arc.mojom.ProtectedBufferManagerRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.arc.mojom.ProtectedBufferManagerRemoteCallHandler(this.proxy);
  }
  ...
  deprecatedGetProtectedSharedMemoryFromHandle(arg_dummy_handle) {
    return this.$.deprecatedGetProtectedSharedMemoryFromHandle(arg_dummy_handle);
  }
  getProtectedSharedMemoryFromHandle(arg_dummy_handle) {
    return this.$.getProtectedSharedMemoryFromHandle(arg_dummy_handle);
  }
  getProtectedNativePixmapHandleFromHandle(arg_dummy_handle) {
    return this.$.getProtectedNativePixmapHandleFromHandle(arg_dummy_handle);
  }
  isProtectedNativePixmapHandle(arg_dummy_handle) {
    return this.$.isProtectedNativePixmapHandle(arg_dummy_handle);
  }
};
...
mojo.internal.bindings.arc.mojom.ProtectedBufferManager.getRemote = function() {
  let remote = new mojo.internal.bindings.arc.mojom.ProtectedBufferManagerRemote();
...
mojo.internal.bindings.arc.mojom.ProtectedBufferManagerReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.arc.mojom.ProtectedBufferManager_DeprecatedGetProtectedSharedMemoryFromHandle_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for DeprecatedGetProtectedSharedMemoryFromHandle failed with TypeError');
           }
        }
        // Try Method 1: GetProtectedSharedMemoryFromHandle
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.arc.mojom.ProtectedBufferManager_GetProtectedSharedMemoryFromHandle_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for GetProtectedSharedMemoryFromHandle failed with TypeError');
           }
        }
        // Try Method 2: GetProtectedNativePixmapHandleFromHandle
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.arc.mojom.ProtectedBufferManager_GetProtectedNativePixmapHandleFromHandle_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for GetProtectedNativePixmapHandleFromHandle failed with TypeError');
           }
        }
        // Try Method 3: IsProtectedNativePixmapHandle
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.arc.mojom.ProtectedBufferManager_IsProtectedNativePixmapHandle_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for IsProtectedNativePixmapHandle failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.arc.mojom.ProtectedBufferManagerReceiver = mojo.internal.bindings.arc.mojom.ProtectedBufferManagerReceiver;
