// Auto-generated MojoJS binding
 // Source: chromium_src/components/browser_apis/ui_controllers/toolbar/extensions_bar.mojom
...
mojo.internal.bindings.extensions_bar = mojo.internal.bindings.extensions_bar || {};
mojo.internal.bindings.extensions_bar.mojom = mojo.internal.bindings.extensions_bar.mojom || {};
mojo.internal.bindings.extensions_bar.mojom.ExtensionActionInfoSpec = mojo.internal.bindings.extensions_bar.mojom.ExtensionActionInfoSpec || { $: mojo.internal.OpaqueStruct.$ };
mojo.internal.bindings.toolbar_ui_api = mojo.internal.bindings.toolbar_ui_api || {};
mojo.internal.bindings.toolbar_ui_api.mojom = mojo.internal.bindings.toolbar_ui_api.mojom || {};
mojo.internal.bindings.toolbar_ui_api.mojom.IconUpdateSpec = mojo.internal.bindings.toolbar_ui_api.mojom.IconUpdateSpec || { $: mojo.internal.OpaqueStruct.$ };
mojo.internal.bindings.ui = mojo.internal.bindings.ui || {};
...
mojo.internal.bindings.extensions_bar.mojom.PageHandlerFactoryRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('extensions_bar.mojom.PageHandlerFactory', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.extensions_bar.mojom.PageHandlerFactoryReceiver = class {
  constructor(impl) {
    ...
    const ordinals = window.mojoScrambler.getOrdinals('extensions_bar.mojom.PageHandlerFactory', [
      { explicit: null },
    ]);
...
mojo.internal.bindings.extensions_bar.mojom.PageHandlerRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('extensions_bar.mojom.PageHandler', [
      { explicit: null },
      { explicit: null },
      { explicit: null },
      { explicit: null },
...
mojo.internal.bindings.extensions_bar.mojom.PageRemote = class {
  ...
  actionsAddedOrUpdated(arg_icons, arg_actions) {
    return this.$.actionsAddedOrUpdated(arg_icons, arg_actions);
  }
  actionRemoved(arg_icons, arg_id) {
    return this.$.actionRemoved(arg_icons, arg_id);
  }
  actionPoppedOut() {
...
mojo.internal.bindings.extensions_bar.mojom.PageRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('extensions_bar.mojom.Page', [
      { explicit: null },
      { explicit: null },
      { explicit: null },
    ]);
...
mojo.internal.bindings.extensions_bar.mojom.PageReceiver = class {
  constructor(impl) {
    ...
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('extensions_bar.mojom.Page', [
      { explicit: null },
      { explicit: null },
      { explicit: null },
    ]);
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        case 0: {
          ...
          const result = this.impl.actionsAddedOrUpdated(params.arg_icons, params.arg_actions);
          break;
        }
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          ...
          const result = this.impl.actionRemoved(params.arg_icons, params.arg_id);
          break;
        }
        case 2: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const message = new mojo.internal.Message(
                ...
                header.ordinal, header.requestId, mojo.internal.bindings.extensions_bar.mojom.Page_ActionPoppedOut_ResponseParamsSpec.$.structSpec, resp_obj);
...
mojo.internal.Struct(
    mojo.internal.bindings.extensions_bar.mojom.PageHandlerFactory_CreatePageHandler_ParamsSpec, 'extensions_bar.mojom.PageHandlerFactory_CreatePageHandler_Params', [
      mojo.internal.StructField('arg_page', 0, 0, mojo.internal.InterfaceProxy(mojo.internal.bindings.extensions_bar.mojom.PageRemote), null, false, 0, undefined),
      mojo.internal.StructField('arg_handler', 8, 0, mojo.internal.InterfaceRequest(mojo.internal.bindings.extensions_bar.mojom.PageHandlerPendingReceiver), null, false, 0, undefined),
    ],
    [[0, 24]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.extensions_bar.mojom.Page_ActionsAddedOrUpdated_ParamsSpec, 'extensions_bar.mojom.Page_ActionsAddedOrUpdated_Params', [
      ...
      mojo.internal.StructField('arg_actions', 8, 0, mojo.internal.Array(mojo.internal.bindings.extensions_bar.mojom.ExtensionActionInfoSpec, false), null, false, 0, undefined),
    ],
    [[0, 24]]);
