...
mojo.internal.bindings.ui.mojom.ScenicGpuService = {};
mojo.internal.bindings.ui.mojom.ScenicGpuServiceSpec = { $ : {} };
...
mojo.internal.bindings.ui.mojom.ScenicGpuServiceRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.ui.mojom.ScenicGpuServicePendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.ui.mojom.ScenicGpuServiceRemoteCallHandler(this.proxy);
  }
  ...
  initialize(arg_scenic_gpu_host) {
    return this.$.initialize(arg_scenic_gpu_host);
  }
};

mojo.internal.bindings.ui.mojom.ScenicGpuServiceRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('ui.mojom.ScenicGpuService', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.ui.mojom.ScenicGpuService.getRemote = function() {
  let remote = new mojo.internal.bindings.ui.mojom.ScenicGpuServiceRemote();
...
mojo.internal.bindings.ui.mojom.ScenicGpuServiceReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('ui.mojom.ScenicGpuService', [
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.ui.mojom.ScenicGpuService_Initialize_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.ui.mojom.ScenicGpuServiceReceiver = mojo.internal.bindings.ui.mojom.ScenicGpuServiceReceiver;
