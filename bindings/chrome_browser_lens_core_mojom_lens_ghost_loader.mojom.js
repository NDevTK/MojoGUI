...
mojo.internal.bindings.lens.mojom.LensGhostLoaderPageHandlerFactoryRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.lens.mojom.LensGhostLoaderPageHandlerFactoryPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.lens.mojom.LensGhostLoaderPageHandlerFactoryRemoteCallHandler(this.proxy);
  }
  ...
  createGhostLoaderPage(arg_page) {
    return this.$.createGhostLoaderPage(arg_page);
  }
};
...
mojo.internal.bindings.lens.mojom.LensGhostLoaderPageHandlerFactory.getRemote = function() {
  let remote = new mojo.internal.bindings.lens.mojom.LensGhostLoaderPageHandlerFactoryRemote();
...
mojo.internal.bindings.lens.mojom.LensGhostLoaderPageHandlerFactoryReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.lens.mojom.LensGhostLoaderPageHandlerFactory_CreateGhostLoaderPage_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for CreateGhostLoaderPage failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.lens.mojom.LensGhostLoaderPageHandlerFactoryReceiver = mojo.internal.bindings.lens.mojom.LensGhostLoaderPageHandlerFactoryReceiver;

mojo.internal.bindings.lens.mojom.LensGhostLoaderPageHandlerFactoryPtr = mojo.internal.bindings.lens.mojom.LensGhostLoaderPageHandlerFactoryRemote;
mojo.internal.bindings.lens.mojom.LensGhostLoaderPageHandlerFactoryRequest = mojo.internal.bindings.lens.mojom.LensGhostLoaderPageHandlerFactoryPendingReceiver;
...
mojo.internal.bindings.lens.mojom.LensGhostLoaderPageRemote = class {
  static get $interfaceName() {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.lens.mojom.LensGhostLoaderPagePendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.lens.mojom.LensGhostLoaderPageRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.lens.mojom.LensGhostLoaderPage.getRemote = function() {
  let remote = new mojo.internal.bindings.lens.mojom.LensGhostLoaderPageRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
...
mojo.internal.bindings.lens.mojom.LensGhostLoaderPageReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.lens.mojom.LensGhostLoaderPage_ShowErrorState_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for ShowErrorState failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
             console.warn('[GeneratedReceiver] Failed to discover ordinal ' + header.ordinal);
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.lens.mojom.LensGhostLoaderPage_ShowErrorState_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.lens.mojom.LensGhostLoaderPageReceiver = mojo.internal.bindings.lens.mojom.LensGhostLoaderPageReceiver;
