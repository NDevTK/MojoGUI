...
mojo.internal.Struct(
    mojo.internal.bindings.arc.mojom.FeatureFlagsSpec, 'arc.mojom.FeatureFlags', [
      ...
      mojo.internal.StructField('arg_rounded_window_compat_strategy', 4, 0, mojo.internal.bindings.arc.mojom.RoundedWindowCompatStrategySpec, null, false, 3, undefined),
      mojo.internal.StructField('arg_rounded_window_radius', 8, 0, mojo.internal.Int32, 0, false, 3, undefined),
      mojo.internal.StructField('arg_xdg_mode', 12, 0, mojo.internal.Bool, false, false, 4, undefined),
      mojo.internal.StructField('arg_enable_pip_double_tap', 12, 1, mojo.internal.Bool, false, false, 5, undefined),
      mojo.internal.StructField('arg_render_arc_notifications_by_chrome', 12, 2, mojo.internal.Bool, false, false, 6, undefined),
      mojo.internal.StructField('arg_game_dashboard', 12, 3, mojo.internal.Bool, false, false, 7, undefined),
      mojo.internal.StructField('arg_resize_compat', 12, 4, mojo.internal.Bool, false, false, 8, undefined),
      mojo.internal.StructField('arg_ignore_hover_event_anr', 12, 5, mojo.internal.Bool, false, false, 9, undefined),
      mojo.internal.StructField('arg_extend_input_anr_timeout', 12, 6, mojo.internal.Bool, false, false, 10, undefined),
      mojo.internal.StructField('arg_notification_width_increase', 12, 7, mojo.internal.Bool, false, false, 11, undefined),
      mojo.internal.StructField('arg_enable_friendlier_error_dialog', 13, 0, mojo.internal.Bool, false, false, 12, undefined),
      mojo.internal.StructField('arg_extend_service_anr_timeout', 13, 1, mojo.internal.Bool, false, false, 13, undefined),
      mojo.internal.StructField('arg_extend_intent_anr_timeout', 13, 2, mojo.internal.Bool, false, false, 14, undefined),
    ],
...
mojo.internal.bindings.arc.mojom.ChromeFeatureFlagsInstanceRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('arc.mojom.ChromeFeatureFlagsInstance', [
      { explicit: 1 },
    ]);
  }
...
mojo.internal.bindings.arc.mojom.ChromeFeatureFlagsInstanceReceiver = class {
  constructor(impl) {
    ...
    const ordinals = window.mojoScrambler.getOrdinals('arc.mojom.ChromeFeatureFlagsInstance', [
      { explicit: 1 },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.arc.mojom.ChromeFeatureFlagsInstance_NotifyFeatureFlags_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for NotifyFeatureFlags failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
