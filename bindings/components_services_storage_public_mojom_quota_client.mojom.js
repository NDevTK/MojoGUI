...
mojo.internal.bindings.storage.mojom.QuotaClientRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.storage.mojom.QuotaClientPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.storage.mojom.QuotaClientRemoteCallHandler(this.proxy);
  }
  ...
  getBucketUsage(arg_bucket) {
    return this.$.getBucketUsage(arg_bucket);
  }
  getDefaultStorageKeys() {
    return this.$.getDefaultStorageKeys();
  }
  deleteBucketData(arg_bucket) {
    return this.$.deleteBucketData(arg_bucket);
  }
...
mojo.internal.bindings.storage.mojom.QuotaClient.getRemote = function() {
  let remote = new mojo.internal.bindings.storage.mojom.QuotaClientRemote();
...
mojo.internal.bindings.storage.mojom.QuotaClientReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.storage.mojom.QuotaClient_GetBucketUsage_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for GetBucketUsage failed with TypeError');
           }
        }
        // Try Method 1: GetDefaultStorageKeys
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.storage.mojom.QuotaClient_GetDefaultStorageKeys_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for GetDefaultStorageKeys failed with TypeError');
           }
        }
        // Try Method 2: DeleteBucketData
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.storage.mojom.QuotaClient_DeleteBucketData_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for DeleteBucketData failed with TypeError');
           }
        }
        // Try Method 3: PerformStorageCleanup
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.storage.mojom.QuotaClient_PerformStorageCleanup_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
      ...
      switch (dispatchId) {
        ...
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.storage.mojom.QuotaClient_GetDefaultStorageKeys_ParamsSpec.$.structSpec);
        ...
        case 3: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.storage.mojom.QuotaClient_PerformStorageCleanup_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.storage.mojom.QuotaClientReceiver = mojo.internal.bindings.storage.mojom.QuotaClientReceiver;
