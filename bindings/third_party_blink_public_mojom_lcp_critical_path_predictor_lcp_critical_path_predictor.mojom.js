...
mojo.internal.bindings.blink.mojom.LcpElementSpec = { $: {} };
mojo.internal.bindings.blink.mojom.LCPCriticalPathPredictorNavigationTimeHintSpec = { $: {} };
mojo.internal.bindings.blink.mojom.LCPCriticalPathPredictorHost = {};
mojo.internal.bindings.blink.mojom.LCPCriticalPathPredictorHostSpec = { $ : {} };
mojo.internal.bindings.blink.mojom.LCPCriticalPathPredictorHost.$interfaceName = 'blink.mojom.LCPCriticalPathPredictorHost';
...
mojo.internal.bindings.blink.mojom.LCPCriticalPathPredictorHostPendingReceiver = class {
  constructor(handle) {
    this.handle = handle;
  }
};

mojo.internal.bindings.blink.mojom.LCPCriticalPathPredictorHostRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.blink.mojom.LCPCriticalPathPredictorHostPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.blink.mojom.LCPCriticalPathPredictorHostRemoteCallHandler(this.proxy);
  }
  ...
  onLcpUpdated(arg_lcp_element) {
    return this.$.onLcpUpdated(arg_lcp_element);
  }
  onLcpTimingPredictedForTesting(arg_element_locator) {
    return this.$.onLcpTimingPredictedForTesting(arg_element_locator);
  }
  setLcpInfluencerScriptUrls(arg_lcp_influencer_scripts) {
    return this.$.setLcpInfluencerScriptUrls(arg_lcp_influencer_scripts);
  }
  addPreconnectOrigin(arg_origin) {
    return this.$.addPreconnectOrigin(arg_origin);
  }
  notifyFetchedFont(arg_font_url, arg_hit) {
    return this.$.notifyFetchedFont(arg_font_url, arg_hit);
  }
  notifyFetchedSubresource(arg_subresource_url, arg_subresource_load_start, arg_request_destination) {
    return this.$.notifyFetchedSubresource(arg_subresource_url, arg_subresource_load_start, arg_request_destination);
  }
  setUnusedPreloads(arg_unused_preloads) {
    return this.$.setUnusedPreloads(arg_unused_preloads);
  }
};

mojo.internal.bindings.blink.mojom.LCPCriticalPathPredictorHostRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('blink.mojom.LCPCriticalPathPredictorHost', [
      { explicit: null },
      { explicit: null },
      { explicit: null },
      { explicit: null },
...
mojo.internal.bindings.blink.mojom.LCPCriticalPathPredictorHost.getRemote = function() {
  let remote = new mojo.internal.bindings.blink.mojom.LCPCriticalPathPredictorHostRemote();
...
mojo.internal.bindings.blink.mojom.LCPCriticalPathPredictorHostReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('blink.mojom.LCPCriticalPathPredictorHost', [
      { explicit: null },
      { explicit: null },
      { explicit: null },
      { explicit: null },
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.blink.mojom.LCPCriticalPathPredictorHost_OnLcpUpdated_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OnLcpUpdated failed with TypeError');
           }
        }
        // Try Method 1: OnLcpTimingPredictedForTesting
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.blink.mojom.LCPCriticalPathPredictorHost_OnLcpTimingPredictedForTesting_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OnLcpTimingPredictedForTesting failed with TypeError');
           }
        }
        // Try Method 2: SetLcpInfluencerScriptUrls
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.blink.mojom.LCPCriticalPathPredictorHost_SetLcpInfluencerScriptUrls_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for SetLcpInfluencerScriptUrls failed with TypeError');
           }
        }
        // Try Method 3: AddPreconnectOrigin
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.blink.mojom.LCPCriticalPathPredictorHost_AddPreconnectOrigin_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for AddPreconnectOrigin failed with TypeError');
           }
        }
        // Try Method 4: NotifyFetchedFont
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.blink.mojom.LCPCriticalPathPredictorHost_NotifyFetchedFont_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for NotifyFetchedFont failed with TypeError');
           }
        }
        // Try Method 5: NotifyFetchedSubresource
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.blink.mojom.LCPCriticalPathPredictorHost_NotifyFetchedSubresource_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for NotifyFetchedSubresource failed with TypeError');
           }
        }
        // Try Method 6: SetUnusedPreloads
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.blink.mojom.LCPCriticalPathPredictorHost_SetUnusedPreloads_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for SetUnusedPreloads failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.blink.mojom.LCPCriticalPathPredictorHostReceiver = mojo.internal.bindings.blink.mojom.LCPCriticalPathPredictorHostReceiver;

mojo.internal.bindings.blink.mojom.LCPCriticalPathPredictorHostPtr = mojo.internal.bindings.blink.mojom.LCPCriticalPathPredictorHostRemote;
mojo.internal.bindings.blink.mojom.LCPCriticalPathPredictorHostRequest = mojo.internal.bindings.blink.mojom.LCPCriticalPathPredictorHostPendingReceiver;
