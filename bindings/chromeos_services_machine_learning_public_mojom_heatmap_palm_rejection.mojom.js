...
mojo.internal.bindings.chromeos.machine_learning.mojom.LoadHeatmapPalmRejectionResult = {
  OK: 0,
  UNKNOWN_ERROR: 1,
  LOAD_MODEL_ERROR: 2,
...
mojo.internal.Struct(
    mojo.internal.bindings.chromeos.machine_learning.mojom.HeatmapPalmRejectionConfigSpec, 'chromeos.machine_learning.mojom.HeatmapPalmRejectionConfig', [
      mojo.internal.StructField('arg_tf_model_path', 0, 0, mojo.internal.String, null, false, 0, undefined),
...
mojo.internal.Struct(
    mojo.internal.bindings.chromeos.machine_learning.mojom.HeatmapProcessedEventSpec, 'chromeos.machine_learning.mojom.HeatmapProcessedEvent', [
      mojo.internal.StructField('arg_timestamp', 0, 0, mojo.internal.bindings.mojo_base.mojom.TimeSpec.$, null, false, 0, undefined),
      mojo.internal.StructField('arg_is_palm', 8, 0, mojo.internal.Bool, false, false, 0, undefined),
    ],
    [[0, 24]]);

// Struct: CropHeatmap
mojo.internal.Struct(
    mojo.internal.bindings.chromeos.machine_learning.mojom.CropHeatmapSpec, 'chromeos.machine_learning.mojom.CropHeatmap', [
      mojo.internal.StructField('arg_bottom_crop', 0, 0, mojo.internal.Uint8, 0, false, 0, undefined),
      mojo.internal.StructField('arg_left_crop', 1, 0, mojo.internal.Uint8, 0, false, 0, undefined),
      mojo.internal.StructField('arg_right_crop', 2, 0, mojo.internal.Uint8, 0, false, 0, undefined),
      mojo.internal.StructField('arg_top_crop', 3, 0, mojo.internal.Uint8, 0, false, 0, undefined),
    ],
    [[0, 16]]);
...
mojo.internal.bindings.chromeos.machine_learning.mojom.HeatmapPalmRejectionClientPendingReceiver = class {
  constructor(handle) {
    this.handle = handle;
  }
};

mojo.internal.bindings.chromeos.machine_learning.mojom.HeatmapPalmRejectionClientRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.chromeos.machine_learning.mojom.HeatmapPalmRejectionClientRemoteCallHandler(this.proxy);
  }
  ...
  onHeatmapProcessedEvent(arg_event) {
    return this.$.onHeatmapProcessedEvent(arg_event);
  }
};

mojo.internal.bindings.chromeos.machine_learning.mojom.HeatmapPalmRejectionClientRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('chromeos.machine_learning.mojom.HeatmapPalmRejectionClient', [
      { explicit: 0 },
    ]);
  }
...
mojo.internal.bindings.chromeos.machine_learning.mojom.HeatmapPalmRejectionClient.getRemote = function() {
  let remote = new mojo.internal.bindings.chromeos.machine_learning.mojom.HeatmapPalmRejectionClientRemote();
...
mojo.internal.bindings.chromeos.machine_learning.mojom.HeatmapPalmRejectionClientReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('chromeos.machine_learning.mojom.HeatmapPalmRejectionClient', [
      { explicit: 0 },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.chromeos.machine_learning.mojom.HeatmapPalmRejectionClient_OnHeatmapProcessedEvent_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OnHeatmapProcessedEvent failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.chromeos.machine_learning.mojom.HeatmapPalmRejectionClientReceiver = mojo.internal.bindings.chromeos.machine_learning.mojom.HeatmapPalmRejectionClientReceiver;

mojo.internal.bindings.chromeos.machine_learning.mojom.HeatmapPalmRejectionClientPtr = mojo.internal.bindings.chromeos.machine_learning.mojom.HeatmapPalmRejectionClientRemote;
mojo.internal.bindings.chromeos.machine_learning.mojom.HeatmapPalmRejectionClientRequest = mojo.internal.bindings.chromeos.machine_learning.mojom.HeatmapPalmRejectionClientPendingReceiver;
