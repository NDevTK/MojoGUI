...
mojo.internal.bindings.chromeos.payments.mojom.PaymentAppInstanceRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.chromeos.payments.mojom.PaymentAppInstanceRemoteCallHandler(this.proxy);
  }
  ...
  isPaymentImplemented(arg_package_name) {
    return this.$.isPaymentImplemented(arg_package_name);
  }
  isReadyToPay(arg_parameters) {
    return this.$.isReadyToPay(arg_parameters);
  }
  invokePaymentApp(arg_parameters) {
    return this.$.invokePaymentApp(arg_parameters);
  }
  abortPaymentApp(arg_request_token) {
    return this.$.abortPaymentApp(arg_request_token);
  }
};
...
mojo.internal.bindings.chromeos.payments.mojom.PaymentAppInstance.getRemote = function() {
  let remote = new mojo.internal.bindings.chromeos.payments.mojom.PaymentAppInstanceRemote();
...
mojo.internal.bindings.chromeos.payments.mojom.PaymentAppInstanceReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.chromeos.payments.mojom.PaymentAppInstance_IsPaymentImplemented_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for IsPaymentImplemented failed with TypeError');
           }
        }
        // Try Method 1: IsReadyToPay
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.chromeos.payments.mojom.PaymentAppInstance_IsReadyToPay_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for IsReadyToPay failed with TypeError');
           }
        }
        // Try Method 2: InvokePaymentApp
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.chromeos.payments.mojom.PaymentAppInstance_InvokePaymentApp_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for InvokePaymentApp failed with TypeError');
           }
        }
        // Try Method 3: AbortPaymentApp
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.chromeos.payments.mojom.PaymentAppInstance_AbortPaymentApp_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for AbortPaymentApp failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.chromeos.payments.mojom.PaymentAppInstanceReceiver = mojo.internal.bindings.chromeos.payments.mojom.PaymentAppInstanceReceiver;
