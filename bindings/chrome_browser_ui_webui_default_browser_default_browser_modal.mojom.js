// Auto-generated MojoJS binding
 // Source: chromium_src/chrome/browser/ui/webui/default_browser/default_browser_modal.mojom
 // Module: default_browser_modal.mojom
 ...
 mojo.internal.bindings.default_browser_modal = mojo.internal.bindings.default_browser_modal || {};
mojo.internal.bindings.default_browser_modal.mojom = mojo.internal.bindings.default_browser_modal.mojom || {};
mojo.internal.bindings.mojo_base = mojo.internal.bindings.mojo_base || {};
mojo.internal.bindings.mojo_base.mojom = mojo.internal.bindings.mojo_base.mojom || {};

mojo.internal.bindings.default_browser_modal.mojom.Page = mojo.internal.bindings.default_browser_modal.mojom.Page || {};
mojo.internal.bindings.default_browser_modal.mojom.PageSpec = mojo.internal.bindings.default_browser_modal.mojom.PageSpec || { $ : {} };
if (mojo.internal.bindings.default_browser_modal.mojom.PageSpec.$.structSpec && mojo.internal.bindings.default_browser_modal.mojom.PageSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.default_browser_modal.mojom.PageSpec.$ = {};
mojo.internal.bindings.default_browser_modal.mojom.Page.$interfaceName = 'default_browser_modal.mojom.Page';
mojo.internal.bindings.default_browser_modal.mojom.Page_OnHasAcceptedChanged_ParamsSpec = mojo.internal.bindings.default_browser_modal.mojom.Page_OnHasAcceptedChanged_ParamsSpec || { $: {} };
if (mojo.internal.bindings.default_browser_modal.mojom.Page_OnHasAcceptedChanged_ParamsSpec.$.structSpec && mojo.internal.bindings.default_browser_modal.mojom.Page_OnHasAcceptedChanged_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.default_browser_modal.mojom.Page_OnHasAcceptedChanged_ParamsSpec.$ = {};
mojo.internal.bindings.default_browser_modal.mojom.PageHandler = mojo.internal.bindings.default_browser_modal.mojom.PageHandler || {};
mojo.internal.bindings.default_browser_modal.mojom.PageHandlerSpec = mojo.internal.bindings.default_browser_modal.mojom.PageHandlerSpec || { $ : {} };
if (mojo.internal.bindings.default_browser_modal.mojom.PageHandlerSpec.$.structSpec && mojo.internal.bindings.default_browser_modal.mojom.PageHandlerSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.default_browser_modal.mojom.PageHandlerSpec.$ = {};
mojo.internal.bindings.default_browser_modal.mojom.PageHandler.$interfaceName = 'default_browser_modal.mojom.PageHandler';
mojo.internal.bindings.default_browser_modal.mojom.PageHandler_Confirm_ParamsSpec = mojo.internal.bindings.default_browser_modal.mojom.PageHandler_Confirm_ParamsSpec || { $: {} };
...
mojo.internal.bindings.default_browser_modal.mojom.PageHandler_TryAgain_ParamsSpec = mojo.internal.bindings.default_browser_modal.mojom.PageHandler_TryAgain_ParamsSpec || { $: {} };
if (mojo.internal.bindings.default_browser_modal.mojom.PageHandler_TryAgain_ParamsSpec.$.structSpec && mojo.internal.bindings.default_browser_modal.mojom.PageHandler_TryAgain_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.default_browser_modal.mojom.PageHandler_TryAgain_ParamsSpec.$ = {};
...
mojo.internal.bindings.default_browser_modal.mojom.PageHandler_ShowUI_ParamsSpec = mojo.internal.bindings.default_browser_modal.mojom.PageHandler_ShowUI_ParamsSpec || { $: {} };
if (mojo.internal.bindings.default_browser_modal.mojom.PageHandler_ShowUI_ParamsSpec.$.structSpec && mojo.internal.bindings.default_browser_modal.mojom.PageHandler_ShowUI_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.default_browser_modal.mojom.PageHandler_ShowUI_ParamsSpec.$ = {};
mojo.internal.bindings.default_browser_modal.mojom.PageHandler_CheckDefaultStatusAndMaybeClose_ParamsSpec = mojo.internal.bindings.default_browser_modal.mojom.PageHandler_CheckDefaultStatusAndMaybeClose_ParamsSpec || { $: {} };
if (mojo.internal.bindings.default_browser_modal.mojom.PageHandler_CheckDefaultStatusAndMaybeClose_ParamsSpec.$.structSpec && mojo.internal.bindings.default_browser_modal.mojom.PageHandler_CheckDefaultStatusAndMaybeClose_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.default_browser_modal.mojom.PageHandler_CheckDefaultStatusAndMaybeClose_ParamsSpec.$ = {};
mojo.internal.bindings.default_browser_modal.mojom.PageHandler_CheckDefaultStatusAndMaybeClose_ResponseParamsSpec = mojo.internal.bindings.default_browser_modal.mojom.PageHandler_CheckDefaultStatusAndMaybeClose_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.default_browser_modal.mojom.PageHandler_CheckDefaultStatusAndMaybeClose_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.default_browser_modal.mojom.PageHandler_CheckDefaultStatusAndMaybeClose_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.default_browser_modal.mojom.PageHandler_CheckDefaultStatusAndMaybeClose_ResponseParamsSpec.$ = {};
...
mojo.internal.bindings.default_browser_modal.mojom.PageHandlerFactory.$interfaceName = 'default_browser_modal.mojom.PageHandlerFactory';
mojo.internal.bindings.default_browser_modal.mojom.PageHandlerFactory_CreatePageHandler_ParamsSpec = mojo.internal.bindings.default_browser_modal.mojom.PageHandlerFactory_CreatePageHandler_ParamsSpec || { $: {} };
if (mojo.internal.bindings.default_browser_modal.mojom.PageHandlerFactory_CreatePageHandler_ParamsSpec.$.structSpec && mojo.internal.bindings.default_browser_modal.mojom.PageHandlerFactory_CreatePageHandler_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.default_browser_modal.mojom.PageHandlerFactory_CreatePageHandler_ParamsSpec.$ = {};

// Interface: Page
mojo.internal.bindings.default_browser_modal.mojom.PagePendingReceiver = class {
  constructor(handle) {
    this.handle = handle;
    if (handle) {
...
mojo.internal.bindings.default_browser_modal.mojom.PageRemote = class {
  static get $interfaceName() {
    return 'default_browser_modal.mojom.Page';
  }

  constructor(handle = undefined) {
    this.__mojoHandle = handle;
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.default_browser_modal.mojom.PagePendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.default_browser_modal.mojom.PageRemoteCallHandler(this.proxy);
  }
  ...
  onHasAcceptedChanged(arg_has_accepted) {
    return this.$.onHasAcceptedChanged(arg_has_accepted);
  }
};

mojo.internal.bindings.default_browser_modal.mojom.PageRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('default_browser_modal.mojom.Page', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.default_browser_modal.mojom.Page.getRemote = function() {
  let remote = new mojo.internal.bindings.default_browser_modal.mojom.PageRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
    'default_browser_modal.mojom.Page',
    'context');
  return remote.$;
};

mojo.internal.bindings.default_browser_modal.mojom.PageReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('default_browser_modal.mojom.Page', [
      { explicit: null },
    ]);
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        case 0: {
          ...
          const params = decoder.decodeStructInline(mojo.internal.bindings.default_browser_modal.mojom.Page_OnHasAcceptedChanged_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.onHasAcceptedChanged');
          const result = this.impl.onHasAcceptedChanged(params.arg_has_accepted);
          break;
        }
      }
      } catch (err) {
...
mojo.internal.bindings.default_browser_modal.mojom.PageReceiver = mojo.internal.bindings.default_browser_modal.mojom.PageReceiver;

mojo.internal.bindings.default_browser_modal.mojom.PagePtr = mojo.internal.bindings.default_browser_modal.mojom.PageRemote;
mojo.internal.bindings.default_browser_modal.mojom.PageRequest = mojo.internal.bindings.default_browser_modal.mojom.PagePendingReceiver;


// Interface: PageHandler
mojo.internal.bindings.default_browser_modal.mojom.PageHandlerPendingReceiver = class {
  constructor(handle) {
    this.handle = handle;
    if (handle) {
      this.__mojoHandle = handle.router_ ? handle.router_.pipe_ : (handle.pipe_ || handle);
...
mojo.internal.bindings.default_browser_modal.mojom.PageHandlerRemote = class {
  static get $interfaceName() {
    return 'default_browser_modal.mojom.PageHandler';
  }

  constructor(handle = undefined) {
    this.__mojoHandle = handle;
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.default_browser_modal.mojom.PageHandlerPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.default_browser_modal.mojom.PageHandlerRemoteCallHandler(this.proxy);
  }
  ...
  checkDefaultStatusAndMaybeClose() {
    return this.$.checkDefaultStatusAndMaybeClose();
  }
};
...
mojo.internal.bindings.default_browser_modal.mojom.PageHandlerRemoteCallHandler = class {
  ...
  confirm() {
    return this.proxy.sendMessage(
      this.ordinals[0],  // ordinal
      mojo.internal.bindings.default_browser_modal.mojom.PageHandler_Confirm_ParamsSpec,
      null,
      [],
      false);
  }
  ...
  tryAgain() {
    return this.proxy.sendMessage(
      ...
      mojo.internal.bindings.default_browser_modal.mojom.PageHandler_TryAgain_ParamsSpec,
      null,
      [],
      false);
  }
  ...
  cancel() {
    return this.proxy.sendMessage(
      ...
      mojo.internal.bindings.default_browser_modal.mojom.PageHandler_Cancel_ParamsSpec,
      null,
      [],
      false);
  }
  ...
  showUI() {
    return this.proxy.sendMessage(
      ...
      mojo.internal.bindings.default_browser_modal.mojom.PageHandler_ShowUI_ParamsSpec,
      null,
      [],
      false);
  }
...
mojo.internal.bindings.default_browser_modal.mojom.PageHandler.getRemote = function() {
  let remote = new mojo.internal.bindings.default_browser_modal.mojom.PageHandlerRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
...
mojo.internal.bindings.default_browser_modal.mojom.PageHandlerReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.default_browser_modal.mojom.PageHandler_Confirm_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.confirm');
          const result = this.impl.confirm();
          break;
        }
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.default_browser_modal.mojom.PageHandler_TryAgain_ParamsSpec.$.structSpec);
        ...
        case 3: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.default_browser_modal.mojom.PageHandler_ShowUI_ParamsSpec.$.structSpec);
        ...
        case 4: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.default_browser_modal.mojom.PageHandler_CheckDefaultStatusAndMaybeClose_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.checkDefaultStatusAndMaybeClose');
          const result = this.impl.checkDefaultStatusAndMaybeClose();
          const expectsResponse = header.expectsResponse || (header.flags & 1);
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              const val = (response && typeof response === 'object' && 'arg_is_default' in response) ? response['arg_is_default'] : response;
              const resp_obj = { 'arg_is_default': val };
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.default_browser_modal.mojom.PageHandler_CheckDefaultStatusAndMaybeClose_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
            }).catch(e => console.error('[GeneratedReceiver] checkDefaultStatusAndMaybeClose FAILED:', e));
          }
          break;
        }
      }
...
mojo.internal.bindings.default_browser_modal.mojom.PageHandlerReceiver = mojo.internal.bindings.default_browser_modal.mojom.PageHandlerReceiver;

mojo.internal.bindings.default_browser_modal.mojom.PageHandlerPtr = mojo.internal.bindings.default_browser_modal.mojom.PageHandlerRemote;
mojo.internal.bindings.default_browser_modal.mojom.PageHandlerRequest = mojo.internal.bindings.default_browser_modal.mojom.PageHandlerPendingReceiver;


// Interface: PageHandlerFactory
mojo.internal.bindings.default_browser_modal.mojom.PageHandlerFactoryPendingReceiver = class {
  constructor(handle) {
    this.handle = handle;
    if (handle) {
      this.__mojoHandle = handle.router_ ? handle.router_.pipe_ : (handle.pipe_ || handle);
...
mojo.internal.bindings.default_browser_modal.mojom.PageHandlerFactoryRemote = class {
  static get $interfaceName() {
    return 'default_browser_modal.mojom.PageHandlerFactory';
  }

  constructor(handle = undefined) {
    this.__mojoHandle = handle;
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.default_browser_modal.mojom.PageHandlerFactoryPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.default_browser_modal.mojom.PageHandlerFactoryRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.default_browser_modal.mojom.PageHandlerFactoryRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('default_browser_modal.mojom.PageHandlerFactory', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.default_browser_modal.mojom.PageHandlerFactory.getRemote = function() {
  let remote = new mojo.internal.bindings.default_browser_modal.mojom.PageHandlerFactoryRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
...
mojo.internal.bindings.default_browser_modal.mojom.PageHandlerFactoryReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('default_browser_modal.mojom.PageHandlerFactory', [
      { explicit: null },
    ]);
    ordinals.forEach((ord, idx) => {
      this.ordinalMap.set(ord, idx); // Scrambled/Explicit
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.default_browser_modal.mojom.PageHandlerFactory_CreatePageHandler_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.default_browser_modal.mojom.PageHandlerFactoryReceiver = mojo.internal.bindings.default_browser_modal.mojom.PageHandlerFactoryReceiver;

mojo.internal.bindings.default_browser_modal.mojom.PageHandlerFactoryPtr = mojo.internal.bindings.default_browser_modal.mojom.PageHandlerFactoryRemote;
mojo.internal.bindings.default_browser_modal.mojom.PageHandlerFactoryRequest = mojo.internal.bindings.default_browser_modal.mojom.PageHandlerFactoryPendingReceiver;


// Specs (at the end to ensure classes are defined for InterfaceProxy)
mojo.internal.Struct(
    mojo.internal.bindings.default_browser_modal.mojom.Page_OnHasAcceptedChanged_ParamsSpec, 'default_browser_modal.mojom.Page_OnHasAcceptedChanged_Params', [
      mojo.internal.StructField('arg_has_accepted', 0, 0, mojo.internal.Bool, false, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.default_browser_modal.mojom.PageHandler_Confirm_ParamsSpec, 'default_browser_modal.mojom.PageHandler_Confirm_Params', [
    ],
    [[0, 8]]);

mojo.internal.Struct(
    mojo.internal.bindings.default_browser_modal.mojom.PageHandler_TryAgain_ParamsSpec, 'default_browser_modal.mojom.PageHandler_TryAgain_Params', [
    ],
    [[0, 8]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.default_browser_modal.mojom.PageHandler_ShowUI_ParamsSpec, 'default_browser_modal.mojom.PageHandler_ShowUI_Params', [
    ],
    [[0, 8]]);

mojo.internal.Struct(
    mojo.internal.bindings.default_browser_modal.mojom.PageHandler_CheckDefaultStatusAndMaybeClose_ParamsSpec, 'default_browser_modal.mojom.PageHandler_CheckDefaultStatusAndMaybeClose_Params', [
    ],
    [[0, 8]]);

mojo.internal.Struct(
    mojo.internal.bindings.default_browser_modal.mojom.PageHandler_CheckDefaultStatusAndMaybeClose_ResponseParamsSpec, 'default_browser_modal.mojom.PageHandler_CheckDefaultStatusAndMaybeClose_ResponseParams', [
...
mojo.internal.Struct(
    mojo.internal.bindings.default_browser_modal.mojom.PageHandlerFactory_CreatePageHandler_ParamsSpec, 'default_browser_modal.mojom.PageHandlerFactory_CreatePageHandler_Params', [
      mojo.internal.StructField('arg_page', 0, 0, mojo.internal.InterfaceProxy(mojo.internal.bindings.default_browser_modal.mojom.PageRemote), null, false, 0, undefined),
      mojo.internal.StructField('arg_handler', 8, 0, mojo.internal.InterfaceRequest(mojo.internal.bindings.default_browser_modal.mojom.PageHandlerPendingReceiver), null, false, 0, undefined),
    ],
    [[0, 24]]);
