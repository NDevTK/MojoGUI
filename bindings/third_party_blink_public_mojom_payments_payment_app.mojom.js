...
mojo.internal.bindings.payments = mojo.internal.bindings.payments || {};
mojo.internal.bindings.payments.mojom = mojo.internal.bindings.payments.mojom || {};
mojo.internal.bindings.payments.mojom.PaymentDetailsModifierSpec = mojo.internal.bindings.payments.mojom.PaymentDetailsModifierSpec || { $: mojo.internal.OpaqueStruct.$ };
mojo.internal.bindings.payments = mojo.internal.bindings.payments || {};
mojo.internal.bindings.payments.mojom = mojo.internal.bindings.payments.mojom || {};
...
mojo.internal.bindings.payments = mojo.internal.bindings.payments || {};
mojo.internal.bindings.payments.mojom = mojo.internal.bindings.payments.mojom || {};
mojo.internal.bindings.payments.mojom.PaymentOptionsSpec = mojo.internal.bindings.payments.mojom.PaymentOptionsSpec || { $: mojo.internal.OpaqueStruct.$ };
mojo.internal.bindings.payments = mojo.internal.bindings.payments || {};
mojo.internal.bindings.payments.mojom = mojo.internal.bindings.payments.mojom || {};
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.payments.mojom.PaymentManager_Init_ParamsSpec.$.structSpec;
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.payments.mojom.PaymentManager_DeletePaymentInstrument_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for DeletePaymentInstrument failed with TypeError');
           }
        }
        // Try Method 2: GetPaymentInstrument
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.payments.mojom.PaymentManager_GetPaymentInstrument_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for GetPaymentInstrument failed with TypeError');
           }
        }
        // Try Method 3: KeysOfPaymentInstruments
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.payments.mojom.PaymentManager_KeysOfPaymentInstruments_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for KeysOfPaymentInstruments failed with TypeError');
           }
        }
        // Try Method 4: HasPaymentInstrument
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.payments.mojom.PaymentManager_HasPaymentInstrument_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for HasPaymentInstrument failed with TypeError');
           }
        }
        // Try Method 5: SetPaymentInstrument
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.payments.mojom.PaymentManager_SetPaymentInstrument_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for SetPaymentInstrument failed with TypeError');
           }
        }
        // Try Method 6: ClearPaymentInstruments
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.payments.mojom.PaymentManager_ClearPaymentInstruments_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for ClearPaymentInstruments failed with TypeError');
           }
        }
        // Try Method 7: SetUserHint
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.payments.mojom.PaymentManager_SetUserHint_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for SetUserHint failed with TypeError');
           }
        }
        // Try Method 8: EnableDelegations
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.payments.mojom.PaymentManager_EnableDelegations_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for EnableDelegations failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.payments.mojom.PaymentHandlerResponseCallback_OnResponseForAbortPayment_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OnResponseForAbortPayment failed with TypeError');
           }
        }
        // Try Method 1: OnResponseForCanMakePayment
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.payments.mojom.PaymentHandlerResponseCallback_OnResponseForCanMakePayment_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OnResponseForCanMakePayment failed with TypeError');
           }
        }
        // Try Method 2: OnResponseForPaymentRequest
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.payments.mojom.PaymentHandlerResponseCallback_OnResponseForPaymentRequest_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OnResponseForPaymentRequest failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
             console.warn('[GeneratedReceiver] Failed to discover ordinal ' + header.ordinal);
