...
// Enum: HDCPState
mojo.internal.bindings.display.mojom.HDCPState = {
...
mojo.internal.bindings.display.mojom.ContentProtectionMethod = {
...
mojo.internal.bindings.display.mojom.PanelOrientation = {
  NORMAL: 0,
  BOTTOM_UP: 1,
  LEFT_UP: 2,
  RIGHT_UP: 3,
...
mojo.internal.bindings.display.mojom.PrivacyScreenState = {
  DISABLED: 0,
  ENABLED: 1,
  DISABLED_LOCKED: 2,
  ENABLED_LOCKED: 3,
...
mojo.internal.bindings.display.mojom.VariableRefreshRateState = {
  kVrrDisabled: 0,
  kVrrEnabled: 1,
  kVrrNotCapable: 2,
};
...
mojo.internal.Struct(
    mojo.internal.bindings.display.mojom.ModesetFlagsSpec, 'display.mojom.ModesetFlags', [
      mojo.internal.StructField('arg_bitmask', 0, 0, mojo.internal.Uint64, 0, false, 0, undefined),
    ],
    [[0, 16]]);
