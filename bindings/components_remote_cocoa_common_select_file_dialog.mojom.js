...
mojo.internal.bindings.remote_cocoa.mojom.SelectFileDialogType = {
  kFolder: 0,
  kUploadFolder: 1,
  kExistingFolder: 2,
  kOpenFile: 3,
...
mojo.internal.bindings.remote_cocoa.mojom.SelectFileDialogRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.remote_cocoa.mojom.SelectFileDialogPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.remote_cocoa.mojom.SelectFileDialogRemoteCallHandler(this.proxy);
  }
  ...
  show(arg_type, arg_title, arg_file_path, arg_file_types, arg_file_type_index, arg_default_extension) {
    return this.$.show(arg_type, arg_title, arg_file_path, arg_file_types, arg_file_type_index, arg_default_extension);
  }
};
...
mojo.internal.bindings.remote_cocoa.mojom.SelectFileDialog.getRemote = function() {
  let remote = new mojo.internal.bindings.remote_cocoa.mojom.SelectFileDialogRemote();
...
mojo.internal.bindings.remote_cocoa.mojom.SelectFileDialogReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
        ...
        case 0: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.remote_cocoa.mojom.SelectFileDialog_Show_ResponseParamsSpec, header, rawHeader);
               responder(response);
...
mojo.internal.bindings.remote_cocoa.mojom.SelectFileDialogReceiver = mojo.internal.bindings.remote_cocoa.mojom.SelectFileDialogReceiver;
