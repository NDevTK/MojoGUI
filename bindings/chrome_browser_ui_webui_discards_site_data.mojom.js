  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.discards.mojom.SiteDataProvider_GetSiteDataArray_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for GetSiteDataArray failed with TypeError');
           }
        }
        // Try Method 1: GetSiteDataDatabaseSize
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.discards.mojom.SiteDataProvider_GetSiteDataDatabaseSize_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for GetSiteDataDatabaseSize failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
