...
ax.mojom.AXTreeUpdateSpec = {
  $: {
    structSpec: {
      ...
      packedSize: 72,
      fields: [
        { name: 'tree_data', packedOffset: 0, packedBitOffset: 0, type: mojo.internal.Pointer, nullable: false },
        { name: 'nodes', packedOffset: 8, packedBitOffset: 0, type: mojo.internal.Array, nullable: false },
        { name: 'event_from', packedOffset: 16, packedBitOffset: 0, type: mojo.internal.Pointer, nullable: false },
        { name: 'event_from_action', packedOffset: 24, packedBitOffset: 0, type: mojo.internal.Pointer, nullable: false },
        { name: 'event_intents', packedOffset: 32, packedBitOffset: 0, type: mojo.internal.Array, nullable: false },
        { name: 'tree_checks', packedOffset: 40, packedBitOffset: 0, type: mojo.internal.Pointer, nullable: true },
