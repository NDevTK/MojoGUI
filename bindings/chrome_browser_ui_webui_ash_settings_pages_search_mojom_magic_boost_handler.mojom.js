...
mojo.internal.bindings.ash.settings.magic_boost_handler = mojo.internal.bindings.ash.settings.magic_boost_handler || {};
...
mojo.internal.bindings.ash.settings.magic_boost_handler.mojom.PageHandlerFactoryRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.ash.settings.magic_boost_handler.mojom.PageHandlerFactoryPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.ash.settings.magic_boost_handler.mojom.PageHandlerFactoryRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.ash.settings.magic_boost_handler.mojom.PageHandlerFactory.getRemote = function() {
  let remote = new mojo.internal.bindings.ash.settings.magic_boost_handler.mojom.PageHandlerFactoryRemote();
...
mojo.internal.bindings.ash.settings.magic_boost_handler.mojom.PageHandlerFactoryReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ash.settings.magic_boost_handler.mojom.PageHandlerFactory_CreatePageHandler_ParamsSpec.$.structSpec;
...
mojo.internal.bindings.ash.settings.magic_boost_handler.mojom.PageHandlerFactoryReceiver = mojo.internal.bindings.ash.settings.magic_boost_handler.mojom.PageHandlerFactoryReceiver;

mojo.internal.bindings.ash.settings.magic_boost_handler.mojom.PageHandlerFactoryPtr = mojo.internal.bindings.ash.settings.magic_boost_handler.mojom.PageHandlerFactoryRemote;
mojo.internal.bindings.ash.settings.magic_boost_handler.mojom.PageHandlerFactoryRequest = mojo.internal.bindings.ash.settings.magic_boost_handler.mojom.PageHandlerFactoryPendingReceiver;
...
mojo.internal.bindings.ash.settings.magic_boost_handler.mojom.PageHandlerRemote = class {
  static get $interfaceName() {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.ash.settings.magic_boost_handler.mojom.PageHandlerPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.ash.settings.magic_boost_handler.mojom.PageHandlerRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.ash.settings.magic_boost_handler.mojom.PageHandler.getRemote = function() {
  let remote = new mojo.internal.bindings.ash.settings.magic_boost_handler.mojom.PageHandlerRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
...
mojo.internal.bindings.ash.settings.magic_boost_handler.mojom.PageHandlerReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ash.settings.magic_boost_handler.mojom.PageHandler_ShowNotice_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for ShowNotice failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
             console.warn('[GeneratedReceiver] Failed to discover ordinal ' + header.ordinal);
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.ash.settings.magic_boost_handler.mojom.PageHandler_ShowNotice_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.ash.settings.magic_boost_handler.mojom.PageHandlerReceiver = mojo.internal.bindings.ash.settings.magic_boost_handler.mojom.PageHandlerReceiver;
