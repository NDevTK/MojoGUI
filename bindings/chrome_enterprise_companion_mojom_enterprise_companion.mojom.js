...
mojo.internal.bindings.enterprise_companion.mojom.EnterpriseCompanionRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.enterprise_companion.mojom.EnterpriseCompanionPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.enterprise_companion.mojom.EnterpriseCompanionRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.enterprise_companion.mojom.EnterpriseCompanion.getRemote = function() {
  let remote = new mojo.internal.bindings.enterprise_companion.mojom.EnterpriseCompanionRemote();
...
mojo.internal.bindings.enterprise_companion.mojom.EnterpriseCompanionReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.enterprise_companion.mojom.EnterpriseCompanion_Shutdown_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for Shutdown failed with TypeError');
           }
        }
        // Try Method 1: FetchPolicies
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.enterprise_companion.mojom.EnterpriseCompanion_FetchPolicies_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for FetchPolicies failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.enterprise_companion.mojom.EnterpriseCompanion_Shutdown_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.enterprise_companion.mojom.EnterpriseCompanionReceiver = mojo.internal.bindings.enterprise_companion.mojom.EnterpriseCompanionReceiver;
