...
// Struct: Status
enterprise_companion.mojom.mojom.StatusSpec = {
  $: {
    structSpec: {
...
enterprise_companion.mojom.mojom.EnterpriseCompanion = {};

enterprise_companion.mojom.mojom.EnterpriseCompanionPendingReceiver = class {
  constructor(handle) {
    this.handle = handle;
  }
};

enterprise_companion.mojom.mojom.EnterpriseCompanionRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      enterprise_companion.mojom.mojom.EnterpriseCompanionPendingReceiver,
      handle);
    this.$ = new enterprise_companion.mojom.mojom.EnterpriseCompanionRemoteCallHandler(this.proxy);
  }
...
enterprise_companion.mojom.mojom.EnterpriseCompanionRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
  }
  ...
  shutdown() {
    ...
    return this.proxy.sendMessage(
      0,  // ordinal
      enterprise_companion.mojom.mojom.EnterpriseCompanion_Shutdown_ParamsSpec,
      enterprise_companion.mojom.mojom.EnterpriseCompanion_Shutdown_ResponseParamsSpec,
      []);
  }
  ...
  fetchPolicies(reason) {
    ...
    return this.proxy.sendMessage(
      1,  // ordinal
      enterprise_companion.mojom.mojom.EnterpriseCompanion_FetchPolicies_ParamsSpec,
      enterprise_companion.mojom.mojom.EnterpriseCompanion_FetchPolicies_ResponseParamsSpec,
      [reason]);
  }

};

enterprise_companion.mojom.mojom.EnterpriseCompanion.getRemote = function() {
  let remote = new enterprise_companion.mojom.mojom.EnterpriseCompanionRemote();
...
enterprise_companion.mojom.mojom.EnterpriseCompanionPtr = enterprise_companion.mojom.mojom.EnterpriseCompanionRemote;
enterprise_companion.mojom.mojom.EnterpriseCompanionRequest = enterprise_companion.mojom.mojom.EnterpriseCompanionPendingReceiver;
