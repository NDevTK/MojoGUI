...
mojo.internal.bindings.shape_detection.mojom.TextDetectionResultSpec = { $: {} };
mojo.internal.bindings.shape_detection.mojom.TextDetection = {};
mojo.internal.bindings.shape_detection.mojom.TextDetection.$interfaceName = 'shape_detection.mojom.TextDetection';
...
mojo.internal.Struct(
    mojo.internal.bindings.shape_detection.mojom.TextDetection_Detect_ResponseParamsSpec, 'shape_detection.mojom.TextDetection_Detect_ResponseParams', [
      mojo.internal.StructField('arg_results', 0, 0, mojo.internal.Array(mojo.internal.bindings.mojo.internal.bindings.shape_detection.mojom.TextDetectionResultSpec.$, false), null, false, 0, undefined),
    ],
    [[0, 16]]);
...
mojo.internal.bindings.shape_detection.mojom.TextDetectionRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.shape_detection.mojom.TextDetectionRemoteCallHandler(this.proxy);
  }
  ...
  detect(arg_bitmap_data) {
    return this.$.detect(arg_bitmap_data);
  }
};

mojo.internal.bindings.shape_detection.mojom.TextDetectionRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('TextDetection', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.shape_detection.mojom.TextDetection.getRemote = function() {
  let remote = new mojo.internal.bindings.shape_detection.mojom.TextDetectionRemote();
...
mojo.internal.bindings.shape_detection.mojom.TextDetectionReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('TextDetection', [
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.shape_detection.mojom.TextDetection_Detect_ParamsSpec);
        ...
        case 0: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.shape_detection.mojom.TextDetection_Detect_ResponseParamsSpec, header, rawHeader);
               responder(response);
...
mojo.internal.bindings.shape_detection.mojom.TextDetectionReceiver = mojo.internal.bindings.shape_detection.mojom.TextDetectionReceiver;
