...
mojo.internal.bindings.shape_detection.mojom.TextDetectionSpec = { $ : {} };
...
mojo.internal.bindings.shape_detection.mojom.TextDetectionRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('shape_detection.mojom.TextDetection', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.shape_detection.mojom.TextDetectionReceiver = class {
  constructor(impl) {
    ...
    const ordinals = window.mojoScrambler.getOrdinals('shape_detection.mojom.TextDetection', [
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.shape_detection.mojom.TextDetection_Detect_ParamsSpec.$.structSpec);
