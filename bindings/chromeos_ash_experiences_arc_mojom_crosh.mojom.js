...
mojo.internal.bindings.arc.mojom.ArcShellExecutionInstanceSpec = { $ : {} };
mojo.internal.bindings.arc.mojom.ArcShellExecutionInstance.$interfaceName = 'arc.mojom.ArcShellExecutionInstance';
...
mojo.internal.bindings.arc = mojo.internal.bindings.arc || {};
mojo.internal.bindings.arc.mojom = mojo.internal.bindings.arc.mojom || {};
mojo.internal.bindings.arc.mojom.ArcShellExecutionResultSpec = mojo.internal.bindings.arc.mojom.ArcShellExecutionResultSpec || { $: mojo.internal.OpaqueStruct.$ };

// Enum: ArcShellCommand
mojo.internal.bindings.arc.mojom.ArcShellCommand = {
  unknown: -1,
  kTop: 0,
  kCpuinfo: 1,
  kMeminfo: 2,
...
mojo.internal.bindings.arc.mojom.ArcShellExecutionInstanceRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.arc.mojom.ArcShellExecutionInstanceRemoteCallHandler(this.proxy);
  }
  ...
  exec(arg_request) {
    return this.$.exec(arg_request);
  }
};

mojo.internal.bindings.arc.mojom.ArcShellExecutionInstanceRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('arc.mojom.ArcShellExecutionInstance', [
      { explicit: 0 },
    ]);
  }
...
mojo.internal.bindings.arc.mojom.ArcShellExecutionInstance.getRemote = function() {
  let remote = new mojo.internal.bindings.arc.mojom.ArcShellExecutionInstanceRemote();
...
mojo.internal.bindings.arc.mojom.ArcShellExecutionInstanceReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('arc.mojom.ArcShellExecutionInstance', [
      { explicit: 0 },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.arc.mojom.ArcShellExecutionInstance_Exec_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for Exec failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.arc.mojom.ArcShellExecutionInstanceReceiver = mojo.internal.bindings.arc.mojom.ArcShellExecutionInstanceReceiver;
