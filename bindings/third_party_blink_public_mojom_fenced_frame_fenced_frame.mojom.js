...
mojo.internal.bindings.blink.mojom.FencedFrameOwnerHost = {};
mojo.internal.bindings.blink.mojom.FencedFrameOwnerHostSpec = { $ : {} };
mojo.internal.bindings.blink.mojom.FencedFrameOwnerHost.$interfaceName = 'blink.mojom.FencedFrameOwnerHost';
...
mojo.internal.bindings.blink.mojom.FencedFrameOwnerHostRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.blink.mojom.FencedFrameOwnerHostRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.blink.mojom.FencedFrameOwnerHostRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('blink.mojom.FencedFrameOwnerHost', [
      { explicit: null },
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.blink.mojom.FencedFrameOwnerHost.getRemote = function() {
  let remote = new mojo.internal.bindings.blink.mojom.FencedFrameOwnerHostRemote();
...
mojo.internal.bindings.blink.mojom.FencedFrameOwnerHostReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('blink.mojom.FencedFrameOwnerHost', [
      { explicit: null },
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.blink.mojom.FencedFrameOwnerHost_Navigate_ParamsSpec.$.structSpec);
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.blink.mojom.FencedFrameOwnerHost_DidChangeFramePolicy_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.blink.mojom.FencedFrameOwnerHostReceiver = mojo.internal.bindings.blink.mojom.FencedFrameOwnerHostReceiver;
