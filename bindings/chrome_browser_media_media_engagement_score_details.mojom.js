...
mojo.internal.Struct(
    mojo.internal.bindings.media.mojom.MediaEngagementScoreDetailsProvider_GetMediaEngagementScoreDetails_ParamsSpec, 'media.mojom.MediaEngagementScoreDetailsProvider_GetMediaEngagementScoreDetails_Params', [
    ],
    [[0, 8]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.media.mojom.MediaEngagementScoreDetailsProvider_GetMediaEngagementConfig_ParamsSpec, 'media.mojom.MediaEngagementScoreDetailsProvider_GetMediaEngagementConfig_Params', [
    ],
    [[0, 8]]);
...
mojo.internal.bindings.media.mojom.MediaEngagementScoreDetailsProviderPendingReceiver = class {
  constructor(handle) {
    this.handle = handle;
  }
};

mojo.internal.bindings.media.mojom.MediaEngagementScoreDetailsProviderRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.media.mojom.MediaEngagementScoreDetailsProviderPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.media.mojom.MediaEngagementScoreDetailsProviderRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.media.mojom.MediaEngagementScoreDetailsProvider.getRemote = function() {
  let remote = new mojo.internal.bindings.media.mojom.MediaEngagementScoreDetailsProviderRemote();
...
mojo.internal.bindings.media.mojom.MediaEngagementScoreDetailsProviderReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.media.mojom.MediaEngagementScoreDetailsProvider_GetMediaEngagementScoreDetails_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for GetMediaEngagementScoreDetails failed with TypeError');
           }
        }
        // Try Method 1: GetMediaEngagementConfig
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.media.mojom.MediaEngagementScoreDetailsProvider_GetMediaEngagementConfig_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for GetMediaEngagementConfig failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.media.mojom.MediaEngagementScoreDetailsProvider_GetMediaEngagementScoreDetails_ParamsSpec.$.structSpec);
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              this.endpoint.send(header.ordinal, header.requestId, mojo.internal.kMessageFlagIsResponse, mojo.internal.bindings.media.mojom.MediaEngagementScoreDetailsProvider_GetMediaEngagementScoreDetails_ResponseParamsSpec, response);
        ...
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.media.mojom.MediaEngagementScoreDetailsProvider_GetMediaEngagementConfig_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.getMediaEngagementConfig');
          const result = this.impl.getMediaEngagementConfig();
          const expectsResponse = header.expectsResponse || (header.flags & 1);
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              this.endpoint.send(header.ordinal, header.requestId, mojo.internal.kMessageFlagIsResponse, mojo.internal.bindings.media.mojom.MediaEngagementScoreDetailsProvider_GetMediaEngagementConfig_ResponseParamsSpec, response);
...
mojo.internal.bindings.media.mojom.MediaEngagementScoreDetailsProviderReceiver = mojo.internal.bindings.media.mojom.MediaEngagementScoreDetailsProviderReceiver;

mojo.internal.bindings.media.mojom.MediaEngagementScoreDetailsProviderPtr = mojo.internal.bindings.media.mojom.MediaEngagementScoreDetailsProviderRemote;
mojo.internal.bindings.media.mojom.MediaEngagementScoreDetailsProviderRequest = mojo.internal.bindings.media.mojom.MediaEngagementScoreDetailsProviderPendingReceiver;
