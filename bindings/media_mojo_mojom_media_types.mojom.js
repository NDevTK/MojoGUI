  ...
  $: {
    structSpec: {
      ...
      fields: [
        ...
        { name: 'encryption_scheme', packedOffset: 32, packedBitOffset: 0, type: media.mojom.EncryptionSchemeSpec, nullable: false },
        { name: 'seek_preroll', packedOffset: 40, packedBitOffset: 0, type: mojo_base.mojom.TimeDeltaSpec, nullable: false },
        { name: 'profile', packedOffset: 48, packedBitOffset: 0, type: media.mojom.AudioCodecProfileSpec, nullable: false },
        { name: 'target_output_channel_layout', packedOffset: 56, packedBitOffset: 0, type: media.mojom.ChannelLayoutSpec, nullable: false },
        { name: 'target_output_sample_format', packedOffset: 64, packedBitOffset: 0, type: media.mojom.SampleFormatSpec, nullable: false },
  ...
  $: {
    structSpec: {
      ...
      fields: [
        ...
        { name: 'encryption_scheme', packedOffset: 64, packedBitOffset: 0, type: media.mojom.EncryptionSchemeSpec, nullable: false },
