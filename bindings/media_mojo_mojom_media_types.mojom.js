...
mojo.internal.bindings.media.mojom.VideoChromaSamplingSpec = mojo.internal.bindings.media.mojom.VideoChromaSamplingSpec || { $: mojo.internal.Enum().$ };
...
// Enum: VideoChromaSampling
mojo.internal.bindings.media.mojom.VideoChromaSampling = {
  kUnknown: 0,
  k420: 1,
  k422: 2,
  k444: 3,
...
mojo.internal.Struct(
    mojo.internal.bindings.media.mojom.VideoFrameMetadataSpec, 'media.mojom.VideoFrameMetadata', [
      ...
      mojo.internal.StructField('arg_capture_counter_$flag', 16, 0, mojo.internal.Bool, false, false, 0, { isPrimary: true, linkedValueFieldName: 'arg_capture_counter_$value', originalFieldName: 'arg_capture_counter' }),
      mojo.internal.StructField('arg_copy_required', 16, 1, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_end_of_stream', 16, 2, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_frame_rate_$flag', 16, 3, mojo.internal.Bool, false, false, 0, { isPrimary: true, linkedValueFieldName: 'arg_frame_rate_$value', originalFieldName: 'arg_frame_rate' }),
      mojo.internal.StructField('arg_interactive_content', 16, 4, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_read_lock_fences_enabled', 16, 5, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_in_surface_view', 16, 6, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_wants_promotion_hint', 16, 7, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_protected_video', 17, 0, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_hw_protected', 17, 1, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_needs_detiling', 17, 2, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_is_webgpu_compatible', 17, 3, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_power_efficient', 17, 4, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_device_scale_factor_$flag', 17, 5, mojo.internal.Bool, false, false, 0, { isPrimary: true, linkedValueFieldName: 'arg_device_scale_factor_$value', originalFieldName: 'arg_device_scale_factor' }),
      mojo.internal.StructField('arg_page_scale_factor_$flag', 17, 6, mojo.internal.Bool, false, false, 0, { isPrimary: true, linkedValueFieldName: 'arg_page_scale_factor_$value', originalFieldName: 'arg_page_scale_factor' }),
      mojo.internal.StructField('arg_root_scroll_offset_x_$flag', 17, 7, mojo.internal.Bool, false, false, 0, { isPrimary: true, linkedValueFieldName: 'arg_root_scroll_offset_x_$value', originalFieldName: 'arg_root_scroll_offset_x' }),
      mojo.internal.StructField('arg_root_scroll_offset_y_$flag', 18, 0, mojo.internal.Bool, false, false, 0, { isPrimary: true, linkedValueFieldName: 'arg_root_scroll_offset_y_$value', originalFieldName: 'arg_root_scroll_offset_y' }),
      mojo.internal.StructField('arg_top_controls_visible_height_$flag', 18, 1, mojo.internal.Bool, false, false, 0, { isPrimary: true, linkedValueFieldName: 'arg_top_controls_visible_height_$value', originalFieldName: 'arg_top_controls_visible_height' }),
      mojo.internal.StructField('arg_rtp_timestamp_$flag', 18, 2, mojo.internal.Bool, false, false, 0, { isPrimary: true, linkedValueFieldName: 'arg_rtp_timestamp_$value', originalFieldName: 'arg_rtp_timestamp' }),
      mojo.internal.StructField('arg_frame_sequence_$flag', 18, 3, mojo.internal.Bool, false, false, 0, { isPrimary: true, linkedValueFieldName: 'arg_frame_sequence_$value', originalFieldName: 'arg_frame_sequence' }),
      mojo.internal.StructField('arg_source_id_$flag', 18, 4, mojo.internal.Bool, false, false, 0, { isPrimary: true, linkedValueFieldName: 'arg_source_id_$value', originalFieldName: 'arg_source_id' }),
      mojo.internal.StructField('arg_capture_counter_$value', 20, 0, mojo.internal.Int32, 0, false, 0, { isPrimary: false, linkedValueFieldName: 'arg_capture_counter_$flag', originalFieldName: 'arg_capture_counter' }),
