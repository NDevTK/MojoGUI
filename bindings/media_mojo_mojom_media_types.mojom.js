  ...
  $: {
    structSpec: {
      ...
      fields: [
        ...
        { name: 'seek_preroll', packedOffset: 40, packedBitOffset: 0, type: mojo_base.mojom.TimeDeltaSpec, nullable: false },
  ...
  $: {
    structSpec: {
      ...
      fields: [
        ...
        { name: 'transformation', packedOffset: 16, packedBitOffset: 0, type: media.mojom.VideoTransformationSpec, nullable: false },
        ...
        { name: 'natural_size', packedOffset: 40, packedBitOffset: 0, type: gfx.mojom.SizeSpec, nullable: false },
        { name: 'aspect_ratio', packedOffset: 48, packedBitOffset: 0, type: media.mojom.VideoAspectRatioSpec, nullable: false },
        ...
        { name: 'color_space_info', packedOffset: 72, packedBitOffset: 0, type: media.mojom.VideoColorSpaceSpec, nullable: false },
        { name: 'hdr_metadata', packedOffset: 80, packedBitOffset: 0, type: gfx.mojom.HDRMetadataSpec, nullable: false },
  ...
  $: {
    structSpec: {
      ...
      fields: [
        ...
        { name: 'decrypt_config', packedOffset: 16, packedBitOffset: 0, type: media.mojom.DecryptConfigSpec, nullable: true },
        { name: 'side_data', packedOffset: 24, packedBitOffset: 0, type: media.mojom.DecoderBufferSideDataSpec, nullable: true },
...
media.mojom.VideoFrameMetadataSpec = {
  $: {
    structSpec: {
      ...
      packedSize: 224,
      fields: [
        { name: 'capture_begin_time', packedOffset: 0, packedBitOffset: 0, type: mojo_base.mojom.TimeTicksSpec, nullable: true },
        { name: 'capture_end_time', packedOffset: 8, packedBitOffset: 0, type: mojo_base.mojom.TimeTicksSpec, nullable: true },
        { name: 'capture_update_rect', packedOffset: 16, packedBitOffset: 0, type: gfx.mojom.RectSpec, nullable: true },
        { name: 'source_size', packedOffset: 24, packedBitOffset: 0, type: gfx.mojom.SizeSpec, nullable: true },
        { name: 'region_capture_rect', packedOffset: 32, packedBitOffset: 0, type: gfx.mojom.RectSpec, nullable: true },
        { name: 'capture_version', packedOffset: 40, packedBitOffset: 0, type: media.mojom.CaptureVersionSpec, nullable: false },
        { name: 'frame_duration', packedOffset: 48, packedBitOffset: 0, type: mojo_base.mojom.TimeDeltaSpec, nullable: true },
        { name: 'frame_rate', packedOffset: 56, packedBitOffset: 0, type: mojo.internal.Double, nullable: false },
        { name: 'reference_time', packedOffset: 64, packedBitOffset: 0, type: mojo_base.mojom.TimeTicksSpec, nullable: true },
        { name: 'transformation', packedOffset: 72, packedBitOffset: 0, type: media.mojom.VideoTransformationSpec, nullable: true },
        { name: 'tracking_token', packedOffset: 80, packedBitOffset: 0, type: mojo_base.mojom.UnguessableTokenSpec, nullable: true },
        ...
        { name: 'decode_begin_time', packedOffset: 128, packedBitOffset: 0, type: mojo_base.mojom.TimeTicksSpec, nullable: true },
        { name: 'decode_end_time', packedOffset: 136, packedBitOffset: 0, type: mojo_base.mojom.TimeTicksSpec, nullable: true },
        { name: 'processing_time', packedOffset: 144, packedBitOffset: 0, type: mojo_base.mojom.TimeDeltaSpec, nullable: true },
        { name: 'rtp_timestamp', packedOffset: 152, packedBitOffset: 0, type: mojo.internal.Double, nullable: false },
        { name: 'receive_time', packedOffset: 160, packedBitOffset: 0, type: mojo_base.mojom.TimeTicksSpec, nullable: true },
        { name: 'wallclock_frame_duration', packedOffset: 168, packedBitOffset: 0, type: mojo_base.mojom.TimeDeltaSpec, nullable: true },
        ...
        { name: 'background_blur', packedOffset: 192, packedBitOffset: 0, type: media.mojom.EffectStateSpec, nullable: false },
  ...
  $: {
    structSpec: {
      ...
      fields: [
        ...
        { name: 'ycbcr_data', packedOffset: 16, packedBitOffset: 0, type: [EnableIf=is_android] gpu.mojom.VulkanYCbCrInfoSpec, nullable: true },
  ...
  $: {
    structSpec: {
      ...
      fields: [
        ...
        { name: 'encryption_type', packedOffset: 8, packedBitOffset: 0, type: media.mojom.EncryptionTypeSpec, nullable: false },
  ...
  $: {
    structSpec: {
      ...
      fields: [
        ...
        { name: 'frames', packedOffset: 16, packedBitOffset: 0, type: mojo_base.mojom.ListValueSpec, nullable: false },
        { name: 'cause', packedOffset: 24, packedBitOffset: 0, type: media.mojom.StatusDataSpec, nullable: true },
        { name: 'data', packedOffset: 32, packedBitOffset: 0, type: mojo_base.mojom.ValueSpec, nullable: false },
