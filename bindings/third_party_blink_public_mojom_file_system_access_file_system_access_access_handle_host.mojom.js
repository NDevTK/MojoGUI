...
mojo.internal.bindings.blink.mojom.FileSystemAccessAccessHandleHostRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('FileSystemAccessAccessHandleHost', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.blink.mojom.FileSystemAccessAccessHandleHostReceiver = class {
  constructor(impl) {
    ...
    const ordinals = window.mojoScrambler.getOrdinals('FileSystemAccessAccessHandleHost', [
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.blink.mojom.FileSystemAccessAccessHandleHost_Close_ParamsSpec);
