...
mojo.internal.bindings.blink.mojom.FileSystemAccessAccessHandleHostRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.blink.mojom.FileSystemAccessAccessHandleHostRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.blink.mojom.FileSystemAccessAccessHandleHostRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('blink.mojom.FileSystemAccessAccessHandleHost', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.blink.mojom.FileSystemAccessAccessHandleHost.getRemote = function() {
  let remote = new mojo.internal.bindings.blink.mojom.FileSystemAccessAccessHandleHostRemote();
...
mojo.internal.bindings.blink.mojom.FileSystemAccessAccessHandleHostReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('blink.mojom.FileSystemAccessAccessHandleHost', [
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.blink.mojom.FileSystemAccessAccessHandleHost_Close_ParamsSpec.$.structSpec);
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.blink.mojom.FileSystemAccessAccessHandleHost_Close_ParamsSpec.$.structSpec);
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.blink.mojom.FileSystemAccessAccessHandleHost_Close_ResponseParamsSpec, header, rawHeader);
               responder(response);
...
mojo.internal.bindings.blink.mojom.FileSystemAccessAccessHandleHostReceiver = mojo.internal.bindings.blink.mojom.FileSystemAccessAccessHandleHostReceiver;
