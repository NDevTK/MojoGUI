...
mojo.internal.bindings.chrome.mojom.RemovableStorageWriterRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.chrome.mojom.RemovableStorageWriterPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.chrome.mojom.RemovableStorageWriterRemoteCallHandler(this.proxy);
  }
  ...
  write(arg_source, arg_target, arg_client) {
    return this.$.write(arg_source, arg_target, arg_client);
  }
  verify(arg_source, arg_target, arg_client) {
    return this.$.verify(arg_source, arg_target, arg_client);
  }
};
...
mojo.internal.bindings.chrome.mojom.RemovableStorageWriter.getRemote = function() {
  let remote = new mojo.internal.bindings.chrome.mojom.RemovableStorageWriterRemote();
...
mojo.internal.bindings.chrome.mojom.RemovableStorageWriterReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.chrome.mojom.RemovableStorageWriter_Write_ParamsSpec.$.structSpec;
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.chrome.mojom.RemovableStorageWriter_Verify_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for Verify failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.chrome.mojom.RemovableStorageWriterReceiver = mojo.internal.bindings.chrome.mojom.RemovableStorageWriterReceiver;

mojo.internal.bindings.chrome.mojom.RemovableStorageWriterPtr = mojo.internal.bindings.chrome.mojom.RemovableStorageWriterRemote;
mojo.internal.bindings.chrome.mojom.RemovableStorageWriterRequest = mojo.internal.bindings.chrome.mojom.RemovableStorageWriterPendingReceiver;
...
mojo.internal.bindings.chrome.mojom.RemovableStorageWriterClientRemote = class {
  static get $interfaceName() {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.chrome.mojom.RemovableStorageWriterClientPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.chrome.mojom.RemovableStorageWriterClientRemoteCallHandler(this.proxy);
  }
  ...
  progress(arg_progress) {
    return this.$.progress(arg_progress);
  }
  complete(arg_error) {
    return this.$.complete(arg_error);
  }
};
...
mojo.internal.bindings.chrome.mojom.RemovableStorageWriterClient.getRemote = function() {
  let remote = new mojo.internal.bindings.chrome.mojom.RemovableStorageWriterClientRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
...
mojo.internal.bindings.chrome.mojom.RemovableStorageWriterClientReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.chrome.mojom.RemovableStorageWriterClient_Progress_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.chrome.mojom.RemovableStorageWriterClient_Complete_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for Complete failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
             console.warn('[GeneratedReceiver] Failed to discover ordinal ' + header.ordinal);
...
mojo.internal.bindings.chrome.mojom.RemovableStorageWriterClientReceiver = mojo.internal.bindings.chrome.mojom.RemovableStorageWriterClientReceiver;
