...
mojo.internal.bindings.android_webview.mojom.RenderMessageFilter = {};
mojo.internal.bindings.android_webview.mojom.RenderMessageFilterSpec = { $ : {} };
mojo.internal.bindings.android_webview.mojom.RenderMessageFilter.$interfaceName = 'android_webview.mojom.RenderMessageFilter';
...
mojo.internal.bindings.android_webview.mojom.RenderMessageFilterRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.android_webview.mojom.RenderMessageFilterPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.android_webview.mojom.RenderMessageFilterRemoteCallHandler(this.proxy);
  }
  ...
  subFrameCreated(arg_parent_frame_token, arg_child_frame_token) {
    return this.$.subFrameCreated(arg_parent_frame_token, arg_child_frame_token);
  }
};

mojo.internal.bindings.android_webview.mojom.RenderMessageFilterRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('android_webview.mojom.RenderMessageFilter', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.android_webview.mojom.RenderMessageFilter.getRemote = function() {
  let remote = new mojo.internal.bindings.android_webview.mojom.RenderMessageFilterRemote();
...
mojo.internal.bindings.android_webview.mojom.RenderMessageFilterReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('android_webview.mojom.RenderMessageFilter', [
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.android_webview.mojom.RenderMessageFilter_SubFrameCreated_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for SubFrameCreated failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.android_webview.mojom.RenderMessageFilterReceiver = mojo.internal.bindings.android_webview.mojom.RenderMessageFilterReceiver;
