...
// Enum: ZucchiniStatus
mojo.internal.bindings.patch.mojom.ZucchiniStatus = {
  kStatusSuccess: 0,
...
mojo.internal.Struct(
    mojo.internal.bindings.patch.mojom.FilePatcher_PatchFileZucchini_ResponseParamsSpec, 'patch.mojom.FilePatcher_PatchFileZucchini_ResponseParams', [
      mojo.internal.StructField('arg_result', 0, 0, mojo.internal.bindings.mojo.internal.bindings.patch.mojom.ZucchiniStatusSpec.$, null, false, 0, undefined),
    ],
    [[0, 16]]);
...
mojo.internal.bindings.patch.mojom.FilePatcherRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.patch.mojom.FilePatcherPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.patch.mojom.FilePatcherRemoteCallHandler(this.proxy);
  }
  ...
  patchFilePuffPatch(arg_input_file, arg_patch_file, arg_output_file) {
    return this.$.patchFilePuffPatch(arg_input_file, arg_patch_file, arg_output_file);
  }
  patchFileZucchini(arg_input_file, arg_patch_file, arg_output_file) {
    return this.$.patchFileZucchini(arg_input_file, arg_patch_file, arg_output_file);
  }
};
...
mojo.internal.bindings.patch.mojom.FilePatcher.getRemote = function() {
  let remote = new mojo.internal.bindings.patch.mojom.FilePatcherRemote();
...
mojo.internal.bindings.patch.mojom.FilePatcherReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
      ...
      switch (dispatchId) {
        case 0: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.patch.mojom.FilePatcher_PatchFilePuffPatch_ResponseParamsSpec, header, rawHeader);
               responder(response);
        ...
        case 1: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              const rawHeader = (args[2] && args[2].slice) ? args[2].slice(0, header.headerSize) : null;
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.patch.mojom.FilePatcher_PatchFileZucchini_ResponseParamsSpec, header, rawHeader);
               responder(response);
...
mojo.internal.bindings.patch.mojom.FilePatcherReceiver = mojo.internal.bindings.patch.mojom.FilePatcherReceiver;
