...
mojo.internal.Struct(
    mojo.internal.bindings.media_router.mojom.Logger_LogInfo_ParamsSpec, 'media_router.mojom.Logger_LogInfo_Params', [
      mojo.internal.StructField('arg_component', 0, 0, mojo.internal.String, null, false, 0, undefined),
      ...
      mojo.internal.StructField('arg_media_source', 24, 0, mojo.internal.String, null, false, 0, undefined),
      mojo.internal.StructField('arg_session_id', 32, 0, mojo.internal.String, null, false, 0, undefined),
      mojo.internal.StructField('arg_category', 40, 0, mojo.internal.bindings.media_router.mojom.LogCategorySpec, null, false, 0, undefined),
    ],
    [[0, 56]]);
...
mojo.internal.bindings.media_router.mojom.LoggerRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.media_router.mojom.LoggerPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.media_router.mojom.LoggerRemoteCallHandler(this.proxy);
  }
  ...
  logInfo(arg_category, arg_component, arg_message, arg_sink_id, arg_media_source, arg_session_id) {
    return this.$.logInfo(arg_category, arg_component, arg_message, arg_sink_id, arg_media_source, arg_session_id);
  }
  logWarning(arg_category, arg_component, arg_message, arg_sink_id, arg_media_source, arg_session_id) {
    return this.$.logWarning(arg_category, arg_component, arg_message, arg_sink_id, arg_media_source, arg_session_id);
  }
  logError(arg_category, arg_component, arg_message, arg_sink_id, arg_media_source, arg_session_id) {
    return this.$.logError(arg_category, arg_component, arg_message, arg_sink_id, arg_media_source, arg_session_id);
  }
...
mojo.internal.bindings.media_router.mojom.Logger.getRemote = function() {
  let remote = new mojo.internal.bindings.media_router.mojom.LoggerRemote();
...
mojo.internal.bindings.media_router.mojom.LoggerReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.media_router.mojom.Logger_LogInfo_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for LogInfo failed with TypeError');
           }
        }
        // Try Method 1: LogWarning
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.media_router.mojom.Logger_LogWarning_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for LogWarning failed with TypeError');
           }
        }
        // Try Method 2: LogError
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.media_router.mojom.Logger_LogError_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for LogError failed with TypeError');
           }
        }
        // Try Method 3: BindReceiver
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.media_router.mojom.Logger_BindReceiver_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
...
mojo.internal.bindings.media_router.mojom.LoggerReceiver = mojo.internal.bindings.media_router.mojom.LoggerReceiver;
