...
// Enum: IconSize
mojo.internal.bindings.chrome.mojom.IconSize = {
  kSmall: 0,
  kNormal: 1,
  kLarge: 2,
};
...
mojo.internal.bindings.chrome.mojom.UtilReadIconRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.chrome.mojom.UtilReadIconPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.chrome.mojom.UtilReadIconRemoteCallHandler(this.proxy);
  }
  ...
  readIcon(arg_file, arg_size, arg_scale) {
    return this.$.readIcon(arg_file, arg_size, arg_scale);
  }
};
...
mojo.internal.bindings.chrome.mojom.UtilReadIcon.getRemote = function() {
  let remote = new mojo.internal.bindings.chrome.mojom.UtilReadIconRemote();
...
mojo.internal.bindings.chrome.mojom.UtilReadIconReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
        ...
        case 0: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.chrome.mojom.UtilReadIcon_ReadIcon_ResponseParamsSpec, header, rawHeader);
               responder(response);
...
mojo.internal.bindings.chrome.mojom.UtilReadIconReceiver = mojo.internal.bindings.chrome.mojom.UtilReadIconReceiver;
