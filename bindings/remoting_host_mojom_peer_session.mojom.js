// Auto-generated MojoJS binding
 // Source: chromium_src/remoting/host/mojom/peer_session.mojom
...
mojo.internal.bindings.remoting.mojom.SdpTypeSpec = mojo.internal.bindings.remoting.mojom.SdpTypeSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.remoting.mojom.SessionDescriptionSpec = mojo.internal.bindings.remoting.mojom.SessionDescriptionSpec || { $: {} };
if (mojo.internal.bindings.remoting.mojom.SessionDescriptionSpec.$.structSpec && mojo.internal.bindings.remoting.mojom.SessionDescriptionSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.remoting.mojom.SessionDescriptionSpec.$ = {};
mojo.internal.bindings.remoting.mojom.NamedCandidateSpec = mojo.internal.bindings.remoting.mojom.NamedCandidateSpec || { $: {} };
if (mojo.internal.bindings.remoting.mojom.NamedCandidateSpec.$.structSpec && mojo.internal.bindings.remoting.mojom.NamedCandidateSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.remoting.mojom.NamedCandidateSpec.$ = {};
mojo.internal.bindings.remoting.mojom.JingleTransportInfoSpec = mojo.internal.bindings.remoting.mojom.JingleTransportInfoSpec || { $: {} };
if (mojo.internal.bindings.remoting.mojom.JingleTransportInfoSpec.$.structSpec && mojo.internal.bindings.remoting.mojom.JingleTransportInfoSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.remoting.mojom.JingleTransportInfoSpec.$ = {};
mojo.internal.bindings.remoting.mojom.IceConfigSpec = mojo.internal.bindings.remoting.mojom.IceConfigSpec || { $: {} };
if (mojo.internal.bindings.remoting.mojom.IceConfigSpec.$.structSpec && mojo.internal.bindings.remoting.mojom.IceConfigSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.remoting.mojom.IceConfigSpec.$ = {};
mojo.internal.bindings.remoting.mojom.PairingResponseSpec = mojo.internal.bindings.remoting.mojom.PairingResponseSpec || { $: {} };
if (mojo.internal.bindings.remoting.mojom.PairingResponseSpec.$.structSpec && mojo.internal.bindings.remoting.mojom.PairingResponseSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.remoting.mojom.PairingResponseSpec.$ = {};
mojo.internal.bindings.remoting.mojom.PeerSessionManager = mojo.internal.bindings.remoting.mojom.PeerSessionManager || {};
mojo.internal.bindings.remoting.mojom.PeerSessionManagerSpec = mojo.internal.bindings.remoting.mojom.PeerSessionManagerSpec || { $ : {} };
if (mojo.internal.bindings.remoting.mojom.PeerSessionManagerSpec.$.structSpec && mojo.internal.bindings.remoting.mojom.PeerSessionManagerSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.remoting.mojom.PeerSessionManagerSpec.$ = {};
mojo.internal.bindings.remoting.mojom.PeerSessionManager.$interfaceName = 'remoting.mojom.PeerSessionManager';
mojo.internal.bindings.remoting.mojom.PeerSessionManager_LaunchPeerSession_ParamsSpec = mojo.internal.bindings.remoting.mojom.PeerSessionManager_LaunchPeerSession_ParamsSpec || { $: {} };
if (mojo.internal.bindings.remoting.mojom.PeerSessionManager_LaunchPeerSession_ParamsSpec.$.structSpec && mojo.internal.bindings.remoting.mojom.PeerSessionManager_LaunchPeerSession_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.remoting.mojom.PeerSessionManager_LaunchPeerSession_ParamsSpec.$ = {};
mojo.internal.bindings.remoting.mojom.PeerSessionEventHandler = mojo.internal.bindings.remoting.mojom.PeerSessionEventHandler || {};
mojo.internal.bindings.remoting.mojom.PeerSessionEventHandlerSpec = mojo.internal.bindings.remoting.mojom.PeerSessionEventHandlerSpec || { $ : {} };
if (mojo.internal.bindings.remoting.mojom.PeerSessionEventHandlerSpec.$.structSpec && mojo.internal.bindings.remoting.mojom.PeerSessionEventHandlerSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.remoting.mojom.PeerSessionEventHandlerSpec.$ = {};
mojo.internal.bindings.remoting.mojom.PeerSessionEventHandler.$interfaceName = 'remoting.mojom.PeerSessionEventHandler';
mojo.internal.bindings.remoting.mojom.PeerSessionEventHandler_OnSessionChannelsConnected_ParamsSpec = mojo.internal.bindings.remoting.mojom.PeerSessionEventHandler_OnSessionChannelsConnected_ParamsSpec || { $: {} };
if (mojo.internal.bindings.remoting.mojom.PeerSessionEventHandler_OnSessionChannelsConnected_ParamsSpec.$.structSpec && mojo.internal.bindings.remoting.mojom.PeerSessionEventHandler_OnSessionChannelsConnected_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.remoting.mojom.PeerSessionEventHandler_OnSessionChannelsConnected_ParamsSpec.$ = {};
mojo.internal.bindings.remoting.mojom.PeerSessionEventHandler_OnSessionClosed_ParamsSpec = mojo.internal.bindings.remoting.mojom.PeerSessionEventHandler_OnSessionClosed_ParamsSpec || { $: {} };
if (mojo.internal.bindings.remoting.mojom.PeerSessionEventHandler_OnSessionClosed_ParamsSpec.$.structSpec && mojo.internal.bindings.remoting.mojom.PeerSessionEventHandler_OnSessionClosed_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.remoting.mojom.PeerSessionEventHandler_OnSessionClosed_ParamsSpec.$ = {};
mojo.internal.bindings.remoting.mojom.PeerSessionEventHandler_OnSessionRouteChange_ParamsSpec = mojo.internal.bindings.remoting.mojom.PeerSessionEventHandler_OnSessionRouteChange_ParamsSpec || { $: {} };
if (mojo.internal.bindings.remoting.mojom.PeerSessionEventHandler_OnSessionRouteChange_ParamsSpec.$.structSpec && mojo.internal.bindings.remoting.mojom.PeerSessionEventHandler_OnSessionRouteChange_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.remoting.mojom.PeerSessionEventHandler_OnSessionRouteChange_ParamsSpec.$ = {};
mojo.internal.bindings.remoting.mojom.TransportEventHandler = mojo.internal.bindings.remoting.mojom.TransportEventHandler || {};
mojo.internal.bindings.remoting.mojom.TransportEventHandlerSpec = mojo.internal.bindings.remoting.mojom.TransportEventHandlerSpec || { $ : {} };
if (mojo.internal.bindings.remoting.mojom.TransportEventHandlerSpec.$.structSpec && mojo.internal.bindings.remoting.mojom.TransportEventHandlerSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.remoting.mojom.TransportEventHandlerSpec.$ = {};
mojo.internal.bindings.remoting.mojom.TransportEventHandler.$interfaceName = 'remoting.mojom.TransportEventHandler';
mojo.internal.bindings.remoting.mojom.TransportEventHandler_SendTransportInfo_ParamsSpec = mojo.internal.bindings.remoting.mojom.TransportEventHandler_SendTransportInfo_ParamsSpec || { $: {} };
if (mojo.internal.bindings.remoting.mojom.TransportEventHandler_SendTransportInfo_ParamsSpec.$.structSpec && mojo.internal.bindings.remoting.mojom.TransportEventHandler_SendTransportInfo_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.remoting.mojom.TransportEventHandler_SendTransportInfo_ParamsSpec.$ = {};
mojo.internal.bindings.remoting.mojom.IceConfigFetcher = mojo.internal.bindings.remoting.mojom.IceConfigFetcher || {};
mojo.internal.bindings.remoting.mojom.IceConfigFetcherSpec = mojo.internal.bindings.remoting.mojom.IceConfigFetcherSpec || { $ : {} };
if (mojo.internal.bindings.remoting.mojom.IceConfigFetcherSpec.$.structSpec && mojo.internal.bindings.remoting.mojom.IceConfigFetcherSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.remoting.mojom.IceConfigFetcherSpec.$ = {};
mojo.internal.bindings.remoting.mojom.IceConfigFetcher.$interfaceName = 'remoting.mojom.IceConfigFetcher';
mojo.internal.bindings.remoting.mojom.IceConfigFetcher_GetIceConfig_ParamsSpec = mojo.internal.bindings.remoting.mojom.IceConfigFetcher_GetIceConfig_ParamsSpec || { $: {} };
if (mojo.internal.bindings.remoting.mojom.IceConfigFetcher_GetIceConfig_ParamsSpec.$.structSpec && mojo.internal.bindings.remoting.mojom.IceConfigFetcher_GetIceConfig_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.remoting.mojom.IceConfigFetcher_GetIceConfig_ParamsSpec.$ = {};
mojo.internal.bindings.remoting.mojom.IceConfigFetcher_GetIceConfig_ResponseParamsSpec = mojo.internal.bindings.remoting.mojom.IceConfigFetcher_GetIceConfig_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.remoting.mojom.IceConfigFetcher_GetIceConfig_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.remoting.mojom.IceConfigFetcher_GetIceConfig_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.remoting.mojom.IceConfigFetcher_GetIceConfig_ResponseParamsSpec.$ = {};
mojo.internal.bindings.remoting.mojom.PairingRequester = mojo.internal.bindings.remoting.mojom.PairingRequester || {};
mojo.internal.bindings.remoting.mojom.PairingRequesterSpec = mojo.internal.bindings.remoting.mojom.PairingRequesterSpec || { $ : {} };
if (mojo.internal.bindings.remoting.mojom.PairingRequesterSpec.$.structSpec && mojo.internal.bindings.remoting.mojom.PairingRequesterSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.remoting.mojom.PairingRequesterSpec.$ = {};
mojo.internal.bindings.remoting.mojom.PairingRequester.$interfaceName = 'remoting.mojom.PairingRequester';
mojo.internal.bindings.remoting.mojom.PairingRequester_RequestPairing_ParamsSpec = mojo.internal.bindings.remoting.mojom.PairingRequester_RequestPairing_ParamsSpec || { $: {} };
if (mojo.internal.bindings.remoting.mojom.PairingRequester_RequestPairing_ParamsSpec.$.structSpec && mojo.internal.bindings.remoting.mojom.PairingRequester_RequestPairing_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.remoting.mojom.PairingRequester_RequestPairing_ParamsSpec.$ = {};
mojo.internal.bindings.remoting.mojom.PairingRequester_RequestPairing_ResponseParamsSpec = mojo.internal.bindings.remoting.mojom.PairingRequester_RequestPairing_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.remoting.mojom.PairingRequester_RequestPairing_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.remoting.mojom.PairingRequester_RequestPairing_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.remoting.mojom.PairingRequester_RequestPairing_ResponseParamsSpec.$ = {};
mojo.internal.bindings.remoting.mojom.DesktopSessionRequester = mojo.internal.bindings.remoting.mojom.DesktopSessionRequester || {};
mojo.internal.bindings.remoting.mojom.DesktopSessionRequesterSpec = mojo.internal.bindings.remoting.mojom.DesktopSessionRequesterSpec || { $ : {} };
if (mojo.internal.bindings.remoting.mojom.DesktopSessionRequesterSpec.$.structSpec && mojo.internal.bindings.remoting.mojom.DesktopSessionRequesterSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.remoting.mojom.DesktopSessionRequesterSpec.$ = {};
mojo.internal.bindings.remoting.mojom.DesktopSessionRequester.$interfaceName = 'remoting.mojom.DesktopSessionRequester';
mojo.internal.bindings.remoting.mojom.DesktopSessionRequester_RequestDesktopSession_ParamsSpec = mojo.internal.bindings.remoting.mojom.DesktopSessionRequester_RequestDesktopSession_ParamsSpec || { $: {} };
if (mojo.internal.bindings.remoting.mojom.DesktopSessionRequester_RequestDesktopSession_ParamsSpec.$.structSpec && mojo.internal.bindings.remoting.mojom.DesktopSessionRequester_RequestDesktopSession_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.remoting.mojom.DesktopSessionRequester_RequestDesktopSession_ParamsSpec.$ = {};
mojo.internal.bindings.remoting.mojom.PeerSession = mojo.internal.bindings.remoting.mojom.PeerSession || {};
mojo.internal.bindings.remoting.mojom.PeerSessionSpec = mojo.internal.bindings.remoting.mojom.PeerSessionSpec || { $ : {} };
if (mojo.internal.bindings.remoting.mojom.PeerSessionSpec.$.structSpec && mojo.internal.bindings.remoting.mojom.PeerSessionSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.remoting.mojom.PeerSessionSpec.$ = {};
mojo.internal.bindings.remoting.mojom.PeerSession.$interfaceName = 'remoting.mojom.PeerSession';
mojo.internal.bindings.remoting.mojom.PeerSession_Start_ParamsSpec = mojo.internal.bindings.remoting.mojom.PeerSession_Start_ParamsSpec || { $: {} };
if (mojo.internal.bindings.remoting.mojom.PeerSession_Start_ParamsSpec.$.structSpec && mojo.internal.bindings.remoting.mojom.PeerSession_Start_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.remoting.mojom.PeerSession_Start_ParamsSpec.$ = {};
mojo.internal.bindings.remoting.mojom.PeerSession_StartTransport_ParamsSpec = mojo.internal.bindings.remoting.mojom.PeerSession_StartTransport_ParamsSpec || { $: {} };
if (mojo.internal.bindings.remoting.mojom.PeerSession_StartTransport_ParamsSpec.$.structSpec && mojo.internal.bindings.remoting.mojom.PeerSession_StartTransport_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.remoting.mojom.PeerSession_StartTransport_ParamsSpec.$ = {};
mojo.internal.bindings.remoting.mojom.PeerSession_ProcessTransportInfo_ParamsSpec = mojo.internal.bindings.remoting.mojom.PeerSession_ProcessTransportInfo_ParamsSpec || { $: {} };
if (mojo.internal.bindings.remoting.mojom.PeerSession_ProcessTransportInfo_ParamsSpec.$.structSpec && mojo.internal.bindings.remoting.mojom.PeerSession_ProcessTransportInfo_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.remoting.mojom.PeerSession_ProcessTransportInfo_ParamsSpec.$ = {};
mojo.internal.bindings.remoting.mojom.PeerSession_DisconnectSession_ParamsSpec = mojo.internal.bindings.remoting.mojom.PeerSession_DisconnectSession_ParamsSpec || { $: {} };
if (mojo.internal.bindings.remoting.mojom.PeerSession_DisconnectSession_ParamsSpec.$.structSpec && mojo.internal.bindings.remoting.mojom.PeerSession_DisconnectSession_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.remoting.mojom.PeerSession_DisconnectSession_ParamsSpec.$ = {};
mojo.internal.bindings.remoting.mojom.PeerConnectionProcessControl = mojo.internal.bindings.remoting.mojom.PeerConnectionProcessControl || {};
mojo.internal.bindings.remoting.mojom.PeerConnectionProcessControlSpec = mojo.internal.bindings.remoting.mojom.PeerConnectionProcessControlSpec || { $ : {} };
if (mojo.internal.bindings.remoting.mojom.PeerConnectionProcessControlSpec.$.structSpec && mojo.internal.bindings.remoting.mojom.PeerConnectionProcessControlSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.remoting.mojom.PeerConnectionProcessControlSpec.$ = {};
mojo.internal.bindings.remoting.mojom.PeerConnectionProcessControl.$interfaceName = 'remoting.mojom.PeerConnectionProcessControl';
mojo.internal.bindings.remoting.mojom.PeerConnectionProcessControl_BindPeerSession_ParamsSpec = mojo.internal.bindings.remoting.mojom.PeerConnectionProcessControl_BindPeerSession_ParamsSpec || { $: {} };
if (mojo.internal.bindings.remoting.mojom.PeerConnectionProcessControl_BindPeerSession_ParamsSpec.$.structSpec && mojo.internal.bindings.remoting.mojom.PeerConnectionProcessControl_BindPeerSession_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.remoting.mojom.PeerConnectionProcessControl_BindPeerSession_ParamsSpec.$ = {};
...
mojo.internal.bindings.remoting = mojo.internal.bindings.remoting || {};
mojo.internal.bindings.remoting.mojom = mojo.internal.bindings.remoting.mojom || {};
mojo.internal.bindings.remoting.mojom.DesktopEnvironmentOptionsSpec = mojo.internal.bindings.remoting.mojom.DesktopEnvironmentOptionsSpec || { $: mojo.internal.OpaqueStruct.$ };
mojo.internal.bindings.remoting = mojo.internal.bindings.remoting || {};
mojo.internal.bindings.remoting.mojom = mojo.internal.bindings.remoting.mojom || {};
mojo.internal.bindings.remoting.mojom.DesktopSessionSpec = mojo.internal.bindings.remoting.mojom.DesktopSessionSpec || { $: mojo.internal.OpaqueStruct.$ };
mojo.internal.bindings.remoting.mojom.DesktopSessionRemote = mojo.internal.bindings.remoting.mojom.DesktopSessionRemote || class {};
mojo.internal.bindings.remoting.mojom.DesktopSessionPendingReceiver = mojo.internal.bindings.remoting.mojom.DesktopSessionPendingReceiver || class { constructor(handle) { this.handle = handle; } };
mojo.internal.bindings.remoting = mojo.internal.bindings.remoting || {};
mojo.internal.bindings.remoting.mojom = mojo.internal.bindings.remoting.mojom || {};
mojo.internal.bindings.remoting.mojom.DesktopSessionEventsSpec = mojo.internal.bindings.remoting.mojom.DesktopSessionEventsSpec || { $: mojo.internal.OpaqueStruct.$ };
mojo.internal.bindings.remoting.mojom.DesktopSessionEventsRemote = mojo.internal.bindings.remoting.mojom.DesktopSessionEventsRemote || class {};
mojo.internal.bindings.remoting.mojom.DesktopSessionEventsPendingReceiver = mojo.internal.bindings.remoting.mojom.DesktopSessionEventsPendingReceiver || class { constructor(handle) { this.handle = handle; } };
mojo.internal.bindings.remoting = mojo.internal.bindings.remoting || {};
mojo.internal.bindings.remoting.mojom = mojo.internal.bindings.remoting.mojom || {};
mojo.internal.bindings.remoting.mojom.ProtocolErrorCodeSpec = mojo.internal.bindings.remoting.mojom.ProtocolErrorCodeSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.remoting = mojo.internal.bindings.remoting || {};
mojo.internal.bindings.remoting.mojom = mojo.internal.bindings.remoting.mojom || {};
mojo.internal.bindings.remoting.mojom.ScreenResolutionSpec = mojo.internal.bindings.remoting.mojom.ScreenResolutionSpec || { $: mojo.internal.OpaqueStruct.$ };
mojo.internal.bindings.remoting = mojo.internal.bindings.remoting || {};
mojo.internal.bindings.remoting.mojom = mojo.internal.bindings.remoting.mojom || {};
mojo.internal.bindings.remoting.mojom.SessionOptionsSpec = mojo.internal.bindings.remoting.mojom.SessionOptionsSpec || { $: mojo.internal.OpaqueStruct.$ };
mojo.internal.bindings.remoting = mojo.internal.bindings.remoting || {};
mojo.internal.bindings.remoting.mojom = mojo.internal.bindings.remoting.mojom || {};
mojo.internal.bindings.remoting.mojom.SessionPoliciesSpec = mojo.internal.bindings.remoting.mojom.SessionPoliciesSpec || { $: mojo.internal.OpaqueStruct.$ };
mojo.internal.bindings.remoting = mojo.internal.bindings.remoting || {};
mojo.internal.bindings.remoting.mojom = mojo.internal.bindings.remoting.mojom || {};
mojo.internal.bindings.remoting.mojom.SourceLocationSpec = mojo.internal.bindings.remoting.mojom.SourceLocationSpec || { $: mojo.internal.OpaqueStruct.$ };
mojo.internal.bindings.remoting = mojo.internal.bindings.remoting || {};
mojo.internal.bindings.remoting.mojom = mojo.internal.bindings.remoting.mojom || {};
mojo.internal.bindings.remoting.mojom.TransportRouteSpec = mojo.internal.bindings.remoting.mojom.TransportRouteSpec || { $: mojo.internal.OpaqueStruct.$ };
mojo.internal.bindings.remoting = mojo.internal.bindings.remoting || {};
mojo.internal.bindings.remoting.mojom = mojo.internal.bindings.remoting.mojom || {};
mojo.internal.bindings.remoting.mojom.WebrtcCandidateSpec = mojo.internal.bindings.remoting.mojom.WebrtcCandidateSpec || { $: mojo.internal.OpaqueStruct.$ };
mojo.internal.bindings.remoting = mojo.internal.bindings.remoting || {};
mojo.internal.bindings.remoting.mojom = mojo.internal.bindings.remoting.mojom || {};
mojo.internal.bindings.remoting.mojom.WebrtcRelayServerConfigSpec = mojo.internal.bindings.remoting.mojom.WebrtcRelayServerConfigSpec || { $: mojo.internal.OpaqueStruct.$ };
mojo.internal.bindings.remoting = mojo.internal.bindings.remoting || {};
mojo.internal.bindings.remoting.mojom = mojo.internal.bindings.remoting.mojom || {};
mojo.internal.bindings.remoting.mojom.WebrtcSocketAddressSpec = mojo.internal.bindings.remoting.mojom.WebrtcSocketAddressSpec || { $: mojo.internal.OpaqueStruct.$ };

// Enum: SdpType
mojo.internal.bindings.remoting.mojom.SdpType = {
  kUnspecified: 0,
  kOffer: 1,
  kAnswer: 2,
};
...
mojo.internal.bindings.remoting.mojom.PeerSessionManagerPendingReceiver = class {
  constructor(handle) {
    this.handle = handle;
    if (handle) {
...
mojo.internal.bindings.remoting.mojom.PeerSessionManagerRemote = class {
  static get $interfaceName() {
    return 'remoting.mojom.PeerSessionManager';
  }

  constructor(handle = undefined) {
    this.__mojoHandle = handle;
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.remoting.mojom.PeerSessionManagerPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.remoting.mojom.PeerSessionManagerRemoteCallHandler(this.proxy);
  }
  ...
  launchPeerSession(arg_peer_session_receiver) {
    return this.$.launchPeerSession(arg_peer_session_receiver);
  }
};

mojo.internal.bindings.remoting.mojom.PeerSessionManagerRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('remoting.mojom.PeerSessionManager', [
      { explicit: null },
    ]);
  }
  ...
  launchPeerSession(arg_peer_session_receiver) {
    return this.proxy.sendMessage(
      ...
      mojo.internal.bindings.remoting.mojom.PeerSessionManager_LaunchPeerSession_ParamsSpec,
      null,
      [arg_peer_session_receiver],
      false);
  }

};

mojo.internal.bindings.remoting.mojom.PeerSessionManager.getRemote = function() {
  let remote = new mojo.internal.bindings.remoting.mojom.PeerSessionManagerRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
    'remoting.mojom.PeerSessionManager',
    'context');
  return remote.$;
};

mojo.internal.bindings.remoting.mojom.PeerSessionManagerReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('remoting.mojom.PeerSessionManager', [
      { explicit: null },
    ]);
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        case 0: {
          ...
          const params = decoder.decodeStructInline(mojo.internal.bindings.remoting.mojom.PeerSessionManager_LaunchPeerSession_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.launchPeerSession');
          const result = this.impl.launchPeerSession(params.arg_peer_session_receiver);
          break;
        }
      }
      } catch (err) {
...
mojo.internal.bindings.remoting.mojom.PeerSessionManagerReceiver = mojo.internal.bindings.remoting.mojom.PeerSessionManagerReceiver;

mojo.internal.bindings.remoting.mojom.PeerSessionManagerPtr = mojo.internal.bindings.remoting.mojom.PeerSessionManagerRemote;
mojo.internal.bindings.remoting.mojom.PeerSessionManagerRequest = mojo.internal.bindings.remoting.mojom.PeerSessionManagerPendingReceiver;


// Interface: PeerSessionEventHandler
mojo.internal.bindings.remoting.mojom.PeerSessionEventHandlerPendingReceiver = class {
  constructor(handle) {
    this.handle = handle;
    if (handle) {
      this.__mojoHandle = handle.router_ ? handle.router_.pipe_ : (handle.pipe_ || handle);
...
mojo.internal.bindings.remoting.mojom.PeerSessionEventHandlerRemote = class {
  static get $interfaceName() {
    return 'remoting.mojom.PeerSessionEventHandler';
  }

  constructor(handle = undefined) {
    this.__mojoHandle = handle;
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.remoting.mojom.PeerSessionEventHandlerPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.remoting.mojom.PeerSessionEventHandlerRemoteCallHandler(this.proxy);
  }
  ...
  onSessionChannelsConnected() {
    return this.$.onSessionChannelsConnected();
  }
  onSessionClosed(arg_error, arg_error_details, arg_error_location) {
    return this.$.onSessionClosed(arg_error, arg_error_details, arg_error_location);
  }
  onSessionRouteChange(arg_channel_name, arg_route) {
    return this.$.onSessionRouteChange(arg_channel_name, arg_route);
  }
};

mojo.internal.bindings.remoting.mojom.PeerSessionEventHandlerRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('remoting.mojom.PeerSessionEventHandler', [
      { explicit: null },
      { explicit: null },
      { explicit: null },
    ]);
  ...
  onSessionClosed(arg_error, arg_error_details, arg_error_location) {
    return this.proxy.sendMessage(
      ...
      mojo.internal.bindings.remoting.mojom.PeerSessionEventHandler_OnSessionClosed_ParamsSpec,
      null,
      [arg_error, arg_error_details, arg_error_location],
      false);
  }
  ...
  onSessionRouteChange(arg_channel_name, arg_route) {
    return this.proxy.sendMessage(
      ...
      mojo.internal.bindings.remoting.mojom.PeerSessionEventHandler_OnSessionRouteChange_ParamsSpec,
      null,
      [arg_channel_name, arg_route],
      false);
  }

};

mojo.internal.bindings.remoting.mojom.PeerSessionEventHandler.getRemote = function() {
  let remote = new mojo.internal.bindings.remoting.mojom.PeerSessionEventHandlerRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
...
mojo.internal.bindings.remoting.mojom.PeerSessionEventHandlerReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('remoting.mojom.PeerSessionEventHandler', [
      { explicit: null },
      { explicit: null },
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.remoting.mojom.PeerSessionEventHandler_OnSessionChannelsConnected_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.onSessionChannelsConnected');
          const result = this.impl.onSessionChannelsConnected();
          break;
        }
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.remoting.mojom.PeerSessionEventHandler_OnSessionClosed_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.onSessionClosed');
          const result = this.impl.onSessionClosed(params.arg_error, params.arg_error_details, params.arg_error_location);
          break;
        }
        case 2: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.remoting.mojom.PeerSessionEventHandler_OnSessionRouteChange_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.onSessionRouteChange');
          const result = this.impl.onSessionRouteChange(params.arg_channel_name, params.arg_route);
          break;
        }
      }
      } catch (err) {
...
mojo.internal.bindings.remoting.mojom.PeerSessionEventHandlerReceiver = mojo.internal.bindings.remoting.mojom.PeerSessionEventHandlerReceiver;

mojo.internal.bindings.remoting.mojom.PeerSessionEventHandlerPtr = mojo.internal.bindings.remoting.mojom.PeerSessionEventHandlerRemote;
mojo.internal.bindings.remoting.mojom.PeerSessionEventHandlerRequest = mojo.internal.bindings.remoting.mojom.PeerSessionEventHandlerPendingReceiver;


// Interface: TransportEventHandler
mojo.internal.bindings.remoting.mojom.TransportEventHandlerPendingReceiver = class {
  constructor(handle) {
    this.handle = handle;
    if (handle) {
      this.__mojoHandle = handle.router_ ? handle.router_.pipe_ : (handle.pipe_ || handle);
...
mojo.internal.bindings.remoting.mojom.TransportEventHandlerRemote = class {
  static get $interfaceName() {
    return 'remoting.mojom.TransportEventHandler';
  }

  constructor(handle = undefined) {
    this.__mojoHandle = handle;
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.remoting.mojom.TransportEventHandlerPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.remoting.mojom.TransportEventHandlerRemoteCallHandler(this.proxy);
  }
  ...
  sendTransportInfo(arg_transport_info) {
    return this.$.sendTransportInfo(arg_transport_info);
  }
};

mojo.internal.bindings.remoting.mojom.TransportEventHandlerRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('remoting.mojom.TransportEventHandler', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.remoting.mojom.TransportEventHandler.getRemote = function() {
  let remote = new mojo.internal.bindings.remoting.mojom.TransportEventHandlerRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
    'remoting.mojom.TransportEventHandler',
    'context');
  return remote.$;
};

mojo.internal.bindings.remoting.mojom.TransportEventHandlerReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('remoting.mojom.TransportEventHandler', [
      { explicit: null },
    ]);
    ordinals.forEach((ord, idx) => {
      this.ordinalMap.set(ord, idx); // Scrambled/Explicit
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.remoting.mojom.TransportEventHandler_SendTransportInfo_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.sendTransportInfo');
          const result = this.impl.sendTransportInfo(params.arg_transport_info);
          break;
        }
      }
      } catch (err) {
...
mojo.internal.bindings.remoting.mojom.TransportEventHandlerReceiver = mojo.internal.bindings.remoting.mojom.TransportEventHandlerReceiver;

mojo.internal.bindings.remoting.mojom.TransportEventHandlerPtr = mojo.internal.bindings.remoting.mojom.TransportEventHandlerRemote;
mojo.internal.bindings.remoting.mojom.TransportEventHandlerRequest = mojo.internal.bindings.remoting.mojom.TransportEventHandlerPendingReceiver;


// Interface: IceConfigFetcher
mojo.internal.bindings.remoting.mojom.IceConfigFetcherPendingReceiver = class {
  constructor(handle) {
    this.handle = handle;
    if (handle) {
      this.__mojoHandle = handle.router_ ? handle.router_.pipe_ : (handle.pipe_ || handle);
...
mojo.internal.bindings.remoting.mojom.IceConfigFetcherRemote = class {
  static get $interfaceName() {
    return 'remoting.mojom.IceConfigFetcher';
  }

  constructor(handle = undefined) {
    this.__mojoHandle = handle;
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.remoting.mojom.IceConfigFetcherPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.remoting.mojom.IceConfigFetcherRemoteCallHandler(this.proxy);
  }
  ...
  getIceConfig() {
    return this.$.getIceConfig();
  }
};

mojo.internal.bindings.remoting.mojom.IceConfigFetcherRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('remoting.mojom.IceConfigFetcher', [
      { explicit: null },
    ]);
  }
  ...
  getIceConfig() {
    return this.proxy.sendMessage(
      this.ordinals[0],  // ordinal
      mojo.internal.bindings.remoting.mojom.IceConfigFetcher_GetIceConfig_ParamsSpec,
      mojo.internal.bindings.remoting.mojom.IceConfigFetcher_GetIceConfig_ResponseParamsSpec,
      [],
      false);
  }
...
mojo.internal.bindings.remoting.mojom.IceConfigFetcher.getRemote = function() {
  let remote = new mojo.internal.bindings.remoting.mojom.IceConfigFetcherRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
    'remoting.mojom.IceConfigFetcher',
    'context');
  return remote.$;
};

mojo.internal.bindings.remoting.mojom.IceConfigFetcherReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('remoting.mojom.IceConfigFetcher', [
      { explicit: null },
    ]);
    ordinals.forEach((ord, idx) => {
      this.ordinalMap.set(ord, idx); // Scrambled/Explicit
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.remoting.mojom.IceConfigFetcher_GetIceConfig_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.getIceConfig');
          const result = this.impl.getIceConfig();
          const expectsResponse = header.expectsResponse || (header.flags & 1);
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              const val = (response && typeof response === 'object' && 'arg_ice_config' in response) ? response['arg_ice_config'] : response;
              const resp_obj = { 'arg_ice_config': val };
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.remoting.mojom.IceConfigFetcher_GetIceConfig_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
            }).catch(e => console.error('[GeneratedReceiver] getIceConfig FAILED:', e));
          }
          break;
        }
      }
...
mojo.internal.bindings.remoting.mojom.IceConfigFetcherReceiver = mojo.internal.bindings.remoting.mojom.IceConfigFetcherReceiver;

mojo.internal.bindings.remoting.mojom.IceConfigFetcherPtr = mojo.internal.bindings.remoting.mojom.IceConfigFetcherRemote;
mojo.internal.bindings.remoting.mojom.IceConfigFetcherRequest = mojo.internal.bindings.remoting.mojom.IceConfigFetcherPendingReceiver;


// Interface: PairingRequester
mojo.internal.bindings.remoting.mojom.PairingRequesterPendingReceiver = class {
  constructor(handle) {
    this.handle = handle;
    if (handle) {
      this.__mojoHandle = handle.router_ ? handle.router_.pipe_ : (handle.pipe_ || handle);
...
mojo.internal.bindings.remoting.mojom.PairingRequesterRemote = class {
  static get $interfaceName() {
    return 'remoting.mojom.PairingRequester';
  }

  constructor(handle = undefined) {
    this.__mojoHandle = handle;
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.remoting.mojom.PairingRequesterPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.remoting.mojom.PairingRequesterRemoteCallHandler(this.proxy);
  }
  ...
  requestPairing(arg_client_name) {
    return this.$.requestPairing(arg_client_name);
  }
};

mojo.internal.bindings.remoting.mojom.PairingRequesterRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('remoting.mojom.PairingRequester', [
      { explicit: null },
    ]);
  }
  ...
  requestPairing(arg_client_name) {
    return this.proxy.sendMessage(
      this.ordinals[0],  // ordinal
      mojo.internal.bindings.remoting.mojom.PairingRequester_RequestPairing_ParamsSpec,
      mojo.internal.bindings.remoting.mojom.PairingRequester_RequestPairing_ResponseParamsSpec,
      [arg_client_name],
      false);
  }
...
mojo.internal.bindings.remoting.mojom.PairingRequester.getRemote = function() {
  let remote = new mojo.internal.bindings.remoting.mojom.PairingRequesterRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
    'remoting.mojom.PairingRequester',
    'context');
  return remote.$;
};

mojo.internal.bindings.remoting.mojom.PairingRequesterReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('remoting.mojom.PairingRequester', [
      { explicit: null },
    ]);
    ordinals.forEach((ord, idx) => {
      this.ordinalMap.set(ord, idx); // Scrambled/Explicit
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.remoting.mojom.PairingRequester_RequestPairing_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.requestPairing');
          const result = this.impl.requestPairing(params.arg_client_name);
          const expectsResponse = header.expectsResponse || (header.flags & 1);
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              const val = (response && typeof response === 'object' && 'arg_pairing_response' in response) ? response['arg_pairing_response'] : response;
              const resp_obj = { 'arg_pairing_response': val };
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.remoting.mojom.PairingRequester_RequestPairing_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
            }).catch(e => console.error('[GeneratedReceiver] requestPairing FAILED:', e));
          }
          break;
        }
      }
...
mojo.internal.bindings.remoting.mojom.PairingRequesterReceiver = mojo.internal.bindings.remoting.mojom.PairingRequesterReceiver;

mojo.internal.bindings.remoting.mojom.PairingRequesterPtr = mojo.internal.bindings.remoting.mojom.PairingRequesterRemote;
mojo.internal.bindings.remoting.mojom.PairingRequesterRequest = mojo.internal.bindings.remoting.mojom.PairingRequesterPendingReceiver;


// Interface: DesktopSessionRequester
mojo.internal.bindings.remoting.mojom.DesktopSessionRequesterPendingReceiver = class {
  constructor(handle) {
    this.handle = handle;
    if (handle) {
      this.__mojoHandle = handle.router_ ? handle.router_.pipe_ : (handle.pipe_ || handle);
...
mojo.internal.bindings.remoting.mojom.DesktopSessionRequesterRemote = class {
  static get $interfaceName() {
    return 'remoting.mojom.DesktopSessionRequester';
  }

  constructor(handle = undefined) {
    this.__mojoHandle = handle;
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.remoting.mojom.DesktopSessionRequesterPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.remoting.mojom.DesktopSessionRequesterRemoteCallHandler(this.proxy);
  }
  ...
  requestDesktopSession(arg_control_receiver, arg_events_remote, arg_screen_resolution) {
    return this.$.requestDesktopSession(arg_control_receiver, arg_events_remote, arg_screen_resolution);
  }
};

mojo.internal.bindings.remoting.mojom.DesktopSessionRequesterRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('remoting.mojom.DesktopSessionRequester', [
      { explicit: null },
    ]);
  }
  ...
  requestDesktopSession(arg_control_receiver, arg_events_remote, arg_screen_resolution) {
    return this.proxy.sendMessage(
      ...
      mojo.internal.bindings.remoting.mojom.DesktopSessionRequester_RequestDesktopSession_ParamsSpec,
      null,
      [arg_control_receiver, arg_events_remote, arg_screen_resolution],
      false);
  }

};

mojo.internal.bindings.remoting.mojom.DesktopSessionRequester.getRemote = function() {
  let remote = new mojo.internal.bindings.remoting.mojom.DesktopSessionRequesterRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
    'remoting.mojom.DesktopSessionRequester',
    'context');
  return remote.$;
};

mojo.internal.bindings.remoting.mojom.DesktopSessionRequesterReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('remoting.mojom.DesktopSessionRequester', [
      { explicit: null },
    ]);
    ordinals.forEach((ord, idx) => {
      this.ordinalMap.set(ord, idx); // Scrambled/Explicit
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.remoting.mojom.DesktopSessionRequester_RequestDesktopSession_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.requestDesktopSession');
          const result = this.impl.requestDesktopSession(params.arg_control_receiver, params.arg_events_remote, params.arg_screen_resolution);
          break;
        }
      }
      } catch (err) {
...
mojo.internal.bindings.remoting.mojom.DesktopSessionRequesterReceiver = mojo.internal.bindings.remoting.mojom.DesktopSessionRequesterReceiver;

mojo.internal.bindings.remoting.mojom.DesktopSessionRequesterPtr = mojo.internal.bindings.remoting.mojom.DesktopSessionRequesterRemote;
mojo.internal.bindings.remoting.mojom.DesktopSessionRequesterRequest = mojo.internal.bindings.remoting.mojom.DesktopSessionRequesterPendingReceiver;


// Interface: PeerSession
mojo.internal.bindings.remoting.mojom.PeerSessionPendingReceiver = class {
  constructor(handle) {
    this.handle = handle;
    if (handle) {
      this.__mojoHandle = handle.router_ ? handle.router_.pipe_ : (handle.pipe_ || handle);
...
mojo.internal.bindings.remoting.mojom.PeerSessionRemote = class {
  static get $interfaceName() {
    return 'remoting.mojom.PeerSession';
  }

  constructor(handle = undefined) {
    this.__mojoHandle = handle;
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.remoting.mojom.PeerSessionPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.remoting.mojom.PeerSessionRemoteCallHandler(this.proxy);
  }
  ...
  start(arg_client_jid, arg_event_handler, arg_desktop_session_requester, arg_ice_config_fetcher, arg_pairing_requester, arg_desktop_environment_options, arg_session_policies, arg_session_options) {
    return this.$.start(arg_client_jid, arg_event_handler, arg_desktop_session_requester, arg_ice_config_fetcher, arg_pairing_requester, arg_desktop_environment_options, arg_session_policies, arg_session_options);
  }
  startTransport(arg_auth_key, arg_transport_event_handler) {
    return this.$.startTransport(arg_auth_key, arg_transport_event_handler);
  }
  processTransportInfo(arg_transport_info) {
    return this.$.processTransportInfo(arg_transport_info);
  }
  disconnectSession(arg_error, arg_error_details, arg_error_location) {
    return this.$.disconnectSession(arg_error, arg_error_details, arg_error_location);
  }
};

mojo.internal.bindings.remoting.mojom.PeerSessionRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('remoting.mojom.PeerSession', [
      { explicit: null },
      { explicit: null },
      { explicit: null },
      { explicit: null },
  ...
  start(arg_client_jid, arg_event_handler, arg_desktop_session_requester, arg_ice_config_fetcher, arg_pairing_requester, arg_desktop_environment_options, arg_session_policies, arg_session_options) {
    return this.proxy.sendMessage(
      this.ordinals[0],  // ordinal
      mojo.internal.bindings.remoting.mojom.PeerSession_Start_ParamsSpec,
      null,
      [arg_client_jid, arg_event_handler, arg_desktop_session_requester, arg_ice_config_fetcher, arg_pairing_requester, arg_desktop_environment_options, arg_session_policies, arg_session_options],
      false);
  }
  ...
  startTransport(arg_auth_key, arg_transport_event_handler) {
    return this.proxy.sendMessage(
      this.ordinals[1],  // ordinal
      mojo.internal.bindings.remoting.mojom.PeerSession_StartTransport_ParamsSpec,
      null,
      [arg_auth_key, arg_transport_event_handler],
      false);
  }
  ...
  processTransportInfo(arg_transport_info) {
    return this.proxy.sendMessage(
      this.ordinals[2],  // ordinal
      mojo.internal.bindings.remoting.mojom.PeerSession_ProcessTransportInfo_ParamsSpec,
      null,
      [arg_transport_info],
      false);
  }
  ...
  disconnectSession(arg_error, arg_error_details, arg_error_location) {
    return this.proxy.sendMessage(
      ...
      mojo.internal.bindings.remoting.mojom.PeerSession_DisconnectSession_ParamsSpec,
      null,
      [arg_error, arg_error_details, arg_error_location],
      false);
  }
...
mojo.internal.bindings.remoting.mojom.PeerSession.getRemote = function() {
  let remote = new mojo.internal.bindings.remoting.mojom.PeerSessionRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
    'remoting.mojom.PeerSession',
    'context');
  return remote.$;
};

mojo.internal.bindings.remoting.mojom.PeerSessionReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('remoting.mojom.PeerSession', [
      { explicit: null },
      { explicit: null },
      { explicit: null },
      { explicit: null },
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.remoting.mojom.PeerSession_Start_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.start');
          const result = this.impl.start(params.arg_client_jid, params.arg_event_handler, params.arg_desktop_session_requester, params.arg_ice_config_fetcher, params.arg_pairing_requester, params.arg_desktop_environment_options, params.arg_session_policies, params.arg_session_options);
          break;
        }
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.remoting.mojom.PeerSession_StartTransport_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.startTransport');
          const result = this.impl.startTransport(params.arg_auth_key, params.arg_transport_event_handler);
          break;
        }
        case 2: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.remoting.mojom.PeerSession_ProcessTransportInfo_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.processTransportInfo');
          const result = this.impl.processTransportInfo(params.arg_transport_info);
          break;
        }
        case 3: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.remoting.mojom.PeerSession_DisconnectSession_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.disconnectSession');
          const result = this.impl.disconnectSession(params.arg_error, params.arg_error_details, params.arg_error_location);
          break;
        }
      }
      } catch (err) {
...
mojo.internal.bindings.remoting.mojom.PeerSessionReceiver = mojo.internal.bindings.remoting.mojom.PeerSessionReceiver;

mojo.internal.bindings.remoting.mojom.PeerSessionPtr = mojo.internal.bindings.remoting.mojom.PeerSessionRemote;
mojo.internal.bindings.remoting.mojom.PeerSessionRequest = mojo.internal.bindings.remoting.mojom.PeerSessionPendingReceiver;


// Interface: PeerConnectionProcessControl
mojo.internal.bindings.remoting.mojom.PeerConnectionProcessControlPendingReceiver = class {
  constructor(handle) {
    this.handle = handle;
    if (handle) {
      this.__mojoHandle = handle.router_ ? handle.router_.pipe_ : (handle.pipe_ || handle);
...
mojo.internal.bindings.remoting.mojom.PeerConnectionProcessControlRemote = class {
  static get $interfaceName() {
    return 'remoting.mojom.PeerConnectionProcessControl';
  }

  constructor(handle = undefined) {
    this.__mojoHandle = handle;
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.remoting.mojom.PeerConnectionProcessControlPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.remoting.mojom.PeerConnectionProcessControlRemoteCallHandler(this.proxy);
  }
  ...
  bindPeerSession(arg_session_receiver) {
    return this.$.bindPeerSession(arg_session_receiver);
  }
};

mojo.internal.bindings.remoting.mojom.PeerConnectionProcessControlRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('remoting.mojom.PeerConnectionProcessControl', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.remoting.mojom.PeerConnectionProcessControl.getRemote = function() {
  let remote = new mojo.internal.bindings.remoting.mojom.PeerConnectionProcessControlRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
    'remoting.mojom.PeerConnectionProcessControl',
    'context');
  return remote.$;
};

mojo.internal.bindings.remoting.mojom.PeerConnectionProcessControlReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('remoting.mojom.PeerConnectionProcessControl', [
      { explicit: null },
    ]);
    ordinals.forEach((ord, idx) => {
      this.ordinalMap.set(ord, idx); // Scrambled/Explicit
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.remoting.mojom.PeerConnectionProcessControl_BindPeerSession_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.bindPeerSession');
          const result = this.impl.bindPeerSession(params.arg_session_receiver);
          break;
        }
      }
      } catch (err) {
...
mojo.internal.bindings.remoting.mojom.PeerConnectionProcessControlReceiver = mojo.internal.bindings.remoting.mojom.PeerConnectionProcessControlReceiver;

mojo.internal.bindings.remoting.mojom.PeerConnectionProcessControlPtr = mojo.internal.bindings.remoting.mojom.PeerConnectionProcessControlRemote;
mojo.internal.bindings.remoting.mojom.PeerConnectionProcessControlRequest = mojo.internal.bindings.remoting.mojom.PeerConnectionProcessControlPendingReceiver;
...
mojo.internal.Struct(
    mojo.internal.bindings.remoting.mojom.SessionDescriptionSpec, 'remoting.mojom.SessionDescription', [
      mojo.internal.StructField('arg_type', 0, 0, mojo.internal.bindings.remoting.mojom.SdpTypeSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_sdp', 8, 0, mojo.internal.String, null, false, 0, undefined),
...
mojo.internal.Struct(
    mojo.internal.bindings.remoting.mojom.NamedCandidateSpec, 'remoting.mojom.NamedCandidate', [
      mojo.internal.StructField('arg_sdp_mid', 0, 0, mojo.internal.String, null, false, 0, undefined),
      mojo.internal.StructField('arg_sdp_m_line_index_$flag', 8, 0, mojo.internal.Bool, false, false, 0, { isPrimary: true, linkedValueFieldName: 'arg_sdp_m_line_index_$value', originalFieldName: 'arg_sdp_m_line_index' }),
      mojo.internal.StructField('arg_sdp_m_line_index_$value', 12, 0, mojo.internal.Int32, 0, false, 0, { isPrimary: false, linkedValueFieldName: 'arg_sdp_m_line_index_$flag', originalFieldName: 'arg_sdp_m_line_index' }),
      mojo.internal.StructField('arg_candidate', 16, 0, mojo.internal.bindings.remoting.mojom.WebrtcCandidateSpec, null, false, 0, undefined),
    ],
    [[0, 32]]);

// Struct: JingleTransportInfo
mojo.internal.Struct(
    mojo.internal.bindings.remoting.mojom.JingleTransportInfoSpec, 'remoting.mojom.JingleTransportInfo', [
      mojo.internal.StructField('arg_candidates', 0, 0, mojo.internal.Array(mojo.internal.bindings.remoting.mojom.NamedCandidateSpec, false), null, false, 0, undefined),
      mojo.internal.StructField('arg_session_description', 8, 0, mojo.internal.bindings.remoting.mojom.SessionDescriptionSpec, null, true, 0, undefined),
    ],
    [[0, 24]]);

// Struct: IceConfig
mojo.internal.Struct(
    mojo.internal.bindings.remoting.mojom.IceConfigSpec, 'remoting.mojom.IceConfig', [
      mojo.internal.StructField('arg_expiration_time', 0, 0, mojo.internal.bindings.mojo_base.mojom.TimeSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_stun_servers', 8, 0, mojo.internal.Array(mojo.internal.bindings.remoting.mojom.WebrtcSocketAddressSpec, false), null, false, 0, undefined),
      mojo.internal.StructField('arg_turn_servers', 16, 0, mojo.internal.Array(mojo.internal.bindings.remoting.mojom.WebrtcRelayServerConfigSpec, false), null, false, 0, undefined),
      mojo.internal.StructField('arg_max_bitrate_kbps', 24, 0, mojo.internal.Int32, 0, false, 0, undefined),
    ],
    [[0, 40]]);

// Struct: PairingResponse
mojo.internal.Struct(
    mojo.internal.bindings.remoting.mojom.PairingResponseSpec, 'remoting.mojom.PairingResponse', [
      mojo.internal.StructField('arg_client_id', 0, 0, mojo.internal.String, null, false, 0, undefined),
      mojo.internal.StructField('arg_shared_secret', 8, 0, mojo.internal.String, null, false, 0, undefined),
    ],
    [[0, 24]]);
mojo.internal.Struct(
    mojo.internal.bindings.remoting.mojom.PeerSessionManager_LaunchPeerSession_ParamsSpec, 'remoting.mojom.PeerSessionManager_LaunchPeerSession_Params', [
      mojo.internal.StructField('arg_peer_session_receiver', 0, 0, mojo.internal.InterfaceRequest(mojo.internal.bindings.remoting.mojom.PeerSessionPendingReceiver), null, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.remoting.mojom.PeerSessionEventHandler_OnSessionChannelsConnected_ParamsSpec, 'remoting.mojom.PeerSessionEventHandler_OnSessionChannelsConnected_Params', [
    ],
    [[0, 8]]);

mojo.internal.Struct(
    mojo.internal.bindings.remoting.mojom.PeerSessionEventHandler_OnSessionClosed_ParamsSpec, 'remoting.mojom.PeerSessionEventHandler_OnSessionClosed_Params', [
      mojo.internal.StructField('arg_error', 0, 0, mojo.internal.bindings.remoting.mojom.ProtocolErrorCodeSpec, null, false, 0, undefined),
...
mojo.internal.Struct(
    mojo.internal.bindings.remoting.mojom.PeerSessionEventHandler_OnSessionRouteChange_ParamsSpec, 'remoting.mojom.PeerSessionEventHandler_OnSessionRouteChange_Params', [
      mojo.internal.StructField('arg_channel_name', 0, 0, mojo.internal.String, null, false, 0, undefined),
      mojo.internal.StructField('arg_route', 8, 0, mojo.internal.bindings.remoting.mojom.TransportRouteSpec, null, false, 0, undefined),
    ],
    [[0, 24]]);

mojo.internal.Struct(
    mojo.internal.bindings.remoting.mojom.TransportEventHandler_SendTransportInfo_ParamsSpec, 'remoting.mojom.TransportEventHandler_SendTransportInfo_Params', [
      mojo.internal.StructField('arg_transport_info', 0, 0, mojo.internal.bindings.remoting.mojom.JingleTransportInfoSpec, null, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.remoting.mojom.IceConfigFetcher_GetIceConfig_ParamsSpec, 'remoting.mojom.IceConfigFetcher_GetIceConfig_Params', [
    ],
    [[0, 8]]);

mojo.internal.Struct(
    mojo.internal.bindings.remoting.mojom.IceConfigFetcher_GetIceConfig_ResponseParamsSpec, 'remoting.mojom.IceConfigFetcher_GetIceConfig_ResponseParams', [
      mojo.internal.StructField('arg_ice_config', 0, 0, mojo.internal.bindings.remoting.mojom.IceConfigSpec, null, true, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.remoting.mojom.PairingRequester_RequestPairing_ParamsSpec, 'remoting.mojom.PairingRequester_RequestPairing_Params', [
      mojo.internal.StructField('arg_client_name', 0, 0, mojo.internal.String, null, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.remoting.mojom.PairingRequester_RequestPairing_ResponseParamsSpec, 'remoting.mojom.PairingRequester_RequestPairing_ResponseParams', [
      mojo.internal.StructField('arg_pairing_response', 0, 0, mojo.internal.bindings.remoting.mojom.PairingResponseSpec, null, true, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.remoting.mojom.DesktopSessionRequester_RequestDesktopSession_ParamsSpec, 'remoting.mojom.DesktopSessionRequester_RequestDesktopSession_Params', [
      mojo.internal.StructField('arg_control_receiver', 0, 0, mojo.internal.InterfaceRequest(mojo.internal.bindings.remoting.mojom.DesktopSessionPendingReceiver), null, false, 0, undefined),
      mojo.internal.StructField('arg_events_remote', 4, 0, mojo.internal.InterfaceProxy(mojo.internal.bindings.remoting.mojom.DesktopSessionEventsRemote), null, false, 0, undefined),
      mojo.internal.StructField('arg_screen_resolution', 16, 0, mojo.internal.bindings.remoting.mojom.ScreenResolutionSpec, null, false, 0, undefined),
    ],
    [[0, 32]]);

mojo.internal.Struct(
    mojo.internal.bindings.remoting.mojom.PeerSession_Start_ParamsSpec, 'remoting.mojom.PeerSession_Start_Params', [
      mojo.internal.StructField('arg_client_jid', 0, 0, mojo.internal.String, null, false, 0, undefined),
      mojo.internal.StructField('arg_event_handler', 8, 0, mojo.internal.InterfaceProxy(mojo.internal.bindings.remoting.mojom.PeerSessionEventHandlerRemote), null, false, 0, undefined),
      mojo.internal.StructField('arg_desktop_session_requester', 16, 0, mojo.internal.InterfaceProxy(mojo.internal.bindings.remoting.mojom.DesktopSessionRequesterRemote), null, false, 0, undefined),
      mojo.internal.StructField('arg_ice_config_fetcher', 24, 0, mojo.internal.InterfaceProxy(mojo.internal.bindings.remoting.mojom.IceConfigFetcherRemote), null, false, 0, undefined),
      mojo.internal.StructField('arg_pairing_requester', 32, 0, mojo.internal.InterfaceProxy(mojo.internal.bindings.remoting.mojom.PairingRequesterRemote), null, false, 0, undefined),
      mojo.internal.StructField('arg_desktop_environment_options', 40, 0, mojo.internal.bindings.remoting.mojom.DesktopEnvironmentOptionsSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_session_policies', 48, 0, mojo.internal.bindings.remoting.mojom.SessionPoliciesSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_session_options', 56, 0, mojo.internal.bindings.remoting.mojom.SessionOptionsSpec, null, false, 0, undefined),
    ],
    [[0, 72]]);

mojo.internal.Struct(
    mojo.internal.bindings.remoting.mojom.PeerSession_StartTransport_ParamsSpec, 'remoting.mojom.PeerSession_StartTransport_Params', [
      mojo.internal.StructField('arg_auth_key', 0, 0, mojo.internal.String, null, false, 0, undefined),
      mojo.internal.StructField('arg_transport_event_handler', 8, 0, mojo.internal.InterfaceProxy(mojo.internal.bindings.remoting.mojom.TransportEventHandlerRemote), null, false, 0, undefined),
    ],
    [[0, 24]]);

mojo.internal.Struct(
    mojo.internal.bindings.remoting.mojom.PeerSession_ProcessTransportInfo_ParamsSpec, 'remoting.mojom.PeerSession_ProcessTransportInfo_Params', [
      mojo.internal.StructField('arg_transport_info', 0, 0, mojo.internal.bindings.remoting.mojom.JingleTransportInfoSpec, null, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.remoting.mojom.PeerSession_DisconnectSession_ParamsSpec, 'remoting.mojom.PeerSession_DisconnectSession_Params', [
      mojo.internal.StructField('arg_error', 0, 0, mojo.internal.bindings.remoting.mojom.ProtocolErrorCodeSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_error_details', 8, 0, mojo.internal.String, null, false, 0, undefined),
      mojo.internal.StructField('arg_error_location', 16, 0, mojo.internal.bindings.remoting.mojom.SourceLocationSpec, null, false, 0, undefined),
    ],
...
mojo.internal.Struct(
    mojo.internal.bindings.remoting.mojom.PeerConnectionProcessControl_BindPeerSession_ParamsSpec, 'remoting.mojom.PeerConnectionProcessControl_BindPeerSession_Params', [
      mojo.internal.StructField('arg_session_receiver', 0, 0, mojo.internal.InterfaceRequest(mojo.internal.bindings.remoting.mojom.PeerSessionPendingReceiver), null, false, 0, undefined),
    ],
    [[0, 16]]);
