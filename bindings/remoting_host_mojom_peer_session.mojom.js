...
mojo.internal.bindings.remoting.mojom.PeerSession_OnSessionServicesClientConnected_ParamsSpec = mojo.internal.bindings.remoting.mojom.PeerSession_OnSessionServicesClientConnected_ParamsSpec || { $: {} };
if (mojo.internal.bindings.remoting.mojom.PeerSession_OnSessionServicesClientConnected_ParamsSpec.$.structSpec && mojo.internal.bindings.remoting.mojom.PeerSession_OnSessionServicesClientConnected_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.remoting.mojom.PeerSession_OnSessionServicesClientConnected_ParamsSpec.$ = {};
...
mojo.internal.bindings.remoting = mojo.internal.bindings.remoting || {};
mojo.internal.bindings.remoting.mojom = mojo.internal.bindings.remoting.mojom || {};
mojo.internal.bindings.remoting.mojom.ChromotingSessionServicesSpec = mojo.internal.bindings.remoting.mojom.ChromotingSessionServicesSpec || { $: mojo.internal.OpaqueStruct.$ };
mojo.internal.bindings.remoting.mojom.ChromotingSessionServicesRemote = mojo.internal.bindings.remoting.mojom.ChromotingSessionServicesRemote || class {};
mojo.internal.bindings.remoting.mojom.ChromotingSessionServicesPendingReceiver = mojo.internal.bindings.remoting.mojom.ChromotingSessionServicesPendingReceiver || class { constructor(handle) { this.handle = handle; } };
mojo.internal.bindings.remoting = mojo.internal.bindings.remoting || {};
mojo.internal.bindings.remoting.mojom = mojo.internal.bindings.remoting.mojom || {};
...
mojo.internal.bindings.remoting.mojom.PeerSessionRemote = class {
  ...
  start(arg_client_jid, arg_event_handler, arg_desktop_control, arg_desktop_events_receiver, arg_ice_config_fetcher, arg_desktop_environment_options, arg_session_policies, arg_session_options) {
    return this.$.start(arg_client_jid, arg_event_handler, arg_desktop_control, arg_desktop_events_receiver, arg_ice_config_fetcher, arg_desktop_environment_options, arg_session_policies, arg_session_options);
  }
  ...
  onSessionServicesClientConnected(arg_receiver) {
    return this.$.onSessionServicesClientConnected(arg_receiver);
  }
};
...
mojo.internal.bindings.remoting.mojom.PeerSessionRemoteCallHandler = class {
  ...
  start(arg_client_jid, arg_event_handler, arg_desktop_control, arg_desktop_events_receiver, arg_ice_config_fetcher, arg_desktop_environment_options, arg_session_policies, arg_session_options) {
    return this.proxy.sendMessage(
      ...
      null,
      [arg_client_jid, arg_event_handler, arg_desktop_control, arg_desktop_events_receiver, arg_ice_config_fetcher, arg_desktop_environment_options, arg_session_policies, arg_session_options],
      false);
  }
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        case 0: {
          ...
          const result = this.impl.start(params.arg_client_jid, params.arg_event_handler, params.arg_desktop_control, params.arg_desktop_events_receiver, params.arg_ice_config_fetcher, params.arg_desktop_environment_options, params.arg_session_policies, params.arg_session_options);
          break;
        }
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
        ...
        case 4: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.remoting.mojom.PeerSession_OnSessionServicesClientConnected_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.onSessionServicesClientConnected');
          const result = this.impl.onSessionServicesClientConnected(params.arg_receiver);
          break;
        }
      }
      } catch (err) {
...
mojo.internal.Struct(
    mojo.internal.bindings.remoting.mojom.PeerSession_OnSessionServicesClientConnected_ParamsSpec, 'remoting.mojom.PeerSession_OnSessionServicesClientConnected_Params', [
