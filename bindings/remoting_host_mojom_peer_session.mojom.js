...
mojo.internal.bindings.remoting.mojom.PeerSessionRemote = class {
  ...
  start(arg_client_jid, arg_event_handler, arg_desktop_control, arg_desktop_events_receiver, arg_ice_config_fetcher, arg_pairing_requester, arg_desktop_environment_options, arg_session_policies, arg_session_options) {
    return this.$.start(arg_client_jid, arg_event_handler, arg_desktop_control, arg_desktop_events_receiver, arg_ice_config_fetcher, arg_pairing_requester, arg_desktop_environment_options, arg_session_policies, arg_session_options);
  }
...
mojo.internal.bindings.remoting.mojom.PeerSessionRemoteCallHandler = class {
  ...
  start(arg_client_jid, arg_event_handler, arg_desktop_control, arg_desktop_events_receiver, arg_ice_config_fetcher, arg_pairing_requester, arg_desktop_environment_options, arg_session_policies, arg_session_options) {
    return this.proxy.sendMessage(
      ...
      null,
      [arg_client_jid, arg_event_handler, arg_desktop_control, arg_desktop_events_receiver, arg_ice_config_fetcher, arg_pairing_requester, arg_desktop_environment_options, arg_session_policies, arg_session_options],
      false);
  }
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        case 0: {
          ...
          const result = this.impl.start(params.arg_client_jid, params.arg_event_handler, params.arg_desktop_control, params.arg_desktop_events_receiver, params.arg_ice_config_fetcher, params.arg_pairing_requester, params.arg_desktop_environment_options, params.arg_session_policies, params.arg_session_options);
          break;
        }
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
...
mojo.internal.Struct(
    mojo.internal.bindings.remoting.mojom.PeerSession_Start_ParamsSpec, 'remoting.mojom.PeerSession_Start_Params', [
      ...
      mojo.internal.StructField('arg_desktop_control', 16, 0, mojo.internal.InterfaceProxy(mojo.internal.bindings.remoting.mojom.DesktopSessionRemote), null, false, 0, undefined),
      mojo.internal.StructField('arg_desktop_events_receiver', 24, 0, mojo.internal.InterfaceRequest(mojo.internal.bindings.remoting.mojom.DesktopSessionEventsPendingReceiver), null, false, 0, undefined),
      mojo.internal.StructField('arg_ice_config_fetcher', 28, 0, mojo.internal.InterfaceProxy(mojo.internal.bindings.remoting.mojom.IceConfigFetcherRemote), null, false, 0, undefined),
      mojo.internal.StructField('arg_pairing_requester', 36, 0, mojo.internal.InterfaceProxy(mojo.internal.bindings.remoting.mojom.PairingRequesterRemote), null, false, 0, undefined),
      mojo.internal.StructField('arg_desktop_environment_options', 48, 0, mojo.internal.bindings.remoting.mojom.DesktopEnvironmentOptionsSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_session_policies', 56, 0, mojo.internal.bindings.remoting.mojom.SessionPoliciesSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_session_options', 64, 0, mojo.internal.bindings.remoting.mojom.SessionOptionsSpec, null, false, 0, undefined),
    ],
    [[0, 80]]);
