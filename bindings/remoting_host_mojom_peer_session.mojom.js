...
mojo.internal.bindings.remoting.mojom.PeerSessionRemote = class {
  ...
  start(arg_event_handler, arg_client_jid, arg_control_remote, arg_events_receiver, arg_desktop_environment_options) {
    return this.$.start(arg_event_handler, arg_client_jid, arg_control_remote, arg_events_receiver, arg_desktop_environment_options);
  }
...
mojo.internal.bindings.remoting.mojom.PeerSessionRemoteCallHandler = class {
  ...
  start(arg_event_handler, arg_client_jid, arg_control_remote, arg_events_receiver, arg_desktop_environment_options) {
    return this.proxy.sendMessage(
      ...
      null,
      [arg_event_handler, arg_client_jid, arg_control_remote, arg_events_receiver, arg_desktop_environment_options],
      false);
  }
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        case 0: {
          ...
          const result = this.impl.start(params.arg_event_handler, params.arg_client_jid, params.arg_control_remote, params.arg_events_receiver, params.arg_desktop_environment_options);
          break;
        }
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
...
mojo.internal.Struct(
    mojo.internal.bindings.remoting.mojom.PeerSession_Start_ParamsSpec, 'remoting.mojom.PeerSession_Start_Params', [
      mojo.internal.StructField('arg_event_handler', 0, 0, mojo.internal.InterfaceProxy(mojo.internal.bindings.remoting.mojom.PeerSessionEventHandlerRemote), null, false, 0, undefined),
      mojo.internal.StructField('arg_client_jid', 8, 0, mojo.internal.String, null, false, 0, undefined),
      mojo.internal.StructField('arg_control_remote', 16, 0, mojo.internal.InterfaceProxy(mojo.internal.bindings.remoting.mojom.DesktopSessionRemote), null, false, 0, undefined),
      mojo.internal.StructField('arg_events_receiver', 24, 0, mojo.internal.InterfaceRequest(mojo.internal.bindings.remoting.mojom.DesktopSessionEventsPendingReceiver), null, false, 0, undefined),
      mojo.internal.StructField('arg_desktop_environment_options', 32, 0, mojo.internal.bindings.remoting.mojom.DesktopEnvironmentOptionsSpec, null, false, 0, undefined),
    ],
    [[0, 48]]);
