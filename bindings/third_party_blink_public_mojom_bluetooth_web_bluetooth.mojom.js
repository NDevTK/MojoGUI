...
mojo.internal.bindings.blink.mojom.WebBluetoothResult = {
  ...
  BLUETOOTH_NOT_ALLOWED: 31,
  NO_BLUETOOTH_ADAPTER: 32,
  CHOSEN_DEVICE_VANISHED: 33,
  CHOOSER_CANCELLED: 34,
  CHOOSER_NOT_SHOWN_API_GLOBALLY_DISABLED: 35,
  CHOOSER_NOT_SHOWN_API_LOCALLY_DISABLED: 36,
  CHOOSER_NOT_SHOWN_USER_DENIED_PERMISSION_TO_SCAN: 37,
  SERVICE_NOT_FOUND: 38,
  NO_SERVICES_FOUND: 39,
  CHARACTERISTIC_NOT_FOUND: 40,
  NO_CHARACTERISTICS_FOUND: 41,
  DESCRIPTOR_NOT_FOUND: 42,
  NO_DESCRIPTORS_FOUND: 43,
  WEB_BLUETOOTH_NOT_SUPPORTED: 44,
  BLUETOOTH_LOW_ENERGY_NOT_AVAILABLE: 45,
  GATT_UNKNOWN_ERROR: 46,
  GATT_UNKNOWN_FAILURE: 47,
  GATT_NOT_PERMITTED: 48,
  GATT_NOT_SUPPORTED: 49,
  GATT_UNTRANSLATED_ERROR_CODE: 50,
  GATT_NOT_AUTHORIZED: 51,
  BLOCKLISTED_DESCRIPTOR_UUID: 52,
  BLOCKLISTED_CHARACTERISTIC_UUID: 53,
  BLOCKLISTED_READ: 54,
  BLOCKLISTED_WRITE: 55,
  NOT_ALLOWED_TO_ACCESS_ANY_SERVICE: 56,
  NOT_ALLOWED_TO_ACCESS_SERVICE: 57,
  REQUEST_DEVICE_WITH_BLOCKLISTED_UUID_OR_MANUFACTURER_DATA: 58,
  DESCRIPTOR_NO_LONGER_EXISTS: 59,
  PERMISSIONS_POLICY_VIOLATION: 60,
  SCANNING_BLOCKED: 61,
};
