  ...
  $: {
    structSpec: {
      ...
      fields: [
        ...
        { name: 'margin_type', packedOffset: 8, packedBitOffset: 0, type: printing.mojom.MarginTypeSpec, nullable: false },
        ...
        { name: 'color', packedOffset: 32, packedBitOffset: 0, type: printing.mojom.ColorModelSpec, nullable: false },
        { name: 'duplex_mode', packedOffset: 40, packedBitOffset: 0, type: printing.mojom.DuplexModeSpec, nullable: false },
        { name: 'device_name', packedOffset: 48, packedBitOffset: 0, type: mojo_base.mojom.String16Spec, nullable: false },
        { name: 'requested_media', packedOffset: 56, packedBitOffset: 0, type: printing.mojom.RequestedMediaSpec, nullable: false },
        { name: 'page_setup_device_units', packedOffset: 64, packedBitOffset: 0, type: printing.mojom.PageSetupSpec, nullable: false },
        { name: 'media_type', packedOffset: 72, packedBitOffset: 0, type: mojo.internal.String, nullable: false },
        { name: 'dpi', packedOffset: 80, packedBitOffset: 0, type: gfx.mojom.SizeSpec, nullable: false },
        ...
        { name: 'requested_custom_margins_in_microns', packedOffset: 104, packedBitOffset: 0, type: printing.mojom.PageMarginsSpec, nullable: false },
        { name: 'advanced_settings', packedOffset: 112, packedBitOffset: 0, type: [EnableIf=is_chromeos|is_linux] map<string, mojo_base.mojom.Value>Spec, nullable: false },
        ...
        { name: 'system_print_dialog_data', packedOffset: 144, packedBitOffset: 0, type: [EnableIf=enable_oop_printing_no_oop_basic_print_dialog] mojo_base.mojom.DictionaryValueSpec, nullable: false },
