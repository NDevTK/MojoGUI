        ...
        case 0: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.chromecast.mojom.ApiBindings_GetAll_ResponseParamsSpec, header, rawHeader);
               responder(response);
