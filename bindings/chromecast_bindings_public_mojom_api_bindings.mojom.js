...
mojo.internal.bindings.chromecast.mojom.ApiBindingsRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.chromecast.mojom.ApiBindingsPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.chromecast.mojom.ApiBindingsRemoteCallHandler(this.proxy);
  }
  ...
  connect(arg_port_name, arg_port) {
    return this.$.connect(arg_port_name, arg_port);
  }
};
...
mojo.internal.bindings.chromecast.mojom.ApiBindings.getRemote = function() {
  let remote = new mojo.internal.bindings.chromecast.mojom.ApiBindingsRemote();
...
mojo.internal.bindings.chromecast.mojom.ApiBindingsReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.chromecast.mojom.ApiBindings_GetAll_ParamsSpec.$.structSpec;
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.chromecast.mojom.ApiBindings_Connect_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.chromecast.mojom.ApiBindings_GetAll_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.chromecast.mojom.ApiBindingsReceiver = mojo.internal.bindings.chromecast.mojom.ApiBindingsReceiver;
