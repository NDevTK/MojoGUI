...
mojo.internal.bindings.tracing.mojom.TracingServiceRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.tracing.mojom.TracingServicePendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.tracing.mojom.TracingServiceRemoteCallHandler(this.proxy);
  }
  ...
  initialize(arg_clients) {
    return this.$.initialize(arg_clients);
  }
...
mojo.internal.bindings.tracing.mojom.TracingService.getRemote = function() {
  let remote = new mojo.internal.bindings.tracing.mojom.TracingServiceRemote();
...
mojo.internal.bindings.tracing.mojom.TracingServiceReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.tracing.mojom.TracingService_Initialize_ParamsSpec.$.structSpec);
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.tracing.mojom.TracingService_AddClient_ParamsSpec.$.structSpec);
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.tracing.mojom.TracingService_BindConsumerHost_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.tracing.mojom.TracingServiceReceiver = mojo.internal.bindings.tracing.mojom.TracingServiceReceiver;
