...
mojo.internal.bindings.ash.babelorca.mojom.TachyonParsingServiceSpec = { $ : {} };
...
mojo.internal.bindings.ash.babelorca.mojom.TachyonParsingServiceRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('ash.babelorca.mojom.TachyonParsingService', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.ash.babelorca.mojom.TachyonParsingServiceReceiver = class {
  constructor(impl) {
    ...
    const ordinals = window.mojoScrambler.getOrdinals('ash.babelorca.mojom.TachyonParsingService', [
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.ash.babelorca.mojom.TachyonParsingService_Parse_ParamsSpec.$.structSpec);
