...
mojo.internal.bindings.ash.babelorca = mojo.internal.bindings.ash.babelorca || {};
...
mojo.internal.bindings.ash.babelorca.mojom.TachyonParsingService = {};
mojo.internal.bindings.ash.babelorca.mojom.TachyonParsingService.$interfaceName = 'ash.babelorca.mojom.TachyonParsingService';
...
// Enum: ParsingState
mojo.internal.bindings.ash.babelorca.mojom.ParsingState = {
  kOk: 0,
  kError: 1,
  kClosed: 2,
};
...
mojo.internal.Struct(
    mojo.internal.bindings.ash.babelorca.mojom.BabelOrcaMessageSpec, 'ash.babelorca.mojom.BabelOrcaMessage', [
      ...
      mojo.internal.StructField('arg_previous_transcript', 32, 0, mojo.internal.bindings.mojo.internal.bindings.ash.babelorca.mojom.TranscriptPartSpec.$, null, true, 0, undefined),
      mojo.internal.StructField('arg_current_transcript', 40, 0, mojo.internal.bindings.mojo.internal.bindings.ash.babelorca.mojom.TranscriptPartSpec.$, null, false, 0, undefined),
    ],
    [[0, 56]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.ash.babelorca.mojom.TachyonParsingService_Parse_ResponseParamsSpec, 'ash.babelorca.mojom.TachyonParsingService_Parse_ResponseParams', [
      mojo.internal.StructField('arg_state', 0, 0, mojo.internal.bindings.mojo.internal.bindings.ash.babelorca.mojom.ParsingStateSpec.$, null, false, 0, undefined),
      mojo.internal.StructField('arg_messages', 8, 0, mojo.internal.Array(mojo.internal.bindings.mojo.internal.bindings.ash.babelorca.mojom.BabelOrcaMessageSpec.$, false), null, false, 0, undefined),
      mojo.internal.StructField('arg_stream_status', 16, 0, mojo.internal.bindings.mojo.internal.bindings.ash.babelorca.mojom.StreamStatusSpec.$, null, true, 0, undefined),
    ],
    [[0, 32]]);
...
mojo.internal.bindings.ash.babelorca.mojom.TachyonParsingServiceRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.ash.babelorca.mojom.TachyonParsingServicePendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.ash.babelorca.mojom.TachyonParsingServiceRemoteCallHandler(this.proxy);
  }
  ...
  parse(arg_stream_data) {
    return this.$.parse(arg_stream_data);
  }
};

mojo.internal.bindings.ash.babelorca.mojom.TachyonParsingServiceRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
...
mojo.internal.bindings.ash.babelorca.mojom.TachyonParsingService.getRemote = function() {
  let remote = new mojo.internal.bindings.ash.babelorca.mojom.TachyonParsingServiceRemote();
...
mojo.internal.bindings.ash.babelorca.mojom.TachyonParsingServiceReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.ash.babelorca.mojom.TachyonParsingService_Parse_ParamsSpec);
        ...
        case 0: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.ash.babelorca.mojom.TachyonParsingService_Parse_ResponseParamsSpec, header, rawHeader);
               responder(response);
...
mojo.internal.bindings.ash.babelorca.mojom.TachyonParsingServiceReceiver = mojo.internal.bindings.ash.babelorca.mojom.TachyonParsingServiceReceiver;
