...
mojo.internal.Union(
    mojo.internal.bindings.url_rewrite.mojom.UrlRequestActionSpec, 'url_rewrite.mojom.UrlRequestAction', {
      'arg_add_headers': {
        'ordinal': 0,
        'type': mojo.internal.bindings.mojo.internal.bindings.url_rewrite.mojom.UrlRequestRewriteAddHeadersSpec.$,
        'nullable': false,
      },
      'arg_remove_header': {
        'ordinal': 1,
        'type': mojo.internal.bindings.mojo.internal.bindings.url_rewrite.mojom.UrlRequestRewriteRemoveHeaderSpec.$,
        'nullable': false,
      },
      'arg_substitute_query_pattern': {
        'ordinal': 2,
        'type': mojo.internal.bindings.mojo.internal.bindings.url_rewrite.mojom.UrlRequestRewriteSubstituteQueryPatternSpec.$,
        'nullable': false,
      },
      'arg_replace_url': {
        'ordinal': 3,
        'type': mojo.internal.bindings.mojo.internal.bindings.url_rewrite.mojom.UrlRequestRewriteReplaceUrlSpec.$,
        'nullable': false,
      },
      'arg_append_to_query': {
        'ordinal': 4,
        'type': mojo.internal.bindings.mojo.internal.bindings.url_rewrite.mojom.UrlRequestRewriteAppendToQuerySpec.$,
        'nullable': false,
      },
      'arg_policy': {
        'ordinal': 5,
        'type': mojo.internal.bindings.mojo.internal.bindings.url_rewrite.mojom.UrlRequestAccessPolicySpec.$,
        'nullable': false,
      },
    });
...
mojo.internal.Struct(
    mojo.internal.bindings.url_rewrite.mojom.UrlRequestRewriteRulesSpec, 'url_rewrite.mojom.UrlRequestRewriteRules', [
      mojo.internal.StructField('arg_rules', 0, 0, mojo.internal.Array(mojo.internal.bindings.mojo.internal.bindings.url_rewrite.mojom.UrlRequestRuleSpec.$, false), null, false, 0, undefined),
    ],
    [[0, 16]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.url_rewrite.mojom.UrlRequestRewriteAddHeadersSpec, 'url_rewrite.mojom.UrlRequestRewriteAddHeaders', [
      mojo.internal.StructField('arg_headers', 0, 0, mojo.internal.Array(mojo.internal.bindings.mojo.internal.bindings.url_rewrite.mojom.UrlHeaderSpec.$, false), null, false, 0, undefined),
    ],
    [[0, 16]]);

// Struct: UrlHeader
mojo.internal.Struct(
    mojo.internal.bindings.url_rewrite.mojom.UrlHeaderSpec, 'url_rewrite.mojom.UrlHeader', [
...
mojo.internal.Struct(
    mojo.internal.bindings.url_rewrite.mojom.UrlRequestRewriteRemoveHeaderSpec, 'url_rewrite.mojom.UrlRequestRewriteRemoveHeader', [
      mojo.internal.StructField('arg_query_pattern', 0, 0, mojo.internal.String, null, true, 0, undefined),
      mojo.internal.StructField('arg_header_name', 8, 0, mojo.internal.String, null, false, 0, undefined),
    ],
    [[0, 24]]);

// Struct: UrlRequestRewriteSubstituteQueryPattern
mojo.internal.Struct(
    mojo.internal.bindings.url_rewrite.mojom.UrlRequestRewriteSubstituteQueryPatternSpec, 'url_rewrite.mojom.UrlRequestRewriteSubstituteQueryPattern', [
      mojo.internal.StructField('arg_pattern', 0, 0, mojo.internal.String, null, false, 0, undefined),
      mojo.internal.StructField('arg_substitution', 8, 0, mojo.internal.String, null, false, 0, undefined),
    ],
    [[0, 24]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.url_rewrite.mojom.UrlRequestRewriteAppendToQuerySpec, 'url_rewrite.mojom.UrlRequestRewriteAppendToQuery', [
...
mojo.internal.Struct(
    mojo.internal.bindings.url_rewrite.mojom.UrlRequestRulesReceiver_OnRulesUpdated_ParamsSpec, 'url_rewrite.mojom.UrlRequestRulesReceiver_OnRulesUpdated_Params', [
      mojo.internal.StructField('arg_rules', 0, 0, mojo.internal.bindings.mojo.internal.bindings.url_rewrite.mojom.UrlRequestRewriteRulesSpec.$, null, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.bindings.url_rewrite.mojom.UrlRequestRulesReceiverPendingReceiver = class {
  constructor(handle) {
    this.handle = handle;
  }
};

mojo.internal.bindings.url_rewrite.mojom.UrlRequestRulesReceiverRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.url_rewrite.mojom.UrlRequestRulesReceiverPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.url_rewrite.mojom.UrlRequestRulesReceiverRemoteCallHandler(this.proxy);
  }
  ...
  onRulesUpdated(arg_rules) {
    return this.$.onRulesUpdated(arg_rules);
  }
};

mojo.internal.bindings.url_rewrite.mojom.UrlRequestRulesReceiverRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
...
mojo.internal.bindings.url_rewrite.mojom.UrlRequestRulesReceiver.getRemote = function() {
  let remote = new mojo.internal.bindings.url_rewrite.mojom.UrlRequestRulesReceiverRemote();
...
mojo.internal.bindings.url_rewrite.mojom.UrlRequestRulesReceiverReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.url_rewrite.mojom.UrlRequestRulesReceiver_OnRulesUpdated_ParamsSpec);
...
mojo.internal.bindings.url_rewrite.mojom.UrlRequestRulesReceiverReceiver = mojo.internal.bindings.url_rewrite.mojom.UrlRequestRulesReceiverReceiver;

mojo.internal.bindings.url_rewrite.mojom.UrlRequestRulesReceiverPtr = mojo.internal.bindings.url_rewrite.mojom.UrlRequestRulesReceiverRemote;
mojo.internal.bindings.url_rewrite.mojom.UrlRequestRulesReceiverRequest = mojo.internal.bindings.url_rewrite.mojom.UrlRequestRulesReceiverPendingReceiver;
