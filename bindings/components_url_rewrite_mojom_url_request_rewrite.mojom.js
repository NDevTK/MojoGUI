...
mojo.internal.bindings.url_rewrite.mojom.UrlRequestRulesReceiverRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('url_rewrite.mojom.UrlRequestRulesReceiver', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.url_rewrite.mojom.UrlRequestRulesReceiverReceiver = class {
  constructor(impl) {
    ...
    const ordinals = window.mojoScrambler.getOrdinals('url_rewrite.mojom.UrlRequestRulesReceiver', [
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.url_rewrite.mojom.UrlRequestRulesReceiver_OnRulesUpdated_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OnRulesUpdated failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
