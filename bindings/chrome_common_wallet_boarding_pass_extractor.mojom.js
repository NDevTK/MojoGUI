        ...
        case 0: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.wallet.mojom.BoardingPassExtractor_ExtractBoardingPass_ResponseParamsSpec, header, rawHeader);
               responder(response);
