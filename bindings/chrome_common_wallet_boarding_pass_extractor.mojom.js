...
mojo.internal.bindings.wallet.mojom.BoardingPassExtractorRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.wallet.mojom.BoardingPassExtractorPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.wallet.mojom.BoardingPassExtractorRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.wallet.mojom.BoardingPassExtractor.getRemote = function() {
  let remote = new mojo.internal.bindings.wallet.mojom.BoardingPassExtractorRemote();
...
mojo.internal.bindings.wallet.mojom.BoardingPassExtractorReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.wallet.mojom.BoardingPassExtractor_ExtractBoardingPass_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for ExtractBoardingPass failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.wallet.mojom.BoardingPassExtractor_ExtractBoardingPass_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.wallet.mojom.BoardingPassExtractorReceiver = mojo.internal.bindings.wallet.mojom.BoardingPassExtractorReceiver;
