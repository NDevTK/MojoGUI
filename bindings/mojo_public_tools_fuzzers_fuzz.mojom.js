...
fuzz.mojom.FuzzStructSpec = {
  $: {
    structSpec: {
      ...
      packedSize: 144,
      fields: [
        { name: 'fuzz_int64', packedOffset: 0, packedBitOffset: 0, type: mojo.internal.Int64, nullable: false },
        { name: 'fuzz_uint64', packedOffset: 8, packedBitOffset: 0, type: mojo.internal.Uint64, nullable: false },
        { name: 'fuzz_double', packedOffset: 16, packedBitOffset: 0, type: mojo.internal.Double, nullable: false },
        { name: 'fuzz_string', packedOffset: 24, packedBitOffset: 0, type: mojo.internal.String, nullable: false },
        { name: 'fuzz_bool_array', packedOffset: 32, packedBitOffset: 0, type: mojo.internal.Array, nullable: false },
        { name: 'fuzz_primitive_array', packedOffset: 40, packedBitOffset: 0, type: mojo.internal.Array, nullable: false },
        { name: 'fuzz_primitive_map', packedOffset: 48, packedBitOffset: 0, type: mojo.internal.Map, nullable: false },
        { name: 'fuzz_array_map', packedOffset: 56, packedBitOffset: 0, type: mojo.internal.Map, nullable: false },
        { name: 'fuzz_union_map', packedOffset: 64, packedBitOffset: 0, type: mojo.internal.Map, nullable: false },
        { name: 'fuzz_union_array', packedOffset: 72, packedBitOffset: 0, type: mojo.internal.Array, nullable: false },
        { name: 'fuzz_struct_array', packedOffset: 80, packedBitOffset: 0, type: mojo.internal.Array, nullable: false },
        { name: 'fuzz_nullable_array', packedOffset: 88, packedBitOffset: 0, type: mojo.internal.Array, nullable: true },
        { name: 'fuzz_complex', packedOffset: 96, packedBitOffset: 0, type: mojo.internal.Array, nullable: true },
        { name: 'fuzz_int32', packedOffset: 104, packedBitOffset: 0, type: mojo.internal.Int32, nullable: false },
        { name: 'fuzz_uint32', packedOffset: 108, packedBitOffset: 0, type: mojo.internal.Uint32, nullable: false },
        { name: 'fuzz_float', packedOffset: 112, packedBitOffset: 0, type: mojo.internal.Float, nullable: false },
        { name: 'fuzz_int16', packedOffset: 116, packedBitOffset: 0, type: mojo.internal.Int16, nullable: false },
        { name: 'fuzz_uint16', packedOffset: 118, packedBitOffset: 0, type: mojo.internal.Uint16, nullable: false },
        { name: 'fuzz_int8', packedOffset: 120, packedBitOffset: 0, type: mojo.internal.Int8, nullable: false },
        { name: 'fuzz_uint8', packedOffset: 121, packedBitOffset: 0, type: mojo.internal.Uint8, nullable: false },
        { name: 'fuzz_bool', packedOffset: 122, packedBitOffset: 0, type: mojo.internal.Bool, nullable: false },
      ],
      versions: [{version: 0}]
    }
  }
