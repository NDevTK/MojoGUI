...
mojo.internal.bindings.fuzz.mojom.FuzzFixedSizeArrayStructSpec = mojo.internal.bindings.fuzz.mojom.FuzzFixedSizeArrayStructSpec || { $: {} };
if (mojo.internal.bindings.fuzz.mojom.FuzzFixedSizeArrayStructSpec.$.structSpec && mojo.internal.bindings.fuzz.mojom.FuzzFixedSizeArrayStructSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.fuzz.mojom.FuzzFixedSizeArrayStructSpec.$ = {};
mojo.internal.bindings.fuzz.mojom.FuzzNullableValueArrayStructSpec = mojo.internal.bindings.fuzz.mojom.FuzzNullableValueArrayStructSpec || { $: {} };
if (mojo.internal.bindings.fuzz.mojom.FuzzNullableValueArrayStructSpec.$.structSpec && mojo.internal.bindings.fuzz.mojom.FuzzNullableValueArrayStructSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.fuzz.mojom.FuzzNullableValueArrayStructSpec.$ = {};
...
mojo.internal.bindings.fuzz.mojom.FuzzInterface_FuzzNullableValueArrays_ParamsSpec = mojo.internal.bindings.fuzz.mojom.FuzzInterface_FuzzNullableValueArrays_ParamsSpec || { $: {} };
if (mojo.internal.bindings.fuzz.mojom.FuzzInterface_FuzzNullableValueArrays_ParamsSpec.$.structSpec && mojo.internal.bindings.fuzz.mojom.FuzzInterface_FuzzNullableValueArrays_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.fuzz.mojom.FuzzInterface_FuzzNullableValueArrays_ParamsSpec.$ = {};
...
mojo.internal.bindings.fuzz = mojo.internal.bindings.fuzz || {};
mojo.internal.bindings.fuzz.mojom = mojo.internal.bindings.fuzz.mojom || {};
mojo.internal.bindings.fuzz.mojom.FuzzUnionSpec = mojo.internal.bindings.fuzz.mojom.FuzzUnionSpec || { $: mojo.internal.OpaqueStruct.$ };
...
mojo.internal.bindings.fuzz.mojom.FuzzInterfaceRemote = class {
  ...
  fuzzNullableValueArrays(arg_s) {
    return this.$.fuzzNullableValueArrays(arg_s);
  }
...
mojo.internal.bindings.fuzz.mojom.FuzzInterfaceRemoteCallHandler = class {
  ...
  fuzzNullableValueArrays(arg_s) {
    return this.proxy.sendMessage(
      ...
      mojo.internal.bindings.fuzz.mojom.FuzzInterface_FuzzNullableValueArrays_ParamsSpec,
      null,
      [arg_s],
      false);
  }
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        ...
        case 6: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.fuzz.mojom.FuzzInterface_FuzzNullableValueArrays_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.fuzzNullableValueArrays');
          const result = this.impl.fuzzNullableValueArrays(params.arg_s);
          break;
        }
        case 7: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
...
// Struct: FuzzFixedSizeArrayStruct
mojo.internal.Struct(
    mojo.internal.bindings.fuzz.mojom.FuzzFixedSizeArrayStructSpec, 'fuzz.mojom.FuzzFixedSizeArrayStruct', [
      mojo.internal.StructField('arg_fuzz_fixed_size_uint32_array', 0, 0, mojo.internal.Array(mojo.internal.Uint32, false), null, false, 0, undefined),
      mojo.internal.StructField('arg_fuzz_fixed_size_int8_array', 8, 0, mojo.internal.Array(mojo.internal.Int8, false), null, false, 0, undefined),
      mojo.internal.StructField('arg_fuzz_fixed_size_bool_array', 16, 0, mojo.internal.Array(mojo.internal.Bool, false), null, false, 0, undefined),
      mojo.internal.StructField('arg_fuzz_fixed_size_enum_array', 24, 0, mojo.internal.Array(mojo.internal.bindings.fuzz.mojom.FuzzEnumSpec, false), null, false, 0, undefined),
      mojo.internal.StructField('arg_fuzz_nullable_fixed_size_uint32_array', 32, 0, mojo.internal.Array(mojo.internal.Uint32, false), null, true, 0, undefined),
      mojo.internal.StructField('arg_fuzz_nullable_fixed_size_int8_array', 40, 0, mojo.internal.Array(mojo.internal.Int8, false), null, true, 0, undefined),
      mojo.internal.StructField('arg_fuzz_nullable_fixed_size_bool_array', 48, 0, mojo.internal.Array(mojo.internal.Bool, false), null, true, 0, undefined),
      mojo.internal.StructField('arg_fuzz_nullable_fixed_size_enum_array', 56, 0, mojo.internal.Array(mojo.internal.bindings.fuzz.mojom.FuzzEnumSpec, false), null, true, 0, undefined),
    ],
    [[0, 72]]);

// Struct: FuzzNullableValueArrayStruct
mojo.internal.Struct(
    mojo.internal.bindings.fuzz.mojom.FuzzNullableValueArrayStructSpec, 'fuzz.mojom.FuzzNullableValueArrayStruct', [
      mojo.internal.StructField('arg_fuzz_nullable_uint32_array', 0, 0, mojo.internal.Array(mojo.internal.Uint32, false), null, true, 0, undefined),
      mojo.internal.StructField('arg_fuzz_nullable_int8_array', 8, 0, mojo.internal.Array(mojo.internal.Int8, false), null, true, 0, undefined),
      mojo.internal.StructField('arg_fuzz_nullable_bool_array', 16, 0, mojo.internal.Array(mojo.internal.Bool, false), null, true, 0, undefined),
      mojo.internal.StructField('arg_fuzz_nullable_enum_array', 24, 0, mojo.internal.Array(mojo.internal.bindings.fuzz.mojom.FuzzEnumSpec, false), null, true, 0, undefined),
    ],
    [[0, 40]]);
mojo.internal.Struct(
...
mojo.internal.Struct(
    mojo.internal.bindings.fuzz.mojom.FuzzInterface_FuzzNullableValueArrays_ParamsSpec, 'fuzz.mojom.FuzzInterface_FuzzNullableValueArrays_Params', [
      mojo.internal.StructField('arg_s', 0, 0, mojo.internal.bindings.fuzz.mojom.FuzzNullableValueArrayStructSpec, null, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.fuzz.mojom.FuzzInterface_FuzzAssociated_ParamsSpec, 'fuzz.mojom.FuzzInterface_FuzzAssociated_Params', [
      mojo.internal.StructField('arg_receiver', 0, 0, mojo.internal.AssociatedInterfaceRequest(mojo.internal.bindings.fuzz.mojom.FuzzDummyInterfacePendingReceiver), null, false, 0, undefined),
    ],
    [[0, 16]]);
