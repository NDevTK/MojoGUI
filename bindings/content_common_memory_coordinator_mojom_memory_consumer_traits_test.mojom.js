...
mojo.internal.bindings.content.mojom.MemoryConsumerTraitsTest = {};
mojo.internal.bindings.content.mojom.MemoryConsumerTraitsTestSpec = { $ : {} };
mojo.internal.bindings.content.mojom.MemoryConsumerTraitsTest.$interfaceName = 'content.mojom.MemoryConsumerTraitsTest';
...
mojo.internal.bindings.content.mojom.MemoryConsumerTraitsTestRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.content.mojom.MemoryConsumerTraitsTestPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.content.mojom.MemoryConsumerTraitsTestRemoteCallHandler(this.proxy);
  }
  ...
  echoMemoryConsumerTraits(arg_in) {
    return this.$.echoMemoryConsumerTraits(arg_in);
  }
};

mojo.internal.bindings.content.mojom.MemoryConsumerTraitsTestRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('content.mojom.MemoryConsumerTraitsTest', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.content.mojom.MemoryConsumerTraitsTest.getRemote = function() {
  let remote = new mojo.internal.bindings.content.mojom.MemoryConsumerTraitsTestRemote();
...
mojo.internal.bindings.content.mojom.MemoryConsumerTraitsTestReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('content.mojom.MemoryConsumerTraitsTest', [
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        // Try Method 0: EchoMemoryConsumerTraits
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.content.mojom.MemoryConsumerTraitsTest_EchoMemoryConsumerTraits_ParamsSpec.$.structSpec);
             console.log('[GeneratedReceiver] Discovery SUCCESS: ' + header.ordinal + ' -> EchoMemoryConsumerTraits (0)');
        ...
        case 0: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.content.mojom.MemoryConsumerTraitsTest_EchoMemoryConsumerTraits_ResponseParamsSpec, header, rawHeader);
               responder(response);
...
mojo.internal.bindings.content.mojom.MemoryConsumerTraitsTestReceiver = mojo.internal.bindings.content.mojom.MemoryConsumerTraitsTestReceiver;
