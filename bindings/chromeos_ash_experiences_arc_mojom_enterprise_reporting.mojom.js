...
mojo.internal.bindings.arc.mojom.EnterpriseReportingHostRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.arc.mojom.EnterpriseReportingHostPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.arc.mojom.EnterpriseReportingHostRemoteCallHandler(this.proxy);
  }
  ...
  reportCloudDpcOperationTime(arg_time_ms, arg_op, arg_success) {
    return this.$.reportCloudDpcOperationTime(arg_time_ms, arg_op, arg_success);
  }
};
...
mojo.internal.bindings.arc.mojom.EnterpriseReportingHost.getRemote = function() {
  let remote = new mojo.internal.bindings.arc.mojom.EnterpriseReportingHostRemote();
...
mojo.internal.bindings.arc.mojom.EnterpriseReportingHostReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.arc.mojom.EnterpriseReportingHost_ReportCloudDpcOperationTime_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for ReportCloudDpcOperationTime failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.arc.mojom.EnterpriseReportingHostReceiver = mojo.internal.bindings.arc.mojom.EnterpriseReportingHostReceiver;

mojo.internal.bindings.arc.mojom.EnterpriseReportingHostPtr = mojo.internal.bindings.arc.mojom.EnterpriseReportingHostRemote;
mojo.internal.bindings.arc.mojom.EnterpriseReportingHostRequest = mojo.internal.bindings.arc.mojom.EnterpriseReportingHostPendingReceiver;
...
mojo.internal.bindings.arc.mojom.EnterpriseReportingInstanceRemote = class {
  static get $interfaceName() {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.arc.mojom.EnterpriseReportingInstanceRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.arc.mojom.EnterpriseReportingInstance.getRemote = function() {
  let remote = new mojo.internal.bindings.arc.mojom.EnterpriseReportingInstanceRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
...
mojo.internal.bindings.arc.mojom.EnterpriseReportingInstanceReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.arc.mojom.EnterpriseReportingInstance_Init_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.arc.mojom.EnterpriseReportingInstance_GetStatus_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
      ...
      switch (dispatchId) {
        ...
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.arc.mojom.EnterpriseReportingInstance_GetStatus_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.arc.mojom.EnterpriseReportingInstanceReceiver = mojo.internal.bindings.arc.mojom.EnterpriseReportingInstanceReceiver;
