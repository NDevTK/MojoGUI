...
mojo.internal.bindings.pdf.mojom.PdfProgressiveSearchifierRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.pdf.mojom.PdfProgressiveSearchifierPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.pdf.mojom.PdfProgressiveSearchifierRemoteCallHandler(this.proxy);
  }
  ...
  addPage(arg_image, arg_page_index) {
    return this.$.addPage(arg_image, arg_page_index);
  }
  deletePage(arg_page_index) {
    return this.$.deletePage(arg_page_index);
  }
  save() {
    return this.$.save();
  }
...
mojo.internal.bindings.pdf.mojom.PdfProgressiveSearchifierRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('pdf.mojom.PdfProgressiveSearchifier', [
      { explicit: null },
      { explicit: null },
      { explicit: null },
    ]);
...
mojo.internal.bindings.pdf.mojom.PdfProgressiveSearchifier.getRemote = function() {
  let remote = new mojo.internal.bindings.pdf.mojom.PdfProgressiveSearchifierRemote();
...
mojo.internal.bindings.pdf.mojom.PdfProgressiveSearchifierReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('pdf.mojom.PdfProgressiveSearchifier', [
      { explicit: null },
      { explicit: null },
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.pdf.mojom.PdfProgressiveSearchifier_AddPage_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for AddPage failed with TypeError');
           }
        }
        // Try Method 1: DeletePage
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.pdf.mojom.PdfProgressiveSearchifier_DeletePage_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for DeletePage failed with TypeError');
           }
        }
        // Try Method 2: Save
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.pdf.mojom.PdfProgressiveSearchifier_Save_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for Save failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
      ...
      switch (dispatchId) {
        ...
        case 2: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.pdf.mojom.PdfProgressiveSearchifier_Save_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.pdf.mojom.PdfProgressiveSearchifierReceiver = mojo.internal.bindings.pdf.mojom.PdfProgressiveSearchifierReceiver;
