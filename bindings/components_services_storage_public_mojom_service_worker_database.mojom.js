  ...
  $: {
    structSpec: {
      ...
      fields: [
        ...
        { name: 'last_update_check', packedOffset: 48, packedBitOffset: 0, type: mojo_base.mojom.TimeSpec, nullable: false },
        { name: 'script_response_time', packedOffset: 56, packedBitOffset: 0, type: mojo_base.mojom.TimeSpec, nullable: false },
        { name: 'origin_trial_tokens', packedOffset: 64, packedBitOffset: 0, type: mojo.internal.Map, nullable: true },
        { name: 'navigation_preload_state', packedOffset: 72, packedBitOffset: 0, type: blink.mojom.NavigationPreloadStateSpec, nullable: false },
        ...
        { name: 'policy_container_policies', packedOffset: 96, packedBitOffset: 0, type: blink.mojom.PolicyContainerPoliciesSpec, nullable: true },
        { name: 'ancestor_frame_type', packedOffset: 104, packedBitOffset: 0, type: blink.mojom.AncestorFrameTypeSpec, nullable: false },
        { name: 'router_rules', packedOffset: 112, packedBitOffset: 0, type: blink.mojom.ServiceWorkerRouterRulesSpec, nullable: true },
