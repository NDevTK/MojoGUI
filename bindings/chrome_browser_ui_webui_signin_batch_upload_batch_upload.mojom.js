...
mojo.internal.bindings.batch_upload.mojom.PageHandlerFactoryRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.batch_upload.mojom.PageHandlerFactoryPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.batch_upload.mojom.PageHandlerFactoryRemoteCallHandler(this.proxy);
  }
  ...
  createBatchUploadHandler(arg_page, arg_handler) {
    return this.$.createBatchUploadHandler(arg_page, arg_handler);
  }
};
...
mojo.internal.bindings.batch_upload.mojom.PageHandlerFactory.getRemote = function() {
  let remote = new mojo.internal.bindings.batch_upload.mojom.PageHandlerFactoryRemote();
...
mojo.internal.bindings.batch_upload.mojom.PageHandlerFactoryReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.batch_upload.mojom.PageHandlerFactory_CreateBatchUploadHandler_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for CreateBatchUploadHandler failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.batch_upload.mojom.PageHandlerFactoryReceiver = mojo.internal.bindings.batch_upload.mojom.PageHandlerFactoryReceiver;

mojo.internal.bindings.batch_upload.mojom.PageHandlerFactoryPtr = mojo.internal.bindings.batch_upload.mojom.PageHandlerFactoryRemote;
mojo.internal.bindings.batch_upload.mojom.PageHandlerFactoryRequest = mojo.internal.bindings.batch_upload.mojom.PageHandlerFactoryPendingReceiver;
...
mojo.internal.bindings.batch_upload.mojom.PageHandlerRemote = class {
  static get $interfaceName() {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.batch_upload.mojom.PageHandlerPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.batch_upload.mojom.PageHandlerRemoteCallHandler(this.proxy);
  }
  ...
  updateViewHeight(arg_height) {
    return this.$.updateViewHeight(arg_height);
  }
  saveToAccount(arg_idsToMove) {
    return this.$.saveToAccount(arg_idsToMove);
  }
  close() {
    return this.$.close();
  }
...
mojo.internal.bindings.batch_upload.mojom.PageHandler.getRemote = function() {
  let remote = new mojo.internal.bindings.batch_upload.mojom.PageHandlerRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
...
mojo.internal.bindings.batch_upload.mojom.PageHandlerReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.batch_upload.mojom.PageHandler_UpdateViewHeight_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for UpdateViewHeight failed with TypeError');
           }
        }
        // Try Method 1: SaveToAccount
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.batch_upload.mojom.PageHandler_SaveToAccount_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for SaveToAccount failed with TypeError');
           }
        }
        // Try Method 2: Close
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.batch_upload.mojom.PageHandler_Close_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
      ...
      switch (dispatchId) {
        ...
        case 2: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.batch_upload.mojom.PageHandler_Close_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.batch_upload.mojom.PageHandlerReceiver = mojo.internal.bindings.batch_upload.mojom.PageHandlerReceiver;

mojo.internal.bindings.batch_upload.mojom.PageHandlerPtr = mojo.internal.bindings.batch_upload.mojom.PageHandlerRemote;
mojo.internal.bindings.batch_upload.mojom.PageHandlerRequest = mojo.internal.bindings.batch_upload.mojom.PageHandlerPendingReceiver;
...
mojo.internal.bindings.batch_upload.mojom.PageRemote = class {
  static get $interfaceName() {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.batch_upload.mojom.PagePendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.batch_upload.mojom.PageRemoteCallHandler(this.proxy);
  }
  ...
  sendBatchUploadData(arg_data) {
    return this.$.sendBatchUploadData(arg_data);
  }
};
...
mojo.internal.bindings.batch_upload.mojom.Page.getRemote = function() {
  let remote = new mojo.internal.bindings.batch_upload.mojom.PageRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
...
mojo.internal.bindings.batch_upload.mojom.PageReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.batch_upload.mojom.Page_SendBatchUploadData_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for SendBatchUploadData failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
             console.warn('[GeneratedReceiver] Failed to discover ordinal ' + header.ordinal);
...
mojo.internal.bindings.batch_upload.mojom.PageReceiver = mojo.internal.bindings.batch_upload.mojom.PageReceiver;
