...
// Enum: Backend
mojo.internal.bindings.ash.local_search_service.mojom.Backend = {
  kLinearMap: 0,
  kInvertedIndex: 1,
};
...
mojo.internal.Struct(
    mojo.internal.bindings.ash.local_search_service.mojom.SearchMetricsReporter_OnSearchPerformed_ParamsSpec, 'ash.local_search_service.mojom.SearchMetricsReporter_OnSearchPerformed_Params', [
      mojo.internal.StructField('arg_index_id', 0, 0, mojo.internal.bindings.mojo.internal.bindings.ash.local_search_service.mojom.IndexIdSpec.$, null, false, 0, undefined),
    ],
    [[0, 16]]);
...
mojo.internal.bindings.ash.local_search_service.mojom.SearchMetricsReporterRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.ash.local_search_service.mojom.SearchMetricsReporterPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.ash.local_search_service.mojom.SearchMetricsReporterRemoteCallHandler(this.proxy);
  }
  ...
  onSearchPerformed(arg_index_id) {
    return this.$.onSearchPerformed(arg_index_id);
  }
};
...
mojo.internal.bindings.ash.local_search_service.mojom.SearchMetricsReporter.getRemote = function() {
  let remote = new mojo.internal.bindings.ash.local_search_service.mojom.SearchMetricsReporterRemote();
...
mojo.internal.bindings.ash.local_search_service.mojom.SearchMetricsReporterReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
        ...
        case 0: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.ash.local_search_service.mojom.SearchMetricsReporter_OnSearchPerformed_ResponseParamsSpec, header, rawHeader);
               responder(response);
...
mojo.internal.bindings.ash.local_search_service.mojom.SearchMetricsReporterReceiver = mojo.internal.bindings.ash.local_search_service.mojom.SearchMetricsReporterReceiver;

mojo.internal.bindings.ash.local_search_service.mojom.SearchMetricsReporterPtr = mojo.internal.bindings.ash.local_search_service.mojom.SearchMetricsReporterRemote;
mojo.internal.bindings.ash.local_search_service.mojom.SearchMetricsReporterRequest = mojo.internal.bindings.ash.local_search_service.mojom.SearchMetricsReporterPendingReceiver;
...
mojo.internal.Struct(
    mojo.internal.bindings.ash.local_search_service.mojom.LocalSearchService_BindIndex_ParamsSpec, 'ash.local_search_service.mojom.LocalSearchService_BindIndex_Params', [
      mojo.internal.StructField('arg_index_id', 0, 0, mojo.internal.bindings.mojo.internal.bindings.ash.local_search_service.mojom.IndexIdSpec.$, null, false, 0, undefined),
      mojo.internal.StructField('arg_backend', 8, 0, mojo.internal.bindings.mojo.internal.bindings.ash.local_search_service.mojom.BackendSpec.$, null, false, 0, undefined),
...
mojo.internal.bindings.ash.local_search_service.mojom.LocalSearchServiceRemote = class {
  static get $interfaceName() {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.ash.local_search_service.mojom.LocalSearchServicePendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.ash.local_search_service.mojom.LocalSearchServiceRemoteCallHandler(this.proxy);
  }
  ...
  bindIndex(arg_index_id, arg_backend, arg_index_receiver, arg_reporter_remote) {
    return this.$.bindIndex(arg_index_id, arg_backend, arg_index_receiver, arg_reporter_remote);
  }
};
...
mojo.internal.bindings.ash.local_search_service.mojom.LocalSearchService.getRemote = function() {
  let remote = new mojo.internal.bindings.ash.local_search_service.mojom.LocalSearchServiceRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
...
mojo.internal.bindings.ash.local_search_service.mojom.LocalSearchServiceReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
      ...
      switch (dispatchId) {
        case 0: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              const rawHeader = (args[2] && args[2].slice) ? args[2].slice(0, header.headerSize) : null;
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.ash.local_search_service.mojom.LocalSearchService_BindIndex_ResponseParamsSpec, header, rawHeader);
               responder(response);
...
mojo.internal.bindings.ash.local_search_service.mojom.LocalSearchServiceReceiver = mojo.internal.bindings.ash.local_search_service.mojom.LocalSearchServiceReceiver;
