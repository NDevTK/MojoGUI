  ...
  $: {
    structSpec: {
      ...
      fields: [
        ...
        { name: 'trusted_bidding_signals_url', packedOffset: 24, packedBitOffset: 0, type: mojo.internal.Pointer, nullable: true },
        { name: 'trusted_bidding_signals_slot_size_param', packedOffset: 32, packedBitOffset: 0, type: mojo.internal.String, nullable: false },
        { name: 'top_window_origin', packedOffset: 40, packedBitOffset: 0, type: mojo.internal.Pointer, nullable: false },
        { name: 'permissions_policy_state', packedOffset: 48, packedBitOffset: 0, type: mojo.internal.Pointer, nullable: false },
        { name: 'public_key', packedOffset: 56, packedBitOffset: 0, type: mojo.internal.Pointer, nullable: true },
  ...
  $: {
    structSpec: {
      ...
      fields: [
        { name: 'shared_storage_hosts', packedOffset: 0, packedBitOffset: 0, type: mojo.internal.Array, nullable: true },
        { name: 'script_source_load', packedOffset: 8, packedBitOffset: 0, type: mojo.internal.Pointer, nullable: false },
        { name: 'trusted_scoring_signals_url', packedOffset: 16, packedBitOffset: 0, type: mojo.internal.Pointer, nullable: true },
        { name: 'top_window_origin', packedOffset: 24, packedBitOffset: 0, type: mojo.internal.Pointer, nullable: false },
        { name: 'permissions_policy_state', packedOffset: 32, packedBitOffset: 0, type: mojo.internal.Pointer, nullable: false },
        { name: 'public_key', packedOffset: 40, packedBitOffset: 0, type: mojo.internal.Pointer, nullable: true },
