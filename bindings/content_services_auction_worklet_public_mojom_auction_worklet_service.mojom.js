  ...
  $: {
    structSpec: {
      ...
      fields: [
        ...
        { name: 'auction_network_events_handler', packedOffset: 32, packedBitOffset: 0, type: mojo.internal.InterfaceProxy, nullable: false },
        { name: 'script_source_load', packedOffset: 40, packedBitOffset: 0, type: mojo.internal.Pointer, nullable: false },
        { name: 'wasm_helper_load', packedOffset: 48, packedBitOffset: 0, type: mojo.internal.Pointer, nullable: true },
        { name: 'trusted_bidding_signals_url', packedOffset: 56, packedBitOffset: 0, type: mojo.internal.Pointer, nullable: true },
        { name: 'trusted_bidding_signals_slot_size_param', packedOffset: 64, packedBitOffset: 0, type: mojo.internal.String, nullable: false },
        { name: 'top_window_origin', packedOffset: 72, packedBitOffset: 0, type: mojo.internal.Pointer, nullable: false },
        { name: 'permissions_policy_state', packedOffset: 80, packedBitOffset: 0, type: mojo.internal.Pointer, nullable: false },
        { name: 'experiment_group_id', packedOffset: 88, packedBitOffset: 0, type: mojo.internal.Uint16, nullable: true },
        { name: 'public_key', packedOffset: 96, packedBitOffset: 0, type: mojo.internal.Pointer, nullable: true },
      ],
      versions: [{version: 0}]
    }
  }
  ...
  $: {
    structSpec: {
      ...
      fields: [
        ...
        { name: 'auction_network_events_handler', packedOffset: 32, packedBitOffset: 0, type: mojo.internal.InterfaceProxy, nullable: false },
        { name: 'script_source_load', packedOffset: 40, packedBitOffset: 0, type: mojo.internal.Pointer, nullable: false },
        { name: 'trusted_scoring_signals_url', packedOffset: 48, packedBitOffset: 0, type: mojo.internal.Pointer, nullable: true },
        { name: 'top_window_origin', packedOffset: 56, packedBitOffset: 0, type: mojo.internal.Pointer, nullable: false },
        { name: 'permissions_policy_state', packedOffset: 64, packedBitOffset: 0, type: mojo.internal.Pointer, nullable: false },
        { name: 'experiment_group_id', packedOffset: 72, packedBitOffset: 0, type: mojo.internal.Uint16, nullable: true },
        { name: 'send_creative_scanning_metadata', packedOffset: 80, packedBitOffset: 0, type: mojo.internal.Bool, nullable: true },
        { name: 'public_key', packedOffset: 88, packedBitOffset: 0, type: mojo.internal.Pointer, nullable: true },
