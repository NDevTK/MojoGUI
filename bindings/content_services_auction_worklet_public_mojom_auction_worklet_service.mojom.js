...
mojo.internal.bindings.auction_worklet.mojom.LoadSellerWorkletClientRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.auction_worklet.mojom.LoadSellerWorkletClientRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.auction_worklet.mojom.LoadSellerWorkletClient.getRemote = function() {
  let remote = new mojo.internal.bindings.auction_worklet.mojom.LoadSellerWorkletClientRemote();
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.auction_worklet.mojom.LoadSellerWorkletClient_SellerWorkletLoaded_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for SellerWorkletLoaded failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.auction_worklet.mojom.LoadSellerWorkletClientReceiver = mojo.internal.bindings.auction_worklet.mojom.LoadSellerWorkletClientReceiver;

mojo.internal.bindings.auction_worklet.mojom.LoadSellerWorkletClientPtr = mojo.internal.bindings.auction_worklet.mojom.LoadSellerWorkletClientRemote;
mojo.internal.bindings.auction_worklet.mojom.LoadSellerWorkletClientRequest = mojo.internal.bindings.auction_worklet.mojom.LoadSellerWorkletClientPendingReceiver;
...
mojo.internal.Struct(
    mojo.internal.bindings.auction_worklet.mojom.AuctionWorkletService_LoadBidderWorklet_ParamsSpec, 'auction_worklet.mojom.AuctionWorkletService_LoadBidderWorklet_Params', [
      ...
      mojo.internal.StructField('arg_shared_storage_hosts', 8, 0, mojo.internal.Array(mojo.internal.InterfaceProxy(mojo.internal.bindings.auction_worklet.mojom.AuctionSharedStorageHostRemote), false), null, true, 0, undefined),
      ...
      mojo.internal.StructField('arg_experiment_group_id_$value', 88, 0, mojo.internal.Uint16, 0, false, 0, { isPrimary: false, linkedValueFieldName: 'arg_experiment_group_id_$flag', originalFieldName: 'arg_experiment_group_id' }),
      mojo.internal.StructField('arg_pause_for_debugger_on_start', 90, 0, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_experiment_group_id_$flag', 90, 1, mojo.internal.Bool, false, false, 0, { isPrimary: true, linkedValueFieldName: 'arg_experiment_group_id_$value', originalFieldName: 'arg_experiment_group_id' }),
    ],
    [[0, 104]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.auction_worklet.mojom.AuctionWorkletService_LoadSellerWorklet_ParamsSpec, 'auction_worklet.mojom.AuctionWorkletService_LoadSellerWorklet_Params', [
      ...
      mojo.internal.StructField('arg_send_creative_scanning_metadata_$flag', 82, 2, mojo.internal.Bool, false, false, 0, { isPrimary: true, linkedValueFieldName: 'arg_send_creative_scanning_metadata_$value', originalFieldName: 'arg_send_creative_scanning_metadata' }),
      mojo.internal.StructField('arg_send_creative_scanning_metadata_$value', 82, 3, mojo.internal.Bool, false, false, 0, { isPrimary: false, linkedValueFieldName: 'arg_send_creative_scanning_metadata_$flag', originalFieldName: 'arg_send_creative_scanning_metadata' }),
    ],
    [[0, 96]]);
...
mojo.internal.bindings.auction_worklet.mojom.AuctionWorkletServiceRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.auction_worklet.mojom.AuctionWorkletServiceRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.auction_worklet.mojom.AuctionWorkletService.getRemote = function() {
  let remote = new mojo.internal.bindings.auction_worklet.mojom.AuctionWorkletServiceRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.auction_worklet.mojom.AuctionWorkletService_SetTrustedSignalsCache_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for SetTrustedSignalsCache failed with TypeError');
           }
        }
        // Try Method 1: LoadBidderWorklet
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.auction_worklet.mojom.AuctionWorkletService_LoadBidderWorklet_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for LoadBidderWorklet failed with TypeError');
           }
        }
        // Try Method 2: LoadSellerWorklet
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.auction_worklet.mojom.AuctionWorkletService_LoadSellerWorklet_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for LoadSellerWorklet failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
             console.warn('[GeneratedReceiver] Failed to discover ordinal ' + header.ordinal);
...
mojo.internal.bindings.auction_worklet.mojom.AuctionWorkletServiceReceiver = mojo.internal.bindings.auction_worklet.mojom.AuctionWorkletServiceReceiver;
