...
mojo.internal.bindings.gpu.mojom.SharedImagePoolClientInterface = {};
mojo.internal.bindings.gpu.mojom.SharedImagePoolClientInterfaceSpec = { $ : {} };
mojo.internal.bindings.gpu.mojom.SharedImagePoolClientInterface.$interfaceName = 'gpu.mojom.SharedImagePoolClientInterface';
...
mojo.internal.bindings.gpu.mojom.SharedImagePoolClientInterfaceRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.gpu.mojom.SharedImagePoolClientInterfaceRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.gpu.mojom.SharedImagePoolClientInterfaceRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('gpu.mojom.SharedImagePoolClientInterface', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.gpu.mojom.SharedImagePoolClientInterface.getRemote = function() {
  let remote = new mojo.internal.bindings.gpu.mojom.SharedImagePoolClientInterfaceRemote();
...
mojo.internal.bindings.gpu.mojom.SharedImagePoolClientInterfaceReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('gpu.mojom.SharedImagePoolClientInterface', [
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.gpu.mojom.SharedImagePoolClientInterface_OnClearPool_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OnClearPool failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.gpu.mojom.SharedImagePoolClientInterface_OnClearPool_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.gpu.mojom.SharedImagePoolClientInterfaceReceiver = mojo.internal.bindings.gpu.mojom.SharedImagePoolClientInterfaceReceiver;
