...
mojo.internal.bindings.video_capture.mojom.PushVideoStreamSubscription_InvalidateBuffers_ParamsSpec = mojo.internal.bindings.video_capture.mojom.PushVideoStreamSubscription_InvalidateBuffers_ParamsSpec || { $: {} };
if (mojo.internal.bindings.video_capture.mojom.PushVideoStreamSubscription_InvalidateBuffers_ParamsSpec.$.structSpec && mojo.internal.bindings.video_capture.mojom.PushVideoStreamSubscription_InvalidateBuffers_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.video_capture.mojom.PushVideoStreamSubscription_InvalidateBuffers_ParamsSpec.$ = {};
...
mojo.internal.bindings.video_capture.mojom.PushVideoStreamSubscriptionRemoteCallHandler = class {
  ...
  invalidateBuffers() {
    return this.proxy.sendMessage(
      ...
      mojo.internal.bindings.video_capture.mojom.PushVideoStreamSubscription_InvalidateBuffers_ParamsSpec,
      null,
      [],
      false);
  }
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        ...
        case 8: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.video_capture.mojom.PushVideoStreamSubscription_InvalidateBuffers_ParamsSpec.$.structSpec);
...
mojo.internal.Struct(
    mojo.internal.bindings.video_capture.mojom.PushVideoStreamSubscription_InvalidateBuffers_ParamsSpec, 'video_capture.mojom.PushVideoStreamSubscription_InvalidateBuffers_Params', [
    ],
    [[0, 8]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.video_capture.mojom.VideoSource_CreatePushSubscription_ParamsSpec, 'video_capture.mojom.VideoSource_CreatePushSubscription_Params', [
      ...
      mojo.internal.StructField('arg_subscription', 20, 0, mojo.internal.InterfaceRequest(mojo.internal.bindings.video_capture.mojom.PushVideoStreamSubscriptionPendingReceiver), null, false, 0, undefined),
    ],
    [[0, 32]]);
