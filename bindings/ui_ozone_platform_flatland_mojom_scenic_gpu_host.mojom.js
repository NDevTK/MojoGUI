...
mojo.internal.Struct(
    mojo.internal.bindings.ui.mojom.ScenicGpuHost_AttachSurfaceToWindow_ParamsSpec, 'ui.mojom.ScenicGpuHost_AttachSurfaceToWindow_Params', [
      mojo.internal.StructField('arg_view_holder_token', 0, 0, mojo.internal.Pointer, null, false, 0, undefined),
...
mojo.internal.bindings.ui.mojom.ScenicGpuHostRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.ui.mojom.ScenicGpuHostRemoteCallHandler(this.proxy);
  }
  ...
  attachSurfaceToWindow(arg_window_id, arg_view_holder_token) {
    return this.$.attachSurfaceToWindow(arg_window_id, arg_view_holder_token);
  }
};
...
mojo.internal.bindings.ui.mojom.ScenicGpuHost.getRemote = function() {
  let remote = new mojo.internal.bindings.ui.mojom.ScenicGpuHostRemote();
...
mojo.internal.bindings.ui.mojom.ScenicGpuHostReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ui.mojom.ScenicGpuHost_AttachSurfaceToWindow_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for AttachSurfaceToWindow failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.ui.mojom.ScenicGpuHostReceiver = mojo.internal.bindings.ui.mojom.ScenicGpuHostReceiver;
