  ...
  $: {
    structSpec: {
      ...
      fields: [
        ...
        { name: 'frame_type', packedOffset: 16, packedBitOffset: 0, type: blink.mojom.RequestContextFrameTypeSpec, nullable: false },
        ...
        { name: 'headers', packedOffset: 40, packedBitOffset: 0, type: blink.mojom.FetchAPIRequestHeadersSpec, nullable: false },
        { name: 'blob', packedOffset: 48, packedBitOffset: 0, type: blink.mojom.SerializedBlobSpec, nullable: true },
        { name: 'body', packedOffset: 56, packedBitOffset: 0, type: blink.mojom.FetchAPIRequestBodySpec, nullable: true },
        { name: 'request_initiator', packedOffset: 64, packedBitOffset: 0, type: url.mojom.OriginSpec, nullable: true },
        { name: 'navigation_redirect_chain', packedOffset: 72, packedBitOffset: 0, type: mojo.internal.Array, nullable: false },
        { name: 'referrer', packedOffset: 80, packedBitOffset: 0, type: blink.mojom.ReferrerSpec, nullable: true },
        { name: 'cache_mode', packedOffset: 88, packedBitOffset: 0, type: blink.mojom.FetchCacheModeSpec, nullable: false },
        ...
        { name: 'fetch_window_id', packedOffset: 112, packedBitOffset: 0, type: mojo_base.mojom.UnguessableTokenSpec, nullable: true },
        { name: 'devtools_stack_id', packedOffset: 120, packedBitOffset: 0, type: mojo.internal.String, nullable: true },
        { name: 'trust_token_params', packedOffset: 128, packedBitOffset: 0, type: network.mojom.TrustTokenParamsSpec, nullable: true },
        { name: 'target_address_space', packedOffset: 136, packedBitOffset: 0, type: network.mojom.IPAddressSpaceSpec, nullable: false },
        { name: 'service_worker_race_network_request_token', packedOffset: 144, packedBitOffset: 0, type: mojo_base.mojom.UnguessableTokenSpec, nullable: true },
