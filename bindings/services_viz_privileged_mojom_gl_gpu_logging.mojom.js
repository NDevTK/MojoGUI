...
mojo.internal.bindings.viz.mojom.GpuLoggingRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.viz.mojom.GpuLoggingPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.viz.mojom.GpuLoggingRemoteCallHandler(this.proxy);
  }
  ...
  recordLogMessage(arg_severity, arg_header, arg_message) {
    return this.$.recordLogMessage(arg_severity, arg_header, arg_message);
  }
};
...
mojo.internal.bindings.viz.mojom.GpuLogging.getRemote = function() {
  let remote = new mojo.internal.bindings.viz.mojom.GpuLoggingRemote();
...
mojo.internal.bindings.viz.mojom.GpuLoggingReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.viz.mojom.GpuLogging_RecordLogMessage_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for RecordLogMessage failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.viz.mojom.GpuLoggingReceiver = mojo.internal.bindings.viz.mojom.GpuLoggingReceiver;
