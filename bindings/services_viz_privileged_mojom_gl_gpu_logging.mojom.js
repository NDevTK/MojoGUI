...
viz.mojom.GpuLogging_RecordLogMessage_ParamsSpec = {
  $: {
    structSpec: {
      ...
      packedSize: 32,
      fields: [
        { name: 'severity', packedOffset: 0, packedBitOffset: 0, type: mojo.internal.String, nullable: true },
        { name: 'header', packedOffset: 8, packedBitOffset: 0, type: mojo.internal.String, nullable: true },
