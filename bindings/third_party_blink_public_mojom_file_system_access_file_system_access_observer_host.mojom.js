...
mojo.internal.bindings.blink.mojom.FileSystemAccessObserverHost = {};
mojo.internal.bindings.blink.mojom.FileSystemAccessObserverHostSpec = { $ : {} };
mojo.internal.bindings.blink.mojom.FileSystemAccessObserverHost.$interfaceName = 'blink.mojom.FileSystemAccessObserverHost';
...
mojo.internal.bindings.blink.mojom.FileSystemAccessObserverHostRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.blink.mojom.FileSystemAccessObserverHostPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.blink.mojom.FileSystemAccessObserverHostRemoteCallHandler(this.proxy);
  }
  ...
  observe(arg_token, arg_is_recursive) {
    return this.$.observe(arg_token, arg_is_recursive);
  }
  unobserve(arg_token) {
    return this.$.unobserve(arg_token);
  }
};

mojo.internal.bindings.blink.mojom.FileSystemAccessObserverHostRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('blink.mojom.FileSystemAccessObserverHost', [
      { explicit: null },
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.blink.mojom.FileSystemAccessObserverHost.getRemote = function() {
  let remote = new mojo.internal.bindings.blink.mojom.FileSystemAccessObserverHostRemote();
...
mojo.internal.bindings.blink.mojom.FileSystemAccessObserverHostReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('blink.mojom.FileSystemAccessObserverHost', [
      { explicit: null },
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.blink.mojom.FileSystemAccessObserverHost_Observe_ParamsSpec.$.structSpec);
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.blink.mojom.FileSystemAccessObserverHost_Unobserve_ParamsSpec.$.structSpec);
        ...
        case 0: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.blink.mojom.FileSystemAccessObserverHost_Observe_ResponseParamsSpec, header, rawHeader);
               responder(response);
...
mojo.internal.bindings.blink.mojom.FileSystemAccessObserverHostReceiver = mojo.internal.bindings.blink.mojom.FileSystemAccessObserverHostReceiver;
