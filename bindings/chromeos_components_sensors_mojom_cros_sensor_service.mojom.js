...
mojo.internal.bindings.chromeos.sensors.mojom.SensorHalServerRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.chromeos.sensors.mojom.SensorHalServerPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.chromeos.sensors.mojom.SensorHalServerRemoteCallHandler(this.proxy);
  }
  ...
  createChannel(arg_sensor_service_request) {
    return this.$.createChannel(arg_sensor_service_request);
  }
};
...
mojo.internal.bindings.chromeos.sensors.mojom.SensorHalServer.getRemote = function() {
  let remote = new mojo.internal.bindings.chromeos.sensors.mojom.SensorHalServerRemote();
...
mojo.internal.bindings.chromeos.sensors.mojom.SensorHalServerReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.chromeos.sensors.mojom.SensorHalServer_CreateChannel_ParamsSpec.$.structSpec;
...
mojo.internal.bindings.chromeos.sensors.mojom.SensorHalServerReceiver = mojo.internal.bindings.chromeos.sensors.mojom.SensorHalServerReceiver;

mojo.internal.bindings.chromeos.sensors.mojom.SensorHalServerPtr = mojo.internal.bindings.chromeos.sensors.mojom.SensorHalServerRemote;
mojo.internal.bindings.chromeos.sensors.mojom.SensorHalServerRequest = mojo.internal.bindings.chromeos.sensors.mojom.SensorHalServerPendingReceiver;
...
mojo.internal.bindings.chromeos.sensors.mojom.SensorHalClientRemote = class {
  static get $interfaceName() {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.chromeos.sensors.mojom.SensorHalClientRemoteCallHandler(this.proxy);
  }
  ...
  setUpChannel(arg_sensor_service_ptr) {
    return this.$.setUpChannel(arg_sensor_service_ptr);
  }
};
...
mojo.internal.bindings.chromeos.sensors.mojom.SensorHalClient.getRemote = function() {
  let remote = new mojo.internal.bindings.chromeos.sensors.mojom.SensorHalClientRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
...
mojo.internal.bindings.chromeos.sensors.mojom.SensorHalClientReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.chromeos.sensors.mojom.SensorHalClient_SetUpChannel_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for SetUpChannel failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
             console.warn('[GeneratedReceiver] Failed to discover ordinal ' + header.ordinal);
...
mojo.internal.bindings.chromeos.sensors.mojom.SensorHalClientReceiver = mojo.internal.bindings.chromeos.sensors.mojom.SensorHalClientReceiver;
