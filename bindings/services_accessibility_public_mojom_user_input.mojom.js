...
mojo.internal.bindings.ui = mojo.internal.bindings.ui || {};
mojo.internal.bindings.ui.mojom = mojo.internal.bindings.ui.mojom || {};
mojo.internal.bindings.ui.mojom.KeyDataSpec = mojo.internal.bindings.ui.mojom.KeyDataSpec || { $: mojo.internal.OpaqueStruct.$ };

// Enum: SyntheticMouseEventButton
mojo.internal.bindings.ax.mojom.SyntheticMouseEventButton = {
  kLeft: 0,
  kMiddle: 1,
  kRight: 2,
  kBack: 3,
...
mojo.internal.Struct(
    mojo.internal.bindings.ax.mojom.SyntheticKeyEventSpec, 'ax.mojom.SyntheticKeyEvent', [
      mojo.internal.StructField('arg_key_data', 0, 0, mojo.internal.bindings.ui.mojom.KeyDataSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_type', 8, 0, mojo.internal.bindings.ui.mojom.EventTypeSpec, null, false, 0, undefined),
...
mojo.internal.Struct(
    mojo.internal.bindings.ax.mojom.SyntheticMouseEventSpec, 'ax.mojom.SyntheticMouseEvent', [
      ...
      mojo.internal.StructField('arg_type', 8, 0, mojo.internal.bindings.ui.mojom.EventTypeSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_mouse_button', 12, 0, mojo.internal.bindings.ax.mojom.SyntheticMouseEventButtonSpec, null, true, 0, undefined),
      mojo.internal.StructField('arg_touch_accessibility_$flag', 16, 0, mojo.internal.Bool, false, false, 0, { isPrimary: true, linkedValueFieldName: 'arg_touch_accessibility_$value', originalFieldName: 'arg_touch_accessibility' }),
      mojo.internal.StructField('arg_touch_accessibility_$value', 16, 1, mojo.internal.Bool, false, false, 0, { isPrimary: false, linkedValueFieldName: 'arg_touch_accessibility_$flag', originalFieldName: 'arg_touch_accessibility' }),
    ],
    [[0, 32]]);
...
mojo.internal.bindings.ax.mojom.UserInputPendingReceiver = class {
  constructor(handle) {
    this.handle = handle;
  }
};

mojo.internal.bindings.ax.mojom.UserInputRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.ax.mojom.UserInputPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.ax.mojom.UserInputRemoteCallHandler(this.proxy);
  }
  ...
  sendSyntheticKeyEventForShortcutOrNavigation(arg_key_event) {
    return this.$.sendSyntheticKeyEventForShortcutOrNavigation(arg_key_event);
  }
  sendSyntheticMouseEvent(arg_mouse_event) {
    return this.$.sendSyntheticMouseEvent(arg_mouse_event);
  }
};

mojo.internal.bindings.ax.mojom.UserInputRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('ax.mojom.UserInput', [
      { explicit: null },
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.ax.mojom.UserInput.getRemote = function() {
  let remote = new mojo.internal.bindings.ax.mojom.UserInputRemote();
...
mojo.internal.bindings.ax.mojom.UserInputReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('ax.mojom.UserInput', [
      { explicit: null },
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ax.mojom.UserInput_SendSyntheticKeyEventForShortcutOrNavigation_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for SendSyntheticKeyEventForShortcutOrNavigation failed with TypeError');
           }
        }
        // Try Method 1: SendSyntheticMouseEvent
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ax.mojom.UserInput_SendSyntheticMouseEvent_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for SendSyntheticMouseEvent failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.ax.mojom.UserInputReceiver = mojo.internal.bindings.ax.mojom.UserInputReceiver;

mojo.internal.bindings.ax.mojom.UserInputPtr = mojo.internal.bindings.ax.mojom.UserInputRemote;
mojo.internal.bindings.ax.mojom.UserInputRequest = mojo.internal.bindings.ax.mojom.UserInputPendingReceiver;
