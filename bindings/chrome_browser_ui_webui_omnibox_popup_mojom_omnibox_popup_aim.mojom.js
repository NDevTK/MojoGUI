...
mojo.internal.bindings.omnibox_popup_aim.mojom.Page_FocusInput_ParamsSpec = mojo.internal.bindings.omnibox_popup_aim.mojom.Page_FocusInput_ParamsSpec || { $: {} };
if (mojo.internal.bindings.omnibox_popup_aim.mojom.Page_FocusInput_ParamsSpec.$.structSpec && mojo.internal.bindings.omnibox_popup_aim.mojom.Page_FocusInput_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.omnibox_popup_aim.mojom.Page_FocusInput_ParamsSpec.$ = {};
mojo.internal.bindings.omnibox_popup_aim.mojom.Page_ClearPopup_ParamsSpec = mojo.internal.bindings.omnibox_popup_aim.mojom.Page_ClearPopup_ParamsSpec || { $: {} };
if (mojo.internal.bindings.omnibox_popup_aim.mojom.Page_ClearPopup_ParamsSpec.$.structSpec && mojo.internal.bindings.omnibox_popup_aim.mojom.Page_ClearPopup_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.omnibox_popup_aim.mojom.Page_ClearPopup_ParamsSpec.$ = {};
mojo.internal.bindings.omnibox_popup_aim.mojom.Page_ClearPopup_ResponseParamsSpec = mojo.internal.bindings.omnibox_popup_aim.mojom.Page_ClearPopup_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.omnibox_popup_aim.mojom.Page_ClearPopup_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.omnibox_popup_aim.mojom.Page_ClearPopup_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.omnibox_popup_aim.mojom.Page_ClearPopup_ResponseParamsSpec.$ = {};
...
mojo.internal.bindings.omnibox_popup_aim.mojom.Page_OnContextMenuClosed_ParamsSpec = mojo.internal.bindings.omnibox_popup_aim.mojom.Page_OnContextMenuClosed_ParamsSpec || { $: {} };
if (mojo.internal.bindings.omnibox_popup_aim.mojom.Page_OnContextMenuClosed_ParamsSpec.$.structSpec && mojo.internal.bindings.omnibox_popup_aim.mojom.Page_OnContextMenuClosed_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.omnibox_popup_aim.mojom.Page_OnContextMenuClosed_ParamsSpec.$ = {};
...
mojo.internal.bindings.omnibox_popup_aim.mojom.PageHandlerFactoryRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('omnibox_popup_aim.mojom.PageHandlerFactory', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.omnibox_popup_aim.mojom.PageHandlerFactoryReceiver = class {
  constructor(impl) {
    ...
    const ordinals = window.mojoScrambler.getOrdinals('omnibox_popup_aim.mojom.PageHandlerFactory', [
      { explicit: null },
    ]);
...
mojo.internal.bindings.omnibox_popup_aim.mojom.PageRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('omnibox_popup_aim.mojom.Page', [
      { explicit: null },
      { explicit: null },
      { explicit: null },
      { explicit: null },
  ...
  focusInput() {
    return this.proxy.sendMessage(
      ...
      mojo.internal.bindings.omnibox_popup_aim.mojom.Page_FocusInput_ParamsSpec,
      null,
      [],
      false);
  }
  ...
  clearPopup() {
    return this.proxy.sendMessage(
      ...
      mojo.internal.bindings.omnibox_popup_aim.mojom.Page_ClearPopup_ParamsSpec,
      mojo.internal.bindings.omnibox_popup_aim.mojom.Page_ClearPopup_ResponseParamsSpec,
      [],
      false);
  }
  ...
  onContextMenuClosed() {
    return this.proxy.sendMessage(
      ...
      mojo.internal.bindings.omnibox_popup_aim.mojom.Page_OnContextMenuClosed_ParamsSpec,
      null,
      [],
      false);
  }
...
mojo.internal.bindings.omnibox_popup_aim.mojom.PageReceiver = class {
  constructor(impl) {
    ...
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('omnibox_popup_aim.mojom.Page', [
      { explicit: null },
      { explicit: null },
      { explicit: null },
      { explicit: null },
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        ...
        case 2: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.omnibox_popup_aim.mojom.Page_FocusInput_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.focusInput');
          const result = this.impl.focusInput();
          break;
        }
        case 3: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.omnibox_popup_aim.mojom.Page_ClearPopup_ParamsSpec.$.structSpec);
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const resp_obj = { 'arg_input': val };
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.omnibox_popup_aim.mojom.Page_ClearPopup_ResponseParamsSpec.$.structSpec, resp_obj);
        ...
        case 5: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.omnibox_popup_aim.mojom.Page_OnContextMenuClosed_ParamsSpec.$.structSpec);
...
mojo.internal.Struct(
    mojo.internal.bindings.omnibox_popup_aim.mojom.Page_FocusInput_ParamsSpec, 'omnibox_popup_aim.mojom.Page_FocusInput_Params', [
    ],
    [[0, 8]]);

mojo.internal.Struct(
    mojo.internal.bindings.omnibox_popup_aim.mojom.Page_ClearPopup_ParamsSpec, 'omnibox_popup_aim.mojom.Page_ClearPopup_Params', [
    ],
    [[0, 8]]);

mojo.internal.Struct(
    mojo.internal.bindings.omnibox_popup_aim.mojom.Page_ClearPopup_ResponseParamsSpec, 'omnibox_popup_aim.mojom.Page_ClearPopup_ResponseParams', [
...
mojo.internal.Struct(
    mojo.internal.bindings.omnibox_popup_aim.mojom.Page_OnContextMenuClosed_ParamsSpec, 'omnibox_popup_aim.mojom.Page_OnContextMenuClosed_Params', [
    ],
    [[0, 8]]);
