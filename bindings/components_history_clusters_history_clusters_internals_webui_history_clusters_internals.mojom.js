...
mojo.internal.bindings.history_clusters_internals.mojom.PageHandlerFactoryRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.history_clusters_internals.mojom.PageHandlerFactoryRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.history_clusters_internals.mojom.PageHandlerFactory.getRemote = function() {
  let remote = new mojo.internal.bindings.history_clusters_internals.mojom.PageHandlerFactoryRemote();
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.history_clusters_internals.mojom.PageHandlerFactory_CreatePageHandler_ParamsSpec.$.structSpec;
...
mojo.internal.bindings.history_clusters_internals.mojom.PageHandlerFactoryReceiver = mojo.internal.bindings.history_clusters_internals.mojom.PageHandlerFactoryReceiver;

mojo.internal.bindings.history_clusters_internals.mojom.PageHandlerFactoryPtr = mojo.internal.bindings.history_clusters_internals.mojom.PageHandlerFactoryRemote;
mojo.internal.bindings.history_clusters_internals.mojom.PageHandlerFactoryRequest = mojo.internal.bindings.history_clusters_internals.mojom.PageHandlerFactoryPendingReceiver;
...
mojo.internal.bindings.history_clusters_internals.mojom.PageHandlerRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.history_clusters_internals.mojom.PageHandlerRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.history_clusters_internals.mojom.PageHandler.getRemote = function() {
  let remote = new mojo.internal.bindings.history_clusters_internals.mojom.PageHandlerRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.history_clusters_internals.mojom.PageHandler_GetContextClustersJson_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for GetContextClustersJson failed with TypeError');
           }
        }
        // Try Method 1: PrintKeywordBagStateToLogMessages
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.history_clusters_internals.mojom.PageHandler_PrintKeywordBagStateToLogMessages_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for PrintKeywordBagStateToLogMessages failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
             console.warn('[GeneratedReceiver] Failed to discover ordinal ' + header.ordinal);
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.history_clusters_internals.mojom.PageHandler_GetContextClustersJson_ParamsSpec.$.structSpec);
        ...
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.history_clusters_internals.mojom.PageHandler_PrintKeywordBagStateToLogMessages_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.history_clusters_internals.mojom.PageHandlerReceiver = mojo.internal.bindings.history_clusters_internals.mojom.PageHandlerReceiver;

mojo.internal.bindings.history_clusters_internals.mojom.PageHandlerPtr = mojo.internal.bindings.history_clusters_internals.mojom.PageHandlerRemote;
mojo.internal.bindings.history_clusters_internals.mojom.PageHandlerRequest = mojo.internal.bindings.history_clusters_internals.mojom.PageHandlerPendingReceiver;
...
mojo.internal.bindings.history_clusters_internals.mojom.PageRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.history_clusters_internals.mojom.PageRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.history_clusters_internals.mojom.Page.getRemote = function() {
  let remote = new mojo.internal.bindings.history_clusters_internals.mojom.PageRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.history_clusters_internals.mojom.Page_OnLogMessageAdded_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
...
mojo.internal.bindings.history_clusters_internals.mojom.PageReceiver = mojo.internal.bindings.history_clusters_internals.mojom.PageReceiver;
