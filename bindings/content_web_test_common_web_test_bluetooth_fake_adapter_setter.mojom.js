...
mojo.internal.bindings.content.mojom.WebTestBluetoothFakeAdapterSetter = {};
mojo.internal.bindings.content.mojom.WebTestBluetoothFakeAdapterSetterSpec = { $ : {} };
mojo.internal.bindings.content.mojom.WebTestBluetoothFakeAdapterSetter.$interfaceName = 'content.mojom.WebTestBluetoothFakeAdapterSetter';
...
mojo.internal.bindings.content.mojom.WebTestBluetoothFakeAdapterSetterRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.content.mojom.WebTestBluetoothFakeAdapterSetterPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.content.mojom.WebTestBluetoothFakeAdapterSetterRemoteCallHandler(this.proxy);
  }
  ...
  set(arg_adapter_name) {
    return this.$.set(arg_adapter_name);
  }
};

mojo.internal.bindings.content.mojom.WebTestBluetoothFakeAdapterSetterRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('content.mojom.WebTestBluetoothFakeAdapterSetter', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.content.mojom.WebTestBluetoothFakeAdapterSetter.getRemote = function() {
  let remote = new mojo.internal.bindings.content.mojom.WebTestBluetoothFakeAdapterSetterRemote();
...
mojo.internal.bindings.content.mojom.WebTestBluetoothFakeAdapterSetterReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('content.mojom.WebTestBluetoothFakeAdapterSetter', [
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.content.mojom.WebTestBluetoothFakeAdapterSetter_Set_ParamsSpec.$.structSpec);
        ...
        case 0: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.content.mojom.WebTestBluetoothFakeAdapterSetter_Set_ResponseParamsSpec, header, rawHeader);
               responder(response);
...
mojo.internal.bindings.content.mojom.WebTestBluetoothFakeAdapterSetterReceiver = mojo.internal.bindings.content.mojom.WebTestBluetoothFakeAdapterSetterReceiver;
