...
mojo.internal.bindings.media.mojom.MediaLog = {};
mojo.internal.bindings.media.mojom.MediaLogSpec = { $ : {} };
...
mojo.internal.bindings.media.mojom.MediaLogRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.media.mojom.MediaLogPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.media.mojom.MediaLogRemoteCallHandler(this.proxy);
  }
  ...
  addLogRecord(arg_event) {
    return this.$.addLogRecord(arg_event);
  }
};

mojo.internal.bindings.media.mojom.MediaLogRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('media.mojom.MediaLog', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.media.mojom.MediaLog.getRemote = function() {
  let remote = new mojo.internal.bindings.media.mojom.MediaLogRemote();
...
mojo.internal.bindings.media.mojom.MediaLogReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('media.mojom.MediaLog', [
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.media.mojom.MediaLog_AddLogRecord_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for AddLogRecord failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.media.mojom.MediaLogReceiver = mojo.internal.bindings.media.mojom.MediaLogReceiver;
