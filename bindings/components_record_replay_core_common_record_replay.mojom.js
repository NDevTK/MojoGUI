// Auto-generated MojoJS binding
 // Source: chromium_src/components/record_replay/core/common/record_replay.mojom
 ...
 mojo.internal.bindings.record_replay = mojo.internal.bindings.record_replay || {};
mojo.internal.bindings.record_replay.mojom = mojo.internal.bindings.record_replay.mojom || {};
mojo.internal.bindings.mojo_base = mojo.internal.bindings.mojo_base || {};
mojo.internal.bindings.mojo_base.mojom = mojo.internal.bindings.mojo_base.mojom || {};

mojo.internal.bindings.record_replay.mojom.DomNodeIdSpec = mojo.internal.bindings.record_replay.mojom.DomNodeIdSpec || { $: {} };
if (mojo.internal.bindings.record_replay.mojom.DomNodeIdSpec.$.structSpec && mojo.internal.bindings.record_replay.mojom.DomNodeIdSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.record_replay.mojom.DomNodeIdSpec.$ = {};
mojo.internal.bindings.record_replay.mojom.SelectorSpec = mojo.internal.bindings.record_replay.mojom.SelectorSpec || { $: {} };
if (mojo.internal.bindings.record_replay.mojom.SelectorSpec.$.structSpec && mojo.internal.bindings.record_replay.mojom.SelectorSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.record_replay.mojom.SelectorSpec.$ = {};
mojo.internal.bindings.record_replay.mojom.FieldValueSpec = mojo.internal.bindings.record_replay.mojom.FieldValueSpec || { $: {} };
if (mojo.internal.bindings.record_replay.mojom.FieldValueSpec.$.structSpec && mojo.internal.bindings.record_replay.mojom.FieldValueSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.record_replay.mojom.FieldValueSpec.$ = {};
mojo.internal.bindings.record_replay.mojom.RecordReplayAgent = mojo.internal.bindings.record_replay.mojom.RecordReplayAgent || {};
mojo.internal.bindings.record_replay.mojom.RecordReplayAgentSpec = mojo.internal.bindings.record_replay.mojom.RecordReplayAgentSpec || { $ : {} };
if (mojo.internal.bindings.record_replay.mojom.RecordReplayAgentSpec.$.structSpec && mojo.internal.bindings.record_replay.mojom.RecordReplayAgentSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.record_replay.mojom.RecordReplayAgentSpec.$ = {};
mojo.internal.bindings.record_replay.mojom.RecordReplayAgent.$interfaceName = 'record_replay.mojom.RecordReplayAgent';
mojo.internal.bindings.record_replay.mojom.RecordReplayAgent_StartRecording_ParamsSpec = mojo.internal.bindings.record_replay.mojom.RecordReplayAgent_StartRecording_ParamsSpec || { $: {} };
if (mojo.internal.bindings.record_replay.mojom.RecordReplayAgent_StartRecording_ParamsSpec.$.structSpec && mojo.internal.bindings.record_replay.mojom.RecordReplayAgent_StartRecording_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.record_replay.mojom.RecordReplayAgent_StartRecording_ParamsSpec.$ = {};
mojo.internal.bindings.record_replay.mojom.RecordReplayAgent_StopRecording_ParamsSpec = mojo.internal.bindings.record_replay.mojom.RecordReplayAgent_StopRecording_ParamsSpec || { $: {} };
if (mojo.internal.bindings.record_replay.mojom.RecordReplayAgent_StopRecording_ParamsSpec.$.structSpec && mojo.internal.bindings.record_replay.mojom.RecordReplayAgent_StopRecording_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.record_replay.mojom.RecordReplayAgent_StopRecording_ParamsSpec.$ = {};
mojo.internal.bindings.record_replay.mojom.RecordReplayAgent_GetElementSelector_ParamsSpec = mojo.internal.bindings.record_replay.mojom.RecordReplayAgent_GetElementSelector_ParamsSpec || { $: {} };
if (mojo.internal.bindings.record_replay.mojom.RecordReplayAgent_GetElementSelector_ParamsSpec.$.structSpec && mojo.internal.bindings.record_replay.mojom.RecordReplayAgent_GetElementSelector_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.record_replay.mojom.RecordReplayAgent_GetElementSelector_ParamsSpec.$ = {};
mojo.internal.bindings.record_replay.mojom.RecordReplayAgent_GetElementSelector_ResponseParamsSpec = mojo.internal.bindings.record_replay.mojom.RecordReplayAgent_GetElementSelector_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.record_replay.mojom.RecordReplayAgent_GetElementSelector_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.record_replay.mojom.RecordReplayAgent_GetElementSelector_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.record_replay.mojom.RecordReplayAgent_GetElementSelector_ResponseParamsSpec.$ = {};
mojo.internal.bindings.record_replay.mojom.RecordReplayAgent_GetMatchingElements_ParamsSpec = mojo.internal.bindings.record_replay.mojom.RecordReplayAgent_GetMatchingElements_ParamsSpec || { $: {} };
if (mojo.internal.bindings.record_replay.mojom.RecordReplayAgent_GetMatchingElements_ParamsSpec.$.structSpec && mojo.internal.bindings.record_replay.mojom.RecordReplayAgent_GetMatchingElements_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.record_replay.mojom.RecordReplayAgent_GetMatchingElements_ParamsSpec.$ = {};
mojo.internal.bindings.record_replay.mojom.RecordReplayAgent_GetMatchingElements_ResponseParamsSpec = mojo.internal.bindings.record_replay.mojom.RecordReplayAgent_GetMatchingElements_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.record_replay.mojom.RecordReplayAgent_GetMatchingElements_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.record_replay.mojom.RecordReplayAgent_GetMatchingElements_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.record_replay.mojom.RecordReplayAgent_GetMatchingElements_ResponseParamsSpec.$ = {};
mojo.internal.bindings.record_replay.mojom.RecordReplayAgent_DoClick_ParamsSpec = mojo.internal.bindings.record_replay.mojom.RecordReplayAgent_DoClick_ParamsSpec || { $: {} };
if (mojo.internal.bindings.record_replay.mojom.RecordReplayAgent_DoClick_ParamsSpec.$.structSpec && mojo.internal.bindings.record_replay.mojom.RecordReplayAgent_DoClick_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.record_replay.mojom.RecordReplayAgent_DoClick_ParamsSpec.$ = {};
mojo.internal.bindings.record_replay.mojom.RecordReplayAgent_DoClick_ResponseParamsSpec = mojo.internal.bindings.record_replay.mojom.RecordReplayAgent_DoClick_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.record_replay.mojom.RecordReplayAgent_DoClick_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.record_replay.mojom.RecordReplayAgent_DoClick_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.record_replay.mojom.RecordReplayAgent_DoClick_ResponseParamsSpec.$ = {};
mojo.internal.bindings.record_replay.mojom.RecordReplayAgent_DoPaste_ParamsSpec = mojo.internal.bindings.record_replay.mojom.RecordReplayAgent_DoPaste_ParamsSpec || { $: {} };
if (mojo.internal.bindings.record_replay.mojom.RecordReplayAgent_DoPaste_ParamsSpec.$.structSpec && mojo.internal.bindings.record_replay.mojom.RecordReplayAgent_DoPaste_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.record_replay.mojom.RecordReplayAgent_DoPaste_ParamsSpec.$ = {};
mojo.internal.bindings.record_replay.mojom.RecordReplayAgent_DoPaste_ResponseParamsSpec = mojo.internal.bindings.record_replay.mojom.RecordReplayAgent_DoPaste_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.record_replay.mojom.RecordReplayAgent_DoPaste_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.record_replay.mojom.RecordReplayAgent_DoPaste_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.record_replay.mojom.RecordReplayAgent_DoPaste_ResponseParamsSpec.$ = {};
mojo.internal.bindings.record_replay.mojom.RecordReplayAgent_DoSelect_ParamsSpec = mojo.internal.bindings.record_replay.mojom.RecordReplayAgent_DoSelect_ParamsSpec || { $: {} };
if (mojo.internal.bindings.record_replay.mojom.RecordReplayAgent_DoSelect_ParamsSpec.$.structSpec && mojo.internal.bindings.record_replay.mojom.RecordReplayAgent_DoSelect_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.record_replay.mojom.RecordReplayAgent_DoSelect_ParamsSpec.$ = {};
mojo.internal.bindings.record_replay.mojom.RecordReplayAgent_DoSelect_ResponseParamsSpec = mojo.internal.bindings.record_replay.mojom.RecordReplayAgent_DoSelect_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.record_replay.mojom.RecordReplayAgent_DoSelect_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.record_replay.mojom.RecordReplayAgent_DoSelect_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.record_replay.mojom.RecordReplayAgent_DoSelect_ResponseParamsSpec.$ = {};
mojo.internal.bindings.record_replay.mojom.RecordReplayAgent_GetValuesOfMatchingElements_ParamsSpec = mojo.internal.bindings.record_replay.mojom.RecordReplayAgent_GetValuesOfMatchingElements_ParamsSpec || { $: {} };
if (mojo.internal.bindings.record_replay.mojom.RecordReplayAgent_GetValuesOfMatchingElements_ParamsSpec.$.structSpec && mojo.internal.bindings.record_replay.mojom.RecordReplayAgent_GetValuesOfMatchingElements_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.record_replay.mojom.RecordReplayAgent_GetValuesOfMatchingElements_ParamsSpec.$ = {};
mojo.internal.bindings.record_replay.mojom.RecordReplayAgent_GetValuesOfMatchingElements_ResponseParamsSpec = mojo.internal.bindings.record_replay.mojom.RecordReplayAgent_GetValuesOfMatchingElements_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.record_replay.mojom.RecordReplayAgent_GetValuesOfMatchingElements_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.record_replay.mojom.RecordReplayAgent_GetValuesOfMatchingElements_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.record_replay.mojom.RecordReplayAgent_GetValuesOfMatchingElements_ResponseParamsSpec.$ = {};
mojo.internal.bindings.record_replay.mojom.RecordReplayDriver = mojo.internal.bindings.record_replay.mojom.RecordReplayDriver || {};
mojo.internal.bindings.record_replay.mojom.RecordReplayDriverSpec = mojo.internal.bindings.record_replay.mojom.RecordReplayDriverSpec || { $ : {} };
if (mojo.internal.bindings.record_replay.mojom.RecordReplayDriverSpec.$.structSpec && mojo.internal.bindings.record_replay.mojom.RecordReplayDriverSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.record_replay.mojom.RecordReplayDriverSpec.$ = {};
mojo.internal.bindings.record_replay.mojom.RecordReplayDriver.$interfaceName = 'record_replay.mojom.RecordReplayDriver';
mojo.internal.bindings.record_replay.mojom.RecordReplayDriver_OnClick_ParamsSpec = mojo.internal.bindings.record_replay.mojom.RecordReplayDriver_OnClick_ParamsSpec || { $: {} };
if (mojo.internal.bindings.record_replay.mojom.RecordReplayDriver_OnClick_ParamsSpec.$.structSpec && mojo.internal.bindings.record_replay.mojom.RecordReplayDriver_OnClick_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.record_replay.mojom.RecordReplayDriver_OnClick_ParamsSpec.$ = {};
mojo.internal.bindings.record_replay.mojom.RecordReplayDriver_OnSelectChanged_ParamsSpec = mojo.internal.bindings.record_replay.mojom.RecordReplayDriver_OnSelectChanged_ParamsSpec || { $: {} };
if (mojo.internal.bindings.record_replay.mojom.RecordReplayDriver_OnSelectChanged_ParamsSpec.$.structSpec && mojo.internal.bindings.record_replay.mojom.RecordReplayDriver_OnSelectChanged_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.record_replay.mojom.RecordReplayDriver_OnSelectChanged_ParamsSpec.$ = {};
mojo.internal.bindings.record_replay.mojom.RecordReplayDriver_OnTextChange_ParamsSpec = mojo.internal.bindings.record_replay.mojom.RecordReplayDriver_OnTextChange_ParamsSpec || { $: {} };
if (mojo.internal.bindings.record_replay.mojom.RecordReplayDriver_OnTextChange_ParamsSpec.$.structSpec && mojo.internal.bindings.record_replay.mojom.RecordReplayDriver_OnTextChange_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.record_replay.mojom.RecordReplayDriver_OnTextChange_ParamsSpec.$ = {};

// Interface: RecordReplayAgent
mojo.internal.bindings.record_replay.mojom.RecordReplayAgentPendingReceiver = class {
  constructor(handle) {
    this.handle = handle;
    if (handle) {
...
mojo.internal.bindings.record_replay.mojom.RecordReplayAgentRemote = class {
  static get $interfaceName() {
    return 'record_replay.mojom.RecordReplayAgent';
  }

  constructor(handle = undefined) {
    this.__mojoHandle = handle;
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.record_replay.mojom.RecordReplayAgentPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.record_replay.mojom.RecordReplayAgentRemoteCallHandler(this.proxy);
  }
  ...
  getElementSelector(arg_dom_node_id) {
    return this.$.getElementSelector(arg_dom_node_id);
  }
  getMatchingElements(arg_element_selector) {
    return this.$.getMatchingElements(arg_element_selector);
  }
  doClick(arg_dom_node_id) {
    return this.$.doClick(arg_dom_node_id);
  }
  doPaste(arg_dom_node_id, arg_text) {
    return this.$.doPaste(arg_dom_node_id, arg_text);
  }
  doSelect(arg_dom_node_id, arg_value) {
    return this.$.doSelect(arg_dom_node_id, arg_value);
  }
  getValuesOfMatchingElements(arg_element_selector) {
    return this.$.getValuesOfMatchingElements(arg_element_selector);
  }
};

mojo.internal.bindings.record_replay.mojom.RecordReplayAgentRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('record_replay.mojom.RecordReplayAgent', [
      { explicit: null },
      { explicit: null },
      { explicit: null },
      { explicit: null },
  ...
  startRecording() {
    return this.proxy.sendMessage(
      ...
      mojo.internal.bindings.record_replay.mojom.RecordReplayAgent_StartRecording_ParamsSpec,
      null,
      [],
      false);
  }
  ...
  stopRecording() {
    return this.proxy.sendMessage(
      ...
      mojo.internal.bindings.record_replay.mojom.RecordReplayAgent_StopRecording_ParamsSpec,
      null,
      [],
      false);
  }
  ...
  getElementSelector(arg_dom_node_id) {
    return this.proxy.sendMessage(
      ...
      mojo.internal.bindings.record_replay.mojom.RecordReplayAgent_GetElementSelector_ParamsSpec,
      mojo.internal.bindings.record_replay.mojom.RecordReplayAgent_GetElementSelector_ResponseParamsSpec,
      [arg_dom_node_id],
      false);
  }
  ...
  getMatchingElements(arg_element_selector) {
    return this.proxy.sendMessage(
      ...
      mojo.internal.bindings.record_replay.mojom.RecordReplayAgent_GetMatchingElements_ParamsSpec,
      mojo.internal.bindings.record_replay.mojom.RecordReplayAgent_GetMatchingElements_ResponseParamsSpec,
      [arg_element_selector],
      false);
  }
  ...
  doClick(arg_dom_node_id) {
    return this.proxy.sendMessage(
      ...
      mojo.internal.bindings.record_replay.mojom.RecordReplayAgent_DoClick_ParamsSpec,
      mojo.internal.bindings.record_replay.mojom.RecordReplayAgent_DoClick_ResponseParamsSpec,
      [arg_dom_node_id],
      false);
  }
  ...
  doPaste(arg_dom_node_id, arg_text) {
    return this.proxy.sendMessage(
      ...
      mojo.internal.bindings.record_replay.mojom.RecordReplayAgent_DoPaste_ParamsSpec,
      mojo.internal.bindings.record_replay.mojom.RecordReplayAgent_DoPaste_ResponseParamsSpec,
  ...
  doSelect(arg_dom_node_id, arg_value) {
    return this.proxy.sendMessage(
      ...
      mojo.internal.bindings.record_replay.mojom.RecordReplayAgent_DoSelect_ParamsSpec,
      mojo.internal.bindings.record_replay.mojom.RecordReplayAgent_DoSelect_ResponseParamsSpec,
  ...
  getValuesOfMatchingElements(arg_element_selector) {
    return this.proxy.sendMessage(
      ...
      mojo.internal.bindings.record_replay.mojom.RecordReplayAgent_GetValuesOfMatchingElements_ParamsSpec,
      mojo.internal.bindings.record_replay.mojom.RecordReplayAgent_GetValuesOfMatchingElements_ResponseParamsSpec,
      [arg_element_selector],
      false);
  }
...
mojo.internal.bindings.record_replay.mojom.RecordReplayAgent.getRemote = function() {
  let remote = new mojo.internal.bindings.record_replay.mojom.RecordReplayAgentRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
    'record_replay.mojom.RecordReplayAgent',
    'context');
  return remote.$;
};

mojo.internal.bindings.record_replay.mojom.RecordReplayAgentReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('record_replay.mojom.RecordReplayAgent', [
      { explicit: null },
      { explicit: null },
      { explicit: null },
      { explicit: null },
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        case 0: {
          ...
          const params = decoder.decodeStructInline(mojo.internal.bindings.record_replay.mojom.RecordReplayAgent_StartRecording_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.startRecording');
          const result = this.impl.startRecording();
          break;
        }
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.record_replay.mojom.RecordReplayAgent_StopRecording_ParamsSpec.$.structSpec);
        ...
        case 2: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.record_replay.mojom.RecordReplayAgent_GetElementSelector_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.getElementSelector');
          const result = this.impl.getElementSelector(params.arg_dom_node_id);
          const expectsResponse = header.expectsResponse || (header.flags & 1);
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              const val = (response && typeof response === 'object' && 'arg_element_selector' in response) ? response['arg_element_selector'] : response;
              const resp_obj = { 'arg_element_selector': val };
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.record_replay.mojom.RecordReplayAgent_GetElementSelector_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
            }).catch(e => console.error('[GeneratedReceiver] getElementSelector FAILED:', e));
          }
          break;
        }
        case 3: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.record_replay.mojom.RecordReplayAgent_GetMatchingElements_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.getMatchingElements');
          const result = this.impl.getMatchingElements(params.arg_element_selector);
          const expectsResponse = header.expectsResponse || (header.flags & 1);
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              const val = (response && typeof response === 'object' && 'arg_elements' in response) ? response['arg_elements'] : response;
              const resp_obj = { 'arg_elements': val };
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.record_replay.mojom.RecordReplayAgent_GetMatchingElements_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
            }).catch(e => console.error('[GeneratedReceiver] getMatchingElements FAILED:', e));
          }
          break;
        }
        case 4: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.record_replay.mojom.RecordReplayAgent_DoClick_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.doClick');
          const result = this.impl.doClick(params.arg_dom_node_id);
          const expectsResponse = header.expectsResponse || (header.flags & 1);
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.record_replay.mojom.RecordReplayAgent_DoClick_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
            }).catch(e => console.error('[GeneratedReceiver] doClick FAILED:', e));
          }
          break;
        }
        case 5: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.record_replay.mojom.RecordReplayAgent_DoPaste_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.doPaste');
          const result = this.impl.doPaste(params.arg_dom_node_id, params.arg_text);
          const expectsResponse = header.expectsResponse || (header.flags & 1);
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              const val = (response && typeof response === 'object' && 'arg_success' in response) ? response['arg_success'] : response;
              ...
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.record_replay.mojom.RecordReplayAgent_DoPaste_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
            }).catch(e => console.error('[GeneratedReceiver] doPaste FAILED:', e));
          }
          break;
        }
        case 6: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.record_replay.mojom.RecordReplayAgent_DoSelect_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.doSelect');
          const result = this.impl.doSelect(params.arg_dom_node_id, params.arg_value);
          const expectsResponse = header.expectsResponse || (header.flags & 1);
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              const val = (response && typeof response === 'object' && 'arg_success' in response) ? response['arg_success'] : response;
              ...
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.record_replay.mojom.RecordReplayAgent_DoSelect_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
            }).catch(e => console.error('[GeneratedReceiver] doSelect FAILED:', e));
          }
          break;
        }
        case 7: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.record_replay.mojom.RecordReplayAgent_GetValuesOfMatchingElements_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.getValuesOfMatchingElements');
          const result = this.impl.getValuesOfMatchingElements(params.arg_element_selector);
          const expectsResponse = header.expectsResponse || (header.flags & 1);
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              const val = (response && typeof response === 'object' && 'arg_values' in response) ? response['arg_values'] : response;
              const resp_obj = { 'arg_values': val };
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.record_replay.mojom.RecordReplayAgent_GetValuesOfMatchingElements_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
            }).catch(e => console.error('[GeneratedReceiver] getValuesOfMatchingElements FAILED:', e));
          }
          break;
        }
      }
...
mojo.internal.bindings.record_replay.mojom.RecordReplayAgentReceiver = mojo.internal.bindings.record_replay.mojom.RecordReplayAgentReceiver;

mojo.internal.bindings.record_replay.mojom.RecordReplayAgentPtr = mojo.internal.bindings.record_replay.mojom.RecordReplayAgentRemote;
mojo.internal.bindings.record_replay.mojom.RecordReplayAgentRequest = mojo.internal.bindings.record_replay.mojom.RecordReplayAgentPendingReceiver;


// Interface: RecordReplayDriver
mojo.internal.bindings.record_replay.mojom.RecordReplayDriverPendingReceiver = class {
  constructor(handle) {
    this.handle = handle;
    if (handle) {
      this.__mojoHandle = handle.router_ ? handle.router_.pipe_ : (handle.pipe_ || handle);
...
mojo.internal.bindings.record_replay.mojom.RecordReplayDriverRemote = class {
  static get $interfaceName() {
    return 'record_replay.mojom.RecordReplayDriver';
  }

  constructor(handle = undefined) {
    this.__mojoHandle = handle;
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.record_replay.mojom.RecordReplayDriverPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.record_replay.mojom.RecordReplayDriverRemoteCallHandler(this.proxy);
  }
  ...
  onClick(arg_dom_node_id, arg_element_selector) {
    return this.$.onClick(arg_dom_node_id, arg_element_selector);
  }
  onSelectChanged(arg_dom_node_id, arg_element_selector, arg_value) {
    return this.$.onSelectChanged(arg_dom_node_id, arg_element_selector, arg_value);
  }
  onTextChange(arg_dom_node_id, arg_element_selector, arg_text) {
    return this.$.onTextChange(arg_dom_node_id, arg_element_selector, arg_text);
  }
};

mojo.internal.bindings.record_replay.mojom.RecordReplayDriverRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('record_replay.mojom.RecordReplayDriver', [
      { explicit: null },
      { explicit: null },
      { explicit: null },
    ]);
  ...
  onClick(arg_dom_node_id, arg_element_selector) {
    return this.proxy.sendMessage(
      this.ordinals[0],  // ordinal
      mojo.internal.bindings.record_replay.mojom.RecordReplayDriver_OnClick_ParamsSpec,
      null,
      [arg_dom_node_id, arg_element_selector],
      false);
  }
  ...
  onSelectChanged(arg_dom_node_id, arg_element_selector, arg_value) {
    return this.proxy.sendMessage(
      this.ordinals[1],  // ordinal
      mojo.internal.bindings.record_replay.mojom.RecordReplayDriver_OnSelectChanged_ParamsSpec,
      null,
      [arg_dom_node_id, arg_element_selector, arg_value],
      false);
  }
  ...
  onTextChange(arg_dom_node_id, arg_element_selector, arg_text) {
    return this.proxy.sendMessage(
      this.ordinals[2],  // ordinal
      mojo.internal.bindings.record_replay.mojom.RecordReplayDriver_OnTextChange_ParamsSpec,
      null,
      [arg_dom_node_id, arg_element_selector, arg_text],
      false);
  }

};

mojo.internal.bindings.record_replay.mojom.RecordReplayDriver.getRemote = function() {
  let remote = new mojo.internal.bindings.record_replay.mojom.RecordReplayDriverRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
    'record_replay.mojom.RecordReplayDriver',
    'context');
  return remote.$;
};

mojo.internal.bindings.record_replay.mojom.RecordReplayDriverReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('record_replay.mojom.RecordReplayDriver', [
      { explicit: null },
      { explicit: null },
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.record_replay.mojom.RecordReplayDriver_OnClick_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.onClick');
          const result = this.impl.onClick(params.arg_dom_node_id, params.arg_element_selector);
          break;
        }
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.record_replay.mojom.RecordReplayDriver_OnSelectChanged_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.onSelectChanged');
          const result = this.impl.onSelectChanged(params.arg_dom_node_id, params.arg_element_selector, params.arg_value);
          break;
        }
        case 2: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.record_replay.mojom.RecordReplayDriver_OnTextChange_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.onTextChange');
          const result = this.impl.onTextChange(params.arg_dom_node_id, params.arg_element_selector, params.arg_text);
          break;
        }
      }
      } catch (err) {
...
mojo.internal.bindings.record_replay.mojom.RecordReplayDriverReceiver = mojo.internal.bindings.record_replay.mojom.RecordReplayDriverReceiver;

mojo.internal.bindings.record_replay.mojom.RecordReplayDriverPtr = mojo.internal.bindings.record_replay.mojom.RecordReplayDriverRemote;
mojo.internal.bindings.record_replay.mojom.RecordReplayDriverRequest = mojo.internal.bindings.record_replay.mojom.RecordReplayDriverPendingReceiver;
...
mojo.internal.Struct(
    mojo.internal.bindings.record_replay.mojom.DomNodeIdSpec, 'record_replay.mojom.DomNodeId', [
...
// Struct: Selector
mojo.internal.Struct(
    mojo.internal.bindings.record_replay.mojom.SelectorSpec, 'record_replay.mojom.Selector', [
...
// Struct: FieldValue
mojo.internal.Struct(
    mojo.internal.bindings.record_replay.mojom.FieldValueSpec, 'record_replay.mojom.FieldValue', [
      mojo.internal.StructField('arg_value', 0, 0, mojo.internal.String, null, false, 0, undefined),
    ],
    [[0, 16]]);
mojo.internal.Struct(
    mojo.internal.bindings.record_replay.mojom.RecordReplayAgent_StartRecording_ParamsSpec, 'record_replay.mojom.RecordReplayAgent_StartRecording_Params', [
    ],
    [[0, 8]]);

mojo.internal.Struct(
    mojo.internal.bindings.record_replay.mojom.RecordReplayAgent_StopRecording_ParamsSpec, 'record_replay.mojom.RecordReplayAgent_StopRecording_Params', [
    ],
    [[0, 8]]);

mojo.internal.Struct(
    mojo.internal.bindings.record_replay.mojom.RecordReplayAgent_GetElementSelector_ParamsSpec, 'record_replay.mojom.RecordReplayAgent_GetElementSelector_Params', [
      mojo.internal.StructField('arg_dom_node_id', 0, 0, mojo.internal.bindings.record_replay.mojom.DomNodeIdSpec, null, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.record_replay.mojom.RecordReplayAgent_GetElementSelector_ResponseParamsSpec, 'record_replay.mojom.RecordReplayAgent_GetElementSelector_ResponseParams', [
      mojo.internal.StructField('arg_element_selector', 0, 0, mojo.internal.bindings.record_replay.mojom.SelectorSpec, null, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.record_replay.mojom.RecordReplayAgent_GetMatchingElements_ParamsSpec, 'record_replay.mojom.RecordReplayAgent_GetMatchingElements_Params', [
      mojo.internal.StructField('arg_element_selector', 0, 0, mojo.internal.bindings.record_replay.mojom.SelectorSpec, null, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.record_replay.mojom.RecordReplayAgent_GetMatchingElements_ResponseParamsSpec, 'record_replay.mojom.RecordReplayAgent_GetMatchingElements_ResponseParams', [
      mojo.internal.StructField('arg_elements', 0, 0, mojo.internal.Array(mojo.internal.bindings.record_replay.mojom.DomNodeIdSpec, false), null, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.record_replay.mojom.RecordReplayAgent_DoClick_ParamsSpec, 'record_replay.mojom.RecordReplayAgent_DoClick_Params', [
      mojo.internal.StructField('arg_dom_node_id', 0, 0, mojo.internal.bindings.record_replay.mojom.DomNodeIdSpec, null, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.record_replay.mojom.RecordReplayAgent_DoClick_ResponseParamsSpec, 'record_replay.mojom.RecordReplayAgent_DoClick_ResponseParams', [
      mojo.internal.StructField('arg_success', 0, 0, mojo.internal.Bool, false, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.record_replay.mojom.RecordReplayAgent_DoPaste_ParamsSpec, 'record_replay.mojom.RecordReplayAgent_DoPaste_Params', [
      mojo.internal.StructField('arg_dom_node_id', 0, 0, mojo.internal.bindings.record_replay.mojom.DomNodeIdSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_text', 8, 0, mojo.internal.bindings.record_replay.mojom.FieldValueSpec, null, false, 0, undefined),
    ],
    [[0, 24]]);

mojo.internal.Struct(
    mojo.internal.bindings.record_replay.mojom.RecordReplayAgent_DoPaste_ResponseParamsSpec, 'record_replay.mojom.RecordReplayAgent_DoPaste_ResponseParams', [
      mojo.internal.StructField('arg_success', 0, 0, mojo.internal.Bool, false, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.record_replay.mojom.RecordReplayAgent_DoSelect_ParamsSpec, 'record_replay.mojom.RecordReplayAgent_DoSelect_Params', [
      mojo.internal.StructField('arg_dom_node_id', 0, 0, mojo.internal.bindings.record_replay.mojom.DomNodeIdSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_value', 8, 0, mojo.internal.bindings.record_replay.mojom.FieldValueSpec, null, false, 0, undefined),
    ],
    [[0, 24]]);

mojo.internal.Struct(
    mojo.internal.bindings.record_replay.mojom.RecordReplayAgent_DoSelect_ResponseParamsSpec, 'record_replay.mojom.RecordReplayAgent_DoSelect_ResponseParams', [
      mojo.internal.StructField('arg_success', 0, 0, mojo.internal.Bool, false, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.record_replay.mojom.RecordReplayAgent_GetValuesOfMatchingElements_ParamsSpec, 'record_replay.mojom.RecordReplayAgent_GetValuesOfMatchingElements_Params', [
      mojo.internal.StructField('arg_element_selector', 0, 0, mojo.internal.bindings.record_replay.mojom.SelectorSpec, null, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.record_replay.mojom.RecordReplayAgent_GetValuesOfMatchingElements_ResponseParamsSpec, 'record_replay.mojom.RecordReplayAgent_GetValuesOfMatchingElements_ResponseParams', [
      mojo.internal.StructField('arg_values', 0, 0, mojo.internal.Array(mojo.internal.bindings.record_replay.mojom.FieldValueSpec, false), null, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.record_replay.mojom.RecordReplayDriver_OnClick_ParamsSpec, 'record_replay.mojom.RecordReplayDriver_OnClick_Params', [
      mojo.internal.StructField('arg_dom_node_id', 0, 0, mojo.internal.bindings.record_replay.mojom.DomNodeIdSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_element_selector', 8, 0, mojo.internal.bindings.record_replay.mojom.SelectorSpec, null, false, 0, undefined),
    ],
    [[0, 24]]);

mojo.internal.Struct(
    mojo.internal.bindings.record_replay.mojom.RecordReplayDriver_OnSelectChanged_ParamsSpec, 'record_replay.mojom.RecordReplayDriver_OnSelectChanged_Params', [
      mojo.internal.StructField('arg_dom_node_id', 0, 0, mojo.internal.bindings.record_replay.mojom.DomNodeIdSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_element_selector', 8, 0, mojo.internal.bindings.record_replay.mojom.SelectorSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_value', 16, 0, mojo.internal.bindings.record_replay.mojom.FieldValueSpec, null, false, 0, undefined),
    ],
    [[0, 32]]);

mojo.internal.Struct(
    mojo.internal.bindings.record_replay.mojom.RecordReplayDriver_OnTextChange_ParamsSpec, 'record_replay.mojom.RecordReplayDriver_OnTextChange_Params', [
      mojo.internal.StructField('arg_dom_node_id', 0, 0, mojo.internal.bindings.record_replay.mojom.DomNodeIdSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_element_selector', 8, 0, mojo.internal.bindings.record_replay.mojom.SelectorSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_text', 16, 0, mojo.internal.bindings.record_replay.mojom.FieldValueSpec, null, false, 0, undefined),
    ],
    [[0, 32]]);
