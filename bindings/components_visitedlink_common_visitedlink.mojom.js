    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      switch (dispatchId) {
        case 0: {
          ...
          const params = decoder.decodeStruct(visitedlink.mojom.VisitedLinkNotificationSink_UpdateVisitedLinks_ParamsSpec.$, 0);
        ...
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStruct(visitedlink.mojom.VisitedLinkNotificationSink_AddVisitedLinks_ParamsSpec.$, 0);
        ...
        case 2: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStruct(visitedlink.mojom.VisitedLinkNotificationSink_ResetVisitedLinks_ParamsSpec.$, 0);
        ...
        case 3: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStruct(visitedlink.mojom.VisitedLinkNotificationSink_UpdateOriginSalts_ParamsSpec.$, 0);
