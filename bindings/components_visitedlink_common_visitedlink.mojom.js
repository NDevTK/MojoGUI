// Auto-generated MojoJS binding
 ...
 mojo.internal.bindings.visitedlink = mojo.internal.bindings.visitedlink || {};
mojo.internal.bindings.visitedlink.mojom = mojo.internal.bindings.visitedlink.mojom || {};
...
mojo.internal.bindings.visitedlink.mojom.VisitedLinkNotificationSinkRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.visitedlink.mojom.VisitedLinkNotificationSinkPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.visitedlink.mojom.VisitedLinkNotificationSinkRemoteCallHandler(this.proxy);
  }
  ...
  updateVisitedLinks(arg_table_region) {
    return this.$.updateVisitedLinks(arg_table_region);
  }
  addVisitedLinks(arg_link_hashes) {
    return this.$.addVisitedLinks(arg_link_hashes);
  }
  resetVisitedLinks(arg_invalidate_cached_hashes) {
    return this.$.resetVisitedLinks(arg_invalidate_cached_hashes);
  }
  updateOriginSalts(arg_origin_salts) {
    return this.$.updateOriginSalts(arg_origin_salts);
  }
};
...
mojo.internal.bindings.visitedlink.mojom.VisitedLinkNotificationSink.getRemote = function() {
  let remote = new mojo.internal.bindings.visitedlink.mojom.VisitedLinkNotificationSinkRemote();
...
mojo.internal.bindings.visitedlink.mojom.VisitedLinkNotificationSinkReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.visitedlink.mojom.VisitedLinkNotificationSink_UpdateVisitedLinks_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for UpdateVisitedLinks failed with TypeError');
           }
        }
        // Try Method 1: AddVisitedLinks
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.visitedlink.mojom.VisitedLinkNotificationSink_AddVisitedLinks_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for AddVisitedLinks failed with TypeError');
           }
        }
        // Try Method 2: ResetVisitedLinks
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.visitedlink.mojom.VisitedLinkNotificationSink_ResetVisitedLinks_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for ResetVisitedLinks failed with TypeError');
           }
        }
        // Try Method 3: UpdateOriginSalts
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.visitedlink.mojom.VisitedLinkNotificationSink_UpdateOriginSalts_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for UpdateOriginSalts failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.visitedlink.mojom.VisitedLinkNotificationSinkReceiver = mojo.internal.bindings.visitedlink.mojom.VisitedLinkNotificationSinkReceiver;
