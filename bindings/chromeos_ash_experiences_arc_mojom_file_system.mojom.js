...
mojo.internal.bindings.arc.mojom.ChangeTypeSpec = mojo.internal.bindings.arc.mojom.ChangeTypeSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.arc.mojom.SelectFilesActionTypeSpec = mojo.internal.bindings.arc.mojom.SelectFilesActionTypeSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.arc.mojom.FileSelectorEventTypeSpec = mojo.internal.bindings.arc.mojom.FileSelectorEventTypeSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.arc.mojom.MediaStoreMetadataSpec = mojo.internal.bindings.arc.mojom.MediaStoreMetadataSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.MediaStoreMetadataSpec.$.structSpec && mojo.internal.bindings.arc.mojom.MediaStoreMetadataSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.MediaStoreMetadataSpec.$ = {};
mojo.internal.bindings.arc.mojom.DocumentSpec = mojo.internal.bindings.arc.mojom.DocumentSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.DocumentSpec.$.structSpec && mojo.internal.bindings.arc.mojom.DocumentSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.DocumentSpec.$ = {};
mojo.internal.bindings.arc.mojom.RootSpec = mojo.internal.bindings.arc.mojom.RootSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.RootSpec.$.structSpec && mojo.internal.bindings.arc.mojom.RootSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.RootSpec.$ = {};
mojo.internal.bindings.arc.mojom.ContentUrlWithMimeTypeSpec = mojo.internal.bindings.arc.mojom.ContentUrlWithMimeTypeSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.ContentUrlWithMimeTypeSpec.$.structSpec && mojo.internal.bindings.arc.mojom.ContentUrlWithMimeTypeSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.ContentUrlWithMimeTypeSpec.$ = {};
mojo.internal.bindings.arc.mojom.OpenUrlsRequestSpec = mojo.internal.bindings.arc.mojom.OpenUrlsRequestSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.OpenUrlsRequestSpec.$.structSpec && mojo.internal.bindings.arc.mojom.OpenUrlsRequestSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.OpenUrlsRequestSpec.$ = {};
mojo.internal.bindings.arc.mojom.SelectFilesRequestSpec = mojo.internal.bindings.arc.mojom.SelectFilesRequestSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.SelectFilesRequestSpec.$.structSpec && mojo.internal.bindings.arc.mojom.SelectFilesRequestSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.SelectFilesRequestSpec.$ = {};
mojo.internal.bindings.arc.mojom.DocumentPathSpec = mojo.internal.bindings.arc.mojom.DocumentPathSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.DocumentPathSpec.$.structSpec && mojo.internal.bindings.arc.mojom.DocumentPathSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.DocumentPathSpec.$ = {};
mojo.internal.bindings.arc.mojom.SelectFilesResultSpec = mojo.internal.bindings.arc.mojom.SelectFilesResultSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.SelectFilesResultSpec.$.structSpec && mojo.internal.bindings.arc.mojom.SelectFilesResultSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.SelectFilesResultSpec.$ = {};
mojo.internal.bindings.arc.mojom.FileSelectorEventSpec = mojo.internal.bindings.arc.mojom.FileSelectorEventSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.FileSelectorEventSpec.$.structSpec && mojo.internal.bindings.arc.mojom.FileSelectorEventSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.FileSelectorEventSpec.$ = {};
mojo.internal.bindings.arc.mojom.GetFileSelectorElementsRequestSpec = mojo.internal.bindings.arc.mojom.GetFileSelectorElementsRequestSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.GetFileSelectorElementsRequestSpec.$.structSpec && mojo.internal.bindings.arc.mojom.GetFileSelectorElementsRequestSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.GetFileSelectorElementsRequestSpec.$ = {};
mojo.internal.bindings.arc.mojom.FileSelectorElementSpec = mojo.internal.bindings.arc.mojom.FileSelectorElementSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.FileSelectorElementSpec.$.structSpec && mojo.internal.bindings.arc.mojom.FileSelectorElementSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.FileSelectorElementSpec.$ = {};
mojo.internal.bindings.arc.mojom.FileSelectorElementsSpec = mojo.internal.bindings.arc.mojom.FileSelectorElementsSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.FileSelectorElementsSpec.$.structSpec && mojo.internal.bindings.arc.mojom.FileSelectorElementsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.FileSelectorElementsSpec.$ = {};
mojo.internal.bindings.arc.mojom.RootSizeSpec = mojo.internal.bindings.arc.mojom.RootSizeSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.RootSizeSpec.$.structSpec && mojo.internal.bindings.arc.mojom.RootSizeSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.RootSizeSpec.$ = {};
mojo.internal.bindings.arc.mojom.FileSessionSpec = mojo.internal.bindings.arc.mojom.FileSessionSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.FileSessionSpec.$.structSpec && mojo.internal.bindings.arc.mojom.FileSessionSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.FileSessionSpec.$ = {};
mojo.internal.bindings.arc.mojom.MediaStoreDownloadMetadataSpec = mojo.internal.bindings.arc.mojom.MediaStoreDownloadMetadataSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.MediaStoreDownloadMetadataSpec.$.structSpec && mojo.internal.bindings.arc.mojom.MediaStoreDownloadMetadataSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.MediaStoreDownloadMetadataSpec.$ = {};
mojo.internal.bindings.arc.mojom.FileSystemHost = mojo.internal.bindings.arc.mojom.FileSystemHost || {};
mojo.internal.bindings.arc.mojom.FileSystemHostSpec = mojo.internal.bindings.arc.mojom.FileSystemHostSpec || { $ : {} };
if (mojo.internal.bindings.arc.mojom.FileSystemHostSpec.$.structSpec && mojo.internal.bindings.arc.mojom.FileSystemHostSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.FileSystemHostSpec.$ = {};
mojo.internal.bindings.arc.mojom.FileSystemHost.$interfaceName = 'arc.mojom.FileSystemHost';
mojo.internal.bindings.arc.mojom.FileSystemHost_GetFileName_ParamsSpec = mojo.internal.bindings.arc.mojom.FileSystemHost_GetFileName_ParamsSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.FileSystemHost_GetFileName_ParamsSpec.$.structSpec && mojo.internal.bindings.arc.mojom.FileSystemHost_GetFileName_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.FileSystemHost_GetFileName_ParamsSpec.$ = {};
mojo.internal.bindings.arc.mojom.FileSystemHost_GetFileName_ResponseParamsSpec = mojo.internal.bindings.arc.mojom.FileSystemHost_GetFileName_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.FileSystemHost_GetFileName_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.arc.mojom.FileSystemHost_GetFileName_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.FileSystemHost_GetFileName_ResponseParamsSpec.$ = {};
mojo.internal.bindings.arc.mojom.FileSystemHost_GetFileSize_ParamsSpec = mojo.internal.bindings.arc.mojom.FileSystemHost_GetFileSize_ParamsSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.FileSystemHost_GetFileSize_ParamsSpec.$.structSpec && mojo.internal.bindings.arc.mojom.FileSystemHost_GetFileSize_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.FileSystemHost_GetFileSize_ParamsSpec.$ = {};
mojo.internal.bindings.arc.mojom.FileSystemHost_GetFileSize_ResponseParamsSpec = mojo.internal.bindings.arc.mojom.FileSystemHost_GetFileSize_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.FileSystemHost_GetFileSize_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.arc.mojom.FileSystemHost_GetFileSize_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.FileSystemHost_GetFileSize_ResponseParamsSpec.$ = {};
mojo.internal.bindings.arc.mojom.FileSystemHost_GetLastModified_ParamsSpec = mojo.internal.bindings.arc.mojom.FileSystemHost_GetLastModified_ParamsSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.FileSystemHost_GetLastModified_ParamsSpec.$.structSpec && mojo.internal.bindings.arc.mojom.FileSystemHost_GetLastModified_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.FileSystemHost_GetLastModified_ParamsSpec.$ = {};
mojo.internal.bindings.arc.mojom.FileSystemHost_GetLastModified_ResponseParamsSpec = mojo.internal.bindings.arc.mojom.FileSystemHost_GetLastModified_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.FileSystemHost_GetLastModified_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.arc.mojom.FileSystemHost_GetLastModified_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.FileSystemHost_GetLastModified_ResponseParamsSpec.$ = {};
mojo.internal.bindings.arc.mojom.FileSystemHost_GetFileType_ParamsSpec = mojo.internal.bindings.arc.mojom.FileSystemHost_GetFileType_ParamsSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.FileSystemHost_GetFileType_ParamsSpec.$.structSpec && mojo.internal.bindings.arc.mojom.FileSystemHost_GetFileType_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.FileSystemHost_GetFileType_ParamsSpec.$ = {};
mojo.internal.bindings.arc.mojom.FileSystemHost_GetFileType_ResponseParamsSpec = mojo.internal.bindings.arc.mojom.FileSystemHost_GetFileType_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.FileSystemHost_GetFileType_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.arc.mojom.FileSystemHost_GetFileType_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.FileSystemHost_GetFileType_ResponseParamsSpec.$ = {};
mojo.internal.bindings.arc.mojom.FileSystemHost_OnDocumentChanged_ParamsSpec = mojo.internal.bindings.arc.mojom.FileSystemHost_OnDocumentChanged_ParamsSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.FileSystemHost_OnDocumentChanged_ParamsSpec.$.structSpec && mojo.internal.bindings.arc.mojom.FileSystemHost_OnDocumentChanged_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.FileSystemHost_OnDocumentChanged_ParamsSpec.$ = {};
mojo.internal.bindings.arc.mojom.FileSystemHost_OnRootsChanged_ParamsSpec = mojo.internal.bindings.arc.mojom.FileSystemHost_OnRootsChanged_ParamsSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.FileSystemHost_OnRootsChanged_ParamsSpec.$.structSpec && mojo.internal.bindings.arc.mojom.FileSystemHost_OnRootsChanged_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.FileSystemHost_OnRootsChanged_ParamsSpec.$ = {};
mojo.internal.bindings.arc.mojom.FileSystemHost_GetVirtualFileId_ParamsSpec = mojo.internal.bindings.arc.mojom.FileSystemHost_GetVirtualFileId_ParamsSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.FileSystemHost_GetVirtualFileId_ParamsSpec.$.structSpec && mojo.internal.bindings.arc.mojom.FileSystemHost_GetVirtualFileId_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.FileSystemHost_GetVirtualFileId_ParamsSpec.$ = {};
mojo.internal.bindings.arc.mojom.FileSystemHost_GetVirtualFileId_ResponseParamsSpec = mojo.internal.bindings.arc.mojom.FileSystemHost_GetVirtualFileId_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.FileSystemHost_GetVirtualFileId_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.arc.mojom.FileSystemHost_GetVirtualFileId_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.FileSystemHost_GetVirtualFileId_ResponseParamsSpec.$ = {};
mojo.internal.bindings.arc.mojom.FileSystemHost_HandleIdReleased_ParamsSpec = mojo.internal.bindings.arc.mojom.FileSystemHost_HandleIdReleased_ParamsSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.FileSystemHost_HandleIdReleased_ParamsSpec.$.structSpec && mojo.internal.bindings.arc.mojom.FileSystemHost_HandleIdReleased_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.FileSystemHost_HandleIdReleased_ParamsSpec.$ = {};
mojo.internal.bindings.arc.mojom.FileSystemHost_HandleIdReleased_ResponseParamsSpec = mojo.internal.bindings.arc.mojom.FileSystemHost_HandleIdReleased_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.FileSystemHost_HandleIdReleased_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.arc.mojom.FileSystemHost_HandleIdReleased_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.FileSystemHost_HandleIdReleased_ResponseParamsSpec.$ = {};
mojo.internal.bindings.arc.mojom.FileSystemHost_OpenFileToRead_ParamsSpec = mojo.internal.bindings.arc.mojom.FileSystemHost_OpenFileToRead_ParamsSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.FileSystemHost_OpenFileToRead_ParamsSpec.$.structSpec && mojo.internal.bindings.arc.mojom.FileSystemHost_OpenFileToRead_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.FileSystemHost_OpenFileToRead_ParamsSpec.$ = {};
mojo.internal.bindings.arc.mojom.FileSystemHost_OpenFileToRead_ResponseParamsSpec = mojo.internal.bindings.arc.mojom.FileSystemHost_OpenFileToRead_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.FileSystemHost_OpenFileToRead_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.arc.mojom.FileSystemHost_OpenFileToRead_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.FileSystemHost_OpenFileToRead_ResponseParamsSpec.$ = {};
mojo.internal.bindings.arc.mojom.FileSystemHost_SelectFiles_ParamsSpec = mojo.internal.bindings.arc.mojom.FileSystemHost_SelectFiles_ParamsSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.FileSystemHost_SelectFiles_ParamsSpec.$.structSpec && mojo.internal.bindings.arc.mojom.FileSystemHost_SelectFiles_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.FileSystemHost_SelectFiles_ParamsSpec.$ = {};
mojo.internal.bindings.arc.mojom.FileSystemHost_SelectFiles_ResponseParamsSpec = mojo.internal.bindings.arc.mojom.FileSystemHost_SelectFiles_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.FileSystemHost_SelectFiles_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.arc.mojom.FileSystemHost_SelectFiles_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.FileSystemHost_SelectFiles_ResponseParamsSpec.$ = {};
mojo.internal.bindings.arc.mojom.FileSystemHost_OnFileSelectorEvent_ParamsSpec = mojo.internal.bindings.arc.mojom.FileSystemHost_OnFileSelectorEvent_ParamsSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.FileSystemHost_OnFileSelectorEvent_ParamsSpec.$.structSpec && mojo.internal.bindings.arc.mojom.FileSystemHost_OnFileSelectorEvent_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.FileSystemHost_OnFileSelectorEvent_ParamsSpec.$ = {};
mojo.internal.bindings.arc.mojom.FileSystemHost_OnFileSelectorEvent_ResponseParamsSpec = mojo.internal.bindings.arc.mojom.FileSystemHost_OnFileSelectorEvent_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.FileSystemHost_OnFileSelectorEvent_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.arc.mojom.FileSystemHost_OnFileSelectorEvent_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.FileSystemHost_OnFileSelectorEvent_ResponseParamsSpec.$ = {};
mojo.internal.bindings.arc.mojom.FileSystemHost_GetFileSelectorElements_ParamsSpec = mojo.internal.bindings.arc.mojom.FileSystemHost_GetFileSelectorElements_ParamsSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.FileSystemHost_GetFileSelectorElements_ParamsSpec.$.structSpec && mojo.internal.bindings.arc.mojom.FileSystemHost_GetFileSelectorElements_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.FileSystemHost_GetFileSelectorElements_ParamsSpec.$ = {};
mojo.internal.bindings.arc.mojom.FileSystemHost_GetFileSelectorElements_ResponseParamsSpec = mojo.internal.bindings.arc.mojom.FileSystemHost_GetFileSelectorElements_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.FileSystemHost_GetFileSelectorElements_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.arc.mojom.FileSystemHost_GetFileSelectorElements_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.FileSystemHost_GetFileSelectorElements_ResponseParamsSpec.$ = {};
mojo.internal.bindings.arc.mojom.FileSystemHost_OnMediaStoreUriAdded_ParamsSpec = mojo.internal.bindings.arc.mojom.FileSystemHost_OnMediaStoreUriAdded_ParamsSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.FileSystemHost_OnMediaStoreUriAdded_ParamsSpec.$.structSpec && mojo.internal.bindings.arc.mojom.FileSystemHost_OnMediaStoreUriAdded_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.FileSystemHost_OnMediaStoreUriAdded_ParamsSpec.$ = {};
mojo.internal.bindings.arc.mojom.FileSystemHost_CreateMoniker_ParamsSpec = mojo.internal.bindings.arc.mojom.FileSystemHost_CreateMoniker_ParamsSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.FileSystemHost_CreateMoniker_ParamsSpec.$.structSpec && mojo.internal.bindings.arc.mojom.FileSystemHost_CreateMoniker_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.FileSystemHost_CreateMoniker_ParamsSpec.$ = {};
mojo.internal.bindings.arc.mojom.FileSystemHost_CreateMoniker_ResponseParamsSpec = mojo.internal.bindings.arc.mojom.FileSystemHost_CreateMoniker_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.FileSystemHost_CreateMoniker_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.arc.mojom.FileSystemHost_CreateMoniker_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.FileSystemHost_CreateMoniker_ResponseParamsSpec.$ = {};
mojo.internal.bindings.arc.mojom.FileSystemHost_DestroyMoniker_ParamsSpec = mojo.internal.bindings.arc.mojom.FileSystemHost_DestroyMoniker_ParamsSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.FileSystemHost_DestroyMoniker_ParamsSpec.$.structSpec && mojo.internal.bindings.arc.mojom.FileSystemHost_DestroyMoniker_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.FileSystemHost_DestroyMoniker_ParamsSpec.$ = {};
mojo.internal.bindings.arc.mojom.FileSystemHost_DestroyMoniker_ResponseParamsSpec = mojo.internal.bindings.arc.mojom.FileSystemHost_DestroyMoniker_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.FileSystemHost_DestroyMoniker_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.arc.mojom.FileSystemHost_DestroyMoniker_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.FileSystemHost_DestroyMoniker_ResponseParamsSpec.$ = {};
mojo.internal.bindings.arc.mojom.FileSystemInstance = mojo.internal.bindings.arc.mojom.FileSystemInstance || {};
mojo.internal.bindings.arc.mojom.FileSystemInstanceSpec = mojo.internal.bindings.arc.mojom.FileSystemInstanceSpec || { $ : {} };
if (mojo.internal.bindings.arc.mojom.FileSystemInstanceSpec.$.structSpec && mojo.internal.bindings.arc.mojom.FileSystemInstanceSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.FileSystemInstanceSpec.$ = {};
mojo.internal.bindings.arc.mojom.FileSystemInstance.$interfaceName = 'arc.mojom.FileSystemInstance';
mojo.internal.bindings.arc.mojom.FileSystemInstance_AddWatcher_ParamsSpec = mojo.internal.bindings.arc.mojom.FileSystemInstance_AddWatcher_ParamsSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.FileSystemInstance_AddWatcher_ParamsSpec.$.structSpec && mojo.internal.bindings.arc.mojom.FileSystemInstance_AddWatcher_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.FileSystemInstance_AddWatcher_ParamsSpec.$ = {};
mojo.internal.bindings.arc.mojom.FileSystemInstance_AddWatcher_ResponseParamsSpec = mojo.internal.bindings.arc.mojom.FileSystemInstance_AddWatcher_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.FileSystemInstance_AddWatcher_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.arc.mojom.FileSystemInstance_AddWatcher_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.FileSystemInstance_AddWatcher_ResponseParamsSpec.$ = {};
mojo.internal.bindings.arc.mojom.FileSystemInstance_GetChildDocuments_ParamsSpec = mojo.internal.bindings.arc.mojom.FileSystemInstance_GetChildDocuments_ParamsSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.FileSystemInstance_GetChildDocuments_ParamsSpec.$.structSpec && mojo.internal.bindings.arc.mojom.FileSystemInstance_GetChildDocuments_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.FileSystemInstance_GetChildDocuments_ParamsSpec.$ = {};
mojo.internal.bindings.arc.mojom.FileSystemInstance_GetChildDocuments_ResponseParamsSpec = mojo.internal.bindings.arc.mojom.FileSystemInstance_GetChildDocuments_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.FileSystemInstance_GetChildDocuments_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.arc.mojom.FileSystemInstance_GetChildDocuments_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.FileSystemInstance_GetChildDocuments_ResponseParamsSpec.$ = {};
mojo.internal.bindings.arc.mojom.FileSystemInstance_GetDocument_ParamsSpec = mojo.internal.bindings.arc.mojom.FileSystemInstance_GetDocument_ParamsSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.FileSystemInstance_GetDocument_ParamsSpec.$.structSpec && mojo.internal.bindings.arc.mojom.FileSystemInstance_GetDocument_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.FileSystemInstance_GetDocument_ParamsSpec.$ = {};
mojo.internal.bindings.arc.mojom.FileSystemInstance_GetDocument_ResponseParamsSpec = mojo.internal.bindings.arc.mojom.FileSystemInstance_GetDocument_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.FileSystemInstance_GetDocument_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.arc.mojom.FileSystemInstance_GetDocument_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.FileSystemInstance_GetDocument_ResponseParamsSpec.$ = {};
mojo.internal.bindings.arc.mojom.FileSystemInstance_GetFileSize_ParamsSpec = mojo.internal.bindings.arc.mojom.FileSystemInstance_GetFileSize_ParamsSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.FileSystemInstance_GetFileSize_ParamsSpec.$.structSpec && mojo.internal.bindings.arc.mojom.FileSystemInstance_GetFileSize_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.FileSystemInstance_GetFileSize_ParamsSpec.$ = {};
mojo.internal.bindings.arc.mojom.FileSystemInstance_GetFileSize_ResponseParamsSpec = mojo.internal.bindings.arc.mojom.FileSystemInstance_GetFileSize_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.FileSystemInstance_GetFileSize_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.arc.mojom.FileSystemInstance_GetFileSize_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.FileSystemInstance_GetFileSize_ResponseParamsSpec.$ = {};
mojo.internal.bindings.arc.mojom.FileSystemInstance_GetMimeType_ParamsSpec = mojo.internal.bindings.arc.mojom.FileSystemInstance_GetMimeType_ParamsSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.FileSystemInstance_GetMimeType_ParamsSpec.$.structSpec && mojo.internal.bindings.arc.mojom.FileSystemInstance_GetMimeType_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.FileSystemInstance_GetMimeType_ParamsSpec.$ = {};
mojo.internal.bindings.arc.mojom.FileSystemInstance_GetMimeType_ResponseParamsSpec = mojo.internal.bindings.arc.mojom.FileSystemInstance_GetMimeType_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.FileSystemInstance_GetMimeType_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.arc.mojom.FileSystemInstance_GetMimeType_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.FileSystemInstance_GetMimeType_ResponseParamsSpec.$ = {};
mojo.internal.bindings.arc.mojom.FileSystemInstance_GetRecentDocuments_ParamsSpec = mojo.internal.bindings.arc.mojom.FileSystemInstance_GetRecentDocuments_ParamsSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.FileSystemInstance_GetRecentDocuments_ParamsSpec.$.structSpec && mojo.internal.bindings.arc.mojom.FileSystemInstance_GetRecentDocuments_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.FileSystemInstance_GetRecentDocuments_ParamsSpec.$ = {};
mojo.internal.bindings.arc.mojom.FileSystemInstance_GetRecentDocuments_ResponseParamsSpec = mojo.internal.bindings.arc.mojom.FileSystemInstance_GetRecentDocuments_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.FileSystemInstance_GetRecentDocuments_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.arc.mojom.FileSystemInstance_GetRecentDocuments_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.FileSystemInstance_GetRecentDocuments_ResponseParamsSpec.$ = {};
mojo.internal.bindings.arc.mojom.FileSystemInstance_GetRoots_ParamsSpec = mojo.internal.bindings.arc.mojom.FileSystemInstance_GetRoots_ParamsSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.FileSystemInstance_GetRoots_ParamsSpec.$.structSpec && mojo.internal.bindings.arc.mojom.FileSystemInstance_GetRoots_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.FileSystemInstance_GetRoots_ParamsSpec.$ = {};
mojo.internal.bindings.arc.mojom.FileSystemInstance_GetRoots_ResponseParamsSpec = mojo.internal.bindings.arc.mojom.FileSystemInstance_GetRoots_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.FileSystemInstance_GetRoots_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.arc.mojom.FileSystemInstance_GetRoots_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.FileSystemInstance_GetRoots_ResponseParamsSpec.$ = {};
mojo.internal.bindings.arc.mojom.FileSystemInstance_GetRootSize_ParamsSpec = mojo.internal.bindings.arc.mojom.FileSystemInstance_GetRootSize_ParamsSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.FileSystemInstance_GetRootSize_ParamsSpec.$.structSpec && mojo.internal.bindings.arc.mojom.FileSystemInstance_GetRootSize_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.FileSystemInstance_GetRootSize_ParamsSpec.$ = {};
mojo.internal.bindings.arc.mojom.FileSystemInstance_GetRootSize_ResponseParamsSpec = mojo.internal.bindings.arc.mojom.FileSystemInstance_GetRootSize_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.FileSystemInstance_GetRootSize_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.arc.mojom.FileSystemInstance_GetRootSize_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.FileSystemInstance_GetRootSize_ResponseParamsSpec.$ = {};
mojo.internal.bindings.arc.mojom.FileSystemInstance_DeleteDocument_ParamsSpec = mojo.internal.bindings.arc.mojom.FileSystemInstance_DeleteDocument_ParamsSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.FileSystemInstance_DeleteDocument_ParamsSpec.$.structSpec && mojo.internal.bindings.arc.mojom.FileSystemInstance_DeleteDocument_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.FileSystemInstance_DeleteDocument_ParamsSpec.$ = {};
mojo.internal.bindings.arc.mojom.FileSystemInstance_DeleteDocument_ResponseParamsSpec = mojo.internal.bindings.arc.mojom.FileSystemInstance_DeleteDocument_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.FileSystemInstance_DeleteDocument_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.arc.mojom.FileSystemInstance_DeleteDocument_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.FileSystemInstance_DeleteDocument_ResponseParamsSpec.$ = {};
mojo.internal.bindings.arc.mojom.FileSystemInstance_RenameDocument_ParamsSpec = mojo.internal.bindings.arc.mojom.FileSystemInstance_RenameDocument_ParamsSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.FileSystemInstance_RenameDocument_ParamsSpec.$.structSpec && mojo.internal.bindings.arc.mojom.FileSystemInstance_RenameDocument_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.FileSystemInstance_RenameDocument_ParamsSpec.$ = {};
mojo.internal.bindings.arc.mojom.FileSystemInstance_RenameDocument_ResponseParamsSpec = mojo.internal.bindings.arc.mojom.FileSystemInstance_RenameDocument_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.FileSystemInstance_RenameDocument_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.arc.mojom.FileSystemInstance_RenameDocument_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.FileSystemInstance_RenameDocument_ResponseParamsSpec.$ = {};
mojo.internal.bindings.arc.mojom.FileSystemInstance_CreateDocument_ParamsSpec = mojo.internal.bindings.arc.mojom.FileSystemInstance_CreateDocument_ParamsSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.FileSystemInstance_CreateDocument_ParamsSpec.$.structSpec && mojo.internal.bindings.arc.mojom.FileSystemInstance_CreateDocument_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.FileSystemInstance_CreateDocument_ParamsSpec.$ = {};
mojo.internal.bindings.arc.mojom.FileSystemInstance_CreateDocument_ResponseParamsSpec = mojo.internal.bindings.arc.mojom.FileSystemInstance_CreateDocument_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.FileSystemInstance_CreateDocument_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.arc.mojom.FileSystemInstance_CreateDocument_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.FileSystemInstance_CreateDocument_ResponseParamsSpec.$ = {};
mojo.internal.bindings.arc.mojom.FileSystemInstance_CopyDocument_ParamsSpec = mojo.internal.bindings.arc.mojom.FileSystemInstance_CopyDocument_ParamsSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.FileSystemInstance_CopyDocument_ParamsSpec.$.structSpec && mojo.internal.bindings.arc.mojom.FileSystemInstance_CopyDocument_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.FileSystemInstance_CopyDocument_ParamsSpec.$ = {};
mojo.internal.bindings.arc.mojom.FileSystemInstance_CopyDocument_ResponseParamsSpec = mojo.internal.bindings.arc.mojom.FileSystemInstance_CopyDocument_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.FileSystemInstance_CopyDocument_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.arc.mojom.FileSystemInstance_CopyDocument_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.FileSystemInstance_CopyDocument_ResponseParamsSpec.$ = {};
mojo.internal.bindings.arc.mojom.FileSystemInstance_MoveDocument_ParamsSpec = mojo.internal.bindings.arc.mojom.FileSystemInstance_MoveDocument_ParamsSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.FileSystemInstance_MoveDocument_ParamsSpec.$.structSpec && mojo.internal.bindings.arc.mojom.FileSystemInstance_MoveDocument_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.FileSystemInstance_MoveDocument_ParamsSpec.$ = {};
mojo.internal.bindings.arc.mojom.FileSystemInstance_MoveDocument_ResponseParamsSpec = mojo.internal.bindings.arc.mojom.FileSystemInstance_MoveDocument_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.FileSystemInstance_MoveDocument_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.arc.mojom.FileSystemInstance_MoveDocument_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.FileSystemInstance_MoveDocument_ResponseParamsSpec.$ = {};
mojo.internal.bindings.arc.mojom.FileSystemInstance_Init_ParamsSpec = mojo.internal.bindings.arc.mojom.FileSystemInstance_Init_ParamsSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.FileSystemInstance_Init_ParamsSpec.$.structSpec && mojo.internal.bindings.arc.mojom.FileSystemInstance_Init_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.FileSystemInstance_Init_ParamsSpec.$ = {};
mojo.internal.bindings.arc.mojom.FileSystemInstance_Init_ResponseParamsSpec = mojo.internal.bindings.arc.mojom.FileSystemInstance_Init_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.FileSystemInstance_Init_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.arc.mojom.FileSystemInstance_Init_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.FileSystemInstance_Init_ResponseParamsSpec.$ = {};
mojo.internal.bindings.arc.mojom.FileSystemInstance_OpenThumbnail_ParamsSpec = mojo.internal.bindings.arc.mojom.FileSystemInstance_OpenThumbnail_ParamsSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.FileSystemInstance_OpenThumbnail_ParamsSpec.$.structSpec && mojo.internal.bindings.arc.mojom.FileSystemInstance_OpenThumbnail_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.FileSystemInstance_OpenThumbnail_ParamsSpec.$ = {};
mojo.internal.bindings.arc.mojom.FileSystemInstance_OpenThumbnail_ResponseParamsSpec = mojo.internal.bindings.arc.mojom.FileSystemInstance_OpenThumbnail_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.FileSystemInstance_OpenThumbnail_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.arc.mojom.FileSystemInstance_OpenThumbnail_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.FileSystemInstance_OpenThumbnail_ResponseParamsSpec.$ = {};
mojo.internal.bindings.arc.mojom.FileSystemInstance_CloseFileSession_ParamsSpec = mojo.internal.bindings.arc.mojom.FileSystemInstance_CloseFileSession_ParamsSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.FileSystemInstance_CloseFileSession_ParamsSpec.$.structSpec && mojo.internal.bindings.arc.mojom.FileSystemInstance_CloseFileSession_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.FileSystemInstance_CloseFileSession_ParamsSpec.$ = {};
mojo.internal.bindings.arc.mojom.FileSystemInstance_OpenFileSessionToWrite_ParamsSpec = mojo.internal.bindings.arc.mojom.FileSystemInstance_OpenFileSessionToWrite_ParamsSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.FileSystemInstance_OpenFileSessionToWrite_ParamsSpec.$.structSpec && mojo.internal.bindings.arc.mojom.FileSystemInstance_OpenFileSessionToWrite_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.FileSystemInstance_OpenFileSessionToWrite_ParamsSpec.$ = {};
mojo.internal.bindings.arc.mojom.FileSystemInstance_OpenFileSessionToWrite_ResponseParamsSpec = mojo.internal.bindings.arc.mojom.FileSystemInstance_OpenFileSessionToWrite_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.FileSystemInstance_OpenFileSessionToWrite_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.arc.mojom.FileSystemInstance_OpenFileSessionToWrite_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.FileSystemInstance_OpenFileSessionToWrite_ResponseParamsSpec.$ = {};
mojo.internal.bindings.arc.mojom.FileSystemInstance_OpenFileSessionToRead_ParamsSpec = mojo.internal.bindings.arc.mojom.FileSystemInstance_OpenFileSessionToRead_ParamsSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.FileSystemInstance_OpenFileSessionToRead_ParamsSpec.$.structSpec && mojo.internal.bindings.arc.mojom.FileSystemInstance_OpenFileSessionToRead_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.FileSystemInstance_OpenFileSessionToRead_ParamsSpec.$ = {};
mojo.internal.bindings.arc.mojom.FileSystemInstance_OpenFileSessionToRead_ResponseParamsSpec = mojo.internal.bindings.arc.mojom.FileSystemInstance_OpenFileSessionToRead_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.FileSystemInstance_OpenFileSessionToRead_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.arc.mojom.FileSystemInstance_OpenFileSessionToRead_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.FileSystemInstance_OpenFileSessionToRead_ResponseParamsSpec.$ = {};
mojo.internal.bindings.arc.mojom.FileSystemInstance_RemoveWatcher_ParamsSpec = mojo.internal.bindings.arc.mojom.FileSystemInstance_RemoveWatcher_ParamsSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.FileSystemInstance_RemoveWatcher_ParamsSpec.$.structSpec && mojo.internal.bindings.arc.mojom.FileSystemInstance_RemoveWatcher_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.FileSystemInstance_RemoveWatcher_ParamsSpec.$ = {};
mojo.internal.bindings.arc.mojom.FileSystemInstance_RemoveWatcher_ResponseParamsSpec = mojo.internal.bindings.arc.mojom.FileSystemInstance_RemoveWatcher_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.FileSystemInstance_RemoveWatcher_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.arc.mojom.FileSystemInstance_RemoveWatcher_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.FileSystemInstance_RemoveWatcher_ResponseParamsSpec.$ = {};
mojo.internal.bindings.arc.mojom.FileSystemInstance_RequestMediaScan_ParamsSpec = mojo.internal.bindings.arc.mojom.FileSystemInstance_RequestMediaScan_ParamsSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.FileSystemInstance_RequestMediaScan_ParamsSpec.$.structSpec && mojo.internal.bindings.arc.mojom.FileSystemInstance_RequestMediaScan_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.FileSystemInstance_RequestMediaScan_ParamsSpec.$ = {};
mojo.internal.bindings.arc.mojom.FileSystemInstance_ReindexDirectory_ParamsSpec = mojo.internal.bindings.arc.mojom.FileSystemInstance_ReindexDirectory_ParamsSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.FileSystemInstance_ReindexDirectory_ParamsSpec.$.structSpec && mojo.internal.bindings.arc.mojom.FileSystemInstance_ReindexDirectory_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.FileSystemInstance_ReindexDirectory_ParamsSpec.$ = {};
mojo.internal.bindings.arc.mojom.FileSystemInstance_RequestFileRemovalScan_ParamsSpec = mojo.internal.bindings.arc.mojom.FileSystemInstance_RequestFileRemovalScan_ParamsSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.FileSystemInstance_RequestFileRemovalScan_ParamsSpec.$.structSpec && mojo.internal.bindings.arc.mojom.FileSystemInstance_RequestFileRemovalScan_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.FileSystemInstance_RequestFileRemovalScan_ParamsSpec.$ = {};
mojo.internal.bindings.arc.mojom.FileSystemInstance_OpenUrlsWithPermissionAndWindowInfo_ParamsSpec = mojo.internal.bindings.arc.mojom.FileSystemInstance_OpenUrlsWithPermissionAndWindowInfo_ParamsSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.FileSystemInstance_OpenUrlsWithPermissionAndWindowInfo_ParamsSpec.$.structSpec && mojo.internal.bindings.arc.mojom.FileSystemInstance_OpenUrlsWithPermissionAndWindowInfo_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.FileSystemInstance_OpenUrlsWithPermissionAndWindowInfo_ParamsSpec.$ = {};
mojo.internal.bindings.arc.mojom.FileSystemInstance_OpenUrlsWithPermissionAndWindowInfo_ResponseParamsSpec = mojo.internal.bindings.arc.mojom.FileSystemInstance_OpenUrlsWithPermissionAndWindowInfo_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.FileSystemInstance_OpenUrlsWithPermissionAndWindowInfo_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.arc.mojom.FileSystemInstance_OpenUrlsWithPermissionAndWindowInfo_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.FileSystemInstance_OpenUrlsWithPermissionAndWindowInfo_ResponseParamsSpec.$ = {};
...
mojo.internal.bindings.arc = mojo.internal.bindings.arc || {};
mojo.internal.bindings.arc.mojom = mojo.internal.bindings.arc.mojom || {};
mojo.internal.bindings.arc.mojom.MediaStoreMetadataSpec = mojo.internal.bindings.arc.mojom.MediaStoreMetadataSpec || { $: mojo.internal.OpaqueStruct.$ };
mojo.internal.bindings.arc = mojo.internal.bindings.arc || {};
mojo.internal.bindings.arc.mojom = mojo.internal.bindings.arc.mojom || {};
...
mojo.internal.bindings.arc.mojom.FileSystemHostRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('arc.mojom.FileSystemHost', [
      { explicit: 1 },
      { explicit: 2 },
      { explicit: 11 },
      { explicit: 3 },
...
mojo.internal.bindings.arc.mojom.FileSystemHostReceiver = class {
  constructor(impl) {
    ...
    const ordinals = window.mojoScrambler.getOrdinals('arc.mojom.FileSystemHost', [
      { explicit: 1 },
      { explicit: 2 },
      { explicit: 11 },
      { explicit: 3 },
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const message = new mojo.internal.Message(
                ...
                header.ordinal, header.requestId, mojo.internal.bindings.arc.mojom.FileSystemHost_GetFileName_ResponseParamsSpec.$.structSpec, resp_obj);
        ...
        case 1: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.arc.mojom.FileSystemHost_GetFileSize_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
        ...
        case 2: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              const val = (response && typeof response === 'object' && 'arg_last_modified' in response) ? response['arg_last_modified'] : response;
              const resp_obj = { 'arg_last_modified': val };
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.arc.mojom.FileSystemHost_GetLastModified_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
        ...
        case 3: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              const val = (response && typeof response === 'object' && 'arg_mime_type' in response) ? response['arg_mime_type'] : response;
              const resp_obj = { 'arg_mime_type': val };
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.arc.mojom.FileSystemHost_GetFileType_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
        ...
        case 6: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.arc.mojom.FileSystemHost_GetVirtualFileId_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
        ...
        case 7: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.arc.mojom.FileSystemHost_HandleIdReleased_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
        ...
        case 8: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.arc.mojom.FileSystemHost_OpenFileToRead_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
        ...
        case 9: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.arc.mojom.FileSystemHost_SelectFiles_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
        ...
        case 10: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.arc.mojom.FileSystemHost_OnFileSelectorEvent_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
        ...
        case 11: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.arc.mojom.FileSystemHost_GetFileSelectorElements_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
        ...
        case 13: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              const val = (response && typeof response === 'object' && 'arg_moniker' in response) ? response['arg_moniker'] : response;
              const resp_obj = { 'arg_moniker': val };
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.arc.mojom.FileSystemHost_CreateMoniker_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
        ...
        case 14: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.arc.mojom.FileSystemHost_DestroyMoniker_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
...
mojo.internal.bindings.arc.mojom.FileSystemInstanceRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('arc.mojom.FileSystemInstance', [
      { explicit: 6 },
      { explicit: 4 },
      { explicit: 3 },
      { explicit: 1 },
...
mojo.internal.bindings.arc.mojom.FileSystemInstanceReceiver = class {
  constructor(impl) {
    ...
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('arc.mojom.FileSystemInstance', [
      { explicit: 6 },
      { explicit: 4 },
      { explicit: 3 },
      { explicit: 1 },
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        case 0: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              const val = (response && typeof response === 'object' && 'arg_watcher_id' in response) ? response['arg_watcher_id'] : response;
              const resp_obj = { 'arg_watcher_id': val };
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.arc.mojom.FileSystemInstance_AddWatcher_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
        ...
        case 1: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              const val = (response && typeof response === 'object' && 'arg_documents' in response) ? response['arg_documents'] : response;
              const resp_obj = { 'arg_documents': val };
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.arc.mojom.FileSystemInstance_GetChildDocuments_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
        ...
        case 2: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              const val = (response && typeof response === 'object' && 'arg_document' in response) ? response['arg_document'] : response;
              const resp_obj = { 'arg_document': val };
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.arc.mojom.FileSystemInstance_GetDocument_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
        ...
        case 3: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.arc.mojom.FileSystemInstance_GetFileSize_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
            }).catch(e => console.error('[GeneratedReceiver] getFileSize FAILED:', e));
          }
          break;
        ...
        case 4: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.arc.mojom.FileSystemInstance_GetMimeType_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
        ...
        case 5: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.arc.mojom.FileSystemInstance_GetRecentDocuments_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
        ...
        case 6: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              const val = (response && typeof response === 'object' && 'arg_roots' in response) ? response['arg_roots'] : response;
              const resp_obj = { 'arg_roots': val };
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.arc.mojom.FileSystemInstance_GetRoots_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
        ...
        case 7: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              const val = (response && typeof response === 'object' && 'arg_root_size' in response) ? response['arg_root_size'] : response;
              const resp_obj = { 'arg_root_size': val };
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.arc.mojom.FileSystemInstance_GetRootSize_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
        ...
        case 8: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.arc.mojom.FileSystemInstance_DeleteDocument_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
        ...
        case 9: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.arc.mojom.FileSystemInstance_RenameDocument_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
        ...
        case 10: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.arc.mojom.FileSystemInstance_CreateDocument_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
        ...
        case 11: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.arc.mojom.FileSystemInstance_CopyDocument_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
        ...
        case 12: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.arc.mojom.FileSystemInstance_MoveDocument_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
        ...
        case 13: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.arc.mojom.FileSystemInstance_Init_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
        ...
        case 14: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.arc.mojom.FileSystemInstance_OpenThumbnail_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
        ...
        case 16: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              const val = (response && typeof response === 'object' && 'arg_file_session' in response) ? response['arg_file_session'] : response;
              const resp_obj = { 'arg_file_session': val };
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.arc.mojom.FileSystemInstance_OpenFileSessionToWrite_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
        ...
        case 17: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.arc.mojom.FileSystemInstance_OpenFileSessionToRead_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
        ...
        case 18: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.arc.mojom.FileSystemInstance_RemoveWatcher_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
        ...
        case 22: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.arc.mojom.FileSystemInstance_OpenUrlsWithPermissionAndWindowInfo_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
...
mojo.internal.Struct(
    mojo.internal.bindings.arc.mojom.SelectFilesRequestSpec, 'arc.mojom.SelectFilesRequest', [
      ...
      mojo.internal.StructField('arg_openable_only', 4, 0, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_allow_multiple', 4, 1, mojo.internal.Bool, false, false, 0, undefined),
      ...
      mojo.internal.StructField('arg_search_query', 48, 0, mojo.internal.String, null, true, 0, undefined),
    ],
    [[0, 64]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.arc.mojom.FileSelectorEventSpec, 'arc.mojom.FileSelectorEvent', [
      ...
      mojo.internal.StructField('arg_creator_task_id', 4, 0, mojo.internal.Int32, 0, false, 0, undefined),
...
mojo.internal.Struct(
    mojo.internal.bindings.arc.mojom.FileSystemInstance_Init_ParamsSpec, 'arc.mojom.FileSystemInstance_Init_Params', [
      mojo.internal.StructField('arg_host_remote', 0, 0, mojo.internal.InterfaceProxy(mojo.internal.bindings.arc.mojom.FileSystemHostRemote), null, false, 0, undefined),
    ],
    [[0, 16]]);
