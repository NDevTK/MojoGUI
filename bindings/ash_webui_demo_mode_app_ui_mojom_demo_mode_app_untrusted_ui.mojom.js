...
mojo.internal.bindings.ash.mojom.demo_mode.UntrustedPageHandlerFactoryRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.ash.mojom.demo_mode.UntrustedPageHandlerFactoryPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.ash.mojom.demo_mode.UntrustedPageHandlerFactoryRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.ash.mojom.demo_mode.UntrustedPageHandlerFactory.getRemote = function() {
  let remote = new mojo.internal.bindings.ash.mojom.demo_mode.UntrustedPageHandlerFactoryRemote();
...
mojo.internal.bindings.ash.mojom.demo_mode.UntrustedPageHandlerFactoryReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ash.mojom.demo_mode.UntrustedPageHandlerFactory_CreatePageHandler_ParamsSpec.$.structSpec;
...
mojo.internal.bindings.ash.mojom.demo_mode.UntrustedPageHandlerFactoryReceiver = mojo.internal.bindings.ash.mojom.demo_mode.UntrustedPageHandlerFactoryReceiver;

mojo.internal.bindings.ash.mojom.demo_mode.UntrustedPageHandlerFactoryPtr = mojo.internal.bindings.ash.mojom.demo_mode.UntrustedPageHandlerFactoryRemote;
mojo.internal.bindings.ash.mojom.demo_mode.UntrustedPageHandlerFactoryRequest = mojo.internal.bindings.ash.mojom.demo_mode.UntrustedPageHandlerFactoryPendingReceiver;
...
mojo.internal.bindings.ash.mojom.demo_mode.UntrustedPageHandlerRemote = class {
  static get $interfaceName() {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.ash.mojom.demo_mode.UntrustedPageHandlerPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.ash.mojom.demo_mode.UntrustedPageHandlerRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.ash.mojom.demo_mode.UntrustedPageHandler.getRemote = function() {
  let remote = new mojo.internal.bindings.ash.mojom.demo_mode.UntrustedPageHandlerRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
...
mojo.internal.bindings.ash.mojom.demo_mode.UntrustedPageHandlerReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ash.mojom.demo_mode.UntrustedPageHandler_ToggleFullscreen_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for ToggleFullscreen failed with TypeError');
           }
        }
        // Try Method 1: LaunchApp
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ash.mojom.demo_mode.UntrustedPageHandler_LaunchApp_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.ash.mojom.demo_mode.UntrustedPageHandler_ToggleFullscreen_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.ash.mojom.demo_mode.UntrustedPageHandlerReceiver = mojo.internal.bindings.ash.mojom.demo_mode.UntrustedPageHandlerReceiver;
