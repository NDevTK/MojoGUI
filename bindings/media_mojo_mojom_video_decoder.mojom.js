...
mojo.internal.bindings.media.mojom.CdmSpec = mojo.internal.bindings.media.mojom.CdmSpec || { $: {} };
if (mojo.internal.bindings.media.mojom.CdmSpec.$.structSpec && mojo.internal.bindings.media.mojom.CdmSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.media.mojom.CdmSpec.$ = {};
mojo.internal.bindings.media.mojom.OverlayInfoSpec = mojo.internal.bindings.media.mojom.OverlayInfoSpec || { $: {} };
if (mojo.internal.bindings.media.mojom.OverlayInfoSpec.$.structSpec && mojo.internal.bindings.media.mojom.OverlayInfoSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.media.mojom.OverlayInfoSpec.$ = {};
mojo.internal.bindings.media.mojom.SupportedVideoDecoderConfigSpec = mojo.internal.bindings.media.mojom.SupportedVideoDecoderConfigSpec || { $: {} };
if (mojo.internal.bindings.media.mojom.SupportedVideoDecoderConfigSpec.$.structSpec && mojo.internal.bindings.media.mojom.SupportedVideoDecoderConfigSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.media.mojom.SupportedVideoDecoderConfigSpec.$ = {};
mojo.internal.bindings.media.mojom.CommandBufferIdSpec = mojo.internal.bindings.media.mojom.CommandBufferIdSpec || { $: {} };
if (mojo.internal.bindings.media.mojom.CommandBufferIdSpec.$.structSpec && mojo.internal.bindings.media.mojom.CommandBufferIdSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.media.mojom.CommandBufferIdSpec.$ = {};
mojo.internal.bindings.media.mojom.OverlayInfoSpec = mojo.internal.bindings.media.mojom.OverlayInfoSpec || { $: {} };
if (mojo.internal.bindings.media.mojom.OverlayInfoSpec.$.structSpec && mojo.internal.bindings.media.mojom.OverlayInfoSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.media.mojom.OverlayInfoSpec.$ = {};
mojo.internal.bindings.media.mojom.VideoFrameHandleReleaser = mojo.internal.bindings.media.mojom.VideoFrameHandleReleaser || {};
mojo.internal.bindings.media.mojom.VideoFrameHandleReleaserSpec = mojo.internal.bindings.media.mojom.VideoFrameHandleReleaserSpec || { $ : {} };
if (mojo.internal.bindings.media.mojom.VideoFrameHandleReleaserSpec.$.structSpec && mojo.internal.bindings.media.mojom.VideoFrameHandleReleaserSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.media.mojom.VideoFrameHandleReleaserSpec.$ = {};
mojo.internal.bindings.media.mojom.VideoFrameHandleReleaser.$interfaceName = 'media.mojom.VideoFrameHandleReleaser';
mojo.internal.bindings.media.mojom.VideoFrameHandleReleaser_ReleaseVideoFrame_ParamsSpec = mojo.internal.bindings.media.mojom.VideoFrameHandleReleaser_ReleaseVideoFrame_ParamsSpec || { $: {} };
if (mojo.internal.bindings.media.mojom.VideoFrameHandleReleaser_ReleaseVideoFrame_ParamsSpec.$.structSpec && mojo.internal.bindings.media.mojom.VideoFrameHandleReleaser_ReleaseVideoFrame_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.media.mojom.VideoFrameHandleReleaser_ReleaseVideoFrame_ParamsSpec.$ = {};
mojo.internal.bindings.media.mojom.VideoDecoder = mojo.internal.bindings.media.mojom.VideoDecoder || {};
mojo.internal.bindings.media.mojom.VideoDecoderSpec = mojo.internal.bindings.media.mojom.VideoDecoderSpec || { $ : {} };
if (mojo.internal.bindings.media.mojom.VideoDecoderSpec.$.structSpec && mojo.internal.bindings.media.mojom.VideoDecoderSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.media.mojom.VideoDecoderSpec.$ = {};
mojo.internal.bindings.media.mojom.VideoDecoder.$interfaceName = 'media.mojom.VideoDecoder';
mojo.internal.bindings.media.mojom.VideoDecoder_GetSupportedConfigs_ParamsSpec = mojo.internal.bindings.media.mojom.VideoDecoder_GetSupportedConfigs_ParamsSpec || { $: {} };
if (mojo.internal.bindings.media.mojom.VideoDecoder_GetSupportedConfigs_ParamsSpec.$.structSpec && mojo.internal.bindings.media.mojom.VideoDecoder_GetSupportedConfigs_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.media.mojom.VideoDecoder_GetSupportedConfigs_ParamsSpec.$ = {};
mojo.internal.bindings.media.mojom.VideoDecoder_GetSupportedConfigs_ResponseParamsSpec = mojo.internal.bindings.media.mojom.VideoDecoder_GetSupportedConfigs_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.media.mojom.VideoDecoder_GetSupportedConfigs_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.media.mojom.VideoDecoder_GetSupportedConfigs_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.media.mojom.VideoDecoder_GetSupportedConfigs_ResponseParamsSpec.$ = {};
mojo.internal.bindings.media.mojom.VideoDecoder_Construct_ParamsSpec = mojo.internal.bindings.media.mojom.VideoDecoder_Construct_ParamsSpec || { $: {} };
if (mojo.internal.bindings.media.mojom.VideoDecoder_Construct_ParamsSpec.$.structSpec && mojo.internal.bindings.media.mojom.VideoDecoder_Construct_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.media.mojom.VideoDecoder_Construct_ParamsSpec.$ = {};
mojo.internal.bindings.media.mojom.VideoDecoder_Initialize_ParamsSpec = mojo.internal.bindings.media.mojom.VideoDecoder_Initialize_ParamsSpec || { $: {} };
if (mojo.internal.bindings.media.mojom.VideoDecoder_Initialize_ParamsSpec.$.structSpec && mojo.internal.bindings.media.mojom.VideoDecoder_Initialize_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.media.mojom.VideoDecoder_Initialize_ParamsSpec.$ = {};
mojo.internal.bindings.media.mojom.VideoDecoder_Initialize_ResponseParamsSpec = mojo.internal.bindings.media.mojom.VideoDecoder_Initialize_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.media.mojom.VideoDecoder_Initialize_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.media.mojom.VideoDecoder_Initialize_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.media.mojom.VideoDecoder_Initialize_ResponseParamsSpec.$ = {};
mojo.internal.bindings.media.mojom.VideoDecoder_Decode_ParamsSpec = mojo.internal.bindings.media.mojom.VideoDecoder_Decode_ParamsSpec || { $: {} };
if (mojo.internal.bindings.media.mojom.VideoDecoder_Decode_ParamsSpec.$.structSpec && mojo.internal.bindings.media.mojom.VideoDecoder_Decode_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.media.mojom.VideoDecoder_Decode_ParamsSpec.$ = {};
mojo.internal.bindings.media.mojom.VideoDecoder_Decode_ResponseParamsSpec = mojo.internal.bindings.media.mojom.VideoDecoder_Decode_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.media.mojom.VideoDecoder_Decode_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.media.mojom.VideoDecoder_Decode_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.media.mojom.VideoDecoder_Decode_ResponseParamsSpec.$ = {};
mojo.internal.bindings.media.mojom.VideoDecoder_Reset_ParamsSpec = mojo.internal.bindings.media.mojom.VideoDecoder_Reset_ParamsSpec || { $: {} };
if (mojo.internal.bindings.media.mojom.VideoDecoder_Reset_ParamsSpec.$.structSpec && mojo.internal.bindings.media.mojom.VideoDecoder_Reset_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.media.mojom.VideoDecoder_Reset_ParamsSpec.$ = {};
mojo.internal.bindings.media.mojom.VideoDecoder_Reset_ResponseParamsSpec = mojo.internal.bindings.media.mojom.VideoDecoder_Reset_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.media.mojom.VideoDecoder_Reset_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.media.mojom.VideoDecoder_Reset_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.media.mojom.VideoDecoder_Reset_ResponseParamsSpec.$ = {};
mojo.internal.bindings.media.mojom.VideoDecoder_OnOverlayInfoChanged_ParamsSpec = mojo.internal.bindings.media.mojom.VideoDecoder_OnOverlayInfoChanged_ParamsSpec || { $: {} };
if (mojo.internal.bindings.media.mojom.VideoDecoder_OnOverlayInfoChanged_ParamsSpec.$.structSpec && mojo.internal.bindings.media.mojom.VideoDecoder_OnOverlayInfoChanged_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.media.mojom.VideoDecoder_OnOverlayInfoChanged_ParamsSpec.$ = {};
mojo.internal.bindings.media.mojom.VideoDecoderClient = mojo.internal.bindings.media.mojom.VideoDecoderClient || {};
mojo.internal.bindings.media.mojom.VideoDecoderClientSpec = mojo.internal.bindings.media.mojom.VideoDecoderClientSpec || { $ : {} };
if (mojo.internal.bindings.media.mojom.VideoDecoderClientSpec.$.structSpec && mojo.internal.bindings.media.mojom.VideoDecoderClientSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.media.mojom.VideoDecoderClientSpec.$ = {};
mojo.internal.bindings.media.mojom.VideoDecoderClient.$interfaceName = 'media.mojom.VideoDecoderClient';
mojo.internal.bindings.media.mojom.VideoDecoderClient_OnVideoFrameDecoded_ParamsSpec = mojo.internal.bindings.media.mojom.VideoDecoderClient_OnVideoFrameDecoded_ParamsSpec || { $: {} };
if (mojo.internal.bindings.media.mojom.VideoDecoderClient_OnVideoFrameDecoded_ParamsSpec.$.structSpec && mojo.internal.bindings.media.mojom.VideoDecoderClient_OnVideoFrameDecoded_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.media.mojom.VideoDecoderClient_OnVideoFrameDecoded_ParamsSpec.$ = {};
mojo.internal.bindings.media.mojom.VideoDecoderClient_OnWaiting_ParamsSpec = mojo.internal.bindings.media.mojom.VideoDecoderClient_OnWaiting_ParamsSpec || { $: {} };
if (mojo.internal.bindings.media.mojom.VideoDecoderClient_OnWaiting_ParamsSpec.$.structSpec && mojo.internal.bindings.media.mojom.VideoDecoderClient_OnWaiting_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.media.mojom.VideoDecoderClient_OnWaiting_ParamsSpec.$ = {};
mojo.internal.bindings.media.mojom.VideoDecoderClient_RequestOverlayInfo_ParamsSpec = mojo.internal.bindings.media.mojom.VideoDecoderClient_RequestOverlayInfo_ParamsSpec || { $: {} };
if (mojo.internal.bindings.media.mojom.VideoDecoderClient_RequestOverlayInfo_ParamsSpec.$.structSpec && mojo.internal.bindings.media.mojom.VideoDecoderClient_RequestOverlayInfo_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.media.mojom.VideoDecoderClient_RequestOverlayInfo_ParamsSpec.$ = {};
...
mojo.internal.bindings.media = mojo.internal.bindings.media || {};
mojo.internal.bindings.media.mojom = mojo.internal.bindings.media.mojom || {};
mojo.internal.bindings.media.mojom.CdmSpec = mojo.internal.bindings.media.mojom.CdmSpec || { $: mojo.internal.OpaqueStruct.$ };
mojo.internal.bindings.media = mojo.internal.bindings.media || {};
mojo.internal.bindings.media.mojom = mojo.internal.bindings.media.mojom || {};
...
mojo.internal.bindings.media.mojom.CdmContextForOOPVDPendingReceiver = mojo.internal.bindings.media.mojom.CdmContextForOOPVDPendingReceiver || class { constructor(handle) { this.handle = handle; } };
mojo.internal.bindings.media = mojo.internal.bindings.media || {};
mojo.internal.bindings.media.mojom = mojo.internal.bindings.media.mojom || {};
...
mojo.internal.bindings.media = mojo.internal.bindings.media || {};
mojo.internal.bindings.media.mojom = mojo.internal.bindings.media.mojom || {};
mojo.internal.bindings.media.mojom.DecoderStatusSpec = mojo.internal.bindings.media.mojom.DecoderStatusSpec || { $: mojo.internal.OpaqueStruct.$ };
mojo.internal.bindings.media = mojo.internal.bindings.media || {};
mojo.internal.bindings.media.mojom = mojo.internal.bindings.media.mojom || {};
...
mojo.internal.bindings.media.mojom.VideoFrameHandleReleaserPendingReceiver = class {
  constructor(handle) {
    this.handle = handle;
    if (handle) {
...
mojo.internal.bindings.media.mojom.VideoFrameHandleReleaserRemote = class {
  ...
  constructor(handle = undefined) {
    ...
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.media.mojom.VideoFrameHandleReleaserPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.media.mojom.VideoFrameHandleReleaserRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.media.mojom.VideoFrameHandleReleaserRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('media.mojom.VideoFrameHandleReleaser', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.media.mojom.VideoFrameHandleReleaser.getRemote = function() {
  let remote = new mojo.internal.bindings.media.mojom.VideoFrameHandleReleaserRemote();
...
mojo.internal.bindings.media.mojom.VideoFrameHandleReleaserReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('media.mojom.VideoFrameHandleReleaser', [
      { explicit: null },
    ]);
...
mojo.internal.bindings.media.mojom.VideoFrameHandleReleaserReceiver = mojo.internal.bindings.media.mojom.VideoFrameHandleReleaserReceiver;

mojo.internal.bindings.media.mojom.VideoFrameHandleReleaserPtr = mojo.internal.bindings.media.mojom.VideoFrameHandleReleaserRemote;
mojo.internal.bindings.media.mojom.VideoFrameHandleReleaserRequest = mojo.internal.bindings.media.mojom.VideoFrameHandleReleaserPendingReceiver;


// Interface: VideoDecoder
mojo.internal.bindings.media.mojom.VideoDecoderPendingReceiver = class {
  constructor(handle) {
    this.handle = handle;
    if (handle) {
      this.__mojoHandle = handle.router_ ? handle.router_.pipe_ : (handle.pipe_ || handle);
...
mojo.internal.bindings.media.mojom.VideoDecoderRemote = class {
  static get $interfaceName() {
  ...
  constructor(handle = undefined) {
    this.__mojoHandle = handle;
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.media.mojom.VideoDecoderPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.media.mojom.VideoDecoderRemoteCallHandler(this.proxy);
  }
  ...
  construct(arg_client, arg_media_log, arg_video_frame_handle_releaser, arg_decoder_buffer_pipe, arg_command_buffer_id, arg_target_color_space) {
    return this.$.construct(arg_client, arg_media_log, arg_video_frame_handle_releaser, arg_decoder_buffer_pipe, arg_command_buffer_id, arg_target_color_space);
  }
  initialize(arg_config, arg_low_delay, arg_cdm) {
    return this.$.initialize(arg_config, arg_low_delay, arg_cdm);
  }
  decode(arg_buffer) {
  ...
  onOverlayInfoChanged(arg_overlay_info) {
    return this.$.onOverlayInfoChanged(arg_overlay_info);
  }
};

mojo.internal.bindings.media.mojom.VideoDecoderRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('media.mojom.VideoDecoder', [
      { explicit: null },
      { explicit: null },
      { explicit: null },
      { explicit: null },
...
mojo.internal.bindings.media.mojom.VideoDecoder.getRemote = function() {
  let remote = new mojo.internal.bindings.media.mojom.VideoDecoderRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
...
mojo.internal.bindings.media.mojom.VideoDecoderReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('media.mojom.VideoDecoder', [
      { explicit: null },
      { explicit: null },
      { explicit: null },
      { explicit: null },
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.media.mojom.VideoDecoder_GetSupportedConfigs_ParamsSpec.$.structSpec);
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const message = new mojo.internal.Message(
                ...
                header.ordinal, header.requestId, mojo.internal.bindings.media.mojom.VideoDecoder_GetSupportedConfigs_ResponseParamsSpec.$.structSpec, resp_obj);
        ...
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.media.mojom.VideoDecoder_Construct_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.construct');
          const result = this.impl.construct(params.arg_client, params.arg_media_log, params.arg_video_frame_handle_releaser, params.arg_decoder_buffer_pipe, params.arg_command_buffer_id, params.arg_target_color_space);
          break;
        }
        case 2: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.media.mojom.VideoDecoder_Initialize_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.initialize');
          const result = this.impl.initialize(params.arg_config, params.arg_low_delay, params.arg_cdm);
          const expectsResponse = header.expectsResponse || (header.flags & 1);
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              const resp_obj = response;
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.media.mojom.VideoDecoder_Initialize_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
        ...
        case 3: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.media.mojom.VideoDecoder_Decode_ParamsSpec.$.structSpec);
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.media.mojom.VideoDecoder_Decode_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
        ...
        case 4: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.media.mojom.VideoDecoder_Reset_ParamsSpec.$.structSpec);
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.media.mojom.VideoDecoder_Reset_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
        ...
        case 5: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.media.mojom.VideoDecoder_OnOverlayInfoChanged_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.onOverlayInfoChanged');
          const result = this.impl.onOverlayInfoChanged(params.arg_overlay_info);
          break;
        }
      }
      } catch (err) {
...
mojo.internal.bindings.media.mojom.VideoDecoderReceiver = mojo.internal.bindings.media.mojom.VideoDecoderReceiver;

mojo.internal.bindings.media.mojom.VideoDecoderPtr = mojo.internal.bindings.media.mojom.VideoDecoderRemote;
mojo.internal.bindings.media.mojom.VideoDecoderRequest = mojo.internal.bindings.media.mojom.VideoDecoderPendingReceiver;


// Interface: VideoDecoderClient
mojo.internal.bindings.media.mojom.VideoDecoderClientPendingReceiver = class {
  constructor(handle) {
    this.handle = handle;
    if (handle) {
      this.__mojoHandle = handle.router_ ? handle.router_.pipe_ : (handle.pipe_ || handle);
...
mojo.internal.bindings.media.mojom.VideoDecoderClientRemote = class {
  static get $interfaceName() {
  ...
  constructor(handle = undefined) {
    this.__mojoHandle = handle;
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.media.mojom.VideoDecoderClientPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.media.mojom.VideoDecoderClientRemoteCallHandler(this.proxy);
  }
  ...
  onVideoFrameDecoded(arg_frame, arg_can_read_without_stalling, arg_release_token) {
    return this.$.onVideoFrameDecoded(arg_frame, arg_can_read_without_stalling, arg_release_token);
  }
...
mojo.internal.bindings.media.mojom.VideoDecoderClientRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('media.mojom.VideoDecoderClient', [
      { explicit: null },
      { explicit: null },
      { explicit: null },
    ]);
...
mojo.internal.bindings.media.mojom.VideoDecoderClient.getRemote = function() {
  let remote = new mojo.internal.bindings.media.mojom.VideoDecoderClientRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
...
mojo.internal.bindings.media.mojom.VideoDecoderClientReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('media.mojom.VideoDecoderClient', [
      { explicit: null },
      { explicit: null },
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.media.mojom.VideoDecoderClient_OnVideoFrameDecoded_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.onVideoFrameDecoded');
          const result = this.impl.onVideoFrameDecoded(params.arg_frame, params.arg_can_read_without_stalling, params.arg_release_token);
          break;
        }
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.media.mojom.VideoDecoderClient_OnWaiting_ParamsSpec.$.structSpec);
        ...
        case 2: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.media.mojom.VideoDecoderClient_RequestOverlayInfo_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.media.mojom.VideoDecoderClientReceiver = mojo.internal.bindings.media.mojom.VideoDecoderClientReceiver;

mojo.internal.bindings.media.mojom.VideoDecoderClientPtr = mojo.internal.bindings.media.mojom.VideoDecoderClientRemote;
mojo.internal.bindings.media.mojom.VideoDecoderClientRequest = mojo.internal.bindings.media.mojom.VideoDecoderClientPendingReceiver;
...
// Union: Cdm
mojo.internal.Union(
    mojo.internal.bindings.media.mojom.CdmSpec, 'media.mojom.Cdm', {
      'arg_cdm_id': {
        'ordinal': 0,
      ...
      'arg_cdm_context': {
        'ordinal': 1,
        'type': mojo.internal.InterfaceProxy(mojo.internal.bindings.media.mojom.CdmContextForOOPVDRemote),
        'nullable': false,
      },
    });
...
mojo.internal.Struct(
    mojo.internal.bindings.media.mojom.SupportedVideoDecoderConfigSpec, 'media.mojom.SupportedVideoDecoderConfig', [
      mojo.internal.StructField('arg_profile_min', 0, 0, mojo.internal.bindings.gpu.mojom.VideoCodecProfileSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_profile_max', 4, 0, mojo.internal.bindings.gpu.mojom.VideoCodecProfileSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_coded_size_min', 8, 0, mojo.internal.bindings.gfx.mojom.SizeSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_coded_size_max', 16, 0, mojo.internal.bindings.gfx.mojom.SizeSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_allow_encrypted', 24, 0, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_require_encrypted', 24, 1, mojo.internal.Bool, false, false, 0, undefined),
    ],
    [[0, 40]]);

// Struct: CommandBufferId
mojo.internal.Struct(
    mojo.internal.bindings.media.mojom.CommandBufferIdSpec, 'media.mojom.CommandBufferId', [
...
mojo.internal.Struct(
    mojo.internal.bindings.media.mojom.VideoDecoder_GetSupportedConfigs_ParamsSpec, 'media.mojom.VideoDecoder_GetSupportedConfigs_Params', [
    ],
    [[0, 8]]);

mojo.internal.Struct(
    mojo.internal.bindings.media.mojom.VideoDecoder_GetSupportedConfigs_ResponseParamsSpec, 'media.mojom.VideoDecoder_GetSupportedConfigs_ResponseParams', [
      ...
      mojo.internal.StructField('arg_decoder_type', 8, 0, mojo.internal.bindings.media.mojom.VideoDecoderTypeSpec, null, false, 0, undefined),
    ],
    [[0, 24]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.media.mojom.VideoDecoder_Initialize_ParamsSpec, 'media.mojom.VideoDecoder_Initialize_Params', [
      ...
      mojo.internal.StructField('arg_low_delay', 8, 0, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_cdm', 16, 0, mojo.internal.bindings.media.mojom.CdmSpec, null, true, 0, undefined),
    ],
    [[0, 40]]);

mojo.internal.Struct(
    mojo.internal.bindings.media.mojom.VideoDecoder_Initialize_ResponseParamsSpec, 'media.mojom.VideoDecoder_Initialize_ResponseParams', [
      mojo.internal.StructField('arg_status', 0, 0, mojo.internal.bindings.media.mojom.DecoderStatusSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_needs_bitstream_conversion', 8, 0, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_needs_transcryption', 8, 1, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_max_decode_requests', 12, 0, mojo.internal.Int32, 0, false, 0, undefined),
      mojo.internal.StructField('arg_decoder_type', 16, 0, mojo.internal.bindings.media.mojom.VideoDecoderTypeSpec, null, false, 0, undefined),
    ],
    [[0, 32]]);

mojo.internal.Struct(
    mojo.internal.bindings.media.mojom.VideoDecoder_Decode_ParamsSpec, 'media.mojom.VideoDecoder_Decode_Params', [
      mojo.internal.StructField('arg_buffer', 0, 0, mojo.internal.bindings.media.mojom.DecoderBufferSpec, null, false, 0, undefined),
    ],
    [[0, 24]]);

mojo.internal.Struct(
    mojo.internal.bindings.media.mojom.VideoDecoder_Decode_ResponseParamsSpec, 'media.mojom.VideoDecoder_Decode_ResponseParams', [
      mojo.internal.StructField('arg_status', 0, 0, mojo.internal.bindings.media.mojom.DecoderStatusSpec, null, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.media.mojom.VideoDecoder_Reset_ParamsSpec, 'media.mojom.VideoDecoder_Reset_Params', [
    ],
    [[0, 8]]);

mojo.internal.Struct(
    mojo.internal.bindings.media.mojom.VideoDecoder_Reset_ResponseParamsSpec, 'media.mojom.VideoDecoder_Reset_ResponseParams', [
    ],
    [[0, 8]]);

mojo.internal.Struct(
    mojo.internal.bindings.media.mojom.VideoDecoder_OnOverlayInfoChanged_ParamsSpec, 'media.mojom.VideoDecoder_OnOverlayInfoChanged_Params', [
      mojo.internal.StructField('arg_overlay_info', 0, 0, mojo.internal.bindings.media.mojom.OverlayInfoSpec, null, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.media.mojom.VideoDecoderClient_OnVideoFrameDecoded_ParamsSpec, 'media.mojom.VideoDecoderClient_OnVideoFrameDecoded_Params', [
      mojo.internal.StructField('arg_frame', 0, 0, mojo.internal.bindings.media.mojom.VideoFrameSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_can_read_without_stalling', 8, 0, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_release_token', 16, 0, mojo.internal.bindings.mojo_base.mojom.UnguessableTokenSpec, null, true, 0, undefined),
    ],
    [[0, 32]]);

mojo.internal.Struct(
    mojo.internal.bindings.media.mojom.VideoDecoderClient_OnWaiting_ParamsSpec, 'media.mojom.VideoDecoderClient_OnWaiting_Params', [
      mojo.internal.StructField('arg_reason', 0, 0, mojo.internal.bindings.media.mojom.WaitingReasonSpec, null, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.media.mojom.VideoDecoderClient_RequestOverlayInfo_ParamsSpec, 'media.mojom.VideoDecoderClient_RequestOverlayInfo_Params', [
    ],
    [[0, 8]]);
