...
mojo.internal.bindings.video_capture.mojom.ProducerRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.video_capture.mojom.ProducerRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.video_capture.mojom.ProducerRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('video_capture.mojom.Producer', [
      { explicit: null },
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.video_capture.mojom.Producer.getRemote = function() {
  let remote = new mojo.internal.bindings.video_capture.mojom.ProducerRemote();
...
mojo.internal.bindings.video_capture.mojom.ProducerReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('video_capture.mojom.Producer', [
      { explicit: null },
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.video_capture.mojom.Producer_OnNewBuffer_ParamsSpec.$.structSpec);
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.video_capture.mojom.Producer_OnBufferRetired_ParamsSpec.$.structSpec);
        ...
        case 0: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.video_capture.mojom.Producer_OnNewBuffer_ResponseParamsSpec, header, rawHeader);
               responder(response);
...
mojo.internal.bindings.video_capture.mojom.ProducerReceiver = mojo.internal.bindings.video_capture.mojom.ProducerReceiver;
