...
mojo.internal.Struct(
    mojo.internal.bindings.discardable_memory.mojom.DiscardableSharedMemoryManager_AllocateLockedDiscardableSharedMemory_ParamsSpec, 'discardable_memory.mojom.DiscardableSharedMemoryManager_AllocateLockedDiscardableSharedMemory_Params', [
      mojo.internal.StructField('arg_size', 0, 0, mojo.internal.Uint32, 0, false, 0, undefined),
      mojo.internal.StructField('arg_id', 4, 0, mojo.internal.Int32, 0, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.discardable_memory.mojom.DiscardableSharedMemoryManager_AllocateLockedDiscardableSharedMemory_ResponseParamsSpec, 'discardable_memory.mojom.DiscardableSharedMemoryManager_AllocateLockedDiscardableSharedMemory_ResponseParams', [
...
mojo.internal.Struct(
    mojo.internal.bindings.discardable_memory.mojom.DiscardableSharedMemoryManager_DeletedDiscardableSharedMemory_ParamsSpec, 'discardable_memory.mojom.DiscardableSharedMemoryManager_DeletedDiscardableSharedMemory_Params', [
      mojo.internal.StructField('arg_id', 0, 0, mojo.internal.Int32, 0, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.bindings.discardable_memory.mojom.DiscardableSharedMemoryManagerPendingReceiver = class {
  constructor(handle) {
    this.handle = handle;
  }
};

mojo.internal.bindings.discardable_memory.mojom.DiscardableSharedMemoryManagerRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.discardable_memory.mojom.DiscardableSharedMemoryManagerPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.discardable_memory.mojom.DiscardableSharedMemoryManagerRemoteCallHandler(this.proxy);
  }
  ...
  allocateLockedDiscardableSharedMemory(arg_size, arg_id) {
    return this.$.allocateLockedDiscardableSharedMemory(arg_size, arg_id);
  }
  deletedDiscardableSharedMemory(arg_id) {
    return this.$.deletedDiscardableSharedMemory(arg_id);
  }
};
...
mojo.internal.bindings.discardable_memory.mojom.DiscardableSharedMemoryManager.getRemote = function() {
  let remote = new mojo.internal.bindings.discardable_memory.mojom.DiscardableSharedMemoryManagerRemote();
...
mojo.internal.bindings.discardable_memory.mojom.DiscardableSharedMemoryManagerReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.discardable_memory.mojom.DiscardableSharedMemoryManager_AllocateLockedDiscardableSharedMemory_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for AllocateLockedDiscardableSharedMemory failed with TypeError');
           }
        }
        // Try Method 1: DeletedDiscardableSharedMemory
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.discardable_memory.mojom.DiscardableSharedMemoryManager_DeletedDiscardableSharedMemory_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for DeletedDiscardableSharedMemory failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
        ...
        case 0: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              this.endpoint.send(header.ordinal, header.requestId, mojo.internal.kMessageFlagIsResponse, mojo.internal.bindings.discardable_memory.mojom.DiscardableSharedMemoryManager_AllocateLockedDiscardableSharedMemory_ResponseParamsSpec, response);
...
mojo.internal.bindings.discardable_memory.mojom.DiscardableSharedMemoryManagerReceiver = mojo.internal.bindings.discardable_memory.mojom.DiscardableSharedMemoryManagerReceiver;

mojo.internal.bindings.discardable_memory.mojom.DiscardableSharedMemoryManagerPtr = mojo.internal.bindings.discardable_memory.mojom.DiscardableSharedMemoryManagerRemote;
mojo.internal.bindings.discardable_memory.mojom.DiscardableSharedMemoryManagerRequest = mojo.internal.bindings.discardable_memory.mojom.DiscardableSharedMemoryManagerPendingReceiver;
