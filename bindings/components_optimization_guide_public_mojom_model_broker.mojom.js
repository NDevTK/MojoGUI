...
mojo.internal.bindings.optimization_guide.mojom.ModelNotSupportedDetailedReasonSpec = mojo.internal.bindings.optimization_guide.mojom.ModelNotSupportedDetailedReasonSpec || { $: mojo.internal.Enum().$ };
...
mojo.internal.bindings.optimization_guide.mojom.ModelSubscriber_CapabilitiesUpdated_ParamsSpec = mojo.internal.bindings.optimization_guide.mojom.ModelSubscriber_CapabilitiesUpdated_ParamsSpec || { $: {} };
if (mojo.internal.bindings.optimization_guide.mojom.ModelSubscriber_CapabilitiesUpdated_ParamsSpec.$.structSpec && mojo.internal.bindings.optimization_guide.mojom.ModelSubscriber_CapabilitiesUpdated_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.optimization_guide.mojom.ModelSubscriber_CapabilitiesUpdated_ParamsSpec.$ = {};
...
mojo.internal.bindings.optimization_guide.mojom.ModelBroker_GetConfig_ParamsSpec = mojo.internal.bindings.optimization_guide.mojom.ModelBroker_GetConfig_ParamsSpec || { $: {} };
if (mojo.internal.bindings.optimization_guide.mojom.ModelBroker_GetConfig_ParamsSpec.$.structSpec && mojo.internal.bindings.optimization_guide.mojom.ModelBroker_GetConfig_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.optimization_guide.mojom.ModelBroker_GetConfig_ParamsSpec.$ = {};
mojo.internal.bindings.optimization_guide.mojom.ModelBroker_GetConfig_ResponseParamsSpec = mojo.internal.bindings.optimization_guide.mojom.ModelBroker_GetConfig_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.optimization_guide.mojom.ModelBroker_GetConfig_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.optimization_guide.mojom.ModelBroker_GetConfig_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.optimization_guide.mojom.ModelBroker_GetConfig_ResponseParamsSpec.$ = {};
mojo.internal.bindings.optimization_guide.mojom.ModelBroker_AddModelDownloadProgressObserver_ParamsSpec = mojo.internal.bindings.optimization_guide.mojom.ModelBroker_AddModelDownloadProgressObserver_ParamsSpec || { $: {} };
if (mojo.internal.bindings.optimization_guide.mojom.ModelBroker_AddModelDownloadProgressObserver_ParamsSpec.$.structSpec && mojo.internal.bindings.optimization_guide.mojom.ModelBroker_AddModelDownloadProgressObserver_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.optimization_guide.mojom.ModelBroker_AddModelDownloadProgressObserver_ParamsSpec.$ = {};
mojo.internal.bindings.optimization_guide.mojom.ModelBroker_RequestAssetsFor_ParamsSpec = mojo.internal.bindings.optimization_guide.mojom.ModelBroker_RequestAssetsFor_ParamsSpec || { $: {} };
if (mojo.internal.bindings.optimization_guide.mojom.ModelBroker_RequestAssetsFor_ParamsSpec.$.structSpec && mojo.internal.bindings.optimization_guide.mojom.ModelBroker_RequestAssetsFor_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.optimization_guide.mojom.ModelBroker_RequestAssetsFor_ParamsSpec.$ = {};
...
mojo.internal.bindings.optimization_guide.mojom.OnDeviceFeature = {
  ...
  kProofreaderApi: 10,
  kSpeechRecognitionSmallExpertModel: 11,
};

// Enum: ModelUnavailableReason
mojo.internal.bindings.optimization_guide.mojom.ModelUnavailableReason = {
  kUnknown: 0,
  kNotSupported: 2,
  kPendingAssets: 3,
  kPendingUsage: 4,
...
mojo.internal.bindings.optimization_guide.mojom.ModelNotSupportedDetailedReason = {
  ...
  kInsufficientDiskSpaceForCaches: 10,
};

// Interface: ModelSolution
mojo.internal.bindings.optimization_guide.mojom.ModelSolutionPendingReceiver = class {
  constructor(handle) {
    this.handle = handle;
    if (handle) {
...
mojo.internal.bindings.optimization_guide.mojom.ModelSolutionRemote = class {
  ...
  constructor(handle = undefined) {
    ...
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.optimization_guide.mojom.ModelSolutionPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.optimization_guide.mojom.ModelSolutionRemoteCallHandler(this.proxy);
  }
  ...
  createSession(arg_session, arg_params) {
    return this.$.createSession(arg_session, arg_params);
  }
  createTextSafetySession(arg_session) {
    return this.$.createTextSafetySession(arg_session);
  }
...
mojo.internal.bindings.optimization_guide.mojom.ModelSolution.getRemote = function() {
  let remote = new mojo.internal.bindings.optimization_guide.mojom.ModelSolutionRemote();
...
mojo.internal.bindings.optimization_guide.mojom.ModelSolutionReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        ...
        case 2: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.optimization_guide.mojom.ModelSolution_ReportHealthyCompletion_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.optimization_guide.mojom.ModelSolutionReceiver = mojo.internal.bindings.optimization_guide.mojom.ModelSolutionReceiver;

mojo.internal.bindings.optimization_guide.mojom.ModelSolutionPtr = mojo.internal.bindings.optimization_guide.mojom.ModelSolutionRemote;
mojo.internal.bindings.optimization_guide.mojom.ModelSolutionRequest = mojo.internal.bindings.optimization_guide.mojom.ModelSolutionPendingReceiver;


// Interface: ModelSubscriber
mojo.internal.bindings.optimization_guide.mojom.ModelSubscriberPendingReceiver = class {
  constructor(handle) {
    this.handle = handle;
    if (handle) {
      this.__mojoHandle = handle.router_ ? handle.router_.pipe_ : (handle.pipe_ || handle);
...
mojo.internal.bindings.optimization_guide.mojom.ModelSubscriberRemote = class {
  static get $interfaceName() {
  ...
  constructor(handle = undefined) {
    this.__mojoHandle = handle;
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.optimization_guide.mojom.ModelSubscriberPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.optimization_guide.mojom.ModelSubscriberRemoteCallHandler(this.proxy);
  }
  ...
  unavailable(arg_reason, arg_detailed_reason) {
    return this.$.unavailable(arg_reason, arg_detailed_reason);
  }
  available(arg_config, arg_solution) {
    return this.$.available(arg_config, arg_solution);
  }
  capabilitiesUpdated(arg_capabilities) {
    return this.$.capabilitiesUpdated(arg_capabilities);
  }
};
...
mojo.internal.bindings.optimization_guide.mojom.ModelSubscriberRemoteCallHandler = class {
  ...
  unavailable(arg_reason, arg_detailed_reason) {
    return this.proxy.sendMessage(
      ...
      mojo.internal.bindings.optimization_guide.mojom.ModelSubscriber_Unavailable_ParamsSpec,
      null,
      [arg_reason, arg_detailed_reason],
      false);
  }
...
mojo.internal.bindings.optimization_guide.mojom.ModelSubscriber.getRemote = function() {
  let remote = new mojo.internal.bindings.optimization_guide.mojom.ModelSubscriberRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
...
mojo.internal.bindings.optimization_guide.mojom.ModelSubscriberReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        case 0: {
          ...
          const result = this.impl.unavailable(params.arg_reason, params.arg_detailed_reason);
          break;
        }
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
        ...
        case 2: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.optimization_guide.mojom.ModelSubscriber_CapabilitiesUpdated_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.capabilitiesUpdated');
          const result = this.impl.capabilitiesUpdated(params.arg_capabilities);
          break;
        }
      }
      } catch (err) {
...
mojo.internal.bindings.optimization_guide.mojom.ModelSubscriberReceiver = mojo.internal.bindings.optimization_guide.mojom.ModelSubscriberReceiver;

mojo.internal.bindings.optimization_guide.mojom.ModelSubscriberPtr = mojo.internal.bindings.optimization_guide.mojom.ModelSubscriberRemote;
mojo.internal.bindings.optimization_guide.mojom.ModelSubscriberRequest = mojo.internal.bindings.optimization_guide.mojom.ModelSubscriberPendingReceiver;


// Interface: ModelBroker
mojo.internal.bindings.optimization_guide.mojom.ModelBrokerPendingReceiver = class {
  constructor(handle) {
    this.handle = handle;
    if (handle) {
      this.__mojoHandle = handle.router_ ? handle.router_.pipe_ : (handle.pipe_ || handle);
...
mojo.internal.bindings.optimization_guide.mojom.ModelBrokerRemote = class {
  static get $interfaceName() {
  ...
  constructor(handle = undefined) {
    this.__mojoHandle = handle;
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.optimization_guide.mojom.ModelBrokerPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.optimization_guide.mojom.ModelBrokerRemoteCallHandler(this.proxy);
  }
  ...
  subscribe(arg_options, arg_subscriber) {
    return this.$.subscribe(arg_options, arg_subscriber);
  }
  getConfig(arg_feature) {
    return this.$.getConfig(arg_feature);
  }
  addModelDownloadProgressObserver(arg_use_case, arg_observer) {
    return this.$.addModelDownloadProgressObserver(arg_use_case, arg_observer);
  }
  requestAssetsFor(arg_use_case) {
    return this.$.requestAssetsFor(arg_use_case);
  }
};
...
mojo.internal.bindings.optimization_guide.mojom.ModelBrokerRemoteCallHandler = class {
  ...
  getConfig(arg_feature) {
    return this.proxy.sendMessage(
      this.ordinals[1],  // ordinal
      mojo.internal.bindings.optimization_guide.mojom.ModelBroker_GetConfig_ParamsSpec,
      mojo.internal.bindings.optimization_guide.mojom.ModelBroker_GetConfig_ResponseParamsSpec,
      [arg_feature],
      false);
  }
...
mojo.internal.bindings.optimization_guide.mojom.ModelBroker.getRemote = function() {
  let remote = new mojo.internal.bindings.optimization_guide.mojom.ModelBrokerRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
...
mojo.internal.bindings.optimization_guide.mojom.ModelBrokerReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        case 0: {
          ...
          const result = this.impl.subscribe(params.arg_options, params.arg_subscriber);
          break;
        }
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.optimization_guide.mojom.ModelBroker_GetConfig_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.getConfig');
          const result = this.impl.getConfig(params.arg_feature);
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const message = new mojo.internal.Message(
                ...
                header.ordinal, header.requestId, mojo.internal.bindings.optimization_guide.mojom.ModelBroker_GetConfig_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
            }).catch(e => console.error('[GeneratedReceiver] getConfig FAILED:', e));
          }
          break;
        }
        case 2: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.optimization_guide.mojom.ModelBroker_AddModelDownloadProgressObserver_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.addModelDownloadProgressObserver');
          const result = this.impl.addModelDownloadProgressObserver(params.arg_use_case, params.arg_observer);
          break;
        }
        case 3: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.optimization_guide.mojom.ModelBroker_RequestAssetsFor_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.requestAssetsFor');
          const result = this.impl.requestAssetsFor(params.arg_use_case);
          break;
        }
      }
      } catch (err) {
...
mojo.internal.bindings.optimization_guide.mojom.ModelBrokerReceiver = mojo.internal.bindings.optimization_guide.mojom.ModelBrokerReceiver;

mojo.internal.bindings.optimization_guide.mojom.ModelBrokerPtr = mojo.internal.bindings.optimization_guide.mojom.ModelBrokerRemote;
mojo.internal.bindings.optimization_guide.mojom.ModelBrokerRequest = mojo.internal.bindings.optimization_guide.mojom.ModelBrokerPendingReceiver;
...
mojo.internal.Struct(
    mojo.internal.bindings.optimization_guide.mojom.ModelSolutionConfigSpec, 'optimization_guide.mojom.ModelSolutionConfig', [
      ...
      mojo.internal.StructField('arg_model_capabilities', 24, 0, mojo.internal.bindings.on_device_model.mojom.CapabilitiesSpec, null, false, 0, undefined),
    ],
    [[0, 40]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.optimization_guide.mojom.ModelSubscriptionOptionsSpec, 'optimization_guide.mojom.ModelSubscriptionOptions', [
      mojo.internal.StructField('arg_use_case', 0, 0, mojo.internal.String, null, false, 0, undefined),
    ],
    [[0, 16]]);
mojo.internal.Struct(
...
mojo.internal.Struct(
    mojo.internal.bindings.optimization_guide.mojom.ModelSolution_ReportHealthyCompletion_ParamsSpec, 'optimization_guide.mojom.ModelSolution_ReportHealthyCompletion_Params', [
    ],
    [[0, 8]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.optimization_guide.mojom.ModelSubscriber_Unavailable_ParamsSpec, 'optimization_guide.mojom.ModelSubscriber_Unavailable_Params', [
      ...
      mojo.internal.StructField('arg_detailed_reason', 4, 0, mojo.internal.bindings.optimization_guide.mojom.ModelNotSupportedDetailedReasonSpec, null, true, 0, undefined),
    ],
    [[0, 16]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.optimization_guide.mojom.ModelSubscriber_CapabilitiesUpdated_ParamsSpec, 'optimization_guide.mojom.ModelSubscriber_CapabilitiesUpdated_Params', [
...
mojo.internal.Struct(
    mojo.internal.bindings.optimization_guide.mojom.ModelBroker_Subscribe_ParamsSpec, 'optimization_guide.mojom.ModelBroker_Subscribe_Params', [
      ...
      mojo.internal.StructField('arg_subscriber', 8, 0, mojo.internal.InterfaceProxy(mojo.internal.bindings.optimization_guide.mojom.ModelSubscriberRemote), null, false, 0, undefined),
    ],
    [[0, 24]]);

mojo.internal.Struct(
    mojo.internal.bindings.optimization_guide.mojom.ModelBroker_GetConfig_ParamsSpec, 'optimization_guide.mojom.ModelBroker_GetConfig_Params', [
...
mojo.internal.Struct(
    mojo.internal.bindings.optimization_guide.mojom.ModelBroker_GetConfig_ResponseParamsSpec, 'optimization_guide.mojom.ModelBroker_GetConfig_ResponseParams', [
      mojo.internal.StructField('arg_config', 0, 0, mojo.internal.bindings.mojo_base.mojom.ProtoWrapperSpec, null, true, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.optimization_guide.mojom.ModelBroker_AddModelDownloadProgressObserver_ParamsSpec, 'optimization_guide.mojom.ModelBroker_AddModelDownloadProgressObserver_Params', [
      mojo.internal.StructField('arg_use_case', 0, 0, mojo.internal.String, null, false, 0, undefined),
      mojo.internal.StructField('arg_observer', 8, 0, mojo.internal.InterfaceProxy(mojo.internal.bindings.on_device_model.mojom.DownloadObserverRemote), null, false, 0, undefined),
    ],
    [[0, 24]]);

mojo.internal.Struct(
    mojo.internal.bindings.optimization_guide.mojom.ModelBroker_RequestAssetsFor_ParamsSpec, 'optimization_guide.mojom.ModelBroker_RequestAssetsFor_Params', [
      mojo.internal.StructField('arg_use_case', 0, 0, mojo.internal.String, null, false, 0, undefined),
    ],
    [[0, 16]]);
