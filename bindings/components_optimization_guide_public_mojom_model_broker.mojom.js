...
optimization_guide.mojom.ModelSolution_CreateSession_ParamsSpec = {
  $: {
    structSpec: {
      name: 'optimization_guide.mojom.ModelSolution_CreateSession_Params',
      packedSize: 24,
      fields: [
...
optimization_guide.mojom.ModelSolution_CreateTextSafetySession_ParamsSpec = {
  $: {
    structSpec: {
      name: 'optimization_guide.mojom.ModelSolution_CreateTextSafetySession_Params',
      packedSize: 16,
      fields: [
...
optimization_guide.mojom.ModelSolution_ReportHealthyCompletion_ParamsSpec = {
  $: {
    structSpec: {
      name: 'optimization_guide.mojom.ModelSolution_ReportHealthyCompletion_Params',
      packedSize: 8,
      fields: [
      ],
...
optimization_guide.mojom.ModelSubscriber_Unavailable_ParamsSpec = {
  $: {
    structSpec: {
      name: 'optimization_guide.mojom.ModelSubscriber_Unavailable_Params',
      packedSize: 16,
      fields: [
...
optimization_guide.mojom.ModelSubscriber_Available_ParamsSpec = {
  $: {
    structSpec: {
      name: 'optimization_guide.mojom.ModelSubscriber_Available_Params',
      packedSize: 24,
      fields: [
...
optimization_guide.mojom.ModelBroker_Subscribe_ParamsSpec = {
  $: {
    structSpec: {
      name: 'optimization_guide.mojom.ModelBroker_Subscribe_Params',
      packedSize: 24,
      fields: [
