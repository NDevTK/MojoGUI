...
mojo.internal.bindings.optimization_guide.mojom.ModelBrokerRemote = class {
  ...
  addModelDownloadProgressObserver(arg_observer) {
    return this.$.addModelDownloadProgressObserver(arg_observer);
  }
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        ...
        case 2: {
          ...
          const result = this.impl.addModelDownloadProgressObserver(params.arg_observer);
          break;
        }
        case 3: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
...
mojo.internal.Struct(
    mojo.internal.bindings.optimization_guide.mojom.ModelBroker_AddModelDownloadProgressObserver_ParamsSpec, 'optimization_guide.mojom.ModelBroker_AddModelDownloadProgressObserver_Params', [
      mojo.internal.StructField('arg_observer', 0, 0, mojo.internal.InterfaceProxy(mojo.internal.bindings.on_device_model.mojom.DownloadObserverRemote), null, false, 0, undefined),
    ],
    [[0, 16]]);
