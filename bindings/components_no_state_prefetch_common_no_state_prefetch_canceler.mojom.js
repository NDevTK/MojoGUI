...
mojo.internal.bindings.prerender.mojom.NoStatePrefetchCancelerRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.prerender.mojom.NoStatePrefetchCancelerPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.prerender.mojom.NoStatePrefetchCancelerRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.prerender.mojom.NoStatePrefetchCanceler.getRemote = function() {
  let remote = new mojo.internal.bindings.prerender.mojom.NoStatePrefetchCancelerRemote();
...
mojo.internal.bindings.prerender.mojom.NoStatePrefetchCancelerReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.prerender.mojom.NoStatePrefetchCanceler_CancelNoStatePrefetchForUnsupportedScheme_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for CancelNoStatePrefetchForUnsupportedScheme failed with TypeError');
           }
        }
        // Try Method 1: CancelNoStatePrefetchAfterSubresourcesDiscovered
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.prerender.mojom.NoStatePrefetchCanceler_CancelNoStatePrefetchAfterSubresourcesDiscovered_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for CancelNoStatePrefetchAfterSubresourcesDiscovered failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.prerender.mojom.NoStatePrefetchCanceler_CancelNoStatePrefetchForUnsupportedScheme_ParamsSpec.$.structSpec);
        ...
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.prerender.mojom.NoStatePrefetchCanceler_CancelNoStatePrefetchAfterSubresourcesDiscovered_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.prerender.mojom.NoStatePrefetchCancelerReceiver = mojo.internal.bindings.prerender.mojom.NoStatePrefetchCancelerReceiver;
