...
mojo.internal.bindings.ash.common.mojom.ShortcutInputObserverRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.ash.common.mojom.ShortcutInputObserverPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.ash.common.mojom.ShortcutInputObserverRemoteCallHandler(this.proxy);
  }
  ...
  onShortcutInputEventPressed(arg_prerewritten_key_event, arg_key_event) {
    return this.$.onShortcutInputEventPressed(arg_prerewritten_key_event, arg_key_event);
  }
  onShortcutInputEventReleased(arg_prerewritten_key_event, arg_key_event) {
    return this.$.onShortcutInputEventReleased(arg_prerewritten_key_event, arg_key_event);
  }
};
...
mojo.internal.bindings.ash.common.mojom.ShortcutInputObserver.getRemote = function() {
  let remote = new mojo.internal.bindings.ash.common.mojom.ShortcutInputObserverRemote();
...
mojo.internal.bindings.ash.common.mojom.ShortcutInputObserverReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ash.common.mojom.ShortcutInputObserver_OnShortcutInputEventPressed_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OnShortcutInputEventPressed failed with TypeError');
           }
        }
        // Try Method 1: OnShortcutInputEventReleased
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ash.common.mojom.ShortcutInputObserver_OnShortcutInputEventReleased_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OnShortcutInputEventReleased failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.ash.common.mojom.ShortcutInputObserverReceiver = mojo.internal.bindings.ash.common.mojom.ShortcutInputObserverReceiver;

mojo.internal.bindings.ash.common.mojom.ShortcutInputObserverPtr = mojo.internal.bindings.ash.common.mojom.ShortcutInputObserverRemote;
mojo.internal.bindings.ash.common.mojom.ShortcutInputObserverRequest = mojo.internal.bindings.ash.common.mojom.ShortcutInputObserverPendingReceiver;
...
mojo.internal.bindings.ash.common.mojom.ShortcutInputProviderRemote = class {
  static get $interfaceName() {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.ash.common.mojom.ShortcutInputProviderPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.ash.common.mojom.ShortcutInputProviderRemoteCallHandler(this.proxy);
  }
  ...
  startObservingShortcutInput(arg_observer) {
    return this.$.startObservingShortcutInput(arg_observer);
  }
...
mojo.internal.bindings.ash.common.mojom.ShortcutInputProvider.getRemote = function() {
  let remote = new mojo.internal.bindings.ash.common.mojom.ShortcutInputProviderRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
...
mojo.internal.bindings.ash.common.mojom.ShortcutInputProviderReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ash.common.mojom.ShortcutInputProvider_StartObservingShortcutInput_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for StartObservingShortcutInput failed with TypeError');
           }
        }
        // Try Method 1: StopObservingShortcutInput
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ash.common.mojom.ShortcutInputProvider_StopObservingShortcutInput_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for StopObservingShortcutInput failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
             console.warn('[GeneratedReceiver] Failed to discover ordinal ' + header.ordinal);
      ...
      switch (dispatchId) {
        ...
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.ash.common.mojom.ShortcutInputProvider_StopObservingShortcutInput_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.ash.common.mojom.ShortcutInputProviderReceiver = mojo.internal.bindings.ash.common.mojom.ShortcutInputProviderReceiver;
