...
mojo.internal.bindings.chromecast.mojom.AudioSocketBroker = {};
mojo.internal.bindings.chromecast.mojom.AudioSocketBrokerSpec = { $ : {} };
mojo.internal.bindings.chromecast.mojom.AudioSocketBroker.$interfaceName = 'chromecast.mojom.AudioSocketBroker';
...
mojo.internal.bindings.chromecast.mojom.AudioSocketBrokerRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.chromecast.mojom.AudioSocketBrokerPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.chromecast.mojom.AudioSocketBrokerRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.chromecast.mojom.AudioSocketBrokerRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('chromecast.mojom.AudioSocketBroker', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.chromecast.mojom.AudioSocketBroker.getRemote = function() {
  let remote = new mojo.internal.bindings.chromecast.mojom.AudioSocketBrokerRemote();
...
mojo.internal.bindings.chromecast.mojom.AudioSocketBrokerReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('chromecast.mojom.AudioSocketBroker', [
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.chromecast.mojom.AudioSocketBroker_GetSocketDescriptor_ParamsSpec.$.structSpec);
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.chromecast.mojom.AudioSocketBroker_GetSocketDescriptor_ParamsSpec.$.structSpec);
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.chromecast.mojom.AudioSocketBroker_GetSocketDescriptor_ResponseParamsSpec, header, rawHeader);
               responder(response);
...
mojo.internal.bindings.chromecast.mojom.AudioSocketBrokerReceiver = mojo.internal.bindings.chromecast.mojom.AudioSocketBrokerReceiver;
