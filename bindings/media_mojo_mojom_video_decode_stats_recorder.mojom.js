...
mojo.internal.bindings.media.mojom.VideoDecodeStatsRecorder = {};
mojo.internal.bindings.media.mojom.VideoDecodeStatsRecorderSpec = { $ : {} };
mojo.internal.bindings.media.mojom.VideoDecodeStatsRecorder.$interfaceName = 'media.mojom.VideoDecodeStatsRecorder';
...
mojo.internal.bindings.media.mojom.VideoDecodeStatsRecorderRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.media.mojom.VideoDecodeStatsRecorderPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.media.mojom.VideoDecodeStatsRecorderRemoteCallHandler(this.proxy);
  }
  ...
  startNewRecord(arg_features) {
    return this.$.startNewRecord(arg_features);
  }
  updateRecord(arg_targets) {
    return this.$.updateRecord(arg_targets);
  }
};

mojo.internal.bindings.media.mojom.VideoDecodeStatsRecorderRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('media.mojom.VideoDecodeStatsRecorder', [
      { explicit: null },
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.media.mojom.VideoDecodeStatsRecorder.getRemote = function() {
  let remote = new mojo.internal.bindings.media.mojom.VideoDecodeStatsRecorderRemote();
...
mojo.internal.bindings.media.mojom.VideoDecodeStatsRecorderReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('media.mojom.VideoDecodeStatsRecorder', [
      { explicit: null },
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.media.mojom.VideoDecodeStatsRecorder_StartNewRecord_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for StartNewRecord failed with TypeError');
           }
        }
        // Try Method 1: UpdateRecord
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.media.mojom.VideoDecodeStatsRecorder_UpdateRecord_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
...
mojo.internal.bindings.media.mojom.VideoDecodeStatsRecorderReceiver = mojo.internal.bindings.media.mojom.VideoDecodeStatsRecorderReceiver;
