...
mojo.internal.bindings.blink.mojom.ImageDownloader = {};
mojo.internal.bindings.blink.mojom.ImageDownloaderSpec = { $ : {} };
mojo.internal.bindings.blink.mojom.ImageDownloader.$interfaceName = 'blink.mojom.ImageDownloader';
...
mojo.internal.bindings.blink.mojom.ImageDownloaderRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.blink.mojom.ImageDownloaderPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.blink.mojom.ImageDownloaderRemoteCallHandler(this.proxy);
  }
  ...
  downloadImage(arg_url, arg_is_favicon, arg_preferred_size, arg_max_bitmap_size, arg_bypass_cache) {
    return this.$.downloadImage(arg_url, arg_is_favicon, arg_preferred_size, arg_max_bitmap_size, arg_bypass_cache);
  }
  downloadImageFromAxNode(arg_ax_node_id, arg_preferred_size, arg_max_bitmap_size, arg_bypass_cache) {
    return this.$.downloadImageFromAxNode(arg_ax_node_id, arg_preferred_size, arg_max_bitmap_size, arg_bypass_cache);
  }
};

mojo.internal.bindings.blink.mojom.ImageDownloaderRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('blink.mojom.ImageDownloader', [
      { explicit: null },
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.blink.mojom.ImageDownloader.getRemote = function() {
  let remote = new mojo.internal.bindings.blink.mojom.ImageDownloaderRemote();
...
mojo.internal.bindings.blink.mojom.ImageDownloaderReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('blink.mojom.ImageDownloader', [
      { explicit: null },
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.blink.mojom.ImageDownloader_DownloadImage_ParamsSpec.$.structSpec);
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.blink.mojom.ImageDownloader_DownloadImageFromAxNode_ParamsSpec.$.structSpec);
      ...
      switch (dispatchId) {
        case 0: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.blink.mojom.ImageDownloader_DownloadImage_ResponseParamsSpec, header, rawHeader);
               responder(response);
        ...
        case 1: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              const rawHeader = (args[2] && args[2].slice) ? args[2].slice(0, header.headerSize) : null;
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.blink.mojom.ImageDownloader_DownloadImageFromAxNode_ResponseParamsSpec, header, rawHeader);
               responder(response);
...
mojo.internal.bindings.blink.mojom.ImageDownloaderReceiver = mojo.internal.bindings.blink.mojom.ImageDownloaderReceiver;
