...
mojo.internal.bindings.network.mojom.CookieAccessDetailsSpec = { $: {} };
mojo.internal.bindings.network.mojom.CookieAccessObserver = {};
mojo.internal.bindings.network.mojom.CookieAccessObserverSpec = { $ : {} };
mojo.internal.bindings.network.mojom.CookieAccessObserver.$interfaceName = 'network.mojom.CookieAccessObserver';
...
mojo.internal.Struct(
    mojo.internal.bindings.network.mojom.CookieAccessDetailsSpec, 'network.mojom.CookieAccessDetails', [
      ...
      mojo.internal.StructField('arg_is_ad_tagged', 64, 0, mojo.internal.Bool, false, false, 0, undefined),
    ],
    [[0, 80]]);
...
mojo.internal.bindings.network.mojom.CookieAccessObserverRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.network.mojom.CookieAccessObserverPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.network.mojom.CookieAccessObserverRemoteCallHandler(this.proxy);
  }
  ...
  onCookiesAccessed(arg_details) {
    return this.$.onCookiesAccessed(arg_details);
  }
  clone(arg_listener) {
...
mojo.internal.bindings.network.mojom.CookieAccessObserverRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('network.mojom.CookieAccessObserver', [
      { explicit: null },
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.network.mojom.CookieAccessObserver.getRemote = function() {
  let remote = new mojo.internal.bindings.network.mojom.CookieAccessObserverRemote();
...
mojo.internal.bindings.network.mojom.CookieAccessObserverReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('network.mojom.CookieAccessObserver', [
      { explicit: null },
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.network.mojom.CookieAccessObserver_OnCookiesAccessed_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OnCookiesAccessed failed with TypeError');
           }
        }
        // Try Method 1: Clone
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.network.mojom.CookieAccessObserver_Clone_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
...
mojo.internal.bindings.network.mojom.CookieAccessObserverReceiver = mojo.internal.bindings.network.mojom.CookieAccessObserverReceiver;
