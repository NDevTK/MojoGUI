...
mojo.internal.bindings.network.mojom.WebBundleErrorType = {
...
mojo.internal.Struct(
    mojo.internal.bindings.network.mojom.WebBundleHandle_OnWebBundleError_ParamsSpec, 'network.mojom.WebBundleHandle_OnWebBundleError_Params', [
      ...
      mojo.internal.StructField('arg_type', 8, 0, mojo.internal.bindings.network.mojom.WebBundleErrorTypeSpec, null, false, 0, undefined),
    ],
    [[0, 24]]);
...
mojo.internal.bindings.network.mojom.WebBundleHandleRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.network.mojom.WebBundleHandleRemoteCallHandler(this.proxy);
  }
  ...
  onWebBundleError(arg_type, arg_message) {
    return this.$.onWebBundleError(arg_type, arg_message);
  }
  onWebBundleLoadFinished(arg_success) {
    return this.$.onWebBundleLoadFinished(arg_success);
  }
};
...
mojo.internal.bindings.network.mojom.WebBundleHandle.getRemote = function() {
  let remote = new mojo.internal.bindings.network.mojom.WebBundleHandleRemote();
...
mojo.internal.bindings.network.mojom.WebBundleHandleReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.network.mojom.WebBundleHandle_Clone_ParamsSpec.$.structSpec;
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.network.mojom.WebBundleHandle_OnWebBundleError_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OnWebBundleError failed with TypeError');
           }
        }
        // Try Method 2: OnWebBundleLoadFinished
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.network.mojom.WebBundleHandle_OnWebBundleLoadFinished_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OnWebBundleLoadFinished failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.network.mojom.WebBundleHandleReceiver = mojo.internal.bindings.network.mojom.WebBundleHandleReceiver;
