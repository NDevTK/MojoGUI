...
mojo.internal.bindings.webnn = mojo.internal.bindings.webnn || {};
mojo.internal.bindings.webnn.mojom = mojo.internal.bindings.webnn.mojom || {};
mojo.internal.bindings.webnn.mojom.WebNNModelLoaderSpec = mojo.internal.bindings.webnn.mojom.WebNNModelLoaderSpec || { $: mojo.internal.OpaqueStruct.$ };
mojo.internal.bindings.webnn.mojom.WebNNModelLoaderRemote = mojo.internal.bindings.webnn.mojom.WebNNModelLoaderRemote || class {};
mojo.internal.bindings.webnn.mojom.WebNNModelLoaderPendingReceiver = mojo.internal.bindings.webnn.mojom.WebNNModelLoaderPendingReceiver || class { constructor(handle) { this.handle = handle; } };
...
mojo.internal.bindings.viz.mojom.GpuHostRemote = class {
  ...
  requestWebNNCompilerContext(arg_context_options, arg_context_properties, arg_target_device, arg_compiler_context_receiver, arg_model_loader_remote) {
    return this.$.requestWebNNCompilerContext(arg_context_options, arg_context_properties, arg_target_device, arg_compiler_context_receiver, arg_model_loader_remote);
  }
...
mojo.internal.Struct(
    mojo.internal.bindings.viz.mojom.GpuHost_RequestWebNNCompilerContext_ParamsSpec, 'viz.mojom.GpuHost_RequestWebNNCompilerContext_Params', [
      ...
      mojo.internal.StructField('arg_compiler_context_receiver', 24, 0, mojo.internal.InterfaceRequest(mojo.internal.bindings.webnn.mojom.WebNNCompilerContextPendingReceiver), null, false, 0, undefined),
