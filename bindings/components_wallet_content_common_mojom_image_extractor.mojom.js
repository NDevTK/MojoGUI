...
mojo.internal.bindings.wallet.mojom.ImageExtractorRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.wallet.mojom.ImageExtractorPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.wallet.mojom.ImageExtractorRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.wallet.mojom.ImageExtractorRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('wallet.mojom.ImageExtractor', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.wallet.mojom.ImageExtractor.getRemote = function() {
  let remote = new mojo.internal.bindings.wallet.mojom.ImageExtractorRemote();
...
mojo.internal.bindings.wallet.mojom.ImageExtractorReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('wallet.mojom.ImageExtractor', [
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.wallet.mojom.ImageExtractor_ExtractImages_ParamsSpec.$.structSpec);
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.wallet.mojom.ImageExtractor_ExtractImages_ParamsSpec.$.structSpec);
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.wallet.mojom.ImageExtractor_ExtractImages_ResponseParamsSpec, header, rawHeader);
               responder(response);
...
mojo.internal.bindings.wallet.mojom.ImageExtractorReceiver = mojo.internal.bindings.wallet.mojom.ImageExtractorReceiver;
