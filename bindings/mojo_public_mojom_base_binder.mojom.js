...
mojo.internal.bindings.mojo_base.mojom.Binder = {};
mojo.internal.bindings.mojo_base.mojom.BinderSpec = { $ : {} };
...
mojo.internal.bindings.mojo_base.mojom.BinderRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.mojo_base.mojom.BinderPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.mojo_base.mojom.BinderRemoteCallHandler(this.proxy);
  }
  ...
  bind(arg_receiver) {
    return this.$.bind(arg_receiver);
  }
};

mojo.internal.bindings.mojo_base.mojom.BinderRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('mojo_base.mojom.Binder', [
      { explicit: 0 },
    ]);
  }
...
mojo.internal.bindings.mojo_base.mojom.Binder.getRemote = function() {
  let remote = new mojo.internal.bindings.mojo_base.mojom.BinderRemote();
...
mojo.internal.bindings.mojo_base.mojom.BinderReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('mojo_base.mojom.Binder', [
      { explicit: 0 },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.mojo_base.mojom.Binder_Bind_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.mojo_base.mojom.BinderReceiver = mojo.internal.bindings.mojo_base.mojom.BinderReceiver;
