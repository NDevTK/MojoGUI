...
mojo.internal.bindings.legion.mojom.OakSessionRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.legion.mojom.OakSessionPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.legion.mojom.OakSessionRemoteCallHandler(this.proxy);
  }
  ...
  completeHandshake(arg_response) {
    return this.$.completeHandshake(arg_response);
  }
  encrypt(arg_input) {
    return this.$.encrypt(arg_input);
  }
  decrypt(arg_input) {
    return this.$.decrypt(arg_input);
  }
};
...
mojo.internal.bindings.legion.mojom.OakSession.getRemote = function() {
  let remote = new mojo.internal.bindings.legion.mojom.OakSessionRemote();
...
mojo.internal.bindings.legion.mojom.OakSessionReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.legion.mojom.OakSession_InitiateHandshake_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for InitiateHandshake failed with TypeError');
           }
        }
        // Try Method 1: CompleteHandshake
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.legion.mojom.OakSession_CompleteHandshake_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for CompleteHandshake failed with TypeError');
           }
        }
        // Try Method 2: Encrypt
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.legion.mojom.OakSession_Encrypt_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for Encrypt failed with TypeError');
           }
        }
        // Try Method 3: Decrypt
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.legion.mojom.OakSession_Decrypt_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.legion.mojom.OakSession_InitiateHandshake_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.legion.mojom.OakSessionReceiver = mojo.internal.bindings.legion.mojom.OakSessionReceiver;
