...
autofill.mojom.mojom.AutofillDriver = {};

autofill.mojom.mojom.AutofillDriverPendingReceiver = class {
  constructor(handle) {
    this.handle = handle;
  }
};

autofill.mojom.mojom.AutofillDriverRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      autofill.mojom.mojom.AutofillDriverPendingReceiver,
      handle);
    this.$ = new autofill.mojom.mojom.AutofillDriverRemoteCallHandler(this.proxy);
  }
...
autofill.mojom.mojom.AutofillDriverRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
  }
  ...
  formsSeen(updated_forms, removed_forms) {
    ...
    return this.proxy.sendMessage(
      0,  // ordinal
      autofill.mojom.mojom.AutofillDriver_FormsSeen_ParamsSpec,
      null,
  ...
  formSubmitted(form, source) {
    ...
    return this.proxy.sendMessage(
      1,  // ordinal
      autofill.mojom.mojom.AutofillDriver_FormSubmitted_ParamsSpec,
      null,
      [form, source]);
  }
  ...
  caretMovedInFormField(form, field_id, caret_bounds) {
    ...
    return this.proxy.sendMessage(
      2,  // ordinal
      autofill.mojom.mojom.AutofillDriver_CaretMovedInFormField_ParamsSpec,
      null,
  ...
  textFieldValueChanged(form, field_id, timestamp) {
    ...
    return this.proxy.sendMessage(
      3,  // ordinal
      autofill.mojom.mojom.AutofillDriver_TextFieldValueChanged_ParamsSpec,
      null,
  ...
  didEndTextFieldEditing() {
    ...
    return this.proxy.sendMessage(
      4,  // ordinal
      autofill.mojom.mojom.AutofillDriver_DidEndTextFieldEditing_ParamsSpec,
      null,
      []);
  }
  ...
  textFieldDidScroll(form, field_id) {
    ...
    return this.proxy.sendMessage(
      5,  // ordinal
      autofill.mojom.mojom.AutofillDriver_TextFieldDidScroll_ParamsSpec,
      null,
      [form, field_id]);
  }
  ...
  selectControlSelectionChanged(form, field_id) {
    ...
    return this.proxy.sendMessage(
      6,  // ordinal
      autofill.mojom.mojom.AutofillDriver_SelectControlSelectionChanged_ParamsSpec,
      null,
      [form, field_id]);
  }
  ...
  selectFieldOptionsDidChange(form, field_id) {
    ...
    return this.proxy.sendMessage(
      7,  // ordinal
      autofill.mojom.mojom.AutofillDriver_SelectFieldOptionsDidChange_ParamsSpec,
      null,
      [form, field_id]);
  }
  ...
  focusOnFormField(form, field_id) {
    ...
    return this.proxy.sendMessage(
      8,  // ordinal
      autofill.mojom.mojom.AutofillDriver_FocusOnFormField_ParamsSpec,
      null,
      [form, field_id]);
  }
  ...
  focusOnNonFormField() {
    ...
    return this.proxy.sendMessage(
      9,  // ordinal
      autofill.mojom.mojom.AutofillDriver_FocusOnNonFormField_ParamsSpec,
      null,
      []);
  }
  ...
  askForValuesToFill(form, field_id, caret_bounds, trigger_source, password_request) {
    ...
    return this.proxy.sendMessage(
      10,  // ordinal
      autofill.mojom.mojom.AutofillDriver_AskForValuesToFill_ParamsSpec,
      null,
  ...
  hidePopup() {
    ...
    return this.proxy.sendMessage(
      11,  // ordinal
      autofill.mojom.mojom.AutofillDriver_HidePopup_ParamsSpec,
      null,
      []);
  }
  ...
  didAutofillForm(form) {
    ...
    return this.proxy.sendMessage(
      12,  // ordinal
      autofill.mojom.mojom.AutofillDriver_DidAutofillForm_ParamsSpec,
      null,
      [form]);
  }
  ...
  suppressAutomaticRefills(fill_id) {
    ...
    return this.proxy.sendMessage(
      13,  // ordinal
      autofill.mojom.mojom.AutofillDriver_SuppressAutomaticRefills_ParamsSpec,
      null,
      [fill_id]);
  }
  ...
  requestRefill(fill_id) {
    ...
    return this.proxy.sendMessage(
      14,  // ordinal
      autofill.mojom.mojom.AutofillDriver_RequestRefill_ParamsSpec,
      null,
      [fill_id]);
  }
  ...
  javaScriptChangedAutofilledValue(form, field_id, old_value) {
    ...
    return this.proxy.sendMessage(
      15,  // ordinal
      autofill.mojom.mojom.AutofillDriver_JavaScriptChangedAutofilledValue_ParamsSpec,
      null,
...
autofill.mojom.mojom.AutofillDriver.getRemote = function() {
  let remote = new autofill.mojom.mojom.AutofillDriverRemote();
...
autofill.mojom.mojom.AutofillDriverPtr = autofill.mojom.mojom.AutofillDriverRemote;
autofill.mojom.mojom.AutofillDriverRequest = autofill.mojom.mojom.AutofillDriverPendingReceiver;


// Interface: PasswordManagerDriver
autofill.mojom.mojom.PasswordManagerDriver = {};

autofill.mojom.mojom.PasswordManagerDriverPendingReceiver = class {
  constructor(handle) {
    this.handle = handle;
  }
};

autofill.mojom.mojom.PasswordManagerDriverRemote = class {
  static get $interfaceName() {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      autofill.mojom.mojom.PasswordManagerDriverPendingReceiver,
      handle);
    this.$ = new autofill.mojom.mojom.PasswordManagerDriverRemoteCallHandler(this.proxy);
  }
...
autofill.mojom.mojom.PasswordManagerDriverRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
  }
  ...
  passwordFormsParsed(forms_data) {
    ...
    return this.proxy.sendMessage(
      0,  // ordinal
      autofill.mojom.mojom.PasswordManagerDriver_PasswordFormsParsed_ParamsSpec,
      null,
      [forms_data]);
  }
  ...
  passwordFormsRendered(visible_forms_data) {
    ...
    return this.proxy.sendMessage(
      1,  // ordinal
      autofill.mojom.mojom.PasswordManagerDriver_PasswordFormsRendered_ParamsSpec,
      null,
      [visible_forms_data]);
  }
  ...
  passwordFormSubmitted(form_data) {
    ...
    return this.proxy.sendMessage(
      2,  // ordinal
      autofill.mojom.mojom.PasswordManagerDriver_PasswordFormSubmitted_ParamsSpec,
      null,
      [form_data]);
  }
  ...
  informAboutUserInput(form_data) {
    ...
    return this.proxy.sendMessage(
      3,  // ordinal
      autofill.mojom.mojom.PasswordManagerDriver_InformAboutUserInput_ParamsSpec,
      null,
      [form_data]);
  }
  ...
  dynamicFormSubmission(submission_indication_event) {
    ...
    return this.proxy.sendMessage(
      4,  // ordinal
      autofill.mojom.mojom.PasswordManagerDriver_DynamicFormSubmission_ParamsSpec,
      null,
  ...
  passwordFormCleared(form_data) {
    ...
    return this.proxy.sendMessage(
      5,  // ordinal
      autofill.mojom.mojom.PasswordManagerDriver_PasswordFormCleared_ParamsSpec,
      null,
      [form_data]);
  }
  ...
  recordSavePasswordProgress(log) {
    ...
    return this.proxy.sendMessage(
      6,  // ordinal
      autofill.mojom.mojom.PasswordManagerDriver_RecordSavePasswordProgress_ParamsSpec,
      null,
      [log]);
  }
  ...
  userModifiedPasswordField() {
    ...
    return this.proxy.sendMessage(
      7,  // ordinal
      autofill.mojom.mojom.PasswordManagerDriver_UserModifiedPasswordField_ParamsSpec,
      null,
      []);
  }
  ...
  userModifiedNonPasswordField(renderer_id, value, autocomplete_attribute_has_username, is_likely_otp) {
    ...
    return this.proxy.sendMessage(
      8,  // ordinal
      autofill.mojom.mojom.PasswordManagerDriver_UserModifiedNonPasswordField_ParamsSpec,
      null,
  ...
  showPasswordSuggestions(request) {
    ...
    return this.proxy.sendMessage(
      9,  // ordinal
      autofill.mojom.mojom.PasswordManagerDriver_ShowPasswordSuggestions_ParamsSpec,
      null,
      [request]);
  }
  ...
  checkSafeBrowsingReputation(form_action, frame_url) {
    ...
    return this.proxy.sendMessage(
      10,  // ordinal
      autofill.mojom.mojom.PasswordManagerDriver_CheckSafeBrowsingReputation_ParamsSpec,
      null,
  ...
  focusedInputChanged(focused_field_id, focused_field_type) {
    ...
    return this.proxy.sendMessage(
      11,  // ordinal
      autofill.mojom.mojom.PasswordManagerDriver_FocusedInputChanged_ParamsSpec,
      null,
  ...
  logFirstFillingResult(form_renderer_id, result) {
    ...
    return this.proxy.sendMessage(
      12,  // ordinal
      autofill.mojom.mojom.PasswordManagerDriver_LogFirstFillingResult_ParamsSpec,
      null,
...
autofill.mojom.mojom.PasswordManagerDriver.getRemote = function() {
  let remote = new autofill.mojom.mojom.PasswordManagerDriverRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
...
// Legacy compatibility
autofill.mojom.mojom.PasswordManagerDriverPtr = autofill.mojom.mojom.PasswordManagerDriverRemote;
autofill.mojom.mojom.PasswordManagerDriverRequest = autofill.mojom.mojom.PasswordManagerDriverPendingReceiver;


// Interface: PasswordGenerationDriver
autofill.mojom.mojom.PasswordGenerationDriver = {};

autofill.mojom.mojom.PasswordGenerationDriverPendingReceiver = class {
  constructor(handle) {
    this.handle = handle;
  }
};

autofill.mojom.mojom.PasswordGenerationDriverRemote = class {
  static get $interfaceName() {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      autofill.mojom.mojom.PasswordGenerationDriverPendingReceiver,
      handle);
    this.$ = new autofill.mojom.mojom.PasswordGenerationDriverRemoteCallHandler(this.proxy);
  }
...
autofill.mojom.mojom.PasswordGenerationDriverRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
  }
  ...
  automaticGenerationAvailable(password_generation_ui_data) {
    ...
    return this.proxy.sendMessage(
      0,  // ordinal
      autofill.mojom.mojom.PasswordGenerationDriver_AutomaticGenerationAvailable_ParamsSpec,
      null,
  ...
  presaveGeneratedPassword(form_data, password_value) {
    ...
    return this.proxy.sendMessage(
      1,  // ordinal
      autofill.mojom.mojom.PasswordGenerationDriver_PresaveGeneratedPassword_ParamsSpec,
      null,
  ...
  passwordNoLongerGenerated(form_data) {
    ...
    return this.proxy.sendMessage(
      2,  // ordinal
      autofill.mojom.mojom.PasswordGenerationDriver_PasswordNoLongerGenerated_ParamsSpec,
      null,
      [form_data]);
  }
  ...
  showPasswordEditingPopup(bounds, form_data, field_renderer_id, password_value) {
    ...
    return this.proxy.sendMessage(
      3,  // ordinal
      autofill.mojom.mojom.PasswordGenerationDriver_ShowPasswordEditingPopup_ParamsSpec,
      null,
  ...
  passwordGenerationRejectedByTyping() {
    ...
    return this.proxy.sendMessage(
      4,  // ordinal
      autofill.mojom.mojom.PasswordGenerationDriver_PasswordGenerationRejectedByTyping_ParamsSpec,
      null,
      []);
  }
  ...
  frameWasScrolled() {
    ...
    return this.proxy.sendMessage(
      5,  // ordinal
      autofill.mojom.mojom.PasswordGenerationDriver_FrameWasScrolled_ParamsSpec,
      null,
      []);
  }
  ...
  generationElementLostFocus() {
    ...
    return this.proxy.sendMessage(
      6,  // ordinal
      autofill.mojom.mojom.PasswordGenerationDriver_GenerationElementLostFocus_ParamsSpec,
      null,
      []);
  }
...
autofill.mojom.mojom.PasswordGenerationDriver.getRemote = function() {
  let remote = new autofill.mojom.mojom.PasswordGenerationDriverRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
...
// Legacy compatibility
autofill.mojom.mojom.PasswordGenerationDriverPtr = autofill.mojom.mojom.PasswordGenerationDriverRemote;
autofill.mojom.mojom.PasswordGenerationDriverRequest = autofill.mojom.mojom.PasswordGenerationDriverPendingReceiver;
