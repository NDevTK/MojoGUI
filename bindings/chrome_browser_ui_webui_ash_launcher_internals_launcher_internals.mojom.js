...
mojo.internal.bindings.launcher_internals.mojom.PageHandlerFactoryRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.launcher_internals.mojom.PageHandlerFactoryPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.launcher_internals.mojom.PageHandlerFactoryRemoteCallHandler(this.proxy);
  }
  ...
  createPageHandler(arg_page) {
    return this.$.createPageHandler(arg_page);
  }
};

mojo.internal.bindings.launcher_internals.mojom.PageHandlerFactoryRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('launcher_internals.mojom.PageHandlerFactory', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.launcher_internals.mojom.PageHandlerFactory.getRemote = function() {
  let remote = new mojo.internal.bindings.launcher_internals.mojom.PageHandlerFactoryRemote();
...
mojo.internal.bindings.launcher_internals.mojom.PageHandlerFactoryReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('launcher_internals.mojom.PageHandlerFactory', [
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.launcher_internals.mojom.PageHandlerFactory_CreatePageHandler_ParamsSpec.$.structSpec;
...
mojo.internal.bindings.launcher_internals.mojom.PageHandlerFactoryReceiver = mojo.internal.bindings.launcher_internals.mojom.PageHandlerFactoryReceiver;

mojo.internal.bindings.launcher_internals.mojom.PageHandlerFactoryPtr = mojo.internal.bindings.launcher_internals.mojom.PageHandlerFactoryRemote;
mojo.internal.bindings.launcher_internals.mojom.PageHandlerFactoryRequest = mojo.internal.bindings.launcher_internals.mojom.PageHandlerFactoryPendingReceiver;
...
mojo.internal.bindings.launcher_internals.mojom.PageRemote = class {
  static get $interfaceName() {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.launcher_internals.mojom.PagePendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.launcher_internals.mojom.PageRemoteCallHandler(this.proxy);
  }
  ...
  updateResults(arg_query, arg_keywords, arg_results) {
    return this.$.updateResults(arg_query, arg_keywords, arg_results);
  }
};

mojo.internal.bindings.launcher_internals.mojom.PageRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('launcher_internals.mojom.Page', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.launcher_internals.mojom.Page.getRemote = function() {
  let remote = new mojo.internal.bindings.launcher_internals.mojom.PageRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
...
mojo.internal.bindings.launcher_internals.mojom.PageReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('launcher_internals.mojom.Page', [
      { explicit: null },
    ]);
    ordinals.forEach((ord, idx) => {
      this.ordinalMap.set(ord, idx); // Scrambled/Explicit
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.launcher_internals.mojom.Page_UpdateResults_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for UpdateResults failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
             console.warn('[GeneratedReceiver] Failed to discover ordinal ' + header.ordinal);
...
mojo.internal.bindings.launcher_internals.mojom.PageReceiver = mojo.internal.bindings.launcher_internals.mojom.PageReceiver;
