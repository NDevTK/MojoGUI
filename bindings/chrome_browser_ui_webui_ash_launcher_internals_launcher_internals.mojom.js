...
launcher_internals.mojom.PageHandlerFactory_CreatePageHandler_ParamsSpec = {
  $: {
    structSpec: {
      name: 'launcher_internals.mojom.PageHandlerFactory_CreatePageHandler_Params',
      packedSize: 16,
      fields: [
        { name: 'page', packedOffset: 0, packedBitOffset: 0, type: mojo.internal.InterfaceProxy(launcher_internals.mojom.PageRemote), nullable: false, minVersion: 0 },
      ],
...
launcher_internals.mojom.Page_UpdateResults_ParamsSpec = {
  $: {
    structSpec: {
      name: 'launcher_internals.mojom.Page_UpdateResults_Params',
      packedSize: 32,
      fields: [
