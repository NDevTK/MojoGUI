...
mojo.internal.bindings.payments.facilitated.mojom.PixCodeValidatorRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('PixCodeValidator', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.payments.facilitated.mojom.PixCodeValidatorReceiver = class {
  constructor(impl) {
    ...
    const ordinals = window.mojoScrambler.getOrdinals('PixCodeValidator', [
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.payments.facilitated.mojom.PixCodeValidator_ValidatePixCode_ParamsSpec);
