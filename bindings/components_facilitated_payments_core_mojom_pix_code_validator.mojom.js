...
// Enum: PixQrCodeType
mojo.internal.bindings.payments.facilitated.mojom.PixQrCodeType = {
  kInvalid: 0,
  kDynamic: 1,
  kStatic: 2,
};
...
mojo.internal.bindings.payments.facilitated.mojom.PixCodeValidatorRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.payments.facilitated.mojom.PixCodeValidatorRemoteCallHandler(this.proxy);
  }
  ...
  validatePixCode(arg_input_text) {
    return this.$.validatePixCode(arg_input_text);
  }
};

mojo.internal.bindings.payments.facilitated.mojom.PixCodeValidatorRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('payments.facilitated.mojom.PixCodeValidator', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.payments.facilitated.mojom.PixCodeValidator.getRemote = function() {
  let remote = new mojo.internal.bindings.payments.facilitated.mojom.PixCodeValidatorRemote();
...
mojo.internal.bindings.payments.facilitated.mojom.PixCodeValidatorReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('payments.facilitated.mojom.PixCodeValidator', [
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.payments.facilitated.mojom.PixCodeValidator_ValidatePixCode_ParamsSpec.$.structSpec);
        ...
        case 0: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.payments.facilitated.mojom.PixCodeValidator_ValidatePixCode_ResponseParamsSpec, header, rawHeader);
               responder(response);
...
mojo.internal.bindings.payments.facilitated.mojom.PixCodeValidatorReceiver = mojo.internal.bindings.payments.facilitated.mojom.PixCodeValidatorReceiver;
