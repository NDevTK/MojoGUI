...
mojo.internal.Struct(
    printing.mojom.AdvancedCapabilitySpec, 'printing.mojom.AdvancedCapability', [
      mojo.internal.StructField('name', 0, 0, mojo.internal.String, null, false, 0, undefined),
      mojo.internal.StructField('display_name', 8, 0, mojo.internal.String, null, false, 0, undefined),
      mojo.internal.StructField('type', 32, 0, printing.mojom.AdvancedCapabilityTypeSpec, null, false, 0, undefined),
      mojo.internal.StructField('default_value', 16, 0, mojo.internal.String, null, false, 0, undefined),
      mojo.internal.StructField('values', 24, 0, mojo.internal.Array(printing.mojom.AdvancedCapabilityValueSpec, false), null, false, 0, undefined),
    ],
    [[0, 48]]);
...
mojo.internal.Struct(
    printing.mojom.PrinterSemanticCapsAndDefaultsSpec, 'printing.mojom.PrinterSemanticCapsAndDefaults', [
      mojo.internal.StructField('collate_capable', 108, 0, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('collate_default', 108, 1, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('copies_max', 88, 0, mojo.internal.Int32, 0, false, 0, undefined),
      ...
      mojo.internal.StructField('duplex_default', 92, 0, printing.mojom.DuplexModeSpec, null, false, 0, undefined),
      mojo.internal.StructField('color_changeable', 108, 2, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('color_default', 108, 3, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('color_model', 96, 0, printing.mojom.ColorModelSpec, null, false, 0, undefined),
      mojo.internal.StructField('bw_model', 100, 0, printing.mojom.ColorModelSpec, null, false, 0, undefined),
      mojo.internal.StructField('papers', 8, 0, mojo.internal.Array(printing.mojom.PaperSpec, false), null, false, 0, undefined),
      mojo.internal.StructField('user_defined_papers', 16, 0, mojo.internal.Array(printing.mojom.PaperSpec, false), null, false, 0, undefined),
      mojo.internal.StructField('default_paper', 24, 0, printing.mojom.PaperSpec, null, false, 0, undefined),
      mojo.internal.StructField('dpis', 32, 0, mojo.internal.Array(gfx.mojom.SizeSpec, false), null, false, 0, undefined),
      mojo.internal.StructField('default_dpi', 40, 0, gfx.mojom.SizeSpec, null, false, 0, undefined),
      mojo.internal.StructField('pin_supported', 108, 4, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('advanced_capabilities', 48, 0, mojo.internal.Array(printing.mojom.AdvancedCapabilitySpec, false), null, false, 0, undefined),
      mojo.internal.StructField('page_output_quality', 56, 0, printing.mojom.PageOutputQualitySpec, null, true, 0, undefined),
      mojo.internal.StructField('media_types', 64, 0, mojo.internal.Array(printing.mojom.MediaTypeSpec, false), null, true, 0, undefined),
      mojo.internal.StructField('default_media_type', 72, 0, printing.mojom.MediaTypeSpec, null, true, 0, undefined),
      mojo.internal.StructField('print_scaling_types', 80, 0, mojo.internal.Array(printing.mojom.PrintScalingTypeSpec, false), null, false, 0, undefined),
      mojo.internal.StructField('print_scaling_type_default', 104, 0, printing.mojom.PrintScalingTypeSpec, null, false, 0, undefined),
    ],
    [[0, 120]]);
