...
mojo.internal.bindings.web_ui_test.mojom.TestRunnerRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.web_ui_test.mojom.TestRunnerPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.web_ui_test.mojom.TestRunnerRemoteCallHandler(this.proxy);
  }
  ...
  testComplete(arg_failureMessage) {
    return this.$.testComplete(arg_failureMessage);
  }
};

mojo.internal.bindings.web_ui_test.mojom.TestRunnerRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('web_ui_test.mojom.TestRunner', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.web_ui_test.mojom.TestRunner.getRemote = function() {
  let remote = new mojo.internal.bindings.web_ui_test.mojom.TestRunnerRemote();
...
mojo.internal.bindings.web_ui_test.mojom.TestRunnerReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('web_ui_test.mojom.TestRunner', [
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.web_ui_test.mojom.TestRunner_TestComplete_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for TestComplete failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.web_ui_test.mojom.TestRunnerReceiver = mojo.internal.bindings.web_ui_test.mojom.TestRunnerReceiver;
