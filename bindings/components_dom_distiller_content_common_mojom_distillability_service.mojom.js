...
mojo.internal.bindings.dom_distiller.mojom.DistillabilityService = {};
mojo.internal.bindings.dom_distiller.mojom.DistillabilityServiceSpec = { $ : {} };
mojo.internal.bindings.dom_distiller.mojom.DistillabilityService.$interfaceName = 'dom_distiller.mojom.DistillabilityService';
...
mojo.internal.bindings.dom_distiller.mojom.DistillabilityServiceRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.dom_distiller.mojom.DistillabilityServicePendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.dom_distiller.mojom.DistillabilityServiceRemoteCallHandler(this.proxy);
  }
  ...
  notifyIsDistillable(arg_page_is_distillable, arg_is_last_update, arg_is_long_article, arg_is_mobile_friendly) {
    return this.$.notifyIsDistillable(arg_page_is_distillable, arg_is_last_update, arg_is_long_article, arg_is_mobile_friendly);
  }
};

mojo.internal.bindings.dom_distiller.mojom.DistillabilityServiceRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('dom_distiller.mojom.DistillabilityService', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.dom_distiller.mojom.DistillabilityService.getRemote = function() {
  let remote = new mojo.internal.bindings.dom_distiller.mojom.DistillabilityServiceRemote();
...
mojo.internal.bindings.dom_distiller.mojom.DistillabilityServiceReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('dom_distiller.mojom.DistillabilityService', [
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.dom_distiller.mojom.DistillabilityService_NotifyIsDistillable_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for NotifyIsDistillable failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.dom_distiller.mojom.DistillabilityServiceReceiver = mojo.internal.bindings.dom_distiller.mojom.DistillabilityServiceReceiver;
