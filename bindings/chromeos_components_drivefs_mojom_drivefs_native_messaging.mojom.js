...
mojo.internal.bindings.drivefs.mojom.NativeMessagingPortRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.drivefs.mojom.NativeMessagingPortPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.drivefs.mojom.NativeMessagingPortRemoteCallHandler(this.proxy);
  }
  ...
  postMessageToExtension(arg_message) {
    return this.$.postMessageToExtension(arg_message);
  }
};
...
mojo.internal.bindings.drivefs.mojom.NativeMessagingPort.getRemote = function() {
  let remote = new mojo.internal.bindings.drivefs.mojom.NativeMessagingPortRemote();
...
mojo.internal.bindings.drivefs.mojom.NativeMessagingPortReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.drivefs.mojom.NativeMessagingPort_PostMessageToExtension_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for PostMessageToExtension failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.drivefs.mojom.NativeMessagingPortReceiver = mojo.internal.bindings.drivefs.mojom.NativeMessagingPortReceiver;

mojo.internal.bindings.drivefs.mojom.NativeMessagingPortPtr = mojo.internal.bindings.drivefs.mojom.NativeMessagingPortRemote;
mojo.internal.bindings.drivefs.mojom.NativeMessagingPortRequest = mojo.internal.bindings.drivefs.mojom.NativeMessagingPortPendingReceiver;
...
mojo.internal.bindings.drivefs.mojom.NativeMessagingHostRemote = class {
  static get $interfaceName() {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.drivefs.mojom.NativeMessagingHostPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.drivefs.mojom.NativeMessagingHostRemoteCallHandler(this.proxy);
  }
  ...
  handleMessageFromExtension(arg_message) {
    return this.$.handleMessageFromExtension(arg_message);
  }
};
...
mojo.internal.bindings.drivefs.mojom.NativeMessagingHost.getRemote = function() {
  let remote = new mojo.internal.bindings.drivefs.mojom.NativeMessagingHostRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
...
mojo.internal.bindings.drivefs.mojom.NativeMessagingHostReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.drivefs.mojom.NativeMessagingHost_HandleMessageFromExtension_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for HandleMessageFromExtension failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
             console.warn('[GeneratedReceiver] Failed to discover ordinal ' + header.ordinal);
...
mojo.internal.bindings.drivefs.mojom.NativeMessagingHostReceiver = mojo.internal.bindings.drivefs.mojom.NativeMessagingHostReceiver;
