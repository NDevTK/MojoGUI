...
mojo.internal.bindings.blink.mojom.UnboundedSurfaceHost_GetCompositorFrameSink_ParamsSpec = mojo.internal.bindings.blink.mojom.UnboundedSurfaceHost_GetCompositorFrameSink_ParamsSpec || { $: {} };
if (mojo.internal.bindings.blink.mojom.UnboundedSurfaceHost_GetCompositorFrameSink_ParamsSpec.$.structSpec && mojo.internal.bindings.blink.mojom.UnboundedSurfaceHost_GetCompositorFrameSink_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.blink.mojom.UnboundedSurfaceHost_GetCompositorFrameSink_ParamsSpec.$ = {};
mojo.internal.bindings.blink.mojom.UnboundedSurfaceHost_UpdateBounds_ParamsSpec = mojo.internal.bindings.blink.mojom.UnboundedSurfaceHost_UpdateBounds_ParamsSpec || { $: {} };
if (mojo.internal.bindings.blink.mojom.UnboundedSurfaceHost_UpdateBounds_ParamsSpec.$.structSpec && mojo.internal.bindings.blink.mojom.UnboundedSurfaceHost_UpdateBounds_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.blink.mojom.UnboundedSurfaceHost_UpdateBounds_ParamsSpec.$ = {};
...
mojo.internal.bindings.blink.mojom.UnboundedSurfaceClient_OnSurfaceAllocated_ParamsSpec = mojo.internal.bindings.blink.mojom.UnboundedSurfaceClient_OnSurfaceAllocated_ParamsSpec || { $: {} };
if (mojo.internal.bindings.blink.mojom.UnboundedSurfaceClient_OnSurfaceAllocated_ParamsSpec.$.structSpec && mojo.internal.bindings.blink.mojom.UnboundedSurfaceClient_OnSurfaceAllocated_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.blink.mojom.UnboundedSurfaceClient_OnSurfaceAllocated_ParamsSpec.$ = {};
...
mojo.internal.bindings.blink.mojom.UnboundedSurfaceHostRemote = class {
  ...
  getCompositorFrameSink(arg_sink, arg_client) {
    return this.$.getCompositorFrameSink(arg_sink, arg_client);
  }
  updateBounds(arg_bounds) {
    return this.$.updateBounds(arg_bounds);
  }
};
...
mojo.internal.bindings.blink.mojom.UnboundedSurfaceHostRemoteCallHandler = class {
  ...
  updateBounds(arg_bounds) {
    return this.proxy.sendMessage(
      ...
      mojo.internal.bindings.blink.mojom.UnboundedSurfaceHost_UpdateBounds_ParamsSpec,
      null,
      [arg_bounds],
      false);
  }
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        case 0: {
          ...
          const params = decoder.decodeStructInline(mojo.internal.bindings.blink.mojom.UnboundedSurfaceHost_GetCompositorFrameSink_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.getCompositorFrameSink');
          const result = this.impl.getCompositorFrameSink(params.arg_sink, params.arg_client);
          break;
        }
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.blink.mojom.UnboundedSurfaceHost_UpdateBounds_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.updateBounds');
          const result = this.impl.updateBounds(params.arg_bounds);
          break;
        }
      }
      } catch (err) {
...
mojo.internal.bindings.blink.mojom.UnboundedSurfaceClientRemote = class {
  ...
  onSurfaceAllocated(arg_frame_sink_id, arg_local_surface_id) {
    return this.$.onSurfaceAllocated(arg_frame_sink_id, arg_local_surface_id);
  }
  onDismissed() {
...
mojo.internal.bindings.blink.mojom.UnboundedSurfaceClientRemoteCallHandler = class {
  ...
  onSurfaceAllocated(arg_frame_sink_id, arg_local_surface_id) {
    return this.proxy.sendMessage(
      ...
      mojo.internal.bindings.blink.mojom.UnboundedSurfaceClient_OnSurfaceAllocated_ParamsSpec,
      null,
      [arg_frame_sink_id, arg_local_surface_id],
      false);
  }
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.blink.mojom.UnboundedSurfaceClient_OnSurfaceAllocated_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.onSurfaceAllocated');
          const result = this.impl.onSurfaceAllocated(params.arg_frame_sink_id, params.arg_local_surface_id);
          break;
        }
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
...
mojo.internal.Struct(
    ...
    [[0, 32]]);
mojo.internal.Struct(
    mojo.internal.bindings.blink.mojom.UnboundedSurfaceHost_GetCompositorFrameSink_ParamsSpec, 'blink.mojom.UnboundedSurfaceHost_GetCompositorFrameSink_Params', [
      mojo.internal.StructField('arg_sink', 0, 0, mojo.internal.InterfaceRequest(mojo.internal.bindings.viz.mojom.CompositorFrameSinkPendingReceiver), null, false, 0, undefined),
      mojo.internal.StructField('arg_client', 4, 0, mojo.internal.InterfaceProxy(mojo.internal.bindings.viz.mojom.CompositorFrameSinkClientRemote), null, false, 0, undefined),
    ],
    [[0, 24]]);

mojo.internal.Struct(
    mojo.internal.bindings.blink.mojom.UnboundedSurfaceHost_UpdateBounds_ParamsSpec, 'blink.mojom.UnboundedSurfaceHost_UpdateBounds_Params', [
      mojo.internal.StructField('arg_bounds', 0, 0, mojo.internal.bindings.gfx.mojom.RectSpec, null, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.blink.mojom.UnboundedSurfaceClient_OnSurfaceAllocated_ParamsSpec, 'blink.mojom.UnboundedSurfaceClient_OnSurfaceAllocated_Params', [
