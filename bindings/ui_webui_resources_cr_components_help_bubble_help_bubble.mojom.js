...
mojo.internal.bindings.help_bubble.mojom.PdfHelpBubbleHandlerFactoryRemote = class {
  ...
  createHelpBubbleHandler(arg_client, arg_help_bubble_handler, arg_tracked_element_handler) {
    return this.$.createHelpBubbleHandler(arg_client, arg_help_bubble_handler, arg_tracked_element_handler);
  }
};
...
mojo.internal.bindings.help_bubble.mojom.PdfHelpBubbleHandlerFactoryRemoteCallHandler = class {
  ...
  createHelpBubbleHandler(arg_client, arg_help_bubble_handler, arg_tracked_element_handler) {
    return this.proxy.sendMessage(
      ...
      mojo.internal.bindings.help_bubble.mojom.PdfHelpBubbleHandlerFactory_CreateHelpBubbleHandler_ParamsSpec,
      null,
      [arg_client, arg_help_bubble_handler, arg_tracked_element_handler],
      false);
  }
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        case 0: {
          ...
          console.log('[GeneratedReceiver] Calling impl.createHelpBubbleHandler');
          const result = this.impl.createHelpBubbleHandler(params.arg_client, params.arg_help_bubble_handler, params.arg_tracked_element_handler);
          break;
        }
      }
      } catch (err) {
...
mojo.internal.bindings.help_bubble.mojom.HelpBubbleHandlerRemote = class {
  ...
  helpBubbleButtonPressed(arg_id, arg_button_index) {
    return this.$.helpBubbleButtonPressed(arg_id, arg_button_index);
  }
  helpBubbleClosed(arg_id, arg_reason) {
    return this.$.helpBubbleClosed(arg_id, arg_reason);
  }
};
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        case 0: {
          ...
          const result = this.impl.helpBubbleButtonPressed(params.arg_id, params.arg_button_index);
          break;
        }
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          ...
          const result = this.impl.helpBubbleClosed(params.arg_id, params.arg_reason);
          break;
        }
      }
      } catch (err) {
...
mojo.internal.bindings.help_bubble.mojom.HelpBubbleClientRemote = class {
  ...
  toggleFocusForAccessibility(arg_id) {
    return this.$.toggleFocusForAccessibility(arg_id);
  }
  hideHelpBubble(arg_id) {
    return this.$.hideHelpBubble(arg_id);
  }
  externalHelpBubbleUpdated(arg_id, arg_shown) {
    return this.$.externalHelpBubbleUpdated(arg_id, arg_shown);
  }
};
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        ...
        case 1: {
          ...
          const result = this.impl.toggleFocusForAccessibility(params.arg_id);
          break;
        }
        case 2: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          ...
          const result = this.impl.hideHelpBubble(params.arg_id);
          break;
        }
        case 3: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          ...
          const result = this.impl.externalHelpBubbleUpdated(params.arg_id, params.arg_shown);
          break;
        }
      }
      } catch (err) {
...
mojo.internal.Struct(
    mojo.internal.bindings.help_bubble.mojom.HelpBubbleParamsSpec, 'help_bubble.mojom.HelpBubbleParams', [
      mojo.internal.StructField('arg_id', 0, 0, mojo.internal.bindings.tracked_element.mojom.TrackedElementIdentifierSpec, null, false, 0, undefined),
...
mojo.internal.Struct(
    mojo.internal.bindings.help_bubble.mojom.PdfHelpBubbleHandlerFactory_CreateHelpBubbleHandler_ParamsSpec, 'help_bubble.mojom.PdfHelpBubbleHandlerFactory_CreateHelpBubbleHandler_Params', [
      mojo.internal.StructField('arg_client', 0, 0, mojo.internal.InterfaceProxy(mojo.internal.bindings.help_bubble.mojom.HelpBubbleClientRemote), null, false, 0, undefined),
      mojo.internal.StructField('arg_help_bubble_handler', 8, 0, mojo.internal.InterfaceRequest(mojo.internal.bindings.help_bubble.mojom.HelpBubbleHandlerPendingReceiver), null, false, 0, undefined),
      mojo.internal.StructField('arg_tracked_element_handler', 12, 0, mojo.internal.InterfaceRequest(mojo.internal.bindings.tracked_element.mojom.TrackedElementHandlerPendingReceiver), null, false, 0, undefined),
    ],
    [[0, 24]]);
