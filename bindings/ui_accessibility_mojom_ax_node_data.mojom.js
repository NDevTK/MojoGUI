...
ax.mojom.AXNodeDataSpec = {
  $: {
    structSpec: {
      ...
      packedSize: 104,
      fields: [
        { name: 'role', packedOffset: 0, packedBitOffset: 0, type: ax.mojom.RoleSpec, nullable: false },
        ...
        { name: 'relative_bounds', packedOffset: 72, packedBitOffset: 0, type: ax.mojom.AXRelativeBoundsSpec, nullable: false },
        { name: 'bool_attributes_data', packedOffset: 80, packedBitOffset: 0, type: ax.mojom.AXBitsetDataSpec, nullable: true },
