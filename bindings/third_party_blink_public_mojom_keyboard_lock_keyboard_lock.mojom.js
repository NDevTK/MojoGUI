...
mojo.internal.bindings.blink.mojom.KeyboardLockService.$interfaceName = 'blink.mojom.KeyboardLockService';
...
mojo.internal.bindings.blink.mojom.KeyboardLockRequestResult = {
  kSuccess: 0,
...
mojo.internal.bindings.blink.mojom.GetKeyboardLayoutMapStatus = {
  kSuccess: 0,
  kFail: 1,
  kDenied: 2,
};
...
mojo.internal.Struct(
    mojo.internal.bindings.blink.mojom.GetKeyboardLayoutMapResultSpec, 'blink.mojom.GetKeyboardLayoutMapResult', [
      mojo.internal.StructField('arg_layout_map', 0, 0, mojo.internal.Map(mojo.internal.String, mojo.internal.String, false), null, false, 0, undefined),
      mojo.internal.StructField('arg_status', 8, 0, mojo.internal.bindings.blink.mojom.GetKeyboardLayoutMapStatusSpec, null, false, 0, undefined),
    ],
    [[0, 24]]);
...
mojo.internal.bindings.blink.mojom.KeyboardLockServiceRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.blink.mojom.KeyboardLockServicePendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.blink.mojom.KeyboardLockServiceRemoteCallHandler(this.proxy);
  }
  ...
  requestKeyboardLock(arg_key_codes) {
    return this.$.requestKeyboardLock(arg_key_codes);
  }
  cancelKeyboardLock() {
...
mojo.internal.bindings.blink.mojom.KeyboardLockServiceRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('blink.mojom.KeyboardLockService', [
      { explicit: null },
      { explicit: null },
      { explicit: null },
    ]);
...
mojo.internal.bindings.blink.mojom.KeyboardLockService.getRemote = function() {
  let remote = new mojo.internal.bindings.blink.mojom.KeyboardLockServiceRemote();
...
mojo.internal.bindings.blink.mojom.KeyboardLockServiceReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('blink.mojom.KeyboardLockService', [
      { explicit: null },
      { explicit: null },
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        // Try Method 0: RequestKeyboardLock
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.blink.mojom.KeyboardLockService_RequestKeyboardLock_ParamsSpec.$.structSpec;
             ...
             if (sizeMatch && (!!(header.flags & 1) === methodExpectsResp)) {
               if (size > 8 || message.payload.byteLength === 8) {
                 ...
                 console.log('[GeneratedReceiver] Discovery SUCCESS: ' + header.ordinal + ' -> RequestKeyboardLock (0)');
                 this.mapOrdinal(header.ordinal, 0);
                 dispatchId = 0;
               }
             }
           } catch (e) {
             if (e instanceof TypeError) console.warn('[Discovery] trial for RequestKeyboardLock failed with TypeError');
           }
        }
        // Try Method 1: CancelKeyboardLock
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.blink.mojom.KeyboardLockService_CancelKeyboardLock_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (sizeMatch && (!!(header.flags & 1) === methodExpectsResp)) {
               if (size > 8 || message.payload.byteLength === 8) {
                 decoder.decodeStructInline(structSpec);
                 console.log('[GeneratedReceiver] Discovery SUCCESS: ' + header.ordinal + ' -> CancelKeyboardLock (1)');
                 this.mapOrdinal(header.ordinal, 1);
                 dispatchId = 1;
               }
             }
           } catch (e) {
             if (e instanceof TypeError) console.warn('[Discovery] trial for CancelKeyboardLock failed with TypeError');
           }
        }
        // Try Method 2: GetKeyboardLayoutMap
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.blink.mojom.KeyboardLockService_GetKeyboardLayoutMap_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (sizeMatch && (!!(header.flags & 1) === methodExpectsResp)) {
               if (size > 8 || message.payload.byteLength === 8) {
                 decoder.decodeStructInline(structSpec);
                 console.log('[GeneratedReceiver] Discovery SUCCESS: ' + header.ordinal + ' -> GetKeyboardLayoutMap (2)');
                 this.mapOrdinal(header.ordinal, 2);
                 dispatchId = 2;
               }
             }
           } catch (e) {
             if (e instanceof TypeError) console.warn('[Discovery] trial for GetKeyboardLayoutMap failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
      ...
      switch (dispatchId) {
        ...
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.blink.mojom.KeyboardLockService_CancelKeyboardLock_ParamsSpec.$.structSpec);
        ...
        case 2: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.blink.mojom.KeyboardLockService_GetKeyboardLayoutMap_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.blink.mojom.KeyboardLockServiceReceiver = mojo.internal.bindings.blink.mojom.KeyboardLockServiceReceiver;
