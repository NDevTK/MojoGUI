...
// Enum: AllocatorType
mojo.internal.bindings.heap_profiling.mojom.AllocatorType = {
  kMalloc: 0,
  kPartitionAlloc: 1,
};
...
mojo.internal.bindings.heap_profiling.mojom.ProfilingClientRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.heap_profiling.mojom.ProfilingClientRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.heap_profiling.mojom.ProfilingClient.getRemote = function() {
  let remote = new mojo.internal.bindings.heap_profiling.mojom.ProfilingClientRemote();
...
mojo.internal.bindings.heap_profiling.mojom.ProfilingClientReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.heap_profiling.mojom.ProfilingClient_StartProfiling_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for StartProfiling failed with TypeError');
           }
        }
        // Try Method 1: RetrieveHeapProfile
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.heap_profiling.mojom.ProfilingClient_RetrieveHeapProfile_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for RetrieveHeapProfile failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.heap_profiling.mojom.ProfilingClientReceiver = mojo.internal.bindings.heap_profiling.mojom.ProfilingClientReceiver;
