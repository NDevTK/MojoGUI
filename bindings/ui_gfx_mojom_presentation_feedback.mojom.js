...
mojo.internal.Struct(
    gfx.mojom.PresentationFeedbackSpec, 'gfx.mojom.PresentationFeedback', [
      ...
      mojo.internal.StructField('display_trace_id_$flag', 60, 0, mojo.internal.Bool, false, false, 0, { isPrimary: true, linkedValueFieldName: 'display_trace_id_$value', originalFieldName: 'display_trace_id' }),
      mojo.internal.StructField('display_trace_id_$value', 64, 0, mojo.internal.Int64, 0, false, 0, { isPrimary: false, linkedValueFieldName: 'display_trace_id_$flag', originalFieldName: 'display_trace_id' }),
    ],
    [[0, 80]]);
