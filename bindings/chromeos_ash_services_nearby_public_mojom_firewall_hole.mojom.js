...
mojo.internal.bindings.sharing.mojom.FirewallHoleRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.sharing.mojom.FirewallHolePendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.sharing.mojom.FirewallHoleRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.sharing.mojom.FirewallHole.getRemote = function() {
  let remote = new mojo.internal.bindings.sharing.mojom.FirewallHoleRemote();
...
mojo.internal.bindings.sharing.mojom.FirewallHoleReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
...
mojo.internal.bindings.sharing.mojom.FirewallHoleReceiver = mojo.internal.bindings.sharing.mojom.FirewallHoleReceiver;

mojo.internal.bindings.sharing.mojom.FirewallHolePtr = mojo.internal.bindings.sharing.mojom.FirewallHoleRemote;
mojo.internal.bindings.sharing.mojom.FirewallHoleRequest = mojo.internal.bindings.sharing.mojom.FirewallHolePendingReceiver;
...
mojo.internal.bindings.sharing.mojom.FirewallHoleFactoryRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.sharing.mojom.FirewallHoleFactoryRemoteCallHandler(this.proxy);
  }
  ...
  openFirewallHole(arg_port) {
    return this.$.openFirewallHole(arg_port);
  }
};
...
mojo.internal.bindings.sharing.mojom.FirewallHoleFactory.getRemote = function() {
  let remote = new mojo.internal.bindings.sharing.mojom.FirewallHoleFactoryRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
...
mojo.internal.bindings.sharing.mojom.FirewallHoleFactoryReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.sharing.mojom.FirewallHoleFactory_OpenFirewallHole_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OpenFirewallHole failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
             console.warn('[GeneratedReceiver] Failed to discover ordinal ' + header.ordinal);
...
mojo.internal.bindings.sharing.mojom.FirewallHoleFactoryReceiver = mojo.internal.bindings.sharing.mojom.FirewallHoleFactoryReceiver;
