...
mojo.internal.bindings.network.mojom.FirstPartySetsAccessDelegatePendingReceiver = mojo.internal.bindings.network.mojom.FirstPartySetsAccessDelegatePendingReceiver || class { constructor(handle) { this.handle = handle; } };
mojo.internal.bindings.network = mojo.internal.bindings.network || {};
mojo.internal.bindings.network.mojom = mojo.internal.bindings.network.mojom || {};
...
mojo.internal.Struct(
    mojo.internal.bindings.network.mojom.NetworkContextParamsSpec, 'network.mojom.NetworkContextParams', [
      ...
      mojo.internal.StructField('arg_device_bound_sessions_restricted_sites', 224, 0, mojo.internal.Array(mojo.internal.bindings.network.mojom.SchemefulSiteSpec, false), null, false, 0, undefined),
      ...
      mojo.internal.StructField('arg_device_bound_sessions_network_observer', 264, 0, mojo.internal.InterfaceProxy(mojo.internal.bindings.network.mojom.URLLoaderNetworkServiceObserverRemote), null, true, 0, undefined),
    ],
    [[0, 280]]);
