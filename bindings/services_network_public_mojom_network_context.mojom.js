...
mojo.internal.bindings.network.mojom.NetworkContext_SetExpectedTargetNetworkForTesting_ParamsSpec = mojo.internal.bindings.network.mojom.NetworkContext_SetExpectedTargetNetworkForTesting_ParamsSpec || { $: {} };
if (mojo.internal.bindings.network.mojom.NetworkContext_SetExpectedTargetNetworkForTesting_ParamsSpec.$.structSpec && mojo.internal.bindings.network.mojom.NetworkContext_SetExpectedTargetNetworkForTesting_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.network.mojom.NetworkContext_SetExpectedTargetNetworkForTesting_ParamsSpec.$ = {};
...
mojo.internal.bindings.network.mojom.NetworkContextRemote = class {
  ...
  setExpectedTargetNetworkForTesting(arg_target_network) {
    return this.$.setExpectedTargetNetworkForTesting(arg_target_network);
  }
};
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        ...
        case 89: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.network.mojom.NetworkContext_SetExpectedTargetNetworkForTesting_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.setExpectedTargetNetworkForTesting');
          const result = this.impl.setExpectedTargetNetworkForTesting(params.arg_target_network);
          break;
        }
      }
      } catch (err) {
...
mojo.internal.Struct(
    mojo.internal.bindings.network.mojom.NetworkContext_SetExpectedTargetNetworkForTesting_ParamsSpec, 'network.mojom.NetworkContext_SetExpectedTargetNetworkForTesting_Params', [
      mojo.internal.StructField('arg_target_network_$flag', 0, 0, mojo.internal.Bool, false, false, 0, { isPrimary: true, linkedValueFieldName: 'arg_target_network_$value', originalFieldName: 'arg_target_network' }),
      mojo.internal.StructField('arg_target_network_$value', 8, 0, mojo.internal.Int64, 0, false, 0, { isPrimary: false, linkedValueFieldName: 'arg_target_network_$flag', originalFieldName: 'arg_target_network' }),
    ],
    [[0, 24]]);
