...
mojo.internal.bindings.network.mojom.NonceAndAllowlistedPatternsSpec = mojo.internal.bindings.network.mojom.NonceAndAllowlistedPatternsSpec || { $: {} };
if (mojo.internal.bindings.network.mojom.NonceAndAllowlistedPatternsSpec.$.structSpec && mojo.internal.bindings.network.mojom.NonceAndAllowlistedPatternsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.network.mojom.NonceAndAllowlistedPatternsSpec.$ = {};
...
mojo.internal.bindings.network.mojom.NetworkContext_SetDohFallbackUpgradeAllowed_ParamsSpec = mojo.internal.bindings.network.mojom.NetworkContext_SetDohFallbackUpgradeAllowed_ParamsSpec || { $: {} };
if (mojo.internal.bindings.network.mojom.NetworkContext_SetDohFallbackUpgradeAllowed_ParamsSpec.$.structSpec && mojo.internal.bindings.network.mojom.NetworkContext_SetDohFallbackUpgradeAllowed_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.network.mojom.NetworkContext_SetDohFallbackUpgradeAllowed_ParamsSpec.$ = {};
...
mojo.internal.bindings.network.mojom.NetworkContext_RevokeNetworkForNonces_ParamsSpec = mojo.internal.bindings.network.mojom.NetworkContext_RevokeNetworkForNonces_ParamsSpec || { $: {} };
if (mojo.internal.bindings.network.mojom.NetworkContext_RevokeNetworkForNonces_ParamsSpec.$.structSpec && mojo.internal.bindings.network.mojom.NetworkContext_RevokeNetworkForNonces_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.network.mojom.NetworkContext_RevokeNetworkForNonces_ParamsSpec.$ = {};
mojo.internal.bindings.network.mojom.NetworkContext_RevokeNetworkForNonces_ResponseParamsSpec = mojo.internal.bindings.network.mojom.NetworkContext_RevokeNetworkForNonces_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.network.mojom.NetworkContext_RevokeNetworkForNonces_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.network.mojom.NetworkContext_RevokeNetworkForNonces_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.network.mojom.NetworkContext_RevokeNetworkForNonces_ResponseParamsSpec.$ = {};
mojo.internal.bindings.network.mojom.NetworkContext_ClearNonces_ParamsSpec = mojo.internal.bindings.network.mojom.NetworkContext_ClearNonces_ParamsSpec || { $: {} };
if (mojo.internal.bindings.network.mojom.NetworkContext_ClearNonces_ParamsSpec.$.structSpec && mojo.internal.bindings.network.mojom.NetworkContext_ClearNonces_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.network.mojom.NetworkContext_ClearNonces_ParamsSpec.$ = {};
mojo.internal.bindings.network.mojom.NetworkContext_ExemptUrlFromNetworkRevocationForNonce_ParamsSpec = mojo.internal.bindings.network.mojom.NetworkContext_ExemptUrlFromNetworkRevocationForNonce_ParamsSpec || { $: {} };
if (mojo.internal.bindings.network.mojom.NetworkContext_ExemptUrlFromNetworkRevocationForNonce_ParamsSpec.$.structSpec && mojo.internal.bindings.network.mojom.NetworkContext_ExemptUrlFromNetworkRevocationForNonce_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.network.mojom.NetworkContext_ExemptUrlFromNetworkRevocationForNonce_ParamsSpec.$ = {};
mojo.internal.bindings.network.mojom.NetworkContext_ExemptUrlFromNetworkRevocationForNonce_ResponseParamsSpec = mojo.internal.bindings.network.mojom.NetworkContext_ExemptUrlFromNetworkRevocationForNonce_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.network.mojom.NetworkContext_ExemptUrlFromNetworkRevocationForNonce_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.network.mojom.NetworkContext_ExemptUrlFromNetworkRevocationForNonce_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.network.mojom.NetworkContext_ExemptUrlFromNetworkRevocationForNonce_ResponseParamsSpec.$ = {};
...
mojo.internal.bindings.network.mojom.NetworkContextRemote = class {
  ...
  setDohFallbackUpgradeAllowed(arg_allowed) {
    return this.$.setDohFallbackUpgradeAllowed(arg_allowed);
  }
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        ...
        case 13: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.network.mojom.NetworkContext_SetDohFallbackUpgradeAllowed_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.setDohFallbackUpgradeAllowed');
          const result = this.impl.setDohFallbackUpgradeAllowed(params.arg_allowed);
          break;
        }
        case 14: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
        ...
        case 82: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.network.mojom.NetworkContext_RevokeNetworkForNonces_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
        ...
        case 84: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.network.mojom.NetworkContext_ExemptUrlFromNetworkRevocationForNonce_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
...
mojo.internal.Struct(
    mojo.internal.bindings.network.mojom.NetworkContextParamsSpec, 'network.mojom.NetworkContextParams', [
      ...
      mojo.internal.StructField('arg_doh_fallback_upgrade_allowed', 18, 2, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_shared_dictionary_enabled', 18, 3, mojo.internal.Bool, false, false, 0, undefined),
...
mojo.internal.Struct(
    mojo.internal.bindings.network.mojom.NetworkContext_SetDohFallbackUpgradeAllowed_ParamsSpec, 'network.mojom.NetworkContext_SetDohFallbackUpgradeAllowed_Params', [
