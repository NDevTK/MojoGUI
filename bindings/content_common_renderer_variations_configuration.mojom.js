...
mojo.internal.bindings.content.mojom.RendererVariationsConfigurationRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.content.mojom.RendererVariationsConfigurationPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.content.mojom.RendererVariationsConfigurationRemoteCallHandler(this.proxy);
  }
  ...
  setFieldTrialGroup(arg_trial_name, arg_group_name) {
    return this.$.setFieldTrialGroup(arg_trial_name, arg_group_name);
  }
};
...
mojo.internal.bindings.content.mojom.RendererVariationsConfiguration.getRemote = function() {
  let remote = new mojo.internal.bindings.content.mojom.RendererVariationsConfigurationRemote();
...
mojo.internal.bindings.content.mojom.RendererVariationsConfigurationReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.content.mojom.RendererVariationsConfiguration_SetVariationsHeaders_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for SetVariationsHeaders failed with TypeError');
           }
        }
        // Try Method 1: SetFieldTrialGroup
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.content.mojom.RendererVariationsConfiguration_SetFieldTrialGroup_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for SetFieldTrialGroup failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.content.mojom.RendererVariationsConfigurationReceiver = mojo.internal.bindings.content.mojom.RendererVariationsConfigurationReceiver;
