...
mojo.internal.bindings.remoting.mojom.DesktopSessionConnectionEvents_OnSessionServicesClientConnected_ParamsSpec = mojo.internal.bindings.remoting.mojom.DesktopSessionConnectionEvents_OnSessionServicesClientConnected_ParamsSpec || { $: {} };
if (mojo.internal.bindings.remoting.mojom.DesktopSessionConnectionEvents_OnSessionServicesClientConnected_ParamsSpec.$.structSpec && mojo.internal.bindings.remoting.mojom.DesktopSessionConnectionEvents_OnSessionServicesClientConnected_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.remoting.mojom.DesktopSessionConnectionEvents_OnSessionServicesClientConnected_ParamsSpec.$ = {};
...
mojo.internal.bindings.remoting.mojom.DesktopSessionConnectionEventsRemote = class {
  ...
  onTerminalDisconnected(arg_terminal_id, arg_error_code, arg_error_details, arg_error_location) {
    return this.$.onTerminalDisconnected(arg_terminal_id, arg_error_code, arg_error_details, arg_error_location);
  }
  onDesktopSessionAgentAttached(arg_terminal_id, arg_desktop_pipe) {
    return this.$.onDesktopSessionAgentAttached(arg_terminal_id, arg_desktop_pipe);
  }
  onSessionServicesClientConnected(arg_terminal_id, arg_receiver) {
    return this.$.onSessionServicesClientConnected(arg_terminal_id, arg_receiver);
  }
};
...
mojo.internal.bindings.remoting.mojom.DesktopSessionConnectionEventsRemoteCallHandler = class {
  ...
  onTerminalDisconnected(arg_terminal_id, arg_error_code, arg_error_details, arg_error_location) {
    return this.proxy.sendMessage(
      ...
      mojo.internal.bindings.remoting.mojom.DesktopSessionConnectionEvents_OnTerminalDisconnected_ParamsSpec,
      null,
      [arg_terminal_id, arg_error_code, arg_error_details, arg_error_location],
      false);
  }
  ...
  onDesktopSessionAgentAttached(arg_terminal_id, arg_desktop_pipe) {
    return this.proxy.sendMessage(
      ...
      mojo.internal.bindings.remoting.mojom.DesktopSessionConnectionEvents_OnDesktopSessionAgentAttached_ParamsSpec,
      null,
      [arg_terminal_id, arg_desktop_pipe],
      false);
  }
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        case 0: {
          ...
          const result = this.impl.onTerminalDisconnected(params.arg_terminal_id, params.arg_error_code, params.arg_error_details, params.arg_error_location);
          break;
        }
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          ...
          const result = this.impl.onDesktopSessionAgentAttached(params.arg_terminal_id, params.arg_desktop_pipe);
          break;
        }
        case 2: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.remoting.mojom.DesktopSessionConnectionEvents_OnSessionServicesClientConnected_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.onSessionServicesClientConnected');
          const result = this.impl.onSessionServicesClientConnected(params.arg_terminal_id, params.arg_receiver);
          break;
        }
      }
      } catch (err) {
...
mojo.internal.Struct(
    mojo.internal.bindings.remoting.mojom.DesktopSessionConnectionEvents_OnTerminalDisconnected_ParamsSpec, 'remoting.mojom.DesktopSessionConnectionEvents_OnTerminalDisconnected_Params', [
      ...
      mojo.internal.StructField('arg_error_code', 4, 0, mojo.internal.bindings.remoting.mojom.ProtocolErrorCodeSpec, null, false, 0, undefined),
...
mojo.internal.Struct(
    mojo.internal.bindings.remoting.mojom.DesktopSessionConnectionEvents_OnDesktopSessionAgentAttached_ParamsSpec, 'remoting.mojom.DesktopSessionConnectionEvents_OnDesktopSessionAgentAttached_Params', [
      mojo.internal.StructField('arg_terminal_id', 0, 0, mojo.internal.Int32, 0, false, 0, undefined),
      mojo.internal.StructField('arg_desktop_pipe', 4, 0, mojo.internal.Handle, null, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.remoting.mojom.DesktopSessionConnectionEvents_OnSessionServicesClientConnected_ParamsSpec, 'remoting.mojom.DesktopSessionConnectionEvents_OnSessionServicesClientConnected_Params', [
      mojo.internal.StructField('arg_terminal_id', 0, 0, mojo.internal.Int32, 0, false, 0, undefined),
      mojo.internal.StructField('arg_receiver', 4, 0, mojo.internal.InterfaceRequest(mojo.internal.bindings.remoting.mojom.ChromotingSessionServicesPendingReceiver), null, false, 0, undefined),
    ],
    [[0, 16]]);
