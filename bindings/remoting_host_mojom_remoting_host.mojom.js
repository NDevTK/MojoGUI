...
mojo.internal.bindings.remoting.mojom.ClientCertificateDetailsSpec = mojo.internal.bindings.remoting.mojom.ClientCertificateDetailsSpec || { $: {} };
if (mojo.internal.bindings.remoting.mojom.ClientCertificateDetailsSpec.$.structSpec && mojo.internal.bindings.remoting.mojom.ClientCertificateDetailsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.remoting.mojom.ClientCertificateDetailsSpec.$ = {};
...
mojo.internal.bindings.remoting.mojom.CertificateBroker = mojo.internal.bindings.remoting.mojom.CertificateBroker || {};
mojo.internal.bindings.remoting.mojom.CertificateBrokerSpec = mojo.internal.bindings.remoting.mojom.CertificateBrokerSpec || { $ : {} };
if (mojo.internal.bindings.remoting.mojom.CertificateBrokerSpec.$.structSpec && mojo.internal.bindings.remoting.mojom.CertificateBrokerSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.remoting.mojom.CertificateBrokerSpec.$ = {};
mojo.internal.bindings.remoting.mojom.CertificateBroker.$interfaceName = 'remoting.mojom.CertificateBroker';
mojo.internal.bindings.remoting.mojom.CertificateBroker_GetCertificates_ParamsSpec = mojo.internal.bindings.remoting.mojom.CertificateBroker_GetCertificates_ParamsSpec || { $: {} };
if (mojo.internal.bindings.remoting.mojom.CertificateBroker_GetCertificates_ParamsSpec.$.structSpec && mojo.internal.bindings.remoting.mojom.CertificateBroker_GetCertificates_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.remoting.mojom.CertificateBroker_GetCertificates_ParamsSpec.$ = {};
mojo.internal.bindings.remoting.mojom.CertificateBroker_GetCertificates_ResponseParamsSpec = mojo.internal.bindings.remoting.mojom.CertificateBroker_GetCertificates_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.remoting.mojom.CertificateBroker_GetCertificates_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.remoting.mojom.CertificateBroker_GetCertificates_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.remoting.mojom.CertificateBroker_GetCertificates_ResponseParamsSpec.$ = {};
...
mojo.internal.bindings.network.mojom.SSLPrivateKeySpec = mojo.internal.bindings.network.mojom.SSLPrivateKeySpec || { $: mojo.internal.OpaqueStruct.$ };
mojo.internal.bindings.network.mojom.SSLPrivateKeyRemote = mojo.internal.bindings.network.mojom.SSLPrivateKeyRemote || class {};
mojo.internal.bindings.network.mojom.SSLPrivateKeyPendingReceiver = mojo.internal.bindings.network.mojom.SSLPrivateKeyPendingReceiver || class { constructor(handle) { this.handle = handle; } };
mojo.internal.bindings.network = mojo.internal.bindings.network || {};
mojo.internal.bindings.network.mojom = mojo.internal.bindings.network.mojom || {};
...
// Interface: CertificateBroker
mojo.internal.bindings.remoting.mojom.CertificateBrokerPendingReceiver = class {
  constructor(handle) {
    this.handle = handle;
    if (handle) {
      this.__mojoHandle = handle.router_ ? handle.router_.pipe_ : (handle.pipe_ || handle);
...
mojo.internal.bindings.remoting.mojom.CertificateBrokerRemote = class {
  static get $interfaceName() {
    return 'remoting.mojom.CertificateBroker';
  }

  constructor(handle = undefined) {
    this.__mojoHandle = handle;
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.remoting.mojom.CertificateBrokerPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.remoting.mojom.CertificateBrokerRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.remoting.mojom.CertificateBrokerRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('remoting.mojom.CertificateBroker', [
      { explicit: null },
    ]);
  }
  ...
  getCertificates() {
    return this.proxy.sendMessage(
      this.ordinals[0],  // ordinal
      mojo.internal.bindings.remoting.mojom.CertificateBroker_GetCertificates_ParamsSpec,
      mojo.internal.bindings.remoting.mojom.CertificateBroker_GetCertificates_ResponseParamsSpec,
      [],
      false);
  }
...
mojo.internal.bindings.remoting.mojom.CertificateBroker.getRemote = function() {
  let remote = new mojo.internal.bindings.remoting.mojom.CertificateBrokerRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
    'remoting.mojom.CertificateBroker',
    'context');
  return remote.$;
};

mojo.internal.bindings.remoting.mojom.CertificateBrokerReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('remoting.mojom.CertificateBroker', [
      { explicit: null },
    ]);
    ordinals.forEach((ord, idx) => {
      this.ordinalMap.set(ord, idx); // Scrambled/Explicit
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.remoting.mojom.CertificateBroker_GetCertificates_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.getCertificates');
          const result = this.impl.getCertificates();
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const message = new mojo.internal.Message(
                ...
                header.ordinal, header.requestId, mojo.internal.bindings.remoting.mojom.CertificateBroker_GetCertificates_ResponseParamsSpec.$.structSpec, resp_obj);
...
mojo.internal.bindings.remoting.mojom.CertificateBrokerReceiver = mojo.internal.bindings.remoting.mojom.CertificateBrokerReceiver;

mojo.internal.bindings.remoting.mojom.CertificateBrokerPtr = mojo.internal.bindings.remoting.mojom.CertificateBrokerRemote;
mojo.internal.bindings.remoting.mojom.CertificateBrokerRequest = mojo.internal.bindings.remoting.mojom.CertificateBrokerPendingReceiver;


// Specs (at the end to ensure classes are defined for InterfaceProxy)

// Struct: ClientCertificateDetails
mojo.internal.Struct(
    mojo.internal.bindings.remoting.mojom.ClientCertificateDetailsSpec, 'remoting.mojom.ClientCertificateDetails', [
      ...
      mojo.internal.StructField('arg_private_key', 24, 0, mojo.internal.InterfaceProxy(mojo.internal.bindings.network.mojom.SSLPrivateKeyRemote), null, false, 0, undefined),
    ],
    [[0, 40]]);
mojo.internal.Struct(
...
mojo.internal.Struct(
    mojo.internal.bindings.remoting.mojom.CertificateBroker_GetCertificates_ParamsSpec, 'remoting.mojom.CertificateBroker_GetCertificates_Params', [
    ],
    [[0, 8]]);

mojo.internal.Struct(
    mojo.internal.bindings.remoting.mojom.CertificateBroker_GetCertificates_ResponseParamsSpec, 'remoting.mojom.CertificateBroker_GetCertificates_ResponseParams', [
      mojo.internal.StructField('arg_certs', 0, 0, mojo.internal.Array(mojo.internal.bindings.remoting.mojom.ClientCertificateDetailsSpec, false), null, false, 0, undefined),
    ],
    [[0, 16]]);
