...
mojo.internal.bindings.content.mojom.FrameHostTestInterface = {};
mojo.internal.bindings.content.mojom.FrameHostTestInterfaceSpec = { $ : {} };
mojo.internal.bindings.content.mojom.FrameHostTestInterface.$interfaceName = 'content.mojom.FrameHostTestInterface';
...
mojo.internal.bindings.content.mojom.FrameHostTestInterfaceRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.content.mojom.FrameHostTestInterfacePendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.content.mojom.FrameHostTestInterfaceRemoteCallHandler(this.proxy);
  }
  ...
  ping(arg_source_url, arg_source_event) {
    return this.$.ping(arg_source_url, arg_source_event);
  }
};

mojo.internal.bindings.content.mojom.FrameHostTestInterfaceRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('content.mojom.FrameHostTestInterface', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.content.mojom.FrameHostTestInterface.getRemote = function() {
  let remote = new mojo.internal.bindings.content.mojom.FrameHostTestInterfaceRemote();
...
mojo.internal.bindings.content.mojom.FrameHostTestInterfaceReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('content.mojom.FrameHostTestInterface', [
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.content.mojom.FrameHostTestInterface_Ping_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.content.mojom.FrameHostTestInterfaceReceiver = mojo.internal.bindings.content.mojom.FrameHostTestInterfaceReceiver;
