...
mojo.internal.bindings.gpu.mojom.GpuChannel_SignalSyncToken_ParamsSpec = mojo.internal.bindings.gpu.mojom.GpuChannel_SignalSyncToken_ParamsSpec || { $: {} };
if (mojo.internal.bindings.gpu.mojom.GpuChannel_SignalSyncToken_ParamsSpec.$.structSpec && mojo.internal.bindings.gpu.mojom.GpuChannel_SignalSyncToken_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.gpu.mojom.GpuChannel_SignalSyncToken_ParamsSpec.$ = {};
mojo.internal.bindings.gpu.mojom.GpuChannel_SignalSyncToken_ResponseParamsSpec = mojo.internal.bindings.gpu.mojom.GpuChannel_SignalSyncToken_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.gpu.mojom.GpuChannel_SignalSyncToken_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.gpu.mojom.GpuChannel_SignalSyncToken_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.gpu.mojom.GpuChannel_SignalSyncToken_ResponseParamsSpec.$ = {};
...
mojo.internal.bindings.gpu.mojom.GpuChannelRemote = class {
  ...
  signalSyncToken(arg_sync_tokens) {
    return this.$.signalSyncToken(arg_sync_tokens);
  }
};
...
mojo.internal.bindings.gpu.mojom.GpuChannelRemoteCallHandler = class {
  ...
  signalSyncToken(arg_sync_tokens) {
    return this.proxy.sendMessage(
      ...
      mojo.internal.bindings.gpu.mojom.GpuChannel_SignalSyncToken_ParamsSpec,
      mojo.internal.bindings.gpu.mojom.GpuChannel_SignalSyncToken_ResponseParamsSpec,
      [arg_sync_tokens],
      false);
  }
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        ...
        case 15: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.gpu.mojom.GpuChannel_SignalSyncToken_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.signalSyncToken');
          const result = this.impl.signalSyncToken(params.arg_sync_tokens);
          const expectsResponse = header.expectsResponse || (header.flags & 1);
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              const resp_obj = response;
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.gpu.mojom.GpuChannel_SignalSyncToken_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
            }).catch(e => console.error('[GeneratedReceiver] signalSyncToken FAILED:', e));
          }
          break;
        }
      }
...
mojo.internal.Struct(
    mojo.internal.bindings.gpu.mojom.GpuChannel_SignalSyncToken_ParamsSpec, 'gpu.mojom.GpuChannel_SignalSyncToken_Params', [
      mojo.internal.StructField('arg_sync_tokens', 0, 0, mojo.internal.Array(mojo.internal.bindings.gpu.mojom.SyncTokenSpec, false), null, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.gpu.mojom.GpuChannel_SignalSyncToken_ResponseParamsSpec, 'gpu.mojom.GpuChannel_SignalSyncToken_ResponseParams', [
    ],
    [[0, 8]]);
