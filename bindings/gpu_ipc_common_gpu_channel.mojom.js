...
mojo.internal.bindings.gpu.mojom.GpuChannel_GetGLGpuFence_ParamsSpec = mojo.internal.bindings.gpu.mojom.GpuChannel_GetGLGpuFence_ParamsSpec || { $: {} };
if (mojo.internal.bindings.gpu.mojom.GpuChannel_GetGLGpuFence_ParamsSpec.$.structSpec && mojo.internal.bindings.gpu.mojom.GpuChannel_GetGLGpuFence_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.gpu.mojom.GpuChannel_GetGLGpuFence_ParamsSpec.$ = {};
mojo.internal.bindings.gpu.mojom.GpuChannel_GetGLGpuFence_ResponseParamsSpec = mojo.internal.bindings.gpu.mojom.GpuChannel_GetGLGpuFence_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.gpu.mojom.GpuChannel_GetGLGpuFence_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.gpu.mojom.GpuChannel_GetGLGpuFence_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.gpu.mojom.GpuChannel_GetGLGpuFence_ResponseParamsSpec.$ = {};
...
mojo.internal.bindings.gpu.mojom.GpuChannelRemote = class {
  ...
  getGLGpuFence(arg_sync_token_dependencies, arg_release_count) {
    return this.$.getGLGpuFence(arg_sync_token_dependencies, arg_release_count);
  }
...
mojo.internal.bindings.gpu.mojom.GpuChannelRemoteCallHandler = class {
  ...
  getGLGpuFence(arg_sync_token_dependencies, arg_release_count) {
    return this.proxy.sendMessage(
      ...
      mojo.internal.bindings.gpu.mojom.GpuChannel_GetGLGpuFence_ParamsSpec,
      mojo.internal.bindings.gpu.mojom.GpuChannel_GetGLGpuFence_ResponseParamsSpec,
      [arg_sync_token_dependencies, arg_release_count],
      false);
  }
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        ...
        case 14: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.gpu.mojom.GpuChannel_GetGLGpuFence_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.getGLGpuFence');
          const result = this.impl.getGLGpuFence(params.arg_sync_token_dependencies, params.arg_release_count);
          const expectsResponse = header.expectsResponse || (header.flags & 1);
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.gpu.mojom.GpuChannel_GetGLGpuFence_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
            }).catch(e => console.error('[GeneratedReceiver] getGLGpuFence FAILED:', e));
          }
          break;
        }
        case 15: {
...
mojo.internal.Struct(
    mojo.internal.bindings.gpu.mojom.GpuChannel_GetGLGpuFence_ParamsSpec, 'gpu.mojom.GpuChannel_GetGLGpuFence_Params', [
      mojo.internal.StructField('arg_sync_token_dependencies', 0, 0, mojo.internal.Array(mojo.internal.bindings.gpu.mojom.SyncTokenSpec, false), null, false, 0, undefined),
      mojo.internal.StructField('arg_release_count', 8, 0, mojo.internal.Uint64, 0, false, 0, undefined),
    ],
    [[0, 24]]);

mojo.internal.Struct(
    mojo.internal.bindings.gpu.mojom.GpuChannel_GetGLGpuFence_ResponseParamsSpec, 'gpu.mojom.GpuChannel_GetGLGpuFence_ResponseParams', [
