  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        // Try Method 0: Clone
        try {
             decoder.decodeStruct(blink.mojom.SessionStorageNamespace_Clone_ParamsSpec.$, message.header.headerSize);
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStruct(blink.mojom.SessionStorageNamespace_Clone_ParamsSpec.$, message.header.headerSize);
