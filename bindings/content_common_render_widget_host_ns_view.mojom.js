...
mojo.internal.Struct(
    remote_cocoa.mojom.PopupMenuSpec, 'remote_cocoa.mojom.PopupMenu', [
      ...
      mojo.internal.StructField('receiver', 32, 0, mojo.internal.InterfaceRequest(remote_cocoa.mojom.PopupMenuRunnerRemote), null, false, 0, undefined),
    ],
    [[0, 48]]);
...
mojo.internal.Struct(
    remote_cocoa.mojom.RenderWidgetHostNSView_DisplayPopupMenu_ResponseParamsSpec, 'remote_cocoa.mojom.RenderWidgetHostNSView_DisplayPopupMenu_ResponseParams', [
      mojo.internal.StructField('selected_item_$flag', 0, 0, mojo.internal.Bool, false, false, 0, { isPrimary: true, linkedValueFieldName: 'selected_item_$value', originalFieldName: 'selected_item' }),
      mojo.internal.StructField('selected_item_$value', 4, 0, mojo.internal.Uint32, 0, false, 0, { isPrimary: false, linkedValueFieldName: 'selected_item_$flag', originalFieldName: 'selected_item' }),
    ],
    [[0, 16]]);
