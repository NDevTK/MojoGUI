...
mojo.internal.bindings.blink.mojom.NodeLocationTypeSpec = { $: mojo.internal.Enum() };
mojo.internal.bindings.blink.mojom.InnerTextSegmentSpec = { $: {} };
mojo.internal.bindings.blink.mojom.InnerTextFrameSpec = { $: {} };
mojo.internal.bindings.blink.mojom.InnerTextParamsSpec = { $: {} };
mojo.internal.bindings.blink.mojom.InnerTextAgent = {};
mojo.internal.bindings.blink.mojom.InnerTextAgentSpec = { $ : {} };
mojo.internal.bindings.blink.mojom.InnerTextAgent.$interfaceName = 'blink.mojom.InnerTextAgent';
...
mojo.internal.bindings.blink.mojom.InnerTextAgentRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.blink.mojom.InnerTextAgentPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.blink.mojom.InnerTextAgentRemoteCallHandler(this.proxy);
  }
  ...
  getInnerText(arg_params) {
    return this.$.getInnerText(arg_params);
  }
};

mojo.internal.bindings.blink.mojom.InnerTextAgentRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('blink.mojom.InnerTextAgent', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.blink.mojom.InnerTextAgent.getRemote = function() {
  let remote = new mojo.internal.bindings.blink.mojom.InnerTextAgentRemote();
...
mojo.internal.bindings.blink.mojom.InnerTextAgentReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('blink.mojom.InnerTextAgent', [
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        // Try Method 0: GetInnerText
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.blink.mojom.InnerTextAgent_GetInnerText_ParamsSpec.$.structSpec);
             console.log('[GeneratedReceiver] Discovery SUCCESS: ' + header.ordinal + ' -> GetInnerText (0)');
        ...
        case 0: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.blink.mojom.InnerTextAgent_GetInnerText_ResponseParamsSpec, header, rawHeader);
               responder(response);
...
mojo.internal.bindings.blink.mojom.InnerTextAgentReceiver = mojo.internal.bindings.blink.mojom.InnerTextAgentReceiver;
