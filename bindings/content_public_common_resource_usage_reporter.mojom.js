...
mojo.internal.Struct(
    mojo.internal.bindings.content.mojom.ResourceTypeStatSpec, 'content.mojom.ResourceTypeStat', [
      ...
      mojo.internal.StructField('arg_live_size', 16, 0, mojo.internal.Uint64, 0, false, 0, undefined),
      mojo.internal.StructField('arg_decoded_size', 24, 0, mojo.internal.Uint64, 0, false, 0, undefined),
    ],
    [[0, 40]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.content.mojom.ResourceUsageReporter_GetUsageData_ParamsSpec, 'content.mojom.ResourceUsageReporter_GetUsageData_Params', [
    ],
    [[0, 8]]);
...
mojo.internal.bindings.content.mojom.ResourceUsageReporterRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.content.mojom.ResourceUsageReporterPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.content.mojom.ResourceUsageReporterRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.content.mojom.ResourceUsageReporterRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('content.mojom.ResourceUsageReporter', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.content.mojom.ResourceUsageReporter.getRemote = function() {
  let remote = new mojo.internal.bindings.content.mojom.ResourceUsageReporterRemote();
...
mojo.internal.bindings.content.mojom.ResourceUsageReporterReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('content.mojom.ResourceUsageReporter', [
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.content.mojom.ResourceUsageReporter_GetUsageData_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for GetUsageData failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.content.mojom.ResourceUsageReporter_GetUsageData_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.getUsageData');
          const result = this.impl.getUsageData();
          const expectsResponse = header.expectsResponse || (header.flags & 1);
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              this.endpoint.send(header.ordinal, header.requestId, mojo.internal.kMessageFlagIsResponse, mojo.internal.bindings.content.mojom.ResourceUsageReporter_GetUsageData_ResponseParamsSpec, response);
...
mojo.internal.bindings.content.mojom.ResourceUsageReporterReceiver = mojo.internal.bindings.content.mojom.ResourceUsageReporterReceiver;

mojo.internal.bindings.content.mojom.ResourceUsageReporterPtr = mojo.internal.bindings.content.mojom.ResourceUsageReporterRemote;
mojo.internal.bindings.content.mojom.ResourceUsageReporterRequest = mojo.internal.bindings.content.mojom.ResourceUsageReporterPendingReceiver;
