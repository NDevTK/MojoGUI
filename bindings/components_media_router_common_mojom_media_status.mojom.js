...
// Enum: PlayState
mojo.internal.bindings.media_router.mojom.PlayState = {
  PLAYING: 0,
  PAUSED: 1,
  BUFFERING: 2,
};
...
mojo.internal.Struct(
    mojo.internal.bindings.media_router.mojom.MediaStatusSpec, 'media_router.mojom.MediaStatus', [
      ...
      mojo.internal.StructField('arg_current_time', 24, 0, mojo.internal.bindings.mojo_base.mojom.TimeDeltaSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_images', 32, 0, mojo.internal.Array(mojo.internal.bindings.media_router.mojom.MediaImageSpec, false), null, false, 0, undefined),
      mojo.internal.StructField('arg_play_state', 40, 0, mojo.internal.bindings.media_router.mojom.PlayStateSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_volume', 44, 0, mojo.internal.Float, 0, false, 0, undefined),
      mojo.internal.StructField('arg_can_play_pause', 48, 0, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_can_mute', 48, 1, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_can_set_volume', 48, 2, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_can_seek', 48, 3, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_can_skip_to_next_track', 48, 4, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_can_skip_to_previous_track', 48, 5, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_is_muted', 48, 6, mojo.internal.Bool, false, false, 0, undefined),
    ],
    [[0, 64]]);
...
mojo.internal.bindings.media_router.mojom.MediaStatusObserverRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.media_router.mojom.MediaStatusObserverPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.media_router.mojom.MediaStatusObserverRemoteCallHandler(this.proxy);
  }
  ...
  onMediaStatusUpdated(arg_status) {
    return this.$.onMediaStatusUpdated(arg_status);
  }
};

mojo.internal.bindings.media_router.mojom.MediaStatusObserverRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('media_router.mojom.MediaStatusObserver', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.media_router.mojom.MediaStatusObserver.getRemote = function() {
  let remote = new mojo.internal.bindings.media_router.mojom.MediaStatusObserverRemote();
...
mojo.internal.bindings.media_router.mojom.MediaStatusObserverReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('media_router.mojom.MediaStatusObserver', [
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.media_router.mojom.MediaStatusObserver_OnMediaStatusUpdated_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OnMediaStatusUpdated failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.media_router.mojom.MediaStatusObserverReceiver = mojo.internal.bindings.media_router.mojom.MediaStatusObserverReceiver;
