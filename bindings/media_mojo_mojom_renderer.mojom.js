...
media.mojom.Renderer_Initialize_ParamsSpec = {
  $: {
    structSpec: {
      ...
      packedSize: 24,
      fields: [
        { name: 'streams', packedOffset: 0, packedBitOffset: 0, type: mojo.internal.Array, nullable: true },
...
media.mojom.RendererClient_OnBufferingStateChange_ParamsSpec = {
  $: {
    structSpec: {
      ...
      packedSize: 24,
      fields: [
        { name: 'state', packedOffset: 0, packedBitOffset: 0, type: media.mojom.BufferingStateSpec, nullable: false },
        { name: 'reason', packedOffset: 8, packedBitOffset: 0, type: media.mojom.BufferingStateChangeReasonSpec, nullable: false },
      ],
      versions: [{version: 0}]
    }
  }
