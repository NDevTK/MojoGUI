...
mojo.internal.bindings.network_hints.mojom.NetworkHintsHandlerRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.network_hints.mojom.NetworkHintsHandlerPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.network_hints.mojom.NetworkHintsHandlerRemoteCallHandler(this.proxy);
  }
  ...
  prefetchDNS(arg_url_list) {
    return this.$.prefetchDNS(arg_url_list);
  }
  preconnect(arg_url, arg_allow_credentials) {
    return this.$.preconnect(arg_url, arg_allow_credentials);
  }
};
...
mojo.internal.bindings.network_hints.mojom.NetworkHintsHandler.getRemote = function() {
  let remote = new mojo.internal.bindings.network_hints.mojom.NetworkHintsHandlerRemote();
...
mojo.internal.bindings.network_hints.mojom.NetworkHintsHandlerReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.network_hints.mojom.NetworkHintsHandler_PrefetchDNS_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for PrefetchDNS failed with TypeError');
           }
        }
        // Try Method 1: Preconnect
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.network_hints.mojom.NetworkHintsHandler_Preconnect_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for Preconnect failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.network_hints.mojom.NetworkHintsHandlerReceiver = mojo.internal.bindings.network_hints.mojom.NetworkHintsHandlerReceiver;
