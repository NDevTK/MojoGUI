...
mojo.internal.bindings.enterprise_reporting.mojom.PageHandlerFactoryRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.enterprise_reporting.mojom.PageHandlerFactoryRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.enterprise_reporting.mojom.PageHandlerFactory.getRemote = function() {
  let remote = new mojo.internal.bindings.enterprise_reporting.mojom.PageHandlerFactoryRemote();
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.enterprise_reporting.mojom.PageHandlerFactory_CreatePageHandler_ParamsSpec.$.structSpec;
...
mojo.internal.bindings.enterprise_reporting.mojom.PageHandlerFactoryReceiver = mojo.internal.bindings.enterprise_reporting.mojom.PageHandlerFactoryReceiver;

mojo.internal.bindings.enterprise_reporting.mojom.PageHandlerFactoryPtr = mojo.internal.bindings.enterprise_reporting.mojom.PageHandlerFactoryRemote;
mojo.internal.bindings.enterprise_reporting.mojom.PageHandlerFactoryRequest = mojo.internal.bindings.enterprise_reporting.mojom.PageHandlerFactoryPendingReceiver;
...
mojo.internal.bindings.enterprise_reporting.mojom.PageHandlerRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.enterprise_reporting.mojom.PageHandlerRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.enterprise_reporting.mojom.PageHandler.getRemote = function() {
  let remote = new mojo.internal.bindings.enterprise_reporting.mojom.PageHandlerRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.enterprise_reporting.mojom.PageHandler_RecordDebugState_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for RecordDebugState failed with TypeError');
           }
        }
        // Try Method 1: GetDebugState
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.enterprise_reporting.mojom.PageHandler_GetDebugState_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for GetDebugState failed with TypeError');
           }
        }
        // Try Method 2: GetErpHistoryData
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.enterprise_reporting.mojom.PageHandler_GetErpHistoryData_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for GetErpHistoryData failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
             console.warn('[GeneratedReceiver] Failed to discover ordinal ' + header.ordinal);
      ...
      switch (dispatchId) {
        ...
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.enterprise_reporting.mojom.PageHandler_GetDebugState_ParamsSpec.$.structSpec);
        ...
        case 2: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.enterprise_reporting.mojom.PageHandler_GetErpHistoryData_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.enterprise_reporting.mojom.PageHandlerReceiver = mojo.internal.bindings.enterprise_reporting.mojom.PageHandlerReceiver;

mojo.internal.bindings.enterprise_reporting.mojom.PageHandlerPtr = mojo.internal.bindings.enterprise_reporting.mojom.PageHandlerRemote;
mojo.internal.bindings.enterprise_reporting.mojom.PageHandlerRequest = mojo.internal.bindings.enterprise_reporting.mojom.PageHandlerPendingReceiver;
...
mojo.internal.bindings.enterprise_reporting.mojom.PageRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.enterprise_reporting.mojom.PageRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.enterprise_reporting.mojom.Page.getRemote = function() {
  let remote = new mojo.internal.bindings.enterprise_reporting.mojom.PageRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.enterprise_reporting.mojom.Page_SetErpHistoryData_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for SetErpHistoryData failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
             console.warn('[GeneratedReceiver] Failed to discover ordinal ' + header.ordinal);
...
mojo.internal.bindings.enterprise_reporting.mojom.PageReceiver = mojo.internal.bindings.enterprise_reporting.mojom.PageReceiver;
