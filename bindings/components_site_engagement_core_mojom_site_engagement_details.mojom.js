...
mojo.internal.Struct(
    mojo.internal.bindings.site_engagement.mojom.SiteEngagementDetailsProvider_GetSiteEngagementDetails_ResponseParamsSpec, 'site_engagement.mojom.SiteEngagementDetailsProvider_GetSiteEngagementDetails_ResponseParams', [
      mojo.internal.StructField('arg_info', 0, 0, mojo.internal.Array(mojo.internal.bindings.mojo.internal.bindings.site_engagement.mojom.SiteEngagementDetailsSpec.$, false), null, false, 0, undefined),
    ],
    [[0, 16]]);
        ...
        case 0: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.site_engagement.mojom.SiteEngagementDetailsProvider_GetSiteEngagementDetails_ResponseParamsSpec, header, rawHeader);
               responder(response);
