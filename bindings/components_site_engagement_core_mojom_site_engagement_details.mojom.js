...
mojo.internal.bindings.site_engagement.mojom.SiteEngagementDetailsProviderRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.site_engagement.mojom.SiteEngagementDetailsProviderPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.site_engagement.mojom.SiteEngagementDetailsProviderRemoteCallHandler(this.proxy);
  }
  ...
  setSiteEngagementBaseScoreForUrl(arg_url, arg_score) {
    return this.$.setSiteEngagementBaseScoreForUrl(arg_url, arg_score);
  }
};
...
mojo.internal.bindings.site_engagement.mojom.SiteEngagementDetailsProvider.getRemote = function() {
  let remote = new mojo.internal.bindings.site_engagement.mojom.SiteEngagementDetailsProviderRemote();
...
mojo.internal.bindings.site_engagement.mojom.SiteEngagementDetailsProviderReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.site_engagement.mojom.SiteEngagementDetailsProvider_GetSiteEngagementDetails_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for GetSiteEngagementDetails failed with TypeError');
           }
        }
        // Try Method 1: SetSiteEngagementBaseScoreForUrl
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.site_engagement.mojom.SiteEngagementDetailsProvider_SetSiteEngagementBaseScoreForUrl_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for SetSiteEngagementBaseScoreForUrl failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.site_engagement.mojom.SiteEngagementDetailsProvider_GetSiteEngagementDetails_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.site_engagement.mojom.SiteEngagementDetailsProviderReceiver = mojo.internal.bindings.site_engagement.mojom.SiteEngagementDetailsProviderReceiver;
