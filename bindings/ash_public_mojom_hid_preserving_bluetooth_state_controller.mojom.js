...
mojo.internal.bindings.ash.mojom.HidPreservingBluetoothStateControllerRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.ash.mojom.HidPreservingBluetoothStateControllerPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.ash.mojom.HidPreservingBluetoothStateControllerRemoteCallHandler(this.proxy);
  }
  ...
  tryToSetBluetoothEnabledState(arg_enabled, arg_source) {
    return this.$.tryToSetBluetoothEnabledState(arg_enabled, arg_source);
  }
};

mojo.internal.bindings.ash.mojom.HidPreservingBluetoothStateControllerRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('ash.mojom.HidPreservingBluetoothStateController', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.ash.mojom.HidPreservingBluetoothStateController.getRemote = function() {
  let remote = new mojo.internal.bindings.ash.mojom.HidPreservingBluetoothStateControllerRemote();
...
mojo.internal.bindings.ash.mojom.HidPreservingBluetoothStateControllerReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('ash.mojom.HidPreservingBluetoothStateController', [
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ash.mojom.HidPreservingBluetoothStateController_TryToSetBluetoothEnabledState_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for TryToSetBluetoothEnabledState failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.ash.mojom.HidPreservingBluetoothStateControllerReceiver = mojo.internal.bindings.ash.mojom.HidPreservingBluetoothStateControllerReceiver;
