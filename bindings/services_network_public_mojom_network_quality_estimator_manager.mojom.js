...
mojo.internal.Struct(
    mojo.internal.bindings.network.mojom.NetworkQualityEstimatorManagerClient_OnNetworkQualityChanged_ParamsSpec, 'network.mojom.NetworkQualityEstimatorManagerClient_OnNetworkQualityChanged_Params', [
      ...
      mojo.internal.StructField('arg_downlink_bandwidth_kbps', 24, 0, mojo.internal.Int32, 0, false, 0, undefined),
    ],
    [[0, 40]]);
...
mojo.internal.bindings.network.mojom.NetworkQualityEstimatorManagerClientRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.network.mojom.NetworkQualityEstimatorManagerClientPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.network.mojom.NetworkQualityEstimatorManagerClientRemoteCallHandler(this.proxy);
  }
  ...
  onNetworkQualityChanged(arg_type, arg_http_rtt, arg_transport_rtt, arg_downlink_bandwidth_kbps) {
    return this.$.onNetworkQualityChanged(arg_type, arg_http_rtt, arg_transport_rtt, arg_downlink_bandwidth_kbps);
  }
};
...
mojo.internal.bindings.network.mojom.NetworkQualityEstimatorManagerClient.getRemote = function() {
  let remote = new mojo.internal.bindings.network.mojom.NetworkQualityEstimatorManagerClientRemote();
...
mojo.internal.bindings.network.mojom.NetworkQualityEstimatorManagerClientReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.network.mojom.NetworkQualityEstimatorManagerClient_OnNetworkQualityChanged_ParamsSpec.$.structSpec;
...
mojo.internal.bindings.network.mojom.NetworkQualityEstimatorManagerClientReceiver = mojo.internal.bindings.network.mojom.NetworkQualityEstimatorManagerClientReceiver;

mojo.internal.bindings.network.mojom.NetworkQualityEstimatorManagerClientPtr = mojo.internal.bindings.network.mojom.NetworkQualityEstimatorManagerClientRemote;
mojo.internal.bindings.network.mojom.NetworkQualityEstimatorManagerClientRequest = mojo.internal.bindings.network.mojom.NetworkQualityEstimatorManagerClientPendingReceiver;
...
mojo.internal.bindings.network.mojom.NetworkQualityEstimatorManagerRemote = class {
  static get $interfaceName() {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.network.mojom.NetworkQualityEstimatorManagerRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.network.mojom.NetworkQualityEstimatorManager.getRemote = function() {
  let remote = new mojo.internal.bindings.network.mojom.NetworkQualityEstimatorManagerRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
...
mojo.internal.bindings.network.mojom.NetworkQualityEstimatorManagerReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.network.mojom.NetworkQualityEstimatorManager_RequestNotifications_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
...
mojo.internal.bindings.network.mojom.NetworkQualityEstimatorManagerReceiver = mojo.internal.bindings.network.mojom.NetworkQualityEstimatorManagerReceiver;
