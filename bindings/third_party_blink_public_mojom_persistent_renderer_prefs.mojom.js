...
mojo.internal.bindings.blink.mojom.PersistentRendererPrefsService = {};
mojo.internal.bindings.blink.mojom.PersistentRendererPrefsServiceSpec = { $ : {} };
mojo.internal.bindings.blink.mojom.PersistentRendererPrefsService.$interfaceName = 'blink.mojom.PersistentRendererPrefsService';
...
mojo.internal.bindings.blink.mojom.PersistentRendererPrefsServiceRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.blink.mojom.PersistentRendererPrefsServicePendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.blink.mojom.PersistentRendererPrefsServiceRemoteCallHandler(this.proxy);
  }
  ...
  setViewSourceLineWrapping(arg_value) {
    return this.$.setViewSourceLineWrapping(arg_value);
  }
};

mojo.internal.bindings.blink.mojom.PersistentRendererPrefsServiceRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('blink.mojom.PersistentRendererPrefsService', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.blink.mojom.PersistentRendererPrefsService.getRemote = function() {
  let remote = new mojo.internal.bindings.blink.mojom.PersistentRendererPrefsServiceRemote();
...
mojo.internal.bindings.blink.mojom.PersistentRendererPrefsServiceReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('blink.mojom.PersistentRendererPrefsService', [
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.blink.mojom.PersistentRendererPrefsService_SetViewSourceLineWrapping_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for SetViewSourceLineWrapping failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.blink.mojom.PersistentRendererPrefsServiceReceiver = mojo.internal.bindings.blink.mojom.PersistentRendererPrefsServiceReceiver;
