...
mojo.internal.bindings.blink.mojom.AILanguageModelSamplingModeSpec = mojo.internal.bindings.blink.mojom.AILanguageModelSamplingModeSpec || { $: mojo.internal.Enum().$ };
...
mojo.internal.bindings.blink.mojom.AILanguageModelToolDeclarationSpec = mojo.internal.bindings.blink.mojom.AILanguageModelToolDeclarationSpec || { $: {} };
if (mojo.internal.bindings.blink.mojom.AILanguageModelToolDeclarationSpec.$.structSpec && mojo.internal.bindings.blink.mojom.AILanguageModelToolDeclarationSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.blink.mojom.AILanguageModelToolDeclarationSpec.$ = {};
...
mojo.internal.bindings.blink = mojo.internal.bindings.blink || {};
mojo.internal.bindings.blink.mojom = mojo.internal.bindings.blink.mojom || {};
mojo.internal.bindings.blink.mojom.AILanguageModelPromptContentSpec = mojo.internal.bindings.blink.mojom.AILanguageModelPromptContentSpec || { $: mojo.internal.OpaqueStruct.$ };
mojo.internal.bindings.blink = mojo.internal.bindings.blink || {};
mojo.internal.bindings.blink.mojom = mojo.internal.bindings.blink.mojom || {};
...
mojo.internal.bindings.on_device_model.mojom.AudioDataSpec = mojo.internal.bindings.on_device_model.mojom.AudioDataSpec || { $: mojo.internal.OpaqueStruct.$ };
mojo.internal.bindings.on_device_model = mojo.internal.bindings.on_device_model || {};
mojo.internal.bindings.on_device_model.mojom = mojo.internal.bindings.on_device_model.mojom || {};
...
mojo.internal.bindings.blink.mojom.AILanguageModelSamplingMode = {
  kMostPredictable: 0,
  kPredictable: 1,
  kBalanced: 2,
  kCreative: 3,
  kMostCreative: 4,
  kSlightlyPredictable: 5,
  kSlightlyCreative: 6,
};
...
mojo.internal.Struct(
    mojo.internal.bindings.blink.mojom.AILanguageModelInstanceInfoSpec, 'blink.mojom.AILanguageModelInstanceInfo', [
      ...
      mojo.internal.StructField('arg_audio_sample_rate_hz_$flag', 32, 0, mojo.internal.Bool, false, false, 0, { isPrimary: true, linkedValueFieldName: 'arg_audio_sample_rate_hz_$value', originalFieldName: 'arg_audio_sample_rate_hz' }),
      mojo.internal.StructField('arg_audio_channel_count_$flag', 32, 1, mojo.internal.Bool, false, false, 0, { isPrimary: true, linkedValueFieldName: 'arg_audio_channel_count_$value', originalFieldName: 'arg_audio_channel_count' }),
      mojo.internal.StructField('arg_audio_sample_rate_hz_$value', 36, 0, mojo.internal.Int32, 0, false, 0, { isPrimary: false, linkedValueFieldName: 'arg_audio_sample_rate_hz_$flag', originalFieldName: 'arg_audio_sample_rate_hz' }),
      mojo.internal.StructField('arg_audio_channel_count_$value', 40, 0, mojo.internal.Int32, 0, false, 0, { isPrimary: false, linkedValueFieldName: 'arg_audio_channel_count_$flag', originalFieldName: 'arg_audio_channel_count' }),
      mojo.internal.StructField('arg_sampling_mode', 44, 0, mojo.internal.bindings.blink.mojom.AILanguageModelSamplingModeSpec, null, true, 0, undefined),
    ],
    [[0, 56]]);
...
// Struct: AILanguageModelToolDeclaration
mojo.internal.Struct(
    mojo.internal.bindings.blink.mojom.AILanguageModelToolDeclarationSpec, 'blink.mojom.AILanguageModelToolDeclaration', [
...
mojo.internal.Struct(
    mojo.internal.bindings.blink.mojom.AILanguageModelCreateOptionsSpec, 'blink.mojom.AILanguageModelCreateOptions', [
      ...
      mojo.internal.StructField('arg_tools', 32, 0, mojo.internal.Array(mojo.internal.bindings.blink.mojom.AILanguageModelToolDeclarationSpec, false), null, true, 0, undefined),
      mojo.internal.StructField('arg_sampling_mode', 40, 0, mojo.internal.bindings.blink.mojom.AILanguageModelSamplingModeSpec, null, true, 0, undefined),
    ],
    [[0, 56]]);
mojo.internal.Struct(
