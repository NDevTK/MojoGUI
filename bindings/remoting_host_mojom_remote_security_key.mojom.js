...
mojo.internal.bindings.remoting.mojom.SecurityKeyForwarder = {};
mojo.internal.bindings.remoting.mojom.SecurityKeyForwarderSpec = { $ : {} };
mojo.internal.bindings.remoting.mojom.SecurityKeyForwarder.$interfaceName = 'remoting.mojom.SecurityKeyForwarder';
...
mojo.internal.bindings.remoting.mojom.SecurityKeyForwarderRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.remoting.mojom.SecurityKeyForwarderRemoteCallHandler(this.proxy);
  }
  ...
  onSecurityKeyRequest(arg_request_data) {
    return this.$.onSecurityKeyRequest(arg_request_data);
  }
};

mojo.internal.bindings.remoting.mojom.SecurityKeyForwarderRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('remoting.mojom.SecurityKeyForwarder', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.remoting.mojom.SecurityKeyForwarder.getRemote = function() {
  let remote = new mojo.internal.bindings.remoting.mojom.SecurityKeyForwarderRemote();
...
mojo.internal.bindings.remoting.mojom.SecurityKeyForwarderReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('remoting.mojom.SecurityKeyForwarder', [
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.remoting.mojom.SecurityKeyForwarder_OnSecurityKeyRequest_ParamsSpec.$.structSpec);
        ...
        case 0: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.remoting.mojom.SecurityKeyForwarder_OnSecurityKeyRequest_ResponseParamsSpec, header, rawHeader);
               responder(response);
...
mojo.internal.bindings.remoting.mojom.SecurityKeyForwarderReceiver = mojo.internal.bindings.remoting.mojom.SecurityKeyForwarderReceiver;
