...
mojo.internal.bindings.viz.mojom.ExternalBeginFrameControllerRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.viz.mojom.ExternalBeginFrameControllerRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.viz.mojom.ExternalBeginFrameController.getRemote = function() {
  let remote = new mojo.internal.bindings.viz.mojom.ExternalBeginFrameControllerRemote();
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.viz.mojom.ExternalBeginFrameController_IssueExternalBeginFrame_ParamsSpec.$.structSpec;
...
mojo.internal.bindings.viz.mojom.ExternalBeginFrameControllerReceiver = mojo.internal.bindings.viz.mojom.ExternalBeginFrameControllerReceiver;

mojo.internal.bindings.viz.mojom.ExternalBeginFrameControllerPtr = mojo.internal.bindings.viz.mojom.ExternalBeginFrameControllerRemote;
mojo.internal.bindings.viz.mojom.ExternalBeginFrameControllerRequest = mojo.internal.bindings.viz.mojom.ExternalBeginFrameControllerPendingReceiver;
...
mojo.internal.bindings.viz.mojom.ExternalBeginFrameControllerClientRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.viz.mojom.ExternalBeginFrameControllerClientRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.viz.mojom.ExternalBeginFrameControllerClient.getRemote = function() {
  let remote = new mojo.internal.bindings.viz.mojom.ExternalBeginFrameControllerClientRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.viz.mojom.ExternalBeginFrameControllerClient_SetNeedsBeginFrame_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.viz.mojom.ExternalBeginFrameControllerClient_NeedsBeginFrameWithId_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for NeedsBeginFrameWithId failed with TypeError');
           }
        }
        // Try Method 2: SetPreferredInterval
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.viz.mojom.ExternalBeginFrameControllerClient_SetPreferredInterval_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for SetPreferredInterval failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
             console.warn('[GeneratedReceiver] Failed to discover ordinal ' + header.ordinal);
...
mojo.internal.bindings.viz.mojom.ExternalBeginFrameControllerClientReceiver = mojo.internal.bindings.viz.mojom.ExternalBeginFrameControllerClientReceiver;
