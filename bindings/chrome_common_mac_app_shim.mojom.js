...
mojo.internal.bindings.mac_notifications.mojom.MacNotificationActionHandlerRemote = mojo.internal.bindings.mac_notifications.mojom.MacNotificationActionHandlerRemote || class {};
mojo.internal.bindings.mac_notifications.mojom.MacNotificationActionHandlerPendingReceiver = mojo.internal.bindings.mac_notifications.mojom.MacNotificationActionHandlerPendingReceiver || class { constructor(handle) { this.handle = handle; } };
mojo.internal.bindings.mac_notifications = mojo.internal.bindings.mac_notifications || {};
mojo.internal.bindings.mac_notifications.mojom = mojo.internal.bindings.mac_notifications.mojom || {};
...
mojo.internal.bindings.mac_notifications.mojom.MacNotificationProviderRemote = mojo.internal.bindings.mac_notifications.mojom.MacNotificationProviderRemote || class {};
mojo.internal.bindings.mac_notifications.mojom.MacNotificationProviderPendingReceiver = mojo.internal.bindings.mac_notifications.mojom.MacNotificationProviderPendingReceiver || class { constructor(handle) { this.handle = handle; } };
mojo.internal.bindings.mac_notifications = mojo.internal.bindings.mac_notifications || {};
mojo.internal.bindings.mac_notifications.mojom = mojo.internal.bindings.mac_notifications.mojom || {};
...
mojo.internal.bindings.metrics.mojom.ChildHistogramFetcherFactoryRemote = mojo.internal.bindings.metrics.mojom.ChildHistogramFetcherFactoryRemote || class {};
mojo.internal.bindings.metrics.mojom.ChildHistogramFetcherFactoryPendingReceiver = mojo.internal.bindings.metrics.mojom.ChildHistogramFetcherFactoryPendingReceiver || class { constructor(handle) { this.handle = handle; } };
mojo.internal.bindings.mojo_base = mojo.internal.bindings.mojo_base || {};
mojo.internal.bindings.mojo_base.mojom = mojo.internal.bindings.mojo_base.mojom || {};
...
mojo.internal.bindings.remote_cocoa.mojom.ApplicationRemote = mojo.internal.bindings.remote_cocoa.mojom.ApplicationRemote || class {};
mojo.internal.bindings.remote_cocoa.mojom.ApplicationPendingReceiver = mojo.internal.bindings.remote_cocoa.mojom.ApplicationPendingReceiver || class { constructor(handle) { this.handle = handle; } };
mojo.internal.bindings.url = mojo.internal.bindings.url || {};
