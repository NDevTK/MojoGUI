...
mojo.internal.bindings.content.mojom.FontCacheWin = {};
mojo.internal.bindings.content.mojom.FontCacheWinSpec = { $ : {} };
mojo.internal.bindings.content.mojom.FontCacheWin.$interfaceName = 'content.mojom.FontCacheWin';
...
mojo.internal.bindings.content.mojom.FontCacheWinRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.content.mojom.FontCacheWinPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.content.mojom.FontCacheWinRemoteCallHandler(this.proxy);
  }
  ...
  preCacheFont(arg_log_font) {
    return this.$.preCacheFont(arg_log_font);
  }
  releaseCachedFonts() {
...
mojo.internal.bindings.content.mojom.FontCacheWinRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('content.mojom.FontCacheWin', [
      { explicit: null },
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.content.mojom.FontCacheWin.getRemote = function() {
  let remote = new mojo.internal.bindings.content.mojom.FontCacheWinRemote();
...
mojo.internal.bindings.content.mojom.FontCacheWinReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('content.mojom.FontCacheWin', [
      { explicit: null },
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.content.mojom.FontCacheWin_PreCacheFont_ParamsSpec.$.structSpec);
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.content.mojom.FontCacheWin_ReleaseCachedFonts_ParamsSpec.$.structSpec);
      ...
      switch (dispatchId) {
        case 0: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.content.mojom.FontCacheWin_PreCacheFont_ResponseParamsSpec, header, rawHeader);
               responder(response);
        ...
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.content.mojom.FontCacheWin_ReleaseCachedFonts_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.content.mojom.FontCacheWinReceiver = mojo.internal.bindings.content.mojom.FontCacheWinReceiver;
