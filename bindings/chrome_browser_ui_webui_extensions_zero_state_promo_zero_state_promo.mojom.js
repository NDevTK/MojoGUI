...
mojo.internal.bindings.zero_state_promo.mojom.PageHandlerFactoryRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.zero_state_promo.mojom.PageHandlerFactoryPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.zero_state_promo.mojom.PageHandlerFactoryRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.zero_state_promo.mojom.PageHandlerFactoryRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('zero_state_promo.mojom.PageHandlerFactory', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.zero_state_promo.mojom.PageHandlerFactory.getRemote = function() {
  let remote = new mojo.internal.bindings.zero_state_promo.mojom.PageHandlerFactoryRemote();
...
mojo.internal.bindings.zero_state_promo.mojom.PageHandlerFactoryReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('zero_state_promo.mojom.PageHandlerFactory', [
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.zero_state_promo.mojom.PageHandlerFactory_CreatePageHandler_ParamsSpec.$.structSpec;
...
mojo.internal.bindings.zero_state_promo.mojom.PageHandlerFactoryReceiver = mojo.internal.bindings.zero_state_promo.mojom.PageHandlerFactoryReceiver;

mojo.internal.bindings.zero_state_promo.mojom.PageHandlerFactoryPtr = mojo.internal.bindings.zero_state_promo.mojom.PageHandlerFactoryRemote;
mojo.internal.bindings.zero_state_promo.mojom.PageHandlerFactoryRequest = mojo.internal.bindings.zero_state_promo.mojom.PageHandlerFactoryPendingReceiver;
...
mojo.internal.bindings.zero_state_promo.mojom.PageHandlerRemote = class {
  static get $interfaceName() {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.zero_state_promo.mojom.PageHandlerPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.zero_state_promo.mojom.PageHandlerRemoteCallHandler(this.proxy);
  }
  ...
  launchWebStoreLink(arg_link) {
    return this.$.launchWebStoreLink(arg_link);
  }
};

mojo.internal.bindings.zero_state_promo.mojom.PageHandlerRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('zero_state_promo.mojom.PageHandler', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.zero_state_promo.mojom.PageHandler.getRemote = function() {
  let remote = new mojo.internal.bindings.zero_state_promo.mojom.PageHandlerRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
...
mojo.internal.bindings.zero_state_promo.mojom.PageHandlerReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('zero_state_promo.mojom.PageHandler', [
      { explicit: null },
    ]);
    ordinals.forEach((ord, idx) => {
      this.ordinalMap.set(ord, idx); // Scrambled/Explicit
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.zero_state_promo.mojom.PageHandler_LaunchWebStoreLink_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for LaunchWebStoreLink failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
             console.warn('[GeneratedReceiver] Failed to discover ordinal ' + header.ordinal);
...
mojo.internal.bindings.zero_state_promo.mojom.PageHandlerReceiver = mojo.internal.bindings.zero_state_promo.mojom.PageHandlerReceiver;
