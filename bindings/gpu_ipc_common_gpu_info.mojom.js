  ...
  $: {
    structSpec: {
      ...
      fields: [
        ...
        { name: 'gpu_preference', packedOffset: 56, packedBitOffset: 0, type: gl.mojom.GpuPreferenceSpec, nullable: false },
...
gpu.mojom.OverlayInfoSpec = {
  $: {
    structSpec: {
      ...
      packedSize: 56,
      fields: [
        { name: 'yuy2_overlay_support', packedOffset: 0, packedBitOffset: 0, type: gpu.mojom.OverlaySupportSpec, nullable: false },
        { name: 'nv12_overlay_support', packedOffset: 8, packedBitOffset: 0, type: gpu.mojom.OverlaySupportSpec, nullable: false },
        { name: 'bgra8_overlay_support', packedOffset: 16, packedBitOffset: 0, type: gpu.mojom.OverlaySupportSpec, nullable: false },
        { name: 'rgb10a2_overlay_support', packedOffset: 24, packedBitOffset: 0, type: gpu.mojom.OverlaySupportSpec, nullable: false },
        { name: 'p010_overlay_support', packedOffset: 32, packedBitOffset: 0, type: gpu.mojom.OverlaySupportSpec, nullable: false },
  ...
  $: {
    structSpec: {
      ...
      fields: [
        ...
        { name: 'gpu', packedOffset: 8, packedBitOffset: 0, type: gpu.mojom.GpuDeviceSpec, nullable: false },
        ...
        { name: 'skia_backend_type', packedOffset: 80, packedBitOffset: 0, type: gpu.mojom.SkiaBackendTypeSpec, nullable: false },
        ...
        { name: 'gl_implementation_parts', packedOffset: 144, packedBitOffset: 0, type: gl.mojom.GLImplementationPartsSpec, nullable: false },
