...
mojo.internal.Struct(
    mojo.internal.bindings.network.mojom.URLRequestSpec, 'network.mojom.URLRequest', [
      ...
      mojo.internal.StructField('arg_attribution_reporting_eligibility', 272, 0, mojo.internal.bindings.network.mojom.AttributionReportingEligibilitySpec.$, 0, false, 0, undefined),
      mojo.internal.StructField('arg_attribution_reporting_src_token', 280, 0, mojo.internal.bindings.mojo_base.mojom.UnguessableTokenSpec.$, null, true, 0, undefined),
      mojo.internal.StructField('arg_keepalive_token', 288, 0, mojo.internal.bindings.mojo_base.mojom.UnguessableTokenSpec.$, null, true, 0, undefined),
      mojo.internal.StructField('arg_socket_tag', 296, 0, mojo.internal.bindings.network.mojom.SocketTagSpec.$, null, false, 0, undefined),
      mojo.internal.StructField('arg_permissions_policy', 304, 0, mojo.internal.bindings.network.mojom.PermissionsPolicySpec.$, null, true, 0, undefined),
      mojo.internal.StructField('arg_fetch_retry_options', 312, 0, mojo.internal.bindings.network.mojom.FetchRetryOptionsSpec.$, null, true, 0, undefined),
      mojo.internal.StructField('arg_load_flags', 320, 0, mojo.internal.Int32, 0, false, 0, undefined),
      mojo.internal.StructField('arg_resource_type', 324, 0, mojo.internal.Int32, 0, false, 0, undefined),
      mojo.internal.StructField('arg_transition_type', 328, 0, mojo.internal.Int32, 0, false, 0, undefined),
      mojo.internal.StructField('arg_previews_state', 332, 0, mojo.internal.Int32, 0, false, 0, undefined),
      mojo.internal.StructField('arg_update_first_party_url_on_redirect', 336, 0, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_priority_incremental', 336, 1, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_originated_from_service_worker', 336, 2, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_skip_service_worker', 336, 3, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_keepalive', 336, 4, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_browsing_topics', 336, 5, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_ad_auction_headers', 336, 6, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_shared_storage_writable_eligible', 336, 7, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_has_user_gesture', 337, 0, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_enable_load_timing', 337, 1, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_enable_upload_progress', 337, 2, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_do_not_prompt_for_login', 337, 3, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_is_outermost_main_frame', 337, 4, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_upgrade_if_insecure', 337, 5, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_is_revalidating', 337, 6, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_is_fetch_like_api', 337, 7, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_is_fetch_later_api', 338, 0, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_is_favicon', 338, 1, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_is_ad_tagged', 338, 2, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_shared_dictionary_writer_enabled', 338, 3, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_client_side_content_decoding_enabled', 338, 4, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_allows_device_bound_session_registration', 338, 5, mojo.internal.Bool, false, false, 0, undefined),
    ],
    [[0, 352]]);
