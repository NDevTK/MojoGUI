...
mojo.internal.Struct(
    network.mojom.URLRequestSpec, 'network.mojom.URLRequest', [
      ...
      mojo.internal.StructField('priority_incremental', 100, 0, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('cors_preflight_policy', 104, 0, network.mojom.CorsPreflightPolicySpec, null, false, 0, undefined),
      mojo.internal.StructField('originated_from_service_worker', 108, 0, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('skip_service_worker', 108, 1, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('mode', 112, 0, network.mojom.RequestModeSpec, null, false, 0, undefined),
      mojo.internal.StructField('credentials_mode', 116, 0, network.mojom.CredentialsModeSpec, null, false, 0, undefined),
      mojo.internal.StructField('redirect_mode', 120, 0, network.mojom.RedirectModeSpec, null, false, 0, undefined),
      mojo.internal.StructField('fetch_integrity', 128, 0, mojo.internal.String, null, false, 0, undefined),
      mojo.internal.StructField('expected_public_keys', 136, 0, mojo.internal.Array(mojo.internal.Array(mojo.internal.Uint8, false), false), null, false, 0, undefined),
      mojo.internal.StructField('destination', 144, 0, network.mojom.RequestDestinationSpec, null, false, 0, undefined),
      mojo.internal.StructField('request_body', 152, 0, network.mojom.URLRequestBodySpec, null, true, 0, undefined),
      mojo.internal.StructField('keepalive', 160, 0, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('browsing_topics', 160, 1, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('ad_auction_headers', 160, 2, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('shared_storage_writable_eligible', 160, 3, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('has_user_gesture', 160, 4, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('enable_load_timing', 160, 5, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('enable_upload_progress', 160, 6, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('do_not_prompt_for_login', 160, 7, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('is_outermost_main_frame', 161, 0, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('transition_type', 164, 0, mojo.internal.Int32, 0, false, 0, undefined),
      mojo.internal.StructField('previews_state', 168, 0, mojo.internal.Int32, 0, false, 0, undefined),
      mojo.internal.StructField('upgrade_if_insecure', 172, 0, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('is_revalidating', 172, 1, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('throttling_profile_id', 176, 0, mojo_base.mojom.UnguessableTokenSpec, null, true, 0, undefined),
      mojo.internal.StructField('fetch_window_id', 184, 0, mojo_base.mojom.UnguessableTokenSpec, null, true, 0, undefined),
      mojo.internal.StructField('devtools_request_id', 192, 0, mojo.internal.String, null, true, 0, undefined),
      mojo.internal.StructField('devtools_stack_id', 200, 0, mojo.internal.String, null, true, 0, undefined),
      mojo.internal.StructField('is_fetch_like_api', 208, 0, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('is_fetch_later_api', 208, 1, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('is_favicon', 208, 2, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('original_destination', 212, 0, network.mojom.RequestDestinationSpec, null, false, 0, undefined),
      mojo.internal.StructField('trusted_params', 216, 0, network.mojom.TrustedUrlRequestParamsSpec, null, true, 0, undefined),
      mojo.internal.StructField('recursive_prefetch_token', 224, 0, mojo_base.mojom.UnguessableTokenSpec, null, true, 0, undefined),
      mojo.internal.StructField('trust_token_params', 232, 0, network.mojom.TrustTokenParamsSpec, null, true, 0, undefined),
      mojo.internal.StructField('web_bundle_token_params', 240, 0, network.mojom.WebBundleTokenParamsSpec, null, true, 0, undefined),
      mojo.internal.StructField('devtools_accepted_stream_types', 248, 0, mojo.internal.Array(network.mojom.SourceTypeSpec, false), null, true, 0, undefined),
      mojo.internal.StructField('net_log_create_info', 256, 0, network.mojom.NetLogSourceSpec, null, true, 0, undefined),
      mojo.internal.StructField('net_log_reference_info', 264, 0, network.mojom.NetLogSourceSpec, null, true, 0, undefined),
      ...
      mojo.internal.StructField('attribution_reporting_src_token', 288, 0, mojo_base.mojom.UnguessableTokenSpec, null, true, 0, undefined),
      mojo.internal.StructField('keepalive_token', 296, 0, mojo_base.mojom.UnguessableTokenSpec, null, true, 0, undefined),
      mojo.internal.StructField('is_ad_tagged', 304, 0, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('shared_dictionary_writer_enabled', 304, 1, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('client_side_content_decoding_enabled', 304, 2, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('socket_tag', 312, 0, network.mojom.SocketTagSpec, null, false, 0, undefined),
      mojo.internal.StructField('allows_device_bound_session_registration', 320, 0, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('permissions_policy', 328, 0, network.mojom.PermissionsPolicySpec, null, true, 0, undefined),
      mojo.internal.StructField('fetch_retry_options', 336, 0, network.mojom.FetchRetryOptionsSpec, null, true, 0, undefined),
    ],
    [[0, 352]]);
