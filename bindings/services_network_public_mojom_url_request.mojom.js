...
mojo.internal.Union(
    mojo.internal.bindings.network.mojom.DataElementSpec, 'network.mojom.DataElement', {
      'arg_bytes': {
        'ordinal': 0,
        'type': mojo.internal.bindings.mojo.internal.bindings.network.mojom.DataElementBytesSpec.$,
        'nullable': false,
      },
      'arg_file': {
        'ordinal': 1,
        'type': mojo.internal.bindings.mojo.internal.bindings.network.mojom.DataElementFileSpec.$,
        'nullable': false,
      },
      'arg_data_pipe': {
        'ordinal': 2,
        'type': mojo.internal.bindings.mojo.internal.bindings.network.mojom.DataElementDataPipeSpec.$,
        'nullable': false,
      },
      'arg_chunked_data_pipe': {
        'ordinal': 3,
        'type': mojo.internal.bindings.mojo.internal.bindings.network.mojom.DataElementChunkedDataPipeSpec.$,
        'nullable': false,
      },
    });
...
mojo.internal.Struct(
    mojo.internal.bindings.network.mojom.TrustedUrlRequestParamsSpec, 'network.mojom.TrustedUrlRequestParams', [
      ...
      mojo.internal.StructField('arg_enabled_client_hints', 8, 0, mojo.internal.bindings.mojo.internal.bindings.network.mojom.EnabledClientHintsSpec.$, null, true, 0, undefined),
...
mojo.internal.Struct(
    mojo.internal.bindings.network.mojom.URLRequestSpec, 'network.mojom.URLRequest', [
      ...
      mojo.internal.StructField('arg_request_body', 144, 0, mojo.internal.bindings.mojo.internal.bindings.network.mojom.URLRequestBodySpec.$, null, true, 0, undefined),
      ...
      mojo.internal.StructField('arg_trusted_params', 192, 0, mojo.internal.bindings.mojo.internal.bindings.network.mojom.TrustedUrlRequestParamsSpec.$, null, true, 0, undefined),
      ...
      mojo.internal.StructField('arg_web_bundle_token_params', 216, 0, mojo.internal.bindings.mojo.internal.bindings.network.mojom.WebBundleTokenParamsSpec.$, null, true, 0, undefined),
      ...
      mojo.internal.StructField('arg_socket_tag', 288, 0, mojo.internal.bindings.mojo.internal.bindings.network.mojom.SocketTagSpec.$, null, false, 0, undefined),
