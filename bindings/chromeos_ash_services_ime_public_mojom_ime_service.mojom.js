...
mojo.internal.bindings.ash.ime.mojom.ConnectionFactoryRemote = mojo.internal.bindings.ash.ime.mojom.ConnectionFactoryRemote || class {};
mojo.internal.bindings.ash.ime.mojom.ConnectionFactoryPendingReceiver = mojo.internal.bindings.ash.ime.mojom.ConnectionFactoryPendingReceiver || class { constructor(handle) { this.handle = handle; } };
mojo.internal.bindings.ash = mojo.internal.bindings.ash || {};
mojo.internal.bindings.ash.ime = mojo.internal.bindings.ash.ime || {};
mojo.internal.bindings.ash.ime.mojom = mojo.internal.bindings.ash.ime.mojom || {};
...
mojo.internal.bindings.ash.ime.mojom.InputChannelRemote = mojo.internal.bindings.ash.ime.mojom.InputChannelRemote || class {};
mojo.internal.bindings.ash.ime.mojom.InputChannelPendingReceiver = mojo.internal.bindings.ash.ime.mojom.InputChannelPendingReceiver || class { constructor(handle) { this.handle = handle; } };
mojo.internal.bindings.ash = mojo.internal.bindings.ash || {};
mojo.internal.bindings.ash.ime = mojo.internal.bindings.ash.ime || {};
mojo.internal.bindings.ash.ime.mojom = mojo.internal.bindings.ash.ime.mojom || {};
...
mojo.internal.bindings.ash.ime.mojom.InputMethodUserDataServiceRemote = mojo.internal.bindings.ash.ime.mojom.InputMethodUserDataServiceRemote || class {};
mojo.internal.bindings.ash.ime.mojom.InputMethodUserDataServicePendingReceiver = mojo.internal.bindings.ash.ime.mojom.InputMethodUserDataServicePendingReceiver || class { constructor(handle) { this.handle = handle; } };
mojo.internal.bindings.mojo_base = mojo.internal.bindings.mojo_base || {};
mojo.internal.bindings.mojo_base.mojom = mojo.internal.bindings.mojo_base.mojom || {};
