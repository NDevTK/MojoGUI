...
mojo.internal.bindings.wl.mojom.ConfigTraitsTestService = {};
mojo.internal.bindings.wl.mojom.ConfigTraitsTestServiceSpec = { $ : {} };
mojo.internal.bindings.wl.mojom.ConfigTraitsTestService.$interfaceName = 'wl.mojom.ConfigTraitsTestService';
...
mojo.internal.bindings.wl.mojom.ConfigTraitsTestServiceRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.wl.mojom.ConfigTraitsTestServicePendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.wl.mojom.ConfigTraitsTestServiceRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.wl.mojom.ConfigTraitsTestServiceRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('wl.mojom.ConfigTraitsTestService', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.wl.mojom.ConfigTraitsTestService.getRemote = function() {
  let remote = new mojo.internal.bindings.wl.mojom.ConfigTraitsTestServiceRemote();
...
mojo.internal.bindings.wl.mojom.ConfigTraitsTestServiceReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('wl.mojom.ConfigTraitsTestService', [
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.wl.mojom.ConfigTraitsTestService_EchoTransform_ParamsSpec.$.structSpec);
        ...
        case 0: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.wl.mojom.ConfigTraitsTestService_EchoTransform_ResponseParamsSpec, header, rawHeader);
               responder(response);
...
mojo.internal.bindings.wl.mojom.ConfigTraitsTestServiceReceiver = mojo.internal.bindings.wl.mojom.ConfigTraitsTestServiceReceiver;
