...
mojo.internal.Struct(
    mojo.internal.bindings.arc.mojom.RunningAppProcessInfoSpec, 'arc.mojom.RunningAppProcessInfo', [
      ...
      mojo.internal.StructField('arg_packages', 8, 0, mojo.internal.Array(mojo.internal.String, false), null, true, 0, undefined),
      mojo.internal.StructField('arg_last_activity_time', 16, 0, mojo.internal.Int64, 0, false, 0, undefined),
      mojo.internal.StructField('arg_pid', 24, 0, mojo.internal.Uint32, 0, false, 0, undefined),
      mojo.internal.StructField('arg_process_state', 28, 0, mojo.internal.bindings.arc.mojom.ProcessStateSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_is_focused', 32, 0, mojo.internal.Bool, false, false, 0, undefined),
    ],
    [[0, 48]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.arc.mojom.ProcessInstance_ApplyHostMemoryPressureDeprecated_ParamsSpec, 'arc.mojom.ProcessInstance_ApplyHostMemoryPressureDeprecated_Params', [
      mojo.internal.StructField('arg_reclaim_target', 0, 0, mojo.internal.Int64, 0, false, 0, undefined),
      mojo.internal.StructField('arg_level', 8, 0, mojo.internal.bindings.arc.mojom.ProcessStateSpec, null, false, 0, undefined),
    ],
    [[0, 24]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.arc.mojom.ProcessInstance_ApplyHostMemoryPressureDeprecated_ResponseParamsSpec, 'arc.mojom.ProcessInstance_ApplyHostMemoryPressureDeprecated_ResponseParams', [
      mojo.internal.StructField('arg_reclaimed', 0, 0, mojo.internal.Uint64, 0, false, 0, undefined),
      mojo.internal.StructField('arg_killed', 8, 0, mojo.internal.Uint32, 0, false, 0, undefined),
    ],
    [[0, 24]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.arc.mojom.ProcessInstance_ApplyHostMemoryPressure_ParamsSpec, 'arc.mojom.ProcessInstance_ApplyHostMemoryPressure_Params', [
      mojo.internal.StructField('arg_reclaim_target', 0, 0, mojo.internal.Int64, 0, false, 0, undefined),
      mojo.internal.StructField('arg_level', 8, 0, mojo.internal.bindings.arc.mojom.PressureLevelSpec, null, false, 0, undefined),
    ],
    [[0, 24]]);
...
mojo.internal.bindings.arc.mojom.ProcessInstanceRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.arc.mojom.ProcessInstanceRemoteCallHandler(this.proxy);
  }
  ...
  applyHostMemoryPressureDeprecated(arg_level, arg_reclaim_target) {
    return this.$.applyHostMemoryPressureDeprecated(arg_level, arg_reclaim_target);
  }
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.arc.mojom.ProcessInstance_KillProcess_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for KillProcess failed with TypeError');
           }
        }
        // Try Method 1: RequestProcessList
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.arc.mojom.ProcessInstance_RequestProcessList_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for RequestProcessList failed with TypeError');
           }
        }
        // Try Method 2: RequestApplicationProcessMemoryInfo
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.arc.mojom.ProcessInstance_RequestApplicationProcessMemoryInfo_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for RequestApplicationProcessMemoryInfo failed with TypeError');
           }
        }
        // Try Method 3: RequestSystemProcessMemoryInfo
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.arc.mojom.ProcessInstance_RequestSystemProcessMemoryInfo_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for RequestSystemProcessMemoryInfo failed with TypeError');
           }
        }
        // Try Method 4: ApplyHostMemoryPressureDeprecated
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.arc.mojom.ProcessInstance_ApplyHostMemoryPressureDeprecated_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for ApplyHostMemoryPressureDeprecated failed with TypeError');
           }
        }
        // Try Method 5: ApplyHostMemoryPressure
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.arc.mojom.ProcessInstance_ApplyHostMemoryPressure_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for ApplyHostMemoryPressure failed with TypeError');
           }
        }
        // Try Method 6: RequestLowMemoryKillCounts
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.arc.mojom.ProcessInstance_RequestLowMemoryKillCounts_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for RequestLowMemoryKillCounts failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
      ...
      switch (dispatchId) {
        ...
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.arc.mojom.ProcessInstance_RequestProcessList_ParamsSpec.$.structSpec);
        ...
        case 2: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.arc.mojom.ProcessInstance_RequestApplicationProcessMemoryInfo_ParamsSpec.$.structSpec);
        ...
        case 6: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.arc.mojom.ProcessInstance_RequestLowMemoryKillCounts_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.arc.mojom.ProcessInstanceReceiver = mojo.internal.bindings.arc.mojom.ProcessInstanceReceiver;
