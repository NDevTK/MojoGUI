...
mojo.internal.bindings.blink.mojom.PointerLockContext = {};
mojo.internal.bindings.blink.mojom.PointerLockContextSpec = { $ : {} };
mojo.internal.bindings.blink.mojom.PointerLockContext.$interfaceName = 'blink.mojom.PointerLockContext';
...
mojo.internal.bindings.blink.mojom.PointerLockContextRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.blink.mojom.PointerLockContextRemoteCallHandler(this.proxy);
  }
  ...
  requestMouseLockChange(arg_unadjusted_movement) {
    return this.$.requestMouseLockChange(arg_unadjusted_movement);
  }
};

mojo.internal.bindings.blink.mojom.PointerLockContextRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('blink.mojom.PointerLockContext', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.blink.mojom.PointerLockContext.getRemote = function() {
  let remote = new mojo.internal.bindings.blink.mojom.PointerLockContextRemote();
...
mojo.internal.bindings.blink.mojom.PointerLockContextReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('blink.mojom.PointerLockContext', [
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        // Try Method 0: RequestMouseLockChange
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.blink.mojom.PointerLockContext_RequestMouseLockChange_ParamsSpec.$.structSpec);
             console.log('[GeneratedReceiver] Discovery SUCCESS: ' + header.ordinal + ' -> RequestMouseLockChange (0)');
        ...
        case 0: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.blink.mojom.PointerLockContext_RequestMouseLockChange_ResponseParamsSpec, header, rawHeader);
               responder(response);
...
mojo.internal.bindings.blink.mojom.PointerLockContextReceiver = mojo.internal.bindings.blink.mojom.PointerLockContextReceiver;
