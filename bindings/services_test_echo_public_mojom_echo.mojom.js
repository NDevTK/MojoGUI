...
// Enum: LoadStatus
mojo.internal.bindings.echo.mojom.LoadStatus = {
  kSuccess: 0,
...
mojo.internal.Struct(
    mojo.internal.bindings.echo.mojom.EchoService_LoadNativeLibrary_ResponseParamsSpec, 'echo.mojom.EchoService_LoadNativeLibrary_ResponseParams', [
      ...
      mojo.internal.StructField('arg_error_code', 8, 0, mojo.internal.Uint32, 0, false, 0, undefined),
    ],
    [[0, 24]]);
...
mojo.internal.bindings.echo.mojom.EchoServiceRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.echo.mojom.EchoServicePendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.echo.mojom.EchoServiceRemoteCallHandler(this.proxy);
  }
  ...
  echoString(arg_input) {
    return this.$.echoString(arg_input);
  }
  echoStringToSharedMemory(arg_input, arg_region) {
    return this.$.echoStringToSharedMemory(arg_input, arg_region);
  }
  quit() {
    return this.$.quit();
  }
  ...
  loadNativeLibrary(arg_library, arg_call_winmm_delayload) {
    return this.$.loadNativeLibrary(arg_library, arg_call_winmm_delayload);
  }
...
mojo.internal.bindings.echo.mojom.EchoService.getRemote = function() {
  let remote = new mojo.internal.bindings.echo.mojom.EchoServiceRemote();
...
mojo.internal.bindings.echo.mojom.EchoServiceReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.echo.mojom.EchoService_EchoString_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for EchoString failed with TypeError');
           }
        }
        // Try Method 1: EchoStringToSharedMemory
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.echo.mojom.EchoService_EchoStringToSharedMemory_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for EchoStringToSharedMemory failed with TypeError');
           }
        }
        // Try Method 2: Quit
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.echo.mojom.EchoService_Quit_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for Quit failed with TypeError');
           }
        }
        // Try Method 3: Crash
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.echo.mojom.EchoService_Crash_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.echo.mojom.EchoService_DelayLoad_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for DelayLoad failed with TypeError');
           }
        }
        // Try Method 5: LoadNativeLibrary
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.echo.mojom.EchoService_LoadNativeLibrary_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for LoadNativeLibrary failed with TypeError');
           }
        }
        // Try Method 6: DecryptEncrypt
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.echo.mojom.EchoService_DecryptEncrypt_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for DecryptEncrypt failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
      ...
      switch (dispatchId) {
        ...
        case 2: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.echo.mojom.EchoService_Quit_ParamsSpec.$.structSpec);
        ...
        case 3: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.echo.mojom.EchoService_Crash_ParamsSpec.$.structSpec);
        ...
        case 4: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.echo.mojom.EchoService_DelayLoad_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.echo.mojom.EchoServiceReceiver = mojo.internal.bindings.echo.mojom.EchoServiceReceiver;
