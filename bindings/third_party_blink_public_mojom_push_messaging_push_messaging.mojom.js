...
// Enum: PushErrorType
mojo.internal.bindings.blink.mojom.PushErrorType = {
  ABORT: 0,
  NETWORK: 1,
  NONE: 2,
  NOT_ALLOWED: 3,
...
mojo.internal.Struct(
    mojo.internal.bindings.blink.mojom.PushSubscriptionOptionsSpec, 'blink.mojom.PushSubscriptionOptions', [
      mojo.internal.StructField('arg_application_server_key', 0, 0, mojo.internal.Array(mojo.internal.Uint8, false), null, false, 0, undefined),
      mojo.internal.StructField('arg_user_visible_only', 8, 0, mojo.internal.Bool, false, false, 0, undefined),
    ],
    [[0, 24]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.blink.mojom.PushSubscriptionSpec, 'blink.mojom.PushSubscription', [
      ...
      mojo.internal.StructField('arg_options', 16, 0, mojo.internal.bindings.mojo.internal.bindings.blink.mojom.PushSubscriptionOptionsSpec.$, null, false, 0, undefined),
...
mojo.internal.Struct(
    mojo.internal.bindings.blink.mojom.PushMessaging_Subscribe_ParamsSpec, 'blink.mojom.PushMessaging_Subscribe_Params', [
      ...
      mojo.internal.StructField('arg_options', 8, 0, mojo.internal.bindings.mojo.internal.bindings.blink.mojom.PushSubscriptionOptionsSpec.$, null, false, 0, undefined),
...
mojo.internal.Struct(
    mojo.internal.bindings.blink.mojom.PushMessaging_Subscribe_ResponseParamsSpec, 'blink.mojom.PushMessaging_Subscribe_ResponseParams', [
      ...
      mojo.internal.StructField('arg_subscription', 8, 0, mojo.internal.bindings.mojo.internal.bindings.blink.mojom.PushSubscriptionSpec.$, null, true, 0, undefined),
    ],
    [[0, 24]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.blink.mojom.PushMessaging_Unsubscribe_ResponseParamsSpec, 'blink.mojom.PushMessaging_Unsubscribe_ResponseParams', [
      mojo.internal.StructField('arg_error_type', 0, 0, mojo.internal.bindings.mojo.internal.bindings.blink.mojom.PushErrorTypeSpec.$, null, false, 0, undefined),
...
mojo.internal.bindings.blink.mojom.PushMessagingRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.blink.mojom.PushMessagingPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.blink.mojom.PushMessagingRemoteCallHandler(this.proxy);
  }
  ...
  subscribe(arg_service_worker_registration_id, arg_options, arg_user_gesture) {
    return this.$.subscribe(arg_service_worker_registration_id, arg_options, arg_user_gesture);
  }
  unsubscribe(arg_service_worker_registration_id) {
    return this.$.unsubscribe(arg_service_worker_registration_id);
  }
  getSubscription(arg_service_worker_registration_id) {
    return this.$.getSubscription(arg_service_worker_registration_id);
  }
};
...
mojo.internal.bindings.blink.mojom.PushMessaging.getRemote = function() {
  let remote = new mojo.internal.bindings.blink.mojom.PushMessagingRemote();
...
mojo.internal.bindings.blink.mojom.PushMessagingReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
      ...
      switch (dispatchId) {
        case 0: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.blink.mojom.PushMessaging_Subscribe_ResponseParamsSpec, header, rawHeader);
               responder(response);
        ...
        case 1: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              const rawHeader = (args[2] && args[2].slice) ? args[2].slice(0, header.headerSize) : null;
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.blink.mojom.PushMessaging_Unsubscribe_ResponseParamsSpec, header, rawHeader);
               responder(response);
        ...
        case 2: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              const rawHeader = (args[2] && args[2].slice) ? args[2].slice(0, header.headerSize) : null;
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.blink.mojom.PushMessaging_GetSubscription_ResponseParamsSpec, header, rawHeader);
               responder(response);
...
mojo.internal.bindings.blink.mojom.PushMessagingReceiver = mojo.internal.bindings.blink.mojom.PushMessagingReceiver;
