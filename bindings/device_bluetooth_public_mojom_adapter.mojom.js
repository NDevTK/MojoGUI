...
mojo.internal.bindings.bluetooth.mojom.ConnectResultSpec = mojo.internal.bindings.bluetooth.mojom.ConnectResultSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.bluetooth.mojom.LocalCharacteristicReadResultSpec = mojo.internal.bindings.bluetooth.mojom.LocalCharacteristicReadResultSpec || { $: {} };
if (mojo.internal.bindings.bluetooth.mojom.LocalCharacteristicReadResultSpec.$.structSpec && mojo.internal.bindings.bluetooth.mojom.LocalCharacteristicReadResultSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.bluetooth.mojom.LocalCharacteristicReadResultSpec.$ = {};
mojo.internal.bindings.bluetooth.mojom.ConnectToServiceResultSpec = mojo.internal.bindings.bluetooth.mojom.ConnectToServiceResultSpec || { $: {} };
if (mojo.internal.bindings.bluetooth.mojom.ConnectToServiceResultSpec.$.structSpec && mojo.internal.bindings.bluetooth.mojom.ConnectToServiceResultSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.bluetooth.mojom.ConnectToServiceResultSpec.$ = {};
mojo.internal.bindings.bluetooth.mojom.AcceptConnectionResultSpec = mojo.internal.bindings.bluetooth.mojom.AcceptConnectionResultSpec || { $: {} };
if (mojo.internal.bindings.bluetooth.mojom.AcceptConnectionResultSpec.$.structSpec && mojo.internal.bindings.bluetooth.mojom.AcceptConnectionResultSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.bluetooth.mojom.AcceptConnectionResultSpec.$ = {};
mojo.internal.bindings.bluetooth.mojom.AdapterInfoSpec = mojo.internal.bindings.bluetooth.mojom.AdapterInfoSpec || { $: {} };
if (mojo.internal.bindings.bluetooth.mojom.AdapterInfoSpec.$.structSpec && mojo.internal.bindings.bluetooth.mojom.AdapterInfoSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.bluetooth.mojom.AdapterInfoSpec.$ = {};
mojo.internal.bindings.bluetooth.mojom.Advertisement = mojo.internal.bindings.bluetooth.mojom.Advertisement || {};
mojo.internal.bindings.bluetooth.mojom.AdvertisementSpec = mojo.internal.bindings.bluetooth.mojom.AdvertisementSpec || { $ : {} };
if (mojo.internal.bindings.bluetooth.mojom.AdvertisementSpec.$.structSpec && mojo.internal.bindings.bluetooth.mojom.AdvertisementSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.bluetooth.mojom.AdvertisementSpec.$ = {};
mojo.internal.bindings.bluetooth.mojom.Advertisement.$interfaceName = 'bluetooth.mojom.Advertisement';
mojo.internal.bindings.bluetooth.mojom.Advertisement_Unregister_ParamsSpec = mojo.internal.bindings.bluetooth.mojom.Advertisement_Unregister_ParamsSpec || { $: {} };
if (mojo.internal.bindings.bluetooth.mojom.Advertisement_Unregister_ParamsSpec.$.structSpec && mojo.internal.bindings.bluetooth.mojom.Advertisement_Unregister_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.bluetooth.mojom.Advertisement_Unregister_ParamsSpec.$ = {};
mojo.internal.bindings.bluetooth.mojom.Advertisement_Unregister_ResponseParamsSpec = mojo.internal.bindings.bluetooth.mojom.Advertisement_Unregister_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.bluetooth.mojom.Advertisement_Unregister_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.bluetooth.mojom.Advertisement_Unregister_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.bluetooth.mojom.Advertisement_Unregister_ResponseParamsSpec.$ = {};
mojo.internal.bindings.bluetooth.mojom.DiscoverySession = mojo.internal.bindings.bluetooth.mojom.DiscoverySession || {};
mojo.internal.bindings.bluetooth.mojom.DiscoverySessionSpec = mojo.internal.bindings.bluetooth.mojom.DiscoverySessionSpec || { $ : {} };
if (mojo.internal.bindings.bluetooth.mojom.DiscoverySessionSpec.$.structSpec && mojo.internal.bindings.bluetooth.mojom.DiscoverySessionSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.bluetooth.mojom.DiscoverySessionSpec.$ = {};
mojo.internal.bindings.bluetooth.mojom.DiscoverySession.$interfaceName = 'bluetooth.mojom.DiscoverySession';
mojo.internal.bindings.bluetooth.mojom.DiscoverySession_IsActive_ParamsSpec = mojo.internal.bindings.bluetooth.mojom.DiscoverySession_IsActive_ParamsSpec || { $: {} };
if (mojo.internal.bindings.bluetooth.mojom.DiscoverySession_IsActive_ParamsSpec.$.structSpec && mojo.internal.bindings.bluetooth.mojom.DiscoverySession_IsActive_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.bluetooth.mojom.DiscoverySession_IsActive_ParamsSpec.$ = {};
mojo.internal.bindings.bluetooth.mojom.DiscoverySession_IsActive_ResponseParamsSpec = mojo.internal.bindings.bluetooth.mojom.DiscoverySession_IsActive_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.bluetooth.mojom.DiscoverySession_IsActive_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.bluetooth.mojom.DiscoverySession_IsActive_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.bluetooth.mojom.DiscoverySession_IsActive_ResponseParamsSpec.$ = {};
mojo.internal.bindings.bluetooth.mojom.DiscoverySession_Stop_ParamsSpec = mojo.internal.bindings.bluetooth.mojom.DiscoverySession_Stop_ParamsSpec || { $: {} };
if (mojo.internal.bindings.bluetooth.mojom.DiscoverySession_Stop_ParamsSpec.$.structSpec && mojo.internal.bindings.bluetooth.mojom.DiscoverySession_Stop_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.bluetooth.mojom.DiscoverySession_Stop_ParamsSpec.$ = {};
mojo.internal.bindings.bluetooth.mojom.DiscoverySession_Stop_ResponseParamsSpec = mojo.internal.bindings.bluetooth.mojom.DiscoverySession_Stop_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.bluetooth.mojom.DiscoverySession_Stop_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.bluetooth.mojom.DiscoverySession_Stop_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.bluetooth.mojom.DiscoverySession_Stop_ResponseParamsSpec.$ = {};
mojo.internal.bindings.bluetooth.mojom.Socket = mojo.internal.bindings.bluetooth.mojom.Socket || {};
mojo.internal.bindings.bluetooth.mojom.SocketSpec = mojo.internal.bindings.bluetooth.mojom.SocketSpec || { $ : {} };
if (mojo.internal.bindings.bluetooth.mojom.SocketSpec.$.structSpec && mojo.internal.bindings.bluetooth.mojom.SocketSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.bluetooth.mojom.SocketSpec.$ = {};
mojo.internal.bindings.bluetooth.mojom.Socket.$interfaceName = 'bluetooth.mojom.Socket';
mojo.internal.bindings.bluetooth.mojom.Socket_Disconnect_ParamsSpec = mojo.internal.bindings.bluetooth.mojom.Socket_Disconnect_ParamsSpec || { $: {} };
if (mojo.internal.bindings.bluetooth.mojom.Socket_Disconnect_ParamsSpec.$.structSpec && mojo.internal.bindings.bluetooth.mojom.Socket_Disconnect_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.bluetooth.mojom.Socket_Disconnect_ParamsSpec.$ = {};
mojo.internal.bindings.bluetooth.mojom.Socket_Disconnect_ResponseParamsSpec = mojo.internal.bindings.bluetooth.mojom.Socket_Disconnect_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.bluetooth.mojom.Socket_Disconnect_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.bluetooth.mojom.Socket_Disconnect_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.bluetooth.mojom.Socket_Disconnect_ResponseParamsSpec.$ = {};
mojo.internal.bindings.bluetooth.mojom.ServerSocket = mojo.internal.bindings.bluetooth.mojom.ServerSocket || {};
mojo.internal.bindings.bluetooth.mojom.ServerSocketSpec = mojo.internal.bindings.bluetooth.mojom.ServerSocketSpec || { $ : {} };
if (mojo.internal.bindings.bluetooth.mojom.ServerSocketSpec.$.structSpec && mojo.internal.bindings.bluetooth.mojom.ServerSocketSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.bluetooth.mojom.ServerSocketSpec.$ = {};
mojo.internal.bindings.bluetooth.mojom.ServerSocket.$interfaceName = 'bluetooth.mojom.ServerSocket';
mojo.internal.bindings.bluetooth.mojom.ServerSocket_Accept_ParamsSpec = mojo.internal.bindings.bluetooth.mojom.ServerSocket_Accept_ParamsSpec || { $: {} };
if (mojo.internal.bindings.bluetooth.mojom.ServerSocket_Accept_ParamsSpec.$.structSpec && mojo.internal.bindings.bluetooth.mojom.ServerSocket_Accept_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.bluetooth.mojom.ServerSocket_Accept_ParamsSpec.$ = {};
mojo.internal.bindings.bluetooth.mojom.ServerSocket_Accept_ResponseParamsSpec = mojo.internal.bindings.bluetooth.mojom.ServerSocket_Accept_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.bluetooth.mojom.ServerSocket_Accept_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.bluetooth.mojom.ServerSocket_Accept_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.bluetooth.mojom.ServerSocket_Accept_ResponseParamsSpec.$ = {};
mojo.internal.bindings.bluetooth.mojom.ServerSocket_Disconnect_ParamsSpec = mojo.internal.bindings.bluetooth.mojom.ServerSocket_Disconnect_ParamsSpec || { $: {} };
if (mojo.internal.bindings.bluetooth.mojom.ServerSocket_Disconnect_ParamsSpec.$.structSpec && mojo.internal.bindings.bluetooth.mojom.ServerSocket_Disconnect_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.bluetooth.mojom.ServerSocket_Disconnect_ParamsSpec.$ = {};
mojo.internal.bindings.bluetooth.mojom.ServerSocket_Disconnect_ResponseParamsSpec = mojo.internal.bindings.bluetooth.mojom.ServerSocket_Disconnect_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.bluetooth.mojom.ServerSocket_Disconnect_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.bluetooth.mojom.ServerSocket_Disconnect_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.bluetooth.mojom.ServerSocket_Disconnect_ResponseParamsSpec.$ = {};
mojo.internal.bindings.bluetooth.mojom.GattService = mojo.internal.bindings.bluetooth.mojom.GattService || {};
mojo.internal.bindings.bluetooth.mojom.GattServiceSpec = mojo.internal.bindings.bluetooth.mojom.GattServiceSpec || { $ : {} };
if (mojo.internal.bindings.bluetooth.mojom.GattServiceSpec.$.structSpec && mojo.internal.bindings.bluetooth.mojom.GattServiceSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.bluetooth.mojom.GattServiceSpec.$ = {};
mojo.internal.bindings.bluetooth.mojom.GattService.$interfaceName = 'bluetooth.mojom.GattService';
mojo.internal.bindings.bluetooth.mojom.GattService_CreateCharacteristic_ParamsSpec = mojo.internal.bindings.bluetooth.mojom.GattService_CreateCharacteristic_ParamsSpec || { $: {} };
if (mojo.internal.bindings.bluetooth.mojom.GattService_CreateCharacteristic_ParamsSpec.$.structSpec && mojo.internal.bindings.bluetooth.mojom.GattService_CreateCharacteristic_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.bluetooth.mojom.GattService_CreateCharacteristic_ParamsSpec.$ = {};
mojo.internal.bindings.bluetooth.mojom.GattService_CreateCharacteristic_ResponseParamsSpec = mojo.internal.bindings.bluetooth.mojom.GattService_CreateCharacteristic_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.bluetooth.mojom.GattService_CreateCharacteristic_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.bluetooth.mojom.GattService_CreateCharacteristic_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.bluetooth.mojom.GattService_CreateCharacteristic_ResponseParamsSpec.$ = {};
mojo.internal.bindings.bluetooth.mojom.GattService_Register_ParamsSpec = mojo.internal.bindings.bluetooth.mojom.GattService_Register_ParamsSpec || { $: {} };
if (mojo.internal.bindings.bluetooth.mojom.GattService_Register_ParamsSpec.$.structSpec && mojo.internal.bindings.bluetooth.mojom.GattService_Register_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.bluetooth.mojom.GattService_Register_ParamsSpec.$ = {};
mojo.internal.bindings.bluetooth.mojom.GattService_Register_ResponseParamsSpec = mojo.internal.bindings.bluetooth.mojom.GattService_Register_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.bluetooth.mojom.GattService_Register_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.bluetooth.mojom.GattService_Register_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.bluetooth.mojom.GattService_Register_ResponseParamsSpec.$ = {};
mojo.internal.bindings.bluetooth.mojom.GattServiceObserver = mojo.internal.bindings.bluetooth.mojom.GattServiceObserver || {};
mojo.internal.bindings.bluetooth.mojom.GattServiceObserverSpec = mojo.internal.bindings.bluetooth.mojom.GattServiceObserverSpec || { $ : {} };
if (mojo.internal.bindings.bluetooth.mojom.GattServiceObserverSpec.$.structSpec && mojo.internal.bindings.bluetooth.mojom.GattServiceObserverSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.bluetooth.mojom.GattServiceObserverSpec.$ = {};
mojo.internal.bindings.bluetooth.mojom.GattServiceObserver.$interfaceName = 'bluetooth.mojom.GattServiceObserver';
mojo.internal.bindings.bluetooth.mojom.GattServiceObserver_OnLocalCharacteristicRead_ParamsSpec = mojo.internal.bindings.bluetooth.mojom.GattServiceObserver_OnLocalCharacteristicRead_ParamsSpec || { $: {} };
if (mojo.internal.bindings.bluetooth.mojom.GattServiceObserver_OnLocalCharacteristicRead_ParamsSpec.$.structSpec && mojo.internal.bindings.bluetooth.mojom.GattServiceObserver_OnLocalCharacteristicRead_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.bluetooth.mojom.GattServiceObserver_OnLocalCharacteristicRead_ParamsSpec.$ = {};
mojo.internal.bindings.bluetooth.mojom.GattServiceObserver_OnLocalCharacteristicRead_ResponseParamsSpec = mojo.internal.bindings.bluetooth.mojom.GattServiceObserver_OnLocalCharacteristicRead_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.bluetooth.mojom.GattServiceObserver_OnLocalCharacteristicRead_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.bluetooth.mojom.GattServiceObserver_OnLocalCharacteristicRead_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.bluetooth.mojom.GattServiceObserver_OnLocalCharacteristicRead_ResponseParamsSpec.$ = {};
mojo.internal.bindings.bluetooth.mojom.Adapter = mojo.internal.bindings.bluetooth.mojom.Adapter || {};
mojo.internal.bindings.bluetooth.mojom.AdapterSpec = mojo.internal.bindings.bluetooth.mojom.AdapterSpec || { $ : {} };
if (mojo.internal.bindings.bluetooth.mojom.AdapterSpec.$.structSpec && mojo.internal.bindings.bluetooth.mojom.AdapterSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.bluetooth.mojom.AdapterSpec.$ = {};
mojo.internal.bindings.bluetooth.mojom.Adapter.$interfaceName = 'bluetooth.mojom.Adapter';
mojo.internal.bindings.bluetooth.mojom.Adapter_ConnectToDevice_ParamsSpec = mojo.internal.bindings.bluetooth.mojom.Adapter_ConnectToDevice_ParamsSpec || { $: {} };
if (mojo.internal.bindings.bluetooth.mojom.Adapter_ConnectToDevice_ParamsSpec.$.structSpec && mojo.internal.bindings.bluetooth.mojom.Adapter_ConnectToDevice_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.bluetooth.mojom.Adapter_ConnectToDevice_ParamsSpec.$ = {};
mojo.internal.bindings.bluetooth.mojom.Adapter_ConnectToDevice_ResponseParamsSpec = mojo.internal.bindings.bluetooth.mojom.Adapter_ConnectToDevice_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.bluetooth.mojom.Adapter_ConnectToDevice_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.bluetooth.mojom.Adapter_ConnectToDevice_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.bluetooth.mojom.Adapter_ConnectToDevice_ResponseParamsSpec.$ = {};
mojo.internal.bindings.bluetooth.mojom.Adapter_GetDevices_ParamsSpec = mojo.internal.bindings.bluetooth.mojom.Adapter_GetDevices_ParamsSpec || { $: {} };
if (mojo.internal.bindings.bluetooth.mojom.Adapter_GetDevices_ParamsSpec.$.structSpec && mojo.internal.bindings.bluetooth.mojom.Adapter_GetDevices_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.bluetooth.mojom.Adapter_GetDevices_ParamsSpec.$ = {};
mojo.internal.bindings.bluetooth.mojom.Adapter_GetDevices_ResponseParamsSpec = mojo.internal.bindings.bluetooth.mojom.Adapter_GetDevices_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.bluetooth.mojom.Adapter_GetDevices_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.bluetooth.mojom.Adapter_GetDevices_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.bluetooth.mojom.Adapter_GetDevices_ResponseParamsSpec.$ = {};
mojo.internal.bindings.bluetooth.mojom.Adapter_GetInfo_ParamsSpec = mojo.internal.bindings.bluetooth.mojom.Adapter_GetInfo_ParamsSpec || { $: {} };
if (mojo.internal.bindings.bluetooth.mojom.Adapter_GetInfo_ParamsSpec.$.structSpec && mojo.internal.bindings.bluetooth.mojom.Adapter_GetInfo_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.bluetooth.mojom.Adapter_GetInfo_ParamsSpec.$ = {};
mojo.internal.bindings.bluetooth.mojom.Adapter_GetInfo_ResponseParamsSpec = mojo.internal.bindings.bluetooth.mojom.Adapter_GetInfo_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.bluetooth.mojom.Adapter_GetInfo_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.bluetooth.mojom.Adapter_GetInfo_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.bluetooth.mojom.Adapter_GetInfo_ResponseParamsSpec.$ = {};
mojo.internal.bindings.bluetooth.mojom.Adapter_AddObserver_ParamsSpec = mojo.internal.bindings.bluetooth.mojom.Adapter_AddObserver_ParamsSpec || { $: {} };
if (mojo.internal.bindings.bluetooth.mojom.Adapter_AddObserver_ParamsSpec.$.structSpec && mojo.internal.bindings.bluetooth.mojom.Adapter_AddObserver_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.bluetooth.mojom.Adapter_AddObserver_ParamsSpec.$ = {};
mojo.internal.bindings.bluetooth.mojom.Adapter_AddObserver_ResponseParamsSpec = mojo.internal.bindings.bluetooth.mojom.Adapter_AddObserver_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.bluetooth.mojom.Adapter_AddObserver_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.bluetooth.mojom.Adapter_AddObserver_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.bluetooth.mojom.Adapter_AddObserver_ResponseParamsSpec.$ = {};
mojo.internal.bindings.bluetooth.mojom.Adapter_RegisterAdvertisement_ParamsSpec = mojo.internal.bindings.bluetooth.mojom.Adapter_RegisterAdvertisement_ParamsSpec || { $: {} };
if (mojo.internal.bindings.bluetooth.mojom.Adapter_RegisterAdvertisement_ParamsSpec.$.structSpec && mojo.internal.bindings.bluetooth.mojom.Adapter_RegisterAdvertisement_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.bluetooth.mojom.Adapter_RegisterAdvertisement_ParamsSpec.$ = {};
mojo.internal.bindings.bluetooth.mojom.Adapter_RegisterAdvertisement_ResponseParamsSpec = mojo.internal.bindings.bluetooth.mojom.Adapter_RegisterAdvertisement_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.bluetooth.mojom.Adapter_RegisterAdvertisement_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.bluetooth.mojom.Adapter_RegisterAdvertisement_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.bluetooth.mojom.Adapter_RegisterAdvertisement_ResponseParamsSpec.$ = {};
mojo.internal.bindings.bluetooth.mojom.Adapter_SetDiscoverable_ParamsSpec = mojo.internal.bindings.bluetooth.mojom.Adapter_SetDiscoverable_ParamsSpec || { $: {} };
if (mojo.internal.bindings.bluetooth.mojom.Adapter_SetDiscoverable_ParamsSpec.$.structSpec && mojo.internal.bindings.bluetooth.mojom.Adapter_SetDiscoverable_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.bluetooth.mojom.Adapter_SetDiscoverable_ParamsSpec.$ = {};
mojo.internal.bindings.bluetooth.mojom.Adapter_SetDiscoverable_ResponseParamsSpec = mojo.internal.bindings.bluetooth.mojom.Adapter_SetDiscoverable_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.bluetooth.mojom.Adapter_SetDiscoverable_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.bluetooth.mojom.Adapter_SetDiscoverable_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.bluetooth.mojom.Adapter_SetDiscoverable_ResponseParamsSpec.$ = {};
mojo.internal.bindings.bluetooth.mojom.Adapter_SetName_ParamsSpec = mojo.internal.bindings.bluetooth.mojom.Adapter_SetName_ParamsSpec || { $: {} };
if (mojo.internal.bindings.bluetooth.mojom.Adapter_SetName_ParamsSpec.$.structSpec && mojo.internal.bindings.bluetooth.mojom.Adapter_SetName_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.bluetooth.mojom.Adapter_SetName_ParamsSpec.$ = {};
mojo.internal.bindings.bluetooth.mojom.Adapter_SetName_ResponseParamsSpec = mojo.internal.bindings.bluetooth.mojom.Adapter_SetName_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.bluetooth.mojom.Adapter_SetName_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.bluetooth.mojom.Adapter_SetName_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.bluetooth.mojom.Adapter_SetName_ResponseParamsSpec.$ = {};
mojo.internal.bindings.bluetooth.mojom.Adapter_StartDiscoverySession_ParamsSpec = mojo.internal.bindings.bluetooth.mojom.Adapter_StartDiscoverySession_ParamsSpec || { $: {} };
if (mojo.internal.bindings.bluetooth.mojom.Adapter_StartDiscoverySession_ParamsSpec.$.structSpec && mojo.internal.bindings.bluetooth.mojom.Adapter_StartDiscoverySession_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.bluetooth.mojom.Adapter_StartDiscoverySession_ParamsSpec.$ = {};
mojo.internal.bindings.bluetooth.mojom.Adapter_StartDiscoverySession_ResponseParamsSpec = mojo.internal.bindings.bluetooth.mojom.Adapter_StartDiscoverySession_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.bluetooth.mojom.Adapter_StartDiscoverySession_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.bluetooth.mojom.Adapter_StartDiscoverySession_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.bluetooth.mojom.Adapter_StartDiscoverySession_ResponseParamsSpec.$ = {};
mojo.internal.bindings.bluetooth.mojom.Adapter_ConnectToServiceInsecurely_ParamsSpec = mojo.internal.bindings.bluetooth.mojom.Adapter_ConnectToServiceInsecurely_ParamsSpec || { $: {} };
if (mojo.internal.bindings.bluetooth.mojom.Adapter_ConnectToServiceInsecurely_ParamsSpec.$.structSpec && mojo.internal.bindings.bluetooth.mojom.Adapter_ConnectToServiceInsecurely_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.bluetooth.mojom.Adapter_ConnectToServiceInsecurely_ParamsSpec.$ = {};
mojo.internal.bindings.bluetooth.mojom.Adapter_ConnectToServiceInsecurely_ResponseParamsSpec = mojo.internal.bindings.bluetooth.mojom.Adapter_ConnectToServiceInsecurely_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.bluetooth.mojom.Adapter_ConnectToServiceInsecurely_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.bluetooth.mojom.Adapter_ConnectToServiceInsecurely_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.bluetooth.mojom.Adapter_ConnectToServiceInsecurely_ResponseParamsSpec.$ = {};
mojo.internal.bindings.bluetooth.mojom.Adapter_CreateRfcommServiceInsecurely_ParamsSpec = mojo.internal.bindings.bluetooth.mojom.Adapter_CreateRfcommServiceInsecurely_ParamsSpec || { $: {} };
if (mojo.internal.bindings.bluetooth.mojom.Adapter_CreateRfcommServiceInsecurely_ParamsSpec.$.structSpec && mojo.internal.bindings.bluetooth.mojom.Adapter_CreateRfcommServiceInsecurely_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.bluetooth.mojom.Adapter_CreateRfcommServiceInsecurely_ParamsSpec.$ = {};
mojo.internal.bindings.bluetooth.mojom.Adapter_CreateRfcommServiceInsecurely_ResponseParamsSpec = mojo.internal.bindings.bluetooth.mojom.Adapter_CreateRfcommServiceInsecurely_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.bluetooth.mojom.Adapter_CreateRfcommServiceInsecurely_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.bluetooth.mojom.Adapter_CreateRfcommServiceInsecurely_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.bluetooth.mojom.Adapter_CreateRfcommServiceInsecurely_ResponseParamsSpec.$ = {};
mojo.internal.bindings.bluetooth.mojom.Adapter_CreateLocalGattService_ParamsSpec = mojo.internal.bindings.bluetooth.mojom.Adapter_CreateLocalGattService_ParamsSpec || { $: {} };
if (mojo.internal.bindings.bluetooth.mojom.Adapter_CreateLocalGattService_ParamsSpec.$.structSpec && mojo.internal.bindings.bluetooth.mojom.Adapter_CreateLocalGattService_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.bluetooth.mojom.Adapter_CreateLocalGattService_ParamsSpec.$ = {};
mojo.internal.bindings.bluetooth.mojom.Adapter_CreateLocalGattService_ResponseParamsSpec = mojo.internal.bindings.bluetooth.mojom.Adapter_CreateLocalGattService_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.bluetooth.mojom.Adapter_CreateLocalGattService_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.bluetooth.mojom.Adapter_CreateLocalGattService_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.bluetooth.mojom.Adapter_CreateLocalGattService_ResponseParamsSpec.$ = {};
mojo.internal.bindings.bluetooth.mojom.Adapter_IsLeScatternetDualRoleSupported_ParamsSpec = mojo.internal.bindings.bluetooth.mojom.Adapter_IsLeScatternetDualRoleSupported_ParamsSpec || { $: {} };
if (mojo.internal.bindings.bluetooth.mojom.Adapter_IsLeScatternetDualRoleSupported_ParamsSpec.$.structSpec && mojo.internal.bindings.bluetooth.mojom.Adapter_IsLeScatternetDualRoleSupported_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.bluetooth.mojom.Adapter_IsLeScatternetDualRoleSupported_ParamsSpec.$ = {};
mojo.internal.bindings.bluetooth.mojom.Adapter_IsLeScatternetDualRoleSupported_ResponseParamsSpec = mojo.internal.bindings.bluetooth.mojom.Adapter_IsLeScatternetDualRoleSupported_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.bluetooth.mojom.Adapter_IsLeScatternetDualRoleSupported_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.bluetooth.mojom.Adapter_IsLeScatternetDualRoleSupported_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.bluetooth.mojom.Adapter_IsLeScatternetDualRoleSupported_ResponseParamsSpec.$ = {};
mojo.internal.bindings.bluetooth.mojom.AdapterObserver = mojo.internal.bindings.bluetooth.mojom.AdapterObserver || {};
mojo.internal.bindings.bluetooth.mojom.AdapterObserverSpec = mojo.internal.bindings.bluetooth.mojom.AdapterObserverSpec || { $ : {} };
if (mojo.internal.bindings.bluetooth.mojom.AdapterObserverSpec.$.structSpec && mojo.internal.bindings.bluetooth.mojom.AdapterObserverSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.bluetooth.mojom.AdapterObserverSpec.$ = {};
mojo.internal.bindings.bluetooth.mojom.AdapterObserver.$interfaceName = 'bluetooth.mojom.AdapterObserver';
mojo.internal.bindings.bluetooth.mojom.AdapterObserver_PresentChanged_ParamsSpec = mojo.internal.bindings.bluetooth.mojom.AdapterObserver_PresentChanged_ParamsSpec || { $: {} };
if (mojo.internal.bindings.bluetooth.mojom.AdapterObserver_PresentChanged_ParamsSpec.$.structSpec && mojo.internal.bindings.bluetooth.mojom.AdapterObserver_PresentChanged_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.bluetooth.mojom.AdapterObserver_PresentChanged_ParamsSpec.$ = {};
mojo.internal.bindings.bluetooth.mojom.AdapterObserver_PoweredChanged_ParamsSpec = mojo.internal.bindings.bluetooth.mojom.AdapterObserver_PoweredChanged_ParamsSpec || { $: {} };
if (mojo.internal.bindings.bluetooth.mojom.AdapterObserver_PoweredChanged_ParamsSpec.$.structSpec && mojo.internal.bindings.bluetooth.mojom.AdapterObserver_PoweredChanged_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.bluetooth.mojom.AdapterObserver_PoweredChanged_ParamsSpec.$ = {};
mojo.internal.bindings.bluetooth.mojom.AdapterObserver_DiscoverableChanged_ParamsSpec = mojo.internal.bindings.bluetooth.mojom.AdapterObserver_DiscoverableChanged_ParamsSpec || { $: {} };
if (mojo.internal.bindings.bluetooth.mojom.AdapterObserver_DiscoverableChanged_ParamsSpec.$.structSpec && mojo.internal.bindings.bluetooth.mojom.AdapterObserver_DiscoverableChanged_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.bluetooth.mojom.AdapterObserver_DiscoverableChanged_ParamsSpec.$ = {};
mojo.internal.bindings.bluetooth.mojom.AdapterObserver_DiscoveringChanged_ParamsSpec = mojo.internal.bindings.bluetooth.mojom.AdapterObserver_DiscoveringChanged_ParamsSpec || { $: {} };
if (mojo.internal.bindings.bluetooth.mojom.AdapterObserver_DiscoveringChanged_ParamsSpec.$.structSpec && mojo.internal.bindings.bluetooth.mojom.AdapterObserver_DiscoveringChanged_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.bluetooth.mojom.AdapterObserver_DiscoveringChanged_ParamsSpec.$ = {};
mojo.internal.bindings.bluetooth.mojom.AdapterObserver_DeviceAdded_ParamsSpec = mojo.internal.bindings.bluetooth.mojom.AdapterObserver_DeviceAdded_ParamsSpec || { $: {} };
if (mojo.internal.bindings.bluetooth.mojom.AdapterObserver_DeviceAdded_ParamsSpec.$.structSpec && mojo.internal.bindings.bluetooth.mojom.AdapterObserver_DeviceAdded_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.bluetooth.mojom.AdapterObserver_DeviceAdded_ParamsSpec.$ = {};
mojo.internal.bindings.bluetooth.mojom.AdapterObserver_DeviceChanged_ParamsSpec = mojo.internal.bindings.bluetooth.mojom.AdapterObserver_DeviceChanged_ParamsSpec || { $: {} };
if (mojo.internal.bindings.bluetooth.mojom.AdapterObserver_DeviceChanged_ParamsSpec.$.structSpec && mojo.internal.bindings.bluetooth.mojom.AdapterObserver_DeviceChanged_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.bluetooth.mojom.AdapterObserver_DeviceChanged_ParamsSpec.$ = {};
mojo.internal.bindings.bluetooth.mojom.AdapterObserver_DeviceRemoved_ParamsSpec = mojo.internal.bindings.bluetooth.mojom.AdapterObserver_DeviceRemoved_ParamsSpec || { $: {} };
if (mojo.internal.bindings.bluetooth.mojom.AdapterObserver_DeviceRemoved_ParamsSpec.$.structSpec && mojo.internal.bindings.bluetooth.mojom.AdapterObserver_DeviceRemoved_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.bluetooth.mojom.AdapterObserver_DeviceRemoved_ParamsSpec.$ = {};
...
mojo.internal.bindings.bluetooth.mojom.AdvertisementRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('bluetooth.mojom.Advertisement', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.bluetooth.mojom.AdvertisementReceiver = class {
  constructor(impl) {
    ...
    const ordinals = window.mojoScrambler.getOrdinals('bluetooth.mojom.Advertisement', [
      { explicit: null },
    ]);
...
mojo.internal.bindings.bluetooth.mojom.DiscoverySessionRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('bluetooth.mojom.DiscoverySession', [
      { explicit: null },
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.bluetooth.mojom.DiscoverySessionReceiver = class {
  constructor(impl) {
    ...
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('bluetooth.mojom.DiscoverySession', [
      { explicit: null },
      { explicit: null },
    ]);
    ordinals.forEach((ord, idx) => {
...
mojo.internal.bindings.bluetooth.mojom.SocketRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('bluetooth.mojom.Socket', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.bluetooth.mojom.SocketReceiver = class {
  constructor(impl) {
    ...
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('bluetooth.mojom.Socket', [
      { explicit: null },
    ]);
    ordinals.forEach((ord, idx) => {
      this.ordinalMap.set(ord, idx); // Scrambled/Explicit
...
mojo.internal.bindings.bluetooth.mojom.ServerSocketRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('bluetooth.mojom.ServerSocket', [
      { explicit: null },
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.bluetooth.mojom.ServerSocketReceiver = class {
  constructor(impl) {
    ...
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('bluetooth.mojom.ServerSocket', [
      { explicit: null },
      { explicit: null },
    ]);
    ordinals.forEach((ord, idx) => {
...
mojo.internal.bindings.bluetooth.mojom.GattServiceRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('bluetooth.mojom.GattService', [
      { explicit: null },
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.bluetooth.mojom.GattServiceReceiver = class {
  constructor(impl) {
    ...
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('bluetooth.mojom.GattService', [
      { explicit: null },
      { explicit: null },
    ]);
    ordinals.forEach((ord, idx) => {
...
mojo.internal.bindings.bluetooth.mojom.GattServiceObserverRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('bluetooth.mojom.GattServiceObserver', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.bluetooth.mojom.GattServiceObserverReceiver = class {
  constructor(impl) {
    ...
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('bluetooth.mojom.GattServiceObserver', [
      { explicit: null },
    ]);
    ordinals.forEach((ord, idx) => {
      this.ordinalMap.set(ord, idx); // Scrambled/Explicit
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        case 0: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              const val = (response && typeof response === 'object' && 'arg_read_result' in response) ? response['arg_read_result'] : response;
              const resp_obj = { 'arg_read_result': val };
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
...
mojo.internal.bindings.bluetooth.mojom.AdapterRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('bluetooth.mojom.Adapter', [
      { explicit: null },
      { explicit: null },
      { explicit: null },
      { explicit: null },
...
mojo.internal.bindings.bluetooth.mojom.AdapterReceiver = class {
  constructor(impl) {
    ...
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('bluetooth.mojom.Adapter', [
      { explicit: null },
      { explicit: null },
      { explicit: null },
      { explicit: null },
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        ...
        case 9: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              const val = (response && typeof response === 'object' && 'arg_server_socket' in response) ? response['arg_server_socket'] : response;
              const resp_obj = { 'arg_server_socket': val };
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
        ...
        case 10: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              const val = (response && typeof response === 'object' && 'arg_gatt_service' in response) ? response['arg_gatt_service'] : response;
              const resp_obj = { 'arg_gatt_service': val };
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
...
mojo.internal.bindings.bluetooth.mojom.AdapterObserverRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('bluetooth.mojom.AdapterObserver', [
      { explicit: null },
      { explicit: null },
      { explicit: null },
      { explicit: null },
...
mojo.internal.bindings.bluetooth.mojom.AdapterObserverReceiver = class {
  constructor(impl) {
    ...
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('bluetooth.mojom.AdapterObserver', [
      { explicit: null },
      { explicit: null },
      { explicit: null },
      { explicit: null },
