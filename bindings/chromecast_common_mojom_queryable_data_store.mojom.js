...
mojo.internal.bindings.chromecast.shell.mojom.QueryableDataStoreRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.chromecast.shell.mojom.QueryableDataStorePendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.chromecast.shell.mojom.QueryableDataStoreRemoteCallHandler(this.proxy);
  }
  ...
  set(arg_key, arg_value) {
    return this.$.set(arg_key, arg_value);
  }
};
...
mojo.internal.bindings.chromecast.shell.mojom.QueryableDataStore.getRemote = function() {
  let remote = new mojo.internal.bindings.chromecast.shell.mojom.QueryableDataStoreRemote();
...
mojo.internal.bindings.chromecast.shell.mojom.QueryableDataStoreReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.chromecast.shell.mojom.QueryableDataStore_Set_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for Set failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.chromecast.shell.mojom.QueryableDataStoreReceiver = mojo.internal.bindings.chromecast.shell.mojom.QueryableDataStoreReceiver;
