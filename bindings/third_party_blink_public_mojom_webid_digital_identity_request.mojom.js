...
mojo.internal.bindings.blink.mojom.RequestDigitalIdentityStatus = {
  kSuccess: 0,
  kError: 1,
...
mojo.internal.Struct(
    mojo.internal.bindings.blink.mojom.DigitalCredentialGetRequestSpec, 'blink.mojom.DigitalCredentialGetRequest', [
      mojo.internal.StructField('arg_data', 0, 0, mojo.internal.bindings.mojo_base.mojom.ValueSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_protocol', 16, 0, mojo.internal.String, null, false, 0, undefined),
    ],
    [[0, 32]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.blink.mojom.DigitalIdentityRequest_Get_ResponseParamsSpec, 'blink.mojom.DigitalIdentityRequest_Get_ResponseParams', [
      mojo.internal.StructField('arg_token', 0, 0, mojo.internal.bindings.mojo_base.mojom.ValueSpec, null, true, 0, undefined),
      mojo.internal.StructField('arg_protocol', 16, 0, mojo.internal.String, null, true, 0, undefined),
      mojo.internal.StructField('arg_status', 24, 0, mojo.internal.bindings.blink.mojom.RequestDigitalIdentityStatusSpec, null, false, 0, undefined),
    ],
    [[0, 40]]);
...
mojo.internal.bindings.blink.mojom.DigitalIdentityRequestRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.blink.mojom.DigitalIdentityRequestPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.blink.mojom.DigitalIdentityRequestRemoteCallHandler(this.proxy);
  }
  ...
  get(arg_digital_credential_requests) {
    return this.$.get(arg_digital_credential_requests);
  }
  create(arg_digital_credential_requests) {
    return this.$.create(arg_digital_credential_requests);
  }
  abort() {
    return this.$.abort();
  }
...
mojo.internal.bindings.blink.mojom.DigitalIdentityRequest.getRemote = function() {
  let remote = new mojo.internal.bindings.blink.mojom.DigitalIdentityRequestRemote();
...
mojo.internal.bindings.blink.mojom.DigitalIdentityRequestReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.blink.mojom.DigitalIdentityRequest_Get_ParamsSpec.$.structSpec;
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.blink.mojom.DigitalIdentityRequest_Create_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.blink.mojom.DigitalIdentityRequest_Abort_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for Abort failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
      ...
      switch (dispatchId) {
        ...
        case 2: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.blink.mojom.DigitalIdentityRequest_Abort_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.blink.mojom.DigitalIdentityRequestReceiver = mojo.internal.bindings.blink.mojom.DigitalIdentityRequestReceiver;
