  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        try {
             decoder.decodeStruct(arc.mojom.CompatibilityModeInstance_SetResizeLockState_ParamsSpec.$, message.header.headerSize);
        ...
        try {
             decoder.decodeStruct(arc.mojom.CompatibilityModeInstance_IsOptimizedForCrosApp_ParamsSpec.$, message.header.headerSize);
      ...
      switch (dispatchId) {
        case 2: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStruct(arc.mojom.CompatibilityModeInstance_SetResizeLockState_ParamsSpec.$, message.header.headerSize);
        ...
        case 2: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStruct(arc.mojom.CompatibilityModeInstance_IsOptimizedForCrosApp_ParamsSpec.$, message.header.headerSize);
