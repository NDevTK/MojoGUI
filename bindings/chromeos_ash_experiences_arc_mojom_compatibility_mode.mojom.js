...
mojo.internal.bindings.arc.mojom.ArcResizeLockState = {
  UNDEFINED: 0,
  READY: 1,
  ON: 2,
  OFF: 3,
...
mojo.internal.bindings.arc.mojom.CompatibilityModeInstanceRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.arc.mojom.CompatibilityModeInstanceRemoteCallHandler(this.proxy);
  }
  ...
  setResizeLockState(arg_package_name, arg_state) {
    return this.$.setResizeLockState(arg_package_name, arg_state);
  }
  isOptimizedForCrosApp(arg_package_name) {
    return this.$.isOptimizedForCrosApp(arg_package_name);
  }
};

mojo.internal.bindings.arc.mojom.CompatibilityModeInstanceRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('arc.mojom.CompatibilityModeInstance', [
      { explicit: 0 },
      { explicit: 2 },
    ]);
  }
...
mojo.internal.bindings.arc.mojom.CompatibilityModeInstance.getRemote = function() {
  let remote = new mojo.internal.bindings.arc.mojom.CompatibilityModeInstanceRemote();
...
mojo.internal.bindings.arc.mojom.CompatibilityModeInstanceReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('arc.mojom.CompatibilityModeInstance', [
      { explicit: 0 },
      { explicit: 2 },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        // Try Method 0: SetResizeLockState
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.arc.mojom.CompatibilityModeInstance_SetResizeLockState_ParamsSpec.$.structSpec);
             console.log('[GeneratedReceiver] Discovery SUCCESS: ' + header.ordinal + ' -> SetResizeLockState (0)');
        ...
        // Try Method 1: IsOptimizedForCrosApp
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.arc.mojom.CompatibilityModeInstance_IsOptimizedForCrosApp_ParamsSpec.$.structSpec);
             console.log('[GeneratedReceiver] Discovery SUCCESS: ' + header.ordinal + ' -> IsOptimizedForCrosApp (1)');
        ...
        case 1: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.arc.mojom.CompatibilityModeInstance_IsOptimizedForCrosApp_ResponseParamsSpec, header, rawHeader);
               responder(response);
...
mojo.internal.bindings.arc.mojom.CompatibilityModeInstanceReceiver = mojo.internal.bindings.arc.mojom.CompatibilityModeInstanceReceiver;
