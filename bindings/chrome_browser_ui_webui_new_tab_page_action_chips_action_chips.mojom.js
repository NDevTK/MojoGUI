...
mojo.internal.bindings.action_chips.mojom.ActionChipsHandler_NotifyActionChipClicked_ParamsSpec = mojo.internal.bindings.action_chips.mojom.ActionChipsHandler_NotifyActionChipClicked_ParamsSpec || { $: {} };
if (mojo.internal.bindings.action_chips.mojom.ActionChipsHandler_NotifyActionChipClicked_ParamsSpec.$.structSpec && mojo.internal.bindings.action_chips.mojom.ActionChipsHandler_NotifyActionChipClicked_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.action_chips.mojom.ActionChipsHandler_NotifyActionChipClicked_ParamsSpec.$ = {};
...
mojo.internal.bindings.action_chips.mojom.ActionChipsHandlerRemote = class {
  ...
  notifyActionChipClicked() {
    return this.$.notifyActionChipClicked();
  }
};
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        ...
        case 3: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.action_chips.mojom.ActionChipsHandler_NotifyActionChipClicked_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.notifyActionChipClicked');
          const result = this.impl.notifyActionChipClicked();
          break;
        }
      }
      } catch (err) {
...
mojo.internal.Struct(
    mojo.internal.bindings.action_chips.mojom.SuggestTemplateInfoSpec, 'action_chips.mojom.SuggestTemplateInfo', [
      ...
      mojo.internal.StructField('arg_preselected_tool', 4, 0, mojo.internal.bindings.action_chips.mojom.ToolModeSpec, null, true, 0, undefined),
      ...
      mojo.internal.StructField('arg_preferred_inventory', 24, 0, mojo.internal.bindings.searchbox.mojom.SuggestInventorySpec, null, true, 0, undefined),
    ],
    [[0, 40]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.action_chips.mojom.ActionChipsHandler_NotifyActionChipClicked_ParamsSpec, 'action_chips.mojom.ActionChipsHandler_NotifyActionChipClicked_Params', [
    ],
    [[0, 8]]);
