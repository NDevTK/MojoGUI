...
if (mojo.internal.bindings.action_chips.mojom.FormattedStringSpec.$.structSpec && mojo.internal.bindings.action_chips.mojom.FormattedStringSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.action_chips.mojom.FormattedStringSpec.$ = {};
mojo.internal.bindings.action_chips.mojom.SuggestTemplateInfoSpec = mojo.internal.bindings.action_chips.mojom.SuggestTemplateInfoSpec || { $: {} };
if (mojo.internal.bindings.action_chips.mojom.SuggestTemplateInfoSpec.$.structSpec && mojo.internal.bindings.action_chips.mojom.SuggestTemplateInfoSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.action_chips.mojom.SuggestTemplateInfoSpec.$ = {};
...
mojo.internal.bindings.action_chips.mojom.ActionChipsHandler_NavigateToAim_ParamsSpec = mojo.internal.bindings.action_chips.mojom.ActionChipsHandler_NavigateToAim_ParamsSpec || { $: {} };
if (mojo.internal.bindings.action_chips.mojom.ActionChipsHandler_NavigateToAim_ParamsSpec.$.structSpec && mojo.internal.bindings.action_chips.mojom.ActionChipsHandler_NavigateToAim_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.action_chips.mojom.ActionChipsHandler_NavigateToAim_ParamsSpec.$ = {};
...
mojo.internal.bindings.searchbox.mojom.ActionModifiersSpec = mojo.internal.bindings.searchbox.mojom.ActionModifiersSpec || { $: mojo.internal.OpaqueStruct.$ };
mojo.internal.bindings.url = mojo.internal.bindings.url || {};
mojo.internal.bindings.url.mojom = mojo.internal.bindings.url.mojom || {};
mojo.internal.bindings.url.mojom.UrlSpec = mojo.internal.bindings.url.mojom.UrlSpec || { $: mojo.internal.OpaqueStruct.$ };

// Enum: IconType
mojo.internal.bindings.action_chips.mojom.IconType = {
...
mojo.internal.bindings.action_chips.mojom.ActionChipsHandlerRemote = class {
  ...
  constructor(handle = undefined) {
    ...
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.action_chips.mojom.ActionChipsHandlerRemoteCallHandler(this.proxy);
  }
  ...
  navigateToAim(arg_query_text, arg_mouse_button, arg_modifiers) {
    return this.$.navigateToAim(arg_query_text, arg_mouse_button, arg_modifiers);
  }
};
...
mojo.internal.bindings.action_chips.mojom.ActionChipsHandlerRemoteCallHandler = class {
  ...
  navigateToAim(arg_query_text, arg_mouse_button, arg_modifiers) {
    return this.proxy.sendMessage(
      ...
      mojo.internal.bindings.action_chips.mojom.ActionChipsHandler_NavigateToAim_ParamsSpec,
      null,
      [arg_query_text, arg_mouse_button, arg_modifiers],
      false);
  }
...
mojo.internal.bindings.action_chips.mojom.ActionChipsHandler.getRemote = function() {
  let remote = new mojo.internal.bindings.action_chips.mojom.ActionChipsHandlerRemote();
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        case 0: {
          ...
          const params = decoder.decodeStructInline(mojo.internal.bindings.action_chips.mojom.ActionChipsHandler_StartActionChipsRetrieval_ParamsSpec.$.structSpec);
        ...
        case 3: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.action_chips.mojom.ActionChipsHandler_NavigateToAim_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.navigateToAim');
          const result = this.impl.navigateToAim(params.arg_query_text, params.arg_mouse_button, params.arg_modifiers);
          break;
        }
      }
      } catch (err) {
...
mojo.internal.bindings.action_chips.mojom.ActionChipsHandlerReceiver = mojo.internal.bindings.action_chips.mojom.ActionChipsHandlerReceiver;

mojo.internal.bindings.action_chips.mojom.ActionChipsHandlerPtr = mojo.internal.bindings.action_chips.mojom.ActionChipsHandlerRemote;
mojo.internal.bindings.action_chips.mojom.ActionChipsHandlerRequest = mojo.internal.bindings.action_chips.mojom.ActionChipsHandlerPendingReceiver;
...
mojo.internal.bindings.action_chips.mojom.PageRemote = class {
  ...
  constructor(handle = undefined) {
    ...
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.action_chips.mojom.PageRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.action_chips.mojom.PageReceiver = mojo.internal.bindings.action_chips.mojom.PageReceiver;

mojo.internal.bindings.action_chips.mojom.PagePtr = mojo.internal.bindings.action_chips.mojom.PageRemote;
mojo.internal.bindings.action_chips.mojom.PageRequest = mojo.internal.bindings.action_chips.mojom.PagePendingReceiver;
...
mojo.internal.bindings.action_chips.mojom.ActionChipsHandlerFactoryRemote = class {
  ...
  constructor(handle = undefined) {
    ...
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.action_chips.mojom.ActionChipsHandlerFactoryRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.action_chips.mojom.ActionChipsHandlerFactory.getRemote = function() {
  let remote = new mojo.internal.bindings.action_chips.mojom.ActionChipsHandlerFactoryRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
...
mojo.internal.bindings.action_chips.mojom.ActionChipsHandlerFactoryReceiver = mojo.internal.bindings.action_chips.mojom.ActionChipsHandlerFactoryReceiver;
...
mojo.internal.Struct(
    mojo.internal.bindings.action_chips.mojom.FormattedStringSpec, 'action_chips.mojom.FormattedString', [
      mojo.internal.StructField('arg_text', 0, 0, mojo.internal.String, null, false, 0, undefined),
      mojo.internal.StructField('arg_a11y_text', 8, 0, mojo.internal.String, null, true, 0, undefined),
    ],
    [[0, 24]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.action_chips.mojom.SuggestTemplateInfoSpec, 'action_chips.mojom.SuggestTemplateInfo', [
      ...
      mojo.internal.StructField('arg_fusebox_action', 24, 0, mojo.internal.bindings.fusebox_action.mojom.FuseboxActionSpec, null, true, 0, undefined),
    ],
    [[0, 40]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.action_chips.mojom.ActionChipSpec, 'action_chips.mojom.ActionChip', [
      ...
      mojo.internal.StructField('arg_suggest_template_info', 8, 0, mojo.internal.bindings.action_chips.mojom.SuggestTemplateInfoSpec, null, false, 0, undefined),
...
mojo.internal.Struct(
    mojo.internal.bindings.action_chips.mojom.ActionChipsHandler_NavigateToAim_ParamsSpec, 'action_chips.mojom.ActionChipsHandler_NavigateToAim_Params', [
      ...
      mojo.internal.StructField('arg_modifiers', 16, 0, mojo.internal.bindings.searchbox.mojom.ActionModifiersSpec, null, false, 0, undefined),
    ],
    [[0, 32]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.action_chips.mojom.ActionChipsHandlerFactory_CreateActionChipsHandler_ParamsSpec, 'action_chips.mojom.ActionChipsHandlerFactory_CreateActionChipsHandler_Params', [
      mojo.internal.StructField('arg_handler', 0, 0, mojo.internal.InterfaceRequest(mojo.internal.bindings.action_chips.mojom.ActionChipsHandlerPendingReceiver), null, false, 0, undefined),
