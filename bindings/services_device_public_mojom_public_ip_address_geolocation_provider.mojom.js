...
mojo.internal.bindings.device.mojom.PublicIpAddressGeolocationProviderRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.device.mojom.PublicIpAddressGeolocationProviderPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.device.mojom.PublicIpAddressGeolocationProviderRemoteCallHandler(this.proxy);
  }
  ...
  createGeolocation(arg_tag, arg_receiver, arg_client_id) {
    return this.$.createGeolocation(arg_tag, arg_receiver, arg_client_id);
  }
};

mojo.internal.bindings.device.mojom.PublicIpAddressGeolocationProviderRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('device.mojom.PublicIpAddressGeolocationProvider', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.device.mojom.PublicIpAddressGeolocationProvider.getRemote = function() {
  let remote = new mojo.internal.bindings.device.mojom.PublicIpAddressGeolocationProviderRemote();
...
mojo.internal.bindings.device.mojom.PublicIpAddressGeolocationProviderReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('device.mojom.PublicIpAddressGeolocationProvider', [
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.device.mojom.PublicIpAddressGeolocationProvider_CreateGeolocation_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.device.mojom.PublicIpAddressGeolocationProviderReceiver = mojo.internal.bindings.device.mojom.PublicIpAddressGeolocationProviderReceiver;
