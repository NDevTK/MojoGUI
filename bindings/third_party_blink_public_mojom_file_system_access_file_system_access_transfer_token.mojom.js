...
mojo.internal.Struct(
    mojo.internal.bindings.blink.mojom.FileSystemAccessTransferToken_GetInternalID_ParamsSpec, 'blink.mojom.FileSystemAccessTransferToken_GetInternalID_Params', [
    ],
    [[0, 8]]);

mojo.internal.Struct(
    mojo.internal.bindings.blink.mojom.FileSystemAccessTransferToken_GetInternalID_ResponseParamsSpec, 'blink.mojom.FileSystemAccessTransferToken_GetInternalID_ResponseParams', [
...
mojo.internal.bindings.blink.mojom.FileSystemAccessTransferTokenPendingReceiver = class {
  constructor(handle) {
    this.handle = handle;
  }
};

mojo.internal.bindings.blink.mojom.FileSystemAccessTransferTokenRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.blink.mojom.FileSystemAccessTransferTokenRemoteCallHandler(this.proxy);
  }
  ...
  clone(arg_token_clone) {
    return this.$.clone(arg_token_clone);
  }
};
...
mojo.internal.bindings.blink.mojom.FileSystemAccessTransferToken.getRemote = function() {
  let remote = new mojo.internal.bindings.blink.mojom.FileSystemAccessTransferTokenRemote();
...
mojo.internal.bindings.blink.mojom.FileSystemAccessTransferTokenReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.blink.mojom.FileSystemAccessTransferToken_GetInternalID_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for GetInternalID failed with TypeError');
           }
        }
        // Try Method 1: Clone
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.blink.mojom.FileSystemAccessTransferToken_Clone_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.blink.mojom.FileSystemAccessTransferToken_GetInternalID_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.getInternalID');
          const result = this.impl.getInternalID();
          const expectsResponse = header.expectsResponse || (header.flags & 1);
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              this.endpoint.send(header.ordinal, header.requestId, mojo.internal.kMessageFlagIsResponse, mojo.internal.bindings.blink.mojom.FileSystemAccessTransferToken_GetInternalID_ResponseParamsSpec, response);
        ...
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.blink.mojom.FileSystemAccessTransferToken_Clone_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.blink.mojom.FileSystemAccessTransferTokenReceiver = mojo.internal.bindings.blink.mojom.FileSystemAccessTransferTokenReceiver;

mojo.internal.bindings.blink.mojom.FileSystemAccessTransferTokenPtr = mojo.internal.bindings.blink.mojom.FileSystemAccessTransferTokenRemote;
mojo.internal.bindings.blink.mojom.FileSystemAccessTransferTokenRequest = mojo.internal.bindings.blink.mojom.FileSystemAccessTransferTokenPendingReceiver;
