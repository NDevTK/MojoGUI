...
mojo.internal.bindings.updater.mojom.UpdateServiceInternalRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.updater.mojom.UpdateServiceInternalPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.updater.mojom.UpdateServiceInternalRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.updater.mojom.UpdateServiceInternal.getRemote = function() {
  let remote = new mojo.internal.bindings.updater.mojom.UpdateServiceInternalRemote();
...
mojo.internal.bindings.updater.mojom.UpdateServiceInternalReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.updater.mojom.UpdateServiceInternal_Run_ParamsSpec.$.structSpec);
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.updater.mojom.UpdateServiceInternal_Run_ResponseParamsSpec, header, rawHeader);
               responder(response);
        ...
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.updater.mojom.UpdateServiceInternal_Hello_ParamsSpec.$.structSpec);
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              const rawHeader = (args[2] && args[2].slice) ? args[2].slice(0, header.headerSize) : null;
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.updater.mojom.UpdateServiceInternal_Hello_ResponseParamsSpec, header, rawHeader);
               responder(response);
...
mojo.internal.bindings.updater.mojom.UpdateServiceInternalReceiver = mojo.internal.bindings.updater.mojom.UpdateServiceInternalReceiver;
