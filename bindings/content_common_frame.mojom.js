...
mojo.internal.bindings.content.mojom.Frame_UndoCommitNavigation_ParamsSpec = mojo.internal.bindings.content.mojom.Frame_UndoCommitNavigation_ParamsSpec || { $: {} };
if (mojo.internal.bindings.content.mojom.Frame_UndoCommitNavigation_ParamsSpec.$.structSpec && mojo.internal.bindings.content.mojom.Frame_UndoCommitNavigation_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.content.mojom.Frame_UndoCommitNavigation_ParamsSpec.$ = {};
...
mojo.internal.bindings.content.mojom.FrameHostRemote = class {
  ...
  beginNavigation(arg_common_params, arg_begin_params, arg_blob_url_token, arg_navigation_client, arg_initiator_navigation_state_keep_alive_handle, arg_renderer_cancellation_listener, arg_resume_deferred_commit_listener) {
    return this.$.beginNavigation(arg_common_params, arg_begin_params, arg_blob_url_token, arg_navigation_client, arg_initiator_navigation_state_keep_alive_handle, arg_renderer_cancellation_listener, arg_resume_deferred_commit_listener);
  }
...
mojo.internal.bindings.content.mojom.FrameHostRemoteCallHandler = class {
  ...
  beginNavigation(arg_common_params, arg_begin_params, arg_blob_url_token, arg_navigation_client, arg_initiator_navigation_state_keep_alive_handle, arg_renderer_cancellation_listener, arg_resume_deferred_commit_listener) {
    return this.proxy.sendMessage(
      ...
      null,
      [arg_common_params, arg_begin_params, arg_blob_url_token, arg_navigation_client, arg_initiator_navigation_state_keep_alive_handle, arg_renderer_cancellation_listener, arg_resume_deferred_commit_listener],
      false);
  }
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        ...
        case 5: {
          ...
          const result = this.impl.beginNavigation(params.arg_common_params, params.arg_begin_params, params.arg_blob_url_token, params.arg_navigation_client, params.arg_initiator_navigation_state_keep_alive_handle, params.arg_renderer_cancellation_listener, params.arg_resume_deferred_commit_listener);
          break;
        }
        case 6: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
...
mojo.internal.Struct(
    mojo.internal.bindings.content.mojom.FrameHost_BeginNavigation_ParamsSpec, 'content.mojom.FrameHost_BeginNavigation_Params', [
      ...
      mojo.internal.StructField('arg_resume_deferred_commit_listener', 44, 0, mojo.internal.InterfaceRequest(mojo.internal.bindings.blink.mojom.NavigationResumeDeferredCommitListenerPendingReceiver), null, true, 0, undefined),
    ],
    [[0, 56]]);
