  ...
  $: {
    structSpec: {
      ...
      fields: [
        ...
        { name: 'are_contents_opaque', packedOffset: 40, packedBitOffset: 0, type: mojo.internal.Bool, nullable: false },
        ...
        { name: 'is_fast_rounded_corner', packedOffset: 64, packedBitOffset: 0, type: mojo.internal.Bool, nullable: false },
        { name: 'offset_tag', packedOffset: 72, packedBitOffset: 0, type: viz.mojom.OffsetTagSpec, nullable: false },
      ],
      versions: [{version: 0}]
    }
  }
