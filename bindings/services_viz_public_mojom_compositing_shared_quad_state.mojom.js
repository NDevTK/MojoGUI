...
viz.mojom.SharedQuadStateSpec = {
  $: {
    structSpec: {
      ...
      packedSize: 80,
      fields: [
        { name: 'quad_to_target_transform', packedOffset: 0, packedBitOffset: 0, type: mojo.internal.Pointer, nullable: false },
        { name: 'quad_layer_rect', packedOffset: 8, packedBitOffset: 0, type: mojo.internal.Pointer, nullable: false },
        { name: 'visible_quad_layer_rect', packedOffset: 16, packedBitOffset: 0, type: mojo.internal.Pointer, nullable: false },
        { name: 'mask_filter_info', packedOffset: 24, packedBitOffset: 0, type: mojo.internal.Pointer, nullable: true },
        { name: 'clip_rect', packedOffset: 32, packedBitOffset: 0, type: mojo.internal.Pointer, nullable: true },
