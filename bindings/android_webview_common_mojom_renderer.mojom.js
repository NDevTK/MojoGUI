...
mojo.internal.bindings.android_webview.mojom.Renderer = {};
mojo.internal.bindings.android_webview.mojom.RendererSpec = { $ : {} };
mojo.internal.bindings.android_webview.mojom.Renderer.$interfaceName = 'android_webview.mojom.Renderer';
...
mojo.internal.bindings.android_webview.mojom.RendererRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.android_webview.mojom.RendererPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.android_webview.mojom.RendererRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.android_webview.mojom.Renderer.getRemote = function() {
  let remote = new mojo.internal.bindings.android_webview.mojom.RendererRemote();
...
mojo.internal.bindings.android_webview.mojom.RendererReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.android_webview.mojom.Renderer_ClearCache_ParamsSpec.$.structSpec;
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.android_webview.mojom.Renderer_SetJsOnlineProperty_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for SetJsOnlineProperty failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.android_webview.mojom.Renderer_ClearCache_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.android_webview.mojom.RendererReceiver = mojo.internal.bindings.android_webview.mojom.RendererReceiver;
