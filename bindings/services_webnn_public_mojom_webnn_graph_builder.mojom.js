...
mojo.internal.Struct(
    mojo.internal.bindings.webnn.mojom.WebNNGraphBuilder_CreatePendingConstant_ParamsSpec, 'webnn.mojom.WebNNGraphBuilder_CreatePendingConstant_Params', [
      ...
      mojo.internal.StructField('arg_constant_handle', 16, 0, mojo.internal.bindings.blink.mojom.WebNNPendingConstantTokenSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_data_type', 24, 0, mojo.internal.bindings.webnn.mojom.DataTypeSpec, null, false, 0, undefined),
    ],
    [[0, 40]]);
...
mojo.internal.bindings.webnn.mojom.WebNNGraphBuilderRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.webnn.mojom.WebNNGraphBuilderRemoteCallHandler(this.proxy);
  }
  ...
  createPendingConstant(arg_constant_handle, arg_data_type, arg_data) {
    return this.$.createPendingConstant(arg_constant_handle, arg_data_type, arg_data);
  }
  createGraph(arg_graph_info) {
    return this.$.createGraph(arg_graph_info);
  }
  isValidGraphForTesting(arg_context_properties, arg_graph_info) {
    return this.$.isValidGraphForTesting(arg_context_properties, arg_graph_info);
  }
};
...
mojo.internal.bindings.webnn.mojom.WebNNGraphBuilder.getRemote = function() {
  let remote = new mojo.internal.bindings.webnn.mojom.WebNNGraphBuilderRemote();
...
mojo.internal.bindings.webnn.mojom.WebNNGraphBuilderReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.webnn.mojom.WebNNGraphBuilder_CreatePendingConstant_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for CreatePendingConstant failed with TypeError');
           }
        }
        // Try Method 1: CreateGraph
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.webnn.mojom.WebNNGraphBuilder_CreateGraph_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for CreateGraph failed with TypeError');
           }
        }
        // Try Method 2: IsValidGraphForTesting
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.webnn.mojom.WebNNGraphBuilder_IsValidGraphForTesting_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for IsValidGraphForTesting failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.webnn.mojom.WebNNGraphBuilderReceiver = mojo.internal.bindings.webnn.mojom.WebNNGraphBuilderReceiver;
