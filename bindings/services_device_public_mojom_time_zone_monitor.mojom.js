...
mojo.internal.bindings.device.mojom.TimeZoneMonitorRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.device.mojom.TimeZoneMonitorPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.device.mojom.TimeZoneMonitorRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.device.mojom.TimeZoneMonitor.getRemote = function() {
  let remote = new mojo.internal.bindings.device.mojom.TimeZoneMonitorRemote();
...
mojo.internal.bindings.device.mojom.TimeZoneMonitorReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.device.mojom.TimeZoneMonitor_AddClient_ParamsSpec.$.structSpec;
...
mojo.internal.bindings.device.mojom.TimeZoneMonitorReceiver = mojo.internal.bindings.device.mojom.TimeZoneMonitorReceiver;

mojo.internal.bindings.device.mojom.TimeZoneMonitorPtr = mojo.internal.bindings.device.mojom.TimeZoneMonitorRemote;
mojo.internal.bindings.device.mojom.TimeZoneMonitorRequest = mojo.internal.bindings.device.mojom.TimeZoneMonitorPendingReceiver;


// Interface: TimeZoneMonitorClient
mojo.internal.Struct(
    mojo.internal.bindings.device.mojom.TimeZoneMonitorClient_OnTimeZoneChange_ParamsSpec, 'device.mojom.TimeZoneMonitorClient_OnTimeZoneChange_Params', [
      mojo.internal.StructField('arg_tz_info', 0, 0, mojo.internal.String, null, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.bindings.device.mojom.TimeZoneMonitorClientPendingReceiver = class {
  constructor(handle) {
    this.handle = handle;
  }
};

mojo.internal.bindings.device.mojom.TimeZoneMonitorClientRemote = class {
  static get $interfaceName() {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.device.mojom.TimeZoneMonitorClientPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.device.mojom.TimeZoneMonitorClientRemoteCallHandler(this.proxy);
  }
  ...
  onTimeZoneChange(arg_tz_info) {
    return this.$.onTimeZoneChange(arg_tz_info);
  }
};
...
mojo.internal.bindings.device.mojom.TimeZoneMonitorClient.getRemote = function() {
  let remote = new mojo.internal.bindings.device.mojom.TimeZoneMonitorClientRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
...
mojo.internal.bindings.device.mojom.TimeZoneMonitorClientReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.device.mojom.TimeZoneMonitorClient_OnTimeZoneChange_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OnTimeZoneChange failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
             console.warn('[GeneratedReceiver] Failed to discover ordinal ' + header.ordinal);
...
mojo.internal.bindings.device.mojom.TimeZoneMonitorClientReceiver = mojo.internal.bindings.device.mojom.TimeZoneMonitorClientReceiver;

mojo.internal.bindings.device.mojom.TimeZoneMonitorClientPtr = mojo.internal.bindings.device.mojom.TimeZoneMonitorClientRemote;
mojo.internal.bindings.device.mojom.TimeZoneMonitorClientRequest = mojo.internal.bindings.device.mojom.TimeZoneMonitorClientPendingReceiver;
