...
mojo.internal.bindings.media = mojo.internal.bindings.media || {};
mojo.internal.bindings.media.mojom = mojo.internal.bindings.media.mojom || {};
mojo.internal.bindings.media.mojom.AudioDecoderSpec = mojo.internal.bindings.media.mojom.AudioDecoderSpec || { $: mojo.internal.OpaqueStruct.$ };
mojo.internal.bindings.media = mojo.internal.bindings.media || {};
mojo.internal.bindings.media.mojom = mojo.internal.bindings.media.mojom || {};
mojo.internal.bindings.media.mojom.AudioEncoderSpec = mojo.internal.bindings.media.mojom.AudioEncoderSpec || { $: mojo.internal.OpaqueStruct.$ };
mojo.internal.bindings.media = mojo.internal.bindings.media || {};
mojo.internal.bindings.media.mojom = mojo.internal.bindings.media.mojom || {};
mojo.internal.bindings.media.mojom.CdmConfigSpec = mojo.internal.bindings.media.mojom.CdmConfigSpec || { $: mojo.internal.OpaqueStruct.$ };
mojo.internal.bindings.media = mojo.internal.bindings.media || {};
mojo.internal.bindings.media.mojom = mojo.internal.bindings.media.mojom || {};
mojo.internal.bindings.media.mojom.CdmContextSpec = mojo.internal.bindings.media.mojom.CdmContextSpec || { $: mojo.internal.OpaqueStruct.$ };
mojo.internal.bindings.media = mojo.internal.bindings.media || {};
mojo.internal.bindings.media.mojom = mojo.internal.bindings.media.mojom || {};
mojo.internal.bindings.media.mojom.ContentDecryptionModuleSpec = mojo.internal.bindings.media.mojom.ContentDecryptionModuleSpec || { $: mojo.internal.OpaqueStruct.$ };
mojo.internal.bindings.media = mojo.internal.bindings.media || {};
mojo.internal.bindings.media.mojom = mojo.internal.bindings.media.mojom || {};
...
mojo.internal.bindings.media = mojo.internal.bindings.media || {};
mojo.internal.bindings.media.mojom = mojo.internal.bindings.media.mojom || {};
mojo.internal.bindings.media.mojom.VideoDecoderSpec = mojo.internal.bindings.media.mojom.VideoDecoderSpec || { $: mojo.internal.OpaqueStruct.$ };
mojo.internal.bindings.mojo_base = mojo.internal.bindings.mojo_base || {};
...
mojo.internal.bindings.media.mojom.VideoDecoderTrackerRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.media.mojom.VideoDecoderTrackerRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.media.mojom.VideoDecoderTracker.getRemote = function() {
  let remote = new mojo.internal.bindings.media.mojom.VideoDecoderTrackerRemote();
...
mojo.internal.bindings.media.mojom.VideoDecoderTrackerReceiver = mojo.internal.bindings.media.mojom.VideoDecoderTrackerReceiver;

mojo.internal.bindings.media.mojom.VideoDecoderTrackerPtr = mojo.internal.bindings.media.mojom.VideoDecoderTrackerRemote;
mojo.internal.bindings.media.mojom.VideoDecoderTrackerRequest = mojo.internal.bindings.media.mojom.VideoDecoderTrackerPendingReceiver;
...
mojo.internal.bindings.media.mojom.InterfaceFactoryRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.media.mojom.InterfaceFactoryRemoteCallHandler(this.proxy);
  }
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.media.mojom.InterfaceFactory_CreateAudioDecoder_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for CreateAudioDecoder failed with TypeError');
           }
        }
        // Try Method 1: CreateVideoDecoder
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.media.mojom.InterfaceFactory_CreateVideoDecoder_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.media.mojom.InterfaceFactory_CreateVideoDecoderWithTracker_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for CreateVideoDecoderWithTracker failed with TypeError');
           }
        }
        // Try Method 3: CreateAudioEncoder
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.media.mojom.InterfaceFactory_CreateAudioEncoder_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for CreateAudioEncoder failed with TypeError');
           }
        }
        // Try Method 4: CreateDefaultRenderer
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.media.mojom.InterfaceFactory_CreateDefaultRenderer_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for CreateDefaultRenderer failed with TypeError');
           }
        }
        // Try Method 5: CreateCastRenderer
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.media.mojom.InterfaceFactory_CreateCastRenderer_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for CreateCastRenderer failed with TypeError');
           }
        }
        // Try Method 6: CreateMediaFoundationRenderer
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.media.mojom.InterfaceFactory_CreateMediaFoundationRenderer_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
...
mojo.internal.bindings.media.mojom.InterfaceFactoryReceiver = mojo.internal.bindings.media.mojom.InterfaceFactoryReceiver;
