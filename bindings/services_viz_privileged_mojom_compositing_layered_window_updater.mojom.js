...
mojo.internal.bindings.viz.mojom.LayeredWindowUpdater = {};
mojo.internal.bindings.viz.mojom.LayeredWindowUpdaterSpec = { $ : {} };
mojo.internal.bindings.viz.mojom.LayeredWindowUpdater.$interfaceName = 'viz.mojom.LayeredWindowUpdater';
...
mojo.internal.bindings.viz.mojom.LayeredWindowUpdaterRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.viz.mojom.LayeredWindowUpdaterRemoteCallHandler(this.proxy);
  }
  ...
  onAllocatedSharedMemory(arg_pixel_size, arg_region) {
    return this.$.onAllocatedSharedMemory(arg_pixel_size, arg_region);
  }
  draw() {
    return this.$.draw();
  }
...
mojo.internal.bindings.viz.mojom.LayeredWindowUpdaterRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('viz.mojom.LayeredWindowUpdater', [
      { explicit: null },
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.viz.mojom.LayeredWindowUpdater.getRemote = function() {
  let remote = new mojo.internal.bindings.viz.mojom.LayeredWindowUpdaterRemote();
...
mojo.internal.bindings.viz.mojom.LayeredWindowUpdaterReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('viz.mojom.LayeredWindowUpdater', [
      { explicit: null },
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.viz.mojom.LayeredWindowUpdater_OnAllocatedSharedMemory_ParamsSpec.$.structSpec);
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.viz.mojom.LayeredWindowUpdater_Draw_ParamsSpec.$.structSpec);
      ...
      switch (dispatchId) {
        ...
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.viz.mojom.LayeredWindowUpdater_Draw_ParamsSpec.$.structSpec);
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.viz.mojom.LayeredWindowUpdater_Draw_ResponseParamsSpec, header, rawHeader);
               responder(response);
...
mojo.internal.bindings.viz.mojom.LayeredWindowUpdaterReceiver = mojo.internal.bindings.viz.mojom.LayeredWindowUpdaterReceiver;
