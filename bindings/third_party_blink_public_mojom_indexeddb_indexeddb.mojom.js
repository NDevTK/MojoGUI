...
mojo.internal.bindings.blink.mojom.IDBCursorDirectionSpec = mojo.internal.bindings.blink.mojom.IDBCursorDirectionSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.blink.mojom.IDBDataLossSpec = mojo.internal.bindings.blink.mojom.IDBDataLossSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.blink.mojom.IDBKeyTypeSpec = mojo.internal.bindings.blink.mojom.IDBKeyTypeSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.blink.mojom.IDBTransactionDurabilitySpec = mojo.internal.bindings.blink.mojom.IDBTransactionDurabilitySpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.blink.mojom.IDBGetAllResultTypeSpec = mojo.internal.bindings.blink.mojom.IDBGetAllResultTypeSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.blink.mojom.IDBKeyPathTypeSpec = mojo.internal.bindings.blink.mojom.IDBKeyPathTypeSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.blink.mojom.IDBOperationTypeSpec = mojo.internal.bindings.blink.mojom.IDBOperationTypeSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.blink.mojom.IDBPutModeSpec = mojo.internal.bindings.blink.mojom.IDBPutModeSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.blink.mojom.IDBTaskTypeSpec = mojo.internal.bindings.blink.mojom.IDBTaskTypeSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.blink.mojom.IDBTransactionModeSpec = mojo.internal.bindings.blink.mojom.IDBTransactionModeSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.blink.mojom.IDBExceptionSpec = mojo.internal.bindings.blink.mojom.IDBExceptionSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.blink.mojom.IDBKeySpec = mojo.internal.bindings.blink.mojom.IDBKeySpec || { $: {} };
if (mojo.internal.bindings.blink.mojom.IDBKeySpec.$.structSpec && mojo.internal.bindings.blink.mojom.IDBKeySpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.blink.mojom.IDBKeySpec.$ = {};
mojo.internal.bindings.blink.mojom.IDBKeyPathDataSpec = mojo.internal.bindings.blink.mojom.IDBKeyPathDataSpec || { $: {} };
if (mojo.internal.bindings.blink.mojom.IDBKeyPathDataSpec.$.structSpec && mojo.internal.bindings.blink.mojom.IDBKeyPathDataSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.blink.mojom.IDBKeyPathDataSpec.$ = {};
mojo.internal.bindings.blink.mojom.IDBExternalObjectSpec = mojo.internal.bindings.blink.mojom.IDBExternalObjectSpec || { $: {} };
if (mojo.internal.bindings.blink.mojom.IDBExternalObjectSpec.$.structSpec && mojo.internal.bindings.blink.mojom.IDBExternalObjectSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.blink.mojom.IDBExternalObjectSpec.$ = {};
mojo.internal.bindings.blink.mojom.IDBCursorResultSpec = mojo.internal.bindings.blink.mojom.IDBCursorResultSpec || { $: {} };
if (mojo.internal.bindings.blink.mojom.IDBCursorResultSpec.$.structSpec && mojo.internal.bindings.blink.mojom.IDBCursorResultSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.blink.mojom.IDBCursorResultSpec.$ = {};
mojo.internal.bindings.blink.mojom.IDBTransactionPutResultSpec = mojo.internal.bindings.blink.mojom.IDBTransactionPutResultSpec || { $: {} };
if (mojo.internal.bindings.blink.mojom.IDBTransactionPutResultSpec.$.structSpec && mojo.internal.bindings.blink.mojom.IDBTransactionPutResultSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.blink.mojom.IDBTransactionPutResultSpec.$ = {};
mojo.internal.bindings.blink.mojom.IDBDatabaseGetResultSpec = mojo.internal.bindings.blink.mojom.IDBDatabaseGetResultSpec || { $: {} };
if (mojo.internal.bindings.blink.mojom.IDBDatabaseGetResultSpec.$.structSpec && mojo.internal.bindings.blink.mojom.IDBDatabaseGetResultSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.blink.mojom.IDBDatabaseGetResultSpec.$ = {};
mojo.internal.bindings.blink.mojom.IDBDatabaseOpenCursorResultSpec = mojo.internal.bindings.blink.mojom.IDBDatabaseOpenCursorResultSpec || { $: {} };
if (mojo.internal.bindings.blink.mojom.IDBDatabaseOpenCursorResultSpec.$.structSpec && mojo.internal.bindings.blink.mojom.IDBDatabaseOpenCursorResultSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.blink.mojom.IDBDatabaseOpenCursorResultSpec.$ = {};
mojo.internal.bindings.blink.mojom.IDBKeyPathSpec = mojo.internal.bindings.blink.mojom.IDBKeyPathSpec || { $: {} };
if (mojo.internal.bindings.blink.mojom.IDBKeyPathSpec.$.structSpec && mojo.internal.bindings.blink.mojom.IDBKeyPathSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.blink.mojom.IDBKeyPathSpec.$ = {};
mojo.internal.bindings.blink.mojom.IDBKeyRangeSpec = mojo.internal.bindings.blink.mojom.IDBKeyRangeSpec || { $: {} };
if (mojo.internal.bindings.blink.mojom.IDBKeyRangeSpec.$.structSpec && mojo.internal.bindings.blink.mojom.IDBKeyRangeSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.blink.mojom.IDBKeyRangeSpec.$ = {};
mojo.internal.bindings.blink.mojom.IDBIndexMetadataSpec = mojo.internal.bindings.blink.mojom.IDBIndexMetadataSpec || { $: {} };
if (mojo.internal.bindings.blink.mojom.IDBIndexMetadataSpec.$.structSpec && mojo.internal.bindings.blink.mojom.IDBIndexMetadataSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.blink.mojom.IDBIndexMetadataSpec.$ = {};
mojo.internal.bindings.blink.mojom.IDBObjectStoreMetadataSpec = mojo.internal.bindings.blink.mojom.IDBObjectStoreMetadataSpec || { $: {} };
if (mojo.internal.bindings.blink.mojom.IDBObjectStoreMetadataSpec.$.structSpec && mojo.internal.bindings.blink.mojom.IDBObjectStoreMetadataSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.blink.mojom.IDBObjectStoreMetadataSpec.$ = {};
mojo.internal.bindings.blink.mojom.IDBDatabaseMetadataSpec = mojo.internal.bindings.blink.mojom.IDBDatabaseMetadataSpec || { $: {} };
if (mojo.internal.bindings.blink.mojom.IDBDatabaseMetadataSpec.$.structSpec && mojo.internal.bindings.blink.mojom.IDBDatabaseMetadataSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.blink.mojom.IDBDatabaseMetadataSpec.$ = {};
mojo.internal.bindings.blink.mojom.IDBNameAndVersionSpec = mojo.internal.bindings.blink.mojom.IDBNameAndVersionSpec || { $: {} };
if (mojo.internal.bindings.blink.mojom.IDBNameAndVersionSpec.$.structSpec && mojo.internal.bindings.blink.mojom.IDBNameAndVersionSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.blink.mojom.IDBNameAndVersionSpec.$ = {};
mojo.internal.bindings.blink.mojom.IDBIndexKeysSpec = mojo.internal.bindings.blink.mojom.IDBIndexKeysSpec || { $: {} };
if (mojo.internal.bindings.blink.mojom.IDBIndexKeysSpec.$.structSpec && mojo.internal.bindings.blink.mojom.IDBIndexKeysSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.blink.mojom.IDBIndexKeysSpec.$ = {};
mojo.internal.bindings.blink.mojom.IDBFileInfoSpec = mojo.internal.bindings.blink.mojom.IDBFileInfoSpec || { $: {} };
if (mojo.internal.bindings.blink.mojom.IDBFileInfoSpec.$.structSpec && mojo.internal.bindings.blink.mojom.IDBFileInfoSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.blink.mojom.IDBFileInfoSpec.$ = {};
mojo.internal.bindings.blink.mojom.IDBBlobInfoSpec = mojo.internal.bindings.blink.mojom.IDBBlobInfoSpec || { $: {} };
if (mojo.internal.bindings.blink.mojom.IDBBlobInfoSpec.$.structSpec && mojo.internal.bindings.blink.mojom.IDBBlobInfoSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.blink.mojom.IDBBlobInfoSpec.$ = {};
mojo.internal.bindings.blink.mojom.IDBValueSpec = mojo.internal.bindings.blink.mojom.IDBValueSpec || { $: {} };
if (mojo.internal.bindings.blink.mojom.IDBValueSpec.$.structSpec && mojo.internal.bindings.blink.mojom.IDBValueSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.blink.mojom.IDBValueSpec.$ = {};
mojo.internal.bindings.blink.mojom.IDBReturnValueSpec = mojo.internal.bindings.blink.mojom.IDBReturnValueSpec || { $: {} };
if (mojo.internal.bindings.blink.mojom.IDBReturnValueSpec.$.structSpec && mojo.internal.bindings.blink.mojom.IDBReturnValueSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.blink.mojom.IDBReturnValueSpec.$ = {};
mojo.internal.bindings.blink.mojom.IDBRecordSpec = mojo.internal.bindings.blink.mojom.IDBRecordSpec || { $: {} };
if (mojo.internal.bindings.blink.mojom.IDBRecordSpec.$.structSpec && mojo.internal.bindings.blink.mojom.IDBRecordSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.blink.mojom.IDBRecordSpec.$ = {};
mojo.internal.bindings.blink.mojom.IDBErrorSpec = mojo.internal.bindings.blink.mojom.IDBErrorSpec || { $: {} };
if (mojo.internal.bindings.blink.mojom.IDBErrorSpec.$.structSpec && mojo.internal.bindings.blink.mojom.IDBErrorSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.blink.mojom.IDBErrorSpec.$ = {};
mojo.internal.bindings.blink.mojom.IDBCursorValueSpec = mojo.internal.bindings.blink.mojom.IDBCursorValueSpec || { $: {} };
if (mojo.internal.bindings.blink.mojom.IDBCursorValueSpec.$.structSpec && mojo.internal.bindings.blink.mojom.IDBCursorValueSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.blink.mojom.IDBCursorValueSpec.$ = {};
mojo.internal.bindings.blink.mojom.IDBDatabaseOpenCursorValueSpec = mojo.internal.bindings.blink.mojom.IDBDatabaseOpenCursorValueSpec || { $: {} };
if (mojo.internal.bindings.blink.mojom.IDBDatabaseOpenCursorValueSpec.$.structSpec && mojo.internal.bindings.blink.mojom.IDBDatabaseOpenCursorValueSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.blink.mojom.IDBDatabaseOpenCursorValueSpec.$ = {};
mojo.internal.bindings.blink.mojom.IDBFactoryClient = mojo.internal.bindings.blink.mojom.IDBFactoryClient || {};
mojo.internal.bindings.blink.mojom.IDBFactoryClientSpec = mojo.internal.bindings.blink.mojom.IDBFactoryClientSpec || { $ : {} };
if (mojo.internal.bindings.blink.mojom.IDBFactoryClientSpec.$.structSpec && mojo.internal.bindings.blink.mojom.IDBFactoryClientSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.blink.mojom.IDBFactoryClientSpec.$ = {};
mojo.internal.bindings.blink.mojom.IDBFactoryClient.$interfaceName = 'blink.mojom.IDBFactoryClient';
mojo.internal.bindings.blink.mojom.IDBFactoryClient_Error_ParamsSpec = mojo.internal.bindings.blink.mojom.IDBFactoryClient_Error_ParamsSpec || { $: {} };
if (mojo.internal.bindings.blink.mojom.IDBFactoryClient_Error_ParamsSpec.$.structSpec && mojo.internal.bindings.blink.mojom.IDBFactoryClient_Error_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.blink.mojom.IDBFactoryClient_Error_ParamsSpec.$ = {};
mojo.internal.bindings.blink.mojom.IDBFactoryClient_Blocked_ParamsSpec = mojo.internal.bindings.blink.mojom.IDBFactoryClient_Blocked_ParamsSpec || { $: {} };
if (mojo.internal.bindings.blink.mojom.IDBFactoryClient_Blocked_ParamsSpec.$.structSpec && mojo.internal.bindings.blink.mojom.IDBFactoryClient_Blocked_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.blink.mojom.IDBFactoryClient_Blocked_ParamsSpec.$ = {};
mojo.internal.bindings.blink.mojom.IDBFactoryClient_UpgradeNeeded_ParamsSpec = mojo.internal.bindings.blink.mojom.IDBFactoryClient_UpgradeNeeded_ParamsSpec || { $: {} };
if (mojo.internal.bindings.blink.mojom.IDBFactoryClient_UpgradeNeeded_ParamsSpec.$.structSpec && mojo.internal.bindings.blink.mojom.IDBFactoryClient_UpgradeNeeded_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.blink.mojom.IDBFactoryClient_UpgradeNeeded_ParamsSpec.$ = {};
mojo.internal.bindings.blink.mojom.IDBFactoryClient_OpenSuccess_ParamsSpec = mojo.internal.bindings.blink.mojom.IDBFactoryClient_OpenSuccess_ParamsSpec || { $: {} };
if (mojo.internal.bindings.blink.mojom.IDBFactoryClient_OpenSuccess_ParamsSpec.$.structSpec && mojo.internal.bindings.blink.mojom.IDBFactoryClient_OpenSuccess_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.blink.mojom.IDBFactoryClient_OpenSuccess_ParamsSpec.$ = {};
mojo.internal.bindings.blink.mojom.IDBFactoryClient_DeleteSuccess_ParamsSpec = mojo.internal.bindings.blink.mojom.IDBFactoryClient_DeleteSuccess_ParamsSpec || { $: {} };
if (mojo.internal.bindings.blink.mojom.IDBFactoryClient_DeleteSuccess_ParamsSpec.$.structSpec && mojo.internal.bindings.blink.mojom.IDBFactoryClient_DeleteSuccess_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.blink.mojom.IDBFactoryClient_DeleteSuccess_ParamsSpec.$ = {};
mojo.internal.bindings.blink.mojom.IDBDatabaseCallbacks = mojo.internal.bindings.blink.mojom.IDBDatabaseCallbacks || {};
mojo.internal.bindings.blink.mojom.IDBDatabaseCallbacksSpec = mojo.internal.bindings.blink.mojom.IDBDatabaseCallbacksSpec || { $ : {} };
if (mojo.internal.bindings.blink.mojom.IDBDatabaseCallbacksSpec.$.structSpec && mojo.internal.bindings.blink.mojom.IDBDatabaseCallbacksSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.blink.mojom.IDBDatabaseCallbacksSpec.$ = {};
mojo.internal.bindings.blink.mojom.IDBDatabaseCallbacks.$interfaceName = 'blink.mojom.IDBDatabaseCallbacks';
mojo.internal.bindings.blink.mojom.IDBDatabaseCallbacks_ForcedClose_ParamsSpec = mojo.internal.bindings.blink.mojom.IDBDatabaseCallbacks_ForcedClose_ParamsSpec || { $: {} };
if (mojo.internal.bindings.blink.mojom.IDBDatabaseCallbacks_ForcedClose_ParamsSpec.$.structSpec && mojo.internal.bindings.blink.mojom.IDBDatabaseCallbacks_ForcedClose_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.blink.mojom.IDBDatabaseCallbacks_ForcedClose_ParamsSpec.$ = {};
mojo.internal.bindings.blink.mojom.IDBDatabaseCallbacks_VersionChange_ParamsSpec = mojo.internal.bindings.blink.mojom.IDBDatabaseCallbacks_VersionChange_ParamsSpec || { $: {} };
if (mojo.internal.bindings.blink.mojom.IDBDatabaseCallbacks_VersionChange_ParamsSpec.$.structSpec && mojo.internal.bindings.blink.mojom.IDBDatabaseCallbacks_VersionChange_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.blink.mojom.IDBDatabaseCallbacks_VersionChange_ParamsSpec.$ = {};
mojo.internal.bindings.blink.mojom.IDBDatabaseCallbacks_Abort_ParamsSpec = mojo.internal.bindings.blink.mojom.IDBDatabaseCallbacks_Abort_ParamsSpec || { $: {} };
if (mojo.internal.bindings.blink.mojom.IDBDatabaseCallbacks_Abort_ParamsSpec.$.structSpec && mojo.internal.bindings.blink.mojom.IDBDatabaseCallbacks_Abort_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.blink.mojom.IDBDatabaseCallbacks_Abort_ParamsSpec.$ = {};
mojo.internal.bindings.blink.mojom.IDBDatabaseCallbacks_Complete_ParamsSpec = mojo.internal.bindings.blink.mojom.IDBDatabaseCallbacks_Complete_ParamsSpec || { $: {} };
if (mojo.internal.bindings.blink.mojom.IDBDatabaseCallbacks_Complete_ParamsSpec.$.structSpec && mojo.internal.bindings.blink.mojom.IDBDatabaseCallbacks_Complete_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.blink.mojom.IDBDatabaseCallbacks_Complete_ParamsSpec.$ = {};
mojo.internal.bindings.blink.mojom.IDBCursor = mojo.internal.bindings.blink.mojom.IDBCursor || {};
mojo.internal.bindings.blink.mojom.IDBCursorSpec = mojo.internal.bindings.blink.mojom.IDBCursorSpec || { $ : {} };
if (mojo.internal.bindings.blink.mojom.IDBCursorSpec.$.structSpec && mojo.internal.bindings.blink.mojom.IDBCursorSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.blink.mojom.IDBCursorSpec.$ = {};
mojo.internal.bindings.blink.mojom.IDBCursor.$interfaceName = 'blink.mojom.IDBCursor';
mojo.internal.bindings.blink.mojom.IDBCursor_Advance_ParamsSpec = mojo.internal.bindings.blink.mojom.IDBCursor_Advance_ParamsSpec || { $: {} };
if (mojo.internal.bindings.blink.mojom.IDBCursor_Advance_ParamsSpec.$.structSpec && mojo.internal.bindings.blink.mojom.IDBCursor_Advance_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.blink.mojom.IDBCursor_Advance_ParamsSpec.$ = {};
mojo.internal.bindings.blink.mojom.IDBCursor_Advance_ResponseParamsSpec = mojo.internal.bindings.blink.mojom.IDBCursor_Advance_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.blink.mojom.IDBCursor_Advance_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.blink.mojom.IDBCursor_Advance_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.blink.mojom.IDBCursor_Advance_ResponseParamsSpec.$ = {};
mojo.internal.bindings.blink.mojom.IDBCursor_Continue_ParamsSpec = mojo.internal.bindings.blink.mojom.IDBCursor_Continue_ParamsSpec || { $: {} };
if (mojo.internal.bindings.blink.mojom.IDBCursor_Continue_ParamsSpec.$.structSpec && mojo.internal.bindings.blink.mojom.IDBCursor_Continue_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.blink.mojom.IDBCursor_Continue_ParamsSpec.$ = {};
mojo.internal.bindings.blink.mojom.IDBCursor_Continue_ResponseParamsSpec = mojo.internal.bindings.blink.mojom.IDBCursor_Continue_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.blink.mojom.IDBCursor_Continue_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.blink.mojom.IDBCursor_Continue_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.blink.mojom.IDBCursor_Continue_ResponseParamsSpec.$ = {};
mojo.internal.bindings.blink.mojom.IDBCursor_Prefetch_ParamsSpec = mojo.internal.bindings.blink.mojom.IDBCursor_Prefetch_ParamsSpec || { $: {} };
if (mojo.internal.bindings.blink.mojom.IDBCursor_Prefetch_ParamsSpec.$.structSpec && mojo.internal.bindings.blink.mojom.IDBCursor_Prefetch_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.blink.mojom.IDBCursor_Prefetch_ParamsSpec.$ = {};
mojo.internal.bindings.blink.mojom.IDBCursor_Prefetch_ResponseParamsSpec = mojo.internal.bindings.blink.mojom.IDBCursor_Prefetch_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.blink.mojom.IDBCursor_Prefetch_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.blink.mojom.IDBCursor_Prefetch_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.blink.mojom.IDBCursor_Prefetch_ResponseParamsSpec.$ = {};
mojo.internal.bindings.blink.mojom.IDBCursor_PrefetchReset_ParamsSpec = mojo.internal.bindings.blink.mojom.IDBCursor_PrefetchReset_ParamsSpec || { $: {} };
if (mojo.internal.bindings.blink.mojom.IDBCursor_PrefetchReset_ParamsSpec.$.structSpec && mojo.internal.bindings.blink.mojom.IDBCursor_PrefetchReset_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.blink.mojom.IDBCursor_PrefetchReset_ParamsSpec.$ = {};
mojo.internal.bindings.blink.mojom.IDBTransaction = mojo.internal.bindings.blink.mojom.IDBTransaction || {};
mojo.internal.bindings.blink.mojom.IDBTransactionSpec = mojo.internal.bindings.blink.mojom.IDBTransactionSpec || { $ : {} };
if (mojo.internal.bindings.blink.mojom.IDBTransactionSpec.$.structSpec && mojo.internal.bindings.blink.mojom.IDBTransactionSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.blink.mojom.IDBTransactionSpec.$ = {};
mojo.internal.bindings.blink.mojom.IDBTransaction.$interfaceName = 'blink.mojom.IDBTransaction';
mojo.internal.bindings.blink.mojom.IDBTransaction_CreateObjectStore_ParamsSpec = mojo.internal.bindings.blink.mojom.IDBTransaction_CreateObjectStore_ParamsSpec || { $: {} };
if (mojo.internal.bindings.blink.mojom.IDBTransaction_CreateObjectStore_ParamsSpec.$.structSpec && mojo.internal.bindings.blink.mojom.IDBTransaction_CreateObjectStore_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.blink.mojom.IDBTransaction_CreateObjectStore_ParamsSpec.$ = {};
mojo.internal.bindings.blink.mojom.IDBTransaction_DeleteObjectStore_ParamsSpec = mojo.internal.bindings.blink.mojom.IDBTransaction_DeleteObjectStore_ParamsSpec || { $: {} };
if (mojo.internal.bindings.blink.mojom.IDBTransaction_DeleteObjectStore_ParamsSpec.$.structSpec && mojo.internal.bindings.blink.mojom.IDBTransaction_DeleteObjectStore_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.blink.mojom.IDBTransaction_DeleteObjectStore_ParamsSpec.$ = {};
mojo.internal.bindings.blink.mojom.IDBTransaction_Put_ParamsSpec = mojo.internal.bindings.blink.mojom.IDBTransaction_Put_ParamsSpec || { $: {} };
if (mojo.internal.bindings.blink.mojom.IDBTransaction_Put_ParamsSpec.$.structSpec && mojo.internal.bindings.blink.mojom.IDBTransaction_Put_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.blink.mojom.IDBTransaction_Put_ParamsSpec.$ = {};
mojo.internal.bindings.blink.mojom.IDBTransaction_Put_ResponseParamsSpec = mojo.internal.bindings.blink.mojom.IDBTransaction_Put_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.blink.mojom.IDBTransaction_Put_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.blink.mojom.IDBTransaction_Put_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.blink.mojom.IDBTransaction_Put_ResponseParamsSpec.$ = {};
mojo.internal.bindings.blink.mojom.IDBTransaction_SetIndexKeys_ParamsSpec = mojo.internal.bindings.blink.mojom.IDBTransaction_SetIndexKeys_ParamsSpec || { $: {} };
if (mojo.internal.bindings.blink.mojom.IDBTransaction_SetIndexKeys_ParamsSpec.$.structSpec && mojo.internal.bindings.blink.mojom.IDBTransaction_SetIndexKeys_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.blink.mojom.IDBTransaction_SetIndexKeys_ParamsSpec.$ = {};
mojo.internal.bindings.blink.mojom.IDBTransaction_SetIndexKeysDone_ParamsSpec = mojo.internal.bindings.blink.mojom.IDBTransaction_SetIndexKeysDone_ParamsSpec || { $: {} };
if (mojo.internal.bindings.blink.mojom.IDBTransaction_SetIndexKeysDone_ParamsSpec.$.structSpec && mojo.internal.bindings.blink.mojom.IDBTransaction_SetIndexKeysDone_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.blink.mojom.IDBTransaction_SetIndexKeysDone_ParamsSpec.$ = {};
mojo.internal.bindings.blink.mojom.IDBTransaction_Commit_ParamsSpec = mojo.internal.bindings.blink.mojom.IDBTransaction_Commit_ParamsSpec || { $: {} };
if (mojo.internal.bindings.blink.mojom.IDBTransaction_Commit_ParamsSpec.$.structSpec && mojo.internal.bindings.blink.mojom.IDBTransaction_Commit_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.blink.mojom.IDBTransaction_Commit_ParamsSpec.$ = {};
mojo.internal.bindings.blink.mojom.IDBDatabaseGetAllResultSink = mojo.internal.bindings.blink.mojom.IDBDatabaseGetAllResultSink || {};
mojo.internal.bindings.blink.mojom.IDBDatabaseGetAllResultSinkSpec = mojo.internal.bindings.blink.mojom.IDBDatabaseGetAllResultSinkSpec || { $ : {} };
if (mojo.internal.bindings.blink.mojom.IDBDatabaseGetAllResultSinkSpec.$.structSpec && mojo.internal.bindings.blink.mojom.IDBDatabaseGetAllResultSinkSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.blink.mojom.IDBDatabaseGetAllResultSinkSpec.$ = {};
mojo.internal.bindings.blink.mojom.IDBDatabaseGetAllResultSink.$interfaceName = 'blink.mojom.IDBDatabaseGetAllResultSink';
mojo.internal.bindings.blink.mojom.IDBDatabaseGetAllResultSink_ReceiveResults_ParamsSpec = mojo.internal.bindings.blink.mojom.IDBDatabaseGetAllResultSink_ReceiveResults_ParamsSpec || { $: {} };
if (mojo.internal.bindings.blink.mojom.IDBDatabaseGetAllResultSink_ReceiveResults_ParamsSpec.$.structSpec && mojo.internal.bindings.blink.mojom.IDBDatabaseGetAllResultSink_ReceiveResults_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.blink.mojom.IDBDatabaseGetAllResultSink_ReceiveResults_ParamsSpec.$ = {};
mojo.internal.bindings.blink.mojom.IDBDatabaseGetAllResultSink_OnError_ParamsSpec = mojo.internal.bindings.blink.mojom.IDBDatabaseGetAllResultSink_OnError_ParamsSpec || { $: {} };
if (mojo.internal.bindings.blink.mojom.IDBDatabaseGetAllResultSink_OnError_ParamsSpec.$.structSpec && mojo.internal.bindings.blink.mojom.IDBDatabaseGetAllResultSink_OnError_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.blink.mojom.IDBDatabaseGetAllResultSink_OnError_ParamsSpec.$ = {};
mojo.internal.bindings.blink.mojom.IDBDatabase = mojo.internal.bindings.blink.mojom.IDBDatabase || {};
mojo.internal.bindings.blink.mojom.IDBDatabaseSpec = mojo.internal.bindings.blink.mojom.IDBDatabaseSpec || { $ : {} };
if (mojo.internal.bindings.blink.mojom.IDBDatabaseSpec.$.structSpec && mojo.internal.bindings.blink.mojom.IDBDatabaseSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.blink.mojom.IDBDatabaseSpec.$ = {};
mojo.internal.bindings.blink.mojom.IDBDatabase.$interfaceName = 'blink.mojom.IDBDatabase';
mojo.internal.bindings.blink.mojom.IDBDatabase_RenameObjectStore_ParamsSpec = mojo.internal.bindings.blink.mojom.IDBDatabase_RenameObjectStore_ParamsSpec || { $: {} };
if (mojo.internal.bindings.blink.mojom.IDBDatabase_RenameObjectStore_ParamsSpec.$.structSpec && mojo.internal.bindings.blink.mojom.IDBDatabase_RenameObjectStore_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.blink.mojom.IDBDatabase_RenameObjectStore_ParamsSpec.$ = {};
mojo.internal.bindings.blink.mojom.IDBDatabase_CreateTransaction_ParamsSpec = mojo.internal.bindings.blink.mojom.IDBDatabase_CreateTransaction_ParamsSpec || { $: {} };
if (mojo.internal.bindings.blink.mojom.IDBDatabase_CreateTransaction_ParamsSpec.$.structSpec && mojo.internal.bindings.blink.mojom.IDBDatabase_CreateTransaction_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.blink.mojom.IDBDatabase_CreateTransaction_ParamsSpec.$ = {};
mojo.internal.bindings.blink.mojom.IDBDatabase_VersionChangeIgnored_ParamsSpec = mojo.internal.bindings.blink.mojom.IDBDatabase_VersionChangeIgnored_ParamsSpec || { $: {} };
if (mojo.internal.bindings.blink.mojom.IDBDatabase_VersionChangeIgnored_ParamsSpec.$.structSpec && mojo.internal.bindings.blink.mojom.IDBDatabase_VersionChangeIgnored_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.blink.mojom.IDBDatabase_VersionChangeIgnored_ParamsSpec.$ = {};
mojo.internal.bindings.blink.mojom.IDBDatabase_Get_ParamsSpec = mojo.internal.bindings.blink.mojom.IDBDatabase_Get_ParamsSpec || { $: {} };
if (mojo.internal.bindings.blink.mojom.IDBDatabase_Get_ParamsSpec.$.structSpec && mojo.internal.bindings.blink.mojom.IDBDatabase_Get_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.blink.mojom.IDBDatabase_Get_ParamsSpec.$ = {};
mojo.internal.bindings.blink.mojom.IDBDatabase_Get_ResponseParamsSpec = mojo.internal.bindings.blink.mojom.IDBDatabase_Get_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.blink.mojom.IDBDatabase_Get_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.blink.mojom.IDBDatabase_Get_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.blink.mojom.IDBDatabase_Get_ResponseParamsSpec.$ = {};
mojo.internal.bindings.blink.mojom.IDBDatabase_GetAll_ParamsSpec = mojo.internal.bindings.blink.mojom.IDBDatabase_GetAll_ParamsSpec || { $: {} };
if (mojo.internal.bindings.blink.mojom.IDBDatabase_GetAll_ParamsSpec.$.structSpec && mojo.internal.bindings.blink.mojom.IDBDatabase_GetAll_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.blink.mojom.IDBDatabase_GetAll_ParamsSpec.$ = {};
mojo.internal.bindings.blink.mojom.IDBDatabase_GetAll_ResponseParamsSpec = mojo.internal.bindings.blink.mojom.IDBDatabase_GetAll_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.blink.mojom.IDBDatabase_GetAll_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.blink.mojom.IDBDatabase_GetAll_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.blink.mojom.IDBDatabase_GetAll_ResponseParamsSpec.$ = {};
mojo.internal.bindings.blink.mojom.IDBDatabase_OpenCursor_ParamsSpec = mojo.internal.bindings.blink.mojom.IDBDatabase_OpenCursor_ParamsSpec || { $: {} };
if (mojo.internal.bindings.blink.mojom.IDBDatabase_OpenCursor_ParamsSpec.$.structSpec && mojo.internal.bindings.blink.mojom.IDBDatabase_OpenCursor_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.blink.mojom.IDBDatabase_OpenCursor_ParamsSpec.$ = {};
mojo.internal.bindings.blink.mojom.IDBDatabase_OpenCursor_ResponseParamsSpec = mojo.internal.bindings.blink.mojom.IDBDatabase_OpenCursor_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.blink.mojom.IDBDatabase_OpenCursor_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.blink.mojom.IDBDatabase_OpenCursor_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.blink.mojom.IDBDatabase_OpenCursor_ResponseParamsSpec.$ = {};
mojo.internal.bindings.blink.mojom.IDBDatabase_Count_ParamsSpec = mojo.internal.bindings.blink.mojom.IDBDatabase_Count_ParamsSpec || { $: {} };
if (mojo.internal.bindings.blink.mojom.IDBDatabase_Count_ParamsSpec.$.structSpec && mojo.internal.bindings.blink.mojom.IDBDatabase_Count_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.blink.mojom.IDBDatabase_Count_ParamsSpec.$ = {};
mojo.internal.bindings.blink.mojom.IDBDatabase_Count_ResponseParamsSpec = mojo.internal.bindings.blink.mojom.IDBDatabase_Count_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.blink.mojom.IDBDatabase_Count_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.blink.mojom.IDBDatabase_Count_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.blink.mojom.IDBDatabase_Count_ResponseParamsSpec.$ = {};
mojo.internal.bindings.blink.mojom.IDBDatabase_DeleteRange_ParamsSpec = mojo.internal.bindings.blink.mojom.IDBDatabase_DeleteRange_ParamsSpec || { $: {} };
if (mojo.internal.bindings.blink.mojom.IDBDatabase_DeleteRange_ParamsSpec.$.structSpec && mojo.internal.bindings.blink.mojom.IDBDatabase_DeleteRange_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.blink.mojom.IDBDatabase_DeleteRange_ParamsSpec.$ = {};
mojo.internal.bindings.blink.mojom.IDBDatabase_DeleteRange_ResponseParamsSpec = mojo.internal.bindings.blink.mojom.IDBDatabase_DeleteRange_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.blink.mojom.IDBDatabase_DeleteRange_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.blink.mojom.IDBDatabase_DeleteRange_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.blink.mojom.IDBDatabase_DeleteRange_ResponseParamsSpec.$ = {};
mojo.internal.bindings.blink.mojom.IDBDatabase_GetKeyGeneratorCurrentNumber_ParamsSpec = mojo.internal.bindings.blink.mojom.IDBDatabase_GetKeyGeneratorCurrentNumber_ParamsSpec || { $: {} };
if (mojo.internal.bindings.blink.mojom.IDBDatabase_GetKeyGeneratorCurrentNumber_ParamsSpec.$.structSpec && mojo.internal.bindings.blink.mojom.IDBDatabase_GetKeyGeneratorCurrentNumber_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.blink.mojom.IDBDatabase_GetKeyGeneratorCurrentNumber_ParamsSpec.$ = {};
mojo.internal.bindings.blink.mojom.IDBDatabase_GetKeyGeneratorCurrentNumber_ResponseParamsSpec = mojo.internal.bindings.blink.mojom.IDBDatabase_GetKeyGeneratorCurrentNumber_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.blink.mojom.IDBDatabase_GetKeyGeneratorCurrentNumber_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.blink.mojom.IDBDatabase_GetKeyGeneratorCurrentNumber_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.blink.mojom.IDBDatabase_GetKeyGeneratorCurrentNumber_ResponseParamsSpec.$ = {};
mojo.internal.bindings.blink.mojom.IDBDatabase_Clear_ParamsSpec = mojo.internal.bindings.blink.mojom.IDBDatabase_Clear_ParamsSpec || { $: {} };
if (mojo.internal.bindings.blink.mojom.IDBDatabase_Clear_ParamsSpec.$.structSpec && mojo.internal.bindings.blink.mojom.IDBDatabase_Clear_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.blink.mojom.IDBDatabase_Clear_ParamsSpec.$ = {};
mojo.internal.bindings.blink.mojom.IDBDatabase_Clear_ResponseParamsSpec = mojo.internal.bindings.blink.mojom.IDBDatabase_Clear_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.blink.mojom.IDBDatabase_Clear_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.blink.mojom.IDBDatabase_Clear_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.blink.mojom.IDBDatabase_Clear_ResponseParamsSpec.$ = {};
mojo.internal.bindings.blink.mojom.IDBDatabase_CreateIndex_ParamsSpec = mojo.internal.bindings.blink.mojom.IDBDatabase_CreateIndex_ParamsSpec || { $: {} };
if (mojo.internal.bindings.blink.mojom.IDBDatabase_CreateIndex_ParamsSpec.$.structSpec && mojo.internal.bindings.blink.mojom.IDBDatabase_CreateIndex_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.blink.mojom.IDBDatabase_CreateIndex_ParamsSpec.$ = {};
mojo.internal.bindings.blink.mojom.IDBDatabase_DeleteIndex_ParamsSpec = mojo.internal.bindings.blink.mojom.IDBDatabase_DeleteIndex_ParamsSpec || { $: {} };
if (mojo.internal.bindings.blink.mojom.IDBDatabase_DeleteIndex_ParamsSpec.$.structSpec && mojo.internal.bindings.blink.mojom.IDBDatabase_DeleteIndex_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.blink.mojom.IDBDatabase_DeleteIndex_ParamsSpec.$ = {};
mojo.internal.bindings.blink.mojom.IDBDatabase_RenameIndex_ParamsSpec = mojo.internal.bindings.blink.mojom.IDBDatabase_RenameIndex_ParamsSpec || { $: {} };
if (mojo.internal.bindings.blink.mojom.IDBDatabase_RenameIndex_ParamsSpec.$.structSpec && mojo.internal.bindings.blink.mojom.IDBDatabase_RenameIndex_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.blink.mojom.IDBDatabase_RenameIndex_ParamsSpec.$ = {};
mojo.internal.bindings.blink.mojom.IDBDatabase_Abort_ParamsSpec = mojo.internal.bindings.blink.mojom.IDBDatabase_Abort_ParamsSpec || { $: {} };
if (mojo.internal.bindings.blink.mojom.IDBDatabase_Abort_ParamsSpec.$.structSpec && mojo.internal.bindings.blink.mojom.IDBDatabase_Abort_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.blink.mojom.IDBDatabase_Abort_ParamsSpec.$ = {};
mojo.internal.bindings.blink.mojom.IDBDatabase_DidBecomeInactive_ParamsSpec = mojo.internal.bindings.blink.mojom.IDBDatabase_DidBecomeInactive_ParamsSpec || { $: {} };
if (mojo.internal.bindings.blink.mojom.IDBDatabase_DidBecomeInactive_ParamsSpec.$.structSpec && mojo.internal.bindings.blink.mojom.IDBDatabase_DidBecomeInactive_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.blink.mojom.IDBDatabase_DidBecomeInactive_ParamsSpec.$ = {};
mojo.internal.bindings.blink.mojom.IDBDatabase_UpdatePriority_ParamsSpec = mojo.internal.bindings.blink.mojom.IDBDatabase_UpdatePriority_ParamsSpec || { $: {} };
if (mojo.internal.bindings.blink.mojom.IDBDatabase_UpdatePriority_ParamsSpec.$.structSpec && mojo.internal.bindings.blink.mojom.IDBDatabase_UpdatePriority_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.blink.mojom.IDBDatabase_UpdatePriority_ParamsSpec.$ = {};
mojo.internal.bindings.blink.mojom.IDBFactory = mojo.internal.bindings.blink.mojom.IDBFactory || {};
mojo.internal.bindings.blink.mojom.IDBFactorySpec = mojo.internal.bindings.blink.mojom.IDBFactorySpec || { $ : {} };
if (mojo.internal.bindings.blink.mojom.IDBFactorySpec.$.structSpec && mojo.internal.bindings.blink.mojom.IDBFactorySpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.blink.mojom.IDBFactorySpec.$ = {};
mojo.internal.bindings.blink.mojom.IDBFactory.$interfaceName = 'blink.mojom.IDBFactory';
mojo.internal.bindings.blink.mojom.IDBFactory_GetDatabaseInfo_ParamsSpec = mojo.internal.bindings.blink.mojom.IDBFactory_GetDatabaseInfo_ParamsSpec || { $: {} };
if (mojo.internal.bindings.blink.mojom.IDBFactory_GetDatabaseInfo_ParamsSpec.$.structSpec && mojo.internal.bindings.blink.mojom.IDBFactory_GetDatabaseInfo_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.blink.mojom.IDBFactory_GetDatabaseInfo_ParamsSpec.$ = {};
mojo.internal.bindings.blink.mojom.IDBFactory_GetDatabaseInfo_ResponseParamsSpec = mojo.internal.bindings.blink.mojom.IDBFactory_GetDatabaseInfo_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.blink.mojom.IDBFactory_GetDatabaseInfo_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.blink.mojom.IDBFactory_GetDatabaseInfo_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.blink.mojom.IDBFactory_GetDatabaseInfo_ResponseParamsSpec.$ = {};
mojo.internal.bindings.blink.mojom.IDBFactory_Open_ParamsSpec = mojo.internal.bindings.blink.mojom.IDBFactory_Open_ParamsSpec || { $: {} };
if (mojo.internal.bindings.blink.mojom.IDBFactory_Open_ParamsSpec.$.structSpec && mojo.internal.bindings.blink.mojom.IDBFactory_Open_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.blink.mojom.IDBFactory_Open_ParamsSpec.$ = {};
mojo.internal.bindings.blink.mojom.IDBFactory_DeleteDatabase_ParamsSpec = mojo.internal.bindings.blink.mojom.IDBFactory_DeleteDatabase_ParamsSpec || { $: {} };
if (mojo.internal.bindings.blink.mojom.IDBFactory_DeleteDatabase_ParamsSpec.$.structSpec && mojo.internal.bindings.blink.mojom.IDBFactory_DeleteDatabase_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.blink.mojom.IDBFactory_DeleteDatabase_ParamsSpec.$ = {};
...
mojo.internal.bindings.blink = mojo.internal.bindings.blink || {};
mojo.internal.bindings.blink.mojom = mojo.internal.bindings.blink.mojom || {};
mojo.internal.bindings.blink.mojom.IDBCursorResultSpec = mojo.internal.bindings.blink.mojom.IDBCursorResultSpec || { $: mojo.internal.OpaqueStruct.$ };
mojo.internal.bindings.blink = mojo.internal.bindings.blink || {};
mojo.internal.bindings.blink.mojom = mojo.internal.bindings.blink.mojom || {};
mojo.internal.bindings.blink.mojom.IDBDatabaseGetResultSpec = mojo.internal.bindings.blink.mojom.IDBDatabaseGetResultSpec || { $: mojo.internal.OpaqueStruct.$ };
mojo.internal.bindings.blink = mojo.internal.bindings.blink || {};
mojo.internal.bindings.blink.mojom = mojo.internal.bindings.blink.mojom || {};
mojo.internal.bindings.blink.mojom.IDBDatabaseOpenCursorResultSpec = mojo.internal.bindings.blink.mojom.IDBDatabaseOpenCursorResultSpec || { $: mojo.internal.OpaqueStruct.$ };
mojo.internal.bindings.blink = mojo.internal.bindings.blink || {};
mojo.internal.bindings.blink.mojom = mojo.internal.bindings.blink.mojom || {};
mojo.internal.bindings.blink.mojom.IDBExternalObjectSpec = mojo.internal.bindings.blink.mojom.IDBExternalObjectSpec || { $: mojo.internal.OpaqueStruct.$ };
mojo.internal.bindings.blink = mojo.internal.bindings.blink || {};
mojo.internal.bindings.blink.mojom = mojo.internal.bindings.blink.mojom || {};
mojo.internal.bindings.blink.mojom.IDBKeySpec = mojo.internal.bindings.blink.mojom.IDBKeySpec || { $: mojo.internal.OpaqueStruct.$ };
mojo.internal.bindings.blink = mojo.internal.bindings.blink || {};
mojo.internal.bindings.blink.mojom = mojo.internal.bindings.blink.mojom || {};
mojo.internal.bindings.blink.mojom.IDBKeyPathDataSpec = mojo.internal.bindings.blink.mojom.IDBKeyPathDataSpec || { $: mojo.internal.OpaqueStruct.$ };
mojo.internal.bindings.blink = mojo.internal.bindings.blink || {};
mojo.internal.bindings.blink.mojom = mojo.internal.bindings.blink.mojom || {};
mojo.internal.bindings.blink.mojom.IDBTransactionPutResultSpec = mojo.internal.bindings.blink.mojom.IDBTransactionPutResultSpec || { $: mojo.internal.OpaqueStruct.$ };
mojo.internal.bindings.mojo_base = mojo.internal.bindings.mojo_base || {};
mojo.internal.bindings.mojo_base.mojom = mojo.internal.bindings.mojo_base.mojom || {};
...
mojo.internal.Union(
    mojo.internal.bindings.blink.mojom.IDBExternalObjectSpec, 'blink.mojom.IDBExternalObject', {
      'arg_blob_or_file': {
        'ordinal': 0,
        'type': mojo.internal.bindings.blink.mojom.IDBBlobInfoSpec,
        'nullable': false,
      },
...
mojo.internal.Union(
    mojo.internal.bindings.blink.mojom.IDBCursorResultSpec, 'blink.mojom.IDBCursorResult', {
      'arg_error_result': {
        'ordinal': 0,
        'type': mojo.internal.bindings.blink.mojom.IDBErrorSpec,
        'nullable': false,
      },
      'arg_empty': {
        'ordinal': 1,
      ...
      'arg_values': {
        'ordinal': 2,
        'type': mojo.internal.bindings.blink.mojom.IDBCursorValueSpec,
        'nullable': false,
      },
    });
...
mojo.internal.Union(
    mojo.internal.bindings.blink.mojom.IDBDatabaseGetResultSpec, 'blink.mojom.IDBDatabaseGetResult', {
      ...
      'arg_value': {
        'ordinal': 3,
        'type': mojo.internal.bindings.blink.mojom.IDBReturnValueSpec,
        'nullable': false,
      },
    });
...
mojo.internal.Union(
    mojo.internal.bindings.blink.mojom.IDBDatabaseOpenCursorResultSpec, 'blink.mojom.IDBDatabaseOpenCursorResult', {
      ...
      'arg_value': {
        'ordinal': 2,
        'type': mojo.internal.bindings.blink.mojom.IDBDatabaseOpenCursorValueSpec,
        'nullable': false,
      },
    });
...
mojo.internal.Struct(
    mojo.internal.bindings.blink.mojom.IDBKeyRangeSpec, 'blink.mojom.IDBKeyRange', [
      ...
      mojo.internal.StructField('arg_upper', 16, 0, mojo.internal.bindings.blink.mojom.IDBKeySpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_lower_open', 32, 0, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_upper_open', 32, 1, mojo.internal.Bool, false, false, 0, undefined),
    ],
    [[0, 48]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.blink.mojom.IDBIndexMetadataSpec, 'blink.mojom.IDBIndexMetadata', [
      ...
      mojo.internal.StructField('arg_key_path', 16, 0, mojo.internal.bindings.blink.mojom.IDBKeyPathSpec, null, false, 0, undefined),
...
mojo.internal.Struct(
    mojo.internal.bindings.blink.mojom.IDBObjectStoreMetadataSpec, 'blink.mojom.IDBObjectStoreMetadata', [
      ...
      mojo.internal.StructField('arg_max_index_id', 32, 0, mojo.internal.Int64, 0, false, 0, undefined),
      mojo.internal.StructField('arg_indexes', 40, 0, mojo.internal.Map(mojo.internal.Int64, mojo.internal.bindings.blink.mojom.IDBIndexMetadataSpec, false), null, false, 0, undefined),
    ],
    [[0, 56]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.blink.mojom.IDBBlobInfoSpec, 'blink.mojom.IDBBlobInfo', [
      ...
      mojo.internal.StructField('arg_file', 24, 0, mojo.internal.bindings.blink.mojom.IDBFileInfoSpec, null, true, 0, undefined),
    ],
    [[0, 40]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.blink.mojom.IDBValueSpec, 'blink.mojom.IDBValue', [
      ...
      mojo.internal.StructField('arg_external_objects', 16, 0, mojo.internal.Array(mojo.internal.bindings.blink.mojom.IDBExternalObjectSpec, false), null, false, 0, undefined),
    ],
    [[0, 32]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.blink.mojom.IDBReturnValueSpec, 'blink.mojom.IDBReturnValue', [
      mojo.internal.StructField('arg_value', 0, 0, mojo.internal.bindings.blink.mojom.IDBValueSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_primary_key', 8, 0, mojo.internal.bindings.blink.mojom.IDBKeySpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_key_path', 24, 0, mojo.internal.bindings.blink.mojom.IDBKeyPathSpec, null, false, 0, undefined),
    ],
    [[0, 40]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.blink.mojom.IDBRecordSpec, 'blink.mojom.IDBRecord', [
      ...
      mojo.internal.StructField('arg_return_value', 16, 0, mojo.internal.bindings.blink.mojom.IDBReturnValueSpec, null, true, 0, undefined),
      mojo.internal.StructField('arg_index_key', 24, 0, mojo.internal.bindings.blink.mojom.IDBKeySpec, null, true, 0, undefined),
    ],
    [[0, 48]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.blink.mojom.IDBErrorSpec, 'blink.mojom.IDBError', [
      mojo.internal.StructField('arg_error_code', 0, 0, mojo.internal.bindings.blink.mojom.IDBExceptionSpec, null, false, 0, undefined),
...
mojo.internal.Struct(
    mojo.internal.bindings.blink.mojom.IDBCursorValueSpec, 'blink.mojom.IDBCursorValue', [
      ...
      mojo.internal.StructField('arg_values', 16, 0, mojo.internal.Array(mojo.internal.bindings.blink.mojom.IDBValueSpec, false), null, false, 0, undefined),
    ],
    [[0, 32]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.blink.mojom.IDBDatabaseOpenCursorValueSpec, 'blink.mojom.IDBDatabaseOpenCursorValue', [
      ...
      mojo.internal.StructField('arg_primary_key', 24, 0, mojo.internal.bindings.blink.mojom.IDBKeySpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_value', 40, 0, mojo.internal.bindings.blink.mojom.IDBValueSpec, null, true, 0, undefined),
    ],
    [[0, 56]]);
mojo.internal.Struct(
    mojo.internal.bindings.blink.mojom.IDBFactoryClient_Error_ParamsSpec, 'blink.mojom.IDBFactoryClient_Error_Params', [
      mojo.internal.StructField('arg_code', 0, 0, mojo.internal.bindings.blink.mojom.IDBExceptionSpec, null, false, 0, undefined),
...
mojo.internal.Struct(
    mojo.internal.bindings.blink.mojom.IDBFactoryClient_UpgradeNeeded_ParamsSpec, 'blink.mojom.IDBFactoryClient_UpgradeNeeded_Params', [
      ...
      mojo.internal.StructField('arg_db_metadata', 32, 0, mojo.internal.bindings.blink.mojom.IDBDatabaseMetadataSpec, null, false, 0, undefined),
    ],
    [[0, 48]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.blink.mojom.IDBDatabaseCallbacks_Abort_ParamsSpec, 'blink.mojom.IDBDatabaseCallbacks_Abort_Params', [
      ...
      mojo.internal.StructField('arg_code', 8, 0, mojo.internal.bindings.blink.mojom.IDBExceptionSpec, null, false, 0, undefined),
...
mojo.internal.Struct(
    mojo.internal.bindings.blink.mojom.IDBTransaction_Put_ParamsSpec, 'blink.mojom.IDBTransaction_Put_Params', [
      mojo.internal.StructField('arg_object_store_id', 0, 0, mojo.internal.Int64, 0, false, 0, undefined),
      mojo.internal.StructField('arg_value', 8, 0, mojo.internal.bindings.blink.mojom.IDBValueSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_key', 16, 0, mojo.internal.bindings.blink.mojom.IDBKeySpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_mode', 32, 0, mojo.internal.bindings.blink.mojom.IDBPutModeSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_index_keys', 40, 0, mojo.internal.Array(mojo.internal.bindings.blink.mojom.IDBIndexKeysSpec, false), null, false, 0, undefined),
    ],
    [[0, 56]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.blink.mojom.IDBTransaction_SetIndexKeys_ParamsSpec, 'blink.mojom.IDBTransaction_SetIndexKeys_Params', [
      mojo.internal.StructField('arg_object_store_id', 0, 0, mojo.internal.Int64, 0, false, 0, undefined),
      mojo.internal.StructField('arg_primary_key', 8, 0, mojo.internal.bindings.blink.mojom.IDBKeySpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_index_keys', 24, 0, mojo.internal.bindings.blink.mojom.IDBIndexKeysSpec, null, false, 0, undefined),
    ],
    [[0, 40]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.blink.mojom.IDBDatabaseGetAllResultSink_ReceiveResults_ParamsSpec, 'blink.mojom.IDBDatabaseGetAllResultSink_ReceiveResults_Params', [
      mojo.internal.StructField('arg_records', 0, 0, mojo.internal.Array(mojo.internal.bindings.blink.mojom.IDBRecordSpec, false), null, false, 0, undefined),
...
mojo.internal.Struct(
    mojo.internal.bindings.blink.mojom.IDBDatabaseGetAllResultSink_OnError_ParamsSpec, 'blink.mojom.IDBDatabaseGetAllResultSink_OnError_Params', [
      mojo.internal.StructField('arg_error', 0, 0, mojo.internal.bindings.blink.mojom.IDBErrorSpec, null, false, 0, undefined),
    ],
    [[0, 16]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.blink.mojom.IDBDatabase_CreateTransaction_ParamsSpec, 'blink.mojom.IDBDatabase_CreateTransaction_Params', [
      ...
      mojo.internal.StructField('arg_durability', 24, 0, mojo.internal.bindings.blink.mojom.IDBTransactionDurabilitySpec, null, false, 0, undefined),
    ],
    [[0, 40]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.blink.mojom.IDBDatabase_Get_ParamsSpec, 'blink.mojom.IDBDatabase_Get_Params', [
      ...
      mojo.internal.StructField('arg_key_range', 24, 0, mojo.internal.bindings.blink.mojom.IDBKeyRangeSpec, null, false, 0, undefined),
...
mojo.internal.Struct(
    mojo.internal.bindings.blink.mojom.IDBDatabase_GetAll_ParamsSpec, 'blink.mojom.IDBDatabase_GetAll_Params', [
      ...
      mojo.internal.StructField('arg_index_id', 16, 0, mojo.internal.Int64, 0, false, 0, undefined),
      mojo.internal.StructField('arg_key_range', 24, 0, mojo.internal.bindings.blink.mojom.IDBKeyRangeSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_result_type', 32, 0, mojo.internal.bindings.blink.mojom.IDBGetAllResultTypeSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_max_count', 36, 0, mojo.internal.Uint32, 0, false, 0, undefined),
      mojo.internal.StructField('arg_direction', 40, 0, mojo.internal.bindings.blink.mojom.IDBCursorDirectionSpec, null, false, 0, undefined),
    ],
    [[0, 56]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.blink.mojom.IDBDatabase_GetAll_ResponseParamsSpec, 'blink.mojom.IDBDatabase_GetAll_ResponseParams', [
      mojo.internal.StructField('arg_records', 0, 0, mojo.internal.Array(mojo.internal.bindings.blink.mojom.IDBRecordSpec, false), null, false, 0, undefined),
      mojo.internal.StructField('arg_receiver', 8, 0, mojo.internal.AssociatedInterfaceRequest(mojo.internal.bindings.blink.mojom.IDBDatabaseGetAllResultSinkPendingReceiver), null, true, 0, undefined),
    ],
    [[0, 24]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.blink.mojom.IDBDatabase_OpenCursor_ParamsSpec, 'blink.mojom.IDBDatabase_OpenCursor_Params', [
      ...
      mojo.internal.StructField('arg_index_id', 16, 0, mojo.internal.Int64, 0, false, 0, undefined),
      mojo.internal.StructField('arg_key_range', 24, 0, mojo.internal.bindings.blink.mojom.IDBKeyRangeSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_direction', 32, 0, mojo.internal.bindings.blink.mojom.IDBCursorDirectionSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_key_only', 36, 0, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_task_type', 40, 0, mojo.internal.bindings.blink.mojom.IDBTaskTypeSpec, null, false, 0, undefined),
    ],
    [[0, 56]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.blink.mojom.IDBDatabase_DeleteRange_ParamsSpec, 'blink.mojom.IDBDatabase_DeleteRange_Params', [
      mojo.internal.StructField('arg_transaction_id', 0, 0, mojo.internal.Int64, 0, false, 0, undefined),
      mojo.internal.StructField('arg_object_store_id', 8, 0, mojo.internal.Int64, 0, false, 0, undefined),
      mojo.internal.StructField('arg_key_range', 16, 0, mojo.internal.bindings.blink.mojom.IDBKeyRangeSpec, null, false, 0, undefined),
    ],
    [[0, 32]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.blink.mojom.IDBDatabase_GetKeyGeneratorCurrentNumber_ResponseParamsSpec, 'blink.mojom.IDBDatabase_GetKeyGeneratorCurrentNumber_ResponseParams', [
      ...
      mojo.internal.StructField('arg_error', 8, 0, mojo.internal.bindings.blink.mojom.IDBErrorSpec, null, true, 0, undefined),
    ],
    [[0, 24]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.blink.mojom.IDBDatabase_CreateIndex_ParamsSpec, 'blink.mojom.IDBDatabase_CreateIndex_Params', [
      mojo.internal.StructField('arg_transaction_id', 0, 0, mojo.internal.Int64, 0, false, 0, undefined),
      mojo.internal.StructField('arg_object_store_id', 8, 0, mojo.internal.Int64, 0, false, 0, undefined),
      mojo.internal.StructField('arg_index', 16, 0, mojo.internal.bindings.blink.mojom.IDBIndexMetadataSpec, null, false, 0, undefined),
    ],
    [[0, 32]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.blink.mojom.IDBFactory_GetDatabaseInfo_ResponseParamsSpec, 'blink.mojom.IDBFactory_GetDatabaseInfo_ResponseParams', [
      mojo.internal.StructField('arg_names_and_versions', 0, 0, mojo.internal.Array(mojo.internal.bindings.blink.mojom.IDBNameAndVersionSpec, false), null, false, 0, undefined),
      mojo.internal.StructField('arg_error', 8, 0, mojo.internal.bindings.blink.mojom.IDBErrorSpec, null, false, 0, undefined),
    ],
    [[0, 24]]);
