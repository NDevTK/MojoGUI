...
mojo.internal.Struct(
    mojo.internal.bindings.webnn.mojom.WebNNContext_CreateTensor_ResponseParamsSpec, 'webnn.mojom.WebNNContext_CreateTensor_ResponseParams', [
      mojo.internal.StructField('arg_result', 0, 0, mojo.internal.bindings.webnn.mojom.CreateTensorResultSpec, null, false, 0, undefined),
    ],
    [[0, 24]]);

mojo.internal.Struct(
    mojo.internal.bindings.webnn.mojom.WebNNContext_CreateTensorFromMailbox_ParamsSpec, 'webnn.mojom.WebNNContext_CreateTensorFromMailbox_Params', [
      ...
      mojo.internal.StructField('arg_fence', 16, 0, mojo.internal.bindings.gpu.mojom.SyncTokenSpec, null, false, 0, undefined),
    ],
    [[0, 32]]);

mojo.internal.Struct(
    mojo.internal.bindings.webnn.mojom.WebNNContext_CreateTensorFromMailbox_ResponseParamsSpec, 'webnn.mojom.WebNNContext_CreateTensorFromMailbox_ResponseParams', [
      mojo.internal.StructField('arg_result', 0, 0, mojo.internal.bindings.webnn.mojom.CreateTensorResultSpec, null, false, 0, undefined),
    ],
    [[0, 24]]);
...
mojo.internal.bindings.webnn.mojom.WebNNContextRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.webnn.mojom.WebNNContextPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.webnn.mojom.WebNNContextRemoteCallHandler(this.proxy);
  }
  ...
  createGraphBuilder(arg_receiver) {
    return this.$.createGraphBuilder(arg_receiver);
  }
  createTensor(arg_tensor_info, arg_tensor_data) {
    return this.$.createTensor(arg_tensor_info, arg_tensor_data);
  }
  createTensorFromMailbox(arg_tensor_info, arg_mailbox, arg_fence) {
    return this.$.createTensorFromMailbox(arg_tensor_info, arg_mailbox, arg_fence);
  }
};
...
mojo.internal.bindings.webnn.mojom.WebNNContext.getRemote = function() {
  let remote = new mojo.internal.bindings.webnn.mojom.WebNNContextRemote();
...
mojo.internal.bindings.webnn.mojom.WebNNContextReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.webnn.mojom.WebNNContext_CreateGraphBuilder_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for CreateGraphBuilder failed with TypeError');
           }
        }
        // Try Method 1: CreateTensor
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.webnn.mojom.WebNNContext_CreateTensor_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for CreateTensor failed with TypeError');
           }
        }
        // Try Method 2: CreateTensorFromMailbox
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.webnn.mojom.WebNNContext_CreateTensorFromMailbox_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for CreateTensorFromMailbox failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.webnn.mojom.WebNNContextReceiver = mojo.internal.bindings.webnn.mojom.WebNNContextReceiver;

mojo.internal.bindings.webnn.mojom.WebNNContextPtr = mojo.internal.bindings.webnn.mojom.WebNNContextRemote;
mojo.internal.bindings.webnn.mojom.WebNNContextRequest = mojo.internal.bindings.webnn.mojom.WebNNContextPendingReceiver;
