...
mojo.internal.bindings.blink.mojom.CookieStoreRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.blink.mojom.CookieStorePendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.blink.mojom.CookieStoreRemoteCallHandler(this.proxy);
  }
  ...
  addSubscriptions(arg_service_worker_registration_id, arg_subscription) {
    return this.$.addSubscriptions(arg_service_worker_registration_id, arg_subscription);
  }
  removeSubscriptions(arg_service_worker_registration_id, arg_subscription) {
    return this.$.removeSubscriptions(arg_service_worker_registration_id, arg_subscription);
  }
  getSubscriptions(arg_service_worker_registration_id) {
    return this.$.getSubscriptions(arg_service_worker_registration_id);
  }
};
...
mojo.internal.bindings.blink.mojom.CookieStore.getRemote = function() {
  let remote = new mojo.internal.bindings.blink.mojom.CookieStoreRemote();
...
mojo.internal.bindings.blink.mojom.CookieStoreReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.blink.mojom.CookieStore_AddSubscriptions_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for AddSubscriptions failed with TypeError');
           }
        }
        // Try Method 1: RemoveSubscriptions
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.blink.mojom.CookieStore_RemoveSubscriptions_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for RemoveSubscriptions failed with TypeError');
           }
        }
        // Try Method 2: GetSubscriptions
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.blink.mojom.CookieStore_GetSubscriptions_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for GetSubscriptions failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.blink.mojom.CookieStoreReceiver = mojo.internal.bindings.blink.mojom.CookieStoreReceiver;
