...
mojo.internal.bindings.audio.mojom.DebugRecordingStreamType = {
  kInput: 0,
  kOutput: 1,
  kLoopback: 2,
};
...
mojo.internal.bindings.audio.mojom.DebugRecordingFileProviderRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.audio.mojom.DebugRecordingFileProviderPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.audio.mojom.DebugRecordingFileProviderRemoteCallHandler(this.proxy);
  }
  ...
  createWavFile(arg_stream_type, arg_id) {
    return this.$.createWavFile(arg_stream_type, arg_id);
  }
  createAecdumpFile(arg_id) {
    return this.$.createAecdumpFile(arg_id);
  }
};
...
mojo.internal.bindings.audio.mojom.DebugRecordingFileProvider.getRemote = function() {
  let remote = new mojo.internal.bindings.audio.mojom.DebugRecordingFileProviderRemote();
...
mojo.internal.bindings.audio.mojom.DebugRecordingFileProviderReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.audio.mojom.DebugRecordingFileProvider_CreateWavFile_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for CreateWavFile failed with TypeError');
           }
        }
        // Try Method 1: CreateAecdumpFile
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.audio.mojom.DebugRecordingFileProvider_CreateAecdumpFile_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for CreateAecdumpFile failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.audio.mojom.DebugRecordingFileProviderReceiver = mojo.internal.bindings.audio.mojom.DebugRecordingFileProviderReceiver;

mojo.internal.bindings.audio.mojom.DebugRecordingFileProviderPtr = mojo.internal.bindings.audio.mojom.DebugRecordingFileProviderRemote;
mojo.internal.bindings.audio.mojom.DebugRecordingFileProviderRequest = mojo.internal.bindings.audio.mojom.DebugRecordingFileProviderPendingReceiver;
...
mojo.internal.bindings.audio.mojom.DebugRecordingRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.audio.mojom.DebugRecordingRemoteCallHandler(this.proxy);
  }
  ...
  enable(arg_file_provider) {
    return this.$.enable(arg_file_provider);
  }
};
...
mojo.internal.bindings.audio.mojom.DebugRecording.getRemote = function() {
  let remote = new mojo.internal.bindings.audio.mojom.DebugRecordingRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
...
mojo.internal.bindings.audio.mojom.DebugRecordingReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.audio.mojom.DebugRecording_Enable_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
...
mojo.internal.bindings.audio.mojom.DebugRecordingReceiver = mojo.internal.bindings.audio.mojom.DebugRecordingReceiver;
