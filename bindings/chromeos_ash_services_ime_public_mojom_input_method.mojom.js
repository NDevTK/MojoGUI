...
mojo.internal.Struct(
    mojo.internal.bindings.ash.ime.mojom.InputFieldInfoSpec, 'ash.ime.mojom.InputFieldInfo', [
      ...
      mojo.internal.StructField('arg_text_prediction', 12, 0, mojo.internal.bindings.ash.ime.mojom.TextPredictionModeSpec, null, false, 10, undefined),
    ],
    [[0, 24], [10, 24]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.ash.ime.mojom.PinyinSettingsSpec, 'ash.ime.mojom.PinyinSettings', [
      ...
      mojo.internal.StructField('arg_use_hyphen_and_equals_to_page_candidates', 12, 0, mojo.internal.Bool, false, false, 6, undefined),
      mojo.internal.StructField('arg_use_comma_and_period_to_page_candidates', 12, 1, mojo.internal.Bool, false, false, 6, undefined),
      mojo.internal.StructField('arg_default_to_chinese', 12, 2, mojo.internal.Bool, false, false, 6, undefined),
      mojo.internal.StructField('arg_default_to_full_width_characters', 12, 3, mojo.internal.Bool, false, false, 6, undefined),
      mojo.internal.StructField('arg_default_to_full_width_punctuation', 12, 4, mojo.internal.Bool, false, false, 6, undefined),
    ],
    [[0, 8], [6, 24]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.ash.ime.mojom.JapaneseSettingsSpec, 'ash.ime.mojom.JapaneseSettings', [
      ...
      mojo.internal.StructField('arg_punctuation_style', 12, 0, mojo.internal.bindings.ash.ime.mojom.PunctuationStyleSpec, null, false, 22, undefined),
      mojo.internal.StructField('arg_symbol_style', 16, 0, mojo.internal.bindings.ash.ime.mojom.SymbolStyleSpec, null, false, 22, undefined),
...
mojo.internal.Struct(
    mojo.internal.bindings.ash.ime.mojom.ZhuyinSettingsSpec, 'ash.ime.mojom.ZhuyinSettings', [
      ...
      mojo.internal.StructField('arg_selection_keys', 4, 0, mojo.internal.bindings.ash.ime.mojom.ZhuyinSelectionKeysSpec, null, false, 7, undefined),
      mojo.internal.StructField('arg_page_size', 8, 0, mojo.internal.Uint32, 0, false, 7, undefined),
    ],
    [[0, 8], [7, 24]]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ash.ime.mojom.InputMethod_OnFocusDeprecated_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OnFocusDeprecated failed with TypeError');
           }
        }
        // Try Method 1: OnFocus
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ash.ime.mojom.InputMethod_OnFocus_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OnFocus failed with TypeError');
           }
        }
        // Try Method 2: OnBlur
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ash.ime.mojom.InputMethod_OnBlur_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OnBlur failed with TypeError');
           }
        }
        // Try Method 3: ProcessKeyEvent
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ash.ime.mojom.InputMethod_ProcessKeyEvent_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for ProcessKeyEvent failed with TypeError');
           }
        }
        // Try Method 4: OnSurroundingTextChanged
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ash.ime.mojom.InputMethod_OnSurroundingTextChanged_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OnSurroundingTextChanged failed with TypeError');
           }
        }
        // Try Method 5: OnCompositionCanceledBySystem
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ash.ime.mojom.InputMethod_OnCompositionCanceledBySystem_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OnCompositionCanceledBySystem failed with TypeError');
           }
        }
        // Try Method 6: OnCandidateSelected
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ash.ime.mojom.InputMethod_OnCandidateSelected_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OnCandidateSelected failed with TypeError');
           }
        }
        // Try Method 7: OnQuickSettingsUpdated
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ash.ime.mojom.InputMethod_OnQuickSettingsUpdated_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OnQuickSettingsUpdated failed with TypeError');
           }
        }
        // Try Method 8: IsReadyForTesting
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ash.ime.mojom.InputMethod_IsReadyForTesting_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for IsReadyForTesting failed with TypeError');
           }
        }
        // Try Method 9: OnAssistiveWindowChanged
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ash.ime.mojom.InputMethod_OnAssistiveWindowChanged_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OnAssistiveWindowChanged failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
