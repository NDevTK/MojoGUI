...
ash.ime.mojom.InputMethodPtr = class {
  ...
  0(input_field_info, settings) {
    // Method: 0
    // Call: 0(input_field_info, settings)
  }

  6(input_field_info, deprecated_settings) {
    // Method: 6
    return new Promise((resolve) => {
      // Call: 6(input_field_info, deprecated_settings)
      resolve({});
    });
  }
  ...
  3(text, offset, selection_range) {
    // Method: 3
    // Call: 3(text, offset, selection_range)
  }
  ...
  5(selected_candidate_index) {
    // Method: 5
    // Call: 5(selected_candidate_index)
  }
