...
mojo.internal.bindings.ash.ime.mojom.KeyEventTypeSpec = mojo.internal.bindings.ash.ime.mojom.KeyEventTypeSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.ash.ime.mojom.NamedDomKeySpec = mojo.internal.bindings.ash.ime.mojom.NamedDomKeySpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.ash.ime.mojom.DomCodeSpec = mojo.internal.bindings.ash.ime.mojom.DomCodeSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.ash.ime.mojom.KeyEventResultSpec = mojo.internal.bindings.ash.ime.mojom.KeyEventResultSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.ash.ime.mojom.InputFieldTypeSpec = mojo.internal.bindings.ash.ime.mojom.InputFieldTypeSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.ash.ime.mojom.AutocorrectModeSpec = mojo.internal.bindings.ash.ime.mojom.AutocorrectModeSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.ash.ime.mojom.PersonalizationModeSpec = mojo.internal.bindings.ash.ime.mojom.PersonalizationModeSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.ash.ime.mojom.TextPredictionModeSpec = mojo.internal.bindings.ash.ime.mojom.TextPredictionModeSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.ash.ime.mojom.KoreanLayoutSpec = mojo.internal.bindings.ash.ime.mojom.KoreanLayoutSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.ash.ime.mojom.PinyinLayoutSpec = mojo.internal.bindings.ash.ime.mojom.PinyinLayoutSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.ash.ime.mojom.PinyinSchemeSpec = mojo.internal.bindings.ash.ime.mojom.PinyinSchemeSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.ash.ime.mojom.InputModeSpec = mojo.internal.bindings.ash.ime.mojom.InputModeSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.ash.ime.mojom.PunctuationStyleSpec = mojo.internal.bindings.ash.ime.mojom.PunctuationStyleSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.ash.ime.mojom.SymbolStyleSpec = mojo.internal.bindings.ash.ime.mojom.SymbolStyleSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.ash.ime.mojom.SpaceInputStyleSpec = mojo.internal.bindings.ash.ime.mojom.SpaceInputStyleSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.ash.ime.mojom.SelectionShortcutSpec = mojo.internal.bindings.ash.ime.mojom.SelectionShortcutSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.ash.ime.mojom.KeymapStyleSpec = mojo.internal.bindings.ash.ime.mojom.KeymapStyleSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.ash.ime.mojom.ShiftKeyModeStyleSpec = mojo.internal.bindings.ash.ime.mojom.ShiftKeyModeStyleSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.ash.ime.mojom.ZhuyinLayoutSpec = mojo.internal.bindings.ash.ime.mojom.ZhuyinLayoutSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.ash.ime.mojom.ZhuyinSelectionKeysSpec = mojo.internal.bindings.ash.ime.mojom.ZhuyinSelectionKeysSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.ash.ime.mojom.ChineseLanguageModeSpec = mojo.internal.bindings.ash.ime.mojom.ChineseLanguageModeSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.ash.ime.mojom.JapaneseInputModeSpec = mojo.internal.bindings.ash.ime.mojom.JapaneseInputModeSpec || { $: mojo.internal.Enum().$ };
...
mojo.internal.bindings.ash.ime.mojom.SuggestionTypeSpec = mojo.internal.bindings.ash.ime.mojom.SuggestionTypeSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.ash.ime.mojom.AssistiveWindowTypeSpec = mojo.internal.bindings.ash.ime.mojom.AssistiveWindowTypeSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.ash.ime.mojom.AutocorrectSuggestionProviderSpec = mojo.internal.bindings.ash.ime.mojom.AutocorrectSuggestionProviderSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.ash.ime.mojom.DomKeySpec = mojo.internal.bindings.ash.ime.mojom.DomKeySpec || { $: {} };
if (mojo.internal.bindings.ash.ime.mojom.DomKeySpec.$.structSpec && mojo.internal.bindings.ash.ime.mojom.DomKeySpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.ime.mojom.DomKeySpec.$ = {};
mojo.internal.bindings.ash.ime.mojom.InputMethodSettingsSpec = mojo.internal.bindings.ash.ime.mojom.InputMethodSettingsSpec || { $: {} };
if (mojo.internal.bindings.ash.ime.mojom.InputMethodSettingsSpec.$.structSpec && mojo.internal.bindings.ash.ime.mojom.InputMethodSettingsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.ime.mojom.InputMethodSettingsSpec.$ = {};
mojo.internal.bindings.ash.ime.mojom.InputMethodQuickSettingsSpec = mojo.internal.bindings.ash.ime.mojom.InputMethodQuickSettingsSpec || { $: {} };
if (mojo.internal.bindings.ash.ime.mojom.InputMethodQuickSettingsSpec.$.structSpec && mojo.internal.bindings.ash.ime.mojom.InputMethodQuickSettingsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.ime.mojom.InputMethodQuickSettingsSpec.$ = {};
mojo.internal.bindings.ash.ime.mojom.ModifierStateSpec = mojo.internal.bindings.ash.ime.mojom.ModifierStateSpec || { $: {} };
if (mojo.internal.bindings.ash.ime.mojom.ModifierStateSpec.$.structSpec && mojo.internal.bindings.ash.ime.mojom.ModifierStateSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.ime.mojom.ModifierStateSpec.$ = {};
mojo.internal.bindings.ash.ime.mojom.PhysicalKeyEventSpec = mojo.internal.bindings.ash.ime.mojom.PhysicalKeyEventSpec || { $: {} };
if (mojo.internal.bindings.ash.ime.mojom.PhysicalKeyEventSpec.$.structSpec && mojo.internal.bindings.ash.ime.mojom.PhysicalKeyEventSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.ime.mojom.PhysicalKeyEventSpec.$ = {};
mojo.internal.bindings.ash.ime.mojom.SelectionRangeSpec = mojo.internal.bindings.ash.ime.mojom.SelectionRangeSpec || { $: {} };
if (mojo.internal.bindings.ash.ime.mojom.SelectionRangeSpec.$.structSpec && mojo.internal.bindings.ash.ime.mojom.SelectionRangeSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.ime.mojom.SelectionRangeSpec.$ = {};
mojo.internal.bindings.ash.ime.mojom.InputFieldInfoSpec = mojo.internal.bindings.ash.ime.mojom.InputFieldInfoSpec || { $: {} };
if (mojo.internal.bindings.ash.ime.mojom.InputFieldInfoSpec.$.structSpec && mojo.internal.bindings.ash.ime.mojom.InputFieldInfoSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.ime.mojom.InputFieldInfoSpec.$ = {};
mojo.internal.bindings.ash.ime.mojom.KoreanSettingsSpec = mojo.internal.bindings.ash.ime.mojom.KoreanSettingsSpec || { $: {} };
if (mojo.internal.bindings.ash.ime.mojom.KoreanSettingsSpec.$.structSpec && mojo.internal.bindings.ash.ime.mojom.KoreanSettingsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.ime.mojom.KoreanSettingsSpec.$ = {};
mojo.internal.bindings.ash.ime.mojom.LatinSettingsSpec = mojo.internal.bindings.ash.ime.mojom.LatinSettingsSpec || { $: {} };
if (mojo.internal.bindings.ash.ime.mojom.LatinSettingsSpec.$.structSpec && mojo.internal.bindings.ash.ime.mojom.LatinSettingsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.ime.mojom.LatinSettingsSpec.$ = {};
mojo.internal.bindings.ash.ime.mojom.FuzzyPinyinSettingsSpec = mojo.internal.bindings.ash.ime.mojom.FuzzyPinyinSettingsSpec || { $: {} };
if (mojo.internal.bindings.ash.ime.mojom.FuzzyPinyinSettingsSpec.$.structSpec && mojo.internal.bindings.ash.ime.mojom.FuzzyPinyinSettingsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.ime.mojom.FuzzyPinyinSettingsSpec.$ = {};
mojo.internal.bindings.ash.ime.mojom.PinyinSettingsSpec = mojo.internal.bindings.ash.ime.mojom.PinyinSettingsSpec || { $: {} };
if (mojo.internal.bindings.ash.ime.mojom.PinyinSettingsSpec.$.structSpec && mojo.internal.bindings.ash.ime.mojom.PinyinSettingsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.ime.mojom.PinyinSettingsSpec.$ = {};
mojo.internal.bindings.ash.ime.mojom.JapaneseSettingsSpec = mojo.internal.bindings.ash.ime.mojom.JapaneseSettingsSpec || { $: {} };
if (mojo.internal.bindings.ash.ime.mojom.JapaneseSettingsSpec.$.structSpec && mojo.internal.bindings.ash.ime.mojom.JapaneseSettingsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.ime.mojom.JapaneseSettingsSpec.$ = {};
mojo.internal.bindings.ash.ime.mojom.ZhuyinSettingsSpec = mojo.internal.bindings.ash.ime.mojom.ZhuyinSettingsSpec || { $: {} };
if (mojo.internal.bindings.ash.ime.mojom.ZhuyinSettingsSpec.$.structSpec && mojo.internal.bindings.ash.ime.mojom.ZhuyinSettingsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.ime.mojom.ZhuyinSettingsSpec.$ = {};
mojo.internal.bindings.ash.ime.mojom.ChineseQuickSettingsSpec = mojo.internal.bindings.ash.ime.mojom.ChineseQuickSettingsSpec || { $: {} };
if (mojo.internal.bindings.ash.ime.mojom.ChineseQuickSettingsSpec.$.structSpec && mojo.internal.bindings.ash.ime.mojom.ChineseQuickSettingsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.ime.mojom.ChineseQuickSettingsSpec.$ = {};
mojo.internal.bindings.ash.ime.mojom.JapaneseQuickSettingsSpec = mojo.internal.bindings.ash.ime.mojom.JapaneseQuickSettingsSpec || { $: {} };
if (mojo.internal.bindings.ash.ime.mojom.JapaneseQuickSettingsSpec.$.structSpec && mojo.internal.bindings.ash.ime.mojom.JapaneseQuickSettingsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.ime.mojom.JapaneseQuickSettingsSpec.$ = {};
mojo.internal.bindings.ash.ime.mojom.SuggestionCandidateSpec = mojo.internal.bindings.ash.ime.mojom.SuggestionCandidateSpec || { $: {} };
if (mojo.internal.bindings.ash.ime.mojom.SuggestionCandidateSpec.$.structSpec && mojo.internal.bindings.ash.ime.mojom.SuggestionCandidateSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.ime.mojom.SuggestionCandidateSpec.$ = {};
mojo.internal.bindings.ash.ime.mojom.InputMethodMetadataSpec = mojo.internal.bindings.ash.ime.mojom.InputMethodMetadataSpec || { $: {} };
if (mojo.internal.bindings.ash.ime.mojom.InputMethodMetadataSpec.$.structSpec && mojo.internal.bindings.ash.ime.mojom.InputMethodMetadataSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.ime.mojom.InputMethodMetadataSpec.$ = {};
mojo.internal.bindings.ash.ime.mojom.AssistiveWindowSpec = mojo.internal.bindings.ash.ime.mojom.AssistiveWindowSpec || { $: {} };
if (mojo.internal.bindings.ash.ime.mojom.AssistiveWindowSpec.$.structSpec && mojo.internal.bindings.ash.ime.mojom.AssistiveWindowSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.ime.mojom.AssistiveWindowSpec.$ = {};
mojo.internal.bindings.ash.ime.mojom.VietnameseTelexSettingsSpec = mojo.internal.bindings.ash.ime.mojom.VietnameseTelexSettingsSpec || { $: {} };
if (mojo.internal.bindings.ash.ime.mojom.VietnameseTelexSettingsSpec.$.structSpec && mojo.internal.bindings.ash.ime.mojom.VietnameseTelexSettingsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.ime.mojom.VietnameseTelexSettingsSpec.$ = {};
mojo.internal.bindings.ash.ime.mojom.VietnameseVniSettingsSpec = mojo.internal.bindings.ash.ime.mojom.VietnameseVniSettingsSpec || { $: {} };
if (mojo.internal.bindings.ash.ime.mojom.VietnameseVniSettingsSpec.$.structSpec && mojo.internal.bindings.ash.ime.mojom.VietnameseVniSettingsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.ime.mojom.VietnameseVniSettingsSpec.$ = {};
mojo.internal.bindings.ash.ime.mojom.InputMethod = mojo.internal.bindings.ash.ime.mojom.InputMethod || {};
mojo.internal.bindings.ash.ime.mojom.InputMethodSpec = mojo.internal.bindings.ash.ime.mojom.InputMethodSpec || { $ : {} };
if (mojo.internal.bindings.ash.ime.mojom.InputMethodSpec.$.structSpec && mojo.internal.bindings.ash.ime.mojom.InputMethodSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.ime.mojom.InputMethodSpec.$ = {};
mojo.internal.bindings.ash.ime.mojom.InputMethod.$interfaceName = 'ash.ime.mojom.InputMethod';
mojo.internal.bindings.ash.ime.mojom.InputMethod_OnFocusDeprecated_ParamsSpec = mojo.internal.bindings.ash.ime.mojom.InputMethod_OnFocusDeprecated_ParamsSpec || { $: {} };
if (mojo.internal.bindings.ash.ime.mojom.InputMethod_OnFocusDeprecated_ParamsSpec.$.structSpec && mojo.internal.bindings.ash.ime.mojom.InputMethod_OnFocusDeprecated_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.ime.mojom.InputMethod_OnFocusDeprecated_ParamsSpec.$ = {};
mojo.internal.bindings.ash.ime.mojom.InputMethod_OnFocus_ParamsSpec = mojo.internal.bindings.ash.ime.mojom.InputMethod_OnFocus_ParamsSpec || { $: {} };
if (mojo.internal.bindings.ash.ime.mojom.InputMethod_OnFocus_ParamsSpec.$.structSpec && mojo.internal.bindings.ash.ime.mojom.InputMethod_OnFocus_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.ime.mojom.InputMethod_OnFocus_ParamsSpec.$ = {};
mojo.internal.bindings.ash.ime.mojom.InputMethod_OnFocus_ResponseParamsSpec = mojo.internal.bindings.ash.ime.mojom.InputMethod_OnFocus_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.ash.ime.mojom.InputMethod_OnFocus_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.ash.ime.mojom.InputMethod_OnFocus_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.ime.mojom.InputMethod_OnFocus_ResponseParamsSpec.$ = {};
mojo.internal.bindings.ash.ime.mojom.InputMethod_OnBlur_ParamsSpec = mojo.internal.bindings.ash.ime.mojom.InputMethod_OnBlur_ParamsSpec || { $: {} };
if (mojo.internal.bindings.ash.ime.mojom.InputMethod_OnBlur_ParamsSpec.$.structSpec && mojo.internal.bindings.ash.ime.mojom.InputMethod_OnBlur_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.ime.mojom.InputMethod_OnBlur_ParamsSpec.$ = {};
mojo.internal.bindings.ash.ime.mojom.InputMethod_ProcessKeyEvent_ParamsSpec = mojo.internal.bindings.ash.ime.mojom.InputMethod_ProcessKeyEvent_ParamsSpec || { $: {} };
if (mojo.internal.bindings.ash.ime.mojom.InputMethod_ProcessKeyEvent_ParamsSpec.$.structSpec && mojo.internal.bindings.ash.ime.mojom.InputMethod_ProcessKeyEvent_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.ime.mojom.InputMethod_ProcessKeyEvent_ParamsSpec.$ = {};
mojo.internal.bindings.ash.ime.mojom.InputMethod_ProcessKeyEvent_ResponseParamsSpec = mojo.internal.bindings.ash.ime.mojom.InputMethod_ProcessKeyEvent_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.ash.ime.mojom.InputMethod_ProcessKeyEvent_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.ash.ime.mojom.InputMethod_ProcessKeyEvent_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.ime.mojom.InputMethod_ProcessKeyEvent_ResponseParamsSpec.$ = {};
mojo.internal.bindings.ash.ime.mojom.InputMethod_OnSurroundingTextChanged_ParamsSpec = mojo.internal.bindings.ash.ime.mojom.InputMethod_OnSurroundingTextChanged_ParamsSpec || { $: {} };
if (mojo.internal.bindings.ash.ime.mojom.InputMethod_OnSurroundingTextChanged_ParamsSpec.$.structSpec && mojo.internal.bindings.ash.ime.mojom.InputMethod_OnSurroundingTextChanged_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.ime.mojom.InputMethod_OnSurroundingTextChanged_ParamsSpec.$ = {};
mojo.internal.bindings.ash.ime.mojom.InputMethod_OnCompositionCanceledBySystem_ParamsSpec = mojo.internal.bindings.ash.ime.mojom.InputMethod_OnCompositionCanceledBySystem_ParamsSpec || { $: {} };
if (mojo.internal.bindings.ash.ime.mojom.InputMethod_OnCompositionCanceledBySystem_ParamsSpec.$.structSpec && mojo.internal.bindings.ash.ime.mojom.InputMethod_OnCompositionCanceledBySystem_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.ime.mojom.InputMethod_OnCompositionCanceledBySystem_ParamsSpec.$ = {};
mojo.internal.bindings.ash.ime.mojom.InputMethod_OnCandidateSelected_ParamsSpec = mojo.internal.bindings.ash.ime.mojom.InputMethod_OnCandidateSelected_ParamsSpec || { $: {} };
if (mojo.internal.bindings.ash.ime.mojom.InputMethod_OnCandidateSelected_ParamsSpec.$.structSpec && mojo.internal.bindings.ash.ime.mojom.InputMethod_OnCandidateSelected_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.ime.mojom.InputMethod_OnCandidateSelected_ParamsSpec.$ = {};
mojo.internal.bindings.ash.ime.mojom.InputMethod_OnQuickSettingsUpdated_ParamsSpec = mojo.internal.bindings.ash.ime.mojom.InputMethod_OnQuickSettingsUpdated_ParamsSpec || { $: {} };
if (mojo.internal.bindings.ash.ime.mojom.InputMethod_OnQuickSettingsUpdated_ParamsSpec.$.structSpec && mojo.internal.bindings.ash.ime.mojom.InputMethod_OnQuickSettingsUpdated_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.ime.mojom.InputMethod_OnQuickSettingsUpdated_ParamsSpec.$ = {};
mojo.internal.bindings.ash.ime.mojom.InputMethod_IsReadyForTesting_ParamsSpec = mojo.internal.bindings.ash.ime.mojom.InputMethod_IsReadyForTesting_ParamsSpec || { $: {} };
if (mojo.internal.bindings.ash.ime.mojom.InputMethod_IsReadyForTesting_ParamsSpec.$.structSpec && mojo.internal.bindings.ash.ime.mojom.InputMethod_IsReadyForTesting_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.ime.mojom.InputMethod_IsReadyForTesting_ParamsSpec.$ = {};
mojo.internal.bindings.ash.ime.mojom.InputMethod_IsReadyForTesting_ResponseParamsSpec = mojo.internal.bindings.ash.ime.mojom.InputMethod_IsReadyForTesting_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.ash.ime.mojom.InputMethod_IsReadyForTesting_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.ash.ime.mojom.InputMethod_IsReadyForTesting_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.ime.mojom.InputMethod_IsReadyForTesting_ResponseParamsSpec.$ = {};
mojo.internal.bindings.ash.ime.mojom.InputMethod_OnAssistiveWindowChanged_ParamsSpec = mojo.internal.bindings.ash.ime.mojom.InputMethod_OnAssistiveWindowChanged_ParamsSpec || { $: {} };
if (mojo.internal.bindings.ash.ime.mojom.InputMethod_OnAssistiveWindowChanged_ParamsSpec.$.structSpec && mojo.internal.bindings.ash.ime.mojom.InputMethod_OnAssistiveWindowChanged_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.ime.mojom.InputMethod_OnAssistiveWindowChanged_ParamsSpec.$ = {};
...
// Enum: PinyinScheme
mojo.internal.bindings.ash.ime.mojom.PinyinScheme = {
  kQuanpin: 0,
  kShuangpinAbc: 1,
  kShuangpinFlypy: 2,
  kShuangpinJiajia: 3,
...
mojo.internal.Struct(
    mojo.internal.bindings.ash.ime.mojom.InputFieldInfoSpec, 'ash.ime.mojom.InputFieldInfo', [
      ...
      mojo.internal.StructField('arg_autocorrect', 4, 0, mojo.internal.bindings.ash.ime.mojom.AutocorrectModeSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_personalization', 8, 0, mojo.internal.bindings.ash.ime.mojom.PersonalizationModeSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_text_prediction', 12, 0, mojo.internal.bindings.ash.ime.mojom.TextPredictionModeSpec, null, false, 0, undefined),
    ],
    [[0, 24]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.ash.ime.mojom.LatinSettingsSpec, 'ash.ime.mojom.LatinSettings', [
      ...
      mojo.internal.StructField('arg_predictive_writing', 0, 1, mojo.internal.Bool, false, false, 0, undefined),
    ],
    [[0, 16]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.ash.ime.mojom.PinyinSettingsSpec, 'ash.ime.mojom.PinyinSettings', [
      mojo.internal.StructField('arg_fuzzy_pinyin', 0, 0, mojo.internal.bindings.ash.ime.mojom.FuzzyPinyinSettingsSpec, null, true, 0, undefined),
      mojo.internal.StructField('arg_layout', 8, 0, mojo.internal.bindings.ash.ime.mojom.PinyinLayoutSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_use_hyphen_and_equals_to_page_candidates', 12, 0, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_use_comma_and_period_to_page_candidates', 12, 1, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_default_to_chinese', 12, 2, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_default_to_full_width_characters', 12, 3, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_default_to_full_width_punctuation', 12, 4, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_pinyin_scheme', 16, 0, mojo.internal.bindings.ash.ime.mojom.PinyinSchemeSpec, null, false, 0, undefined),
    ],
    [[0, 32]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.ash.ime.mojom.JapaneseSettingsSpec, 'ash.ime.mojom.JapaneseSettings', [
      ...
      mojo.internal.StructField('arg_input_mode', 8, 0, mojo.internal.bindings.ash.ime.mojom.InputModeSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_punctuation_style', 12, 0, mojo.internal.bindings.ash.ime.mojom.PunctuationStyleSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_symbol_style', 16, 0, mojo.internal.bindings.ash.ime.mojom.SymbolStyleSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_space_input_style', 20, 0, mojo.internal.bindings.ash.ime.mojom.SpaceInputStyleSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_selection_shortcut', 24, 0, mojo.internal.bindings.ash.ime.mojom.SelectionShortcutSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_keymap_style', 28, 0, mojo.internal.bindings.ash.ime.mojom.KeymapStyleSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_automatically_switch_to_halfwidth', 32, 0, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_use_input_history', 32, 1, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_use_system_dictionary', 32, 2, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_disable_personalized_suggestions', 32, 3, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_unused2', 32, 4, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_shift_key_mode_style', 36, 0, mojo.internal.bindings.ash.ime.mojom.ShiftKeyModeStyleSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_number_of_suggestions', 40, 0, mojo.internal.Uint32, 0, false, 0, undefined),
    ],
    [[0, 56]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.ash.ime.mojom.ZhuyinSettingsSpec, 'ash.ime.mojom.ZhuyinSettings', [
      mojo.internal.StructField('arg_layout', 0, 0, mojo.internal.bindings.ash.ime.mojom.ZhuyinLayoutSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_selection_keys', 4, 0, mojo.internal.bindings.ash.ime.mojom.ZhuyinSelectionKeysSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_page_size', 8, 0, mojo.internal.Uint32, 0, false, 0, undefined),
    ],
    [[0, 24]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.ash.ime.mojom.ChineseQuickSettingsSpec, 'ash.ime.mojom.ChineseQuickSettings', [
      ...
      mojo.internal.StructField('arg_full_width_characters', 4, 0, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_full_width_punctuation', 4, 1, mojo.internal.Bool, false, false, 0, undefined),
    ],
    [[0, 16]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.ash.ime.mojom.SuggestionCandidateSpec, 'ash.ime.mojom.SuggestionCandidate', [
      ...
      mojo.internal.StructField('arg_confirmed_length', 16, 0, mojo.internal.Int32, 0, false, 0, undefined),
    ],
    [[0, 32]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.ash.ime.mojom.VietnameseTelexSettingsSpec, 'ash.ime.mojom.VietnameseTelexSettings', [
      ...
      mojo.internal.StructField('arg_show_underline_for_composition_text', 0, 4, mojo.internal.Bool, false, false, 0, undefined),
    ],
    [[0, 16]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.ash.ime.mojom.VietnameseVniSettingsSpec, 'ash.ime.mojom.VietnameseVniSettings', [
      ...
      mojo.internal.StructField('arg_new_style_tone_mark_placement', 0, 1, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_enable_insert_double_horn_on_uo', 0, 2, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_show_underline_for_composition_text', 0, 3, mojo.internal.Bool, false, false, 0, undefined),
    ],
    [[0, 16]]);
mojo.internal.Struct(
    mojo.internal.bindings.ash.ime.mojom.InputMethod_OnFocusDeprecated_ParamsSpec, 'ash.ime.mojom.InputMethod_OnFocusDeprecated_Params', [
      ...
      mojo.internal.StructField('arg_settings', 8, 0, mojo.internal.bindings.ash.ime.mojom.InputMethodSettingsSpec, null, true, 0, undefined),
    ],
    [[0, 32]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.ash.ime.mojom.InputMethod_OnFocus_ResponseParamsSpec, 'ash.ime.mojom.InputMethod_OnFocus_ResponseParams', [
      ...
      mojo.internal.StructField('arg_metadata', 8, 0, mojo.internal.bindings.ash.ime.mojom.InputMethodMetadataSpec, null, true, 0, undefined),
    ],
    [[0, 24]]);
