...
mojo.internal.bindings.network.mojom.DevToolsObserver_OnLocalNetworkRequest_ParamsSpec = mojo.internal.bindings.network.mojom.DevToolsObserver_OnLocalNetworkRequest_ParamsSpec || { $: {} };
if (mojo.internal.bindings.network.mojom.DevToolsObserver_OnLocalNetworkRequest_ParamsSpec.$.structSpec && mojo.internal.bindings.network.mojom.DevToolsObserver_OnLocalNetworkRequest_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.network.mojom.DevToolsObserver_OnLocalNetworkRequest_ParamsSpec.$ = {};
...
mojo.internal.bindings.network.mojom.DevToolsObserver_OnConnectionAllowlistIssue_ParamsSpec = mojo.internal.bindings.network.mojom.DevToolsObserver_OnConnectionAllowlistIssue_ParamsSpec || { $: {} };
if (mojo.internal.bindings.network.mojom.DevToolsObserver_OnConnectionAllowlistIssue_ParamsSpec.$.structSpec && mojo.internal.bindings.network.mojom.DevToolsObserver_OnConnectionAllowlistIssue_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.network.mojom.DevToolsObserver_OnConnectionAllowlistIssue_ParamsSpec.$ = {};
...
mojo.internal.bindings.network = mojo.internal.bindings.network || {};
mojo.internal.bindings.network.mojom = mojo.internal.bindings.network.mojom || {};
mojo.internal.bindings.network.mojom.DeviceBoundSessionWithUsageSpec = mojo.internal.bindings.network.mojom.DeviceBoundSessionWithUsageSpec || { $: mojo.internal.OpaqueStruct.$ };
mojo.internal.bindings.network = mojo.internal.bindings.network || {};
mojo.internal.bindings.network.mojom = mojo.internal.bindings.network.mojom || {};
...
mojo.internal.bindings.network.mojom.DevToolsObserverRemote = class {
  ...
  onRawRequest(arg_devtool_request_id, arg_cookies_with_access_result, arg_headers, arg_timestamp, arg_device_bound_session_usages, arg_client_security_state, arg_other_partition_info, arg_applied_network_conditions_id) {
    return this.$.onRawRequest(arg_devtool_request_id, arg_cookies_with_access_result, arg_headers, arg_timestamp, arg_device_bound_session_usages, arg_client_security_state, arg_other_partition_info, arg_applied_network_conditions_id);
  }
  ...
  onLocalNetworkRequest(arg_devtool_request_id, arg_url, arg_is_warning, arg_resource_address_space, arg_client_security_state) {
    return this.$.onLocalNetworkRequest(arg_devtool_request_id, arg_url, arg_is_warning, arg_resource_address_space, arg_client_security_state);
  }
  ...
  onConnectionAllowlistIssue(arg_devtool_request_id, arg_url, arg_issue) {
    return this.$.onConnectionAllowlistIssue(arg_devtool_request_id, arg_url, arg_issue);
  }
  clone(arg_listener) {
...
mojo.internal.bindings.network.mojom.DevToolsObserverRemoteCallHandler = class {
  ...
  onRawRequest(arg_devtool_request_id, arg_cookies_with_access_result, arg_headers, arg_timestamp, arg_device_bound_session_usages, arg_client_security_state, arg_other_partition_info, arg_applied_network_conditions_id) {
    return this.proxy.sendMessage(
      ...
      null,
      [arg_devtool_request_id, arg_cookies_with_access_result, arg_headers, arg_timestamp, arg_device_bound_session_usages, arg_client_security_state, arg_other_partition_info, arg_applied_network_conditions_id],
      false);
  }
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        case 0: {
          ...
          const result = this.impl.onRawRequest(params.arg_devtool_request_id, params.arg_cookies_with_access_result, params.arg_headers, params.arg_timestamp, params.arg_device_bound_session_usages, params.arg_client_security_state, params.arg_other_partition_info, params.arg_applied_network_conditions_id);
          break;
        }
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
        ...
        case 3: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.network.mojom.DevToolsObserver_OnLocalNetworkRequest_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.onLocalNetworkRequest');
          const result = this.impl.onLocalNetworkRequest(params.arg_devtool_request_id, params.arg_url, params.arg_is_warning, params.arg_resource_address_space, params.arg_client_security_state);
          break;
        }
        case 4: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
        ...
        case 13: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.network.mojom.DevToolsObserver_OnConnectionAllowlistIssue_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.onConnectionAllowlistIssue');
          const result = this.impl.onConnectionAllowlistIssue(params.arg_devtool_request_id, params.arg_url, params.arg_issue);
          break;
        }
        case 14: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
...
mojo.internal.Struct(
    mojo.internal.bindings.network.mojom.DevToolsObserver_OnRawRequest_ParamsSpec, 'network.mojom.DevToolsObserver_OnRawRequest_Params', [
      ...
      mojo.internal.StructField('arg_device_bound_session_usages', 32, 0, mojo.internal.Array(mojo.internal.bindings.network.mojom.DeviceBoundSessionWithUsageSpec, false), null, false, 0, undefined),
      ...
      mojo.internal.StructField('arg_other_partition_info', 48, 0, mojo.internal.bindings.network.mojom.OtherPartitionInfoSpec, null, true, 0, undefined),
      mojo.internal.StructField('arg_applied_network_conditions_id', 56, 0, mojo.internal.bindings.mojo_base.mojom.UnguessableTokenSpec, null, true, 0, undefined),
    ],
    [[0, 72]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.network.mojom.DevToolsObserver_OnLocalNetworkRequest_ParamsSpec, 'network.mojom.DevToolsObserver_OnLocalNetworkRequest_Params', [
...
mojo.internal.Struct(
    mojo.internal.bindings.network.mojom.DevToolsObserver_OnConnectionAllowlistIssue_ParamsSpec, 'network.mojom.DevToolsObserver_OnConnectionAllowlistIssue_Params', [
      mojo.internal.StructField('arg_devtool_request_id', 0, 0, mojo.internal.String, null, false, 0, undefined),
      mojo.internal.StructField('arg_url', 8, 0, mojo.internal.bindings.url.mojom.UrlSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_issue', 16, 0, mojo.internal.bindings.network.mojom.ConnectionAllowlistIssueSpec, null, false, 0, undefined),
    ],
    [[0, 32]]);

mojo.internal.Struct(
    mojo.internal.bindings.network.mojom.DevToolsObserver_Clone_ParamsSpec, 'network.mojom.DevToolsObserver_Clone_Params', [
      mojo.internal.StructField('arg_listener', 0, 0, mojo.internal.InterfaceRequest(mojo.internal.bindings.network.mojom.DevToolsObserverPendingReceiver), null, false, 0, undefined),
    ],
    [[0, 16]]);
