...
mojo.internal.bindings.ash.auth.mojom.PinComplexity = {
  kOk: 0,
  kTooShort: 1,
  kContainsOrderedSequence: 2,
  kContainsRepeatingDigits: 3,
  kContainsNonDigits: 4,
};
...
mojo.internal.bindings.ash.auth.mojom.FactorObserverRemote = class {
  ...
  onFactorChanged(arg_factor, arg_result) {
    return this.$.onFactorChanged(arg_factor, arg_result);
  }
};
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        case 0: {
          ...
          const result = this.impl.onFactorChanged(params.arg_factor, params.arg_result);
          break;
        }
      }
      } catch (err) {
...
mojo.internal.Struct(
    mojo.internal.bindings.ash.auth.mojom.FactorObserver_OnFactorChanged_ParamsSpec, 'ash.auth.mojom.FactorObserver_OnFactorChanged_Params', [
      ...
      mojo.internal.StructField('arg_result', 4, 0, mojo.internal.bindings.ash.auth.mojom.ConfigureResultSpec, null, false, 0, undefined),
    ],
    [[0, 16]]);
