...
mojo.internal.bindings.ash.auth.mojom.PasswordFactorEditorRemote = class {
  ...
  checkLocalPasswordComplexity(arg_auth_token, arg_password) {
    return this.$.checkLocalPasswordComplexity(arg_auth_token, arg_password);
  }
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        ...
        case 4: {
          ...
          const result = this.impl.checkLocalPasswordComplexity(params.arg_auth_token, params.arg_password);
          break;
        }
        case 5: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
