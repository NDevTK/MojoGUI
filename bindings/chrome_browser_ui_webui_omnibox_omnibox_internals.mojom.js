...
mojo.internal.bindings.mojom.OmniboxPageHandlerRemote = class {
  ...
  startOmniboxQuery(arg_input_string, arg_reset_autocomplete_controller, arg_cursor_position, arg_zero_suggest, arg_prevent_inline_autocomplete, arg_in_keyword_mode, arg_current_url, arg_page_classification) {
    return this.$.startOmniboxQuery(arg_input_string, arg_reset_autocomplete_controller, arg_cursor_position, arg_zero_suggest, arg_prevent_inline_autocomplete, arg_in_keyword_mode, arg_current_url, arg_page_classification);
  }
  getMlModelVersion() {
...
mojo.internal.bindings.mojom.OmniboxPageHandlerRemoteCallHandler = class {
  ...
  startOmniboxQuery(arg_input_string, arg_reset_autocomplete_controller, arg_cursor_position, arg_zero_suggest, arg_prevent_inline_autocomplete, arg_in_keyword_mode, arg_current_url, arg_page_classification) {
    return this.proxy.sendMessage(
      ...
      null,
      [arg_input_string, arg_reset_autocomplete_controller, arg_cursor_position, arg_zero_suggest, arg_prevent_inline_autocomplete, arg_in_keyword_mode, arg_current_url, arg_page_classification],
      false);
  }
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        ...
        case 1: {
          ...
          const result = this.impl.startOmniboxQuery(params.arg_input_string, params.arg_reset_autocomplete_controller, params.arg_cursor_position, params.arg_zero_suggest, params.arg_prevent_inline_autocomplete, params.arg_in_keyword_mode, params.arg_current_url, params.arg_page_classification);
          break;
        }
        case 2: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
...
mojo.internal.Struct(
    mojo.internal.bindings.mojom.OmniboxPageHandler_StartOmniboxQuery_ParamsSpec, 'mojom.OmniboxPageHandler_StartOmniboxQuery_Params', [
      ...
      mojo.internal.StructField('arg_in_keyword_mode', 8, 3, mojo.internal.Bool, false, false, 0, undefined),
