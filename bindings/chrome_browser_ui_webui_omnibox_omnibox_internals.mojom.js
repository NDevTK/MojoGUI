  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.mojom.OmniboxPageHandler_SetClientPage_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for SetClientPage failed with TypeError');
           }
        }
        // Try Method 1: StartOmniboxQuery
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.mojom.OmniboxPageHandler_StartOmniboxQuery_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for StartOmniboxQuery failed with TypeError');
           }
        }
        // Try Method 2: GetMlModelVersion
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.mojom.OmniboxPageHandler_GetMlModelVersion_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for GetMlModelVersion failed with TypeError');
           }
        }
        // Try Method 3: StartMl
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.mojom.OmniboxPageHandler_StartMl_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for StartMl failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.Struct(
    mojo.internal.bindings.mojom.OmniboxPage_HandleNewAutocompleteQuery_ParamsSpec, 'mojom.OmniboxPage_HandleNewAutocompleteQuery_Params', [
      ...
      mojo.internal.StructField('arg_autocomplete_controller_type', 8, 0, mojo.internal.bindings.mojom.AutocompleteControllerTypeSpec, null, false, 0, undefined),
    ],
    [[0, 24]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.mojom.OmniboxPage_HandleNewAutocompleteResponse_ParamsSpec, 'mojom.OmniboxPage_HandleNewAutocompleteResponse_Params', [
      mojo.internal.StructField('arg_response', 0, 0, mojo.internal.bindings.mojom.OmniboxResponseSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_autocomplete_controller_type', 8, 0, mojo.internal.bindings.mojom.AutocompleteControllerTypeSpec, null, false, 0, undefined),
    ],
    [[0, 24]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.mojom.OmniboxPage_HandleNewMlResponse_ParamsSpec, 'mojom.OmniboxPage_HandleNewMlResponse_Params', [
      mojo.internal.StructField('arg_input_text', 0, 0, mojo.internal.String, null, false, 0, undefined),
      mojo.internal.StructField('arg_matches', 8, 0, mojo.internal.Array(mojo.internal.bindings.mojom.AutocompleteMatchSpec, false), null, false, 0, undefined),
      mojo.internal.StructField('arg_autocomplete_controller_type', 16, 0, mojo.internal.bindings.mojom.AutocompleteControllerTypeSpec, null, false, 0, undefined),
    ],
    [[0, 32]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.mojom.OmniboxPage_HandleAnswerIconImageData_ParamsSpec, 'mojom.OmniboxPage_HandleAnswerIconImageData_Params', [
      ...
      mojo.internal.StructField('arg_image_data', 8, 0, mojo.internal.String, null, false, 0, undefined),
      mojo.internal.StructField('arg_autocomplete_controller_type', 16, 0, mojo.internal.bindings.mojom.AutocompleteControllerTypeSpec, null, false, 0, undefined),
    ],
    [[0, 32]]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.mojom.OmniboxPage_HandleNewAutocompleteQuery_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for HandleNewAutocompleteQuery failed with TypeError');
           }
        }
        // Try Method 1: HandleNewAutocompleteResponse
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.mojom.OmniboxPage_HandleNewAutocompleteResponse_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for HandleNewAutocompleteResponse failed with TypeError');
           }
        }
        // Try Method 2: HandleNewMlResponse
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.mojom.OmniboxPage_HandleNewMlResponse_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for HandleNewMlResponse failed with TypeError');
           }
        }
        // Try Method 3: HandleAnswerIconImageData
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.mojom.OmniboxPage_HandleAnswerIconImageData_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for HandleAnswerIconImageData failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
             console.warn('[GeneratedReceiver] Failed to discover ordinal ' + header.ordinal);
