...
mojo.internal.bindings.remote_cocoa.mojom.AlertDisposition = {
  PRIMARY_BUTTON: 0,
  SECONDARY_BUTTON: 1,
  CLOSE: 2,
};
...
mojo.internal.Struct(
    mojo.internal.bindings.remote_cocoa.mojom.AlertBridge_Show_ResponseParamsSpec, 'remote_cocoa.mojom.AlertBridge_Show_ResponseParams', [
      mojo.internal.StructField('arg_text_field_value', 0, 0, mojo.internal.bindings.mojo_base.mojom.String16Spec, null, false, 0, undefined),
      mojo.internal.StructField('arg_disposition', 8, 0, mojo.internal.bindings.remote_cocoa.mojom.AlertDispositionSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_check_box_value', 12, 0, mojo.internal.Bool, false, false, 0, undefined),
    ],
    [[0, 24]]);
...
mojo.internal.bindings.remote_cocoa.mojom.AlertBridgeRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.remote_cocoa.mojom.AlertBridgePendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.remote_cocoa.mojom.AlertBridgeRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.remote_cocoa.mojom.AlertBridge.getRemote = function() {
  let remote = new mojo.internal.bindings.remote_cocoa.mojom.AlertBridgeRemote();
...
mojo.internal.bindings.remote_cocoa.mojom.AlertBridgeReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.remote_cocoa.mojom.AlertBridge_Show_ParamsSpec.$.structSpec;
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.remote_cocoa.mojom.AlertBridge_Dismiss_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for Dismiss failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
      ...
      switch (dispatchId) {
        ...
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.remote_cocoa.mojom.AlertBridge_Dismiss_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.remote_cocoa.mojom.AlertBridgeReceiver = mojo.internal.bindings.remote_cocoa.mojom.AlertBridgeReceiver;
