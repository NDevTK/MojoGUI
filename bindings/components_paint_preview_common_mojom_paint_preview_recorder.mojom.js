...
mojo.internal.bindings.paint_preview.mojom.PaintPreviewStatus = {
  kOk: 0,
  kAlreadyCapturing: 1,
  kCaptureFailed: 2,
  kGuidCollision: 3,
...
mojo.internal.Struct(
    mojo.internal.bindings.paint_preview.mojom.PaintPreviewCaptureParamsSpec, 'paint_preview.mojom.PaintPreviewCaptureParams', [
      ...
      mojo.internal.StructField('arg_geometry_metadata_params', 16, 0, mojo.internal.bindings.mojo.internal.bindings.paint_preview.mojom.GeometryMetadataParamsSpec.$, null, false, 0, undefined),
      ...
      mojo.internal.StructField('arg_is_main_frame', 48, 0, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_capture_links', 48, 1, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_skip_accelerated_content', 48, 2, mojo.internal.Bool, false, false, 0, undefined),
    ],
    [[0, 64]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.paint_preview.mojom.PaintPreviewCaptureResponseSpec, 'paint_preview.mojom.PaintPreviewCaptureResponse', [
      ...
      mojo.internal.StructField('arg_links', 16, 0, mojo.internal.Array(mojo.internal.bindings.mojo.internal.bindings.paint_preview.mojom.LinkDataSpec.$, false), null, false, 0, undefined),
      ...
      mojo.internal.StructField('arg_geometry_metadata', 40, 0, mojo.internal.bindings.mojo.internal.bindings.paint_preview.mojom.GeometryMetadataResponseSpec.$, null, false, 0, undefined),
...
mojo.internal.Struct(
    mojo.internal.bindings.paint_preview.mojom.GeometryMetadataParamsSpec, 'paint_preview.mojom.GeometryMetadataParams', [
      ...
      mojo.internal.StructField('arg_clip_y_coord_override', 16, 0, mojo.internal.bindings.paint_preview.mojom.ClipCoordOverrideSpec.$, 0, false, 0, undefined),
      mojo.internal.StructField('arg_clip_rect_is_hint', 24, 0, mojo.internal.Bool, false, false, 0, undefined),
    ],
    [[0, 40]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.paint_preview.mojom.PaintPreviewRecorder_CapturePaintPreview_ParamsSpec, 'paint_preview.mojom.PaintPreviewRecorder_CapturePaintPreview_Params', [
      mojo.internal.StructField('arg_params', 0, 0, mojo.internal.bindings.mojo.internal.bindings.paint_preview.mojom.PaintPreviewCaptureParamsSpec.$, null, false, 0, undefined),
    ],
    [[0, 16]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.paint_preview.mojom.PaintPreviewRecorder_GetGeometryMetadata_ParamsSpec, 'paint_preview.mojom.PaintPreviewRecorder_GetGeometryMetadata_Params', [
      mojo.internal.StructField('arg_params', 0, 0, mojo.internal.bindings.mojo.internal.bindings.paint_preview.mojom.GeometryMetadataParamsSpec.$, null, false, 0, undefined),
    ],
    [[0, 16]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.paint_preview.mojom.PaintPreviewRecorder_GetGeometryMetadata_ResponseParamsSpec, 'paint_preview.mojom.PaintPreviewRecorder_GetGeometryMetadata_ResponseParams', [
      mojo.internal.StructField('arg_response', 0, 0, mojo.internal.bindings.mojo.internal.bindings.paint_preview.mojom.GeometryMetadataResponseSpec.$, null, true, 0, undefined),
    ],
    [[0, 16]]);
...
mojo.internal.bindings.paint_preview.mojom.PaintPreviewRecorderRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.paint_preview.mojom.PaintPreviewRecorderPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.paint_preview.mojom.PaintPreviewRecorderRemoteCallHandler(this.proxy);
  }
  ...
  capturePaintPreview(arg_params) {
    return this.$.capturePaintPreview(arg_params);
  }
  getGeometryMetadata(arg_params) {
    return this.$.getGeometryMetadata(arg_params);
  }
};
...
mojo.internal.bindings.paint_preview.mojom.PaintPreviewRecorder.getRemote = function() {
  let remote = new mojo.internal.bindings.paint_preview.mojom.PaintPreviewRecorderRemote();
...
mojo.internal.bindings.paint_preview.mojom.PaintPreviewRecorderReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
        ...
        case 1: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.paint_preview.mojom.PaintPreviewRecorder_GetGeometryMetadata_ResponseParamsSpec, header, rawHeader);
               responder(response);
...
mojo.internal.bindings.paint_preview.mojom.PaintPreviewRecorderReceiver = mojo.internal.bindings.paint_preview.mojom.PaintPreviewRecorderReceiver;
