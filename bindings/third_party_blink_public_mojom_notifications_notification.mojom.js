  ...
  $: {
    structSpec: {
      ...
      fields: [
        ...
        { name: 'show_trigger_timestamp', packedOffset: 112, packedBitOffset: 0, type: mojo_base.mojom.TimeSpec, nullable: true },
        { name: 'scenario', packedOffset: 120, packedBitOffset: 0, type: blink.mojom.NotificationScenarioSpec, nullable: false },
