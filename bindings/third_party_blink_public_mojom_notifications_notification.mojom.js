...
blink.mojom.NotificationActionSpec = {
  $: {
    structSpec: {
      ...
      packedSize: 48,
      fields: [
        { name: 'type', packedOffset: 0, packedBitOffset: 0, type: blink.mojom.NotificationActionTypeSpec, nullable: false },
        ...
        { name: 'placeholder', packedOffset: 32, packedBitOffset: 0, type: mojo_base.mojom.String16Spec, nullable: true },
      ],
      versions: [{version: 0}]
    }
  }
  ...
  $: {
    structSpec: {
      ...
      fields: [
        ...
        { name: 'title', packedOffset: 16, packedBitOffset: 0, type: mojo_base.mojom.String16Spec, nullable: false },
        { name: 'direction', packedOffset: 24, packedBitOffset: 0, type: blink.mojom.NotificationDirectionSpec, nullable: false },
        { name: 'lang', packedOffset: 32, packedBitOffset: 0, type: mojo.internal.String, nullable: true },
        { name: 'body', packedOffset: 40, packedBitOffset: 0, type: mojo_base.mojom.String16Spec, nullable: false },
        { name: 'tag', packedOffset: 48, packedBitOffset: 0, type: mojo.internal.String, nullable: false },
        { name: 'image', packedOffset: 56, packedBitOffset: 0, type: url.mojom.UrlSpec, nullable: false },
        { name: 'icon', packedOffset: 64, packedBitOffset: 0, type: url.mojom.UrlSpec, nullable: false },
        { name: 'badge', packedOffset: 72, packedBitOffset: 0, type: url.mojom.UrlSpec, nullable: false },
        ...
        { name: 'renotify', packedOffset: 96, packedBitOffset: 0, type: mojo.internal.Bool, nullable: false },
        { name: 'silent', packedOffset: 96, packedBitOffset: 1, type: mojo.internal.Bool, nullable: false },
        { name: 'require_interaction', packedOffset: 96, packedBitOffset: 2, type: mojo.internal.Bool, nullable: false },
        { name: 'data', packedOffset: 104, packedBitOffset: 0, type: mojo.internal.Array, nullable: true },
        { name: 'actions', packedOffset: 112, packedBitOffset: 0, type: mojo.internal.Array, nullable: true },
        { name: 'show_trigger_timestamp', packedOffset: 120, packedBitOffset: 0, type: mojo_base.mojom.TimeSpec, nullable: true },
        { name: 'scenario', packedOffset: 128, packedBitOffset: 0, type: blink.mojom.NotificationScenarioSpec, nullable: false },
      ],
      versions: [{version: 0}]
    }
  }
...
blink.mojom.NotificationResourcesSpec = {
  $: {
    structSpec: {
      ...
      packedSize: 40,
      fields: [
        { name: 'image', packedOffset: 0, packedBitOffset: 0, type: skia.mojom.BitmapN32Spec, nullable: true },
        { name: 'icon', packedOffset: 8, packedBitOffset: 0, type: skia.mojom.BitmapN32Spec, nullable: true },
        { name: 'badge', packedOffset: 16, packedBitOffset: 0, type: skia.mojom.BitmapN32Spec, nullable: true },
