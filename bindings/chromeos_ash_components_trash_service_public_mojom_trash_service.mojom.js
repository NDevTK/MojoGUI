...
mojo.internal.bindings.ash.trash_service = mojo.internal.bindings.ash.trash_service || {};
mojo.internal.bindings.ash.trash_service.mojom = mojo.internal.bindings.ash.trash_service.mojom || {};
mojo.internal.bindings.mojo_base = mojo.internal.bindings.mojo_base || {};
mojo.internal.bindings.sandbox = mojo.internal.bindings.sandbox || {};

mojo.internal.bindings.ash.trash_service.mojom.TrashService = {};
mojo.internal.bindings.ash.trash_service.mojom.TrashServiceSpec = { $ : {} };
mojo.internal.bindings.ash.trash_service.mojom.TrashService.$interfaceName = 'ash.trash_service.mojom.TrashService';
...
mojo.internal.Struct(
    mojo.internal.bindings.ash.trash_service.mojom.TrashService_ParseTrashInfoFile_ResponseParamsSpec, 'ash.trash_service.mojom.TrashService_ParseTrashInfoFile_ResponseParams', [
      mojo.internal.StructField('arg_restore_path', 0, 0, mojo.internal.bindings.mojo_base.mojom.FilePathSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_deletion_date', 8, 0, mojo.internal.bindings.mojo_base.mojom.TimeSpec, null, false, 0, undefined),
...
mojo.internal.bindings.ash.trash_service.mojom.TrashServiceRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.ash.trash_service.mojom.TrashServicePendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.ash.trash_service.mojom.TrashServiceRemoteCallHandler(this.proxy);
  }
  ...
  parseTrashInfoFile(arg_trash_info_file) {
    return this.$.parseTrashInfoFile(arg_trash_info_file);
  }
};

mojo.internal.bindings.ash.trash_service.mojom.TrashServiceRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('ash.trash_service.mojom.TrashService', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.ash.trash_service.mojom.TrashService.getRemote = function() {
  let remote = new mojo.internal.bindings.ash.trash_service.mojom.TrashServiceRemote();
...
mojo.internal.bindings.ash.trash_service.mojom.TrashServiceReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('ash.trash_service.mojom.TrashService', [
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ash.trash_service.mojom.TrashService_ParseTrashInfoFile_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for ParseTrashInfoFile failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.ash.trash_service.mojom.TrashServiceReceiver = mojo.internal.bindings.ash.trash_service.mojom.TrashServiceReceiver;
