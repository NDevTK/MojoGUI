...
mojo.internal.bindings.ash.settings.graduation.mojom.GraduationHandlerRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.ash.settings.graduation.mojom.GraduationHandlerPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.ash.settings.graduation.mojom.GraduationHandlerRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.ash.settings.graduation.mojom.GraduationHandler.getRemote = function() {
  let remote = new mojo.internal.bindings.ash.settings.graduation.mojom.GraduationHandlerRemote();
...
mojo.internal.bindings.ash.settings.graduation.mojom.GraduationHandlerReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ash.settings.graduation.mojom.GraduationHandler_LaunchGraduationApp_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for LaunchGraduationApp failed with TypeError');
           }
        }
        // Try Method 1: AddObserver
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ash.settings.graduation.mojom.GraduationHandler_AddObserver_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.ash.settings.graduation.mojom.GraduationHandler_LaunchGraduationApp_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.ash.settings.graduation.mojom.GraduationHandlerReceiver = mojo.internal.bindings.ash.settings.graduation.mojom.GraduationHandlerReceiver;

mojo.internal.bindings.ash.settings.graduation.mojom.GraduationHandlerPtr = mojo.internal.bindings.ash.settings.graduation.mojom.GraduationHandlerRemote;
mojo.internal.bindings.ash.settings.graduation.mojom.GraduationHandlerRequest = mojo.internal.bindings.ash.settings.graduation.mojom.GraduationHandlerPendingReceiver;
...
mojo.internal.bindings.ash.settings.graduation.mojom.GraduationObserverRemote = class {
  static get $interfaceName() {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.ash.settings.graduation.mojom.GraduationObserverPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.ash.settings.graduation.mojom.GraduationObserverRemoteCallHandler(this.proxy);
  }
  ...
  onGraduationAppUpdated(arg_is_app_enabled) {
    return this.$.onGraduationAppUpdated(arg_is_app_enabled);
  }
};
...
mojo.internal.bindings.ash.settings.graduation.mojom.GraduationObserver.getRemote = function() {
  let remote = new mojo.internal.bindings.ash.settings.graduation.mojom.GraduationObserverRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
...
mojo.internal.bindings.ash.settings.graduation.mojom.GraduationObserverReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ash.settings.graduation.mojom.GraduationObserver_OnGraduationAppUpdated_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OnGraduationAppUpdated failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
             console.warn('[GeneratedReceiver] Failed to discover ordinal ' + header.ordinal);
...
mojo.internal.bindings.ash.settings.graduation.mojom.GraduationObserverReceiver = mojo.internal.bindings.ash.settings.graduation.mojom.GraduationObserverReceiver;
