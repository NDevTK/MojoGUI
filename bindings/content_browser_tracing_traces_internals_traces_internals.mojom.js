  ...
  $: {
    structSpec: {
      ...
      fields: [
        ...
        { name: 'upload_rule_value_$flag', packedOffset: 32, packedBitOffset: 0, type: mojo.internal.Bool, nullable: false, minVersion: 0, nullableValueKindProperties: { isPrimary: true, linkedValueFieldName: 'upload_rule_value_$value', originalFieldName: 'upload_rule_value' } },
        { name: 'upload_rule_value_$value', packedOffset: 36, packedBitOffset: 0, type: mojo.internal.Int32, nullable: false, minVersion: 0, nullableValueKindProperties: { isPrimary: false, linkedValueFieldName: 'upload_rule_value_$flag', originalFieldName: 'upload_rule_value' } },
        { name: 'total_size', packedOffset: 40, packedBitOffset: 0, type: mojo.internal.Int64, nullable: false, minVersion: 0 },
        { name: 'upload_state', packedOffset: 48, packedBitOffset: 0, type: traces_internals.mojom.ReportUploadStateSpec, nullable: false, minVersion: 0 },
        { name: 'upload_time', packedOffset: 56, packedBitOffset: 0, type: mojo_base.mojom.TimeSpec, nullable: false, minVersion: 0 },
        { name: 'skip_reason', packedOffset: 52, packedBitOffset: 0, type: traces_internals.mojom.SkipUploadReasonSpec, nullable: false, minVersion: 0 },
        { name: 'has_trace_content', packedOffset: 32, packedBitOffset: 1, type: mojo.internal.Bool, nullable: false, minVersion: 0 },
      ],
  ...
  $: {
    structSpec: {
      ...
      fields: [
        ...
        { name: 'is_local_scenario', packedOffset: 16, packedBitOffset: 0, type: mojo.internal.Bool, nullable: false, minVersion: 0 },
        { name: 'is_enabled', packedOffset: 16, packedBitOffset: 1, type: mojo.internal.Bool, nullable: false, minVersion: 0 },
        { name: 'current_state', packedOffset: 20, packedBitOffset: 0, type: traces_internals.mojom.TracingScenarioStateSpec, nullable: false, minVersion: 0 },
      ],
  ...
  $: {
    structSpec: {
      ...
      fields: [
        ...
        { name: 'is_group', packedOffset: 8, packedBitOffset: 0, type: mojo.internal.Bool, nullable: false, minVersion: 0 },
        { name: 'description', packedOffset: 16, packedBitOffset: 0, type: mojo.internal.String, nullable: false, minVersion: 0 },
        { name: 'tags', packedOffset: 24, packedBitOffset: 0, type: mojo.internal.Array(mojo.internal.String, false), nullable: false, minVersion: 0 },
      ],
