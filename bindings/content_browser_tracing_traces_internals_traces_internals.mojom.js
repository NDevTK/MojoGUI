  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.traces_internals.mojom.TracesInternalsHandlerFactory_CreatePageHandler_ParamsSpec.$.structSpec;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.traces_internals.mojom.PageHandler_StartTraceSession_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for StartTraceSession failed with TypeError');
           }
        }
        // Try Method 1: CloneTraceSession
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.traces_internals.mojom.PageHandler_CloneTraceSession_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for CloneTraceSession failed with TypeError');
           }
        }
        // Try Method 2: StopTraceSession
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.traces_internals.mojom.PageHandler_StopTraceSession_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for StopTraceSession failed with TypeError');
           }
        }
        // Try Method 3: GetTrackEventCategories
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.traces_internals.mojom.PageHandler_GetTrackEventCategories_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for GetTrackEventCategories failed with TypeError');
           }
        }
        // Try Method 4: GetBufferUsage
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.traces_internals.mojom.PageHandler_GetBufferUsage_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for GetBufferUsage failed with TypeError');
           }
        }
        // Try Method 5: GetAllTraceReports
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.traces_internals.mojom.PageHandler_GetAllTraceReports_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for GetAllTraceReports failed with TypeError');
           }
        }
        // Try Method 6: DeleteSingleTrace
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.traces_internals.mojom.PageHandler_DeleteSingleTrace_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for DeleteSingleTrace failed with TypeError');
           }
        }
        // Try Method 7: DeleteAllTraces
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.traces_internals.mojom.PageHandler_DeleteAllTraces_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for DeleteAllTraces failed with TypeError');
           }
        }
        // Try Method 8: UserUploadSingleTrace
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.traces_internals.mojom.PageHandler_UserUploadSingleTrace_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for UserUploadSingleTrace failed with TypeError');
           }
        }
        // Try Method 9: DownloadTrace
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.traces_internals.mojom.PageHandler_DownloadTrace_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for DownloadTrace failed with TypeError');
           }
        }
        // Try Method 10: GetAllScenarios
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.traces_internals.mojom.PageHandler_GetAllScenarios_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for GetAllScenarios failed with TypeError');
           }
        }
        // Try Method 11: SetEnabledScenarios
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.traces_internals.mojom.PageHandler_SetEnabledScenarios_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for SetEnabledScenarios failed with TypeError');
           }
        }
        // Try Method 12: SetScenariosConfigFromString
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.traces_internals.mojom.PageHandler_SetScenariosConfigFromString_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for SetScenariosConfigFromString failed with TypeError');
           }
        }
        // Try Method 13: SetScenariosConfigFromBuffer
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.traces_internals.mojom.PageHandler_SetScenariosConfigFromBuffer_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for SetScenariosConfigFromBuffer failed with TypeError');
           }
        }
        // Try Method 14: GetPrivacyFilterEnabled
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.traces_internals.mojom.PageHandler_GetPrivacyFilterEnabled_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for GetPrivacyFilterEnabled failed with TypeError');
           }
        }
        // Try Method 15: SetPrivacyFilterEnabled
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.traces_internals.mojom.PageHandler_SetPrivacyFilterEnabled_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for SetPrivacyFilterEnabled failed with TypeError');
           }
        }
        // Try Method 16: GetSystemTracingState
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.traces_internals.mojom.PageHandler_GetSystemTracingState_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for GetSystemTracingState failed with TypeError');
           }
        }
        // Try Method 17: GetSecurityShieldIconUrl
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.traces_internals.mojom.PageHandler_GetSecurityShieldIconUrl_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for GetSecurityShieldIconUrl failed with TypeError');
           }
        }
        // Try Method 18: EnableSystemTracing
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.traces_internals.mojom.PageHandler_EnableSystemTracing_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for EnableSystemTracing failed with TypeError');
           }
        }
        // Try Method 19: DisableSystemTracing
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.traces_internals.mojom.PageHandler_DisableSystemTracing_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for DisableSystemTracing failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
             console.warn('[GeneratedReceiver] Failed to discover ordinal ' + header.ordinal);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.traces_internals.mojom.Page_OnTraceComplete_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OnTraceComplete failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
             console.warn('[GeneratedReceiver] Failed to discover ordinal ' + header.ordinal);
