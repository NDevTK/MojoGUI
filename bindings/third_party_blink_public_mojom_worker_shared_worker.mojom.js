...
mojo.internal.bindings.blink.mojom.SharedWorkerRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.blink.mojom.SharedWorkerPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.blink.mojom.SharedWorkerRemoteCallHandler(this.proxy);
  }
  ...
  connect(arg_connection_id, arg_message_port) {
    return this.$.connect(arg_connection_id, arg_message_port);
  }
  terminate() {
...
mojo.internal.bindings.blink.mojom.SharedWorkerRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('blink.mojom.SharedWorker', [
      { explicit: null },
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.blink.mojom.SharedWorker.getRemote = function() {
  let remote = new mojo.internal.bindings.blink.mojom.SharedWorkerRemote();
...
mojo.internal.bindings.blink.mojom.SharedWorkerReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('blink.mojom.SharedWorker', [
      { explicit: null },
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.blink.mojom.SharedWorker_Connect_ParamsSpec.$.structSpec;
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.blink.mojom.SharedWorker_Terminate_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for Terminate failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
      ...
      switch (dispatchId) {
        ...
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.blink.mojom.SharedWorker_Terminate_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.blink.mojom.SharedWorkerReceiver = mojo.internal.bindings.blink.mojom.SharedWorkerReceiver;
