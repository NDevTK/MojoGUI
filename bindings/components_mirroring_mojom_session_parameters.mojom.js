...
mirroring.mojom.SessionParametersSpec = {
  $: {
    structSpec: {
      ...
      packedSize: 64,
      fields: [
        { name: 'type', packedOffset: 0, packedBitOffset: 0, type: mirroring.mojom.SessionTypeSpec, nullable: false },
        { name: 'receiver_address', packedOffset: 8, packedBitOffset: 0, type: network.mojom.IPAddressSpec, nullable: false },
        ...
        { name: 'target_playout_delay', packedOffset: 40, packedBitOffset: 0, type: mojo_base.mojom.TimeDeltaSpec, nullable: true },
