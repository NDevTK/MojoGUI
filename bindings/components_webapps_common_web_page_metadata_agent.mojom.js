...
mojo.internal.bindings.webapps.mojom.WebPageMetadataAgent = {};
mojo.internal.bindings.webapps.mojom.WebPageMetadataAgentSpec = { $ : {} };
mojo.internal.bindings.webapps.mojom.WebPageMetadataAgent.$interfaceName = 'webapps.mojom.WebPageMetadataAgent';
...
mojo.internal.bindings.webapps.mojom.WebPageMetadataAgentRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.webapps.mojom.WebPageMetadataAgentPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.webapps.mojom.WebPageMetadataAgentRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.webapps.mojom.WebPageMetadataAgentRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('webapps.mojom.WebPageMetadataAgent', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.webapps.mojom.WebPageMetadataAgent.getRemote = function() {
  let remote = new mojo.internal.bindings.webapps.mojom.WebPageMetadataAgentRemote();
...
mojo.internal.bindings.webapps.mojom.WebPageMetadataAgentReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('webapps.mojom.WebPageMetadataAgent', [
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.webapps.mojom.WebPageMetadataAgent_GetWebPageMetadata_ParamsSpec.$.structSpec);
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.webapps.mojom.WebPageMetadataAgent_GetWebPageMetadata_ParamsSpec.$.structSpec);
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.webapps.mojom.WebPageMetadataAgent_GetWebPageMetadata_ResponseParamsSpec, header, rawHeader);
               responder(response);
...
mojo.internal.bindings.webapps.mojom.WebPageMetadataAgentReceiver = mojo.internal.bindings.webapps.mojom.WebPageMetadataAgentReceiver;
