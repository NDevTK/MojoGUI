...
mojo.internal.bindings.read_anything.mojom.UntrustedPageHandler_RequestReadabilityDistillation_ResponseParamsSpec = mojo.internal.bindings.read_anything.mojom.UntrustedPageHandler_RequestReadabilityDistillation_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.read_anything.mojom.UntrustedPageHandler_RequestReadabilityDistillation_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.read_anything.mojom.UntrustedPageHandler_RequestReadabilityDistillation_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.read_anything.mojom.UntrustedPageHandler_RequestReadabilityDistillation_ResponseParamsSpec.$ = {};
        ...
        case 34: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.read_anything.mojom.UntrustedPageHandler_RequestReadabilityDistillation_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
            }).catch(e => console.error('[GeneratedReceiver] requestReadabilityDistillation FAILED:', e));
          }
          break;
        }
      }
...
mojo.internal.Struct(
    mojo.internal.bindings.read_anything.mojom.UntrustedPageHandler_RequestReadabilityDistillation_ResponseParamsSpec, 'read_anything.mojom.UntrustedPageHandler_RequestReadabilityDistillation_ResponseParams', [
      mojo.internal.StructField('arg_title', 0, 0, mojo.internal.String, null, false, 0, undefined),
      mojo.internal.StructField('arg_content', 8, 0, mojo.internal.bindings.mojo_base.mojom.BigStringSpec, null, false, 0, undefined),
    ],
    [[0, 24]]);
