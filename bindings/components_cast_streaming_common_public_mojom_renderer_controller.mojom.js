...
mojo.internal.bindings.cast_streaming.mojom.RendererControllerRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.cast_streaming.mojom.RendererControllerPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.cast_streaming.mojom.RendererControllerRemoteCallHandler(this.proxy);
  }
  ...
  setPlaybackController(arg_renderer) {
    return this.$.setPlaybackController(arg_renderer);
  }
};

mojo.internal.bindings.cast_streaming.mojom.RendererControllerRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('cast_streaming.mojom.RendererController', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.cast_streaming.mojom.RendererController.getRemote = function() {
  let remote = new mojo.internal.bindings.cast_streaming.mojom.RendererControllerRemote();
...
mojo.internal.bindings.cast_streaming.mojom.RendererControllerReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('cast_streaming.mojom.RendererController', [
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.cast_streaming.mojom.RendererController_SetPlaybackController_ParamsSpec.$.structSpec);
        ...
        case 0: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.cast_streaming.mojom.RendererController_SetPlaybackController_ResponseParamsSpec, header, rawHeader);
               responder(response);
...
mojo.internal.bindings.cast_streaming.mojom.RendererControllerReceiver = mojo.internal.bindings.cast_streaming.mojom.RendererControllerReceiver;
