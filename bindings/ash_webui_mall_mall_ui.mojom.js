...
mojo.internal.bindings.ash.mall.mojom.PageHandlerRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.ash.mall.mojom.PageHandlerPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.ash.mall.mojom.PageHandlerRemoteCallHandler(this.proxy);
  }
  ...
  getMallEmbedUrl(arg_path) {
    return this.$.getMallEmbedUrl(arg_path);
  }
};

mojo.internal.bindings.ash.mall.mojom.PageHandlerRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('ash.mall.mojom.PageHandler', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.ash.mall.mojom.PageHandler.getRemote = function() {
  let remote = new mojo.internal.bindings.ash.mall.mojom.PageHandlerRemote();
...
mojo.internal.bindings.ash.mall.mojom.PageHandlerReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('ash.mall.mojom.PageHandler', [
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.ash.mall.mojom.PageHandler_GetMallEmbedUrl_ParamsSpec.$.structSpec);
        ...
        case 0: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.ash.mall.mojom.PageHandler_GetMallEmbedUrl_ResponseParamsSpec, header, rawHeader);
               responder(response);
...
mojo.internal.bindings.ash.mall.mojom.PageHandlerReceiver = mojo.internal.bindings.ash.mall.mojom.PageHandlerReceiver;
