...
mojo.internal.bindings.extensions.mojom.RendererAutomationRegistry = {};
mojo.internal.bindings.extensions.mojom.RendererAutomationRegistrySpec = { $ : {} };
...
mojo.internal.bindings.extensions.mojom.RendererAutomationRegistryRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.extensions.mojom.RendererAutomationRegistryPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.extensions.mojom.RendererAutomationRegistryRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.extensions.mojom.RendererAutomationRegistryRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('extensions.mojom.RendererAutomationRegistry', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.extensions.mojom.RendererAutomationRegistry.getRemote = function() {
  let remote = new mojo.internal.bindings.extensions.mojom.RendererAutomationRegistryRemote();
...
mojo.internal.bindings.extensions.mojom.RendererAutomationRegistryReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('extensions.mojom.RendererAutomationRegistry', [
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.extensions.mojom.RendererAutomationRegistry_BindAutomation_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for BindAutomation failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.extensions.mojom.RendererAutomationRegistryReceiver = mojo.internal.bindings.extensions.mojom.RendererAutomationRegistryReceiver;
