...
remoting.mojom.DesktopCaptureOptionsSpec = {
  $: {
    structSpec: {
      ...
      packedSize: 24,
      fields: [
        { name: 'use_update_notifications', packedOffset: 0, packedBitOffset: 0, type: mojo.internal.Bool, nullable: false },
        { name: 'detect_updated_region', packedOffset: 0, packedBitOffset: 1, type: mojo.internal.Bool, nullable: false },
        { name: 'allow_directx_capturer', packedOffset: 8, packedBitOffset: 0, type: mojo.internal.Pointer, nullable: false },
      ],
      versions: [{version: 0}]
    }
  }
...
remoting.mojom.DesktopFrameSpec = {
  $: {
    structSpec: {
      ...
      packedSize: 56,
      fields: [
        { name: 'shared_buffer_id', packedOffset: 0, packedBitOffset: 0, type: mojo.internal.Int32, nullable: false },
        { name: 'stride', packedOffset: 4, packedBitOffset: 0, type: mojo.internal.Int32, nullable: false },
        { name: 'size', packedOffset: 8, packedBitOffset: 0, type: remoting.mojom.DesktopSizeSpec, nullable: false },
        { name: 'dirty_region', packedOffset: 16, packedBitOffset: 0, type: mojo.internal.Array, nullable: false },
        { name: 'capture_time_ms', packedOffset: 24, packedBitOffset: 0, type: mojo.internal.Int64, nullable: false },
