...
mojo.internal.bindings.browser_controls_api.mojom.BrowserControlsFactoryRemote = class {
  ...
  constructor(handle = undefined) {
    ...
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.browser_controls_api.mojom.BrowserControlsFactoryRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.browser_controls_api.mojom.BrowserControlsFactoryRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('browser_controls_api.mojom.BrowserControlsFactory', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.browser_controls_api.mojom.BrowserControlsFactory.getRemote = function() {
  let remote = new mojo.internal.bindings.browser_controls_api.mojom.BrowserControlsFactoryRemote();
...
mojo.internal.bindings.browser_controls_api.mojom.BrowserControlsFactoryReceiver = class {
  constructor(impl) {
    ...
    const ordinals = window.mojoScrambler.getOrdinals('browser_controls_api.mojom.BrowserControlsFactory', [
      { explicit: null },
    ]);
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        case 0: {
          ...
          const params = decoder.decodeStructInline(mojo.internal.bindings.browser_controls_api.mojom.BrowserControlsFactory_CreateBrowserControls_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.createBrowserControls');
          const result = this.impl.createBrowserControls(params.arg_observer, params.arg_service);
          break;
        }
      }
      } catch (err) {
...
mojo.internal.bindings.browser_controls_api.mojom.BrowserControlsFactoryReceiver = mojo.internal.bindings.browser_controls_api.mojom.BrowserControlsFactoryReceiver;

mojo.internal.bindings.browser_controls_api.mojom.BrowserControlsFactoryPtr = mojo.internal.bindings.browser_controls_api.mojom.BrowserControlsFactoryRemote;
mojo.internal.bindings.browser_controls_api.mojom.BrowserControlsFactoryRequest = mojo.internal.bindings.browser_controls_api.mojom.BrowserControlsFactoryPendingReceiver;
...
mojo.internal.Struct(
    mojo.internal.bindings.browser_controls_api.mojom.BrowserControlsFactory_CreateBrowserControls_ParamsSpec, 'browser_controls_api.mojom.BrowserControlsFactory_CreateBrowserControls_Params', [
      ...
      mojo.internal.StructField('arg_service', 8, 0, mojo.internal.InterfaceRequest(mojo.internal.bindings.browser_controls_api.mojom.BrowserControlsServicePendingReceiver), null, false, 0, undefined),
    ],
    [[0, 24]]);
