...
mojo.internal.bindings.browser_controls_api.mojom.BrowserControlsObserver_OnTabSplitStatusChanged_ParamsSpec = mojo.internal.bindings.browser_controls_api.mojom.BrowserControlsObserver_OnTabSplitStatusChanged_ParamsSpec || { $: {} };
if (mojo.internal.bindings.browser_controls_api.mojom.BrowserControlsObserver_OnTabSplitStatusChanged_ParamsSpec.$.structSpec && mojo.internal.bindings.browser_controls_api.mojom.BrowserControlsObserver_OnTabSplitStatusChanged_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.browser_controls_api.mojom.BrowserControlsObserver_OnTabSplitStatusChanged_ParamsSpec.$ = {};
mojo.internal.bindings.browser_controls_api.mojom.BrowserControlsObserver_OnButtonPinStateChanged_ParamsSpec = mojo.internal.bindings.browser_controls_api.mojom.BrowserControlsObserver_OnButtonPinStateChanged_ParamsSpec || { $: {} };
if (mojo.internal.bindings.browser_controls_api.mojom.BrowserControlsObserver_OnButtonPinStateChanged_ParamsSpec.$.structSpec && mojo.internal.bindings.browser_controls_api.mojom.BrowserControlsObserver_OnButtonPinStateChanged_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.browser_controls_api.mojom.BrowserControlsObserver_OnButtonPinStateChanged_ParamsSpec.$ = {};
mojo.internal.bindings.browser_controls_api.mojom.BrowserControlsObserver_OnLayoutChanged_ParamsSpec = mojo.internal.bindings.browser_controls_api.mojom.BrowserControlsObserver_OnLayoutChanged_ParamsSpec || { $: {} };
if (mojo.internal.bindings.browser_controls_api.mojom.BrowserControlsObserver_OnLayoutChanged_ParamsSpec.$.structSpec && mojo.internal.bindings.browser_controls_api.mojom.BrowserControlsObserver_OnLayoutChanged_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.browser_controls_api.mojom.BrowserControlsObserver_OnLayoutChanged_ParamsSpec.$ = {};
...
mojo.internal.bindings.browser_controls_api.mojom.BrowserControlsService_AddObserver_ParamsSpec = mojo.internal.bindings.browser_controls_api.mojom.BrowserControlsService_AddObserver_ParamsSpec || { $: {} };
if (mojo.internal.bindings.browser_controls_api.mojom.BrowserControlsService_AddObserver_ParamsSpec.$.structSpec && mojo.internal.bindings.browser_controls_api.mojom.BrowserControlsService_AddObserver_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.browser_controls_api.mojom.BrowserControlsService_AddObserver_ParamsSpec.$ = {};
...
mojo.internal.bindings.browser_controls_api.mojom.BrowserControlsService_SplitActiveTab_ParamsSpec = mojo.internal.bindings.browser_controls_api.mojom.BrowserControlsService_SplitActiveTab_ParamsSpec || { $: {} };
if (mojo.internal.bindings.browser_controls_api.mojom.BrowserControlsService_SplitActiveTab_ParamsSpec.$.structSpec && mojo.internal.bindings.browser_controls_api.mojom.BrowserControlsService_SplitActiveTab_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.browser_controls_api.mojom.BrowserControlsService_SplitActiveTab_ParamsSpec.$ = {};
mojo.internal.bindings.browser_controls_api.mojom.BrowserControlsService_GetTabSplitState_ParamsSpec = mojo.internal.bindings.browser_controls_api.mojom.BrowserControlsService_GetTabSplitState_ParamsSpec || { $: {} };
if (mojo.internal.bindings.browser_controls_api.mojom.BrowserControlsService_GetTabSplitState_ParamsSpec.$.structSpec && mojo.internal.bindings.browser_controls_api.mojom.BrowserControlsService_GetTabSplitState_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.browser_controls_api.mojom.BrowserControlsService_GetTabSplitState_ParamsSpec.$ = {};
mojo.internal.bindings.browser_controls_api.mojom.BrowserControlsService_GetTabSplitState_ResponseParamsSpec = mojo.internal.bindings.browser_controls_api.mojom.BrowserControlsService_GetTabSplitState_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.browser_controls_api.mojom.BrowserControlsService_GetTabSplitState_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.browser_controls_api.mojom.BrowserControlsService_GetTabSplitState_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.browser_controls_api.mojom.BrowserControlsService_GetTabSplitState_ResponseParamsSpec.$ = {};
mojo.internal.bindings.browser_controls_api.mojom.BrowserControlsService_GetButtonPinState_ParamsSpec = mojo.internal.bindings.browser_controls_api.mojom.BrowserControlsService_GetButtonPinState_ParamsSpec || { $: {} };
if (mojo.internal.bindings.browser_controls_api.mojom.BrowserControlsService_GetButtonPinState_ParamsSpec.$.structSpec && mojo.internal.bindings.browser_controls_api.mojom.BrowserControlsService_GetButtonPinState_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.browser_controls_api.mojom.BrowserControlsService_GetButtonPinState_ParamsSpec.$ = {};
mojo.internal.bindings.browser_controls_api.mojom.BrowserControlsService_GetButtonPinState_ResponseParamsSpec = mojo.internal.bindings.browser_controls_api.mojom.BrowserControlsService_GetButtonPinState_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.browser_controls_api.mojom.BrowserControlsService_GetButtonPinState_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.browser_controls_api.mojom.BrowserControlsService_GetButtonPinState_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.browser_controls_api.mojom.BrowserControlsService_GetButtonPinState_ResponseParamsSpec.$ = {};
mojo.internal.bindings.browser_controls_api.mojom.BrowserControlsService_GetLayoutConstants_ParamsSpec = mojo.internal.bindings.browser_controls_api.mojom.BrowserControlsService_GetLayoutConstants_ParamsSpec || { $: {} };
if (mojo.internal.bindings.browser_controls_api.mojom.BrowserControlsService_GetLayoutConstants_ParamsSpec.$.structSpec && mojo.internal.bindings.browser_controls_api.mojom.BrowserControlsService_GetLayoutConstants_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.browser_controls_api.mojom.BrowserControlsService_GetLayoutConstants_ParamsSpec.$ = {};
mojo.internal.bindings.browser_controls_api.mojom.BrowserControlsService_GetLayoutConstants_ResponseParamsSpec = mojo.internal.bindings.browser_controls_api.mojom.BrowserControlsService_GetLayoutConstants_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.browser_controls_api.mojom.BrowserControlsService_GetLayoutConstants_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.browser_controls_api.mojom.BrowserControlsService_GetLayoutConstants_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.browser_controls_api.mojom.BrowserControlsService_GetLayoutConstants_ResponseParamsSpec.$ = {};
...
mojo.internal.bindings.browser_controls_api = mojo.internal.bindings.browser_controls_api || {};
mojo.internal.bindings.browser_controls_api.mojom = mojo.internal.bindings.browser_controls_api.mojom || {};
mojo.internal.bindings.browser_controls_api.mojom.LayoutConstantsSpec = mojo.internal.bindings.browser_controls_api.mojom.LayoutConstantsSpec || { $: mojo.internal.OpaqueStruct.$ };
mojo.internal.bindings.browser_controls_api = mojo.internal.bindings.browser_controls_api || {};
mojo.internal.bindings.browser_controls_api.mojom = mojo.internal.bindings.browser_controls_api.mojom || {};
...
mojo.internal.bindings.browser_controls_api = mojo.internal.bindings.browser_controls_api || {};
mojo.internal.bindings.browser_controls_api.mojom = mojo.internal.bindings.browser_controls_api.mojom || {};
mojo.internal.bindings.browser_controls_api.mojom.SplitTabActiveLocationSpec = mojo.internal.bindings.browser_controls_api.mojom.SplitTabActiveLocationSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.browser_controls_api = mojo.internal.bindings.browser_controls_api || {};
mojo.internal.bindings.browser_controls_api.mojom = mojo.internal.bindings.browser_controls_api.mojom || {};
mojo.internal.bindings.browser_controls_api.mojom.ToolbarButtonTypeSpec = mojo.internal.bindings.browser_controls_api.mojom.ToolbarButtonTypeSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.gfx = mojo.internal.bindings.gfx || {};
...
mojo.internal.bindings.browser_controls_api.mojom.BrowserControlsObserverRemote = class {
  ...
  constructor(handle = undefined) {
    ...
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.browser_controls_api.mojom.BrowserControlsObserverRemoteCallHandler(this.proxy);
  }
  ...
  onTabSplitStatusChanged(arg_is_split, arg_location) {
    return this.$.onTabSplitStatusChanged(arg_is_split, arg_location);
  }
  onButtonPinStateChanged(arg_type, arg_is_pinned) {
    return this.$.onButtonPinStateChanged(arg_type, arg_is_pinned);
  }
  onLayoutChanged(arg_layout_constants) {
    return this.$.onLayoutChanged(arg_layout_constants);
  }
};
...
mojo.internal.bindings.browser_controls_api.mojom.BrowserControlsObserver.getRemote = function() {
  let remote = new mojo.internal.bindings.browser_controls_api.mojom.BrowserControlsObserverRemote();
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        case 0: {
          ...
          const params = decoder.decodeStructInline(mojo.internal.bindings.browser_controls_api.mojom.BrowserControlsObserver_OnDevToolsStatusChanged_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.onDevToolsStatusChanged');
          const result = this.impl.onDevToolsStatusChanged(params.arg_state);
          break;
        }
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
        ...
        case 3: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.browser_controls_api.mojom.BrowserControlsObserver_OnTabSplitStatusChanged_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.onTabSplitStatusChanged');
          const result = this.impl.onTabSplitStatusChanged(params.arg_is_split, params.arg_location);
          break;
        }
        case 4: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.browser_controls_api.mojom.BrowserControlsObserver_OnButtonPinStateChanged_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.onButtonPinStateChanged');
          const result = this.impl.onButtonPinStateChanged(params.arg_type, params.arg_is_pinned);
          break;
        }
        case 5: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.browser_controls_api.mojom.BrowserControlsObserver_OnLayoutChanged_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.onLayoutChanged');
          const result = this.impl.onLayoutChanged(params.arg_layout_constants);
          break;
        }
      }
      } catch (err) {
...
mojo.internal.bindings.browser_controls_api.mojom.BrowserControlsObserverReceiver = mojo.internal.bindings.browser_controls_api.mojom.BrowserControlsObserverReceiver;

mojo.internal.bindings.browser_controls_api.mojom.BrowserControlsObserverPtr = mojo.internal.bindings.browser_controls_api.mojom.BrowserControlsObserverRemote;
mojo.internal.bindings.browser_controls_api.mojom.BrowserControlsObserverRequest = mojo.internal.bindings.browser_controls_api.mojom.BrowserControlsObserverPendingReceiver;
...
mojo.internal.bindings.browser_controls_api.mojom.BrowserControlsServiceRemote = class {
  ...
  constructor(handle = undefined) {
    ...
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.browser_controls_api.mojom.BrowserControlsServiceRemoteCallHandler(this.proxy);
  }
  ...
  splitActiveTab() {
    return this.$.splitActiveTab();
  }
  getTabSplitState() {
    return this.$.getTabSplitState();
  }
  getButtonPinState(arg_type) {
    return this.$.getButtonPinState(arg_type);
  }
  getLayoutConstants() {
    return this.$.getLayoutConstants();
  }
};
...
mojo.internal.bindings.browser_controls_api.mojom.BrowserControlsServiceRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('browser_controls_api.mojom.BrowserControlsService', [
      { explicit: null },
      { explicit: null },
      { explicit: null },
      { explicit: null },
...
mojo.internal.bindings.browser_controls_api.mojom.BrowserControlsService.getRemote = function() {
  let remote = new mojo.internal.bindings.browser_controls_api.mojom.BrowserControlsServiceRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
...
mojo.internal.bindings.browser_controls_api.mojom.BrowserControlsServiceReceiver = class {
  constructor(impl) {
    ...
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('browser_controls_api.mojom.BrowserControlsService', [
      { explicit: null },
      { explicit: null },
      { explicit: null },
      { explicit: null },
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.browser_controls_api.mojom.BrowserControlsService_AddObserver_ParamsSpec.$.structSpec);
        ...
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.browser_controls_api.mojom.BrowserControlsService_StopLoad_ParamsSpec.$.structSpec);
        ...
        case 2: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.browser_controls_api.mojom.BrowserControlsService_ShowContextMenu_ParamsSpec.$.structSpec);
        ...
        case 3: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.browser_controls_api.mojom.BrowserControlsService_OnPageInitialized_ParamsSpec.$.structSpec);
        ...
        case 4: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.browser_controls_api.mojom.BrowserControlsService_ReloadFromClick_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.reloadFromClick');
          const result = this.impl.reloadFromClick(params.arg_bypass_cache, params.arg_click_flags);
          break;
        }
        case 5: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.browser_controls_api.mojom.BrowserControlsService_SplitActiveTab_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.splitActiveTab');
          const result = this.impl.splitActiveTab();
          break;
        }
        case 6: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.browser_controls_api.mojom.BrowserControlsService_GetTabSplitState_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.getTabSplitState');
          const result = this.impl.getTabSplitState();
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const message = new mojo.internal.Message(
                ...
                header.ordinal, header.requestId, mojo.internal.bindings.browser_controls_api.mojom.BrowserControlsService_GetTabSplitState_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
            }).catch(e => console.error('[GeneratedReceiver] getTabSplitState FAILED:', e));
          }
          break;
        }
        case 7: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.browser_controls_api.mojom.BrowserControlsService_GetButtonPinState_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.getButtonPinState');
          const result = this.impl.getButtonPinState(params.arg_type);
          const expectsResponse = header.expectsResponse || (header.flags & 1);
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              const val = (response && typeof response === 'object' && 'arg_is_pinned' in response) ? response['arg_is_pinned'] : response;
              const resp_obj = { 'arg_is_pinned': val };
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.browser_controls_api.mojom.BrowserControlsService_GetButtonPinState_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
            }).catch(e => console.error('[GeneratedReceiver] getButtonPinState FAILED:', e));
          }
          break;
        }
        case 8: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.browser_controls_api.mojom.BrowserControlsService_GetLayoutConstants_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.getLayoutConstants');
          const result = this.impl.getLayoutConstants();
          const expectsResponse = header.expectsResponse || (header.flags & 1);
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              const val = (response && typeof response === 'object' && 'arg_layout_constants' in response) ? response['arg_layout_constants'] : response;
              const resp_obj = { 'arg_layout_constants': val };
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.browser_controls_api.mojom.BrowserControlsService_GetLayoutConstants_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
            }).catch(e => console.error('[GeneratedReceiver] getLayoutConstants FAILED:', e));
          }
          break;
        }
      }
...
mojo.internal.bindings.browser_controls_api.mojom.BrowserControlsServiceReceiver = mojo.internal.bindings.browser_controls_api.mojom.BrowserControlsServiceReceiver;

mojo.internal.bindings.browser_controls_api.mojom.BrowserControlsServicePtr = mojo.internal.bindings.browser_controls_api.mojom.BrowserControlsServiceRemote;
mojo.internal.bindings.browser_controls_api.mojom.BrowserControlsServiceRequest = mojo.internal.bindings.browser_controls_api.mojom.BrowserControlsServicePendingReceiver;


// Specs (at the end to ensure classes are defined for InterfaceProxy)
mojo.internal.Struct(
    mojo.internal.bindings.browser_controls_api.mojom.BrowserControlsObserver_OnDevToolsStatusChanged_ParamsSpec, 'browser_controls_api.mojom.BrowserControlsObserver_OnDevToolsStatusChanged_Params', [
      mojo.internal.StructField('arg_state', 0, 0, mojo.internal.bindings.browser_controls_api.mojom.DevToolsStateSpec, null, false, 0, undefined),
    ],
    [[0, 16]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.browser_controls_api.mojom.BrowserControlsObserver_OnTabSplitStatusChanged_ParamsSpec, 'browser_controls_api.mojom.BrowserControlsObserver_OnTabSplitStatusChanged_Params', [
      mojo.internal.StructField('arg_is_split', 0, 0, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_location', 4, 0, mojo.internal.bindings.browser_controls_api.mojom.SplitTabActiveLocationSpec, null, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.browser_controls_api.mojom.BrowserControlsObserver_OnButtonPinStateChanged_ParamsSpec, 'browser_controls_api.mojom.BrowserControlsObserver_OnButtonPinStateChanged_Params', [
      mojo.internal.StructField('arg_type', 0, 0, mojo.internal.bindings.browser_controls_api.mojom.ToolbarButtonTypeSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_is_pinned', 4, 0, mojo.internal.Bool, false, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.browser_controls_api.mojom.BrowserControlsObserver_OnLayoutChanged_ParamsSpec, 'browser_controls_api.mojom.BrowserControlsObserver_OnLayoutChanged_Params', [
      mojo.internal.StructField('arg_layout_constants', 0, 0, mojo.internal.bindings.browser_controls_api.mojom.LayoutConstantsSpec, null, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.browser_controls_api.mojom.BrowserControlsService_AddObserver_ParamsSpec, 'browser_controls_api.mojom.BrowserControlsService_AddObserver_Params', [
      mojo.internal.StructField('arg_observer', 0, 0, mojo.internal.InterfaceProxy(mojo.internal.bindings.browser_controls_api.mojom.BrowserControlsObserverRemote), null, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.browser_controls_api.mojom.BrowserControlsService_StopLoad_ParamsSpec, 'browser_controls_api.mojom.BrowserControlsService_StopLoad_Params', [
    ],
    [[0, 8]]);

mojo.internal.Struct(
    mojo.internal.bindings.browser_controls_api.mojom.BrowserControlsService_ShowContextMenu_ParamsSpec, 'browser_controls_api.mojom.BrowserControlsService_ShowContextMenu_Params', [
      mojo.internal.StructField('arg_menu_type', 0, 0, mojo.internal.bindings.browser_controls_api.mojom.ContextMenuTypeSpec, null, false, 0, undefined),
...
mojo.internal.Struct(
    mojo.internal.bindings.browser_controls_api.mojom.BrowserControlsService_OnPageInitialized_ParamsSpec, 'browser_controls_api.mojom.BrowserControlsService_OnPageInitialized_Params', [
    ],
    [[0, 8]]);

mojo.internal.Struct(
    mojo.internal.bindings.browser_controls_api.mojom.BrowserControlsService_ReloadFromClick_ParamsSpec, 'browser_controls_api.mojom.BrowserControlsService_ReloadFromClick_Params', [
      mojo.internal.StructField('arg_bypass_cache', 0, 0, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_click_flags', 8, 0, mojo.internal.Array(mojo.internal.bindings.browser_controls_api.mojom.ClickDispositionFlagSpec, false), null, false, 0, undefined),
    ],
    [[0, 24]]);

mojo.internal.Struct(
    mojo.internal.bindings.browser_controls_api.mojom.BrowserControlsService_SplitActiveTab_ParamsSpec, 'browser_controls_api.mojom.BrowserControlsService_SplitActiveTab_Params', [
    ],
    [[0, 8]]);

mojo.internal.Struct(
    mojo.internal.bindings.browser_controls_api.mojom.BrowserControlsService_GetTabSplitState_ParamsSpec, 'browser_controls_api.mojom.BrowserControlsService_GetTabSplitState_Params', [
    ],
    [[0, 8]]);

mojo.internal.Struct(
    mojo.internal.bindings.browser_controls_api.mojom.BrowserControlsService_GetTabSplitState_ResponseParamsSpec, 'browser_controls_api.mojom.BrowserControlsService_GetTabSplitState_ResponseParams', [
      mojo.internal.StructField('arg_is_split', 0, 0, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_location', 4, 0, mojo.internal.bindings.browser_controls_api.mojom.SplitTabActiveLocationSpec, null, false, 0, undefined),
    ],
    [[0, 16]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.browser_controls_api.mojom.BrowserControlsService_GetButtonPinState_ParamsSpec, 'browser_controls_api.mojom.BrowserControlsService_GetButtonPinState_Params', [
      mojo.internal.StructField('arg_type', 0, 0, mojo.internal.bindings.browser_controls_api.mojom.ToolbarButtonTypeSpec, null, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.browser_controls_api.mojom.BrowserControlsService_GetButtonPinState_ResponseParamsSpec, 'browser_controls_api.mojom.BrowserControlsService_GetButtonPinState_ResponseParams', [
      mojo.internal.StructField('arg_is_pinned', 0, 0, mojo.internal.Bool, false, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.browser_controls_api.mojom.BrowserControlsService_GetLayoutConstants_ParamsSpec, 'browser_controls_api.mojom.BrowserControlsService_GetLayoutConstants_Params', [
    ],
    [[0, 8]]);

mojo.internal.Struct(
    mojo.internal.bindings.browser_controls_api.mojom.BrowserControlsService_GetLayoutConstants_ResponseParamsSpec, 'browser_controls_api.mojom.BrowserControlsService_GetLayoutConstants_ResponseParams', [
      mojo.internal.StructField('arg_layout_constants', 0, 0, mojo.internal.bindings.browser_controls_api.mojom.LayoutConstantsSpec, null, false, 0, undefined),
    ],
    [[0, 16]]);
