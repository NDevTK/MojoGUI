...
mojo.internal.bindings.media.mojom.RemoterFactory = mojo.internal.bindings.media.mojom.RemoterFactory || {};
mojo.internal.bindings.media.mojom.RemoterFactorySpec = mojo.internal.bindings.media.mojom.RemoterFactorySpec || { $ : {} };
if (mojo.internal.bindings.media.mojom.RemoterFactorySpec.$.structSpec && mojo.internal.bindings.media.mojom.RemoterFactorySpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.media.mojom.RemoterFactorySpec.$ = {};
mojo.internal.bindings.media.mojom.RemoterFactory.$interfaceName = 'media.mojom.RemoterFactory';
mojo.internal.bindings.media.mojom.RemoterFactory_Create_ParamsSpec = mojo.internal.bindings.media.mojom.RemoterFactory_Create_ParamsSpec || { $: {} };
if (mojo.internal.bindings.media.mojom.RemoterFactory_Create_ParamsSpec.$.structSpec && mojo.internal.bindings.media.mojom.RemoterFactory_Create_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.media.mojom.RemoterFactory_Create_ParamsSpec.$ = {};
mojo.internal.bindings.media.mojom.RemotingDataStreamSender = mojo.internal.bindings.media.mojom.RemotingDataStreamSender || {};
mojo.internal.bindings.media.mojom.RemotingDataStreamSenderSpec = mojo.internal.bindings.media.mojom.RemotingDataStreamSenderSpec || { $ : {} };
if (mojo.internal.bindings.media.mojom.RemotingDataStreamSenderSpec.$.structSpec && mojo.internal.bindings.media.mojom.RemotingDataStreamSenderSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.media.mojom.RemotingDataStreamSenderSpec.$ = {};
mojo.internal.bindings.media.mojom.RemotingDataStreamSender.$interfaceName = 'media.mojom.RemotingDataStreamSender';
mojo.internal.bindings.media.mojom.RemotingDataStreamSender_SendFrame_ParamsSpec = mojo.internal.bindings.media.mojom.RemotingDataStreamSender_SendFrame_ParamsSpec || { $: {} };
if (mojo.internal.bindings.media.mojom.RemotingDataStreamSender_SendFrame_ParamsSpec.$.structSpec && mojo.internal.bindings.media.mojom.RemotingDataStreamSender_SendFrame_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.media.mojom.RemotingDataStreamSender_SendFrame_ParamsSpec.$ = {};
mojo.internal.bindings.media.mojom.RemotingDataStreamSender_SendFrame_ResponseParamsSpec = mojo.internal.bindings.media.mojom.RemotingDataStreamSender_SendFrame_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.media.mojom.RemotingDataStreamSender_SendFrame_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.media.mojom.RemotingDataStreamSender_SendFrame_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.media.mojom.RemotingDataStreamSender_SendFrame_ResponseParamsSpec.$ = {};
mojo.internal.bindings.media.mojom.RemotingDataStreamSender_CancelInFlightData_ParamsSpec = mojo.internal.bindings.media.mojom.RemotingDataStreamSender_CancelInFlightData_ParamsSpec || { $: {} };
if (mojo.internal.bindings.media.mojom.RemotingDataStreamSender_CancelInFlightData_ParamsSpec.$.structSpec && mojo.internal.bindings.media.mojom.RemotingDataStreamSender_CancelInFlightData_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.media.mojom.RemotingDataStreamSender_CancelInFlightData_ParamsSpec.$ = {};
mojo.internal.bindings.media.mojom.Remoter = mojo.internal.bindings.media.mojom.Remoter || {};
mojo.internal.bindings.media.mojom.RemoterSpec = mojo.internal.bindings.media.mojom.RemoterSpec || { $ : {} };
if (mojo.internal.bindings.media.mojom.RemoterSpec.$.structSpec && mojo.internal.bindings.media.mojom.RemoterSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.media.mojom.RemoterSpec.$ = {};
mojo.internal.bindings.media.mojom.Remoter.$interfaceName = 'media.mojom.Remoter';
mojo.internal.bindings.media.mojom.Remoter_Start_ParamsSpec = mojo.internal.bindings.media.mojom.Remoter_Start_ParamsSpec || { $: {} };
if (mojo.internal.bindings.media.mojom.Remoter_Start_ParamsSpec.$.structSpec && mojo.internal.bindings.media.mojom.Remoter_Start_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.media.mojom.Remoter_Start_ParamsSpec.$ = {};
mojo.internal.bindings.media.mojom.Remoter_StartWithPermissionAlreadyGranted_ParamsSpec = mojo.internal.bindings.media.mojom.Remoter_StartWithPermissionAlreadyGranted_ParamsSpec || { $: {} };
if (mojo.internal.bindings.media.mojom.Remoter_StartWithPermissionAlreadyGranted_ParamsSpec.$.structSpec && mojo.internal.bindings.media.mojom.Remoter_StartWithPermissionAlreadyGranted_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.media.mojom.Remoter_StartWithPermissionAlreadyGranted_ParamsSpec.$ = {};
mojo.internal.bindings.media.mojom.Remoter_StartDataStreams_ParamsSpec = mojo.internal.bindings.media.mojom.Remoter_StartDataStreams_ParamsSpec || { $: {} };
if (mojo.internal.bindings.media.mojom.Remoter_StartDataStreams_ParamsSpec.$.structSpec && mojo.internal.bindings.media.mojom.Remoter_StartDataStreams_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.media.mojom.Remoter_StartDataStreams_ParamsSpec.$ = {};
mojo.internal.bindings.media.mojom.Remoter_Stop_ParamsSpec = mojo.internal.bindings.media.mojom.Remoter_Stop_ParamsSpec || { $: {} };
if (mojo.internal.bindings.media.mojom.Remoter_Stop_ParamsSpec.$.structSpec && mojo.internal.bindings.media.mojom.Remoter_Stop_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.media.mojom.Remoter_Stop_ParamsSpec.$ = {};
mojo.internal.bindings.media.mojom.Remoter_SendMessageToSink_ParamsSpec = mojo.internal.bindings.media.mojom.Remoter_SendMessageToSink_ParamsSpec || { $: {} };
if (mojo.internal.bindings.media.mojom.Remoter_SendMessageToSink_ParamsSpec.$.structSpec && mojo.internal.bindings.media.mojom.Remoter_SendMessageToSink_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.media.mojom.Remoter_SendMessageToSink_ParamsSpec.$ = {};
mojo.internal.bindings.media.mojom.Remoter_EstimateTransmissionCapacity_ParamsSpec = mojo.internal.bindings.media.mojom.Remoter_EstimateTransmissionCapacity_ParamsSpec || { $: {} };
if (mojo.internal.bindings.media.mojom.Remoter_EstimateTransmissionCapacity_ParamsSpec.$.structSpec && mojo.internal.bindings.media.mojom.Remoter_EstimateTransmissionCapacity_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.media.mojom.Remoter_EstimateTransmissionCapacity_ParamsSpec.$ = {};
mojo.internal.bindings.media.mojom.Remoter_EstimateTransmissionCapacity_ResponseParamsSpec = mojo.internal.bindings.media.mojom.Remoter_EstimateTransmissionCapacity_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.media.mojom.Remoter_EstimateTransmissionCapacity_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.media.mojom.Remoter_EstimateTransmissionCapacity_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.media.mojom.Remoter_EstimateTransmissionCapacity_ResponseParamsSpec.$ = {};
mojo.internal.bindings.media.mojom.RemotingSource = mojo.internal.bindings.media.mojom.RemotingSource || {};
mojo.internal.bindings.media.mojom.RemotingSourceSpec = mojo.internal.bindings.media.mojom.RemotingSourceSpec || { $ : {} };
if (mojo.internal.bindings.media.mojom.RemotingSourceSpec.$.structSpec && mojo.internal.bindings.media.mojom.RemotingSourceSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.media.mojom.RemotingSourceSpec.$ = {};
mojo.internal.bindings.media.mojom.RemotingSource.$interfaceName = 'media.mojom.RemotingSource';
mojo.internal.bindings.media.mojom.RemotingSource_OnSinkAvailable_ParamsSpec = mojo.internal.bindings.media.mojom.RemotingSource_OnSinkAvailable_ParamsSpec || { $: {} };
if (mojo.internal.bindings.media.mojom.RemotingSource_OnSinkAvailable_ParamsSpec.$.structSpec && mojo.internal.bindings.media.mojom.RemotingSource_OnSinkAvailable_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.media.mojom.RemotingSource_OnSinkAvailable_ParamsSpec.$ = {};
mojo.internal.bindings.media.mojom.RemotingSource_OnSinkGone_ParamsSpec = mojo.internal.bindings.media.mojom.RemotingSource_OnSinkGone_ParamsSpec || { $: {} };
if (mojo.internal.bindings.media.mojom.RemotingSource_OnSinkGone_ParamsSpec.$.structSpec && mojo.internal.bindings.media.mojom.RemotingSource_OnSinkGone_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.media.mojom.RemotingSource_OnSinkGone_ParamsSpec.$ = {};
mojo.internal.bindings.media.mojom.RemotingSource_OnStarted_ParamsSpec = mojo.internal.bindings.media.mojom.RemotingSource_OnStarted_ParamsSpec || { $: {} };
if (mojo.internal.bindings.media.mojom.RemotingSource_OnStarted_ParamsSpec.$.structSpec && mojo.internal.bindings.media.mojom.RemotingSource_OnStarted_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.media.mojom.RemotingSource_OnStarted_ParamsSpec.$ = {};
mojo.internal.bindings.media.mojom.RemotingSource_OnStartFailed_ParamsSpec = mojo.internal.bindings.media.mojom.RemotingSource_OnStartFailed_ParamsSpec || { $: {} };
if (mojo.internal.bindings.media.mojom.RemotingSource_OnStartFailed_ParamsSpec.$.structSpec && mojo.internal.bindings.media.mojom.RemotingSource_OnStartFailed_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.media.mojom.RemotingSource_OnStartFailed_ParamsSpec.$ = {};
mojo.internal.bindings.media.mojom.RemotingSource_OnMessageFromSink_ParamsSpec = mojo.internal.bindings.media.mojom.RemotingSource_OnMessageFromSink_ParamsSpec || { $: {} };
if (mojo.internal.bindings.media.mojom.RemotingSource_OnMessageFromSink_ParamsSpec.$.structSpec && mojo.internal.bindings.media.mojom.RemotingSource_OnMessageFromSink_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.media.mojom.RemotingSource_OnMessageFromSink_ParamsSpec.$ = {};
mojo.internal.bindings.media.mojom.RemotingSource_OnStopped_ParamsSpec = mojo.internal.bindings.media.mojom.RemotingSource_OnStopped_ParamsSpec || { $: {} };
if (mojo.internal.bindings.media.mojom.RemotingSource_OnStopped_ParamsSpec.$.structSpec && mojo.internal.bindings.media.mojom.RemotingSource_OnStopped_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.media.mojom.RemotingSource_OnStopped_ParamsSpec.$ = {};
mojo.internal.bindings.media.mojom.Remotee = mojo.internal.bindings.media.mojom.Remotee || {};
mojo.internal.bindings.media.mojom.RemoteeSpec = mojo.internal.bindings.media.mojom.RemoteeSpec || { $ : {} };
if (mojo.internal.bindings.media.mojom.RemoteeSpec.$.structSpec && mojo.internal.bindings.media.mojom.RemoteeSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.media.mojom.RemoteeSpec.$ = {};
mojo.internal.bindings.media.mojom.Remotee.$interfaceName = 'media.mojom.Remotee';
mojo.internal.bindings.media.mojom.Remotee_OnRemotingSinkReady_ParamsSpec = mojo.internal.bindings.media.mojom.Remotee_OnRemotingSinkReady_ParamsSpec || { $: {} };
if (mojo.internal.bindings.media.mojom.Remotee_OnRemotingSinkReady_ParamsSpec.$.structSpec && mojo.internal.bindings.media.mojom.Remotee_OnRemotingSinkReady_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.media.mojom.Remotee_OnRemotingSinkReady_ParamsSpec.$ = {};
mojo.internal.bindings.media.mojom.Remotee_SendMessageToSource_ParamsSpec = mojo.internal.bindings.media.mojom.Remotee_SendMessageToSource_ParamsSpec || { $: {} };
if (mojo.internal.bindings.media.mojom.Remotee_SendMessageToSource_ParamsSpec.$.structSpec && mojo.internal.bindings.media.mojom.Remotee_SendMessageToSource_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.media.mojom.Remotee_SendMessageToSource_ParamsSpec.$ = {};
mojo.internal.bindings.media.mojom.Remotee_StartDataStreams_ParamsSpec = mojo.internal.bindings.media.mojom.Remotee_StartDataStreams_ParamsSpec || { $: {} };
if (mojo.internal.bindings.media.mojom.Remotee_StartDataStreams_ParamsSpec.$.structSpec && mojo.internal.bindings.media.mojom.Remotee_StartDataStreams_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.media.mojom.Remotee_StartDataStreams_ParamsSpec.$ = {};
mojo.internal.bindings.media.mojom.Remotee_OnFlushUntil_ParamsSpec = mojo.internal.bindings.media.mojom.Remotee_OnFlushUntil_ParamsSpec || { $: {} };
if (mojo.internal.bindings.media.mojom.Remotee_OnFlushUntil_ParamsSpec.$.structSpec && mojo.internal.bindings.media.mojom.Remotee_OnFlushUntil_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.media.mojom.Remotee_OnFlushUntil_ParamsSpec.$ = {};
mojo.internal.bindings.media.mojom.Remotee_OnVideoNaturalSizeChange_ParamsSpec = mojo.internal.bindings.media.mojom.Remotee_OnVideoNaturalSizeChange_ParamsSpec || { $: {} };
if (mojo.internal.bindings.media.mojom.Remotee_OnVideoNaturalSizeChange_ParamsSpec.$.structSpec && mojo.internal.bindings.media.mojom.Remotee_OnVideoNaturalSizeChange_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.media.mojom.Remotee_OnVideoNaturalSizeChange_ParamsSpec.$ = {};
mojo.internal.bindings.media.mojom.RemotingSink = mojo.internal.bindings.media.mojom.RemotingSink || {};
mojo.internal.bindings.media.mojom.RemotingSinkSpec = mojo.internal.bindings.media.mojom.RemotingSinkSpec || { $ : {} };
if (mojo.internal.bindings.media.mojom.RemotingSinkSpec.$.structSpec && mojo.internal.bindings.media.mojom.RemotingSinkSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.media.mojom.RemotingSinkSpec.$ = {};
mojo.internal.bindings.media.mojom.RemotingSink.$interfaceName = 'media.mojom.RemotingSink';
mojo.internal.bindings.media.mojom.RemotingSink_OnMessageFromSource_ParamsSpec = mojo.internal.bindings.media.mojom.RemotingSink_OnMessageFromSource_ParamsSpec || { $: {} };
if (mojo.internal.bindings.media.mojom.RemotingSink_OnMessageFromSource_ParamsSpec.$.structSpec && mojo.internal.bindings.media.mojom.RemotingSink_OnMessageFromSource_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.media.mojom.RemotingSink_OnMessageFromSource_ParamsSpec.$ = {};
mojo.internal.bindings.media.mojom.RemotingDataStreamReceiver = mojo.internal.bindings.media.mojom.RemotingDataStreamReceiver || {};
mojo.internal.bindings.media.mojom.RemotingDataStreamReceiverSpec = mojo.internal.bindings.media.mojom.RemotingDataStreamReceiverSpec || { $ : {} };
if (mojo.internal.bindings.media.mojom.RemotingDataStreamReceiverSpec.$.structSpec && mojo.internal.bindings.media.mojom.RemotingDataStreamReceiverSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.media.mojom.RemotingDataStreamReceiverSpec.$ = {};
mojo.internal.bindings.media.mojom.RemotingDataStreamReceiver.$interfaceName = 'media.mojom.RemotingDataStreamReceiver';
mojo.internal.bindings.media.mojom.RemotingDataStreamReceiver_InitializeDataPipe_ParamsSpec = mojo.internal.bindings.media.mojom.RemotingDataStreamReceiver_InitializeDataPipe_ParamsSpec || { $: {} };
if (mojo.internal.bindings.media.mojom.RemotingDataStreamReceiver_InitializeDataPipe_ParamsSpec.$.structSpec && mojo.internal.bindings.media.mojom.RemotingDataStreamReceiver_InitializeDataPipe_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.media.mojom.RemotingDataStreamReceiver_InitializeDataPipe_ParamsSpec.$ = {};
mojo.internal.bindings.media.mojom.RemotingDataStreamReceiver_ReceiveFrame_ParamsSpec = mojo.internal.bindings.media.mojom.RemotingDataStreamReceiver_ReceiveFrame_ParamsSpec || { $: {} };
if (mojo.internal.bindings.media.mojom.RemotingDataStreamReceiver_ReceiveFrame_ParamsSpec.$.structSpec && mojo.internal.bindings.media.mojom.RemotingDataStreamReceiver_ReceiveFrame_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.media.mojom.RemotingDataStreamReceiver_ReceiveFrame_ParamsSpec.$ = {};
mojo.internal.bindings.media.mojom.RemotingDataStreamReceiver_FlushUntil_ParamsSpec = mojo.internal.bindings.media.mojom.RemotingDataStreamReceiver_FlushUntil_ParamsSpec || { $: {} };
if (mojo.internal.bindings.media.mojom.RemotingDataStreamReceiver_FlushUntil_ParamsSpec.$.structSpec && mojo.internal.bindings.media.mojom.RemotingDataStreamReceiver_FlushUntil_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.media.mojom.RemotingDataStreamReceiver_FlushUntil_ParamsSpec.$ = {};
...
mojo.internal.bindings.media.mojom.RemoterFactoryRemote = class {
  ...
  constructor(handle = undefined) {
    ...
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.media.mojom.RemoterFactoryPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.media.mojom.RemoterFactoryRemoteCallHandler(this.proxy);
  }
  ...
  create(arg_source, arg_remoter) {
    return this.$.create(arg_source, arg_remoter);
  }
};
...
mojo.internal.bindings.media.mojom.RemoterFactoryRemoteCallHandler = class {
  ...
  create(arg_source, arg_remoter) {
    return this.proxy.sendMessage(
      ...
      null,
      [arg_source, arg_remoter],
      false);
  }

};

mojo.internal.bindings.media.mojom.RemoterFactory.getRemote = function() {
  let remote = new mojo.internal.bindings.media.mojom.RemoterFactoryRemote();
...
mojo.internal.bindings.media.mojom.RemoterFactoryReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
...
mojo.internal.bindings.media.mojom.RemoterFactoryReceiver = mojo.internal.bindings.media.mojom.RemoterFactoryReceiver;

mojo.internal.bindings.media.mojom.RemoterFactoryPtr = mojo.internal.bindings.media.mojom.RemoterFactoryRemote;
mojo.internal.bindings.media.mojom.RemoterFactoryRequest = mojo.internal.bindings.media.mojom.RemoterFactoryPendingReceiver;
...
mojo.internal.bindings.media.mojom.RemotingDataStreamSenderRemote = class {
  static get $interfaceName() {
  ...
  constructor(handle = undefined) {
    this.__mojoHandle = handle;
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.media.mojom.RemotingDataStreamSenderPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.media.mojom.RemotingDataStreamSenderRemoteCallHandler(this.proxy);
  }
  ...
  sendFrame(arg_frame) {
    return this.$.sendFrame(arg_frame);
  }
  cancelInFlightData() {
...
mojo.internal.bindings.media.mojom.RemotingDataStreamSender.getRemote = function() {
  let remote = new mojo.internal.bindings.media.mojom.RemotingDataStreamSenderRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
...
mojo.internal.bindings.media.mojom.RemotingDataStreamSenderReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        ...
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.media.mojom.RemotingDataStreamSender_CancelInFlightData_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.media.mojom.RemotingDataStreamSenderReceiver = mojo.internal.bindings.media.mojom.RemotingDataStreamSenderReceiver;

mojo.internal.bindings.media.mojom.RemotingDataStreamSenderPtr = mojo.internal.bindings.media.mojom.RemotingDataStreamSenderRemote;
mojo.internal.bindings.media.mojom.RemotingDataStreamSenderRequest = mojo.internal.bindings.media.mojom.RemotingDataStreamSenderPendingReceiver;
...
mojo.internal.bindings.media.mojom.RemoterRemote = class {
  static get $interfaceName() {
  ...
  constructor(handle = undefined) {
    this.__mojoHandle = handle;
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.media.mojom.RemoterPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.media.mojom.RemoterRemoteCallHandler(this.proxy);
  }
  ...
  startDataStreams(arg_audio_pipe, arg_video_pipe, arg_audio_sender, arg_video_sender) {
    return this.$.startDataStreams(arg_audio_pipe, arg_video_pipe, arg_audio_sender, arg_video_sender);
  }
  stop(arg_reason) {
    return this.$.stop(arg_reason);
  }
  sendMessageToSink(arg_message) {
    return this.$.sendMessageToSink(arg_message);
  }
...
mojo.internal.bindings.media.mojom.RemoterRemoteCallHandler = class {
  ...
  startDataStreams(arg_audio_pipe, arg_video_pipe, arg_audio_sender, arg_video_sender) {
    return this.proxy.sendMessage(
      ...
      mojo.internal.bindings.media.mojom.Remoter_StartDataStreams_ParamsSpec,
      null,
      [arg_audio_pipe, arg_video_pipe, arg_audio_sender, arg_video_sender],
      false);
  }
  ...
  stop(arg_reason) {
    return this.proxy.sendMessage(
      ...
      mojo.internal.bindings.media.mojom.Remoter_Stop_ParamsSpec,
      null,
      [arg_reason],
      false);
  }
  ...
  sendMessageToSink(arg_message) {
    return this.proxy.sendMessage(
      ...
      mojo.internal.bindings.media.mojom.Remoter_SendMessageToSink_ParamsSpec,
      null,
      [arg_message],
      false);
  }
...
mojo.internal.bindings.media.mojom.Remoter.getRemote = function() {
  let remote = new mojo.internal.bindings.media.mojom.RemoterRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
    'media.mojom.Remoter',
...
mojo.internal.bindings.media.mojom.RemoterReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.media.mojom.Remoter_Start_ParamsSpec.$.structSpec);
        ...
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.media.mojom.Remoter_StartWithPermissionAlreadyGranted_ParamsSpec.$.structSpec);
        ...
        case 5: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.media.mojom.Remoter_EstimateTransmissionCapacity_ParamsSpec.$.structSpec);
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              const val = (response && typeof response === 'object' && 'arg_rate' in response) ? response['arg_rate'] : response;
              const resp_obj = { 'arg_rate': val };
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
...
mojo.internal.bindings.media.mojom.RemoterReceiver = mojo.internal.bindings.media.mojom.RemoterReceiver;

mojo.internal.bindings.media.mojom.RemoterPtr = mojo.internal.bindings.media.mojom.RemoterRemote;
mojo.internal.bindings.media.mojom.RemoterRequest = mojo.internal.bindings.media.mojom.RemoterPendingReceiver;
...
mojo.internal.bindings.media.mojom.RemotingSourceRemote = class {
  static get $interfaceName() {
  ...
  constructor(handle = undefined) {
    this.__mojoHandle = handle;
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.media.mojom.RemotingSourcePendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.media.mojom.RemotingSourceRemoteCallHandler(this.proxy);
  }
  ...
  onSinkAvailable(arg_metadata) {
    return this.$.onSinkAvailable(arg_metadata);
  }
  onSinkGone() {
  ...
  onStartFailed(arg_reason) {
    return this.$.onStartFailed(arg_reason);
  }
  onMessageFromSink(arg_message) {
    return this.$.onMessageFromSink(arg_message);
  }
  onStopped(arg_reason) {
    return this.$.onStopped(arg_reason);
  }
};
...
mojo.internal.bindings.media.mojom.RemotingSourceRemoteCallHandler = class {
  ...
  onStarted() {
    return this.proxy.sendMessage(
      this.ordinals[2],  // ordinal
      mojo.internal.bindings.media.mojom.RemotingSource_OnStarted_ParamsSpec,
      null,
      [],
      false);
  }
  ...
  onStartFailed(arg_reason) {
    return this.proxy.sendMessage(
      this.ordinals[3],  // ordinal
      mojo.internal.bindings.media.mojom.RemotingSource_OnStartFailed_ParamsSpec,
      null,
      [arg_reason],
      false);
  }
...
mojo.internal.bindings.media.mojom.RemotingSource.getRemote = function() {
  let remote = new mojo.internal.bindings.media.mojom.RemotingSourceRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
...
mojo.internal.bindings.media.mojom.RemotingSourceReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        ...
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.media.mojom.RemotingSource_OnSinkGone_ParamsSpec.$.structSpec);
        ...
        case 2: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.media.mojom.RemotingSource_OnStarted_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.media.mojom.RemotingSourceReceiver = mojo.internal.bindings.media.mojom.RemotingSourceReceiver;

mojo.internal.bindings.media.mojom.RemotingSourcePtr = mojo.internal.bindings.media.mojom.RemotingSourceRemote;
mojo.internal.bindings.media.mojom.RemotingSourceRequest = mojo.internal.bindings.media.mojom.RemotingSourcePendingReceiver;
...
mojo.internal.bindings.media.mojom.RemoteeRemote = class {
  static get $interfaceName() {
  ...
  constructor(handle = undefined) {
    this.__mojoHandle = handle;
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.media.mojom.RemoteePendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.media.mojom.RemoteeRemoteCallHandler(this.proxy);
  }
  ...
  onRemotingSinkReady(arg_sink) {
    return this.$.onRemotingSinkReady(arg_sink);
  }
  sendMessageToSource(arg_message) {
    return this.$.sendMessageToSource(arg_message);
  }
  startDataStreams(arg_audio_stream, arg_video_stream) {
    return this.$.startDataStreams(arg_audio_stream, arg_video_stream);
  }
  onFlushUntil(arg_audio_frame_count, arg_video_frame_count) {
    return this.$.onFlushUntil(arg_audio_frame_count, arg_video_frame_count);
  }
...
mojo.internal.bindings.media.mojom.RemoteeRemoteCallHandler = class {
  ...
  startDataStreams(arg_audio_stream, arg_video_stream) {
    return this.proxy.sendMessage(
      this.ordinals[2],  // ordinal
      mojo.internal.bindings.media.mojom.Remotee_StartDataStreams_ParamsSpec,
      null,
      [arg_audio_stream, arg_video_stream],
      false);
  }
  ...
  onFlushUntil(arg_audio_frame_count, arg_video_frame_count) {
    return this.proxy.sendMessage(
      ...
      null,
      [arg_audio_frame_count, arg_video_frame_count],
      false);
  }
...
mojo.internal.bindings.media.mojom.Remotee.getRemote = function() {
  let remote = new mojo.internal.bindings.media.mojom.RemoteeRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
    'media.mojom.Remotee',
...
mojo.internal.bindings.media.mojom.RemoteeReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
...
mojo.internal.bindings.media.mojom.RemoteeReceiver = mojo.internal.bindings.media.mojom.RemoteeReceiver;

mojo.internal.bindings.media.mojom.RemoteePtr = mojo.internal.bindings.media.mojom.RemoteeRemote;
mojo.internal.bindings.media.mojom.RemoteeRequest = mojo.internal.bindings.media.mojom.RemoteePendingReceiver;
...
mojo.internal.bindings.media.mojom.RemotingSinkRemote = class {
  static get $interfaceName() {
  ...
  constructor(handle = undefined) {
    this.__mojoHandle = handle;
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.media.mojom.RemotingSinkPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.media.mojom.RemotingSinkRemoteCallHandler(this.proxy);
  }
  ...
  onMessageFromSource(arg_message) {
    return this.$.onMessageFromSource(arg_message);
  }
};
...
mojo.internal.bindings.media.mojom.RemotingSink.getRemote = function() {
  let remote = new mojo.internal.bindings.media.mojom.RemotingSinkRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
...
mojo.internal.bindings.media.mojom.RemotingSinkReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
...
mojo.internal.bindings.media.mojom.RemotingSinkReceiver = mojo.internal.bindings.media.mojom.RemotingSinkReceiver;

mojo.internal.bindings.media.mojom.RemotingSinkPtr = mojo.internal.bindings.media.mojom.RemotingSinkRemote;
mojo.internal.bindings.media.mojom.RemotingSinkRequest = mojo.internal.bindings.media.mojom.RemotingSinkPendingReceiver;
...
mojo.internal.bindings.media.mojom.RemotingDataStreamReceiverRemote = class {
  static get $interfaceName() {
  ...
  constructor(handle = undefined) {
    this.__mojoHandle = handle;
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.media.mojom.RemotingDataStreamReceiverPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.media.mojom.RemotingDataStreamReceiverRemoteCallHandler(this.proxy);
  }
  ...
  initializeDataPipe(arg_data_pipe) {
    return this.$.initializeDataPipe(arg_data_pipe);
  }
  receiveFrame(arg_frame_count, arg_buffer) {
    return this.$.receiveFrame(arg_frame_count, arg_buffer);
  }
  flushUntil(arg_frame_count) {
    return this.$.flushUntil(arg_frame_count);
  }
};
...
mojo.internal.bindings.media.mojom.RemotingDataStreamReceiverRemoteCallHandler = class {
  ...
  flushUntil(arg_frame_count) {
    return this.proxy.sendMessage(
      this.ordinals[2],  // ordinal
      mojo.internal.bindings.media.mojom.RemotingDataStreamReceiver_FlushUntil_ParamsSpec,
      null,
      [arg_frame_count],
      false);
  }
...
mojo.internal.bindings.media.mojom.RemotingDataStreamReceiver.getRemote = function() {
  let remote = new mojo.internal.bindings.media.mojom.RemotingDataStreamReceiverRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
...
mojo.internal.bindings.media.mojom.RemotingDataStreamReceiverReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
...
mojo.internal.bindings.media.mojom.RemotingDataStreamReceiverReceiver = mojo.internal.bindings.media.mojom.RemotingDataStreamReceiverReceiver;
