...
mojo.internal.bindings.chromecast.metrics = mojo.internal.bindings.chromecast.metrics || {};
...
mojo.internal.bindings.chromecast.metrics.mojom.MetricsHelperRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.chromecast.metrics.mojom.MetricsHelperPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.chromecast.metrics.mojom.MetricsHelperRemoteCallHandler(this.proxy);
  }
  ...
  recordApplicationEvent(arg_app_id, arg_session_id, arg_sdk_version, arg_event) {
    return this.$.recordApplicationEvent(arg_app_id, arg_session_id, arg_sdk_version, arg_event);
  }
};
...
mojo.internal.bindings.chromecast.metrics.mojom.MetricsHelper.getRemote = function() {
  let remote = new mojo.internal.bindings.chromecast.metrics.mojom.MetricsHelperRemote();
...
mojo.internal.bindings.chromecast.metrics.mojom.MetricsHelperReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.chromecast.metrics.mojom.MetricsHelper_RecordApplicationEvent_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for RecordApplicationEvent failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.chromecast.metrics.mojom.MetricsHelperReceiver = mojo.internal.bindings.chromecast.metrics.mojom.MetricsHelperReceiver;
