...
mojo.internal.bindings.crosapi.mojom.ButtonTypeSpec = mojo.internal.bindings.crosapi.mojom.ButtonTypeSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticLedNameSpec = mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticLedNameSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticLedColorSpec = mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticLedColorSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.crosapi.mojom.TypeSpec = mojo.internal.bindings.crosapi.mojom.TypeSpec || { $: mojo.internal.Enum().$ };
...
mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticMemtesterTestItemEnumSpec = mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticMemtesterTestItemEnumSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticHardwarePresenceStatusSpec = mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticHardwarePresenceStatusSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticCameraSubtestResultSpec = mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticCameraSubtestResultSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.crosapi.mojom.IssueSpec = mojo.internal.bindings.crosapi.mojom.IssueSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticRoutineArgumentSpec = mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticRoutineArgumentSpec || { $: {} };
if (mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticRoutineArgumentSpec.$.structSpec && mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticRoutineArgumentSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticRoutineArgumentSpec.$ = {};
mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticRoutineRunningInfoSpec = mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticRoutineRunningInfoSpec || { $: {} };
if (mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticRoutineRunningInfoSpec.$.structSpec && mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticRoutineRunningInfoSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticRoutineRunningInfoSpec.$ = {};
mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticRoutineInquiryReplySpec = mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticRoutineInquiryReplySpec || { $: {} };
if (mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticRoutineInquiryReplySpec.$.structSpec && mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticRoutineInquiryReplySpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticRoutineInquiryReplySpec.$ = {};
mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticRoutineInquirySpec = mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticRoutineInquirySpec || { $: {} };
if (mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticRoutineInquirySpec.$.structSpec && mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticRoutineInquirySpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticRoutineInquirySpec.$ = {};
mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticRoutineInteractionSpec = mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticRoutineInteractionSpec || { $: {} };
if (mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticRoutineInteractionSpec.$.structSpec && mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticRoutineInteractionSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticRoutineInteractionSpec.$ = {};
mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticRoutineDetailSpec = mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticRoutineDetailSpec || { $: {} };
if (mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticRoutineDetailSpec.$.structSpec && mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticRoutineDetailSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticRoutineDetailSpec.$ = {};
mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticRoutineStateUnionSpec = mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticRoutineStateUnionSpec || { $: {} };
if (mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticRoutineStateUnionSpec.$.structSpec && mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticRoutineStateUnionSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticRoutineStateUnionSpec.$ = {};
mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticMemoryRoutineArgumentSpec = mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticMemoryRoutineArgumentSpec || { $: {} };
if (mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticMemoryRoutineArgumentSpec.$.structSpec && mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticMemoryRoutineArgumentSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticMemoryRoutineArgumentSpec.$ = {};
mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticVolumeButtonRoutineArgumentSpec = mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticVolumeButtonRoutineArgumentSpec || { $: {} };
if (mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticVolumeButtonRoutineArgumentSpec.$.structSpec && mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticVolumeButtonRoutineArgumentSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticVolumeButtonRoutineArgumentSpec.$ = {};
mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticFanRoutineArgumentSpec = mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticFanRoutineArgumentSpec || { $: {} };
if (mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticFanRoutineArgumentSpec.$.structSpec && mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticFanRoutineArgumentSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticFanRoutineArgumentSpec.$ = {};
mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticLedLitUpRoutineArgumentSpec = mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticLedLitUpRoutineArgumentSpec || { $: {} };
if (mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticLedLitUpRoutineArgumentSpec.$.structSpec && mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticLedLitUpRoutineArgumentSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticLedLitUpRoutineArgumentSpec.$ = {};
mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticNetworkBandwidthRoutineArgumentSpec = mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticNetworkBandwidthRoutineArgumentSpec || { $: {} };
if (mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticNetworkBandwidthRoutineArgumentSpec.$.structSpec && mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticNetworkBandwidthRoutineArgumentSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticNetworkBandwidthRoutineArgumentSpec.$ = {};
mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticCameraFrameAnalysisRoutineArgumentSpec = mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticCameraFrameAnalysisRoutineArgumentSpec || { $: {} };
if (mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticCameraFrameAnalysisRoutineArgumentSpec.$.structSpec && mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticCameraFrameAnalysisRoutineArgumentSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticCameraFrameAnalysisRoutineArgumentSpec.$ = {};
mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticKeyboardBacklightRoutineArgumentSpec = mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticKeyboardBacklightRoutineArgumentSpec || { $: {} };
if (mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticKeyboardBacklightRoutineArgumentSpec.$.structSpec && mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticKeyboardBacklightRoutineArgumentSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticKeyboardBacklightRoutineArgumentSpec.$ = {};
mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticRoutineStateInitializedSpec = mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticRoutineStateInitializedSpec || { $: {} };
if (mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticRoutineStateInitializedSpec.$.structSpec && mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticRoutineStateInitializedSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticRoutineStateInitializedSpec.$ = {};
mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticNetworkBandwidthRoutineRunningInfoSpec = mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticNetworkBandwidthRoutineRunningInfoSpec || { $: {} };
if (mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticNetworkBandwidthRoutineRunningInfoSpec.$.structSpec && mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticNetworkBandwidthRoutineRunningInfoSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticNetworkBandwidthRoutineRunningInfoSpec.$ = {};
mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticRoutineStateRunningSpec = mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticRoutineStateRunningSpec || { $: {} };
if (mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticRoutineStateRunningSpec.$.structSpec && mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticRoutineStateRunningSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticRoutineStateRunningSpec.$ = {};
mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticCheckLedLitUpStateReplySpec = mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticCheckLedLitUpStateReplySpec || { $: {} };
if (mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticCheckLedLitUpStateReplySpec.$.structSpec && mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticCheckLedLitUpStateReplySpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticCheckLedLitUpStateReplySpec.$ = {};
mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticCheckKeyboardBacklightStateReplySpec = mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticCheckKeyboardBacklightStateReplySpec || { $: {} };
if (mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticCheckKeyboardBacklightStateReplySpec.$.structSpec && mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticCheckKeyboardBacklightStateReplySpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticCheckKeyboardBacklightStateReplySpec.$ = {};
mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticCheckLedLitUpStateInquirySpec = mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticCheckLedLitUpStateInquirySpec || { $: {} };
if (mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticCheckLedLitUpStateInquirySpec.$.structSpec && mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticCheckLedLitUpStateInquirySpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticCheckLedLitUpStateInquirySpec.$ = {};
mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticCheckKeyboardBacklightStateInquirySpec = mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticCheckKeyboardBacklightStateInquirySpec || { $: {} };
if (mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticCheckKeyboardBacklightStateInquirySpec.$.structSpec && mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticCheckKeyboardBacklightStateInquirySpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticCheckKeyboardBacklightStateInquirySpec.$ = {};
mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticRoutineStateWaitingSpec = mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticRoutineStateWaitingSpec || { $: {} };
if (mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticRoutineStateWaitingSpec.$.structSpec && mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticRoutineStateWaitingSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticRoutineStateWaitingSpec.$ = {};
mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticMemtesterResultSpec = mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticMemtesterResultSpec || { $: {} };
if (mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticMemtesterResultSpec.$.structSpec && mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticMemtesterResultSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticMemtesterResultSpec.$ = {};
mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticMemoryRoutineDetailSpec = mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticMemoryRoutineDetailSpec || { $: {} };
if (mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticMemoryRoutineDetailSpec.$.structSpec && mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticMemoryRoutineDetailSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticMemoryRoutineDetailSpec.$ = {};
mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticVolumeButtonRoutineDetailSpec = mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticVolumeButtonRoutineDetailSpec || { $: {} };
if (mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticVolumeButtonRoutineDetailSpec.$.structSpec && mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticVolumeButtonRoutineDetailSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticVolumeButtonRoutineDetailSpec.$ = {};
mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticFanRoutineDetailSpec = mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticFanRoutineDetailSpec || { $: {} };
if (mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticFanRoutineDetailSpec.$.structSpec && mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticFanRoutineDetailSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticFanRoutineDetailSpec.$ = {};
mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticNetworkBandwidthRoutineDetailSpec = mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticNetworkBandwidthRoutineDetailSpec || { $: {} };
if (mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticNetworkBandwidthRoutineDetailSpec.$.structSpec && mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticNetworkBandwidthRoutineDetailSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticNetworkBandwidthRoutineDetailSpec.$ = {};
mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticCameraFrameAnalysisRoutineDetailSpec = mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticCameraFrameAnalysisRoutineDetailSpec || { $: {} };
if (mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticCameraFrameAnalysisRoutineDetailSpec.$.structSpec && mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticCameraFrameAnalysisRoutineDetailSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticCameraFrameAnalysisRoutineDetailSpec.$ = {};
mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticRoutineStateFinishedSpec = mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticRoutineStateFinishedSpec || { $: {} };
if (mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticRoutineStateFinishedSpec.$.structSpec && mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticRoutineStateFinishedSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticRoutineStateFinishedSpec.$ = {};
mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticRoutineStateSpec = mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticRoutineStateSpec || { $: {} };
if (mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticRoutineStateSpec.$.structSpec && mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticRoutineStateSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticRoutineStateSpec.$ = {};
mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticRoutineControl = mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticRoutineControl || {};
mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticRoutineControlSpec = mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticRoutineControlSpec || { $ : {} };
if (mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticRoutineControlSpec.$.structSpec && mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticRoutineControlSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticRoutineControlSpec.$ = {};
...
mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticRoutineControl_GetState_ParamsSpec = mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticRoutineControl_GetState_ParamsSpec || { $: {} };
if (mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticRoutineControl_GetState_ParamsSpec.$.structSpec && mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticRoutineControl_GetState_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticRoutineControl_GetState_ParamsSpec.$ = {};
mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticRoutineControl_GetState_ResponseParamsSpec = mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticRoutineControl_GetState_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticRoutineControl_GetState_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticRoutineControl_GetState_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticRoutineControl_GetState_ResponseParamsSpec.$ = {};
mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticRoutineControl_Start_ParamsSpec = mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticRoutineControl_Start_ParamsSpec || { $: {} };
if (mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticRoutineControl_Start_ParamsSpec.$.structSpec && mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticRoutineControl_Start_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticRoutineControl_Start_ParamsSpec.$ = {};
mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticRoutineControl_ReplyToInquiry_ParamsSpec = mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticRoutineControl_ReplyToInquiry_ParamsSpec || { $: {} };
if (mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticRoutineControl_ReplyToInquiry_ParamsSpec.$.structSpec && mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticRoutineControl_ReplyToInquiry_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticRoutineControl_ReplyToInquiry_ParamsSpec.$ = {};
mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticRoutineObserver = mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticRoutineObserver || {};
mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticRoutineObserverSpec = mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticRoutineObserverSpec || { $ : {} };
if (mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticRoutineObserverSpec.$.structSpec && mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticRoutineObserverSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticRoutineObserverSpec.$ = {};
...
mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticRoutineObserver_OnRoutineStateChange_ParamsSpec = mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticRoutineObserver_OnRoutineStateChange_ParamsSpec || { $: {} };
if (mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticRoutineObserver_OnRoutineStateChange_ParamsSpec.$.structSpec && mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticRoutineObserver_OnRoutineStateChange_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticRoutineObserver_OnRoutineStateChange_ParamsSpec.$ = {};
mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticRoutinesService = mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticRoutinesService || {};
mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticRoutinesServiceSpec = mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticRoutinesServiceSpec || { $ : {} };
if (mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticRoutinesServiceSpec.$.structSpec && mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticRoutinesServiceSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticRoutinesServiceSpec.$ = {};
...
mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticRoutinesService_CreateRoutine_ParamsSpec = mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticRoutinesService_CreateRoutine_ParamsSpec || { $: {} };
if (mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticRoutinesService_CreateRoutine_ParamsSpec.$.structSpec && mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticRoutinesService_CreateRoutine_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticRoutinesService_CreateRoutine_ParamsSpec.$ = {};
mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticRoutinesService_IsRoutineArgumentSupported_ParamsSpec = mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticRoutinesService_IsRoutineArgumentSupported_ParamsSpec || { $: {} };
if (mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticRoutinesService_IsRoutineArgumentSupported_ParamsSpec.$.structSpec && mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticRoutinesService_IsRoutineArgumentSupported_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticRoutinesService_IsRoutineArgumentSupported_ParamsSpec.$ = {};
mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticRoutinesService_IsRoutineArgumentSupported_ResponseParamsSpec = mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticRoutinesService_IsRoutineArgumentSupported_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticRoutinesService_IsRoutineArgumentSupported_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticRoutinesService_IsRoutineArgumentSupported_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticRoutinesService_IsRoutineArgumentSupported_ResponseParamsSpec.$ = {};
...
mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticRoutineControlRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('crosapi.mojom.TelemetryDiagnosticRoutineControl', [
      { explicit: 0 },
      { explicit: 1 },
      { explicit: 2 },
    ]);
...
mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticRoutineControlReceiver = class {
  constructor(impl) {
    ...
    const ordinals = window.mojoScrambler.getOrdinals('crosapi.mojom.TelemetryDiagnosticRoutineControl', [
      { explicit: 0 },
      { explicit: 1 },
      { explicit: 2 },
    ]);
...
mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticRoutineObserverRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('crosapi.mojom.TelemetryDiagnosticRoutineObserver', [
      { explicit: 0 },
    ]);
  }
...
mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticRoutineObserverReceiver = class {
  constructor(impl) {
    ...
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('crosapi.mojom.TelemetryDiagnosticRoutineObserver', [
      { explicit: 0 },
    ]);
    ordinals.forEach((ord, idx) => {
      this.ordinalMap.set(ord, idx); // Scrambled/Explicit
...
mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticRoutinesServiceRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('crosapi.mojom.TelemetryDiagnosticRoutinesService', [
      { explicit: 0 },
      { explicit: 1 },
    ]);
  }
...
mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticRoutinesServiceReceiver = class {
  constructor(impl) {
    ...
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('crosapi.mojom.TelemetryDiagnosticRoutinesService', [
      { explicit: 0 },
      { explicit: 1 },
    ]);
    ordinals.forEach((ord, idx) => {
...
mojo.internal.Struct(
    mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticRoutineStateFinishedSpec, 'crosapi.mojom.TelemetryDiagnosticRoutineStateFinished', [
      ...
      mojo.internal.StructField('arg_detail', 8, 0, mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticRoutineDetailSpec, null, true, 0, undefined),
    ],
    [[0, 32]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticRoutineStateSpec, 'crosapi.mojom.TelemetryDiagnosticRoutineState', [
      ...
      mojo.internal.StructField('arg_state_union', 8, 0, mojo.internal.bindings.crosapi.mojom.TelemetryDiagnosticRoutineStateUnionSpec, null, false, 0, undefined),
    ],
    [[0, 32]]);
mojo.internal.Struct(
