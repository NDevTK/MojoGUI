...
mojo.internal.bindings.userspace_swap.mojom.UserspaceSwapInitializationRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.userspace_swap.mojom.UserspaceSwapInitializationRemoteCallHandler(this.proxy);
  }
  ...
  transferUserfaultFD(arg_uffd_error, arg_uffd_handle, arg_mmap_error, arg_swap_area) {
    return this.$.transferUserfaultFD(arg_uffd_error, arg_uffd_handle, arg_mmap_error, arg_swap_area);
  }
};
...
mojo.internal.bindings.userspace_swap.mojom.UserspaceSwapInitialization.getRemote = function() {
  let remote = new mojo.internal.bindings.userspace_swap.mojom.UserspaceSwapInitializationRemote();
        ...
        case 0: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.userspace_swap.mojom.UserspaceSwapInitialization_TransferUserfaultFD_ResponseParamsSpec, header, rawHeader);
               responder(response);
...
mojo.internal.bindings.userspace_swap.mojom.UserspaceSwapInitializationReceiver = mojo.internal.bindings.userspace_swap.mojom.UserspaceSwapInitializationReceiver;

mojo.internal.bindings.userspace_swap.mojom.UserspaceSwapInitializationPtr = mojo.internal.bindings.userspace_swap.mojom.UserspaceSwapInitializationRemote;
mojo.internal.bindings.userspace_swap.mojom.UserspaceSwapInitializationRequest = mojo.internal.bindings.userspace_swap.mojom.UserspaceSwapInitializationPendingReceiver;
...
mojo.internal.bindings.userspace_swap.mojom.UserspaceSwapRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.userspace_swap.mojom.UserspaceSwapRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.userspace_swap.mojom.UserspaceSwap.getRemote = function() {
  let remote = new mojo.internal.bindings.userspace_swap.mojom.UserspaceSwapRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
      ...
      switch (dispatchId) {
        ...
        case 2: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              const rawHeader = (args[2] && args[2].slice) ? args[2].slice(0, header.headerSize) : null;
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.userspace_swap.mojom.UserspaceSwap_GetPartitionAllocSuperPagesUsed_ResponseParamsSpec, header, rawHeader);
               responder(response);
...
mojo.internal.bindings.userspace_swap.mojom.UserspaceSwapReceiver = mojo.internal.bindings.userspace_swap.mojom.UserspaceSwapReceiver;
