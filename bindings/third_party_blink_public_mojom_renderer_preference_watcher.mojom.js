...
mojo.internal.bindings.blink.mojom.RendererPreferenceWatcher = {};
mojo.internal.bindings.blink.mojom.RendererPreferenceWatcherSpec = { $ : {} };
...
mojo.internal.bindings.blink.mojom.RendererPreferenceWatcherRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.blink.mojom.RendererPreferenceWatcherPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.blink.mojom.RendererPreferenceWatcherRemoteCallHandler(this.proxy);
  }
  ...
  notifyUpdate(arg_new_prefs) {
    return this.$.notifyUpdate(arg_new_prefs);
  }
};

mojo.internal.bindings.blink.mojom.RendererPreferenceWatcherRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('blink.mojom.RendererPreferenceWatcher', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.blink.mojom.RendererPreferenceWatcher.getRemote = function() {
  let remote = new mojo.internal.bindings.blink.mojom.RendererPreferenceWatcherRemote();
...
mojo.internal.bindings.blink.mojom.RendererPreferenceWatcherReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('blink.mojom.RendererPreferenceWatcher', [
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.blink.mojom.RendererPreferenceWatcher_NotifyUpdate_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for NotifyUpdate failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.blink.mojom.RendererPreferenceWatcherReceiver = mojo.internal.bindings.blink.mojom.RendererPreferenceWatcherReceiver;
