...
mojo.internal.bindings.content.mojom.ChildProcessHost_BindHostReceivers_ParamsSpec = mojo.internal.bindings.content.mojom.ChildProcessHost_BindHostReceivers_ParamsSpec || { $: {} };
if (mojo.internal.bindings.content.mojom.ChildProcessHost_BindHostReceivers_ParamsSpec.$.structSpec && mojo.internal.bindings.content.mojom.ChildProcessHost_BindHostReceivers_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.content.mojom.ChildProcessHost_BindHostReceivers_ParamsSpec.$ = {};
...
mojo.internal.bindings.content.mojom.ChildProcessHostRemote = class {
  ...
  bindHostReceivers(arg_receivers) {
    return this.$.bindHostReceivers(arg_receivers);
  }
};
...
mojo.internal.bindings.content.mojom.ChildProcessHostRemoteCallHandler = class {
  ...
  bindHostReceivers(arg_receivers) {
    return this.proxy.sendMessage(
      ...
      mojo.internal.bindings.content.mojom.ChildProcessHost_BindHostReceivers_ParamsSpec,
      null,
      [arg_receivers],
      false);
  }
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const message = new mojo.internal.Message(
                ...
                header.ordinal, header.requestId, mojo.internal.bindings.content.mojom.ChildProcessHost_Ping_ResponseParamsSpec.$.structSpec, resp_obj);
        ...
        case 2: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.content.mojom.ChildProcessHost_BindHostReceivers_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.bindHostReceivers');
          const result = this.impl.bindHostReceivers(params.arg_receivers);
          break;
        }
      }
      } catch (err) {
        ...
        case 7: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.content.mojom.ChildProcess_WriteClangProfilingProfile_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
...
mojo.internal.Struct(
    mojo.internal.bindings.content.mojom.ChildProcessHost_BindHostReceivers_ParamsSpec, 'content.mojom.ChildProcessHost_BindHostReceivers_Params', [
      mojo.internal.StructField('arg_receivers', 0, 0, mojo.internal.Array(mojo.internal.bindings.mojo_base.mojom.GenericPendingReceiverSpec, false), null, false, 0, undefined),
    ],
    [[0, 16]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.content.mojom.ChildProcess_GetBackgroundTracingAgentProvider_ParamsSpec, 'content.mojom.ChildProcess_GetBackgroundTracingAgentProvider_Params', [
      mojo.internal.StructField('arg_receiver', 0, 0, mojo.internal.InterfaceRequest(mojo.internal.bindings.tracing.mojom.BackgroundTracingAgentProviderPendingReceiver), null, false, 0, undefined),
    ],
    [[0, 16]]);
