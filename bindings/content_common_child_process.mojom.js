...
mojo.internal.bindings.content.mojom.ChildProcess_FreeAslrBeacons_ParamsSpec = mojo.internal.bindings.content.mojom.ChildProcess_FreeAslrBeacons_ParamsSpec || { $: {} };
if (mojo.internal.bindings.content.mojom.ChildProcess_FreeAslrBeacons_ParamsSpec.$.structSpec && mojo.internal.bindings.content.mojom.ChildProcess_FreeAslrBeacons_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.content.mojom.ChildProcess_FreeAslrBeacons_ParamsSpec.$ = {};
...
mojo.internal.bindings.content.mojom.ChildProcessRemote = class {
  ...
  freeAslrBeacons(arg_base_addresses) {
    return this.$.freeAslrBeacons(arg_base_addresses);
  }
};
...
mojo.internal.bindings.content.mojom.ChildProcessRemoteCallHandler = class {
  ...
  freeAslrBeacons(arg_base_addresses) {
    return this.proxy.sendMessage(
      ...
      mojo.internal.bindings.content.mojom.ChildProcess_FreeAslrBeacons_ParamsSpec,
      null,
      [arg_base_addresses],
      false);
  }
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        ...
        case 10: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.content.mojom.ChildProcess_FreeAslrBeacons_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.freeAslrBeacons');
          const result = this.impl.freeAslrBeacons(params.arg_base_addresses);
          break;
        }
      }
      } catch (err) {
...
mojo.internal.Struct(
    mojo.internal.bindings.content.mojom.ChildProcess_FreeAslrBeacons_ParamsSpec, 'content.mojom.ChildProcess_FreeAslrBeacons_Params', [
      mojo.internal.StructField('arg_base_addresses', 0, 0, mojo.internal.Array(mojo.internal.Uint64, false), null, false, 0, undefined),
    ],
    [[0, 16]]);
