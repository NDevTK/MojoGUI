// Auto-generated MojoJS binding
 // Source: chromium_src/chrome/browser/glic/host/glic_webui.mojom
 // Module: glic.mojom
...
mojo.internal.bindings.glic.mojom.ClientLoadErrorReasonSpec = mojo.internal.bindings.glic.mojom.ClientLoadErrorReasonSpec || { $: mojo.internal.Enum().$ };
...
mojo.internal.bindings.glic.mojom.PreloadPage_OnGuestNavigationStarted_ParamsSpec = mojo.internal.bindings.glic.mojom.PreloadPage_OnGuestNavigationStarted_ParamsSpec || { $: {} };
if (mojo.internal.bindings.glic.mojom.PreloadPage_OnGuestNavigationStarted_ParamsSpec.$.structSpec && mojo.internal.bindings.glic.mojom.PreloadPage_OnGuestNavigationStarted_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.glic.mojom.PreloadPage_OnGuestNavigationStarted_ParamsSpec.$ = {};
mojo.internal.bindings.glic.mojom.PreloadPage_OnGuestNavigated_ParamsSpec = mojo.internal.bindings.glic.mojom.PreloadPage_OnGuestNavigated_ParamsSpec || { $: {} };
if (mojo.internal.bindings.glic.mojom.PreloadPage_OnGuestNavigated_ParamsSpec.$.structSpec && mojo.internal.bindings.glic.mojom.PreloadPage_OnGuestNavigated_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.glic.mojom.PreloadPage_OnGuestNavigated_ParamsSpec.$ = {};
mojo.internal.bindings.glic.mojom.PreloadPage_OnGuestProcessGone_ParamsSpec = mojo.internal.bindings.glic.mojom.PreloadPage_OnGuestProcessGone_ParamsSpec || { $: {} };
if (mojo.internal.bindings.glic.mojom.PreloadPage_OnGuestProcessGone_ParamsSpec.$.structSpec && mojo.internal.bindings.glic.mojom.PreloadPage_OnGuestProcessGone_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.glic.mojom.PreloadPage_OnGuestProcessGone_ParamsSpec.$ = {};
mojo.internal.bindings.glic.mojom.PreloadPage_WebClientStateChanged_ParamsSpec = mojo.internal.bindings.glic.mojom.PreloadPage_WebClientStateChanged_ParamsSpec || { $: {} };
if (mojo.internal.bindings.glic.mojom.PreloadPage_WebClientStateChanged_ParamsSpec.$.structSpec && mojo.internal.bindings.glic.mojom.PreloadPage_WebClientStateChanged_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.glic.mojom.PreloadPage_WebClientStateChanged_ParamsSpec.$ = {};
...
mojo.internal.bindings.glic.mojom.Page_ClientReadyStateChanged_ParamsSpec = mojo.internal.bindings.glic.mojom.Page_ClientReadyStateChanged_ParamsSpec || { $: {} };
if (mojo.internal.bindings.glic.mojom.Page_ClientReadyStateChanged_ParamsSpec.$.structSpec && mojo.internal.bindings.glic.mojom.Page_ClientReadyStateChanged_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.glic.mojom.Page_ClientReadyStateChanged_ParamsSpec.$ = {};
...
mojo.internal.bindings.glic.mojom.PageHandler_OpenLinkInPopup_ParamsSpec = mojo.internal.bindings.glic.mojom.PageHandler_OpenLinkInPopup_ParamsSpec || { $: {} };
if (mojo.internal.bindings.glic.mojom.PageHandler_OpenLinkInPopup_ParamsSpec.$.structSpec && mojo.internal.bindings.glic.mojom.PageHandler_OpenLinkInPopup_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.glic.mojom.PageHandler_OpenLinkInPopup_ParamsSpec.$ = {};
mojo.internal.bindings.glic.mojom.PageHandler_OpenLinkInNewTab_ParamsSpec = mojo.internal.bindings.glic.mojom.PageHandler_OpenLinkInNewTab_ParamsSpec || { $: {} };
if (mojo.internal.bindings.glic.mojom.PageHandler_OpenLinkInNewTab_ParamsSpec.$.structSpec && mojo.internal.bindings.glic.mojom.PageHandler_OpenLinkInNewTab_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.glic.mojom.PageHandler_OpenLinkInNewTab_ParamsSpec.$ = {};
...
mojo.internal.bindings.glic.mojom.PageHandler_ShouldAllowGeolocationPermissionRequest_ParamsSpec = mojo.internal.bindings.glic.mojom.PageHandler_ShouldAllowGeolocationPermissionRequest_ParamsSpec || { $: {} };
if (mojo.internal.bindings.glic.mojom.PageHandler_ShouldAllowGeolocationPermissionRequest_ParamsSpec.$.structSpec && mojo.internal.bindings.glic.mojom.PageHandler_ShouldAllowGeolocationPermissionRequest_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.glic.mojom.PageHandler_ShouldAllowGeolocationPermissionRequest_ParamsSpec.$ = {};
mojo.internal.bindings.glic.mojom.PageHandler_ShouldAllowGeolocationPermissionRequest_ResponseParamsSpec = mojo.internal.bindings.glic.mojom.PageHandler_ShouldAllowGeolocationPermissionRequest_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.glic.mojom.PageHandler_ShouldAllowGeolocationPermissionRequest_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.glic.mojom.PageHandler_ShouldAllowGeolocationPermissionRequest_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.glic.mojom.PageHandler_ShouldAllowGeolocationPermissionRequest_ResponseParamsSpec.$ = {};
...
mojo.internal.bindings.glic.mojom.PageHandler_NotifyClientLoadError_ParamsSpec = mojo.internal.bindings.glic.mojom.PageHandler_NotifyClientLoadError_ParamsSpec || { $: {} };
if (mojo.internal.bindings.glic.mojom.PageHandler_NotifyClientLoadError_ParamsSpec.$.structSpec && mojo.internal.bindings.glic.mojom.PageHandler_NotifyClientLoadError_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.glic.mojom.PageHandler_NotifyClientLoadError_ParamsSpec.$ = {};
mojo.internal.bindings.glic.mojom.PageHandler_OnClientLoadFailed_ParamsSpec = mojo.internal.bindings.glic.mojom.PageHandler_OnClientLoadFailed_ParamsSpec || { $: {} };
if (mojo.internal.bindings.glic.mojom.PageHandler_OnClientLoadFailed_ParamsSpec.$.structSpec && mojo.internal.bindings.glic.mojom.PageHandler_OnClientLoadFailed_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.glic.mojom.PageHandler_OnClientLoadFailed_ParamsSpec.$ = {};
...
// Enum: ClientLoadErrorReason
mojo.internal.bindings.glic.mojom.ClientLoadErrorReason = {
  kUnknown: 0,
  kUnavailable: 1,
...
mojo.internal.bindings.glic.mojom.PreloadPageRemote = class {
  ...
  onGuestNavigationStarted() {
    return this.$.onGuestNavigationStarted();
  }
  onGuestNavigated(arg_url, arg_is_api_allowed, arg_page_type, arg_is_initial_commit) {
    return this.$.onGuestNavigated(arg_url, arg_is_api_allowed, arg_page_type, arg_is_initial_commit);
  }
  onGuestProcessGone() {
    return this.$.onGuestProcessGone();
  }
...
mojo.internal.bindings.glic.mojom.PreloadPageRemoteCallHandler = class {
  ...
  onGuestNavigationStarted() {
    return this.proxy.sendMessage(
      ...
      mojo.internal.bindings.glic.mojom.PreloadPage_OnGuestNavigationStarted_ParamsSpec,
      null,
      [],
      false);
  }
  ...
  onGuestNavigated(arg_url, arg_is_api_allowed, arg_page_type, arg_is_initial_commit) {
    return this.proxy.sendMessage(
      ...
      mojo.internal.bindings.glic.mojom.PreloadPage_OnGuestNavigated_ParamsSpec,
      null,
      [arg_url, arg_is_api_allowed, arg_page_type, arg_is_initial_commit],
      false);
  }
  ...
  onGuestProcessGone() {
    return this.proxy.sendMessage(
      ...
      mojo.internal.bindings.glic.mojom.PreloadPage_OnGuestProcessGone_ParamsSpec,
      null,
      [],
      false);
  }
  ...
  webClientStateChanged(arg_state) {
    return this.proxy.sendMessage(
      ...
      mojo.internal.bindings.glic.mojom.PreloadPage_WebClientStateChanged_ParamsSpec,
      null,
      [arg_state],
      false);
  }
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        ...
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.glic.mojom.PreloadPage_OnGuestNavigationStarted_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.onGuestNavigationStarted');
          const result = this.impl.onGuestNavigationStarted();
          break;
        }
        case 2: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.glic.mojom.PreloadPage_OnGuestNavigated_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.onGuestNavigated');
          const result = this.impl.onGuestNavigated(params.arg_url, params.arg_is_api_allowed, params.arg_page_type, params.arg_is_initial_commit);
          break;
        }
        case 3: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.glic.mojom.PreloadPage_OnGuestProcessGone_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.onGuestProcessGone');
          const result = this.impl.onGuestProcessGone();
          break;
        }
        case 4: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.glic.mojom.PreloadPage_WebClientStateChanged_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.glic.mojom.PageRemote = class {
  ...
  clientReadyStateChanged(arg_ready) {
    return this.$.clientReadyStateChanged(arg_ready);
  }
  zoom(arg_action) {
...
mojo.internal.bindings.glic.mojom.PageRemoteCallHandler = class {
  ...
  clientReadyStateChanged(arg_ready) {
    return this.proxy.sendMessage(
      this.ordinals[3],  // ordinal
      mojo.internal.bindings.glic.mojom.Page_ClientReadyStateChanged_ParamsSpec,
      null,
      [arg_ready],
      false);
  }
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        ...
        case 3: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.glic.mojom.Page_ClientReadyStateChanged_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.clientReadyStateChanged');
          const result = this.impl.clientReadyStateChanged(params.arg_ready);
          break;
        }
        case 4: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
...
mojo.internal.bindings.glic.mojom.PageHandlerRemote = class {
  ...
  openLinkInNewTab(arg_url) {
    return this.$.openLinkInNewTab(arg_url);
  }
  ...
  notifyClientLoadError(arg_reason) {
    return this.$.notifyClientLoadError(arg_reason);
  }
  onClientLoadFailed(arg_failed) {
    return this.$.onClientLoadFailed(arg_failed);
  }
};
...
mojo.internal.bindings.glic.mojom.PageHandlerRemoteCallHandler = class {
  ...
  openLinkInPopup(arg_url, arg_popup_width, arg_popup_height) {
    return this.proxy.sendMessage(
      this.ordinals[2],  // ordinal
      mojo.internal.bindings.glic.mojom.PageHandler_OpenLinkInPopup_ParamsSpec,
      null,
  ...
  openLinkInNewTab(arg_url) {
    return this.proxy.sendMessage(
      this.ordinals[3],  // ordinal
      mojo.internal.bindings.glic.mojom.PageHandler_OpenLinkInNewTab_ParamsSpec,
      null,
      [arg_url],
      false);
  }
  ...
  notifyClientLoadError(arg_reason) {
    return this.proxy.sendMessage(
      ...
      mojo.internal.bindings.glic.mojom.PageHandler_NotifyClientLoadError_ParamsSpec,
      null,
      [arg_reason],
      false);
  }
  ...
  onClientLoadFailed(arg_failed) {
    return this.proxy.sendMessage(
      ...
      mojo.internal.bindings.glic.mojom.PageHandler_OnClientLoadFailed_ParamsSpec,
      null,
      [arg_failed],
      false);
  }
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        ...
        case 2: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.glic.mojom.PageHandler_OpenLinkInPopup_ParamsSpec.$.structSpec);
        ...
        case 3: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.glic.mojom.PageHandler_OpenLinkInNewTab_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.openLinkInNewTab');
          const result = this.impl.openLinkInNewTab(params.arg_url);
          break;
        }
        case 4: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
        ...
        case 5: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.glic.mojom.PageHandler_ShouldAllowGeolocationPermissionRequest_ParamsSpec.$.structSpec);
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.glic.mojom.PageHandler_ShouldAllowGeolocationPermissionRequest_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
        ...
        case 13: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.glic.mojom.PageHandler_NotifyClientLoadError_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.notifyClientLoadError');
          const result = this.impl.notifyClientLoadError(params.arg_reason);
          break;
        }
        case 14: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.glic.mojom.PageHandler_OnClientLoadFailed_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.onClientLoadFailed');
          const result = this.impl.onClientLoadFailed(params.arg_failed);
          break;
        }
      }
      } catch (err) {
...
mojo.internal.Struct(
    mojo.internal.bindings.glic.mojom.PreloadPage_OnGuestNavigationStarted_ParamsSpec, 'glic.mojom.PreloadPage_OnGuestNavigationStarted_Params', [
    ],
    [[0, 8]]);

mojo.internal.Struct(
    mojo.internal.bindings.glic.mojom.PreloadPage_OnGuestNavigated_ParamsSpec, 'glic.mojom.PreloadPage_OnGuestNavigated_Params', [
      mojo.internal.StructField('arg_url', 0, 0, mojo.internal.bindings.url.mojom.UrlSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_is_api_allowed', 8, 0, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_is_initial_commit', 8, 1, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_page_type', 12, 0, mojo.internal.bindings.glic.mojom.GuestPageTypeSpec, null, false, 0, undefined),
    ],
    [[0, 24]]);

mojo.internal.Struct(
    mojo.internal.bindings.glic.mojom.PreloadPage_OnGuestProcessGone_ParamsSpec, 'glic.mojom.PreloadPage_OnGuestProcessGone_Params', [
    ],
    [[0, 8]]);

mojo.internal.Struct(
    mojo.internal.bindings.glic.mojom.PreloadPage_WebClientStateChanged_ParamsSpec, 'glic.mojom.PreloadPage_WebClientStateChanged_Params', [
...
mojo.internal.Struct(
    mojo.internal.bindings.glic.mojom.Page_ClientReadyStateChanged_ParamsSpec, 'glic.mojom.Page_ClientReadyStateChanged_Params', [
...
mojo.internal.Struct(
    mojo.internal.bindings.glic.mojom.PageHandler_OpenLinkInPopup_ParamsSpec, 'glic.mojom.PageHandler_OpenLinkInPopup_Params', [
      mojo.internal.StructField('arg_url', 0, 0, mojo.internal.bindings.url.mojom.UrlSpec, null, false, 0, undefined),
...
mojo.internal.Struct(
    mojo.internal.bindings.glic.mojom.PageHandler_OpenLinkInNewTab_ParamsSpec, 'glic.mojom.PageHandler_OpenLinkInNewTab_Params', [
      mojo.internal.StructField('arg_url', 0, 0, mojo.internal.bindings.url.mojom.UrlSpec, null, false, 0, undefined),
    ],
    [[0, 16]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.glic.mojom.PageHandler_ShouldAllowGeolocationPermissionRequest_ParamsSpec, 'glic.mojom.PageHandler_ShouldAllowGeolocationPermissionRequest_Params', [
    ],
    [[0, 8]]);

mojo.internal.Struct(
    mojo.internal.bindings.glic.mojom.PageHandler_ShouldAllowGeolocationPermissionRequest_ResponseParamsSpec, 'glic.mojom.PageHandler_ShouldAllowGeolocationPermissionRequest_ResponseParams', [
...
mojo.internal.Struct(
    mojo.internal.bindings.glic.mojom.PageHandler_NotifyClientLoadError_ParamsSpec, 'glic.mojom.PageHandler_NotifyClientLoadError_Params', [
      mojo.internal.StructField('arg_reason', 0, 0, mojo.internal.bindings.glic.mojom.ClientLoadErrorReasonSpec, null, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.glic.mojom.PageHandler_OnClientLoadFailed_ParamsSpec, 'glic.mojom.PageHandler_OnClientLoadFailed_Params', [
      mojo.internal.StructField('arg_failed', 0, 0, mojo.internal.Bool, false, false, 0, undefined),
    ],
    [[0, 16]]);
