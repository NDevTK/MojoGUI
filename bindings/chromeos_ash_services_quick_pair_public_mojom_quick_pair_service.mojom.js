...
mojo.internal.bindings.ash.quick_pair.mojom.QuickPairService = {};
mojo.internal.bindings.ash.quick_pair.mojom.QuickPairServiceSpec = { $ : {} };
...
mojo.internal.bindings.ash.quick_pair.mojom.QuickPairServiceRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.ash.quick_pair.mojom.QuickPairServicePendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.ash.quick_pair.mojom.QuickPairServiceRemoteCallHandler(this.proxy);
  }
  ...
  connect(arg_fast_pair_data_parser) {
    return this.$.connect(arg_fast_pair_data_parser);
  }
};

mojo.internal.bindings.ash.quick_pair.mojom.QuickPairServiceRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('ash.quick_pair.mojom.QuickPairService', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.ash.quick_pair.mojom.QuickPairService.getRemote = function() {
  let remote = new mojo.internal.bindings.ash.quick_pair.mojom.QuickPairServiceRemote();
...
mojo.internal.bindings.ash.quick_pair.mojom.QuickPairServiceReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('ash.quick_pair.mojom.QuickPairService', [
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.ash.quick_pair.mojom.QuickPairService_Connect_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.ash.quick_pair.mojom.QuickPairServiceReceiver = mojo.internal.bindings.ash.quick_pair.mojom.QuickPairServiceReceiver;
