...
mojo.internal.Struct(
    mojo.internal.bindings.blink.mojom.WebOTPService_Receive_ResponseParamsSpec, 'blink.mojom.WebOTPService_Receive_ResponseParams', [
      mojo.internal.StructField('arg_otp', 0, 0, mojo.internal.String, null, true, 0, undefined),
      mojo.internal.StructField('arg_status', 8, 0, mojo.internal.bindings.blink.mojom.SmsStatusSpec, null, false, 0, undefined),
    ],
    [[0, 24]]);
...
mojo.internal.bindings.blink.mojom.WebOTPServiceRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.blink.mojom.WebOTPServicePendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.blink.mojom.WebOTPServiceRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.blink.mojom.WebOTPServiceRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('blink.mojom.WebOTPService', [
      { explicit: null },
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.blink.mojom.WebOTPService.getRemote = function() {
  let remote = new mojo.internal.bindings.blink.mojom.WebOTPServiceRemote();
...
mojo.internal.bindings.blink.mojom.WebOTPServiceReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('blink.mojom.WebOTPService', [
      { explicit: null },
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.blink.mojom.WebOTPService_Receive_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for Receive failed with TypeError');
           }
        }
        // Try Method 1: Abort
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.blink.mojom.WebOTPService_Abort_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.blink.mojom.WebOTPService_Receive_ParamsSpec.$.structSpec);
        ...
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.blink.mojom.WebOTPService_Abort_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.blink.mojom.WebOTPServiceReceiver = mojo.internal.bindings.blink.mojom.WebOTPServiceReceiver;
