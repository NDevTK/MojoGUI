...
mojo.internal.bindings.ui.mojom.TextEditCommandSpec = mojo.internal.bindings.ui.mojom.TextEditCommandSpec || { $: mojo.internal.Enum().$ };
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.remote_cocoa.mojom.TextInputHost_HasClient_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for HasClient failed with TypeError');
           }
        }
        // Try Method 1: HasInputContext
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.remote_cocoa.mojom.TextInputHost_HasInputContext_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for HasInputContext failed with TypeError');
           }
        }
        // Try Method 2: IsRTL
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.remote_cocoa.mojom.TextInputHost_IsRTL_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for IsRTL failed with TypeError');
           }
        }
        // Try Method 3: GetSelectionRange
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.remote_cocoa.mojom.TextInputHost_GetSelectionRange_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for GetSelectionRange failed with TypeError');
           }
        }
        // Try Method 4: GetSelectionText
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.remote_cocoa.mojom.TextInputHost_GetSelectionText_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for GetSelectionText failed with TypeError');
           }
        }
        // Try Method 5: InsertText
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.remote_cocoa.mojom.TextInputHost_InsertText_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for InsertText failed with TypeError');
           }
        }
        // Try Method 6: DeleteRange
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.remote_cocoa.mojom.TextInputHost_DeleteRange_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for DeleteRange failed with TypeError');
           }
        }
        // Try Method 7: SetCompositionText
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.remote_cocoa.mojom.TextInputHost_SetCompositionText_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for SetCompositionText failed with TypeError');
           }
        }
        // Try Method 8: ConfirmCompositionText
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.remote_cocoa.mojom.TextInputHost_ConfirmCompositionText_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for ConfirmCompositionText failed with TypeError');
           }
        }
        // Try Method 9: HasCompositionText
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.remote_cocoa.mojom.TextInputHost_HasCompositionText_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for HasCompositionText failed with TypeError');
           }
        }
        // Try Method 10: GetCompositionTextRange
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.remote_cocoa.mojom.TextInputHost_GetCompositionTextRange_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for GetCompositionTextRange failed with TypeError');
           }
        }
        // Try Method 11: GetAttributedSubstringForRange
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.remote_cocoa.mojom.TextInputHost_GetAttributedSubstringForRange_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for GetAttributedSubstringForRange failed with TypeError');
           }
        }
        // Try Method 12: GetFirstRectForRange
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.remote_cocoa.mojom.TextInputHost_GetFirstRectForRange_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.remote_cocoa.mojom.TextInputHost_IsTextEditCommandEnabled_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for IsTextEditCommandEnabled failed with TypeError');
           }
        }
        // Try Method 14: SetTextEditCommandForNextKeyEvent
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.remote_cocoa.mojom.TextInputHost_SetTextEditCommandForNextKeyEvent_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for SetTextEditCommandForNextKeyEvent failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
