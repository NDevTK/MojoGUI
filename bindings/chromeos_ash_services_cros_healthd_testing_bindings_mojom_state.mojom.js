...
mojo.internal.bindings.ash.cros_healthd.connectivity.mojom.StateRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.ash.cros_healthd.connectivity.mojom.StatePendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.ash.cros_healthd.connectivity.mojom.StateRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.ash.cros_healthd.connectivity.mojom.StateRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('ash.cros_healthd.connectivity.mojom.State', [
      { explicit: null },
      { explicit: null },
      { explicit: null },
    ]);
...
mojo.internal.bindings.ash.cros_healthd.connectivity.mojom.State.getRemote = function() {
  let remote = new mojo.internal.bindings.ash.cros_healthd.connectivity.mojom.StateRemote();
...
mojo.internal.bindings.ash.cros_healthd.connectivity.mojom.StateReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('ash.cros_healthd.connectivity.mojom.State', [
      { explicit: null },
      { explicit: null },
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ash.cros_healthd.connectivity.mojom.State_LastCallHasNext_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for LastCallHasNext failed with TypeError');
           }
        }
        // Try Method 1: WaitLastCall
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ash.cros_healthd.connectivity.mojom.State_WaitLastCall_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for WaitLastCall failed with TypeError');
           }
        }
        // Try Method 2: FulfillLastCallCallback
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ash.cros_healthd.connectivity.mojom.State_FulfillLastCallCallback_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for FulfillLastCallCallback failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.ash.cros_healthd.connectivity.mojom.State_LastCallHasNext_ParamsSpec.$.structSpec);
        ...
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.ash.cros_healthd.connectivity.mojom.State_WaitLastCall_ParamsSpec.$.structSpec);
        ...
        case 2: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.ash.cros_healthd.connectivity.mojom.State_FulfillLastCallCallback_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.ash.cros_healthd.connectivity.mojom.StateReceiver = mojo.internal.bindings.ash.cros_healthd.connectivity.mojom.StateReceiver;

mojo.internal.bindings.ash.cros_healthd.connectivity.mojom.StatePtr = mojo.internal.bindings.ash.cros_healthd.connectivity.mojom.StateRemote;
mojo.internal.bindings.ash.cros_healthd.connectivity.mojom.StateRequest = mojo.internal.bindings.ash.cros_healthd.connectivity.mojom.StatePendingReceiver;
...
mojo.internal.bindings.ash.cros_healthd.connectivity.mojom.ConnectivityTestProviderRemote = class {
  static get $interfaceName() {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.ash.cros_healthd.connectivity.mojom.ConnectivityTestProviderPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.ash.cros_healthd.connectivity.mojom.ConnectivityTestProviderRemoteCallHandler(this.proxy);
  }
  ...
  bindContext(arg_remote, arg_receiver) {
    return this.$.bindContext(arg_remote, arg_receiver);
  }
  bindTestProvider(arg_interface_name, arg_receiver) {
    return this.$.bindTestProvider(arg_interface_name, arg_receiver);
  }
};

mojo.internal.bindings.ash.cros_healthd.connectivity.mojom.ConnectivityTestProviderRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('ash.cros_healthd.connectivity.mojom.ConnectivityTestProvider', [
      { explicit: null },
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.ash.cros_healthd.connectivity.mojom.ConnectivityTestProvider.getRemote = function() {
  let remote = new mojo.internal.bindings.ash.cros_healthd.connectivity.mojom.ConnectivityTestProviderRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
...
mojo.internal.bindings.ash.cros_healthd.connectivity.mojom.ConnectivityTestProviderReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('ash.cros_healthd.connectivity.mojom.ConnectivityTestProvider', [
      { explicit: null },
      { explicit: null },
    ]);
    ordinals.forEach((ord, idx) => {
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ash.cros_healthd.connectivity.mojom.ConnectivityTestProvider_BindContext_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for BindContext failed with TypeError');
           }
        }
        // Try Method 1: BindTestProvider
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ash.cros_healthd.connectivity.mojom.ConnectivityTestProvider_BindTestProvider_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for BindTestProvider failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
             console.warn('[GeneratedReceiver] Failed to discover ordinal ' + header.ordinal);
...
mojo.internal.bindings.ash.cros_healthd.connectivity.mojom.ConnectivityTestProviderReceiver = mojo.internal.bindings.ash.cros_healthd.connectivity.mojom.ConnectivityTestProviderReceiver;
