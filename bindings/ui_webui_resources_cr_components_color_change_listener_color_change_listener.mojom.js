...
mojo.internal.bindings.color_change_listener.mojom.PageHandlerRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.color_change_listener.mojom.PageHandlerPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.color_change_listener.mojom.PageHandlerRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.color_change_listener.mojom.PageHandlerRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('color_change_listener.mojom.PageHandler', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.color_change_listener.mojom.PageHandler.getRemote = function() {
  let remote = new mojo.internal.bindings.color_change_listener.mojom.PageHandlerRemote();
...
mojo.internal.bindings.color_change_listener.mojom.PageHandlerReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('color_change_listener.mojom.PageHandler', [
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.color_change_listener.mojom.PageHandler_SetPage_ParamsSpec.$.structSpec;
...
mojo.internal.bindings.color_change_listener.mojom.PageHandlerReceiver = mojo.internal.bindings.color_change_listener.mojom.PageHandlerReceiver;

mojo.internal.bindings.color_change_listener.mojom.PageHandlerPtr = mojo.internal.bindings.color_change_listener.mojom.PageHandlerRemote;
mojo.internal.bindings.color_change_listener.mojom.PageHandlerRequest = mojo.internal.bindings.color_change_listener.mojom.PageHandlerPendingReceiver;
...
mojo.internal.bindings.color_change_listener.mojom.PageRemote = class {
  static get $interfaceName() {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.color_change_listener.mojom.PagePendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.color_change_listener.mojom.PageRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.color_change_listener.mojom.PageRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('color_change_listener.mojom.Page', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.color_change_listener.mojom.Page.getRemote = function() {
  let remote = new mojo.internal.bindings.color_change_listener.mojom.PageRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
...
mojo.internal.bindings.color_change_listener.mojom.PageReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('color_change_listener.mojom.Page', [
      { explicit: null },
    ]);
    ordinals.forEach((ord, idx) => {
      this.ordinalMap.set(ord, idx); // Scrambled/Explicit
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        // Try Method 0: OnColorProviderChanged
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.color_change_listener.mojom.Page_OnColorProviderChanged_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (sizeMatch && (!!(header.flags & 1) === methodExpectsResp)) {
               if (size > 8 || message.payload.byteLength === 8) {
                 decoder.decodeStructInline(structSpec);
                 console.log('[GeneratedReceiver] Discovery SUCCESS: ' + header.ordinal + ' -> OnColorProviderChanged (0)');
                 this.mapOrdinal(header.ordinal, 0);
                 dispatchId = 0;
               }
             }
           } catch (e) {
             if (e instanceof TypeError) console.warn('[Discovery] trial for OnColorProviderChanged failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
             console.warn('[GeneratedReceiver] Failed to discover ordinal ' + header.ordinal);
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.color_change_listener.mojom.Page_OnColorProviderChanged_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.color_change_listener.mojom.PageReceiver = mojo.internal.bindings.color_change_listener.mojom.PageReceiver;
