...
mojo.internal.bindings.remoting.mojom.StartSupportSessionError = {
  kUnknown: 0,
...
mojo.internal.bindings.remoting.mojom.SupportHostObserverRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.remoting.mojom.SupportHostObserverPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.remoting.mojom.SupportHostObserverRemoteCallHandler(this.proxy);
  }
  ...
  onHostStateReceivedAccessCode(arg_access_code, arg_lifetime) {
    return this.$.onHostStateReceivedAccessCode(arg_access_code, arg_lifetime);
  }
  onHostStateConnecting() {
    return this.$.onHostStateConnecting();
  }
  onHostStateConnected(arg_remote_username) {
    return this.$.onHostStateConnected(arg_remote_username);
  }
  onHostStateDisconnected(arg_disconnect_reason) {
    return this.$.onHostStateDisconnected(arg_disconnect_reason);
  }
  onNatPolicyChanged(arg_nat_policy_state) {
    return this.$.onNatPolicyChanged(arg_nat_policy_state);
  }
  onHostStateError(arg_error_code) {
    return this.$.onHostStateError(arg_error_code);
  }
  onPolicyError() {
...
mojo.internal.bindings.remoting.mojom.SupportHostObserver.getRemote = function() {
  let remote = new mojo.internal.bindings.remoting.mojom.SupportHostObserverRemote();
...
mojo.internal.bindings.remoting.mojom.SupportHostObserverReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.remoting.mojom.SupportHostObserver_OnHostStateStarting_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OnHostStateStarting failed with TypeError');
           }
        }
        // Try Method 1: OnHostStateRequestedAccessCode
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.remoting.mojom.SupportHostObserver_OnHostStateRequestedAccessCode_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OnHostStateRequestedAccessCode failed with TypeError');
           }
        }
        // Try Method 2: OnHostStateReceivedAccessCode
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.remoting.mojom.SupportHostObserver_OnHostStateReceivedAccessCode_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OnHostStateReceivedAccessCode failed with TypeError');
           }
        }
        // Try Method 3: OnHostStateConnecting
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.remoting.mojom.SupportHostObserver_OnHostStateConnecting_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OnHostStateConnecting failed with TypeError');
           }
        }
        // Try Method 4: OnHostStateConnected
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.remoting.mojom.SupportHostObserver_OnHostStateConnected_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OnHostStateConnected failed with TypeError');
           }
        }
        // Try Method 5: OnHostStateDisconnected
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.remoting.mojom.SupportHostObserver_OnHostStateDisconnected_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OnHostStateDisconnected failed with TypeError');
           }
        }
        // Try Method 6: OnNatPolicyChanged
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.remoting.mojom.SupportHostObserver_OnNatPolicyChanged_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OnNatPolicyChanged failed with TypeError');
           }
        }
        // Try Method 7: OnHostStateError
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.remoting.mojom.SupportHostObserver_OnHostStateError_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OnHostStateError failed with TypeError');
           }
        }
        // Try Method 8: OnPolicyError
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.remoting.mojom.SupportHostObserver_OnPolicyError_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OnPolicyError failed with TypeError');
           }
        }
        // Try Method 9: OnInvalidDomainError
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.remoting.mojom.SupportHostObserver_OnInvalidDomainError_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OnInvalidDomainError failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.remoting.mojom.SupportHostObserver_OnHostStateStarting_ParamsSpec.$.structSpec);
        ...
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.remoting.mojom.SupportHostObserver_OnHostStateRequestedAccessCode_ParamsSpec.$.structSpec);
        ...
        case 3: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.remoting.mojom.SupportHostObserver_OnHostStateConnecting_ParamsSpec.$.structSpec);
        ...
        case 8: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.remoting.mojom.SupportHostObserver_OnPolicyError_ParamsSpec.$.structSpec);
        ...
        case 9: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.remoting.mojom.SupportHostObserver_OnInvalidDomainError_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.remoting.mojom.SupportHostObserverReceiver = mojo.internal.bindings.remoting.mojom.SupportHostObserverReceiver;
