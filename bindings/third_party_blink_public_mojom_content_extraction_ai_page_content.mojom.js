...
mojo.internal.bindings.blink.mojom.NonSalientContentConfigSpec = mojo.internal.bindings.blink.mojom.NonSalientContentConfigSpec || { $: {} };
if (mojo.internal.bindings.blink.mojom.NonSalientContentConfigSpec.$.structSpec && mojo.internal.bindings.blink.mojom.NonSalientContentConfigSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.blink.mojom.NonSalientContentConfigSpec.$ = {};
...
mojo.internal.bindings.blink.mojom.AIPageContentImageBytesResultSpec = mojo.internal.bindings.blink.mojom.AIPageContentImageBytesResultSpec || { $: {} };
if (mojo.internal.bindings.blink.mojom.AIPageContentImageBytesResultSpec.$.structSpec && mojo.internal.bindings.blink.mojom.AIPageContentImageBytesResultSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.blink.mojom.AIPageContentImageBytesResultSpec.$ = {};
...
mojo.internal.bindings.blink.mojom.AIPageContentAgent_GetImageBytes_ParamsSpec = mojo.internal.bindings.blink.mojom.AIPageContentAgent_GetImageBytes_ParamsSpec || { $: {} };
if (mojo.internal.bindings.blink.mojom.AIPageContentAgent_GetImageBytes_ParamsSpec.$.structSpec && mojo.internal.bindings.blink.mojom.AIPageContentAgent_GetImageBytes_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.blink.mojom.AIPageContentAgent_GetImageBytes_ParamsSpec.$ = {};
mojo.internal.bindings.blink.mojom.AIPageContentAgent_GetImageBytes_ResponseParamsSpec = mojo.internal.bindings.blink.mojom.AIPageContentAgent_GetImageBytes_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.blink.mojom.AIPageContentAgent_GetImageBytes_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.blink.mojom.AIPageContentAgent_GetImageBytes_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.blink.mojom.AIPageContentAgent_GetImageBytes_ResponseParamsSpec.$ = {};
...
mojo.internal.bindings.blink = mojo.internal.bindings.blink || {};
mojo.internal.bindings.blink.mojom = mojo.internal.bindings.blink.mojom || {};
mojo.internal.bindings.blink.mojom.AIPageContentIframeContentSpec = mojo.internal.bindings.blink.mojom.AIPageContentIframeContentSpec || { $: mojo.internal.OpaqueStruct.$ };
mojo.internal.bindings.blink = mojo.internal.bindings.blink || {};
mojo.internal.bindings.blink.mojom = mojo.internal.bindings.blink.mojom || {};
...
mojo.internal.bindings.blink = mojo.internal.bindings.blink || {};
mojo.internal.bindings.blink.mojom = mojo.internal.bindings.blink.mojom || {};
mojo.internal.bindings.blink.mojom.ScriptToolSpec = mojo.internal.bindings.blink.mojom.ScriptToolSpec || { $: mojo.internal.OpaqueStruct.$ };
mojo.internal.bindings.gfx = mojo.internal.bindings.gfx || {};
...
mojo.internal.bindings.blink.mojom.AIPageContentAgentRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('blink.mojom.AIPageContentAgent', [
      { explicit: null },
      { explicit: null },
    ]);
  }
  ...
  getImageBytes(arg_dom_node_id) {
    return this.proxy.sendMessage(
      ...
      mojo.internal.bindings.blink.mojom.AIPageContentAgent_GetImageBytes_ParamsSpec,
      mojo.internal.bindings.blink.mojom.AIPageContentAgent_GetImageBytes_ResponseParamsSpec,
      [arg_dom_node_id],
      false);
  }
...
mojo.internal.bindings.blink.mojom.AIPageContentAgentReceiver = class {
  constructor(impl) {
    ...
    const ordinals = window.mojoScrambler.getOrdinals('blink.mojom.AIPageContentAgent', [
      { explicit: null },
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        case 0: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const resp_obj = { 'arg_page_content': val };
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.blink.mojom.AIPageContentAgent_GetAIPageContent_ResponseParamsSpec.$.structSpec, resp_obj);
        ...
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.blink.mojom.AIPageContentAgent_GetImageBytes_ParamsSpec.$.structSpec);
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.blink.mojom.AIPageContentAgent_GetImageBytes_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
...
mojo.internal.Union(
    mojo.internal.bindings.blink.mojom.AIPageContentIframeContentSpec, 'blink.mojom.AIPageContentIframeContent', {
      'arg_local_frame_data': {
        'ordinal': 0,
        'type': mojo.internal.bindings.blink.mojom.AIPageContentFrameDataSpec,
        'nullable': false,
      },
      'arg_redacted_frame_metadata': {
        'ordinal': 1,
        'type': mojo.internal.bindings.blink.mojom.RedactedFrameMetadataSpec,
        'nullable': false,
      },
    });
...
mojo.internal.Struct(
    mojo.internal.bindings.blink.mojom.AIPageContentSelectionSpec, 'blink.mojom.AIPageContentSelection', [
      mojo.internal.StructField('arg_start_dom_node_id', 0, 0, mojo.internal.Int32, 0, false, 0, undefined),
      mojo.internal.StructField('arg_start_offset', 4, 0, mojo.internal.Int32, 0, false, 0, undefined),
      mojo.internal.StructField('arg_end_dom_node_id', 8, 0, mojo.internal.Int32, 0, false, 0, undefined),
      mojo.internal.StructField('arg_end_offset', 12, 0, mojo.internal.Int32, 0, false, 0, undefined),
      mojo.internal.StructField('arg_selected_text', 16, 0, mojo.internal.String, null, false, 0, undefined),
    ],
    [[0, 32]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.blink.mojom.AIPageContentPageInteractionInfoSpec, 'blink.mojom.AIPageContentPageInteractionInfo', [
      mojo.internal.StructField('arg_focused_dom_node_id_$flag', 0, 0, mojo.internal.Bool, false, false, 0, { isPrimary: true, linkedValueFieldName: 'arg_focused_dom_node_id_$value', originalFieldName: 'arg_focused_dom_node_id' }),
      mojo.internal.StructField('arg_accessibility_focused_dom_node_id_$flag', 0, 1, mojo.internal.Bool, false, false, 0, { isPrimary: true, linkedValueFieldName: 'arg_accessibility_focused_dom_node_id_$value', originalFieldName: 'arg_accessibility_focused_dom_node_id' }),
      mojo.internal.StructField('arg_focused_dom_node_id_$value', 4, 0, mojo.internal.Int32, 0, false, 0, { isPrimary: false, linkedValueFieldName: 'arg_focused_dom_node_id_$flag', originalFieldName: 'arg_focused_dom_node_id' }),
      mojo.internal.StructField('arg_accessibility_focused_dom_node_id_$value', 8, 0, mojo.internal.Int32, 0, false, 0, { isPrimary: false, linkedValueFieldName: 'arg_accessibility_focused_dom_node_id_$flag', originalFieldName: 'arg_accessibility_focused_dom_node_id' }),
      mojo.internal.StructField('arg_mouse_position', 16, 0, mojo.internal.bindings.gfx.mojom.PointSpec, null, true, 0, undefined),
    ],
    [[0, 32]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.blink.mojom.AIPageContentFrameInteractionInfoSpec, 'blink.mojom.AIPageContentFrameInteractionInfo', [
      mojo.internal.StructField('arg_selection', 0, 0, mojo.internal.bindings.blink.mojom.AIPageContentSelectionSpec, null, true, 0, undefined),
      mojo.internal.StructField('arg_focused_dom_node_id_$flag', 8, 0, mojo.internal.Bool, false, false, 0, { isPrimary: true, linkedValueFieldName: 'arg_focused_dom_node_id_$value', originalFieldName: 'arg_focused_dom_node_id' }),
      mojo.internal.StructField('arg_accessibility_focused_dom_node_id_$flag', 8, 1, mojo.internal.Bool, false, false, 0, { isPrimary: true, linkedValueFieldName: 'arg_accessibility_focused_dom_node_id_$value', originalFieldName: 'arg_accessibility_focused_dom_node_id' }),
      mojo.internal.StructField('arg_focused_dom_node_id_$value', 12, 0, mojo.internal.Int32, 0, false, 0, { isPrimary: false, linkedValueFieldName: 'arg_focused_dom_node_id_$flag', originalFieldName: 'arg_focused_dom_node_id' }),
      mojo.internal.StructField('arg_accessibility_focused_dom_node_id_$value', 16, 0, mojo.internal.Int32, 0, false, 0, { isPrimary: false, linkedValueFieldName: 'arg_accessibility_focused_dom_node_id_$flag', originalFieldName: 'arg_accessibility_focused_dom_node_id' }),
    ],
    [[0, 32]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.blink.mojom.AIPageContentNodeInteractionInfoSpec, 'blink.mojom.AIPageContentNodeInteractionInfo', [
      mojo.internal.StructField('arg_scroller_info', 0, 0, mojo.internal.bindings.blink.mojom.AIPageContentScrollerInfoSpec, null, true, 0, undefined),
      mojo.internal.StructField('arg_is_focusable', 8, 0, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_is_tabbable', 8, 1, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_has_aria_activedescendant', 8, 2, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_document_scoped_z_order_$flag', 8, 3, mojo.internal.Bool, false, false, 0, { isPrimary: true, linkedValueFieldName: 'arg_document_scoped_z_order_$value', originalFieldName: 'arg_document_scoped_z_order' }),
      mojo.internal.StructField('arg_is_disabled', 8, 4, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_document_scoped_z_order_$value', 12, 0, mojo.internal.Int32, 0, false, 0, { isPrimary: false, linkedValueFieldName: 'arg_document_scoped_z_order_$flag', originalFieldName: 'arg_document_scoped_z_order' }),
      mojo.internal.StructField('arg_aria_action_target_node_ids', 16, 0, mojo.internal.Array(mojo.internal.Int32, false), null, false, 0, undefined),
      mojo.internal.StructField('arg_clickability_reasons', 24, 0, mojo.internal.Array(mojo.internal.bindings.blink.mojom.AIPageContentClickabilityReasonSpec, false), null, false, 0, undefined),
      mojo.internal.StructField('arg_interaction_disabled_reasons', 32, 0, mojo.internal.Array(mojo.internal.bindings.blink.mojom.AIPageContentInteractionDisabledReasonSpec, false), null, false, 0, undefined),
    ],
    [[0, 48]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.blink.mojom.AIPageContentTextStyleSpec, 'blink.mojom.AIPageContentTextStyle', [
      mojo.internal.StructField('arg_text_size', 0, 0, mojo.internal.bindings.blink.mojom.AIPageContentTextSizeSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_has_emphasis', 4, 0, mojo.internal.Bool, false, false, 0, undefined),
...
mojo.internal.Struct(
    mojo.internal.bindings.blink.mojom.AIPageContentTextInfoSpec, 'blink.mojom.AIPageContentTextInfo', [
      ...
      mojo.internal.StructField('arg_text_style', 8, 0, mojo.internal.bindings.blink.mojom.AIPageContentTextStyleSpec, null, false, 0, undefined),
    ],
    [[0, 24]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.blink.mojom.AIPageContentAnchorDataSpec, 'blink.mojom.AIPageContentAnchorData', [
      ...
      mojo.internal.StructField('arg_rel', 8, 0, mojo.internal.Array(mojo.internal.bindings.blink.mojom.AIPageContentAnchorRelSpec, false), null, false, 0, undefined),
    ],
    [[0, 24]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.blink.mojom.AIPageContentFrameDataSpec, 'blink.mojom.AIPageContentFrameData', [
      mojo.internal.StructField('arg_frame_interaction_info', 0, 0, mojo.internal.bindings.blink.mojom.AIPageContentFrameInteractionInfoSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_meta_data', 8, 0, mojo.internal.Array(mojo.internal.bindings.blink.mojom.AIPageContentMetaSpec, false), null, false, 0, undefined),
      mojo.internal.StructField('arg_title', 16, 0, mojo.internal.String, null, true, 0, undefined),
      mojo.internal.StructField('arg_contains_paid_content_$flag', 24, 0, mojo.internal.Bool, false, false, 0, { isPrimary: true, linkedValueFieldName: 'arg_contains_paid_content_$value', originalFieldName: 'arg_contains_paid_content' }),
      mojo.internal.StructField('arg_contains_paid_content_$value', 24, 1, mojo.internal.Bool, false, false, 0, { isPrimary: false, linkedValueFieldName: 'arg_contains_paid_content_$flag', originalFieldName: 'arg_contains_paid_content' }),
      mojo.internal.StructField('arg_default_line_height_px', 28, 0, mojo.internal.Uint32, 0, false, 0, undefined),
      mojo.internal.StructField('arg_script_tools', 32, 0, mojo.internal.Array(mojo.internal.bindings.blink.mojom.ScriptToolSpec, false), null, false, 0, undefined),
      mojo.internal.StructField('arg_popup', 40, 0, mojo.internal.bindings.blink.mojom.AIPageContentPopupSpec, null, true, 0, undefined),
    ],
    [[0, 56]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.blink.mojom.AIPageContentIframeDataSpec, 'blink.mojom.AIPageContentIframeData', [
      ...
      mojo.internal.StructField('arg_content', 16, 0, mojo.internal.bindings.blink.mojom.AIPageContentIframeContentSpec, null, true, 0, undefined),
    ],
    [[0, 40]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.blink.mojom.AIPageContentTableRowDataSpec, 'blink.mojom.AIPageContentTableRowData', [
      mojo.internal.StructField('arg_row_type', 0, 0, mojo.internal.bindings.blink.mojom.AIPageContentTableRowTypeSpec, null, false, 0, undefined),
    ],
    [[0, 16]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.blink.mojom.AIPageContentFormControlDataSpec, 'blink.mojom.AIPageContentFormControlData', [
      ...
      mojo.internal.StructField('arg_is_checked', 4, 0, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_is_required', 4, 1, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_is_readonly', 4, 2, mojo.internal.Bool, false, false, 0, undefined),
      ...
      mojo.internal.StructField('arg_select_options', 24, 0, mojo.internal.Array(mojo.internal.bindings.blink.mojom.AIPageContentSelectOptionSpec, false), null, false, 0, undefined),
...
mojo.internal.Struct(
    mojo.internal.bindings.blink.mojom.AIPageContentAttributesSpec, 'blink.mojom.AIPageContentAttributes', [
      mojo.internal.StructField('arg_dom_node_id_$flag', 0, 0, mojo.internal.Bool, false, false, 0, { isPrimary: true, linkedValueFieldName: 'arg_dom_node_id_$value', originalFieldName: 'arg_dom_node_id' }),
      mojo.internal.StructField('arg_label_for_dom_node_id_$flag', 0, 1, mojo.internal.Bool, false, false, 0, { isPrimary: true, linkedValueFieldName: 'arg_label_for_dom_node_id_$value', originalFieldName: 'arg_label_for_dom_node_id' }),
      mojo.internal.StructField('arg_is_ad_related', 0, 2, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_dom_node_id_$value', 4, 0, mojo.internal.Int32, 0, false, 0, { isPrimary: false, linkedValueFieldName: 'arg_dom_node_id_$flag', originalFieldName: 'arg_dom_node_id' }),
      mojo.internal.StructField('arg_attribute_type', 8, 0, mojo.internal.bindings.blink.mojom.AIPageContentAttributeTypeSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_redaction_decision', 12, 0, mojo.internal.bindings.blink.mojom.AIPageContentRedactionDecisionSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_geometry', 16, 0, mojo.internal.bindings.blink.mojom.AIPageContentGeometrySpec, null, true, 0, undefined),
      mojo.internal.StructField('arg_node_interaction_info', 24, 0, mojo.internal.bindings.blink.mojom.AIPageContentNodeInteractionInfoSpec, null, true, 0, undefined),
      mojo.internal.StructField('arg_text_info', 32, 0, mojo.internal.bindings.blink.mojom.AIPageContentTextInfoSpec, null, true, 0, undefined),
      mojo.internal.StructField('arg_image_info', 40, 0, mojo.internal.bindings.blink.mojom.AIPageContentImageInfoSpec, null, true, 0, undefined),
      mojo.internal.StructField('arg_svg_root_data', 48, 0, mojo.internal.bindings.blink.mojom.AIPageContentSvgRootDataSpec, null, true, 0, undefined),
      mojo.internal.StructField('arg_canvas_data', 56, 0, mojo.internal.bindings.blink.mojom.AIPageContentCanvasDataSpec, null, true, 0, undefined),
      mojo.internal.StructField('arg_video_data', 64, 0, mojo.internal.bindings.blink.mojom.AIPageContentVideoDataSpec, null, true, 0, undefined),
      mojo.internal.StructField('arg_anchor_data', 72, 0, mojo.internal.bindings.blink.mojom.AIPageContentAnchorDataSpec, null, true, 0, undefined),
      mojo.internal.StructField('arg_form_data', 80, 0, mojo.internal.bindings.blink.mojom.AIPageContentFormDataSpec, null, true, 0, undefined),
      mojo.internal.StructField('arg_form_control_data', 88, 0, mojo.internal.bindings.blink.mojom.AIPageContentFormControlDataSpec, null, true, 0, undefined),
      mojo.internal.StructField('arg_table_data', 96, 0, mojo.internal.bindings.blink.mojom.AIPageContentTableDataSpec, null, true, 0, undefined),
      mojo.internal.StructField('arg_iframe_data', 104, 0, mojo.internal.bindings.blink.mojom.AIPageContentIframeDataSpec, null, true, 0, undefined),
      mojo.internal.StructField('arg_table_row_data', 112, 0, mojo.internal.bindings.blink.mojom.AIPageContentTableRowDataSpec, null, true, 0, undefined),
      mojo.internal.StructField('arg_annotated_roles', 120, 0, mojo.internal.Array(mojo.internal.bindings.blink.mojom.AIPageContentAnnotatedRoleSpec, false), null, false, 0, undefined),
      mojo.internal.StructField('arg_label', 128, 0, mojo.internal.String, null, true, 0, undefined),
      mojo.internal.StructField('arg_aria_role', 136, 0, mojo.internal.bindings.ax.mojom.RoleSpec, null, true, 0, undefined),
...
mojo.internal.Struct(
    mojo.internal.bindings.blink.mojom.AIPageContentNodeSpec, 'blink.mojom.AIPageContentNode', [
      mojo.internal.StructField('arg_children_nodes', 0, 0, mojo.internal.Array(mojo.internal.bindings.blink.mojom.AIPageContentNodeSpec, false), null, false, 0, undefined),
      mojo.internal.StructField('arg_content_attributes', 8, 0, mojo.internal.bindings.blink.mojom.AIPageContentAttributesSpec, null, false, 0, undefined),
    ],
    [[0, 24]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.blink.mojom.AIPageContentPopupSpec, 'blink.mojom.AIPageContentPopup', [
      mojo.internal.StructField('arg_root_node', 0, 0, mojo.internal.bindings.blink.mojom.AIPageContentNodeSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_opener_dom_node_id', 8, 0, mojo.internal.Int32, 0, false, 0, undefined),
      mojo.internal.StructField('arg_visible_bounding_box', 16, 0, mojo.internal.bindings.gfx.mojom.RectSpec, null, false, 0, undefined),
    ],
    [[0, 32]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.blink.mojom.AIPageContentSpec, 'blink.mojom.AIPageContent', [
      mojo.internal.StructField('arg_root_node', 0, 0, mojo.internal.bindings.blink.mojom.AIPageContentNodeSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_page_interaction_info', 8, 0, mojo.internal.bindings.blink.mojom.AIPageContentPageInteractionInfoSpec, null, true, 0, undefined),
      mojo.internal.StructField('arg_frame_data', 16, 0, mojo.internal.bindings.blink.mojom.AIPageContentFrameDataSpec, null, false, 0, undefined),
...
// Struct: NonSalientContentConfig
mojo.internal.Struct(
    mojo.internal.bindings.blink.mojom.NonSalientContentConfigSpec, 'blink.mojom.NonSalientContentConfig', [
      mojo.internal.StructField('arg_exclude_ad_related', 0, 0, mojo.internal.Bool, false, false, 0, undefined),
    ],
    [[0, 16]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.blink.mojom.AIPageContentOptionsSpec, 'blink.mojom.AIPageContentOptions', [
      mojo.internal.StructField('arg_mode', 0, 0, mojo.internal.bindings.blink.mojom.AIPageContentModeSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_on_critical_path', 4, 0, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_include_same_site_only', 4, 1, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_include_passwords_for_redaction', 4, 2, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_include_sensitive_payments_for_redaction', 4, 3, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_include_otps_for_redaction', 4, 4, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_max_meta_elements', 8, 0, mojo.internal.Int32, 0, false, 0, undefined),
      mojo.internal.StructField('arg_main_frame_view_rect_in_dips', 16, 0, mojo.internal.bindings.gfx.mojom.RectSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_node_id_allowlist', 24, 0, mojo.internal.Array(mojo.internal.bindings.blink.mojom.AIPageContentAttributeTypeSpec, false), null, true, 0, undefined),
      mojo.internal.StructField('arg_non_salient_content_config', 32, 0, mojo.internal.bindings.blink.mojom.NonSalientContentConfigSpec, null, true, 0, undefined),
    ],
    [[0, 48]]);

// Struct: AIPageContentImageBytesResult
mojo.internal.Struct(
    mojo.internal.bindings.blink.mojom.AIPageContentImageBytesResultSpec, 'blink.mojom.AIPageContentImageBytesResult', [
      ...
      mojo.internal.StructField('arg_image_info', 16, 0, mojo.internal.bindings.blink.mojom.AIPageContentImageInfoSpec, null, false, 0, undefined),
    ],
    [[0, 32]]);
mojo.internal.Struct(
    mojo.internal.bindings.blink.mojom.AIPageContentAgent_GetAIPageContent_ParamsSpec, 'blink.mojom.AIPageContentAgent_GetAIPageContent_Params', [
      mojo.internal.StructField('arg_request', 0, 0, mojo.internal.bindings.blink.mojom.AIPageContentOptionsSpec, null, false, 0, undefined),
    ],
    [[0, 16]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.blink.mojom.AIPageContentAgent_GetAIPageContent_ResponseParamsSpec, 'blink.mojom.AIPageContentAgent_GetAIPageContent_ResponseParams', [
      mojo.internal.StructField('arg_page_content', 0, 0, mojo.internal.bindings.blink.mojom.AIPageContentSpec, null, true, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.blink.mojom.AIPageContentAgent_GetImageBytes_ParamsSpec, 'blink.mojom.AIPageContentAgent_GetImageBytes_Params', [
      mojo.internal.StructField('arg_dom_node_id', 0, 0, mojo.internal.Int32, 0, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.blink.mojom.AIPageContentAgent_GetImageBytes_ResponseParamsSpec, 'blink.mojom.AIPageContentAgent_GetImageBytes_ResponseParams', [
      mojo.internal.StructField('arg_result', 0, 0, mojo.internal.bindings.blink.mojom.AIPageContentImageBytesResultSpec, null, true, 0, undefined),
    ],
    [[0, 16]]);
