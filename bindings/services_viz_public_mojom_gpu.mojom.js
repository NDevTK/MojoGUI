...
mojo.internal.bindings.viz.mojom.GpuRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.viz.mojom.GpuRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.viz.mojom.Gpu.getRemote = function() {
  let remote = new mojo.internal.bindings.viz.mojom.GpuRemote();
...
mojo.internal.bindings.viz.mojom.GpuReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.viz.mojom.Gpu_EstablishGpuChannel_ParamsSpec.$.structSpec);
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.viz.mojom.Gpu_EstablishGpuChannel_ResponseParamsSpec, header, rawHeader);
               responder(response);
...
mojo.internal.bindings.viz.mojom.GpuReceiver = mojo.internal.bindings.viz.mojom.GpuReceiver;
