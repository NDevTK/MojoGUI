...
mojo.internal.bindings.content.mojom.FieldTrialRecorder = {};
mojo.internal.bindings.content.mojom.FieldTrialRecorderSpec = { $ : {} };
mojo.internal.bindings.content.mojom.FieldTrialRecorder.$interfaceName = 'content.mojom.FieldTrialRecorder';
...
mojo.internal.bindings.content.mojom.FieldTrialRecorderRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.content.mojom.FieldTrialRecorderPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.content.mojom.FieldTrialRecorderRemoteCallHandler(this.proxy);
  }
  ...
  fieldTrialActivated(arg_trial_name) {
    return this.$.fieldTrialActivated(arg_trial_name);
  }
};

mojo.internal.bindings.content.mojom.FieldTrialRecorderRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('content.mojom.FieldTrialRecorder', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.content.mojom.FieldTrialRecorder.getRemote = function() {
  let remote = new mojo.internal.bindings.content.mojom.FieldTrialRecorderRemote();
...
mojo.internal.bindings.content.mojom.FieldTrialRecorderReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('content.mojom.FieldTrialRecorder', [
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.content.mojom.FieldTrialRecorder_FieldTrialActivated_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for FieldTrialActivated failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.content.mojom.FieldTrialRecorderReceiver = mojo.internal.bindings.content.mojom.FieldTrialRecorderReceiver;
