...
mojo.internal.bindings.guest_contents.mojom.GuestContentsHostRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.guest_contents.mojom.GuestContentsHostPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.guest_contents.mojom.GuestContentsHostRemoteCallHandler(this.proxy);
  }
  ...
  attach(arg_frame_to_swap, arg_guest_contents_id) {
    return this.$.attach(arg_frame_to_swap, arg_guest_contents_id);
  }
};

mojo.internal.bindings.guest_contents.mojom.GuestContentsHostRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('guest_contents.mojom.GuestContentsHost', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.guest_contents.mojom.GuestContentsHost.getRemote = function() {
  let remote = new mojo.internal.bindings.guest_contents.mojom.GuestContentsHostRemote();
...
mojo.internal.bindings.guest_contents.mojom.GuestContentsHostReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('guest_contents.mojom.GuestContentsHost', [
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.guest_contents.mojom.GuestContentsHost_Attach_ParamsSpec.$.structSpec);
        ...
        case 0: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.guest_contents.mojom.GuestContentsHost_Attach_ResponseParamsSpec, header, rawHeader);
               responder(response);
...
mojo.internal.bindings.guest_contents.mojom.GuestContentsHostReceiver = mojo.internal.bindings.guest_contents.mojom.GuestContentsHostReceiver;
