...
mojo.internal.bindings.ash.growth.mojom.PageHandlerRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.ash.growth.mojom.PageHandlerPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.ash.growth.mojom.PageHandlerRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.ash.growth.mojom.PageHandlerRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('ash.growth.mojom.PageHandler', [
      { explicit: null },
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.ash.growth.mojom.PageHandler.getRemote = function() {
  let remote = new mojo.internal.bindings.ash.growth.mojom.PageHandlerRemote();
...
mojo.internal.bindings.ash.growth.mojom.PageHandlerReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('ash.growth.mojom.PageHandler', [
      { explicit: null },
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.ash.growth.mojom.PageHandler_GetCampaignsLogs_ParamsSpec.$.structSpec);
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.ash.growth.mojom.PageHandler_ClearAllEvents_ParamsSpec.$.structSpec);
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.ash.growth.mojom.PageHandler_GetCampaignsLogs_ParamsSpec.$.structSpec);
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.ash.growth.mojom.PageHandler_GetCampaignsLogs_ResponseParamsSpec, header, rawHeader);
               responder(response);
        ...
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.ash.growth.mojom.PageHandler_ClearAllEvents_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.ash.growth.mojom.PageHandlerReceiver = mojo.internal.bindings.ash.growth.mojom.PageHandlerReceiver;
