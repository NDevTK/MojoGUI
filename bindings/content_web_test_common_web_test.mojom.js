  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.content.mojom.WebTestRenderFrame_SynchronouslyCompositeAfterTest_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for SynchronouslyCompositeAfterTest failed with TypeError');
           }
        }
        // Try Method 1: DumpFrameLayout
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.content.mojom.WebTestRenderFrame_DumpFrameLayout_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for DumpFrameLayout failed with TypeError');
           }
        }
        // Try Method 2: SetTestConfiguration
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.content.mojom.WebTestRenderFrame_SetTestConfiguration_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for SetTestConfiguration failed with TypeError');
           }
        }
        // Try Method 3: OnDeactivated
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.content.mojom.WebTestRenderFrame_OnDeactivated_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OnDeactivated failed with TypeError');
           }
        }
        // Try Method 4: OnReactivated
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.content.mojom.WebTestRenderFrame_OnReactivated_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OnReactivated failed with TypeError');
           }
        }
        // Try Method 5: BlockTestUntilStart
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.content.mojom.WebTestRenderFrame_BlockTestUntilStart_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for BlockTestUntilStart failed with TypeError');
           }
        }
        // Try Method 6: StartTest
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.content.mojom.WebTestRenderFrame_StartTest_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for StartTest failed with TypeError');
           }
        }
        // Try Method 7: SetupRendererProcessForNonTestWindow
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.content.mojom.WebTestRenderFrame_SetupRendererProcessForNonTestWindow_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for SetupRendererProcessForNonTestWindow failed with TypeError');
           }
        }
        // Try Method 8: ReplicateWebTestRuntimeFlagsChanges
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.content.mojom.WebTestRenderFrame_ReplicateWebTestRuntimeFlagsChanges_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for ReplicateWebTestRuntimeFlagsChanges failed with TypeError');
           }
        }
        // Try Method 9: TestFinishedFromSecondaryRenderer
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.content.mojom.WebTestRenderFrame_TestFinishedFromSecondaryRenderer_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for TestFinishedFromSecondaryRenderer failed with TypeError');
           }
        }
        // Try Method 10: ResetRendererAfterWebTest
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.content.mojom.WebTestRenderFrame_ResetRendererAfterWebTest_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for ResetRendererAfterWebTest failed with TypeError');
           }
        }
        // Try Method 11: ProcessWorkItem
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.content.mojom.WebTestRenderFrame_ProcessWorkItem_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for ProcessWorkItem failed with TypeError');
           }
        }
        // Try Method 12: ReplicateWorkQueueStates
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.content.mojom.WebTestRenderFrame_ReplicateWorkQueueStates_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for ReplicateWorkQueueStates failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.content.mojom.WebTestControlHost_InitiateCaptureDump_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for InitiateCaptureDump failed with TypeError');
           }
        }
        // Try Method 1: TestFinishedInSecondaryRenderer
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.content.mojom.WebTestControlHost_TestFinishedInSecondaryRenderer_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for TestFinishedInSecondaryRenderer failed with TypeError');
           }
        }
        // Try Method 2: PrintMessageToStderr
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.content.mojom.WebTestControlHost_PrintMessageToStderr_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for PrintMessageToStderr failed with TypeError');
           }
        }
        // Try Method 3: PrintMessage
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.content.mojom.WebTestControlHost_PrintMessage_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for PrintMessage failed with TypeError');
           }
        }
        // Try Method 4: OverridePreferences
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.content.mojom.WebTestControlHost_OverridePreferences_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OverridePreferences failed with TypeError');
           }
        }
        // Try Method 5: Reload
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.content.mojom.WebTestControlHost_Reload_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.content.mojom.WebTestControlHost_CheckForLeakedWindows_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for CheckForLeakedWindows failed with TypeError');
           }
        }
        // Try Method 7: SetMainWindowHidden
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.content.mojom.WebTestControlHost_SetMainWindowHidden_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for SetMainWindowHidden failed with TypeError');
           }
        }
        // Try Method 8: SetFrameWindowHidden
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.content.mojom.WebTestControlHost_SetFrameWindowHidden_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for SetFrameWindowHidden failed with TypeError');
           }
        }
        // Try Method 9: GoToOffset
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.content.mojom.WebTestControlHost_GoToOffset_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for GoToOffset failed with TypeError');
           }
        }
        // Try Method 10: SendBluetoothManualChooserEvent
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.content.mojom.WebTestControlHost_SendBluetoothManualChooserEvent_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for SendBluetoothManualChooserEvent failed with TypeError');
           }
        }
        // Try Method 11: SetBluetoothManualChooser
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.content.mojom.WebTestControlHost_SetBluetoothManualChooser_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for SetBluetoothManualChooser failed with TypeError');
           }
        }
        // Try Method 12: GetBluetoothManualChooserEvents
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.content.mojom.WebTestControlHost_GetBluetoothManualChooserEvents_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for GetBluetoothManualChooserEvents failed with TypeError');
           }
        }
        // Try Method 13: SetPopupBlockingEnabled
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.content.mojom.WebTestControlHost_SetPopupBlockingEnabled_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for SetPopupBlockingEnabled failed with TypeError');
           }
        }
        // Try Method 14: LoadURLForFrame
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.content.mojom.WebTestControlHost_LoadURLForFrame_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for LoadURLForFrame failed with TypeError');
           }
        }
        // Try Method 15: SimulateScreenOrientationChanged
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.content.mojom.WebTestControlHost_SimulateScreenOrientationChanged_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for SimulateScreenOrientationChanged failed with TypeError');
           }
        }
        // Try Method 16: SetPermission
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.content.mojom.WebTestControlHost_SetPermission_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.content.mojom.WebTestControlHost_BlockThirdPartyCookies_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.content.mojom.WebTestControlHost_GetWritableDirectory_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for GetWritableDirectory failed with TypeError');
           }
        }
        // Try Method 19: SetFilePathForMockFileDialog
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.content.mojom.WebTestControlHost_SetFilePathForMockFileDialog_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for SetFilePathForMockFileDialog failed with TypeError');
           }
        }
        // Try Method 20: CreateSubresourceFilterRulesetFile
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.content.mojom.WebTestControlHost_CreateSubresourceFilterRulesetFile_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for CreateSubresourceFilterRulesetFile failed with TypeError');
           }
        }
        // Try Method 21: FocusDevtoolsSecondaryWindow
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.content.mojom.WebTestControlHost_FocusDevtoolsSecondaryWindow_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for FocusDevtoolsSecondaryWindow failed with TypeError');
           }
        }
        // Try Method 22: SetTrustTokenKeyCommitments
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.content.mojom.WebTestControlHost_SetTrustTokenKeyCommitments_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.content.mojom.WebTestControlHost_ClearTrustTokenState_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for ClearTrustTokenState failed with TypeError');
           }
        }
        // Try Method 24: SimulateWebNotificationClick
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.content.mojom.WebTestControlHost_SimulateWebNotificationClick_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for SimulateWebNotificationClick failed with TypeError');
           }
        }
        // Try Method 25: SimulateWebNotificationClose
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.content.mojom.WebTestControlHost_SimulateWebNotificationClose_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for SimulateWebNotificationClose failed with TypeError');
           }
        }
        // Try Method 26: SimulateWebContentIndexDelete
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.content.mojom.WebTestControlHost_SimulateWebContentIndexDelete_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for SimulateWebContentIndexDelete failed with TypeError');
           }
        }
        // Try Method 27: WebTestRuntimeFlagsChanged
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.content.mojom.WebTestControlHost_WebTestRuntimeFlagsChanged_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for WebTestRuntimeFlagsChanged failed with TypeError');
           }
        }
        // Try Method 28: RegisterIsolatedFileSystem
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.content.mojom.WebTestControlHost_RegisterIsolatedFileSystem_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for RegisterIsolatedFileSystem failed with TypeError');
           }
        }
        // Try Method 29: DropPointerLock
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.content.mojom.WebTestControlHost_DropPointerLock_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for DropPointerLock failed with TypeError');
           }
        }
        // Try Method 30: SetPointerLockWillFail
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.content.mojom.WebTestControlHost_SetPointerLockWillFail_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for SetPointerLockWillFail failed with TypeError');
           }
        }
        // Try Method 31: SetPointerLockWillRespondAsynchronously
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.content.mojom.WebTestControlHost_SetPointerLockWillRespondAsynchronously_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for SetPointerLockWillRespondAsynchronously failed with TypeError');
           }
        }
        // Try Method 32: AllowPointerLock
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.content.mojom.WebTestControlHost_AllowPointerLock_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for AllowPointerLock failed with TypeError');
           }
        }
        // Try Method 33: WorkItemAdded
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.content.mojom.WebTestControlHost_WorkItemAdded_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for WorkItemAdded failed with TypeError');
           }
        }
        // Try Method 34: RequestWorkItem
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.content.mojom.WebTestControlHost_RequestWorkItem_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for RequestWorkItem failed with TypeError');
           }
        }
        // Try Method 35: WorkQueueStatesChanged
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.content.mojom.WebTestControlHost_WorkQueueStatesChanged_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for WorkQueueStatesChanged failed with TypeError');
           }
        }
        // Try Method 36: SetAcceptLanguages
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.content.mojom.WebTestControlHost_SetAcceptLanguages_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for SetAcceptLanguages failed with TypeError');
           }
        }
        // Try Method 37: SetRegisterProtocolHandlerMode
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.content.mojom.WebTestControlHost_SetRegisterProtocolHandlerMode_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for SetRegisterProtocolHandlerMode failed with TypeError');
           }
        }
        // Try Method 38: EnableAutoResize
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.content.mojom.WebTestControlHost_EnableAutoResize_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.content.mojom.WebTestControlHost_DisableAutoResize_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.content.mojom.NonAssociatedWebTestControlHost_SetLCPPNavigationHint_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for SetLCPPNavigationHint failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
             console.warn('[GeneratedReceiver] Failed to discover ordinal ' + header.ordinal);
