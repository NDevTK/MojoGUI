...
mojo.internal.bindings.chromecast.media.mojom.VideoGeometryChangeClientRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.chromecast.media.mojom.VideoGeometryChangeClientRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.chromecast.media.mojom.VideoGeometryChangeClient.getRemote = function() {
  let remote = new mojo.internal.bindings.chromecast.media.mojom.VideoGeometryChangeClientRemote();
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.chromecast.media.mojom.VideoGeometryChangeClient_OnVideoGeometryChange_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OnVideoGeometryChange failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.chromecast.media.mojom.VideoGeometryChangeClientReceiver = mojo.internal.bindings.chromecast.media.mojom.VideoGeometryChangeClientReceiver;

mojo.internal.bindings.chromecast.media.mojom.VideoGeometryChangeClientPtr = mojo.internal.bindings.chromecast.media.mojom.VideoGeometryChangeClientRemote;
mojo.internal.bindings.chromecast.media.mojom.VideoGeometryChangeClientRequest = mojo.internal.bindings.chromecast.media.mojom.VideoGeometryChangeClientPendingReceiver;
...
mojo.internal.bindings.chromecast.media.mojom.VideoGeometryChangeSubscriberRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.chromecast.media.mojom.VideoGeometryChangeSubscriberRemoteCallHandler(this.proxy);
  }
  ...
  subscribeToVideoGeometryChange(arg_overlay_plane_id, arg_client_pending_remote) {
    return this.$.subscribeToVideoGeometryChange(arg_overlay_plane_id, arg_client_pending_remote);
  }
};
...
mojo.internal.bindings.chromecast.media.mojom.VideoGeometryChangeSubscriber.getRemote = function() {
  let remote = new mojo.internal.bindings.chromecast.media.mojom.VideoGeometryChangeSubscriberRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.chromecast.media.mojom.VideoGeometryChangeSubscriber_SubscribeToVideoGeometryChange_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for SubscribeToVideoGeometryChange failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
             console.warn('[GeneratedReceiver] Failed to discover ordinal ' + header.ordinal);
...
mojo.internal.bindings.chromecast.media.mojom.VideoGeometryChangeSubscriberReceiver = mojo.internal.bindings.chromecast.media.mojom.VideoGeometryChangeSubscriberReceiver;

mojo.internal.bindings.chromecast.media.mojom.VideoGeometryChangeSubscriberPtr = mojo.internal.bindings.chromecast.media.mojom.VideoGeometryChangeSubscriberRemote;
mojo.internal.bindings.chromecast.media.mojom.VideoGeometryChangeSubscriberRequest = mojo.internal.bindings.chromecast.media.mojom.VideoGeometryChangeSubscriberPendingReceiver;
...
mojo.internal.Struct(
    mojo.internal.bindings.chromecast.media.mojom.VideoGeometrySetter_SetVideoGeometry_ParamsSpec, 'chromecast.media.mojom.VideoGeometrySetter_SetVideoGeometry_Params', [
      mojo.internal.StructField('arg_rect_f', 0, 0, mojo.internal.bindings.gfx.mojom.RectFSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_overlay_plane_id', 8, 0, mojo.internal.bindings.mojo_base.mojom.UnguessableTokenSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_transform', 16, 0, mojo.internal.bindings.gfx.mojom.OverlayTransformSpec, null, false, 0, undefined),
    ],
    [[0, 32]]);
...
mojo.internal.bindings.chromecast.media.mojom.VideoGeometrySetterRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.chromecast.media.mojom.VideoGeometrySetterRemoteCallHandler(this.proxy);
  }
  ...
  setVideoGeometry(arg_rect_f, arg_transform, arg_overlay_plane_id) {
    return this.$.setVideoGeometry(arg_rect_f, arg_transform, arg_overlay_plane_id);
  }
};
...
mojo.internal.bindings.chromecast.media.mojom.VideoGeometrySetter.getRemote = function() {
  let remote = new mojo.internal.bindings.chromecast.media.mojom.VideoGeometrySetterRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.chromecast.media.mojom.VideoGeometrySetter_SetVideoGeometry_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for SetVideoGeometry failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
             console.warn('[GeneratedReceiver] Failed to discover ordinal ' + header.ordinal);
...
mojo.internal.bindings.chromecast.media.mojom.VideoGeometrySetterReceiver = mojo.internal.bindings.chromecast.media.mojom.VideoGeometrySetterReceiver;
