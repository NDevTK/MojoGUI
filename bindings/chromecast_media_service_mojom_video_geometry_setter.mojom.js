...
chromecast.media.mojom.VideoGeometryChangeClient_OnVideoGeometryChange_ParamsSpec = {
  $: {
    structSpec: {
      ...
      packedSize: 24,
      fields: [
        { name: 'rect_f', packedOffset: 0, packedBitOffset: 0, type: gfx.mojom.RectFSpec, nullable: false },
        { name: 'transform', packedOffset: 8, packedBitOffset: 0, type: gfx.mojom.OverlayTransformSpec, nullable: false },
      ],
      versions: [{version: 0}]
    }
  }
  ...
  $: {
    structSpec: {
      ...
      fields: [
        { name: 'rect_f', packedOffset: 0, packedBitOffset: 0, type: gfx.mojom.RectFSpec, nullable: false },
        { name: 'transform', packedOffset: 8, packedBitOffset: 0, type: gfx.mojom.OverlayTransformSpec, nullable: false },
        { name: 'overlay_plane_id', packedOffset: 16, packedBitOffset: 0, type: mojo_base.mojom.UnguessableTokenSpec, nullable: false },
      ],
      versions: [{version: 0}]
    }
  }
