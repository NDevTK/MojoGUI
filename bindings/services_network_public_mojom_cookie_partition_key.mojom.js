...
mojo.internal.bindings.network.mojom.AncestorChainBitSpec = { $: mojo.internal.Enum() };
mojo.internal.bindings.network.mojom.CookiePartitionKeySpec = { $: {} };
mojo.internal.bindings.network.mojom.CookiePartitionKeyCollectionSpec = { $: {} };
...
mojo.internal.bindings.network.mojom.AncestorChainBit = {
  kSameSite: 0,
  kCrossSite: 1,
};
...
mojo.internal.Struct(
    mojo.internal.bindings.network.mojom.CookiePartitionKeySpec, 'network.mojom.CookiePartitionKey', [
      ...
      mojo.internal.StructField('arg_from_script', 20, 0, mojo.internal.Bool, false, false, 0, undefined),
    ],
    [[0, 32]]);
