...
mojo.internal.bindings.remoting.mojom.WebAuthnCreateResponseSpec = { $: {} };
...
mojo.internal.Struct(
    mojo.internal.bindings.remoting.mojom.WebAuthnExceptionDetailsSpec, 'remoting.mojom.WebAuthnExceptionDetails', [
...
mojo.internal.Struct(
    mojo.internal.bindings.remoting.mojom.WebAuthnRequestCanceller_Cancel_ParamsSpec, 'remoting.mojom.WebAuthnRequestCanceller_Cancel_Params', [
    ],
    [[0, 8]]);

mojo.internal.Struct(
    mojo.internal.bindings.remoting.mojom.WebAuthnRequestCanceller_Cancel_ResponseParamsSpec, 'remoting.mojom.WebAuthnRequestCanceller_Cancel_ResponseParams', [
      mojo.internal.StructField('arg_was_canceled', 0, 0, mojo.internal.Bool, false, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.bindings.remoting.mojom.WebAuthnRequestCancellerPendingReceiver = class {
  constructor(handle) {
    this.handle = handle;
  }
};

mojo.internal.bindings.remoting.mojom.WebAuthnRequestCancellerRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.remoting.mojom.WebAuthnRequestCancellerPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.remoting.mojom.WebAuthnRequestCancellerRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.remoting.mojom.WebAuthnRequestCanceller.getRemote = function() {
  let remote = new mojo.internal.bindings.remoting.mojom.WebAuthnRequestCancellerRemote();
...
mojo.internal.bindings.remoting.mojom.WebAuthnRequestCancellerReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.remoting.mojom.WebAuthnRequestCanceller_Cancel_ParamsSpec.$.structSpec;
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.remoting.mojom.WebAuthnRequestCanceller_Cancel_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.remoting.mojom.WebAuthnRequestCancellerReceiver = mojo.internal.bindings.remoting.mojom.WebAuthnRequestCancellerReceiver;

mojo.internal.bindings.remoting.mojom.WebAuthnRequestCancellerPtr = mojo.internal.bindings.remoting.mojom.WebAuthnRequestCancellerRemote;
mojo.internal.bindings.remoting.mojom.WebAuthnRequestCancellerRequest = mojo.internal.bindings.remoting.mojom.WebAuthnRequestCancellerPendingReceiver;


// Interface: WebAuthnProxy
mojo.internal.Struct(
    mojo.internal.bindings.remoting.mojom.WebAuthnProxy_IsUserVerifyingPlatformAuthenticatorAvailable_ParamsSpec, 'remoting.mojom.WebAuthnProxy_IsUserVerifyingPlatformAuthenticatorAvailable_Params', [
    ],
    [[0, 8]]);

mojo.internal.Struct(
    mojo.internal.bindings.remoting.mojom.WebAuthnProxy_IsUserVerifyingPlatformAuthenticatorAvailable_ResponseParamsSpec, 'remoting.mojom.WebAuthnProxy_IsUserVerifyingPlatformAuthenticatorAvailable_ResponseParams', [
...
mojo.internal.bindings.remoting.mojom.WebAuthnProxyRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.remoting.mojom.WebAuthnProxyRemoteCallHandler(this.proxy);
  }
  ...
  create(arg_request_data, arg_request_canceller) {
    return this.$.create(arg_request_data, arg_request_canceller);
  }
  get(arg_request_data, arg_request_canceller) {
    return this.$.get(arg_request_data, arg_request_canceller);
  }
};
...
mojo.internal.bindings.remoting.mojom.WebAuthnProxy.getRemote = function() {
  let remote = new mojo.internal.bindings.remoting.mojom.WebAuthnProxyRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
...
mojo.internal.bindings.remoting.mojom.WebAuthnProxyReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.remoting.mojom.WebAuthnProxy_IsUserVerifyingPlatformAuthenticatorAvailable_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for IsUserVerifyingPlatformAuthenticatorAvailable failed with TypeError');
           }
        }
        // Try Method 1: Create
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.remoting.mojom.WebAuthnProxy_Create_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.remoting.mojom.WebAuthnProxy_Get_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.remoting.mojom.WebAuthnProxy_IsUserVerifyingPlatformAuthenticatorAvailable_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.remoting.mojom.WebAuthnProxyReceiver = mojo.internal.bindings.remoting.mojom.WebAuthnProxyReceiver;

mojo.internal.bindings.remoting.mojom.WebAuthnProxyPtr = mojo.internal.bindings.remoting.mojom.WebAuthnProxyRemote;
mojo.internal.bindings.remoting.mojom.WebAuthnProxyRequest = mojo.internal.bindings.remoting.mojom.WebAuthnProxyPendingReceiver;
