...
mojo.internal.bindings.aim_eligibility.mojom.DisclaimerStateSpec = mojo.internal.bindings.aim_eligibility.mojom.DisclaimerStateSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.aim_eligibility.mojom.DriveStatusSpec = mojo.internal.bindings.aim_eligibility.mojom.DriveStatusSpec || { $: {} };
if (mojo.internal.bindings.aim_eligibility.mojom.DriveStatusSpec.$.structSpec && mojo.internal.bindings.aim_eligibility.mojom.DriveStatusSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.aim_eligibility.mojom.DriveStatusSpec.$ = {};
...
mojo.internal.bindings.aim_eligibility.mojom.Page_OnDriveStatusChanged_ParamsSpec = mojo.internal.bindings.aim_eligibility.mojom.Page_OnDriveStatusChanged_ParamsSpec || { $: {} };
if (mojo.internal.bindings.aim_eligibility.mojom.Page_OnDriveStatusChanged_ParamsSpec.$.structSpec && mojo.internal.bindings.aim_eligibility.mojom.Page_OnDriveStatusChanged_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.aim_eligibility.mojom.Page_OnDriveStatusChanged_ParamsSpec.$ = {};
...
mojo.internal.bindings.aim_eligibility.mojom.DisclaimerState = {
  kAccepted: 0,
  kNotAccepted: 1,
  kRestricted: 2,
};
...
// Interface: Page
mojo.internal.bindings.aim_eligibility.mojom.PagePendingReceiver = class {
  constructor(handle) {
    this.handle = handle;
    if (handle) {
...
mojo.internal.bindings.aim_eligibility.mojom.PageRemote = class {
  ...
  constructor(handle = undefined) {
    ...
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.aim_eligibility.mojom.PagePendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.aim_eligibility.mojom.PageRemoteCallHandler(this.proxy);
  }
  ...
  onEligibilityStateChanged(arg_state) {
    return this.$.onEligibilityStateChanged(arg_state);
  }
  onDriveStatusChanged(arg_status) {
    return this.$.onDriveStatusChanged(arg_status);
  }
};

mojo.internal.bindings.aim_eligibility.mojom.PageRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('aim_eligibility.mojom.Page', [
      { explicit: null },
      { explicit: null },
    ]);
  }
  ...
  onDriveStatusChanged(arg_status) {
    return this.proxy.sendMessage(
      ...
      mojo.internal.bindings.aim_eligibility.mojom.Page_OnDriveStatusChanged_ParamsSpec,
      null,
      [arg_status],
      false);
  }
...
mojo.internal.bindings.aim_eligibility.mojom.Page.getRemote = function() {
  let remote = new mojo.internal.bindings.aim_eligibility.mojom.PageRemote();
...
mojo.internal.bindings.aim_eligibility.mojom.PageReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('aim_eligibility.mojom.Page', [
      { explicit: null },
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        ...
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.aim_eligibility.mojom.Page_OnDriveStatusChanged_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.onDriveStatusChanged');
          const result = this.impl.onDriveStatusChanged(params.arg_status);
          break;
        }
      }
      } catch (err) {
...
mojo.internal.bindings.aim_eligibility.mojom.PageReceiver = mojo.internal.bindings.aim_eligibility.mojom.PageReceiver;

mojo.internal.bindings.aim_eligibility.mojom.PagePtr = mojo.internal.bindings.aim_eligibility.mojom.PageRemote;
mojo.internal.bindings.aim_eligibility.mojom.PageRequest = mojo.internal.bindings.aim_eligibility.mojom.PagePendingReceiver;


// Interface: PageHandler
mojo.internal.bindings.aim_eligibility.mojom.PageHandlerPendingReceiver = class {
  constructor(handle) {
    this.handle = handle;
    if (handle) {
      this.__mojoHandle = handle.router_ ? handle.router_.pipe_ : (handle.pipe_ || handle);
...
mojo.internal.bindings.aim_eligibility.mojom.PageHandlerRemote = class {
  static get $interfaceName() {
  ...
  constructor(handle = undefined) {
    this.__mojoHandle = handle;
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.aim_eligibility.mojom.PageHandlerPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.aim_eligibility.mojom.PageHandlerRemoteCallHandler(this.proxy);
  }
  ...
  setEligibilityResponseForDebugging(arg_base64_encoded_response) {
    return this.$.setEligibilityResponseForDebugging(arg_base64_encoded_response);
  }
};

mojo.internal.bindings.aim_eligibility.mojom.PageHandlerRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('aim_eligibility.mojom.PageHandler', [
      { explicit: null },
      { explicit: null },
      { explicit: null },
    ]);
...
mojo.internal.bindings.aim_eligibility.mojom.PageHandler.getRemote = function() {
  let remote = new mojo.internal.bindings.aim_eligibility.mojom.PageHandlerRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
...
mojo.internal.bindings.aim_eligibility.mojom.PageHandlerReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('aim_eligibility.mojom.PageHandler', [
      { explicit: null },
      { explicit: null },
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.aim_eligibility.mojom.PageHandler_GetEligibilityState_ParamsSpec.$.structSpec);
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const message = new mojo.internal.Message(
                ...
                header.ordinal, header.requestId, mojo.internal.bindings.aim_eligibility.mojom.PageHandler_GetEligibilityState_ResponseParamsSpec.$.structSpec, resp_obj);
        ...
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.aim_eligibility.mojom.PageHandler_RequestServerEligibilityForDebugging_ParamsSpec.$.structSpec);
        ...
        case 2: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.aim_eligibility.mojom.PageHandler_SetEligibilityResponseForDebugging_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
...
mojo.internal.bindings.aim_eligibility.mojom.PageHandlerReceiver = mojo.internal.bindings.aim_eligibility.mojom.PageHandlerReceiver;

mojo.internal.bindings.aim_eligibility.mojom.PageHandlerPtr = mojo.internal.bindings.aim_eligibility.mojom.PageHandlerRemote;
mojo.internal.bindings.aim_eligibility.mojom.PageHandlerRequest = mojo.internal.bindings.aim_eligibility.mojom.PageHandlerPendingReceiver;


// Interface: PageHandlerFactory
mojo.internal.bindings.aim_eligibility.mojom.PageHandlerFactoryPendingReceiver = class {
  constructor(handle) {
    this.handle = handle;
    if (handle) {
      this.__mojoHandle = handle.router_ ? handle.router_.pipe_ : (handle.pipe_ || handle);
...
mojo.internal.bindings.aim_eligibility.mojom.PageHandlerFactoryRemote = class {
  static get $interfaceName() {
  ...
  constructor(handle = undefined) {
    this.__mojoHandle = handle;
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.aim_eligibility.mojom.PageHandlerFactoryPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.aim_eligibility.mojom.PageHandlerFactoryRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.aim_eligibility.mojom.PageHandlerFactoryRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('aim_eligibility.mojom.PageHandlerFactory', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.aim_eligibility.mojom.PageHandlerFactory.getRemote = function() {
  let remote = new mojo.internal.bindings.aim_eligibility.mojom.PageHandlerFactoryRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
...
mojo.internal.bindings.aim_eligibility.mojom.PageHandlerFactoryReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('aim_eligibility.mojom.PageHandlerFactory', [
      { explicit: null },
    ]);
    ordinals.forEach((ord, idx) => {
      this.ordinalMap.set(ord, idx); // Scrambled/Explicit
...
mojo.internal.bindings.aim_eligibility.mojom.PageHandlerFactoryReceiver = mojo.internal.bindings.aim_eligibility.mojom.PageHandlerFactoryReceiver;

mojo.internal.bindings.aim_eligibility.mojom.PageHandlerFactoryPtr = mojo.internal.bindings.aim_eligibility.mojom.PageHandlerFactoryRemote;
mojo.internal.bindings.aim_eligibility.mojom.PageHandlerFactoryRequest = mojo.internal.bindings.aim_eligibility.mojom.PageHandlerFactoryPendingReceiver;
...
mojo.internal.Struct(
    mojo.internal.bindings.aim_eligibility.mojom.DriveStatusSpec, 'aim_eligibility.mojom.DriveStatus', [
      mojo.internal.StructField('arg_is_drive_supported', 0, 0, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_is_pec_eligible', 0, 1, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_is_identity_match', 0, 2, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_is_incognito', 0, 3, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_is_feature_flag_enabled', 0, 4, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_is_force_drive_disclaimer_accepted', 0, 5, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_is_search_content_sharing_enabled', 0, 6, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_is_disclaimer_flag_enabled', 0, 7, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_disclaimer_state', 4, 0, mojo.internal.bindings.aim_eligibility.mojom.DisclaimerStateSpec, null, false, 0, undefined),
    ],
    [[0, 16]]);

// Struct: EligibilityState
mojo.internal.Struct(
    mojo.internal.bindings.aim_eligibility.mojom.EligibilityStateSpec, 'aim_eligibility.mojom.EligibilityState', [
      mojo.internal.StructField('arg_is_eligible', 0, 0, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_is_eligible_by_policy', 0, 1, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_is_third_party_eligible_by_policy', 0, 2, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_is_eligible_by_dse', 0, 3, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_is_aim_eligible_by_server', 0, 4, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_is_fusebox_eligible_by_server', 0, 5, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_is_cobrowse_eligible_by_server', 0, 6, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_is_server_eligibility_enabled', 0, 7, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_eligibility_response_base64_encoded', 8, 0, mojo.internal.String, null, false, 0, undefined),
      mojo.internal.StructField('arg_eligibility_response_source', 16, 0, mojo.internal.String, null, false, 0, undefined),
      mojo.internal.StructField('arg_eligibility_response_auth_type', 24, 0, mojo.internal.String, null, true, 0, undefined),
      mojo.internal.StructField('arg_drive_status', 32, 0, mojo.internal.bindings.aim_eligibility.mojom.DriveStatusSpec, null, true, 0, undefined),
      mojo.internal.StructField('arg_last_updated', 40, 0, mojo.internal.bindings.mojo_base.mojom.JSTimeSpec, null, false, 0, undefined),
    ],
    [[0, 56]]);
mojo.internal.Struct(
...
mojo.internal.Struct(
    mojo.internal.bindings.aim_eligibility.mojom.Page_OnDriveStatusChanged_ParamsSpec, 'aim_eligibility.mojom.Page_OnDriveStatusChanged_Params', [
      mojo.internal.StructField('arg_status', 0, 0, mojo.internal.bindings.aim_eligibility.mojom.DriveStatusSpec, null, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.aim_eligibility.mojom.PageHandler_GetEligibilityState_ParamsSpec, 'aim_eligibility.mojom.PageHandler_GetEligibilityState_Params', [
    ],
    [[0, 8]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.aim_eligibility.mojom.PageHandler_RequestServerEligibilityForDebugging_ParamsSpec, 'aim_eligibility.mojom.PageHandler_RequestServerEligibilityForDebugging_Params', [
    ],
    [[0, 8]]);

mojo.internal.Struct(
    mojo.internal.bindings.aim_eligibility.mojom.PageHandler_SetEligibilityResponseForDebugging_ParamsSpec, 'aim_eligibility.mojom.PageHandler_SetEligibilityResponseForDebugging_Params', [
      mojo.internal.StructField('arg_base64_encoded_response', 0, 0, mojo.internal.String, null, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.aim_eligibility.mojom.PageHandler_SetEligibilityResponseForDebugging_ResponseParamsSpec, 'aim_eligibility.mojom.PageHandler_SetEligibilityResponseForDebugging_ResponseParams', [
      mojo.internal.StructField('arg_success', 0, 0, mojo.internal.Bool, false, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.aim_eligibility.mojom.PageHandlerFactory_CreatePageHandler_ParamsSpec, 'aim_eligibility.mojom.PageHandlerFactory_CreatePageHandler_Params', [
      mojo.internal.StructField('arg_page', 0, 0, mojo.internal.InterfaceProxy(mojo.internal.bindings.aim_eligibility.mojom.PageRemote), null, false, 0, undefined),
      mojo.internal.StructField('arg_handler', 8, 0, mojo.internal.InterfaceRequest(mojo.internal.bindings.aim_eligibility.mojom.PageHandlerPendingReceiver), null, false, 0, undefined),
    ],
    [[0, 24]]);
