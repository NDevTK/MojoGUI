...
mojo.internal.bindings.payments.facilitated.mojom.PaymentLinkHandler = {};
mojo.internal.bindings.payments.facilitated.mojom.PaymentLinkHandlerSpec = { $ : {} };
mojo.internal.bindings.payments.facilitated.mojom.PaymentLinkHandler.$interfaceName = 'payments.facilitated.mojom.PaymentLinkHandler';
...
mojo.internal.bindings.payments.facilitated.mojom.PaymentLinkHandlerRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.payments.facilitated.mojom.PaymentLinkHandlerPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.payments.facilitated.mojom.PaymentLinkHandlerRemoteCallHandler(this.proxy);
  }
  ...
  handlePaymentLink(arg_url) {
    return this.$.handlePaymentLink(arg_url);
  }
};

mojo.internal.bindings.payments.facilitated.mojom.PaymentLinkHandlerRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('payments.facilitated.mojom.PaymentLinkHandler', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.payments.facilitated.mojom.PaymentLinkHandler.getRemote = function() {
  let remote = new mojo.internal.bindings.payments.facilitated.mojom.PaymentLinkHandlerRemote();
...
mojo.internal.bindings.payments.facilitated.mojom.PaymentLinkHandlerReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('payments.facilitated.mojom.PaymentLinkHandler', [
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.payments.facilitated.mojom.PaymentLinkHandler_HandlePaymentLink_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for HandlePaymentLink failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.payments.facilitated.mojom.PaymentLinkHandlerReceiver = mojo.internal.bindings.payments.facilitated.mojom.PaymentLinkHandlerReceiver;
