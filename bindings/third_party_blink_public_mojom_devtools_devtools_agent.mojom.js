...
mojo.internal.bindings.blink.mojom.URLBreakpointLocatorSpec = mojo.internal.bindings.blink.mojom.URLBreakpointLocatorSpec || { $: {} };
if (mojo.internal.bindings.blink.mojom.URLBreakpointLocatorSpec.$.structSpec && mojo.internal.bindings.blink.mojom.URLBreakpointLocatorSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.blink.mojom.URLBreakpointLocatorSpec.$ = {};
...
mojo.internal.bindings.blink.mojom.URLBreakpointSpec = mojo.internal.bindings.blink.mojom.URLBreakpointSpec || { $: {} };
if (mojo.internal.bindings.blink.mojom.URLBreakpointSpec.$.structSpec && mojo.internal.bindings.blink.mojom.URLBreakpointSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.blink.mojom.URLBreakpointSpec.$ = {};
...
mojo.internal.bindings.blink = mojo.internal.bindings.blink || {};
mojo.internal.bindings.blink.mojom = mojo.internal.bindings.blink.mojom || {};
mojo.internal.bindings.blink.mojom.URLBreakpointLocatorSpec = mojo.internal.bindings.blink.mojom.URLBreakpointLocatorSpec || { $: mojo.internal.OpaqueStruct.$ };
mojo.internal.bindings.gfx = mojo.internal.bindings.gfx || {};
...
mojo.internal.bindings.blink.mojom.DevToolsAgentRemote = class {
  ...
  attachDevToolsSession(arg_host, arg_session, arg_io_session, arg_reattach_session_state, arg_client_expects_binary_responses, arg_client_is_trusted, arg_session_id, arg_session_waits_for_debugger) {
    return this.$.attachDevToolsSession(arg_host, arg_session, arg_io_session, arg_reattach_session_state, arg_client_expects_binary_responses, arg_client_is_trusted, arg_session_id, arg_session_waits_for_debugger);
  }
...
mojo.internal.bindings.blink.mojom.DevToolsAgentRemoteCallHandler = class {
  ...
  attachDevToolsSession(arg_host, arg_session, arg_io_session, arg_reattach_session_state, arg_client_expects_binary_responses, arg_client_is_trusted, arg_session_id, arg_session_waits_for_debugger) {
    return this.proxy.sendMessage(
      ...
      null,
      [arg_host, arg_session, arg_io_session, arg_reattach_session_state, arg_client_expects_binary_responses, arg_client_is_trusted, arg_session_id, arg_session_waits_for_debugger],
      false);
  }
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        case 0: {
          ...
          const result = this.impl.attachDevToolsSession(params.arg_host, params.arg_session, params.arg_io_session, params.arg_reattach_session_state, params.arg_client_expects_binary_responses, params.arg_client_is_trusted, params.arg_session_id, params.arg_session_waits_for_debugger);
          break;
        }
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
...
// Union: URLBreakpointLocator
mojo.internal.Union(
    mojo.internal.bindings.blink.mojom.URLBreakpointLocatorSpec, 'blink.mojom.URLBreakpointLocator', {
      'arg_url': {
        'ordinal': 0,
...
mojo.internal.Struct(
    mojo.internal.bindings.blink.mojom.URLBreakpointSpec, 'blink.mojom.URLBreakpoint', [
      mojo.internal.StructField('arg_line_number', 0, 0, mojo.internal.Int32, 0, false, 0, undefined),
      mojo.internal.StructField('arg_column_number_$flag', 4, 0, mojo.internal.Bool, false, false, 0, { isPrimary: true, linkedValueFieldName: 'arg_column_number_$value', originalFieldName: 'arg_column_number' }),
      mojo.internal.StructField('arg_locator', 8, 0, mojo.internal.bindings.blink.mojom.URLBreakpointLocatorSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_column_number_$value', 24, 0, mojo.internal.Int32, 0, false, 0, { isPrimary: false, linkedValueFieldName: 'arg_column_number_$flag', originalFieldName: 'arg_column_number' }),
      mojo.internal.StructField('arg_condition', 32, 0, mojo.internal.String, null, true, 0, undefined),
    ],
    [[0, 48]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.blink.mojom.BrowserOriginatingSessionStateSpec, 'blink.mojom.BrowserOriginatingSessionState', [
      ...
      mojo.internal.StructField('arg_script_to_evaluate_on_load_once', 8, 0, mojo.internal.String, null, false, 0, undefined),
      mojo.internal.StructField('arg_extra_request_headers', 16, 0, mojo.internal.Map(mojo.internal.String, mojo.internal.String, false), null, false, 0, undefined),
      mojo.internal.StructField('arg_overlay_enabled', 24, 0, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_paused_in_debugger_message', 32, 0, mojo.internal.String, null, false, 0, undefined),
      mojo.internal.StructField('arg_url_breakpoints', 40, 0, mojo.internal.Map(mojo.internal.String, mojo.internal.bindings.blink.mojom.URLBreakpointSpec, false), null, false, 0, undefined),
    ],
    [[0, 56]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.blink.mojom.DevToolsAgent_AttachDevToolsSession_ParamsSpec, 'blink.mojom.DevToolsAgent_AttachDevToolsSession_Params', [
      ...
      mojo.internal.StructField('arg_reattach_session_state', 16, 0, mojo.internal.bindings.blink.mojom.DevToolsSessionStateSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_client_expects_binary_responses', 24, 0, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_client_is_trusted', 24, 1, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_session_waits_for_debugger', 24, 2, mojo.internal.Bool, false, false, 0, undefined),
