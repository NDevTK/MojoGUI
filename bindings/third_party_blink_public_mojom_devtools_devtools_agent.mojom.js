...
mojo.internal.bindings.blink.mojom.ScriptToEvaluateOnNewDocumentSpec = mojo.internal.bindings.blink.mojom.ScriptToEvaluateOnNewDocumentSpec || { $: {} };
if (mojo.internal.bindings.blink.mojom.ScriptToEvaluateOnNewDocumentSpec.$.structSpec && mojo.internal.bindings.blink.mojom.ScriptToEvaluateOnNewDocumentSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.blink.mojom.ScriptToEvaluateOnNewDocumentSpec.$ = {};
mojo.internal.bindings.blink.mojom.BrowserOriginatingSessionStateSpec = mojo.internal.bindings.blink.mojom.BrowserOriginatingSessionStateSpec || { $: {} };
if (mojo.internal.bindings.blink.mojom.BrowserOriginatingSessionStateSpec.$.structSpec && mojo.internal.bindings.blink.mojom.BrowserOriginatingSessionStateSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.blink.mojom.BrowserOriginatingSessionStateSpec.$ = {};
mojo.internal.bindings.blink.mojom.RendererOriginatingSessionStateSpec = mojo.internal.bindings.blink.mojom.RendererOriginatingSessionStateSpec || { $: {} };
if (mojo.internal.bindings.blink.mojom.RendererOriginatingSessionStateSpec.$.structSpec && mojo.internal.bindings.blink.mojom.RendererOriginatingSessionStateSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.blink.mojom.RendererOriginatingSessionStateSpec.$ = {};
...
mojo.internal.bindings.blink.mojom.DevToolsSession_AddScriptToEvaluateOnNewDocument_ParamsSpec = mojo.internal.bindings.blink.mojom.DevToolsSession_AddScriptToEvaluateOnNewDocument_ParamsSpec || { $: {} };
if (mojo.internal.bindings.blink.mojom.DevToolsSession_AddScriptToEvaluateOnNewDocument_ParamsSpec.$.structSpec && mojo.internal.bindings.blink.mojom.DevToolsSession_AddScriptToEvaluateOnNewDocument_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.blink.mojom.DevToolsSession_AddScriptToEvaluateOnNewDocument_ParamsSpec.$ = {};
mojo.internal.bindings.blink.mojom.DevToolsSession_AddScriptToEvaluateOnNewDocument_ResponseParamsSpec = mojo.internal.bindings.blink.mojom.DevToolsSession_AddScriptToEvaluateOnNewDocument_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.blink.mojom.DevToolsSession_AddScriptToEvaluateOnNewDocument_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.blink.mojom.DevToolsSession_AddScriptToEvaluateOnNewDocument_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.blink.mojom.DevToolsSession_AddScriptToEvaluateOnNewDocument_ResponseParamsSpec.$ = {};
mojo.internal.bindings.blink.mojom.DevToolsSession_RemoveScriptToEvaluateOnNewDocument_ParamsSpec = mojo.internal.bindings.blink.mojom.DevToolsSession_RemoveScriptToEvaluateOnNewDocument_ParamsSpec || { $: {} };
if (mojo.internal.bindings.blink.mojom.DevToolsSession_RemoveScriptToEvaluateOnNewDocument_ParamsSpec.$.structSpec && mojo.internal.bindings.blink.mojom.DevToolsSession_RemoveScriptToEvaluateOnNewDocument_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.blink.mojom.DevToolsSession_RemoveScriptToEvaluateOnNewDocument_ParamsSpec.$ = {};
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const message = new mojo.internal.Message(
                ...
                header.ordinal, header.requestId, mojo.internal.bindings.blink.mojom.DevToolsAgent_ReportChildTargets_ResponseParamsSpec.$.structSpec, resp_obj);
...
mojo.internal.bindings.blink.mojom.DevToolsSessionRemote = class {
  ...
  dispatchProtocolCommand(arg_call_id, arg_method, arg_message, arg_fallthrough_data) {
    return this.$.dispatchProtocolCommand(arg_call_id, arg_method, arg_message, arg_fallthrough_data);
  }
  unpauseAndTerminate() {
    return this.$.unpauseAndTerminate();
  }
  addScriptToEvaluateOnNewDocument(arg_identifier, arg_script, arg_run_immediately) {
    return this.$.addScriptToEvaluateOnNewDocument(arg_identifier, arg_script, arg_run_immediately);
  }
  removeScriptToEvaluateOnNewDocument(arg_identifier) {
    return this.$.removeScriptToEvaluateOnNewDocument(arg_identifier);
  }
};
...
mojo.internal.bindings.blink.mojom.DevToolsSessionRemoteCallHandler = class {
  ...
  dispatchProtocolCommand(arg_call_id, arg_method, arg_message, arg_fallthrough_data) {
    return this.proxy.sendMessage(
      ...
      null,
      [arg_call_id, arg_method, arg_message, arg_fallthrough_data],
      false);
  }
  ...
  addScriptToEvaluateOnNewDocument(arg_identifier, arg_script, arg_run_immediately) {
    return this.proxy.sendMessage(
      ...
      mojo.internal.bindings.blink.mojom.DevToolsSession_AddScriptToEvaluateOnNewDocument_ParamsSpec,
      mojo.internal.bindings.blink.mojom.DevToolsSession_AddScriptToEvaluateOnNewDocument_ResponseParamsSpec,
      [arg_identifier, arg_script, arg_run_immediately],
      false);
  }
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        case 0: {
          ...
          const result = this.impl.dispatchProtocolCommand(params.arg_call_id, params.arg_method, params.arg_message, params.arg_fallthrough_data);
          break;
        }
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
        ...
        case 2: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.blink.mojom.DevToolsSession_AddScriptToEvaluateOnNewDocument_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.addScriptToEvaluateOnNewDocument');
          const result = this.impl.addScriptToEvaluateOnNewDocument(params.arg_identifier, params.arg_script, params.arg_run_immediately);
          const expectsResponse = header.expectsResponse || (header.flags & 1);
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              const resp_obj = response;
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.blink.mojom.DevToolsSession_AddScriptToEvaluateOnNewDocument_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
            }).catch(e => console.error('[GeneratedReceiver] addScriptToEvaluateOnNewDocument FAILED:', e));
          }
          break;
        }
        case 3: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.blink.mojom.DevToolsSession_RemoveScriptToEvaluateOnNewDocument_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.removeScriptToEvaluateOnNewDocument');
          const result = this.impl.removeScriptToEvaluateOnNewDocument(params.arg_identifier);
          break;
        }
      }
      } catch (err) {
...
mojo.internal.Struct(
    mojo.internal.bindings.blink.mojom.ScriptToEvaluateOnNewDocumentSpec, 'blink.mojom.ScriptToEvaluateOnNewDocument', [
      mojo.internal.StructField('arg_source', 0, 0, mojo.internal.String, null, false, 0, undefined),
      mojo.internal.StructField('arg_world_name', 8, 0, mojo.internal.String, null, false, 0, undefined),
      mojo.internal.StructField('arg_include_command_line_api', 16, 0, mojo.internal.Bool, false, false, 0, undefined),
    ],
    [[0, 32]]);

// Struct: BrowserOriginatingSessionState
mojo.internal.Struct(
    mojo.internal.bindings.blink.mojom.BrowserOriginatingSessionStateSpec, 'blink.mojom.BrowserOriginatingSessionState', [
      mojo.internal.StructField('arg_scripts_to_evaluate_on_new_document', 0, 0, mojo.internal.Map(mojo.internal.String, mojo.internal.bindings.blink.mojom.ScriptToEvaluateOnNewDocumentSpec, false), null, false, 0, undefined),
    ],
    [[0, 16]]);

// Struct: RendererOriginatingSessionState
mojo.internal.Struct(
    mojo.internal.bindings.blink.mojom.RendererOriginatingSessionStateSpec, 'blink.mojom.RendererOriginatingSessionState', [
...
mojo.internal.Struct(
    mojo.internal.bindings.blink.mojom.DevToolsSessionStateSpec, 'blink.mojom.DevToolsSessionState', [
      mojo.internal.StructField('arg_browser_originating_session_state', 0, 0, mojo.internal.bindings.blink.mojom.BrowserOriginatingSessionStateSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_renderer_originating_session_state', 8, 0, mojo.internal.bindings.blink.mojom.RendererOriginatingSessionStateSpec, null, true, 0, undefined),
    ],
    [[0, 24]]);
mojo.internal.Struct(
    mojo.internal.bindings.blink.mojom.DevToolsAgent_AttachDevToolsSession_ParamsSpec, 'blink.mojom.DevToolsAgent_AttachDevToolsSession_Params', [
      ...
      mojo.internal.StructField('arg_client_is_trusted', 32, 1, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_session_waits_for_debugger', 32, 2, mojo.internal.Bool, false, false, 0, undefined),
...
mojo.internal.Struct(
    mojo.internal.bindings.blink.mojom.DevToolsSession_DispatchProtocolCommand_ParamsSpec, 'blink.mojom.DevToolsSession_DispatchProtocolCommand_Params', [
      mojo.internal.StructField('arg_call_id', 0, 0, mojo.internal.Int32, 0, false, 0, undefined),
      mojo.internal.StructField('arg_method', 8, 0, mojo.internal.String, null, false, 0, undefined),
      mojo.internal.StructField('arg_message', 16, 0, mojo.internal.bindings.mojo_base.mojom.ReadOnlyBufferSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_fallthrough_data', 24, 0, mojo.internal.String, null, false, 0, undefined),
    ],
    [[0, 40]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.blink.mojom.DevToolsSession_AddScriptToEvaluateOnNewDocument_ParamsSpec, 'blink.mojom.DevToolsSession_AddScriptToEvaluateOnNewDocument_Params', [
      mojo.internal.StructField('arg_identifier', 0, 0, mojo.internal.String, null, false, 0, undefined),
      mojo.internal.StructField('arg_script', 8, 0, mojo.internal.bindings.blink.mojom.ScriptToEvaluateOnNewDocumentSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_run_immediately', 16, 0, mojo.internal.Bool, false, false, 0, undefined),
    ],
    [[0, 32]]);

mojo.internal.Struct(
    mojo.internal.bindings.blink.mojom.DevToolsSession_AddScriptToEvaluateOnNewDocument_ResponseParamsSpec, 'blink.mojom.DevToolsSession_AddScriptToEvaluateOnNewDocument_ResponseParams', [
    ],
    [[0, 8]]);

mojo.internal.Struct(
    mojo.internal.bindings.blink.mojom.DevToolsSession_RemoveScriptToEvaluateOnNewDocument_ParamsSpec, 'blink.mojom.DevToolsSession_RemoveScriptToEvaluateOnNewDocument_Params', [
      mojo.internal.StructField('arg_identifier', 0, 0, mojo.internal.String, null, false, 0, undefined),
    ],
    [[0, 16]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.blink.mojom.DevToolsSessionHost_DispatchProtocolResponse_ParamsSpec, 'blink.mojom.DevToolsSessionHost_DispatchProtocolResponse_Params', [
      ...
      mojo.internal.StructField('arg_call_id', 8, 0, mojo.internal.Int32, 0, false, 0, undefined),
      mojo.internal.StructField('arg_updates', 16, 0, mojo.internal.bindings.blink.mojom.RendererOriginatingSessionStateSpec, null, true, 0, undefined),
    ],
    [[0, 32]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.blink.mojom.DevToolsSessionHost_DispatchProtocolNotification_ParamsSpec, 'blink.mojom.DevToolsSessionHost_DispatchProtocolNotification_Params', [
      mojo.internal.StructField('arg_message', 0, 0, mojo.internal.bindings.blink.mojom.DevToolsMessageSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_updates', 8, 0, mojo.internal.bindings.blink.mojom.RendererOriginatingSessionStateSpec, null, true, 0, undefined),
    ],
    [[0, 24]]);
