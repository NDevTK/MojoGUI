...
mojo.internal.bindings.content.mojom.PowerMonitorTest = {};
mojo.internal.bindings.content.mojom.PowerMonitorTestSpec = { $ : {} };
mojo.internal.bindings.content.mojom.PowerMonitorTest.$interfaceName = 'content.mojom.PowerMonitorTest';
...
mojo.internal.bindings.content.mojom.PowerMonitorTestRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.content.mojom.PowerMonitorTestPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.content.mojom.PowerMonitorTestRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.content.mojom.PowerMonitorTestRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('content.mojom.PowerMonitorTest', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.content.mojom.PowerMonitorTest.getRemote = function() {
  let remote = new mojo.internal.bindings.content.mojom.PowerMonitorTestRemote();
...
mojo.internal.bindings.content.mojom.PowerMonitorTestReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('content.mojom.PowerMonitorTest', [
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.content.mojom.PowerMonitorTest_QueryNextState_ParamsSpec.$.structSpec);
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.content.mojom.PowerMonitorTest_QueryNextState_ParamsSpec.$.structSpec);
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.content.mojom.PowerMonitorTest_QueryNextState_ResponseParamsSpec, header, rawHeader);
               responder(response);
...
mojo.internal.bindings.content.mojom.PowerMonitorTestReceiver = mojo.internal.bindings.content.mojom.PowerMonitorTestReceiver;
