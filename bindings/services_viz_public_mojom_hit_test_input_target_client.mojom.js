...
mojo.internal.bindings.viz.mojom.InputTargetClient = {};
mojo.internal.bindings.viz.mojom.InputTargetClientSpec = { $ : {} };
mojo.internal.bindings.viz.mojom.InputTargetClient.$interfaceName = 'viz.mojom.InputTargetClient';
...
mojo.internal.bindings.viz.mojom.InputTargetClientRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.viz.mojom.InputTargetClientRemoteCallHandler(this.proxy);
  }
  ...
  frameSinkIdAt(arg_point, arg_trace_id) {
    return this.$.frameSinkIdAt(arg_point, arg_trace_id);
  }
};

mojo.internal.bindings.viz.mojom.InputTargetClientRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('viz.mojom.InputTargetClient', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.viz.mojom.InputTargetClient.getRemote = function() {
  let remote = new mojo.internal.bindings.viz.mojom.InputTargetClientRemote();
...
mojo.internal.bindings.viz.mojom.InputTargetClientReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('viz.mojom.InputTargetClient', [
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.viz.mojom.InputTargetClient_FrameSinkIdAt_ParamsSpec.$.structSpec);
        ...
        case 0: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.viz.mojom.InputTargetClient_FrameSinkIdAt_ResponseParamsSpec, header, rawHeader);
               responder(response);
...
mojo.internal.bindings.viz.mojom.InputTargetClientReceiver = mojo.internal.bindings.viz.mojom.InputTargetClientReceiver;
