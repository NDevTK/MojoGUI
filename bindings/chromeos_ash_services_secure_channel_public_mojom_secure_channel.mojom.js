...
mojo.internal.bindings.ash.secure_channel.mojom.kConnectionDroppedReason = 1;

// Enum: ConnectionAttemptFailureReason
mojo.internal.bindings.ash.secure_channel.mojom.ConnectionAttemptFailureReason = {
...
mojo.internal.bindings.ash.secure_channel.mojom.ConnectionCreationDetail = {
  REMOTE_DEVICE_USED_BACKGROUND_BLE_ADVERTISING: 0,
  REMOTE_DEVICE_USED_FOREGROUND_BLE_ADVERTISING: 1,
};

// Enum: ConnectionPriority
mojo.internal.bindings.ash.secure_channel.mojom.ConnectionPriority = {
  LOW: 0,
  MEDIUM: 1,
  HIGH: 2,
};
...
mojo.internal.bindings.ash.secure_channel.mojom.ConnectionMedium = {
  kBluetoothLowEnergy: 0,
  kNearbyConnections: 1,
};

// Enum: DiscoveryResult
mojo.internal.bindings.ash.secure_channel.mojom.DiscoveryResult = {
  kFailure: 0,
  kSuccess: 1,
};

// Enum: DiscoveryErrorCode
mojo.internal.bindings.ash.secure_channel.mojom.DiscoveryErrorCode = {
...
mojo.internal.bindings.ash.secure_channel.mojom.SecureChannelState = {
...
mojo.internal.Struct(
    mojo.internal.bindings.ash.secure_channel.mojom.ConnectionMetadataSpec, 'ash.secure_channel.mojom.ConnectionMetadata', [
      mojo.internal.StructField('arg_creation_details', 0, 0, mojo.internal.Array(mojo.internal.bindings.mojo.internal.bindings.ash.secure_channel.mojom.ConnectionCreationDetailSpec.$, false), null, false, 0, undefined),
      mojo.internal.StructField('arg_bluetooth_connection_metadata', 8, 0, mojo.internal.bindings.mojo.internal.bindings.ash.secure_channel.mojom.BluetoothConnectionMetadataSpec.$, null, true, 0, undefined),
...
mojo.internal.Struct(
    mojo.internal.bindings.ash.secure_channel.mojom.Channel_GetConnectionMetadata_ResponseParamsSpec, 'ash.secure_channel.mojom.Channel_GetConnectionMetadata_ResponseParams', [
      mojo.internal.StructField('arg_metadata', 0, 0, mojo.internal.bindings.mojo.internal.bindings.ash.secure_channel.mojom.ConnectionMetadataSpec.$, null, false, 0, undefined),
    ],
    [[0, 16]]);
...
mojo.internal.bindings.ash.secure_channel.mojom.ChannelRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.ash.secure_channel.mojom.ChannelPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.ash.secure_channel.mojom.ChannelRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.ash.secure_channel.mojom.ChannelRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
...
mojo.internal.bindings.ash.secure_channel.mojom.Channel.getRemote = function() {
  let remote = new mojo.internal.bindings.ash.secure_channel.mojom.ChannelRemote();
...
mojo.internal.bindings.ash.secure_channel.mojom.ChannelReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.ash.secure_channel.mojom.Channel_SendMessage_ParamsSpec);
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.ash.secure_channel.mojom.Channel_RegisterPayloadFile_ParamsSpec);
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.ash.secure_channel.mojom.Channel_GetConnectionMetadata_ParamsSpec);
      ...
      switch (dispatchId) {
        ...
        case 2: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.ash.secure_channel.mojom.Channel_GetConnectionMetadata_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.ash.secure_channel.mojom.ChannelReceiver = mojo.internal.bindings.ash.secure_channel.mojom.ChannelReceiver;

mojo.internal.bindings.ash.secure_channel.mojom.ChannelPtr = mojo.internal.bindings.ash.secure_channel.mojom.ChannelRemote;
mojo.internal.bindings.ash.secure_channel.mojom.ChannelRequest = mojo.internal.bindings.ash.secure_channel.mojom.ChannelPendingReceiver;
...
mojo.internal.bindings.ash.secure_channel.mojom.MessageReceiverRemote = class {
  static get $interfaceName() {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.ash.secure_channel.mojom.MessageReceiverPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.ash.secure_channel.mojom.MessageReceiverRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.ash.secure_channel.mojom.MessageReceiverRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
...
mojo.internal.bindings.ash.secure_channel.mojom.MessageReceiver.getRemote = function() {
  let remote = new mojo.internal.bindings.ash.secure_channel.mojom.MessageReceiverRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
...
mojo.internal.bindings.ash.secure_channel.mojom.MessageReceiverReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.ash.secure_channel.mojom.MessageReceiver_OnMessageReceived_ParamsSpec);
...
mojo.internal.bindings.ash.secure_channel.mojom.MessageReceiverReceiver = mojo.internal.bindings.ash.secure_channel.mojom.MessageReceiverReceiver;

mojo.internal.bindings.ash.secure_channel.mojom.MessageReceiverPtr = mojo.internal.bindings.ash.secure_channel.mojom.MessageReceiverRemote;
mojo.internal.bindings.ash.secure_channel.mojom.MessageReceiverRequest = mojo.internal.bindings.ash.secure_channel.mojom.MessageReceiverPendingReceiver;
...
mojo.internal.Struct(
    mojo.internal.bindings.ash.secure_channel.mojom.ConnectionDelegate_OnConnectionAttemptFailure_ParamsSpec, 'ash.secure_channel.mojom.ConnectionDelegate_OnConnectionAttemptFailure_Params', [
      mojo.internal.StructField('arg_reason', 0, 0, mojo.internal.bindings.mojo.internal.bindings.ash.secure_channel.mojom.ConnectionAttemptFailureReasonSpec.$, null, false, 0, undefined),
    ],
    [[0, 16]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.ash.secure_channel.mojom.ConnectionDelegate_OnConnection_ParamsSpec, 'ash.secure_channel.mojom.ConnectionDelegate_OnConnection_Params', [
      mojo.internal.StructField('arg_channel', 0, 0, mojo.internal.InterfaceProxy(mojo.internal.bindings.ash.secure_channel.mojom.ChannelSpec), null, false, 0, undefined),
      mojo.internal.StructField('arg_message_receiver_receiver', 8, 0, mojo.internal.InterfaceRequest(mojo.internal.bindings.ash.secure_channel.mojom.MessageReceiverSpec), null, false, 0, undefined),
      mojo.internal.StructField('arg_nearby_connection_state_listener_receiver', 16, 0, mojo.internal.InterfaceRequest(mojo.internal.bindings.ash.secure_channel.mojom.NearbyConnectionStateListenerRemote), null, false, 0, undefined),
    ],
    [[0, 32]]);
...
mojo.internal.bindings.ash.secure_channel.mojom.ConnectionDelegateRemote = class {
  static get $interfaceName() {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.ash.secure_channel.mojom.ConnectionDelegatePendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.ash.secure_channel.mojom.ConnectionDelegateRemoteCallHandler(this.proxy);
  }
  ...
  onConnectionAttemptFailure(arg_reason) {
    return this.$.onConnectionAttemptFailure(arg_reason);
  }
  onConnection(arg_channel, arg_message_receiver_receiver, arg_nearby_connection_state_listener_receiver) {
    return this.$.onConnection(arg_channel, arg_message_receiver_receiver, arg_nearby_connection_state_listener_receiver);
  }
};

mojo.internal.bindings.ash.secure_channel.mojom.ConnectionDelegateRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
...
mojo.internal.bindings.ash.secure_channel.mojom.ConnectionDelegate.getRemote = function() {
  let remote = new mojo.internal.bindings.ash.secure_channel.mojom.ConnectionDelegateRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
...
mojo.internal.bindings.ash.secure_channel.mojom.ConnectionDelegateReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.ash.secure_channel.mojom.ConnectionDelegate_OnConnectionAttemptFailure_ParamsSpec);
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.ash.secure_channel.mojom.ConnectionDelegate_OnConnection_ParamsSpec);
...
mojo.internal.bindings.ash.secure_channel.mojom.ConnectionDelegateReceiver = mojo.internal.bindings.ash.secure_channel.mojom.ConnectionDelegateReceiver;

mojo.internal.bindings.ash.secure_channel.mojom.ConnectionDelegatePtr = mojo.internal.bindings.ash.secure_channel.mojom.ConnectionDelegateRemote;
mojo.internal.bindings.ash.secure_channel.mojom.ConnectionDelegateRequest = mojo.internal.bindings.ash.secure_channel.mojom.ConnectionDelegatePendingReceiver;
...
mojo.internal.Struct(
    mojo.internal.bindings.ash.secure_channel.mojom.SecureChannelStructuredMetricsLogger_LogDiscoveryAttempt_ParamsSpec, 'ash.secure_channel.mojom.SecureChannelStructuredMetricsLogger_LogDiscoveryAttempt_Params', [
      mojo.internal.StructField('arg_result', 0, 0, mojo.internal.bindings.mojo.internal.bindings.ash.secure_channel.mojom.DiscoveryResultSpec.$, null, false, 0, undefined),
      mojo.internal.StructField('arg_error_code', 8, 0, mojo.internal.bindings.mojo.internal.bindings.ash.secure_channel.mojom.DiscoveryErrorCodeSpec.$, null, true, 0, undefined),
    ],
    [[0, 24]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.ash.secure_channel.mojom.SecureChannelStructuredMetricsLogger_LogSecureChannelState_ParamsSpec, 'ash.secure_channel.mojom.SecureChannelStructuredMetricsLogger_LogSecureChannelState_Params', [
      mojo.internal.StructField('arg_state', 0, 0, mojo.internal.bindings.mojo.internal.bindings.ash.secure_channel.mojom.SecureChannelStateSpec.$, null, false, 0, undefined),
    ],
    [[0, 16]]);
...
mojo.internal.bindings.ash.secure_channel.mojom.SecureChannelStructuredMetricsLoggerRemote = class {
  static get $interfaceName() {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.ash.secure_channel.mojom.SecureChannelStructuredMetricsLoggerPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.ash.secure_channel.mojom.SecureChannelStructuredMetricsLoggerRemoteCallHandler(this.proxy);
  }
  ...
  logDiscoveryAttempt(arg_result, arg_error_code) {
    return this.$.logDiscoveryAttempt(arg_result, arg_error_code);
  }
  logNearbyConnectionState(arg_step, arg_status) {
    return this.$.logNearbyConnectionState(arg_step, arg_status);
  }
  logSecureChannelState(arg_state) {
    return this.$.logSecureChannelState(arg_state);
  }
};

mojo.internal.bindings.ash.secure_channel.mojom.SecureChannelStructuredMetricsLoggerRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
...
mojo.internal.bindings.ash.secure_channel.mojom.SecureChannelStructuredMetricsLogger.getRemote = function() {
  let remote = new mojo.internal.bindings.ash.secure_channel.mojom.SecureChannelStructuredMetricsLoggerRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
...
mojo.internal.bindings.ash.secure_channel.mojom.SecureChannelStructuredMetricsLoggerReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.ash.secure_channel.mojom.SecureChannelStructuredMetricsLogger_LogDiscoveryAttempt_ParamsSpec);
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.ash.secure_channel.mojom.SecureChannelStructuredMetricsLogger_LogNearbyConnectionState_ParamsSpec);
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.ash.secure_channel.mojom.SecureChannelStructuredMetricsLogger_LogSecureChannelState_ParamsSpec);
...
mojo.internal.bindings.ash.secure_channel.mojom.SecureChannelStructuredMetricsLoggerReceiver = mojo.internal.bindings.ash.secure_channel.mojom.SecureChannelStructuredMetricsLoggerReceiver;

mojo.internal.bindings.ash.secure_channel.mojom.SecureChannelStructuredMetricsLoggerPtr = mojo.internal.bindings.ash.secure_channel.mojom.SecureChannelStructuredMetricsLoggerRemote;
mojo.internal.bindings.ash.secure_channel.mojom.SecureChannelStructuredMetricsLoggerRequest = mojo.internal.bindings.ash.secure_channel.mojom.SecureChannelStructuredMetricsLoggerPendingReceiver;
...
mojo.internal.Struct(
    mojo.internal.bindings.ash.secure_channel.mojom.SecureChannel_ListenForConnectionFromDevice_ParamsSpec, 'ash.secure_channel.mojom.SecureChannel_ListenForConnectionFromDevice_Params', [
      ...
      mojo.internal.StructField('arg_connection_medium', 24, 0, mojo.internal.bindings.mojo.internal.bindings.ash.secure_channel.mojom.ConnectionMediumSpec.$, null, false, 0, undefined),
      mojo.internal.StructField('arg_connection_priority', 32, 0, mojo.internal.bindings.mojo.internal.bindings.ash.secure_channel.mojom.ConnectionPrioritySpec.$, null, false, 0, undefined),
      mojo.internal.StructField('arg_delegate', 40, 0, mojo.internal.InterfaceProxy(mojo.internal.bindings.ash.secure_channel.mojom.ConnectionDelegateSpec), null, false, 0, undefined),
    ],
    [[0, 56]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.ash.secure_channel.mojom.SecureChannel_InitiateConnectionToDevice_ParamsSpec, 'ash.secure_channel.mojom.SecureChannel_InitiateConnectionToDevice_Params', [
      ...
      mojo.internal.StructField('arg_connection_priority', 32, 0, mojo.internal.bindings.mojo.internal.bindings.ash.secure_channel.mojom.ConnectionPrioritySpec.$, null, false, 0, undefined),
      mojo.internal.StructField('arg_delegate', 40, 0, mojo.internal.InterfaceProxy(mojo.internal.bindings.ash.secure_channel.mojom.ConnectionDelegateSpec), null, false, 0, undefined),
      mojo.internal.StructField('arg_secure_channel_structured_metrics_logger', 48, 0, mojo.internal.InterfaceProxy(mojo.internal.bindings.ash.secure_channel.mojom.SecureChannelStructuredMetricsLoggerSpec), null, true, 0, undefined),
    ],
    [[0, 64]]);
...
mojo.internal.bindings.ash.secure_channel.mojom.SecureChannelRemote = class {
  static get $interfaceName() {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.ash.secure_channel.mojom.SecureChannelPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.ash.secure_channel.mojom.SecureChannelRemoteCallHandler(this.proxy);
  }
  ...
  listenForConnectionFromDevice(arg_device_to_connect, arg_local_device, arg_feature, arg_connection_medium, arg_connection_priority, arg_delegate) {
    return this.$.listenForConnectionFromDevice(arg_device_to_connect, arg_local_device, arg_feature, arg_connection_medium, arg_connection_priority, arg_delegate);
  }
  initiateConnectionToDevice(arg_device_to_connect, arg_local_device, arg_feature, arg_connection_medium, arg_connection_priority, arg_delegate, arg_secure_channel_structured_metrics_logger) {
    return this.$.initiateConnectionToDevice(arg_device_to_connect, arg_local_device, arg_feature, arg_connection_medium, arg_connection_priority, arg_delegate, arg_secure_channel_structured_metrics_logger);
  }
  setNearbyConnector(arg_nearby_connector) {
    return this.$.setNearbyConnector(arg_nearby_connector);
  }
  getLastSeenTimestamp(arg_remote_device_id) {
    return this.$.getLastSeenTimestamp(arg_remote_device_id);
  }
};

mojo.internal.bindings.ash.secure_channel.mojom.SecureChannelRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
...
mojo.internal.bindings.ash.secure_channel.mojom.SecureChannel.getRemote = function() {
  let remote = new mojo.internal.bindings.ash.secure_channel.mojom.SecureChannelRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
...
mojo.internal.bindings.ash.secure_channel.mojom.SecureChannelReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.ash.secure_channel.mojom.SecureChannel_ListenForConnectionFromDevice_ParamsSpec);
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.ash.secure_channel.mojom.SecureChannel_InitiateConnectionToDevice_ParamsSpec);
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.ash.secure_channel.mojom.SecureChannel_SetNearbyConnector_ParamsSpec);
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.ash.secure_channel.mojom.SecureChannel_GetLastSeenTimestamp_ParamsSpec);
...
mojo.internal.bindings.ash.secure_channel.mojom.SecureChannelReceiver = mojo.internal.bindings.ash.secure_channel.mojom.SecureChannelReceiver;
