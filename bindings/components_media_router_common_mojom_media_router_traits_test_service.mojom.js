...
mojo.internal.bindings.media_router.mojom.MediaRouterTraitsTestService = {};
mojo.internal.bindings.media_router.mojom.MediaRouterTraitsTestServiceSpec = { $ : {} };
mojo.internal.bindings.media_router.mojom.MediaRouterTraitsTestService.$interfaceName = 'media_router.mojom.MediaRouterTraitsTestService';
...
mojo.internal.bindings.media_router.mojom.MediaRouterTraitsTestServiceRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.media_router.mojom.MediaRouterTraitsTestServicePendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.media_router.mojom.MediaRouterTraitsTestServiceRemoteCallHandler(this.proxy);
  }
  ...
  echoMediaSink(arg_s) {
    return this.$.echoMediaSink(arg_s);
  }
};

mojo.internal.bindings.media_router.mojom.MediaRouterTraitsTestServiceRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('media_router.mojom.MediaRouterTraitsTestService', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.media_router.mojom.MediaRouterTraitsTestService.getRemote = function() {
  let remote = new mojo.internal.bindings.media_router.mojom.MediaRouterTraitsTestServiceRemote();
...
mojo.internal.bindings.media_router.mojom.MediaRouterTraitsTestServiceReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('media_router.mojom.MediaRouterTraitsTestService', [
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.media_router.mojom.MediaRouterTraitsTestService_EchoMediaSink_ParamsSpec.$.structSpec);
        ...
        case 0: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.media_router.mojom.MediaRouterTraitsTestService_EchoMediaSink_ResponseParamsSpec, header, rawHeader);
               responder(response);
...
mojo.internal.bindings.media_router.mojom.MediaRouterTraitsTestServiceReceiver = mojo.internal.bindings.media_router.mojom.MediaRouterTraitsTestServiceReceiver;
