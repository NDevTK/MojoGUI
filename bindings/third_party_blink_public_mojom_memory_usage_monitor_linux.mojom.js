...
mojo.internal.bindings.blink.mojom.MemoryUsageMonitorLinux = {};
mojo.internal.bindings.blink.mojom.MemoryUsageMonitorLinuxSpec = { $ : {} };
mojo.internal.bindings.blink.mojom.MemoryUsageMonitorLinux.$interfaceName = 'blink.mojom.MemoryUsageMonitorLinux';
...
mojo.internal.bindings.blink.mojom.MemoryUsageMonitorLinuxRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.blink.mojom.MemoryUsageMonitorLinuxPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.blink.mojom.MemoryUsageMonitorLinuxRemoteCallHandler(this.proxy);
  }
  ...
  setProcFiles(arg_statm_file, arg_status_file) {
    return this.$.setProcFiles(arg_statm_file, arg_status_file);
  }
};

mojo.internal.bindings.blink.mojom.MemoryUsageMonitorLinuxRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('blink.mojom.MemoryUsageMonitorLinux', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.blink.mojom.MemoryUsageMonitorLinux.getRemote = function() {
  let remote = new mojo.internal.bindings.blink.mojom.MemoryUsageMonitorLinuxRemote();
...
mojo.internal.bindings.blink.mojom.MemoryUsageMonitorLinuxReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('blink.mojom.MemoryUsageMonitorLinux', [
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.blink.mojom.MemoryUsageMonitorLinux_SetProcFiles_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for SetProcFiles failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.blink.mojom.MemoryUsageMonitorLinuxReceiver = mojo.internal.bindings.blink.mojom.MemoryUsageMonitorLinuxReceiver;
