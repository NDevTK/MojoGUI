...
mojo.internal.Struct(
    mojo.internal.bindings.blink.mojom.GpuDataManager_Are3DAPIsBlockedForUrl_ResponseParamsSpec, 'blink.mojom.GpuDataManager_Are3DAPIsBlockedForUrl_ResponseParams', [
      mojo.internal.StructField('arg_blocked', 0, 0, mojo.internal.Bool, false, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.bindings.blink.mojom.GpuDataManagerPendingReceiver = class {
  constructor(handle) {
    this.handle = handle;
  }
};

mojo.internal.bindings.blink.mojom.GpuDataManagerRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.blink.mojom.GpuDataManagerPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.blink.mojom.GpuDataManagerRemoteCallHandler(this.proxy);
  }
  ...
  are3DAPIsBlockedForUrl(arg_url) {
    return this.$.are3DAPIsBlockedForUrl(arg_url);
  }
};
...
mojo.internal.bindings.blink.mojom.GpuDataManager.getRemote = function() {
  let remote = new mojo.internal.bindings.blink.mojom.GpuDataManagerRemote();
...
mojo.internal.bindings.blink.mojom.GpuDataManagerReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.blink.mojom.GpuDataManager_Are3DAPIsBlockedForUrl_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for Are3DAPIsBlockedForUrl failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
        ...
        case 0: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              this.endpoint.send(header.ordinal, header.requestId, mojo.internal.kMessageFlagIsResponse, mojo.internal.bindings.blink.mojom.GpuDataManager_Are3DAPIsBlockedForUrl_ResponseParamsSpec, response);
...
mojo.internal.bindings.blink.mojom.GpuDataManagerReceiver = mojo.internal.bindings.blink.mojom.GpuDataManagerReceiver;

mojo.internal.bindings.blink.mojom.GpuDataManagerPtr = mojo.internal.bindings.blink.mojom.GpuDataManagerRemote;
mojo.internal.bindings.blink.mojom.GpuDataManagerRequest = mojo.internal.bindings.blink.mojom.GpuDataManagerPendingReceiver;
