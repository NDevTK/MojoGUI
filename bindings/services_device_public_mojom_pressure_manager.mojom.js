...
mojo.internal.Struct(
    mojo.internal.bindings.device.mojom.VirtualPressureSourceMetadataSpec, 'device.mojom.VirtualPressureSourceMetadata', [
      mojo.internal.StructField('arg_available', 0, 0, mojo.internal.Bool, true, false, 0, undefined),
    ],
    [[0, 16]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.device.mojom.PressureManager_AddVirtualPressureSource_ResponseParamsSpec, 'device.mojom.PressureManager_AddVirtualPressureSource_ResponseParams', [
    ],
    [[0, 8]]);

mojo.internal.Struct(
    mojo.internal.bindings.device.mojom.PressureManager_RemoveVirtualPressureSource_ParamsSpec, 'device.mojom.PressureManager_RemoveVirtualPressureSource_Params', [
      mojo.internal.StructField('arg_token', 0, 0, mojo.internal.bindings.mojo_base.mojom.UnguessableTokenSpec.$, null, false, 0, undefined),
      mojo.internal.StructField('arg_source', 8, 0, mojo.internal.bindings.device.mojom.PressureSourceSpec.$, null, false, 0, undefined),
    ],
    [[0, 24]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.device.mojom.PressureManager_RemoveVirtualPressureSource_ResponseParamsSpec, 'device.mojom.PressureManager_RemoveVirtualPressureSource_ResponseParams', [
    ],
    [[0, 8]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.device.mojom.PressureManager_UpdateVirtualPressureSourceData_ParamsSpec, 'device.mojom.PressureManager_UpdateVirtualPressureSourceData_Params', [
      mojo.internal.StructField('arg_token', 0, 0, mojo.internal.bindings.mojo_base.mojom.UnguessableTokenSpec.$, null, false, 0, undefined),
      mojo.internal.StructField('arg_source', 8, 0, mojo.internal.bindings.device.mojom.PressureSourceSpec.$, null, false, 0, undefined),
      mojo.internal.StructField('arg_state', 16, 0, mojo.internal.bindings.device.mojom.PressureStateSpec.$, null, false, 0, undefined),
      mojo.internal.StructField('arg_own_contribution_estimate', 24, 0, mojo.internal.Double, 0, false, 0, undefined),
    ],
    [[0, 40]]);

mojo.internal.Struct(
    mojo.internal.bindings.device.mojom.PressureManager_UpdateVirtualPressureSourceData_ResponseParamsSpec, 'device.mojom.PressureManager_UpdateVirtualPressureSourceData_ResponseParams', [
    ],
    [[0, 8]]);
...
mojo.internal.bindings.device.mojom.PressureManagerRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.device.mojom.PressureManagerRemoteCallHandler(this.proxy);
  }
  ...
  updateVirtualPressureSourceData(arg_token, arg_source, arg_state, arg_own_contribution_estimate) {
    return this.$.updateVirtualPressureSourceData(arg_token, arg_source, arg_state, arg_own_contribution_estimate);
  }
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.device.mojom.PressureManager_AddVirtualPressureSource_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for AddVirtualPressureSource failed with TypeError');
           }
        }
        // Try Method 1: RemoveVirtualPressureSource
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.device.mojom.PressureManager_RemoveVirtualPressureSource_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for RemoveVirtualPressureSource failed with TypeError');
           }
        }
        // Try Method 2: UpdateVirtualPressureSourceData
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.device.mojom.PressureManager_UpdateVirtualPressureSourceData_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for UpdateVirtualPressureSourceData failed with TypeError');
           }
        }
        // Try Method 3: AddClient
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.device.mojom.PressureManager_AddClient_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
...
mojo.internal.bindings.device.mojom.PressureManagerReceiver = mojo.internal.bindings.device.mojom.PressureManagerReceiver;

mojo.internal.bindings.device.mojom.PressureManagerPtr = mojo.internal.bindings.device.mojom.PressureManagerRemote;
mojo.internal.bindings.device.mojom.PressureManagerRequest = mojo.internal.bindings.device.mojom.PressureManagerPendingReceiver;


// Interface: PressureClient
mojo.internal.Struct(
    mojo.internal.bindings.device.mojom.PressureClient_OnPressureUpdated_ParamsSpec, 'device.mojom.PressureClient_OnPressureUpdated_Params', [
      mojo.internal.StructField('arg_update', 0, 0, mojo.internal.bindings.device.mojom.PressureUpdateSpec.$, null, false, 0, undefined),
    ],
    [[0, 16]]);
...
mojo.internal.bindings.device.mojom.PressureClientRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.device.mojom.PressureClientRemoteCallHandler(this.proxy);
  }
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.device.mojom.PressureClient_OnPressureUpdated_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OnPressureUpdated failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
             console.warn('[GeneratedReceiver] Failed to discover ordinal ' + header.ordinal);
...
mojo.internal.bindings.device.mojom.PressureClientReceiver = mojo.internal.bindings.device.mojom.PressureClientReceiver;

mojo.internal.bindings.device.mojom.PressureClientPtr = mojo.internal.bindings.device.mojom.PressureClientRemote;
mojo.internal.bindings.device.mojom.PressureClientRequest = mojo.internal.bindings.device.mojom.PressureClientPendingReceiver;
