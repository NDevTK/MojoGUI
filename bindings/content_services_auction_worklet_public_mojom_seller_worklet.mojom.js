  ...
  $: {
    structSpec: {
      ...
      fields: [
        ...
        { name: 'bid_currency', packedOffset: 16, packedBitOffset: 0, type: blink.mojom.AdCurrencySpec, nullable: true },
      ],
      versions: [{version: 0}]
    }
  }
...
auction_worklet.mojom.ScoreAdDependencyLatenciesSpec = {
  $: {
    structSpec: {
      ...
      packedSize: 56,
      fields: [
        { name: 'code_ready_latency', packedOffset: 0, packedBitOffset: 0, type: mojo_base.mojom.TimeDeltaSpec, nullable: true },
        { name: 'direct_from_seller_signals_latency', packedOffset: 8, packedBitOffset: 0, type: mojo_base.mojom.TimeDeltaSpec, nullable: true },
        { name: 'trusted_scoring_signals_latency', packedOffset: 16, packedBitOffset: 0, type: mojo_base.mojom.TimeDeltaSpec, nullable: true },
        { name: 'deps_wait_start_time', packedOffset: 24, packedBitOffset: 0, type: mojo_base.mojom.TimeTicksSpec, nullable: false },
        { name: 'score_ad_start_time', packedOffset: 32, packedBitOffset: 0, type: mojo_base.mojom.TimeTicksSpec, nullable: false },
        { name: 'score_ad_finish_time', packedOffset: 40, packedBitOffset: 0, type: mojo_base.mojom.TimeTicksSpec, nullable: false },
      ],
      versions: [{version: 0}]
    }
  }
...
auction_worklet.mojom.SellerTimingMetricsSpec = {
  $: {
    structSpec: {
      ...
      packedSize: 32,
      fields: [
        { name: 'js_fetch_latency', packedOffset: 0, packedBitOffset: 0, type: mojo_base.mojom.TimeDeltaSpec, nullable: true },
        { name: 'script_latency', packedOffset: 8, packedBitOffset: 0, type: mojo_base.mojom.TimeDeltaSpec, nullable: false },
...
auction_worklet.mojom.CreativeInfoWithoutOwnerSpec = {
  $: {
    structSpec: {
      ...
      packedSize: 24,
      fields: [
        { name: 'ad_descriptor', packedOffset: 0, packedBitOffset: 0, type: blink.mojom.AdDescriptorSpec, nullable: false },
  ...
  $: {
    structSpec: {
      ...
      fields: [
        ...
        { name: 'reject_reason', packedOffset: 8, packedBitOffset: 0, type: auction_worklet.mojom.RejectReasonSpec, nullable: false },
        { name: 'component_auction_modified_bid_params', packedOffset: 16, packedBitOffset: 0, type: auction_worklet.mojom.ComponentAuctionModifiedBidParamsSpec, nullable: true },
        { name: 'bid_in_seller_currency', packedOffset: 24, packedBitOffset: 0, type: mojo.internal.Double, nullable: true },
        { name: 'scoring_signals_data_version', packedOffset: 32, packedBitOffset: 0, type: mojo.internal.Uint32, nullable: true },
        { name: 'debug_loss_report_url', packedOffset: 40, packedBitOffset: 0, type: url.mojom.UrlSpec, nullable: true },
        { name: 'debug_win_report_url', packedOffset: 48, packedBitOffset: 0, type: url.mojom.UrlSpec, nullable: true },
        { name: 'pa_requests', packedOffset: 56, packedBitOffset: 0, type: mojo.internal.Array, nullable: false },
        { name: 'real_time_contributions', packedOffset: 64, packedBitOffset: 0, type: mojo.internal.Array, nullable: false },
        { name: 'score_ad_timing_metrics', packedOffset: 72, packedBitOffset: 0, type: auction_worklet.mojom.SellerTimingMetricsSpec, nullable: false },
        { name: 'score_ad_dependency_latencies', packedOffset: 80, packedBitOffset: 0, type: auction_worklet.mojom.ScoreAdDependencyLatenciesSpec, nullable: false },
  ...
  $: {
    structSpec: {
      ...
      fields: [
        ...
        { name: 'bid_currency', packedOffset: 16, packedBitOffset: 0, type: blink.mojom.AdCurrencySpec, nullable: true },
        { name: 'auction_ad_config_non_shared_params', packedOffset: 24, packedBitOffset: 0, type: blink.mojom.AuctionAdConfigNonSharedParamsSpec, nullable: false },
        { name: 'key_value_signals_cache_key', packedOffset: 32, packedBitOffset: 0, type: auction_worklet.mojom.TrustedSignalsCacheKeySpec, nullable: true },
        { name: 'ad', packedOffset: 40, packedBitOffset: 0, type: auction_worklet.mojom.CreativeInfoWithoutOwnerSpec, nullable: false },
        { name: 'ad_components', packedOffset: 48, packedBitOffset: 0, type: mojo.internal.Array, nullable: false },
        { name: 'direct_from_seller_seller_signals', packedOffset: 56, packedBitOffset: 0, type: url.mojom.UrlSpec, nullable: true },
        ...
        { name: 'direct_from_seller_auction_signals', packedOffset: 72, packedBitOffset: 0, type: url.mojom.UrlSpec, nullable: true },
        ...
        { name: 'browser_signals_other_seller', packedOffset: 88, packedBitOffset: 0, type: auction_worklet.mojom.ComponentAuctionOtherSellerSpec, nullable: true },
        { name: 'component_expect_bid_currency', packedOffset: 96, packedBitOffset: 0, type: blink.mojom.AdCurrencySpec, nullable: true },
        { name: 'browser_signal_interest_group_owner', packedOffset: 104, packedBitOffset: 0, type: url.mojom.OriginSpec, nullable: false },
        ...
        { name: 'browser_signal_for_debugging_only_in_cooldown_or_lockout', packedOffset: 132, packedBitOffset: 0, type: mojo.internal.Bool, nullable: false },
        { name: 'browser_signal_for_debugging_only_sampling', packedOffset: 132, packedBitOffset: 1, type: mojo.internal.Bool, nullable: false },
        { name: 'seller_timeout', packedOffset: 144, packedBitOffset: 0, type: mojo_base.mojom.TimeDeltaSpec, nullable: true },
        ...
        { name: 'bidder_joining_origin', packedOffset: 176, packedBitOffset: 0, type: url.mojom.OriginSpec, nullable: false },
...
auction_worklet.mojom.SellerWorklet_ReportResult_ParamsSpec = {
  $: {
    structSpec: {
      ...
      packedSize: 152,
      fields: [
        { name: 'auction_ad_config_non_shared_params', packedOffset: 0, packedBitOffset: 0, type: blink.mojom.AuctionAdConfigNonSharedParamsSpec, nullable: false },
        { name: 'direct_from_seller_seller_signals', packedOffset: 8, packedBitOffset: 0, type: url.mojom.UrlSpec, nullable: true },
        ...
        { name: 'direct_from_seller_auction_signals', packedOffset: 24, packedBitOffset: 0, type: url.mojom.UrlSpec, nullable: true },
        ...
        { name: 'browser_signals_other_seller', packedOffset: 40, packedBitOffset: 0, type: auction_worklet.mojom.ComponentAuctionOtherSellerSpec, nullable: true },
        { name: 'browser_signal_interest_group_owner', packedOffset: 48, packedBitOffset: 0, type: url.mojom.OriginSpec, nullable: false },
        ...
        { name: 'browser_signal_render_url', packedOffset: 72, packedBitOffset: 0, type: url.mojom.UrlSpec, nullable: false },
        { name: 'browser_signal_bid', packedOffset: 80, packedBitOffset: 0, type: mojo.internal.Double, nullable: false },
        { name: 'browser_signal_bid_currency', packedOffset: 88, packedBitOffset: 0, type: blink.mojom.AdCurrencySpec, nullable: true },
        ...
        { name: 'browser_signal_highest_scoring_other_bid_currency', packedOffset: 112, packedBitOffset: 0, type: blink.mojom.AdCurrencySpec, nullable: true },
        { name: 'browser_signals_component_auction_report_result_params', packedOffset: 120, packedBitOffset: 0, type: auction_worklet.mojom.ComponentAuctionReportResultParamsSpec, nullable: true },
        { name: 'scoring_signals_data_version', packedOffset: 128, packedBitOffset: 0, type: mojo.internal.Uint32, nullable: true },
        { name: 'trace_id', packedOffset: 136, packedBitOffset: 0, type: mojo.internal.Uint64, nullable: false },
      ],
      versions: [{version: 0}]
    }
  }
  ...
  $: {
    structSpec: {
      ...
      fields: [
        ...
        { name: 'report_url', packedOffset: 8, packedBitOffset: 0, type: url.mojom.UrlSpec, nullable: true },
        ...
        { name: 'time_metrics', packedOffset: 32, packedBitOffset: 0, type: auction_worklet.mojom.SellerTimingMetricsSpec, nullable: false },
