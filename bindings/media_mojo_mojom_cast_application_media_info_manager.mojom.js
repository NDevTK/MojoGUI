...
mojo.internal.bindings.media.mojom.CastApplicationMediaInfoManagerRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.media.mojom.CastApplicationMediaInfoManagerPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.media.mojom.CastApplicationMediaInfoManagerRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.media.mojom.CastApplicationMediaInfoManager.getRemote = function() {
  let remote = new mojo.internal.bindings.media.mojom.CastApplicationMediaInfoManagerRemote();
...
mojo.internal.bindings.media.mojom.CastApplicationMediaInfoManagerReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.media.mojom.CastApplicationMediaInfoManager_GetCastApplicationMediaInfo_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for GetCastApplicationMediaInfo failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.media.mojom.CastApplicationMediaInfoManager_GetCastApplicationMediaInfo_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.media.mojom.CastApplicationMediaInfoManagerReceiver = mojo.internal.bindings.media.mojom.CastApplicationMediaInfoManagerReceiver;
