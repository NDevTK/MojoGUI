...
mojo.internal.bindings.read_aloud.mojom.ReadAloudPlaybackControllerRemote = class {
  ...
  initializeAudio(arg_stream, arg_data_pipe) {
    return this.$.initializeAudio(arg_stream, arg_data_pipe);
  }
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        case 0: {
          ...
          const result = this.impl.initializeAudio(params.arg_stream, params.arg_data_pipe);
          break;
        }
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
