...
mojo.internal.bindings.ntp.safe_browsing.mojom.SafeBrowsingHandlerRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.ntp.safe_browsing.mojom.SafeBrowsingHandlerPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.ntp.safe_browsing.mojom.SafeBrowsingHandlerRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.ntp.safe_browsing.mojom.SafeBrowsingHandlerRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('ntp.safe_browsing.mojom.SafeBrowsingHandler', [
      { explicit: null },
      { explicit: null },
      { explicit: null },
      { explicit: null },
...
mojo.internal.bindings.ntp.safe_browsing.mojom.SafeBrowsingHandler.getRemote = function() {
  let remote = new mojo.internal.bindings.ntp.safe_browsing.mojom.SafeBrowsingHandlerRemote();
...
mojo.internal.bindings.ntp.safe_browsing.mojom.SafeBrowsingHandlerReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('ntp.safe_browsing.mojom.SafeBrowsingHandler', [
      { explicit: null },
      { explicit: null },
      { explicit: null },
      { explicit: null },
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.ntp.safe_browsing.mojom.SafeBrowsingHandler_CanShowModule_ParamsSpec.$.structSpec);
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.ntp.safe_browsing.mojom.SafeBrowsingHandler_ProcessModuleClick_ParamsSpec.$.structSpec);
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.ntp.safe_browsing.mojom.SafeBrowsingHandler_DismissModule_ParamsSpec.$.structSpec);
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.ntp.safe_browsing.mojom.SafeBrowsingHandler_RestoreModule_ParamsSpec.$.structSpec);
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.ntp.safe_browsing.mojom.SafeBrowsingHandler_CanShowModule_ParamsSpec.$.structSpec);
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.ntp.safe_browsing.mojom.SafeBrowsingHandler_CanShowModule_ResponseParamsSpec, header, rawHeader);
               responder(response);
        ...
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.ntp.safe_browsing.mojom.SafeBrowsingHandler_ProcessModuleClick_ParamsSpec.$.structSpec);
        ...
        case 2: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.ntp.safe_browsing.mojom.SafeBrowsingHandler_DismissModule_ParamsSpec.$.structSpec);
        ...
        case 3: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.ntp.safe_browsing.mojom.SafeBrowsingHandler_RestoreModule_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.ntp.safe_browsing.mojom.SafeBrowsingHandlerReceiver = mojo.internal.bindings.ntp.safe_browsing.mojom.SafeBrowsingHandlerReceiver;
