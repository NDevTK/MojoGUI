...
mojo.internal.bindings.chrome.mojom.OpenSearchDescriptionDocumentHandlerRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.chrome.mojom.OpenSearchDescriptionDocumentHandlerPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.chrome.mojom.OpenSearchDescriptionDocumentHandlerRemoteCallHandler(this.proxy);
  }
  ...
  pageHasOpenSearchDescriptionDocument(arg_page_url, arg_osdd_url) {
    return this.$.pageHasOpenSearchDescriptionDocument(arg_page_url, arg_osdd_url);
  }
};

mojo.internal.bindings.chrome.mojom.OpenSearchDescriptionDocumentHandlerRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('chrome.mojom.OpenSearchDescriptionDocumentHandler', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.chrome.mojom.OpenSearchDescriptionDocumentHandler.getRemote = function() {
  let remote = new mojo.internal.bindings.chrome.mojom.OpenSearchDescriptionDocumentHandlerRemote();
...
mojo.internal.bindings.chrome.mojom.OpenSearchDescriptionDocumentHandlerReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('chrome.mojom.OpenSearchDescriptionDocumentHandler', [
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.chrome.mojom.OpenSearchDescriptionDocumentHandler_PageHasOpenSearchDescriptionDocument_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for PageHasOpenSearchDescriptionDocument failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.chrome.mojom.OpenSearchDescriptionDocumentHandlerReceiver = mojo.internal.bindings.chrome.mojom.OpenSearchDescriptionDocumentHandlerReceiver;
