...
mojo.internal.bindings.viz.mojom.VideoDetectorObserverRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.viz.mojom.VideoDetectorObserverPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.viz.mojom.VideoDetectorObserverRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.viz.mojom.VideoDetectorObserverRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('viz.mojom.VideoDetectorObserver', [
      { explicit: null },
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.viz.mojom.VideoDetectorObserver.getRemote = function() {
  let remote = new mojo.internal.bindings.viz.mojom.VideoDetectorObserverRemote();
...
mojo.internal.bindings.viz.mojom.VideoDetectorObserverReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('viz.mojom.VideoDetectorObserver', [
      { explicit: null },
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.viz.mojom.VideoDetectorObserver_OnVideoActivityStarted_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OnVideoActivityStarted failed with TypeError');
           }
        }
        // Try Method 1: OnVideoActivityEnded
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.viz.mojom.VideoDetectorObserver_OnVideoActivityEnded_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OnVideoActivityEnded failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.viz.mojom.VideoDetectorObserver_OnVideoActivityStarted_ParamsSpec.$.structSpec);
        ...
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.viz.mojom.VideoDetectorObserver_OnVideoActivityEnded_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.viz.mojom.VideoDetectorObserverReceiver = mojo.internal.bindings.viz.mojom.VideoDetectorObserverReceiver;
