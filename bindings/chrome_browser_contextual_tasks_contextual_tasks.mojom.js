...
mojo.internal.bindings.contextual_tasks.mojom.ExtensionPageHandlerRemote = class {
  ...
  getLensCropPreview(arg_data_id) {
    return this.$.getLensCropPreview(arg_data_id);
  }
};
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        ...
        case 3: {
          ...
          const result = this.impl.getLensCropPreview(params.arg_data_id);
          const expectsResponse = header.expectsResponse || (header.flags & 1);
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
...
mojo.internal.Struct(
    mojo.internal.bindings.contextual_tasks.mojom.ExtensionPageHandler_GetLensCropPreview_ParamsSpec, 'contextual_tasks.mojom.ExtensionPageHandler_GetLensCropPreview_Params', [
      mojo.internal.StructField('arg_data_id', 0, 0, mojo.internal.String, null, false, 0, undefined),
    ],
    [[0, 16]]);
