...
mojo.internal.bindings.contextual_tasks.mojom.Page_SetAimUrl_ParamsSpec = mojo.internal.bindings.contextual_tasks.mojom.Page_SetAimUrl_ParamsSpec || { $: {} };
if (mojo.internal.bindings.contextual_tasks.mojom.Page_SetAimUrl_ParamsSpec.$.structSpec && mojo.internal.bindings.contextual_tasks.mojom.Page_SetAimUrl_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.contextual_tasks.mojom.Page_SetAimUrl_ParamsSpec.$ = {};
...
mojo.internal.bindings.contextual_tasks.mojom.PageRemote = class {
  ...
  setTaskDetails(arg_uuid) {
    return this.$.setTaskDetails(arg_uuid);
  }
  setAimUrl(arg_url) {
    return this.$.setAimUrl(arg_url);
  }
...
mojo.internal.bindings.contextual_tasks.mojom.PageRemoteCallHandler = class {
  ...
  setAimUrl(arg_url) {
    return this.proxy.sendMessage(
      this.ordinals[2],  // ordinal
      mojo.internal.bindings.contextual_tasks.mojom.Page_SetAimUrl_ParamsSpec,
      null,
      [arg_url],
      false);
  }
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        ...
        case 1: {
          ...
          const result = this.impl.setTaskDetails(params.arg_uuid);
          break;
        }
        case 2: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.contextual_tasks.mojom.Page_SetAimUrl_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.setAimUrl');
          const result = this.impl.setAimUrl(params.arg_url);
          break;
        }
        case 3: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
...
mojo.internal.Struct(
    mojo.internal.bindings.contextual_tasks.mojom.Page_SetAimUrl_ParamsSpec, 'contextual_tasks.mojom.Page_SetAimUrl_Params', [
      mojo.internal.StructField('arg_url', 0, 0, mojo.internal.bindings.url.mojom.UrlSpec, null, false, 0, undefined),
    ],
    [[0, 16]]);
