...
mojo.internal.bindings.contextual_tasks.mojom.TabSpec = mojo.internal.bindings.contextual_tasks.mojom.TabSpec || { $: {} };
if (mojo.internal.bindings.contextual_tasks.mojom.TabSpec.$.structSpec && mojo.internal.bindings.contextual_tasks.mojom.TabSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.contextual_tasks.mojom.TabSpec.$ = {};
mojo.internal.bindings.contextual_tasks.mojom.UploadedFileSpec = mojo.internal.bindings.contextual_tasks.mojom.UploadedFileSpec || { $: {} };
if (mojo.internal.bindings.contextual_tasks.mojom.UploadedFileSpec.$.structSpec && mojo.internal.bindings.contextual_tasks.mojom.UploadedFileSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.contextual_tasks.mojom.UploadedFileSpec.$ = {};
mojo.internal.bindings.contextual_tasks.mojom.ImageSpec = mojo.internal.bindings.contextual_tasks.mojom.ImageSpec || { $: {} };
if (mojo.internal.bindings.contextual_tasks.mojom.ImageSpec.$.structSpec && mojo.internal.bindings.contextual_tasks.mojom.ImageSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.contextual_tasks.mojom.ImageSpec.$ = {};
...
mojo.internal.bindings.contextual_tasks.mojom.PageRemote = class {
  ...
  onContextUpdated(arg_context_tabs, arg_context_files, arg_context_images) {
    return this.$.onContextUpdated(arg_context_tabs, arg_context_files, arg_context_images);
  }
  hideInput() {
...
mojo.internal.bindings.contextual_tasks.mojom.PageRemoteCallHandler = class {
  ...
  onContextUpdated(arg_context_tabs, arg_context_files, arg_context_images) {
    return this.proxy.sendMessage(
      ...
      null,
      [arg_context_tabs, arg_context_files, arg_context_images],
      false);
  }
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        ...
        case 6: {
          ...
          const result = this.impl.onContextUpdated(params.arg_context_tabs, params.arg_context_files, params.arg_context_images);
          break;
        }
        case 7: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
...
// Struct: UploadedFile
mojo.internal.Struct(
    mojo.internal.bindings.contextual_tasks.mojom.UploadedFileSpec, 'contextual_tasks.mojom.UploadedFile', [
...
// Struct: Image
mojo.internal.Struct(
    mojo.internal.bindings.contextual_tasks.mojom.ImageSpec, 'contextual_tasks.mojom.Image', [
...
mojo.internal.Struct(
    mojo.internal.bindings.contextual_tasks.mojom.Page_OnContextUpdated_ParamsSpec, 'contextual_tasks.mojom.Page_OnContextUpdated_Params', [
      ...
      mojo.internal.StructField('arg_context_files', 8, 0, mojo.internal.Array(mojo.internal.bindings.contextual_tasks.mojom.UploadedFileSpec, false), null, false, 0, undefined),
      mojo.internal.StructField('arg_context_images', 16, 0, mojo.internal.Array(mojo.internal.bindings.contextual_tasks.mojom.ImageSpec, false), null, false, 0, undefined),
    ],
    [[0, 32]]);
