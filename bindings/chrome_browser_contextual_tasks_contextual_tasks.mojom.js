...
mojo.internal.bindings.contextual_tasks.mojom.PageRemote = class {
  ...
  onContextUpdated(arg_context_tabs, arg_context_files) {
    return this.$.onContextUpdated(arg_context_tabs, arg_context_files);
  }
  hideInput() {
...
mojo.internal.bindings.contextual_tasks.mojom.PageRemoteCallHandler = class {
  ...
  onContextUpdated(arg_context_tabs, arg_context_files) {
    return this.proxy.sendMessage(
      ...
      mojo.internal.bindings.contextual_tasks.mojom.Page_OnContextUpdated_ParamsSpec,
      null,
      [arg_context_tabs, arg_context_files],
      false);
  }
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        ...
        case 6: {
          ...
          const result = this.impl.onContextUpdated(params.arg_context_tabs, params.arg_context_files);
          break;
        }
        case 7: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
