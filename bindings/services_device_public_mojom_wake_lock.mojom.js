...
// Enum: WakeLockReason
mojo.internal.bindings.device.mojom.WakeLockReason = {
  kAudioPlayback: 0,
  kVideoPlayback: 1,
  kOther: 2,
};
...
mojo.internal.Struct(
    mojo.internal.bindings.device.mojom.WakeLock_AddClient_ParamsSpec, 'device.mojom.WakeLock_AddClient_Params', [
      mojo.internal.StructField('arg_wake_lock', 0, 0, mojo.internal.InterfaceRequest(mojo.internal.bindings.device.mojom.WakeLockSpec), null, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.device.mojom.WakeLock_ChangeType_ParamsSpec, 'device.mojom.WakeLock_ChangeType_Params', [
      mojo.internal.StructField('arg_type', 0, 0, mojo.internal.bindings.mojo.internal.bindings.device.mojom.WakeLockTypeSpec.$, null, false, 0, undefined),
    ],
    [[0, 16]]);
...
mojo.internal.bindings.device.mojom.WakeLockRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.device.mojom.WakeLockRemoteCallHandler(this.proxy);
  }
  ...
  addClient(arg_wake_lock) {
    return this.$.addClient(arg_wake_lock);
  }
  changeType(arg_type) {
    return this.$.changeType(arg_type);
  }
  hasWakeLockForTests() {
...
mojo.internal.bindings.device.mojom.WakeLockRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('WakeLock', [
      { explicit: null },
      { explicit: null },
      { explicit: null },
      { explicit: null },
...
mojo.internal.bindings.device.mojom.WakeLock.getRemote = function() {
  let remote = new mojo.internal.bindings.device.mojom.WakeLockRemote();
...
mojo.internal.bindings.device.mojom.WakeLockReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('WakeLock', [
      { explicit: null },
      { explicit: null },
      { explicit: null },
      { explicit: null },
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.device.mojom.WakeLock_RequestWakeLock_ParamsSpec);
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.device.mojom.WakeLock_CancelWakeLock_ParamsSpec);
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.device.mojom.WakeLock_AddClient_ParamsSpec);
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.device.mojom.WakeLock_ChangeType_ParamsSpec);
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.device.mojom.WakeLock_HasWakeLockForTests_ParamsSpec);
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.device.mojom.WakeLock_RequestWakeLock_ParamsSpec.$.structSpec);
        ...
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.device.mojom.WakeLock_CancelWakeLock_ParamsSpec.$.structSpec);
        ...
        case 3: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.device.mojom.WakeLock_ChangeType_ResponseParamsSpec, header, rawHeader);
               responder(response);
        ...
        case 4: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.device.mojom.WakeLock_HasWakeLockForTests_ParamsSpec.$.structSpec);
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              const rawHeader = (args[2] && args[2].slice) ? args[2].slice(0, header.headerSize) : null;
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.device.mojom.WakeLock_HasWakeLockForTests_ResponseParamsSpec, header, rawHeader);
               responder(response);
...
mojo.internal.bindings.device.mojom.WakeLockReceiver = mojo.internal.bindings.device.mojom.WakeLockReceiver;
