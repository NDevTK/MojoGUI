...
mojo.internal.bindings.network.mojom.kURLLoadOptionSniffMimeType = 2;

mojo.internal.bindings.network.mojom.kURLLoadOptionSynchronous = 4;

mojo.internal.bindings.network.mojom.kURLLoadOptionSendSSLInfoForCertificateError = 8;

mojo.internal.bindings.network.mojom.kURLLoadOptionUseHeaderClient = 16;

mojo.internal.bindings.network.mojom.kURLLoadOptionBlockAllCookies = 32;

mojo.internal.bindings.network.mojom.kURLLoadOptionBlockThirdPartyCookies = 64;

mojo.internal.bindings.network.mojom.kURLLoadOptionAsCorsPreflight = 128;

mojo.internal.bindings.network.mojom.kURLLoadOptionBlockLocalRequest = 256;
...
mojo.internal.bindings.network.mojom.URLLoaderFactoryRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.network.mojom.URLLoaderFactoryPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.network.mojom.URLLoaderFactoryRemoteCallHandler(this.proxy);
  }
  ...
  createLoaderAndStart(arg_loader, arg_request_id, arg_options, arg_request, arg_client, arg_traffic_annotation) {
    return this.$.createLoaderAndStart(arg_loader, arg_request_id, arg_options, arg_request, arg_client, arg_traffic_annotation);
  }
  clone(arg_factory) {
...
mojo.internal.bindings.network.mojom.URLLoaderFactory.getRemote = function() {
  let remote = new mojo.internal.bindings.network.mojom.URLLoaderFactoryRemote();
...
mojo.internal.bindings.network.mojom.URLLoaderFactoryReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.network.mojom.URLLoaderFactory_CreateLoaderAndStart_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for CreateLoaderAndStart failed with TypeError');
           }
        }
        // Try Method 1: Clone
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.network.mojom.URLLoaderFactory_Clone_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
...
mojo.internal.bindings.network.mojom.URLLoaderFactoryReceiver = mojo.internal.bindings.network.mojom.URLLoaderFactoryReceiver;
