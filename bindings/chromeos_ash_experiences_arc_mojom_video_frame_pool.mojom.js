...
mojo.internal.bindings.arc.mojom.VideoFrameSpec = { $: {} };
mojo.internal.bindings.arc.mojom.VideoFramePool = {};
mojo.internal.bindings.arc.mojom.VideoFramePoolSpec = { $ : {} };
mojo.internal.bindings.arc.mojom.VideoFramePool.$interfaceName = 'arc.mojom.VideoFramePool';
...
mojo.internal.bindings.arc.mojom.VideoFramePoolClient = {};
mojo.internal.bindings.arc.mojom.VideoFramePoolClientSpec = { $ : {} };
mojo.internal.bindings.arc.mojom.VideoFramePoolClient.$interfaceName = 'arc.mojom.VideoFramePoolClient';
...
mojo.internal.Struct(
    mojo.internal.bindings.arc.mojom.VideoFrameSpec, 'arc.mojom.VideoFrame', [
      ...
      mojo.internal.StructField('arg_format', 36, 0, mojo.internal.bindings.arc.mojom.HalPixelFormatSpec, null, false, 0, undefined),
    ],
    [[0, 48]]);
...
mojo.internal.bindings.arc.mojom.VideoFramePoolRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.arc.mojom.VideoFramePoolPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.arc.mojom.VideoFramePoolRemoteCallHandler(this.proxy);
  }
  ...
  initialize(arg_client) {
    return this.$.initialize(arg_client);
  }
  addVideoFrame(arg_video_frame) {
    return this.$.addVideoFrame(arg_video_frame);
  }
};

mojo.internal.bindings.arc.mojom.VideoFramePoolRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('arc.mojom.VideoFramePool', [
      { explicit: 0 },
      { explicit: 1 },
    ]);
  }
...
mojo.internal.bindings.arc.mojom.VideoFramePool.getRemote = function() {
  let remote = new mojo.internal.bindings.arc.mojom.VideoFramePoolRemote();
...
mojo.internal.bindings.arc.mojom.VideoFramePoolReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('arc.mojom.VideoFramePool', [
      { explicit: 0 },
      { explicit: 1 },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.arc.mojom.VideoFramePool_Initialize_ParamsSpec.$.structSpec;
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.arc.mojom.VideoFramePool_AddVideoFrame_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for AddVideoFrame failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.arc.mojom.VideoFramePoolReceiver = mojo.internal.bindings.arc.mojom.VideoFramePoolReceiver;

mojo.internal.bindings.arc.mojom.VideoFramePoolPtr = mojo.internal.bindings.arc.mojom.VideoFramePoolRemote;
mojo.internal.bindings.arc.mojom.VideoFramePoolRequest = mojo.internal.bindings.arc.mojom.VideoFramePoolPendingReceiver;
...
mojo.internal.Struct(
    mojo.internal.bindings.arc.mojom.VideoFramePoolClient_RequestVideoFrames_ParamsSpec, 'arc.mojom.VideoFramePoolClient_RequestVideoFrames_Params', [
      ...
      mojo.internal.StructField('arg_format', 16, 0, mojo.internal.bindings.arc.mojom.VideoPixelFormatSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_num_frames', 20, 0, mojo.internal.Uint32, 0, false, 0, undefined),
    ],
    [[0, 32]]);
...
mojo.internal.bindings.arc.mojom.VideoFramePoolClientRemote = class {
  static get $interfaceName() {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.arc.mojom.VideoFramePoolClientPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.arc.mojom.VideoFramePoolClientRemoteCallHandler(this.proxy);
  }
  ...
  requestVideoFrames(arg_format, arg_coded_size, arg_visible_rect, arg_num_frames) {
    return this.$.requestVideoFrames(arg_format, arg_coded_size, arg_visible_rect, arg_num_frames);
  }
};

mojo.internal.bindings.arc.mojom.VideoFramePoolClientRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('arc.mojom.VideoFramePoolClient', [
      { explicit: 1 },
    ]);
  }
...
mojo.internal.bindings.arc.mojom.VideoFramePoolClient.getRemote = function() {
  let remote = new mojo.internal.bindings.arc.mojom.VideoFramePoolClientRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
...
mojo.internal.bindings.arc.mojom.VideoFramePoolClientReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('arc.mojom.VideoFramePoolClient', [
      { explicit: 1 },
    ]);
    ordinals.forEach((ord, idx) => {
      this.ordinalMap.set(ord, idx); // Scrambled/Explicit
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.arc.mojom.VideoFramePoolClient_RequestVideoFrames_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for RequestVideoFrames failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
             console.warn('[GeneratedReceiver] Failed to discover ordinal ' + header.ordinal);
...
mojo.internal.bindings.arc.mojom.VideoFramePoolClientReceiver = mojo.internal.bindings.arc.mojom.VideoFramePoolClientReceiver;
