  ...
  $: {
    structSpec: {
      ...
      fields: [
        ...
        { name: 'planes_count', packedOffset: 48, packedBitOffset: 0, type: mojo.internal.Uint32, nullable: false },
  ...
  $: {
    structSpec: {
      ...
      fields: [
        { name: 'widget', packedOffset: 0, packedBitOffset: 0, type: mojo.internal.Pointer, nullable: false },
        { name: 'frame_id', packedOffset: 8, packedBitOffset: 0, type: mojo.internal.Uint32, nullable: false },
        { name: 'swap_result', packedOffset: 16, packedBitOffset: 0, type: mojo.internal.Pointer, nullable: false },
