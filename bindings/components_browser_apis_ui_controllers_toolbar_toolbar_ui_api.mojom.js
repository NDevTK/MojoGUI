...
mojo.internal.bindings.toolbar_ui_api.mojom.ToolbarUIServiceRemote = class {
  ...
  showContextMenu(arg_menu_type, arg_bounds_in_css_pixels, arg_source) {
    return this.$.showContextMenu(arg_menu_type, arg_bounds_in_css_pixels, arg_source);
  }
...
mojo.internal.bindings.toolbar_ui_api.mojom.ToolbarUIServiceRemoteCallHandler = class {
  ...
  showContextMenu(arg_menu_type, arg_bounds_in_css_pixels, arg_source) {
    return this.proxy.sendMessage(
      ...
      mojo.internal.bindings.toolbar_ui_api.mojom.ToolbarUIService_ShowContextMenu_ParamsSpec,
      null,
      [arg_menu_type, arg_bounds_in_css_pixels, arg_source],
      false);
  }
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        ...
        case 1: {
          ...
          const result = this.impl.showContextMenu(params.arg_menu_type, params.arg_bounds_in_css_pixels, params.arg_source);
          break;
        }
        case 2: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
