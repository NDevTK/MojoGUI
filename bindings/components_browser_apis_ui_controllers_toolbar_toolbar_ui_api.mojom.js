...
mojo.internal.bindings.toolbar_ui_api.mojom.ToolbarUIObserverRemote = class {
  ...
  onNavigationControlsStateChanged(arg_state) {
    return this.$.onNavigationControlsStateChanged(arg_state);
  }
};
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        case 0: {
          ...
          const result = this.impl.onNavigationControlsStateChanged(params.arg_state);
          break;
        }
      }
      } catch (err) {
...
mojo.internal.Struct(
    mojo.internal.bindings.toolbar_ui_api.mojom.InitialStateSpec, 'toolbar_ui_api.mojom.InitialState', [
      mojo.internal.StructField('arg_state', 0, 0, mojo.internal.bindings.toolbar_ui_api.mojom.NavigationControlsStateSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_update_stream', 8, 0, mojo.internal.InterfaceRequest(mojo.internal.bindings.toolbar_ui_api.mojom.ToolbarUIObserverPendingReceiver), null, false, 0, undefined),
    ],
    [[0, 24]]);
mojo.internal.Struct(
