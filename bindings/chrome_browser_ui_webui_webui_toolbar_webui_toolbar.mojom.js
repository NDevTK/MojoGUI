...
mojo.internal.bindings.webui_toolbar.mojom.PageHandler_OnPageInitialized_ParamsSpec = { $: {} };
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        ...
        case 3: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.webui_toolbar.mojom.PageHandler_OnPageInitialized_ParamsSpec.$.structSpec);
...
mojo.internal.Struct(
    mojo.internal.bindings.webui_toolbar.mojom.PageHandler_OnPageInitialized_ParamsSpec, 'webui_toolbar.mojom.PageHandler_OnPageInitialized_Params', [
    ],
    [[0, 8]]);
