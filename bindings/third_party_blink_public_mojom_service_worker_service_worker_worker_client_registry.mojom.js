...
mojo.internal.bindings.blink.mojom.ServiceWorkerWorkerClientRegistry = {};
mojo.internal.bindings.blink.mojom.ServiceWorkerWorkerClientRegistrySpec = { $ : {} };
mojo.internal.bindings.blink.mojom.ServiceWorkerWorkerClientRegistry.$interfaceName = 'blink.mojom.ServiceWorkerWorkerClientRegistry';
...
mojo.internal.bindings.blink.mojom.ServiceWorkerWorkerClientRegistryRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.blink.mojom.ServiceWorkerWorkerClientRegistryPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.blink.mojom.ServiceWorkerWorkerClientRegistryRemoteCallHandler(this.proxy);
  }
  ...
  registerWorkerClient(arg_client) {
    return this.$.registerWorkerClient(arg_client);
  }
  cloneWorkerClientRegistry(arg_host) {
    return this.$.cloneWorkerClientRegistry(arg_host);
  }
};

mojo.internal.bindings.blink.mojom.ServiceWorkerWorkerClientRegistryRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('blink.mojom.ServiceWorkerWorkerClientRegistry', [
      { explicit: null },
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.blink.mojom.ServiceWorkerWorkerClientRegistry.getRemote = function() {
  let remote = new mojo.internal.bindings.blink.mojom.ServiceWorkerWorkerClientRegistryRemote();
...
mojo.internal.bindings.blink.mojom.ServiceWorkerWorkerClientRegistryReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('blink.mojom.ServiceWorkerWorkerClientRegistry', [
      { explicit: null },
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.blink.mojom.ServiceWorkerWorkerClientRegistry_RegisterWorkerClient_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for RegisterWorkerClient failed with TypeError');
           }
        }
        // Try Method 1: CloneWorkerClientRegistry
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.blink.mojom.ServiceWorkerWorkerClientRegistry_CloneWorkerClientRegistry_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for CloneWorkerClientRegistry failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.blink.mojom.ServiceWorkerWorkerClientRegistryReceiver = mojo.internal.bindings.blink.mojom.ServiceWorkerWorkerClientRegistryReceiver;
