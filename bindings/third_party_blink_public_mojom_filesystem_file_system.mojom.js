...
mojo.internal.bindings.blink.mojom.FileSystemTypeSpec = mojo.internal.bindings.blink.mojom.FileSystemTypeSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.blink.mojom.FileSystemInfoSpec = mojo.internal.bindings.blink.mojom.FileSystemInfoSpec || { $: {} };
if (mojo.internal.bindings.blink.mojom.FileSystemInfoSpec.$.structSpec && mojo.internal.bindings.blink.mojom.FileSystemInfoSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.blink.mojom.FileSystemInfoSpec.$ = {};
mojo.internal.bindings.blink.mojom.FileSystemCancellableOperation = mojo.internal.bindings.blink.mojom.FileSystemCancellableOperation || {};
mojo.internal.bindings.blink.mojom.FileSystemCancellableOperationSpec = mojo.internal.bindings.blink.mojom.FileSystemCancellableOperationSpec || { $ : {} };
if (mojo.internal.bindings.blink.mojom.FileSystemCancellableOperationSpec.$.structSpec && mojo.internal.bindings.blink.mojom.FileSystemCancellableOperationSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.blink.mojom.FileSystemCancellableOperationSpec.$ = {};
...
mojo.internal.bindings.blink.mojom.FileSystemCancellableOperation_Cancel_ParamsSpec = mojo.internal.bindings.blink.mojom.FileSystemCancellableOperation_Cancel_ParamsSpec || { $: {} };
if (mojo.internal.bindings.blink.mojom.FileSystemCancellableOperation_Cancel_ParamsSpec.$.structSpec && mojo.internal.bindings.blink.mojom.FileSystemCancellableOperation_Cancel_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.blink.mojom.FileSystemCancellableOperation_Cancel_ParamsSpec.$ = {};
mojo.internal.bindings.blink.mojom.FileSystemCancellableOperation_Cancel_ResponseParamsSpec = mojo.internal.bindings.blink.mojom.FileSystemCancellableOperation_Cancel_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.blink.mojom.FileSystemCancellableOperation_Cancel_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.blink.mojom.FileSystemCancellableOperation_Cancel_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.blink.mojom.FileSystemCancellableOperation_Cancel_ResponseParamsSpec.$ = {};
mojo.internal.bindings.blink.mojom.FileSystemOperationListener = mojo.internal.bindings.blink.mojom.FileSystemOperationListener || {};
mojo.internal.bindings.blink.mojom.FileSystemOperationListenerSpec = mojo.internal.bindings.blink.mojom.FileSystemOperationListenerSpec || { $ : {} };
if (mojo.internal.bindings.blink.mojom.FileSystemOperationListenerSpec.$.structSpec && mojo.internal.bindings.blink.mojom.FileSystemOperationListenerSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.blink.mojom.FileSystemOperationListenerSpec.$ = {};
mojo.internal.bindings.blink.mojom.FileSystemOperationListener.$interfaceName = 'blink.mojom.FileSystemOperationListener';
mojo.internal.bindings.blink.mojom.FileSystemOperationListener_ResultsRetrieved_ParamsSpec = mojo.internal.bindings.blink.mojom.FileSystemOperationListener_ResultsRetrieved_ParamsSpec || { $: {} };
if (mojo.internal.bindings.blink.mojom.FileSystemOperationListener_ResultsRetrieved_ParamsSpec.$.structSpec && mojo.internal.bindings.blink.mojom.FileSystemOperationListener_ResultsRetrieved_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.blink.mojom.FileSystemOperationListener_ResultsRetrieved_ParamsSpec.$ = {};
mojo.internal.bindings.blink.mojom.FileSystemOperationListener_DidWrite_ParamsSpec = mojo.internal.bindings.blink.mojom.FileSystemOperationListener_DidWrite_ParamsSpec || { $: {} };
if (mojo.internal.bindings.blink.mojom.FileSystemOperationListener_DidWrite_ParamsSpec.$.structSpec && mojo.internal.bindings.blink.mojom.FileSystemOperationListener_DidWrite_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.blink.mojom.FileSystemOperationListener_DidWrite_ParamsSpec.$ = {};
mojo.internal.bindings.blink.mojom.FileSystemOperationListener_ErrorOccurred_ParamsSpec = mojo.internal.bindings.blink.mojom.FileSystemOperationListener_ErrorOccurred_ParamsSpec || { $: {} };
if (mojo.internal.bindings.blink.mojom.FileSystemOperationListener_ErrorOccurred_ParamsSpec.$.structSpec && mojo.internal.bindings.blink.mojom.FileSystemOperationListener_ErrorOccurred_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.blink.mojom.FileSystemOperationListener_ErrorOccurred_ParamsSpec.$ = {};
mojo.internal.bindings.blink.mojom.ReceivedSnapshotListener = mojo.internal.bindings.blink.mojom.ReceivedSnapshotListener || {};
mojo.internal.bindings.blink.mojom.ReceivedSnapshotListenerSpec = mojo.internal.bindings.blink.mojom.ReceivedSnapshotListenerSpec || { $ : {} };
if (mojo.internal.bindings.blink.mojom.ReceivedSnapshotListenerSpec.$.structSpec && mojo.internal.bindings.blink.mojom.ReceivedSnapshotListenerSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.blink.mojom.ReceivedSnapshotListenerSpec.$ = {};
mojo.internal.bindings.blink.mojom.ReceivedSnapshotListener.$interfaceName = 'blink.mojom.ReceivedSnapshotListener';
mojo.internal.bindings.blink.mojom.ReceivedSnapshotListener_DidReceiveSnapshotFile_ParamsSpec = mojo.internal.bindings.blink.mojom.ReceivedSnapshotListener_DidReceiveSnapshotFile_ParamsSpec || { $: {} };
if (mojo.internal.bindings.blink.mojom.ReceivedSnapshotListener_DidReceiveSnapshotFile_ParamsSpec.$.structSpec && mojo.internal.bindings.blink.mojom.ReceivedSnapshotListener_DidReceiveSnapshotFile_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.blink.mojom.ReceivedSnapshotListener_DidReceiveSnapshotFile_ParamsSpec.$ = {};
mojo.internal.bindings.blink.mojom.FileSystemManager = mojo.internal.bindings.blink.mojom.FileSystemManager || {};
mojo.internal.bindings.blink.mojom.FileSystemManagerSpec = mojo.internal.bindings.blink.mojom.FileSystemManagerSpec || { $ : {} };
if (mojo.internal.bindings.blink.mojom.FileSystemManagerSpec.$.structSpec && mojo.internal.bindings.blink.mojom.FileSystemManagerSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.blink.mojom.FileSystemManagerSpec.$ = {};
mojo.internal.bindings.blink.mojom.FileSystemManager.$interfaceName = 'blink.mojom.FileSystemManager';
mojo.internal.bindings.blink.mojom.FileSystemManager_Open_ParamsSpec = mojo.internal.bindings.blink.mojom.FileSystemManager_Open_ParamsSpec || { $: {} };
if (mojo.internal.bindings.blink.mojom.FileSystemManager_Open_ParamsSpec.$.structSpec && mojo.internal.bindings.blink.mojom.FileSystemManager_Open_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.blink.mojom.FileSystemManager_Open_ParamsSpec.$ = {};
mojo.internal.bindings.blink.mojom.FileSystemManager_Open_ResponseParamsSpec = mojo.internal.bindings.blink.mojom.FileSystemManager_Open_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.blink.mojom.FileSystemManager_Open_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.blink.mojom.FileSystemManager_Open_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.blink.mojom.FileSystemManager_Open_ResponseParamsSpec.$ = {};
mojo.internal.bindings.blink.mojom.FileSystemManager_ResolveURL_ParamsSpec = mojo.internal.bindings.blink.mojom.FileSystemManager_ResolveURL_ParamsSpec || { $: {} };
if (mojo.internal.bindings.blink.mojom.FileSystemManager_ResolveURL_ParamsSpec.$.structSpec && mojo.internal.bindings.blink.mojom.FileSystemManager_ResolveURL_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.blink.mojom.FileSystemManager_ResolveURL_ParamsSpec.$ = {};
mojo.internal.bindings.blink.mojom.FileSystemManager_ResolveURL_ResponseParamsSpec = mojo.internal.bindings.blink.mojom.FileSystemManager_ResolveURL_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.blink.mojom.FileSystemManager_ResolveURL_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.blink.mojom.FileSystemManager_ResolveURL_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.blink.mojom.FileSystemManager_ResolveURL_ResponseParamsSpec.$ = {};
mojo.internal.bindings.blink.mojom.FileSystemManager_Move_ParamsSpec = mojo.internal.bindings.blink.mojom.FileSystemManager_Move_ParamsSpec || { $: {} };
if (mojo.internal.bindings.blink.mojom.FileSystemManager_Move_ParamsSpec.$.structSpec && mojo.internal.bindings.blink.mojom.FileSystemManager_Move_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.blink.mojom.FileSystemManager_Move_ParamsSpec.$ = {};
mojo.internal.bindings.blink.mojom.FileSystemManager_Move_ResponseParamsSpec = mojo.internal.bindings.blink.mojom.FileSystemManager_Move_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.blink.mojom.FileSystemManager_Move_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.blink.mojom.FileSystemManager_Move_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.blink.mojom.FileSystemManager_Move_ResponseParamsSpec.$ = {};
mojo.internal.bindings.blink.mojom.FileSystemManager_Copy_ParamsSpec = mojo.internal.bindings.blink.mojom.FileSystemManager_Copy_ParamsSpec || { $: {} };
if (mojo.internal.bindings.blink.mojom.FileSystemManager_Copy_ParamsSpec.$.structSpec && mojo.internal.bindings.blink.mojom.FileSystemManager_Copy_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.blink.mojom.FileSystemManager_Copy_ParamsSpec.$ = {};
mojo.internal.bindings.blink.mojom.FileSystemManager_Copy_ResponseParamsSpec = mojo.internal.bindings.blink.mojom.FileSystemManager_Copy_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.blink.mojom.FileSystemManager_Copy_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.blink.mojom.FileSystemManager_Copy_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.blink.mojom.FileSystemManager_Copy_ResponseParamsSpec.$ = {};
mojo.internal.bindings.blink.mojom.FileSystemManager_Remove_ParamsSpec = mojo.internal.bindings.blink.mojom.FileSystemManager_Remove_ParamsSpec || { $: {} };
if (mojo.internal.bindings.blink.mojom.FileSystemManager_Remove_ParamsSpec.$.structSpec && mojo.internal.bindings.blink.mojom.FileSystemManager_Remove_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.blink.mojom.FileSystemManager_Remove_ParamsSpec.$ = {};
mojo.internal.bindings.blink.mojom.FileSystemManager_Remove_ResponseParamsSpec = mojo.internal.bindings.blink.mojom.FileSystemManager_Remove_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.blink.mojom.FileSystemManager_Remove_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.blink.mojom.FileSystemManager_Remove_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.blink.mojom.FileSystemManager_Remove_ResponseParamsSpec.$ = {};
mojo.internal.bindings.blink.mojom.FileSystemManager_ReadMetadata_ParamsSpec = mojo.internal.bindings.blink.mojom.FileSystemManager_ReadMetadata_ParamsSpec || { $: {} };
if (mojo.internal.bindings.blink.mojom.FileSystemManager_ReadMetadata_ParamsSpec.$.structSpec && mojo.internal.bindings.blink.mojom.FileSystemManager_ReadMetadata_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.blink.mojom.FileSystemManager_ReadMetadata_ParamsSpec.$ = {};
mojo.internal.bindings.blink.mojom.FileSystemManager_ReadMetadata_ResponseParamsSpec = mojo.internal.bindings.blink.mojom.FileSystemManager_ReadMetadata_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.blink.mojom.FileSystemManager_ReadMetadata_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.blink.mojom.FileSystemManager_ReadMetadata_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.blink.mojom.FileSystemManager_ReadMetadata_ResponseParamsSpec.$ = {};
mojo.internal.bindings.blink.mojom.FileSystemManager_Create_ParamsSpec = mojo.internal.bindings.blink.mojom.FileSystemManager_Create_ParamsSpec || { $: {} };
if (mojo.internal.bindings.blink.mojom.FileSystemManager_Create_ParamsSpec.$.structSpec && mojo.internal.bindings.blink.mojom.FileSystemManager_Create_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.blink.mojom.FileSystemManager_Create_ParamsSpec.$ = {};
mojo.internal.bindings.blink.mojom.FileSystemManager_Create_ResponseParamsSpec = mojo.internal.bindings.blink.mojom.FileSystemManager_Create_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.blink.mojom.FileSystemManager_Create_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.blink.mojom.FileSystemManager_Create_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.blink.mojom.FileSystemManager_Create_ResponseParamsSpec.$ = {};
mojo.internal.bindings.blink.mojom.FileSystemManager_Exists_ParamsSpec = mojo.internal.bindings.blink.mojom.FileSystemManager_Exists_ParamsSpec || { $: {} };
if (mojo.internal.bindings.blink.mojom.FileSystemManager_Exists_ParamsSpec.$.structSpec && mojo.internal.bindings.blink.mojom.FileSystemManager_Exists_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.blink.mojom.FileSystemManager_Exists_ParamsSpec.$ = {};
mojo.internal.bindings.blink.mojom.FileSystemManager_Exists_ResponseParamsSpec = mojo.internal.bindings.blink.mojom.FileSystemManager_Exists_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.blink.mojom.FileSystemManager_Exists_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.blink.mojom.FileSystemManager_Exists_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.blink.mojom.FileSystemManager_Exists_ResponseParamsSpec.$ = {};
mojo.internal.bindings.blink.mojom.FileSystemManager_ReadDirectory_ParamsSpec = mojo.internal.bindings.blink.mojom.FileSystemManager_ReadDirectory_ParamsSpec || { $: {} };
if (mojo.internal.bindings.blink.mojom.FileSystemManager_ReadDirectory_ParamsSpec.$.structSpec && mojo.internal.bindings.blink.mojom.FileSystemManager_ReadDirectory_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.blink.mojom.FileSystemManager_ReadDirectory_ParamsSpec.$ = {};
mojo.internal.bindings.blink.mojom.FileSystemManager_ReadDirectorySync_ParamsSpec = mojo.internal.bindings.blink.mojom.FileSystemManager_ReadDirectorySync_ParamsSpec || { $: {} };
if (mojo.internal.bindings.blink.mojom.FileSystemManager_ReadDirectorySync_ParamsSpec.$.structSpec && mojo.internal.bindings.blink.mojom.FileSystemManager_ReadDirectorySync_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.blink.mojom.FileSystemManager_ReadDirectorySync_ParamsSpec.$ = {};
mojo.internal.bindings.blink.mojom.FileSystemManager_ReadDirectorySync_ResponseParamsSpec = mojo.internal.bindings.blink.mojom.FileSystemManager_ReadDirectorySync_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.blink.mojom.FileSystemManager_ReadDirectorySync_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.blink.mojom.FileSystemManager_ReadDirectorySync_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.blink.mojom.FileSystemManager_ReadDirectorySync_ResponseParamsSpec.$ = {};
mojo.internal.bindings.blink.mojom.FileSystemManager_Write_ParamsSpec = mojo.internal.bindings.blink.mojom.FileSystemManager_Write_ParamsSpec || { $: {} };
if (mojo.internal.bindings.blink.mojom.FileSystemManager_Write_ParamsSpec.$.structSpec && mojo.internal.bindings.blink.mojom.FileSystemManager_Write_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.blink.mojom.FileSystemManager_Write_ParamsSpec.$ = {};
mojo.internal.bindings.blink.mojom.FileSystemManager_WriteSync_ParamsSpec = mojo.internal.bindings.blink.mojom.FileSystemManager_WriteSync_ParamsSpec || { $: {} };
if (mojo.internal.bindings.blink.mojom.FileSystemManager_WriteSync_ParamsSpec.$.structSpec && mojo.internal.bindings.blink.mojom.FileSystemManager_WriteSync_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.blink.mojom.FileSystemManager_WriteSync_ParamsSpec.$ = {};
mojo.internal.bindings.blink.mojom.FileSystemManager_WriteSync_ResponseParamsSpec = mojo.internal.bindings.blink.mojom.FileSystemManager_WriteSync_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.blink.mojom.FileSystemManager_WriteSync_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.blink.mojom.FileSystemManager_WriteSync_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.blink.mojom.FileSystemManager_WriteSync_ResponseParamsSpec.$ = {};
mojo.internal.bindings.blink.mojom.FileSystemManager_Truncate_ParamsSpec = mojo.internal.bindings.blink.mojom.FileSystemManager_Truncate_ParamsSpec || { $: {} };
if (mojo.internal.bindings.blink.mojom.FileSystemManager_Truncate_ParamsSpec.$.structSpec && mojo.internal.bindings.blink.mojom.FileSystemManager_Truncate_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.blink.mojom.FileSystemManager_Truncate_ParamsSpec.$ = {};
mojo.internal.bindings.blink.mojom.FileSystemManager_Truncate_ResponseParamsSpec = mojo.internal.bindings.blink.mojom.FileSystemManager_Truncate_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.blink.mojom.FileSystemManager_Truncate_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.blink.mojom.FileSystemManager_Truncate_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.blink.mojom.FileSystemManager_Truncate_ResponseParamsSpec.$ = {};
mojo.internal.bindings.blink.mojom.FileSystemManager_TruncateSync_ParamsSpec = mojo.internal.bindings.blink.mojom.FileSystemManager_TruncateSync_ParamsSpec || { $: {} };
if (mojo.internal.bindings.blink.mojom.FileSystemManager_TruncateSync_ParamsSpec.$.structSpec && mojo.internal.bindings.blink.mojom.FileSystemManager_TruncateSync_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.blink.mojom.FileSystemManager_TruncateSync_ParamsSpec.$ = {};
mojo.internal.bindings.blink.mojom.FileSystemManager_TruncateSync_ResponseParamsSpec = mojo.internal.bindings.blink.mojom.FileSystemManager_TruncateSync_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.blink.mojom.FileSystemManager_TruncateSync_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.blink.mojom.FileSystemManager_TruncateSync_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.blink.mojom.FileSystemManager_TruncateSync_ResponseParamsSpec.$ = {};
mojo.internal.bindings.blink.mojom.FileSystemManager_CreateSnapshotFile_ParamsSpec = mojo.internal.bindings.blink.mojom.FileSystemManager_CreateSnapshotFile_ParamsSpec || { $: {} };
if (mojo.internal.bindings.blink.mojom.FileSystemManager_CreateSnapshotFile_ParamsSpec.$.structSpec && mojo.internal.bindings.blink.mojom.FileSystemManager_CreateSnapshotFile_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.blink.mojom.FileSystemManager_CreateSnapshotFile_ParamsSpec.$ = {};
mojo.internal.bindings.blink.mojom.FileSystemManager_CreateSnapshotFile_ResponseParamsSpec = mojo.internal.bindings.blink.mojom.FileSystemManager_CreateSnapshotFile_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.blink.mojom.FileSystemManager_CreateSnapshotFile_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.blink.mojom.FileSystemManager_CreateSnapshotFile_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.blink.mojom.FileSystemManager_CreateSnapshotFile_ResponseParamsSpec.$ = {};
mojo.internal.bindings.blink.mojom.FileSystemManager_GetPlatformPath_ParamsSpec = mojo.internal.bindings.blink.mojom.FileSystemManager_GetPlatformPath_ParamsSpec || { $: {} };
if (mojo.internal.bindings.blink.mojom.FileSystemManager_GetPlatformPath_ParamsSpec.$.structSpec && mojo.internal.bindings.blink.mojom.FileSystemManager_GetPlatformPath_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.blink.mojom.FileSystemManager_GetPlatformPath_ParamsSpec.$ = {};
mojo.internal.bindings.blink.mojom.FileSystemManager_GetPlatformPath_ResponseParamsSpec = mojo.internal.bindings.blink.mojom.FileSystemManager_GetPlatformPath_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.blink.mojom.FileSystemManager_GetPlatformPath_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.blink.mojom.FileSystemManager_GetPlatformPath_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.blink.mojom.FileSystemManager_GetPlatformPath_ResponseParamsSpec.$ = {};
mojo.internal.bindings.blink.mojom.FileSystemManager_RegisterBlob_ParamsSpec = mojo.internal.bindings.blink.mojom.FileSystemManager_RegisterBlob_ParamsSpec || { $: {} };
if (mojo.internal.bindings.blink.mojom.FileSystemManager_RegisterBlob_ParamsSpec.$.structSpec && mojo.internal.bindings.blink.mojom.FileSystemManager_RegisterBlob_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.blink.mojom.FileSystemManager_RegisterBlob_ParamsSpec.$ = {};
mojo.internal.bindings.blink.mojom.FileSystemManager_RegisterBlob_ResponseParamsSpec = mojo.internal.bindings.blink.mojom.FileSystemManager_RegisterBlob_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.blink.mojom.FileSystemManager_RegisterBlob_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.blink.mojom.FileSystemManager_RegisterBlob_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.blink.mojom.FileSystemManager_RegisterBlob_ResponseParamsSpec.$ = {};
...
mojo.internal.bindings.blink.mojom.FileSystemManagerRemote = class {
  ...
  open(arg_file_system_type) {
    return this.$.open(arg_file_system_type);
  }
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        case 0: {
          ...
          const result = this.impl.open(params.arg_file_system_type);
          const expectsResponse = header.expectsResponse || (header.flags & 1);
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
...
mojo.internal.Struct(
    mojo.internal.bindings.blink.mojom.FileSystemManager_Open_ParamsSpec, 'blink.mojom.FileSystemManager_Open_Params', [
      mojo.internal.StructField('arg_file_system_type', 0, 0, mojo.internal.bindings.blink.mojom.FileSystemTypeSpec, null, false, 0, undefined),
    ],
    [[0, 16]]);
