...
mojo.internal.bindings.pdf.mojom.PdfSearchifier = {};
mojo.internal.bindings.pdf.mojom.PdfSearchifierSpec = { $ : {} };
mojo.internal.bindings.pdf.mojom.PdfSearchifier.$interfaceName = 'pdf.mojom.PdfSearchifier';
...
mojo.internal.bindings.pdf.mojom.PdfSearchifierRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.pdf.mojom.PdfSearchifierPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.pdf.mojom.PdfSearchifierRemoteCallHandler(this.proxy);
  }
  ...
  searchify(arg_pdf) {
    return this.$.searchify(arg_pdf);
  }
};

mojo.internal.bindings.pdf.mojom.PdfSearchifierRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('pdf.mojom.PdfSearchifier', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.pdf.mojom.PdfSearchifier.getRemote = function() {
  let remote = new mojo.internal.bindings.pdf.mojom.PdfSearchifierRemote();
...
mojo.internal.bindings.pdf.mojom.PdfSearchifierReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('pdf.mojom.PdfSearchifier', [
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        // Try Method 0: Searchify
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.pdf.mojom.PdfSearchifier_Searchify_ParamsSpec.$.structSpec);
             console.log('[GeneratedReceiver] Discovery SUCCESS: ' + header.ordinal + ' -> Searchify (0)');
        ...
        case 0: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.pdf.mojom.PdfSearchifier_Searchify_ResponseParamsSpec, header, rawHeader);
               responder(response);
...
mojo.internal.bindings.pdf.mojom.PdfSearchifierReceiver = mojo.internal.bindings.pdf.mojom.PdfSearchifierReceiver;
