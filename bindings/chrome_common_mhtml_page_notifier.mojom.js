...
mojo.internal.bindings.blink.mojom.MHTMLLoadResultSpec = mojo.internal.bindings.blink.mojom.MHTMLLoadResultSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.mojo_base = mojo.internal.bindings.mojo_base || {};
...
mojo.internal.Struct(
    mojo.internal.bindings.offline_pages.mojom.MhtmlPageNotifier_NotifyMhtmlPageLoadAttempted_ParamsSpec, 'offline_pages.mojom.MhtmlPageNotifier_NotifyMhtmlPageLoadAttempted_Params', [
      ...
      mojo.internal.StructField('arg_date', 8, 0, mojo.internal.bindings.mojo_base.mojom.TimeSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_load_result', 16, 0, mojo.internal.bindings.blink.mojom.MHTMLLoadResultSpec, null, false, 0, undefined),
    ],
    [[0, 32]]);
...
mojo.internal.bindings.offline_pages.mojom.MhtmlPageNotifierRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.offline_pages.mojom.MhtmlPageNotifierPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.offline_pages.mojom.MhtmlPageNotifierRemoteCallHandler(this.proxy);
  }
  ...
  notifyMhtmlPageLoadAttempted(arg_load_result, arg_url, arg_date) {
    return this.$.notifyMhtmlPageLoadAttempted(arg_load_result, arg_url, arg_date);
  }
};

mojo.internal.bindings.offline_pages.mojom.MhtmlPageNotifierRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('offline_pages.mojom.MhtmlPageNotifier', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.offline_pages.mojom.MhtmlPageNotifier.getRemote = function() {
  let remote = new mojo.internal.bindings.offline_pages.mojom.MhtmlPageNotifierRemote();
...
mojo.internal.bindings.offline_pages.mojom.MhtmlPageNotifierReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('offline_pages.mojom.MhtmlPageNotifier', [
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.offline_pages.mojom.MhtmlPageNotifier_NotifyMhtmlPageLoadAttempted_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for NotifyMhtmlPageLoadAttempted failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.offline_pages.mojom.MhtmlPageNotifierReceiver = mojo.internal.bindings.offline_pages.mojom.MhtmlPageNotifierReceiver;
