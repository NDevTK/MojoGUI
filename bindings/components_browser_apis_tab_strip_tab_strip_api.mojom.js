...
mojo.internal.bindings.tabs_api.mojom.TabStripService_CloseNodes_ParamsSpec = mojo.internal.bindings.tabs_api.mojom.TabStripService_CloseNodes_ParamsSpec || { $: {} };
if (mojo.internal.bindings.tabs_api.mojom.TabStripService_CloseNodes_ParamsSpec.$.structSpec && mojo.internal.bindings.tabs_api.mojom.TabStripService_CloseNodes_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.tabs_api.mojom.TabStripService_CloseNodes_ParamsSpec.$ = {};
...
mojo.internal.bindings.tabs_api.mojom.TabStripService_Update_ParamsSpec = mojo.internal.bindings.tabs_api.mojom.TabStripService_Update_ParamsSpec || { $: {} };
if (mojo.internal.bindings.tabs_api.mojom.TabStripService_Update_ParamsSpec.$.structSpec && mojo.internal.bindings.tabs_api.mojom.TabStripService_Update_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.tabs_api.mojom.TabStripService_Update_ParamsSpec.$ = {};
...
mojo.internal.bindings.tabs_api = mojo.internal.bindings.tabs_api || {};
mojo.internal.bindings.tabs_api.mojom = mojo.internal.bindings.tabs_api.mojom || {};
mojo.internal.bindings.tabs_api.mojom.OnCollectionCreatedEventSpec = mojo.internal.bindings.tabs_api.mojom.OnCollectionCreatedEventSpec || { $: mojo.internal.OpaqueStruct.$ };
mojo.internal.bindings.tabs_api = mojo.internal.bindings.tabs_api || {};
mojo.internal.bindings.tabs_api.mojom = mojo.internal.bindings.tabs_api.mojom || {};
mojo.internal.bindings.tabs_api.mojom.OnDataChangedEventSpec = mojo.internal.bindings.tabs_api.mojom.OnDataChangedEventSpec || { $: mojo.internal.OpaqueStruct.$ };
mojo.internal.bindings.tabs_api = mojo.internal.bindings.tabs_api || {};
mojo.internal.bindings.tabs_api.mojom = mojo.internal.bindings.tabs_api.mojom || {};
mojo.internal.bindings.tabs_api.mojom.OnNodeMovedEventSpec = mojo.internal.bindings.tabs_api.mojom.OnNodeMovedEventSpec || { $: mojo.internal.OpaqueStruct.$ };
mojo.internal.bindings.tabs_api = mojo.internal.bindings.tabs_api || {};
mojo.internal.bindings.tabs_api.mojom = mojo.internal.bindings.tabs_api.mojom || {};
mojo.internal.bindings.tabs_api.mojom.OnNodesClosedEventSpec = mojo.internal.bindings.tabs_api.mojom.OnNodesClosedEventSpec || { $: mojo.internal.OpaqueStruct.$ };
mojo.internal.bindings.tabs_api = mojo.internal.bindings.tabs_api || {};
mojo.internal.bindings.tabs_api.mojom = mojo.internal.bindings.tabs_api.mojom || {};
mojo.internal.bindings.tabs_api.mojom.OnTabsCreatedEventSpec = mojo.internal.bindings.tabs_api.mojom.OnTabsCreatedEventSpec || { $: mojo.internal.OpaqueStruct.$ };
mojo.internal.bindings.tabs_api = mojo.internal.bindings.tabs_api || {};
mojo.internal.bindings.tabs_api.mojom = mojo.internal.bindings.tabs_api.mojom || {};
...
mojo.internal.bindings.tabs_api = mojo.internal.bindings.tabs_api || {};
mojo.internal.bindings.tabs_api.mojom = mojo.internal.bindings.tabs_api.mojom || {};
mojo.internal.bindings.tabs_api.mojom.TabsEventSpec = mojo.internal.bindings.tabs_api.mojom.TabsEventSpec || { $: mojo.internal.OpaqueStruct.$ };
mojo.internal.bindings.url = mojo.internal.bindings.url || {};
...
mojo.internal.bindings.tabs_api.mojom.TabStripServiceRemote = class {
  ...
  closeNodes(arg_ids) {
    return this.$.closeNodes(arg_ids);
  }
  activateTab(arg_id) {
  ...
  update(arg_data, arg_update_mask) {
    return this.$.update(arg_data, arg_update_mask);
  }
};
...
mojo.internal.bindings.tabs_api.mojom.TabStripServiceRemoteCallHandler = class {
  ...
  closeNodes(arg_ids) {
    return this.proxy.sendMessage(
      ...
      mojo.internal.bindings.tabs_api.mojom.TabStripService_CloseNodes_ParamsSpec,
      null,
      [arg_ids],
      false);
  }
  ...
  update(arg_data, arg_update_mask) {
    return this.proxy.sendMessage(
      ...
      mojo.internal.bindings.tabs_api.mojom.TabStripService_Update_ParamsSpec,
      null,
      [arg_data, arg_update_mask],
      false);
  }
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        ...
        case 3: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.tabs_api.mojom.TabStripService_CloseNodes_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.closeNodes');
          const result = this.impl.closeNodes(params.arg_ids);
          break;
        }
        case 4: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
        ...
        case 7: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.tabs_api.mojom.TabStripService_Update_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.update');
          const result = this.impl.update(params.arg_data, params.arg_update_mask);
          break;
        }
      }
      } catch (err) {
...
mojo.internal.Union(
    mojo.internal.bindings.tabs_api.mojom.TabsEventSpec, 'tabs_api.mojom.TabsEvent', {
      ...
      'arg_nodes_closed_event': {
        'ordinal': 1,
        'type': mojo.internal.bindings.tabs_api.mojom.OnNodesClosedEventSpec,
        'nullable': false,
      },
...
mojo.internal.Struct(
    mojo.internal.bindings.tabs_api.mojom.TabStripService_CloseNodes_ParamsSpec, 'tabs_api.mojom.TabStripService_CloseNodes_Params', [
      mojo.internal.StructField('arg_ids', 0, 0, mojo.internal.Array(mojo.internal.bindings.tabs_api.mojom.NodeIdSpec, false), null, false, 0, undefined),
    ],
    [[0, 16]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.tabs_api.mojom.TabStripService_Update_ParamsSpec, 'tabs_api.mojom.TabStripService_Update_Params', [
      mojo.internal.StructField('arg_data', 0, 0, mojo.internal.bindings.tabs_api.mojom.DataSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_update_mask', 16, 0, mojo.internal.Array(mojo.internal.String, false), null, true, 0, undefined),
    ],
    [[0, 32]]);
