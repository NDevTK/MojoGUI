...
mojo.internal.bindings.blink.mojom.UnhandledTapNotifierRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.blink.mojom.UnhandledTapNotifierPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.blink.mojom.UnhandledTapNotifierRemoteCallHandler(this.proxy);
  }
  ...
  showUnhandledTapUIIfNeeded(arg_unhandled_tap_info) {
    return this.$.showUnhandledTapUIIfNeeded(arg_unhandled_tap_info);
  }
};

mojo.internal.bindings.blink.mojom.UnhandledTapNotifierRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('blink.mojom.UnhandledTapNotifier', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.blink.mojom.UnhandledTapNotifier.getRemote = function() {
  let remote = new mojo.internal.bindings.blink.mojom.UnhandledTapNotifierRemote();
...
mojo.internal.bindings.blink.mojom.UnhandledTapNotifierReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('blink.mojom.UnhandledTapNotifier', [
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.blink.mojom.UnhandledTapNotifier_ShowUnhandledTapUIIfNeeded_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for ShowUnhandledTapUIIfNeeded failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.blink.mojom.UnhandledTapNotifierReceiver = mojo.internal.bindings.blink.mojom.UnhandledTapNotifierReceiver;
