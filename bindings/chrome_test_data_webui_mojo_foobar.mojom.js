...
mojo.internal.bindings.test.mojom.FooRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.test.mojom.FooPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.test.mojom.FooRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.test.mojom.Foo.getRemote = function() {
  let remote = new mojo.internal.bindings.test.mojom.FooRemote();
...
mojo.internal.bindings.test.mojom.FooReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.test.mojom.Foo_GetFoo_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for GetFoo failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.test.mojom.Foo_GetFoo_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.test.mojom.FooReceiver = mojo.internal.bindings.test.mojom.FooReceiver;

mojo.internal.bindings.test.mojom.FooPtr = mojo.internal.bindings.test.mojom.FooRemote;
mojo.internal.bindings.test.mojom.FooRequest = mojo.internal.bindings.test.mojom.FooPendingReceiver;
...
mojo.internal.bindings.test.mojom.BarRemote = class {
  static get $interfaceName() {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.test.mojom.BarPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.test.mojom.BarRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.test.mojom.Bar.getRemote = function() {
  let remote = new mojo.internal.bindings.test.mojom.BarRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
    'test.mojom.Bar',
...
mojo.internal.bindings.test.mojom.BarReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.test.mojom.Bar_GetBar_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for GetBar failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
             console.warn('[GeneratedReceiver] Failed to discover ordinal ' + header.ordinal);
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.test.mojom.Bar_GetBar_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.test.mojom.BarReceiver = mojo.internal.bindings.test.mojom.BarReceiver;

mojo.internal.bindings.test.mojom.BarPtr = mojo.internal.bindings.test.mojom.BarRemote;
mojo.internal.bindings.test.mojom.BarRequest = mojo.internal.bindings.test.mojom.BarPendingReceiver;
...
mojo.internal.bindings.test.mojom.BazRemote = class {
  static get $interfaceName() {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.test.mojom.BazPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.test.mojom.BazRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.test.mojom.Baz.getRemote = function() {
  let remote = new mojo.internal.bindings.test.mojom.BazRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
    'test.mojom.Baz',
...
mojo.internal.bindings.test.mojom.BazReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.test.mojom.Baz_GetBaz_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for GetBaz failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
             console.warn('[GeneratedReceiver] Failed to discover ordinal ' + header.ordinal);
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.test.mojom.Baz_GetBaz_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.test.mojom.BazReceiver = mojo.internal.bindings.test.mojom.BazReceiver;
