...
mojo.internal.bindings.ash.mojom.scanner_feedback_ui.PageHandlerRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.ash.mojom.scanner_feedback_ui.PageHandlerPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.ash.mojom.scanner_feedback_ui.PageHandlerRemoteCallHandler(this.proxy);
  }
  ...
  sendFeedback(arg_user_description) {
    return this.$.sendFeedback(arg_user_description);
  }
};
...
mojo.internal.bindings.ash.mojom.scanner_feedback_ui.PageHandler.getRemote = function() {
  let remote = new mojo.internal.bindings.ash.mojom.scanner_feedback_ui.PageHandlerRemote();
...
mojo.internal.bindings.ash.mojom.scanner_feedback_ui.PageHandlerReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ash.mojom.scanner_feedback_ui.PageHandler_GetFeedbackInfo_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for GetFeedbackInfo failed with TypeError');
           }
        }
        // Try Method 1: CloseDialog
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ash.mojom.scanner_feedback_ui.PageHandler_CloseDialog_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for CloseDialog failed with TypeError');
           }
        }
        // Try Method 2: SendFeedback
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ash.mojom.scanner_feedback_ui.PageHandler_SendFeedback_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for SendFeedback failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.ash.mojom.scanner_feedback_ui.PageHandler_GetFeedbackInfo_ParamsSpec.$.structSpec);
        ...
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.ash.mojom.scanner_feedback_ui.PageHandler_CloseDialog_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.ash.mojom.scanner_feedback_ui.PageHandlerReceiver = mojo.internal.bindings.ash.mojom.scanner_feedback_ui.PageHandlerReceiver;
