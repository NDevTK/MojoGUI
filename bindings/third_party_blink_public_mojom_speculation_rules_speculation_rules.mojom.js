...
mojo.internal.bindings.blink.mojom.SpeculationAction = {
  kPrefetch: 0,
...
mojo.internal.bindings.blink.mojom.SpeculationTargetHint = {
  kNoHint: 0,
  kBlank: 1,
  kSelf: 2,
};
...
mojo.internal.bindings.blink.mojom.SpeculationEagerness = {
  kConservative: 0,
  kModerate: 1,
  kImmediate: 2,
  kEager: 3,
...
mojo.internal.bindings.blink.mojom.SpeculationInjectionType = {
  kNone: 0,
  kMainWorldScript: 1,
...
mojo.internal.bindings.blink.mojom.SpeculationHostRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.blink.mojom.SpeculationHostPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.blink.mojom.SpeculationHostRemoteCallHandler(this.proxy);
  }
  ...
  updateSpeculationCandidates(arg_candidates, arg_enable_cross_origin_prerender_iframes) {
    return this.$.updateSpeculationCandidates(arg_candidates, arg_enable_cross_origin_prerender_iframes);
  }
  onLCPPredicted() {
    return this.$.onLCPPredicted();
  }
  initiatePreview(arg_url) {
    return this.$.initiatePreview(arg_url);
  }
};
...
mojo.internal.bindings.blink.mojom.SpeculationHost.getRemote = function() {
  let remote = new mojo.internal.bindings.blink.mojom.SpeculationHostRemote();
...
mojo.internal.bindings.blink.mojom.SpeculationHostReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.blink.mojom.SpeculationHost_UpdateSpeculationCandidates_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for UpdateSpeculationCandidates failed with TypeError');
           }
        }
        // Try Method 1: OnLCPPredicted
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.blink.mojom.SpeculationHost_OnLCPPredicted_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OnLCPPredicted failed with TypeError');
           }
        }
        // Try Method 2: InitiatePreview
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.blink.mojom.SpeculationHost_InitiatePreview_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for InitiatePreview failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
      ...
      switch (dispatchId) {
        ...
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.blink.mojom.SpeculationHost_OnLCPPredicted_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.blink.mojom.SpeculationHostReceiver = mojo.internal.bindings.blink.mojom.SpeculationHostReceiver;
