...
mojo.internal.Struct(
    mojo.internal.bindings.device.mojom.UsbDeviceManagerTest_GetTestDevices_ResponseParamsSpec, 'device.mojom.UsbDeviceManagerTest_GetTestDevices_ResponseParams', [
      mojo.internal.StructField('arg_devices', 0, 0, mojo.internal.Array(mojo.internal.bindings.mojo.internal.bindings.device.mojom.TestDeviceInfoSpec.$, false), null, false, 0, undefined),
    ],
    [[0, 16]]);
...
mojo.internal.bindings.device.mojom.UsbDeviceManagerTestRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.device.mojom.UsbDeviceManagerTestPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.device.mojom.UsbDeviceManagerTestRemoteCallHandler(this.proxy);
  }
  ...
  addDeviceForTesting(arg_name, arg_serial_number, arg_landing_page) {
    return this.$.addDeviceForTesting(arg_name, arg_serial_number, arg_landing_page);
  }
  removeDeviceForTesting(arg_guid) {
    return this.$.removeDeviceForTesting(arg_guid);
  }
  getTestDevices() {
...
mojo.internal.bindings.device.mojom.UsbDeviceManagerTest.getRemote = function() {
  let remote = new mojo.internal.bindings.device.mojom.UsbDeviceManagerTestRemote();
...
mojo.internal.bindings.device.mojom.UsbDeviceManagerTestReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
      ...
      switch (dispatchId) {
        case 0: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.device.mojom.UsbDeviceManagerTest_AddDeviceForTesting_ResponseParamsSpec, header, rawHeader);
               responder(response);
        ...
        case 1: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              const rawHeader = (args[2] && args[2].slice) ? args[2].slice(0, header.headerSize) : null;
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.device.mojom.UsbDeviceManagerTest_RemoveDeviceForTesting_ResponseParamsSpec, header, rawHeader);
               responder(response);
        ...
        case 2: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.device.mojom.UsbDeviceManagerTest_GetTestDevices_ParamsSpec.$.structSpec);
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              const rawHeader = (args[2] && args[2].slice) ? args[2].slice(0, header.headerSize) : null;
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.device.mojom.UsbDeviceManagerTest_GetTestDevices_ResponseParamsSpec, header, rawHeader);
               responder(response);
...
mojo.internal.bindings.device.mojom.UsbDeviceManagerTestReceiver = mojo.internal.bindings.device.mojom.UsbDeviceManagerTestReceiver;
