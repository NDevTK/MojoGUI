...
mojo.internal.bindings.network.mojom.TraitsTestService = {};
mojo.internal.bindings.network.mojom.TraitsTestServiceSpec = { $ : {} };
mojo.internal.bindings.network.mojom.TraitsTestService.$interfaceName = 'network.mojom.TraitsTestService';
...
mojo.internal.bindings.network.mojom.TraitsTestServiceRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.network.mojom.TraitsTestServicePendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.network.mojom.TraitsTestServiceRemoteCallHandler(this.proxy);
  }
  ...
  echoHttpRequestHeaders(arg_headers) {
    return this.$.echoHttpRequestHeaders(arg_headers);
  }
};

mojo.internal.bindings.network.mojom.TraitsTestServiceRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('network.mojom.TraitsTestService', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.network.mojom.TraitsTestService.getRemote = function() {
  let remote = new mojo.internal.bindings.network.mojom.TraitsTestServiceRemote();
...
mojo.internal.bindings.network.mojom.TraitsTestServiceReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('network.mojom.TraitsTestService', [
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.network.mojom.TraitsTestService_EchoHttpRequestHeaders_ParamsSpec.$.structSpec);
        ...
        case 0: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.network.mojom.TraitsTestService_EchoHttpRequestHeaders_ResponseParamsSpec, header, rawHeader);
               responder(response);
...
mojo.internal.bindings.network.mojom.TraitsTestServiceReceiver = mojo.internal.bindings.network.mojom.TraitsTestServiceReceiver;
