...
network.mojom.TraitsTestService_EchoHttpRequestHeaders_ParamsSpec = {
  $: {
    structSpec: {
      ...
      packedSize: 16,
      fields: [
        { name: 'headers', packedOffset: 0, packedBitOffset: 0, type: network.mojom.HttpRequestHeadersSpec, nullable: false },
      ],
      versions: [{version: 0}]
    }
  }
...
network.mojom.TraitsTestService_EchoHttpRequestHeaders_ResponseParamsSpec = {
  $: {
    structSpec: {
      ...
      packedSize: 16,
      fields: [
        { name: 'pass', packedOffset: 0, packedBitOffset: 0, type: network.mojom.HttpRequestHeadersSpec, nullable: false },
      ],
      versions: [{version: 0}]
    }
  }
