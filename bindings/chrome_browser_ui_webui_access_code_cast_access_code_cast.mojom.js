...
mojo.internal.bindings.media_router.mojom.RouteRequestResultCodeSpec = mojo.internal.bindings.media_router.mojom.RouteRequestResultCodeSpec || { $: mojo.internal.Enum().$ };

// Enum: AddSinkResultCode
mojo.internal.bindings.access_code_cast.mojom.AddSinkResultCode = {
  UNKNOWN_ERROR: 0,
  OK: 1,
  AUTH_ERROR: 2,
...
mojo.internal.bindings.access_code_cast.mojom.CastDiscoveryMethod = {
  QR_CODE: 0,
  INPUT_ACCESS_CODE: 1,
};
...
mojo.internal.bindings.access_code_cast.mojom.PageHandlerFactoryRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.access_code_cast.mojom.PageHandlerFactoryPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.access_code_cast.mojom.PageHandlerFactoryRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.access_code_cast.mojom.PageHandlerFactoryRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('access_code_cast.mojom.PageHandlerFactory', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.access_code_cast.mojom.PageHandlerFactory.getRemote = function() {
  let remote = new mojo.internal.bindings.access_code_cast.mojom.PageHandlerFactoryRemote();
...
mojo.internal.bindings.access_code_cast.mojom.PageHandlerFactoryReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('access_code_cast.mojom.PageHandlerFactory', [
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.access_code_cast.mojom.PageHandlerFactory_CreatePageHandler_ParamsSpec.$.structSpec;
...
mojo.internal.bindings.access_code_cast.mojom.PageHandlerFactoryReceiver = mojo.internal.bindings.access_code_cast.mojom.PageHandlerFactoryReceiver;

mojo.internal.bindings.access_code_cast.mojom.PageHandlerFactoryPtr = mojo.internal.bindings.access_code_cast.mojom.PageHandlerFactoryRemote;
mojo.internal.bindings.access_code_cast.mojom.PageHandlerFactoryRequest = mojo.internal.bindings.access_code_cast.mojom.PageHandlerFactoryPendingReceiver;
...
mojo.internal.bindings.access_code_cast.mojom.PageHandlerRemote = class {
  static get $interfaceName() {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.access_code_cast.mojom.PageHandlerPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.access_code_cast.mojom.PageHandlerRemoteCallHandler(this.proxy);
  }
  ...
  addSink(arg_access_code, arg_discovery_method) {
    return this.$.addSink(arg_access_code, arg_discovery_method);
  }
  castToSink() {
...
mojo.internal.bindings.access_code_cast.mojom.PageHandlerRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('access_code_cast.mojom.PageHandler', [
      { explicit: null },
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.access_code_cast.mojom.PageHandler.getRemote = function() {
  let remote = new mojo.internal.bindings.access_code_cast.mojom.PageHandlerRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
...
mojo.internal.bindings.access_code_cast.mojom.PageHandlerReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('access_code_cast.mojom.PageHandler', [
      { explicit: null },
      { explicit: null },
    ]);
    ordinals.forEach((ord, idx) => {
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        // Try Method 0: AddSink
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.access_code_cast.mojom.PageHandler_AddSink_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (sizeMatch && (!!(header.flags & 1) === methodExpectsResp)) {
               if (size > 8 || message.payload.byteLength === 8) {
                 decoder.decodeStructInline(structSpec);
                 console.log('[GeneratedReceiver] Discovery SUCCESS: ' + header.ordinal + ' -> AddSink (0)');
                 this.mapOrdinal(header.ordinal, 0);
                 dispatchId = 0;
               }
             }
           } catch (e) {
             if (e instanceof TypeError) console.warn('[Discovery] trial for AddSink failed with TypeError');
           }
        }
        // Try Method 1: CastToSink
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.access_code_cast.mojom.PageHandler_CastToSink_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (sizeMatch && (!!(header.flags & 1) === methodExpectsResp)) {
               if (size > 8 || message.payload.byteLength === 8) {
                 decoder.decodeStructInline(structSpec);
                 console.log('[GeneratedReceiver] Discovery SUCCESS: ' + header.ordinal + ' -> CastToSink (1)');
                 this.mapOrdinal(header.ordinal, 1);
                 dispatchId = 1;
               }
             }
           } catch (e) {
             if (e instanceof TypeError) console.warn('[Discovery] trial for CastToSink failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
             console.warn('[GeneratedReceiver] Failed to discover ordinal ' + header.ordinal);
      ...
      switch (dispatchId) {
        ...
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.access_code_cast.mojom.PageHandler_CastToSink_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.access_code_cast.mojom.PageHandlerReceiver = mojo.internal.bindings.access_code_cast.mojom.PageHandlerReceiver;

mojo.internal.bindings.access_code_cast.mojom.PageHandlerPtr = mojo.internal.bindings.access_code_cast.mojom.PageHandlerRemote;
mojo.internal.bindings.access_code_cast.mojom.PageHandlerRequest = mojo.internal.bindings.access_code_cast.mojom.PageHandlerPendingReceiver;


// Interface: Page
mojo.internal.bindings.access_code_cast.mojom.PagePendingReceiver = class {
  constructor(handle) {
    this.handle = handle;
  }
};

mojo.internal.bindings.access_code_cast.mojom.PageRemote = class {
  static get $interfaceName() {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.access_code_cast.mojom.PagePendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.access_code_cast.mojom.PageRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.access_code_cast.mojom.PageRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('access_code_cast.mojom.Page', [
    ]);
  }

};

mojo.internal.bindings.access_code_cast.mojom.Page.getRemote = function() {
  let remote = new mojo.internal.bindings.access_code_cast.mojom.PageRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
...
mojo.internal.bindings.access_code_cast.mojom.PageReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('access_code_cast.mojom.Page', [
    ]);
    ordinals.forEach((ord, idx) => {
      this.ordinalMap.set(ord, idx); // Scrambled/Explicit
    });
...
mojo.internal.bindings.access_code_cast.mojom.PageReceiver = mojo.internal.bindings.access_code_cast.mojom.PageReceiver;
