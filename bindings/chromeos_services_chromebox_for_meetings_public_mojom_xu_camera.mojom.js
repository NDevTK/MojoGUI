...
// Union: WebcamId
mojo.internal.Union(
    mojo.internal.bindings.ash.cfm.mojom.WebcamIdSpec, 'ash.cfm.mojom.WebcamId', {
      'arg_device_id': {
        'ordinal': 0,
...
mojo.internal.Struct(
    mojo.internal.bindings.ash.cfm.mojom.MenuInfoSpec, 'ash.cfm.mojom.MenuInfo', [
...
mojo.internal.Struct(
    mojo.internal.bindings.ash.cfm.mojom.ControlMappingSpec, 'ash.cfm.mojom.ControlMapping', [
      ...
      mojo.internal.StructField('arg_selector', 36, 0, mojo.internal.Uint8, 0, false, 0, undefined),
      mojo.internal.StructField('arg_size', 37, 0, mojo.internal.Uint8, 0, false, 0, undefined),
      mojo.internal.StructField('arg_offset', 38, 0, mojo.internal.Uint8, 0, false, 0, undefined),
    ],
    [[0, 48]]);

// Struct: ControlQuery
mojo.internal.Struct(
    mojo.internal.bindings.ash.cfm.mojom.ControlQuerySpec, 'ash.cfm.mojom.ControlQuery', [
      mojo.internal.StructField('arg_unit_id', 0, 0, mojo.internal.Uint8, 0, false, 0, undefined),
      mojo.internal.StructField('arg_selector', 1, 0, mojo.internal.Uint8, 0, false, 0, undefined),
    ],
    [[0, 16]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.ash.cfm.mojom.XuCamera_GetUnitId_ResponseParamsSpec, 'ash.cfm.mojom.XuCamera_GetUnitId_ResponseParams', [
      mojo.internal.StructField('arg_error_code', 0, 0, mojo.internal.Uint8, 0, false, 0, undefined),
      mojo.internal.StructField('arg_unit_id', 1, 0, mojo.internal.Uint8, 0, false, 0, undefined),
    ],
    [[0, 16]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.ash.cfm.mojom.XuCamera_GetCtrl_ResponseParamsSpec, 'ash.cfm.mojom.XuCamera_GetCtrl_ResponseParams', [
      ...
      mojo.internal.StructField('arg_error_code', 8, 0, mojo.internal.Uint8, 0, false, 0, undefined),
    ],
    [[0, 24]]);
...
mojo.internal.bindings.ash.cfm.mojom.XuCameraPendingReceiver = class {
  constructor(handle) {
    this.handle = handle;
  }
};

mojo.internal.bindings.ash.cfm.mojom.XuCameraRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.ash.cfm.mojom.XuCameraPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.ash.cfm.mojom.XuCameraRemoteCallHandler(this.proxy);
  }
  ...
  getUnitId(arg_id, arg_guid) {
    return this.$.getUnitId(arg_id, arg_guid);
  }
  mapCtrl(arg_id, arg_mapping_ctrl) {
    return this.$.mapCtrl(arg_id, arg_mapping_ctrl);
  }
  getCtrl(arg_id, arg_ctrl, arg_fn) {
    return this.$.getCtrl(arg_id, arg_ctrl, arg_fn);
  }
  setCtrl(arg_id, arg_ctrl, arg_data) {
    return this.$.setCtrl(arg_id, arg_ctrl, arg_data);
  }
};
...
mojo.internal.bindings.ash.cfm.mojom.XuCamera.getRemote = function() {
  let remote = new mojo.internal.bindings.ash.cfm.mojom.XuCameraRemote();
...
mojo.internal.bindings.ash.cfm.mojom.XuCameraReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ash.cfm.mojom.XuCamera_GetUnitId_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for GetUnitId failed with TypeError');
           }
        }
        // Try Method 1: MapCtrl
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ash.cfm.mojom.XuCamera_MapCtrl_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for MapCtrl failed with TypeError');
           }
        }
        // Try Method 2: GetCtrl
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ash.cfm.mojom.XuCamera_GetCtrl_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for GetCtrl failed with TypeError');
           }
        }
        // Try Method 3: SetCtrl
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ash.cfm.mojom.XuCamera_SetCtrl_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for SetCtrl failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.ash.cfm.mojom.XuCameraReceiver = mojo.internal.bindings.ash.cfm.mojom.XuCameraReceiver;

mojo.internal.bindings.ash.cfm.mojom.XuCameraPtr = mojo.internal.bindings.ash.cfm.mojom.XuCameraRemote;
mojo.internal.bindings.ash.cfm.mojom.XuCameraRequest = mojo.internal.bindings.ash.cfm.mojom.XuCameraPendingReceiver;
