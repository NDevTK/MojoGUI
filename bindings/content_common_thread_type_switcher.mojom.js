...
mojo.internal.bindings.content.mojom.ThreadTypeSwitcher = {};
mojo.internal.bindings.content.mojom.ThreadTypeSwitcherSpec = { $ : {} };
mojo.internal.bindings.content.mojom.ThreadTypeSwitcher.$interfaceName = 'content.mojom.ThreadTypeSwitcher';
...
mojo.internal.bindings.content.mojom.ThreadTypeSwitcherRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.content.mojom.ThreadTypeSwitcherPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.content.mojom.ThreadTypeSwitcherRemoteCallHandler(this.proxy);
  }
  ...
  setThreadType(arg_platform_thread_id, arg_thread_type) {
    return this.$.setThreadType(arg_platform_thread_id, arg_thread_type);
  }
};

mojo.internal.bindings.content.mojom.ThreadTypeSwitcherRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('content.mojom.ThreadTypeSwitcher', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.content.mojom.ThreadTypeSwitcher.getRemote = function() {
  let remote = new mojo.internal.bindings.content.mojom.ThreadTypeSwitcherRemote();
...
mojo.internal.bindings.content.mojom.ThreadTypeSwitcherReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('content.mojom.ThreadTypeSwitcher', [
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        // Try Method 0: SetThreadType
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.content.mojom.ThreadTypeSwitcher_SetThreadType_ParamsSpec.$.structSpec;
             ...
             if (sizeMatch && (!!(header.flags & 1) === methodExpectsResp)) {
               if (size > 8 || message.payload.byteLength === 8) {
                 ...
                 console.log('[GeneratedReceiver] Discovery SUCCESS: ' + header.ordinal + ' -> SetThreadType (0)');
                 this.mapOrdinal(header.ordinal, 0);
                 dispatchId = 0;
               }
             }
           } catch (e) {
             if (e instanceof TypeError) console.warn('[Discovery] trial for SetThreadType failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.content.mojom.ThreadTypeSwitcherReceiver = mojo.internal.bindings.content.mojom.ThreadTypeSwitcherReceiver;
