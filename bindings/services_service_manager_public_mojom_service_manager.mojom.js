...
mojo.internal.bindings.service_manager.mojom.ServiceManagerListenerRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.service_manager.mojom.ServiceManagerListenerPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.service_manager.mojom.ServiceManagerListenerRemoteCallHandler(this.proxy);
  }
  ...
  onInit(arg_running_services) {
    return this.$.onInit(arg_running_services);
  }
  onServiceCreated(arg_service) {
    return this.$.onServiceCreated(arg_service);
  }
  onServiceStarted(arg_identity, arg_pid_deprecated) {
    return this.$.onServiceStarted(arg_identity, arg_pid_deprecated);
  }
  onServicePIDReceived(arg_identity, arg_pid) {
    return this.$.onServicePIDReceived(arg_identity, arg_pid);
  }
  onServiceFailedToStart(arg_identity) {
    return this.$.onServiceFailedToStart(arg_identity);
  }
  onServiceStopped(arg_identity) {
    return this.$.onServiceStopped(arg_identity);
  }
};

mojo.internal.bindings.service_manager.mojom.ServiceManagerListenerRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('service_manager.mojom.ServiceManagerListener', [
      { explicit: null },
      { explicit: null },
      { explicit: null },
      { explicit: null },
...
mojo.internal.bindings.service_manager.mojom.ServiceManagerListener.getRemote = function() {
  let remote = new mojo.internal.bindings.service_manager.mojom.ServiceManagerListenerRemote();
...
mojo.internal.bindings.service_manager.mojom.ServiceManagerListenerReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('service_manager.mojom.ServiceManagerListener', [
      { explicit: null },
      { explicit: null },
      { explicit: null },
      { explicit: null },
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.service_manager.mojom.ServiceManagerListener_OnInit_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OnInit failed with TypeError');
           }
        }
        // Try Method 1: OnServiceCreated
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.service_manager.mojom.ServiceManagerListener_OnServiceCreated_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OnServiceCreated failed with TypeError');
           }
        }
        // Try Method 2: OnServiceStarted
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.service_manager.mojom.ServiceManagerListener_OnServiceStarted_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OnServiceStarted failed with TypeError');
           }
        }
        // Try Method 3: OnServicePIDReceived
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.service_manager.mojom.ServiceManagerListener_OnServicePIDReceived_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OnServicePIDReceived failed with TypeError');
           }
        }
        // Try Method 4: OnServiceFailedToStart
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.service_manager.mojom.ServiceManagerListener_OnServiceFailedToStart_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OnServiceFailedToStart failed with TypeError');
           }
        }
        // Try Method 5: OnServiceStopped
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.service_manager.mojom.ServiceManagerListener_OnServiceStopped_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OnServiceStopped failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.service_manager.mojom.ServiceManagerListenerReceiver = mojo.internal.bindings.service_manager.mojom.ServiceManagerListenerReceiver;

mojo.internal.bindings.service_manager.mojom.ServiceManagerListenerPtr = mojo.internal.bindings.service_manager.mojom.ServiceManagerListenerRemote;
mojo.internal.bindings.service_manager.mojom.ServiceManagerListenerRequest = mojo.internal.bindings.service_manager.mojom.ServiceManagerListenerPendingReceiver;
...
mojo.internal.bindings.service_manager.mojom.ServiceManagerRemote = class {
  static get $interfaceName() {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.service_manager.mojom.ServiceManagerPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.service_manager.mojom.ServiceManagerRemoteCallHandler(this.proxy);
  }
  ...
  addListener(arg_listener) {
    return this.$.addListener(arg_listener);
  }
};

mojo.internal.bindings.service_manager.mojom.ServiceManagerRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('service_manager.mojom.ServiceManager', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.service_manager.mojom.ServiceManager.getRemote = function() {
  let remote = new mojo.internal.bindings.service_manager.mojom.ServiceManagerRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
...
mojo.internal.bindings.service_manager.mojom.ServiceManagerReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('service_manager.mojom.ServiceManager', [
      { explicit: null },
    ]);
    ordinals.forEach((ord, idx) => {
      this.ordinalMap.set(ord, idx); // Scrambled/Explicit
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.service_manager.mojom.ServiceManager_AddListener_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for AddListener failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
             console.warn('[GeneratedReceiver] Failed to discover ordinal ' + header.ordinal);
...
mojo.internal.bindings.service_manager.mojom.ServiceManagerReceiver = mojo.internal.bindings.service_manager.mojom.ServiceManagerReceiver;
