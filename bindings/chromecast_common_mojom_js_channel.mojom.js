...
mojo.internal.bindings.chromecast.mojom.JsChannelRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.chromecast.mojom.JsChannelPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.chromecast.mojom.JsChannelRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.chromecast.mojom.JsChannel.getRemote = function() {
  let remote = new mojo.internal.bindings.chromecast.mojom.JsChannelRemote();
...
mojo.internal.bindings.chromecast.mojom.JsChannelReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.chromecast.mojom.JsChannel_PostMessage_ParamsSpec.$.structSpec;
...
mojo.internal.bindings.chromecast.mojom.JsChannelReceiver = mojo.internal.bindings.chromecast.mojom.JsChannelReceiver;

mojo.internal.bindings.chromecast.mojom.JsChannelPtr = mojo.internal.bindings.chromecast.mojom.JsChannelRemote;
mojo.internal.bindings.chromecast.mojom.JsChannelRequest = mojo.internal.bindings.chromecast.mojom.JsChannelPendingReceiver;
...
mojo.internal.bindings.chromecast.mojom.JsChannelClientRemote = class {
  static get $interfaceName() {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.chromecast.mojom.JsChannelClientPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.chromecast.mojom.JsChannelClientRemoteCallHandler(this.proxy);
  }
  ...
  createChannel(arg_channel, arg_pipe) {
    return this.$.createChannel(arg_channel, arg_pipe);
  }
  removeChannel(arg_channel) {
    return this.$.removeChannel(arg_channel);
  }
};
...
mojo.internal.bindings.chromecast.mojom.JsChannelClient.getRemote = function() {
  let remote = new mojo.internal.bindings.chromecast.mojom.JsChannelClientRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
...
mojo.internal.bindings.chromecast.mojom.JsChannelClientReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.chromecast.mojom.JsChannelClient_CreateChannel_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for CreateChannel failed with TypeError');
           }
        }
        // Try Method 1: RemoveChannel
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.chromecast.mojom.JsChannelClient_RemoveChannel_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for RemoveChannel failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
             console.warn('[GeneratedReceiver] Failed to discover ordinal ' + header.ordinal);
...
mojo.internal.bindings.chromecast.mojom.JsChannelClientReceiver = mojo.internal.bindings.chromecast.mojom.JsChannelClientReceiver;

mojo.internal.bindings.chromecast.mojom.JsChannelClientPtr = mojo.internal.bindings.chromecast.mojom.JsChannelClientRemote;
mojo.internal.bindings.chromecast.mojom.JsChannelClientRequest = mojo.internal.bindings.chromecast.mojom.JsChannelClientPendingReceiver;
...
mojo.internal.bindings.chromecast.mojom.JsChannelBindingProviderRemote = class {
  static get $interfaceName() {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.chromecast.mojom.JsChannelBindingProviderPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.chromecast.mojom.JsChannelBindingProviderRemoteCallHandler(this.proxy);
  }
  ...
  register(arg_routing_id, arg_client) {
    return this.$.register(arg_routing_id, arg_client);
  }
};
...
mojo.internal.bindings.chromecast.mojom.JsChannelBindingProvider.getRemote = function() {
  let remote = new mojo.internal.bindings.chromecast.mojom.JsChannelBindingProviderRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
...
mojo.internal.bindings.chromecast.mojom.JsChannelBindingProviderReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.chromecast.mojom.JsChannelBindingProvider_Register_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
...
mojo.internal.bindings.chromecast.mojom.JsChannelBindingProviderReceiver = mojo.internal.bindings.chromecast.mojom.JsChannelBindingProviderReceiver;
