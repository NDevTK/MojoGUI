...
mojo.internal.bindings.arc.mojom.MediaSessionInstance = {};
mojo.internal.bindings.arc.mojom.MediaSessionInstanceSpec = { $ : {} };
mojo.internal.bindings.arc.mojom.MediaSessionInstance.$interfaceName = 'arc.mojom.MediaSessionInstance';
...
mojo.internal.bindings.arc.mojom.MediaSessionInstanceRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.arc.mojom.MediaSessionInstanceRemoteCallHandler(this.proxy);
  }
  ...
  enableAudioFocus(arg_service) {
    return this.$.enableAudioFocus(arg_service);
  }
  disableAudioFocus() {
...
mojo.internal.bindings.arc.mojom.MediaSessionInstanceRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('arc.mojom.MediaSessionInstance', [
      { explicit: 1 },
      { explicit: 2 },
    ]);
  }
...
mojo.internal.bindings.arc.mojom.MediaSessionInstance.getRemote = function() {
  let remote = new mojo.internal.bindings.arc.mojom.MediaSessionInstanceRemote();
...
mojo.internal.bindings.arc.mojom.MediaSessionInstanceReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('arc.mojom.MediaSessionInstance', [
      { explicit: 1 },
      { explicit: 2 },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.arc.mojom.MediaSessionInstance_EnableAudioFocus_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for EnableAudioFocus failed with TypeError');
           }
        }
        // Try Method 1: DisableAudioFocus
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.arc.mojom.MediaSessionInstance_DisableAudioFocus_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for DisableAudioFocus failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
      ...
      switch (dispatchId) {
        ...
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.arc.mojom.MediaSessionInstance_DisableAudioFocus_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.arc.mojom.MediaSessionInstanceReceiver = mojo.internal.bindings.arc.mojom.MediaSessionInstanceReceiver;
