...
mojo.internal.bindings.chromeos.cfm.mojom.CfmBrowserRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.chromeos.cfm.mojom.CfmBrowserPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.chromeos.cfm.mojom.CfmBrowserRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.chromeos.cfm.mojom.CfmBrowser.getRemote = function() {
  let remote = new mojo.internal.bindings.chromeos.cfm.mojom.CfmBrowserRemote();
...
mojo.internal.bindings.chromeos.cfm.mojom.CfmBrowserReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.chromeos.cfm.mojom.CfmBrowser_GetVariationsData_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for GetVariationsData failed with TypeError');
           }
        }
        // Try Method 1: GetMemoryDetails
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.chromeos.cfm.mojom.CfmBrowser_GetMemoryDetails_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for GetMemoryDetails failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.chromeos.cfm.mojom.CfmBrowser_GetVariationsData_ParamsSpec.$.structSpec);
        ...
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.chromeos.cfm.mojom.CfmBrowser_GetMemoryDetails_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.chromeos.cfm.mojom.CfmBrowserReceiver = mojo.internal.bindings.chromeos.cfm.mojom.CfmBrowserReceiver;
