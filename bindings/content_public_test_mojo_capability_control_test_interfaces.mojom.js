        ...
        case 0: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, content.mojom.TestInterfaceForDefer_Ping_ResponseParamsSpec, header, rawHeader);
               responder(response);
