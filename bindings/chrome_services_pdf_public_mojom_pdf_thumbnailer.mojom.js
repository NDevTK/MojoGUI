...
mojo.internal.bindings.pdf.mojom.kMaxWidthPixels = 512;
...
mojo.internal.bindings.pdf.mojom.PdfThumbnailerRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.pdf.mojom.PdfThumbnailerPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.pdf.mojom.PdfThumbnailerRemoteCallHandler(this.proxy);
  }
  ...
  getThumbnail(arg_params, arg_pdf_region) {
    return this.$.getThumbnail(arg_params, arg_pdf_region);
  }
...
mojo.internal.bindings.pdf.mojom.PdfThumbnailer.getRemote = function() {
  let remote = new mojo.internal.bindings.pdf.mojom.PdfThumbnailerRemote();
...
mojo.internal.bindings.pdf.mojom.PdfThumbnailerReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.pdf.mojom.PdfThumbnailer_GetThumbnail_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for GetThumbnail failed with TypeError');
           }
        }
        // Try Method 1: SetUseSkiaRendererPolicy
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.pdf.mojom.PdfThumbnailer_SetUseSkiaRendererPolicy_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
...
mojo.internal.bindings.pdf.mojom.PdfThumbnailerReceiver = mojo.internal.bindings.pdf.mojom.PdfThumbnailerReceiver;
