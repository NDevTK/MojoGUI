  ...
  $: {
    structSpec: {
      ...
      fields: [
        ...
        { name: 'physical_layout', packedOffset: 16, packedBitOffset: 0, type: ash.diagnostics.mojom.PhysicalLayoutSpec, nullable: false, minVersion: 0 },
        { name: 'mechanical_layout', packedOffset: 20, packedBitOffset: 0, type: ash.diagnostics.mojom.MechanicalLayoutSpec, nullable: false, minVersion: 0 },
        { name: 'region_code', packedOffset: 24, packedBitOffset: 0, type: mojo.internal.String, nullable: true, minVersion: 0 },
        { name: 'number_pad_present', packedOffset: 32, packedBitOffset: 0, type: ash.diagnostics.mojom.NumberPadPresenceSpec, nullable: false, minVersion: 0 },
        { name: 'top_row_keys', packedOffset: 40, packedBitOffset: 0, type: mojo.internal.Array(ash.diagnostics.mojom.TopRowKeySpec, false), nullable: false, minVersion: 0 },
        { name: 'top_right_key', packedOffset: 36, packedBitOffset: 0, type: ash.diagnostics.mojom.TopRightKeySpec, nullable: false, minVersion: 0 },
