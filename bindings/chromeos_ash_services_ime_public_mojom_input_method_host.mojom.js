...
ash.ime.mojom.InputMethodHostPtr = class {
  ...
  0(text, cursor_behavior) {
    // Method: 0
    // Call: 0(text, cursor_behavior)
  }
  ...
  12(text, spans, new_cursor_position) {
    // Method: 12
    // Call: 12(text, spans, new_cursor_position)
  }

  2(start_index, end_index) {
    // Method: 2
    // Call: 2(start_index, end_index)
  }
  ...
  4(num_before_cursor, num_after_cursor) {
    // Method: 4
    // Call: 4(num_before_cursor, num_after_cursor)
  }

  16(num_before_cursor, num_after_cursor, text) {
    // Method: 16
    // Call: 16(num_before_cursor, num_after_cursor, text)
  }

  5(autocorrect_span) {
    // Method: 5
    // Call: 5(autocorrect_span)
  }

  6(suggestions, context) {
    // Method: 6
    // Call: 6(suggestions, context)
  }
