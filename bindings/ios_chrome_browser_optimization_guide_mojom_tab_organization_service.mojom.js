...
mojo.internal.bindings.ai.mojom.TabOrganizationService = {};
mojo.internal.bindings.ai.mojom.TabOrganizationServiceSpec = { $ : {} };
mojo.internal.bindings.ai.mojom.TabOrganizationService.$interfaceName = 'ai.mojom.TabOrganizationService';
...
mojo.internal.bindings.ai.mojom.TabOrganizationServiceRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.ai.mojom.TabOrganizationServicePendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.ai.mojom.TabOrganizationServiceRemoteCallHandler(this.proxy);
  }
  ...
  executeGroupTabs(arg_request) {
    return this.$.executeGroupTabs(arg_request);
  }
};

mojo.internal.bindings.ai.mojom.TabOrganizationServiceRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('ai.mojom.TabOrganizationService', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.ai.mojom.TabOrganizationService.getRemote = function() {
  let remote = new mojo.internal.bindings.ai.mojom.TabOrganizationServiceRemote();
...
mojo.internal.bindings.ai.mojom.TabOrganizationServiceReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('ai.mojom.TabOrganizationService', [
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.ai.mojom.TabOrganizationService_ExecuteGroupTabs_ParamsSpec.$.structSpec);
        ...
        case 0: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.ai.mojom.TabOrganizationService_ExecuteGroupTabs_ResponseParamsSpec, header, rawHeader);
               responder(response);
...
mojo.internal.bindings.ai.mojom.TabOrganizationServiceReceiver = mojo.internal.bindings.ai.mojom.TabOrganizationServiceReceiver;
