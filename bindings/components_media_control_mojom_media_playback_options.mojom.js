...
mojo.internal.bindings.components.media_control.mojom.MediaPlaybackOptionsRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.components.media_control.mojom.MediaPlaybackOptionsPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.components.media_control.mojom.MediaPlaybackOptionsRemoteCallHandler(this.proxy);
  }
  ...
  setMediaLoadingBlocked(arg_blocked) {
    return this.$.setMediaLoadingBlocked(arg_blocked);
  }
  setBackgroundVideoPlaybackEnabled(arg_enabled) {
    return this.$.setBackgroundVideoPlaybackEnabled(arg_enabled);
  }
  setRendererType(arg_type) {
    return this.$.setRendererType(arg_type);
  }
};
...
mojo.internal.bindings.components.media_control.mojom.MediaPlaybackOptions.getRemote = function() {
  let remote = new mojo.internal.bindings.components.media_control.mojom.MediaPlaybackOptionsRemote();
...
mojo.internal.bindings.components.media_control.mojom.MediaPlaybackOptionsReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.components.media_control.mojom.MediaPlaybackOptions_SetMediaLoadingBlocked_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for SetMediaLoadingBlocked failed with TypeError');
           }
        }
        // Try Method 1: SetBackgroundVideoPlaybackEnabled
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.components.media_control.mojom.MediaPlaybackOptions_SetBackgroundVideoPlaybackEnabled_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for SetBackgroundVideoPlaybackEnabled failed with TypeError');
           }
        }
        // Try Method 2: SetRendererType
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.components.media_control.mojom.MediaPlaybackOptions_SetRendererType_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for SetRendererType failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.components.media_control.mojom.MediaPlaybackOptionsReceiver = mojo.internal.bindings.components.media_control.mojom.MediaPlaybackOptionsReceiver;
