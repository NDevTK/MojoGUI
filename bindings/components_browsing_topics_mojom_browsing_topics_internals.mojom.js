  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.browsing_topics.mojom.PageHandler_GetBrowsingTopicsConfiguration_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for GetBrowsingTopicsConfiguration failed with TypeError');
           }
        }
        // Try Method 1: GetBrowsingTopicsState
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.browsing_topics.mojom.PageHandler_GetBrowsingTopicsState_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for GetBrowsingTopicsState failed with TypeError');
           }
        }
        // Try Method 2: GetModelInfo
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.browsing_topics.mojom.PageHandler_GetModelInfo_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for GetModelInfo failed with TypeError');
           }
        }
        // Try Method 3: ClassifyHosts
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.browsing_topics.mojom.PageHandler_ClassifyHosts_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for ClassifyHosts failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
