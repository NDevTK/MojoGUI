...
mojo.internal.bindings.chromecast.mojom.FeatureUpdateObserverRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.chromecast.mojom.FeatureUpdateObserverPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.chromecast.mojom.FeatureUpdateObserverRemoteCallHandler(this.proxy);
  }
  ...
  onFeaturesUpdated(arg_features) {
    return this.$.onFeaturesUpdated(arg_features);
  }
};
...
mojo.internal.bindings.chromecast.mojom.FeatureUpdateObserver.getRemote = function() {
  let remote = new mojo.internal.bindings.chromecast.mojom.FeatureUpdateObserverRemote();
...
mojo.internal.bindings.chromecast.mojom.FeatureUpdateObserverReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.chromecast.mojom.FeatureUpdateObserver_OnFeaturesUpdated_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OnFeaturesUpdated failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.chromecast.mojom.FeatureUpdateObserverReceiver = mojo.internal.bindings.chromecast.mojom.FeatureUpdateObserverReceiver;

mojo.internal.bindings.chromecast.mojom.FeatureUpdateObserverPtr = mojo.internal.bindings.chromecast.mojom.FeatureUpdateObserverRemote;
mojo.internal.bindings.chromecast.mojom.FeatureUpdateObserverRequest = mojo.internal.bindings.chromecast.mojom.FeatureUpdateObserverPendingReceiver;
...
mojo.internal.bindings.chromecast.mojom.FeatureUpdateServiceRemote = class {
  static get $interfaceName() {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.chromecast.mojom.FeatureUpdateServicePendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.chromecast.mojom.FeatureUpdateServiceRemoteCallHandler(this.proxy);
  }
  ...
  registerFeatureUpdateObserver(arg_observer) {
    return this.$.registerFeatureUpdateObserver(arg_observer);
  }
};
...
mojo.internal.bindings.chromecast.mojom.FeatureUpdateService.getRemote = function() {
  let remote = new mojo.internal.bindings.chromecast.mojom.FeatureUpdateServiceRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
...
mojo.internal.bindings.chromecast.mojom.FeatureUpdateServiceReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.chromecast.mojom.FeatureUpdateService_RegisterFeatureUpdateObserver_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for RegisterFeatureUpdateObserver failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
             console.warn('[GeneratedReceiver] Failed to discover ordinal ' + header.ordinal);
...
mojo.internal.bindings.chromecast.mojom.FeatureUpdateServiceReceiver = mojo.internal.bindings.chromecast.mojom.FeatureUpdateServiceReceiver;
