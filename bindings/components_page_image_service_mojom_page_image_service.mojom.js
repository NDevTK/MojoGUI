...
// Enum: ClientId
mojo.internal.bindings.page_image_service.mojom.ClientId = {
  Journeys: 0,
  JourneysSidePanel: 1,
  NtpRealbox: 2,
  NtpQuests: 3,
...
mojo.internal.Struct(
    mojo.internal.bindings.page_image_service.mojom.PageImageServiceHandler_GetPageImageUrl_ParamsSpec, 'page_image_service.mojom.PageImageServiceHandler_GetPageImageUrl_Params', [
      ...
      mojo.internal.StructField('arg_options', 8, 0, mojo.internal.bindings.page_image_service.mojom.OptionsSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_client_id', 16, 0, mojo.internal.bindings.page_image_service.mojom.ClientIdSpec, null, false, 0, undefined),
    ],
    [[0, 32]]);
...
mojo.internal.bindings.page_image_service.mojom.PageImageServiceHandlerRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.page_image_service.mojom.PageImageServiceHandlerPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.page_image_service.mojom.PageImageServiceHandlerRemoteCallHandler(this.proxy);
  }
  ...
  getPageImageUrl(arg_client_id, arg_page_url, arg_options) {
    return this.$.getPageImageUrl(arg_client_id, arg_page_url, arg_options);
  }
};
...
mojo.internal.bindings.page_image_service.mojom.PageImageServiceHandler.getRemote = function() {
  let remote = new mojo.internal.bindings.page_image_service.mojom.PageImageServiceHandlerRemote();
...
mojo.internal.bindings.page_image_service.mojom.PageImageServiceHandlerReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.page_image_service.mojom.PageImageServiceHandler_GetPageImageUrl_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for GetPageImageUrl failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.page_image_service.mojom.PageImageServiceHandlerReceiver = mojo.internal.bindings.page_image_service.mojom.PageImageServiceHandlerReceiver;
