...
mojo.internal.bindings.ash.cfm.mojom.MeetBrowserRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.ash.cfm.mojom.MeetBrowserPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.ash.cfm.mojom.MeetBrowserRemoteCallHandler(this.proxy);
  }
  ...
  translateVideoDeviceId(arg_hashed_device_id) {
    return this.$.translateVideoDeviceId(arg_hashed_device_id);
  }
};

mojo.internal.bindings.ash.cfm.mojom.MeetBrowserRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('ash.cfm.mojom.MeetBrowser', [
      { explicit: 0 },
    ]);
  }
...
mojo.internal.bindings.ash.cfm.mojom.MeetBrowser.getRemote = function() {
  let remote = new mojo.internal.bindings.ash.cfm.mojom.MeetBrowserRemote();
...
mojo.internal.bindings.ash.cfm.mojom.MeetBrowserReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('ash.cfm.mojom.MeetBrowser', [
      { explicit: 0 },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.ash.cfm.mojom.MeetBrowser_TranslateVideoDeviceId_ParamsSpec.$.structSpec);
        ...
        case 0: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.ash.cfm.mojom.MeetBrowser_TranslateVideoDeviceId_ResponseParamsSpec, header, rawHeader);
               responder(response);
...
mojo.internal.bindings.ash.cfm.mojom.MeetBrowserReceiver = mojo.internal.bindings.ash.cfm.mojom.MeetBrowserReceiver;
