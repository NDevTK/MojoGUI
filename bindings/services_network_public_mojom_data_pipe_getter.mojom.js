...
mojo.internal.bindings.network.mojom.DataPipeGetterRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.network.mojom.DataPipeGetterPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.network.mojom.DataPipeGetterRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.network.mojom.DataPipeGetter.getRemote = function() {
  let remote = new mojo.internal.bindings.network.mojom.DataPipeGetterRemote();
...
mojo.internal.bindings.network.mojom.DataPipeGetterReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.network.mojom.DataPipeGetter_Read_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for Read failed with TypeError');
           }
        }
        // Try Method 1: Clone
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.network.mojom.DataPipeGetter_Clone_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
...
mojo.internal.bindings.network.mojom.DataPipeGetterReceiver = mojo.internal.bindings.network.mojom.DataPipeGetterReceiver;
