...
mojo.internal.bindings.chrome.mojom.NetErrorPageSupportRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.chrome.mojom.NetErrorPageSupportPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.chrome.mojom.NetErrorPageSupportRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.chrome.mojom.NetErrorPageSupport.getRemote = function() {
  let remote = new mojo.internal.bindings.chrome.mojom.NetErrorPageSupportRemote();
...
mojo.internal.bindings.chrome.mojom.NetErrorPageSupportReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.chrome.mojom.NetErrorPageSupport_DownloadPageLater_ParamsSpec.$.structSpec);
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.chrome.mojom.NetErrorPageSupport_SetIsShowingDownloadButtonInErrorPage_ParamsSpec.$.structSpec);
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.chrome.mojom.NetErrorPageSupport_ShowPortalSignin_ParamsSpec.$.structSpec);
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.chrome.mojom.NetErrorPageSupport_DownloadPageLater_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.chrome.mojom.NetErrorPageSupportReceiver = mojo.internal.bindings.chrome.mojom.NetErrorPageSupportReceiver;
