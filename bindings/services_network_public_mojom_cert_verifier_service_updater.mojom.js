...
mojo.internal.bindings.cert_verifier.mojom.CIDRSpec = { $: {} };
mojo.internal.bindings.cert_verifier.mojom.CertWithConstraintsSpec = { $: {} };
mojo.internal.bindings.cert_verifier.mojom.AdditionalCertificatesSpec = { $: {} };
mojo.internal.bindings.cert_verifier.mojom.CertVerifierServiceUpdater = {};
mojo.internal.bindings.cert_verifier.mojom.CertVerifierServiceUpdater.$interfaceName = 'cert_verifier.mojom.CertVerifierServiceUpdater';
...
mojo.internal.Struct(
    mojo.internal.bindings.cert_verifier.mojom.CertWithConstraintsSpec, 'cert_verifier.mojom.CertWithConstraints', [
      ...
      mojo.internal.StructField('arg_permitted_cidrs', 16, 0, mojo.internal.Array(mojo.internal.bindings.mojo.internal.bindings.cert_verifier.mojom.CIDRSpec.$, false), null, false, 0, undefined),
    ],
    [[0, 32]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.cert_verifier.mojom.AdditionalCertificatesSpec, 'cert_verifier.mojom.AdditionalCertificates', [
      ...
      mojo.internal.StructField('arg_trust_anchors_with_additional_constraints', 24, 0, mojo.internal.Array(mojo.internal.bindings.mojo.internal.bindings.cert_verifier.mojom.CertWithConstraintsSpec.$, false), null, false, 0, undefined),
      mojo.internal.StructField('arg_trust_anchors_and_leafs', 32, 0, mojo.internal.Array(mojo.internal.bindings.mojo.internal.bindings.cert_verifier.mojom.CertWithConstraintsSpec.$, false), null, false, 0, undefined),
      mojo.internal.StructField('arg_trust_leafs', 40, 0, mojo.internal.Array(mojo.internal.bindings.mojo.internal.bindings.cert_verifier.mojom.CertWithConstraintsSpec.$, false), null, false, 0, undefined),
...
mojo.internal.Struct(
    mojo.internal.bindings.cert_verifier.mojom.CertVerifierServiceUpdater_UpdateAdditionalCertificates_ParamsSpec, 'cert_verifier.mojom.CertVerifierServiceUpdater_UpdateAdditionalCertificates_Params', [
      mojo.internal.StructField('arg_certificates', 0, 0, mojo.internal.bindings.mojo.internal.bindings.cert_verifier.mojom.AdditionalCertificatesSpec.$, null, false, 0, undefined),
    ],
    [[0, 16]]);
...
mojo.internal.bindings.cert_verifier.mojom.CertVerifierServiceUpdaterRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.cert_verifier.mojom.CertVerifierServiceUpdaterPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.cert_verifier.mojom.CertVerifierServiceUpdaterRemoteCallHandler(this.proxy);
  }
  ...
  updateAdditionalCertificates(arg_certificates) {
    return this.$.updateAdditionalCertificates(arg_certificates);
  }
...
mojo.internal.bindings.cert_verifier.mojom.CertVerifierServiceUpdater.getRemote = function() {
  let remote = new mojo.internal.bindings.cert_verifier.mojom.CertVerifierServiceUpdaterRemote();
...
mojo.internal.bindings.cert_verifier.mojom.CertVerifierServiceUpdaterReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.cert_verifier.mojom.CertVerifierServiceUpdater_UpdateAdditionalCertificates_ParamsSpec);
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.cert_verifier.mojom.CertVerifierServiceUpdater_WaitUntilNextUpdateForTesting_ParamsSpec);
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.cert_verifier.mojom.CertVerifierServiceUpdater_SetCTPolicy_ParamsSpec);
      ...
      switch (dispatchId) {
        ...
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.cert_verifier.mojom.CertVerifierServiceUpdater_WaitUntilNextUpdateForTesting_ParamsSpec.$.structSpec);
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.cert_verifier.mojom.CertVerifierServiceUpdater_WaitUntilNextUpdateForTesting_ResponseParamsSpec, header, rawHeader);
               responder(response);
...
mojo.internal.bindings.cert_verifier.mojom.CertVerifierServiceUpdaterReceiver = mojo.internal.bindings.cert_verifier.mojom.CertVerifierServiceUpdaterReceiver;
