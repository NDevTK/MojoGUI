  ...
  $: {
    structSpec: {
      ...
      fields: [
        ...
        { name: 'response_body', packedOffset: 16, packedBitOffset: 0, type: mojo.internal.Pointer, nullable: false },
        { name: 'url_loader_client_endpoints', packedOffset: 24, packedBitOffset: 0, type: network.mojom.URLLoaderClientEndpointsSpec, nullable: true },
        { name: 'redirect_infos', packedOffset: 32, packedBitOffset: 0, type: mojo.internal.Array, nullable: false },
        { name: 'redirect_response_heads', packedOffset: 40, packedBitOffset: 0, type: mojo.internal.Array, nullable: false },
      ],
      versions: [{version: 0}]
    }
  }
