...
mojo.internal.bindings.arc.mojom.BootPhaseMonitorHostRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.arc.mojom.BootPhaseMonitorHostPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.arc.mojom.BootPhaseMonitorHostRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.arc.mojom.BootPhaseMonitorHost.getRemote = function() {
  let remote = new mojo.internal.bindings.arc.mojom.BootPhaseMonitorHostRemote();
...
mojo.internal.bindings.arc.mojom.BootPhaseMonitorHostReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.arc.mojom.BootPhaseMonitorHost_OnBootCompleted_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OnBootCompleted failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.arc.mojom.BootPhaseMonitorHost_OnBootCompleted_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.arc.mojom.BootPhaseMonitorHostReceiver = mojo.internal.bindings.arc.mojom.BootPhaseMonitorHostReceiver;

mojo.internal.bindings.arc.mojom.BootPhaseMonitorHostPtr = mojo.internal.bindings.arc.mojom.BootPhaseMonitorHostRemote;
mojo.internal.bindings.arc.mojom.BootPhaseMonitorHostRequest = mojo.internal.bindings.arc.mojom.BootPhaseMonitorHostPendingReceiver;
...
mojo.internal.bindings.arc.mojom.BootPhaseMonitorInstanceRemote = class {
  static get $interfaceName() {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.arc.mojom.BootPhaseMonitorInstancePendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.arc.mojom.BootPhaseMonitorInstanceRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.arc.mojom.BootPhaseMonitorInstance.getRemote = function() {
  let remote = new mojo.internal.bindings.arc.mojom.BootPhaseMonitorInstanceRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
...
mojo.internal.bindings.arc.mojom.BootPhaseMonitorInstanceReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.arc.mojom.BootPhaseMonitorInstance_Init_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
...
mojo.internal.bindings.arc.mojom.BootPhaseMonitorInstanceReceiver = mojo.internal.bindings.arc.mojom.BootPhaseMonitorInstanceReceiver;
