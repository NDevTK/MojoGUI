...
mojo.internal.Struct(
    mojo.internal.bindings.blink.mojom.PolicyContainerPoliciesSpec, 'blink.mojom.PolicyContainerPolicies', [
      ...
      mojo.internal.StructField('arg_referrer_policy', 40, 0, mojo.internal.bindings.network.mojom.ReferrerPolicySpec, 0, false, 0, undefined),
      mojo.internal.StructField('arg_sandbox_flags', 44, 0, mojo.internal.bindings.network.mojom.WebSandboxFlagsSpec, 0, false, 0, undefined),
      mojo.internal.StructField('arg_ip_address_space', 48, 0, mojo.internal.bindings.network.mojom.IPAddressSpaceSpec, 0, false, 0, undefined),
      mojo.internal.StructField('arg_is_credentialless', 52, 0, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_can_navigate_top_without_user_gesture', 52, 1, mojo.internal.Bool, true, false, 0, undefined),
      mojo.internal.StructField('arg_cross_origin_isolation_enabled_by_dip', 52, 2, mojo.internal.Bool, false, false, 0, undefined),
    ],
    [[0, 64]]);
...
mojo.internal.bindings.blink.mojom.PolicyContainerHostRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.blink.mojom.PolicyContainerHostPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.blink.mojom.PolicyContainerHostRemoteCallHandler(this.proxy);
  }
  ...
  setReferrerPolicy(arg_referrer_policy) {
    return this.$.setReferrerPolicy(arg_referrer_policy);
  }
  addContentSecurityPolicies(arg_content_security_policies) {
    return this.$.addContentSecurityPolicies(arg_content_security_policies);
  }
};
...
mojo.internal.bindings.blink.mojom.PolicyContainerHost.getRemote = function() {
  let remote = new mojo.internal.bindings.blink.mojom.PolicyContainerHostRemote();
...
mojo.internal.bindings.blink.mojom.PolicyContainerHostReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.blink.mojom.PolicyContainerHost_SetReferrerPolicy_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for SetReferrerPolicy failed with TypeError');
           }
        }
        // Try Method 1: AddContentSecurityPolicies
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.blink.mojom.PolicyContainerHost_AddContentSecurityPolicies_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for AddContentSecurityPolicies failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.blink.mojom.PolicyContainerHostReceiver = mojo.internal.bindings.blink.mojom.PolicyContainerHostReceiver;
