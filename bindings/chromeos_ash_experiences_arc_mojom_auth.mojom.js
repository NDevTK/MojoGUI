  ...
  $: {
    structSpec: {
      ...
      fields: [
        ...
        { name: 'account_info', packedOffset: 8, packedBitOffset: 0, type: arc.mojom.AccountInfoSpec, nullable: true, minVersion: 0 },
      ],
      versions: [{version: 0, packedSize: 24}]
    }
  }
  ...
  $: {
    structSpec: {
      ...
      fields: [
        { name: 'status', packedOffset: 0, packedBitOffset: 0, type: arc.mojom.ArcAuthCodeStatusSpec, nullable: false, minVersion: 0 },
        { name: 'account_info', packedOffset: 8, packedBitOffset: 0, type: arc.mojom.AccountInfoSpec, nullable: true, minVersion: 0 },
        { name: 'persistent_error', packedOffset: 4, packedBitOffset: 0, type: mojo.internal.Bool, nullable: false, minVersion: 24 },
      ],
