...
mojo.internal.bindings.arc.mojom.ArcAuthCodeStatusSpec = mojo.internal.bindings.arc.mojom.ArcAuthCodeStatusSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.arc.mojom.GeneralSignInErrorSpec = mojo.internal.bindings.arc.mojom.GeneralSignInErrorSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.arc.mojom.GMSCheckInErrorSpec = mojo.internal.bindings.arc.mojom.GMSCheckInErrorSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.arc.mojom.GMSSignInErrorSpec = mojo.internal.bindings.arc.mojom.GMSSignInErrorSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.arc.mojom.CloudProvisionFlowErrorSpec = mojo.internal.bindings.arc.mojom.CloudProvisionFlowErrorSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.arc.mojom.ArcSignInSuccessSpec = mojo.internal.bindings.arc.mojom.ArcSignInSuccessSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.arc.mojom.AccountCheckStatusSpec = mojo.internal.bindings.arc.mojom.AccountCheckStatusSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.arc.mojom.AndroidIdSourceSpec = mojo.internal.bindings.arc.mojom.AndroidIdSourceSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.arc.mojom.ReauthReasonSpec = mojo.internal.bindings.arc.mojom.ReauthReasonSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.arc.mojom.MainAccountResolutionStatusSpec = mojo.internal.bindings.arc.mojom.MainAccountResolutionStatusSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.arc.mojom.ManagementChangeStatusSpec = mojo.internal.bindings.arc.mojom.ManagementChangeStatusSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.arc.mojom.ChromeAccountTypeSpec = mojo.internal.bindings.arc.mojom.ChromeAccountTypeSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.arc.mojom.MetricsTypeSpec = mojo.internal.bindings.arc.mojom.MetricsTypeSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.arc.mojom.AccountUpdateTypeSpec = mojo.internal.bindings.arc.mojom.AccountUpdateTypeSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.arc.mojom.ArcSignInErrorSpec = mojo.internal.bindings.arc.mojom.ArcSignInErrorSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.ArcSignInErrorSpec.$.structSpec && mojo.internal.bindings.arc.mojom.ArcSignInErrorSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.ArcSignInErrorSpec.$ = {};
mojo.internal.bindings.arc.mojom.ArcSignInResultSpec = mojo.internal.bindings.arc.mojom.ArcSignInResultSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.ArcSignInResultSpec.$.structSpec && mojo.internal.bindings.arc.mojom.ArcSignInResultSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.ArcSignInResultSpec.$ = {};
mojo.internal.bindings.arc.mojom.ArcSignInAccountSpec = mojo.internal.bindings.arc.mojom.ArcSignInAccountSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.ArcSignInAccountSpec.$.structSpec && mojo.internal.bindings.arc.mojom.ArcSignInAccountSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.ArcSignInAccountSpec.$ = {};
mojo.internal.bindings.arc.mojom.AccountInfoSpec = mojo.internal.bindings.arc.mojom.AccountInfoSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.AccountInfoSpec.$.structSpec && mojo.internal.bindings.arc.mojom.AccountInfoSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.AccountInfoSpec.$ = {};
mojo.internal.bindings.arc.mojom.ArcAccountInfoSpec = mojo.internal.bindings.arc.mojom.ArcAccountInfoSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.ArcAccountInfoSpec.$.structSpec && mojo.internal.bindings.arc.mojom.ArcAccountInfoSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.ArcAccountInfoSpec.$ = {};
mojo.internal.bindings.arc.mojom.AuthHost = mojo.internal.bindings.arc.mojom.AuthHost || {};
mojo.internal.bindings.arc.mojom.AuthHostSpec = mojo.internal.bindings.arc.mojom.AuthHostSpec || { $ : {} };
if (mojo.internal.bindings.arc.mojom.AuthHostSpec.$.structSpec && mojo.internal.bindings.arc.mojom.AuthHostSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.AuthHostSpec.$ = {};
mojo.internal.bindings.arc.mojom.AuthHost.$interfaceName = 'arc.mojom.AuthHost';
mojo.internal.bindings.arc.mojom.AuthHost_OnAuthorizationResult_ParamsSpec = mojo.internal.bindings.arc.mojom.AuthHost_OnAuthorizationResult_ParamsSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.AuthHost_OnAuthorizationResult_ParamsSpec.$.structSpec && mojo.internal.bindings.arc.mojom.AuthHost_OnAuthorizationResult_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.AuthHost_OnAuthorizationResult_ParamsSpec.$ = {};
mojo.internal.bindings.arc.mojom.AuthHost_ReportMetrics_ParamsSpec = mojo.internal.bindings.arc.mojom.AuthHost_ReportMetrics_ParamsSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.AuthHost_ReportMetrics_ParamsSpec.$.structSpec && mojo.internal.bindings.arc.mojom.AuthHost_ReportMetrics_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.AuthHost_ReportMetrics_ParamsSpec.$ = {};
mojo.internal.bindings.arc.mojom.AuthHost_ReportAccountCheckStatus_ParamsSpec = mojo.internal.bindings.arc.mojom.AuthHost_ReportAccountCheckStatus_ParamsSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.AuthHost_ReportAccountCheckStatus_ParamsSpec.$.structSpec && mojo.internal.bindings.arc.mojom.AuthHost_ReportAccountCheckStatus_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.AuthHost_ReportAccountCheckStatus_ParamsSpec.$ = {};
mojo.internal.bindings.arc.mojom.AuthHost_ReportManagementChangeStatus_ParamsSpec = mojo.internal.bindings.arc.mojom.AuthHost_ReportManagementChangeStatus_ParamsSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.AuthHost_ReportManagementChangeStatus_ParamsSpec.$.structSpec && mojo.internal.bindings.arc.mojom.AuthHost_ReportManagementChangeStatus_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.AuthHost_ReportManagementChangeStatus_ParamsSpec.$ = {};
mojo.internal.bindings.arc.mojom.AuthHost_RequestPrimaryAccount_ParamsSpec = mojo.internal.bindings.arc.mojom.AuthHost_RequestPrimaryAccount_ParamsSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.AuthHost_RequestPrimaryAccount_ParamsSpec.$.structSpec && mojo.internal.bindings.arc.mojom.AuthHost_RequestPrimaryAccount_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.AuthHost_RequestPrimaryAccount_ParamsSpec.$ = {};
mojo.internal.bindings.arc.mojom.AuthHost_RequestPrimaryAccount_ResponseParamsSpec = mojo.internal.bindings.arc.mojom.AuthHost_RequestPrimaryAccount_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.AuthHost_RequestPrimaryAccount_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.arc.mojom.AuthHost_RequestPrimaryAccount_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.AuthHost_RequestPrimaryAccount_ResponseParamsSpec.$ = {};
mojo.internal.bindings.arc.mojom.AuthHost_RequestPrimaryAccountInfo_ParamsSpec = mojo.internal.bindings.arc.mojom.AuthHost_RequestPrimaryAccountInfo_ParamsSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.AuthHost_RequestPrimaryAccountInfo_ParamsSpec.$.structSpec && mojo.internal.bindings.arc.mojom.AuthHost_RequestPrimaryAccountInfo_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.AuthHost_RequestPrimaryAccountInfo_ParamsSpec.$ = {};
mojo.internal.bindings.arc.mojom.AuthHost_RequestPrimaryAccountInfo_ResponseParamsSpec = mojo.internal.bindings.arc.mojom.AuthHost_RequestPrimaryAccountInfo_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.AuthHost_RequestPrimaryAccountInfo_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.arc.mojom.AuthHost_RequestPrimaryAccountInfo_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.AuthHost_RequestPrimaryAccountInfo_ResponseParamsSpec.$ = {};
mojo.internal.bindings.arc.mojom.AuthHost_RequestAccountInfo_ParamsSpec = mojo.internal.bindings.arc.mojom.AuthHost_RequestAccountInfo_ParamsSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.AuthHost_RequestAccountInfo_ParamsSpec.$.structSpec && mojo.internal.bindings.arc.mojom.AuthHost_RequestAccountInfo_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.AuthHost_RequestAccountInfo_ParamsSpec.$ = {};
mojo.internal.bindings.arc.mojom.AuthHost_RequestAccountInfo_ResponseParamsSpec = mojo.internal.bindings.arc.mojom.AuthHost_RequestAccountInfo_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.AuthHost_RequestAccountInfo_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.arc.mojom.AuthHost_RequestAccountInfo_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.AuthHost_RequestAccountInfo_ResponseParamsSpec.$ = {};
mojo.internal.bindings.arc.mojom.AuthHost_IsAccountManagerAvailable_ParamsSpec = mojo.internal.bindings.arc.mojom.AuthHost_IsAccountManagerAvailable_ParamsSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.AuthHost_IsAccountManagerAvailable_ParamsSpec.$.structSpec && mojo.internal.bindings.arc.mojom.AuthHost_IsAccountManagerAvailable_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.AuthHost_IsAccountManagerAvailable_ParamsSpec.$ = {};
mojo.internal.bindings.arc.mojom.AuthHost_IsAccountManagerAvailable_ResponseParamsSpec = mojo.internal.bindings.arc.mojom.AuthHost_IsAccountManagerAvailable_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.AuthHost_IsAccountManagerAvailable_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.arc.mojom.AuthHost_IsAccountManagerAvailable_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.AuthHost_IsAccountManagerAvailable_ResponseParamsSpec.$ = {};
mojo.internal.bindings.arc.mojom.AuthHost_HandleAddAccountRequest_ParamsSpec = mojo.internal.bindings.arc.mojom.AuthHost_HandleAddAccountRequest_ParamsSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.AuthHost_HandleAddAccountRequest_ParamsSpec.$.structSpec && mojo.internal.bindings.arc.mojom.AuthHost_HandleAddAccountRequest_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.AuthHost_HandleAddAccountRequest_ParamsSpec.$ = {};
mojo.internal.bindings.arc.mojom.AuthHost_HandleRemoveAccountRequest_ParamsSpec = mojo.internal.bindings.arc.mojom.AuthHost_HandleRemoveAccountRequest_ParamsSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.AuthHost_HandleRemoveAccountRequest_ParamsSpec.$.structSpec && mojo.internal.bindings.arc.mojom.AuthHost_HandleRemoveAccountRequest_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.AuthHost_HandleRemoveAccountRequest_ParamsSpec.$ = {};
mojo.internal.bindings.arc.mojom.AuthHost_HandleUpdateCredentialsRequest_ParamsSpec = mojo.internal.bindings.arc.mojom.AuthHost_HandleUpdateCredentialsRequest_ParamsSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.AuthHost_HandleUpdateCredentialsRequest_ParamsSpec.$.structSpec && mojo.internal.bindings.arc.mojom.AuthHost_HandleUpdateCredentialsRequest_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.AuthHost_HandleUpdateCredentialsRequest_ParamsSpec.$ = {};
mojo.internal.bindings.arc.mojom.AuthHost_ReportAccountReauthReason_ParamsSpec = mojo.internal.bindings.arc.mojom.AuthHost_ReportAccountReauthReason_ParamsSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.AuthHost_ReportAccountReauthReason_ParamsSpec.$.structSpec && mojo.internal.bindings.arc.mojom.AuthHost_ReportAccountReauthReason_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.AuthHost_ReportAccountReauthReason_ParamsSpec.$ = {};
mojo.internal.bindings.arc.mojom.AuthInstance = mojo.internal.bindings.arc.mojom.AuthInstance || {};
mojo.internal.bindings.arc.mojom.AuthInstanceSpec = mojo.internal.bindings.arc.mojom.AuthInstanceSpec || { $ : {} };
if (mojo.internal.bindings.arc.mojom.AuthInstanceSpec.$.structSpec && mojo.internal.bindings.arc.mojom.AuthInstanceSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.AuthInstanceSpec.$ = {};
mojo.internal.bindings.arc.mojom.AuthInstance.$interfaceName = 'arc.mojom.AuthInstance';
mojo.internal.bindings.arc.mojom.AuthInstance_Init_ParamsSpec = mojo.internal.bindings.arc.mojom.AuthInstance_Init_ParamsSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.AuthInstance_Init_ParamsSpec.$.structSpec && mojo.internal.bindings.arc.mojom.AuthInstance_Init_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.AuthInstance_Init_ParamsSpec.$ = {};
mojo.internal.bindings.arc.mojom.AuthInstance_Init_ResponseParamsSpec = mojo.internal.bindings.arc.mojom.AuthInstance_Init_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.AuthInstance_Init_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.arc.mojom.AuthInstance_Init_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.AuthInstance_Init_ResponseParamsSpec.$ = {};
mojo.internal.bindings.arc.mojom.AuthInstance_OnAccountUpdated_ParamsSpec = mojo.internal.bindings.arc.mojom.AuthInstance_OnAccountUpdated_ParamsSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.AuthInstance_OnAccountUpdated_ParamsSpec.$.structSpec && mojo.internal.bindings.arc.mojom.AuthInstance_OnAccountUpdated_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.AuthInstance_OnAccountUpdated_ParamsSpec.$ = {};
mojo.internal.bindings.arc.mojom.AuthInstance_GetGoogleAccounts_ParamsSpec = mojo.internal.bindings.arc.mojom.AuthInstance_GetGoogleAccounts_ParamsSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.AuthInstance_GetGoogleAccounts_ParamsSpec.$.structSpec && mojo.internal.bindings.arc.mojom.AuthInstance_GetGoogleAccounts_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.AuthInstance_GetGoogleAccounts_ParamsSpec.$ = {};
mojo.internal.bindings.arc.mojom.AuthInstance_GetGoogleAccounts_ResponseParamsSpec = mojo.internal.bindings.arc.mojom.AuthInstance_GetGoogleAccounts_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.AuthInstance_GetGoogleAccounts_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.arc.mojom.AuthInstance_GetGoogleAccounts_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.AuthInstance_GetGoogleAccounts_ResponseParamsSpec.$ = {};
mojo.internal.bindings.arc.mojom.AuthInstance_GetMainAccountResolutionStatus_ParamsSpec = mojo.internal.bindings.arc.mojom.AuthInstance_GetMainAccountResolutionStatus_ParamsSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.AuthInstance_GetMainAccountResolutionStatus_ParamsSpec.$.structSpec && mojo.internal.bindings.arc.mojom.AuthInstance_GetMainAccountResolutionStatus_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.AuthInstance_GetMainAccountResolutionStatus_ParamsSpec.$ = {};
mojo.internal.bindings.arc.mojom.AuthInstance_GetMainAccountResolutionStatus_ResponseParamsSpec = mojo.internal.bindings.arc.mojom.AuthInstance_GetMainAccountResolutionStatus_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.AuthInstance_GetMainAccountResolutionStatus_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.arc.mojom.AuthInstance_GetMainAccountResolutionStatus_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.AuthInstance_GetMainAccountResolutionStatus_ResponseParamsSpec.$ = {};
mojo.internal.bindings.arc.mojom.AuthInstance_SetAccounts_ParamsSpec = mojo.internal.bindings.arc.mojom.AuthInstance_SetAccounts_ParamsSpec || { $: {} };
if (mojo.internal.bindings.arc.mojom.AuthInstance_SetAccounts_ParamsSpec.$.structSpec && mojo.internal.bindings.arc.mojom.AuthInstance_SetAccounts_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.arc.mojom.AuthInstance_SetAccounts_ParamsSpec.$ = {};
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const message = new mojo.internal.Message(
                ...
                header.ordinal, header.requestId, mojo.internal.bindings.arc.mojom.AuthHost_RequestPrimaryAccount_ResponseParamsSpec.$.structSpec, resp_obj);
        ...
        case 5: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.arc.mojom.AuthHost_RequestPrimaryAccountInfo_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
        ...
        case 6: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.arc.mojom.AuthHost_RequestAccountInfo_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
        ...
        case 7: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.arc.mojom.AuthHost_IsAccountManagerAvailable_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
        ...
        case 0: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.arc.mojom.AuthInstance_Init_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
        ...
        case 2: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const resp_obj = { 'arg_accounts': val };
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.arc.mojom.AuthInstance_GetGoogleAccounts_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
        ...
        case 3: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.arc.mojom.AuthInstance_GetMainAccountResolutionStatus_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
