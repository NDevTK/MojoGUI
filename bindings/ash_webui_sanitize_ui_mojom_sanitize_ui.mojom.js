...
mojo.internal.bindings.ash.sanitize_ui = mojo.internal.bindings.ash.sanitize_ui || {};
mojo.internal.bindings.ash.sanitize_ui.mojom = mojo.internal.bindings.ash.sanitize_ui.mojom || {};
...
mojo.internal.bindings.ash.sanitize_ui.mojom.SettingsResetterRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.ash.sanitize_ui.mojom.SettingsResetterPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.ash.sanitize_ui.mojom.SettingsResetterRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.ash.sanitize_ui.mojom.SettingsResetter.getRemote = function() {
  let remote = new mojo.internal.bindings.ash.sanitize_ui.mojom.SettingsResetterRemote();
...
mojo.internal.bindings.ash.sanitize_ui.mojom.SettingsResetterReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ash.sanitize_ui.mojom.SettingsResetter_PerformSanitizeSettings_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for PerformSanitizeSettings failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.ash.sanitize_ui.mojom.SettingsResetter_PerformSanitizeSettings_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.ash.sanitize_ui.mojom.SettingsResetterReceiver = mojo.internal.bindings.ash.sanitize_ui.mojom.SettingsResetterReceiver;
