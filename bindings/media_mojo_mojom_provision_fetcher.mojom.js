...
mojo.internal.bindings.media.mojom.ProvisionFetcher = {};
mojo.internal.bindings.media.mojom.ProvisionFetcherSpec = { $ : {} };
mojo.internal.bindings.media.mojom.ProvisionFetcher.$interfaceName = 'media.mojom.ProvisionFetcher';
...
mojo.internal.bindings.media.mojom.ProvisionFetcherRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.media.mojom.ProvisionFetcherRemoteCallHandler(this.proxy);
  }
  ...
  retrieve(arg_default_url, arg_request_data) {
    return this.$.retrieve(arg_default_url, arg_request_data);
  }
};

mojo.internal.bindings.media.mojom.ProvisionFetcherRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('media.mojom.ProvisionFetcher', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.media.mojom.ProvisionFetcher.getRemote = function() {
  let remote = new mojo.internal.bindings.media.mojom.ProvisionFetcherRemote();
...
mojo.internal.bindings.media.mojom.ProvisionFetcherReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('media.mojom.ProvisionFetcher', [
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        // Try Method 0: Retrieve
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.media.mojom.ProvisionFetcher_Retrieve_ParamsSpec.$.structSpec);
             console.log('[GeneratedReceiver] Discovery SUCCESS: ' + header.ordinal + ' -> Retrieve (0)');
        ...
        case 0: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.media.mojom.ProvisionFetcher_Retrieve_ResponseParamsSpec, header, rawHeader);
               responder(response);
...
mojo.internal.bindings.media.mojom.ProvisionFetcherReceiver = mojo.internal.bindings.media.mojom.ProvisionFetcherReceiver;
