...
mojo.internal.bindings.ash.cros_safety.mojom.GetOnDeviceSafetySessionResult = {
  kOk: 0,
  kGenericError: 1,
  MinVersion: 1,
  MinVersion: 1,
...
mojo.internal.bindings.ash.cros_safety.mojom.CrosSafetyServiceRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.ash.cros_safety.mojom.CrosSafetyServicePendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.ash.cros_safety.mojom.CrosSafetyServiceRemoteCallHandler(this.proxy);
  }
  ...
  createOnDeviceSafetySession(arg_session) {
    return this.$.createOnDeviceSafetySession(arg_session);
  }
  createCloudSafetySession(arg_session) {
    return this.$.createCloudSafetySession(arg_session);
  }
};
...
mojo.internal.bindings.ash.cros_safety.mojom.CrosSafetyService.getRemote = function() {
  let remote = new mojo.internal.bindings.ash.cros_safety.mojom.CrosSafetyServiceRemote();
...
mojo.internal.bindings.ash.cros_safety.mojom.CrosSafetyServiceReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ash.cros_safety.mojom.CrosSafetyService_CreateOnDeviceSafetySession_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for CreateOnDeviceSafetySession failed with TypeError');
           }
        }
        // Try Method 1: CreateCloudSafetySession
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ash.cros_safety.mojom.CrosSafetyService_CreateCloudSafetySession_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for CreateCloudSafetySession failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.ash.cros_safety.mojom.CrosSafetyServiceReceiver = mojo.internal.bindings.ash.cros_safety.mojom.CrosSafetyServiceReceiver;
