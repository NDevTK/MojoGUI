...
mojo.internal.bindings.mojom.LocationInternalsHandler = {};
mojo.internal.bindings.mojom.LocationInternalsHandlerSpec = { $ : {} };
...
mojo.internal.bindings.mojom.LocationInternalsHandlerRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.mojom.LocationInternalsHandlerPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.mojom.LocationInternalsHandlerRemoteCallHandler(this.proxy);
  }
  ...
  bindInternalsInterface(arg_receiver) {
    return this.$.bindInternalsInterface(arg_receiver);
  }
};

mojo.internal.bindings.mojom.LocationInternalsHandlerRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('mojom.LocationInternalsHandler', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.mojom.LocationInternalsHandler.getRemote = function() {
  let remote = new mojo.internal.bindings.mojom.LocationInternalsHandlerRemote();
...
mojo.internal.bindings.mojom.LocationInternalsHandlerReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('mojom.LocationInternalsHandler', [
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.mojom.LocationInternalsHandler_BindInternalsInterface_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for BindInternalsInterface failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.mojom.LocationInternalsHandlerReceiver = mojo.internal.bindings.mojom.LocationInternalsHandlerReceiver;
