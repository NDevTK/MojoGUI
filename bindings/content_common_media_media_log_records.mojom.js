...
mojo.internal.bindings.content.mojom.MediaInternalLogRecords = {};
mojo.internal.bindings.content.mojom.MediaInternalLogRecordsSpec = { $ : {} };
mojo.internal.bindings.content.mojom.MediaInternalLogRecords.$interfaceName = 'content.mojom.MediaInternalLogRecords';
...
mojo.internal.bindings.content.mojom.MediaInternalLogRecordsRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.content.mojom.MediaInternalLogRecordsPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.content.mojom.MediaInternalLogRecordsRemoteCallHandler(this.proxy);
  }
  ...
  log(arg_events) {
    return this.$.log(arg_events);
  }
};

mojo.internal.bindings.content.mojom.MediaInternalLogRecordsRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('content.mojom.MediaInternalLogRecords', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.content.mojom.MediaInternalLogRecords.getRemote = function() {
  let remote = new mojo.internal.bindings.content.mojom.MediaInternalLogRecordsRemote();
...
mojo.internal.bindings.content.mojom.MediaInternalLogRecordsReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('content.mojom.MediaInternalLogRecords', [
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.content.mojom.MediaInternalLogRecords_Log_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for Log failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.content.mojom.MediaInternalLogRecordsReceiver = mojo.internal.bindings.content.mojom.MediaInternalLogRecordsReceiver;
