  ...
  $: {
    structSpec: {
      ...
      fields: [
        ...
        { name: 'red_eye_reduction', packedOffset: 152, packedBitOffset: 0, type: media.mojom.RedEyeReductionSpec, nullable: false },
        { name: 'height', packedOffset: 160, packedBitOffset: 0, type: media.mojom.RangeSpec, nullable: false },
        { name: 'width', packedOffset: 168, packedBitOffset: 0, type: media.mojom.RangeSpec, nullable: false },
        ...
        { name: 'background_blur_mode', packedOffset: 192, packedBitOffset: 0, type: media.mojom.BackgroundBlurModeSpec, nullable: false },
        { name: 'supported_face_framing_modes', packedOffset: 200, packedBitOffset: 0, type: mojo.internal.Array, nullable: false },
        { name: 'current_face_framing_mode', packedOffset: 208, packedBitOffset: 0, type: media.mojom.MeteringModeSpec, nullable: false },
        { name: 'supported_eye_gaze_correction_modes', packedOffset: 216, packedBitOffset: 0, type: mojo.internal.Array, nullable: false },
        { name: 'current_eye_gaze_correction_mode', packedOffset: 224, packedBitOffset: 0, type: media.mojom.EyeGazeCorrectionModeSpec, nullable: false },
...
media.mojom.PhotoSettingsSpec = {
  $: {
    structSpec: {
      ...
      packedSize: 192,
      fields: [
        { name: 'white_balance_mode', packedOffset: 0, packedBitOffset: 0, type: media.mojom.MeteringModeSpec, nullable: false },
        { name: 'exposure_mode', packedOffset: 8, packedBitOffset: 0, type: media.mojom.MeteringModeSpec, nullable: false },
        { name: 'focus_mode', packedOffset: 16, packedBitOffset: 0, type: media.mojom.MeteringModeSpec, nullable: false },
        ...
        { name: 'fill_light_mode', packedOffset: 128, packedBitOffset: 0, type: media.mojom.FillLightModeSpec, nullable: false },
        ...
        { name: 'background_blur_mode', packedOffset: 152, packedBitOffset: 0, type: media.mojom.BackgroundBlurModeSpec, nullable: false },
        { name: 'face_framing_mode', packedOffset: 160, packedBitOffset: 0, type: media.mojom.MeteringModeSpec, nullable: false },
        { name: 'eye_gaze_correction_mode', packedOffset: 168, packedBitOffset: 0, type: media.mojom.EyeGazeCorrectionModeSpec, nullable: true },
