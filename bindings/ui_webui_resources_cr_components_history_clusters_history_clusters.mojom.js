...
mojo.internal.bindings.history_clusters.mojom.PageHandlerFactory = mojo.internal.bindings.history_clusters.mojom.PageHandlerFactory || {};
mojo.internal.bindings.history_clusters.mojom.PageHandlerFactorySpec = mojo.internal.bindings.history_clusters.mojom.PageHandlerFactorySpec || { $ : {} };
if (mojo.internal.bindings.history_clusters.mojom.PageHandlerFactorySpec.$.structSpec && mojo.internal.bindings.history_clusters.mojom.PageHandlerFactorySpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.history_clusters.mojom.PageHandlerFactorySpec.$ = {};
mojo.internal.bindings.history_clusters.mojom.PageHandlerFactory.$interfaceName = 'history_clusters.mojom.PageHandlerFactory';
mojo.internal.bindings.history_clusters.mojom.PageHandlerFactory_CreatePageHandler_ParamsSpec = mojo.internal.bindings.history_clusters.mojom.PageHandlerFactory_CreatePageHandler_ParamsSpec || { $: {} };
if (mojo.internal.bindings.history_clusters.mojom.PageHandlerFactory_CreatePageHandler_ParamsSpec.$.structSpec && mojo.internal.bindings.history_clusters.mojom.PageHandlerFactory_CreatePageHandler_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.history_clusters.mojom.PageHandlerFactory_CreatePageHandler_ParamsSpec.$ = {};
...
mojo.internal.bindings.ui.mojom.ClickModifiersSpec = mojo.internal.bindings.ui.mojom.ClickModifiersSpec || { $: mojo.internal.OpaqueStruct.$ };
mojo.internal.bindings.url = mojo.internal.bindings.url || {};
        ...
        case 4: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              const val = (response && typeof response === 'object' && 'arg_visible' in response) ? response['arg_visible'] : response;
...
mojo.internal.bindings.history_clusters.mojom.PageHandlerFactoryPendingReceiver = class {
  constructor(handle) {
    this.handle = handle;
    if (handle) {
      this.__mojoHandle = handle.router_ ? handle.router_.pipe_ : (handle.pipe_ || handle);
...
mojo.internal.bindings.history_clusters.mojom.PageHandlerFactoryRemote = class {
  static get $interfaceName() {
    return 'history_clusters.mojom.PageHandlerFactory';
  }

  constructor(handle = undefined) {
    this.__mojoHandle = handle;
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.history_clusters.mojom.PageHandlerFactoryPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.history_clusters.mojom.PageHandlerFactoryRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.history_clusters.mojom.PageHandlerFactoryRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('history_clusters.mojom.PageHandlerFactory', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.history_clusters.mojom.PageHandlerFactory.getRemote = function() {
  let remote = new mojo.internal.bindings.history_clusters.mojom.PageHandlerFactoryRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
...
mojo.internal.bindings.history_clusters.mojom.PageHandlerFactoryReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('history_clusters.mojom.PageHandlerFactory', [
      { explicit: null },
    ]);
    ordinals.forEach((ord, idx) => {
      this.ordinalMap.set(ord, idx); // Scrambled/Explicit
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.history_clusters.mojom.PageHandlerFactory_CreatePageHandler_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.history_clusters.mojom.PageHandlerFactoryReceiver = mojo.internal.bindings.history_clusters.mojom.PageHandlerFactoryReceiver;

mojo.internal.bindings.history_clusters.mojom.PageHandlerFactoryPtr = mojo.internal.bindings.history_clusters.mojom.PageHandlerFactoryRemote;
mojo.internal.bindings.history_clusters.mojom.PageHandlerFactoryRequest = mojo.internal.bindings.history_clusters.mojom.PageHandlerFactoryPendingReceiver;
...
mojo.internal.Struct(
    mojo.internal.bindings.history_clusters.mojom.PageHandlerFactory_CreatePageHandler_ParamsSpec, 'history_clusters.mojom.PageHandlerFactory_CreatePageHandler_Params', [
      ...
      mojo.internal.StructField('arg_handler', 8, 0, mojo.internal.InterfaceRequest(mojo.internal.bindings.history_clusters.mojom.PageHandlerPendingReceiver), null, false, 0, undefined),
    ],
    [[0, 24]]);
