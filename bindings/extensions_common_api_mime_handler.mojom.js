...
mojo.internal.bindings.extensions.mime_handler.MimeHandlerServiceRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.extensions.mime_handler.MimeHandlerServicePendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.extensions.mime_handler.MimeHandlerServiceRemoteCallHandler(this.proxy);
  }
  ...
  setPdfPluginAttributes(arg_pdf_plugin_attributes) {
    return this.$.setPdfPluginAttributes(arg_pdf_plugin_attributes);
  }
};
...
mojo.internal.bindings.extensions.mime_handler.MimeHandlerService.getRemote = function() {
  let remote = new mojo.internal.bindings.extensions.mime_handler.MimeHandlerServiceRemote();
...
mojo.internal.bindings.extensions.mime_handler.MimeHandlerServiceReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.extensions.mime_handler.MimeHandlerService_GetStreamInfo_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for GetStreamInfo failed with TypeError');
           }
        }
        // Try Method 1: SetPdfPluginAttributes
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.extensions.mime_handler.MimeHandlerService_SetPdfPluginAttributes_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for SetPdfPluginAttributes failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.extensions.mime_handler.MimeHandlerService_GetStreamInfo_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.extensions.mime_handler.MimeHandlerServiceReceiver = mojo.internal.bindings.extensions.mime_handler.MimeHandlerServiceReceiver;

mojo.internal.bindings.extensions.mime_handler.MimeHandlerServicePtr = mojo.internal.bindings.extensions.mime_handler.MimeHandlerServiceRemote;
mojo.internal.bindings.extensions.mime_handler.MimeHandlerServiceRequest = mojo.internal.bindings.extensions.mime_handler.MimeHandlerServicePendingReceiver;
...
mojo.internal.bindings.extensions.mime_handler.BeforeUnloadControlRemote = class {
  static get $interfaceName() {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.extensions.mime_handler.BeforeUnloadControlPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.extensions.mime_handler.BeforeUnloadControlRemoteCallHandler(this.proxy);
  }
  ...
  setShowBeforeUnloadDialog(arg_show_dialog) {
    return this.$.setShowBeforeUnloadDialog(arg_show_dialog);
  }
};
...
mojo.internal.bindings.extensions.mime_handler.BeforeUnloadControl.getRemote = function() {
  let remote = new mojo.internal.bindings.extensions.mime_handler.BeforeUnloadControlRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
...
mojo.internal.bindings.extensions.mime_handler.BeforeUnloadControlReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.extensions.mime_handler.BeforeUnloadControl_SetShowBeforeUnloadDialog_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for SetShowBeforeUnloadDialog failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
             console.warn('[GeneratedReceiver] Failed to discover ordinal ' + header.ordinal);
...
mojo.internal.bindings.extensions.mime_handler.BeforeUnloadControlReceiver = mojo.internal.bindings.extensions.mime_handler.BeforeUnloadControlReceiver;
