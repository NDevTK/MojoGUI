...
mojo.internal.bindings.device.mojom.WakeLockContext = {};
mojo.internal.bindings.device.mojom.WakeLockContextSpec = { $ : {} };
...
mojo.internal.bindings.device.mojom.WakeLockContextRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.device.mojom.WakeLockContextRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.device.mojom.WakeLockContextRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('device.mojom.WakeLockContext', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.device.mojom.WakeLockContext.getRemote = function() {
  let remote = new mojo.internal.bindings.device.mojom.WakeLockContextRemote();
...
mojo.internal.bindings.device.mojom.WakeLockContextReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('device.mojom.WakeLockContext', [
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.device.mojom.WakeLockContext_GetWakeLock_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.device.mojom.WakeLockContextReceiver = mojo.internal.bindings.device.mojom.WakeLockContextReceiver;
