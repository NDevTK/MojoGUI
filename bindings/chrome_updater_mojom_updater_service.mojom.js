...
mojo.internal.Struct(
    mojo.internal.bindings.updater.mojom.UpdateService_Update_ParamsSpec, 'updater.mojom.UpdateService_Update_Params', [
      ...
      mojo.internal.StructField('arg_do_update_check_only', 24, 0, mojo.internal.Bool, false, false, 1, undefined),
...
mojo.internal.Struct(
    mojo.internal.bindings.updater.mojom.UpdateService_CheckForUpdate_ParamsSpec, 'updater.mojom.UpdateService_CheckForUpdate_Params', [
      ...
      mojo.internal.StructField('arg_language', 16, 0, mojo.internal.String, null, true, 3, undefined),
    ],
    [[0, 24], [3, 32]]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.updater.mojom.UpdateService_GetVersion_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for GetVersion failed with TypeError');
           }
        }
        // Try Method 1: FetchPolicies
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.updater.mojom.UpdateService_FetchPolicies_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.updater.mojom.UpdateService_RegisterApp_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for RegisterApp failed with TypeError');
           }
        }
        // Try Method 3: GetAppStates
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.updater.mojom.UpdateService_GetAppStates_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for GetAppStates failed with TypeError');
           }
        }
        // Try Method 4: RunPeriodicTasks
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.updater.mojom.UpdateService_RunPeriodicTasks_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for RunPeriodicTasks failed with TypeError');
           }
        }
        // Try Method 5: UpdateAll
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.updater.mojom.UpdateService_UpdateAll_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for UpdateAll failed with TypeError');
           }
        }
        // Try Method 6: Update
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.updater.mojom.UpdateService_Update_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.updater.mojom.UpdateService_Install_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.updater.mojom.UpdateService_CancelInstalls_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for CancelInstalls failed with TypeError');
           }
        }
        // Try Method 9: RunInstaller
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.updater.mojom.UpdateService_RunInstaller_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for RunInstaller failed with TypeError');
           }
        }
        // Try Method 10: CheckForUpdate
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.updater.mojom.UpdateService_CheckForUpdate_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for CheckForUpdate failed with TypeError');
           }
        }
        // Try Method 11: GetUpdaterState
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.updater.mojom.UpdateService_GetUpdaterState_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for GetUpdaterState failed with TypeError');
           }
        }
        // Try Method 12: GetUpdaterPolicies
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.updater.mojom.UpdateService_GetUpdaterPolicies_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for GetUpdaterPolicies failed with TypeError');
           }
        }
        // Try Method 13: GetAppPolicies
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.updater.mojom.UpdateService_GetAppPolicies_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for GetAppPolicies failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.updater.mojom.StateChangeObserver_OnStateChange_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OnStateChange failed with TypeError');
           }
        }
        // Try Method 1: OnComplete
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.updater.mojom.StateChangeObserver_OnComplete_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
