...
mojo.internal.bindings.bookmarks_api.mojom.BookmarksService_DeleteBookmarkNode_ParamsSpec = mojo.internal.bindings.bookmarks_api.mojom.BookmarksService_DeleteBookmarkNode_ParamsSpec || { $: {} };
if (mojo.internal.bindings.bookmarks_api.mojom.BookmarksService_DeleteBookmarkNode_ParamsSpec.$.structSpec && mojo.internal.bindings.bookmarks_api.mojom.BookmarksService_DeleteBookmarkNode_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.bookmarks_api.mojom.BookmarksService_DeleteBookmarkNode_ParamsSpec.$ = {};
...
mojo.internal.bindings.bookmarks_api.mojom.BookmarksServiceRemote = class {
  ...
  deleteBookmarkNode(arg_id) {
    return this.$.deleteBookmarkNode(arg_id);
  }
};
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        ...
        case 5: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.bookmarks_api.mojom.BookmarksService_DeleteBookmarkNode_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.deleteBookmarkNode');
          const result = this.impl.deleteBookmarkNode(params.arg_id);
          break;
        }
      }
      } catch (err) {
...
mojo.internal.Struct(
    mojo.internal.bindings.bookmarks_api.mojom.BookmarksService_DeleteBookmarkNode_ParamsSpec, 'bookmarks_api.mojom.BookmarksService_DeleteBookmarkNode_Params', [
      mojo.internal.StructField('arg_id', 0, 0, mojo.internal.bindings.mojo_base.mojom.UuidSpec, null, false, 0, undefined),
    ],
    [[0, 16]]);
