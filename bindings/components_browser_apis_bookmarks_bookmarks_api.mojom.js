// Auto-generated MojoJS binding
 // Source: chromium_src/components/browser_apis/bookmarks/bookmarks_api.mojom
 ...
 mojo.internal.bindings.bookmarks_api = mojo.internal.bindings.bookmarks_api || {};
mojo.internal.bindings.bookmarks_api.mojom = mojo.internal.bindings.bookmarks_api.mojom || {};
mojo.internal.bindings.mojo_base = mojo.internal.bindings.mojo_base || {};
mojo.internal.bindings.mojo_base.mojom = mojo.internal.bindings.mojo_base.mojom || {};
mojo.internal.bindings.url = mojo.internal.bindings.url || {};

mojo.internal.bindings.bookmarks_api.mojom.PermanentFolderTypeSpec = mojo.internal.bindings.bookmarks_api.mojom.PermanentFolderTypeSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.bookmarks_api.mojom.BookmarkNodeSpec = mojo.internal.bindings.bookmarks_api.mojom.BookmarkNodeSpec || { $: {} };
if (mojo.internal.bindings.bookmarks_api.mojom.BookmarkNodeSpec.$.structSpec && mojo.internal.bindings.bookmarks_api.mojom.BookmarkNodeSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.bookmarks_api.mojom.BookmarkNodeSpec.$ = {};
mojo.internal.bindings.bookmarks_api.mojom.BookmarksEventSpec = mojo.internal.bindings.bookmarks_api.mojom.BookmarksEventSpec || { $: {} };
if (mojo.internal.bindings.bookmarks_api.mojom.BookmarksEventSpec.$.structSpec && mojo.internal.bindings.bookmarks_api.mojom.BookmarksEventSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.bookmarks_api.mojom.BookmarksEventSpec.$ = {};
mojo.internal.bindings.bookmarks_api.mojom.LegacyFieldsSpec = mojo.internal.bindings.bookmarks_api.mojom.LegacyFieldsSpec || { $: {} };
if (mojo.internal.bindings.bookmarks_api.mojom.LegacyFieldsSpec.$.structSpec && mojo.internal.bindings.bookmarks_api.mojom.LegacyFieldsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.bookmarks_api.mojom.LegacyFieldsSpec.$ = {};
mojo.internal.bindings.bookmarks_api.mojom.RootNodeSpec = mojo.internal.bindings.bookmarks_api.mojom.RootNodeSpec || { $: {} };
if (mojo.internal.bindings.bookmarks_api.mojom.RootNodeSpec.$.structSpec && mojo.internal.bindings.bookmarks_api.mojom.RootNodeSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.bookmarks_api.mojom.RootNodeSpec.$ = {};
mojo.internal.bindings.bookmarks_api.mojom.UrlSpec = mojo.internal.bindings.bookmarks_api.mojom.UrlSpec || { $: {} };
if (mojo.internal.bindings.bookmarks_api.mojom.UrlSpec.$.structSpec && mojo.internal.bindings.bookmarks_api.mojom.UrlSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.bookmarks_api.mojom.UrlSpec.$ = {};
mojo.internal.bindings.bookmarks_api.mojom.FolderSpec = mojo.internal.bindings.bookmarks_api.mojom.FolderSpec || { $: {} };
if (mojo.internal.bindings.bookmarks_api.mojom.FolderSpec.$.structSpec && mojo.internal.bindings.bookmarks_api.mojom.FolderSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.bookmarks_api.mojom.FolderSpec.$ = {};
mojo.internal.bindings.bookmarks_api.mojom.BookmarksSnapshotSpec = mojo.internal.bindings.bookmarks_api.mojom.BookmarksSnapshotSpec || { $: {} };
if (mojo.internal.bindings.bookmarks_api.mojom.BookmarksSnapshotSpec.$.structSpec && mojo.internal.bindings.bookmarks_api.mojom.BookmarksSnapshotSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.bookmarks_api.mojom.BookmarksSnapshotSpec.$ = {};
mojo.internal.bindings.bookmarks_api.mojom.BookmarkNodeCreatedSpec = mojo.internal.bindings.bookmarks_api.mojom.BookmarkNodeCreatedSpec || { $: {} };
if (mojo.internal.bindings.bookmarks_api.mojom.BookmarkNodeCreatedSpec.$.structSpec && mojo.internal.bindings.bookmarks_api.mojom.BookmarkNodeCreatedSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.bookmarks_api.mojom.BookmarkNodeCreatedSpec.$ = {};
mojo.internal.bindings.bookmarks_api.mojom.BookmarkNodeRemovedSpec = mojo.internal.bindings.bookmarks_api.mojom.BookmarkNodeRemovedSpec || { $: {} };
if (mojo.internal.bindings.bookmarks_api.mojom.BookmarkNodeRemovedSpec.$.structSpec && mojo.internal.bindings.bookmarks_api.mojom.BookmarkNodeRemovedSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.bookmarks_api.mojom.BookmarkNodeRemovedSpec.$ = {};
mojo.internal.bindings.bookmarks_api.mojom.BookmarkNodeMovedSpec = mojo.internal.bindings.bookmarks_api.mojom.BookmarkNodeMovedSpec || { $: {} };
if (mojo.internal.bindings.bookmarks_api.mojom.BookmarkNodeMovedSpec.$.structSpec && mojo.internal.bindings.bookmarks_api.mojom.BookmarkNodeMovedSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.bookmarks_api.mojom.BookmarkNodeMovedSpec.$ = {};
mojo.internal.bindings.bookmarks_api.mojom.BookmarkNodeChangedSpec = mojo.internal.bindings.bookmarks_api.mojom.BookmarkNodeChangedSpec || { $: {} };
if (mojo.internal.bindings.bookmarks_api.mojom.BookmarkNodeChangedSpec.$.structSpec && mojo.internal.bindings.bookmarks_api.mojom.BookmarkNodeChangedSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.bookmarks_api.mojom.BookmarkNodeChangedSpec.$ = {};
mojo.internal.bindings.bookmarks_api.mojom.BookmarksObserver = mojo.internal.bindings.bookmarks_api.mojom.BookmarksObserver || {};
mojo.internal.bindings.bookmarks_api.mojom.BookmarksObserverSpec = mojo.internal.bindings.bookmarks_api.mojom.BookmarksObserverSpec || { $ : {} };
if (mojo.internal.bindings.bookmarks_api.mojom.BookmarksObserverSpec.$.structSpec && mojo.internal.bindings.bookmarks_api.mojom.BookmarksObserverSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.bookmarks_api.mojom.BookmarksObserverSpec.$ = {};
mojo.internal.bindings.bookmarks_api.mojom.BookmarksObserver.$interfaceName = 'bookmarks_api.mojom.BookmarksObserver';
mojo.internal.bindings.bookmarks_api.mojom.BookmarksObserver_OnBookmarksEvents_ParamsSpec = mojo.internal.bindings.bookmarks_api.mojom.BookmarksObserver_OnBookmarksEvents_ParamsSpec || { $: {} };
if (mojo.internal.bindings.bookmarks_api.mojom.BookmarksObserver_OnBookmarksEvents_ParamsSpec.$.structSpec && mojo.internal.bindings.bookmarks_api.mojom.BookmarksObserver_OnBookmarksEvents_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.bookmarks_api.mojom.BookmarksObserver_OnBookmarksEvents_ParamsSpec.$ = {};
mojo.internal.bindings.bookmarks_api.mojom.BookmarksService = mojo.internal.bindings.bookmarks_api.mojom.BookmarksService || {};
mojo.internal.bindings.bookmarks_api.mojom.BookmarksServiceSpec = mojo.internal.bindings.bookmarks_api.mojom.BookmarksServiceSpec || { $ : {} };
if (mojo.internal.bindings.bookmarks_api.mojom.BookmarksServiceSpec.$.structSpec && mojo.internal.bindings.bookmarks_api.mojom.BookmarksServiceSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.bookmarks_api.mojom.BookmarksServiceSpec.$ = {};
mojo.internal.bindings.bookmarks_api.mojom.BookmarksService.$interfaceName = 'bookmarks_api.mojom.BookmarksService';
mojo.internal.bindings.bookmarks_api.mojom.BookmarksService_GetBookmarks_ParamsSpec = mojo.internal.bindings.bookmarks_api.mojom.BookmarksService_GetBookmarks_ParamsSpec || { $: {} };
if (mojo.internal.bindings.bookmarks_api.mojom.BookmarksService_GetBookmarks_ParamsSpec.$.structSpec && mojo.internal.bindings.bookmarks_api.mojom.BookmarksService_GetBookmarks_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.bookmarks_api.mojom.BookmarksService_GetBookmarks_ParamsSpec.$ = {};
mojo.internal.bindings.bookmarks_api.mojom.BookmarksService_GetBookmark_ParamsSpec = mojo.internal.bindings.bookmarks_api.mojom.BookmarksService_GetBookmark_ParamsSpec || { $: {} };
if (mojo.internal.bindings.bookmarks_api.mojom.BookmarksService_GetBookmark_ParamsSpec.$.structSpec && mojo.internal.bindings.bookmarks_api.mojom.BookmarksService_GetBookmark_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.bookmarks_api.mojom.BookmarksService_GetBookmark_ParamsSpec.$ = {};
mojo.internal.bindings.bookmarks_api.mojom.BookmarksService_CreateBookmarkNode_ParamsSpec = mojo.internal.bindings.bookmarks_api.mojom.BookmarksService_CreateBookmarkNode_ParamsSpec || { $: {} };
if (mojo.internal.bindings.bookmarks_api.mojom.BookmarksService_CreateBookmarkNode_ParamsSpec.$.structSpec && mojo.internal.bindings.bookmarks_api.mojom.BookmarksService_CreateBookmarkNode_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.bookmarks_api.mojom.BookmarksService_CreateBookmarkNode_ParamsSpec.$ = {};
mojo.internal.bindings.bookmarks_api.mojom.BookmarksService_UpdateBookmarkNode_ParamsSpec = mojo.internal.bindings.bookmarks_api.mojom.BookmarksService_UpdateBookmarkNode_ParamsSpec || { $: {} };
if (mojo.internal.bindings.bookmarks_api.mojom.BookmarksService_UpdateBookmarkNode_ParamsSpec.$.structSpec && mojo.internal.bindings.bookmarks_api.mojom.BookmarksService_UpdateBookmarkNode_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.bookmarks_api.mojom.BookmarksService_UpdateBookmarkNode_ParamsSpec.$ = {};
mojo.internal.bindings.bookmarks_api.mojom.BookmarksService_MoveBookmarkNode_ParamsSpec = mojo.internal.bindings.bookmarks_api.mojom.BookmarksService_MoveBookmarkNode_ParamsSpec || { $: {} };
if (mojo.internal.bindings.bookmarks_api.mojom.BookmarksService_MoveBookmarkNode_ParamsSpec.$.structSpec && mojo.internal.bindings.bookmarks_api.mojom.BookmarksService_MoveBookmarkNode_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.bookmarks_api.mojom.BookmarksService_MoveBookmarkNode_ParamsSpec.$ = {};
mojo.internal.bindings.bookmarks_api.mojom.BookmarksService_DeleteBookmarkNodes_ParamsSpec = mojo.internal.bindings.bookmarks_api.mojom.BookmarksService_DeleteBookmarkNodes_ParamsSpec || { $: {} };
if (mojo.internal.bindings.bookmarks_api.mojom.BookmarksService_DeleteBookmarkNodes_ParamsSpec.$.structSpec && mojo.internal.bindings.bookmarks_api.mojom.BookmarksService_DeleteBookmarkNodes_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.bookmarks_api.mojom.BookmarksService_DeleteBookmarkNodes_ParamsSpec.$ = {};

// External type stubs (from imports)
mojo.internal.bindings.bookmarks_api = mojo.internal.bindings.bookmarks_api || {};
mojo.internal.bindings.bookmarks_api.mojom = mojo.internal.bindings.bookmarks_api.mojom || {};
mojo.internal.bindings.bookmarks_api.mojom.BookmarkNodeSpec = mojo.internal.bindings.bookmarks_api.mojom.BookmarkNodeSpec || { $: mojo.internal.OpaqueStruct.$ };
mojo.internal.bindings.bookmarks_api = mojo.internal.bindings.bookmarks_api || {};
mojo.internal.bindings.bookmarks_api.mojom = mojo.internal.bindings.bookmarks_api.mojom || {};
mojo.internal.bindings.bookmarks_api.mojom.BookmarksEventSpec = mojo.internal.bindings.bookmarks_api.mojom.BookmarksEventSpec || { $: mojo.internal.OpaqueStruct.$ };
mojo.internal.bindings.mojo_base = mojo.internal.bindings.mojo_base || {};
mojo.internal.bindings.mojo_base.mojom = mojo.internal.bindings.mojo_base.mojom || {};
...
mojo.internal.bindings.bookmarks_api.mojom.PermanentFolderType = {
  kUnknown: 0,
  kBookmarkBar: 1,
  kOther: 2,
  kMobile: 3,
...
mojo.internal.bindings.bookmarks_api.mojom.BookmarksObserverPendingReceiver = class {
  constructor(handle) {
    this.handle = handle;
    if (handle) {
...
mojo.internal.bindings.bookmarks_api.mojom.BookmarksObserverRemote = class {
  static get $interfaceName() {
    return 'bookmarks_api.mojom.BookmarksObserver';
  }

  constructor(handle = undefined) {
    this.__mojoHandle = handle;
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.bookmarks_api.mojom.BookmarksObserverPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.bookmarks_api.mojom.BookmarksObserverRemoteCallHandler(this.proxy);
  }
  ...
  onBookmarksEvents(arg_events) {
    return this.$.onBookmarksEvents(arg_events);
  }
};

mojo.internal.bindings.bookmarks_api.mojom.BookmarksObserverRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('bookmarks_api.mojom.BookmarksObserver', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.bookmarks_api.mojom.BookmarksObserver.getRemote = function() {
  let remote = new mojo.internal.bindings.bookmarks_api.mojom.BookmarksObserverRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
    'bookmarks_api.mojom.BookmarksObserver',
    'context');
  return remote.$;
};

mojo.internal.bindings.bookmarks_api.mojom.BookmarksObserverReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('bookmarks_api.mojom.BookmarksObserver', [
      { explicit: null },
    ]);
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        case 0: {
          ...
          const params = decoder.decodeStructInline(mojo.internal.bindings.bookmarks_api.mojom.BookmarksObserver_OnBookmarksEvents_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.onBookmarksEvents');
          const result = this.impl.onBookmarksEvents(params.arg_events);
          break;
        }
      }
      } catch (err) {
...
mojo.internal.bindings.bookmarks_api.mojom.BookmarksObserverReceiver = mojo.internal.bindings.bookmarks_api.mojom.BookmarksObserverReceiver;

mojo.internal.bindings.bookmarks_api.mojom.BookmarksObserverPtr = mojo.internal.bindings.bookmarks_api.mojom.BookmarksObserverRemote;
mojo.internal.bindings.bookmarks_api.mojom.BookmarksObserverRequest = mojo.internal.bindings.bookmarks_api.mojom.BookmarksObserverPendingReceiver;


// Interface: BookmarksService
mojo.internal.bindings.bookmarks_api.mojom.BookmarksServicePendingReceiver = class {
  constructor(handle) {
    this.handle = handle;
    if (handle) {
      this.__mojoHandle = handle.router_ ? handle.router_.pipe_ : (handle.pipe_ || handle);
...
mojo.internal.bindings.bookmarks_api.mojom.BookmarksServiceRemote = class {
  static get $interfaceName() {
    return 'bookmarks_api.mojom.BookmarksService';
  }

  constructor(handle = undefined) {
    this.__mojoHandle = handle;
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.bookmarks_api.mojom.BookmarksServicePendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.bookmarks_api.mojom.BookmarksServiceRemoteCallHandler(this.proxy);
  }
  ...
  getBookmark(arg_id) {
    return this.$.getBookmark(arg_id);
  }
  createBookmarkNode(arg_parent_id, arg_index, arg_node) {
    return this.$.createBookmarkNode(arg_parent_id, arg_index, arg_node);
  }
  updateBookmarkNode(arg_node) {
    return this.$.updateBookmarkNode(arg_node);
  }
  moveBookmarkNode(arg_id, arg_new_parent_id, arg_index) {
    return this.$.moveBookmarkNode(arg_id, arg_new_parent_id, arg_index);
  }
  deleteBookmarkNodes(arg_ids) {
    return this.$.deleteBookmarkNodes(arg_ids);
  }
};

mojo.internal.bindings.bookmarks_api.mojom.BookmarksServiceRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('bookmarks_api.mojom.BookmarksService', [
      { explicit: null },
      { explicit: null },
      { explicit: null },
      { explicit: null },
  ...
  getBookmarks() {
    return this.proxy.sendMessage(
      this.ordinals[0],  // ordinal
      mojo.internal.bindings.bookmarks_api.mojom.BookmarksService_GetBookmarks_ParamsSpec,
      null,
      [],
      false);
  }
  ...
  getBookmark(arg_id) {
    return this.proxy.sendMessage(
      ...
      mojo.internal.bindings.bookmarks_api.mojom.BookmarksService_GetBookmark_ParamsSpec,
      null,
      [arg_id],
      false);
  }
  ...
  createBookmarkNode(arg_parent_id, arg_index, arg_node) {
    return this.proxy.sendMessage(
      ...
      mojo.internal.bindings.bookmarks_api.mojom.BookmarksService_CreateBookmarkNode_ParamsSpec,
      null,
      [arg_parent_id, arg_index, arg_node],
      false);
  }
  ...
  moveBookmarkNode(arg_id, arg_new_parent_id, arg_index) {
    return this.proxy.sendMessage(
      ...
      mojo.internal.bindings.bookmarks_api.mojom.BookmarksService_MoveBookmarkNode_ParamsSpec,
      null,
      [arg_id, arg_new_parent_id, arg_index],
      false);
  }
...
mojo.internal.bindings.bookmarks_api.mojom.BookmarksService.getRemote = function() {
  let remote = new mojo.internal.bindings.bookmarks_api.mojom.BookmarksServiceRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
...
mojo.internal.bindings.bookmarks_api.mojom.BookmarksServiceReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('bookmarks_api.mojom.BookmarksService', [
      { explicit: null },
      { explicit: null },
      { explicit: null },
      { explicit: null },
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.bookmarks_api.mojom.BookmarksService_GetBookmarks_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.getBookmarks');
          const result = this.impl.getBookmarks();
          break;
        }
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.bookmarks_api.mojom.BookmarksService_GetBookmark_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.getBookmark');
          const result = this.impl.getBookmark(params.arg_id);
          break;
        }
        case 2: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.bookmarks_api.mojom.BookmarksService_CreateBookmarkNode_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.createBookmarkNode');
          const result = this.impl.createBookmarkNode(params.arg_parent_id, params.arg_index, params.arg_node);
          break;
        }
        case 3: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.bookmarks_api.mojom.BookmarksService_UpdateBookmarkNode_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.updateBookmarkNode');
          const result = this.impl.updateBookmarkNode(params.arg_node);
          break;
        }
        case 4: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.bookmarks_api.mojom.BookmarksService_MoveBookmarkNode_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.moveBookmarkNode');
          const result = this.impl.moveBookmarkNode(params.arg_id, params.arg_new_parent_id, params.arg_index);
          break;
        }
        case 5: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.bookmarks_api.mojom.BookmarksService_DeleteBookmarkNodes_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.deleteBookmarkNodes');
          const result = this.impl.deleteBookmarkNodes(params.arg_ids);
          break;
        }
      }
      } catch (err) {
...
mojo.internal.bindings.bookmarks_api.mojom.BookmarksServiceReceiver = mojo.internal.bindings.bookmarks_api.mojom.BookmarksServiceReceiver;

mojo.internal.bindings.bookmarks_api.mojom.BookmarksServicePtr = mojo.internal.bindings.bookmarks_api.mojom.BookmarksServiceRemote;
mojo.internal.bindings.bookmarks_api.mojom.BookmarksServiceRequest = mojo.internal.bindings.bookmarks_api.mojom.BookmarksServicePendingReceiver;
...
// Union: BookmarkNode
mojo.internal.Union(
    mojo.internal.bindings.bookmarks_api.mojom.BookmarkNodeSpec, 'bookmarks_api.mojom.BookmarkNode', {
      'arg_url': {
        'ordinal': 0,
        'type': mojo.internal.bindings.bookmarks_api.mojom.UrlSpec,
        'nullable': false,
      },
      'arg_folder': {
        'ordinal': 1,
        'type': mojo.internal.bindings.bookmarks_api.mojom.FolderSpec,
        'nullable': false,
      },
    });
...
mojo.internal.Union(
    mojo.internal.bindings.bookmarks_api.mojom.BookmarksEventSpec, 'bookmarks_api.mojom.BookmarksEvent', {
      'arg_added': {
        'ordinal': 0,
        'type': mojo.internal.bindings.bookmarks_api.mojom.BookmarkNodeCreatedSpec,
        'nullable': false,
      },
      'arg_removed': {
        'ordinal': 1,
        'type': mojo.internal.bindings.bookmarks_api.mojom.BookmarkNodeRemovedSpec,
        'nullable': false,
      },
      'arg_moved': {
        'ordinal': 2,
        'type': mojo.internal.bindings.bookmarks_api.mojom.BookmarkNodeMovedSpec,
        'nullable': false,
      },
      'arg_changed': {
        'ordinal': 3,
        'type': mojo.internal.bindings.bookmarks_api.mojom.BookmarkNodeChangedSpec,
        'nullable': false,
      },
    });
...
mojo.internal.Struct(
    mojo.internal.bindings.bookmarks_api.mojom.LegacyFieldsSpec, 'bookmarks_api.mojom.LegacyFields', [
      ...
      mojo.internal.StructField('arg_id_$value', 8, 0, mojo.internal.Int64, 0, false, 0, { isPrimary: false, linkedValueFieldName: 'arg_id_$flag', originalFieldName: 'arg_id' }),
    ],
    [[0, 24]]);

// Struct: RootNode
mojo.internal.Struct(
    mojo.internal.bindings.bookmarks_api.mojom.RootNodeSpec, 'bookmarks_api.mojom.RootNode', [
      mojo.internal.StructField('arg_id', 0, 0, mojo.internal.bindings.mojo_base.mojom.UuidSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_children', 8, 0, mojo.internal.Array(mojo.internal.bindings.bookmarks_api.mojom.FolderSpec, false), null, false, 0, undefined),
    ],
    [[0, 24]]);

// Struct: Url
mojo.internal.Struct(
    mojo.internal.bindings.bookmarks_api.mojom.UrlSpec, 'bookmarks_api.mojom.Url', [
      mojo.internal.StructField('arg_id', 0, 0, mojo.internal.bindings.mojo_base.mojom.UuidSpec, null, true, 0, undefined),
      mojo.internal.StructField('arg_legacy', 8, 0, mojo.internal.bindings.bookmarks_api.mojom.LegacyFieldsSpec, null, true, 0, undefined),
      mojo.internal.StructField('arg_title', 16, 0, mojo.internal.String, null, false, 0, undefined),
      mojo.internal.StructField('arg_url', 24, 0, mojo.internal.bindings.bookmarks_api.mojom.UrlSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_favicon_url', 32, 0, mojo.internal.bindings.bookmarks_api.mojom.UrlSpec, null, true, 0, undefined),
      mojo.internal.StructField('arg_is_synced', 40, 0, mojo.internal.Bool, false, false, 0, undefined),
    ],
    [[0, 56]]);

// Struct: Folder
mojo.internal.Struct(
    mojo.internal.bindings.bookmarks_api.mojom.FolderSpec, 'bookmarks_api.mojom.Folder', [
      mojo.internal.StructField('arg_id', 0, 0, mojo.internal.bindings.mojo_base.mojom.UuidSpec, null, true, 0, undefined),
      mojo.internal.StructField('arg_legacy', 8, 0, mojo.internal.bindings.bookmarks_api.mojom.LegacyFieldsSpec, null, true, 0, undefined),
      mojo.internal.StructField('arg_title', 16, 0, mojo.internal.String, null, false, 0, undefined),
      mojo.internal.StructField('arg_children', 24, 0, mojo.internal.Array(mojo.internal.bindings.bookmarks_api.mojom.BookmarkNodeSpec, false), null, false, 0, undefined),
      mojo.internal.StructField('arg_permanent_folder_type', 32, 0, mojo.internal.bindings.bookmarks_api.mojom.PermanentFolderTypeSpec, null, true, 0, undefined),
      mojo.internal.StructField('arg_is_synced', 36, 0, mojo.internal.Bool, false, false, 0, undefined),
    ],
    [[0, 48]]);

// Struct: BookmarksSnapshot
mojo.internal.Struct(
    mojo.internal.bindings.bookmarks_api.mojom.BookmarksSnapshotSpec, 'bookmarks_api.mojom.BookmarksSnapshot', [
      mojo.internal.StructField('arg_root', 0, 0, mojo.internal.bindings.bookmarks_api.mojom.RootNodeSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_stream', 8, 0, mojo.internal.AssociatedInterfaceRequest(mojo.internal.bindings.bookmarks_api.mojom.BookmarksObserverPendingReceiver), null, false, 0, undefined),
    ],
    [[0, 24]]);

// Struct: BookmarkNodeCreated
mojo.internal.Struct(
    mojo.internal.bindings.bookmarks_api.mojom.BookmarkNodeCreatedSpec, 'bookmarks_api.mojom.BookmarkNodeCreated', [
      mojo.internal.StructField('arg_parent_id', 0, 0, mojo.internal.bindings.mojo_base.mojom.UuidSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_index', 8, 0, mojo.internal.Int32, 0, false, 0, undefined),
      mojo.internal.StructField('arg_node', 16, 0, mojo.internal.bindings.bookmarks_api.mojom.BookmarkNodeSpec, null, false, 0, undefined),
    ],
    [[0, 40]]);

// Struct: BookmarkNodeRemoved
mojo.internal.Struct(
    mojo.internal.bindings.bookmarks_api.mojom.BookmarkNodeRemovedSpec, 'bookmarks_api.mojom.BookmarkNodeRemoved', [
      mojo.internal.StructField('arg_id', 0, 0, mojo.internal.bindings.mojo_base.mojom.UuidSpec, null, false, 0, undefined),
    ],
    [[0, 16]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.bookmarks_api.mojom.BookmarkNodeMovedSpec, 'bookmarks_api.mojom.BookmarkNodeMoved', [
      mojo.internal.StructField('arg_old_parent_id', 0, 0, mojo.internal.bindings.mojo_base.mojom.UuidSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_old_index', 8, 0, mojo.internal.Int32, 0, false, 0, undefined),
      mojo.internal.StructField('arg_new_index', 12, 0, mojo.internal.Int32, 0, false, 0, undefined),
      mojo.internal.StructField('arg_new_parent_id', 16, 0, mojo.internal.bindings.mojo_base.mojom.UuidSpec, null, false, 0, undefined),
    ],
    [[0, 32]]);

// Struct: BookmarkNodeChanged
mojo.internal.Struct(
    mojo.internal.bindings.bookmarks_api.mojom.BookmarkNodeChangedSpec, 'bookmarks_api.mojom.BookmarkNodeChanged', [
      mojo.internal.StructField('arg_node', 0, 0, mojo.internal.bindings.bookmarks_api.mojom.BookmarkNodeSpec, null, false, 0, undefined),
    ],
    [[0, 24]]);
mojo.internal.Struct(
    mojo.internal.bindings.bookmarks_api.mojom.BookmarksObserver_OnBookmarksEvents_ParamsSpec, 'bookmarks_api.mojom.BookmarksObserver_OnBookmarksEvents_Params', [
      mojo.internal.StructField('arg_events', 0, 0, mojo.internal.Array(mojo.internal.bindings.bookmarks_api.mojom.BookmarksEventSpec, false), null, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.bookmarks_api.mojom.BookmarksService_GetBookmarks_ParamsSpec, 'bookmarks_api.mojom.BookmarksService_GetBookmarks_Params', [
    ],
    [[0, 8]]);

mojo.internal.Struct(
    mojo.internal.bindings.bookmarks_api.mojom.BookmarksService_GetBookmark_ParamsSpec, 'bookmarks_api.mojom.BookmarksService_GetBookmark_Params', [
      mojo.internal.StructField('arg_id', 0, 0, mojo.internal.bindings.mojo_base.mojom.UuidSpec, null, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.bookmarks_api.mojom.BookmarksService_CreateBookmarkNode_ParamsSpec, 'bookmarks_api.mojom.BookmarksService_CreateBookmarkNode_Params', [
      mojo.internal.StructField('arg_parent_id', 0, 0, mojo.internal.bindings.mojo_base.mojom.UuidSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_index_$flag', 8, 0, mojo.internal.Bool, false, false, 0, { isPrimary: true, linkedValueFieldName: 'arg_index_$value', originalFieldName: 'arg_index' }),
      mojo.internal.StructField('arg_index_$value', 12, 0, mojo.internal.Int32, 0, false, 0, { isPrimary: false, linkedValueFieldName: 'arg_index_$flag', originalFieldName: 'arg_index' }),
      mojo.internal.StructField('arg_node', 16, 0, mojo.internal.bindings.bookmarks_api.mojom.BookmarkNodeSpec, null, false, 0, undefined),
    ],
    [[0, 40]]);

mojo.internal.Struct(
    mojo.internal.bindings.bookmarks_api.mojom.BookmarksService_UpdateBookmarkNode_ParamsSpec, 'bookmarks_api.mojom.BookmarksService_UpdateBookmarkNode_Params', [
      mojo.internal.StructField('arg_node', 0, 0, mojo.internal.bindings.bookmarks_api.mojom.BookmarkNodeSpec, null, false, 0, undefined),
    ],
    [[0, 24]]);

mojo.internal.Struct(
    mojo.internal.bindings.bookmarks_api.mojom.BookmarksService_MoveBookmarkNode_ParamsSpec, 'bookmarks_api.mojom.BookmarksService_MoveBookmarkNode_Params', [
      mojo.internal.StructField('arg_id', 0, 0, mojo.internal.bindings.mojo_base.mojom.UuidSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_new_parent_id', 8, 0, mojo.internal.bindings.mojo_base.mojom.UuidSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_index_$flag', 16, 0, mojo.internal.Bool, false, false, 0, { isPrimary: true, linkedValueFieldName: 'arg_index_$value', originalFieldName: 'arg_index' }),
      mojo.internal.StructField('arg_index_$value', 20, 0, mojo.internal.Int32, 0, false, 0, { isPrimary: false, linkedValueFieldName: 'arg_index_$flag', originalFieldName: 'arg_index' }),
    ],
    [[0, 32]]);

mojo.internal.Struct(
    mojo.internal.bindings.bookmarks_api.mojom.BookmarksService_DeleteBookmarkNodes_ParamsSpec, 'bookmarks_api.mojom.BookmarksService_DeleteBookmarkNodes_Params', [
      mojo.internal.StructField('arg_ids', 0, 0, mojo.internal.Array(mojo.internal.bindings.mojo_base.mojom.UuidSpec, false), null, false, 0, undefined),
    ],
    [[0, 16]]);
