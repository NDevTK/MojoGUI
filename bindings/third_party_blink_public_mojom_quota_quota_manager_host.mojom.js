...
mojo.internal.bindings.blink.mojom.QuotaManagerHostRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('QuotaManagerHost', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.blink.mojom.QuotaManagerHostReceiver = class {
  constructor(impl) {
    ...
    const ordinals = window.mojoScrambler.getOrdinals('QuotaManagerHost', [
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.blink.mojom.QuotaManagerHost_QueryStorageUsageAndQuota_ParamsSpec);
