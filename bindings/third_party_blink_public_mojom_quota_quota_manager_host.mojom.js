...
mojo.internal.bindings.blink.mojom.QuotaManagerHost = {};
mojo.internal.bindings.blink.mojom.QuotaManagerHostSpec = { $ : {} };
mojo.internal.bindings.blink.mojom.QuotaManagerHost.$interfaceName = 'blink.mojom.QuotaManagerHost';
...
mojo.internal.bindings.blink.mojom.QuotaManagerHostRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.blink.mojom.QuotaManagerHostPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.blink.mojom.QuotaManagerHostRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.blink.mojom.QuotaManagerHostRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('blink.mojom.QuotaManagerHost', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.blink.mojom.QuotaManagerHost.getRemote = function() {
  let remote = new mojo.internal.bindings.blink.mojom.QuotaManagerHostRemote();
...
mojo.internal.bindings.blink.mojom.QuotaManagerHostReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('blink.mojom.QuotaManagerHost', [
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        // Try Method 0: QueryStorageUsageAndQuota
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.blink.mojom.QuotaManagerHost_QueryStorageUsageAndQuota_ParamsSpec.$.structSpec);
             console.log('[GeneratedReceiver] Discovery SUCCESS: ' + header.ordinal + ' -> QueryStorageUsageAndQuota (0)');
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.blink.mojom.QuotaManagerHost_QueryStorageUsageAndQuota_ParamsSpec.$.structSpec);
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.blink.mojom.QuotaManagerHost_QueryStorageUsageAndQuota_ResponseParamsSpec, header, rawHeader);
               responder(response);
...
mojo.internal.bindings.blink.mojom.QuotaManagerHostReceiver = mojo.internal.bindings.blink.mojom.QuotaManagerHostReceiver;
