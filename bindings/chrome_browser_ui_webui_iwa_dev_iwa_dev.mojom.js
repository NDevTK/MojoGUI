...
mojo.internal.bindings.iwa_dev.mojom.PageHandler_InstallAppFromUpdateManifest_ResponseParamsSpec = mojo.internal.bindings.iwa_dev.mojom.PageHandler_InstallAppFromUpdateManifest_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.iwa_dev.mojom.PageHandler_InstallAppFromUpdateManifest_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.iwa_dev.mojom.PageHandler_InstallAppFromUpdateManifest_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.iwa_dev.mojom.PageHandler_InstallAppFromUpdateManifest_ResponseParamsSpec.$ = {};
        ...
        case 2: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.iwa_dev.mojom.PageHandler_InstallAppFromUpdateManifest_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
            }).catch(e => console.error('[GeneratedReceiver] installAppFromUpdateManifest FAILED:', e));
          }
          break;
        }
        case 3: {
...
mojo.internal.Struct(
    mojo.internal.bindings.iwa_dev.mojom.PageHandler_InstallAppFromUpdateManifest_ResponseParamsSpec, 'iwa_dev.mojom.PageHandler_InstallAppFromUpdateManifest_ResponseParams', [
      mojo.internal.StructField('arg_error', 0, 0, mojo.internal.String, null, true, 0, undefined),
    ],
    [[0, 16]]);
