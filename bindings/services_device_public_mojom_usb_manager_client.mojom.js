...
mojo.internal.bindings.device.mojom.UsbDeviceManagerClient = {};
mojo.internal.bindings.device.mojom.UsbDeviceManagerClientSpec = { $ : {} };
mojo.internal.bindings.device.mojom.UsbDeviceManagerClient.$interfaceName = 'device.mojom.UsbDeviceManagerClient';
...
mojo.internal.bindings.device.mojom.UsbDeviceManagerClientRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.device.mojom.UsbDeviceManagerClientPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.device.mojom.UsbDeviceManagerClientRemoteCallHandler(this.proxy);
  }
  ...
  onDeviceAdded(arg_device_info) {
    return this.$.onDeviceAdded(arg_device_info);
  }
  onDeviceRemoved(arg_device_info) {
    return this.$.onDeviceRemoved(arg_device_info);
  }
};

mojo.internal.bindings.device.mojom.UsbDeviceManagerClientRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('device.mojom.UsbDeviceManagerClient', [
      { explicit: null },
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.device.mojom.UsbDeviceManagerClient.getRemote = function() {
  let remote = new mojo.internal.bindings.device.mojom.UsbDeviceManagerClientRemote();
...
mojo.internal.bindings.device.mojom.UsbDeviceManagerClientReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('device.mojom.UsbDeviceManagerClient', [
      { explicit: null },
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.device.mojom.UsbDeviceManagerClient_OnDeviceAdded_ParamsSpec.$.structSpec);
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.device.mojom.UsbDeviceManagerClient_OnDeviceRemoved_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.device.mojom.UsbDeviceManagerClientReceiver = mojo.internal.bindings.device.mojom.UsbDeviceManagerClientReceiver;
