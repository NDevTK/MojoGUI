...
mojo.internal.bindings.prerender.mojom.NoStatePrefetchMessagesRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.prerender.mojom.NoStatePrefetchMessagesPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.prerender.mojom.NoStatePrefetchMessagesRemoteCallHandler(this.proxy);
  }
  ...
  setIsNoStatePrefetching(arg_histogram_prefix) {
    return this.$.setIsNoStatePrefetching(arg_histogram_prefix);
  }
};

mojo.internal.bindings.prerender.mojom.NoStatePrefetchMessagesRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('prerender.mojom.NoStatePrefetchMessages', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.prerender.mojom.NoStatePrefetchMessages.getRemote = function() {
  let remote = new mojo.internal.bindings.prerender.mojom.NoStatePrefetchMessagesRemote();
...
mojo.internal.bindings.prerender.mojom.NoStatePrefetchMessagesReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('prerender.mojom.NoStatePrefetchMessages', [
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.prerender.mojom.NoStatePrefetchMessages_SetIsNoStatePrefetching_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for SetIsNoStatePrefetching failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.prerender.mojom.NoStatePrefetchMessagesReceiver = mojo.internal.bindings.prerender.mojom.NoStatePrefetchMessagesReceiver;
