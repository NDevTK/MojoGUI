...
mojo.internal.bindings.crosapi.mojom.GuestOsSkForwarderFactoryRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.crosapi.mojom.GuestOsSkForwarderFactoryPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.crosapi.mojom.GuestOsSkForwarderFactoryRemoteCallHandler(this.proxy);
  }
  ...
  bindGuestOsSkForwarder(arg_remote) {
    return this.$.bindGuestOsSkForwarder(arg_remote);
  }
};
...
mojo.internal.bindings.crosapi.mojom.GuestOsSkForwarderFactory.getRemote = function() {
  let remote = new mojo.internal.bindings.crosapi.mojom.GuestOsSkForwarderFactoryRemote();
...
mojo.internal.bindings.crosapi.mojom.GuestOsSkForwarderFactoryReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.crosapi.mojom.GuestOsSkForwarderFactory_BindGuestOsSkForwarder_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for BindGuestOsSkForwarder failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.crosapi.mojom.GuestOsSkForwarderFactoryReceiver = mojo.internal.bindings.crosapi.mojom.GuestOsSkForwarderFactoryReceiver;

mojo.internal.bindings.crosapi.mojom.GuestOsSkForwarderFactoryPtr = mojo.internal.bindings.crosapi.mojom.GuestOsSkForwarderFactoryRemote;
mojo.internal.bindings.crosapi.mojom.GuestOsSkForwarderFactoryRequest = mojo.internal.bindings.crosapi.mojom.GuestOsSkForwarderFactoryPendingReceiver;
...
mojo.internal.bindings.crosapi.mojom.GuestOsSkForwarderRemote = class {
  static get $interfaceName() {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.crosapi.mojom.GuestOsSkForwarderPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.crosapi.mojom.GuestOsSkForwarderRemoteCallHandler(this.proxy);
  }
  ...
  forwardRequest(arg_message) {
    return this.$.forwardRequest(arg_message);
  }
};
...
mojo.internal.bindings.crosapi.mojom.GuestOsSkForwarder.getRemote = function() {
  let remote = new mojo.internal.bindings.crosapi.mojom.GuestOsSkForwarderRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
...
mojo.internal.bindings.crosapi.mojom.GuestOsSkForwarderReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.crosapi.mojom.GuestOsSkForwarder_ForwardRequest_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for ForwardRequest failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
             console.warn('[GeneratedReceiver] Failed to discover ordinal ' + header.ordinal);
...
mojo.internal.bindings.crosapi.mojom.GuestOsSkForwarderReceiver = mojo.internal.bindings.crosapi.mojom.GuestOsSkForwarderReceiver;
