...
mojo.internal.Struct(
    mojo.internal.bindings.blink.mojom.FontUniqueNameLookup_GetUniqueNameLookupTableIfAvailable_ResponseParamsSpec, 'blink.mojom.FontUniqueNameLookup_GetUniqueNameLookupTableIfAvailable_ResponseParams', [
      ...
      mojo.internal.StructField('arg_sync_available', 8, 0, mojo.internal.Bool, false, false, 0, undefined),
    ],
    [[0, 24]]);
...
mojo.internal.bindings.blink.mojom.FontUniqueNameLookupRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.blink.mojom.FontUniqueNameLookupPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.blink.mojom.FontUniqueNameLookupRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.blink.mojom.FontUniqueNameLookup.getRemote = function() {
  let remote = new mojo.internal.bindings.blink.mojom.FontUniqueNameLookupRemote();
...
mojo.internal.bindings.blink.mojom.FontUniqueNameLookupReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.blink.mojom.FontUniqueNameLookup_GetUniqueNameLookupTableIfAvailable_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for GetUniqueNameLookupTableIfAvailable failed with TypeError');
           }
        }
        // Try Method 1: GetUniqueNameLookupTable
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.blink.mojom.FontUniqueNameLookup_GetUniqueNameLookupTable_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for GetUniqueNameLookupTable failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.blink.mojom.FontUniqueNameLookup_GetUniqueNameLookupTableIfAvailable_ParamsSpec.$.structSpec);
        ...
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.blink.mojom.FontUniqueNameLookup_GetUniqueNameLookupTable_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.blink.mojom.FontUniqueNameLookupReceiver = mojo.internal.bindings.blink.mojom.FontUniqueNameLookupReceiver;
