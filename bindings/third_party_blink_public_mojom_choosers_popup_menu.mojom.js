...
// Enum: Type
mojo.internal.bindings.blink.mojom.Type = {
  kOption: 0,
  kCheckableOption: 1,
  kGroup: 2,
  kSeparator: 3,
...
mojo.internal.Struct(
    mojo.internal.bindings.blink.mojom.MenuItemSpec, 'blink.mojom.MenuItem', [
      mojo.internal.StructField('arg_kOption', 0, 0, mojo.internal.Pointer, null, false, 0, undefined),
...
mojo.internal.bindings.blink.mojom.PopupMenuClientRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.blink.mojom.PopupMenuClientRemoteCallHandler(this.proxy);
  }
  ...
  didAcceptIndices(arg_indices) {
    return this.$.didAcceptIndices(arg_indices);
  }
  didCancel() {
...
mojo.internal.bindings.blink.mojom.PopupMenuClientRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('blink.mojom.PopupMenuClient', [
      { explicit: null },
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.blink.mojom.PopupMenuClient.getRemote = function() {
  let remote = new mojo.internal.bindings.blink.mojom.PopupMenuClientRemote();
...
mojo.internal.bindings.blink.mojom.PopupMenuClientReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('blink.mojom.PopupMenuClient', [
      { explicit: null },
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.blink.mojom.PopupMenuClient_DidAcceptIndices_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for DidAcceptIndices failed with TypeError');
           }
        }
        // Try Method 1: DidCancel
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.blink.mojom.PopupMenuClient_DidCancel_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for DidCancel failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
      ...
      switch (dispatchId) {
        ...
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.blink.mojom.PopupMenuClient_DidCancel_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.blink.mojom.PopupMenuClientReceiver = mojo.internal.bindings.blink.mojom.PopupMenuClientReceiver;
