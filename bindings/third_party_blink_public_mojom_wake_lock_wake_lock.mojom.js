...
mojo.internal.bindings.blink.mojom.WakeLockService = {};
mojo.internal.bindings.blink.mojom.WakeLockServiceSpec = { $ : {} };
mojo.internal.bindings.blink.mojom.WakeLockService.$interfaceName = 'blink.mojom.WakeLockService';
mojo.internal.bindings.blink.mojom.WakeLockService_GetWakeLock_ParamsSpec = { $: {} };
...
mojo.internal.bindings.blink.mojom.WakeLockServiceRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.blink.mojom.WakeLockServicePendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.blink.mojom.WakeLockServiceRemoteCallHandler(this.proxy);
  }
  ...
  getWakeLock(arg_type, arg_reason, arg_description, arg_wake_lock) {
    return this.$.getWakeLock(arg_type, arg_reason, arg_description, arg_wake_lock);
  }
};

mojo.internal.bindings.blink.mojom.WakeLockServiceRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('blink.mojom.WakeLockService', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.blink.mojom.WakeLockService.getRemote = function() {
  let remote = new mojo.internal.bindings.blink.mojom.WakeLockServiceRemote();
...
mojo.internal.bindings.blink.mojom.WakeLockServiceReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('blink.mojom.WakeLockService', [
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.blink.mojom.WakeLockService_GetWakeLock_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for GetWakeLock failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.blink.mojom.WakeLockServiceReceiver = mojo.internal.bindings.blink.mojom.WakeLockServiceReceiver;
