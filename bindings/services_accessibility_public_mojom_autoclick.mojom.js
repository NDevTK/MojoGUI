...
mojo.internal.bindings.ax.mojom.AutoclickPendingReceiver = class {
  constructor(handle) {
    this.handle = handle;
  }
};

mojo.internal.bindings.ax.mojom.AutoclickRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.ax.mojom.AutoclickPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.ax.mojom.AutoclickRemoteCallHandler(this.proxy);
  }
  ...
  requestScrollableBoundsForPoint(arg_point) {
    return this.$.requestScrollableBoundsForPoint(arg_point);
  }
};
...
mojo.internal.bindings.ax.mojom.Autoclick.getRemote = function() {
  let remote = new mojo.internal.bindings.ax.mojom.AutoclickRemote();
...
mojo.internal.bindings.ax.mojom.AutoclickReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ax.mojom.Autoclick_RequestScrollableBoundsForPoint_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for RequestScrollableBoundsForPoint failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.ax.mojom.AutoclickReceiver = mojo.internal.bindings.ax.mojom.AutoclickReceiver;

mojo.internal.bindings.ax.mojom.AutoclickPtr = mojo.internal.bindings.ax.mojom.AutoclickRemote;
mojo.internal.bindings.ax.mojom.AutoclickRequest = mojo.internal.bindings.ax.mojom.AutoclickPendingReceiver;
...
mojo.internal.Struct(
    mojo.internal.bindings.ax.mojom.AutoclickClient_BindAutoclick_ParamsSpec, 'ax.mojom.AutoclickClient_BindAutoclick_Params', [
    ],
    [[0, 8]]);
...
mojo.internal.bindings.ax.mojom.AutoclickClientPendingReceiver = class {
  constructor(handle) {
    this.handle = handle;
  }
};

mojo.internal.bindings.ax.mojom.AutoclickClientRemote = class {
  static get $interfaceName() {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.ax.mojom.AutoclickClientPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.ax.mojom.AutoclickClientRemoteCallHandler(this.proxy);
  }
  ...
  handleScrollableBoundsForPointFound(arg_bounds) {
    return this.$.handleScrollableBoundsForPointFound(arg_bounds);
  }
  bindAutoclick() {
...
mojo.internal.bindings.ax.mojom.AutoclickClient.getRemote = function() {
  let remote = new mojo.internal.bindings.ax.mojom.AutoclickClientRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
...
mojo.internal.bindings.ax.mojom.AutoclickClientReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ax.mojom.AutoclickClient_HandleScrollableBoundsForPointFound_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for HandleScrollableBoundsForPointFound failed with TypeError');
           }
        }
        // Try Method 1: BindAutoclick
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ax.mojom.AutoclickClient_BindAutoclick_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for BindAutoclick failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
             console.warn('[GeneratedReceiver] Failed to discover ordinal ' + header.ordinal);
      ...
      switch (dispatchId) {
        ...
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.ax.mojom.AutoclickClient_BindAutoclick_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.bindAutoclick');
          const result = this.impl.bindAutoclick();
          const expectsResponse = header.expectsResponse || (header.flags & 1);
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              this.endpoint.send(header.ordinal, header.requestId, mojo.internal.kMessageFlagIsResponse, mojo.internal.bindings.ax.mojom.AutoclickClient_BindAutoclick_ResponseParamsSpec, response);
...
mojo.internal.bindings.ax.mojom.AutoclickClientReceiver = mojo.internal.bindings.ax.mojom.AutoclickClientReceiver;

mojo.internal.bindings.ax.mojom.AutoclickClientPtr = mojo.internal.bindings.ax.mojom.AutoclickClientRemote;
mojo.internal.bindings.ax.mojom.AutoclickClientRequest = mojo.internal.bindings.ax.mojom.AutoclickClientPendingReceiver;
