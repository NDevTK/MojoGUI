...
mojo.internal.bindings.lobster = mojo.internal.bindings.lobster || {};
mojo.internal.bindings.lobster.mojom = mojo.internal.bindings.lobster.mojom || {};
mojo.internal.bindings.lobster.mojom.ResponseSpec = mojo.internal.bindings.lobster.mojom.ResponseSpec || { $: mojo.internal.OpaqueStruct.$ };
mojo.internal.bindings.url = mojo.internal.bindings.url || {};
...
mojo.internal.Struct(
    mojo.internal.bindings.lobster.mojom.ErrorSpec, 'lobster.mojom.Error', [
      ...
      mojo.internal.StructField('arg_code', 8, 0, mojo.internal.bindings.lobster.mojom.StatusCodeSpec, null, false, 0, undefined),
    ],
    [[0, 24]]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.lobster.mojom.UntrustedLobsterPageHandler_RequestCandidates_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for RequestCandidates failed with TypeError');
           }
        }
        // Try Method 1: DownloadCandidate
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.lobster.mojom.UntrustedLobsterPageHandler_DownloadCandidate_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for DownloadCandidate failed with TypeError');
           }
        }
        // Try Method 2: CommitAsInsert
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.lobster.mojom.UntrustedLobsterPageHandler_CommitAsInsert_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for CommitAsInsert failed with TypeError');
           }
        }
        // Try Method 3: CommitAsDownload
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.lobster.mojom.UntrustedLobsterPageHandler_CommitAsDownload_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for CommitAsDownload failed with TypeError');
           }
        }
        // Try Method 4: PreviewFeedback
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.lobster.mojom.UntrustedLobsterPageHandler_PreviewFeedback_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for PreviewFeedback failed with TypeError');
           }
        }
        // Try Method 5: SubmitFeedback
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.lobster.mojom.UntrustedLobsterPageHandler_SubmitFeedback_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for SubmitFeedback failed with TypeError');
           }
        }
        // Try Method 6: ShowUI
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.lobster.mojom.UntrustedLobsterPageHandler_ShowUI_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.lobster.mojom.UntrustedLobsterPageHandler_CloseUI_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for CloseUI failed with TypeError');
           }
        }
        // Try Method 8: EmitMetricEvent
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.lobster.mojom.UntrustedLobsterPageHandler_EmitMetricEvent_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for EmitMetricEvent failed with TypeError');
           }
        }
        // Try Method 9: OpenUrlInNewWindow
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.lobster.mojom.UntrustedLobsterPageHandler_OpenUrlInNewWindow_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OpenUrlInNewWindow failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
