...
// Enum: Status
mojo.internal.bindings.password_manager.mojom.Status = {
  kOK: 0,
  kSyntaxError: 1,
  kSemanticError: 2,
};
...
mojo.internal.Struct(
    mojo.internal.bindings.password_manager.mojom.CSVPasswordSequenceSpec, 'password_manager.mojom.CSVPasswordSequence', [
      mojo.internal.StructField('arg_csv_passwords', 0, 0, mojo.internal.Array(mojo.internal.bindings.mojo.internal.bindings.password_manager.mojom.CSVPasswordSpec.$, false), null, false, 0, undefined),
    ],
    [[0, 16]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.password_manager.mojom.CSVPasswordParser_ParseCSV_ResponseParamsSpec, 'password_manager.mojom.CSVPasswordParser_ParseCSV_ResponseParams', [
      mojo.internal.StructField('arg_sequence', 0, 0, mojo.internal.bindings.mojo.internal.bindings.password_manager.mojom.CSVPasswordSequenceSpec.$, null, true, 0, undefined),
    ],
    [[0, 16]]);
...
mojo.internal.bindings.password_manager.mojom.CSVPasswordParserRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.password_manager.mojom.CSVPasswordParserPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.password_manager.mojom.CSVPasswordParserRemoteCallHandler(this.proxy);
  }
  ...
  parseCSV(arg_raw_csv) {
    return this.$.parseCSV(arg_raw_csv);
  }
};
...
mojo.internal.bindings.password_manager.mojom.CSVPasswordParser.getRemote = function() {
  let remote = new mojo.internal.bindings.password_manager.mojom.CSVPasswordParserRemote();
...
mojo.internal.bindings.password_manager.mojom.CSVPasswordParserReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
        ...
        case 0: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.password_manager.mojom.CSVPasswordParser_ParseCSV_ResponseParamsSpec, header, rawHeader);
               responder(response);
...
mojo.internal.bindings.password_manager.mojom.CSVPasswordParserReceiver = mojo.internal.bindings.password_manager.mojom.CSVPasswordParserReceiver;
