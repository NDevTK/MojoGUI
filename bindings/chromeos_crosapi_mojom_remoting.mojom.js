...
mojo.internal.Struct(
    mojo.internal.bindings.crosapi.mojom.Remoting_GetSupportHostDetails_ParamsSpec, 'crosapi.mojom.Remoting_GetSupportHostDetails_Params', [
    ],
    [[0, 8]]);
...
mojo.internal.bindings.crosapi.mojom.RemotingRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.crosapi.mojom.RemotingPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.crosapi.mojom.RemotingRemoteCallHandler(this.proxy);
  }
  ...
  startSupportSession(arg_params) {
    return this.$.startSupportSession(arg_params);
  }
};

mojo.internal.bindings.crosapi.mojom.RemotingRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('crosapi.mojom.Remoting', [
      { explicit: 0 },
      { explicit: 1 },
    ]);
  }
...
mojo.internal.bindings.crosapi.mojom.Remoting.getRemote = function() {
  let remote = new mojo.internal.bindings.crosapi.mojom.RemotingRemote();
...
mojo.internal.bindings.crosapi.mojom.RemotingReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('crosapi.mojom.Remoting', [
      { explicit: 0 },
      { explicit: 1 },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        // Try Method 0: GetSupportHostDetails
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.crosapi.mojom.Remoting_GetSupportHostDetails_ParamsSpec.$.structSpec;
             ...
             if (sizeMatch && (!!(header.flags & 1) === methodExpectsResp)) {
               if (size > 8 || message.payload.byteLength === 8) {
                 ...
                 console.log('[GeneratedReceiver] Discovery SUCCESS: ' + header.ordinal + ' -> GetSupportHostDetails (0)');
                 this.mapOrdinal(header.ordinal, 0);
                 dispatchId = 0;
               }
             }
           } catch (e) {
             if (e instanceof TypeError) console.warn('[Discovery] trial for GetSupportHostDetails failed with TypeError');
           }
        }
        // Try Method 1: StartSupportSession
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.crosapi.mojom.Remoting_StartSupportSession_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (sizeMatch && (!!(header.flags & 1) === methodExpectsResp)) {
               if (size > 8 || message.payload.byteLength === 8) {
                 decoder.decodeStructInline(structSpec);
                 console.log('[GeneratedReceiver] Discovery SUCCESS: ' + header.ordinal + ' -> StartSupportSession (1)');
                 this.mapOrdinal(header.ordinal, 1);
                 dispatchId = 1;
               }
             }
           } catch (e) {
             if (e instanceof TypeError) console.warn('[Discovery] trial for StartSupportSession failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.crosapi.mojom.Remoting_GetSupportHostDetails_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.getSupportHostDetails');
          const result = this.impl.getSupportHostDetails();
          const expectsResponse = header.expectsResponse || (header.flags & 1);
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              this.endpoint.send(header.ordinal, header.requestId, mojo.internal.kMessageFlagIsResponse, mojo.internal.bindings.crosapi.mojom.Remoting_GetSupportHostDetails_ResponseParamsSpec, response);
        ...
        case 1: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              this.endpoint.send(header.ordinal, header.requestId, mojo.internal.kMessageFlagIsResponse, mojo.internal.bindings.crosapi.mojom.Remoting_StartSupportSession_ResponseParamsSpec, response);
...
mojo.internal.bindings.crosapi.mojom.RemotingReceiver = mojo.internal.bindings.crosapi.mojom.RemotingReceiver;

mojo.internal.bindings.crosapi.mojom.RemotingPtr = mojo.internal.bindings.crosapi.mojom.RemotingRemote;
mojo.internal.bindings.crosapi.mojom.RemotingRequest = mojo.internal.bindings.crosapi.mojom.RemotingPendingReceiver;
