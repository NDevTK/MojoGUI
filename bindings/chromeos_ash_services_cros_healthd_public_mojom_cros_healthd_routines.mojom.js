...
mojo.internal.bindings.ash.cros_healthd.mojom.ButtonTypeSpec = mojo.internal.bindings.ash.cros_healthd.mojom.ButtonTypeSpec || { $: mojo.internal.Enum().$ };
...
mojo.internal.bindings.ash.cros_healthd.mojom.ReasonSpec = mojo.internal.bindings.ash.cros_healthd.mojom.ReasonSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.ash.cros_healthd.mojom.StateSpec = mojo.internal.bindings.ash.cros_healthd.mojom.StateSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.ash.cros_healthd.mojom.StateSpec = mojo.internal.bindings.ash.cros_healthd.mojom.StateSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.ash.cros_healthd.mojom.MemtesterTestItemEnumSpec = mojo.internal.bindings.ash.cros_healthd.mojom.MemtesterTestItemEnumSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.ash.cros_healthd.mojom.PairErrorSpec = mojo.internal.bindings.ash.cros_healthd.mojom.PairErrorSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.ash.cros_healthd.mojom.ConnectErrorSpec = mojo.internal.bindings.ash.cros_healthd.mojom.ConnectErrorSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.ash.cros_healthd.mojom.AddressTypeSpec = mojo.internal.bindings.ash.cros_healthd.mojom.AddressTypeSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.ash.cros_healthd.mojom.CameraSubtestResultSpec = mojo.internal.bindings.ash.cros_healthd.mojom.CameraSubtestResultSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.ash.cros_healthd.mojom.DiskReadTypeEnumSpec = mojo.internal.bindings.ash.cros_healthd.mojom.DiskReadTypeEnumSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.ash.cros_healthd.mojom.LedNameSpec = mojo.internal.bindings.ash.cros_healthd.mojom.LedNameSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.ash.cros_healthd.mojom.LedColorSpec = mojo.internal.bindings.ash.cros_healthd.mojom.LedColorSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.ash.cros_healthd.mojom.HardwarePresenceStatusSpec = mojo.internal.bindings.ash.cros_healthd.mojom.HardwarePresenceStatusSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.ash.cros_healthd.mojom.TypeSpec = mojo.internal.bindings.ash.cros_healthd.mojom.TypeSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.ash.cros_healthd.mojom.IssueSpec = mojo.internal.bindings.ash.cros_healthd.mojom.IssueSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.ash.cros_healthd.mojom.RoutineArgumentSpec = mojo.internal.bindings.ash.cros_healthd.mojom.RoutineArgumentSpec || { $: {} };
if (mojo.internal.bindings.ash.cros_healthd.mojom.RoutineArgumentSpec.$.structSpec && mojo.internal.bindings.ash.cros_healthd.mojom.RoutineArgumentSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.cros_healthd.mojom.RoutineArgumentSpec.$ = {};
mojo.internal.bindings.ash.cros_healthd.mojom.RoutineStateUnionSpec = mojo.internal.bindings.ash.cros_healthd.mojom.RoutineStateUnionSpec || { $: {} };
if (mojo.internal.bindings.ash.cros_healthd.mojom.RoutineStateUnionSpec.$.structSpec && mojo.internal.bindings.ash.cros_healthd.mojom.RoutineStateUnionSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.cros_healthd.mojom.RoutineStateUnionSpec.$ = {};
mojo.internal.bindings.ash.cros_healthd.mojom.RoutineRunningInfoSpec = mojo.internal.bindings.ash.cros_healthd.mojom.RoutineRunningInfoSpec || { $: {} };
if (mojo.internal.bindings.ash.cros_healthd.mojom.RoutineRunningInfoSpec.$.structSpec && mojo.internal.bindings.ash.cros_healthd.mojom.RoutineRunningInfoSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.cros_healthd.mojom.RoutineRunningInfoSpec.$ = {};
mojo.internal.bindings.ash.cros_healthd.mojom.RoutineInteractionSpec = mojo.internal.bindings.ash.cros_healthd.mojom.RoutineInteractionSpec || { $: {} };
if (mojo.internal.bindings.ash.cros_healthd.mojom.RoutineInteractionSpec.$.structSpec && mojo.internal.bindings.ash.cros_healthd.mojom.RoutineInteractionSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.cros_healthd.mojom.RoutineInteractionSpec.$ = {};
mojo.internal.bindings.ash.cros_healthd.mojom.RoutineInquirySpec = mojo.internal.bindings.ash.cros_healthd.mojom.RoutineInquirySpec || { $: {} };
if (mojo.internal.bindings.ash.cros_healthd.mojom.RoutineInquirySpec.$.structSpec && mojo.internal.bindings.ash.cros_healthd.mojom.RoutineInquirySpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.cros_healthd.mojom.RoutineInquirySpec.$ = {};
mojo.internal.bindings.ash.cros_healthd.mojom.RoutineInquiryReplySpec = mojo.internal.bindings.ash.cros_healthd.mojom.RoutineInquiryReplySpec || { $: {} };
if (mojo.internal.bindings.ash.cros_healthd.mojom.RoutineInquiryReplySpec.$.structSpec && mojo.internal.bindings.ash.cros_healthd.mojom.RoutineInquiryReplySpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.cros_healthd.mojom.RoutineInquiryReplySpec.$ = {};
mojo.internal.bindings.ash.cros_healthd.mojom.RoutineDetailSpec = mojo.internal.bindings.ash.cros_healthd.mojom.RoutineDetailSpec || { $: {} };
if (mojo.internal.bindings.ash.cros_healthd.mojom.RoutineDetailSpec.$.structSpec && mojo.internal.bindings.ash.cros_healthd.mojom.RoutineDetailSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.cros_healthd.mojom.RoutineDetailSpec.$ = {};
mojo.internal.bindings.ash.cros_healthd.mojom.MemoryRoutineArgumentSpec = mojo.internal.bindings.ash.cros_healthd.mojom.MemoryRoutineArgumentSpec || { $: {} };
if (mojo.internal.bindings.ash.cros_healthd.mojom.MemoryRoutineArgumentSpec.$.structSpec && mojo.internal.bindings.ash.cros_healthd.mojom.MemoryRoutineArgumentSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.cros_healthd.mojom.MemoryRoutineArgumentSpec.$ = {};
mojo.internal.bindings.ash.cros_healthd.mojom.AudioDriverRoutineArgumentSpec = mojo.internal.bindings.ash.cros_healthd.mojom.AudioDriverRoutineArgumentSpec || { $: {} };
if (mojo.internal.bindings.ash.cros_healthd.mojom.AudioDriverRoutineArgumentSpec.$.structSpec && mojo.internal.bindings.ash.cros_healthd.mojom.AudioDriverRoutineArgumentSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.cros_healthd.mojom.AudioDriverRoutineArgumentSpec.$ = {};
mojo.internal.bindings.ash.cros_healthd.mojom.CpuStressRoutineArgumentSpec = mojo.internal.bindings.ash.cros_healthd.mojom.CpuStressRoutineArgumentSpec || { $: {} };
if (mojo.internal.bindings.ash.cros_healthd.mojom.CpuStressRoutineArgumentSpec.$.structSpec && mojo.internal.bindings.ash.cros_healthd.mojom.CpuStressRoutineArgumentSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.cros_healthd.mojom.CpuStressRoutineArgumentSpec.$ = {};
mojo.internal.bindings.ash.cros_healthd.mojom.UfsLifetimeRoutineArgumentSpec = mojo.internal.bindings.ash.cros_healthd.mojom.UfsLifetimeRoutineArgumentSpec || { $: {} };
if (mojo.internal.bindings.ash.cros_healthd.mojom.UfsLifetimeRoutineArgumentSpec.$.structSpec && mojo.internal.bindings.ash.cros_healthd.mojom.UfsLifetimeRoutineArgumentSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.cros_healthd.mojom.UfsLifetimeRoutineArgumentSpec.$ = {};
mojo.internal.bindings.ash.cros_healthd.mojom.DiskReadRoutineArgumentSpec = mojo.internal.bindings.ash.cros_healthd.mojom.DiskReadRoutineArgumentSpec || { $: {} };
if (mojo.internal.bindings.ash.cros_healthd.mojom.DiskReadRoutineArgumentSpec.$.structSpec && mojo.internal.bindings.ash.cros_healthd.mojom.DiskReadRoutineArgumentSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.cros_healthd.mojom.DiskReadRoutineArgumentSpec.$ = {};
mojo.internal.bindings.ash.cros_healthd.mojom.CpuCacheRoutineArgumentSpec = mojo.internal.bindings.ash.cros_healthd.mojom.CpuCacheRoutineArgumentSpec || { $: {} };
if (mojo.internal.bindings.ash.cros_healthd.mojom.CpuCacheRoutineArgumentSpec.$.structSpec && mojo.internal.bindings.ash.cros_healthd.mojom.CpuCacheRoutineArgumentSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.cros_healthd.mojom.CpuCacheRoutineArgumentSpec.$ = {};
mojo.internal.bindings.ash.cros_healthd.mojom.PrimeSearchRoutineArgumentSpec = mojo.internal.bindings.ash.cros_healthd.mojom.PrimeSearchRoutineArgumentSpec || { $: {} };
if (mojo.internal.bindings.ash.cros_healthd.mojom.PrimeSearchRoutineArgumentSpec.$.structSpec && mojo.internal.bindings.ash.cros_healthd.mojom.PrimeSearchRoutineArgumentSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.cros_healthd.mojom.PrimeSearchRoutineArgumentSpec.$ = {};
mojo.internal.bindings.ash.cros_healthd.mojom.VolumeButtonRoutineArgumentSpec = mojo.internal.bindings.ash.cros_healthd.mojom.VolumeButtonRoutineArgumentSpec || { $: {} };
if (mojo.internal.bindings.ash.cros_healthd.mojom.VolumeButtonRoutineArgumentSpec.$.structSpec && mojo.internal.bindings.ash.cros_healthd.mojom.VolumeButtonRoutineArgumentSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.cros_healthd.mojom.VolumeButtonRoutineArgumentSpec.$ = {};
mojo.internal.bindings.ash.cros_healthd.mojom.LedLitUpRoutineArgumentSpec = mojo.internal.bindings.ash.cros_healthd.mojom.LedLitUpRoutineArgumentSpec || { $: {} };
if (mojo.internal.bindings.ash.cros_healthd.mojom.LedLitUpRoutineArgumentSpec.$.structSpec && mojo.internal.bindings.ash.cros_healthd.mojom.LedLitUpRoutineArgumentSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.cros_healthd.mojom.LedLitUpRoutineArgumentSpec.$ = {};
mojo.internal.bindings.ash.cros_healthd.mojom.KeyboardBacklightRoutineArgumentSpec = mojo.internal.bindings.ash.cros_healthd.mojom.KeyboardBacklightRoutineArgumentSpec || { $: {} };
if (mojo.internal.bindings.ash.cros_healthd.mojom.KeyboardBacklightRoutineArgumentSpec.$.structSpec && mojo.internal.bindings.ash.cros_healthd.mojom.KeyboardBacklightRoutineArgumentSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.cros_healthd.mojom.KeyboardBacklightRoutineArgumentSpec.$ = {};
mojo.internal.bindings.ash.cros_healthd.mojom.FloatingPointRoutineArgumentSpec = mojo.internal.bindings.ash.cros_healthd.mojom.FloatingPointRoutineArgumentSpec || { $: {} };
if (mojo.internal.bindings.ash.cros_healthd.mojom.FloatingPointRoutineArgumentSpec.$.structSpec && mojo.internal.bindings.ash.cros_healthd.mojom.FloatingPointRoutineArgumentSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.cros_healthd.mojom.FloatingPointRoutineArgumentSpec.$ = {};
mojo.internal.bindings.ash.cros_healthd.mojom.BluetoothPowerRoutineArgumentSpec = mojo.internal.bindings.ash.cros_healthd.mojom.BluetoothPowerRoutineArgumentSpec || { $: {} };
if (mojo.internal.bindings.ash.cros_healthd.mojom.BluetoothPowerRoutineArgumentSpec.$.structSpec && mojo.internal.bindings.ash.cros_healthd.mojom.BluetoothPowerRoutineArgumentSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.cros_healthd.mojom.BluetoothPowerRoutineArgumentSpec.$ = {};
mojo.internal.bindings.ash.cros_healthd.mojom.BluetoothDiscoveryRoutineArgumentSpec = mojo.internal.bindings.ash.cros_healthd.mojom.BluetoothDiscoveryRoutineArgumentSpec || { $: {} };
if (mojo.internal.bindings.ash.cros_healthd.mojom.BluetoothDiscoveryRoutineArgumentSpec.$.structSpec && mojo.internal.bindings.ash.cros_healthd.mojom.BluetoothDiscoveryRoutineArgumentSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.cros_healthd.mojom.BluetoothDiscoveryRoutineArgumentSpec.$ = {};
mojo.internal.bindings.ash.cros_healthd.mojom.FanRoutineArgumentSpec = mojo.internal.bindings.ash.cros_healthd.mojom.FanRoutineArgumentSpec || { $: {} };
if (mojo.internal.bindings.ash.cros_healthd.mojom.FanRoutineArgumentSpec.$.structSpec && mojo.internal.bindings.ash.cros_healthd.mojom.FanRoutineArgumentSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.cros_healthd.mojom.FanRoutineArgumentSpec.$ = {};
mojo.internal.bindings.ash.cros_healthd.mojom.BluetoothScanningRoutineArgumentSpec = mojo.internal.bindings.ash.cros_healthd.mojom.BluetoothScanningRoutineArgumentSpec || { $: {} };
if (mojo.internal.bindings.ash.cros_healthd.mojom.BluetoothScanningRoutineArgumentSpec.$.structSpec && mojo.internal.bindings.ash.cros_healthd.mojom.BluetoothScanningRoutineArgumentSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.cros_healthd.mojom.BluetoothScanningRoutineArgumentSpec.$ = {};
mojo.internal.bindings.ash.cros_healthd.mojom.BluetoothPairingRoutineArgumentSpec = mojo.internal.bindings.ash.cros_healthd.mojom.BluetoothPairingRoutineArgumentSpec || { $: {} };
if (mojo.internal.bindings.ash.cros_healthd.mojom.BluetoothPairingRoutineArgumentSpec.$.structSpec && mojo.internal.bindings.ash.cros_healthd.mojom.BluetoothPairingRoutineArgumentSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.cros_healthd.mojom.BluetoothPairingRoutineArgumentSpec.$ = {};
mojo.internal.bindings.ash.cros_healthd.mojom.CameraAvailabilityRoutineArgumentSpec = mojo.internal.bindings.ash.cros_healthd.mojom.CameraAvailabilityRoutineArgumentSpec || { $: {} };
if (mojo.internal.bindings.ash.cros_healthd.mojom.CameraAvailabilityRoutineArgumentSpec.$.structSpec && mojo.internal.bindings.ash.cros_healthd.mojom.CameraAvailabilityRoutineArgumentSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.cros_healthd.mojom.CameraAvailabilityRoutineArgumentSpec.$ = {};
mojo.internal.bindings.ash.cros_healthd.mojom.UrandomRoutineArgumentSpec = mojo.internal.bindings.ash.cros_healthd.mojom.UrandomRoutineArgumentSpec || { $: {} };
if (mojo.internal.bindings.ash.cros_healthd.mojom.UrandomRoutineArgumentSpec.$.structSpec && mojo.internal.bindings.ash.cros_healthd.mojom.UrandomRoutineArgumentSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.cros_healthd.mojom.UrandomRoutineArgumentSpec.$ = {};
mojo.internal.bindings.ash.cros_healthd.mojom.NetworkBandwidthRoutineArgumentSpec = mojo.internal.bindings.ash.cros_healthd.mojom.NetworkBandwidthRoutineArgumentSpec || { $: {} };
if (mojo.internal.bindings.ash.cros_healthd.mojom.NetworkBandwidthRoutineArgumentSpec.$.structSpec && mojo.internal.bindings.ash.cros_healthd.mojom.NetworkBandwidthRoutineArgumentSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.cros_healthd.mojom.NetworkBandwidthRoutineArgumentSpec.$ = {};
mojo.internal.bindings.ash.cros_healthd.mojom.SensitiveSensorRoutineArgumentSpec = mojo.internal.bindings.ash.cros_healthd.mojom.SensitiveSensorRoutineArgumentSpec || { $: {} };
if (mojo.internal.bindings.ash.cros_healthd.mojom.SensitiveSensorRoutineArgumentSpec.$.structSpec && mojo.internal.bindings.ash.cros_healthd.mojom.SensitiveSensorRoutineArgumentSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.cros_healthd.mojom.SensitiveSensorRoutineArgumentSpec.$ = {};
mojo.internal.bindings.ash.cros_healthd.mojom.CameraFrameAnalysisRoutineArgumentSpec = mojo.internal.bindings.ash.cros_healthd.mojom.CameraFrameAnalysisRoutineArgumentSpec || { $: {} };
if (mojo.internal.bindings.ash.cros_healthd.mojom.CameraFrameAnalysisRoutineArgumentSpec.$.structSpec && mojo.internal.bindings.ash.cros_healthd.mojom.CameraFrameAnalysisRoutineArgumentSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.cros_healthd.mojom.CameraFrameAnalysisRoutineArgumentSpec.$ = {};
mojo.internal.bindings.ash.cros_healthd.mojom.BatteryDischargeRoutineArgumentSpec = mojo.internal.bindings.ash.cros_healthd.mojom.BatteryDischargeRoutineArgumentSpec || { $: {} };
if (mojo.internal.bindings.ash.cros_healthd.mojom.BatteryDischargeRoutineArgumentSpec.$.structSpec && mojo.internal.bindings.ash.cros_healthd.mojom.BatteryDischargeRoutineArgumentSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.cros_healthd.mojom.BatteryDischargeRoutineArgumentSpec.$ = {};
mojo.internal.bindings.ash.cros_healthd.mojom.RoutineStateSpec = mojo.internal.bindings.ash.cros_healthd.mojom.RoutineStateSpec || { $: {} };
if (mojo.internal.bindings.ash.cros_healthd.mojom.RoutineStateSpec.$.structSpec && mojo.internal.bindings.ash.cros_healthd.mojom.RoutineStateSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.cros_healthd.mojom.RoutineStateSpec.$ = {};
mojo.internal.bindings.ash.cros_healthd.mojom.RoutineStateInitializedSpec = mojo.internal.bindings.ash.cros_healthd.mojom.RoutineStateInitializedSpec || { $: {} };
if (mojo.internal.bindings.ash.cros_healthd.mojom.RoutineStateInitializedSpec.$.structSpec && mojo.internal.bindings.ash.cros_healthd.mojom.RoutineStateInitializedSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.cros_healthd.mojom.RoutineStateInitializedSpec.$ = {};
mojo.internal.bindings.ash.cros_healthd.mojom.RoutineStateRunningSpec = mojo.internal.bindings.ash.cros_healthd.mojom.RoutineStateRunningSpec || { $: {} };
if (mojo.internal.bindings.ash.cros_healthd.mojom.RoutineStateRunningSpec.$.structSpec && mojo.internal.bindings.ash.cros_healthd.mojom.RoutineStateRunningSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.cros_healthd.mojom.RoutineStateRunningSpec.$ = {};
mojo.internal.bindings.ash.cros_healthd.mojom.NetworkBandwidthRoutineRunningInfoSpec = mojo.internal.bindings.ash.cros_healthd.mojom.NetworkBandwidthRoutineRunningInfoSpec || { $: {} };
if (mojo.internal.bindings.ash.cros_healthd.mojom.NetworkBandwidthRoutineRunningInfoSpec.$.structSpec && mojo.internal.bindings.ash.cros_healthd.mojom.NetworkBandwidthRoutineRunningInfoSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.cros_healthd.mojom.NetworkBandwidthRoutineRunningInfoSpec.$ = {};
mojo.internal.bindings.ash.cros_healthd.mojom.RoutineStateWaitingSpec = mojo.internal.bindings.ash.cros_healthd.mojom.RoutineStateWaitingSpec || { $: {} };
if (mojo.internal.bindings.ash.cros_healthd.mojom.RoutineStateWaitingSpec.$.structSpec && mojo.internal.bindings.ash.cros_healthd.mojom.RoutineStateWaitingSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.cros_healthd.mojom.RoutineStateWaitingSpec.$ = {};
mojo.internal.bindings.ash.cros_healthd.mojom.CheckLedLitUpStateInquirySpec = mojo.internal.bindings.ash.cros_healthd.mojom.CheckLedLitUpStateInquirySpec || { $: {} };
if (mojo.internal.bindings.ash.cros_healthd.mojom.CheckLedLitUpStateInquirySpec.$.structSpec && mojo.internal.bindings.ash.cros_healthd.mojom.CheckLedLitUpStateInquirySpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.cros_healthd.mojom.CheckLedLitUpStateInquirySpec.$ = {};
mojo.internal.bindings.ash.cros_healthd.mojom.CheckLedLitUpStateReplySpec = mojo.internal.bindings.ash.cros_healthd.mojom.CheckLedLitUpStateReplySpec || { $: {} };
if (mojo.internal.bindings.ash.cros_healthd.mojom.CheckLedLitUpStateReplySpec.$.structSpec && mojo.internal.bindings.ash.cros_healthd.mojom.CheckLedLitUpStateReplySpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.cros_healthd.mojom.CheckLedLitUpStateReplySpec.$ = {};
mojo.internal.bindings.ash.cros_healthd.mojom.UnplugAcAdapterInquirySpec = mojo.internal.bindings.ash.cros_healthd.mojom.UnplugAcAdapterInquirySpec || { $: {} };
if (mojo.internal.bindings.ash.cros_healthd.mojom.UnplugAcAdapterInquirySpec.$.structSpec && mojo.internal.bindings.ash.cros_healthd.mojom.UnplugAcAdapterInquirySpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.cros_healthd.mojom.UnplugAcAdapterInquirySpec.$ = {};
mojo.internal.bindings.ash.cros_healthd.mojom.UnplugAcAdapterReplySpec = mojo.internal.bindings.ash.cros_healthd.mojom.UnplugAcAdapterReplySpec || { $: {} };
if (mojo.internal.bindings.ash.cros_healthd.mojom.UnplugAcAdapterReplySpec.$.structSpec && mojo.internal.bindings.ash.cros_healthd.mojom.UnplugAcAdapterReplySpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.cros_healthd.mojom.UnplugAcAdapterReplySpec.$ = {};
mojo.internal.bindings.ash.cros_healthd.mojom.CheckKeyboardBacklightStateInquirySpec = mojo.internal.bindings.ash.cros_healthd.mojom.CheckKeyboardBacklightStateInquirySpec || { $: {} };
if (mojo.internal.bindings.ash.cros_healthd.mojom.CheckKeyboardBacklightStateInquirySpec.$.structSpec && mojo.internal.bindings.ash.cros_healthd.mojom.CheckKeyboardBacklightStateInquirySpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.cros_healthd.mojom.CheckKeyboardBacklightStateInquirySpec.$ = {};
mojo.internal.bindings.ash.cros_healthd.mojom.CheckKeyboardBacklightStateReplySpec = mojo.internal.bindings.ash.cros_healthd.mojom.CheckKeyboardBacklightStateReplySpec || { $: {} };
if (mojo.internal.bindings.ash.cros_healthd.mojom.CheckKeyboardBacklightStateReplySpec.$.structSpec && mojo.internal.bindings.ash.cros_healthd.mojom.CheckKeyboardBacklightStateReplySpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.cros_healthd.mojom.CheckKeyboardBacklightStateReplySpec.$ = {};
mojo.internal.bindings.ash.cros_healthd.mojom.RoutineStateFinishedSpec = mojo.internal.bindings.ash.cros_healthd.mojom.RoutineStateFinishedSpec || { $: {} };
if (mojo.internal.bindings.ash.cros_healthd.mojom.RoutineStateFinishedSpec.$.structSpec && mojo.internal.bindings.ash.cros_healthd.mojom.RoutineStateFinishedSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.cros_healthd.mojom.RoutineStateFinishedSpec.$ = {};
mojo.internal.bindings.ash.cros_healthd.mojom.MemoryRoutineDetailSpec = mojo.internal.bindings.ash.cros_healthd.mojom.MemoryRoutineDetailSpec || { $: {} };
if (mojo.internal.bindings.ash.cros_healthd.mojom.MemoryRoutineDetailSpec.$.structSpec && mojo.internal.bindings.ash.cros_healthd.mojom.MemoryRoutineDetailSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.cros_healthd.mojom.MemoryRoutineDetailSpec.$ = {};
mojo.internal.bindings.ash.cros_healthd.mojom.AudioDriverRoutineDetailSpec = mojo.internal.bindings.ash.cros_healthd.mojom.AudioDriverRoutineDetailSpec || { $: {} };
if (mojo.internal.bindings.ash.cros_healthd.mojom.AudioDriverRoutineDetailSpec.$.structSpec && mojo.internal.bindings.ash.cros_healthd.mojom.AudioDriverRoutineDetailSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.cros_healthd.mojom.AudioDriverRoutineDetailSpec.$ = {};
mojo.internal.bindings.ash.cros_healthd.mojom.UfsLifetimeRoutineDetailSpec = mojo.internal.bindings.ash.cros_healthd.mojom.UfsLifetimeRoutineDetailSpec || { $: {} };
if (mojo.internal.bindings.ash.cros_healthd.mojom.UfsLifetimeRoutineDetailSpec.$.structSpec && mojo.internal.bindings.ash.cros_healthd.mojom.UfsLifetimeRoutineDetailSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.cros_healthd.mojom.UfsLifetimeRoutineDetailSpec.$ = {};
mojo.internal.bindings.ash.cros_healthd.mojom.MemtesterResultSpec = mojo.internal.bindings.ash.cros_healthd.mojom.MemtesterResultSpec || { $: {} };
if (mojo.internal.bindings.ash.cros_healthd.mojom.MemtesterResultSpec.$.structSpec && mojo.internal.bindings.ash.cros_healthd.mojom.MemtesterResultSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.cros_healthd.mojom.MemtesterResultSpec.$ = {};
mojo.internal.bindings.ash.cros_healthd.mojom.BluetoothPoweredDetailSpec = mojo.internal.bindings.ash.cros_healthd.mojom.BluetoothPoweredDetailSpec || { $: {} };
if (mojo.internal.bindings.ash.cros_healthd.mojom.BluetoothPoweredDetailSpec.$.structSpec && mojo.internal.bindings.ash.cros_healthd.mojom.BluetoothPoweredDetailSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.cros_healthd.mojom.BluetoothPoweredDetailSpec.$ = {};
mojo.internal.bindings.ash.cros_healthd.mojom.BluetoothPowerRoutineDetailSpec = mojo.internal.bindings.ash.cros_healthd.mojom.BluetoothPowerRoutineDetailSpec || { $: {} };
if (mojo.internal.bindings.ash.cros_healthd.mojom.BluetoothPowerRoutineDetailSpec.$.structSpec && mojo.internal.bindings.ash.cros_healthd.mojom.BluetoothPowerRoutineDetailSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.cros_healthd.mojom.BluetoothPowerRoutineDetailSpec.$ = {};
mojo.internal.bindings.ash.cros_healthd.mojom.BluetoothDiscoveringDetailSpec = mojo.internal.bindings.ash.cros_healthd.mojom.BluetoothDiscoveringDetailSpec || { $: {} };
if (mojo.internal.bindings.ash.cros_healthd.mojom.BluetoothDiscoveringDetailSpec.$.structSpec && mojo.internal.bindings.ash.cros_healthd.mojom.BluetoothDiscoveringDetailSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.cros_healthd.mojom.BluetoothDiscoveringDetailSpec.$ = {};
mojo.internal.bindings.ash.cros_healthd.mojom.BluetoothDiscoveryRoutineDetailSpec = mojo.internal.bindings.ash.cros_healthd.mojom.BluetoothDiscoveryRoutineDetailSpec || { $: {} };
if (mojo.internal.bindings.ash.cros_healthd.mojom.BluetoothDiscoveryRoutineDetailSpec.$.structSpec && mojo.internal.bindings.ash.cros_healthd.mojom.BluetoothDiscoveryRoutineDetailSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.cros_healthd.mojom.BluetoothDiscoveryRoutineDetailSpec.$ = {};
mojo.internal.bindings.ash.cros_healthd.mojom.BluetoothScannedPeripheralInfoSpec = mojo.internal.bindings.ash.cros_healthd.mojom.BluetoothScannedPeripheralInfoSpec || { $: {} };
if (mojo.internal.bindings.ash.cros_healthd.mojom.BluetoothScannedPeripheralInfoSpec.$.structSpec && mojo.internal.bindings.ash.cros_healthd.mojom.BluetoothScannedPeripheralInfoSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.cros_healthd.mojom.BluetoothScannedPeripheralInfoSpec.$ = {};
mojo.internal.bindings.ash.cros_healthd.mojom.BluetoothScanningRoutineDetailSpec = mojo.internal.bindings.ash.cros_healthd.mojom.BluetoothScanningRoutineDetailSpec || { $: {} };
if (mojo.internal.bindings.ash.cros_healthd.mojom.BluetoothScanningRoutineDetailSpec.$.structSpec && mojo.internal.bindings.ash.cros_healthd.mojom.BluetoothScanningRoutineDetailSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.cros_healthd.mojom.BluetoothScanningRoutineDetailSpec.$ = {};
mojo.internal.bindings.ash.cros_healthd.mojom.BluetoothPairingPeripheralInfoSpec = mojo.internal.bindings.ash.cros_healthd.mojom.BluetoothPairingPeripheralInfoSpec || { $: {} };
if (mojo.internal.bindings.ash.cros_healthd.mojom.BluetoothPairingPeripheralInfoSpec.$.structSpec && mojo.internal.bindings.ash.cros_healthd.mojom.BluetoothPairingPeripheralInfoSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.cros_healthd.mojom.BluetoothPairingPeripheralInfoSpec.$ = {};
mojo.internal.bindings.ash.cros_healthd.mojom.BluetoothPairingRoutineDetailSpec = mojo.internal.bindings.ash.cros_healthd.mojom.BluetoothPairingRoutineDetailSpec || { $: {} };
if (mojo.internal.bindings.ash.cros_healthd.mojom.BluetoothPairingRoutineDetailSpec.$.structSpec && mojo.internal.bindings.ash.cros_healthd.mojom.BluetoothPairingRoutineDetailSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.cros_healthd.mojom.BluetoothPairingRoutineDetailSpec.$ = {};
mojo.internal.bindings.ash.cros_healthd.mojom.CameraAvailabilityRoutineDetailSpec = mojo.internal.bindings.ash.cros_healthd.mojom.CameraAvailabilityRoutineDetailSpec || { $: {} };
if (mojo.internal.bindings.ash.cros_healthd.mojom.CameraAvailabilityRoutineDetailSpec.$.structSpec && mojo.internal.bindings.ash.cros_healthd.mojom.CameraAvailabilityRoutineDetailSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.cros_healthd.mojom.CameraAvailabilityRoutineDetailSpec.$ = {};
mojo.internal.bindings.ash.cros_healthd.mojom.BatteryDischargeRoutineDetailSpec = mojo.internal.bindings.ash.cros_healthd.mojom.BatteryDischargeRoutineDetailSpec || { $: {} };
if (mojo.internal.bindings.ash.cros_healthd.mojom.BatteryDischargeRoutineDetailSpec.$.structSpec && mojo.internal.bindings.ash.cros_healthd.mojom.BatteryDischargeRoutineDetailSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.cros_healthd.mojom.BatteryDischargeRoutineDetailSpec.$ = {};
mojo.internal.bindings.ash.cros_healthd.mojom.FanRoutineDetailSpec = mojo.internal.bindings.ash.cros_healthd.mojom.FanRoutineDetailSpec || { $: {} };
if (mojo.internal.bindings.ash.cros_healthd.mojom.FanRoutineDetailSpec.$.structSpec && mojo.internal.bindings.ash.cros_healthd.mojom.FanRoutineDetailSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.cros_healthd.mojom.FanRoutineDetailSpec.$ = {};
mojo.internal.bindings.ash.cros_healthd.mojom.NetworkBandwidthRoutineDetailSpec = mojo.internal.bindings.ash.cros_healthd.mojom.NetworkBandwidthRoutineDetailSpec || { $: {} };
if (mojo.internal.bindings.ash.cros_healthd.mojom.NetworkBandwidthRoutineDetailSpec.$.structSpec && mojo.internal.bindings.ash.cros_healthd.mojom.NetworkBandwidthRoutineDetailSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.cros_healthd.mojom.NetworkBandwidthRoutineDetailSpec.$ = {};
mojo.internal.bindings.ash.cros_healthd.mojom.SensitiveSensorInfoSpec = mojo.internal.bindings.ash.cros_healthd.mojom.SensitiveSensorInfoSpec || { $: {} };
if (mojo.internal.bindings.ash.cros_healthd.mojom.SensitiveSensorInfoSpec.$.structSpec && mojo.internal.bindings.ash.cros_healthd.mojom.SensitiveSensorInfoSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.cros_healthd.mojom.SensitiveSensorInfoSpec.$ = {};
mojo.internal.bindings.ash.cros_healthd.mojom.SensitiveSensorReportSpec = mojo.internal.bindings.ash.cros_healthd.mojom.SensitiveSensorReportSpec || { $: {} };
if (mojo.internal.bindings.ash.cros_healthd.mojom.SensitiveSensorReportSpec.$.structSpec && mojo.internal.bindings.ash.cros_healthd.mojom.SensitiveSensorReportSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.cros_healthd.mojom.SensitiveSensorReportSpec.$ = {};
mojo.internal.bindings.ash.cros_healthd.mojom.SensitiveSensorRoutineDetailSpec = mojo.internal.bindings.ash.cros_healthd.mojom.SensitiveSensorRoutineDetailSpec || { $: {} };
if (mojo.internal.bindings.ash.cros_healthd.mojom.SensitiveSensorRoutineDetailSpec.$.structSpec && mojo.internal.bindings.ash.cros_healthd.mojom.SensitiveSensorRoutineDetailSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.cros_healthd.mojom.SensitiveSensorRoutineDetailSpec.$ = {};
mojo.internal.bindings.ash.cros_healthd.mojom.CameraFrameAnalysisRoutineDetailSpec = mojo.internal.bindings.ash.cros_healthd.mojom.CameraFrameAnalysisRoutineDetailSpec || { $: {} };
if (mojo.internal.bindings.ash.cros_healthd.mojom.CameraFrameAnalysisRoutineDetailSpec.$.structSpec && mojo.internal.bindings.ash.cros_healthd.mojom.CameraFrameAnalysisRoutineDetailSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.cros_healthd.mojom.CameraFrameAnalysisRoutineDetailSpec.$ = {};
mojo.internal.bindings.ash.cros_healthd.mojom.CrosHealthdRoutinesService = mojo.internal.bindings.ash.cros_healthd.mojom.CrosHealthdRoutinesService || {};
mojo.internal.bindings.ash.cros_healthd.mojom.CrosHealthdRoutinesServiceSpec = mojo.internal.bindings.ash.cros_healthd.mojom.CrosHealthdRoutinesServiceSpec || { $ : {} };
if (mojo.internal.bindings.ash.cros_healthd.mojom.CrosHealthdRoutinesServiceSpec.$.structSpec && mojo.internal.bindings.ash.cros_healthd.mojom.CrosHealthdRoutinesServiceSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.cros_healthd.mojom.CrosHealthdRoutinesServiceSpec.$ = {};
...
mojo.internal.bindings.ash.cros_healthd.mojom.CrosHealthdRoutinesService_CreateRoutine_ParamsSpec = mojo.internal.bindings.ash.cros_healthd.mojom.CrosHealthdRoutinesService_CreateRoutine_ParamsSpec || { $: {} };
if (mojo.internal.bindings.ash.cros_healthd.mojom.CrosHealthdRoutinesService_CreateRoutine_ParamsSpec.$.structSpec && mojo.internal.bindings.ash.cros_healthd.mojom.CrosHealthdRoutinesService_CreateRoutine_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.cros_healthd.mojom.CrosHealthdRoutinesService_CreateRoutine_ParamsSpec.$ = {};
mojo.internal.bindings.ash.cros_healthd.mojom.CrosHealthdRoutinesService_IsRoutineArgumentSupported_ParamsSpec = mojo.internal.bindings.ash.cros_healthd.mojom.CrosHealthdRoutinesService_IsRoutineArgumentSupported_ParamsSpec || { $: {} };
if (mojo.internal.bindings.ash.cros_healthd.mojom.CrosHealthdRoutinesService_IsRoutineArgumentSupported_ParamsSpec.$.structSpec && mojo.internal.bindings.ash.cros_healthd.mojom.CrosHealthdRoutinesService_IsRoutineArgumentSupported_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.cros_healthd.mojom.CrosHealthdRoutinesService_IsRoutineArgumentSupported_ParamsSpec.$ = {};
mojo.internal.bindings.ash.cros_healthd.mojom.CrosHealthdRoutinesService_IsRoutineArgumentSupported_ResponseParamsSpec = mojo.internal.bindings.ash.cros_healthd.mojom.CrosHealthdRoutinesService_IsRoutineArgumentSupported_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.ash.cros_healthd.mojom.CrosHealthdRoutinesService_IsRoutineArgumentSupported_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.ash.cros_healthd.mojom.CrosHealthdRoutinesService_IsRoutineArgumentSupported_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.cros_healthd.mojom.CrosHealthdRoutinesService_IsRoutineArgumentSupported_ResponseParamsSpec.$ = {};
mojo.internal.bindings.ash.cros_healthd.mojom.RoutineControl = mojo.internal.bindings.ash.cros_healthd.mojom.RoutineControl || {};
mojo.internal.bindings.ash.cros_healthd.mojom.RoutineControlSpec = mojo.internal.bindings.ash.cros_healthd.mojom.RoutineControlSpec || { $ : {} };
if (mojo.internal.bindings.ash.cros_healthd.mojom.RoutineControlSpec.$.structSpec && mojo.internal.bindings.ash.cros_healthd.mojom.RoutineControlSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.cros_healthd.mojom.RoutineControlSpec.$ = {};
mojo.internal.bindings.ash.cros_healthd.mojom.RoutineControl.$interfaceName = 'ash.cros_healthd.mojom.RoutineControl';
mojo.internal.bindings.ash.cros_healthd.mojom.RoutineControl_GetState_ParamsSpec = mojo.internal.bindings.ash.cros_healthd.mojom.RoutineControl_GetState_ParamsSpec || { $: {} };
if (mojo.internal.bindings.ash.cros_healthd.mojom.RoutineControl_GetState_ParamsSpec.$.structSpec && mojo.internal.bindings.ash.cros_healthd.mojom.RoutineControl_GetState_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.cros_healthd.mojom.RoutineControl_GetState_ParamsSpec.$ = {};
mojo.internal.bindings.ash.cros_healthd.mojom.RoutineControl_GetState_ResponseParamsSpec = mojo.internal.bindings.ash.cros_healthd.mojom.RoutineControl_GetState_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.ash.cros_healthd.mojom.RoutineControl_GetState_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.ash.cros_healthd.mojom.RoutineControl_GetState_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.cros_healthd.mojom.RoutineControl_GetState_ResponseParamsSpec.$ = {};
mojo.internal.bindings.ash.cros_healthd.mojom.RoutineControl_Start_ParamsSpec = mojo.internal.bindings.ash.cros_healthd.mojom.RoutineControl_Start_ParamsSpec || { $: {} };
if (mojo.internal.bindings.ash.cros_healthd.mojom.RoutineControl_Start_ParamsSpec.$.structSpec && mojo.internal.bindings.ash.cros_healthd.mojom.RoutineControl_Start_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.cros_healthd.mojom.RoutineControl_Start_ParamsSpec.$ = {};
mojo.internal.bindings.ash.cros_healthd.mojom.RoutineControl_ReplyInquiry_ParamsSpec = mojo.internal.bindings.ash.cros_healthd.mojom.RoutineControl_ReplyInquiry_ParamsSpec || { $: {} };
if (mojo.internal.bindings.ash.cros_healthd.mojom.RoutineControl_ReplyInquiry_ParamsSpec.$.structSpec && mojo.internal.bindings.ash.cros_healthd.mojom.RoutineControl_ReplyInquiry_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.cros_healthd.mojom.RoutineControl_ReplyInquiry_ParamsSpec.$ = {};
mojo.internal.bindings.ash.cros_healthd.mojom.RoutineObserver = mojo.internal.bindings.ash.cros_healthd.mojom.RoutineObserver || {};
mojo.internal.bindings.ash.cros_healthd.mojom.RoutineObserverSpec = mojo.internal.bindings.ash.cros_healthd.mojom.RoutineObserverSpec || { $ : {} };
if (mojo.internal.bindings.ash.cros_healthd.mojom.RoutineObserverSpec.$.structSpec && mojo.internal.bindings.ash.cros_healthd.mojom.RoutineObserverSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.cros_healthd.mojom.RoutineObserverSpec.$ = {};
mojo.internal.bindings.ash.cros_healthd.mojom.RoutineObserver.$interfaceName = 'ash.cros_healthd.mojom.RoutineObserver';
mojo.internal.bindings.ash.cros_healthd.mojom.RoutineObserver_OnRoutineStateChange_ParamsSpec = mojo.internal.bindings.ash.cros_healthd.mojom.RoutineObserver_OnRoutineStateChange_ParamsSpec || { $: {} };
if (mojo.internal.bindings.ash.cros_healthd.mojom.RoutineObserver_OnRoutineStateChange_ParamsSpec.$.structSpec && mojo.internal.bindings.ash.cros_healthd.mojom.RoutineObserver_OnRoutineStateChange_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.cros_healthd.mojom.RoutineObserver_OnRoutineStateChange_ParamsSpec.$ = {};

// External type stubs (from imports)
mojo.internal.bindings.ash = mojo.internal.bindings.ash || {};
mojo.internal.bindings.ash.cros_healthd = mojo.internal.bindings.ash.cros_healthd || {};
mojo.internal.bindings.ash.cros_healthd.mojom = mojo.internal.bindings.ash.cros_healthd.mojom || {};
mojo.internal.bindings.ash.cros_healthd.mojom.RoutineArgumentSpec = mojo.internal.bindings.ash.cros_healthd.mojom.RoutineArgumentSpec || { $: mojo.internal.OpaqueStruct.$ };
mojo.internal.bindings.ash = mojo.internal.bindings.ash || {};
mojo.internal.bindings.ash.cros_healthd = mojo.internal.bindings.ash.cros_healthd || {};
mojo.internal.bindings.ash.cros_healthd.mojom = mojo.internal.bindings.ash.cros_healthd.mojom || {};
mojo.internal.bindings.ash.cros_healthd.mojom.RoutineDetailSpec = mojo.internal.bindings.ash.cros_healthd.mojom.RoutineDetailSpec || { $: mojo.internal.OpaqueStruct.$ };
mojo.internal.bindings.ash = mojo.internal.bindings.ash || {};
mojo.internal.bindings.ash.cros_healthd = mojo.internal.bindings.ash.cros_healthd || {};
mojo.internal.bindings.ash.cros_healthd.mojom = mojo.internal.bindings.ash.cros_healthd.mojom || {};
mojo.internal.bindings.ash.cros_healthd.mojom.RoutineInquirySpec = mojo.internal.bindings.ash.cros_healthd.mojom.RoutineInquirySpec || { $: mojo.internal.OpaqueStruct.$ };
mojo.internal.bindings.ash = mojo.internal.bindings.ash || {};
mojo.internal.bindings.ash.cros_healthd = mojo.internal.bindings.ash.cros_healthd || {};
mojo.internal.bindings.ash.cros_healthd.mojom = mojo.internal.bindings.ash.cros_healthd.mojom || {};
mojo.internal.bindings.ash.cros_healthd.mojom.RoutineInquiryReplySpec = mojo.internal.bindings.ash.cros_healthd.mojom.RoutineInquiryReplySpec || { $: mojo.internal.OpaqueStruct.$ };
mojo.internal.bindings.ash = mojo.internal.bindings.ash || {};
mojo.internal.bindings.ash.cros_healthd = mojo.internal.bindings.ash.cros_healthd || {};
mojo.internal.bindings.ash.cros_healthd.mojom = mojo.internal.bindings.ash.cros_healthd.mojom || {};
mojo.internal.bindings.ash.cros_healthd.mojom.RoutineInteractionSpec = mojo.internal.bindings.ash.cros_healthd.mojom.RoutineInteractionSpec || { $: mojo.internal.OpaqueStruct.$ };
mojo.internal.bindings.ash = mojo.internal.bindings.ash || {};
mojo.internal.bindings.ash.cros_healthd = mojo.internal.bindings.ash.cros_healthd || {};
mojo.internal.bindings.ash.cros_healthd.mojom = mojo.internal.bindings.ash.cros_healthd.mojom || {};
mojo.internal.bindings.ash.cros_healthd.mojom.RoutineRunningInfoSpec = mojo.internal.bindings.ash.cros_healthd.mojom.RoutineRunningInfoSpec || { $: mojo.internal.OpaqueStruct.$ };
mojo.internal.bindings.ash = mojo.internal.bindings.ash || {};
mojo.internal.bindings.ash.cros_healthd = mojo.internal.bindings.ash.cros_healthd || {};
mojo.internal.bindings.ash.cros_healthd.mojom = mojo.internal.bindings.ash.cros_healthd.mojom || {};
mojo.internal.bindings.ash.cros_healthd.mojom.RoutineStateUnionSpec = mojo.internal.bindings.ash.cros_healthd.mojom.RoutineStateUnionSpec || { $: mojo.internal.OpaqueStruct.$ };
mojo.internal.bindings.ash = mojo.internal.bindings.ash || {};
mojo.internal.bindings.ash.cros_healthd = mojo.internal.bindings.ash.cros_healthd || {};
mojo.internal.bindings.ash.cros_healthd.mojom = mojo.internal.bindings.ash.cros_healthd.mojom || {};
mojo.internal.bindings.ash.cros_healthd.mojom.SupportStatusSpec = mojo.internal.bindings.ash.cros_healthd.mojom.SupportStatusSpec || { $: mojo.internal.OpaqueStruct.$ };
mojo.internal.bindings.mojo_base = mojo.internal.bindings.mojo_base || {};
mojo.internal.bindings.mojo_base.mojom = mojo.internal.bindings.mojo_base.mojom || {};
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const message = new mojo.internal.Message(
                ...
                header.ordinal, header.requestId, mojo.internal.bindings.ash.cros_healthd.mojom.CrosHealthdRoutinesService_IsRoutineArgumentSupported_ResponseParamsSpec.$.structSpec, resp_obj);
        ...
        case 0: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.ash.cros_healthd.mojom.RoutineControl_GetState_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
...
mojo.internal.Struct(
    mojo.internal.bindings.ash.cros_healthd.mojom.LedLitUpRoutineArgumentSpec, 'ash.cros_healthd.mojom.LedLitUpRoutineArgument', [
      ...
      mojo.internal.StructField('arg_color', 4, 0, mojo.internal.bindings.ash.cros_healthd.mojom.LedColorSpec, null, false, 0, undefined),
    ],
    [[0, 16]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.ash.cros_healthd.mojom.CameraAvailabilityRoutineDetailSpec, 'ash.cros_healthd.mojom.CameraAvailabilityRoutineDetail', [
      ...
      mojo.internal.StructField('arg_camera_diagnostic_service_available_check', 4, 0, mojo.internal.bindings.ash.cros_healthd.mojom.CameraSubtestResultSpec, null, false, 0, undefined),
    ],
    [[0, 16]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.ash.cros_healthd.mojom.CameraFrameAnalysisRoutineDetailSpec, 'ash.cros_healthd.mojom.CameraFrameAnalysisRoutineDetail', [
      ...
      mojo.internal.StructField('arg_privacy_shutter_open_test', 4, 0, mojo.internal.bindings.ash.cros_healthd.mojom.CameraSubtestResultSpec, null, false, 0, undefined),
