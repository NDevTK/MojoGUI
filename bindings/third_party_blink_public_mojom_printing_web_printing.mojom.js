  ...
  $: {
    structSpec: {
      ...
      fields: [
        ...
        { name: 'printer_id', packedOffset: 8, packedBitOffset: 0, type: mojo.internal.String, nullable: false },
        { name: 'printer_remote', packedOffset: 16, packedBitOffset: 0, type: mojo.internal.InterfaceProxy, nullable: false },
      ],
      versions: [{version: 0}]
    }
  }
...
blink.mojom.WebPrinterAttributesSpec = {
  $: {
    structSpec: {
      ...
      packedSize: 184,
      fields: [
        { name: 'copies_default', packedOffset: 0, packedBitOffset: 0, type: mojo.internal.Uint32, nullable: false },
        { name: 'copies_supported', packedOffset: 8, packedBitOffset: 0, type: blink.mojom.WebPrintingRangeSpec, nullable: false },
        { name: 'media_col_default', packedOffset: 16, packedBitOffset: 0, type: blink.mojom.WebPrintingMediaCollectionSpec, nullable: false },
        { name: 'media_col_database', packedOffset: 24, packedBitOffset: 0, type: mojo.internal.Array, nullable: false },
        { name: 'media_source_default', packedOffset: 32, packedBitOffset: 0, type: mojo.internal.String, nullable: true },
        { name: 'media_source_supported', packedOffset: 40, packedBitOffset: 0, type: mojo.internal.Array, nullable: false },
        { name: 'multiple_document_handling_default', packedOffset: 48, packedBitOffset: 0, type: blink.mojom.WebPrintingMultipleDocumentHandlingSpec, nullable: false },
        { name: 'multiple_document_handling_supported', packedOffset: 56, packedBitOffset: 0, type: mojo.internal.Array, nullable: false },
        { name: 'orientation_requested_default', packedOffset: 64, packedBitOffset: 0, type: blink.mojom.WebPrintingOrientationRequestedSpec, nullable: false },
        { name: 'orientation_requested_supported', packedOffset: 72, packedBitOffset: 0, type: mojo.internal.Array, nullable: false },
        { name: 'printer_resolution_default', packedOffset: 80, packedBitOffset: 0, type: gfx.mojom.SizeSpec, nullable: false },
        { name: 'printer_resolution_supported', packedOffset: 88, packedBitOffset: 0, type: mojo.internal.Array, nullable: false },
        { name: 'print_color_mode_default', packedOffset: 96, packedBitOffset: 0, type: blink.mojom.WebPrintColorModeSpec, nullable: false },
        { name: 'print_color_mode_supported', packedOffset: 104, packedBitOffset: 0, type: mojo.internal.Array, nullable: false },
        { name: 'print_quality_default', packedOffset: 112, packedBitOffset: 0, type: blink.mojom.WebPrintQualitySpec, nullable: true },
        { name: 'print_quality_supported', packedOffset: 120, packedBitOffset: 0, type: mojo.internal.Array, nullable: false },
        { name: 'printer_state', packedOffset: 128, packedBitOffset: 0, type: blink.mojom.WebPrinterStateSpec, nullable: false },
        { name: 'printer_state_message', packedOffset: 136, packedBitOffset: 0, type: mojo.internal.String, nullable: false },
        { name: 'printer_state_reasons', packedOffset: 144, packedBitOffset: 0, type: mojo.internal.Array, nullable: false },
        { name: 'sides_default', packedOffset: 152, packedBitOffset: 0, type: blink.mojom.WebPrintingSidesSpec, nullable: true },
        { name: 'sides_supported', packedOffset: 160, packedBitOffset: 0, type: mojo.internal.Array, nullable: false },
        { name: 'printer_id', packedOffset: 168, packedBitOffset: 0, type: mojo.internal.String, nullable: false },
      ],
      versions: [{version: 0}]
    }
  }
  ...
  $: {
    structSpec: {
      ...
      fields: [
        ...
        { name: 'copies', packedOffset: 8, packedBitOffset: 0, type: mojo.internal.Uint32, nullable: false },
        { name: 'media_col', packedOffset: 16, packedBitOffset: 0, type: blink.mojom.WebPrintingMediaCollectionRequestedSpec, nullable: true },
        { name: 'media_source', packedOffset: 24, packedBitOffset: 0, type: mojo.internal.String, nullable: true },
        { name: 'multiple_document_handling', packedOffset: 32, packedBitOffset: 0, type: blink.mojom.WebPrintingMultipleDocumentHandlingSpec, nullable: true },
        { name: 'orientation_requested', packedOffset: 40, packedBitOffset: 0, type: blink.mojom.WebPrintingOrientationRequestedSpec, nullable: true },
        { name: 'printer_resolution', packedOffset: 48, packedBitOffset: 0, type: gfx.mojom.SizeSpec, nullable: true },
        { name: 'print_color_mode', packedOffset: 56, packedBitOffset: 0, type: blink.mojom.WebPrintColorModeSpec, nullable: true },
        { name: 'print_quality', packedOffset: 64, packedBitOffset: 0, type: blink.mojom.WebPrintQualitySpec, nullable: true },
        { name: 'sides', packedOffset: 72, packedBitOffset: 0, type: blink.mojom.WebPrintingSidesSpec, nullable: true },
      ],
      versions: [{version: 0}]
    }
  }
...
blink.mojom.WebPrintJobInfoSpec = {
  $: {
    structSpec: {
      ...
      fields: [
        { name: 'job_name', packedOffset: 0, packedBitOffset: 0, type: mojo.internal.String, nullable: false },
        { name: 'job_pages', packedOffset: 8, packedBitOffset: 0, type: mojo.internal.Uint32, nullable: false },
        { name: 'observer', packedOffset: 12, packedBitOffset: 0, type: mojo.internal.InterfaceRequest, nullable: false },
  ...
  $: {
    structSpec: {
      ...
      fields: [
        ...
        { name: 'attributes', packedOffset: 8, packedBitOffset: 0, type: blink.mojom.WebPrintJobTemplateAttributesSpec, nullable: false },
      ],
      versions: [{version: 0}]
    }
  }
