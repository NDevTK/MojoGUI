...
blink.mojom.DevToolsFrontend_SetupDevToolsFrontend_ParamsSpec = {
  $: {
    structSpec: {
      ...
      packedSize: 24,
      fields: [
        { name: 'api_script', packedOffset: 8, packedBitOffset: 0, type: mojo.internal.String, nullable: false },
...
blink.mojom.DevToolsFrontend_SetupDevToolsExtensionAPI_ParamsSpec = {
  $: {
    structSpec: {
      ...
      packedSize: 16,
      fields: [
        { name: 'extension_api', packedOffset: 8, packedBitOffset: 0, type: mojo.internal.String, nullable: false },
      ],
      versions: [{version: 0}]
    }
  }
...
blink.mojom.DevToolsFrontendHost_DispatchEmbedderMessage_ParamsSpec = {
  $: {
    structSpec: {
      ...
      packedSize: 16,
      fields: [
        { name: 'message', packedOffset: 8, packedBitOffset: 0, type: mojo_base.mojom.DictionaryValueSpec, nullable: false },
      ],
      versions: [{version: 0}]
    }
  }
