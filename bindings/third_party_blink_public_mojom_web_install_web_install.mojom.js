...
mojo.internal.bindings.blink.mojom.WebInstallService.$interfaceName = 'blink.mojom.WebInstallService';
...
mojo.internal.bindings.blink.mojom.WebInstallServiceResult = {
  kSuccess: 0,
  kAbortError: 1,
  kDataError: 2,
};
...
mojo.internal.Struct(
    mojo.internal.bindings.blink.mojom.WebInstallService_Install_ParamsSpec, 'blink.mojom.WebInstallService_Install_Params', [
      mojo.internal.StructField('arg_options', 0, 0, mojo.internal.bindings.mojo.internal.bindings.blink.mojom.InstallOptionsSpec.$, null, true, 0, undefined),
    ],
    [[0, 16]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.blink.mojom.WebInstallService_Install_ResponseParamsSpec, 'blink.mojom.WebInstallService_Install_ResponseParams', [
      mojo.internal.StructField('arg_result', 0, 0, mojo.internal.bindings.mojo.internal.bindings.blink.mojom.WebInstallServiceResultSpec.$, null, false, 0, undefined),
...
mojo.internal.bindings.blink.mojom.WebInstallServiceRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.blink.mojom.WebInstallServicePendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.blink.mojom.WebInstallServiceRemoteCallHandler(this.proxy);
  }
  ...
  install(arg_options) {
    return this.$.install(arg_options);
  }
  installFromElement(arg_options) {
    return this.$.installFromElement(arg_options);
  }
};

mojo.internal.bindings.blink.mojom.WebInstallServiceRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
...
mojo.internal.bindings.blink.mojom.WebInstallService.getRemote = function() {
  let remote = new mojo.internal.bindings.blink.mojom.WebInstallServiceRemote();
...
mojo.internal.bindings.blink.mojom.WebInstallServiceReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.blink.mojom.WebInstallService_Install_ParamsSpec);
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.blink.mojom.WebInstallService_InstallFromElement_ParamsSpec);
      ...
      switch (dispatchId) {
        case 0: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.blink.mojom.WebInstallService_Install_ResponseParamsSpec, header, rawHeader);
               responder(response);
        ...
        case 1: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              const rawHeader = (args[2] && args[2].slice) ? args[2].slice(0, header.headerSize) : null;
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.blink.mojom.WebInstallService_InstallFromElement_ResponseParamsSpec, header, rawHeader);
               responder(response);
...
mojo.internal.bindings.blink.mojom.WebInstallServiceReceiver = mojo.internal.bindings.blink.mojom.WebInstallServiceReceiver;
