...
viz.mojom.mojom.CopyOutputResultSpec = {
  $: {
    structSpec: {
      ...
      packedSize: 56,
      fields: [
        { name: 'format', packedOffset: 40, packedBitOffset: 0, type: viz.mojom.CopyOutputResultFormatSpec, nullable: false, minVersion: 0 },
        { name: 'destination', packedOffset: 44, packedBitOffset: 0, type: viz.mojom.CopyOutputResultDestinationSpec, nullable: false, minVersion: 0 },
        ...
        { name: 'releaser', packedOffset: 32, packedBitOffset: 0, type: mojo.internal.InterfaceProxy(viz.mojom.TextureReleaserRemote), nullable: true, minVersion: 0 },
      ],
