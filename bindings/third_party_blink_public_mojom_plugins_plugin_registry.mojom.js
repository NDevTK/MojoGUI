...
mojo.internal.Struct(
    mojo.internal.bindings.blink.mojom.PluginInfoSpec, 'blink.mojom.PluginInfo', [
      ...
      mojo.internal.StructField('arg_mime_types', 24, 0, mojo.internal.Array(mojo.internal.bindings.mojo.internal.bindings.blink.mojom.PluginMimeTypeSpec.$, false), null, false, 0, undefined),
...
mojo.internal.Struct(
    mojo.internal.bindings.blink.mojom.PluginRegistry_GetPlugins_ResponseParamsSpec, 'blink.mojom.PluginRegistry_GetPlugins_ResponseParams', [
      mojo.internal.StructField('arg_plugins', 0, 0, mojo.internal.Array(mojo.internal.bindings.mojo.internal.bindings.blink.mojom.PluginInfoSpec.$, false), null, false, 0, undefined),
    ],
    [[0, 16]]);
...
mojo.internal.bindings.blink.mojom.PluginRegistryRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.blink.mojom.PluginRegistryPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.blink.mojom.PluginRegistryRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.blink.mojom.PluginRegistry.getRemote = function() {
  let remote = new mojo.internal.bindings.blink.mojom.PluginRegistryRemote();
...
mojo.internal.bindings.blink.mojom.PluginRegistryReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.blink.mojom.PluginRegistry_GetPlugins_ParamsSpec.$.structSpec);
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.blink.mojom.PluginRegistry_GetPlugins_ResponseParamsSpec, header, rawHeader);
               responder(response);
...
mojo.internal.bindings.blink.mojom.PluginRegistryReceiver = mojo.internal.bindings.blink.mojom.PluginRegistryReceiver;
