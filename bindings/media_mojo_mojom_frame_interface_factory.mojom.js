...
mojo.internal.bindings.media.mojom.MuteStateObserverRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.media.mojom.MuteStateObserverRemoteCallHandler(this.proxy);
  }
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.media.mojom.MuteStateObserver_OnMuteStateChange_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OnMuteStateChange failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.media.mojom.MuteStateObserverReceiver = mojo.internal.bindings.media.mojom.MuteStateObserverReceiver;

mojo.internal.bindings.media.mojom.MuteStateObserverPtr = mojo.internal.bindings.media.mojom.MuteStateObserverRemote;
mojo.internal.bindings.media.mojom.MuteStateObserverRequest = mojo.internal.bindings.media.mojom.MuteStateObserverPendingReceiver;
...
mojo.internal.bindings.media.mojom.FrameInterfaceFactoryRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.media.mojom.FrameInterfaceFactoryRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.media.mojom.FrameInterfaceFactory.getRemote = function() {
  let remote = new mojo.internal.bindings.media.mojom.FrameInterfaceFactoryRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.media.mojom.FrameInterfaceFactory_CreateProvisionFetcher_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for CreateProvisionFetcher failed with TypeError');
           }
        }
        // Try Method 1: CreateCdmStorage
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.media.mojom.FrameInterfaceFactory_CreateCdmStorage_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for CreateCdmStorage failed with TypeError');
           }
        }
        // Try Method 2: RegisterMuteStateObserver
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.media.mojom.FrameInterfaceFactory_RegisterMuteStateObserver_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for RegisterMuteStateObserver failed with TypeError');
           }
        }
        // Try Method 3: CreateDCOMPSurfaceRegistry
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.media.mojom.FrameInterfaceFactory_CreateDCOMPSurfaceRegistry_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for CreateDCOMPSurfaceRegistry failed with TypeError');
           }
        }
        // Try Method 4: GetCdmOrigin
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.media.mojom.FrameInterfaceFactory_GetCdmOrigin_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for GetCdmOrigin failed with TypeError');
           }
        }
        // Try Method 5: BindEmbedderReceiver
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.media.mojom.FrameInterfaceFactory_BindEmbedderReceiver_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for BindEmbedderReceiver failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
             console.warn('[GeneratedReceiver] Failed to discover ordinal ' + header.ordinal);
      ...
      switch (dispatchId) {
        ...
        case 4: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.media.mojom.FrameInterfaceFactory_GetCdmOrigin_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.media.mojom.FrameInterfaceFactoryReceiver = mojo.internal.bindings.media.mojom.FrameInterfaceFactoryReceiver;
