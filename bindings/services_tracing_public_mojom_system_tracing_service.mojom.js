...
mojo.internal.bindings.tracing.mojom.SystemTracingServiceRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.tracing.mojom.SystemTracingServicePendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.tracing.mojom.SystemTracingServiceRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.tracing.mojom.SystemTracingServiceRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('tracing.mojom.SystemTracingService', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.tracing.mojom.SystemTracingService.getRemote = function() {
  let remote = new mojo.internal.bindings.tracing.mojom.SystemTracingServiceRemote();
...
mojo.internal.bindings.tracing.mojom.SystemTracingServiceReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('tracing.mojom.SystemTracingService', [
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.tracing.mojom.SystemTracingService_OpenProducerSocket_ParamsSpec.$.structSpec);
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.tracing.mojom.SystemTracingService_OpenProducerSocket_ParamsSpec.$.structSpec);
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.tracing.mojom.SystemTracingService_OpenProducerSocket_ResponseParamsSpec, header, rawHeader);
               responder(response);
...
mojo.internal.bindings.tracing.mojom.SystemTracingServiceReceiver = mojo.internal.bindings.tracing.mojom.SystemTracingServiceReceiver;
