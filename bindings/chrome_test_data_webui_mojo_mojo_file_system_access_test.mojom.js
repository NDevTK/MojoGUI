...
mojo.internal.bindings.test.mojom.MojoFileSystemAccessTest = {};
mojo.internal.bindings.test.mojom.MojoFileSystemAccessTestSpec = { $ : {} };
mojo.internal.bindings.test.mojom.MojoFileSystemAccessTest.$interfaceName = 'test.mojom.MojoFileSystemAccessTest';
...
mojo.internal.bindings.test.mojom.MojoFileSystemAccessTestRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.test.mojom.MojoFileSystemAccessTestPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.test.mojom.MojoFileSystemAccessTestRemoteCallHandler(this.proxy);
  }
  ...
  resolveTransferToken(arg_h) {
    return this.$.resolveTransferToken(arg_h);
  }
};

mojo.internal.bindings.test.mojom.MojoFileSystemAccessTestRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('test.mojom.MojoFileSystemAccessTest', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.test.mojom.MojoFileSystemAccessTest.getRemote = function() {
  let remote = new mojo.internal.bindings.test.mojom.MojoFileSystemAccessTestRemote();
...
mojo.internal.bindings.test.mojom.MojoFileSystemAccessTestReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('test.mojom.MojoFileSystemAccessTest', [
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.test.mojom.MojoFileSystemAccessTest_ResolveTransferToken_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for ResolveTransferToken failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.test.mojom.MojoFileSystemAccessTestReceiver = mojo.internal.bindings.test.mojom.MojoFileSystemAccessTestReceiver;
