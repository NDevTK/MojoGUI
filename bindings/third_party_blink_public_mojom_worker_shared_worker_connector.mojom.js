  ...
  $: {
    structSpec: {
      ...
      fields: [
        ...
        { name: 'creation_context_type', packedOffset: 16, packedBitOffset: 0, type: mojo.internal.Pointer, nullable: false },
        { name: 'message_port', packedOffset: 24, packedBitOffset: 0, type: mojo.internal.Pointer, nullable: false },
