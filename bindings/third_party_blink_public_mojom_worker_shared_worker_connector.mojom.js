...
mojo.internal.Struct(
    mojo.internal.bindings.blink.mojom.SharedWorkerConnector_Connect_ParamsSpec, 'blink.mojom.SharedWorkerConnector_Connect_Params', [
      ...
      mojo.internal.StructField('arg_message_port', 16, 0, mojo.internal.bindings.blink.mojom.MessagePortDescriptorSpec, null, false, 0, undefined),
      ...
      mojo.internal.StructField('arg_creation_context_type', 32, 0, mojo.internal.bindings.blink.mojom.SharedWorkerCreationContextTypeSpec, null, false, 0, undefined),
    ],
    [[0, 48]]);
...
mojo.internal.bindings.blink.mojom.SharedWorkerConnectorRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.blink.mojom.SharedWorkerConnectorPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.blink.mojom.SharedWorkerConnectorRemoteCallHandler(this.proxy);
  }
  ...
  connect(arg_info, arg_client, arg_creation_context_type, arg_message_port, arg_blob_url_token) {
    return this.$.connect(arg_info, arg_client, arg_creation_context_type, arg_message_port, arg_blob_url_token);
  }
};
...
mojo.internal.bindings.blink.mojom.SharedWorkerConnector.getRemote = function() {
  let remote = new mojo.internal.bindings.blink.mojom.SharedWorkerConnectorRemote();
...
mojo.internal.bindings.blink.mojom.SharedWorkerConnectorReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.blink.mojom.SharedWorkerConnector_Connect_ParamsSpec.$.structSpec;
...
mojo.internal.bindings.blink.mojom.SharedWorkerConnectorReceiver = mojo.internal.bindings.blink.mojom.SharedWorkerConnectorReceiver;
