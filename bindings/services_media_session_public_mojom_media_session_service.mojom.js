...
mojo.internal.bindings.media_session.mojom.MediaSessionServiceRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.media_session.mojom.MediaSessionServicePendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.media_session.mojom.MediaSessionServiceRemoteCallHandler(this.proxy);
  }
  ...
  bindAudioFocusManager(arg_receiver) {
    return this.$.bindAudioFocusManager(arg_receiver);
  }
  bindAudioFocusManagerDebug(arg_receiver) {
    return this.$.bindAudioFocusManagerDebug(arg_receiver);
  }
  bindMediaControllerManager(arg_receiver) {
    return this.$.bindMediaControllerManager(arg_receiver);
  }
  bind(arg_receiver) {
...
mojo.internal.bindings.media_session.mojom.MediaSessionService.getRemote = function() {
  let remote = new mojo.internal.bindings.media_session.mojom.MediaSessionServiceRemote();
...
mojo.internal.bindings.media_session.mojom.MediaSessionServiceReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.media_session.mojom.MediaSessionService_BindAudioFocusManager_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for BindAudioFocusManager failed with TypeError');
           }
        }
        // Try Method 1: BindAudioFocusManagerDebug
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.media_session.mojom.MediaSessionService_BindAudioFocusManagerDebug_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for BindAudioFocusManagerDebug failed with TypeError');
           }
        }
        // Try Method 2: BindMediaControllerManager
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.media_session.mojom.MediaSessionService_BindMediaControllerManager_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for BindMediaControllerManager failed with TypeError');
           }
        }
        // Try Method 3: Bind
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.media_session.mojom.MediaSessionService_Bind_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
...
mojo.internal.bindings.media_session.mojom.MediaSessionServiceReceiver = mojo.internal.bindings.media_session.mojom.MediaSessionServiceReceiver;
