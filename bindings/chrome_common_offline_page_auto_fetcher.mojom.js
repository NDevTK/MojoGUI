...
mojo.internal.bindings.chrome.mojom.OfflinePageAutoFetcherRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.chrome.mojom.OfflinePageAutoFetcherPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.chrome.mojom.OfflinePageAutoFetcherRemoteCallHandler(this.proxy);
  }
  ...
  trySchedule(arg_user_requested) {
    return this.$.trySchedule(arg_user_requested);
  }
  cancelSchedule() {
...
mojo.internal.bindings.chrome.mojom.OfflinePageAutoFetcherRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('chrome.mojom.OfflinePageAutoFetcher', [
      { explicit: null },
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.chrome.mojom.OfflinePageAutoFetcher.getRemote = function() {
  let remote = new mojo.internal.bindings.chrome.mojom.OfflinePageAutoFetcherRemote();
...
mojo.internal.bindings.chrome.mojom.OfflinePageAutoFetcherReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('chrome.mojom.OfflinePageAutoFetcher', [
      { explicit: null },
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.chrome.mojom.OfflinePageAutoFetcher_TrySchedule_ParamsSpec.$.structSpec);
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.chrome.mojom.OfflinePageAutoFetcher_CancelSchedule_ParamsSpec.$.structSpec);
      ...
      switch (dispatchId) {
        case 0: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.chrome.mojom.OfflinePageAutoFetcher_TrySchedule_ResponseParamsSpec, header, rawHeader);
               responder(response);
        ...
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.chrome.mojom.OfflinePageAutoFetcher_CancelSchedule_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.chrome.mojom.OfflinePageAutoFetcherReceiver = mojo.internal.bindings.chrome.mojom.OfflinePageAutoFetcherReceiver;
