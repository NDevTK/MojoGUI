...
mojo.internal.bindings.ntp.calendar.mojom.OutlookCalendarPageHandler = {};
mojo.internal.bindings.ntp.calendar.mojom.OutlookCalendarPageHandlerSpec = { $ : {} };
mojo.internal.bindings.ntp.calendar.mojom.OutlookCalendarPageHandler.$interfaceName = 'ntp.calendar.mojom.OutlookCalendarPageHandler';
...
mojo.internal.bindings.ntp.calendar.mojom.OutlookCalendarPageHandlerRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.ntp.calendar.mojom.OutlookCalendarPageHandlerPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.ntp.calendar.mojom.OutlookCalendarPageHandlerRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.ntp.calendar.mojom.OutlookCalendarPageHandlerRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('ntp.calendar.mojom.OutlookCalendarPageHandler', [
      { explicit: null },
      { explicit: null },
      { explicit: null },
    ]);
...
mojo.internal.bindings.ntp.calendar.mojom.OutlookCalendarPageHandler.getRemote = function() {
  let remote = new mojo.internal.bindings.ntp.calendar.mojom.OutlookCalendarPageHandlerRemote();
...
mojo.internal.bindings.ntp.calendar.mojom.OutlookCalendarPageHandlerReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('ntp.calendar.mojom.OutlookCalendarPageHandler', [
      { explicit: null },
      { explicit: null },
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.ntp.calendar.mojom.OutlookCalendarPageHandler_GetEvents_ParamsSpec.$.structSpec);
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.ntp.calendar.mojom.OutlookCalendarPageHandler_DismissModule_ParamsSpec.$.structSpec);
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.ntp.calendar.mojom.OutlookCalendarPageHandler_RestoreModule_ParamsSpec.$.structSpec);
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.ntp.calendar.mojom.OutlookCalendarPageHandler_GetEvents_ParamsSpec.$.structSpec);
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.ntp.calendar.mojom.OutlookCalendarPageHandler_GetEvents_ResponseParamsSpec, header, rawHeader);
               responder(response);
        ...
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.ntp.calendar.mojom.OutlookCalendarPageHandler_DismissModule_ParamsSpec.$.structSpec);
        ...
        case 2: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.ntp.calendar.mojom.OutlookCalendarPageHandler_RestoreModule_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.ntp.calendar.mojom.OutlookCalendarPageHandlerReceiver = mojo.internal.bindings.ntp.calendar.mojom.OutlookCalendarPageHandlerReceiver;
