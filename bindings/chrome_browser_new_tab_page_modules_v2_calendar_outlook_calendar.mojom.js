    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      switch (dispatchId) {
        case 0: {
          ...
          const params = decoder.decodeStruct(ntp.calendar.mojom.OutlookCalendarPageHandler_GetEvents_ParamsSpec.$, 0);
        ...
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStruct(ntp.calendar.mojom.OutlookCalendarPageHandler_DismissModule_ParamsSpec.$, 0);
        ...
        case 2: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStruct(ntp.calendar.mojom.OutlookCalendarPageHandler_RestoreModule_ParamsSpec.$, 0);
