...
mojo.internal.bindings.network.mojom.SharedDictionaryAccessObserver.$interfaceName = 'network.mojom.SharedDictionaryAccessObserver';
...
// Enum: Type
mojo.internal.bindings.network.mojom.Type = {
  kRead: 0,
  kWrite: 1,
};
...
mojo.internal.Struct(
    mojo.internal.bindings.network.mojom.SharedDictionaryAccessDetailsSpec, 'network.mojom.SharedDictionaryAccessDetails', [
      mojo.internal.StructField('arg_kRead', 0, 0, mojo.internal.Pointer, null, false, 0, undefined),
...
mojo.internal.Struct(
    mojo.internal.bindings.network.mojom.SharedDictionaryAccessObserver_Clone_ParamsSpec, 'network.mojom.SharedDictionaryAccessObserver_Clone_Params', [
      mojo.internal.StructField('arg_observer', 0, 0, mojo.internal.InterfaceRequest(mojo.internal.bindings.network.mojom.SharedDictionaryAccessObserverSpec), null, false, 0, undefined),
    ],
    [[0, 16]]);
...
mojo.internal.bindings.network.mojom.SharedDictionaryAccessObserverRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.network.mojom.SharedDictionaryAccessObserverPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.network.mojom.SharedDictionaryAccessObserverRemoteCallHandler(this.proxy);
  }
  ...
  onSharedDictionaryAccessed(arg_details) {
    return this.$.onSharedDictionaryAccessed(arg_details);
  }
  clone(arg_observer) {
...
mojo.internal.bindings.network.mojom.SharedDictionaryAccessObserverRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('SharedDictionaryAccessObserver', [
      { explicit: null },
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.network.mojom.SharedDictionaryAccessObserver.getRemote = function() {
  let remote = new mojo.internal.bindings.network.mojom.SharedDictionaryAccessObserverRemote();
...
mojo.internal.bindings.network.mojom.SharedDictionaryAccessObserverReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('SharedDictionaryAccessObserver', [
      { explicit: null },
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.network.mojom.SharedDictionaryAccessObserver_OnSharedDictionaryAccessed_ParamsSpec);
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.network.mojom.SharedDictionaryAccessObserver_Clone_ParamsSpec);
...
mojo.internal.bindings.network.mojom.SharedDictionaryAccessObserverReceiver = mojo.internal.bindings.network.mojom.SharedDictionaryAccessObserverReceiver;
