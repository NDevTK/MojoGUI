...
viz.mojom.BlitRequestSpec = {
  $: {
    structSpec: {
      ...
      packedSize: 48,
      fields: [
        { name: 'destination_region_offset', packedOffset: 0, packedBitOffset: 0, type: gfx.mojom.PointSpec, nullable: false },
        { name: 'letterboxing_behavior', packedOffset: 8, packedBitOffset: 0, type: viz.mojom.LetterboxingBehaviorSpec, nullable: false },
