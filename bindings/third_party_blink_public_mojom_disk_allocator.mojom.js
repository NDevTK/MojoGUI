...
mojo.internal.bindings.blink.mojom.DiskAllocator = {};
mojo.internal.bindings.blink.mojom.DiskAllocatorSpec = { $ : {} };
mojo.internal.bindings.blink.mojom.DiskAllocator.$interfaceName = 'blink.mojom.DiskAllocator';
...
mojo.internal.bindings.blink.mojom.DiskAllocatorRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.blink.mojom.DiskAllocatorPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.blink.mojom.DiskAllocatorRemoteCallHandler(this.proxy);
  }
  ...
  provideTemporaryFile(arg_file) {
    return this.$.provideTemporaryFile(arg_file);
  }
};

mojo.internal.bindings.blink.mojom.DiskAllocatorRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('blink.mojom.DiskAllocator', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.blink.mojom.DiskAllocator.getRemote = function() {
  let remote = new mojo.internal.bindings.blink.mojom.DiskAllocatorRemote();
...
mojo.internal.bindings.blink.mojom.DiskAllocatorReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('blink.mojom.DiskAllocator', [
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.blink.mojom.DiskAllocator_ProvideTemporaryFile_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for ProvideTemporaryFile failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.blink.mojom.DiskAllocatorReceiver = mojo.internal.bindings.blink.mojom.DiskAllocatorReceiver;
