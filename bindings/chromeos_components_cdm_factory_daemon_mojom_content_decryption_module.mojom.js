...
mojo.internal.Struct(
    mojo.internal.bindings.chromeos.cdm.mojom.CdmPromiseResultSpec, 'chromeos.cdm.mojom.CdmPromiseResult', [
      ...
      mojo.internal.StructField('arg_exception', 8, 0, mojo.internal.bindings.chromeos.cdm.mojom.PromiseExceptionSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_system_code', 12, 0, mojo.internal.Uint32, 0, false, 0, undefined),
...
mojo.internal.Struct(
    mojo.internal.bindings.chromeos.cdm.mojom.DecryptConfigSpec, 'chromeos.cdm.mojom.DecryptConfig', [
      mojo.internal.StructField('arg_key_id', 0, 0, mojo.internal.String, null, false, 0, undefined),
      mojo.internal.StructField('arg_iv', 8, 0, mojo.internal.String, null, false, 0, undefined),
      mojo.internal.StructField('arg_subsamples', 16, 0, mojo.internal.Array(mojo.internal.bindings.chromeos.cdm.mojom.SubsampleEntrySpec, false), null, false, 0, undefined),
      mojo.internal.StructField('arg_encryption_pattern', 24, 0, mojo.internal.bindings.chromeos.cdm.mojom.EncryptionPatternSpec, null, true, 0, undefined),
      mojo.internal.StructField('arg_encryption_scheme', 32, 0, mojo.internal.bindings.chromeos.cdm.mojom.EncryptionSchemeSpec, null, false, 0, undefined),
    ],
    [[0, 48]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.chromeos.cdm.mojom.ContentDecryptionModule_CreateSessionAndGenerateRequest_ParamsSpec, 'chromeos.cdm.mojom.ContentDecryptionModule_CreateSessionAndGenerateRequest_Params', [
      ...
      mojo.internal.StructField('arg_session_type', 8, 0, mojo.internal.bindings.chromeos.cdm.mojom.CdmSessionTypeSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_init_data_type', 12, 0, mojo.internal.bindings.chromeos.cdm.mojom.EmeInitDataTypeSpec, null, false, 0, undefined),
    ],
    [[0, 24]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.chromeos.cdm.mojom.ContentDecryptionModule_DecryptDeprecated_ResponseParamsSpec, 'chromeos.cdm.mojom.ContentDecryptionModule_DecryptDeprecated_ResponseParams', [
      mojo.internal.StructField('arg_decrypted_data', 0, 0, mojo.internal.Array(mojo.internal.Uint8, false), null, false, 0, undefined),
...
mojo.internal.Struct(
    mojo.internal.bindings.chromeos.cdm.mojom.ContentDecryptionModule_Decrypt_ResponseParamsSpec, 'chromeos.cdm.mojom.ContentDecryptionModule_Decrypt_ResponseParams', [
      mojo.internal.StructField('arg_decrypted_data', 0, 0, mojo.internal.Array(mojo.internal.Uint8, false), null, false, 0, undefined),
      mojo.internal.StructField('arg_decrypt_config_out', 8, 0, mojo.internal.bindings.chromeos.cdm.mojom.DecryptConfigSpec, null, true, 0, undefined),
      mojo.internal.StructField('arg_status', 16, 0, mojo.internal.bindings.chromeos.cdm.mojom.DecryptStatusSpec, null, false, 0, undefined),
    ],
    [[0, 32]]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.chromeos.cdm.mojom.ContentDecryptionModule_SetServerCertificate_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for SetServerCertificate failed with TypeError');
           }
        }
        // Try Method 1: GetStatusForPolicy
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.chromeos.cdm.mojom.ContentDecryptionModule_GetStatusForPolicy_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for GetStatusForPolicy failed with TypeError');
           }
        }
        // Try Method 2: CreateSessionAndGenerateRequest
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.chromeos.cdm.mojom.ContentDecryptionModule_CreateSessionAndGenerateRequest_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for CreateSessionAndGenerateRequest failed with TypeError');
           }
        }
        // Try Method 3: LoadSession
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.chromeos.cdm.mojom.ContentDecryptionModule_LoadSession_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for LoadSession failed with TypeError');
           }
        }
        // Try Method 4: UpdateSession
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.chromeos.cdm.mojom.ContentDecryptionModule_UpdateSession_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for UpdateSession failed with TypeError');
           }
        }
        // Try Method 5: CloseSession
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.chromeos.cdm.mojom.ContentDecryptionModule_CloseSession_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for CloseSession failed with TypeError');
           }
        }
        // Try Method 6: RemoveSession
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.chromeos.cdm.mojom.ContentDecryptionModule_RemoveSession_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for RemoveSession failed with TypeError');
           }
        }
        // Try Method 7: DecryptDeprecated
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.chromeos.cdm.mojom.ContentDecryptionModule_DecryptDeprecated_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for DecryptDeprecated failed with TypeError');
           }
        }
        // Try Method 8: GetHwKeyData
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.chromeos.cdm.mojom.ContentDecryptionModule_GetHwKeyData_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.chromeos.cdm.mojom.ContentDecryptionModule_Decrypt_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for Decrypt failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.Struct(
    mojo.internal.bindings.chromeos.cdm.mojom.ContentDecryptionModuleClient_OnSessionMessage_ParamsSpec, 'chromeos.cdm.mojom.ContentDecryptionModuleClient_OnSessionMessage_Params', [
      ...
      mojo.internal.StructField('arg_message_type', 16, 0, mojo.internal.bindings.chromeos.cdm.mojom.CdmMessageTypeSpec, null, false, 0, undefined),
    ],
    [[0, 32]]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.chromeos.cdm.mojom.ContentDecryptionModuleClient_OnSessionMessage_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OnSessionMessage failed with TypeError');
           }
        }
        // Try Method 1: OnSessionClosed
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.chromeos.cdm.mojom.ContentDecryptionModuleClient_OnSessionClosed_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OnSessionClosed failed with TypeError');
           }
        }
        // Try Method 2: OnSessionKeysChange
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.chromeos.cdm.mojom.ContentDecryptionModuleClient_OnSessionKeysChange_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OnSessionKeysChange failed with TypeError');
           }
        }
        // Try Method 3: OnSessionExpirationUpdate
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.chromeos.cdm.mojom.ContentDecryptionModuleClient_OnSessionExpirationUpdate_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OnSessionExpirationUpdate failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
             console.warn('[GeneratedReceiver] Failed to discover ordinal ' + header.ordinal);
