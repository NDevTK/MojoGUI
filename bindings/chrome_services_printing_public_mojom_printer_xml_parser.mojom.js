...
mojo.internal.bindings.printing.mojom.PrinterXmlParserRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.printing.mojom.PrinterXmlParserPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.printing.mojom.PrinterXmlParserRemoteCallHandler(this.proxy);
  }
  ...
  parseXmlForPrinterCapabilities(arg_capabilities_xml) {
    return this.$.parseXmlForPrinterCapabilities(arg_capabilities_xml);
  }
};

mojo.internal.bindings.printing.mojom.PrinterXmlParserRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('printing.mojom.PrinterXmlParser', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.printing.mojom.PrinterXmlParser.getRemote = function() {
  let remote = new mojo.internal.bindings.printing.mojom.PrinterXmlParserRemote();
...
mojo.internal.bindings.printing.mojom.PrinterXmlParserReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('printing.mojom.PrinterXmlParser', [
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.printing.mojom.PrinterXmlParser_ParseXmlForPrinterCapabilities_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for ParseXmlForPrinterCapabilities failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.printing.mojom.PrinterXmlParserReceiver = mojo.internal.bindings.printing.mojom.PrinterXmlParserReceiver;
