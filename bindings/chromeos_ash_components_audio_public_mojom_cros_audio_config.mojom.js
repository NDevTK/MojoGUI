...
mojo.internal.bindings.ash.audio_config.mojom.AudioEffectState = {
  kNotSupported: 0,
  kNotEnabled: 1,
  kEnabled: 2,
};
...
// Enum: MuteState
mojo.internal.bindings.ash.audio_config.mojom.MuteState = {
  kNotMuted: 0,
  kMutedByUser: 1,
  kMutedByPolicy: 2,
  kMutedExternally: 3,
...
mojo.internal.bindings.ash.audio_config.mojom.AudioEffectType = {
  kNone: 0,
...
mojo.internal.Struct(
    mojo.internal.bindings.ash.audio_config.mojom.VoiceIsolationUIAppearanceSpec, 'ash.audio_config.mojom.VoiceIsolationUIAppearance', [
      ...
      mojo.internal.StructField('arg_effect_mode_options', 4, 0, mojo.internal.Uint32, 0, false, 0, undefined),
      mojo.internal.StructField('arg_show_effect_fallback_message', 8, 0, mojo.internal.Bool, false, false, 0, undefined),
    ],
    [[0, 24]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.ash.audio_config.mojom.AudioDeviceSpec, 'ash.audio_config.mojom.AudioDevice', [
      ...
      mojo.internal.StructField('arg_noise_cancellation_state', 20, 0, mojo.internal.bindings.ash.audio_config.mojom.AudioEffectStateSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_style_transfer_state', 24, 0, mojo.internal.bindings.ash.audio_config.mojom.AudioEffectStateSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_force_respect_ui_gains_state', 28, 0, mojo.internal.bindings.ash.audio_config.mojom.AudioEffectStateSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_hfp_mic_sr_state', 32, 0, mojo.internal.bindings.ash.audio_config.mojom.AudioEffectStateSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_spatial_audio_state', 36, 0, mojo.internal.bindings.ash.audio_config.mojom.AudioEffectStateSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_is_active', 40, 0, mojo.internal.Bool, false, false, 0, undefined),
    ],
    [[0, 56]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.ash.audio_config.mojom.AudioSystemPropertiesSpec, 'ash.audio_config.mojom.AudioSystemProperties', [
      ...
      mojo.internal.StructField('arg_input_devices', 8, 0, mojo.internal.Array(mojo.internal.bindings.ash.audio_config.mojom.AudioDeviceSpec, false), null, false, 0, undefined),
      mojo.internal.StructField('arg_voice_isolation_ui_appearance', 16, 0, mojo.internal.bindings.ash.audio_config.mojom.VoiceIsolationUIAppearanceSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_output_mute_state', 24, 0, mojo.internal.bindings.ash.audio_config.mojom.MuteStateSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_input_mute_state', 28, 0, mojo.internal.bindings.ash.audio_config.mojom.MuteStateSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_output_volume_percent', 32, 0, mojo.internal.Uint8, 0, false, 0, undefined),
      mojo.internal.StructField('arg_input_gain_percent', 33, 0, mojo.internal.Uint8, 0, false, 0, undefined),
    ],
    [[0, 48]]);
...
mojo.internal.bindings.ash.audio_config.mojom.AudioSystemPropertiesObserverPendingReceiver = class {
  constructor(handle) {
    this.handle = handle;
  }
};

mojo.internal.bindings.ash.audio_config.mojom.AudioSystemPropertiesObserverRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.ash.audio_config.mojom.AudioSystemPropertiesObserverPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.ash.audio_config.mojom.AudioSystemPropertiesObserverRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.ash.audio_config.mojom.AudioSystemPropertiesObserver.getRemote = function() {
  let remote = new mojo.internal.bindings.ash.audio_config.mojom.AudioSystemPropertiesObserverRemote();
...
mojo.internal.bindings.ash.audio_config.mojom.AudioSystemPropertiesObserverReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ash.audio_config.mojom.AudioSystemPropertiesObserver_OnPropertiesUpdated_ParamsSpec.$.structSpec;
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.ash.audio_config.mojom.AudioSystemPropertiesObserver_OnPropertiesUpdated_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.ash.audio_config.mojom.AudioSystemPropertiesObserverReceiver = mojo.internal.bindings.ash.audio_config.mojom.AudioSystemPropertiesObserverReceiver;

mojo.internal.bindings.ash.audio_config.mojom.AudioSystemPropertiesObserverPtr = mojo.internal.bindings.ash.audio_config.mojom.AudioSystemPropertiesObserverRemote;
mojo.internal.bindings.ash.audio_config.mojom.AudioSystemPropertiesObserverRequest = mojo.internal.bindings.ash.audio_config.mojom.AudioSystemPropertiesObserverPendingReceiver;
...
mojo.internal.Struct(
    mojo.internal.bindings.ash.audio_config.mojom.CrosAudioConfig_SetOutputMuted_ParamsSpec, 'ash.audio_config.mojom.CrosAudioConfig_SetOutputMuted_Params', [
      mojo.internal.StructField('arg_muted', 0, 0, mojo.internal.Bool, false, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.ash.audio_config.mojom.CrosAudioConfig_SetOutputVolumePercent_ParamsSpec, 'ash.audio_config.mojom.CrosAudioConfig_SetOutputVolumePercent_Params', [
      mojo.internal.StructField('arg_volume', 0, 0, mojo.internal.Int8, 0, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.ash.audio_config.mojom.CrosAudioConfig_SetInputGainPercent_ParamsSpec, 'ash.audio_config.mojom.CrosAudioConfig_SetInputGainPercent_Params', [
      mojo.internal.StructField('arg_gain', 0, 0, mojo.internal.Uint8, 0, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.ash.audio_config.mojom.CrosAudioConfig_SetActiveDevice_ParamsSpec, 'ash.audio_config.mojom.CrosAudioConfig_SetActiveDevice_Params', [
      mojo.internal.StructField('arg_device', 0, 0, mojo.internal.Uint64, 0, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.ash.audio_config.mojom.CrosAudioConfig_SetInputMuted_ParamsSpec, 'ash.audio_config.mojom.CrosAudioConfig_SetInputMuted_Params', [
      mojo.internal.StructField('arg_muted', 0, 0, mojo.internal.Bool, false, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.ash.audio_config.mojom.CrosAudioConfig_RecordVoiceIsolationEnabledChange_ParamsSpec, 'ash.audio_config.mojom.CrosAudioConfig_RecordVoiceIsolationEnabledChange_Params', [
    ],
    [[0, 8]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.ash.audio_config.mojom.CrosAudioConfig_SetNoiseCancellationEnabled_ParamsSpec, 'ash.audio_config.mojom.CrosAudioConfig_SetNoiseCancellationEnabled_Params', [
      mojo.internal.StructField('arg_enabled', 0, 0, mojo.internal.Bool, false, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.ash.audio_config.mojom.CrosAudioConfig_SetStyleTransferEnabled_ParamsSpec, 'ash.audio_config.mojom.CrosAudioConfig_SetStyleTransferEnabled_Params', [
      mojo.internal.StructField('arg_enabled', 0, 0, mojo.internal.Bool, false, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.ash.audio_config.mojom.CrosAudioConfig_SetForceRespectUiGainsEnabled_ParamsSpec, 'ash.audio_config.mojom.CrosAudioConfig_SetForceRespectUiGainsEnabled_Params', [
      mojo.internal.StructField('arg_enabled', 0, 0, mojo.internal.Bool, false, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.ash.audio_config.mojom.CrosAudioConfig_SetHfpMicSrEnabled_ParamsSpec, 'ash.audio_config.mojom.CrosAudioConfig_SetHfpMicSrEnabled_Params', [
      mojo.internal.StructField('arg_enabled', 0, 0, mojo.internal.Bool, false, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.ash.audio_config.mojom.CrosAudioConfig_SetSpatialAudioEnabled_ParamsSpec, 'ash.audio_config.mojom.CrosAudioConfig_SetSpatialAudioEnabled_Params', [
      mojo.internal.StructField('arg_enabled', 0, 0, mojo.internal.Bool, false, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.bindings.ash.audio_config.mojom.CrosAudioConfigPendingReceiver = class {
  constructor(handle) {
    this.handle = handle;
  }
};

mojo.internal.bindings.ash.audio_config.mojom.CrosAudioConfigRemote = class {
  static get $interfaceName() {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.ash.audio_config.mojom.CrosAudioConfigPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.ash.audio_config.mojom.CrosAudioConfigRemoteCallHandler(this.proxy);
  }
  ...
  observeAudioSystemProperties(arg_observer) {
    return this.$.observeAudioSystemProperties(arg_observer);
  }
  setOutputMuted(arg_muted) {
    return this.$.setOutputMuted(arg_muted);
  }
  setOutputVolumePercent(arg_volume) {
    return this.$.setOutputVolumePercent(arg_volume);
  }
  setInputGainPercent(arg_gain) {
    return this.$.setInputGainPercent(arg_gain);
  }
  setActiveDevice(arg_device) {
    return this.$.setActiveDevice(arg_device);
  }
  setInputMuted(arg_muted) {
    return this.$.setInputMuted(arg_muted);
  }
  recordVoiceIsolationEnabledChange() {
    return this.$.recordVoiceIsolationEnabledChange();
  }
  recordVoiceIsolationPreferredEffectChange(arg_preferred_effect) {
    return this.$.recordVoiceIsolationPreferredEffectChange(arg_preferred_effect);
  }
  setNoiseCancellationEnabled(arg_enabled) {
    return this.$.setNoiseCancellationEnabled(arg_enabled);
  }
  setStyleTransferEnabled(arg_enabled) {
    return this.$.setStyleTransferEnabled(arg_enabled);
  }
  setForceRespectUiGainsEnabled(arg_enabled) {
    return this.$.setForceRespectUiGainsEnabled(arg_enabled);
  }
  setHfpMicSrEnabled(arg_enabled) {
    return this.$.setHfpMicSrEnabled(arg_enabled);
  }
  setSpatialAudioEnabled(arg_enabled) {
    return this.$.setSpatialAudioEnabled(arg_enabled);
  }
};
...
mojo.internal.bindings.ash.audio_config.mojom.CrosAudioConfig.getRemote = function() {
  let remote = new mojo.internal.bindings.ash.audio_config.mojom.CrosAudioConfigRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
...
mojo.internal.bindings.ash.audio_config.mojom.CrosAudioConfigReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ash.audio_config.mojom.CrosAudioConfig_ObserveAudioSystemProperties_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for ObserveAudioSystemProperties failed with TypeError');
           }
        }
        // Try Method 1: SetOutputMuted
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ash.audio_config.mojom.CrosAudioConfig_SetOutputMuted_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for SetOutputMuted failed with TypeError');
           }
        }
        // Try Method 2: SetOutputVolumePercent
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ash.audio_config.mojom.CrosAudioConfig_SetOutputVolumePercent_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for SetOutputVolumePercent failed with TypeError');
           }
        }
        // Try Method 3: SetInputGainPercent
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ash.audio_config.mojom.CrosAudioConfig_SetInputGainPercent_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for SetInputGainPercent failed with TypeError');
           }
        }
        // Try Method 4: SetActiveDevice
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ash.audio_config.mojom.CrosAudioConfig_SetActiveDevice_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for SetActiveDevice failed with TypeError');
           }
        }
        // Try Method 5: SetInputMuted
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ash.audio_config.mojom.CrosAudioConfig_SetInputMuted_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for SetInputMuted failed with TypeError');
           }
        }
        // Try Method 6: RecordVoiceIsolationEnabledChange
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ash.audio_config.mojom.CrosAudioConfig_RecordVoiceIsolationEnabledChange_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for RecordVoiceIsolationEnabledChange failed with TypeError');
           }
        }
        // Try Method 7: RecordVoiceIsolationPreferredEffectChange
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ash.audio_config.mojom.CrosAudioConfig_RecordVoiceIsolationPreferredEffectChange_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for RecordVoiceIsolationPreferredEffectChange failed with TypeError');
           }
        }
        // Try Method 8: SetNoiseCancellationEnabled
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ash.audio_config.mojom.CrosAudioConfig_SetNoiseCancellationEnabled_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for SetNoiseCancellationEnabled failed with TypeError');
           }
        }
        // Try Method 9: SetStyleTransferEnabled
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ash.audio_config.mojom.CrosAudioConfig_SetStyleTransferEnabled_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for SetStyleTransferEnabled failed with TypeError');
           }
        }
        // Try Method 10: SetForceRespectUiGainsEnabled
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ash.audio_config.mojom.CrosAudioConfig_SetForceRespectUiGainsEnabled_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for SetForceRespectUiGainsEnabled failed with TypeError');
           }
        }
        // Try Method 11: SetHfpMicSrEnabled
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ash.audio_config.mojom.CrosAudioConfig_SetHfpMicSrEnabled_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for SetHfpMicSrEnabled failed with TypeError');
           }
        }
        // Try Method 12: SetSpatialAudioEnabled
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ash.audio_config.mojom.CrosAudioConfig_SetSpatialAudioEnabled_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for SetSpatialAudioEnabled failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
             console.warn('[GeneratedReceiver] Failed to discover ordinal ' + header.ordinal);
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.ash.audio_config.mojom.CrosAudioConfig_ObserveAudioSystemProperties_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.observeAudioSystemProperties');
          const result = this.impl.observeAudioSystemProperties(params.arg_observer);
          break;
        }
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.ash.audio_config.mojom.CrosAudioConfig_SetOutputMuted_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.setOutputMuted');
          const result = this.impl.setOutputMuted(params.arg_muted);
          break;
        }
        case 2: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.ash.audio_config.mojom.CrosAudioConfig_SetOutputVolumePercent_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.setOutputVolumePercent');
          const result = this.impl.setOutputVolumePercent(params.arg_volume);
          break;
        }
        case 3: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.ash.audio_config.mojom.CrosAudioConfig_SetInputGainPercent_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.setInputGainPercent');
          const result = this.impl.setInputGainPercent(params.arg_gain);
          break;
        }
        case 4: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.ash.audio_config.mojom.CrosAudioConfig_SetActiveDevice_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.setActiveDevice');
          const result = this.impl.setActiveDevice(params.arg_device);
          break;
        }
        case 5: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.ash.audio_config.mojom.CrosAudioConfig_SetInputMuted_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.setInputMuted');
          const result = this.impl.setInputMuted(params.arg_muted);
          break;
        }
        case 6: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.ash.audio_config.mojom.CrosAudioConfig_RecordVoiceIsolationEnabledChange_ParamsSpec.$.structSpec);
        ...
        case 7: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.ash.audio_config.mojom.CrosAudioConfig_RecordVoiceIsolationPreferredEffectChange_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.recordVoiceIsolationPreferredEffectChange');
          const result = this.impl.recordVoiceIsolationPreferredEffectChange(params.arg_preferred_effect);
          break;
        }
        case 8: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.ash.audio_config.mojom.CrosAudioConfig_SetNoiseCancellationEnabled_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.setNoiseCancellationEnabled');
          const result = this.impl.setNoiseCancellationEnabled(params.arg_enabled);
          break;
        }
        case 9: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.ash.audio_config.mojom.CrosAudioConfig_SetStyleTransferEnabled_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.setStyleTransferEnabled');
          const result = this.impl.setStyleTransferEnabled(params.arg_enabled);
          break;
        }
        case 10: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.ash.audio_config.mojom.CrosAudioConfig_SetForceRespectUiGainsEnabled_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.setForceRespectUiGainsEnabled');
          const result = this.impl.setForceRespectUiGainsEnabled(params.arg_enabled);
          break;
        }
        case 11: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.ash.audio_config.mojom.CrosAudioConfig_SetHfpMicSrEnabled_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.setHfpMicSrEnabled');
          const result = this.impl.setHfpMicSrEnabled(params.arg_enabled);
          break;
        }
        case 12: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.ash.audio_config.mojom.CrosAudioConfig_SetSpatialAudioEnabled_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.setSpatialAudioEnabled');
          const result = this.impl.setSpatialAudioEnabled(params.arg_enabled);
          break;
        }
      }
      } catch (err) {
...
mojo.internal.bindings.ash.audio_config.mojom.CrosAudioConfigReceiver = mojo.internal.bindings.ash.audio_config.mojom.CrosAudioConfigReceiver;

mojo.internal.bindings.ash.audio_config.mojom.CrosAudioConfigPtr = mojo.internal.bindings.ash.audio_config.mojom.CrosAudioConfigRemote;
mojo.internal.bindings.ash.audio_config.mojom.CrosAudioConfigRequest = mojo.internal.bindings.ash.audio_config.mojom.CrosAudioConfigPendingReceiver;
