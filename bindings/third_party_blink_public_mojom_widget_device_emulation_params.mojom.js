...
mojo.internal.Struct(
    blink.mojom.DeviceEmulationParamsSpec, 'blink.mojom.DeviceEmulationParams', [
      ...
      mojo.internal.StructField('screen_orientation_angle', 64, 0, mojo.internal.Uint32, 0, false, 0, undefined),
      mojo.internal.StructField('viewport_segments', 72, 0, mojo.internal.Array(gfx.mojom.RectSpec.$, false), null, false, 0, undefined),
      mojo.internal.StructField('device_posture', 80, 0, blink.mojom.DevicePostureTypeSpec.$, null, false, 0, undefined),
    ],
    [[0, 96]]);
