  ...
  $: {
    structSpec: {
      ...
      fields: [
        ...
        { name: 'viewport_offset', packedOffset: 32, packedBitOffset: 0, type: gfx.mojom.PointFSpec, nullable: false },
        { name: 'screen_orientation_type', packedOffset: 40, packedBitOffset: 0, type: display.mojom.ScreenOrientationSpec, nullable: false },
        { name: 'viewport_segments', packedOffset: 48, packedBitOffset: 0, type: mojo.internal.Array, nullable: false },
        { name: 'device_posture', packedOffset: 56, packedBitOffset: 0, type: blink.mojom.DevicePostureTypeSpec, nullable: false },
