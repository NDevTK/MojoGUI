...
display.mojom.DisplaySnapshotColorInfoSpec = {
  $: {
    structSpec: {
      ...
      packedSize: 48,
      fields: [
        { name: 'color_space', packedOffset: 0, packedBitOffset: 0, type: mojo.internal.Pointer, nullable: false },
        { name: 'edid_primaries', packedOffset: 8, packedBitOffset: 0, type: mojo.internal.Pointer, nullable: false },
        { name: 'hdr_static_metadata', packedOffset: 16, packedBitOffset: 0, type: mojo.internal.Pointer, nullable: true },
  ...
  $: {
    structSpec: {
      ...
      fields: [
        ...
        { name: 'origin', packedOffset: 24, packedBitOffset: 0, type: mojo.internal.Pointer, nullable: false },
        { name: 'physical_size', packedOffset: 32, packedBitOffset: 0, type: mojo.internal.Pointer, nullable: false },
        { name: 'type', packedOffset: 40, packedBitOffset: 0, type: mojo.internal.Pointer, nullable: false },
        ...
        { name: 'privacy_screen_state', packedOffset: 64, packedBitOffset: 0, type: mojo.internal.Pointer, nullable: false },
        { name: 'color_info', packedOffset: 72, packedBitOffset: 0, type: mojo.internal.Pointer, nullable: false },
        { name: 'display_name', packedOffset: 80, packedBitOffset: 0, type: mojo.internal.String, nullable: false },
        { name: 'sys_path', packedOffset: 88, packedBitOffset: 0, type: mojo.internal.Pointer, nullable: false },
        { name: 'modes', packedOffset: 96, packedBitOffset: 0, type: mojo.internal.Array, nullable: false },
        { name: 'panel_orientation', packedOffset: 104, packedBitOffset: 0, type: mojo.internal.Pointer, nullable: false },
        ...
        { name: 'maximum_cursor_size', packedOffset: 144, packedBitOffset: 0, type: mojo.internal.Pointer, nullable: false },
