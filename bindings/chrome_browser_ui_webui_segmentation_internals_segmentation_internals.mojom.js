...
mojo.internal.bindings.segmentation_internals.mojom.PageHandlerFactoryRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.segmentation_internals.mojom.PageHandlerFactoryRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.segmentation_internals.mojom.PageHandlerFactory.getRemote = function() {
  let remote = new mojo.internal.bindings.segmentation_internals.mojom.PageHandlerFactoryRemote();
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.segmentation_internals.mojom.PageHandlerFactory_CreatePageHandler_ParamsSpec.$.structSpec;
...
mojo.internal.bindings.segmentation_internals.mojom.PageHandlerFactoryReceiver = mojo.internal.bindings.segmentation_internals.mojom.PageHandlerFactoryReceiver;

mojo.internal.bindings.segmentation_internals.mojom.PageHandlerFactoryPtr = mojo.internal.bindings.segmentation_internals.mojom.PageHandlerFactoryRemote;
mojo.internal.bindings.segmentation_internals.mojom.PageHandlerFactoryRequest = mojo.internal.bindings.segmentation_internals.mojom.PageHandlerFactoryPendingReceiver;
...
mojo.internal.bindings.segmentation_internals.mojom.PageHandlerRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.segmentation_internals.mojom.PageHandlerRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.segmentation_internals.mojom.PageHandler.getRemote = function() {
  let remote = new mojo.internal.bindings.segmentation_internals.mojom.PageHandlerRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.segmentation_internals.mojom.PageHandler_GetServiceStatus_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for GetServiceStatus failed with TypeError');
           }
        }
        // Try Method 1: ExecuteModel
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.segmentation_internals.mojom.PageHandler_ExecuteModel_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for ExecuteModel failed with TypeError');
           }
        }
        // Try Method 2: OverwriteResult
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.segmentation_internals.mojom.PageHandler_OverwriteResult_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OverwriteResult failed with TypeError');
           }
        }
        // Try Method 3: SetSelected
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.segmentation_internals.mojom.PageHandler_SetSelected_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for SetSelected failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
             console.warn('[GeneratedReceiver] Failed to discover ordinal ' + header.ordinal);
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.segmentation_internals.mojom.PageHandler_GetServiceStatus_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.segmentation_internals.mojom.PageHandlerReceiver = mojo.internal.bindings.segmentation_internals.mojom.PageHandlerReceiver;

mojo.internal.bindings.segmentation_internals.mojom.PageHandlerPtr = mojo.internal.bindings.segmentation_internals.mojom.PageHandlerRemote;
mojo.internal.bindings.segmentation_internals.mojom.PageHandlerRequest = mojo.internal.bindings.segmentation_internals.mojom.PageHandlerPendingReceiver;
...
mojo.internal.bindings.segmentation_internals.mojom.PageRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.segmentation_internals.mojom.PageRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.segmentation_internals.mojom.Page.getRemote = function() {
  let remote = new mojo.internal.bindings.segmentation_internals.mojom.PageRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.segmentation_internals.mojom.Page_OnServiceStatusChanged_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OnServiceStatusChanged failed with TypeError');
           }
        }
        // Try Method 1: OnClientInfoAvailable
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.segmentation_internals.mojom.Page_OnClientInfoAvailable_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OnClientInfoAvailable failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
             console.warn('[GeneratedReceiver] Failed to discover ordinal ' + header.ordinal);
...
mojo.internal.bindings.segmentation_internals.mojom.PageReceiver = mojo.internal.bindings.segmentation_internals.mojom.PageReceiver;
