...
mojo.internal.bindings.tracing.mojom.TracedProcessRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.tracing.mojom.TracedProcessRemoteCallHandler(this.proxy);
  }
  ...
  connectToTracingService(arg_request) {
    return this.$.connectToTracingService(arg_request);
  }
};

mojo.internal.bindings.tracing.mojom.TracedProcessRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('tracing.mojom.TracedProcess', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.tracing.mojom.TracedProcess.getRemote = function() {
  let remote = new mojo.internal.bindings.tracing.mojom.TracedProcessRemote();
...
mojo.internal.bindings.tracing.mojom.TracedProcessReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('tracing.mojom.TracedProcess', [
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.tracing.mojom.TracedProcess_ConnectToTracingService_ParamsSpec.$.structSpec);
        ...
        case 0: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.tracing.mojom.TracedProcess_ConnectToTracingService_ResponseParamsSpec, header, rawHeader);
               responder(response);
...
mojo.internal.bindings.tracing.mojom.TracedProcessReceiver = mojo.internal.bindings.tracing.mojom.TracedProcessReceiver;
