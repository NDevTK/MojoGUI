...
mojo.internal.Struct(
    mojo.internal.bindings.chromeos.network_diagnostics.mojom.GoogleServicesConnectivityConnectionErrorSpec, 'chromeos.network_diagnostics.mojom.GoogleServicesConnectivityConnectionError', [
      mojo.internal.StructField('arg_proxy', 0, 0, mojo.internal.String, null, true, 0, undefined),
      mojo.internal.StructField('arg_connection_info', 8, 0, mojo.internal.bindings.chromeos.network_diagnostics.mojom.GoogleServicesConnectivityConnectionErrorInfoSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_problem_type', 16, 0, mojo.internal.bindings.chromeos.network_diagnostics.mojom.GoogleServicesConnectivityProblemTypeSpec, null, false, 0, undefined),
    ],
    [[0, 32]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.chromeos.network_diagnostics.mojom.GoogleServicesConnectivityProxyConnectionErrorSpec, 'chromeos.network_diagnostics.mojom.GoogleServicesConnectivityProxyConnectionError', [
      mojo.internal.StructField('arg_proxy', 0, 0, mojo.internal.String, null, false, 0, undefined),
      mojo.internal.StructField('arg_connection_info', 8, 0, mojo.internal.bindings.chromeos.network_diagnostics.mojom.GoogleServicesConnectivityConnectionErrorInfoSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_problem_type', 16, 0, mojo.internal.bindings.chromeos.network_diagnostics.mojom.GoogleServicesConnectivityProxyProblemTypeSpec, null, false, 0, undefined),
    ],
    [[0, 32]]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.chromeos.network_diagnostics.mojom.NetworkDiagnosticsRoutines_GetResult_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for GetResult failed with TypeError');
           }
        }
        // Try Method 1: GetAllResults
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.chromeos.network_diagnostics.mojom.NetworkDiagnosticsRoutines_GetAllResults_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for GetAllResults failed with TypeError');
           }
        }
        // Try Method 2: RunLanConnectivity
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.chromeos.network_diagnostics.mojom.NetworkDiagnosticsRoutines_RunLanConnectivity_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for RunLanConnectivity failed with TypeError');
           }
        }
        // Try Method 3: RunSignalStrength
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.chromeos.network_diagnostics.mojom.NetworkDiagnosticsRoutines_RunSignalStrength_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for RunSignalStrength failed with TypeError');
           }
        }
        // Try Method 4: RunGatewayCanBePinged
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.chromeos.network_diagnostics.mojom.NetworkDiagnosticsRoutines_RunGatewayCanBePinged_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for RunGatewayCanBePinged failed with TypeError');
           }
        }
        // Try Method 5: RunHasSecureWiFiConnection
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.chromeos.network_diagnostics.mojom.NetworkDiagnosticsRoutines_RunHasSecureWiFiConnection_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for RunHasSecureWiFiConnection failed with TypeError');
           }
        }
        // Try Method 6: RunDnsResolverPresent
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.chromeos.network_diagnostics.mojom.NetworkDiagnosticsRoutines_RunDnsResolverPresent_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for RunDnsResolverPresent failed with TypeError');
           }
        }
        // Try Method 7: RunDnsLatency
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.chromeos.network_diagnostics.mojom.NetworkDiagnosticsRoutines_RunDnsLatency_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for RunDnsLatency failed with TypeError');
           }
        }
        // Try Method 8: RunDnsResolution
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.chromeos.network_diagnostics.mojom.NetworkDiagnosticsRoutines_RunDnsResolution_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for RunDnsResolution failed with TypeError');
           }
        }
        // Try Method 9: RunCaptivePortal
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.chromeos.network_diagnostics.mojom.NetworkDiagnosticsRoutines_RunCaptivePortal_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for RunCaptivePortal failed with TypeError');
           }
        }
        // Try Method 10: RunHttpFirewall
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.chromeos.network_diagnostics.mojom.NetworkDiagnosticsRoutines_RunHttpFirewall_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for RunHttpFirewall failed with TypeError');
           }
        }
        // Try Method 11: RunHttpsFirewall
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.chromeos.network_diagnostics.mojom.NetworkDiagnosticsRoutines_RunHttpsFirewall_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for RunHttpsFirewall failed with TypeError');
           }
        }
        // Try Method 12: RunHttpsLatency
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.chromeos.network_diagnostics.mojom.NetworkDiagnosticsRoutines_RunHttpsLatency_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for RunHttpsLatency failed with TypeError');
           }
        }
        // Try Method 13: RunVideoConferencing
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.chromeos.network_diagnostics.mojom.NetworkDiagnosticsRoutines_RunVideoConferencing_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for RunVideoConferencing failed with TypeError');
           }
        }
        // Try Method 14: RunArcHttp
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.chromeos.network_diagnostics.mojom.NetworkDiagnosticsRoutines_RunArcHttp_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for RunArcHttp failed with TypeError');
           }
        }
        // Try Method 15: RunArcPing
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.chromeos.network_diagnostics.mojom.NetworkDiagnosticsRoutines_RunArcPing_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for RunArcPing failed with TypeError');
           }
        }
        // Try Method 16: RunArcDnsResolution
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.chromeos.network_diagnostics.mojom.NetworkDiagnosticsRoutines_RunArcDnsResolution_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for RunArcDnsResolution failed with TypeError');
           }
        }
        // Try Method 17: RunGoogleServicesConnectivity
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.chromeos.network_diagnostics.mojom.NetworkDiagnosticsRoutines_RunGoogleServicesConnectivity_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for RunGoogleServicesConnectivity failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
