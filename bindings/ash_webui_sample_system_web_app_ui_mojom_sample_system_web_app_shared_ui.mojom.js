...
mojo.internal.bindings.ash.mojom.sample_swa.ChildUntrustedPageRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.ash.mojom.sample_swa.ChildUntrustedPagePendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.ash.mojom.sample_swa.ChildUntrustedPageRemoteCallHandler(this.proxy);
  }
  ...
  doSomethingForParent(arg_task) {
    return this.$.doSomethingForParent(arg_task);
  }
};
...
mojo.internal.bindings.ash.mojom.sample_swa.ChildUntrustedPage.getRemote = function() {
  let remote = new mojo.internal.bindings.ash.mojom.sample_swa.ChildUntrustedPageRemote();
...
mojo.internal.bindings.ash.mojom.sample_swa.ChildUntrustedPageReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ash.mojom.sample_swa.ChildUntrustedPage_DoSomethingForParent_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for DoSomethingForParent failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.ash.mojom.sample_swa.ChildUntrustedPageReceiver = mojo.internal.bindings.ash.mojom.sample_swa.ChildUntrustedPageReceiver;

mojo.internal.bindings.ash.mojom.sample_swa.ChildUntrustedPagePtr = mojo.internal.bindings.ash.mojom.sample_swa.ChildUntrustedPageRemote;
mojo.internal.bindings.ash.mojom.sample_swa.ChildUntrustedPageRequest = mojo.internal.bindings.ash.mojom.sample_swa.ChildUntrustedPagePendingReceiver;
...
mojo.internal.bindings.ash.mojom.sample_swa.ParentTrustedPageRemote = class {
  static get $interfaceName() {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.ash.mojom.sample_swa.ParentTrustedPagePendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.ash.mojom.sample_swa.ParentTrustedPageRemoteCallHandler(this.proxy);
  }
  ...
  doSomethingForChild(arg_task) {
    return this.$.doSomethingForChild(arg_task);
  }
};
...
mojo.internal.bindings.ash.mojom.sample_swa.ParentTrustedPage.getRemote = function() {
  let remote = new mojo.internal.bindings.ash.mojom.sample_swa.ParentTrustedPageRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
...
mojo.internal.bindings.ash.mojom.sample_swa.ParentTrustedPageReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ash.mojom.sample_swa.ParentTrustedPage_DoSomethingForChild_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for DoSomethingForChild failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
             console.warn('[GeneratedReceiver] Failed to discover ordinal ' + header.ordinal);
...
mojo.internal.bindings.ash.mojom.sample_swa.ParentTrustedPageReceiver = mojo.internal.bindings.ash.mojom.sample_swa.ParentTrustedPageReceiver;
