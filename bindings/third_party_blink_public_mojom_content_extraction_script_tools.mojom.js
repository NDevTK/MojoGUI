...
mojo.internal.bindings.blink.mojom.ModelContextHostRemoteCallHandler = class {
  ...
  executeRemoteScriptTool(arg_tool_owner_frame_token, arg_expected_target_origin, arg_name, arg_input_arguments) {
    return this.proxy.sendMessage(
      ...
      mojo.internal.bindings.blink.mojom.ModelContextHost_ExecuteRemoteScriptTool_ParamsSpec,
      mojo.internal.bindings.blink.mojom.ModelContextHost_ExecuteRemoteScriptTool_ResponseParamsSpec,
      [arg_tool_owner_frame_token, arg_expected_target_origin, arg_name, arg_input_arguments],
      false);
  }
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        ...
        case 4: {
          ...
          const result = this.impl.executeRemoteScriptTool(params.arg_tool_owner_frame_token, params.arg_expected_target_origin, params.arg_name, params.arg_input_arguments);
          const expectsResponse = header.expectsResponse || (header.flags & 1);
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              const resp_obj = response;
...
mojo.internal.bindings.blink.mojom.ModelContextRemote = class {
  ...
  executeScriptTool(arg_name, arg_input_arguments) {
    return this.$.executeScriptTool(arg_name, arg_input_arguments);
  }
};
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        ...
        case 1: {
          ...
          const result = this.impl.executeScriptTool(params.arg_name, params.arg_input_arguments);
          const expectsResponse = header.expectsResponse || (header.flags & 1);
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              const resp_obj = response;
...
mojo.internal.Struct(
    mojo.internal.bindings.blink.mojom.ModelContextHost_ExecuteRemoteScriptTool_ParamsSpec, 'blink.mojom.ModelContextHost_ExecuteRemoteScriptTool_Params', [
      mojo.internal.StructField('arg_tool_owner_frame_token', 0, 0, mojo.internal.bindings.blink.mojom.FrameTokenSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_expected_target_origin', 16, 0, mojo.internal.bindings.url.mojom.OriginSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_name', 24, 0, mojo.internal.String, null, false, 0, undefined),
      mojo.internal.StructField('arg_input_arguments', 32, 0, mojo.internal.String, null, false, 0, undefined),
    ],
    [[0, 48]]);
