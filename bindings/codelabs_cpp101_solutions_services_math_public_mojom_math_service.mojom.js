// Auto-generated MojoJS binding
 ...
 mojo.internal.bindings.math = mojo.internal.bindings.math || {};
mojo.internal.bindings.math.mojom = mojo.internal.bindings.math.mojom || {};

mojo.internal.bindings.math.mojom.MathService = {};
mojo.internal.bindings.math.mojom.MathServiceSpec = { $ : {} };
mojo.internal.bindings.math.mojom.MathService.$interfaceName = 'math.mojom.MathService';
...
mojo.internal.bindings.math.mojom.MathServiceRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.math.mojom.MathServicePendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.math.mojom.MathServiceRemoteCallHandler(this.proxy);
  }
  ...
  divide(arg_dividend, arg_divisor) {
    return this.$.divide(arg_dividend, arg_divisor);
  }
};

mojo.internal.bindings.math.mojom.MathServiceRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('math.mojom.MathService', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.math.mojom.MathService.getRemote = function() {
  let remote = new mojo.internal.bindings.math.mojom.MathServiceRemote();
...
mojo.internal.bindings.math.mojom.MathServiceReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('math.mojom.MathService', [
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.math.mojom.MathService_Divide_ParamsSpec.$.structSpec);
        ...
        case 0: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.math.mojom.MathService_Divide_ResponseParamsSpec, header, rawHeader);
               responder(response);
...
mojo.internal.bindings.math.mojom.MathServiceReceiver = mojo.internal.bindings.math.mojom.MathServiceReceiver;
