...
mojo.internal.Struct(
    mojo.internal.bindings.ash.focus_mode.mojom.PlaybackDataSpec, 'ash.focus_mode.mojom.PlaybackData', [
      ...
      mojo.internal.StructField('arg_client_start_time', 32, 0, mojo.internal.bindings.mojo_base.mojom.JSTimeSpec.$, null, false, 0, undefined),
      mojo.internal.StructField('arg_playback_start_offset', 40, 0, mojo.internal.Int32, 0, false, 0, undefined),
      mojo.internal.StructField('arg_media_time_current', 44, 0, mojo.internal.Int32, 0, false, 0, undefined),
      mojo.internal.StructField('arg_media_start', 48, 0, mojo.internal.Int32, 0, false, 0, undefined),
      mojo.internal.StructField('arg_media_end', 52, 0, mojo.internal.Int32, 0, false, 0, undefined),
      mojo.internal.StructField('arg_initial_playback', 56, 0, mojo.internal.Bool, false, false, 0, undefined),
    ],
    [[0, 72]]);
...
mojo.internal.bindings.ash.focus_mode.mojom.MediaClientRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.ash.focus_mode.mojom.MediaClientRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.ash.focus_mode.mojom.MediaClient.getRemote = function() {
  let remote = new mojo.internal.bindings.ash.focus_mode.mojom.MediaClientRemote();
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ash.focus_mode.mojom.MediaClient_StartPlay_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for StartPlay failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.ash.focus_mode.mojom.MediaClientReceiver = mojo.internal.bindings.ash.focus_mode.mojom.MediaClientReceiver;

mojo.internal.bindings.ash.focus_mode.mojom.MediaClientPtr = mojo.internal.bindings.ash.focus_mode.mojom.MediaClientRemote;
mojo.internal.bindings.ash.focus_mode.mojom.MediaClientRequest = mojo.internal.bindings.ash.focus_mode.mojom.MediaClientPendingReceiver;
...
mojo.internal.bindings.ash.focus_mode.mojom.TrackProviderRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.ash.focus_mode.mojom.TrackProviderRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.ash.focus_mode.mojom.TrackProvider.getRemote = function() {
  let remote = new mojo.internal.bindings.ash.focus_mode.mojom.TrackProviderRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ash.focus_mode.mojom.TrackProvider_GetTrack_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for GetTrack failed with TypeError');
           }
        }
        // Try Method 1: SetMediaClient
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ash.focus_mode.mojom.TrackProvider_SetMediaClient_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for SetMediaClient failed with TypeError');
           }
        }
        // Try Method 2: ReportPlayback
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ash.focus_mode.mojom.TrackProvider_ReportPlayback_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for ReportPlayback failed with TypeError');
           }
        }
        // Try Method 3: ReportPlayerError
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ash.focus_mode.mojom.TrackProvider_ReportPlayerError_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for ReportPlayerError failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
             console.warn('[GeneratedReceiver] Failed to discover ordinal ' + header.ordinal);
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.ash.focus_mode.mojom.TrackProvider_GetTrack_ParamsSpec.$.structSpec);
        ...
        case 3: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.ash.focus_mode.mojom.TrackProvider_ReportPlayerError_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.ash.focus_mode.mojom.TrackProviderReceiver = mojo.internal.bindings.ash.focus_mode.mojom.TrackProviderReceiver;
