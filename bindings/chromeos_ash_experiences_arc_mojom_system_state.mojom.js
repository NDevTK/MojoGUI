...
mojo.internal.bindings.arc.mojom.SystemStateHostRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.arc.mojom.SystemStateHostPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.arc.mojom.SystemStateHostRemoteCallHandler(this.proxy);
  }
  ...
  updateAppRunningState(arg_state) {
    return this.$.updateAppRunningState(arg_state);
  }
};
...
mojo.internal.bindings.arc.mojom.SystemStateHost.getRemote = function() {
  let remote = new mojo.internal.bindings.arc.mojom.SystemStateHostRemote();
...
mojo.internal.bindings.arc.mojom.SystemStateHostReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.arc.mojom.SystemStateHost_UpdateAppRunningState_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for UpdateAppRunningState failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.arc.mojom.SystemStateHostReceiver = mojo.internal.bindings.arc.mojom.SystemStateHostReceiver;

mojo.internal.bindings.arc.mojom.SystemStateHostPtr = mojo.internal.bindings.arc.mojom.SystemStateHostRemote;
mojo.internal.bindings.arc.mojom.SystemStateHostRequest = mojo.internal.bindings.arc.mojom.SystemStateHostPendingReceiver;
...
mojo.internal.bindings.arc.mojom.SystemStateInstanceRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.arc.mojom.SystemStateInstanceRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.arc.mojom.SystemStateInstance.getRemote = function() {
  let remote = new mojo.internal.bindings.arc.mojom.SystemStateInstanceRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
...
mojo.internal.bindings.arc.mojom.SystemStateInstanceReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.arc.mojom.SystemStateInstance_Init_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
...
mojo.internal.bindings.arc.mojom.SystemStateInstanceReceiver = mojo.internal.bindings.arc.mojom.SystemStateInstanceReceiver;
