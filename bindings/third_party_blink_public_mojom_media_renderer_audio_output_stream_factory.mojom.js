...
mojo.internal.bindings.blink.mojom.RendererAudioOutputStreamFactory = {};
mojo.internal.bindings.blink.mojom.RendererAudioOutputStreamFactorySpec = { $ : {} };
mojo.internal.bindings.blink.mojom.RendererAudioOutputStreamFactory.$interfaceName = 'blink.mojom.RendererAudioOutputStreamFactory';
...
mojo.internal.bindings.blink.mojom.RendererAudioOutputStreamFactoryRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.blink.mojom.RendererAudioOutputStreamFactoryPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.blink.mojom.RendererAudioOutputStreamFactoryRemoteCallHandler(this.proxy);
  }
  ...
  requestDeviceAuthorization(arg_stream_provider_receiver, arg_session_id, arg_device_id) {
    return this.$.requestDeviceAuthorization(arg_stream_provider_receiver, arg_session_id, arg_device_id);
  }
};

mojo.internal.bindings.blink.mojom.RendererAudioOutputStreamFactoryRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('blink.mojom.RendererAudioOutputStreamFactory', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.blink.mojom.RendererAudioOutputStreamFactory.getRemote = function() {
  let remote = new mojo.internal.bindings.blink.mojom.RendererAudioOutputStreamFactoryRemote();
...
mojo.internal.bindings.blink.mojom.RendererAudioOutputStreamFactoryReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('blink.mojom.RendererAudioOutputStreamFactory', [
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.blink.mojom.RendererAudioOutputStreamFactory_RequestDeviceAuthorization_ParamsSpec.$.structSpec);
        ...
        case 0: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.blink.mojom.RendererAudioOutputStreamFactory_RequestDeviceAuthorization_ResponseParamsSpec, header, rawHeader);
               responder(response);
...
mojo.internal.bindings.blink.mojom.RendererAudioOutputStreamFactoryReceiver = mojo.internal.bindings.blink.mojom.RendererAudioOutputStreamFactoryReceiver;
