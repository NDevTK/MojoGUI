...
mojo.internal.bindings.autofill.mojom.AutofillVisibilityObserver.$interfaceName = 'autofill.mojom.AutofillVisibilityObserver';
mojo.internal.bindings.autofill.mojom.AutofillVisibilityObserver_OnFieldBecameVisible_ParamsSpec = mojo.internal.bindings.autofill.mojom.AutofillVisibilityObserver_OnFieldBecameVisible_ParamsSpec || { $: {} };
if (mojo.internal.bindings.autofill.mojom.AutofillVisibilityObserver_OnFieldBecameVisible_ParamsSpec.$.structSpec && mojo.internal.bindings.autofill.mojom.AutofillVisibilityObserver_OnFieldBecameVisible_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.autofill.mojom.AutofillVisibilityObserver_OnFieldBecameVisible_ParamsSpec.$ = {};
...
mojo.internal.bindings.autofill.mojom.FormControlType = {
  ...
  kTextArea: 14,
  kInputDate: 15,
  kInputHiddenEmailVerification: 16,
};
...
mojo.internal.bindings.autofill.mojom.FieldActionType = {
  kReplaceAll: 0,
  kReplaceSelection: 1,
  kReplaceSelectionForAtMemory: 2,
  kSelectAll: 3,
};
...
mojo.internal.bindings.autofill.mojom.EmailVerificationState = {
  kNone: 0,
  kLoading: 1,
  kVerified: 2,
...
mojo.internal.bindings.autofill.mojom.AutofillVisibilityObserverPendingReceiver = class {
  constructor(handle) {
    this.handle = handle;
    if (handle) {
...
mojo.internal.bindings.autofill.mojom.AutofillVisibilityObserverRemote = class {
  static get $interfaceName() {
    return 'autofill.mojom.AutofillVisibilityObserver';
  }

  constructor(handle = undefined) {
    this.__mojoHandle = handle;
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.autofill.mojom.AutofillVisibilityObserverPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.autofill.mojom.AutofillVisibilityObserverRemoteCallHandler(this.proxy);
  }
  ...
  onFieldBecameVisible() {
    return this.$.onFieldBecameVisible();
  }
};

mojo.internal.bindings.autofill.mojom.AutofillVisibilityObserverRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('autofill.mojom.AutofillVisibilityObserver', [
      { explicit: null },
    ]);
  }
  ...
  onFieldBecameVisible() {
    return this.proxy.sendMessage(
      ...
      mojo.internal.bindings.autofill.mojom.AutofillVisibilityObserver_OnFieldBecameVisible_ParamsSpec,
      null,
      [],
      false);
  }
...
mojo.internal.bindings.autofill.mojom.AutofillVisibilityObserver.getRemote = function() {
  let remote = new mojo.internal.bindings.autofill.mojom.AutofillVisibilityObserverRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
    'autofill.mojom.AutofillVisibilityObserver',
    'context');
  return remote.$;
};

mojo.internal.bindings.autofill.mojom.AutofillVisibilityObserverReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('autofill.mojom.AutofillVisibilityObserver', [
      { explicit: null },
    ]);
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        case 0: {
          ...
          const params = decoder.decodeStructInline(mojo.internal.bindings.autofill.mojom.AutofillVisibilityObserver_OnFieldBecameVisible_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.onFieldBecameVisible');
          const result = this.impl.onFieldBecameVisible();
          break;
        }
      }
      } catch (err) {
...
mojo.internal.bindings.autofill.mojom.AutofillVisibilityObserverReceiver = mojo.internal.bindings.autofill.mojom.AutofillVisibilityObserverReceiver;

mojo.internal.bindings.autofill.mojom.AutofillVisibilityObserverPtr = mojo.internal.bindings.autofill.mojom.AutofillVisibilityObserverRemote;
mojo.internal.bindings.autofill.mojom.AutofillVisibilityObserverRequest = mojo.internal.bindings.autofill.mojom.AutofillVisibilityObserverPendingReceiver;
...
mojo.internal.Struct(
    mojo.internal.bindings.autofill.mojom.AutocompleteParsingResultSpec, 'autofill.mojom.AutocompleteParsingResult', [
      ...
      mojo.internal.StructField('arg_field_type', 12, 0, mojo.internal.bindings.autofill.mojom.HtmlFieldTypeSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_webauthn', 16, 0, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_webidentity', 16, 1, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_email_verification_token', 16, 2, mojo.internal.Bool, false, false, 0, undefined),
    ],
    [[0, 32]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.autofill.mojom.FormFieldDataSpec, 'autofill.mojom.FormFieldData', [
      ...
      mojo.internal.StructField('arg_placeholder_attribute', 96, 0, mojo.internal.bindings.mojo_base.mojom.String16Spec, null, false, 0, undefined),
      mojo.internal.StructField('arg_css_classes', 104, 0, mojo.internal.bindings.mojo_base.mojom.String16Spec, null, false, 0, undefined),
      mojo.internal.StructField('arg_aria_label', 112, 0, mojo.internal.bindings.mojo_base.mojom.String16Spec, null, false, 0, undefined),
      mojo.internal.StructField('arg_aria_description', 120, 0, mojo.internal.bindings.mojo_base.mojom.String16Spec, null, false, 0, undefined),
      mojo.internal.StructField('arg_nonce', 128, 0, mojo.internal.bindings.mojo_base.mojom.String16Spec, null, false, 0, undefined),
      mojo.internal.StructField('arg_renderer_id', 136, 0, mojo.internal.bindings.autofill.mojom.FieldRendererIdSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_host_form_id', 144, 0, mojo.internal.bindings.autofill.mojom.FormRendererIdSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_form_control_ax_id', 152, 0, mojo.internal.Int32, 0, false, 0, undefined),
      mojo.internal.StructField('arg_is_autofilled_according_to_renderer', 156, 0, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_is_focusable', 156, 1, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_is_visible', 156, 2, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_should_autocomplete', 156, 3, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_is_enabled', 156, 4, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_is_readonly', 156, 5, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_allows_writing_suggestions', 156, 6, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_force_override', 156, 7, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_max_length', 160, 0, mojo.internal.Uint64, 0, false, 0, undefined),
      mojo.internal.StructField('arg_check_status', 168, 0, mojo.internal.bindings.autofill.mojom.CheckStatusSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_role', 172, 0, mojo.internal.bindings.autofill.mojom.RoleAttributeSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_text_direction', 176, 0, mojo.internal.bindings.mojo_base.mojom.TextDirectionSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_label_source', 180, 0, mojo.internal.bindings.autofill.mojom.LabelSourceSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_user_input', 184, 0, mojo.internal.bindings.mojo_base.mojom.String16Spec, null, false, 0, undefined),
      mojo.internal.StructField('arg_options', 192, 0, mojo.internal.Array(mojo.internal.bindings.autofill.mojom.SelectOptionSpec, false), null, false, 0, undefined),
      mojo.internal.StructField('arg_bounds', 200, 0, mojo.internal.bindings.gfx.mojom.RectFSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_datalist_options', 208, 0, mojo.internal.Array(mojo.internal.bindings.autofill.mojom.SelectOptionSpec, false), null, false, 0, undefined),
    ],
    [[0, 224]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.autofill.mojom.FormDataSpec, 'autofill.mojom.FormData', [
      ...
      mojo.internal.StructField('arg_is_action_empty', 40, 0, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_is_gaia_with_skip_save_password_form', 40, 1, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_likely_contains_captcha', 40, 2, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_submission_event', 44, 0, mojo.internal.bindings.autofill.mojom.SubmissionIndicatorEventSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_renderer_id', 48, 0, mojo.internal.bindings.autofill.mojom.FormRendererIdSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_child_frames', 56, 0, mojo.internal.Array(mojo.internal.bindings.autofill.mojom.FrameTokenWithPredecessorSpec, false), null, false, 0, undefined),
...
mojo.internal.Struct(
    mojo.internal.bindings.autofill.mojom.PasswordFormFillDataSpec, 'autofill.mojom.PasswordFormFillData', [
      ...
      mojo.internal.StructField('arg_wait_for_username', 48, 0, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_suggestion_banned_fields', 56, 0, mojo.internal.Array(mojo.internal.bindings.autofill.mojom.FieldRendererIdSpec, false), null, false, 0, undefined),
    ],
    [[0, 72]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.autofill.mojom.PasswordGenerationUIDataSpec, 'autofill.mojom.PasswordGenerationUIData', [
      ...
      mojo.internal.StructField('arg_max_length', 8, 0, mojo.internal.Int32, 0, false, 0, undefined),
      mojo.internal.StructField('arg_is_generation_element_password_type', 12, 0, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_generation_rejected', 12, 1, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_generation_element', 16, 0, mojo.internal.bindings.mojo_base.mojom.String16Spec, null, false, 0, undefined),
      mojo.internal.StructField('arg_generation_element_id', 24, 0, mojo.internal.bindings.autofill.mojom.FieldRendererIdSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_text_direction', 32, 0, mojo.internal.bindings.mojo_base.mojom.TextDirectionSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_form_data', 40, 0, mojo.internal.bindings.autofill.mojom.FormDataSpec, null, false, 0, undefined),
    ],
    [[0, 56]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.autofill.mojom.TriggeringFieldSpec, 'autofill.mojom.TriggeringField', [
      ...
      mojo.internal.StructField('arg_text_direction', 12, 0, mojo.internal.bindings.mojo_base.mojom.TextDirectionSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_typed_username', 16, 0, mojo.internal.bindings.mojo_base.mojom.String16Spec, null, false, 0, undefined),
      mojo.internal.StructField('arg_show_webauthn_credentials', 24, 0, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_show_identity_credentials', 24, 1, mojo.internal.Bool, false, false, 0, undefined),
...
mojo.internal.Struct(
    mojo.internal.bindings.autofill.mojom.PasswordSuggestionRequestSpec, 'autofill.mojom.PasswordSuggestionRequest', [
      ...
      mojo.internal.StructField('arg_username_field_id', 16, 0, mojo.internal.bindings.autofill.mojom.FieldRendererIdSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_password_field_id', 24, 0, mojo.internal.bindings.autofill.mojom.FieldRendererIdSpec, null, false, 0, undefined),
    ],
    [[0, 40]]);
