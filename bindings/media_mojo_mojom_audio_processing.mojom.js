...
mojo.internal.bindings.media.mojom.AudioProcessorControlsRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.media.mojom.AudioProcessorControlsPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.media.mojom.AudioProcessorControlsRemoteCallHandler(this.proxy);
  }
  ...
  setPreferredNumCaptureChannels(arg_num_preferred_channels) {
    return this.$.setPreferredNumCaptureChannels(arg_num_preferred_channels);
  }
};
...
mojo.internal.bindings.media.mojom.AudioProcessorControls.getRemote = function() {
  let remote = new mojo.internal.bindings.media.mojom.AudioProcessorControlsRemote();
...
mojo.internal.bindings.media.mojom.AudioProcessorControlsReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.media.mojom.AudioProcessorControls_GetStats_ParamsSpec.$.structSpec;
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.media.mojom.AudioProcessorControls_SetPreferredNumCaptureChannels_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for SetPreferredNumCaptureChannels failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.media.mojom.AudioProcessorControls_GetStats_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.media.mojom.AudioProcessorControlsReceiver = mojo.internal.bindings.media.mojom.AudioProcessorControlsReceiver;
