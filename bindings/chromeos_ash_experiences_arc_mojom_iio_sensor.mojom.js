...
mojo.internal.bindings.arc.mojom.IioSensorHostRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.arc.mojom.IioSensorHostPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.arc.mojom.IioSensorHostRemoteCallHandler(this.proxy);
  }
  ...
  registerSensorHalClient(arg_client) {
    return this.$.registerSensorHalClient(arg_client);
  }
};
...
mojo.internal.bindings.arc.mojom.IioSensorHost.getRemote = function() {
  let remote = new mojo.internal.bindings.arc.mojom.IioSensorHostRemote();
...
mojo.internal.bindings.arc.mojom.IioSensorHostReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.arc.mojom.IioSensorHost_RegisterSensorHalClient_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for RegisterSensorHalClient failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.arc.mojom.IioSensorHostReceiver = mojo.internal.bindings.arc.mojom.IioSensorHostReceiver;

mojo.internal.bindings.arc.mojom.IioSensorHostPtr = mojo.internal.bindings.arc.mojom.IioSensorHostRemote;
mojo.internal.bindings.arc.mojom.IioSensorHostRequest = mojo.internal.bindings.arc.mojom.IioSensorHostPendingReceiver;
...
mojo.internal.bindings.arc.mojom.IioSensorInstanceRemote = class {
  static get $interfaceName() {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.arc.mojom.IioSensorInstancePendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.arc.mojom.IioSensorInstanceRemoteCallHandler(this.proxy);
  }
  ...
  onTabletModeChanged(arg_is_tablet_mode_on) {
    return this.$.onTabletModeChanged(arg_is_tablet_mode_on);
  }
};
...
mojo.internal.bindings.arc.mojom.IioSensorInstance.getRemote = function() {
  let remote = new mojo.internal.bindings.arc.mojom.IioSensorInstanceRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
...
mojo.internal.bindings.arc.mojom.IioSensorInstanceReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.arc.mojom.IioSensorInstance_Init_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.arc.mojom.IioSensorInstance_OnTabletModeChanged_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
...
mojo.internal.bindings.arc.mojom.IioSensorInstanceReceiver = mojo.internal.bindings.arc.mojom.IioSensorInstanceReceiver;
