...
mojo.internal.Struct(
    network.mojom.LinkHeaderSpec, 'network.mojom.LinkHeader', [
      ...
      mojo.internal.StructField('as', 12, 0, network.mojom.LinkAsAttributeSpec, null, false, 0, undefined),
      mojo.internal.StructField('cross_origin', 16, 0, network.mojom.CrossOriginAttributeSpec, null, false, 0, undefined),
      mojo.internal.StructField('fetch_priority', 20, 0, network.mojom.FetchPriorityAttributeSpec, null, false, 0, undefined),
      mojo.internal.StructField('mime_type', 24, 0, mojo.internal.String, null, true, 0, undefined),
    ],
    [[0, 40]]);
