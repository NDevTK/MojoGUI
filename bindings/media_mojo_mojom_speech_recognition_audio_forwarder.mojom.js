...
mojo.internal.bindings.media.mojom.SpeechRecognitionAudioForwarder = {};
mojo.internal.bindings.media.mojom.SpeechRecognitionAudioForwarderSpec = { $ : {} };
...
mojo.internal.bindings.media.mojom.SpeechRecognitionAudioForwarderRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.media.mojom.SpeechRecognitionAudioForwarderPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.media.mojom.SpeechRecognitionAudioForwarderRemoteCallHandler(this.proxy);
  }
  ...
  addAudioFromRenderer(arg_buffer) {
    return this.$.addAudioFromRenderer(arg_buffer);
  }
};

mojo.internal.bindings.media.mojom.SpeechRecognitionAudioForwarderRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('media.mojom.SpeechRecognitionAudioForwarder', [
      { explicit: 1 },
    ]);
  }
...
mojo.internal.bindings.media.mojom.SpeechRecognitionAudioForwarder.getRemote = function() {
  let remote = new mojo.internal.bindings.media.mojom.SpeechRecognitionAudioForwarderRemote();
...
mojo.internal.bindings.media.mojom.SpeechRecognitionAudioForwarderReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('media.mojom.SpeechRecognitionAudioForwarder', [
      { explicit: 1 },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.media.mojom.SpeechRecognitionAudioForwarder_AddAudioFromRenderer_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for AddAudioFromRenderer failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.media.mojom.SpeechRecognitionAudioForwarderReceiver = mojo.internal.bindings.media.mojom.SpeechRecognitionAudioForwarderReceiver;
