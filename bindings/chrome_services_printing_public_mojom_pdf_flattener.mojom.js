...
mojo.internal.Struct(
    mojo.internal.bindings.printing.mojom.PdfFlattener_SetUseSkiaRendererPolicy_ParamsSpec, 'printing.mojom.PdfFlattener_SetUseSkiaRendererPolicy_Params', [
      mojo.internal.StructField('arg_use_skia', 0, 0, mojo.internal.Bool, false, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.bindings.printing.mojom.PdfFlattenerPendingReceiver = class {
  constructor(handle) {
    this.handle = handle;
  }
};

mojo.internal.bindings.printing.mojom.PdfFlattenerRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.printing.mojom.PdfFlattenerPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.printing.mojom.PdfFlattenerRemoteCallHandler(this.proxy);
  }
  ...
  flattenPdf(arg_src_pdf_region) {
    return this.$.flattenPdf(arg_src_pdf_region);
  }
...
mojo.internal.bindings.printing.mojom.PdfFlattenerRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('printing.mojom.PdfFlattener', [
      { explicit: null },
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.printing.mojom.PdfFlattener.getRemote = function() {
  let remote = new mojo.internal.bindings.printing.mojom.PdfFlattenerRemote();
...
mojo.internal.bindings.printing.mojom.PdfFlattenerReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('printing.mojom.PdfFlattener', [
      { explicit: null },
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.printing.mojom.PdfFlattener_FlattenPdf_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for FlattenPdf failed with TypeError');
           }
        }
        // Try Method 1: SetUseSkiaRendererPolicy
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.printing.mojom.PdfFlattener_SetUseSkiaRendererPolicy_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.printing.mojom.PdfFlattener_FlattenPdf_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.flattenPdf');
          const result = this.impl.flattenPdf(params.arg_src_pdf_region);
          const expectsResponse = header.expectsResponse || (header.flags & 1);
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              this.endpoint.send(header.ordinal, header.requestId, mojo.internal.kMessageFlagIsResponse, mojo.internal.bindings.printing.mojom.PdfFlattener_FlattenPdf_ResponseParamsSpec, response);
        ...
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.printing.mojom.PdfFlattener_SetUseSkiaRendererPolicy_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.printing.mojom.PdfFlattenerReceiver = mojo.internal.bindings.printing.mojom.PdfFlattenerReceiver;

mojo.internal.bindings.printing.mojom.PdfFlattenerPtr = mojo.internal.bindings.printing.mojom.PdfFlattenerRemote;
mojo.internal.bindings.printing.mojom.PdfFlattenerRequest = mojo.internal.bindings.printing.mojom.PdfFlattenerPendingReceiver;
