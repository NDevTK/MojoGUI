...
mojo.internal.bindings.device_test.mojom.XRTestHook_WaitGetAllControllerData_ParamsSpec = mojo.internal.bindings.device_test.mojom.XRTestHook_WaitGetAllControllerData_ParamsSpec || { $: {} };
if (mojo.internal.bindings.device_test.mojom.XRTestHook_WaitGetAllControllerData_ParamsSpec.$.structSpec && mojo.internal.bindings.device_test.mojom.XRTestHook_WaitGetAllControllerData_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.device_test.mojom.XRTestHook_WaitGetAllControllerData_ParamsSpec.$ = {};
mojo.internal.bindings.device_test.mojom.XRTestHook_WaitGetAllControllerData_ResponseParamsSpec = mojo.internal.bindings.device_test.mojom.XRTestHook_WaitGetAllControllerData_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.device_test.mojom.XRTestHook_WaitGetAllControllerData_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.device_test.mojom.XRTestHook_WaitGetAllControllerData_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.device_test.mojom.XRTestHook_WaitGetAllControllerData_ResponseParamsSpec.$ = {};
...
mojo.internal.bindings.device_test.mojom.XRTestHookRemote = class {
  ...
  waitGetAllControllerData() {
    return this.$.waitGetAllControllerData();
  }
  waitGetEventData() {
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        ...
        case 4: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.device_test.mojom.XRTestHook_WaitGetAllControllerData_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.waitGetAllControllerData');
          const result = this.impl.waitGetAllControllerData();
          const expectsResponse = header.expectsResponse || (header.flags & 1);
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              const val = (response && typeof response === 'object' && 'arg_data' in response) ? response['arg_data'] : response;
              ...
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.device_test.mojom.XRTestHook_WaitGetAllControllerData_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
            }).catch(e => console.error('[GeneratedReceiver] waitGetAllControllerData FAILED:', e));
          }
          break;
        }
        case 5: {
...
mojo.internal.Struct(
    mojo.internal.bindings.device_test.mojom.XRTestHook_WaitGetAllControllerData_ParamsSpec, 'device_test.mojom.XRTestHook_WaitGetAllControllerData_Params', [
    ],
    [[0, 8]]);

mojo.internal.Struct(
    mojo.internal.bindings.device_test.mojom.XRTestHook_WaitGetAllControllerData_ResponseParamsSpec, 'device_test.mojom.XRTestHook_WaitGetAllControllerData_ResponseParams', [
      mojo.internal.StructField('arg_data', 0, 0, mojo.internal.Array(mojo.internal.bindings.device_test.mojom.ControllerFrameDataSpec, false), null, false, 0, undefined),
    ],
    [[0, 16]]);
