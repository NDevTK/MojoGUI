    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        ...
        case 4: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              const val = (response && typeof response === 'object' && 'arg_role' in response) ? response['arg_role'] : response;
...
mojo.internal.Struct(
    mojo.internal.bindings.device_test.mojom.LayerDataSpec, 'device_test.mojom.LayerData', [
      ...
      mojo.internal.StructField('arg_face_colors', 8, 0, mojo.internal.Array(mojo.internal.bindings.device_test.mojom.ColorSpec, false), null, false, 0, undefined),
    ],
    [[0, 24]]);
