...
mojo.internal.bindings.device_test.mojom.LayerTypeSpec = mojo.internal.bindings.device_test.mojom.LayerTypeSpec || { $: mojo.internal.Enum().$ };
...
mojo.internal.bindings.device_test.mojom.LayerDataSpec = mojo.internal.bindings.device_test.mojom.LayerDataSpec || { $: {} };
if (mojo.internal.bindings.device_test.mojom.LayerDataSpec.$.structSpec && mojo.internal.bindings.device_test.mojom.LayerDataSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.device_test.mojom.LayerDataSpec.$ = {};
...
mojo.internal.bindings.device_test.mojom.XRTestFrameDataSpec = mojo.internal.bindings.device_test.mojom.XRTestFrameDataSpec || { $: {} };
if (mojo.internal.bindings.device_test.mojom.XRTestFrameDataSpec.$.structSpec && mojo.internal.bindings.device_test.mojom.XRTestFrameDataSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.device_test.mojom.XRTestFrameDataSpec.$ = {};
...
mojo.internal.bindings.device_test.mojom.XRTestHook_WaitGetFrameData_ParamsSpec = mojo.internal.bindings.device_test.mojom.XRTestHook_WaitGetFrameData_ParamsSpec || { $: {} };
if (mojo.internal.bindings.device_test.mojom.XRTestHook_WaitGetFrameData_ParamsSpec.$.structSpec && mojo.internal.bindings.device_test.mojom.XRTestHook_WaitGetFrameData_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.device_test.mojom.XRTestHook_WaitGetFrameData_ParamsSpec.$ = {};
mojo.internal.bindings.device_test.mojom.XRTestHook_WaitGetFrameData_ResponseParamsSpec = mojo.internal.bindings.device_test.mojom.XRTestHook_WaitGetFrameData_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.device_test.mojom.XRTestHook_WaitGetFrameData_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.device_test.mojom.XRTestHook_WaitGetFrameData_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.device_test.mojom.XRTestHook_WaitGetFrameData_ResponseParamsSpec.$ = {};
...
mojo.internal.bindings.device = mojo.internal.bindings.device || {};
mojo.internal.bindings.device.mojom = mojo.internal.bindings.device.mojom || {};
mojo.internal.bindings.device.mojom.OpenXrInteractionProfileTypeSpec = mojo.internal.bindings.device.mojom.OpenXrInteractionProfileTypeSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.device = mojo.internal.bindings.device || {};
mojo.internal.bindings.device.mojom = mojo.internal.bindings.device.mojom || {};
...
mojo.internal.bindings.device = mojo.internal.bindings.device || {};
mojo.internal.bindings.device.mojom = mojo.internal.bindings.device.mojom || {};
mojo.internal.bindings.device.mojom.XRVisibilityMaskSpec = mojo.internal.bindings.device.mojom.XRVisibilityMaskSpec || { $: mojo.internal.OpaqueStruct.$ };
mojo.internal.bindings.gfx = mojo.internal.bindings.gfx || {};
...
// Enum: LayerType
mojo.internal.bindings.device_test.mojom.LayerType = {
  NONE: 0,
  QUAD: 1,
  CYLINDER: 2,
  EQUIRECT: 3,
...
mojo.internal.bindings.device_test.mojom.XRTestHookRemote = class {
  ...
  onFrameSubmitted(arg_frame_data, arg_layers) {
    return this.$.onFrameSubmitted(arg_frame_data, arg_layers);
  }
  waitGetDeviceConfig() {
    return this.$.waitGetDeviceConfig();
  }
  waitGetFrameData() {
    return this.$.waitGetFrameData();
  }
  waitGetEventData() {
...
mojo.internal.bindings.device_test.mojom.XRTestHookRemoteCallHandler = class {
  ...
  waitGetFrameData() {
    return this.proxy.sendMessage(
      ...
      mojo.internal.bindings.device_test.mojom.XRTestHook_WaitGetFrameData_ParamsSpec,
      mojo.internal.bindings.device_test.mojom.XRTestHook_WaitGetFrameData_ResponseParamsSpec,
      [],
      false);
  }
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        case 0: {
          ...
          const result = this.impl.onFrameSubmitted(params.arg_frame_data, params.arg_layers);
        ...
        case 2: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.device_test.mojom.XRTestHook_WaitGetFrameData_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.waitGetFrameData');
          const result = this.impl.waitGetFrameData();
          const expectsResponse = header.expectsResponse || (header.flags & 1);
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.device_test.mojom.XRTestHook_WaitGetFrameData_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
            }).catch(e => console.error('[GeneratedReceiver] waitGetFrameData FAILED:', e));
          }
          break;
        }
        case 3: {
        ...
        case 4: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              const val = (response && typeof response === 'object' && 'arg_can_create_session' in response) ? response['arg_can_create_session'] : response;
        ...
        case 5: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              const val = (response && typeof response === 'object' && 'arg_mask' in response) ? response['arg_mask'] : response;
...
mojo.internal.Struct(
    mojo.internal.bindings.device_test.mojom.LayerDataSpec, 'device_test.mojom.LayerData', [
      mojo.internal.StructField('arg_type', 0, 0, mojo.internal.bindings.device_test.mojom.LayerTypeSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_face_colors', 8, 0, mojo.internal.Array(mojo.internal.bindings.skia.mojom.SkColorSpec, false), null, false, 0, undefined),
    ],
    [[0, 24]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.device_test.mojom.ViewDataSpec, 'device_test.mojom.ViewData', [
      mojo.internal.StructField('arg_color', 0, 0, mojo.internal.bindings.skia.mojom.SkColorSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_eye', 8, 0, mojo.internal.bindings.device.mojom.XREyeSpec, null, false, 0, undefined),
...
mojo.internal.Struct(
    mojo.internal.bindings.device_test.mojom.ControllerFrameDataSpec, 'device_test.mojom.ControllerFrameData', [
      mojo.internal.StructField('arg_handedness', 0, 0, mojo.internal.bindings.device.mojom.XRHandednessSpec, 0, false, 0, undefined),
      mojo.internal.StructField('arg_is_valid', 4, 0, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_gamepad', 8, 0, mojo.internal.bindings.device.mojom.GamepadSpec, null, true, 0, undefined),
      mojo.internal.StructField('arg_pose_data', 16, 0, mojo.internal.bindings.gfx.mojom.TransformSpec, null, true, 0, undefined),
      mojo.internal.StructField('arg_hand_data', 24, 0, mojo.internal.bindings.device.mojom.XRHandTrackingDataSpec, null, true, 0, undefined),
    ],
    [[0, 40]]);

// Struct: XRTestFrameData
mojo.internal.Struct(
    mojo.internal.bindings.device_test.mojom.XRTestFrameDataSpec, 'device_test.mojom.XRTestFrameData', [
      mojo.internal.StructField('arg_head_pose', 0, 0, mojo.internal.bindings.gfx.mojom.TransformSpec, null, true, 0, undefined),
      mojo.internal.StructField('arg_controllers', 8, 0, mojo.internal.Array(mojo.internal.bindings.device_test.mojom.ControllerFrameDataSpec, false), null, false, 0, undefined),
    ],
    [[0, 24]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.device_test.mojom.XRTestHook_OnFrameSubmitted_ParamsSpec, 'device_test.mojom.XRTestHook_OnFrameSubmitted_Params', [
      ...
      mojo.internal.StructField('arg_layers', 8, 0, mojo.internal.Array(mojo.internal.bindings.device_test.mojom.LayerDataSpec, false), null, false, 0, undefined),
    ],
    [[0, 24]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.device_test.mojom.XRTestHook_WaitGetFrameData_ParamsSpec, 'device_test.mojom.XRTestHook_WaitGetFrameData_Params', [
    ],
    [[0, 8]]);

mojo.internal.Struct(
    mojo.internal.bindings.device_test.mojom.XRTestHook_WaitGetFrameData_ResponseParamsSpec, 'device_test.mojom.XRTestHook_WaitGetFrameData_ResponseParams', [
      mojo.internal.StructField('arg_data', 0, 0, mojo.internal.bindings.device_test.mojom.XRTestFrameDataSpec, null, false, 0, undefined),
    ],
    [[0, 16]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.device_test.mojom.XRTestHook_WaitGetVisibilityMask_ResponseParamsSpec, 'device_test.mojom.XRTestHook_WaitGetVisibilityMask_ResponseParams', [
      mojo.internal.StructField('arg_mask', 0, 0, mojo.internal.bindings.device.mojom.XRVisibilityMaskSpec, null, true, 0, undefined),
    ],
    [[0, 16]]);
