...
device_test.mojom.ViewDataSpec = {
  $: {
    structSpec: {
      ...
      packedSize: 32,
      fields: [
        { name: 'color', packedOffset: 0, packedBitOffset: 0, type: device_test.mojom.ColorSpec, nullable: false },
        { name: 'eye', packedOffset: 8, packedBitOffset: 0, type: device_test.mojom.EyeSpec, nullable: false },
...
device_test.mojom.ControllerFrameDataSpec = {
  $: {
    structSpec: {
      ...
      packedSize: 80,
      fields: [
        { name: 'packet_number', packedOffset: 0, packedBitOffset: 0, type: mojo.internal.Uint32, nullable: false },
        { name: 'buttons_pressed', packedOffset: 8, packedBitOffset: 0, type: mojo.internal.Uint64, nullable: false },
        { name: 'buttons_touched', packedOffset: 16, packedBitOffset: 0, type: mojo.internal.Uint64, nullable: false },
        { name: 'supported_buttons', packedOffset: 24, packedBitOffset: 0, type: mojo.internal.Uint64, nullable: false },
        { name: 'axis_data', packedOffset: 32, packedBitOffset: 0, type: mojo.internal.Array, nullable: false },
        { name: 'pose_data', packedOffset: 40, packedBitOffset: 0, type: gfx.mojom.TransformSpec, nullable: true },
        { name: 'role', packedOffset: 48, packedBitOffset: 0, type: device_test.mojom.ControllerRoleSpec, nullable: false },
        { name: 'hand_data', packedOffset: 56, packedBitOffset: 0, type: device.mojom.XRHandTrackingDataSpec, nullable: true },
        { name: 'is_valid', packedOffset: 64, packedBitOffset: 0, type: mojo.internal.Bool, nullable: false },
      ],
      versions: [{version: 0}]
    }
  }
...
device_test.mojom.EventDataSpec = {
  $: {
    structSpec: {
      ...
      packedSize: 24,
      fields: [
        { name: 'type', packedOffset: 0, packedBitOffset: 0, type: device_test.mojom.EventTypeSpec, nullable: false },
        { name: 'interaction_profile', packedOffset: 8, packedBitOffset: 0, type: device.mojom.OpenXrInteractionProfileTypeSpec, nullable: false },
      ],
      versions: [{version: 0}]
    }
  }
...
device_test.mojom.XRTestHook_WaitGetDeviceConfig_ResponseParamsSpec = {
  $: {
    structSpec: {
      ...
      packedSize: 16,
      fields: [
        { name: 'config', packedOffset: 0, packedBitOffset: 0, type: device_test.mojom.DeviceConfigSpec, nullable: false },
      ],
      versions: [{version: 0}]
    }
  }
...
device_test.mojom.XRTestHook_WaitGetPresentingPose_ResponseParamsSpec = {
  $: {
    structSpec: {
      ...
      packedSize: 16,
      fields: [
        { name: 'data', packedOffset: 0, packedBitOffset: 0, type: gfx.mojom.TransformSpec, nullable: true },
      ],
      versions: [{version: 0}]
    }
  }
...
device_test.mojom.XRTestHook_WaitGetControllerRoleForTrackedDeviceIndex_ResponseParamsSpec = {
  $: {
    structSpec: {
      ...
      packedSize: 16,
      fields: [
        { name: 'role', packedOffset: 0, packedBitOffset: 0, type: device_test.mojom.ControllerRoleSpec, nullable: false },
      ],
      versions: [{version: 0}]
    }
  }
...
device_test.mojom.XRTestHook_WaitGetControllerData_ResponseParamsSpec = {
  $: {
    structSpec: {
      ...
      packedSize: 16,
      fields: [
        { name: 'data', packedOffset: 0, packedBitOffset: 0, type: device_test.mojom.ControllerFrameDataSpec, nullable: false },
      ],
      versions: [{version: 0}]
    }
  }
...
device_test.mojom.XRTestHook_WaitGetEventData_ResponseParamsSpec = {
  $: {
    structSpec: {
      ...
      packedSize: 16,
      fields: [
        { name: 'data', packedOffset: 0, packedBitOffset: 0, type: device_test.mojom.EventDataSpec, nullable: false },
      ],
      versions: [{version: 0}]
    }
  }
...
device_test.mojom.XRTestHook_WaitGetVisibilityMask_ResponseParamsSpec = {
  $: {
    structSpec: {
      ...
      packedSize: 16,
      fields: [
        { name: 'mask', packedOffset: 0, packedBitOffset: 0, type: device_test.mojom.XRVisibilityMaskSpec, nullable: true },
      ],
      versions: [{version: 0}]
    }
  }
