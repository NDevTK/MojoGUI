...
mojo.internal.Struct(
    mojo.internal.bindings.device_test.mojom.ViewDataSpec, 'device_test.mojom.ViewData', [
      ...
      mojo.internal.StructField('arg_viewport', 8, 0, mojo.internal.bindings.gfx.mojom.RectSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_eye', 16, 0, mojo.internal.bindings.device_test.mojom.EyeSpec, null, false, 0, undefined),
    ],
    [[0, 32]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.device_test.mojom.ControllerFrameDataSpec, 'device_test.mojom.ControllerFrameData', [
      ...
      mojo.internal.StructField('arg_axis_data', 24, 0, mojo.internal.Array(mojo.internal.bindings.device_test.mojom.ControllerAxisDataSpec, false), null, false, 0, undefined),
      mojo.internal.StructField('arg_pose_data', 32, 0, mojo.internal.bindings.gfx.mojom.TransformSpec, null, true, 0, undefined),
      mojo.internal.StructField('arg_hand_data', 40, 0, mojo.internal.bindings.device.mojom.XRHandTrackingDataSpec, null, true, 0, undefined),
      mojo.internal.StructField('arg_packet_number', 48, 0, mojo.internal.Uint32, 0, false, 0, undefined),
      mojo.internal.StructField('arg_role', 52, 0, mojo.internal.bindings.device_test.mojom.ControllerRoleSpec, 0, false, 0, undefined),
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.device_test.mojom.XRTestHook_OnFrameSubmitted_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OnFrameSubmitted failed with TypeError');
           }
        }
        // Try Method 1: WaitGetDeviceConfig
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.device_test.mojom.XRTestHook_WaitGetDeviceConfig_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for WaitGetDeviceConfig failed with TypeError');
           }
        }
        // Try Method 2: WaitGetPresentingPose
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.device_test.mojom.XRTestHook_WaitGetPresentingPose_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for WaitGetPresentingPose failed with TypeError');
           }
        }
        // Try Method 3: WaitGetMagicWindowPose
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.device_test.mojom.XRTestHook_WaitGetMagicWindowPose_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for WaitGetMagicWindowPose failed with TypeError');
           }
        }
        // Try Method 4: WaitGetControllerRoleForTrackedDeviceIndex
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.device_test.mojom.XRTestHook_WaitGetControllerRoleForTrackedDeviceIndex_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for WaitGetControllerRoleForTrackedDeviceIndex failed with TypeError');
           }
        }
        // Try Method 5: WaitGetControllerData
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.device_test.mojom.XRTestHook_WaitGetControllerData_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for WaitGetControllerData failed with TypeError');
           }
        }
        // Try Method 6: WaitGetEventData
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.device_test.mojom.XRTestHook_WaitGetEventData_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for WaitGetEventData failed with TypeError');
           }
        }
        // Try Method 7: WaitGetCanCreateSession
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.device_test.mojom.XRTestHook_WaitGetCanCreateSession_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for WaitGetCanCreateSession failed with TypeError');
           }
        }
        // Try Method 8: WaitGetVisibilityMask
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.device_test.mojom.XRTestHook_WaitGetVisibilityMask_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for WaitGetVisibilityMask failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.device_test.mojom.XRServiceTestHook_SetTestHook_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for SetTestHook failed with TypeError');
           }
        }
        // Try Method 1: TerminateDeviceServiceProcessForTesting
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.device_test.mojom.XRServiceTestHook_TerminateDeviceServiceProcessForTesting_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for TerminateDeviceServiceProcessForTesting failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
             console.warn('[GeneratedReceiver] Failed to discover ordinal ' + header.ordinal);
