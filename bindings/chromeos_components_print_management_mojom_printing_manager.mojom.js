...
mojo.internal.bindings.chromeos.printing.printing_manager.mojom.PrintJobCompletionStatusSpec = mojo.internal.bindings.chromeos.printing.printing_manager.mojom.PrintJobCompletionStatusSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.chromeos.printing.printing_manager.mojom.PrinterErrorCodeSpec = mojo.internal.bindings.chromeos.printing.printing_manager.mojom.PrinterErrorCodeSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.chromeos.printing.printing_manager.mojom.ActivePrintJobStateSpec = mojo.internal.bindings.chromeos.printing.printing_manager.mojom.ActivePrintJobStateSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.chromeos.printing.printing_manager.mojom.LaunchSourceSpec = mojo.internal.bindings.chromeos.printing.printing_manager.mojom.LaunchSourceSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.chromeos.printing.printing_manager.mojom.CompletedPrintJobInfoSpec = mojo.internal.bindings.chromeos.printing.printing_manager.mojom.CompletedPrintJobInfoSpec || { $: {} };
if (mojo.internal.bindings.chromeos.printing.printing_manager.mojom.CompletedPrintJobInfoSpec.$.structSpec && mojo.internal.bindings.chromeos.printing.printing_manager.mojom.CompletedPrintJobInfoSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.chromeos.printing.printing_manager.mojom.CompletedPrintJobInfoSpec.$ = {};
mojo.internal.bindings.chromeos.printing.printing_manager.mojom.ActivePrintJobInfoSpec = mojo.internal.bindings.chromeos.printing.printing_manager.mojom.ActivePrintJobInfoSpec || { $: {} };
if (mojo.internal.bindings.chromeos.printing.printing_manager.mojom.ActivePrintJobInfoSpec.$.structSpec && mojo.internal.bindings.chromeos.printing.printing_manager.mojom.ActivePrintJobInfoSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.chromeos.printing.printing_manager.mojom.ActivePrintJobInfoSpec.$ = {};
mojo.internal.bindings.chromeos.printing.printing_manager.mojom.PrintJobInfoSpec = mojo.internal.bindings.chromeos.printing.printing_manager.mojom.PrintJobInfoSpec || { $: {} };
if (mojo.internal.bindings.chromeos.printing.printing_manager.mojom.PrintJobInfoSpec.$.structSpec && mojo.internal.bindings.chromeos.printing.printing_manager.mojom.PrintJobInfoSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.chromeos.printing.printing_manager.mojom.PrintJobInfoSpec.$ = {};
mojo.internal.bindings.chromeos.printing.printing_manager.mojom.PrintJobsObserver = mojo.internal.bindings.chromeos.printing.printing_manager.mojom.PrintJobsObserver || {};
mojo.internal.bindings.chromeos.printing.printing_manager.mojom.PrintJobsObserverSpec = mojo.internal.bindings.chromeos.printing.printing_manager.mojom.PrintJobsObserverSpec || { $ : {} };
if (mojo.internal.bindings.chromeos.printing.printing_manager.mojom.PrintJobsObserverSpec.$.structSpec && mojo.internal.bindings.chromeos.printing.printing_manager.mojom.PrintJobsObserverSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.chromeos.printing.printing_manager.mojom.PrintJobsObserverSpec.$ = {};
...
mojo.internal.bindings.chromeos.printing.printing_manager.mojom.PrintJobsObserver_OnAllPrintJobsDeleted_ParamsSpec = mojo.internal.bindings.chromeos.printing.printing_manager.mojom.PrintJobsObserver_OnAllPrintJobsDeleted_ParamsSpec || { $: {} };
if (mojo.internal.bindings.chromeos.printing.printing_manager.mojom.PrintJobsObserver_OnAllPrintJobsDeleted_ParamsSpec.$.structSpec && mojo.internal.bindings.chromeos.printing.printing_manager.mojom.PrintJobsObserver_OnAllPrintJobsDeleted_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.chromeos.printing.printing_manager.mojom.PrintJobsObserver_OnAllPrintJobsDeleted_ParamsSpec.$ = {};
mojo.internal.bindings.chromeos.printing.printing_manager.mojom.PrintJobsObserver_OnPrintJobUpdate_ParamsSpec = mojo.internal.bindings.chromeos.printing.printing_manager.mojom.PrintJobsObserver_OnPrintJobUpdate_ParamsSpec || { $: {} };
if (mojo.internal.bindings.chromeos.printing.printing_manager.mojom.PrintJobsObserver_OnPrintJobUpdate_ParamsSpec.$.structSpec && mojo.internal.bindings.chromeos.printing.printing_manager.mojom.PrintJobsObserver_OnPrintJobUpdate_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.chromeos.printing.printing_manager.mojom.PrintJobsObserver_OnPrintJobUpdate_ParamsSpec.$ = {};
mojo.internal.bindings.chromeos.printing.printing_manager.mojom.PrintingMetadataProvider = mojo.internal.bindings.chromeos.printing.printing_manager.mojom.PrintingMetadataProvider || {};
mojo.internal.bindings.chromeos.printing.printing_manager.mojom.PrintingMetadataProviderSpec = mojo.internal.bindings.chromeos.printing.printing_manager.mojom.PrintingMetadataProviderSpec || { $ : {} };
if (mojo.internal.bindings.chromeos.printing.printing_manager.mojom.PrintingMetadataProviderSpec.$.structSpec && mojo.internal.bindings.chromeos.printing.printing_manager.mojom.PrintingMetadataProviderSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.chromeos.printing.printing_manager.mojom.PrintingMetadataProviderSpec.$ = {};
...
mojo.internal.bindings.chromeos.printing.printing_manager.mojom.PrintingMetadataProvider_ObservePrintJobs_ParamsSpec = mojo.internal.bindings.chromeos.printing.printing_manager.mojom.PrintingMetadataProvider_ObservePrintJobs_ParamsSpec || { $: {} };
if (mojo.internal.bindings.chromeos.printing.printing_manager.mojom.PrintingMetadataProvider_ObservePrintJobs_ParamsSpec.$.structSpec && mojo.internal.bindings.chromeos.printing.printing_manager.mojom.PrintingMetadataProvider_ObservePrintJobs_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.chromeos.printing.printing_manager.mojom.PrintingMetadataProvider_ObservePrintJobs_ParamsSpec.$ = {};
mojo.internal.bindings.chromeos.printing.printing_manager.mojom.PrintingMetadataProvider_ObservePrintJobs_ResponseParamsSpec = mojo.internal.bindings.chromeos.printing.printing_manager.mojom.PrintingMetadataProvider_ObservePrintJobs_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.chromeos.printing.printing_manager.mojom.PrintingMetadataProvider_ObservePrintJobs_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.chromeos.printing.printing_manager.mojom.PrintingMetadataProvider_ObservePrintJobs_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.chromeos.printing.printing_manager.mojom.PrintingMetadataProvider_ObservePrintJobs_ResponseParamsSpec.$ = {};
mojo.internal.bindings.chromeos.printing.printing_manager.mojom.PrintingMetadataProvider_GetPrintJobs_ParamsSpec = mojo.internal.bindings.chromeos.printing.printing_manager.mojom.PrintingMetadataProvider_GetPrintJobs_ParamsSpec || { $: {} };
if (mojo.internal.bindings.chromeos.printing.printing_manager.mojom.PrintingMetadataProvider_GetPrintJobs_ParamsSpec.$.structSpec && mojo.internal.bindings.chromeos.printing.printing_manager.mojom.PrintingMetadataProvider_GetPrintJobs_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.chromeos.printing.printing_manager.mojom.PrintingMetadataProvider_GetPrintJobs_ParamsSpec.$ = {};
mojo.internal.bindings.chromeos.printing.printing_manager.mojom.PrintingMetadataProvider_GetPrintJobs_ResponseParamsSpec = mojo.internal.bindings.chromeos.printing.printing_manager.mojom.PrintingMetadataProvider_GetPrintJobs_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.chromeos.printing.printing_manager.mojom.PrintingMetadataProvider_GetPrintJobs_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.chromeos.printing.printing_manager.mojom.PrintingMetadataProvider_GetPrintJobs_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.chromeos.printing.printing_manager.mojom.PrintingMetadataProvider_GetPrintJobs_ResponseParamsSpec.$ = {};
mojo.internal.bindings.chromeos.printing.printing_manager.mojom.PrintingMetadataProvider_DeleteAllPrintJobs_ParamsSpec = mojo.internal.bindings.chromeos.printing.printing_manager.mojom.PrintingMetadataProvider_DeleteAllPrintJobs_ParamsSpec || { $: {} };
if (mojo.internal.bindings.chromeos.printing.printing_manager.mojom.PrintingMetadataProvider_DeleteAllPrintJobs_ParamsSpec.$.structSpec && mojo.internal.bindings.chromeos.printing.printing_manager.mojom.PrintingMetadataProvider_DeleteAllPrintJobs_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.chromeos.printing.printing_manager.mojom.PrintingMetadataProvider_DeleteAllPrintJobs_ParamsSpec.$ = {};
mojo.internal.bindings.chromeos.printing.printing_manager.mojom.PrintingMetadataProvider_DeleteAllPrintJobs_ResponseParamsSpec = mojo.internal.bindings.chromeos.printing.printing_manager.mojom.PrintingMetadataProvider_DeleteAllPrintJobs_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.chromeos.printing.printing_manager.mojom.PrintingMetadataProvider_DeleteAllPrintJobs_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.chromeos.printing.printing_manager.mojom.PrintingMetadataProvider_DeleteAllPrintJobs_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.chromeos.printing.printing_manager.mojom.PrintingMetadataProvider_DeleteAllPrintJobs_ResponseParamsSpec.$ = {};
mojo.internal.bindings.chromeos.printing.printing_manager.mojom.PrintingMetadataProvider_CancelPrintJob_ParamsSpec = mojo.internal.bindings.chromeos.printing.printing_manager.mojom.PrintingMetadataProvider_CancelPrintJob_ParamsSpec || { $: {} };
if (mojo.internal.bindings.chromeos.printing.printing_manager.mojom.PrintingMetadataProvider_CancelPrintJob_ParamsSpec.$.structSpec && mojo.internal.bindings.chromeos.printing.printing_manager.mojom.PrintingMetadataProvider_CancelPrintJob_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.chromeos.printing.printing_manager.mojom.PrintingMetadataProvider_CancelPrintJob_ParamsSpec.$ = {};
mojo.internal.bindings.chromeos.printing.printing_manager.mojom.PrintingMetadataProvider_CancelPrintJob_ResponseParamsSpec = mojo.internal.bindings.chromeos.printing.printing_manager.mojom.PrintingMetadataProvider_CancelPrintJob_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.chromeos.printing.printing_manager.mojom.PrintingMetadataProvider_CancelPrintJob_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.chromeos.printing.printing_manager.mojom.PrintingMetadataProvider_CancelPrintJob_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.chromeos.printing.printing_manager.mojom.PrintingMetadataProvider_CancelPrintJob_ResponseParamsSpec.$ = {};
mojo.internal.bindings.chromeos.printing.printing_manager.mojom.PrintingMetadataProvider_GetDeletePrintJobHistoryAllowedByPolicy_ParamsSpec = mojo.internal.bindings.chromeos.printing.printing_manager.mojom.PrintingMetadataProvider_GetDeletePrintJobHistoryAllowedByPolicy_ParamsSpec || { $: {} };
if (mojo.internal.bindings.chromeos.printing.printing_manager.mojom.PrintingMetadataProvider_GetDeletePrintJobHistoryAllowedByPolicy_ParamsSpec.$.structSpec && mojo.internal.bindings.chromeos.printing.printing_manager.mojom.PrintingMetadataProvider_GetDeletePrintJobHistoryAllowedByPolicy_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.chromeos.printing.printing_manager.mojom.PrintingMetadataProvider_GetDeletePrintJobHistoryAllowedByPolicy_ParamsSpec.$ = {};
mojo.internal.bindings.chromeos.printing.printing_manager.mojom.PrintingMetadataProvider_GetDeletePrintJobHistoryAllowedByPolicy_ResponseParamsSpec = mojo.internal.bindings.chromeos.printing.printing_manager.mojom.PrintingMetadataProvider_GetDeletePrintJobHistoryAllowedByPolicy_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.chromeos.printing.printing_manager.mojom.PrintingMetadataProvider_GetDeletePrintJobHistoryAllowedByPolicy_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.chromeos.printing.printing_manager.mojom.PrintingMetadataProvider_GetDeletePrintJobHistoryAllowedByPolicy_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.chromeos.printing.printing_manager.mojom.PrintingMetadataProvider_GetDeletePrintJobHistoryAllowedByPolicy_ResponseParamsSpec.$ = {};
mojo.internal.bindings.chromeos.printing.printing_manager.mojom.PrintingMetadataProvider_GetPrintJobHistoryExpirationPeriod_ParamsSpec = mojo.internal.bindings.chromeos.printing.printing_manager.mojom.PrintingMetadataProvider_GetPrintJobHistoryExpirationPeriod_ParamsSpec || { $: {} };
if (mojo.internal.bindings.chromeos.printing.printing_manager.mojom.PrintingMetadataProvider_GetPrintJobHistoryExpirationPeriod_ParamsSpec.$.structSpec && mojo.internal.bindings.chromeos.printing.printing_manager.mojom.PrintingMetadataProvider_GetPrintJobHistoryExpirationPeriod_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.chromeos.printing.printing_manager.mojom.PrintingMetadataProvider_GetPrintJobHistoryExpirationPeriod_ParamsSpec.$ = {};
mojo.internal.bindings.chromeos.printing.printing_manager.mojom.PrintingMetadataProvider_GetPrintJobHistoryExpirationPeriod_ResponseParamsSpec = mojo.internal.bindings.chromeos.printing.printing_manager.mojom.PrintingMetadataProvider_GetPrintJobHistoryExpirationPeriod_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.chromeos.printing.printing_manager.mojom.PrintingMetadataProvider_GetPrintJobHistoryExpirationPeriod_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.chromeos.printing.printing_manager.mojom.PrintingMetadataProvider_GetPrintJobHistoryExpirationPeriod_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.chromeos.printing.printing_manager.mojom.PrintingMetadataProvider_GetPrintJobHistoryExpirationPeriod_ResponseParamsSpec.$ = {};
mojo.internal.bindings.chromeos.printing.printing_manager.mojom.PrintManagementHandler = mojo.internal.bindings.chromeos.printing.printing_manager.mojom.PrintManagementHandler || {};
mojo.internal.bindings.chromeos.printing.printing_manager.mojom.PrintManagementHandlerSpec = mojo.internal.bindings.chromeos.printing.printing_manager.mojom.PrintManagementHandlerSpec || { $ : {} };
if (mojo.internal.bindings.chromeos.printing.printing_manager.mojom.PrintManagementHandlerSpec.$.structSpec && mojo.internal.bindings.chromeos.printing.printing_manager.mojom.PrintManagementHandlerSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.chromeos.printing.printing_manager.mojom.PrintManagementHandlerSpec.$ = {};
...
mojo.internal.bindings.chromeos.printing.printing_manager.mojom.PrintManagementHandler_LaunchPrinterSettings_ParamsSpec = mojo.internal.bindings.chromeos.printing.printing_manager.mojom.PrintManagementHandler_LaunchPrinterSettings_ParamsSpec || { $: {} };
if (mojo.internal.bindings.chromeos.printing.printing_manager.mojom.PrintManagementHandler_LaunchPrinterSettings_ParamsSpec.$.structSpec && mojo.internal.bindings.chromeos.printing.printing_manager.mojom.PrintManagementHandler_LaunchPrinterSettings_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.chromeos.printing.printing_manager.mojom.PrintManagementHandler_LaunchPrinterSettings_ParamsSpec.$ = {};
mojo.internal.bindings.chromeos.printing.printing_manager.mojom.PrintManagementHandler_RecordGetPrintJobsRequestDuration_ParamsSpec = mojo.internal.bindings.chromeos.printing.printing_manager.mojom.PrintManagementHandler_RecordGetPrintJobsRequestDuration_ParamsSpec || { $: {} };
if (mojo.internal.bindings.chromeos.printing.printing_manager.mojom.PrintManagementHandler_RecordGetPrintJobsRequestDuration_ParamsSpec.$.structSpec && mojo.internal.bindings.chromeos.printing.printing_manager.mojom.PrintManagementHandler_RecordGetPrintJobsRequestDuration_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.chromeos.printing.printing_manager.mojom.PrintManagementHandler_RecordGetPrintJobsRequestDuration_ParamsSpec.$ = {};
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const message = new mojo.internal.Message(
                ...
                header.ordinal, header.requestId, mojo.internal.bindings.chromeos.printing.printing_manager.mojom.PrintingMetadataProvider_ObservePrintJobs_ResponseParamsSpec.$.structSpec, resp_obj);
        ...
        case 1: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const resp_obj = { 'arg_print_jobs': val };
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.chromeos.printing.printing_manager.mojom.PrintingMetadataProvider_GetPrintJobs_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
        ...
        case 2: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.chromeos.printing.printing_manager.mojom.PrintingMetadataProvider_DeleteAllPrintJobs_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
        ...
        case 3: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const resp_obj = { 'arg_attempted_cancel': val };
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.chromeos.printing.printing_manager.mojom.PrintingMetadataProvider_CancelPrintJob_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
        ...
        case 4: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const resp_obj = { 'arg_is_allowed_by_policy': val };
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.chromeos.printing.printing_manager.mojom.PrintingMetadataProvider_GetDeletePrintJobHistoryAllowedByPolicy_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
        ...
        case 5: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.chromeos.printing.printing_manager.mojom.PrintingMetadataProvider_GetPrintJobHistoryExpirationPeriod_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
...
mojo.internal.Struct(
    mojo.internal.bindings.chromeos.printing.printing_manager.mojom.PrintJobInfoSpec, 'chromeos.printing.printing_manager.mojom.PrintJobInfo', [
      ...
      mojo.internal.StructField('arg_number_of_pages', 24, 0, mojo.internal.Uint32, 0, false, 0, undefined),
      mojo.internal.StructField('arg_printer_error_code', 28, 0, mojo.internal.bindings.chromeos.printing.printing_manager.mojom.PrinterErrorCodeSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_printer_id', 32, 0, mojo.internal.String, null, false, 0, undefined),
      mojo.internal.StructField('arg_printer_name', 40, 0, mojo.internal.bindings.mojo_base.mojom.String16Spec, null, false, 0, undefined),
      mojo.internal.StructField('arg_printer_uri', 48, 0, mojo.internal.bindings.url.mojom.UrlSpec, null, false, 0, undefined),
