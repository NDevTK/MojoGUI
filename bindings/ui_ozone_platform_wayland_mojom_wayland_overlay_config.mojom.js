  ...
  $: {
    structSpec: {
      ...
      fields: [
        ...
        { name: 'access_fence_handle', packedOffset: 48, packedBitOffset: 0, type: gfx.mojom.GpuFenceHandleSpec, nullable: true },
        { name: 'priority_hint', packedOffset: 56, packedBitOffset: 0, type: gfx.mojom.OverlayPriorityHintSpec, nullable: false },
