...
mojo.internal.Struct(
    mojo.internal.bindings.prefs.mojom.TrackedPreferenceValidationDelegate_OnAtomicPreferenceValidation_ParamsSpec, 'prefs.mojom.TrackedPreferenceValidationDelegate_OnAtomicPreferenceValidation_Params', [
      ...
      mojo.internal.StructField('arg_value_state', 16, 0, mojo.internal.bindings.prefs.mojom.ValueStateSpec.$, null, false, 0, undefined),
      mojo.internal.StructField('arg_external_validation_value_state', 24, 0, mojo.internal.bindings.prefs.mojom.ValueStateSpec.$, null, false, 0, undefined),
...
mojo.internal.Struct(
    mojo.internal.bindings.prefs.mojom.TrackedPreferenceValidationDelegate_OnSplitPreferenceValidation_ParamsSpec, 'prefs.mojom.TrackedPreferenceValidationDelegate_OnSplitPreferenceValidation_Params', [
      ...
      mojo.internal.StructField('arg_external_validation_value_state', 32, 0, mojo.internal.bindings.prefs.mojom.ValueStateSpec.$, null, false, 0, undefined),
...
mojo.internal.bindings.prefs.mojom.TrackedPreferenceValidationDelegateRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('prefs.mojom.TrackedPreferenceValidationDelegate', [
      { explicit: null },
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.prefs.mojom.TrackedPreferenceValidationDelegateReceiver = class {
  constructor(impl) {
    ...
    const ordinals = window.mojoScrambler.getOrdinals('prefs.mojom.TrackedPreferenceValidationDelegate', [
      { explicit: null },
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.prefs.mojom.TrackedPreferenceValidationDelegate_OnAtomicPreferenceValidation_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OnAtomicPreferenceValidation failed with TypeError');
           }
        }
        // Try Method 1: OnSplitPreferenceValidation
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.prefs.mojom.TrackedPreferenceValidationDelegate_OnSplitPreferenceValidation_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OnSplitPreferenceValidation failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
