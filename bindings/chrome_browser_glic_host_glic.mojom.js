...
mojo.internal.bindings.glic.mojom.ActuationEligibilitySpec = { $: mojo.internal.Enum().$ };
...
mojo.internal.bindings.glic.mojom.AdditionalContextSourceSpec = { $: mojo.internal.Enum().$ };
