...
mojo.internal.bindings.glic.mojom.PageHandlerRemote = class {
  ...
  setGuestUrlPresets(arg_autopush, arg_preprod, arg_prod) {
    return this.$.setGuestUrlPresets(arg_autopush, arg_preprod, arg_prod);
  }
};
...
mojo.internal.bindings.glic.mojom.PageHandlerRemoteCallHandler = class {
  ...
  setGuestUrlPresets(arg_autopush, arg_preprod, arg_prod) {
    return this.proxy.sendMessage(
      ...
      null,
      [arg_autopush, arg_preprod, arg_prod],
      false);
  }
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        ...
        case 11: {
          ...
          const result = this.impl.setGuestUrlPresets(params.arg_autopush, params.arg_preprod, params.arg_prod);
          break;
        }
      }
      } catch (err) {
...
mojo.internal.Struct(
    mojo.internal.bindings.glic.mojom.ProfileEnablementSpec, 'glic.mojom.ProfileEnablement', [
      ...
      mojo.internal.StructField('arg_live_disallowed', 1, 1, mojo.internal.Bool, false, false, 0, undefined),
...
mojo.internal.Struct(
    mojo.internal.bindings.glic.mojom.PageHandler_SetGuestUrlPresets_ParamsSpec, 'glic.mojom.PageHandler_SetGuestUrlPresets_Params', [
      ...
      mojo.internal.StructField('arg_preprod', 8, 0, mojo.internal.bindings.url.mojom.UrlSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_prod', 16, 0, mojo.internal.bindings.url.mojom.UrlSpec, null, false, 0, undefined),
    ],
    [[0, 32]]);
