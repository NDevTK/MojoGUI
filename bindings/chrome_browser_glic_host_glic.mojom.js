...
mojo.internal.bindings.glic.mojom.WebClient_NotifyIsInvoking_ParamsSpec = mojo.internal.bindings.glic.mojom.WebClient_NotifyIsInvoking_ParamsSpec || { $: {} };
if (mojo.internal.bindings.glic.mojom.WebClient_NotifyIsInvoking_ParamsSpec.$.structSpec && mojo.internal.bindings.glic.mojom.WebClient_NotifyIsInvoking_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.glic.mojom.WebClient_NotifyIsInvoking_ParamsSpec.$ = {};
...
mojo.internal.bindings.glic.mojom.WebClientRemote = class {
  ...
  notifyIsInvoking(arg_is_invoking) {
    return this.$.notifyIsInvoking(arg_is_invoking);
  }
...
mojo.internal.bindings.glic.mojom.WebClientRemoteCallHandler = class {
  ...
  notifyIsInvoking(arg_is_invoking) {
    return this.proxy.sendMessage(
      this.ordinals[4],  // ordinal
      mojo.internal.bindings.glic.mojom.WebClient_NotifyIsInvoking_ParamsSpec,
      null,
      [arg_is_invoking],
      false);
  }
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        ...
        case 4: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.glic.mojom.WebClient_NotifyIsInvoking_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.notifyIsInvoking');
          const result = this.impl.notifyIsInvoking(params.arg_is_invoking);
          break;
        }
        case 5: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
...
mojo.internal.Struct(
    mojo.internal.bindings.glic.mojom.WebClient_NotifyIsInvoking_ParamsSpec, 'glic.mojom.WebClient_NotifyIsInvoking_Params', [
      mojo.internal.StructField('arg_is_invoking', 0, 0, mojo.internal.Bool, false, false, 0, undefined),
    ],
    [[0, 16]]);
