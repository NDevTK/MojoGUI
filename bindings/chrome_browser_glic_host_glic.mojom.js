...
mojo.internal.bindings.glic.mojom.WebClientStateSpec = mojo.internal.bindings.glic.mojom.WebClientStateSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.glic.mojom.GuestPageTypeSpec = mojo.internal.bindings.glic.mojom.GuestPageTypeSpec || { $: mojo.internal.Enum().$ };
...
mojo.internal.bindings.glic.mojom.Page_WebClientStateChanged_ParamsSpec = mojo.internal.bindings.glic.mojom.Page_WebClientStateChanged_ParamsSpec || { $: {} };
if (mojo.internal.bindings.glic.mojom.Page_WebClientStateChanged_ParamsSpec.$.structSpec && mojo.internal.bindings.glic.mojom.Page_WebClientStateChanged_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.glic.mojom.Page_WebClientStateChanged_ParamsSpec.$ = {};
...
mojo.internal.bindings.glic.mojom.PageHandler_OnWebUiStateChanged_ParamsSpec = mojo.internal.bindings.glic.mojom.PageHandler_OnWebUiStateChanged_ParamsSpec || { $: {} };
if (mojo.internal.bindings.glic.mojom.PageHandler_OnWebUiStateChanged_ParamsSpec.$.structSpec && mojo.internal.bindings.glic.mojom.PageHandler_OnWebUiStateChanged_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.glic.mojom.PageHandler_OnWebUiStateChanged_ParamsSpec.$ = {};
...
// Enum: WebClientState
mojo.internal.bindings.glic.mojom.WebClientState = {
  kUninitialized: 0,
  kResponsive: 1,
  kUnresponsive: 2,
  kError: 3,
...
// Enum: GuestPageType
mojo.internal.bindings.glic.mojom.GuestPageType = {
  kRegular: 0,
  kLogin: 1,
  kGuestError: 2,
  kLoadError: 3,
...
mojo.internal.bindings.glic.mojom.PageRemote = class {
  ...
  webClientStateChanged(arg_state) {
    return this.$.webClientStateChanged(arg_state);
  }
};
...
mojo.internal.bindings.glic.mojom.PageRemoteCallHandler = class {
  ...
  webClientStateChanged(arg_state) {
    return this.proxy.sendMessage(
      ...
      mojo.internal.bindings.glic.mojom.Page_WebClientStateChanged_ParamsSpec,
      null,
      [arg_state],
      false);
  }
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        ...
        case 4: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.glic.mojom.Page_WebClientStateChanged_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.webClientStateChanged');
          const result = this.impl.webClientStateChanged(params.arg_state);
          break;
        }
      }
      } catch (err) {
...
mojo.internal.bindings.glic.mojom.PageHandlerRemote = class {
  ...
  onWebUiStateChanged(arg_new_state) {
    return this.$.onWebUiStateChanged(arg_new_state);
  }
};
...
mojo.internal.bindings.glic.mojom.PageHandlerRemoteCallHandler = class {
  ...
  onWebUiStateChanged(arg_new_state) {
    return this.proxy.sendMessage(
      ...
      mojo.internal.bindings.glic.mojom.PageHandler_OnWebUiStateChanged_ParamsSpec,
      null,
      [arg_new_state],
      false);
  }
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        ...
        case 11: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.glic.mojom.PageHandler_OnWebUiStateChanged_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.onWebUiStateChanged');
          const result = this.impl.onWebUiStateChanged(params.arg_new_state);
          break;
        }
      }
      } catch (err) {
...
mojo.internal.Struct(
    mojo.internal.bindings.glic.mojom.Page_WebClientStateChanged_ParamsSpec, 'glic.mojom.Page_WebClientStateChanged_Params', [
      mojo.internal.StructField('arg_state', 0, 0, mojo.internal.bindings.glic.mojom.WebClientStateSpec, null, false, 0, undefined),
    ],
    [[0, 16]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.glic.mojom.PageHandler_OnWebUiStateChanged_ParamsSpec, 'glic.mojom.PageHandler_OnWebUiStateChanged_Params', [
