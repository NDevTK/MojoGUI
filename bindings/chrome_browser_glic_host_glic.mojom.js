...
mojo.internal.bindings.ai_overlay_dialog = mojo.internal.bindings.ai_overlay_dialog || {};
...
mojo.internal.bindings.glic.mojom.FileUploadPolicyStateSpec = mojo.internal.bindings.glic.mojom.FileUploadPolicyStateSpec || { $: mojo.internal.Enum().$ };
...
mojo.internal.bindings.glic.mojom.GlicRequestEventSpec = mojo.internal.bindings.glic.mojom.GlicRequestEventSpec || { $: mojo.internal.Enum().$ };
...
mojo.internal.bindings.glic.mojom.PromptTypeSpec = mojo.internal.bindings.glic.mojom.PromptTypeSpec || { $: mojo.internal.Enum().$ };
...
mojo.internal.bindings.glic.mojom.ScreenshotEncryptionSchemeSpec = mojo.internal.bindings.glic.mojom.ScreenshotEncryptionSchemeSpec || { $: mojo.internal.Enum().$ };
...
mojo.internal.bindings.glic.mojom.SafeBrowsingVerdictSpec = mojo.internal.bindings.glic.mojom.SafeBrowsingVerdictSpec || { $: {} };
if (mojo.internal.bindings.glic.mojom.SafeBrowsingVerdictSpec.$.structSpec && mojo.internal.bindings.glic.mojom.SafeBrowsingVerdictSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.glic.mojom.SafeBrowsingVerdictSpec.$ = {};
...
mojo.internal.bindings.glic.mojom.TabContextOptionsSpec = mojo.internal.bindings.glic.mojom.TabContextOptionsSpec || { $: {} };
if (mojo.internal.bindings.glic.mojom.TabContextOptionsSpec.$.structSpec && mojo.internal.bindings.glic.mojom.TabContextOptionsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.glic.mojom.TabContextOptionsSpec.$ = {};
...
mojo.internal.bindings.glic.mojom.OpenPinnedTabPickerOptionsSpec = mojo.internal.bindings.glic.mojom.OpenPinnedTabPickerOptionsSpec || { $: {} };
if (mojo.internal.bindings.glic.mojom.OpenPinnedTabPickerOptionsSpec.$.structSpec && mojo.internal.bindings.glic.mojom.OpenPinnedTabPickerOptionsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.glic.mojom.OpenPinnedTabPickerOptionsSpec.$ = {};
mojo.internal.bindings.glic.mojom.CreateActorTabOptionsSpec = mojo.internal.bindings.glic.mojom.CreateActorTabOptionsSpec || { $: {} };
if (mojo.internal.bindings.glic.mojom.CreateActorTabOptionsSpec.$.structSpec && mojo.internal.bindings.glic.mojom.CreateActorTabOptionsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.glic.mojom.CreateActorTabOptionsSpec.$ = {};
...
mojo.internal.bindings.glic.mojom.CreateTabOptionsSpec = mojo.internal.bindings.glic.mojom.CreateTabOptionsSpec || { $: {} };
if (mojo.internal.bindings.glic.mojom.CreateTabOptionsSpec.$.structSpec && mojo.internal.bindings.glic.mojom.CreateTabOptionsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.glic.mojom.CreateTabOptionsSpec.$ = {};
...
mojo.internal.bindings.glic.mojom.SkillsPayloadSpec = mojo.internal.bindings.glic.mojom.SkillsPayloadSpec || { $: {} };
if (mojo.internal.bindings.glic.mojom.SkillsPayloadSpec.$.structSpec && mojo.internal.bindings.glic.mojom.SkillsPayloadSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.glic.mojom.SkillsPayloadSpec.$ = {};
...
mojo.internal.bindings.glic.mojom.TabContextResultSpec = mojo.internal.bindings.glic.mojom.TabContextResultSpec || { $: {} };
if (mojo.internal.bindings.glic.mojom.TabContextResultSpec.$.structSpec && mojo.internal.bindings.glic.mojom.TabContextResultSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.glic.mojom.TabContextResultSpec.$ = {};
...
mojo.internal.bindings.glic.mojom.ActorClient_RequestToShowGmailOtpConfirmationDialog_ParamsSpec = mojo.internal.bindings.glic.mojom.ActorClient_RequestToShowGmailOtpConfirmationDialog_ParamsSpec || { $: {} };
if (mojo.internal.bindings.glic.mojom.ActorClient_RequestToShowGmailOtpConfirmationDialog_ParamsSpec.$.structSpec && mojo.internal.bindings.glic.mojom.ActorClient_RequestToShowGmailOtpConfirmationDialog_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.glic.mojom.ActorClient_RequestToShowGmailOtpConfirmationDialog_ParamsSpec.$ = {};
mojo.internal.bindings.glic.mojom.ActorClient_RequestToShowGmailOtpConfirmationDialog_ResponseParamsSpec = mojo.internal.bindings.glic.mojom.ActorClient_RequestToShowGmailOtpConfirmationDialog_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.glic.mojom.ActorClient_RequestToShowGmailOtpConfirmationDialog_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.glic.mojom.ActorClient_RequestToShowGmailOtpConfirmationDialog_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.glic.mojom.ActorClient_RequestToShowGmailOtpConfirmationDialog_ResponseParamsSpec.$ = {};
...
mojo.internal.bindings.glic.mojom.ActorHandler_UpdateActorTaskStepProgress_ParamsSpec = mojo.internal.bindings.glic.mojom.ActorHandler_UpdateActorTaskStepProgress_ParamsSpec || { $: {} };
if (mojo.internal.bindings.glic.mojom.ActorHandler_UpdateActorTaskStepProgress_ParamsSpec.$.structSpec && mojo.internal.bindings.glic.mojom.ActorHandler_UpdateActorTaskStepProgress_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.glic.mojom.ActorHandler_UpdateActorTaskStepProgress_ParamsSpec.$ = {};
...
mojo.internal.bindings.glic.mojom.SkillsClient_NotifySkillsEnabledChanged_ParamsSpec = mojo.internal.bindings.glic.mojom.SkillsClient_NotifySkillsEnabledChanged_ParamsSpec || { $: {} };
if (mojo.internal.bindings.glic.mojom.SkillsClient_NotifySkillsEnabledChanged_ParamsSpec.$.structSpec && mojo.internal.bindings.glic.mojom.SkillsClient_NotifySkillsEnabledChanged_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.glic.mojom.SkillsClient_NotifySkillsEnabledChanged_ParamsSpec.$ = {};
...
mojo.internal.bindings.glic.mojom.WebClientHandler_ReportApiRequestCount_ParamsSpec = mojo.internal.bindings.glic.mojom.WebClientHandler_ReportApiRequestCount_ParamsSpec || { $: {} };
if (mojo.internal.bindings.glic.mojom.WebClientHandler_ReportApiRequestCount_ParamsSpec.$.structSpec && mojo.internal.bindings.glic.mojom.WebClientHandler_ReportApiRequestCount_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.glic.mojom.WebClientHandler_ReportApiRequestCount_ParamsSpec.$ = {};
mojo.internal.bindings.glic.mojom.WebClientHandler_ReportApiRequestLatency_ParamsSpec = mojo.internal.bindings.glic.mojom.WebClientHandler_ReportApiRequestLatency_ParamsSpec || { $: {} };
if (mojo.internal.bindings.glic.mojom.WebClientHandler_ReportApiRequestLatency_ParamsSpec.$.structSpec && mojo.internal.bindings.glic.mojom.WebClientHandler_ReportApiRequestLatency_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.glic.mojom.WebClientHandler_ReportApiRequestLatency_ParamsSpec.$ = {};
mojo.internal.bindings.glic.mojom.WebClientHandler_RecordSparseValue_ParamsSpec = mojo.internal.bindings.glic.mojom.WebClientHandler_RecordSparseValue_ParamsSpec || { $: {} };
if (mojo.internal.bindings.glic.mojom.WebClientHandler_RecordSparseValue_ParamsSpec.$.structSpec && mojo.internal.bindings.glic.mojom.WebClientHandler_RecordSparseValue_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.glic.mojom.WebClientHandler_RecordSparseValue_ParamsSpec.$ = {};
...
mojo.internal.bindings.glic.mojom.WebClientHandler_CreateExperimentalTriggeringClient_ParamsSpec = mojo.internal.bindings.glic.mojom.WebClientHandler_CreateExperimentalTriggeringClient_ParamsSpec || { $: {} };
if (mojo.internal.bindings.glic.mojom.WebClientHandler_CreateExperimentalTriggeringClient_ParamsSpec.$.structSpec && mojo.internal.bindings.glic.mojom.WebClientHandler_CreateExperimentalTriggeringClient_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.glic.mojom.WebClientHandler_CreateExperimentalTriggeringClient_ParamsSpec.$ = {};
...
mojo.internal.bindings.glic.mojom.WebClientHandler_CreateZeroStateSuggestionsHandler_ParamsSpec = mojo.internal.bindings.glic.mojom.WebClientHandler_CreateZeroStateSuggestionsHandler_ParamsSpec || { $: {} };
if (mojo.internal.bindings.glic.mojom.WebClientHandler_CreateZeroStateSuggestionsHandler_ParamsSpec.$.structSpec && mojo.internal.bindings.glic.mojom.WebClientHandler_CreateZeroStateSuggestionsHandler_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.glic.mojom.WebClientHandler_CreateZeroStateSuggestionsHandler_ParamsSpec.$ = {};
mojo.internal.bindings.glic.mojom.WebClientHandler_CreateAiOverlayTools_ParamsSpec = mojo.internal.bindings.glic.mojom.WebClientHandler_CreateAiOverlayTools_ParamsSpec || { $: {} };
if (mojo.internal.bindings.glic.mojom.WebClientHandler_CreateAiOverlayTools_ParamsSpec.$.structSpec && mojo.internal.bindings.glic.mojom.WebClientHandler_CreateAiOverlayTools_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.glic.mojom.WebClientHandler_CreateAiOverlayTools_ParamsSpec.$ = {};
...
mojo.internal.bindings.glic.mojom.WebClientHandler_OpenContactInfoSettingsPage_ParamsSpec = mojo.internal.bindings.glic.mojom.WebClientHandler_OpenContactInfoSettingsPage_ParamsSpec || { $: {} };
if (mojo.internal.bindings.glic.mojom.WebClientHandler_OpenContactInfoSettingsPage_ParamsSpec.$.structSpec && mojo.internal.bindings.glic.mojom.WebClientHandler_OpenContactInfoSettingsPage_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.glic.mojom.WebClientHandler_OpenContactInfoSettingsPage_ParamsSpec.$ = {};
mojo.internal.bindings.glic.mojom.WebClientHandler_EnableDragResize_ParamsSpec = mojo.internal.bindings.glic.mojom.WebClientHandler_EnableDragResize_ParamsSpec || { $: {} };
if (mojo.internal.bindings.glic.mojom.WebClientHandler_EnableDragResize_ParamsSpec.$.structSpec && mojo.internal.bindings.glic.mojom.WebClientHandler_EnableDragResize_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.glic.mojom.WebClientHandler_EnableDragResize_ParamsSpec.$ = {};
...
mojo.internal.bindings.glic.mojom.WebClientHandler_OpenPinnedTabPicker_ParamsSpec = mojo.internal.bindings.glic.mojom.WebClientHandler_OpenPinnedTabPicker_ParamsSpec || { $: {} };
if (mojo.internal.bindings.glic.mojom.WebClientHandler_OpenPinnedTabPicker_ParamsSpec.$.structSpec && mojo.internal.bindings.glic.mojom.WebClientHandler_OpenPinnedTabPicker_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.glic.mojom.WebClientHandler_OpenPinnedTabPicker_ParamsSpec.$ = {};
mojo.internal.bindings.glic.mojom.WebClientHandler_OpenPinnedTabPicker_ResponseParamsSpec = mojo.internal.bindings.glic.mojom.WebClientHandler_OpenPinnedTabPicker_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.glic.mojom.WebClientHandler_OpenPinnedTabPicker_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.glic.mojom.WebClientHandler_OpenPinnedTabPicker_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.glic.mojom.WebClientHandler_OpenPinnedTabPicker_ResponseParamsSpec.$ = {};
...
mojo.internal.bindings.glic.mojom.WebClientHandler_CreateGeminiEnterpriseHandler_ParamsSpec = mojo.internal.bindings.glic.mojom.WebClientHandler_CreateGeminiEnterpriseHandler_ParamsSpec || { $: {} };
if (mojo.internal.bindings.glic.mojom.WebClientHandler_CreateGeminiEnterpriseHandler_ParamsSpec.$.structSpec && mojo.internal.bindings.glic.mojom.WebClientHandler_CreateGeminiEnterpriseHandler_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.glic.mojom.WebClientHandler_CreateGeminiEnterpriseHandler_ParamsSpec.$ = {};
mojo.internal.bindings.glic.mojom.ZeroStateSuggestionsHandler = mojo.internal.bindings.glic.mojom.ZeroStateSuggestionsHandler || {};
mojo.internal.bindings.glic.mojom.ZeroStateSuggestionsHandlerSpec = mojo.internal.bindings.glic.mojom.ZeroStateSuggestionsHandlerSpec || { $ : {} };
if (mojo.internal.bindings.glic.mojom.ZeroStateSuggestionsHandlerSpec.$.structSpec && mojo.internal.bindings.glic.mojom.ZeroStateSuggestionsHandlerSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.glic.mojom.ZeroStateSuggestionsHandlerSpec.$ = {};
mojo.internal.bindings.glic.mojom.ZeroStateSuggestionsHandler.$interfaceName = 'glic.mojom.ZeroStateSuggestionsHandler';
mojo.internal.bindings.glic.mojom.ZeroStateSuggestionsHandler_GetZeroStateSuggestionsAndSubscribe_ParamsSpec = mojo.internal.bindings.glic.mojom.ZeroStateSuggestionsHandler_GetZeroStateSuggestionsAndSubscribe_ParamsSpec || { $: {} };
if (mojo.internal.bindings.glic.mojom.ZeroStateSuggestionsHandler_GetZeroStateSuggestionsAndSubscribe_ParamsSpec.$.structSpec && mojo.internal.bindings.glic.mojom.ZeroStateSuggestionsHandler_GetZeroStateSuggestionsAndSubscribe_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.glic.mojom.ZeroStateSuggestionsHandler_GetZeroStateSuggestionsAndSubscribe_ParamsSpec.$ = {};
mojo.internal.bindings.glic.mojom.ZeroStateSuggestionsHandler_GetZeroStateSuggestionsAndSubscribe_ResponseParamsSpec = mojo.internal.bindings.glic.mojom.ZeroStateSuggestionsHandler_GetZeroStateSuggestionsAndSubscribe_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.glic.mojom.ZeroStateSuggestionsHandler_GetZeroStateSuggestionsAndSubscribe_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.glic.mojom.ZeroStateSuggestionsHandler_GetZeroStateSuggestionsAndSubscribe_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.glic.mojom.ZeroStateSuggestionsHandler_GetZeroStateSuggestionsAndSubscribe_ResponseParamsSpec.$ = {};
mojo.internal.bindings.glic.mojom.ZeroStateSuggestionsClient = mojo.internal.bindings.glic.mojom.ZeroStateSuggestionsClient || {};
mojo.internal.bindings.glic.mojom.ZeroStateSuggestionsClientSpec = mojo.internal.bindings.glic.mojom.ZeroStateSuggestionsClientSpec || { $ : {} };
if (mojo.internal.bindings.glic.mojom.ZeroStateSuggestionsClientSpec.$.structSpec && mojo.internal.bindings.glic.mojom.ZeroStateSuggestionsClientSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.glic.mojom.ZeroStateSuggestionsClientSpec.$ = {};
mojo.internal.bindings.glic.mojom.ZeroStateSuggestionsClient.$interfaceName = 'glic.mojom.ZeroStateSuggestionsClient';
mojo.internal.bindings.glic.mojom.ZeroStateSuggestionsClient_NotifyZeroStateSuggestionsChanged_ParamsSpec = mojo.internal.bindings.glic.mojom.ZeroStateSuggestionsClient_NotifyZeroStateSuggestionsChanged_ParamsSpec || { $: {} };
if (mojo.internal.bindings.glic.mojom.ZeroStateSuggestionsClient_NotifyZeroStateSuggestionsChanged_ParamsSpec.$.structSpec && mojo.internal.bindings.glic.mojom.ZeroStateSuggestionsClient_NotifyZeroStateSuggestionsChanged_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.glic.mojom.ZeroStateSuggestionsClient_NotifyZeroStateSuggestionsChanged_ParamsSpec.$ = {};
...
mojo.internal.bindings.glic.mojom.ExperimentalTriggeringClient = mojo.internal.bindings.glic.mojom.ExperimentalTriggeringClient || {};
mojo.internal.bindings.glic.mojom.ExperimentalTriggeringClientSpec = mojo.internal.bindings.glic.mojom.ExperimentalTriggeringClientSpec || { $ : {} };
if (mojo.internal.bindings.glic.mojom.ExperimentalTriggeringClientSpec.$.structSpec && mojo.internal.bindings.glic.mojom.ExperimentalTriggeringClientSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.glic.mojom.ExperimentalTriggeringClientSpec.$ = {};
mojo.internal.bindings.glic.mojom.ExperimentalTriggeringClient.$interfaceName = 'glic.mojom.ExperimentalTriggeringClient';
mojo.internal.bindings.glic.mojom.ExperimentalTriggeringClient_UploadEncryptedScreenshot_ParamsSpec = mojo.internal.bindings.glic.mojom.ExperimentalTriggeringClient_UploadEncryptedScreenshot_ParamsSpec || { $: {} };
if (mojo.internal.bindings.glic.mojom.ExperimentalTriggeringClient_UploadEncryptedScreenshot_ParamsSpec.$.structSpec && mojo.internal.bindings.glic.mojom.ExperimentalTriggeringClient_UploadEncryptedScreenshot_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.glic.mojom.ExperimentalTriggeringClient_UploadEncryptedScreenshot_ParamsSpec.$ = {};
mojo.internal.bindings.glic.mojom.ExperimentalTriggeringClient_UploadEncryptedScreenshot_ResponseParamsSpec = mojo.internal.bindings.glic.mojom.ExperimentalTriggeringClient_UploadEncryptedScreenshot_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.glic.mojom.ExperimentalTriggeringClient_UploadEncryptedScreenshot_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.glic.mojom.ExperimentalTriggeringClient_UploadEncryptedScreenshot_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.glic.mojom.ExperimentalTriggeringClient_UploadEncryptedScreenshot_ResponseParamsSpec.$ = {};
mojo.internal.bindings.glic.mojom.ExperimentalTriggeringClient_GetExperimentalTriggeringUpdates_ParamsSpec = mojo.internal.bindings.glic.mojom.ExperimentalTriggeringClient_GetExperimentalTriggeringUpdates_ParamsSpec || { $: {} };
if (mojo.internal.bindings.glic.mojom.ExperimentalTriggeringClient_GetExperimentalTriggeringUpdates_ParamsSpec.$.structSpec && mojo.internal.bindings.glic.mojom.ExperimentalTriggeringClient_GetExperimentalTriggeringUpdates_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.glic.mojom.ExperimentalTriggeringClient_GetExperimentalTriggeringUpdates_ParamsSpec.$ = {};
mojo.internal.bindings.glic.mojom.ExperimentalTriggeringClient_GetExperimentalTriggeringUpdates_ResponseParamsSpec = mojo.internal.bindings.glic.mojom.ExperimentalTriggeringClient_GetExperimentalTriggeringUpdates_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.glic.mojom.ExperimentalTriggeringClient_GetExperimentalTriggeringUpdates_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.glic.mojom.ExperimentalTriggeringClient_GetExperimentalTriggeringUpdates_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.glic.mojom.ExperimentalTriggeringClient_GetExperimentalTriggeringUpdates_ResponseParamsSpec.$ = {};
mojo.internal.bindings.glic.mojom.ExperimentalTriggeringClient_SubmitExperimentalTriggeringConfirmationResponse_ParamsSpec = mojo.internal.bindings.glic.mojom.ExperimentalTriggeringClient_SubmitExperimentalTriggeringConfirmationResponse_ParamsSpec || { $: {} };
if (mojo.internal.bindings.glic.mojom.ExperimentalTriggeringClient_SubmitExperimentalTriggeringConfirmationResponse_ParamsSpec.$.structSpec && mojo.internal.bindings.glic.mojom.ExperimentalTriggeringClient_SubmitExperimentalTriggeringConfirmationResponse_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.glic.mojom.ExperimentalTriggeringClient_SubmitExperimentalTriggeringConfirmationResponse_ParamsSpec.$ = {};
mojo.internal.bindings.glic.mojom.ExperimentalTriggeringClient_SubmitExperimentalTriggeringConfirmationResponse_ResponseParamsSpec = mojo.internal.bindings.glic.mojom.ExperimentalTriggeringClient_SubmitExperimentalTriggeringConfirmationResponse_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.glic.mojom.ExperimentalTriggeringClient_SubmitExperimentalTriggeringConfirmationResponse_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.glic.mojom.ExperimentalTriggeringClient_SubmitExperimentalTriggeringConfirmationResponse_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.glic.mojom.ExperimentalTriggeringClient_SubmitExperimentalTriggeringConfirmationResponse_ResponseParamsSpec.$ = {};
...
mojo.internal.bindings.glic.mojom.WebClient_CheckResponsive_ParamsSpec = mojo.internal.bindings.glic.mojom.WebClient_CheckResponsive_ParamsSpec || { $: {} };
if (mojo.internal.bindings.glic.mojom.WebClient_CheckResponsive_ParamsSpec.$.structSpec && mojo.internal.bindings.glic.mojom.WebClient_CheckResponsive_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.glic.mojom.WebClient_CheckResponsive_ParamsSpec.$ = {};
mojo.internal.bindings.glic.mojom.WebClient_CheckResponsive_ResponseParamsSpec = mojo.internal.bindings.glic.mojom.WebClient_CheckResponsive_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.glic.mojom.WebClient_CheckResponsive_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.glic.mojom.WebClient_CheckResponsive_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.glic.mojom.WebClient_CheckResponsive_ResponseParamsSpec.$ = {};
...
mojo.internal.bindings.glic.mojom.WebClient_NotifyFileUploadStateChanged_ParamsSpec = mojo.internal.bindings.glic.mojom.WebClient_NotifyFileUploadStateChanged_ParamsSpec || { $: {} };
if (mojo.internal.bindings.glic.mojom.WebClient_NotifyFileUploadStateChanged_ParamsSpec.$.structSpec && mojo.internal.bindings.glic.mojom.WebClient_NotifyFileUploadStateChanged_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.glic.mojom.WebClient_NotifyFileUploadStateChanged_ParamsSpec.$ = {};
...
mojo.internal.bindings.glic.mojom.WebClient_NotifyZoomLevelChanged_ParamsSpec = mojo.internal.bindings.glic.mojom.WebClient_NotifyZoomLevelChanged_ParamsSpec || { $: {} };
if (mojo.internal.bindings.glic.mojom.WebClient_NotifyZoomLevelChanged_ParamsSpec.$.structSpec && mojo.internal.bindings.glic.mojom.WebClient_NotifyZoomLevelChanged_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.glic.mojom.WebClient_NotifyZoomLevelChanged_ParamsSpec.$ = {};
...
mojo.internal.bindings.actor.webui = mojo.internal.bindings.actor.webui || {};
mojo.internal.bindings.actor.webui.mojom = mojo.internal.bindings.actor.webui.mojom || {};
mojo.internal.bindings.actor.webui.mojom.GmailOtpConfirmationRequestSpec = mojo.internal.bindings.actor.webui.mojom.GmailOtpConfirmationRequestSpec || { $: mojo.internal.OpaqueStruct.$ };
mojo.internal.bindings.actor = mojo.internal.bindings.actor || {};
mojo.internal.bindings.actor.webui = mojo.internal.bindings.actor.webui || {};
mojo.internal.bindings.actor.webui.mojom = mojo.internal.bindings.actor.webui.mojom || {};
mojo.internal.bindings.actor.webui.mojom.GmailOtpConfirmationResultSpec = mojo.internal.bindings.actor.webui.mojom.GmailOtpConfirmationResultSpec || { $: mojo.internal.OpaqueStruct.$ };
mojo.internal.bindings.actor = mojo.internal.bindings.actor || {};
mojo.internal.bindings.actor.webui = mojo.internal.bindings.actor.webui || {};
mojo.internal.bindings.actor.webui.mojom = mojo.internal.bindings.actor.webui.mojom || {};
mojo.internal.bindings.actor.webui.mojom.GmailOtpOptInRequestSpec = mojo.internal.bindings.actor.webui.mojom.GmailOtpOptInRequestSpec || { $: mojo.internal.OpaqueStruct.$ };
mojo.internal.bindings.actor = mojo.internal.bindings.actor || {};
mojo.internal.bindings.actor.webui = mojo.internal.bindings.actor.webui || {};
mojo.internal.bindings.actor.webui.mojom = mojo.internal.bindings.actor.webui.mojom || {};
...
mojo.internal.bindings.glic = mojo.internal.bindings.glic || {};
mojo.internal.bindings.glic.mojom = mojo.internal.bindings.glic.mojom || {};
mojo.internal.bindings.glic.mojom.GeminiEnterpriseHandlerSpec = mojo.internal.bindings.glic.mojom.GeminiEnterpriseHandlerSpec || { $: mojo.internal.OpaqueStruct.$ };
mojo.internal.bindings.glic.mojom.GeminiEnterpriseHandlerRemote = mojo.internal.bindings.glic.mojom.GeminiEnterpriseHandlerRemote || class {};
mojo.internal.bindings.glic.mojom.GeminiEnterpriseHandlerPendingReceiver = mojo.internal.bindings.glic.mojom.GeminiEnterpriseHandlerPendingReceiver || class { constructor(handle) { this.handle = handle; } };
mojo.internal.bindings.glic = mojo.internal.bindings.glic || {};
mojo.internal.bindings.glic.mojom = mojo.internal.bindings.glic.mojom || {};
...
mojo.internal.bindings.glic.mojom.FileUploadPolicyState = {
  kEnabled: 0,
  kDisabled: 1,
};
...
mojo.internal.bindings.glic.mojom.GlicRequestEvent = {
  kRequestReceived: 0,
  kResponseSent: 1,
...
// Enum: PromptType
mojo.internal.bindings.glic.mojom.PromptType = {
  kUnspecified: 0,
  kTypedText: 1,
...
mojo.internal.bindings.glic.mojom.ScreenshotEncryptionScheme = {
  kUnknown: 0,
  kNone: 1,
  kRfc8291: 2,
};
...
mojo.internal.bindings.glic.mojom.ActorClientRemote = class {
  ...
  requestToShowGmailOtpOptInDialog(arg_request) {
    return this.$.requestToShowGmailOtpOptInDialog(arg_request);
  }
  requestToShowGmailOtpConfirmationDialog(arg_request) {
    return this.$.requestToShowGmailOtpConfirmationDialog(arg_request);
  }
};
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        ...
        case 5: {
          ...
          const result = this.impl.requestToShowGmailOtpOptInDialog(params.arg_request);
          const expectsResponse = header.expectsResponse || (header.flags & 1);
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
        ...
        case 6: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.glic.mojom.ActorClient_RequestToShowGmailOtpConfirmationDialog_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.requestToShowGmailOtpConfirmationDialog');
          const result = this.impl.requestToShowGmailOtpConfirmationDialog(params.arg_request);
          const expectsResponse = header.expectsResponse || (header.flags & 1);
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              const val = (response && typeof response === 'object' && 'arg_result' in response) ? response['arg_result'] : response;
              ...
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.glic.mojom.ActorClient_RequestToShowGmailOtpConfirmationDialog_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
            }).catch(e => console.error('[GeneratedReceiver] requestToShowGmailOtpConfirmationDialog FAILED:', e));
          }
          break;
        }
      }
...
mojo.internal.bindings.glic.mojom.ActorHandlerRemote = class {
  ...
  updateActorTaskStepProgress(arg_task_id, arg_step_progress) {
    return this.$.updateActorTaskStepProgress(arg_task_id, arg_step_progress);
  }
  createActorTab(arg_task_id, arg_options) {
    return this.$.createActorTab(arg_task_id, arg_options);
  }
...
mojo.internal.bindings.glic.mojom.ActorHandlerRemoteCallHandler = class {
  ...
  updateActorTaskStepProgress(arg_task_id, arg_step_progress) {
    return this.proxy.sendMessage(
      ...
      mojo.internal.bindings.glic.mojom.ActorHandler_UpdateActorTaskStepProgress_ParamsSpec,
      null,
      [arg_task_id, arg_step_progress],
      false);
  }
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        ...
        case 12: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.glic.mojom.ActorHandler_UpdateActorTaskStepProgress_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.updateActorTaskStepProgress');
          const result = this.impl.updateActorTaskStepProgress(params.arg_task_id, params.arg_step_progress);
          break;
        }
        case 13: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          ...
          const result = this.impl.createActorTab(params.arg_task_id, params.arg_options);
          const expectsResponse = header.expectsResponse || (header.flags & 1);
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
...
mojo.internal.bindings.glic.mojom.SkillsClientRemote = class {
  ...
  notifySkillsEnabledChanged(arg_enabled) {
    return this.$.notifySkillsEnabledChanged(arg_enabled);
  }
};
...
mojo.internal.bindings.glic.mojom.SkillsClientRemoteCallHandler = class {
  ...
  notifySkillsEnabledChanged(arg_enabled) {
    return this.proxy.sendMessage(
      this.ordinals[4],  // ordinal
      mojo.internal.bindings.glic.mojom.SkillsClient_NotifySkillsEnabledChanged_ParamsSpec,
      null,
      [arg_enabled],
      false);
  }
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        ...
        case 4: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.glic.mojom.SkillsClient_NotifySkillsEnabledChanged_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.notifySkillsEnabledChanged');
          const result = this.impl.notifySkillsEnabledChanged(params.arg_enabled);
          break;
        }
      }
      } catch (err) {
...
mojo.internal.bindings.glic.mojom.WebClientHandlerRemote = class {
  ...
  recordSparseValue(arg_name, arg_value) {
    return this.$.recordSparseValue(arg_name, arg_value);
  }
  ...
  createExperimentalTriggeringClient(arg_client) {
    return this.$.createExperimentalTriggeringClient(arg_client);
  }
  ...
  createZeroStateSuggestionsHandler(arg_receiver) {
    return this.$.createZeroStateSuggestionsHandler(arg_receiver);
  }
  createAiOverlayTools(arg_receiver) {
    return this.$.createAiOverlayTools(arg_receiver);
  }
  createTab(arg_url, arg_create_options) {
    return this.$.createTab(arg_url, arg_create_options);
  }
  ...
  openContactInfoSettingsPage() {
    return this.$.openContactInfoSettingsPage();
  }
  ...
  openPinnedTabPicker(arg_options) {
    return this.$.openPinnedTabPicker(arg_options);
  }
  ...
  onUserInputSubmitted(arg_mode, arg_prompt_type) {
    return this.$.onUserInputSubmitted(arg_mode, arg_prompt_type);
  }
  ...
  createGeminiEnterpriseHandler(arg_receiver) {
    return this.$.createGeminiEnterpriseHandler(arg_receiver);
  }
};
...
mojo.internal.bindings.glic.mojom.WebClientHandlerRemoteCallHandler = class {
  ...
  reportApiRequestLatency(arg_request_type, arg_latency) {
    return this.proxy.sendMessage(
      this.ordinals[1],  // ordinal
      mojo.internal.bindings.glic.mojom.WebClientHandler_ReportApiRequestLatency_ParamsSpec,
      null,
      [arg_request_type, arg_latency],
      false);
  }
  ...
  recordSparseValue(arg_name, arg_value) {
    return this.proxy.sendMessage(
      this.ordinals[2],  // ordinal
      mojo.internal.bindings.glic.mojom.WebClientHandler_RecordSparseValue_ParamsSpec,
      null,
      [arg_name, arg_value],
      false);
  }
  ...
  createAiOverlayTools(arg_receiver) {
    return this.proxy.sendMessage(
      this.ordinals[11],  // ordinal
      mojo.internal.bindings.glic.mojom.WebClientHandler_CreateAiOverlayTools_ParamsSpec,
      null,
      [arg_receiver],
      false);
  }
  ...
  enableDragResize(arg_enabled) {
    return this.proxy.sendMessage(
      this.ordinals[18],  // ordinal
      mojo.internal.bindings.glic.mojom.WebClientHandler_EnableDragResize_ParamsSpec,
      null,
      [arg_enabled],
      false);
  }
  ...
  openPinnedTabPicker(arg_options) {
    return this.proxy.sendMessage(
      ...
      mojo.internal.bindings.glic.mojom.WebClientHandler_OpenPinnedTabPicker_ParamsSpec,
      mojo.internal.bindings.glic.mojom.WebClientHandler_OpenPinnedTabPicker_ResponseParamsSpec,
      [arg_options],
      false);
  }
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        ...
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.glic.mojom.WebClientHandler_ReportApiRequestLatency_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.reportApiRequestLatency');
          const result = this.impl.reportApiRequestLatency(params.arg_request_type, params.arg_latency);
          break;
        }
        case 2: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.glic.mojom.WebClientHandler_RecordSparseValue_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.recordSparseValue');
          const result = this.impl.recordSparseValue(params.arg_name, params.arg_value);
          break;
        }
        case 3: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
        ...
        case 7: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.glic.mojom.WebClientHandler_CreateExperimentalTriggeringClient_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.createExperimentalTriggeringClient');
          const result = this.impl.createExperimentalTriggeringClient(params.arg_client);
          break;
        }
        case 8: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
        ...
        case 10: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.glic.mojom.WebClientHandler_CreateZeroStateSuggestionsHandler_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.createZeroStateSuggestionsHandler');
          const result = this.impl.createZeroStateSuggestionsHandler(params.arg_receiver);
          break;
        }
        case 11: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.glic.mojom.WebClientHandler_CreateAiOverlayTools_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.createAiOverlayTools');
          const result = this.impl.createAiOverlayTools(params.arg_receiver);
          break;
        }
        case 12: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          ...
          const result = this.impl.createTab(params.arg_url, params.arg_create_options);
          const expectsResponse = header.expectsResponse || (header.flags & 1);
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              const val = (response && typeof response === 'object' && 'arg_tab_data' in response) ? response['arg_tab_data'] : response;
        ...
        case 17: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.glic.mojom.WebClientHandler_OpenContactInfoSettingsPage_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.openContactInfoSettingsPage');
          const result = this.impl.openContactInfoSettingsPage();
          break;
        }
        case 18: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.glic.mojom.WebClientHandler_EnableDragResize_ParamsSpec.$.structSpec);
        ...
        case 35: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.glic.mojom.WebClientHandler_OpenPinnedTabPicker_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.openPinnedTabPicker');
          const result = this.impl.openPinnedTabPicker(params.arg_options);
          const expectsResponse = header.expectsResponse || (header.flags & 1);
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.glic.mojom.WebClientHandler_OpenPinnedTabPicker_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
            }).catch(e => console.error('[GeneratedReceiver] openPinnedTabPicker FAILED:', e));
          }
          break;
        }
        case 36: {
        ...
        case 56: {
          ...
          const result = this.impl.onUserInputSubmitted(params.arg_mode, params.arg_prompt_type);
          break;
        }
        case 57: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
        ...
        case 79: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.glic.mojom.WebClientHandler_CreateGeminiEnterpriseHandler_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.createGeminiEnterpriseHandler');
          const result = this.impl.createGeminiEnterpriseHandler(params.arg_receiver);
          break;
        }
      }
      } catch (err) {
...
mojo.internal.bindings.glic.mojom.ZeroStateSuggestionsHandlerPendingReceiver = class {
  constructor(handle) {
    this.handle = handle;
    if (handle) {
      this.__mojoHandle = handle.router_ ? handle.router_.pipe_ : (handle.pipe_ || handle);
...
mojo.internal.bindings.glic.mojom.ZeroStateSuggestionsHandlerRemote = class {
  static get $interfaceName() {
    return 'glic.mojom.ZeroStateSuggestionsHandler';
  }

  constructor(handle = undefined) {
    this.__mojoHandle = handle;
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.glic.mojom.ZeroStateSuggestionsHandlerPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.glic.mojom.ZeroStateSuggestionsHandlerRemoteCallHandler(this.proxy);
  }
  ...
  getZeroStateSuggestionsAndSubscribe(arg_client, arg_options) {
    return this.$.getZeroStateSuggestionsAndSubscribe(arg_client, arg_options);
  }
};

mojo.internal.bindings.glic.mojom.ZeroStateSuggestionsHandlerRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('glic.mojom.ZeroStateSuggestionsHandler', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.glic.mojom.ZeroStateSuggestionsHandler.getRemote = function() {
  let remote = new mojo.internal.bindings.glic.mojom.ZeroStateSuggestionsHandlerRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
    'glic.mojom.ZeroStateSuggestionsHandler',
    'context');
  return remote.$;
};

mojo.internal.bindings.glic.mojom.ZeroStateSuggestionsHandlerReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('glic.mojom.ZeroStateSuggestionsHandler', [
      { explicit: null },
    ]);
    ordinals.forEach((ord, idx) => {
      this.ordinalMap.set(ord, idx); // Scrambled/Explicit
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.glic.mojom.ZeroStateSuggestionsHandler_GetZeroStateSuggestionsAndSubscribe_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.getZeroStateSuggestionsAndSubscribe');
          const result = this.impl.getZeroStateSuggestionsAndSubscribe(params.arg_client, params.arg_options);
          const expectsResponse = header.expectsResponse || (header.flags & 1);
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.glic.mojom.ZeroStateSuggestionsHandler_GetZeroStateSuggestionsAndSubscribe_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
...
mojo.internal.bindings.glic.mojom.ZeroStateSuggestionsHandlerReceiver = mojo.internal.bindings.glic.mojom.ZeroStateSuggestionsHandlerReceiver;

mojo.internal.bindings.glic.mojom.ZeroStateSuggestionsHandlerPtr = mojo.internal.bindings.glic.mojom.ZeroStateSuggestionsHandlerRemote;
mojo.internal.bindings.glic.mojom.ZeroStateSuggestionsHandlerRequest = mojo.internal.bindings.glic.mojom.ZeroStateSuggestionsHandlerPendingReceiver;


// Interface: ZeroStateSuggestionsClient
mojo.internal.bindings.glic.mojom.ZeroStateSuggestionsClientPendingReceiver = class {
  constructor(handle) {
    this.handle = handle;
    if (handle) {
      this.__mojoHandle = handle.router_ ? handle.router_.pipe_ : (handle.pipe_ || handle);
...
mojo.internal.bindings.glic.mojom.ZeroStateSuggestionsClientRemote = class {
  static get $interfaceName() {
    return 'glic.mojom.ZeroStateSuggestionsClient';
  }

  constructor(handle = undefined) {
    this.__mojoHandle = handle;
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.glic.mojom.ZeroStateSuggestionsClientPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.glic.mojom.ZeroStateSuggestionsClientRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.glic.mojom.ZeroStateSuggestionsClientRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('glic.mojom.ZeroStateSuggestionsClient', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.glic.mojom.ZeroStateSuggestionsClient.getRemote = function() {
  let remote = new mojo.internal.bindings.glic.mojom.ZeroStateSuggestionsClientRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
    'glic.mojom.ZeroStateSuggestionsClient',
    'context');
  return remote.$;
};

mojo.internal.bindings.glic.mojom.ZeroStateSuggestionsClientReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('glic.mojom.ZeroStateSuggestionsClient', [
      { explicit: null },
    ]);
    ordinals.forEach((ord, idx) => {
      this.ordinalMap.set(ord, idx); // Scrambled/Explicit
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.glic.mojom.ZeroStateSuggestionsClient_NotifyZeroStateSuggestionsChanged_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.glic.mojom.ZeroStateSuggestionsClientReceiver = mojo.internal.bindings.glic.mojom.ZeroStateSuggestionsClientReceiver;

mojo.internal.bindings.glic.mojom.ZeroStateSuggestionsClientPtr = mojo.internal.bindings.glic.mojom.ZeroStateSuggestionsClientRemote;
mojo.internal.bindings.glic.mojom.ZeroStateSuggestionsClientRequest = mojo.internal.bindings.glic.mojom.ZeroStateSuggestionsClientPendingReceiver;
...
mojo.internal.bindings.glic.mojom.ExperimentalTriggeringClientPendingReceiver = class {
  constructor(handle) {
    this.handle = handle;
    if (handle) {
      this.__mojoHandle = handle.router_ ? handle.router_.pipe_ : (handle.pipe_ || handle);
...
mojo.internal.bindings.glic.mojom.ExperimentalTriggeringClientRemote = class {
  static get $interfaceName() {
    return 'glic.mojom.ExperimentalTriggeringClient';
  }

  constructor(handle = undefined) {
    this.__mojoHandle = handle;
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.glic.mojom.ExperimentalTriggeringClientPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.glic.mojom.ExperimentalTriggeringClientRemoteCallHandler(this.proxy);
  }
  ...
  uploadEncryptedScreenshot(arg_screenshot) {
    return this.$.uploadEncryptedScreenshot(arg_screenshot);
  }
  getExperimentalTriggeringUpdates(arg_handler) {
    return this.$.getExperimentalTriggeringUpdates(arg_handler);
  }
  submitExperimentalTriggeringConfirmationResponse(arg_response) {
    return this.$.submitExperimentalTriggeringConfirmationResponse(arg_response);
  }
};

mojo.internal.bindings.glic.mojom.ExperimentalTriggeringClientRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('glic.mojom.ExperimentalTriggeringClient', [
      { explicit: null },
      { explicit: null },
      { explicit: null },
    ]);
...
mojo.internal.bindings.glic.mojom.ExperimentalTriggeringClient.getRemote = function() {
  let remote = new mojo.internal.bindings.glic.mojom.ExperimentalTriggeringClientRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
    'glic.mojom.ExperimentalTriggeringClient',
    'context');
  return remote.$;
};

mojo.internal.bindings.glic.mojom.ExperimentalTriggeringClientReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('glic.mojom.ExperimentalTriggeringClient', [
      { explicit: null },
      { explicit: null },
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.glic.mojom.ExperimentalTriggeringClient_UploadEncryptedScreenshot_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.uploadEncryptedScreenshot');
          const result = this.impl.uploadEncryptedScreenshot(params.arg_screenshot);
          const expectsResponse = header.expectsResponse || (header.flags & 1);
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              const val = (response && typeof response === 'object' && 'arg_file_token' in response) ? response['arg_file_token'] : response;
              const resp_obj = { 'arg_file_token': val };
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.glic.mojom.ExperimentalTriggeringClient_UploadEncryptedScreenshot_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
            }).catch(e => console.error('[GeneratedReceiver] uploadEncryptedScreenshot FAILED:', e));
          }
          break;
        }
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.glic.mojom.ExperimentalTriggeringClient_GetExperimentalTriggeringUpdates_ParamsSpec.$.structSpec);
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.glic.mojom.ExperimentalTriggeringClient_GetExperimentalTriggeringUpdates_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
        ...
        case 2: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.glic.mojom.ExperimentalTriggeringClient_SubmitExperimentalTriggeringConfirmationResponse_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.submitExperimentalTriggeringConfirmationResponse');
          const result = this.impl.submitExperimentalTriggeringConfirmationResponse(params.arg_response);
          const expectsResponse = header.expectsResponse || (header.flags & 1);
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              const val = (response && typeof response === 'object' && 'arg_accepted' in response) ? response['arg_accepted'] : response;
              const resp_obj = { 'arg_accepted': val };
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.glic.mojom.ExperimentalTriggeringClient_SubmitExperimentalTriggeringConfirmationResponse_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
            }).catch(e => console.error('[GeneratedReceiver] submitExperimentalTriggeringConfirmationResponse FAILED:', e));
          }
          break;
        }
      }
...
mojo.internal.bindings.glic.mojom.ExperimentalTriggeringClientReceiver = mojo.internal.bindings.glic.mojom.ExperimentalTriggeringClientReceiver;

mojo.internal.bindings.glic.mojom.ExperimentalTriggeringClientPtr = mojo.internal.bindings.glic.mojom.ExperimentalTriggeringClientRemote;
mojo.internal.bindings.glic.mojom.ExperimentalTriggeringClientRequest = mojo.internal.bindings.glic.mojom.ExperimentalTriggeringClientPendingReceiver;
...
mojo.internal.bindings.glic.mojom.WebClientRemote = class {
  ...
  notifyFileUploadStateChanged(arg_state) {
    return this.$.notifyFileUploadStateChanged(arg_state);
  }
  stopMicrophone() {
  ...
  notifyZoomLevelChanged(arg_zoom_factor) {
    return this.$.notifyZoomLevelChanged(arg_zoom_factor);
  }
...
mojo.internal.bindings.glic.mojom.WebClientRemoteCallHandler = class {
  ...
  checkResponsive() {
    return this.proxy.sendMessage(
      this.ordinals[0],  // ordinal
      mojo.internal.bindings.glic.mojom.WebClient_CheckResponsive_ParamsSpec,
      mojo.internal.bindings.glic.mojom.WebClient_CheckResponsive_ResponseParamsSpec,
      [],
      false);
  }
  ...
  notifyFileUploadStateChanged(arg_state) {
    return this.proxy.sendMessage(
      this.ordinals[7],  // ordinal
      mojo.internal.bindings.glic.mojom.WebClient_NotifyFileUploadStateChanged_ParamsSpec,
      null,
      [arg_state],
      false);
  }
  ...
  notifyZoomLevelChanged(arg_zoom_factor) {
    return this.proxy.sendMessage(
      this.ordinals[16],  // ordinal
      mojo.internal.bindings.glic.mojom.WebClient_NotifyZoomLevelChanged_ParamsSpec,
      null,
      [arg_zoom_factor],
      false);
  }
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.glic.mojom.WebClient_CheckResponsive_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.checkResponsive');
          const result = this.impl.checkResponsive();
          const expectsResponse = header.expectsResponse || (header.flags & 1);
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              const resp_obj = response;
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.glic.mojom.WebClient_CheckResponsive_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
            }).catch(e => console.error('[GeneratedReceiver] checkResponsive FAILED:', e));
          }
          break;
        }
        case 1: {
        ...
        case 7: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.glic.mojom.WebClient_NotifyFileUploadStateChanged_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.notifyFileUploadStateChanged');
          const result = this.impl.notifyFileUploadStateChanged(params.arg_state);
          break;
        }
        case 8: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
        ...
        case 16: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.glic.mojom.WebClient_NotifyZoomLevelChanged_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.notifyZoomLevelChanged');
          const result = this.impl.notifyZoomLevelChanged(params.arg_zoom_factor);
          break;
        }
        case 17: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
...
mojo.internal.Union(
    mojo.internal.bindings.glic.mojom.GetContextResultSpec, 'glic.mojom.GetContextResult', {
      ...
      'arg_tab_context': {
        'ordinal': 1,
        'type': mojo.internal.bindings.glic.mojom.TabContextResultSpec,
        'nullable': false,
      },
    });
...
mojo.internal.Union(
    mojo.internal.bindings.glic.mojom.InvocationPayloadSpec, 'glic.mojom.InvocationPayload', {
      ...
      'arg_skills_payload': {
        'ordinal': 1,
        'type': mojo.internal.bindings.glic.mojom.SkillsPayloadSpec,
        'nullable': false,
      },
    });
...
mojo.internal.Struct(
    mojo.internal.bindings.glic.mojom.UserProfileInfoSpec, 'glic.mojom.UserProfileInfo', [
      ...
      mojo.internal.StructField('arg_given_name', 16, 0, mojo.internal.String, null, false, 0, undefined),
...
mojo.internal.Struct(
    mojo.internal.bindings.glic.mojom.SafeBrowsingVerdictSpec, 'glic.mojom.SafeBrowsingVerdict', [
...
mojo.internal.Struct(
    mojo.internal.bindings.glic.mojom.CounterAbuseVerdictSpec, 'glic.mojom.CounterAbuseVerdict', [
      mojo.internal.StructField('arg_sb_verdict_result', 0, 0, mojo.internal.bindings.glic.mojom.SafeBrowsingVerdictSpec, null, false, 0, undefined),
    ],
    [[0, 16]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.glic.mojom.WebClientInitialStateSpec, 'glic.mojom.WebClientInitialState', [
      ...
      mojo.internal.StructField('arg_enable_open_contact_info_settings_page', 27, 2, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_enable_trust_first_onboarding', 27, 3, mojo.internal.Bool, false, false, 0, undefined),
      ...
      mojo.internal.StructField('arg_zoom_factor', 32, 0, mojo.internal.Double, 0, false, 0, undefined),
      mojo.internal.StructField('arg_hotkey', 40, 0, mojo.internal.String, null, false, 0, undefined),
      mojo.internal.StructField('arg_chrome_version', 48, 0, mojo.internal.bindings.mojo_base.mojom.VersionSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_form_factor', 56, 0, mojo.internal.bindings.glic.mojom.FormFactorSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_enable_gmail_otp_opt_in', 60, 0, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_enable_gmail_otp_confirmation', 60, 1, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_host_capabilities', 64, 0, mojo.internal.Array(mojo.internal.bindings.glic.mojom.HostCapabilitySpec, false), null, false, 0, undefined),
      mojo.internal.StructField('arg_gemini_enterprise_settings', 72, 0, mojo.internal.bindings.glic.mojom.GeminiEnterpriseSettingsSpec, null, true, 0, undefined),
      mojo.internal.StructField('arg_file_upload_policy_state', 80, 0, mojo.internal.bindings.glic.mojom.FileUploadPolicyStateSpec, null, false, 0, undefined),
    ],
    [[0, 96]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.glic.mojom.TabContextOptionsSpec, 'glic.mojom.TabContextOptions', [
      mojo.internal.StructField('arg_inner_text', 0, 0, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_viewport_screenshot', 0, 1, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_annotated_page_content', 0, 2, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_pdf_data', 0, 3, mojo.internal.Bool, false, false, 0, undefined),
...
mojo.internal.Struct(
    mojo.internal.bindings.glic.mojom.SkillPreviewSpec, 'glic.mojom.SkillPreview', [
      ...
      mojo.internal.StructField('arg_enabled', 28, 0, mojo.internal.Bool, true, false, 0, undefined),
      ...
      mojo.internal.StructField('arg_category', 56, 0, mojo.internal.String, null, true, 0, undefined),
      mojo.internal.StructField('arg_creation_time', 64, 0, mojo.internal.bindings.mojo_base.mojom.TimeSpec, null, true, 0, undefined),
    ],
    [[0, 80]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.glic.mojom.OpenPinnedTabPickerOptionsSpec, 'glic.mojom.OpenPinnedTabPickerOptions', [
    ],
    [[0, 8]]);

// Struct: CreateActorTabOptions
mojo.internal.Struct(
    mojo.internal.bindings.glic.mojom.CreateActorTabOptionsSpec, 'glic.mojom.CreateActorTabOptions', [
      mojo.internal.StructField('arg_initiator_tab_id_$flag', 0, 0, mojo.internal.Bool, false, false, 0, { isPrimary: true, linkedValueFieldName: 'arg_initiator_tab_id_$value', originalFieldName: 'arg_initiator_tab_id' }),
      mojo.internal.StructField('arg_initiator_window_id_$flag', 0, 1, mojo.internal.Bool, false, false, 0, { isPrimary: true, linkedValueFieldName: 'arg_initiator_window_id_$value', originalFieldName: 'arg_initiator_window_id' }),
      mojo.internal.StructField('arg_open_in_background', 0, 2, mojo.internal.Bool, false, false, 0, undefined),
...
mojo.internal.Struct(
    mojo.internal.bindings.glic.mojom.CaptureRegionParamsSpec, 'glic.mojom.CaptureRegionParams', [
      ...
      mojo.internal.StructField('arg_options', 8, 0, mojo.internal.bindings.glic.mojom.TabContextOptionsSpec, null, false, 0, undefined),
    ],
    [[0, 24]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.glic.mojom.CreateTabOptionsSpec, 'glic.mojom.CreateTabOptions', [
      mojo.internal.StructField('arg_open_in_background', 0, 0, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_window_id_$flag', 0, 1, mojo.internal.Bool, false, false, 0, { isPrimary: true, linkedValueFieldName: 'arg_window_id_$value', originalFieldName: 'arg_window_id' }),
...
mojo.internal.Struct(
    mojo.internal.bindings.glic.mojom.SkillsPayloadSpec, 'glic.mojom.SkillsPayload', [
      mojo.internal.StructField('arg_skill_id', 0, 0, mojo.internal.String, null, false, 0, undefined),
      mojo.internal.StructField('arg_skill_name', 8, 0, mojo.internal.String, null, false, 0, undefined),
...
mojo.internal.Struct(
    mojo.internal.bindings.glic.mojom.ExperimentalTriggeringUpdateSpec, 'glic.mojom.ExperimentalTriggeringUpdate', [
      ...
      mojo.internal.StructField('arg_metadata', 16, 0, mojo.internal.Map(mojo.internal.String, mojo.internal.String, false), null, true, 0, undefined),
    ],
    [[0, 32]]);

// Struct: TabContextResult
mojo.internal.Struct(
    mojo.internal.bindings.glic.mojom.TabContextResultSpec, 'glic.mojom.TabContextResult', [
      mojo.internal.StructField('arg_tab_data', 0, 0, mojo.internal.bindings.glic.mojom.TabDataSpec, null, false, 0, undefined),
...
mojo.internal.Struct(
    mojo.internal.bindings.glic.mojom.PdfDocumentDataSpec, 'glic.mojom.PdfDocumentData', [
      ...
      mojo.internal.StructField('arg_pdf_size_limit_exceeded', 16, 0, mojo.internal.Bool, false, false, 0, undefined),
    ],
    [[0, 32]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.glic.mojom.ScreenshotSpec, 'glic.mojom.Screenshot', [
      ...
      mojo.internal.StructField('arg_encryption_scheme', 32, 0, mojo.internal.bindings.glic.mojom.ScreenshotEncryptionSchemeSpec, null, false, 0, undefined),
    ],
    [[0, 48]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.glic.mojom.ActorClient_RequestToShowGmailOtpOptInDialog_ParamsSpec, 'glic.mojom.ActorClient_RequestToShowGmailOtpOptInDialog_Params', [
      mojo.internal.StructField('arg_request', 0, 0, mojo.internal.bindings.actor.webui.mojom.GmailOtpOptInRequestSpec, null, false, 0, undefined),
    ],
    [[0, 16]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.glic.mojom.ActorClient_RequestToShowGmailOtpConfirmationDialog_ParamsSpec, 'glic.mojom.ActorClient_RequestToShowGmailOtpConfirmationDialog_Params', [
      mojo.internal.StructField('arg_request', 0, 0, mojo.internal.bindings.actor.webui.mojom.GmailOtpConfirmationRequestSpec, null, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.glic.mojom.ActorClient_RequestToShowGmailOtpConfirmationDialog_ResponseParamsSpec, 'glic.mojom.ActorClient_RequestToShowGmailOtpConfirmationDialog_ResponseParams', [
      mojo.internal.StructField('arg_result', 0, 0, mojo.internal.bindings.actor.webui.mojom.GmailOtpConfirmationResultSpec, null, false, 0, undefined),
    ],
    [[0, 24]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.glic.mojom.ActorHandler_ResumeActorTask_ParamsSpec, 'glic.mojom.ActorHandler_ResumeActorTask_Params', [
      mojo.internal.StructField('arg_task_id', 0, 0, mojo.internal.Int32, 0, false, 0, undefined),
      mojo.internal.StructField('arg_context_options', 8, 0, mojo.internal.bindings.glic.mojom.TabContextOptionsSpec, null, false, 0, undefined),
    ],
    [[0, 24]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.glic.mojom.ActorHandler_UpdateActorTaskStepProgress_ParamsSpec, 'glic.mojom.ActorHandler_UpdateActorTaskStepProgress_Params', [
      mojo.internal.StructField('arg_task_id', 0, 0, mojo.internal.Int32, 0, false, 0, undefined),
      mojo.internal.StructField('arg_step_progress', 8, 0, mojo.internal.String, null, false, 0, undefined),
    ],
    [[0, 24]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.glic.mojom.ActorHandler_CreateActorTab_ParamsSpec, 'glic.mojom.ActorHandler_CreateActorTab_Params', [
      mojo.internal.StructField('arg_task_id', 0, 0, mojo.internal.Int32, 0, false, 0, undefined),
      mojo.internal.StructField('arg_options', 8, 0, mojo.internal.bindings.glic.mojom.CreateActorTabOptionsSpec, null, false, 0, undefined),
    ],
    [[0, 24]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.glic.mojom.SkillsClient_NotifySkillsEnabledChanged_ParamsSpec, 'glic.mojom.SkillsClient_NotifySkillsEnabledChanged_Params', [
...
mojo.internal.Struct(
    mojo.internal.bindings.glic.mojom.WebClientHandler_RecordSparseValue_ParamsSpec, 'glic.mojom.WebClientHandler_RecordSparseValue_Params', [
...
mojo.internal.Struct(
    mojo.internal.bindings.glic.mojom.WebClientHandler_CreateExperimentalTriggeringClient_ParamsSpec, 'glic.mojom.WebClientHandler_CreateExperimentalTriggeringClient_Params', [
      mojo.internal.StructField('arg_client', 0, 0, mojo.internal.InterfaceProxy(mojo.internal.bindings.glic.mojom.ExperimentalTriggeringClientRemote), null, false, 0, undefined),
    ],
    [[0, 16]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.glic.mojom.WebClientHandler_CreateZeroStateSuggestionsHandler_ParamsSpec, 'glic.mojom.WebClientHandler_CreateZeroStateSuggestionsHandler_Params', [
      mojo.internal.StructField('arg_receiver', 0, 0, mojo.internal.InterfaceRequest(mojo.internal.bindings.glic.mojom.ZeroStateSuggestionsHandlerPendingReceiver), null, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.glic.mojom.WebClientHandler_CreateAiOverlayTools_ParamsSpec, 'glic.mojom.WebClientHandler_CreateAiOverlayTools_Params', [
      mojo.internal.StructField('arg_receiver', 0, 0, mojo.internal.InterfaceRequest(mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayToolsPendingReceiver), null, false, 0, undefined),
    ],
    [[0, 16]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.glic.mojom.WebClientHandler_CreateTab_ParamsSpec, 'glic.mojom.WebClientHandler_CreateTab_Params', [
      ...
      mojo.internal.StructField('arg_create_options', 8, 0, mojo.internal.bindings.glic.mojom.CreateTabOptionsSpec, null, false, 0, undefined),
    ],
    [[0, 24]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.glic.mojom.WebClientHandler_OpenContactInfoSettingsPage_ParamsSpec, 'glic.mojom.WebClientHandler_OpenContactInfoSettingsPage_Params', [
    ],
    [[0, 8]]);

mojo.internal.Struct(
    mojo.internal.bindings.glic.mojom.WebClientHandler_EnableDragResize_ParamsSpec, 'glic.mojom.WebClientHandler_EnableDragResize_Params', [
      mojo.internal.StructField('arg_enabled', 0, 0, mojo.internal.Bool, false, false, 0, undefined),
    ],
    [[0, 16]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.glic.mojom.WebClientHandler_GetContextFromFocusedTab_ParamsSpec, 'glic.mojom.WebClientHandler_GetContextFromFocusedTab_Params', [
      mojo.internal.StructField('arg_options', 0, 0, mojo.internal.bindings.glic.mojom.TabContextOptionsSpec, null, false, 0, undefined),
    ],
    [[0, 16]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.glic.mojom.WebClientHandler_OpenPinnedTabPicker_ParamsSpec, 'glic.mojom.WebClientHandler_OpenPinnedTabPicker_Params', [
      mojo.internal.StructField('arg_options', 0, 0, mojo.internal.bindings.glic.mojom.OpenPinnedTabPickerOptionsSpec, null, true, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.glic.mojom.WebClientHandler_OpenPinnedTabPicker_ResponseParamsSpec, 'glic.mojom.WebClientHandler_OpenPinnedTabPicker_ResponseParams', [
    ],
    [[0, 8]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.glic.mojom.WebClientHandler_OnUserInputSubmitted_ParamsSpec, 'glic.mojom.WebClientHandler_OnUserInputSubmitted_Params', [
      ...
      mojo.internal.StructField('arg_prompt_type', 4, 0, mojo.internal.bindings.glic.mojom.PromptTypeSpec, null, false, 0, undefined),
    ],
    [[0, 16]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.glic.mojom.WebClientHandler_CreateGeminiEnterpriseHandler_ParamsSpec, 'glic.mojom.WebClientHandler_CreateGeminiEnterpriseHandler_Params', [
      mojo.internal.StructField('arg_receiver', 0, 0, mojo.internal.InterfaceRequest(mojo.internal.bindings.glic.mojom.GeminiEnterpriseHandlerPendingReceiver), null, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.glic.mojom.ZeroStateSuggestionsHandler_GetZeroStateSuggestionsAndSubscribe_ParamsSpec, 'glic.mojom.ZeroStateSuggestionsHandler_GetZeroStateSuggestionsAndSubscribe_Params', [
      mojo.internal.StructField('arg_client', 0, 0, mojo.internal.InterfaceProxy(mojo.internal.bindings.glic.mojom.ZeroStateSuggestionsClientRemote), null, true, 0, undefined),
...
mojo.internal.Struct(
    mojo.internal.bindings.glic.mojom.ZeroStateSuggestionsHandler_GetZeroStateSuggestionsAndSubscribe_ResponseParamsSpec, 'glic.mojom.ZeroStateSuggestionsHandler_GetZeroStateSuggestionsAndSubscribe_ResponseParams', [
...
mojo.internal.Struct(
    mojo.internal.bindings.glic.mojom.ZeroStateSuggestionsClient_NotifyZeroStateSuggestionsChanged_ParamsSpec, 'glic.mojom.ZeroStateSuggestionsClient_NotifyZeroStateSuggestionsChanged_Params', [
      mojo.internal.StructField('arg_suggestions', 0, 0, mojo.internal.bindings.glic.mojom.ZeroStateSuggestionsV2Spec, null, false, 0, undefined),
      mojo.internal.StructField('arg_options', 8, 0, mojo.internal.bindings.glic.mojom.ZeroStateSuggestionsOptionsSpec, null, false, 0, undefined),
    ],
    [[0, 24]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.glic.mojom.ExperimentalTriggeringClient_UploadEncryptedScreenshot_ParamsSpec, 'glic.mojom.ExperimentalTriggeringClient_UploadEncryptedScreenshot_Params', [
      mojo.internal.StructField('arg_screenshot', 0, 0, mojo.internal.bindings.glic.mojom.ScreenshotSpec, null, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.glic.mojom.ExperimentalTriggeringClient_UploadEncryptedScreenshot_ResponseParamsSpec, 'glic.mojom.ExperimentalTriggeringClient_UploadEncryptedScreenshot_ResponseParams', [
      mojo.internal.StructField('arg_file_token', 0, 0, mojo.internal.String, null, true, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.glic.mojom.ExperimentalTriggeringClient_GetExperimentalTriggeringUpdates_ParamsSpec, 'glic.mojom.ExperimentalTriggeringClient_GetExperimentalTriggeringUpdates_Params', [
...
mojo.internal.Struct(
    mojo.internal.bindings.glic.mojom.ExperimentalTriggeringClient_GetExperimentalTriggeringUpdates_ResponseParamsSpec, 'glic.mojom.ExperimentalTriggeringClient_GetExperimentalTriggeringUpdates_ResponseParams', [
      mojo.internal.StructField('arg_success', 0, 0, mojo.internal.Bool, false, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.glic.mojom.ExperimentalTriggeringClient_SubmitExperimentalTriggeringConfirmationResponse_ParamsSpec, 'glic.mojom.ExperimentalTriggeringClient_SubmitExperimentalTriggeringConfirmationResponse_Params', [
      mojo.internal.StructField('arg_response', 0, 0, mojo.internal.Array(mojo.internal.Uint8, false), null, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.glic.mojom.ExperimentalTriggeringClient_SubmitExperimentalTriggeringConfirmationResponse_ResponseParamsSpec, 'glic.mojom.ExperimentalTriggeringClient_SubmitExperimentalTriggeringConfirmationResponse_ResponseParams', [
      mojo.internal.StructField('arg_accepted', 0, 0, mojo.internal.Bool, false, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.glic.mojom.WebClient_CheckResponsive_ParamsSpec, 'glic.mojom.WebClient_CheckResponsive_Params', [
    ],
    [[0, 8]]);

mojo.internal.Struct(
    mojo.internal.bindings.glic.mojom.WebClient_CheckResponsive_ResponseParamsSpec, 'glic.mojom.WebClient_CheckResponsive_ResponseParams', [
    ],
    [[0, 8]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.glic.mojom.WebClient_NotifyFileUploadStateChanged_ParamsSpec, 'glic.mojom.WebClient_NotifyFileUploadStateChanged_Params', [
      mojo.internal.StructField('arg_state', 0, 0, mojo.internal.bindings.glic.mojom.FileUploadPolicyStateSpec, null, false, 0, undefined),
    ],
    [[0, 16]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.glic.mojom.WebClient_NotifyZoomLevelChanged_ParamsSpec, 'glic.mojom.WebClient_NotifyZoomLevelChanged_Params', [
