...
mojo.internal.bindings.blink.mojom.PageBroadcast_UpgradePrerenderUntilScriptToFullPrerender_ParamsSpec = mojo.internal.bindings.blink.mojom.PageBroadcast_UpgradePrerenderUntilScriptToFullPrerender_ParamsSpec || { $: {} };
if (mojo.internal.bindings.blink.mojom.PageBroadcast_UpgradePrerenderUntilScriptToFullPrerender_ParamsSpec.$.structSpec && mojo.internal.bindings.blink.mojom.PageBroadcast_UpgradePrerenderUntilScriptToFullPrerender_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.blink.mojom.PageBroadcast_UpgradePrerenderUntilScriptToFullPrerender_ParamsSpec.$ = {};
...
mojo.internal.bindings.blink.mojom.PageBroadcastRemote = class {
  ...
  upgradePrerenderUntilScriptToFullPrerender() {
    return this.$.upgradePrerenderUntilScriptToFullPrerender();
  }
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        ...
        case 3: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.blink.mojom.PageBroadcast_UpgradePrerenderUntilScriptToFullPrerender_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.upgradePrerenderUntilScriptToFullPrerender');
          const result = this.impl.upgradePrerenderUntilScriptToFullPrerender();
          break;
        }
        case 4: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
...
mojo.internal.Struct(
    mojo.internal.bindings.blink.mojom.PageBroadcast_UpgradePrerenderUntilScriptToFullPrerender_ParamsSpec, 'blink.mojom.PageBroadcast_UpgradePrerenderUntilScriptToFullPrerender_Params', [
    ],
    [[0, 8]]);
