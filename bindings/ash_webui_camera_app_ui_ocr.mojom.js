  ...
  $: {
    structSpec: {
      ...
      fields: [
        ...
        { name: 'confidence', packedOffset: 40, packedBitOffset: 0, type: mojo.internal.Float, nullable: false },
      ],
      versions: [{version: 0}]
    }
  }
  ...
  $: {
    structSpec: {
      ...
      fields: [
        ...
        { name: 'bounding_box_angle', packedOffset: 16, packedBitOffset: 0, type: mojo.internal.Float, nullable: false },
        { name: 'direction', packedOffset: 24, packedBitOffset: 0, type: ash.camera_app.mojom.WordDirectionSpec, nullable: false },
      ],
      versions: [{version: 0}]
    }
  }
