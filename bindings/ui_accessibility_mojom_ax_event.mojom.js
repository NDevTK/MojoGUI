  ...
  $: {
    structSpec: {
      ...
      fields: [
        ...
        { name: 'event_from', packedOffset: 8, packedBitOffset: 0, type: ax.mojom.EventFromSpec, nullable: false },
        { name: 'event_from_action', packedOffset: 16, packedBitOffset: 0, type: ax.mojom.ActionSpec, nullable: false },
