...
mojo.internal.bindings.chrome.mojom.GoogleAccountsPrivateApiExtension = {};
mojo.internal.bindings.chrome.mojom.GoogleAccountsPrivateApiExtensionSpec = { $ : {} };
mojo.internal.bindings.chrome.mojom.GoogleAccountsPrivateApiExtension.$interfaceName = 'chrome.mojom.GoogleAccountsPrivateApiExtension';
...
mojo.internal.bindings.chrome.mojom.GoogleAccountsPrivateApiExtensionRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.chrome.mojom.GoogleAccountsPrivateApiExtensionPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.chrome.mojom.GoogleAccountsPrivateApiExtensionRemoteCallHandler(this.proxy);
  }
  ...
  setConsentResult(arg_consent_result) {
    return this.$.setConsentResult(arg_consent_result);
  }
};

mojo.internal.bindings.chrome.mojom.GoogleAccountsPrivateApiExtensionRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('chrome.mojom.GoogleAccountsPrivateApiExtension', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.chrome.mojom.GoogleAccountsPrivateApiExtension.getRemote = function() {
  let remote = new mojo.internal.bindings.chrome.mojom.GoogleAccountsPrivateApiExtensionRemote();
...
mojo.internal.bindings.chrome.mojom.GoogleAccountsPrivateApiExtensionReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('chrome.mojom.GoogleAccountsPrivateApiExtension', [
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.chrome.mojom.GoogleAccountsPrivateApiExtension_SetConsentResult_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for SetConsentResult failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.chrome.mojom.GoogleAccountsPrivateApiExtensionReceiver = mojo.internal.bindings.chrome.mojom.GoogleAccountsPrivateApiExtensionReceiver;
