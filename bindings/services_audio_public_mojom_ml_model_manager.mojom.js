...
mojo.internal.bindings.audio.mojom.MlModelManagerRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.audio.mojom.MlModelManagerPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.audio.mojom.MlModelManagerRemoteCallHandler(this.proxy);
  }
  ...
  setResidualEchoEstimationModel(arg_tflite_file) {
    return this.$.setResidualEchoEstimationModel(arg_tflite_file);
  }
...
mojo.internal.bindings.audio.mojom.MlModelManager.getRemote = function() {
  let remote = new mojo.internal.bindings.audio.mojom.MlModelManagerRemote();
...
mojo.internal.bindings.audio.mojom.MlModelManagerReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.audio.mojom.MlModelManager_SetResidualEchoEstimationModel_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for SetResidualEchoEstimationModel failed with TypeError');
           }
        }
        // Try Method 1: StopServingResidualEchoEstimationModel
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.audio.mojom.MlModelManager_StopServingResidualEchoEstimationModel_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for StopServingResidualEchoEstimationModel failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
      ...
      switch (dispatchId) {
        ...
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.audio.mojom.MlModelManager_StopServingResidualEchoEstimationModel_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.audio.mojom.MlModelManagerReceiver = mojo.internal.bindings.audio.mojom.MlModelManagerReceiver;
