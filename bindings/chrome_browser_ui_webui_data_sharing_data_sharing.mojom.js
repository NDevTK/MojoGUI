...
mojo.internal.bindings.data_sharing.mojom.GroupActionSpec = mojo.internal.bindings.data_sharing.mojom.GroupActionSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.data_sharing.mojom.GroupActionProgressSpec = mojo.internal.bindings.data_sharing.mojom.GroupActionProgressSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.data_sharing.mojom.ReadGroupsParamsSpec = mojo.internal.bindings.data_sharing.mojom.ReadGroupsParamsSpec || { $: {} };
if (mojo.internal.bindings.data_sharing.mojom.ReadGroupsParamsSpec.$.structSpec && mojo.internal.bindings.data_sharing.mojom.ReadGroupsParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.data_sharing.mojom.ReadGroupsParamsSpec.$ = {};
mojo.internal.bindings.data_sharing.mojom.ReadGroupParamsSpec = mojo.internal.bindings.data_sharing.mojom.ReadGroupParamsSpec || { $: {} };
if (mojo.internal.bindings.data_sharing.mojom.ReadGroupParamsSpec.$.structSpec && mojo.internal.bindings.data_sharing.mojom.ReadGroupParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.data_sharing.mojom.ReadGroupParamsSpec.$ = {};
mojo.internal.bindings.data_sharing.mojom.ReadGroupsResultSpec = mojo.internal.bindings.data_sharing.mojom.ReadGroupsResultSpec || { $: {} };
if (mojo.internal.bindings.data_sharing.mojom.ReadGroupsResultSpec.$.structSpec && mojo.internal.bindings.data_sharing.mojom.ReadGroupsResultSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.data_sharing.mojom.ReadGroupsResultSpec.$ = {};
mojo.internal.bindings.data_sharing.mojom.ReadGroupWithTokenParamSpec = mojo.internal.bindings.data_sharing.mojom.ReadGroupWithTokenParamSpec || { $: {} };
if (mojo.internal.bindings.data_sharing.mojom.ReadGroupWithTokenParamSpec.$.structSpec && mojo.internal.bindings.data_sharing.mojom.ReadGroupWithTokenParamSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.data_sharing.mojom.ReadGroupWithTokenParamSpec.$ = {};
mojo.internal.bindings.data_sharing.mojom.ReadGroupWithTokenResultSpec = mojo.internal.bindings.data_sharing.mojom.ReadGroupWithTokenResultSpec || { $: {} };
if (mojo.internal.bindings.data_sharing.mojom.ReadGroupWithTokenResultSpec.$.structSpec && mojo.internal.bindings.data_sharing.mojom.ReadGroupWithTokenResultSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.data_sharing.mojom.ReadGroupWithTokenResultSpec.$ = {};
mojo.internal.bindings.data_sharing.mojom.SharedTabSpec = mojo.internal.bindings.data_sharing.mojom.SharedTabSpec || { $: {} };
if (mojo.internal.bindings.data_sharing.mojom.SharedTabSpec.$.structSpec && mojo.internal.bindings.data_sharing.mojom.SharedTabSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.data_sharing.mojom.SharedTabSpec.$ = {};
mojo.internal.bindings.data_sharing.mojom.GroupPreviewSpec = mojo.internal.bindings.data_sharing.mojom.GroupPreviewSpec || { $: {} };
if (mojo.internal.bindings.data_sharing.mojom.GroupPreviewSpec.$.structSpec && mojo.internal.bindings.data_sharing.mojom.GroupPreviewSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.data_sharing.mojom.GroupPreviewSpec.$ = {};
mojo.internal.bindings.data_sharing.mojom.PageHandlerFactory = mojo.internal.bindings.data_sharing.mojom.PageHandlerFactory || {};
mojo.internal.bindings.data_sharing.mojom.PageHandlerFactorySpec = mojo.internal.bindings.data_sharing.mojom.PageHandlerFactorySpec || { $ : {} };
if (mojo.internal.bindings.data_sharing.mojom.PageHandlerFactorySpec.$.structSpec && mojo.internal.bindings.data_sharing.mojom.PageHandlerFactorySpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.data_sharing.mojom.PageHandlerFactorySpec.$ = {};
mojo.internal.bindings.data_sharing.mojom.PageHandlerFactory.$interfaceName = 'data_sharing.mojom.PageHandlerFactory';
mojo.internal.bindings.data_sharing.mojom.PageHandlerFactory_CreatePageHandler_ParamsSpec = mojo.internal.bindings.data_sharing.mojom.PageHandlerFactory_CreatePageHandler_ParamsSpec || { $: {} };
if (mojo.internal.bindings.data_sharing.mojom.PageHandlerFactory_CreatePageHandler_ParamsSpec.$.structSpec && mojo.internal.bindings.data_sharing.mojom.PageHandlerFactory_CreatePageHandler_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.data_sharing.mojom.PageHandlerFactory_CreatePageHandler_ParamsSpec.$ = {};
mojo.internal.bindings.data_sharing.mojom.PageHandler = mojo.internal.bindings.data_sharing.mojom.PageHandler || {};
mojo.internal.bindings.data_sharing.mojom.PageHandlerSpec = mojo.internal.bindings.data_sharing.mojom.PageHandlerSpec || { $ : {} };
if (mojo.internal.bindings.data_sharing.mojom.PageHandlerSpec.$.structSpec && mojo.internal.bindings.data_sharing.mojom.PageHandlerSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.data_sharing.mojom.PageHandlerSpec.$ = {};
mojo.internal.bindings.data_sharing.mojom.PageHandler.$interfaceName = 'data_sharing.mojom.PageHandler';
mojo.internal.bindings.data_sharing.mojom.PageHandler_ShowUI_ParamsSpec = mojo.internal.bindings.data_sharing.mojom.PageHandler_ShowUI_ParamsSpec || { $: {} };
if (mojo.internal.bindings.data_sharing.mojom.PageHandler_ShowUI_ParamsSpec.$.structSpec && mojo.internal.bindings.data_sharing.mojom.PageHandler_ShowUI_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.data_sharing.mojom.PageHandler_ShowUI_ParamsSpec.$ = {};
mojo.internal.bindings.data_sharing.mojom.PageHandler_CloseUI_ParamsSpec = mojo.internal.bindings.data_sharing.mojom.PageHandler_CloseUI_ParamsSpec || { $: {} };
if (mojo.internal.bindings.data_sharing.mojom.PageHandler_CloseUI_ParamsSpec.$.structSpec && mojo.internal.bindings.data_sharing.mojom.PageHandler_CloseUI_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.data_sharing.mojom.PageHandler_CloseUI_ParamsSpec.$ = {};
mojo.internal.bindings.data_sharing.mojom.PageHandler_ApiInitComplete_ParamsSpec = mojo.internal.bindings.data_sharing.mojom.PageHandler_ApiInitComplete_ParamsSpec || { $: {} };
if (mojo.internal.bindings.data_sharing.mojom.PageHandler_ApiInitComplete_ParamsSpec.$.structSpec && mojo.internal.bindings.data_sharing.mojom.PageHandler_ApiInitComplete_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.data_sharing.mojom.PageHandler_ApiInitComplete_ParamsSpec.$ = {};
mojo.internal.bindings.data_sharing.mojom.PageHandler_MakeTabGroupShared_ParamsSpec = mojo.internal.bindings.data_sharing.mojom.PageHandler_MakeTabGroupShared_ParamsSpec || { $: {} };
if (mojo.internal.bindings.data_sharing.mojom.PageHandler_MakeTabGroupShared_ParamsSpec.$.structSpec && mojo.internal.bindings.data_sharing.mojom.PageHandler_MakeTabGroupShared_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.data_sharing.mojom.PageHandler_MakeTabGroupShared_ParamsSpec.$ = {};
mojo.internal.bindings.data_sharing.mojom.PageHandler_MakeTabGroupShared_ResponseParamsSpec = mojo.internal.bindings.data_sharing.mojom.PageHandler_MakeTabGroupShared_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.data_sharing.mojom.PageHandler_MakeTabGroupShared_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.data_sharing.mojom.PageHandler_MakeTabGroupShared_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.data_sharing.mojom.PageHandler_MakeTabGroupShared_ResponseParamsSpec.$ = {};
mojo.internal.bindings.data_sharing.mojom.PageHandler_GetShareLink_ParamsSpec = mojo.internal.bindings.data_sharing.mojom.PageHandler_GetShareLink_ParamsSpec || { $: {} };
if (mojo.internal.bindings.data_sharing.mojom.PageHandler_GetShareLink_ParamsSpec.$.structSpec && mojo.internal.bindings.data_sharing.mojom.PageHandler_GetShareLink_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.data_sharing.mojom.PageHandler_GetShareLink_ParamsSpec.$ = {};
mojo.internal.bindings.data_sharing.mojom.PageHandler_GetShareLink_ResponseParamsSpec = mojo.internal.bindings.data_sharing.mojom.PageHandler_GetShareLink_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.data_sharing.mojom.PageHandler_GetShareLink_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.data_sharing.mojom.PageHandler_GetShareLink_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.data_sharing.mojom.PageHandler_GetShareLink_ResponseParamsSpec.$ = {};
mojo.internal.bindings.data_sharing.mojom.PageHandler_GetTabGroupPreview_ParamsSpec = mojo.internal.bindings.data_sharing.mojom.PageHandler_GetTabGroupPreview_ParamsSpec || { $: {} };
if (mojo.internal.bindings.data_sharing.mojom.PageHandler_GetTabGroupPreview_ParamsSpec.$.structSpec && mojo.internal.bindings.data_sharing.mojom.PageHandler_GetTabGroupPreview_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.data_sharing.mojom.PageHandler_GetTabGroupPreview_ParamsSpec.$ = {};
mojo.internal.bindings.data_sharing.mojom.PageHandler_GetTabGroupPreview_ResponseParamsSpec = mojo.internal.bindings.data_sharing.mojom.PageHandler_GetTabGroupPreview_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.data_sharing.mojom.PageHandler_GetTabGroupPreview_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.data_sharing.mojom.PageHandler_GetTabGroupPreview_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.data_sharing.mojom.PageHandler_GetTabGroupPreview_ResponseParamsSpec.$ = {};
mojo.internal.bindings.data_sharing.mojom.PageHandler_OpenTabGroup_ParamsSpec = mojo.internal.bindings.data_sharing.mojom.PageHandler_OpenTabGroup_ParamsSpec || { $: {} };
if (mojo.internal.bindings.data_sharing.mojom.PageHandler_OpenTabGroup_ParamsSpec.$.structSpec && mojo.internal.bindings.data_sharing.mojom.PageHandler_OpenTabGroup_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.data_sharing.mojom.PageHandler_OpenTabGroup_ParamsSpec.$ = {};
mojo.internal.bindings.data_sharing.mojom.PageHandler_AboutToUnShareTabGroup_ParamsSpec = mojo.internal.bindings.data_sharing.mojom.PageHandler_AboutToUnShareTabGroup_ParamsSpec || { $: {} };
if (mojo.internal.bindings.data_sharing.mojom.PageHandler_AboutToUnShareTabGroup_ParamsSpec.$.structSpec && mojo.internal.bindings.data_sharing.mojom.PageHandler_AboutToUnShareTabGroup_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.data_sharing.mojom.PageHandler_AboutToUnShareTabGroup_ParamsSpec.$ = {};
mojo.internal.bindings.data_sharing.mojom.PageHandler_OnTabGroupUnShareComplete_ParamsSpec = mojo.internal.bindings.data_sharing.mojom.PageHandler_OnTabGroupUnShareComplete_ParamsSpec || { $: {} };
if (mojo.internal.bindings.data_sharing.mojom.PageHandler_OnTabGroupUnShareComplete_ParamsSpec.$.structSpec && mojo.internal.bindings.data_sharing.mojom.PageHandler_OnTabGroupUnShareComplete_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.data_sharing.mojom.PageHandler_OnTabGroupUnShareComplete_ParamsSpec.$ = {};
mojo.internal.bindings.data_sharing.mojom.PageHandler_OnGroupAction_ParamsSpec = mojo.internal.bindings.data_sharing.mojom.PageHandler_OnGroupAction_ParamsSpec || { $: {} };
if (mojo.internal.bindings.data_sharing.mojom.PageHandler_OnGroupAction_ParamsSpec.$.structSpec && mojo.internal.bindings.data_sharing.mojom.PageHandler_OnGroupAction_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.data_sharing.mojom.PageHandler_OnGroupAction_ParamsSpec.$ = {};
mojo.internal.bindings.data_sharing.mojom.Page = mojo.internal.bindings.data_sharing.mojom.Page || {};
mojo.internal.bindings.data_sharing.mojom.PageSpec = mojo.internal.bindings.data_sharing.mojom.PageSpec || { $ : {} };
if (mojo.internal.bindings.data_sharing.mojom.PageSpec.$.structSpec && mojo.internal.bindings.data_sharing.mojom.PageSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.data_sharing.mojom.PageSpec.$ = {};
mojo.internal.bindings.data_sharing.mojom.Page.$interfaceName = 'data_sharing.mojom.Page';
mojo.internal.bindings.data_sharing.mojom.Page_OnAccessTokenFetched_ParamsSpec = mojo.internal.bindings.data_sharing.mojom.Page_OnAccessTokenFetched_ParamsSpec || { $: {} };
if (mojo.internal.bindings.data_sharing.mojom.Page_OnAccessTokenFetched_ParamsSpec.$.structSpec && mojo.internal.bindings.data_sharing.mojom.Page_OnAccessTokenFetched_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.data_sharing.mojom.Page_OnAccessTokenFetched_ParamsSpec.$ = {};
mojo.internal.bindings.data_sharing.mojom.Page_ReadGroups_ParamsSpec = mojo.internal.bindings.data_sharing.mojom.Page_ReadGroups_ParamsSpec || { $: {} };
if (mojo.internal.bindings.data_sharing.mojom.Page_ReadGroups_ParamsSpec.$.structSpec && mojo.internal.bindings.data_sharing.mojom.Page_ReadGroups_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.data_sharing.mojom.Page_ReadGroups_ParamsSpec.$ = {};
mojo.internal.bindings.data_sharing.mojom.Page_ReadGroups_ResponseParamsSpec = mojo.internal.bindings.data_sharing.mojom.Page_ReadGroups_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.data_sharing.mojom.Page_ReadGroups_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.data_sharing.mojom.Page_ReadGroups_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.data_sharing.mojom.Page_ReadGroups_ResponseParamsSpec.$ = {};
mojo.internal.bindings.data_sharing.mojom.Page_ReadGroupWithToken_ParamsSpec = mojo.internal.bindings.data_sharing.mojom.Page_ReadGroupWithToken_ParamsSpec || { $: {} };
if (mojo.internal.bindings.data_sharing.mojom.Page_ReadGroupWithToken_ParamsSpec.$.structSpec && mojo.internal.bindings.data_sharing.mojom.Page_ReadGroupWithToken_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.data_sharing.mojom.Page_ReadGroupWithToken_ParamsSpec.$ = {};
mojo.internal.bindings.data_sharing.mojom.Page_ReadGroupWithToken_ResponseParamsSpec = mojo.internal.bindings.data_sharing.mojom.Page_ReadGroupWithToken_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.data_sharing.mojom.Page_ReadGroupWithToken_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.data_sharing.mojom.Page_ReadGroupWithToken_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.data_sharing.mojom.Page_ReadGroupWithToken_ResponseParamsSpec.$ = {};
mojo.internal.bindings.data_sharing.mojom.Page_DeleteGroup_ParamsSpec = mojo.internal.bindings.data_sharing.mojom.Page_DeleteGroup_ParamsSpec || { $: {} };
if (mojo.internal.bindings.data_sharing.mojom.Page_DeleteGroup_ParamsSpec.$.structSpec && mojo.internal.bindings.data_sharing.mojom.Page_DeleteGroup_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.data_sharing.mojom.Page_DeleteGroup_ParamsSpec.$ = {};
mojo.internal.bindings.data_sharing.mojom.Page_DeleteGroup_ResponseParamsSpec = mojo.internal.bindings.data_sharing.mojom.Page_DeleteGroup_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.data_sharing.mojom.Page_DeleteGroup_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.data_sharing.mojom.Page_DeleteGroup_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.data_sharing.mojom.Page_DeleteGroup_ResponseParamsSpec.$ = {};
mojo.internal.bindings.data_sharing.mojom.Page_LeaveGroup_ParamsSpec = mojo.internal.bindings.data_sharing.mojom.Page_LeaveGroup_ParamsSpec || { $: {} };
if (mojo.internal.bindings.data_sharing.mojom.Page_LeaveGroup_ParamsSpec.$.structSpec && mojo.internal.bindings.data_sharing.mojom.Page_LeaveGroup_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.data_sharing.mojom.Page_LeaveGroup_ParamsSpec.$ = {};
mojo.internal.bindings.data_sharing.mojom.Page_LeaveGroup_ResponseParamsSpec = mojo.internal.bindings.data_sharing.mojom.Page_LeaveGroup_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.data_sharing.mojom.Page_LeaveGroup_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.data_sharing.mojom.Page_LeaveGroup_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.data_sharing.mojom.Page_LeaveGroup_ResponseParamsSpec.$ = {};
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        ...
        case 5: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              const val = (response && typeof response === 'object' && 'arg_group_preview' in response) ? response['arg_group_preview'] : response;
              const resp_obj = { 'arg_group_preview': val };
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        ...
        case 3: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              const val = (response && typeof response === 'object' && 'arg_status_code' in response) ? response['arg_status_code'] : response;
              const resp_obj = { 'arg_status_code': val };
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
...
mojo.internal.Struct(
    mojo.internal.bindings.data_sharing.mojom.PageHandlerFactory_CreatePageHandler_ParamsSpec, 'data_sharing.mojom.PageHandlerFactory_CreatePageHandler_Params', [
      ...
      mojo.internal.StructField('arg_handler', 8, 0, mojo.internal.InterfaceRequest(mojo.internal.bindings.data_sharing.mojom.PageHandlerPendingReceiver), null, false, 0, undefined),
    ],
    [[0, 24]]);
