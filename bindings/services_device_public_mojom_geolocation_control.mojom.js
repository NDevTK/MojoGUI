...
mojo.internal.bindings.device.mojom.GeolocationControl = {};
mojo.internal.bindings.device.mojom.GeolocationControlSpec = { $ : {} };
mojo.internal.bindings.device.mojom.GeolocationControl.$interfaceName = 'device.mojom.GeolocationControl';
...
mojo.internal.bindings.device.mojom.GeolocationControlRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.device.mojom.GeolocationControlPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.device.mojom.GeolocationControlRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.device.mojom.GeolocationControlRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('device.mojom.GeolocationControl', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.device.mojom.GeolocationControl.getRemote = function() {
  let remote = new mojo.internal.bindings.device.mojom.GeolocationControlRemote();
...
mojo.internal.bindings.device.mojom.GeolocationControlReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('device.mojom.GeolocationControl', [
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.device.mojom.GeolocationControl_UserDidOptIntoLocationServices_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for UserDidOptIntoLocationServices failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.device.mojom.GeolocationControl_UserDidOptIntoLocationServices_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.device.mojom.GeolocationControlReceiver = mojo.internal.bindings.device.mojom.GeolocationControlReceiver;
