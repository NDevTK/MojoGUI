...
mojo.internal.bindings.network.mojom.RequestDestination = {
  kEmpty: 0,
  kAudio: 1,
  kAudioWorklet: 2,
  kDocument: 3,
...
// Enum: RedirectMode
mojo.internal.bindings.network.mojom.RedirectMode = {
  kFollow: 0,
  kError: 1,
  kManual: 2,
};
...
mojo.internal.bindings.network.mojom.CredentialsMode = {
  kOmit: 0,
  kSameOrigin: 1,
  kInclude: 2,
...
mojo.internal.bindings.network.mojom.FetchResponseType = {
  kBasic: 0,
  kCors: 1,
  kDefault: 2,
  kError: 3,
...
mojo.internal.bindings.network.mojom.FetchResponseSource = {
  kUnspecified: 0,
  kNetwork: 1,
  kHttpCache: 2,
  kCacheStorage: 3,
