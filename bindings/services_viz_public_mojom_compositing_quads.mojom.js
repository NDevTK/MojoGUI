...
mojo.internal.Struct(
    viz.mojom.CompositorRenderPassQuadStateSpec, 'viz.mojom.CompositorRenderPassQuadState', [
      ...
      mojo.internal.StructField('force_anti_aliasing_off', 56, 0, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('backdrop_filter_quality', 60, 0, mojo.internal.Float, 0, false, 0, undefined),
      mojo.internal.StructField('intersects_damage_under', 64, 0, mojo.internal.Bool, false, false, 0, undefined),
    ],
    [[0, 80]]);
...
mojo.internal.Struct(
    viz.mojom.SurfaceQuadStateSpec, 'viz.mojom.SurfaceQuadState', [
      ...
      mojo.internal.StructField('is_reflection', 16, 1, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('allow_merge', 16, 2, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('override_child_filter_quality', 24, 0, cc.mojom.FilterQualitySpec.$, null, true, 0, undefined),
      mojo.internal.StructField('override_child_dynamic_range_limit', 32, 0, cc.mojom.DynamicRangeLimitSpec.$, null, true, 0, undefined),
    ],
    [[0, 48]]);
...
mojo.internal.Struct(
    viz.mojom.TextureQuadStateSpec, 'viz.mojom.TextureQuadState', [
      ...
      mojo.internal.StructField('nearest_neighbor', 32, 0, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('secure_output_only', 32, 1, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('is_video_frame', 32, 2, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('force_rgbx', 32, 3, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('is_normalized_coords', 32, 4, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('protected_video_type', 40, 0, viz.mojom.ProtectedVideoStateSpec.$, null, false, 0, undefined),
      mojo.internal.StructField('damage_rect', 48, 0, gfx.mojom.RectSpec.$, null, true, 0, undefined),
      mojo.internal.StructField('overlay_priority_hint', 56, 0, viz.mojom.OverlayPrioritySpec.$, null, false, 0, undefined),
      mojo.internal.StructField('rounded_display_masks_info', 64, 0, viz.mojom.RoundedDisplayMasksInfoSpec.$, null, false, 0, undefined),
    ],
    [[0, 80]]);
...
mojo.internal.Struct(
    viz.mojom.DrawQuadSpec, 'viz.mojom.DrawQuad', [
      ...
      mojo.internal.StructField('needs_blending', 16, 0, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('sqs', 24, 0, viz.mojom.SharedQuadStateSpec.$, null, true, 0, undefined),
      mojo.internal.StructField('draw_quad_state', 32, 0, viz.mojom.DrawQuadStateSpec.$, null, false, 0, undefined),
    ],
    [[0, 48]]);
