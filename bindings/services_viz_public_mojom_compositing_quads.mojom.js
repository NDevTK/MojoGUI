...
mojo.internal.Union(
    mojo.internal.bindings.viz.mojom.DrawQuadStateSpec, 'viz.mojom.DrawQuadState', {
      'arg_debug_border_quad_state': {
        'ordinal': 0,
        'type': mojo.internal.bindings.mojo.internal.bindings.viz.mojom.DebugBorderQuadStateSpec.$,
        'nullable': false,
      },
      'arg_render_pass_quad_state': {
        'ordinal': 1,
        'type': mojo.internal.bindings.mojo.internal.bindings.viz.mojom.CompositorRenderPassQuadStateSpec.$,
        'nullable': false,
      },
      'arg_solid_color_quad_state': {
        'ordinal': 2,
        'type': mojo.internal.bindings.mojo.internal.bindings.viz.mojom.SolidColorQuadStateSpec.$,
        'nullable': false,
      },
      'arg_surface_quad_state': {
        'ordinal': 3,
        'type': mojo.internal.bindings.mojo.internal.bindings.viz.mojom.SurfaceQuadStateSpec.$,
        'nullable': false,
      },
      'arg_texture_quad_state': {
        'ordinal': 4,
        'type': mojo.internal.bindings.mojo.internal.bindings.viz.mojom.TextureQuadStateSpec.$,
        'nullable': false,
      },
      'arg_tile_quad_state': {
        'ordinal': 5,
        'type': mojo.internal.bindings.mojo.internal.bindings.viz.mojom.TileQuadStateSpec.$,
        'nullable': false,
      },
      'arg_video_hole_quad_state': {
        'ordinal': 6,
        'type': mojo.internal.bindings.mojo.internal.bindings.viz.mojom.VideoHoleQuadStateSpec.$,
        'nullable': false,
      },
      'arg_shared_element_quad_state': {
        'ordinal': 7,
        'type': mojo.internal.bindings.mojo.internal.bindings.viz.mojom.SharedElementQuadStateSpec.$,
        'nullable': false,
      },
    });
...
mojo.internal.Struct(
    mojo.internal.bindings.viz.mojom.TextureQuadStateSpec, 'viz.mojom.TextureQuadState', [
      ...
      mojo.internal.StructField('arg_protected_video_type', 32, 0, mojo.internal.bindings.mojo.internal.bindings.viz.mojom.ProtectedVideoStateSpec.$, null, false, 0, undefined),
      mojo.internal.StructField('arg_damage_rect', 40, 0, mojo.internal.bindings.gfx.mojom.RectSpec.$, null, true, 0, undefined),
      mojo.internal.StructField('arg_overlay_priority_hint', 48, 0, mojo.internal.bindings.mojo.internal.bindings.viz.mojom.OverlayPrioritySpec.$, null, false, 0, undefined),
      mojo.internal.StructField('arg_rounded_display_masks_info', 56, 0, mojo.internal.bindings.mojo.internal.bindings.viz.mojom.RoundedDisplayMasksInfoSpec.$, null, false, 0, undefined),
