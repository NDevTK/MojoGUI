...
mojo.internal.Struct(
    mojo.internal.bindings.sharing.mojom.LocationHintSpec, 'sharing.mojom.LocationHint', [
      ...
      mojo.internal.StructField('arg_format', 8, 0, mojo.internal.bindings.mojo.internal.bindings.sharing.mojom.LocationStandardFormatSpec.$, null, false, 0, undefined),
    ],
    [[0, 24]]);
...
mojo.internal.bindings.sharing.mojom.IncomingMessagesListenerRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.sharing.mojom.IncomingMessagesListenerRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.sharing.mojom.IncomingMessagesListener.getRemote = function() {
  let remote = new mojo.internal.bindings.sharing.mojom.IncomingMessagesListenerRemote();
...
mojo.internal.bindings.sharing.mojom.IncomingMessagesListenerReceiver = mojo.internal.bindings.sharing.mojom.IncomingMessagesListenerReceiver;

mojo.internal.bindings.sharing.mojom.IncomingMessagesListenerPtr = mojo.internal.bindings.sharing.mojom.IncomingMessagesListenerRemote;
mojo.internal.bindings.sharing.mojom.IncomingMessagesListenerRequest = mojo.internal.bindings.sharing.mojom.IncomingMessagesListenerPendingReceiver;
...
mojo.internal.bindings.sharing.mojom.ReceiveMessagesSessionRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.sharing.mojom.ReceiveMessagesSessionRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.sharing.mojom.ReceiveMessagesSession.getRemote = function() {
  let remote = new mojo.internal.bindings.sharing.mojom.ReceiveMessagesSessionRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.sharing.mojom.ReceiveMessagesSession_StopReceivingMessages_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.sharing.mojom.ReceiveMessagesSessionReceiver = mojo.internal.bindings.sharing.mojom.ReceiveMessagesSessionReceiver;

mojo.internal.bindings.sharing.mojom.ReceiveMessagesSessionPtr = mojo.internal.bindings.sharing.mojom.ReceiveMessagesSessionRemote;
mojo.internal.bindings.sharing.mojom.ReceiveMessagesSessionRequest = mojo.internal.bindings.sharing.mojom.ReceiveMessagesSessionPendingReceiver;
...
mojo.internal.Struct(
    mojo.internal.bindings.sharing.mojom.WebRtcSignalingMessenger_SendMessage_ParamsSpec, 'sharing.mojom.WebRtcSignalingMessenger_SendMessage_Params', [
      ...
      mojo.internal.StructField('arg_location_hint', 16, 0, mojo.internal.bindings.mojo.internal.bindings.sharing.mojom.LocationHintSpec.$, null, false, 0, undefined),
...
mojo.internal.Struct(
    mojo.internal.bindings.sharing.mojom.WebRtcSignalingMessenger_StartReceivingMessages_ParamsSpec, 'sharing.mojom.WebRtcSignalingMessenger_StartReceivingMessages_Params', [
      mojo.internal.StructField('arg_self_id', 0, 0, mojo.internal.String, null, false, 0, undefined),
      mojo.internal.StructField('arg_location_hint', 8, 0, mojo.internal.bindings.mojo.internal.bindings.sharing.mojom.LocationHintSpec.$, null, false, 0, undefined),
...
mojo.internal.bindings.sharing.mojom.WebRtcSignalingMessengerRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.sharing.mojom.WebRtcSignalingMessengerRemoteCallHandler(this.proxy);
  }
  ...
  sendMessage(arg_self_id, arg_peer_id, arg_location_hint, arg_message) {
    return this.$.sendMessage(arg_self_id, arg_peer_id, arg_location_hint, arg_message);
  }
  startReceivingMessages(arg_self_id, arg_location_hint, arg_listener) {
    return this.$.startReceivingMessages(arg_self_id, arg_location_hint, arg_listener);
  }
};
...
mojo.internal.bindings.sharing.mojom.WebRtcSignalingMessenger.getRemote = function() {
  let remote = new mojo.internal.bindings.sharing.mojom.WebRtcSignalingMessengerRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
      ...
      switch (dispatchId) {
        case 0: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.sharing.mojom.WebRtcSignalingMessenger_SendMessage_ResponseParamsSpec, header, rawHeader);
               responder(response);
        ...
        case 1: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              const rawHeader = (args[2] && args[2].slice) ? args[2].slice(0, header.headerSize) : null;
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.sharing.mojom.WebRtcSignalingMessenger_StartReceivingMessages_ResponseParamsSpec, header, rawHeader);
               responder(response);
...
mojo.internal.bindings.sharing.mojom.WebRtcSignalingMessengerReceiver = mojo.internal.bindings.sharing.mojom.WebRtcSignalingMessengerReceiver;
