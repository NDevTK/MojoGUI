// Auto-generated MojoJS binding
 ...
 mojo.internal.bindings.private_state_tokens = mojo.internal.bindings.private_state_tokens || {};
mojo.internal.bindings.private_state_tokens.mojom = mojo.internal.bindings.private_state_tokens.mojom || {};

mojo.internal.bindings.private_state_tokens.mojom.IssuerTokenCountSpec = { $: {} };
mojo.internal.bindings.private_state_tokens.mojom.PrivateStateTokensPageHandler = {};
mojo.internal.bindings.private_state_tokens.mojom.PrivateStateTokensPageHandlerSpec = { $ : {} };
mojo.internal.bindings.private_state_tokens.mojom.PrivateStateTokensPageHandler.$interfaceName = 'private_state_tokens.mojom.PrivateStateTokensPageHandler';
...
mojo.internal.bindings.private_state_tokens.mojom.PrivateStateTokensPageHandlerRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.private_state_tokens.mojom.PrivateStateTokensPageHandlerPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.private_state_tokens.mojom.PrivateStateTokensPageHandlerRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.private_state_tokens.mojom.PrivateStateTokensPageHandlerRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('private_state_tokens.mojom.PrivateStateTokensPageHandler', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.private_state_tokens.mojom.PrivateStateTokensPageHandler.getRemote = function() {
  let remote = new mojo.internal.bindings.private_state_tokens.mojom.PrivateStateTokensPageHandlerRemote();
...
mojo.internal.bindings.private_state_tokens.mojom.PrivateStateTokensPageHandlerReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('private_state_tokens.mojom.PrivateStateTokensPageHandler', [
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.private_state_tokens.mojom.PrivateStateTokensPageHandler_GetIssuerTokenCounts_ParamsSpec.$.structSpec);
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.private_state_tokens.mojom.PrivateStateTokensPageHandler_GetIssuerTokenCounts_ParamsSpec.$.structSpec);
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.private_state_tokens.mojom.PrivateStateTokensPageHandler_GetIssuerTokenCounts_ResponseParamsSpec, header, rawHeader);
               responder(response);
...
mojo.internal.bindings.private_state_tokens.mojom.PrivateStateTokensPageHandlerReceiver = mojo.internal.bindings.private_state_tokens.mojom.PrivateStateTokensPageHandlerReceiver;
