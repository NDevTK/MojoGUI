...
mojo.internal.bindings.filesystem.mojom.kFlagOpen = 0x1;

mojo.internal.bindings.filesystem.mojom.kFlagCreate = 0x2;

mojo.internal.bindings.filesystem.mojom.kFlagOpenAlways = 0x4;

mojo.internal.bindings.filesystem.mojom.kCreateAlways = 0x8;

mojo.internal.bindings.filesystem.mojom.kFlagOpenTruncated = 0x10;

mojo.internal.bindings.filesystem.mojom.kFlagRead = 0x20;

mojo.internal.bindings.filesystem.mojom.kFlagWrite = 0x40;

mojo.internal.bindings.filesystem.mojom.kFlagAppend = 0x80;

mojo.internal.bindings.filesystem.mojom.kDeleteOnClose = 0x2000;

mojo.internal.bindings.filesystem.mojom.kFlagWriteAttributes = 0x4000;

mojo.internal.bindings.filesystem.mojom.kDeleteFlagRecursive = 0x1;

// Enum: Whence
mojo.internal.bindings.filesystem.mojom.Whence = {
  FROM_BEGIN: 0,
  FROM_CURRENT: 1,
  FROM_END: 2,
};
...
// Enum: FsFileType
mojo.internal.bindings.filesystem.mojom.FsFileType = {
  UNKNOWN: 0,
  REGULAR_FILE: 1,
  DIRECTORY: 2,
};
...
mojo.internal.Struct(
    mojo.internal.bindings.filesystem.mojom.TimespecOrNowSpec, 'filesystem.mojom.TimespecOrNow', [
      mojo.internal.StructField('arg_seconds', 0, 0, mojo.internal.Double, 0, false, 0, undefined),
      mojo.internal.StructField('arg_now', 8, 0, mojo.internal.Bool, false, false, 0, undefined),
    ],
    [[0, 24]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.filesystem.mojom.FileInformationSpec, 'filesystem.mojom.FileInformation', [
      ...
      mojo.internal.StructField('arg_atime', 8, 0, mojo.internal.Double, 0, false, 0, undefined),
      mojo.internal.StructField('arg_mtime', 16, 0, mojo.internal.Double, 0, false, 0, undefined),
      mojo.internal.StructField('arg_ctime', 24, 0, mojo.internal.Double, 0, false, 0, undefined),
      mojo.internal.StructField('arg_type', 32, 0, mojo.internal.bindings.filesystem.mojom.FsFileTypeSpec, null, false, 0, undefined),
    ],
    [[0, 48]]);
