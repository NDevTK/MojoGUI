...
mojo.internal.bindings.chromeos.cfm.mojom.kServiceUnavailableMessage = "Hotline Disabled";

mojo.internal.bindings.chromeos.cfm.mojom.kFinchDisabledCode = 2;

mojo.internal.bindings.chromeos.cfm.mojom.kFinchDisabledMessage = "Finch Disabled";
...
mojo.internal.bindings.chromeos.cfm.mojom.DisconnectReasonRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.chromeos.cfm.mojom.DisconnectReasonRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.chromeos.cfm.mojom.DisconnectReason.getRemote = function() {
  let remote = new mojo.internal.bindings.chromeos.cfm.mojom.DisconnectReasonRemote();
...
mojo.internal.bindings.chromeos.cfm.mojom.DisconnectReasonReceiver = mojo.internal.bindings.chromeos.cfm.mojom.DisconnectReasonReceiver;

mojo.internal.bindings.chromeos.cfm.mojom.DisconnectReasonPtr = mojo.internal.bindings.chromeos.cfm.mojom.DisconnectReasonRemote;
mojo.internal.bindings.chromeos.cfm.mojom.DisconnectReasonRequest = mojo.internal.bindings.chromeos.cfm.mojom.DisconnectReasonPendingReceiver;
...
mojo.internal.bindings.chromeos.cfm.mojom.CfmServiceContextRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.chromeos.cfm.mojom.CfmServiceContextRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.chromeos.cfm.mojom.CfmServiceContext.getRemote = function() {
  let remote = new mojo.internal.bindings.chromeos.cfm.mojom.CfmServiceContextRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.chromeos.cfm.mojom.CfmServiceContext_ProvideAdaptor_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for ProvideAdaptor failed with TypeError');
           }
        }
        // Try Method 1: RequestBindService
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.chromeos.cfm.mojom.CfmServiceContext_RequestBindService_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for RequestBindService failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
             console.warn('[GeneratedReceiver] Failed to discover ordinal ' + header.ordinal);
...
mojo.internal.bindings.chromeos.cfm.mojom.CfmServiceContextReceiver = mojo.internal.bindings.chromeos.cfm.mojom.CfmServiceContextReceiver;

mojo.internal.bindings.chromeos.cfm.mojom.CfmServiceContextPtr = mojo.internal.bindings.chromeos.cfm.mojom.CfmServiceContextRemote;
mojo.internal.bindings.chromeos.cfm.mojom.CfmServiceContextRequest = mojo.internal.bindings.chromeos.cfm.mojom.CfmServiceContextPendingReceiver;
...
mojo.internal.bindings.chromeos.cfm.mojom.CfmServiceAdaptorRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.chromeos.cfm.mojom.CfmServiceAdaptorRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.chromeos.cfm.mojom.CfmServiceAdaptor.getRemote = function() {
  let remote = new mojo.internal.bindings.chromeos.cfm.mojom.CfmServiceAdaptorRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.chromeos.cfm.mojom.CfmServiceAdaptor_OnBindService_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OnBindService failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
             console.warn('[GeneratedReceiver] Failed to discover ordinal ' + header.ordinal);
...
mojo.internal.bindings.chromeos.cfm.mojom.CfmServiceAdaptorReceiver = mojo.internal.bindings.chromeos.cfm.mojom.CfmServiceAdaptorReceiver;
