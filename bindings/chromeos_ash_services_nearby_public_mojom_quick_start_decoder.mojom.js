  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        try {
             decoder.decodeStruct(ash.quick_start.mojom.QuickStartDecoder_DecodeQuickStartMessage_ParamsSpec.$, message.header.headerSize);
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStruct(ash.quick_start.mojom.QuickStartDecoder_DecodeQuickStartMessage_ParamsSpec.$, message.header.headerSize);
