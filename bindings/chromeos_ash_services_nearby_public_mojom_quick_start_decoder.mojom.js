...
mojo.internal.bindings.ash.quick_start.mojom.QuickStartDecoder = {};
mojo.internal.bindings.ash.quick_start.mojom.QuickStartDecoderSpec = { $ : {} };
mojo.internal.bindings.ash.quick_start.mojom.QuickStartDecoder.$interfaceName = 'ash.quick_start.mojom.QuickStartDecoder';
...
mojo.internal.bindings.ash.quick_start.mojom.QuickStartDecoderRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.ash.quick_start.mojom.QuickStartDecoderPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.ash.quick_start.mojom.QuickStartDecoderRemoteCallHandler(this.proxy);
  }
  ...
  decodeQuickStartMessage(arg_data) {
    return this.$.decodeQuickStartMessage(arg_data);
  }
};

mojo.internal.bindings.ash.quick_start.mojom.QuickStartDecoderRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('ash.quick_start.mojom.QuickStartDecoder', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.ash.quick_start.mojom.QuickStartDecoder.getRemote = function() {
  let remote = new mojo.internal.bindings.ash.quick_start.mojom.QuickStartDecoderRemote();
...
mojo.internal.bindings.ash.quick_start.mojom.QuickStartDecoderReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('ash.quick_start.mojom.QuickStartDecoder', [
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        // Try Method 0: DecodeQuickStartMessage
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.ash.quick_start.mojom.QuickStartDecoder_DecodeQuickStartMessage_ParamsSpec.$.structSpec);
             console.log('[GeneratedReceiver] Discovery SUCCESS: ' + header.ordinal + ' -> DecodeQuickStartMessage (0)');
        ...
        case 0: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.ash.quick_start.mojom.QuickStartDecoder_DecodeQuickStartMessage_ResponseParamsSpec, header, rawHeader);
               responder(response);
...
mojo.internal.bindings.ash.quick_start.mojom.QuickStartDecoderReceiver = mojo.internal.bindings.ash.quick_start.mojom.QuickStartDecoderReceiver;
