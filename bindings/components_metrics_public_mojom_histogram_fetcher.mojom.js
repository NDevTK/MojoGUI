...
mojo.internal.bindings.metrics.mojom.ChildHistogramFetcherFactoryRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.metrics.mojom.ChildHistogramFetcherFactoryRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.metrics.mojom.ChildHistogramFetcherFactory.getRemote = function() {
  let remote = new mojo.internal.bindings.metrics.mojom.ChildHistogramFetcherFactoryRemote();
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.metrics.mojom.ChildHistogramFetcherFactory_CreateFetcher_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for CreateFetcher failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.metrics.mojom.ChildHistogramFetcherFactoryReceiver = mojo.internal.bindings.metrics.mojom.ChildHistogramFetcherFactoryReceiver;

mojo.internal.bindings.metrics.mojom.ChildHistogramFetcherFactoryPtr = mojo.internal.bindings.metrics.mojom.ChildHistogramFetcherFactoryRemote;
mojo.internal.bindings.metrics.mojom.ChildHistogramFetcherFactoryRequest = mojo.internal.bindings.metrics.mojom.ChildHistogramFetcherFactoryPendingReceiver;
...
mojo.internal.bindings.metrics.mojom.ChildHistogramFetcherRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.metrics.mojom.ChildHistogramFetcherRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.metrics.mojom.ChildHistogramFetcher.getRemote = function() {
  let remote = new mojo.internal.bindings.metrics.mojom.ChildHistogramFetcherRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.metrics.mojom.ChildHistogramFetcher_GetChildNonPersistentHistogramData_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for GetChildNonPersistentHistogramData failed with TypeError');
           }
        }
        // Try Method 1: Ping
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.metrics.mojom.ChildHistogramFetcher_Ping_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.metrics.mojom.ChildHistogramFetcher_GetChildNonPersistentHistogramData_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.metrics.mojom.ChildHistogramFetcherReceiver = mojo.internal.bindings.metrics.mojom.ChildHistogramFetcherReceiver;
