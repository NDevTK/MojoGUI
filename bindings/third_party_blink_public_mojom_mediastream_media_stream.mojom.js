...
mojo.internal.Struct(
    mojo.internal.bindings.blink.mojom.MediaStreamDeviceSpec, 'blink.mojom.MediaStreamDevice', [
      ...
      mojo.internal.StructField('arg_group_id', 16, 0, mojo.internal.String, null, true, 0, undefined),
      mojo.internal.StructField('arg_matched_output_device_id', 24, 0, mojo.internal.String, null, true, 0, undefined),
      mojo.internal.StructField('arg_name', 32, 0, mojo.internal.String, null, false, 0, undefined),
      mojo.internal.StructField('arg_input', 40, 0, mojo.internal.bindings.media.mojom.AudioParametersSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_session_id', 48, 0, mojo.internal.bindings.mojo_base.mojom.UnguessableTokenSpec, null, true, 0, undefined),
      mojo.internal.StructField('arg_display_media_info', 56, 0, mojo.internal.bindings.media.mojom.DisplayMediaInformationSpec, null, true, 0, undefined),
      mojo.internal.StructField('arg_type', 64, 0, mojo.internal.bindings.blink.mojom.MediaStreamTypeSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_video_facing', 68, 0, mojo.internal.bindings.media.mojom.VideoFacingModeSpec, null, false, 0, undefined),
    ],
    [[0, 80]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.blink.mojom.TrackControlsSpec, 'blink.mojom.TrackControls', [
      mojo.internal.StructField('arg_device_ids', 0, 0, mojo.internal.Array(mojo.internal.String, false), null, false, 0, undefined),
      mojo.internal.StructField('arg_stream_type', 8, 0, mojo.internal.bindings.blink.mojom.MediaStreamTypeSpec, null, false, 0, undefined),
    ],
    [[0, 24]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.blink.mojom.StreamControlsSpec, 'blink.mojom.StreamControls', [
      ...
      mojo.internal.StructField('arg_preferred_display_surface', 20, 0, mojo.internal.bindings.blink.mojom.PreferredDisplaySurfaceSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_hotword_enabled', 24, 0, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_disable_local_echo', 24, 1, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_suppress_local_audio_playback', 24, 2, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_restrict_own_audio', 24, 3, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_exclude_system_audio', 24, 4, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_exclude_self_browser_surface', 24, 5, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_request_pan_tilt_zoom_permission', 24, 6, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_request_all_screens', 24, 7, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_dynamic_surface_switching_requested', 25, 0, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_exclude_monitor_type_surfaces', 25, 1, mojo.internal.Bool, false, false, 0, undefined),
    ],
    [[0, 40]]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.blink.mojom.MediaStreamDeviceObserver_OnDeviceStopped_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OnDeviceStopped failed with TypeError');
           }
        }
        // Try Method 1: OnDeviceChanged
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.blink.mojom.MediaStreamDeviceObserver_OnDeviceChanged_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.blink.mojom.MediaStreamDeviceObserver_OnDeviceRequestStateChange_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OnDeviceRequestStateChange failed with TypeError');
           }
        }
        // Try Method 3: OnDeviceCaptureConfigurationChange
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.blink.mojom.MediaStreamDeviceObserver_OnDeviceCaptureConfigurationChange_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OnDeviceCaptureConfigurationChange failed with TypeError');
           }
        }
        // Try Method 4: OnDeviceCaptureHandleChange
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.blink.mojom.MediaStreamDeviceObserver_OnDeviceCaptureHandleChange_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OnDeviceCaptureHandleChange failed with TypeError');
           }
        }
        // Try Method 5: OnZoomLevelChange
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.blink.mojom.MediaStreamDeviceObserver_OnZoomLevelChange_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OnZoomLevelChange failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.Struct(
    mojo.internal.bindings.blink.mojom.MediaStreamDispatcherHost_GenerateStreams_ParamsSpec, 'blink.mojom.MediaStreamDispatcherHost_GenerateStreams_Params', [
      mojo.internal.StructField('arg_audio_stream_selection_info', 0, 0, mojo.internal.bindings.blink.mojom.StreamSelectionInfoSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_controls', 16, 0, mojo.internal.bindings.blink.mojom.StreamControlsSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_request_id', 24, 0, mojo.internal.Int32, 0, false, 0, undefined),
      mojo.internal.StructField('arg_user_gesture', 28, 0, mojo.internal.Bool, false, false, 0, undefined),
    ],
    [[0, 40]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.blink.mojom.MediaStreamDispatcherHost_GenerateStreams_ResponseParamsSpec, 'blink.mojom.MediaStreamDispatcherHost_GenerateStreams_ResponseParams', [
      mojo.internal.StructField('arg_label', 0, 0, mojo.internal.String, null, false, 0, undefined),
      mojo.internal.StructField('arg_stream_devices', 8, 0, mojo.internal.bindings.blink.mojom.StreamDevicesSetSpec, null, true, 0, undefined),
      mojo.internal.StructField('arg_result', 16, 0, mojo.internal.bindings.blink.mojom.MediaStreamRequestResultSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_pan_tilt_zoom_allowed', 20, 0, mojo.internal.Bool, false, false, 0, undefined),
    ],
    [[0, 32]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.blink.mojom.MediaStreamDispatcherHost_OpenDevice_ParamsSpec, 'blink.mojom.MediaStreamDispatcherHost_OpenDevice_Params', [
      ...
      mojo.internal.StructField('arg_type', 12, 0, mojo.internal.bindings.blink.mojom.MediaStreamTypeSpec, null, false, 0, undefined),
    ],
    [[0, 24]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.blink.mojom.MediaStreamDispatcherHost_ApplySubCaptureTarget_ParamsSpec, 'blink.mojom.MediaStreamDispatcherHost_ApplySubCaptureTarget_Params', [
      ...
      mojo.internal.StructField('arg_sub_capture_target', 8, 0, mojo.internal.bindings.mojo_base.mojom.TokenSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_type', 16, 0, mojo.internal.bindings.media.mojom.SubCaptureTargetTypeSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_sub_capture_target_version', 20, 0, mojo.internal.Uint32, 0, false, 0, undefined),
    ],
    [[0, 32]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.blink.mojom.MediaStreamDispatcherHost_GetOpenDevice_ResponseParamsSpec, 'blink.mojom.MediaStreamDispatcherHost_GetOpenDevice_ResponseParams', [
      mojo.internal.StructField('arg_response', 0, 0, mojo.internal.bindings.blink.mojom.GetOpenDeviceResponseSpec, null, true, 0, undefined),
      mojo.internal.StructField('arg_result', 8, 0, mojo.internal.bindings.blink.mojom.MediaStreamRequestResultSpec, null, false, 0, undefined),
    ],
    [[0, 24]]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.blink.mojom.MediaStreamDispatcherHost_GenerateStreams_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for GenerateStreams failed with TypeError');
           }
        }
        // Try Method 1: FocusCapturedSurface
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.blink.mojom.MediaStreamDispatcherHost_FocusCapturedSurface_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for FocusCapturedSurface failed with TypeError');
           }
        }
        // Try Method 2: CancelRequest
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.blink.mojom.MediaStreamDispatcherHost_CancelRequest_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for CancelRequest failed with TypeError');
           }
        }
        // Try Method 3: StopStreamDevice
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.blink.mojom.MediaStreamDispatcherHost_StopStreamDevice_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for StopStreamDevice failed with TypeError');
           }
        }
        // Try Method 4: OpenDevice
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.blink.mojom.MediaStreamDispatcherHost_OpenDevice_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.blink.mojom.MediaStreamDispatcherHost_CloseDevice_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for CloseDevice failed with TypeError');
           }
        }
        // Try Method 6: SetCapturingLinkSecured
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.blink.mojom.MediaStreamDispatcherHost_SetCapturingLinkSecured_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for SetCapturingLinkSecured failed with TypeError');
           }
        }
        // Try Method 7: ApplySubCaptureTarget
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.blink.mojom.MediaStreamDispatcherHost_ApplySubCaptureTarget_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for ApplySubCaptureTarget failed with TypeError');
           }
        }
        // Try Method 8: SendWheel
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.blink.mojom.MediaStreamDispatcherHost_SendWheel_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for SendWheel failed with TypeError');
           }
        }
        // Try Method 9: UpdateZoomLevel
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.blink.mojom.MediaStreamDispatcherHost_UpdateZoomLevel_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for UpdateZoomLevel failed with TypeError');
           }
        }
        // Try Method 10: RequestCapturedSurfaceControlPermission
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.blink.mojom.MediaStreamDispatcherHost_RequestCapturedSurfaceControlPermission_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for RequestCapturedSurfaceControlPermission failed with TypeError');
           }
        }
        // Try Method 11: GetOpenDevice
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.blink.mojom.MediaStreamDispatcherHost_GetOpenDevice_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for GetOpenDevice failed with TypeError');
           }
        }
        // Try Method 12: KeepDeviceAliveForTransfer
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.blink.mojom.MediaStreamDispatcherHost_KeepDeviceAliveForTransfer_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for KeepDeviceAliveForTransfer failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
             console.warn('[GeneratedReceiver] Failed to discover ordinal ' + header.ordinal);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.blink.mojom.MediaStreamTrackMetricsHost_AddTrack_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for AddTrack failed with TypeError');
           }
        }
        // Try Method 1: RemoveTrack
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.blink.mojom.MediaStreamTrackMetricsHost_RemoveTrack_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for RemoveTrack failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
             console.warn('[GeneratedReceiver] Failed to discover ordinal ' + header.ordinal);
