...
mojo.internal.bindings.new_tab_page.mojom.MicrosoftAuthUntrustedDocumentRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.new_tab_page.mojom.MicrosoftAuthUntrustedDocumentRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.new_tab_page.mojom.MicrosoftAuthUntrustedDocument.getRemote = function() {
  let remote = new mojo.internal.bindings.new_tab_page.mojom.MicrosoftAuthUntrustedDocumentRemote();
...
mojo.internal.bindings.new_tab_page.mojom.MicrosoftAuthUntrustedDocumentReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.new_tab_page.mojom.MicrosoftAuthUntrustedDocument_AcquireTokenPopup_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for AcquireTokenPopup failed with TypeError');
           }
        }
        // Try Method 1: AcquireTokenSilent
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.new_tab_page.mojom.MicrosoftAuthUntrustedDocument_AcquireTokenSilent_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for AcquireTokenSilent failed with TypeError');
           }
        }
        // Try Method 2: SignOut
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.new_tab_page.mojom.MicrosoftAuthUntrustedDocument_SignOut_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for SignOut failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.new_tab_page.mojom.MicrosoftAuthUntrustedDocument_AcquireTokenPopup_ParamsSpec.$.structSpec);
        ...
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.new_tab_page.mojom.MicrosoftAuthUntrustedDocument_AcquireTokenSilent_ParamsSpec.$.structSpec);
        ...
        case 2: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.new_tab_page.mojom.MicrosoftAuthUntrustedDocument_SignOut_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.new_tab_page.mojom.MicrosoftAuthUntrustedDocumentReceiver = mojo.internal.bindings.new_tab_page.mojom.MicrosoftAuthUntrustedDocumentReceiver;
