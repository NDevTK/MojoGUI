...
mojo.internal.Struct(
    mojo.internal.bindings.viz.mojom.FrameSinkManagerParamsSpec, 'viz.mojom.FrameSinkManagerParams', [
      mojo.internal.StructField('arg_frame_sink_manager', 0, 0, mojo.internal.InterfaceRequest(mojo.internal.bindings.viz.mojom.FrameSinkManagerRemote), null, false, 0, undefined),
      mojo.internal.StructField('arg_frame_sink_manager_client', 8, 0, mojo.internal.InterfaceProxy(mojo.internal.bindings.viz.mojom.FrameSinkManagerClientRemote), null, false, 0, undefined),
      mojo.internal.StructField('arg_debug_renderer_settings', 16, 0, mojo.internal.bindings.viz.mojom.DebugRendererSettingsSpec.$, null, false, 0, undefined),
      mojo.internal.StructField('arg_restart_id', 24, 0, mojo.internal.Uint32, 0, false, 0, undefined),
      mojo.internal.StructField('arg_activation_deadline_in_frames', 28, 0, mojo.internal.Uint32, 4, false, 0, undefined),
      mojo.internal.StructField('arg_use_activation_deadline', 32, 0, mojo.internal.Bool, true, false, 0, undefined),
    ],
    [[0, 48]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.viz.mojom.VizMain_CreateGpuService_ParamsSpec, 'viz.mojom.VizMain_CreateGpuService_Params', [
      ...
      mojo.internal.StructField('arg_gpu_host', 8, 0, mojo.internal.InterfaceProxy(mojo.internal.bindings.viz.mojom.GpuHostRemote), null, false, 0, undefined),
...
mojo.internal.Struct(
    mojo.internal.bindings.viz.mojom.VizMain_SetRenderParams_ParamsSpec, 'viz.mojom.VizMain_SetRenderParams_Params', [
      ...
      mojo.internal.StructField('arg_text_contrast', 8, 0, mojo.internal.Float, 0, false, 0, undefined),
      mojo.internal.StructField('arg_text_gamma', 12, 0, mojo.internal.Float, 0, false, 0, undefined),
    ],
    [[0, 24]]);
...
mojo.internal.bindings.viz.mojom.VizMainRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.viz.mojom.VizMainRemoteCallHandler(this.proxy);
  }
  ...
  createGpuService(arg_gpu_service, arg_gpu_host, arg_gpu_logging, arg_discardable_memory_manager, arg_use_shader_cache_shm_count, arg_params) {
    return this.$.createGpuService(arg_gpu_service, arg_gpu_host, arg_gpu_logging, arg_discardable_memory_manager, arg_use_shader_cache_shm_count, arg_params);
  }
  setRenderParams(arg_subpixel_rendering, arg_text_contrast, arg_text_gamma) {
    return this.$.setRenderParams(arg_subpixel_rendering, arg_text_contrast, arg_text_gamma);
  }
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.viz.mojom.VizMain_CreateFrameSinkManager_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for CreateFrameSinkManager failed with TypeError');
           }
        }
        // Try Method 1: CreateGpuService
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.viz.mojom.VizMain_CreateGpuService_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for CreateGpuService failed with TypeError');
           }
        }
        // Try Method 2: SetRenderParams
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.viz.mojom.VizMain_SetRenderParams_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for SetRenderParams failed with TypeError');
           }
        }
        // Try Method 3: CreateInfoCollectionGpuService
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.viz.mojom.VizMain_CreateInfoCollectionGpuService_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
        ...
        if (dispatchId === undefined) {
           try {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for StopDebugStream failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.viz.mojom.VizMainReceiver = mojo.internal.bindings.viz.mojom.VizMainReceiver;
