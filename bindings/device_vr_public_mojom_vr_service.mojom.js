...
mojo.internal.bindings.device.mojom.XRPresentationProviderRemote = class {
  ...
  submitFrameDrawnIntoTexture(arg_frame_id, arg_layer_updates, arg_camera_sync_tokens, arg_time_waited) {
    return this.$.submitFrameDrawnIntoTexture(arg_frame_id, arg_layer_updates, arg_camera_sync_tokens, arg_time_waited);
  }
};
...
mojo.internal.bindings.device.mojom.XRPresentationProviderRemoteCallHandler = class {
  ...
  submitFrameDrawnIntoTexture(arg_frame_id, arg_layer_updates, arg_camera_sync_tokens, arg_time_waited) {
    return this.proxy.sendMessage(
      ...
      mojo.internal.bindings.device.mojom.XRPresentationProvider_SubmitFrameDrawnIntoTexture_ParamsSpec,
      null,
      [arg_frame_id, arg_layer_updates, arg_camera_sync_tokens, arg_time_waited],
      false);
  }
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        ...
        case 4: {
          ...
          const result = this.impl.submitFrameDrawnIntoTexture(params.arg_frame_id, params.arg_layer_updates, params.arg_camera_sync_tokens, params.arg_time_waited);
          break;
        }
      }
      } catch (err) {
...
mojo.internal.Struct(
    mojo.internal.bindings.device.mojom.XRPresentationProvider_SubmitFrameDrawnIntoTexture_ParamsSpec, 'device.mojom.XRPresentationProvider_SubmitFrameDrawnIntoTexture_Params', [
      ...
      mojo.internal.StructField('arg_camera_sync_tokens', 16, 0, mojo.internal.Array(mojo.internal.bindings.gpu.mojom.SyncTokenSpec, false), null, false, 0, undefined),
