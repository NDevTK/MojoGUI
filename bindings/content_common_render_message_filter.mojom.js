...
mojo.internal.Struct(
    mojo.internal.bindings.content.mojom.RenderMessageFilter_GenerateSingleFrameRoutingInfo_ResponseParamsSpec, 'content.mojom.RenderMessageFilter_GenerateSingleFrameRoutingInfo_ResponseParams', [
      mojo.internal.StructField('arg_info', 0, 0, mojo.internal.bindings.mojo.internal.bindings.content.mojom.FrameRoutingInfoSpec.$, null, false, 0, undefined),
    ],
    [[0, 16]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.content.mojom.RenderMessageFilter_GenerateFrameRoutingInfos_ResponseParamsSpec, 'content.mojom.RenderMessageFilter_GenerateFrameRoutingInfos_ResponseParams', [
      mojo.internal.StructField('arg_info_array', 0, 0, mojo.internal.Array(mojo.internal.bindings.mojo.internal.bindings.content.mojom.FrameRoutingInfoSpec.$, false), null, false, 0, undefined),
    ],
    [[0, 16]]);
...
mojo.internal.bindings.content.mojom.RenderMessageFilterRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.content.mojom.RenderMessageFilterPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.content.mojom.RenderMessageFilterRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.content.mojom.RenderMessageFilterRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
...
mojo.internal.bindings.content.mojom.RenderMessageFilter.getRemote = function() {
  let remote = new mojo.internal.bindings.content.mojom.RenderMessageFilterRemote();
...
mojo.internal.bindings.content.mojom.RenderMessageFilterReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.content.mojom.RenderMessageFilter_GenerateSingleFrameRoutingInfo_ParamsSpec);
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.content.mojom.RenderMessageFilter_GenerateFrameRoutingInfos_ParamsSpec);
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.content.mojom.RenderMessageFilter_GenerateSingleFrameRoutingInfo_ParamsSpec.$.structSpec);
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.content.mojom.RenderMessageFilter_GenerateSingleFrameRoutingInfo_ResponseParamsSpec, header, rawHeader);
               responder(response);
        ...
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.content.mojom.RenderMessageFilter_GenerateFrameRoutingInfos_ParamsSpec.$.structSpec);
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              const rawHeader = (args[2] && args[2].slice) ? args[2].slice(0, header.headerSize) : null;
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.content.mojom.RenderMessageFilter_GenerateFrameRoutingInfos_ResponseParamsSpec, header, rawHeader);
               responder(response);
...
mojo.internal.bindings.content.mojom.RenderMessageFilterReceiver = mojo.internal.bindings.content.mojom.RenderMessageFilterReceiver;
