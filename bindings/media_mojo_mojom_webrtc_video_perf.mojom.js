...
mojo.internal.bindings.media.mojom.WebrtcVideoPerfRecorderRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.media.mojom.WebrtcVideoPerfRecorderPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.media.mojom.WebrtcVideoPerfRecorderRemoteCallHandler(this.proxy);
  }
  ...
  updateRecord(arg_features, arg_video_stats) {
    return this.$.updateRecord(arg_features, arg_video_stats);
  }
};

mojo.internal.bindings.media.mojom.WebrtcVideoPerfRecorderRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('media.mojom.WebrtcVideoPerfRecorder', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.media.mojom.WebrtcVideoPerfRecorder.getRemote = function() {
  let remote = new mojo.internal.bindings.media.mojom.WebrtcVideoPerfRecorderRemote();
...
mojo.internal.bindings.media.mojom.WebrtcVideoPerfRecorderReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('media.mojom.WebrtcVideoPerfRecorder', [
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.media.mojom.WebrtcVideoPerfRecorder_UpdateRecord_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.media.mojom.WebrtcVideoPerfRecorderReceiver = mojo.internal.bindings.media.mojom.WebrtcVideoPerfRecorderReceiver;

mojo.internal.bindings.media.mojom.WebrtcVideoPerfRecorderPtr = mojo.internal.bindings.media.mojom.WebrtcVideoPerfRecorderRemote;
mojo.internal.bindings.media.mojom.WebrtcVideoPerfRecorderRequest = mojo.internal.bindings.media.mojom.WebrtcVideoPerfRecorderPendingReceiver;
...
mojo.internal.bindings.media.mojom.WebrtcVideoPerfHistoryRemote = class {
  static get $interfaceName() {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.media.mojom.WebrtcVideoPerfHistoryPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.media.mojom.WebrtcVideoPerfHistoryRemoteCallHandler(this.proxy);
  }
  ...
  getPerfInfo(arg_features, arg_frames_per_second) {
    return this.$.getPerfInfo(arg_features, arg_frames_per_second);
  }
};

mojo.internal.bindings.media.mojom.WebrtcVideoPerfHistoryRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('media.mojom.WebrtcVideoPerfHistory', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.media.mojom.WebrtcVideoPerfHistory.getRemote = function() {
  let remote = new mojo.internal.bindings.media.mojom.WebrtcVideoPerfHistoryRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
...
mojo.internal.bindings.media.mojom.WebrtcVideoPerfHistoryReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('media.mojom.WebrtcVideoPerfHistory', [
      { explicit: null },
    ]);
    ordinals.forEach((ord, idx) => {
      this.ordinalMap.set(ord, idx); // Scrambled/Explicit
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.media.mojom.WebrtcVideoPerfHistory_GetPerfInfo_ParamsSpec.$.structSpec);
        ...
        case 0: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.media.mojom.WebrtcVideoPerfHistory_GetPerfInfo_ResponseParamsSpec, header, rawHeader);
               responder(response);
...
mojo.internal.bindings.media.mojom.WebrtcVideoPerfHistoryReceiver = mojo.internal.bindings.media.mojom.WebrtcVideoPerfHistoryReceiver;
