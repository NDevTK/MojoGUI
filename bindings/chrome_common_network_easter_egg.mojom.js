...
mojo.internal.bindings.chrome.mojom.NetworkEasterEggRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.chrome.mojom.NetworkEasterEggPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.chrome.mojom.NetworkEasterEggRemoteCallHandler(this.proxy);
  }
  ...
  updateHighScore(arg_high_score) {
    return this.$.updateHighScore(arg_high_score);
  }
  resetHighScore() {
...
mojo.internal.bindings.chrome.mojom.NetworkEasterEggRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('chrome.mojom.NetworkEasterEgg', [
      { explicit: null },
      { explicit: null },
      { explicit: null },
    ]);
...
mojo.internal.bindings.chrome.mojom.NetworkEasterEgg.getRemote = function() {
  let remote = new mojo.internal.bindings.chrome.mojom.NetworkEasterEggRemote();
...
mojo.internal.bindings.chrome.mojom.NetworkEasterEggReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('chrome.mojom.NetworkEasterEgg', [
      { explicit: null },
      { explicit: null },
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.chrome.mojom.NetworkEasterEgg_GetHighScore_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for GetHighScore failed with TypeError');
           }
        }
        // Try Method 1: UpdateHighScore
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.chrome.mojom.NetworkEasterEgg_UpdateHighScore_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for UpdateHighScore failed with TypeError');
           }
        }
        // Try Method 2: ResetHighScore
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.chrome.mojom.NetworkEasterEgg_ResetHighScore_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for ResetHighScore failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.chrome.mojom.NetworkEasterEgg_GetHighScore_ParamsSpec.$.structSpec);
        ...
        case 2: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.chrome.mojom.NetworkEasterEgg_ResetHighScore_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.chrome.mojom.NetworkEasterEggReceiver = mojo.internal.bindings.chrome.mojom.NetworkEasterEggReceiver;
