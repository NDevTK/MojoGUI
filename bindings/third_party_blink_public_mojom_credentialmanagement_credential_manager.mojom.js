...
// Enum: CredentialType
mojo.internal.bindings.blink.mojom.CredentialType = {
  EMPTY: 0,
  PASSWORD: 1,
  FEDERATED: 2,
};
...
mojo.internal.bindings.blink.mojom.CredentialMediationRequirement = {
  kSilent: 0,
  kOptional: 1,
  kRequired: 2,
  kConditional: 3,
...
mojo.internal.bindings.blink.mojom.CredentialManagerError = {
  SUCCESS: 0,
  PENDING_REQUEST: 1,
...
mojo.internal.Struct(
    mojo.internal.bindings.blink.mojom.CredentialInfoSpec, 'blink.mojom.CredentialInfo', [
      mojo.internal.StructField('arg_type', 0, 0, mojo.internal.bindings.mojo.internal.bindings.blink.mojom.CredentialTypeSpec.$, null, false, 0, undefined),
...
mojo.internal.Struct(
    mojo.internal.bindings.blink.mojom.CredentialManager_Store_ParamsSpec, 'blink.mojom.CredentialManager_Store_Params', [
      mojo.internal.StructField('arg_credential', 0, 0, mojo.internal.bindings.mojo.internal.bindings.blink.mojom.CredentialInfoSpec.$, null, false, 0, undefined),
    ],
    [[0, 16]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.blink.mojom.CredentialManager_Get_ParamsSpec, 'blink.mojom.CredentialManager_Get_Params', [
      mojo.internal.StructField('arg_mediation', 0, 0, mojo.internal.bindings.mojo.internal.bindings.blink.mojom.CredentialMediationRequirementSpec.$, null, false, 0, undefined),
...
mojo.internal.Struct(
    mojo.internal.bindings.blink.mojom.CredentialManager_Get_ResponseParamsSpec, 'blink.mojom.CredentialManager_Get_ResponseParams', [
      mojo.internal.StructField('arg_error', 0, 0, mojo.internal.bindings.mojo.internal.bindings.blink.mojom.CredentialManagerErrorSpec.$, null, false, 0, undefined),
      mojo.internal.StructField('arg_credential', 8, 0, mojo.internal.bindings.mojo.internal.bindings.blink.mojom.CredentialInfoSpec.$, null, true, 0, undefined),
    ],
    [[0, 24]]);
...
mojo.internal.bindings.blink.mojom.CredentialManagerRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.blink.mojom.CredentialManagerPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.blink.mojom.CredentialManagerRemoteCallHandler(this.proxy);
  }
  ...
  store(arg_credential) {
    return this.$.store(arg_credential);
  }
  preventSilentAccess() {
    return this.$.preventSilentAccess();
  }
  get(arg_mediation, arg_include_passwords, arg_federations) {
    return this.$.get(arg_mediation, arg_include_passwords, arg_federations);
  }
};
...
mojo.internal.bindings.blink.mojom.CredentialManager.getRemote = function() {
  let remote = new mojo.internal.bindings.blink.mojom.CredentialManagerRemote();
...
mojo.internal.bindings.blink.mojom.CredentialManagerReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      switch (dispatchId) {
        ...
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.blink.mojom.CredentialManager_PreventSilentAccess_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.blink.mojom.CredentialManagerReceiver = mojo.internal.bindings.blink.mojom.CredentialManagerReceiver;
