...
mojo.internal.bindings.blink.mojom.TextSuggestionHostRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.blink.mojom.TextSuggestionHostPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.blink.mojom.TextSuggestionHostRemoteCallHandler(this.proxy);
  }
  ...
  showSpellCheckSuggestionMenu(arg_caret_x, arg_caret_y, arg_marked_text, arg_suggestions) {
    return this.$.showSpellCheckSuggestionMenu(arg_caret_x, arg_caret_y, arg_marked_text, arg_suggestions);
  }
  showTextSuggestionMenu(arg_caret_x, arg_caret_y, arg_marked_text, arg_suggestions) {
    return this.$.showTextSuggestionMenu(arg_caret_x, arg_caret_y, arg_marked_text, arg_suggestions);
  }
};

mojo.internal.bindings.blink.mojom.TextSuggestionHostRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('blink.mojom.TextSuggestionHost', [
      { explicit: null },
      { explicit: null },
      { explicit: null },
    ]);
...
mojo.internal.bindings.blink.mojom.TextSuggestionHost.getRemote = function() {
  let remote = new mojo.internal.bindings.blink.mojom.TextSuggestionHostRemote();
...
mojo.internal.bindings.blink.mojom.TextSuggestionHostReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('blink.mojom.TextSuggestionHost', [
      { explicit: null },
      { explicit: null },
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.blink.mojom.TextSuggestionHost_StartSuggestionMenuTimer_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for StartSuggestionMenuTimer failed with TypeError');
           }
        }
        // Try Method 1: ShowSpellCheckSuggestionMenu
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.blink.mojom.TextSuggestionHost_ShowSpellCheckSuggestionMenu_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for ShowSpellCheckSuggestionMenu failed with TypeError');
           }
        }
        // Try Method 2: ShowTextSuggestionMenu
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.blink.mojom.TextSuggestionHost_ShowTextSuggestionMenu_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for ShowTextSuggestionMenu failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.blink.mojom.TextSuggestionHost_StartSuggestionMenuTimer_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.blink.mojom.TextSuggestionHostReceiver = mojo.internal.bindings.blink.mojom.TextSuggestionHostReceiver;
