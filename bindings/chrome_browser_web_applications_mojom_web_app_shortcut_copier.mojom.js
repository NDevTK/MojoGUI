  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.web_app.mojom.WebAppShortcutCopier_CopyWebAppShortcut_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for CopyWebAppShortcut failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
