...
mojo.internal.bindings.web_app.mojom.WebAppShortcutCopier = {};
mojo.internal.bindings.web_app.mojom.WebAppShortcutCopierSpec = { $ : {} };
mojo.internal.bindings.web_app.mojom.WebAppShortcutCopier.$interfaceName = 'web_app.mojom.WebAppShortcutCopier';
...
mojo.internal.bindings.web_app.mojom.WebAppShortcutCopierRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.web_app.mojom.WebAppShortcutCopierPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.web_app.mojom.WebAppShortcutCopierRemoteCallHandler(this.proxy);
  }
  ...
  copyWebAppShortcut(arg_source_path, arg_destination_path) {
    return this.$.copyWebAppShortcut(arg_source_path, arg_destination_path);
  }
};

mojo.internal.bindings.web_app.mojom.WebAppShortcutCopierRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('web_app.mojom.WebAppShortcutCopier', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.web_app.mojom.WebAppShortcutCopier.getRemote = function() {
  let remote = new mojo.internal.bindings.web_app.mojom.WebAppShortcutCopierRemote();
...
mojo.internal.bindings.web_app.mojom.WebAppShortcutCopierReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('web_app.mojom.WebAppShortcutCopier', [
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.web_app.mojom.WebAppShortcutCopier_CopyWebAppShortcut_ParamsSpec.$.structSpec);
        ...
        case 0: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.web_app.mojom.WebAppShortcutCopier_CopyWebAppShortcut_ResponseParamsSpec, header, rawHeader);
               responder(response);
...
mojo.internal.bindings.web_app.mojom.WebAppShortcutCopierReceiver = mojo.internal.bindings.web_app.mojom.WebAppShortcutCopierReceiver;
