// Auto-generated MojoJS binding
 // Source: chromium_src/chrome/browser/ui/webui/ai_overlay_dialog/tools/tools.mojom
...
mojo.internal.bindings.ai_overlay_dialog.mojom.ScrollGranularitySpec = mojo.internal.bindings.ai_overlay_dialog.mojom.ScrollGranularitySpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.ai_overlay_dialog.mojom.SwitchTabResultSpec = mojo.internal.bindings.ai_overlay_dialog.mojom.SwitchTabResultSpec || { $: {} };
if (mojo.internal.bindings.ai_overlay_dialog.mojom.SwitchTabResultSpec.$.structSpec && mojo.internal.bindings.ai_overlay_dialog.mojom.SwitchTabResultSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ai_overlay_dialog.mojom.SwitchTabResultSpec.$ = {};
mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayTools = mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayTools || {};
mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayToolsSpec = mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayToolsSpec || { $ : {} };
if (mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayToolsSpec.$.structSpec && mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayToolsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayToolsSpec.$ = {};
mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayTools.$interfaceName = 'ai_overlay_dialog.mojom.AiOverlayTools';
mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayTools_OpenUrl_ParamsSpec = mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayTools_OpenUrl_ParamsSpec || { $: {} };
if (mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayTools_OpenUrl_ParamsSpec.$.structSpec && mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayTools_OpenUrl_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayTools_OpenUrl_ParamsSpec.$ = {};
mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayTools_FollowLink_ParamsSpec = mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayTools_FollowLink_ParamsSpec || { $: {} };
if (mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayTools_FollowLink_ParamsSpec.$.structSpec && mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayTools_FollowLink_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayTools_FollowLink_ParamsSpec.$ = {};
mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayTools_PerformSearch_ParamsSpec = mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayTools_PerformSearch_ParamsSpec || { $: {} };
if (mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayTools_PerformSearch_ParamsSpec.$.structSpec && mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayTools_PerformSearch_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayTools_PerformSearch_ParamsSpec.$ = {};
mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayTools_SwitchTab_ParamsSpec = mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayTools_SwitchTab_ParamsSpec || { $: {} };
if (mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayTools_SwitchTab_ParamsSpec.$.structSpec && mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayTools_SwitchTab_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayTools_SwitchTab_ParamsSpec.$ = {};
mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayTools_CloseCurrentTab_ParamsSpec = mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayTools_CloseCurrentTab_ParamsSpec || { $: {} };
if (mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayTools_CloseCurrentTab_ParamsSpec.$.structSpec && mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayTools_CloseCurrentTab_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayTools_CloseCurrentTab_ParamsSpec.$ = {};
mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayTools_GoBack_ParamsSpec = mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayTools_GoBack_ParamsSpec || { $: {} };
if (mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayTools_GoBack_ParamsSpec.$.structSpec && mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayTools_GoBack_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayTools_GoBack_ParamsSpec.$ = {};
mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayTools_GoForward_ParamsSpec = mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayTools_GoForward_ParamsSpec || { $: {} };
if (mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayTools_GoForward_ParamsSpec.$.structSpec && mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayTools_GoForward_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayTools_GoForward_ParamsSpec.$ = {};
mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayTools_ReloadPage_ParamsSpec = mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayTools_ReloadPage_ParamsSpec || { $: {} };
if (mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayTools_ReloadPage_ParamsSpec.$.structSpec && mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayTools_ReloadPage_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayTools_ReloadPage_ParamsSpec.$ = {};
mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayTools_FindAndHighlight_ParamsSpec = mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayTools_FindAndHighlight_ParamsSpec || { $: {} };
if (mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayTools_FindAndHighlight_ParamsSpec.$.structSpec && mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayTools_FindAndHighlight_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayTools_FindAndHighlight_ParamsSpec.$ = {};
mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayTools_Scroll_ParamsSpec = mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayTools_Scroll_ParamsSpec || { $: {} };
if (mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayTools_Scroll_ParamsSpec.$.structSpec && mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayTools_Scroll_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayTools_Scroll_ParamsSpec.$ = {};
mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayTools_PlayVideo_ParamsSpec = mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayTools_PlayVideo_ParamsSpec || { $: {} };
if (mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayTools_PlayVideo_ParamsSpec.$.structSpec && mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayTools_PlayVideo_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayTools_PlayVideo_ParamsSpec.$ = {};
mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayTools_PauseVideo_ParamsSpec = mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayTools_PauseVideo_ParamsSpec || { $: {} };
if (mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayTools_PauseVideo_ParamsSpec.$.structSpec && mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayTools_PauseVideo_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayTools_PauseVideo_ParamsSpec.$ = {};
mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayTools_SeekToTimestamp_ParamsSpec = mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayTools_SeekToTimestamp_ParamsSpec || { $: {} };
if (mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayTools_SeekToTimestamp_ParamsSpec.$.structSpec && mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayTools_SeekToTimestamp_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayTools_SeekToTimestamp_ParamsSpec.$ = {};
mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayTools_TranslatePage_ParamsSpec = mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayTools_TranslatePage_ParamsSpec || { $: {} };
if (mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayTools_TranslatePage_ParamsSpec.$.structSpec && mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayTools_TranslatePage_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayTools_TranslatePage_ParamsSpec.$ = {};
mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayTools_AddBookmark_ParamsSpec = mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayTools_AddBookmark_ParamsSpec || { $: {} };
if (mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayTools_AddBookmark_ParamsSpec.$.structSpec && mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayTools_AddBookmark_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayTools_AddBookmark_ParamsSpec.$ = {};
mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayTools_RemoveBookmark_ParamsSpec = mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayTools_RemoveBookmark_ParamsSpec || { $: {} };
...
mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayTools_OpenGeminiPanel_ParamsSpec = mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayTools_OpenGeminiPanel_ParamsSpec || { $: {} };
if (mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayTools_OpenGeminiPanel_ParamsSpec.$.structSpec && mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayTools_OpenGeminiPanel_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayTools_OpenGeminiPanel_ParamsSpec.$ = {};
mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayTools_CloseGeminiPanel_ParamsSpec = mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayTools_CloseGeminiPanel_ParamsSpec || { $: {} };
if (mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayTools_CloseGeminiPanel_ParamsSpec.$.structSpec && mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayTools_CloseGeminiPanel_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayTools_CloseGeminiPanel_ParamsSpec.$ = {};
...
mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayToolRegistrySpec = mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayToolRegistrySpec || { $ : {} };
if (mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayToolRegistrySpec.$.structSpec && mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayToolRegistrySpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayToolRegistrySpec.$ = {};
mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayToolRegistry.$interfaceName = 'ai_overlay_dialog.mojom.AiOverlayToolRegistry';
mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayToolRegistry_GetToolDefinitions_ParamsSpec = mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayToolRegistry_GetToolDefinitions_ParamsSpec || { $: {} };
if (mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayToolRegistry_GetToolDefinitions_ParamsSpec.$.structSpec && mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayToolRegistry_GetToolDefinitions_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayToolRegistry_GetToolDefinitions_ParamsSpec.$ = {};
mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayToolRegistry_GetToolDefinitions_ResponseParamsSpec = mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayToolRegistry_GetToolDefinitions_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayToolRegistry_GetToolDefinitions_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayToolRegistry_GetToolDefinitions_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayToolRegistry_GetToolDefinitions_ResponseParamsSpec.$ = {};
...
mojo.internal.bindings.ai_overlay_dialog.mojom.ScrollGranularity = {
  kDocument: 0,
  kPage: 1,
};

// Interface: AiOverlayTools
mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayToolsPendingReceiver = class {
  constructor(handle) {
    this.handle = handle;
    if (handle) {
...
mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayToolsRemote = class {
  static get $interfaceName() {
    return 'ai_overlay_dialog.mojom.AiOverlayTools';
  }

  constructor(handle = undefined) {
    this.__mojoHandle = handle;
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayToolsPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayToolsRemoteCallHandler(this.proxy);
  }
  ...
  openUrl(arg_url, arg_new_tab) {
    return this.$.openUrl(arg_url, arg_new_tab);
  }
  followLink(arg_id) {
    return this.$.followLink(arg_id);
  }
  performSearch(arg_query, arg_new_tab) {
    return this.$.performSearch(arg_query, arg_new_tab);
  }
  switchTab(arg_query) {
    return this.$.switchTab(arg_query);
  }
  closeCurrentTab() {
  ...
  findAndHighlight(arg_query) {
    return this.$.findAndHighlight(arg_query);
  }
  scroll(arg_granularity, arg_magnitude) {
    return this.$.scroll(arg_granularity, arg_magnitude);
  }
  playVideo() {
  ...
  seekToTimestamp(arg_timecode) {
    return this.$.seekToTimestamp(arg_timecode);
  }
  translatePage(arg_target_language) {
    return this.$.translatePage(arg_target_language);
  }
  addBookmark() {
  ...
  openGeminiPanel(arg_prompt) {
    return this.$.openGeminiPanel(arg_prompt);
  }
  closeGeminiPanel() {
    return this.$.closeGeminiPanel();
  }
};

mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayToolsRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
  ...
  openUrl(arg_url, arg_new_tab) {
    return this.proxy.sendMessage(
      ...
      mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayTools_OpenUrl_ParamsSpec,
      null,
      [arg_url, arg_new_tab],
      false);
  }
  ...
  followLink(arg_id) {
    return this.proxy.sendMessage(
      ...
      mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayTools_FollowLink_ParamsSpec,
      null,
      [arg_id],
      false);
  }
  ...
  switchTab(arg_query) {
    return this.proxy.sendMessage(
      ...
      mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayTools_SwitchTab_ParamsSpec,
      null,
      [arg_query],
      false);
  }
  ...
  goBack() {
    return this.proxy.sendMessage(
      ...
      mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayTools_GoBack_ParamsSpec,
      null,
      [],
      false);
  }
  ...
  goForward() {
    return this.proxy.sendMessage(
      ...
      mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayTools_GoForward_ParamsSpec,
      null,
      [],
      false);
  }
  ...
  reloadPage() {
    return this.proxy.sendMessage(
      ...
      mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayTools_ReloadPage_ParamsSpec,
      null,
      [],
      false);
  }
  ...
  scroll(arg_granularity, arg_magnitude) {
    return this.proxy.sendMessage(
      ...
      mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayTools_Scroll_ParamsSpec,
      null,
      [arg_granularity, arg_magnitude],
      false);
  }
  ...
  playVideo() {
    return this.proxy.sendMessage(
      ...
      mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayTools_PlayVideo_ParamsSpec,
      null,
      [],
      false);
  }
  ...
  pauseVideo() {
    return this.proxy.sendMessage(
      ...
      mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayTools_PauseVideo_ParamsSpec,
      null,
      [],
      false);
  }
  ...
  addBookmark() {
    return this.proxy.sendMessage(
      ...
      mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayTools_AddBookmark_ParamsSpec,
      null,
      [],
      false);
  }
  ...
  openPage(arg_query) {
    return this.proxy.sendMessage(
      ...
      mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayTools_OpenPage_ParamsSpec,
      null,
      [arg_query],
      false);
  }
...
mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayTools.getRemote = function() {
  let remote = new mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayToolsRemote();
...
mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayToolsReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        case 0: {
          ...
          const params = decoder.decodeStructInline(mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayTools_OpenUrl_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.openUrl');
          const result = this.impl.openUrl(params.arg_url, params.arg_new_tab);
          break;
        }
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayTools_FollowLink_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.followLink');
          const result = this.impl.followLink(params.arg_id);
          break;
        }
        case 2: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayTools_PerformSearch_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.performSearch');
          const result = this.impl.performSearch(params.arg_query, params.arg_new_tab);
          break;
        }
        case 3: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayTools_SwitchTab_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.switchTab');
          const result = this.impl.switchTab(params.arg_query);
          break;
        }
        case 4: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayTools_CloseCurrentTab_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.closeCurrentTab');
          const result = this.impl.closeCurrentTab();
          break;
        }
        case 5: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayTools_GoBack_ParamsSpec.$.structSpec);
        ...
        case 6: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayTools_GoForward_ParamsSpec.$.structSpec);
        ...
        case 7: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayTools_ReloadPage_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.reloadPage');
          const result = this.impl.reloadPage();
          break;
        }
        case 8: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayTools_FindAndHighlight_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.findAndHighlight');
          const result = this.impl.findAndHighlight(params.arg_query);
          break;
        }
        case 9: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayTools_Scroll_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.scroll');
          const result = this.impl.scroll(params.arg_granularity, params.arg_magnitude);
          break;
        }
        case 10: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayTools_PlayVideo_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.playVideo');
          const result = this.impl.playVideo();
          break;
        }
        case 11: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayTools_PauseVideo_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.pauseVideo');
          const result = this.impl.pauseVideo();
          break;
        }
        case 12: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayTools_SeekToTimestamp_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.seekToTimestamp');
          const result = this.impl.seekToTimestamp(params.arg_timecode);
          break;
        }
        case 13: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayTools_TranslatePage_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.translatePage');
          const result = this.impl.translatePage(params.arg_target_language);
          break;
        }
        case 14: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayTools_AddBookmark_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.addBookmark');
          const result = this.impl.addBookmark();
          break;
        }
        case 15: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayTools_RemoveBookmark_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.removeBookmark');
          const result = this.impl.removeBookmark();
          break;
        }
        case 16: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayTools_OpenPage_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.openPage');
          const result = this.impl.openPage(params.arg_query);
          break;
        }
        case 17: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
        ...
        case 21: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayTools_OpenGeminiPanel_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.openGeminiPanel');
          const result = this.impl.openGeminiPanel(params.arg_prompt);
          break;
        }
        case 22: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayTools_CloseGeminiPanel_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.closeGeminiPanel');
          const result = this.impl.closeGeminiPanel();
          break;
        }
      }
      } catch (err) {
...
mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayToolsReceiver = mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayToolsReceiver;

mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayToolsPtr = mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayToolsRemote;
mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayToolsRequest = mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayToolsPendingReceiver;


// Interface: AiOverlayToolRegistry
mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayToolRegistryPendingReceiver = class {
  constructor(handle) {
    this.handle = handle;
    if (handle) {
      this.__mojoHandle = handle.router_ ? handle.router_.pipe_ : (handle.pipe_ || handle);
...
mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayToolRegistryRemote = class {
  static get $interfaceName() {
    return 'ai_overlay_dialog.mojom.AiOverlayToolRegistry';
  }

  constructor(handle = undefined) {
    this.__mojoHandle = handle;
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayToolRegistryPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayToolRegistryRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayToolRegistryRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('ai_overlay_dialog.mojom.AiOverlayToolRegistry', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayToolRegistry.getRemote = function() {
  let remote = new mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayToolRegistryRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
...
mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayToolRegistryReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('ai_overlay_dialog.mojom.AiOverlayToolRegistry', [
      { explicit: null },
    ]);
    ordinals.forEach((ord, idx) => {
      this.ordinalMap.set(ord, idx); // Scrambled/Explicit
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayToolRegistry_GetToolDefinitions_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.getToolDefinitions');
          const result = this.impl.getToolDefinitions();
          const expectsResponse = header.expectsResponse || (header.flags & 1);
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              const val = (response && typeof response === 'object' && 'arg_json_definitions' in response) ? response['arg_json_definitions'] : response;
              const resp_obj = { 'arg_json_definitions': val };
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayToolRegistry_GetToolDefinitions_ResponseParamsSpec.$.structSpec, resp_obj);
...
mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayToolRegistryReceiver = mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayToolRegistryReceiver;

mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayToolRegistryPtr = mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayToolRegistryRemote;
mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayToolRegistryRequest = mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayToolRegistryPendingReceiver;
...
mojo.internal.Struct(
    mojo.internal.bindings.ai_overlay_dialog.mojom.SwitchTabResultSpec, 'ai_overlay_dialog.mojom.SwitchTabResult', [
    ...
    [[0, 32]]);
mojo.internal.Struct(
    mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayTools_OpenUrl_ParamsSpec, 'ai_overlay_dialog.mojom.AiOverlayTools_OpenUrl_Params', [
      mojo.internal.StructField('arg_url', 0, 0, mojo.internal.String, null, false, 0, undefined),
      mojo.internal.StructField('arg_new_tab', 8, 0, mojo.internal.Bool, false, false, 0, undefined),
    ],
    [[0, 24]]);

mojo.internal.Struct(
    mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayTools_FollowLink_ParamsSpec, 'ai_overlay_dialog.mojom.AiOverlayTools_FollowLink_Params', [
      mojo.internal.StructField('arg_id', 0, 0, mojo.internal.String, null, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayTools_PerformSearch_ParamsSpec, 'ai_overlay_dialog.mojom.AiOverlayTools_PerformSearch_Params', [
...
mojo.internal.Struct(
    mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayTools_SwitchTab_ParamsSpec, 'ai_overlay_dialog.mojom.AiOverlayTools_SwitchTab_Params', [
      mojo.internal.StructField('arg_query', 0, 0, mojo.internal.String, null, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayTools_CloseCurrentTab_ParamsSpec, 'ai_overlay_dialog.mojom.AiOverlayTools_CloseCurrentTab_Params', [
    ],
    [[0, 8]]);

mojo.internal.Struct(
    mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayTools_GoBack_ParamsSpec, 'ai_overlay_dialog.mojom.AiOverlayTools_GoBack_Params', [
    ],
    [[0, 8]]);

mojo.internal.Struct(
    mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayTools_GoForward_ParamsSpec, 'ai_overlay_dialog.mojom.AiOverlayTools_GoForward_Params', [
    ],
    [[0, 8]]);

mojo.internal.Struct(
    mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayTools_ReloadPage_ParamsSpec, 'ai_overlay_dialog.mojom.AiOverlayTools_ReloadPage_Params', [
    ],
    [[0, 8]]);

mojo.internal.Struct(
    mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayTools_FindAndHighlight_ParamsSpec, 'ai_overlay_dialog.mojom.AiOverlayTools_FindAndHighlight_Params', [
      mojo.internal.StructField('arg_query', 0, 0, mojo.internal.String, null, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayTools_Scroll_ParamsSpec, 'ai_overlay_dialog.mojom.AiOverlayTools_Scroll_Params', [
      mojo.internal.StructField('arg_granularity', 0, 0, mojo.internal.bindings.ai_overlay_dialog.mojom.ScrollGranularitySpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_magnitude', 8, 0, mojo.internal.Double, 0, false, 0, undefined),
    ],
    [[0, 24]]);

mojo.internal.Struct(
    mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayTools_PlayVideo_ParamsSpec, 'ai_overlay_dialog.mojom.AiOverlayTools_PlayVideo_Params', [
    ],
    [[0, 8]]);

mojo.internal.Struct(
    mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayTools_PauseVideo_ParamsSpec, 'ai_overlay_dialog.mojom.AiOverlayTools_PauseVideo_Params', [
    ],
    [[0, 8]]);

mojo.internal.Struct(
    mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayTools_SeekToTimestamp_ParamsSpec, 'ai_overlay_dialog.mojom.AiOverlayTools_SeekToTimestamp_Params', [
      mojo.internal.StructField('arg_timecode', 0, 0, mojo.internal.String, null, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayTools_TranslatePage_ParamsSpec, 'ai_overlay_dialog.mojom.AiOverlayTools_TranslatePage_Params', [
      mojo.internal.StructField('arg_target_language', 0, 0, mojo.internal.String, null, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayTools_AddBookmark_ParamsSpec, 'ai_overlay_dialog.mojom.AiOverlayTools_AddBookmark_Params', [
    ],
    [[0, 8]]);

mojo.internal.Struct(
    mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayTools_RemoveBookmark_ParamsSpec, 'ai_overlay_dialog.mojom.AiOverlayTools_RemoveBookmark_Params', [
    ],
    [[0, 8]]);

mojo.internal.Struct(
    mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayTools_OpenPage_ParamsSpec, 'ai_overlay_dialog.mojom.AiOverlayTools_OpenPage_Params', [
      mojo.internal.StructField('arg_query', 0, 0, mojo.internal.String, null, false, 0, undefined),
    ],
    [[0, 16]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayTools_OpenGeminiPanel_ParamsSpec, 'ai_overlay_dialog.mojom.AiOverlayTools_OpenGeminiPanel_Params', [
      mojo.internal.StructField('arg_prompt', 0, 0, mojo.internal.String, null, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayTools_CloseGeminiPanel_ParamsSpec, 'ai_overlay_dialog.mojom.AiOverlayTools_CloseGeminiPanel_Params', [
    ],
    [[0, 8]]);

mojo.internal.Struct(
    mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayToolRegistry_GetToolDefinitions_ParamsSpec, 'ai_overlay_dialog.mojom.AiOverlayToolRegistry_GetToolDefinitions_Params', [
    ],
    [[0, 8]]);

mojo.internal.Struct(
    mojo.internal.bindings.ai_overlay_dialog.mojom.AiOverlayToolRegistry_GetToolDefinitions_ResponseParamsSpec, 'ai_overlay_dialog.mojom.AiOverlayToolRegistry_GetToolDefinitions_ResponseParams', [
      mojo.internal.StructField('arg_json_definitions', 0, 0, mojo.internal.String, null, false, 0, undefined),
    ],
    [[0, 16]]);
