...
mojo.internal.bindings.blink.mojom.FileSystemAccessFileModificationHost = {};
mojo.internal.bindings.blink.mojom.FileSystemAccessFileModificationHostSpec = { $ : {} };
mojo.internal.bindings.blink.mojom.FileSystemAccessFileModificationHost.$interfaceName = 'blink.mojom.FileSystemAccessFileModificationHost';
...
mojo.internal.bindings.blink.mojom.FileSystemAccessFileModificationHostRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.blink.mojom.FileSystemAccessFileModificationHostRemoteCallHandler(this.proxy);
  }
  ...
  requestCapacityChange(arg_capacity_delta) {
    return this.$.requestCapacityChange(arg_capacity_delta);
  }
  onContentsModified() {
...
mojo.internal.bindings.blink.mojom.FileSystemAccessFileModificationHostRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('blink.mojom.FileSystemAccessFileModificationHost', [
      { explicit: null },
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.blink.mojom.FileSystemAccessFileModificationHost.getRemote = function() {
  let remote = new mojo.internal.bindings.blink.mojom.FileSystemAccessFileModificationHostRemote();
...
mojo.internal.bindings.blink.mojom.FileSystemAccessFileModificationHostReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('blink.mojom.FileSystemAccessFileModificationHost', [
      { explicit: null },
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.blink.mojom.FileSystemAccessFileModificationHost_RequestCapacityChange_ParamsSpec.$.structSpec);
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.blink.mojom.FileSystemAccessFileModificationHost_OnContentsModified_ParamsSpec.$.structSpec);
      ...
      switch (dispatchId) {
        case 0: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.blink.mojom.FileSystemAccessFileModificationHost_RequestCapacityChange_ResponseParamsSpec, header, rawHeader);
               responder(response);
        ...
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.blink.mojom.FileSystemAccessFileModificationHost_OnContentsModified_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.blink.mojom.FileSystemAccessFileModificationHostReceiver = mojo.internal.bindings.blink.mojom.FileSystemAccessFileModificationHostReceiver;
