...
mojo.internal.bindings.chromecast.mojom.ActivityWindowRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.chromecast.mojom.ActivityWindowPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.chromecast.mojom.ActivityWindowRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.chromecast.mojom.ActivityWindow.getRemote = function() {
  let remote = new mojo.internal.bindings.chromecast.mojom.ActivityWindowRemote();
...
mojo.internal.bindings.chromecast.mojom.ActivityWindowReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.chromecast.mojom.ActivityWindow_Show_ParamsSpec.$.structSpec;
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.chromecast.mojom.ActivityWindow_Hide_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.chromecast.mojom.ActivityWindow_Show_ParamsSpec.$.structSpec);
        ...
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.chromecast.mojom.ActivityWindow_Hide_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.chromecast.mojom.ActivityWindowReceiver = mojo.internal.bindings.chromecast.mojom.ActivityWindowReceiver;
