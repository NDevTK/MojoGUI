...
mojo.internal.bindings.skia = mojo.internal.bindings.skia || {};
mojo.internal.bindings.skia.mojom = mojo.internal.bindings.skia.mojom || {};
mojo.internal.bindings.skia.mojom.InlineBitmapSpec = mojo.internal.bindings.skia.mojom.InlineBitmapSpec || { $: mojo.internal.OpaqueStruct.$ };
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.data_decoder.mojom.ImageDecoder_DecodeImage_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for DecodeImage failed with TypeError');
           }
        }
        // Try Method 1: DecodeAnimation
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.data_decoder.mojom.ImageDecoder_DecodeAnimation_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for DecodeAnimation failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
