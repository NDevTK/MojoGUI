...
mojo.internal.Struct(
    mojo.internal.bindings.storage.mojom.StorageService_BindTestApi_ParamsSpec, 'storage.mojom.StorageService_BindTestApi_Params', [
      mojo.internal.StructField('arg_test_api_receiver', 0, 0, mojo.internal.Pointer, null, false, 0, undefined),
    ],
    [[0, 16]]);
...
mojo.internal.bindings.storage.mojom.StorageServiceRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.storage.mojom.StorageServicePendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.storage.mojom.StorageServiceRemoteCallHandler(this.proxy);
  }
  ...
  bindTestApi(arg_test_api_receiver) {
    return this.$.bindTestApi(arg_test_api_receiver);
  }
};

mojo.internal.bindings.storage.mojom.StorageServiceRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('storage.mojom.StorageService', [
      { explicit: null },
      { explicit: null },
      { explicit: null },
      { explicit: null },
...
mojo.internal.bindings.storage.mojom.StorageService.getRemote = function() {
  let remote = new mojo.internal.bindings.storage.mojom.StorageServiceRemote();
...
mojo.internal.bindings.storage.mojom.StorageServiceReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('storage.mojom.StorageService', [
      { explicit: null },
      { explicit: null },
      { explicit: null },
      { explicit: null },
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.storage.mojom.StorageService_EnableAggressiveDomStorageFlushing_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for EnableAggressiveDomStorageFlushing failed with TypeError');
           }
        }
        // Try Method 1: SetDataDirectory
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.storage.mojom.StorageService_SetDataDirectory_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for SetDataDirectory failed with TypeError');
           }
        }
        // Try Method 2: BindSessionStorageControl
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.storage.mojom.StorageService_BindSessionStorageControl_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for BindSessionStorageControl failed with TypeError');
           }
        }
        // Try Method 3: BindLocalStorageControl
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.storage.mojom.StorageService_BindLocalStorageControl_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for BindLocalStorageControl failed with TypeError');
           }
        }
        // Try Method 4: BindTestApi
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.storage.mojom.StorageService_BindTestApi_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for BindTestApi failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.storage.mojom.StorageService_EnableAggressiveDomStorageFlushing_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.storage.mojom.StorageServiceReceiver = mojo.internal.bindings.storage.mojom.StorageServiceReceiver;
