...
mojo.internal.Struct(
    mojo.internal.bindings.service_manager.mojom.Service_OnBindInterface_ResponseParamsSpec, 'service_manager.mojom.Service_OnBindInterface_ResponseParams', [
    ],
    [[0, 8]]);
...
mojo.internal.bindings.service_manager.mojom.ServiceRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.service_manager.mojom.ServicePendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.service_manager.mojom.ServiceRemoteCallHandler(this.proxy);
  }
  ...
  onStart(arg_identity) {
    return this.$.onStart(arg_identity);
  }
  onBindInterface(arg_source, arg_interface_name, arg_interface_pipe) {
    return this.$.onBindInterface(arg_source, arg_interface_name, arg_interface_pipe);
  }
  createPackagedServiceInstance(arg_identity, arg_receiver, arg_metadata) {
    return this.$.createPackagedServiceInstance(arg_identity, arg_receiver, arg_metadata);
  }
};
...
mojo.internal.bindings.service_manager.mojom.Service.getRemote = function() {
  let remote = new mojo.internal.bindings.service_manager.mojom.ServiceRemote();
...
mojo.internal.bindings.service_manager.mojom.ServiceReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.service_manager.mojom.Service_OnStart_ParamsSpec.$.structSpec;
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.service_manager.mojom.Service_OnBindInterface_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OnBindInterface failed with TypeError');
           }
        }
        // Try Method 2: CreatePackagedServiceInstance
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.service_manager.mojom.Service_CreatePackagedServiceInstance_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for CreatePackagedServiceInstance failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.service_manager.mojom.ServiceReceiver = mojo.internal.bindings.service_manager.mojom.ServiceReceiver;

mojo.internal.bindings.service_manager.mojom.ServicePtr = mojo.internal.bindings.service_manager.mojom.ServiceRemote;
mojo.internal.bindings.service_manager.mojom.ServiceRequest = mojo.internal.bindings.service_manager.mojom.ServicePendingReceiver;
