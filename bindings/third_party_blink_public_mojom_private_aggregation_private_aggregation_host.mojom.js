...
mojo.internal.Struct(
    mojo.internal.bindings.blink.mojom.DebugKeySpec, 'blink.mojom.DebugKey', [
...
mojo.internal.bindings.blink.mojom.PrivateAggregationHostPendingReceiver = class {
  constructor(handle) {
    this.handle = handle;
  }
};
...
mojo.internal.bindings.blink.mojom.PrivateAggregationHostRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.blink.mojom.PrivateAggregationHostRemoteCallHandler(this.proxy);
  }
  ...
  contributeToHistogram(arg_contributions) {
    return this.$.contributeToHistogram(arg_contributions);
  }
  contributeToHistogramOnEvent(arg_error_event, arg_contributions) {
    return this.$.contributeToHistogramOnEvent(arg_error_event, arg_contributions);
  }
  enableDebugMode(arg_debug_key) {
    return this.$.enableDebugMode(arg_debug_key);
  }
};
...
mojo.internal.bindings.blink.mojom.PrivateAggregationHost.getRemote = function() {
  let remote = new mojo.internal.bindings.blink.mojom.PrivateAggregationHostRemote();
...
mojo.internal.bindings.blink.mojom.PrivateAggregationHostReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.blink.mojom.PrivateAggregationHost_ContributeToHistogram_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for ContributeToHistogram failed with TypeError');
           }
        }
        // Try Method 1: ContributeToHistogramOnEvent
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.blink.mojom.PrivateAggregationHost_ContributeToHistogramOnEvent_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for ContributeToHistogramOnEvent failed with TypeError');
           }
        }
        // Try Method 2: EnableDebugMode
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.blink.mojom.PrivateAggregationHost_EnableDebugMode_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for EnableDebugMode failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.blink.mojom.PrivateAggregationHostReceiver = mojo.internal.bindings.blink.mojom.PrivateAggregationHostReceiver;

mojo.internal.bindings.blink.mojom.PrivateAggregationHostPtr = mojo.internal.bindings.blink.mojom.PrivateAggregationHostRemote;
mojo.internal.bindings.blink.mojom.PrivateAggregationHostRequest = mojo.internal.bindings.blink.mojom.PrivateAggregationHostPendingReceiver;
