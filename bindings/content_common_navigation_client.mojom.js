  ...
  $: {
    structSpec: {
      ...
      fields: [
        ...
        { name: 'previous_page_state', packedOffset: 72, packedBitOffset: 0, type: content.mojom.PageStateSpec, nullable: true },
        { name: 'page_state', packedOffset: 80, packedBitOffset: 0, type: content.mojom.PageStateSpec, nullable: false },
        { name: 'origin', packedOffset: 88, packedBitOffset: 0, type: url.mojom.OriginSpec, nullable: false },
        { name: 'initiator_base_url', packedOffset: 96, packedBitOffset: 0, type: url.mojom.UrlSpec, nullable: true },
        ...
        { name: 'insecure_request_policy', packedOffset: 120, packedBitOffset: 0, type: blink.mojom.InsecureRequestPolicySpec, nullable: false },
        { name: 'insecure_navigations_set', packedOffset: 128, packedBitOffset: 0, type: mojo.internal.Array, nullable: false },
        { name: 'navigation_token', packedOffset: 136, packedBitOffset: 0, type: mojo_base.mojom.UnguessableTokenSpec, nullable: false },
        { name: 'embedding_token', packedOffset: 144, packedBitOffset: 0, type: mojo_base.mojom.UnguessableTokenSpec, nullable: true },
        { name: 'unload_start', packedOffset: 152, packedBitOffset: 0, type: mojo_base.mojom.TimeTicksSpec, nullable: true },
        { name: 'unload_end', packedOffset: 160, packedBitOffset: 0, type: mojo_base.mojom.TimeTicksSpec, nullable: true },
        { name: 'commit_navigation_start', packedOffset: 168, packedBitOffset: 0, type: mojo_base.mojom.TimeTicksSpec, nullable: false },
        { name: 'commit_navigation_end', packedOffset: 176, packedBitOffset: 0, type: mojo_base.mojom.TimeTicksSpec, nullable: true },
        { name: 'commit_reply_sent', packedOffset: 184, packedBitOffset: 0, type: mojo_base.mojom.TimeTicksSpec, nullable: false },
  ...
  $: {
    structSpec: {
      ...
      fields: [
        ...
        { name: 'navigation_entry_screenshot_destination', packedOffset: 8, packedBitOffset: 0, type: blink.mojom.SameDocNavigationScreenshotDestinationTokenSpec, nullable: true },
        { name: 'same_document_metrics_token', packedOffset: 16, packedBitOffset: 0, type: mojo_base.mojom.UnguessableTokenSpec, nullable: false },
  ...
  $: {
    structSpec: {
      ...
      fields: [
        ...
        { name: 'document_token', packedOffset: 72, packedBitOffset: 0, type: blink.mojom.DocumentTokenSpec, nullable: false },
        { name: 'devtools_navigation_token', packedOffset: 80, packedBitOffset: 0, type: mojo_base.mojom.UnguessableTokenSpec, nullable: false },
        { name: 'base_auction_nonce', packedOffset: 88, packedBitOffset: 0, type: mojo_base.mojom.UuidSpec, nullable: false },
        { name: 'permissions_policy', packedOffset: 96, packedBitOffset: 0, type: mojo.internal.Array, nullable: true },
        { name: 'policy_container', packedOffset: 104, packedBitOffset: 0, type: blink.mojom.PolicyContainerSpec, nullable: false },
        { name: 'cookie_manager_info', packedOffset: 112, packedBitOffset: 0, type: content.mojom.CookieManagerInfoSpec, nullable: true },
        { name: 'storage_info', packedOffset: 120, packedBitOffset: 0, type: content.mojom.StorageInfoSpec, nullable: true },
  ...
  $: {
    structSpec: {
      ...
      fields: [
        ...
        { name: 'subresource_loader_factories', packedOffset: 32, packedBitOffset: 0, type: blink.mojom.URLLoaderFactoryBundleSpec, nullable: true },
        { name: 'document_token', packedOffset: 40, packedBitOffset: 0, type: blink.mojom.DocumentTokenSpec, nullable: false },
        { name: 'devtools_navigation_token', packedOffset: 48, packedBitOffset: 0, type: mojo_base.mojom.UnguessableTokenSpec, nullable: false },
        { name: 'policy_container', packedOffset: 56, packedBitOffset: 0, type: blink.mojom.PolicyContainerSpec, nullable: false },
        { name: 'alternative_error_page_info', packedOffset: 64, packedBitOffset: 0, type: content.mojom.AlternativeErrorPageOverrideInfoSpec, nullable: true },
