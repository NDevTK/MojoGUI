...
mojo.internal.bindings.blink.mojom.CodeCacheHostSpec = mojo.internal.bindings.blink.mojom.CodeCacheHostSpec || { $: mojo.internal.OpaqueStruct.$ };
mojo.internal.bindings.blink = mojo.internal.bindings.blink || {};
mojo.internal.bindings.blink.mojom = mojo.internal.bindings.blink.mojom || {};
...
mojo.internal.bindings.blink = mojo.internal.bindings.blink || {};
mojo.internal.bindings.blink.mojom = mojo.internal.bindings.blink.mojom || {};
mojo.internal.bindings.blink.mojom.FetchLaterLoaderFactorySpec = mojo.internal.bindings.blink.mojom.FetchLaterLoaderFactorySpec || { $: mojo.internal.OpaqueStruct.$ };
mojo.internal.bindings.blink = mojo.internal.bindings.blink || {};
mojo.internal.bindings.blink.mojom = mojo.internal.bindings.blink.mojom || {};
...
mojo.internal.bindings.content = mojo.internal.bindings.content || {};
mojo.internal.bindings.content.mojom = mojo.internal.bindings.content.mojom || {};
mojo.internal.bindings.content.mojom.AlternativeErrorPageOverrideInfoSpec = mojo.internal.bindings.content.mojom.AlternativeErrorPageOverrideInfoSpec || { $: mojo.internal.OpaqueStruct.$ };
mojo.internal.bindings.content = mojo.internal.bindings.content || {};
mojo.internal.bindings.content.mojom = mojo.internal.bindings.content.mojom || {};
mojo.internal.bindings.content.mojom.DidCommitProvisionalLoadInterfaceParamsSpec = mojo.internal.bindings.content.mojom.DidCommitProvisionalLoadInterfaceParamsSpec || { $: mojo.internal.OpaqueStruct.$ };
mojo.internal.bindings.content = mojo.internal.bindings.content || {};
mojo.internal.bindings.content.mojom = mojo.internal.bindings.content.mojom || {};
...
mojo.internal.Struct(
    mojo.internal.bindings.content.mojom.PageStateSpec, 'content.mojom.PageState', [
      ...
      mojo.internal.StructField('arg_contents_mime_type', 40, 0, mojo.internal.String, null, false, 0, undefined),
      mojo.internal.StructField('arg_method', 48, 0, mojo.internal.String, null, false, 0, undefined),
      mojo.internal.StructField('arg_post_id', 56, 0, mojo.internal.Int64, 0, false, 0, undefined),
      mojo.internal.StructField('arg_previous_page_state', 64, 0, mojo.internal.bindings.content.mojom.PageStateSpec, null, true, 0, undefined),
      mojo.internal.StructField('arg_page_state', 72, 0, mojo.internal.bindings.content.mojom.PageStateSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_origin', 80, 0, mojo.internal.bindings.url.mojom.OriginSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_initiator_base_url', 88, 0, mojo.internal.bindings.url.mojom.UrlSpec, null, true, 0, undefined),
      mojo.internal.StructField('arg_permissions_policy_header', 96, 0, mojo.internal.Array(mojo.internal.bindings.network.mojom.ParsedPermissionsPolicyDeclarationSpec, false), null, false, 0, undefined),
      mojo.internal.StructField('arg_document_policy_header', 104, 0, mojo.internal.Map(mojo.internal.bindings.blink.mojom.DocumentPolicyFeatureSpec, mojo.internal.bindings.blink.mojom.PolicyValueSpec, false), null, false, 0, undefined),
      mojo.internal.StructField('arg_insecure_navigations_set', 112, 0, mojo.internal.Array(mojo.internal.Uint32, false), null, false, 0, undefined),
      mojo.internal.StructField('arg_navigation_token', 120, 0, mojo.internal.bindings.mojo_base.mojom.UnguessableTokenSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_embedding_token', 128, 0, mojo.internal.bindings.mojo_base.mojom.UnguessableTokenSpec, null, true, 0, undefined),
      mojo.internal.StructField('arg_unload_start', 136, 0, mojo.internal.bindings.mojo_base.mojom.TimeTicksSpec, null, true, 0, undefined),
      mojo.internal.StructField('arg_unload_end', 144, 0, mojo.internal.bindings.mojo_base.mojom.TimeTicksSpec, null, true, 0, undefined),
      mojo.internal.StructField('arg_commit_navigation_start', 152, 0, mojo.internal.bindings.mojo_base.mojom.TimeTicksSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_commit_navigation_end', 160, 0, mojo.internal.bindings.mojo_base.mojom.TimeTicksSpec, null, true, 0, undefined),
      mojo.internal.StructField('arg_commit_reply_sent', 168, 0, mojo.internal.bindings.mojo_base.mojom.TimeTicksSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_transition', 176, 0, mojo.internal.bindings.content.mojom.PageTransitionSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_http_status_code', 180, 0, mojo.internal.Int32, 0, false, 0, undefined),
      mojo.internal.StructField('arg_insecure_request_policy', 184, 0, mojo.internal.bindings.blink.mojom.InsecureRequestPolicySpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_request_id', 188, 0, mojo.internal.Int32, 0, false, 0, undefined),
      mojo.internal.StructField('arg_should_update_history', 192, 0, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_did_create_new_entry', 192, 1, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_url_is_unreachable', 192, 2, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_is_overriding_user_agent', 192, 3, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_history_list_was_cleared', 192, 4, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_has_potentially_trustworthy_unique_origin', 192, 5, mojo.internal.Bool, false, false, 0, undefined),
    ],
    [[0, 208]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.content.mojom.DidCommitSameDocumentNavigationParamsSpec, 'content.mojom.DidCommitSameDocumentNavigationParams', [
      mojo.internal.StructField('arg_navigation_entry_screenshot_destination', 0, 0, mojo.internal.bindings.blink.mojom.SameDocNavigationScreenshotDestinationTokenSpec, null, true, 0, undefined),
      mojo.internal.StructField('arg_same_document_metrics_token', 8, 0, mojo.internal.bindings.mojo_base.mojom.UnguessableTokenSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_same_document_navigation_type', 16, 0, mojo.internal.bindings.blink.mojom.SameDocumentNavigationTypeSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_is_client_redirect', 20, 0, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_started_with_transient_activation', 20, 1, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_should_replace_current_entry', 20, 2, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_caused_by_ad', 20, 3, mojo.internal.Bool, false, false, 0, undefined),
    ],
    [[0, 32]]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.content.mojom.NavigationClient_CommitNavigation_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for CommitNavigation failed with TypeError');
           }
        }
        // Try Method 1: CommitFailedNavigation
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.content.mojom.NavigationClient_CommitFailedNavigation_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for CommitFailedNavigation failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
