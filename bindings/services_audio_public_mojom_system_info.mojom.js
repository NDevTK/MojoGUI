...
mojo.internal.bindings.audio.mojom.SystemInfoRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.audio.mojom.SystemInfoRemoteCallHandler(this.proxy);
  }
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.audio.mojom.SystemInfo_GetInputStreamParameters_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for GetInputStreamParameters failed with TypeError');
           }
        }
        // Try Method 1: GetOutputStreamParameters
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.audio.mojom.SystemInfo_GetOutputStreamParameters_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for GetOutputStreamParameters failed with TypeError');
           }
        }
        // Try Method 2: HasInputDevices
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.audio.mojom.SystemInfo_HasInputDevices_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for HasInputDevices failed with TypeError');
           }
        }
        // Try Method 3: HasOutputDevices
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.audio.mojom.SystemInfo_HasOutputDevices_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for HasOutputDevices failed with TypeError');
           }
        }
        // Try Method 4: GetInputDeviceDescriptions
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.audio.mojom.SystemInfo_GetInputDeviceDescriptions_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for GetInputDeviceDescriptions failed with TypeError');
           }
        }
        // Try Method 5: GetOutputDeviceDescriptions
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.audio.mojom.SystemInfo_GetOutputDeviceDescriptions_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for GetOutputDeviceDescriptions failed with TypeError');
           }
        }
        // Try Method 6: GetAssociatedOutputDeviceID
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.audio.mojom.SystemInfo_GetAssociatedOutputDeviceID_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for GetAssociatedOutputDeviceID failed with TypeError');
           }
        }
        // Try Method 7: GetInputDeviceInfo
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.audio.mojom.SystemInfo_GetInputDeviceInfo_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for GetInputDeviceInfo failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
      ...
      switch (dispatchId) {
        ...
        case 2: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.audio.mojom.SystemInfo_HasInputDevices_ParamsSpec.$.structSpec);
        ...
        case 3: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.audio.mojom.SystemInfo_HasOutputDevices_ParamsSpec.$.structSpec);
        ...
        case 4: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.audio.mojom.SystemInfo_GetInputDeviceDescriptions_ParamsSpec.$.structSpec);
        ...
        case 5: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.audio.mojom.SystemInfo_GetOutputDeviceDescriptions_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.audio.mojom.SystemInfoReceiver = mojo.internal.bindings.audio.mojom.SystemInfoReceiver;
