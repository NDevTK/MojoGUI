...
mojo.internal.bindings.blink.mojom.FontAccessManager.$interfaceName = 'blink.mojom.FontAccessManager';
...
mojo.internal.bindings.blink.mojom.FontEnumerationStatus = {
  kOk: 0,
  kUnimplemented: 1,
  kUnexpectedError: 2,
...
mojo.internal.Struct(
    mojo.internal.bindings.blink.mojom.FontAccessManager_EnumerateLocalFonts_ResponseParamsSpec, 'blink.mojom.FontAccessManager_EnumerateLocalFonts_ResponseParams', [
      mojo.internal.StructField('arg_enumeration_table', 0, 0, mojo.internal.bindings.mojo_base.mojom.ReadOnlySharedMemoryRegionSpec, null, true, 0, undefined),
      mojo.internal.StructField('arg_enumeration_status', 8, 0, mojo.internal.bindings.blink.mojom.FontEnumerationStatusSpec, null, false, 0, undefined),
    ],
    [[0, 24]]);
...
mojo.internal.bindings.blink.mojom.FontAccessManagerRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.blink.mojom.FontAccessManagerPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.blink.mojom.FontAccessManagerRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.blink.mojom.FontAccessManagerRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('blink.mojom.FontAccessManager', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.blink.mojom.FontAccessManager.getRemote = function() {
  let remote = new mojo.internal.bindings.blink.mojom.FontAccessManagerRemote();
...
mojo.internal.bindings.blink.mojom.FontAccessManagerReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('blink.mojom.FontAccessManager', [
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        // Try Method 0: EnumerateLocalFonts
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.blink.mojom.FontAccessManager_EnumerateLocalFonts_ParamsSpec.$.structSpec;
             ...
             if (sizeMatch && (!!(header.flags & 1) === methodExpectsResp)) {
               if (size > 8 || message.payload.byteLength === 8) {
                 ...
                 console.log('[GeneratedReceiver] Discovery SUCCESS: ' + header.ordinal + ' -> EnumerateLocalFonts (0)');
                 this.mapOrdinal(header.ordinal, 0);
                 dispatchId = 0;
               }
             }
           } catch (e) {
             if (e instanceof TypeError) console.warn('[Discovery] trial for EnumerateLocalFonts failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.blink.mojom.FontAccessManager_EnumerateLocalFonts_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.blink.mojom.FontAccessManagerReceiver = mojo.internal.bindings.blink.mojom.FontAccessManagerReceiver;
