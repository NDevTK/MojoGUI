...
mojo.internal.bindings.ai.mojom.ZeroStateSuggestionsServiceRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.ai.mojom.ZeroStateSuggestionsServicePendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.ai.mojom.ZeroStateSuggestionsServiceRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.ai.mojom.ZeroStateSuggestionsServiceRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('ai.mojom.ZeroStateSuggestionsService', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.ai.mojom.ZeroStateSuggestionsService.getRemote = function() {
  let remote = new mojo.internal.bindings.ai.mojom.ZeroStateSuggestionsServiceRemote();
...
mojo.internal.bindings.ai.mojom.ZeroStateSuggestionsServiceReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('ai.mojom.ZeroStateSuggestionsService', [
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.ai.mojom.ZeroStateSuggestionsService_FetchZeroStateSuggestions_ParamsSpec.$.structSpec);
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.ai.mojom.ZeroStateSuggestionsService_FetchZeroStateSuggestions_ParamsSpec.$.structSpec);
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.ai.mojom.ZeroStateSuggestionsService_FetchZeroStateSuggestions_ResponseParamsSpec, header, rawHeader);
               responder(response);
...
mojo.internal.bindings.ai.mojom.ZeroStateSuggestionsServiceReceiver = mojo.internal.bindings.ai.mojom.ZeroStateSuggestionsServiceReceiver;
