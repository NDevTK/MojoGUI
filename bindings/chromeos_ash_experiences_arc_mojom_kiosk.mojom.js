...
mojo.internal.Struct(
    mojo.internal.bindings.arc.mojom.KioskHost_OnMaintenanceSessionCreated_ParamsSpec, 'arc.mojom.KioskHost_OnMaintenanceSessionCreated_Params', [
      mojo.internal.StructField('arg_session_id', 0, 0, mojo.internal.Int32, 0, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.arc.mojom.KioskHost_OnMaintenanceSessionFinished_ParamsSpec, 'arc.mojom.KioskHost_OnMaintenanceSessionFinished_Params', [
      mojo.internal.StructField('arg_session_id', 0, 0, mojo.internal.Int32, 0, false, 0, undefined),
...
mojo.internal.bindings.arc.mojom.KioskHostRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.arc.mojom.KioskHostPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.arc.mojom.KioskHostRemoteCallHandler(this.proxy);
  }
  ...
  onMaintenanceSessionCreated(arg_session_id) {
    return this.$.onMaintenanceSessionCreated(arg_session_id);
  }
  onMaintenanceSessionFinished(arg_session_id, arg_succeeded) {
    return this.$.onMaintenanceSessionFinished(arg_session_id, arg_succeeded);
  }
};
...
mojo.internal.bindings.arc.mojom.KioskHost.getRemote = function() {
  let remote = new mojo.internal.bindings.arc.mojom.KioskHostRemote();
...
mojo.internal.bindings.arc.mojom.KioskHostReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.arc.mojom.KioskHost_OnMaintenanceSessionCreated_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OnMaintenanceSessionCreated failed with TypeError');
           }
        }
        // Try Method 1: OnMaintenanceSessionFinished
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.arc.mojom.KioskHost_OnMaintenanceSessionFinished_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OnMaintenanceSessionFinished failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.arc.mojom.KioskHostReceiver = mojo.internal.bindings.arc.mojom.KioskHostReceiver;

mojo.internal.bindings.arc.mojom.KioskHostPtr = mojo.internal.bindings.arc.mojom.KioskHostRemote;
mojo.internal.bindings.arc.mojom.KioskHostRequest = mojo.internal.bindings.arc.mojom.KioskHostPendingReceiver;
...
mojo.internal.Struct(
    mojo.internal.bindings.arc.mojom.KioskInstance_Init_ResponseParamsSpec, 'arc.mojom.KioskInstance_Init_ResponseParams', [
    ],
    [[0, 8]]);

mojo.internal.bindings.arc.mojom.KioskInstancePendingReceiver = class {
  constructor(handle) {
    this.handle = handle;
  }
};

mojo.internal.bindings.arc.mojom.KioskInstanceRemote = class {
  static get $interfaceName() {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.arc.mojom.KioskInstancePendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.arc.mojom.KioskInstanceRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.arc.mojom.KioskInstance.getRemote = function() {
  let remote = new mojo.internal.bindings.arc.mojom.KioskInstanceRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
...
mojo.internal.bindings.arc.mojom.KioskInstanceReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.arc.mojom.KioskInstance_Init_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
        ...
        case 0: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              this.endpoint.send(header.ordinal, header.requestId, mojo.internal.kMessageFlagIsResponse, mojo.internal.bindings.arc.mojom.KioskInstance_Init_ResponseParamsSpec, response);
...
mojo.internal.bindings.arc.mojom.KioskInstanceReceiver = mojo.internal.bindings.arc.mojom.KioskInstanceReceiver;

mojo.internal.bindings.arc.mojom.KioskInstancePtr = mojo.internal.bindings.arc.mojom.KioskInstanceRemote;
mojo.internal.bindings.arc.mojom.KioskInstanceRequest = mojo.internal.bindings.arc.mojom.KioskInstancePendingReceiver;
