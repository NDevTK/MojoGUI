...
mojo.internal.bindings.cros.mojom.CrosDocumentScannerRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.cros.mojom.CrosDocumentScannerPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.cros.mojom.CrosDocumentScannerRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.cros.mojom.CrosDocumentScannerRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('cros.mojom.CrosDocumentScanner', [
      { explicit: 0 },
    ]);
  }
...
mojo.internal.bindings.cros.mojom.CrosDocumentScanner.getRemote = function() {
  let remote = new mojo.internal.bindings.cros.mojom.CrosDocumentScannerRemote();
...
mojo.internal.bindings.cros.mojom.CrosDocumentScannerReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('cros.mojom.CrosDocumentScanner', [
      { explicit: 0 },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.cros.mojom.CrosDocumentScanner_DetectCornersFromNV12Image_ParamsSpec.$.structSpec);
        ...
        case 0: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.cros.mojom.CrosDocumentScanner_DetectCornersFromNV12Image_ResponseParamsSpec, header, rawHeader);
               responder(response);
...
mojo.internal.bindings.cros.mojom.CrosDocumentScannerReceiver = mojo.internal.bindings.cros.mojom.CrosDocumentScannerReceiver;
