...
mojo.internal.bindings.blink.mojom.BrowsingTopicsDocumentServiceRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.blink.mojom.BrowsingTopicsDocumentServicePendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.blink.mojom.BrowsingTopicsDocumentServiceRemoteCallHandler(this.proxy);
  }
  ...
  getBrowsingTopics(arg_observe) {
    return this.$.getBrowsingTopics(arg_observe);
  }
};

mojo.internal.bindings.blink.mojom.BrowsingTopicsDocumentServiceRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('blink.mojom.BrowsingTopicsDocumentService', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.blink.mojom.BrowsingTopicsDocumentService.getRemote = function() {
  let remote = new mojo.internal.bindings.blink.mojom.BrowsingTopicsDocumentServiceRemote();
...
mojo.internal.bindings.blink.mojom.BrowsingTopicsDocumentServiceReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('blink.mojom.BrowsingTopicsDocumentService', [
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        // Try Method 0: GetBrowsingTopics
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.blink.mojom.BrowsingTopicsDocumentService_GetBrowsingTopics_ParamsSpec.$.structSpec;
             ...
             if (sizeMatch && (!!(header.flags & 1) === methodExpectsResp)) {
               if (size > 8 || message.payload.byteLength === 8) {
                 ...
                 console.log('[GeneratedReceiver] Discovery SUCCESS: ' + header.ordinal + ' -> GetBrowsingTopics (0)');
                 this.mapOrdinal(header.ordinal, 0);
                 dispatchId = 0;
               }
             }
           } catch (e) {
             if (e instanceof TypeError) console.warn('[Discovery] trial for GetBrowsingTopics failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.blink.mojom.BrowsingTopicsDocumentServiceReceiver = mojo.internal.bindings.blink.mojom.BrowsingTopicsDocumentServiceReceiver;
