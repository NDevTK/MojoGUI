...
mojo.internal.bindings.blink.mojom.OriginTrialStateHostPendingReceiver = class {
  constructor(handle) {
    this.handle = handle;
  }
};

mojo.internal.bindings.blink.mojom.OriginTrialStateHostRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.blink.mojom.OriginTrialStateHostPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.blink.mojom.OriginTrialStateHostRemoteCallHandler(this.proxy);
  }
  ...
  applyFeatureDiffForOriginTrial(arg_origin_trial_features) {
    return this.$.applyFeatureDiffForOriginTrial(arg_origin_trial_features);
  }
  enablePersistentTrial(arg_token, arg_script_origins) {
    return this.$.enablePersistentTrial(arg_token, arg_script_origins);
  }
};
...
mojo.internal.bindings.blink.mojom.OriginTrialStateHost.getRemote = function() {
  let remote = new mojo.internal.bindings.blink.mojom.OriginTrialStateHostRemote();
...
mojo.internal.bindings.blink.mojom.OriginTrialStateHostReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.blink.mojom.OriginTrialStateHost_ApplyFeatureDiffForOriginTrial_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for ApplyFeatureDiffForOriginTrial failed with TypeError');
           }
        }
        // Try Method 1: EnablePersistentTrial
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.blink.mojom.OriginTrialStateHost_EnablePersistentTrial_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for EnablePersistentTrial failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.blink.mojom.OriginTrialStateHostReceiver = mojo.internal.bindings.blink.mojom.OriginTrialStateHostReceiver;

mojo.internal.bindings.blink.mojom.OriginTrialStateHostPtr = mojo.internal.bindings.blink.mojom.OriginTrialStateHostRemote;
mojo.internal.bindings.blink.mojom.OriginTrialStateHostRequest = mojo.internal.bindings.blink.mojom.OriginTrialStateHostPendingReceiver;
