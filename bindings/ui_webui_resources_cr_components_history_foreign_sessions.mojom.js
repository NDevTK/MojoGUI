// Auto-generated MojoJS binding
 // Source: chromium_src/ui/webui/resources/cr_components/history/foreign_sessions.mojom
 ...
 mojo.internal.bindings.history = mojo.internal.bindings.history || {};
...
mojo.internal.bindings.history.mojom.ForeignSessionTabSpec = mojo.internal.bindings.history.mojom.ForeignSessionTabSpec || { $: {} };
if (mojo.internal.bindings.history.mojom.ForeignSessionTabSpec.$.structSpec && mojo.internal.bindings.history.mojom.ForeignSessionTabSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.history.mojom.ForeignSessionTabSpec.$ = {};
mojo.internal.bindings.history.mojom.ForeignSessionWindowSpec = mojo.internal.bindings.history.mojom.ForeignSessionWindowSpec || { $: {} };
if (mojo.internal.bindings.history.mojom.ForeignSessionWindowSpec.$.structSpec && mojo.internal.bindings.history.mojom.ForeignSessionWindowSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.history.mojom.ForeignSessionWindowSpec.$ = {};
mojo.internal.bindings.history.mojom.ForeignSessionSpec = mojo.internal.bindings.history.mojom.ForeignSessionSpec || { $: {} };
if (mojo.internal.bindings.history.mojom.ForeignSessionSpec.$.structSpec && mojo.internal.bindings.history.mojom.ForeignSessionSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.history.mojom.ForeignSessionSpec.$ = {};
mojo.internal.bindings.history.mojom.ForeignSessionPageHandlerFactory = mojo.internal.bindings.history.mojom.ForeignSessionPageHandlerFactory || {};
mojo.internal.bindings.history.mojom.ForeignSessionPageHandlerFactorySpec = mojo.internal.bindings.history.mojom.ForeignSessionPageHandlerFactorySpec || { $ : {} };
if (mojo.internal.bindings.history.mojom.ForeignSessionPageHandlerFactorySpec.$.structSpec && mojo.internal.bindings.history.mojom.ForeignSessionPageHandlerFactorySpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.history.mojom.ForeignSessionPageHandlerFactorySpec.$ = {};
mojo.internal.bindings.history.mojom.ForeignSessionPageHandlerFactory.$interfaceName = 'history.mojom.ForeignSessionPageHandlerFactory';
mojo.internal.bindings.history.mojom.ForeignSessionPageHandlerFactory_CreateForeignSessionPageHandler_ParamsSpec = mojo.internal.bindings.history.mojom.ForeignSessionPageHandlerFactory_CreateForeignSessionPageHandler_ParamsSpec || { $: {} };
if (mojo.internal.bindings.history.mojom.ForeignSessionPageHandlerFactory_CreateForeignSessionPageHandler_ParamsSpec.$.structSpec && mojo.internal.bindings.history.mojom.ForeignSessionPageHandlerFactory_CreateForeignSessionPageHandler_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.history.mojom.ForeignSessionPageHandlerFactory_CreateForeignSessionPageHandler_ParamsSpec.$ = {};
mojo.internal.bindings.history.mojom.ForeignSessionPageHandler = mojo.internal.bindings.history.mojom.ForeignSessionPageHandler || {};
mojo.internal.bindings.history.mojom.ForeignSessionPageHandlerSpec = mojo.internal.bindings.history.mojom.ForeignSessionPageHandlerSpec || { $ : {} };
if (mojo.internal.bindings.history.mojom.ForeignSessionPageHandlerSpec.$.structSpec && mojo.internal.bindings.history.mojom.ForeignSessionPageHandlerSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.history.mojom.ForeignSessionPageHandlerSpec.$ = {};
mojo.internal.bindings.history.mojom.ForeignSessionPageHandler.$interfaceName = 'history.mojom.ForeignSessionPageHandler';
mojo.internal.bindings.history.mojom.ForeignSessionPageHandler_GetForeignSessions_ParamsSpec = mojo.internal.bindings.history.mojom.ForeignSessionPageHandler_GetForeignSessions_ParamsSpec || { $: {} };
if (mojo.internal.bindings.history.mojom.ForeignSessionPageHandler_GetForeignSessions_ParamsSpec.$.structSpec && mojo.internal.bindings.history.mojom.ForeignSessionPageHandler_GetForeignSessions_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.history.mojom.ForeignSessionPageHandler_GetForeignSessions_ParamsSpec.$ = {};
mojo.internal.bindings.history.mojom.ForeignSessionPageHandler_GetForeignSessions_ResponseParamsSpec = mojo.internal.bindings.history.mojom.ForeignSessionPageHandler_GetForeignSessions_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.history.mojom.ForeignSessionPageHandler_GetForeignSessions_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.history.mojom.ForeignSessionPageHandler_GetForeignSessions_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.history.mojom.ForeignSessionPageHandler_GetForeignSessions_ResponseParamsSpec.$ = {};
mojo.internal.bindings.history.mojom.ForeignSessionPageHandler_OpenForeignSessionAllTabs_ParamsSpec = mojo.internal.bindings.history.mojom.ForeignSessionPageHandler_OpenForeignSessionAllTabs_ParamsSpec || { $: {} };
if (mojo.internal.bindings.history.mojom.ForeignSessionPageHandler_OpenForeignSessionAllTabs_ParamsSpec.$.structSpec && mojo.internal.bindings.history.mojom.ForeignSessionPageHandler_OpenForeignSessionAllTabs_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.history.mojom.ForeignSessionPageHandler_OpenForeignSessionAllTabs_ParamsSpec.$ = {};
mojo.internal.bindings.history.mojom.ForeignSessionPageHandler_OpenForeignSessionTab_ParamsSpec = mojo.internal.bindings.history.mojom.ForeignSessionPageHandler_OpenForeignSessionTab_ParamsSpec || { $: {} };
if (mojo.internal.bindings.history.mojom.ForeignSessionPageHandler_OpenForeignSessionTab_ParamsSpec.$.structSpec && mojo.internal.bindings.history.mojom.ForeignSessionPageHandler_OpenForeignSessionTab_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.history.mojom.ForeignSessionPageHandler_OpenForeignSessionTab_ParamsSpec.$ = {};
mojo.internal.bindings.history.mojom.ForeignSessionPageHandler_DeleteForeignSession_ParamsSpec = mojo.internal.bindings.history.mojom.ForeignSessionPageHandler_DeleteForeignSession_ParamsSpec || { $: {} };
...
mojo.internal.bindings.history.mojom.ForeignSessionPage.$interfaceName = 'history.mojom.ForeignSessionPage';
mojo.internal.bindings.history.mojom.ForeignSessionPage_OnForeignSessionsChanged_ParamsSpec = mojo.internal.bindings.history.mojom.ForeignSessionPage_OnForeignSessionsChanged_ParamsSpec || { $: {} };
if (mojo.internal.bindings.history.mojom.ForeignSessionPage_OnForeignSessionsChanged_ParamsSpec.$.structSpec && mojo.internal.bindings.history.mojom.ForeignSessionPage_OnForeignSessionsChanged_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.history.mojom.ForeignSessionPage_OnForeignSessionsChanged_ParamsSpec.$ = {};
...
// Interface: ForeignSessionPageHandlerFactory
mojo.internal.bindings.history.mojom.ForeignSessionPageHandlerFactoryPendingReceiver = class {
  constructor(handle) {
    this.handle = handle;
    if (handle) {
...
mojo.internal.bindings.history.mojom.ForeignSessionPageHandlerFactoryRemote = class {
  static get $interfaceName() {
    return 'history.mojom.ForeignSessionPageHandlerFactory';
  }

  constructor(handle = undefined) {
    this.__mojoHandle = handle;
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.history.mojom.ForeignSessionPageHandlerFactoryPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.history.mojom.ForeignSessionPageHandlerFactoryRemoteCallHandler(this.proxy);
  }
  ...
  createForeignSessionPageHandler(arg_page, arg_handler) {
    return this.$.createForeignSessionPageHandler(arg_page, arg_handler);
  }
};

mojo.internal.bindings.history.mojom.ForeignSessionPageHandlerFactoryRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('history.mojom.ForeignSessionPageHandlerFactory', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.history.mojom.ForeignSessionPageHandlerFactory.getRemote = function() {
  let remote = new mojo.internal.bindings.history.mojom.ForeignSessionPageHandlerFactoryRemote();
...
mojo.internal.bindings.history.mojom.ForeignSessionPageHandlerFactoryReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('history.mojom.ForeignSessionPageHandlerFactory', [
      { explicit: null },
    ]);
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        case 0: {
          ...
          const params = decoder.decodeStructInline(mojo.internal.bindings.history.mojom.ForeignSessionPageHandlerFactory_CreateForeignSessionPageHandler_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.createForeignSessionPageHandler');
          const result = this.impl.createForeignSessionPageHandler(params.arg_page, params.arg_handler);
          break;
        }
      }
      } catch (err) {
...
mojo.internal.bindings.history.mojom.ForeignSessionPageHandlerFactoryReceiver = mojo.internal.bindings.history.mojom.ForeignSessionPageHandlerFactoryReceiver;

mojo.internal.bindings.history.mojom.ForeignSessionPageHandlerFactoryPtr = mojo.internal.bindings.history.mojom.ForeignSessionPageHandlerFactoryRemote;
mojo.internal.bindings.history.mojom.ForeignSessionPageHandlerFactoryRequest = mojo.internal.bindings.history.mojom.ForeignSessionPageHandlerFactoryPendingReceiver;


// Interface: ForeignSessionPageHandler
mojo.internal.bindings.history.mojom.ForeignSessionPageHandlerPendingReceiver = class {
  constructor(handle) {
    this.handle = handle;
    if (handle) {
      this.__mojoHandle = handle.router_ ? handle.router_.pipe_ : (handle.pipe_ || handle);
...
mojo.internal.bindings.history.mojom.ForeignSessionPageHandlerRemote = class {
  static get $interfaceName() {
    return 'history.mojom.ForeignSessionPageHandler';
  }

  constructor(handle = undefined) {
    this.__mojoHandle = handle;
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.history.mojom.ForeignSessionPageHandlerPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.history.mojom.ForeignSessionPageHandlerRemoteCallHandler(this.proxy);
  }
  ...
  getForeignSessions() {
    return this.$.getForeignSessions();
  }
  openForeignSessionAllTabs(arg_session_tag) {
    return this.$.openForeignSessionAllTabs(arg_session_tag);
  }
  openForeignSessionTab(arg_session_tag, arg_tab_id, arg_modifiers) {
    return this.$.openForeignSessionTab(arg_session_tag, arg_tab_id, arg_modifiers);
  }
  deleteForeignSession(arg_session_tag) {
    return this.$.deleteForeignSession(arg_session_tag);
  }
...
mojo.internal.bindings.history.mojom.ForeignSessionPageHandlerRemoteCallHandler = class {
  ...
  openForeignSessionTab(arg_session_tag, arg_tab_id, arg_modifiers) {
    return this.proxy.sendMessage(
      ...
      mojo.internal.bindings.history.mojom.ForeignSessionPageHandler_OpenForeignSessionTab_ParamsSpec,
      null,
      [arg_session_tag, arg_tab_id, arg_modifiers],
      false);
  }
...
mojo.internal.bindings.history.mojom.ForeignSessionPageHandler.getRemote = function() {
  let remote = new mojo.internal.bindings.history.mojom.ForeignSessionPageHandlerRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
    'history.mojom.ForeignSessionPageHandler',
    'context');
  return remote.$;
};

mojo.internal.bindings.history.mojom.ForeignSessionPageHandlerReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.history.mojom.ForeignSessionPageHandler_GetForeignSessions_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.getForeignSessions');
          const result = this.impl.getForeignSessions();
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const message = new mojo.internal.Message(
                ...
                header.ordinal, header.requestId, mojo.internal.bindings.history.mojom.ForeignSessionPageHandler_GetForeignSessions_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
            }).catch(e => console.error('[GeneratedReceiver] getForeignSessions FAILED:', e));
          }
          break;
        }
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.history.mojom.ForeignSessionPageHandler_OpenForeignSessionAllTabs_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.openForeignSessionAllTabs');
          const result = this.impl.openForeignSessionAllTabs(params.arg_session_tag);
          break;
        }
        case 2: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.history.mojom.ForeignSessionPageHandler_OpenForeignSessionTab_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.openForeignSessionTab');
          const result = this.impl.openForeignSessionTab(params.arg_session_tag, params.arg_tab_id, params.arg_modifiers);
          break;
        }
        case 3: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.history.mojom.ForeignSessionPageHandler_DeleteForeignSession_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.deleteForeignSession');
          const result = this.impl.deleteForeignSession(params.arg_session_tag);
          break;
        }
        case 4: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
...
mojo.internal.bindings.history.mojom.ForeignSessionPageHandlerReceiver = mojo.internal.bindings.history.mojom.ForeignSessionPageHandlerReceiver;

mojo.internal.bindings.history.mojom.ForeignSessionPageHandlerPtr = mojo.internal.bindings.history.mojom.ForeignSessionPageHandlerRemote;
mojo.internal.bindings.history.mojom.ForeignSessionPageHandlerRequest = mojo.internal.bindings.history.mojom.ForeignSessionPageHandlerPendingReceiver;


// Interface: ForeignSessionPage
mojo.internal.bindings.history.mojom.ForeignSessionPagePendingReceiver = class {
  constructor(handle) {
    this.handle = handle;
    if (handle) {
      this.__mojoHandle = handle.router_ ? handle.router_.pipe_ : (handle.pipe_ || handle);
...
mojo.internal.bindings.history.mojom.ForeignSessionPageRemote = class {
  static get $interfaceName() {
    return 'history.mojom.ForeignSessionPage';
  }

  constructor(handle = undefined) {
    this.__mojoHandle = handle;
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.history.mojom.ForeignSessionPagePendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.history.mojom.ForeignSessionPageRemoteCallHandler(this.proxy);
  }
  ...
  onForeignSessionsChanged(arg_sessions) {
    return this.$.onForeignSessionsChanged(arg_sessions);
  }
};

mojo.internal.bindings.history.mojom.ForeignSessionPageRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('history.mojom.ForeignSessionPage', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.history.mojom.ForeignSessionPage.getRemote = function() {
  let remote = new mojo.internal.bindings.history.mojom.ForeignSessionPageRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
    'history.mojom.ForeignSessionPage',
    'context');
  return remote.$;
};

mojo.internal.bindings.history.mojom.ForeignSessionPageReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('history.mojom.ForeignSessionPage', [
      { explicit: null },
    ]);
    ordinals.forEach((ord, idx) => {
      this.ordinalMap.set(ord, idx); // Scrambled/Explicit
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.history.mojom.ForeignSessionPage_OnForeignSessionsChanged_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.onForeignSessionsChanged');
          const result = this.impl.onForeignSessionsChanged(params.arg_sessions);
          break;
        }
      }
      } catch (err) {
...
mojo.internal.bindings.history.mojom.ForeignSessionPageReceiver = mojo.internal.bindings.history.mojom.ForeignSessionPageReceiver;

mojo.internal.bindings.history.mojom.ForeignSessionPagePtr = mojo.internal.bindings.history.mojom.ForeignSessionPageRemote;
mojo.internal.bindings.history.mojom.ForeignSessionPageRequest = mojo.internal.bindings.history.mojom.ForeignSessionPagePendingReceiver;
...
mojo.internal.Struct(
    mojo.internal.bindings.history.mojom.ForeignSessionTabSpec, 'history.mojom.ForeignSessionTab', [
      mojo.internal.StructField('arg_direction', 0, 0, mojo.internal.String, null, false, 0, undefined),
      mojo.internal.StructField('arg_remote_icon_url_for_uma', 8, 0, mojo.internal.String, null, false, 0, undefined),
...
mojo.internal.Struct(
    mojo.internal.bindings.history.mojom.ForeignSessionWindowSpec, 'history.mojom.ForeignSessionWindow', [
      ...
      mojo.internal.StructField('arg_tabs', 16, 0, mojo.internal.Array(mojo.internal.bindings.history.mojom.ForeignSessionTabSpec, false), null, false, 0, undefined),
    ],
    [[0, 32]]);

// Struct: ForeignSession
mojo.internal.Struct(
    mojo.internal.bindings.history.mojom.ForeignSessionSpec, 'history.mojom.ForeignSession', [
      mojo.internal.StructField('arg_tag', 0, 0, mojo.internal.String, null, false, 0, undefined),
      mojo.internal.StructField('arg_name', 8, 0, mojo.internal.String, null, false, 0, undefined),
      mojo.internal.StructField('arg_modified_time', 16, 0, mojo.internal.String, null, false, 0, undefined),
      mojo.internal.StructField('arg_timestamp', 24, 0, mojo.internal.Double, 0, false, 0, undefined),
      mojo.internal.StructField('arg_collapsed', 32, 0, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_windows', 40, 0, mojo.internal.Array(mojo.internal.bindings.history.mojom.ForeignSessionWindowSpec, false), null, false, 0, undefined),
    ],
    [[0, 56]]);
mojo.internal.Struct(
    mojo.internal.bindings.history.mojom.ForeignSessionPageHandlerFactory_CreateForeignSessionPageHandler_ParamsSpec, 'history.mojom.ForeignSessionPageHandlerFactory_CreateForeignSessionPageHandler_Params', [
      mojo.internal.StructField('arg_page', 0, 0, mojo.internal.InterfaceProxy(mojo.internal.bindings.history.mojom.ForeignSessionPageRemote), null, false, 0, undefined),
      mojo.internal.StructField('arg_handler', 8, 0, mojo.internal.InterfaceRequest(mojo.internal.bindings.history.mojom.ForeignSessionPageHandlerPendingReceiver), null, false, 0, undefined),
    ],
    [[0, 24]]);

mojo.internal.Struct(
    mojo.internal.bindings.history.mojom.ForeignSessionPageHandler_GetForeignSessions_ParamsSpec, 'history.mojom.ForeignSessionPageHandler_GetForeignSessions_Params', [
    ],
    [[0, 8]]);

mojo.internal.Struct(
    mojo.internal.bindings.history.mojom.ForeignSessionPageHandler_GetForeignSessions_ResponseParamsSpec, 'history.mojom.ForeignSessionPageHandler_GetForeignSessions_ResponseParams', [
      mojo.internal.StructField('arg_sessions', 0, 0, mojo.internal.Array(mojo.internal.bindings.history.mojom.ForeignSessionSpec, false), null, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.history.mojom.ForeignSessionPageHandler_OpenForeignSessionAllTabs_ParamsSpec, 'history.mojom.ForeignSessionPageHandler_OpenForeignSessionAllTabs_Params', [
      mojo.internal.StructField('arg_session_tag', 0, 0, mojo.internal.String, null, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.history.mojom.ForeignSessionPageHandler_OpenForeignSessionTab_ParamsSpec, 'history.mojom.ForeignSessionPageHandler_OpenForeignSessionTab_Params', [
      mojo.internal.StructField('arg_session_tag', 0, 0, mojo.internal.String, null, false, 0, undefined),
      mojo.internal.StructField('arg_tab_id', 8, 0, mojo.internal.Int32, 0, false, 0, undefined),
      mojo.internal.StructField('arg_modifiers', 16, 0, mojo.internal.bindings.ui.mojom.ClickModifiersSpec, null, false, 0, undefined),
    ],
    [[0, 32]]);

mojo.internal.Struct(
    mojo.internal.bindings.history.mojom.ForeignSessionPageHandler_DeleteForeignSession_ParamsSpec, 'history.mojom.ForeignSessionPageHandler_DeleteForeignSession_Params', [
      mojo.internal.StructField('arg_session_tag', 0, 0, mojo.internal.String, null, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.history.mojom.ForeignSessionPageHandler_SetForeignSessionCollapsed_ParamsSpec, 'history.mojom.ForeignSessionPageHandler_SetForeignSessionCollapsed_Params', [
      mojo.internal.StructField('arg_session_tag', 0, 0, mojo.internal.String, null, false, 0, undefined),
