...
mojo.internal.Struct(
    mojo.internal.bindings.blink.mojom.ServiceWorkerScriptInfoSpec, 'blink.mojom.ServiceWorkerScriptInfo', [
      ...
      mojo.internal.StructField('arg_meta_data', 40, 0, mojo.internal.Pointer, null, true, 0, undefined),
...
mojo.internal.bindings.blink.mojom.ServiceWorkerInstalledScriptsManagerHostRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.blink.mojom.ServiceWorkerInstalledScriptsManagerHostPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.blink.mojom.ServiceWorkerInstalledScriptsManagerHostRemoteCallHandler(this.proxy);
  }
  ...
  requestInstalledScript(arg_script_url) {
    return this.$.requestInstalledScript(arg_script_url);
  }
};
...
mojo.internal.bindings.blink.mojom.ServiceWorkerInstalledScriptsManagerHost.getRemote = function() {
  let remote = new mojo.internal.bindings.blink.mojom.ServiceWorkerInstalledScriptsManagerHostRemote();
...
mojo.internal.bindings.blink.mojom.ServiceWorkerInstalledScriptsManagerHostReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.blink.mojom.ServiceWorkerInstalledScriptsManagerHost_RequestInstalledScript_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for RequestInstalledScript failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.blink.mojom.ServiceWorkerInstalledScriptsManagerHostReceiver = mojo.internal.bindings.blink.mojom.ServiceWorkerInstalledScriptsManagerHostReceiver;

mojo.internal.bindings.blink.mojom.ServiceWorkerInstalledScriptsManagerHostPtr = mojo.internal.bindings.blink.mojom.ServiceWorkerInstalledScriptsManagerHostRemote;
mojo.internal.bindings.blink.mojom.ServiceWorkerInstalledScriptsManagerHostRequest = mojo.internal.bindings.blink.mojom.ServiceWorkerInstalledScriptsManagerHostPendingReceiver;
...
mojo.internal.bindings.blink.mojom.ServiceWorkerInstalledScriptsManagerRemote = class {
  static get $interfaceName() {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.blink.mojom.ServiceWorkerInstalledScriptsManagerPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.blink.mojom.ServiceWorkerInstalledScriptsManagerRemoteCallHandler(this.proxy);
  }
  ...
  transferInstalledScript(arg_script_info) {
    return this.$.transferInstalledScript(arg_script_info);
  }
};
...
mojo.internal.bindings.blink.mojom.ServiceWorkerInstalledScriptsManager.getRemote = function() {
  let remote = new mojo.internal.bindings.blink.mojom.ServiceWorkerInstalledScriptsManagerRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
...
mojo.internal.bindings.blink.mojom.ServiceWorkerInstalledScriptsManagerReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.blink.mojom.ServiceWorkerInstalledScriptsManager_TransferInstalledScript_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for TransferInstalledScript failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
             console.warn('[GeneratedReceiver] Failed to discover ordinal ' + header.ordinal);
...
mojo.internal.bindings.blink.mojom.ServiceWorkerInstalledScriptsManagerReceiver = mojo.internal.bindings.blink.mojom.ServiceWorkerInstalledScriptsManagerReceiver;
