...
mojo.internal.bindings.storage.mojom.DisallowInactiveClientReason = {
...
mojo.internal.Struct(
    mojo.internal.bindings.storage.mojom.IndexedDBClientStateChecker_DisallowInactiveClient_ParamsSpec, 'storage.mojom.IndexedDBClientStateChecker_DisallowInactiveClient_Params', [
      mojo.internal.StructField('arg_keep_active', 0, 0, mojo.internal.InterfaceRequest(mojo.internal.bindings.storage.mojom.IndexedDBClientKeepActiveRemote), null, true, 0, undefined),
      mojo.internal.StructField('arg_connection_id', 8, 0, mojo.internal.Int32, 0, false, 0, undefined),
      mojo.internal.StructField('arg_reason', 12, 0, mojo.internal.bindings.storage.mojom.DisallowInactiveClientReasonSpec, null, false, 0, undefined),
    ],
    [[0, 24]]);
...
mojo.internal.bindings.storage.mojom.IndexedDBClientStateCheckerRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.storage.mojom.IndexedDBClientStateCheckerRemoteCallHandler(this.proxy);
  }
  ...
  disallowInactiveClient(arg_connection_id, arg_reason, arg_keep_active) {
    return this.$.disallowInactiveClient(arg_connection_id, arg_reason, arg_keep_active);
  }
  makeClone(arg_receiver) {
    return this.$.makeClone(arg_receiver);
  }
};
...
mojo.internal.bindings.storage.mojom.IndexedDBClientStateChecker.getRemote = function() {
  let remote = new mojo.internal.bindings.storage.mojom.IndexedDBClientStateCheckerRemote();
...
mojo.internal.bindings.storage.mojom.IndexedDBClientStateCheckerReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.storage.mojom.IndexedDBClientStateChecker_DisallowInactiveClient_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for DisallowInactiveClient failed with TypeError');
           }
        }
        // Try Method 1: MakeClone
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.storage.mojom.IndexedDBClientStateChecker_MakeClone_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for MakeClone failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.storage.mojom.IndexedDBClientStateCheckerReceiver = mojo.internal.bindings.storage.mojom.IndexedDBClientStateCheckerReceiver;

mojo.internal.bindings.storage.mojom.IndexedDBClientStateCheckerPtr = mojo.internal.bindings.storage.mojom.IndexedDBClientStateCheckerRemote;
mojo.internal.bindings.storage.mojom.IndexedDBClientStateCheckerRequest = mojo.internal.bindings.storage.mojom.IndexedDBClientStateCheckerPendingReceiver;


// Interface: IndexedDBClientKeepActive
mojo.internal.bindings.storage.mojom.IndexedDBClientKeepActivePendingReceiver = class {
  constructor(handle) {
    this.handle = handle;
  }
};

mojo.internal.bindings.storage.mojom.IndexedDBClientKeepActiveRemote = class {
  static get $interfaceName() {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.storage.mojom.IndexedDBClientKeepActivePendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.storage.mojom.IndexedDBClientKeepActiveRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.storage.mojom.IndexedDBClientKeepActive.getRemote = function() {
  let remote = new mojo.internal.bindings.storage.mojom.IndexedDBClientKeepActiveRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
...
mojo.internal.bindings.storage.mojom.IndexedDBClientKeepActiveReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
...
mojo.internal.bindings.storage.mojom.IndexedDBClientKeepActiveReceiver = mojo.internal.bindings.storage.mojom.IndexedDBClientKeepActiveReceiver;
