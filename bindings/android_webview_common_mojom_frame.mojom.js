...
mojo.internal.bindings.android_webview.mojom.EmbedderTransferableMessageSpec = mojo.internal.bindings.android_webview.mojom.EmbedderTransferableMessageSpec || { $: {} };
if (mojo.internal.bindings.android_webview.mojom.EmbedderTransferableMessageSpec.$.structSpec && mojo.internal.bindings.android_webview.mojom.EmbedderTransferableMessageSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.android_webview.mojom.EmbedderTransferableMessageSpec.$ = {};
...
mojo.internal.bindings.android_webview.mojom.LocalMainFrame_PostEmbedderMessageEvent_ParamsSpec = mojo.internal.bindings.android_webview.mojom.LocalMainFrame_PostEmbedderMessageEvent_ParamsSpec || { $: {} };
if (mojo.internal.bindings.android_webview.mojom.LocalMainFrame_PostEmbedderMessageEvent_ParamsSpec.$.structSpec && mojo.internal.bindings.android_webview.mojom.LocalMainFrame_PostEmbedderMessageEvent_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.android_webview.mojom.LocalMainFrame_PostEmbedderMessageEvent_ParamsSpec.$ = {};
...
mojo.internal.bindings.android_webview.mojom.LocalMainFrameRemote = class {
  ...
  postEmbedderMessageEvent(arg_target_origin, arg_message) {
    return this.$.postEmbedderMessageEvent(arg_target_origin, arg_message);
  }
};
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        ...
        case 5: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.android_webview.mojom.LocalMainFrame_PostEmbedderMessageEvent_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.postEmbedderMessageEvent');
          const result = this.impl.postEmbedderMessageEvent(params.arg_target_origin, params.arg_message);
          break;
        }
      }
      } catch (err) {
...
mojo.internal.bindings.android_webview.mojom.FrameHostRemote = class {
  ...
  shouldOverrideUrlLoading(arg_url, arg_has_user_gesture) {
    return this.$.shouldOverrideUrlLoading(arg_url, arg_has_user_gesture);
  }
};
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        ...
        case 2: {
          ...
          const result = this.impl.shouldOverrideUrlLoading(params.arg_url, params.arg_has_user_gesture);
          const expectsResponse = header.expectsResponse || (header.flags & 1);
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
...
// Struct: EmbedderTransferableMessage
mojo.internal.Struct(
    mojo.internal.bindings.android_webview.mojom.EmbedderTransferableMessageSpec, 'android_webview.mojom.EmbedderTransferableMessage', [
      mojo.internal.StructField('arg_ports', 0, 0, mojo.internal.Array(mojo.internal.bindings.blink.mojom.MessagePortDescriptorSpec, false), null, false, 0, undefined),
      mojo.internal.StructField('arg_shared_array_buffer', 8, 0, mojo.internal.bindings.mojo_base.mojom.UnsafeSharedMemoryRegionSpec, null, false, 0, undefined),
    ],
    [[0, 24]]);
mojo.internal.Struct(
...
mojo.internal.Struct(
    mojo.internal.bindings.android_webview.mojom.LocalMainFrame_PostEmbedderMessageEvent_ParamsSpec, 'android_webview.mojom.LocalMainFrame_PostEmbedderMessageEvent_Params', [
      mojo.internal.StructField('arg_target_origin', 0, 0, mojo.internal.bindings.url.mojom.OriginSpec, null, true, 0, undefined),
      mojo.internal.StructField('arg_message', 8, 0, mojo.internal.bindings.android_webview.mojom.EmbedderTransferableMessageSpec, null, false, 0, undefined),
    ],
    [[0, 24]]);
