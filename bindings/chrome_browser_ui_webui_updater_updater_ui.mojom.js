...
mojo.internal.bindings.updater_ui.mojom.ShowDirectoryTargetSpec = mojo.internal.bindings.updater_ui.mojom.ShowDirectoryTargetSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.updater_ui.mojom.HistoryFilterSpec = mojo.internal.bindings.updater_ui.mojom.HistoryFilterSpec || { $: mojo.internal.Enum().$ };
...
mojo.internal.bindings.updater_ui.mojom.EnterpriseCompanionStateSpec = mojo.internal.bindings.updater_ui.mojom.EnterpriseCompanionStateSpec || { $: {} };
if (mojo.internal.bindings.updater_ui.mojom.EnterpriseCompanionStateSpec.$.structSpec && mojo.internal.bindings.updater_ui.mojom.EnterpriseCompanionStateSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.updater_ui.mojom.EnterpriseCompanionStateSpec.$ = {};
mojo.internal.bindings.updater_ui.mojom.GetEnterpriseCompanionStateResponseSpec = mojo.internal.bindings.updater_ui.mojom.GetEnterpriseCompanionStateResponseSpec || { $: {} };
if (mojo.internal.bindings.updater_ui.mojom.GetEnterpriseCompanionStateResponseSpec.$.structSpec && mojo.internal.bindings.updater_ui.mojom.GetEnterpriseCompanionStateResponseSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.updater_ui.mojom.GetEnterpriseCompanionStateResponseSpec.$ = {};
mojo.internal.bindings.updater_ui.mojom.GetEnterpriseCompanionStateErrorSpec = mojo.internal.bindings.updater_ui.mojom.GetEnterpriseCompanionStateErrorSpec || { $: {} };
if (mojo.internal.bindings.updater_ui.mojom.GetEnterpriseCompanionStateErrorSpec.$.structSpec && mojo.internal.bindings.updater_ui.mojom.GetEnterpriseCompanionStateErrorSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.updater_ui.mojom.GetEnterpriseCompanionStateErrorSpec.$ = {};
mojo.internal.bindings.updater_ui.mojom.AppStateSpec = mojo.internal.bindings.updater_ui.mojom.AppStateSpec || { $: {} };
if (mojo.internal.bindings.updater_ui.mojom.AppStateSpec.$.structSpec && mojo.internal.bindings.updater_ui.mojom.AppStateSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.updater_ui.mojom.AppStateSpec.$ = {};
mojo.internal.bindings.updater_ui.mojom.GetAppStatesResponseSpec = mojo.internal.bindings.updater_ui.mojom.GetAppStatesResponseSpec || { $: {} };
if (mojo.internal.bindings.updater_ui.mojom.GetAppStatesResponseSpec.$.structSpec && mojo.internal.bindings.updater_ui.mojom.GetAppStatesResponseSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.updater_ui.mojom.GetAppStatesResponseSpec.$ = {};
mojo.internal.bindings.updater_ui.mojom.GetAppStatesErrorSpec = mojo.internal.bindings.updater_ui.mojom.GetAppStatesErrorSpec || { $: {} };
if (mojo.internal.bindings.updater_ui.mojom.GetAppStatesErrorSpec.$.structSpec && mojo.internal.bindings.updater_ui.mojom.GetAppStatesErrorSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.updater_ui.mojom.GetAppStatesErrorSpec.$ = {};
mojo.internal.bindings.updater_ui.mojom.UnzipUpdaterHistoryFilesResponseSpec = mojo.internal.bindings.updater_ui.mojom.UnzipUpdaterHistoryFilesResponseSpec || { $: {} };
if (mojo.internal.bindings.updater_ui.mojom.UnzipUpdaterHistoryFilesResponseSpec.$.structSpec && mojo.internal.bindings.updater_ui.mojom.UnzipUpdaterHistoryFilesResponseSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.updater_ui.mojom.UnzipUpdaterHistoryFilesResponseSpec.$ = {};
mojo.internal.bindings.updater_ui.mojom.UnzipUpdaterHistoryFilesErrorSpec = mojo.internal.bindings.updater_ui.mojom.UnzipUpdaterHistoryFilesErrorSpec || { $: {} };
if (mojo.internal.bindings.updater_ui.mojom.UnzipUpdaterHistoryFilesErrorSpec.$.structSpec && mojo.internal.bindings.updater_ui.mojom.UnzipUpdaterHistoryFilesErrorSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.updater_ui.mojom.UnzipUpdaterHistoryFilesErrorSpec.$ = {};
...
mojo.internal.bindings.updater_ui.mojom.PageHandler_GetEnterpriseCompanionState_ParamsSpec = mojo.internal.bindings.updater_ui.mojom.PageHandler_GetEnterpriseCompanionState_ParamsSpec || { $: {} };
if (mojo.internal.bindings.updater_ui.mojom.PageHandler_GetEnterpriseCompanionState_ParamsSpec.$.structSpec && mojo.internal.bindings.updater_ui.mojom.PageHandler_GetEnterpriseCompanionState_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.updater_ui.mojom.PageHandler_GetEnterpriseCompanionState_ParamsSpec.$ = {};
mojo.internal.bindings.updater_ui.mojom.PageHandler_GetAppStates_ParamsSpec = mojo.internal.bindings.updater_ui.mojom.PageHandler_GetAppStates_ParamsSpec || { $: {} };
if (mojo.internal.bindings.updater_ui.mojom.PageHandler_GetAppStates_ParamsSpec.$.structSpec && mojo.internal.bindings.updater_ui.mojom.PageHandler_GetAppStates_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.updater_ui.mojom.PageHandler_GetAppStates_ParamsSpec.$ = {};
mojo.internal.bindings.updater_ui.mojom.PageHandler_ShowDirectory_ParamsSpec = mojo.internal.bindings.updater_ui.mojom.PageHandler_ShowDirectory_ParamsSpec || { $: {} };
if (mojo.internal.bindings.updater_ui.mojom.PageHandler_ShowDirectory_ParamsSpec.$.structSpec && mojo.internal.bindings.updater_ui.mojom.PageHandler_ShowDirectory_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.updater_ui.mojom.PageHandler_ShowDirectory_ParamsSpec.$ = {};
mojo.internal.bindings.updater_ui.mojom.PageHandler_RecordFilterChange_ParamsSpec = mojo.internal.bindings.updater_ui.mojom.PageHandler_RecordFilterChange_ParamsSpec || { $: {} };
if (mojo.internal.bindings.updater_ui.mojom.PageHandler_RecordFilterChange_ParamsSpec.$.structSpec && mojo.internal.bindings.updater_ui.mojom.PageHandler_RecordFilterChange_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.updater_ui.mojom.PageHandler_RecordFilterChange_ParamsSpec.$ = {};
mojo.internal.bindings.updater_ui.mojom.PageHandler_UnzipUpdaterHistoryFiles_ParamsSpec = mojo.internal.bindings.updater_ui.mojom.PageHandler_UnzipUpdaterHistoryFiles_ParamsSpec || { $: {} };
if (mojo.internal.bindings.updater_ui.mojom.PageHandler_UnzipUpdaterHistoryFiles_ParamsSpec.$.structSpec && mojo.internal.bindings.updater_ui.mojom.PageHandler_UnzipUpdaterHistoryFiles_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.updater_ui.mojom.PageHandler_UnzipUpdaterHistoryFiles_ParamsSpec.$ = {};
...
mojo.internal.bindings.updater_ui.mojom.ShowDirectoryTarget = {
  kSystemUpdater: 0,
  kUserUpdater: 1,
  kEnterpriseCompanionApp: 2,
};

// Enum: HistoryFilter
mojo.internal.bindings.updater_ui.mojom.HistoryFilter = {
  kApp: 0,
  kEvent: 1,
  kOutcome: 2,
  kDate: 3,
...
mojo.internal.bindings.updater_ui.mojom.PageHandlerFactoryRemote = class {
  ...
  constructor(handle = undefined) {
    ...
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.updater_ui.mojom.PageHandlerFactoryPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.updater_ui.mojom.PageHandlerFactoryRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.updater_ui.mojom.PageHandlerFactoryRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('updater_ui.mojom.PageHandlerFactory', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.updater_ui.mojom.PageHandlerFactory.getRemote = function() {
  let remote = new mojo.internal.bindings.updater_ui.mojom.PageHandlerFactoryRemote();
...
mojo.internal.bindings.updater_ui.mojom.PageHandlerFactoryReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('updater_ui.mojom.PageHandlerFactory', [
      { explicit: null },
    ]);
...
mojo.internal.bindings.updater_ui.mojom.PageHandlerFactoryReceiver = mojo.internal.bindings.updater_ui.mojom.PageHandlerFactoryReceiver;

mojo.internal.bindings.updater_ui.mojom.PageHandlerFactoryPtr = mojo.internal.bindings.updater_ui.mojom.PageHandlerFactoryRemote;
mojo.internal.bindings.updater_ui.mojom.PageHandlerFactoryRequest = mojo.internal.bindings.updater_ui.mojom.PageHandlerFactoryPendingReceiver;
...
mojo.internal.bindings.updater_ui.mojom.PageHandlerRemote = class {
  static get $interfaceName() {
  ...
  constructor(handle = undefined) {
    this.__mojoHandle = handle;
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.updater_ui.mojom.PageHandlerPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.updater_ui.mojom.PageHandlerRemoteCallHandler(this.proxy);
  }
  ...
  getEnterpriseCompanionState() {
    return this.$.getEnterpriseCompanionState();
  }
  getAppStates() {
    return this.$.getAppStates();
  }
  showDirectory(arg_scope) {
    return this.$.showDirectory(arg_scope);
  }
  recordFilterChange(arg_filter) {
    return this.$.recordFilterChange(arg_filter);
  }
  unzipUpdaterHistoryFiles(arg_zip_data) {
    return this.$.unzipUpdaterHistoryFiles(arg_zip_data);
  }
};
...
mojo.internal.bindings.updater_ui.mojom.PageHandlerRemoteCallHandler = class {
  ...
  getAppStates() {
    return this.proxy.sendMessage(
      ...
      mojo.internal.bindings.updater_ui.mojom.PageHandler_GetAppStates_ParamsSpec,
      null,
      [],
      false);
  }
  ...
  showDirectory(arg_scope) {
    return this.proxy.sendMessage(
      ...
      mojo.internal.bindings.updater_ui.mojom.PageHandler_ShowDirectory_ParamsSpec,
      null,
      [arg_scope],
      false);
  }
  ...
  recordFilterChange(arg_filter) {
    return this.proxy.sendMessage(
      ...
      mojo.internal.bindings.updater_ui.mojom.PageHandler_RecordFilterChange_ParamsSpec,
      null,
      [arg_filter],
      false);
  }
...
mojo.internal.bindings.updater_ui.mojom.PageHandler.getRemote = function() {
  let remote = new mojo.internal.bindings.updater_ui.mojom.PageHandlerRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
...
mojo.internal.bindings.updater_ui.mojom.PageHandlerReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.updater_ui.mojom.PageHandler_GetAllUpdaterEvents_ParamsSpec.$.structSpec);
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const message = new mojo.internal.Message(
                ...
                header.ordinal, header.requestId, mojo.internal.bindings.updater_ui.mojom.PageHandler_GetAllUpdaterEvents_ResponseParamsSpec.$.structSpec, resp_obj);
        ...
        case 2: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.updater_ui.mojom.PageHandler_GetEnterpriseCompanionState_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.getEnterpriseCompanionState');
          const result = this.impl.getEnterpriseCompanionState();
          break;
        }
        case 3: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.updater_ui.mojom.PageHandler_GetAppStates_ParamsSpec.$.structSpec);
        ...
        case 4: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.updater_ui.mojom.PageHandler_ShowDirectory_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.showDirectory');
          const result = this.impl.showDirectory(params.arg_scope);
          break;
        }
        case 5: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.updater_ui.mojom.PageHandler_RecordFilterChange_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.recordFilterChange');
          const result = this.impl.recordFilterChange(params.arg_filter);
          break;
        }
        case 6: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.updater_ui.mojom.PageHandler_UnzipUpdaterHistoryFiles_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.unzipUpdaterHistoryFiles');
          const result = this.impl.unzipUpdaterHistoryFiles(params.arg_zip_data);
          break;
        }
      }
      } catch (err) {
...
mojo.internal.bindings.updater_ui.mojom.PageHandlerReceiver = mojo.internal.bindings.updater_ui.mojom.PageHandlerReceiver;

mojo.internal.bindings.updater_ui.mojom.PageHandlerPtr = mojo.internal.bindings.updater_ui.mojom.PageHandlerRemote;
mojo.internal.bindings.updater_ui.mojom.PageHandlerRequest = mojo.internal.bindings.updater_ui.mojom.PageHandlerPendingReceiver;


// Interface: Page
mojo.internal.bindings.updater_ui.mojom.PagePendingReceiver = class {
  constructor(handle) {
    this.handle = handle;
    if (handle) {
      this.__mojoHandle = handle.router_ ? handle.router_.pipe_ : (handle.pipe_ || handle);
...
mojo.internal.bindings.updater_ui.mojom.PageRemote = class {
  static get $interfaceName() {
  ...
  constructor(handle = undefined) {
    this.__mojoHandle = handle;
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.updater_ui.mojom.PagePendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.updater_ui.mojom.PageRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.updater_ui.mojom.PageRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('updater_ui.mojom.Page', [
    ]);
  }

};

mojo.internal.bindings.updater_ui.mojom.Page.getRemote = function() {
  let remote = new mojo.internal.bindings.updater_ui.mojom.PageRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
...
mojo.internal.bindings.updater_ui.mojom.PageReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('updater_ui.mojom.Page', [
    ]);
    ordinals.forEach((ord, idx) => {
      this.ordinalMap.set(ord, idx); // Scrambled/Explicit
    });
...
mojo.internal.bindings.updater_ui.mojom.PageReceiver = mojo.internal.bindings.updater_ui.mojom.PageReceiver;
...
mojo.internal.Struct(
    mojo.internal.bindings.updater_ui.mojom.EnterpriseCompanionStateSpec, 'updater_ui.mojom.EnterpriseCompanionState', [
      mojo.internal.StructField('arg_version', 0, 0, mojo.internal.String, null, false, 0, undefined),
      mojo.internal.StructField('arg_installation_directory', 8, 0, mojo.internal.bindings.mojo_base.mojom.FilePathSpec, null, false, 0, undefined),
    ],
    [[0, 24]]);

// Struct: GetEnterpriseCompanionStateResponse
mojo.internal.Struct(
    mojo.internal.bindings.updater_ui.mojom.GetEnterpriseCompanionStateResponseSpec, 'updater_ui.mojom.GetEnterpriseCompanionStateResponse', [
      mojo.internal.StructField('arg_state', 0, 0, mojo.internal.bindings.updater_ui.mojom.EnterpriseCompanionStateSpec, null, true, 0, undefined),
    ],
    [[0, 16]]);

// Struct: GetEnterpriseCompanionStateError
mojo.internal.Struct(
    mojo.internal.bindings.updater_ui.mojom.GetEnterpriseCompanionStateErrorSpec, 'updater_ui.mojom.GetEnterpriseCompanionStateError', [
      mojo.internal.StructField('arg_message', 0, 0, mojo.internal.String, null, false, 0, undefined),
    ],
    [[0, 16]]);
...
// Struct: AppState
mojo.internal.Struct(
    mojo.internal.bindings.updater_ui.mojom.AppStateSpec, 'updater_ui.mojom.AppState', [
      ...
      mojo.internal.StructField('arg_cohort', 16, 0, mojo.internal.String, null, true, 0, undefined),
    ],
    [[0, 32]]);

// Struct: GetAppStatesResponse
mojo.internal.Struct(
    mojo.internal.bindings.updater_ui.mojom.GetAppStatesResponseSpec, 'updater_ui.mojom.GetAppStatesResponse', [
      mojo.internal.StructField('arg_system_apps', 0, 0, mojo.internal.Array(mojo.internal.bindings.updater_ui.mojom.AppStateSpec, false), null, false, 0, undefined),
      mojo.internal.StructField('arg_user_apps', 8, 0, mojo.internal.Array(mojo.internal.bindings.updater_ui.mojom.AppStateSpec, false), null, false, 0, undefined),
    ],
    [[0, 24]]);

// Struct: GetAppStatesError
mojo.internal.Struct(
    mojo.internal.bindings.updater_ui.mojom.GetAppStatesErrorSpec, 'updater_ui.mojom.GetAppStatesError', [
      mojo.internal.StructField('arg_message', 0, 0, mojo.internal.String, null, false, 0, undefined),
    ],
    [[0, 16]]);

// Struct: UnzipUpdaterHistoryFilesResponse
mojo.internal.Struct(
    mojo.internal.bindings.updater_ui.mojom.UnzipUpdaterHistoryFilesResponseSpec, 'updater_ui.mojom.UnzipUpdaterHistoryFilesResponse', [
      mojo.internal.StructField('arg_history_file_contents', 0, 0, mojo.internal.Array(mojo.internal.String, false), null, false, 0, undefined),
    ],
    [[0, 16]]);

// Struct: UnzipUpdaterHistoryFilesError
mojo.internal.Struct(
    mojo.internal.bindings.updater_ui.mojom.UnzipUpdaterHistoryFilesErrorSpec, 'updater_ui.mojom.UnzipUpdaterHistoryFilesError', [
      mojo.internal.StructField('arg_message', 0, 0, mojo.internal.String, null, false, 0, undefined),
    ],
    [[0, 16]]);
mojo.internal.Struct(
    mojo.internal.bindings.updater_ui.mojom.PageHandlerFactory_CreatePageHandler_ParamsSpec, 'updater_ui.mojom.PageHandlerFactory_CreatePageHandler_Params', [
      ...
      mojo.internal.StructField('arg_handler', 8, 0, mojo.internal.InterfaceRequest(mojo.internal.bindings.updater_ui.mojom.PageHandlerPendingReceiver), null, false, 0, undefined),
    ],
    [[0, 24]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.updater_ui.mojom.PageHandler_GetEnterpriseCompanionState_ParamsSpec, 'updater_ui.mojom.PageHandler_GetEnterpriseCompanionState_Params', [
    ],
    [[0, 8]]);

mojo.internal.Struct(
    mojo.internal.bindings.updater_ui.mojom.PageHandler_GetAppStates_ParamsSpec, 'updater_ui.mojom.PageHandler_GetAppStates_Params', [
    ],
    [[0, 8]]);

mojo.internal.Struct(
    mojo.internal.bindings.updater_ui.mojom.PageHandler_ShowDirectory_ParamsSpec, 'updater_ui.mojom.PageHandler_ShowDirectory_Params', [
      mojo.internal.StructField('arg_scope', 0, 0, mojo.internal.bindings.updater_ui.mojom.ShowDirectoryTargetSpec, null, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.updater_ui.mojom.PageHandler_RecordFilterChange_ParamsSpec, 'updater_ui.mojom.PageHandler_RecordFilterChange_Params', [
      mojo.internal.StructField('arg_filter', 0, 0, mojo.internal.bindings.updater_ui.mojom.HistoryFilterSpec, null, false, 0, undefined),
    ],
    [[0, 16]]);

mojo.internal.Struct(
    mojo.internal.bindings.updater_ui.mojom.PageHandler_UnzipUpdaterHistoryFiles_ParamsSpec, 'updater_ui.mojom.PageHandler_UnzipUpdaterHistoryFiles_Params', [
      mojo.internal.StructField('arg_zip_data', 0, 0, mojo.internal.bindings.mojo_base.mojom.BigBufferSpec, null, false, 0, undefined),
    ],
    [[0, 24]]);
