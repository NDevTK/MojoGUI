...
// Enum: UpdaterScope
mojo.internal.bindings.updater_ui.mojom.UpdaterScope = {
  kSystem: 0,
  kUser: 1,
};
...
mojo.internal.bindings.updater_ui.mojom.PageHandlerRemote = class {
  ...
  showUpdaterDirectory(arg_scope) {
    return this.$.showUpdaterDirectory(arg_scope);
  }
};
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        ...
        case 3: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.updater_ui.mojom.PageHandler_ShowUpdaterDirectory_ParamsSpec.$.structSpec);
          console.log('[GeneratedReceiver] Calling impl.showUpdaterDirectory');
          const result = this.impl.showUpdaterDirectory(params.arg_scope);
          break;
        }
      }
      } catch (err) {
...
mojo.internal.Struct(
    mojo.internal.bindings.updater_ui.mojom.PageHandler_ShowUpdaterDirectory_ParamsSpec, 'updater_ui.mojom.PageHandler_ShowUpdaterDirectory_Params', [
      mojo.internal.StructField('arg_scope', 0, 0, mojo.internal.bindings.updater_ui.mojom.UpdaterScopeSpec, null, false, 0, undefined),
    ],
    [[0, 16]]);
