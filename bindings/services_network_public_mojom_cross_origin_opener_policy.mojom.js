...
mojo.internal.bindings.network.mojom.CrossOriginOpenerPolicyValue = {
  kUnsafeNone: 0,
...
mojo.internal.bindings.network.mojom.CrossOriginOpenerPolicyReporterPendingReceiver = class {
  constructor(handle) {
    this.handle = handle;
  }
};

mojo.internal.bindings.network.mojom.CrossOriginOpenerPolicyReporterRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.network.mojom.CrossOriginOpenerPolicyReporterPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.network.mojom.CrossOriginOpenerPolicyReporterRemoteCallHandler(this.proxy);
  }
  ...
  queueAccessReport(arg_report_type, arg_property, arg_source_location, arg_reported_window_url) {
    return this.$.queueAccessReport(arg_report_type, arg_property, arg_source_location, arg_reported_window_url);
  }
};
...
mojo.internal.bindings.network.mojom.CrossOriginOpenerPolicyReporter.getRemote = function() {
  let remote = new mojo.internal.bindings.network.mojom.CrossOriginOpenerPolicyReporterRemote();
...
mojo.internal.bindings.network.mojom.CrossOriginOpenerPolicyReporterReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.network.mojom.CrossOriginOpenerPolicyReporter_QueueAccessReport_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for QueueAccessReport failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.network.mojom.CrossOriginOpenerPolicyReporterReceiver = mojo.internal.bindings.network.mojom.CrossOriginOpenerPolicyReporterReceiver;

mojo.internal.bindings.network.mojom.CrossOriginOpenerPolicyReporterPtr = mojo.internal.bindings.network.mojom.CrossOriginOpenerPolicyReporterRemote;
mojo.internal.bindings.network.mojom.CrossOriginOpenerPolicyReporterRequest = mojo.internal.bindings.network.mojom.CrossOriginOpenerPolicyReporterPendingReceiver;
