  ...
  $: {
    structSpec: {
      ...
      fields: [
        ...
        { name: 'visible_viewport_size', packedOffset: 24, packedBitOffset: 0, type: mojo.internal.Pointer, nullable: false },
        { name: 'min_size_for_auto_resize', packedOffset: 32, packedBitOffset: 0, type: mojo.internal.Pointer, nullable: false },
        { name: 'max_size_for_auto_resize', packedOffset: 40, packedBitOffset: 0, type: mojo.internal.Pointer, nullable: false },
        { name: 'root_widget_viewport_segments', packedOffset: 48, packedBitOffset: 0, type: mojo.internal.Array, nullable: false },
        { name: 'compositor_viewport', packedOffset: 56, packedBitOffset: 0, type: mojo.internal.Pointer, nullable: false },
        { name: 'rect_in_local_root', packedOffset: 64, packedBitOffset: 0, type: mojo.internal.Pointer, nullable: false },
        { name: 'local_frame_size', packedOffset: 72, packedBitOffset: 0, type: mojo.internal.Pointer, nullable: false },
        { name: 'local_surface_id', packedOffset: 80, packedBitOffset: 0, type: mojo.internal.Pointer, nullable: false },
