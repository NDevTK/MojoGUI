...
mojo.internal.bindings.glic.selection.SelectionOverlayPageHandler_GetSuggestedActions_ResponseParamsSpec = mojo.internal.bindings.glic.selection.SelectionOverlayPageHandler_GetSuggestedActions_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.glic.selection.SelectionOverlayPageHandler_GetSuggestedActions_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.glic.selection.SelectionOverlayPageHandler_GetSuggestedActions_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.glic.selection.SelectionOverlayPageHandler_GetSuggestedActions_ResponseParamsSpec.$ = {};
...
mojo.internal.bindings.glic.selection.SelectionOverlayPageHandlerRemote = class {
  ...
  getSuggestedActions() {
    return this.$.getSuggestedActions();
  }
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        ...
        case 7: {
          ...
          const result = this.impl.getSuggestedActions();
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const message = new mojo.internal.Message(
                ...
                header.ordinal, header.requestId, mojo.internal.bindings.glic.selection.SelectionOverlayPageHandler_GetSuggestedActions_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
            }).catch(e => console.error('[GeneratedReceiver] getSuggestedActions FAILED:', e));
          }
          break;
        }
        case 8: {
...
mojo.internal.Struct(
    mojo.internal.bindings.glic.selection.SelectionOverlayPageHandler_GetSuggestedActions_ResponseParamsSpec, 'glic.selection.SelectionOverlayPageHandler_GetSuggestedActions_ResponseParams', [
