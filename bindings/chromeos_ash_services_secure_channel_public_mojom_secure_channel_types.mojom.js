...
mojo.internal.Struct(
    mojo.internal.bindings.ash.secure_channel.mojom.FileTransferUpdateSpec, 'ash.secure_channel.mojom.FileTransferUpdate', [
      ...
      mojo.internal.StructField('arg_status', 24, 0, mojo.internal.bindings.ash.secure_channel.mojom.FileTransferStatusSpec, null, false, 0, undefined),
    ],
    [[0, 40]]);
...
mojo.internal.bindings.ash.secure_channel.mojom.FilePayloadListenerRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.ash.secure_channel.mojom.FilePayloadListenerRemoteCallHandler(this.proxy);
  }
  ...
  onFileTransferUpdate(arg_update) {
    return this.$.onFileTransferUpdate(arg_update);
  }
};
...
mojo.internal.bindings.ash.secure_channel.mojom.FilePayloadListener.getRemote = function() {
  let remote = new mojo.internal.bindings.ash.secure_channel.mojom.FilePayloadListenerRemote();
...
mojo.internal.bindings.ash.secure_channel.mojom.FilePayloadListenerReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ash.secure_channel.mojom.FilePayloadListener_OnFileTransferUpdate_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OnFileTransferUpdate failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.ash.secure_channel.mojom.FilePayloadListenerReceiver = mojo.internal.bindings.ash.secure_channel.mojom.FilePayloadListenerReceiver;
