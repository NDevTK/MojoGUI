...
// Enum: Status
mojo.internal.bindings.tenor.mojom.Status = {
  kHttpOk: 0,
  kNetError: 1,
  kHttpError: 2,
};
...
mojo.internal.Struct(
    mojo.internal.bindings.tenor.mojom.GifUrlsSpec, 'tenor.mojom.GifUrls', [
      mojo.internal.StructField('arg_full', 0, 0, mojo.internal.bindings.url.mojom.UrlSpec.$, null, false, 0, undefined),
      mojo.internal.StructField('arg_preview', 8, 0, mojo.internal.bindings.url.mojom.UrlSpec.$, null, false, 0, undefined),
      mojo.internal.StructField('arg_preview_image', 16, 0, mojo.internal.bindings.url.mojom.UrlSpec.$, null, false, 0, undefined),
    ],
    [[0, 32]]);
