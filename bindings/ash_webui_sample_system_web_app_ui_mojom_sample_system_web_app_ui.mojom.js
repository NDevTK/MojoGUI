...
mojo.internal.bindings.ash.mojom.sample_swa.PageHandlerFactoryRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.ash.mojom.sample_swa.PageHandlerFactoryPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.ash.mojom.sample_swa.PageHandlerFactoryRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.ash.mojom.sample_swa.PageHandlerFactoryRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('ash.mojom.sample_swa.PageHandlerFactory', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.ash.mojom.sample_swa.PageHandlerFactory.getRemote = function() {
  let remote = new mojo.internal.bindings.ash.mojom.sample_swa.PageHandlerFactoryRemote();
...
mojo.internal.bindings.ash.mojom.sample_swa.PageHandlerFactoryReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('ash.mojom.sample_swa.PageHandlerFactory', [
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.ash.mojom.sample_swa.PageHandlerFactory_CreatePageHandler_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.ash.mojom.sample_swa.PageHandlerFactoryReceiver = mojo.internal.bindings.ash.mojom.sample_swa.PageHandlerFactoryReceiver;

mojo.internal.bindings.ash.mojom.sample_swa.PageHandlerFactoryPtr = mojo.internal.bindings.ash.mojom.sample_swa.PageHandlerFactoryRemote;
mojo.internal.bindings.ash.mojom.sample_swa.PageHandlerFactoryRequest = mojo.internal.bindings.ash.mojom.sample_swa.PageHandlerFactoryPendingReceiver;
...
mojo.internal.bindings.ash.mojom.sample_swa.PageHandlerRemote = class {
  static get $interfaceName() {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.ash.mojom.sample_swa.PageHandlerPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.ash.mojom.sample_swa.PageHandlerRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.ash.mojom.sample_swa.PageHandlerRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('ash.mojom.sample_swa.PageHandler', [
      { explicit: null },
      { explicit: null },
      { explicit: null },
    ]);
...
mojo.internal.bindings.ash.mojom.sample_swa.PageHandler.getRemote = function() {
  let remote = new mojo.internal.bindings.ash.mojom.sample_swa.PageHandlerRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
...
mojo.internal.bindings.ash.mojom.sample_swa.PageHandlerReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('ash.mojom.sample_swa.PageHandler', [
      { explicit: null },
      { explicit: null },
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.ash.mojom.sample_swa.PageHandler_GetPreferences_ParamsSpec.$.structSpec);
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.ash.mojom.sample_swa.PageHandler_Send_ParamsSpec.$.structSpec);
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.ash.mojom.sample_swa.PageHandler_DoSomething_ParamsSpec.$.structSpec);
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.ash.mojom.sample_swa.PageHandler_GetPreferences_ParamsSpec.$.structSpec);
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.ash.mojom.sample_swa.PageHandler_GetPreferences_ResponseParamsSpec, header, rawHeader);
               responder(response);
        ...
        case 2: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.ash.mojom.sample_swa.PageHandler_DoSomething_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.ash.mojom.sample_swa.PageHandlerReceiver = mojo.internal.bindings.ash.mojom.sample_swa.PageHandlerReceiver;

mojo.internal.bindings.ash.mojom.sample_swa.PageHandlerPtr = mojo.internal.bindings.ash.mojom.sample_swa.PageHandlerRemote;
mojo.internal.bindings.ash.mojom.sample_swa.PageHandlerRequest = mojo.internal.bindings.ash.mojom.sample_swa.PageHandlerPendingReceiver;
...
mojo.internal.bindings.ash.mojom.sample_swa.PageRemote = class {
  static get $interfaceName() {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.ash.mojom.sample_swa.PagePendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.ash.mojom.sample_swa.PageRemoteCallHandler(this.proxy);
  }
  ...
  onEventOccurred(arg_name) {
    return this.$.onEventOccurred(arg_name);
  }
  createParentPage(arg_child_untrusted_page, arg_parent_trusted_page) {
    return this.$.createParentPage(arg_child_untrusted_page, arg_parent_trusted_page);
  }
};

mojo.internal.bindings.ash.mojom.sample_swa.PageRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('ash.mojom.sample_swa.Page', [
      { explicit: null },
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.ash.mojom.sample_swa.Page.getRemote = function() {
  let remote = new mojo.internal.bindings.ash.mojom.sample_swa.PageRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
...
mojo.internal.bindings.ash.mojom.sample_swa.PageReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('ash.mojom.sample_swa.Page', [
      { explicit: null },
      { explicit: null },
    ]);
    ordinals.forEach((ord, idx) => {
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.ash.mojom.sample_swa.Page_OnEventOccurred_ParamsSpec.$.structSpec);
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.ash.mojom.sample_swa.Page_CreateParentPage_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.ash.mojom.sample_swa.PageReceiver = mojo.internal.bindings.ash.mojom.sample_swa.PageReceiver;
