   ...
   const SHA256 = (s) => {
    ...
    window.mojoScrambler = window.mojoScrambler || {
      ...
      getOrdinals: function(ifaceName, methodSpecs) {
        ...
        const versionStr = window.mojoVersion || '155.0.8054.0';
