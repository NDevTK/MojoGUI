...
mojo.internal.bindings.ash.camera_app.mojom.ScreenStateSpec = mojo.internal.bindings.ash.camera_app.mojom.ScreenStateSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.ash.camera_app.mojom.LidStateSpec = mojo.internal.bindings.ash.camera_app.mojom.LidStateSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.ash.camera_app.mojom.WindowStateTypeSpec = mojo.internal.bindings.ash.camera_app.mojom.WindowStateTypeSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.ash.camera_app.mojom.FileMonitorResultSpec = mojo.internal.bindings.ash.camera_app.mojom.FileMonitorResultSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.ash.camera_app.mojom.StorageMonitorStatusSpec = mojo.internal.bindings.ash.camera_app.mojom.StorageMonitorStatusSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.ash.camera_app.mojom.AspectRatioSpec = mojo.internal.bindings.ash.camera_app.mojom.AspectRatioSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.ash.camera_app.mojom.FileTypeSpec = mojo.internal.bindings.ash.camera_app.mojom.FileTypeSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.ash.camera_app.mojom.CaptureDestinationSpec = mojo.internal.bindings.ash.camera_app.mojom.CaptureDestinationSpec || { $: {} };
if (mojo.internal.bindings.ash.camera_app.mojom.CaptureDestinationSpec.$.structSpec && mojo.internal.bindings.ash.camera_app.mojom.CaptureDestinationSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.camera_app.mojom.CaptureDestinationSpec.$ = {};
mojo.internal.bindings.ash.camera_app.mojom.WifiConfigSpec = mojo.internal.bindings.ash.camera_app.mojom.WifiConfigSpec || { $: {} };
if (mojo.internal.bindings.ash.camera_app.mojom.WifiConfigSpec.$.structSpec && mojo.internal.bindings.ash.camera_app.mojom.WifiConfigSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.camera_app.mojom.WifiConfigSpec.$ = {};
mojo.internal.bindings.ash.camera_app.mojom.CloudUploadSpec = mojo.internal.bindings.ash.camera_app.mojom.CloudUploadSpec || { $: {} };
if (mojo.internal.bindings.ash.camera_app.mojom.CloudUploadSpec.$.structSpec && mojo.internal.bindings.ash.camera_app.mojom.CloudUploadSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.camera_app.mojom.CloudUploadSpec.$ = {};
mojo.internal.bindings.ash.camera_app.mojom.LocalFileSpec = mojo.internal.bindings.ash.camera_app.mojom.LocalFileSpec || { $: {} };
if (mojo.internal.bindings.ash.camera_app.mojom.LocalFileSpec.$.structSpec && mojo.internal.bindings.ash.camera_app.mojom.LocalFileSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.camera_app.mojom.LocalFileSpec.$ = {};
mojo.internal.bindings.ash.camera_app.mojom.TabletModeMonitor = mojo.internal.bindings.ash.camera_app.mojom.TabletModeMonitor || {};
mojo.internal.bindings.ash.camera_app.mojom.TabletModeMonitorSpec = mojo.internal.bindings.ash.camera_app.mojom.TabletModeMonitorSpec || { $ : {} };
if (mojo.internal.bindings.ash.camera_app.mojom.TabletModeMonitorSpec.$.structSpec && mojo.internal.bindings.ash.camera_app.mojom.TabletModeMonitorSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.camera_app.mojom.TabletModeMonitorSpec.$ = {};
mojo.internal.bindings.ash.camera_app.mojom.TabletModeMonitor.$interfaceName = 'ash.camera_app.mojom.TabletModeMonitor';
mojo.internal.bindings.ash.camera_app.mojom.TabletModeMonitor_Update_ParamsSpec = mojo.internal.bindings.ash.camera_app.mojom.TabletModeMonitor_Update_ParamsSpec || { $: {} };
if (mojo.internal.bindings.ash.camera_app.mojom.TabletModeMonitor_Update_ParamsSpec.$.structSpec && mojo.internal.bindings.ash.camera_app.mojom.TabletModeMonitor_Update_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.camera_app.mojom.TabletModeMonitor_Update_ParamsSpec.$ = {};
mojo.internal.bindings.ash.camera_app.mojom.ScreenStateMonitor = mojo.internal.bindings.ash.camera_app.mojom.ScreenStateMonitor || {};
mojo.internal.bindings.ash.camera_app.mojom.ScreenStateMonitorSpec = mojo.internal.bindings.ash.camera_app.mojom.ScreenStateMonitorSpec || { $ : {} };
if (mojo.internal.bindings.ash.camera_app.mojom.ScreenStateMonitorSpec.$.structSpec && mojo.internal.bindings.ash.camera_app.mojom.ScreenStateMonitorSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.camera_app.mojom.ScreenStateMonitorSpec.$ = {};
mojo.internal.bindings.ash.camera_app.mojom.ScreenStateMonitor.$interfaceName = 'ash.camera_app.mojom.ScreenStateMonitor';
mojo.internal.bindings.ash.camera_app.mojom.ScreenStateMonitor_Update_ParamsSpec = mojo.internal.bindings.ash.camera_app.mojom.ScreenStateMonitor_Update_ParamsSpec || { $: {} };
if (mojo.internal.bindings.ash.camera_app.mojom.ScreenStateMonitor_Update_ParamsSpec.$.structSpec && mojo.internal.bindings.ash.camera_app.mojom.ScreenStateMonitor_Update_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.camera_app.mojom.ScreenStateMonitor_Update_ParamsSpec.$ = {};
mojo.internal.bindings.ash.camera_app.mojom.ScreenLockedMonitor = mojo.internal.bindings.ash.camera_app.mojom.ScreenLockedMonitor || {};
mojo.internal.bindings.ash.camera_app.mojom.ScreenLockedMonitorSpec = mojo.internal.bindings.ash.camera_app.mojom.ScreenLockedMonitorSpec || { $ : {} };
if (mojo.internal.bindings.ash.camera_app.mojom.ScreenLockedMonitorSpec.$.structSpec && mojo.internal.bindings.ash.camera_app.mojom.ScreenLockedMonitorSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.camera_app.mojom.ScreenLockedMonitorSpec.$ = {};
mojo.internal.bindings.ash.camera_app.mojom.ScreenLockedMonitor.$interfaceName = 'ash.camera_app.mojom.ScreenLockedMonitor';
mojo.internal.bindings.ash.camera_app.mojom.ScreenLockedMonitor_Update_ParamsSpec = mojo.internal.bindings.ash.camera_app.mojom.ScreenLockedMonitor_Update_ParamsSpec || { $: {} };
if (mojo.internal.bindings.ash.camera_app.mojom.ScreenLockedMonitor_Update_ParamsSpec.$.structSpec && mojo.internal.bindings.ash.camera_app.mojom.ScreenLockedMonitor_Update_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.camera_app.mojom.ScreenLockedMonitor_Update_ParamsSpec.$ = {};
mojo.internal.bindings.ash.camera_app.mojom.ExternalScreenMonitor = mojo.internal.bindings.ash.camera_app.mojom.ExternalScreenMonitor || {};
mojo.internal.bindings.ash.camera_app.mojom.ExternalScreenMonitorSpec = mojo.internal.bindings.ash.camera_app.mojom.ExternalScreenMonitorSpec || { $ : {} };
if (mojo.internal.bindings.ash.camera_app.mojom.ExternalScreenMonitorSpec.$.structSpec && mojo.internal.bindings.ash.camera_app.mojom.ExternalScreenMonitorSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.camera_app.mojom.ExternalScreenMonitorSpec.$ = {};
...
mojo.internal.bindings.ash.camera_app.mojom.ExternalScreenMonitor_Update_ParamsSpec = mojo.internal.bindings.ash.camera_app.mojom.ExternalScreenMonitor_Update_ParamsSpec || { $: {} };
if (mojo.internal.bindings.ash.camera_app.mojom.ExternalScreenMonitor_Update_ParamsSpec.$.structSpec && mojo.internal.bindings.ash.camera_app.mojom.ExternalScreenMonitor_Update_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.camera_app.mojom.ExternalScreenMonitor_Update_ParamsSpec.$ = {};
mojo.internal.bindings.ash.camera_app.mojom.CameraUsageOwnershipMonitor = mojo.internal.bindings.ash.camera_app.mojom.CameraUsageOwnershipMonitor || {};
mojo.internal.bindings.ash.camera_app.mojom.CameraUsageOwnershipMonitorSpec = mojo.internal.bindings.ash.camera_app.mojom.CameraUsageOwnershipMonitorSpec || { $ : {} };
if (mojo.internal.bindings.ash.camera_app.mojom.CameraUsageOwnershipMonitorSpec.$.structSpec && mojo.internal.bindings.ash.camera_app.mojom.CameraUsageOwnershipMonitorSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.camera_app.mojom.CameraUsageOwnershipMonitorSpec.$ = {};
...
mojo.internal.bindings.ash.camera_app.mojom.CameraUsageOwnershipMonitor_OnCameraUsageOwnershipChanged_ParamsSpec = mojo.internal.bindings.ash.camera_app.mojom.CameraUsageOwnershipMonitor_OnCameraUsageOwnershipChanged_ParamsSpec || { $: {} };
if (mojo.internal.bindings.ash.camera_app.mojom.CameraUsageOwnershipMonitor_OnCameraUsageOwnershipChanged_ParamsSpec.$.structSpec && mojo.internal.bindings.ash.camera_app.mojom.CameraUsageOwnershipMonitor_OnCameraUsageOwnershipChanged_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.camera_app.mojom.CameraUsageOwnershipMonitor_OnCameraUsageOwnershipChanged_ParamsSpec.$ = {};
mojo.internal.bindings.ash.camera_app.mojom.CameraUsageOwnershipMonitor_OnCameraUsageOwnershipChanged_ResponseParamsSpec = mojo.internal.bindings.ash.camera_app.mojom.CameraUsageOwnershipMonitor_OnCameraUsageOwnershipChanged_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.ash.camera_app.mojom.CameraUsageOwnershipMonitor_OnCameraUsageOwnershipChanged_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.ash.camera_app.mojom.CameraUsageOwnershipMonitor_OnCameraUsageOwnershipChanged_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.camera_app.mojom.CameraUsageOwnershipMonitor_OnCameraUsageOwnershipChanged_ResponseParamsSpec.$ = {};
mojo.internal.bindings.ash.camera_app.mojom.LidStateMonitor = mojo.internal.bindings.ash.camera_app.mojom.LidStateMonitor || {};
mojo.internal.bindings.ash.camera_app.mojom.LidStateMonitorSpec = mojo.internal.bindings.ash.camera_app.mojom.LidStateMonitorSpec || { $ : {} };
if (mojo.internal.bindings.ash.camera_app.mojom.LidStateMonitorSpec.$.structSpec && mojo.internal.bindings.ash.camera_app.mojom.LidStateMonitorSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.camera_app.mojom.LidStateMonitorSpec.$ = {};
mojo.internal.bindings.ash.camera_app.mojom.LidStateMonitor.$interfaceName = 'ash.camera_app.mojom.LidStateMonitor';
mojo.internal.bindings.ash.camera_app.mojom.LidStateMonitor_Update_ParamsSpec = mojo.internal.bindings.ash.camera_app.mojom.LidStateMonitor_Update_ParamsSpec || { $: {} };
if (mojo.internal.bindings.ash.camera_app.mojom.LidStateMonitor_Update_ParamsSpec.$.structSpec && mojo.internal.bindings.ash.camera_app.mojom.LidStateMonitor_Update_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.camera_app.mojom.LidStateMonitor_Update_ParamsSpec.$ = {};
mojo.internal.bindings.ash.camera_app.mojom.SWPrivacySwitchMonitor = mojo.internal.bindings.ash.camera_app.mojom.SWPrivacySwitchMonitor || {};
mojo.internal.bindings.ash.camera_app.mojom.SWPrivacySwitchMonitorSpec = mojo.internal.bindings.ash.camera_app.mojom.SWPrivacySwitchMonitorSpec || { $ : {} };
if (mojo.internal.bindings.ash.camera_app.mojom.SWPrivacySwitchMonitorSpec.$.structSpec && mojo.internal.bindings.ash.camera_app.mojom.SWPrivacySwitchMonitorSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.camera_app.mojom.SWPrivacySwitchMonitorSpec.$ = {};
...
mojo.internal.bindings.ash.camera_app.mojom.SWPrivacySwitchMonitor_Update_ParamsSpec = mojo.internal.bindings.ash.camera_app.mojom.SWPrivacySwitchMonitor_Update_ParamsSpec || { $: {} };
if (mojo.internal.bindings.ash.camera_app.mojom.SWPrivacySwitchMonitor_Update_ParamsSpec.$.structSpec && mojo.internal.bindings.ash.camera_app.mojom.SWPrivacySwitchMonitor_Update_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.camera_app.mojom.SWPrivacySwitchMonitor_Update_ParamsSpec.$ = {};
mojo.internal.bindings.ash.camera_app.mojom.WindowStateMonitor = mojo.internal.bindings.ash.camera_app.mojom.WindowStateMonitor || {};
mojo.internal.bindings.ash.camera_app.mojom.WindowStateMonitorSpec = mojo.internal.bindings.ash.camera_app.mojom.WindowStateMonitorSpec || { $ : {} };
if (mojo.internal.bindings.ash.camera_app.mojom.WindowStateMonitorSpec.$.structSpec && mojo.internal.bindings.ash.camera_app.mojom.WindowStateMonitorSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.camera_app.mojom.WindowStateMonitorSpec.$ = {};
mojo.internal.bindings.ash.camera_app.mojom.WindowStateMonitor.$interfaceName = 'ash.camera_app.mojom.WindowStateMonitor';
mojo.internal.bindings.ash.camera_app.mojom.WindowStateMonitor_OnWindowStateChanged_ParamsSpec = mojo.internal.bindings.ash.camera_app.mojom.WindowStateMonitor_OnWindowStateChanged_ParamsSpec || { $: {} };
if (mojo.internal.bindings.ash.camera_app.mojom.WindowStateMonitor_OnWindowStateChanged_ParamsSpec.$.structSpec && mojo.internal.bindings.ash.camera_app.mojom.WindowStateMonitor_OnWindowStateChanged_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.camera_app.mojom.WindowStateMonitor_OnWindowStateChanged_ParamsSpec.$ = {};
mojo.internal.bindings.ash.camera_app.mojom.WindowStateMonitor_OnWindowFocusChanged_ParamsSpec = mojo.internal.bindings.ash.camera_app.mojom.WindowStateMonitor_OnWindowFocusChanged_ParamsSpec || { $: {} };
if (mojo.internal.bindings.ash.camera_app.mojom.WindowStateMonitor_OnWindowFocusChanged_ParamsSpec.$.structSpec && mojo.internal.bindings.ash.camera_app.mojom.WindowStateMonitor_OnWindowFocusChanged_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.camera_app.mojom.WindowStateMonitor_OnWindowFocusChanged_ParamsSpec.$ = {};
mojo.internal.bindings.ash.camera_app.mojom.StorageMonitor = mojo.internal.bindings.ash.camera_app.mojom.StorageMonitor || {};
mojo.internal.bindings.ash.camera_app.mojom.StorageMonitorSpec = mojo.internal.bindings.ash.camera_app.mojom.StorageMonitorSpec || { $ : {} };
if (mojo.internal.bindings.ash.camera_app.mojom.StorageMonitorSpec.$.structSpec && mojo.internal.bindings.ash.camera_app.mojom.StorageMonitorSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.camera_app.mojom.StorageMonitorSpec.$ = {};
mojo.internal.bindings.ash.camera_app.mojom.StorageMonitor.$interfaceName = 'ash.camera_app.mojom.StorageMonitor';
mojo.internal.bindings.ash.camera_app.mojom.StorageMonitor_Update_ParamsSpec = mojo.internal.bindings.ash.camera_app.mojom.StorageMonitor_Update_ParamsSpec || { $: {} };
if (mojo.internal.bindings.ash.camera_app.mojom.StorageMonitor_Update_ParamsSpec.$.structSpec && mojo.internal.bindings.ash.camera_app.mojom.StorageMonitor_Update_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.camera_app.mojom.StorageMonitor_Update_ParamsSpec.$ = {};
mojo.internal.bindings.ash.camera_app.mojom.WindowStateController = mojo.internal.bindings.ash.camera_app.mojom.WindowStateController || {};
mojo.internal.bindings.ash.camera_app.mojom.WindowStateControllerSpec = mojo.internal.bindings.ash.camera_app.mojom.WindowStateControllerSpec || { $ : {} };
if (mojo.internal.bindings.ash.camera_app.mojom.WindowStateControllerSpec.$.structSpec && mojo.internal.bindings.ash.camera_app.mojom.WindowStateControllerSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.camera_app.mojom.WindowStateControllerSpec.$ = {};
...
mojo.internal.bindings.ash.camera_app.mojom.WindowStateController_AddMonitor_ParamsSpec = mojo.internal.bindings.ash.camera_app.mojom.WindowStateController_AddMonitor_ParamsSpec || { $: {} };
if (mojo.internal.bindings.ash.camera_app.mojom.WindowStateController_AddMonitor_ParamsSpec.$.structSpec && mojo.internal.bindings.ash.camera_app.mojom.WindowStateController_AddMonitor_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.camera_app.mojom.WindowStateController_AddMonitor_ParamsSpec.$ = {};
mojo.internal.bindings.ash.camera_app.mojom.WindowStateController_AddMonitor_ResponseParamsSpec = mojo.internal.bindings.ash.camera_app.mojom.WindowStateController_AddMonitor_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.ash.camera_app.mojom.WindowStateController_AddMonitor_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.ash.camera_app.mojom.WindowStateController_AddMonitor_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.camera_app.mojom.WindowStateController_AddMonitor_ResponseParamsSpec.$ = {};
mojo.internal.bindings.ash.camera_app.mojom.WindowStateController_GetWindowState_ParamsSpec = mojo.internal.bindings.ash.camera_app.mojom.WindowStateController_GetWindowState_ParamsSpec || { $: {} };
if (mojo.internal.bindings.ash.camera_app.mojom.WindowStateController_GetWindowState_ParamsSpec.$.structSpec && mojo.internal.bindings.ash.camera_app.mojom.WindowStateController_GetWindowState_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.camera_app.mojom.WindowStateController_GetWindowState_ParamsSpec.$ = {};
mojo.internal.bindings.ash.camera_app.mojom.WindowStateController_GetWindowState_ResponseParamsSpec = mojo.internal.bindings.ash.camera_app.mojom.WindowStateController_GetWindowState_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.ash.camera_app.mojom.WindowStateController_GetWindowState_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.ash.camera_app.mojom.WindowStateController_GetWindowState_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.camera_app.mojom.WindowStateController_GetWindowState_ResponseParamsSpec.$ = {};
mojo.internal.bindings.ash.camera_app.mojom.WindowStateController_Minimize_ParamsSpec = mojo.internal.bindings.ash.camera_app.mojom.WindowStateController_Minimize_ParamsSpec || { $: {} };
if (mojo.internal.bindings.ash.camera_app.mojom.WindowStateController_Minimize_ParamsSpec.$.structSpec && mojo.internal.bindings.ash.camera_app.mojom.WindowStateController_Minimize_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.camera_app.mojom.WindowStateController_Minimize_ParamsSpec.$ = {};
mojo.internal.bindings.ash.camera_app.mojom.WindowStateController_Minimize_ResponseParamsSpec = mojo.internal.bindings.ash.camera_app.mojom.WindowStateController_Minimize_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.ash.camera_app.mojom.WindowStateController_Minimize_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.ash.camera_app.mojom.WindowStateController_Minimize_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.camera_app.mojom.WindowStateController_Minimize_ResponseParamsSpec.$ = {};
mojo.internal.bindings.ash.camera_app.mojom.WindowStateController_Restore_ParamsSpec = mojo.internal.bindings.ash.camera_app.mojom.WindowStateController_Restore_ParamsSpec || { $: {} };
if (mojo.internal.bindings.ash.camera_app.mojom.WindowStateController_Restore_ParamsSpec.$.structSpec && mojo.internal.bindings.ash.camera_app.mojom.WindowStateController_Restore_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.camera_app.mojom.WindowStateController_Restore_ParamsSpec.$ = {};
mojo.internal.bindings.ash.camera_app.mojom.WindowStateController_Restore_ResponseParamsSpec = mojo.internal.bindings.ash.camera_app.mojom.WindowStateController_Restore_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.ash.camera_app.mojom.WindowStateController_Restore_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.ash.camera_app.mojom.WindowStateController_Restore_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.camera_app.mojom.WindowStateController_Restore_ResponseParamsSpec.$ = {};
mojo.internal.bindings.ash.camera_app.mojom.WindowStateController_Maximize_ParamsSpec = mojo.internal.bindings.ash.camera_app.mojom.WindowStateController_Maximize_ParamsSpec || { $: {} };
if (mojo.internal.bindings.ash.camera_app.mojom.WindowStateController_Maximize_ParamsSpec.$.structSpec && mojo.internal.bindings.ash.camera_app.mojom.WindowStateController_Maximize_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.camera_app.mojom.WindowStateController_Maximize_ParamsSpec.$ = {};
mojo.internal.bindings.ash.camera_app.mojom.WindowStateController_Maximize_ResponseParamsSpec = mojo.internal.bindings.ash.camera_app.mojom.WindowStateController_Maximize_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.ash.camera_app.mojom.WindowStateController_Maximize_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.ash.camera_app.mojom.WindowStateController_Maximize_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.camera_app.mojom.WindowStateController_Maximize_ResponseParamsSpec.$ = {};
mojo.internal.bindings.ash.camera_app.mojom.WindowStateController_Fullscreen_ParamsSpec = mojo.internal.bindings.ash.camera_app.mojom.WindowStateController_Fullscreen_ParamsSpec || { $: {} };
if (mojo.internal.bindings.ash.camera_app.mojom.WindowStateController_Fullscreen_ParamsSpec.$.structSpec && mojo.internal.bindings.ash.camera_app.mojom.WindowStateController_Fullscreen_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.camera_app.mojom.WindowStateController_Fullscreen_ParamsSpec.$ = {};
mojo.internal.bindings.ash.camera_app.mojom.WindowStateController_Fullscreen_ResponseParamsSpec = mojo.internal.bindings.ash.camera_app.mojom.WindowStateController_Fullscreen_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.ash.camera_app.mojom.WindowStateController_Fullscreen_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.ash.camera_app.mojom.WindowStateController_Fullscreen_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.camera_app.mojom.WindowStateController_Fullscreen_ResponseParamsSpec.$ = {};
mojo.internal.bindings.ash.camera_app.mojom.WindowStateController_Focus_ParamsSpec = mojo.internal.bindings.ash.camera_app.mojom.WindowStateController_Focus_ParamsSpec || { $: {} };
if (mojo.internal.bindings.ash.camera_app.mojom.WindowStateController_Focus_ParamsSpec.$.structSpec && mojo.internal.bindings.ash.camera_app.mojom.WindowStateController_Focus_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.camera_app.mojom.WindowStateController_Focus_ParamsSpec.$ = {};
mojo.internal.bindings.ash.camera_app.mojom.WindowStateController_Focus_ResponseParamsSpec = mojo.internal.bindings.ash.camera_app.mojom.WindowStateController_Focus_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.ash.camera_app.mojom.WindowStateController_Focus_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.ash.camera_app.mojom.WindowStateController_Focus_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.camera_app.mojom.WindowStateController_Focus_ResponseParamsSpec.$ = {};
mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper = mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper || {};
mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelperSpec = mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelperSpec || { $ : {} };
if (mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelperSpec.$.structSpec && mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelperSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelperSpec.$ = {};
mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper.$interfaceName = 'ash.camera_app.mojom.CameraAppHelper';
mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_HandleCameraResult_ParamsSpec = mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_HandleCameraResult_ParamsSpec || { $: {} };
if (mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_HandleCameraResult_ParamsSpec.$.structSpec && mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_HandleCameraResult_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_HandleCameraResult_ParamsSpec.$ = {};
mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_HandleCameraResult_ResponseParamsSpec = mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_HandleCameraResult_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_HandleCameraResult_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_HandleCameraResult_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_HandleCameraResult_ResponseParamsSpec.$ = {};
mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_IsTabletMode_ParamsSpec = mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_IsTabletMode_ParamsSpec || { $: {} };
if (mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_IsTabletMode_ParamsSpec.$.structSpec && mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_IsTabletMode_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_IsTabletMode_ParamsSpec.$ = {};
mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_IsTabletMode_ResponseParamsSpec = mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_IsTabletMode_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_IsTabletMode_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_IsTabletMode_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_IsTabletMode_ResponseParamsSpec.$ = {};
mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_StartPerfEventTrace_ParamsSpec = mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_StartPerfEventTrace_ParamsSpec || { $: {} };
if (mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_StartPerfEventTrace_ParamsSpec.$.structSpec && mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_StartPerfEventTrace_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_StartPerfEventTrace_ParamsSpec.$ = {};
mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_StopPerfEventTrace_ParamsSpec = mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_StopPerfEventTrace_ParamsSpec || { $: {} };
if (mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_StopPerfEventTrace_ParamsSpec.$.structSpec && mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_StopPerfEventTrace_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_StopPerfEventTrace_ParamsSpec.$ = {};
mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_SetTabletMonitor_ParamsSpec = mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_SetTabletMonitor_ParamsSpec || { $: {} };
if (mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_SetTabletMonitor_ParamsSpec.$.structSpec && mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_SetTabletMonitor_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_SetTabletMonitor_ParamsSpec.$ = {};
mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_SetTabletMonitor_ResponseParamsSpec = mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_SetTabletMonitor_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_SetTabletMonitor_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_SetTabletMonitor_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_SetTabletMonitor_ResponseParamsSpec.$ = {};
mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_SetScreenStateMonitor_ParamsSpec = mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_SetScreenStateMonitor_ParamsSpec || { $: {} };
if (mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_SetScreenStateMonitor_ParamsSpec.$.structSpec && mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_SetScreenStateMonitor_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_SetScreenStateMonitor_ParamsSpec.$ = {};
mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_SetScreenStateMonitor_ResponseParamsSpec = mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_SetScreenStateMonitor_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_SetScreenStateMonitor_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_SetScreenStateMonitor_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_SetScreenStateMonitor_ResponseParamsSpec.$ = {};
mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_IsMetricsAndCrashReportingEnabled_ParamsSpec = mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_IsMetricsAndCrashReportingEnabled_ParamsSpec || { $: {} };
if (mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_IsMetricsAndCrashReportingEnabled_ParamsSpec.$.structSpec && mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_IsMetricsAndCrashReportingEnabled_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_IsMetricsAndCrashReportingEnabled_ParamsSpec.$ = {};
mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_IsMetricsAndCrashReportingEnabled_ResponseParamsSpec = mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_IsMetricsAndCrashReportingEnabled_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_IsMetricsAndCrashReportingEnabled_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_IsMetricsAndCrashReportingEnabled_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_IsMetricsAndCrashReportingEnabled_ResponseParamsSpec.$ = {};
mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_SetExternalScreenMonitor_ParamsSpec = mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_SetExternalScreenMonitor_ParamsSpec || { $: {} };
if (mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_SetExternalScreenMonitor_ParamsSpec.$.structSpec && mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_SetExternalScreenMonitor_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_SetExternalScreenMonitor_ParamsSpec.$ = {};
mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_SetExternalScreenMonitor_ResponseParamsSpec = mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_SetExternalScreenMonitor_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_SetExternalScreenMonitor_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_SetExternalScreenMonitor_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_SetExternalScreenMonitor_ResponseParamsSpec.$ = {};
mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_OpenFileInGallery_ParamsSpec = mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_OpenFileInGallery_ParamsSpec || { $: {} };
if (mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_OpenFileInGallery_ParamsSpec.$.structSpec && mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_OpenFileInGallery_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_OpenFileInGallery_ParamsSpec.$ = {};
mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_OpenFeedbackDialog_ParamsSpec = mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_OpenFeedbackDialog_ParamsSpec || { $: {} };
if (mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_OpenFeedbackDialog_ParamsSpec.$.structSpec && mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_OpenFeedbackDialog_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_OpenFeedbackDialog_ParamsSpec.$ = {};
mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_OpenUrlInBrowser_ParamsSpec = mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_OpenUrlInBrowser_ParamsSpec || { $: {} };
if (mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_OpenUrlInBrowser_ParamsSpec.$.structSpec && mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_OpenUrlInBrowser_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_OpenUrlInBrowser_ParamsSpec.$ = {};
mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_GetWindowStateController_ParamsSpec = mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_GetWindowStateController_ParamsSpec || { $: {} };
if (mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_GetWindowStateController_ParamsSpec.$.structSpec && mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_GetWindowStateController_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_GetWindowStateController_ParamsSpec.$ = {};
mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_GetWindowStateController_ResponseParamsSpec = mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_GetWindowStateController_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_GetWindowStateController_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_GetWindowStateController_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_GetWindowStateController_ResponseParamsSpec.$ = {};
mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_ProcessCapturedFile_ParamsSpec = mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_ProcessCapturedFile_ParamsSpec || { $: {} };
if (mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_ProcessCapturedFile_ParamsSpec.$.structSpec && mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_ProcessCapturedFile_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_ProcessCapturedFile_ParamsSpec.$ = {};
mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_ProcessCapturedFile_ResponseParamsSpec = mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_ProcessCapturedFile_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_ProcessCapturedFile_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_ProcessCapturedFile_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_ProcessCapturedFile_ResponseParamsSpec.$ = {};
mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_MonitorFileDeletion_ParamsSpec = mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_MonitorFileDeletion_ParamsSpec || { $: {} };
if (mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_MonitorFileDeletion_ParamsSpec.$.structSpec && mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_MonitorFileDeletion_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_MonitorFileDeletion_ParamsSpec.$ = {};
mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_MonitorFileDeletion_ResponseParamsSpec = mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_MonitorFileDeletion_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_MonitorFileDeletion_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_MonitorFileDeletion_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_MonitorFileDeletion_ResponseParamsSpec.$ = {};
mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_IsDocumentScannerSupported_ParamsSpec = mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_IsDocumentScannerSupported_ParamsSpec || { $: {} };
if (mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_IsDocumentScannerSupported_ParamsSpec.$.structSpec && mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_IsDocumentScannerSupported_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_IsDocumentScannerSupported_ParamsSpec.$ = {};
mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_IsDocumentScannerSupported_ResponseParamsSpec = mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_IsDocumentScannerSupported_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_IsDocumentScannerSupported_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_IsDocumentScannerSupported_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_IsDocumentScannerSupported_ResponseParamsSpec.$ = {};
mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_CheckDocumentModeReadiness_ParamsSpec = mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_CheckDocumentModeReadiness_ParamsSpec || { $: {} };
if (mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_CheckDocumentModeReadiness_ParamsSpec.$.structSpec && mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_CheckDocumentModeReadiness_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_CheckDocumentModeReadiness_ParamsSpec.$ = {};
mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_CheckDocumentModeReadiness_ResponseParamsSpec = mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_CheckDocumentModeReadiness_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_CheckDocumentModeReadiness_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_CheckDocumentModeReadiness_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_CheckDocumentModeReadiness_ResponseParamsSpec.$ = {};
mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_ScanDocumentCorners_ParamsSpec = mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_ScanDocumentCorners_ParamsSpec || { $: {} };
if (mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_ScanDocumentCorners_ParamsSpec.$.structSpec && mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_ScanDocumentCorners_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_ScanDocumentCorners_ParamsSpec.$ = {};
mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_ScanDocumentCorners_ResponseParamsSpec = mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_ScanDocumentCorners_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_ScanDocumentCorners_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_ScanDocumentCorners_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_ScanDocumentCorners_ResponseParamsSpec.$ = {};
mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_ConvertToDocument_ParamsSpec = mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_ConvertToDocument_ParamsSpec || { $: {} };
if (mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_ConvertToDocument_ParamsSpec.$.structSpec && mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_ConvertToDocument_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_ConvertToDocument_ParamsSpec.$ = {};
mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_ConvertToDocument_ResponseParamsSpec = mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_ConvertToDocument_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_ConvertToDocument_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_ConvertToDocument_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_ConvertToDocument_ResponseParamsSpec.$ = {};
mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_MaybeTriggerSurvey_ParamsSpec = mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_MaybeTriggerSurvey_ParamsSpec || { $: {} };
if (mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_MaybeTriggerSurvey_ParamsSpec.$.structSpec && mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_MaybeTriggerSurvey_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_MaybeTriggerSurvey_ParamsSpec.$ = {};
mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_StartStorageMonitor_ParamsSpec = mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_StartStorageMonitor_ParamsSpec || { $: {} };
if (mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_StartStorageMonitor_ParamsSpec.$.structSpec && mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_StartStorageMonitor_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_StartStorageMonitor_ParamsSpec.$ = {};
mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_StartStorageMonitor_ResponseParamsSpec = mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_StartStorageMonitor_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_StartStorageMonitor_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_StartStorageMonitor_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_StartStorageMonitor_ResponseParamsSpec.$ = {};
mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_StopStorageMonitor_ParamsSpec = mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_StopStorageMonitor_ParamsSpec || { $: {} };
if (mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_StopStorageMonitor_ParamsSpec.$.structSpec && mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_StopStorageMonitor_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_StopStorageMonitor_ParamsSpec.$ = {};
mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_OpenStorageManagement_ParamsSpec = mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_OpenStorageManagement_ParamsSpec || { $: {} };
if (mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_OpenStorageManagement_ParamsSpec.$.structSpec && mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_OpenStorageManagement_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_OpenStorageManagement_ParamsSpec.$ = {};
mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_OpenWifiDialog_ParamsSpec = mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_OpenWifiDialog_ParamsSpec || { $: {} };
if (mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_OpenWifiDialog_ParamsSpec.$.structSpec && mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_OpenWifiDialog_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_OpenWifiDialog_ParamsSpec.$ = {};
mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_SetLidStateMonitor_ParamsSpec = mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_SetLidStateMonitor_ParamsSpec || { $: {} };
if (mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_SetLidStateMonitor_ParamsSpec.$.structSpec && mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_SetLidStateMonitor_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_SetLidStateMonitor_ParamsSpec.$ = {};
mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_SetLidStateMonitor_ResponseParamsSpec = mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_SetLidStateMonitor_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_SetLidStateMonitor_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_SetLidStateMonitor_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_SetLidStateMonitor_ResponseParamsSpec.$ = {};
mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_SetSWPrivacySwitchMonitor_ParamsSpec = mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_SetSWPrivacySwitchMonitor_ParamsSpec || { $: {} };
if (mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_SetSWPrivacySwitchMonitor_ParamsSpec.$.structSpec && mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_SetSWPrivacySwitchMonitor_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_SetSWPrivacySwitchMonitor_ParamsSpec.$ = {};
mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_SetSWPrivacySwitchMonitor_ResponseParamsSpec = mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_SetSWPrivacySwitchMonitor_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_SetSWPrivacySwitchMonitor_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_SetSWPrivacySwitchMonitor_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_SetSWPrivacySwitchMonitor_ResponseParamsSpec.$ = {};
mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_GetEventsSender_ParamsSpec = mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_GetEventsSender_ParamsSpec || { $: {} };
if (mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_GetEventsSender_ParamsSpec.$.structSpec && mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_GetEventsSender_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_GetEventsSender_ParamsSpec.$ = {};
mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_GetEventsSender_ResponseParamsSpec = mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_GetEventsSender_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_GetEventsSender_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_GetEventsSender_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_GetEventsSender_ResponseParamsSpec.$ = {};
mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_SetScreenLockedMonitor_ParamsSpec = mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_SetScreenLockedMonitor_ParamsSpec || { $: {} };
if (mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_SetScreenLockedMonitor_ParamsSpec.$.structSpec && mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_SetScreenLockedMonitor_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_SetScreenLockedMonitor_ParamsSpec.$ = {};
mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_SetScreenLockedMonitor_ResponseParamsSpec = mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_SetScreenLockedMonitor_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_SetScreenLockedMonitor_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_SetScreenLockedMonitor_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_SetScreenLockedMonitor_ResponseParamsSpec.$ = {};
mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_RenderPdfAsJpeg_ParamsSpec = mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_RenderPdfAsJpeg_ParamsSpec || { $: {} };
if (mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_RenderPdfAsJpeg_ParamsSpec.$.structSpec && mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_RenderPdfAsJpeg_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_RenderPdfAsJpeg_ParamsSpec.$ = {};
mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_RenderPdfAsJpeg_ResponseParamsSpec = mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_RenderPdfAsJpeg_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_RenderPdfAsJpeg_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_RenderPdfAsJpeg_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_RenderPdfAsJpeg_ResponseParamsSpec.$ = {};
mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_PerformOcr_ParamsSpec = mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_PerformOcr_ParamsSpec || { $: {} };
if (mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_PerformOcr_ParamsSpec.$.structSpec && mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_PerformOcr_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_PerformOcr_ParamsSpec.$ = {};
mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_PerformOcr_ResponseParamsSpec = mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_PerformOcr_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_PerformOcr_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_PerformOcr_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_PerformOcr_ResponseParamsSpec.$ = {};
mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_PerformOcrInline_ParamsSpec = mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_PerformOcrInline_ParamsSpec || { $: {} };
if (mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_PerformOcrInline_ParamsSpec.$.structSpec && mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_PerformOcrInline_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_PerformOcrInline_ParamsSpec.$ = {};
mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_PerformOcrInline_ResponseParamsSpec = mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_PerformOcrInline_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_PerformOcrInline_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_PerformOcrInline_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_PerformOcrInline_ResponseParamsSpec.$ = {};
mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_CreatePdfBuilder_ParamsSpec = mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_CreatePdfBuilder_ParamsSpec || { $: {} };
if (mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_CreatePdfBuilder_ParamsSpec.$.structSpec && mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_CreatePdfBuilder_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_CreatePdfBuilder_ParamsSpec.$ = {};
mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_GetAspectRatioOrder_ParamsSpec = mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_GetAspectRatioOrder_ParamsSpec || { $: {} };
if (mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_GetAspectRatioOrder_ParamsSpec.$.structSpec && mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_GetAspectRatioOrder_ParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_GetAspectRatioOrder_ParamsSpec.$ = {};
mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_GetAspectRatioOrder_ResponseParamsSpec = mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_GetAspectRatioOrder_ResponseParamsSpec || { $: {} };
if (mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_GetAspectRatioOrder_ResponseParamsSpec.$.structSpec && mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_GetAspectRatioOrder_ResponseParamsSpec.$.structSpec.name === 'OpaqueStruct') mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_GetAspectRatioOrder_ResponseParamsSpec.$ = {};
...
mojo.internal.bindings.ash.camera_app = mojo.internal.bindings.ash.camera_app || {};
mojo.internal.bindings.ash.camera_app.mojom = mojo.internal.bindings.ash.camera_app.mojom || {};
mojo.internal.bindings.ash.camera_app.mojom.CaptureDestinationSpec = mojo.internal.bindings.ash.camera_app.mojom.CaptureDestinationSpec || { $: mojo.internal.OpaqueStruct.$ };
mojo.internal.bindings.ash = mojo.internal.bindings.ash || {};
mojo.internal.bindings.ash.camera_app = mojo.internal.bindings.ash.camera_app || {};
mojo.internal.bindings.ash.camera_app.mojom = mojo.internal.bindings.ash.camera_app.mojom || {};
...
mojo.internal.bindings.ash.camera_app = mojo.internal.bindings.ash.camera_app || {};
mojo.internal.bindings.ash.camera_app.mojom = mojo.internal.bindings.ash.camera_app.mojom || {};
mojo.internal.bindings.ash.camera_app.mojom.OcrResultSpec = mojo.internal.bindings.ash.camera_app.mojom.OcrResultSpec || { $: mojo.internal.OpaqueStruct.$ };
mojo.internal.bindings.ash = mojo.internal.bindings.ash || {};
mojo.internal.bindings.ash.camera_app = mojo.internal.bindings.ash.camera_app || {};
mojo.internal.bindings.ash.camera_app.mojom = mojo.internal.bindings.ash.camera_app.mojom || {};
...
mojo.internal.bindings.chromeos.machine_learning.mojom.RotationSpec = mojo.internal.bindings.chromeos.machine_learning.mojom.RotationSpec || { $: mojo.internal.Enum().$ };
mojo.internal.bindings.gfx = mojo.internal.bindings.gfx || {};
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const message = new mojo.internal.Message(
                ...
                header.ordinal, header.requestId, mojo.internal.bindings.ash.camera_app.mojom.CameraUsageOwnershipMonitor_OnCameraUsageOwnershipChanged_ResponseParamsSpec.$.structSpec, resp_obj);
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        case 0: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              const val = (response && typeof response === 'object' && 'arg_states' in response) ? response['arg_states'] : response;
              const resp_obj = { 'arg_states': val };
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.ash.camera_app.mojom.WindowStateController_AddMonitor_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
        ...
        case 1: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.ash.camera_app.mojom.WindowStateController_GetWindowState_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
        ...
        case 2: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.ash.camera_app.mojom.WindowStateController_Minimize_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
        ...
        case 3: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.ash.camera_app.mojom.WindowStateController_Restore_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
        ...
        case 4: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.ash.camera_app.mojom.WindowStateController_Maximize_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
        ...
        case 5: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.ash.camera_app.mojom.WindowStateController_Fullscreen_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
        ...
        case 6: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.ash.camera_app.mojom.WindowStateController_Focus_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
    ...
    this.endpoint.start({ onError: function() { console.log('[GeneratedReceiver] Endpoint Error'); },
      ...
      switch (dispatchId) {
        case 0: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_HandleCameraResult_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
        ...
        case 1: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_IsTabletMode_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
        ...
        case 4: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_SetTabletMonitor_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
        ...
        case 5: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_SetScreenStateMonitor_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
        ...
        case 6: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_IsMetricsAndCrashReportingEnabled_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
        ...
        case 7: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              const val = (response && typeof response === 'object' && 'arg_has_external_screen' in response) ? response['arg_has_external_screen'] : response;
              const resp_obj = { 'arg_has_external_screen': val };
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_SetExternalScreenMonitor_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
        ...
        case 11: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_GetWindowStateController_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
        ...
        case 12: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_ProcessCapturedFile_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
        ...
        case 13: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_MonitorFileDeletion_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
        ...
        case 14: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_IsDocumentScannerSupported_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
        ...
        case 15: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              const val = (response && typeof response === 'object' && 'arg_is_loaded' in response) ? response['arg_is_loaded'] : response;
              const resp_obj = { 'arg_is_loaded': val };
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_CheckDocumentModeReadiness_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
        ...
        case 16: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              const val = (response && typeof response === 'object' && 'arg_corners' in response) ? response['arg_corners'] : response;
              const resp_obj = { 'arg_corners': val };
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_ScanDocumentCorners_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
        ...
        case 17: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              const val = (response && typeof response === 'object' && 'arg_doc_data' in response) ? response['arg_doc_data'] : response;
              const resp_obj = { 'arg_doc_data': val };
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_ConvertToDocument_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
        ...
        case 19: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              const val = (response && typeof response === 'object' && 'arg_initial_status' in response) ? response['arg_initial_status'] : response;
              const resp_obj = { 'arg_initial_status': val };
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_StartStorageMonitor_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
        ...
        case 23: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              const val = (response && typeof response === 'object' && 'arg_lid_status' in response) ? response['arg_lid_status'] : response;
              const resp_obj = { 'arg_lid_status': val };
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_SetLidStateMonitor_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
        ...
        case 24: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              const val = (response && typeof response === 'object' && 'arg_is_sw_privacy_switch_on' in response) ? response['arg_is_sw_privacy_switch_on'] : response;
              const resp_obj = { 'arg_is_sw_privacy_switch_on': val };
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_SetSWPrivacySwitchMonitor_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
        ...
        case 25: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              const val = (response && typeof response === 'object' && 'arg_events_sender' in response) ? response['arg_events_sender'] : response;
              const resp_obj = { 'arg_events_sender': val };
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_GetEventsSender_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
        ...
        case 26: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              const val = (response && typeof response === 'object' && 'arg_is_screen_locked' in response) ? response['arg_is_screen_locked'] : response;
              const resp_obj = { 'arg_is_screen_locked': val };
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_SetScreenLockedMonitor_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
        ...
        case 27: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              const val = (response && typeof response === 'object' && 'arg_jpeg_data' in response) ? response['arg_jpeg_data'] : response;
              const resp_obj = { 'arg_jpeg_data': val };
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_RenderPdfAsJpeg_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
        ...
        case 28: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              const val = (response && typeof response === 'object' && 'arg_ocr_result' in response) ? response['arg_ocr_result'] : response;
              const resp_obj = { 'arg_ocr_result': val };
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_PerformOcr_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
        ...
        case 29: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_PerformOcrInline_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
        ...
        case 31: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              const val = (response && typeof response === 'object' && 'arg_order' in response) ? response['arg_order'] : response;
              const resp_obj = { 'arg_order': val };
              const message = new mojo.internal.Message(
                this.router_, 0, mojo.internal.kMessageFlagIsResponse,
                header.ordinal, header.requestId, mojo.internal.bindings.ash.camera_app.mojom.CameraAppHelper_GetAspectRatioOrder_ResponseParamsSpec.$.structSpec, resp_obj);
              this.router_.send(message);
