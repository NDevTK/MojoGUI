...
mojo.internal.bindings.mirroring.mojom.kRemotingNamespace = "urn:x-cast:com.google.cast.remoting";
...
mojo.internal.bindings.mirroring.mojom.CastMessageChannelRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.mirroring.mojom.CastMessageChannelPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.mirroring.mojom.CastMessageChannelRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.mirroring.mojom.CastMessageChannel.getRemote = function() {
  let remote = new mojo.internal.bindings.mirroring.mojom.CastMessageChannelRemote();
...
mojo.internal.bindings.mirroring.mojom.CastMessageChannelReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.mirroring.mojom.CastMessageChannel_OnMessage_ParamsSpec.$.structSpec;
...
mojo.internal.bindings.mirroring.mojom.CastMessageChannelReceiver = mojo.internal.bindings.mirroring.mojom.CastMessageChannelReceiver;
