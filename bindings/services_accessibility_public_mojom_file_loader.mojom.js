...
mojo.internal.bindings.ax.mojom.AccessibilityFileLoaderRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.ax.mojom.AccessibilityFileLoaderPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.ax.mojom.AccessibilityFileLoaderRemoteCallHandler(this.proxy);
  }
  ...
  load(arg_path) {
    return this.$.load(arg_path);
  }
};

mojo.internal.bindings.ax.mojom.AccessibilityFileLoaderRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('ax.mojom.AccessibilityFileLoader', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.ax.mojom.AccessibilityFileLoader.getRemote = function() {
  let remote = new mojo.internal.bindings.ax.mojom.AccessibilityFileLoaderRemote();
...
mojo.internal.bindings.ax.mojom.AccessibilityFileLoaderReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('ax.mojom.AccessibilityFileLoader', [
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.ax.mojom.AccessibilityFileLoader_Load_ParamsSpec.$.structSpec);
        ...
        case 0: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.ax.mojom.AccessibilityFileLoader_Load_ResponseParamsSpec, header, rawHeader);
               responder(response);
...
mojo.internal.bindings.ax.mojom.AccessibilityFileLoaderReceiver = mojo.internal.bindings.ax.mojom.AccessibilityFileLoaderReceiver;
