...
mojo.internal.Struct(
    mojo.internal.bindings.ash.nearby.presence.mojom.MetadataSpec, 'ash.nearby.presence.mojom.Metadata', [
      ...
      mojo.internal.StructField('arg_bluetooth_mac_address', 8, 0, mojo.internal.Array(mojo.internal.Uint8, false), null, false, 0, undefined),
      mojo.internal.StructField('arg_device_id', 16, 0, mojo.internal.Array(mojo.internal.Uint8, false), null, false, 0, undefined),
      mojo.internal.StructField('arg_device_type', 24, 0, mojo.internal.bindings.ash.nearby.presence.mojom.PresenceDeviceTypeSpec, null, false, 0, undefined),
    ],
    [[0, 40]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.ash.nearby.presence.mojom.SharedCredentialSpec, 'ash.nearby.presence.mojom.SharedCredential', [
      ...
      mojo.internal.StructField('arg_version', 56, 0, mojo.internal.Array(mojo.internal.Uint8, false), null, false, 0, undefined),
      mojo.internal.StructField('arg_encrypted_metadata_bytes_v1', 64, 0, mojo.internal.Array(mojo.internal.Uint8, false), null, false, 0, undefined),
      mojo.internal.StructField('arg_identity_token_short_salt_adv_hmac_key_v1', 72, 0, mojo.internal.Array(mojo.internal.Uint8, false), null, false, 0, undefined),
      mojo.internal.StructField('arg_id', 80, 0, mojo.internal.Int64, 0, false, 0, undefined),
      mojo.internal.StructField('arg_dusi', 88, 0, mojo.internal.String, null, false, 0, undefined),
      mojo.internal.StructField('arg_signature_version', 96, 0, mojo.internal.String, null, false, 0, undefined),
      mojo.internal.StructField('arg_identity_token_extended_salt_adv_hmac_key_v1', 104, 0, mojo.internal.Array(mojo.internal.Uint8, false), null, false, 0, undefined),
      mojo.internal.StructField('arg_identity_token_signed_adv_hmac_key_v1', 112, 0, mojo.internal.Array(mojo.internal.Uint8, false), null, false, 0, undefined),
      mojo.internal.StructField('arg_identity_type', 120, 0, mojo.internal.bindings.ash.nearby.presence.mojom.IdentityTypeSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_credential_type', 124, 0, mojo.internal.bindings.ash.nearby.presence.mojom.CredentialTypeSpec, null, false, 0, undefined),
    ],
    [[0, 136]]);
...
mojo.internal.Struct(
    mojo.internal.bindings.ash.nearby.presence.mojom.LocalCredentialSpec, 'ash.nearby.presence.mojom.LocalCredential', [
      ...
      mojo.internal.StructField('arg_consumed_salts', 56, 0, mojo.internal.Map(mojo.internal.Uint32, mojo.internal.Bool, false), null, false, 0, undefined),
      mojo.internal.StructField('arg_identity_token_v1', 64, 0, mojo.internal.Array(mojo.internal.Uint8, false), null, false, 0, undefined),
      mojo.internal.StructField('arg_id', 72, 0, mojo.internal.Int64, 0, false, 0, undefined),
      mojo.internal.StructField('arg_signature_version', 80, 0, mojo.internal.String, null, false, 0, undefined),
      mojo.internal.StructField('arg_identity_type', 88, 0, mojo.internal.bindings.ash.nearby.presence.mojom.IdentityTypeSpec, null, false, 0, undefined),
    ],
    [[0, 104]]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ash.nearby.presence.mojom.ScanObserver_OnDeviceFound_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OnDeviceFound failed with TypeError');
           }
        }
        // Try Method 1: OnDeviceChanged
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ash.nearby.presence.mojom.ScanObserver_OnDeviceChanged_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OnDeviceChanged failed with TypeError');
           }
        }
        // Try Method 2: OnDeviceLost
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ash.nearby.presence.mojom.ScanObserver_OnDeviceLost_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OnDeviceLost failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
             console.warn('[GeneratedReceiver] Failed to discover ordinal ' + header.ordinal);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ash.nearby.presence.mojom.NearbyPresence_StartScan_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for StartScan failed with TypeError');
           }
        }
        // Try Method 1: SetScanObserver
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ash.nearby.presence.mojom.NearbyPresence_SetScanObserver_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for SetScanObserver failed with TypeError');
           }
        }
        // Try Method 2: UpdateLocalDeviceMetadata
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ash.nearby.presence.mojom.NearbyPresence_UpdateLocalDeviceMetadata_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for UpdateLocalDeviceMetadata failed with TypeError');
           }
        }
        // Try Method 3: UpdateLocalDeviceMetadataAndGenerateCredentials
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ash.nearby.presence.mojom.NearbyPresence_UpdateLocalDeviceMetadataAndGenerateCredentials_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for UpdateLocalDeviceMetadataAndGenerateCredentials failed with TypeError');
           }
        }
        // Try Method 4: UpdateRemoteSharedCredentials
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ash.nearby.presence.mojom.NearbyPresence_UpdateRemoteSharedCredentials_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for UpdateRemoteSharedCredentials failed with TypeError');
           }
        }
        // Try Method 5: GetLocalSharedCredentials
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ash.nearby.presence.mojom.NearbyPresence_GetLocalSharedCredentials_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for GetLocalSharedCredentials failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
             console.warn('[GeneratedReceiver] Failed to discover ordinal ' + header.ordinal);
