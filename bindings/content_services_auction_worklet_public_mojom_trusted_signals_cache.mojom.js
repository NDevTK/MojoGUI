...
mojo.internal.bindings.auction_worklet.mojom.TrustedSignalsCompressionScheme = {
  kNone: 0,
  kGzip: 1,
  kBrotli: 2,
};
...
mojo.internal.bindings.auction_worklet.mojom.TrustedSignalsCacheClientRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.auction_worklet.mojom.TrustedSignalsCacheClientPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.auction_worklet.mojom.TrustedSignalsCacheClientRemoteCallHandler(this.proxy);
  }
  ...
  onSuccess(arg_compression_scheme, arg_compression_group_data) {
    return this.$.onSuccess(arg_compression_scheme, arg_compression_group_data);
  }
  onError(arg_error_message) {
    return this.$.onError(arg_error_message);
  }
};
...
mojo.internal.bindings.auction_worklet.mojom.TrustedSignalsCacheClient.getRemote = function() {
  let remote = new mojo.internal.bindings.auction_worklet.mojom.TrustedSignalsCacheClientRemote();
...
mojo.internal.bindings.auction_worklet.mojom.TrustedSignalsCacheClientReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.auction_worklet.mojom.TrustedSignalsCacheClient_OnSuccess_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OnSuccess failed with TypeError');
           }
        }
        // Try Method 1: OnError
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.auction_worklet.mojom.TrustedSignalsCacheClient_OnError_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
...
mojo.internal.bindings.auction_worklet.mojom.TrustedSignalsCacheClientReceiver = mojo.internal.bindings.auction_worklet.mojom.TrustedSignalsCacheClientReceiver;

mojo.internal.bindings.auction_worklet.mojom.TrustedSignalsCacheClientPtr = mojo.internal.bindings.auction_worklet.mojom.TrustedSignalsCacheClientRemote;
mojo.internal.bindings.auction_worklet.mojom.TrustedSignalsCacheClientRequest = mojo.internal.bindings.auction_worklet.mojom.TrustedSignalsCacheClientPendingReceiver;
...
mojo.internal.bindings.auction_worklet.mojom.TrustedSignalsCacheRemote = class {
  static get $interfaceName() {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.auction_worklet.mojom.TrustedSignalsCacheRemoteCallHandler(this.proxy);
  }
  ...
  getTrustedSignals(arg_compression_group_token, arg_client) {
    return this.$.getTrustedSignals(arg_compression_group_token, arg_client);
  }
};
...
mojo.internal.bindings.auction_worklet.mojom.TrustedSignalsCache.getRemote = function() {
  let remote = new mojo.internal.bindings.auction_worklet.mojom.TrustedSignalsCacheRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
...
mojo.internal.bindings.auction_worklet.mojom.TrustedSignalsCacheReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.auction_worklet.mojom.TrustedSignalsCache_GetTrustedSignals_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for GetTrustedSignals failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
             console.warn('[GeneratedReceiver] Failed to discover ordinal ' + header.ordinal);
...
mojo.internal.bindings.auction_worklet.mojom.TrustedSignalsCacheReceiver = mojo.internal.bindings.auction_worklet.mojom.TrustedSignalsCacheReceiver;
