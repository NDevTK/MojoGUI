...
mojo.internal.bindings.content.mojom.ChooserEventType = {
  CHOOSER_OPENED: 0,
  CHOOSER_CLOSED: 1,
  ADAPTER_REMOVED: 2,
  ADAPTER_DISABLED: 3,
...
mojo.internal.bindings.content.mojom.FakeBluetoothChooserRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.content.mojom.FakeBluetoothChooserPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.content.mojom.FakeBluetoothChooserRemoteCallHandler(this.proxy);
  }
  ...
  selectPeripheral(arg_peripheral_address) {
    return this.$.selectPeripheral(arg_peripheral_address);
  }
  cancel() {
    return this.$.cancel();
  }
...
mojo.internal.bindings.content.mojom.FakeBluetoothChooser.getRemote = function() {
  let remote = new mojo.internal.bindings.content.mojom.FakeBluetoothChooserRemote();
...
mojo.internal.bindings.content.mojom.FakeBluetoothChooserReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.content.mojom.FakeBluetoothChooser_SelectPeripheral_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for SelectPeripheral failed with TypeError');
           }
        }
        // Try Method 1: Cancel
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.content.mojom.FakeBluetoothChooser_Cancel_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.content.mojom.FakeBluetoothChooser_Rescan_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for Rescan failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
      ...
      switch (dispatchId) {
        ...
        case 1: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.content.mojom.FakeBluetoothChooser_Cancel_ParamsSpec.$.structSpec);
        ...
        case 2: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.content.mojom.FakeBluetoothChooser_Rescan_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.content.mojom.FakeBluetoothChooserReceiver = mojo.internal.bindings.content.mojom.FakeBluetoothChooserReceiver;

mojo.internal.bindings.content.mojom.FakeBluetoothChooserPtr = mojo.internal.bindings.content.mojom.FakeBluetoothChooserRemote;
mojo.internal.bindings.content.mojom.FakeBluetoothChooserRequest = mojo.internal.bindings.content.mojom.FakeBluetoothChooserPendingReceiver;
...
mojo.internal.bindings.content.mojom.FakeBluetoothChooserFactoryRemote = class {
  static get $interfaceName() {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.content.mojom.FakeBluetoothChooserFactoryPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.content.mojom.FakeBluetoothChooserFactoryRemoteCallHandler(this.proxy);
  }
  ...
  createFakeBluetoothChooser(arg_fake_chooser, arg_client) {
    return this.$.createFakeBluetoothChooser(arg_fake_chooser, arg_client);
  }
};
...
mojo.internal.bindings.content.mojom.FakeBluetoothChooserFactory.getRemote = function() {
  let remote = new mojo.internal.bindings.content.mojom.FakeBluetoothChooserFactoryRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
...
mojo.internal.bindings.content.mojom.FakeBluetoothChooserFactoryReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.content.mojom.FakeBluetoothChooserFactory_CreateFakeBluetoothChooser_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for CreateFakeBluetoothChooser failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
             console.warn('[GeneratedReceiver] Failed to discover ordinal ' + header.ordinal);
...
mojo.internal.bindings.content.mojom.FakeBluetoothChooserFactoryReceiver = mojo.internal.bindings.content.mojom.FakeBluetoothChooserFactoryReceiver;

mojo.internal.bindings.content.mojom.FakeBluetoothChooserFactoryPtr = mojo.internal.bindings.content.mojom.FakeBluetoothChooserFactoryRemote;
mojo.internal.bindings.content.mojom.FakeBluetoothChooserFactoryRequest = mojo.internal.bindings.content.mojom.FakeBluetoothChooserFactoryPendingReceiver;
...
mojo.internal.bindings.content.mojom.FakeBluetoothChooserClientRemote = class {
  static get $interfaceName() {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.content.mojom.FakeBluetoothChooserClientPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.content.mojom.FakeBluetoothChooserClientRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.content.mojom.FakeBluetoothChooserClient.getRemote = function() {
  let remote = new mojo.internal.bindings.content.mojom.FakeBluetoothChooserClientRemote();
  let receiver = remote.bindNewPipeAndPassReceiver();
  mojo.internal.interfaceSupport.bind(
    receiver.handle,
...
mojo.internal.bindings.content.mojom.FakeBluetoothChooserClientReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.content.mojom.FakeBluetoothChooserClient_OnEvent_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
...
mojo.internal.bindings.content.mojom.FakeBluetoothChooserClientReceiver = mojo.internal.bindings.content.mojom.FakeBluetoothChooserClientReceiver;
