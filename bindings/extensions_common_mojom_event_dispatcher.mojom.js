...
mojo.internal.bindings.extensions.mojom.EventFilteringInfoSpec = { $: {} };
mojo.internal.bindings.extensions.mojom.DispatchEventParamsSpec = { $: {} };
mojo.internal.bindings.extensions.mojom.EventDispatcher = {};
mojo.internal.bindings.extensions.mojom.EventDispatcherSpec = { $ : {} };
mojo.internal.bindings.extensions.mojom.EventDispatcher.$interfaceName = 'extensions.mojom.EventDispatcher';
...
mojo.internal.Struct(
    mojo.internal.bindings.extensions.mojom.EventFilteringInfoSpec, 'extensions.mojom.EventFilteringInfo', [
      ...
      mojo.internal.StructField('arg_window_type', 16, 0, mojo.internal.String, null, true, 0, undefined),
      mojo.internal.StructField('arg_instance_id', 24, 0, mojo.internal.Int32, 0, false, 0, undefined),
      mojo.internal.StructField('arg_has_instance_id', 28, 0, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_has_window_exposed_by_default', 28, 1, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_window_exposed_by_default', 28, 2, mojo.internal.Bool, false, false, 0, undefined),
    ],
    [[0, 40]]);
...
mojo.internal.bindings.extensions.mojom.EventDispatcherRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      ...
      handle);
    this.$ = new mojo.internal.bindings.extensions.mojom.EventDispatcherRemoteCallHandler(this.proxy);
  }
  ...
  dispatchEvent(arg_params, arg_event_args) {
    return this.$.dispatchEvent(arg_params, arg_event_args);
  }
};

mojo.internal.bindings.extensions.mojom.EventDispatcherRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('extensions.mojom.EventDispatcher', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.extensions.mojom.EventDispatcher.getRemote = function() {
  let remote = new mojo.internal.bindings.extensions.mojom.EventDispatcherRemote();
...
mojo.internal.bindings.extensions.mojom.EventDispatcherReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('extensions.mojom.EventDispatcher', [
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             decoder.decodeStructInline(mojo.internal.bindings.extensions.mojom.EventDispatcher_DispatchEvent_ParamsSpec.$.structSpec);
        ...
        case 0: {
          ...
          if (expectsResponse) {
            Promise.resolve(result).then(response => {
              ...
              const responder = mojo.internal.interfaceSupport.createResponder(this.endpoint, header.requestId, mojo.internal.bindings.extensions.mojom.EventDispatcher_DispatchEvent_ResponseParamsSpec, header, rawHeader);
               responder(response);
...
mojo.internal.bindings.extensions.mojom.EventDispatcherReceiver = mojo.internal.bindings.extensions.mojom.EventDispatcherReceiver;
