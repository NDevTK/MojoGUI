...
mojo.internal.bindings.ai = mojo.internal.bindings.ai || {};
mojo.internal.bindings.ai.mojom = mojo.internal.bindings.ai.mojom || {};
mojo.internal.bindings.ai.mojom.EnhancedCalendarResponseResultSpec = mojo.internal.bindings.ai.mojom.EnhancedCalendarResponseResultSpec || { $: mojo.internal.OpaqueStruct.$ };
mojo.internal.bindings.mojo_base = mojo.internal.bindings.mojo_base || {};
...
mojo.internal.bindings.ai.mojom.EnhancedCalendarServiceRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.ai.mojom.EnhancedCalendarServicePendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.ai.mojom.EnhancedCalendarServiceRemoteCallHandler(this.proxy);
  }
  ...
  executeEnhancedCalendarRequest(arg_request_params) {
    return this.$.executeEnhancedCalendarRequest(arg_request_params);
  }
};

mojo.internal.bindings.ai.mojom.EnhancedCalendarServiceRemoteCallHandler = class {
  constructor(proxy) {
    this.proxy = proxy;
    this.ordinals = window.mojoScrambler.getOrdinals('ai.mojom.EnhancedCalendarService', [
      { explicit: null },
    ]);
  }
...
mojo.internal.bindings.ai.mojom.EnhancedCalendarService.getRemote = function() {
  let remote = new mojo.internal.bindings.ai.mojom.EnhancedCalendarServiceRemote();
...
mojo.internal.bindings.ai.mojom.EnhancedCalendarServiceReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
    this.ordinalMap = new Map();
    const ordinals = window.mojoScrambler.getOrdinals('ai.mojom.EnhancedCalendarService', [
      { explicit: null },
    ]);
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        // Try Method 0: ExecuteEnhancedCalendarRequest
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.ai.mojom.EnhancedCalendarService_ExecuteEnhancedCalendarRequest_ParamsSpec.$.structSpec;
             ...
             if (sizeMatch && (!!(header.flags & 1) === methodExpectsResp)) {
               if (size > 8 || message.payload.byteLength === 8) {
                 ...
                 console.log('[GeneratedReceiver] Discovery SUCCESS: ' + header.ordinal + ' -> ExecuteEnhancedCalendarRequest (0)');
                 this.mapOrdinal(header.ordinal, 0);
                 dispatchId = 0;
               }
             }
           } catch (e) {
             if (e instanceof TypeError) console.warn('[Discovery] trial for ExecuteEnhancedCalendarRequest failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.ai.mojom.EnhancedCalendarServiceReceiver = mojo.internal.bindings.ai.mojom.EnhancedCalendarServiceReceiver;
