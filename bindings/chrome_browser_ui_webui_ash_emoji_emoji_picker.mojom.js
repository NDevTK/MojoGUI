  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.emoji_picker.mojom.PageHandlerFactory_CreatePageHandler_ParamsSpec.$.structSpec;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.emoji_picker.mojom.PageHandler_ShowUI_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for ShowUI failed with TypeError');
           }
        }
        // Try Method 1: InsertEmoji
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.emoji_picker.mojom.PageHandler_InsertEmoji_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for InsertEmoji failed with TypeError');
           }
        }
        // Try Method 2: InsertGif
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.emoji_picker.mojom.PageHandler_InsertGif_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for InsertGif failed with TypeError');
           }
        }
        // Try Method 3: IsIncognitoTextField
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.emoji_picker.mojom.PageHandler_IsIncognitoTextField_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for IsIncognitoTextField failed with TypeError');
           }
        }
        // Try Method 4: GetFeatureList
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.emoji_picker.mojom.PageHandler_GetFeatureList_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for GetFeatureList failed with TypeError');
           }
        }
        // Try Method 5: GetCategories
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.emoji_picker.mojom.PageHandler_GetCategories_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for GetCategories failed with TypeError');
           }
        }
        // Try Method 6: GetFeaturedGifs
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.emoji_picker.mojom.PageHandler_GetFeaturedGifs_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for GetFeaturedGifs failed with TypeError');
           }
        }
        // Try Method 7: SearchGifs
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.emoji_picker.mojom.PageHandler_SearchGifs_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for SearchGifs failed with TypeError');
           }
        }
        // Try Method 8: GetGifsByIds
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.emoji_picker.mojom.PageHandler_GetGifsByIds_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for GetGifsByIds failed with TypeError');
           }
        }
        // Try Method 9: OnUiFullyLoaded
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.emoji_picker.mojom.PageHandler_OnUiFullyLoaded_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for OnUiFullyLoaded failed with TypeError');
           }
        }
        // Try Method 10: GetInitialCategory
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.emoji_picker.mojom.PageHandler_GetInitialCategory_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for GetInitialCategory failed with TypeError');
           }
        }
        // Try Method 11: GetInitialQuery
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.emoji_picker.mojom.PageHandler_GetInitialQuery_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for GetInitialQuery failed with TypeError');
           }
        }
        // Try Method 12: UpdateHistoryInPrefs
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.emoji_picker.mojom.PageHandler_UpdateHistoryInPrefs_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for UpdateHistoryInPrefs failed with TypeError');
           }
        }
        // Try Method 13: UpdatePreferredVariantsInPrefs
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.emoji_picker.mojom.PageHandler_UpdatePreferredVariantsInPrefs_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for UpdatePreferredVariantsInPrefs failed with TypeError');
           }
        }
        // Try Method 14: GetHistoryFromPrefs
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.emoji_picker.mojom.PageHandler_GetHistoryFromPrefs_ParamsSpec.$.structSpec;
             const size = decoder.decodeUint32(0);
             const version = decoder.decodeUint32(4);
             let sizeMatch = false;
             for (const v of structSpec.versions) {
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for GetHistoryFromPrefs failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
             console.warn('[GeneratedReceiver] Failed to discover ordinal ' + header.ordinal);
