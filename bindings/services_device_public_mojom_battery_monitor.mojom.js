...
mojo.internal.bindings.device.mojom.BatteryMonitorRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.device.mojom.BatteryMonitorPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.device.mojom.BatteryMonitorRemoteCallHandler(this.proxy);
  }
...
mojo.internal.bindings.device.mojom.BatteryMonitor.getRemote = function() {
  let remote = new mojo.internal.bindings.device.mojom.BatteryMonitorRemote();
...
mojo.internal.bindings.device.mojom.BatteryMonitorReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.device.mojom.BatteryMonitor_QueryNextStatus_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for QueryNextStatus failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
      ...
      switch (dispatchId) {
        case 0: {
          const decoder = new mojo.internal.Decoder(message.payload, message.handles);
          const params = decoder.decodeStructInline(mojo.internal.bindings.device.mojom.BatteryMonitor_QueryNextStatus_ParamsSpec.$.structSpec);
...
mojo.internal.bindings.device.mojom.BatteryMonitorReceiver = mojo.internal.bindings.device.mojom.BatteryMonitorReceiver;
