...
mojo.internal.bindings.content.mojom.MhtmlSaveStatus = {
  kSuccess: 0,
  kFileClosingError: 1,
...
mojo.internal.Struct(
    mojo.internal.bindings.content.mojom.SerializeAsMHTMLParamsSpec, 'content.mojom.SerializeAsMHTMLParams', [
      ...
      mojo.internal.StructField('arg_salt', 16, 0, mojo.internal.bindings.mojo_base.mojom.ByteStringSpec, null, false, 0, undefined),
      mojo.internal.StructField('arg_output_handle', 24, 0, mojo.internal.bindings.content.mojom.MhtmlOutputHandleSpec.$, null, false, 0, undefined),
      mojo.internal.StructField('arg_mhtml_binary_encoding', 32, 0, mojo.internal.Bool, false, false, 0, undefined),
      mojo.internal.StructField('arg_mhtml_popup_overlay_removal', 32, 1, mojo.internal.Bool, false, false, 0, undefined),
    ],
    [[0, 48]]);
...
mojo.internal.bindings.content.mojom.MhtmlFileWriterRemote = class {
  ...
  constructor(handle = undefined) {
    this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(
      mojo.internal.bindings.content.mojom.MhtmlFileWriterPendingReceiver,
      handle);
    this.$ = new mojo.internal.bindings.content.mojom.MhtmlFileWriterRemoteCallHandler(this.proxy);
  }
  ...
  serializeAsMHTML(arg_params) {
    return this.$.serializeAsMHTML(arg_params);
  }
};
...
mojo.internal.bindings.content.mojom.MhtmlFileWriter.getRemote = function() {
  let remote = new mojo.internal.bindings.content.mojom.MhtmlFileWriterRemote();
...
mojo.internal.bindings.content.mojom.MhtmlFileWriterReceiver = class {
  constructor(impl) {
    this.impl = impl;
    this.endpoint = null;
  ...
  bind(handle) {
    ...
    this.endpoint.start({ onMessageReceived: (...args) => {
      ...
      if (dispatchId === undefined) {
        ...
        if (dispatchId === undefined) {
           try {
             const structSpec = mojo.internal.bindings.content.mojom.MhtmlFileWriter_SerializeAsMHTML_ParamsSpec.$.structSpec;
             ...
             if (e instanceof TypeError) console.warn('[Discovery] trial for SerializeAsMHTML failed with TypeError');
           }
        }
        if (dispatchId === undefined) {
...
mojo.internal.bindings.content.mojom.MhtmlFileWriterReceiver = mojo.internal.bindings.content.mojom.MhtmlFileWriterReceiver;
